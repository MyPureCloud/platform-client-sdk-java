...
public class GetWorkforcemanagementAlternativeshiftsSettingsRequest {
    ...
    public GetWorkforcemanagementAlternativeshiftsSettingsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/alternativeshifts/settings")
	...
	public static class Builder {
		private final GetWorkforcemanagementAlternativeshiftsSettingsRequest request;

		private Builder() {
			request = new GetWorkforcemanagementAlternativeshiftsSettingsRequest();
		}
		...
		public GetWorkforcemanagementAlternativeshiftsSettingsRequest build() {
