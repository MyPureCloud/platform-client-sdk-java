...
public class PostJourneyDeploymentAppeventsRequest {
	...
	public PostJourneyDeploymentAppeventsRequest withDeploymentId(String deploymentId) {
	    this.setDeploymentId(deploymentId);
	    return this;
	} 

	private AppEventRequest body;
	public AppEventRequest getBody() {
		return this.body;
	}

	public void setBody(AppEventRequest body) {
		this.body = body;
	}

	public PostJourneyDeploymentAppeventsRequest withBody(AppEventRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostJourneyDeploymentAppeventsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<AppEventRequest> withHttpInfo() {
        
        // verify the required parameter 'deploymentId' is set
        if (this.deploymentId == null) {
            throw new IllegalStateException("Missing the required parameter 'deploymentId' when building request for PostJourneyDeploymentAppeventsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/journey/deployments/{deploymentId}/appevents")
	...
	public static class Builder {
		private final PostJourneyDeploymentAppeventsRequest request;

		private Builder() {
			request = new PostJourneyDeploymentAppeventsRequest();
		}
		...
		public Builder withBody(AppEventRequest body) {
		...
		public PostJourneyDeploymentAppeventsRequest build() {
