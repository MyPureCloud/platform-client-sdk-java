...
public class GetTelephonyProvidersEdgesMediastatisticsConversationRequest {
	...
	public GetTelephonyProvidersEdgesMediastatisticsConversationRequest withConversationId(String conversationId) {
    ...
    public GetTelephonyProvidersEdgesMediastatisticsConversationRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for GetTelephonyProvidersEdgesMediastatisticsConversationRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/telephony/providers/edges/mediastatistics/conversations/{conversationId}")
	...
	public static class Builder {
		private final GetTelephonyProvidersEdgesMediastatisticsConversationRequest request;

		private Builder() {
			request = new GetTelephonyProvidersEdgesMediastatisticsConversationRequest();
		}
		...
		public GetTelephonyProvidersEdgesMediastatisticsConversationRequest build() {
