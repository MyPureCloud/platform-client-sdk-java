...
public class PostExternalcontactsImportCsvJobsRequest {

	private CsvJobRequest body;
	public CsvJobRequest getBody() {
		return this.body;
	}

	public void setBody(CsvJobRequest body) {
		this.body = body;
	}

	public PostExternalcontactsImportCsvJobsRequest withBody(CsvJobRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostExternalcontactsImportCsvJobsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<CsvJobRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostExternalcontactsImportCsvJobsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/externalcontacts/import/csv/jobs")
                .withBody(body)
	...
	public static Builder builder(CsvJobRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostExternalcontactsImportCsvJobsRequest request;

		private Builder() {
			request = new PostExternalcontactsImportCsvJobsRequest();
		}


		public Builder withBody(CsvJobRequest body) {
		...
		public Builder withRequiredParams(CsvJobRequest body) {
			request.setBody(body);
		...
		public PostExternalcontactsImportCsvJobsRequest build() {
