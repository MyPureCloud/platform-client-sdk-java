...
public class GetUserSkillgroupsRequest {
	...
	public GetUserSkillgroupsRequest withUserId(String userId) {
	...
	public GetUserSkillgroupsRequest withPageSize(Integer pageSize) {
	...
	public GetUserSkillgroupsRequest withAfter(String after) {
	    this.setAfter(after);
	    return this;
	} 
	...
	public GetUserSkillgroupsRequest withBefore(String before) {
    ...
    public GetUserSkillgroupsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.userId == null) {
            throw new IllegalStateException("Missing the required parameter 'userId' when building request for GetUserSkillgroupsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/users/{userId}/skillgroups")
	...
	public static class Builder {
		private final GetUserSkillgroupsRequest request;

		private Builder() {
			request = new GetUserSkillgroupsRequest();
		}
		...
		public GetUserSkillgroupsRequest build() {
