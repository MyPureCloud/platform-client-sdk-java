...
public class PostOutboundMessagingcampaignStopRequest {
	...
	public PostOutboundMessagingcampaignStopRequest withMessagingCampaignId(String messagingCampaignId) {
    ...
    public PostOutboundMessagingcampaignStopRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.messagingCampaignId == null) {
            throw new IllegalStateException("Missing the required parameter 'messagingCampaignId' when building request for PostOutboundMessagingcampaignStopRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/outbound/messagingcampaigns/{messagingCampaignId}/stop")
	...
	public static class Builder {
		private final PostOutboundMessagingcampaignStopRequest request;

		private Builder() {
			request = new PostOutboundMessagingcampaignStopRequest();
		}
		...
		public PostOutboundMessagingcampaignStopRequest build() {
