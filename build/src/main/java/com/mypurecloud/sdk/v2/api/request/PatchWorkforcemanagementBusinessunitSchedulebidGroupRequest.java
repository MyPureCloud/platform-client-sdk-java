...
public class PatchWorkforcemanagementBusinessunitSchedulebidGroupRequest {
	...
	public PatchWorkforcemanagementBusinessunitSchedulebidGroupRequest withBusinessUnitId(String businessUnitId) {
	...
	public PatchWorkforcemanagementBusinessunitSchedulebidGroupRequest withBidId(String bidId) {
	    this.setBidId(bidId);
	    return this;
	} 
	...
	public PatchWorkforcemanagementBusinessunitSchedulebidGroupRequest withBidGroupId(String bidGroupId) {
	    this.setBidGroupId(bidGroupId);
	    return this;
	} 

	private ScheduleBidGroupUpdate body;
	public ScheduleBidGroupUpdate getBody() {
		return this.body;
	}

	public void setBody(ScheduleBidGroupUpdate body) {
		this.body = body;
	}

	public PatchWorkforcemanagementBusinessunitSchedulebidGroupRequest withBody(ScheduleBidGroupUpdate body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchWorkforcemanagementBusinessunitSchedulebidGroupRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<ScheduleBidGroupUpdate> withHttpInfo() {
        
        // verify the required parameter 'businessUnitId' is set
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PatchWorkforcemanagementBusinessunitSchedulebidGroupRequest.");
        }
        
        // verify the required parameter 'bidId' is set
        if (this.bidId == null) {
            throw new IllegalStateException("Missing the required parameter 'bidId' when building request for PatchWorkforcemanagementBusinessunitSchedulebidGroupRequest.");
        }
        
        // verify the required parameter 'bidGroupId' is set
        if (this.bidGroupId == null) {
            throw new IllegalStateException("Missing the required parameter 'bidGroupId' when building request for PatchWorkforcemanagementBusinessunitSchedulebidGroupRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchWorkforcemanagementBusinessunitSchedulebidGroupRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/schedulebids/{bidId}/groups/{bidGroupId}")
	...
	public static Builder builder(String businessUnitId, String bidId, String bidGroupId, ScheduleBidGroupUpdate body) {
	    return new Builder()
	...
	public static class Builder {
		private final PatchWorkforcemanagementBusinessunitSchedulebidGroupRequest request;

		private Builder() {
			request = new PatchWorkforcemanagementBusinessunitSchedulebidGroupRequest();
		}
		...
		public Builder withBody(ScheduleBidGroupUpdate body) {
		...
		public Builder withRequiredParams(String businessUnitId, String bidId, String bidGroupId, ScheduleBidGroupUpdate body) {
			request.setBusinessUnitId(businessUnitId);
			request.setBidId(bidId);
			request.setBidGroupId(bidGroupId);
			request.setBody(body);
		...
		public PatchWorkforcemanagementBusinessunitSchedulebidGroupRequest build() {
