...
public class DeleteProcessautomationScheduledtriggerRequest {
	...
	public DeleteProcessautomationScheduledtriggerRequest withScheduledTriggerId(String scheduledTriggerId) {
    ...
    public DeleteProcessautomationScheduledtriggerRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.scheduledTriggerId == null) {
            throw new IllegalStateException("Missing the required parameter 'scheduledTriggerId' when building request for DeleteProcessautomationScheduledtriggerRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/processautomation/scheduledtriggers/{scheduledTriggerId}")
	...
	public static class Builder {
		private final DeleteProcessautomationScheduledtriggerRequest request;

		private Builder() {
			request = new DeleteProcessautomationScheduledtriggerRequest();
		}
		...
		public DeleteProcessautomationScheduledtriggerRequest build() {
