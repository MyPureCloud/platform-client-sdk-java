...
public class PostExternalcontactsImportCsvUploadsRequest {

	private CsvUploadRequest body;
	public CsvUploadRequest getBody() {
		return this.body;
	}

	public void setBody(CsvUploadRequest body) {
		this.body = body;
	}

	public PostExternalcontactsImportCsvUploadsRequest withBody(CsvUploadRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostExternalcontactsImportCsvUploadsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<CsvUploadRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostExternalcontactsImportCsvUploadsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/externalcontacts/import/csv/uploads")
                .withBody(body)
	...
	public static Builder builder(CsvUploadRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostExternalcontactsImportCsvUploadsRequest request;

		private Builder() {
			request = new PostExternalcontactsImportCsvUploadsRequest();
		}


		public Builder withBody(CsvUploadRequest body) {
		...
		public Builder withRequiredParams(CsvUploadRequest body) {
			request.setBody(body);
		...
		public PostExternalcontactsImportCsvUploadsRequest build() {
