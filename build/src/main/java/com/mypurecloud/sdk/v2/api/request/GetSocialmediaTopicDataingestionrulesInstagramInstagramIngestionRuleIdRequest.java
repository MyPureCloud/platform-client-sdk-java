...
public class GetSocialmediaTopicDataingestionrulesInstagramInstagramIngestionRuleIdRequest {
	...
	public GetSocialmediaTopicDataingestionrulesInstagramInstagramIngestionRuleIdRequest withTopicId(String topicId) {
	...
	public GetSocialmediaTopicDataingestionrulesInstagramInstagramIngestionRuleIdRequest withInstagramIngestionRuleId(String instagramIngestionRuleId) {
	...
	public GetSocialmediaTopicDataingestionrulesInstagramInstagramIngestionRuleIdRequest withIncludeDeleted(Boolean includeDeleted) {
    ...
    public GetSocialmediaTopicDataingestionrulesInstagramInstagramIngestionRuleIdRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.topicId == null) {
            throw new IllegalStateException("Missing the required parameter 'topicId' when building request for GetSocialmediaTopicDataingestionrulesInstagramInstagramIngestionRuleIdRequest.");
        }
        
        // verify the required parameter 'instagramIngestionRuleId' is set
        if (this.instagramIngestionRuleId == null) {
            throw new IllegalStateException("Missing the required parameter 'instagramIngestionRuleId' when building request for GetSocialmediaTopicDataingestionrulesInstagramInstagramIngestionRuleIdRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/socialmedia/topics/{topicId}/dataingestionrules/instagram/{instagramIngestionRuleId}")
	...
	public static class Builder {
		private final GetSocialmediaTopicDataingestionrulesInstagramInstagramIngestionRuleIdRequest request;

		private Builder() {
			request = new GetSocialmediaTopicDataingestionrulesInstagramInstagramIngestionRuleIdRequest();
		}
		...
		public GetSocialmediaTopicDataingestionrulesInstagramInstagramIngestionRuleIdRequest build() {
