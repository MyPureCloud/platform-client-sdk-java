...
public class PublishTopicTestPhraseDetectedPhrase  implements Serializable {
  ...
  public PublishTopicTestPhraseDetectedPhrase() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
    }
  }

  public PublishTopicTestPhraseDetectedPhrase(Boolean initWithEmptyList) {
  ...
  /**
   **/
  public PublishTopicTestPhraseDetectedPhrase confidence(Long confidence) {
