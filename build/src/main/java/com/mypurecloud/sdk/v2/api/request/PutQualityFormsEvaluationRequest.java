...
public class PutQualityFormsEvaluationRequest {
	...
	public PutQualityFormsEvaluationRequest withFormId(String formId) {
	...
	public PutQualityFormsEvaluationRequest withBody(EvaluationForm body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutQualityFormsEvaluationRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<EvaluationForm> withHttpInfo() {
        ...
        if (this.formId == null) {
            throw new IllegalStateException("Missing the required parameter 'formId' when building request for PutQualityFormsEvaluationRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutQualityFormsEvaluationRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/quality/forms/evaluations/{formId}")
	...
	public static class Builder {
		private final PutQualityFormsEvaluationRequest request;

		private Builder() {
			request = new PutQualityFormsEvaluationRequest();
		}
		...
		public PutQualityFormsEvaluationRequest build() {
