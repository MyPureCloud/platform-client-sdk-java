...
public class GetConversationsSummariesSettingRequest {
	...
	public GetConversationsSummariesSettingRequest withSummarySettingId(String summarySettingId) {
    ...
    public GetConversationsSummariesSettingRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.summarySettingId == null) {
            throw new IllegalStateException("Missing the required parameter 'summarySettingId' when building request for GetConversationsSummariesSettingRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/conversations/summaries/settings/{summarySettingId}")
	...
	public static class Builder {
		private final GetConversationsSummariesSettingRequest request;

		private Builder() {
			request = new GetConversationsSummariesSettingRequest();
		}
		...
		public GetConversationsSummariesSettingRequest build() {
