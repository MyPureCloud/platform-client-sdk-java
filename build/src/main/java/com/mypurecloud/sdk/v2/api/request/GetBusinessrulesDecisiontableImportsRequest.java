...
public class GetBusinessrulesDecisiontableImportsRequest {
	...
	public GetBusinessrulesDecisiontableImportsRequest withTableId(String tableId) {
	...
	public GetBusinessrulesDecisiontableImportsRequest withAfter(String after) {
	    this.setAfter(after);
	    return this;
	} 
	...
	public GetBusinessrulesDecisiontableImportsRequest withPageSize(String pageSize) {
    ...
    public GetBusinessrulesDecisiontableImportsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.tableId == null) {
            throw new IllegalStateException("Missing the required parameter 'tableId' when building request for GetBusinessrulesDecisiontableImportsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/businessrules/decisiontables/{tableId}/imports")
	...
	public static class Builder {
		private final GetBusinessrulesDecisiontableImportsRequest request;

		private Builder() {
			request = new GetBusinessrulesDecisiontableImportsRequest();
		}
		...
		public GetBusinessrulesDecisiontableImportsRequest build() {
