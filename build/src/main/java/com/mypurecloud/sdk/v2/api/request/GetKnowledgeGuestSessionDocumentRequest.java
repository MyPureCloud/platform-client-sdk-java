...
public class GetKnowledgeGuestSessionDocumentRequest {
	...
	public GetKnowledgeGuestSessionDocumentRequest withSessionId(String sessionId) {
	...
	public GetKnowledgeGuestSessionDocumentRequest withDocumentId(String documentId) {
    ...
    public GetKnowledgeGuestSessionDocumentRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.sessionId == null) {
            throw new IllegalStateException("Missing the required parameter 'sessionId' when building request for GetKnowledgeGuestSessionDocumentRequest.");
        }
        
        // verify the required parameter 'documentId' is set
        if (this.documentId == null) {
            throw new IllegalStateException("Missing the required parameter 'documentId' when building request for GetKnowledgeGuestSessionDocumentRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/knowledge/guest/sessions/{sessionId}/documents/{documentId}")
	...
	public static class Builder {
		private final GetKnowledgeGuestSessionDocumentRequest request;

		private Builder() {
			request = new GetKnowledgeGuestSessionDocumentRequest();
		}
		...
		public GetKnowledgeGuestSessionDocumentRequest build() {
