...
public class GetTelephonyProvidersEdgesPhonesTemplateRequest {
    ...
    public ApiRequest<Void> withHttpInfo() throws ApiException {
        ...
        if (this.phoneBaseSettingsId == null) {
            throw new ApiException(400, "Missing the required parameter 'phoneBaseSettingsId' when building request for GetTelephonyProvidersEdgesPhonesTemplateRequest.");
        }
