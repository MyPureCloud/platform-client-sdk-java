...
public class ContinuousForecastWeeks  implements Serializable {
  
  private Integer weekOffset = null;
  private List<Double> values = null;

  public ContinuousForecastWeeks() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
      values = new ArrayList<Double>();
    }
  }

  public ContinuousForecastWeeks(Boolean initWithEmptyList) {
   ...
   **/
  public ContinuousForecastWeeks weekOffset(Integer weekOffset) {
   ...
   **/
  public ContinuousForecastWeeks values(List<Double> values) {
    this.values = values;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ContinuousForecastWeeks continuousForecastWeeks = (ContinuousForecastWeeks) o;

    return Objects.equals(this.weekOffset, continuousForecastWeeks.weekOffset) &&
            Objects.equals(this.values, continuousForecastWeeks.values);
  }
