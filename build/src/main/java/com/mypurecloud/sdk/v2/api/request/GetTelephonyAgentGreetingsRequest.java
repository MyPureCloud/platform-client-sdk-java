...
public class GetTelephonyAgentGreetingsRequest {
	...
	public GetTelephonyAgentGreetingsRequest withAgentId(String agentId) {
    ...
    public GetTelephonyAgentGreetingsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.agentId == null) {
            throw new IllegalStateException("Missing the required parameter 'agentId' when building request for GetTelephonyAgentGreetingsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/telephony/agents/{agentId}/greetings")
	...
	public static class Builder {
		private final GetTelephonyAgentGreetingsRequest request;

		private Builder() {
			request = new GetTelephonyAgentGreetingsRequest();
		}
		...
		public GetTelephonyAgentGreetingsRequest build() {
