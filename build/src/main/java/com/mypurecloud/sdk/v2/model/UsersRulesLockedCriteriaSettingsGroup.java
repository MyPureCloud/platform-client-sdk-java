...
public class UsersRulesLockedCriteriaSettingsGroup  implements Serializable {
  ...
  private static class OperatorsEnumDeserializer extends StdDeserializer<OperatorsEnum> {
    public OperatorsEnumDeserializer() {
      super(OperatorsEnumDeserializer.class);
    }

    @Override
    public OperatorsEnum deserialize(JsonParser jsonParser, DeserializationContext ctxt)
            throws IOException {
      JsonNode node = jsonParser.getCodec().readTree(jsonParser);
      return OperatorsEnum.fromString(node.toString().replace("\"", ""));
    }
  }
  /**
   * Gets or Sets operators
   */
 @JsonDeserialize(using = OperatorsEnumDeserializer.class)
  public enum OperatorsEnum {
    ...
    OperatorsEnum(String value) {
      this.value = value;
    }

    @JsonCreator
    public static OperatorsEnum fromString(String key) {
  ...
  private List<OperatorsEnum> operators = null;
 ...
 @JsonDeserialize(using = ContainerEnumDeserializer.class)
   ...
   **/
  public UsersRulesLockedCriteriaSettingsGroup operators(List<OperatorsEnum> operators) {
    this.operators = operators;
    return this;
  }
  
  @ApiModelProperty(example = "null", required = true, value = "The allowed operators for this criteria")
  @JsonProperty("operators")
  public List<OperatorsEnum> getOperators() {
    return operators;
  }
  public void setOperators(List<OperatorsEnum> operators) {
    this.operators = operators;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.operators, usersRulesLockedCriteriaSettingsGroup.operators) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(operators, container, maxIdCount);
  }
