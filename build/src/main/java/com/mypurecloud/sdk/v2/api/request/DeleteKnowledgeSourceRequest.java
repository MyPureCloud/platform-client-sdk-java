...
public class DeleteKnowledgeSourceRequest {
	...
	public DeleteKnowledgeSourceRequest withSourceId(String sourceId) {
    ...
    public DeleteKnowledgeSourceRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.sourceId == null) {
            throw new IllegalStateException("Missing the required parameter 'sourceId' when building request for DeleteKnowledgeSourceRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/knowledge/sources/{sourceId}")
	...
	public static class Builder {
		private final DeleteKnowledgeSourceRequest request;

		private Builder() {
			request = new DeleteKnowledgeSourceRequest();
		}
		...
		public DeleteKnowledgeSourceRequest build() {
