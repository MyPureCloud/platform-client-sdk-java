...
public class PostConversationsMessagingIntegrationsOpenRequest {
    
	private OpenIntegrationRequest body;
	public OpenIntegrationRequest getBody() {
		return this.body;
	}

	public void setBody(OpenIntegrationRequest body) {
		this.body = body;
	}

	public PostConversationsMessagingIntegrationsOpenRequest withBody(OpenIntegrationRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostConversationsMessagingIntegrationsOpenRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<OpenIntegrationRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostConversationsMessagingIntegrationsOpenRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/conversations/messaging/integrations/open")
                .withBody(body)
	...
	public static Builder builder(OpenIntegrationRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostConversationsMessagingIntegrationsOpenRequest request;

		private Builder() {
			request = new PostConversationsMessagingIntegrationsOpenRequest();
		}

		
		public Builder withBody(OpenIntegrationRequest body) {
		...
		public Builder withRequiredParams(OpenIntegrationRequest body) {
			request.setBody(body);
		...
		public PostConversationsMessagingIntegrationsOpenRequest build() {
