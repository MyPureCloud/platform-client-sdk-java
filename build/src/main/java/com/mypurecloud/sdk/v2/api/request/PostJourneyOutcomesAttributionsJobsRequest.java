...
public class PostJourneyOutcomesAttributionsJobsRequest {

	private OutcomeAttributionListing body;
	public OutcomeAttributionListing getBody() {
		return this.body;
	}

	public void setBody(OutcomeAttributionListing body) {
		this.body = body;
	}

	public PostJourneyOutcomesAttributionsJobsRequest withBody(OutcomeAttributionListing body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostJourneyOutcomesAttributionsJobsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<OutcomeAttributionListing> withHttpInfo() {
        

        return ApiRequestBuilder.create("POST", "/api/v2/journey/outcomes/attributions/jobs")
                .withBody(body)
	...
	public static class Builder {
		private final PostJourneyOutcomesAttributionsJobsRequest request;

		private Builder() {
			request = new PostJourneyOutcomesAttributionsJobsRequest();
		}


		public Builder withBody(OutcomeAttributionListing body) {
		...
		public PostJourneyOutcomesAttributionsJobsRequest build() {
