...
public class GetWorkforcemanagementBusinessunitSchedulerSettingsRequest {
	...
	public GetWorkforcemanagementBusinessunitSchedulerSettingsRequest withBusinessUnitId(String businessUnitId) {
    ...
    public GetWorkforcemanagementBusinessunitSchedulerSettingsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for GetWorkforcemanagementBusinessunitSchedulerSettingsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/scheduler/settings")
	...
	public static class Builder {
		private final GetWorkforcemanagementBusinessunitSchedulerSettingsRequest request;

		private Builder() {
			request = new GetWorkforcemanagementBusinessunitSchedulerSettingsRequest();
		}
		...
		public GetWorkforcemanagementBusinessunitSchedulerSettingsRequest build() {
