...
public class DeleteChatsUsersMeSettingsRequest {
    ...
    public DeleteChatsUsersMeSettingsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("DELETE", "/api/v2/chats/users/me/settings")
	...
	public static class Builder {
		private final DeleteChatsUsersMeSettingsRequest request;

		private Builder() {
			request = new DeleteChatsUsersMeSettingsRequest();
		}
		...
		public DeleteChatsUsersMeSettingsRequest build() {
