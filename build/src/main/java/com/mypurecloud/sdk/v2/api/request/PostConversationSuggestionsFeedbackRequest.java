...
public class PostConversationSuggestionsFeedbackRequest {
	...
	public PostConversationSuggestionsFeedbackRequest withConversationId(String conversationId) {
	...
	public void setBody(Feedback body) {
		this.body = body;
	}

	public PostConversationSuggestionsFeedbackRequest withBody(Feedback body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostConversationSuggestionsFeedbackRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<Feedback> withHttpInfo() {
        
        // verify the required parameter 'conversationId' is set
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PostConversationSuggestionsFeedbackRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostConversationSuggestionsFeedbackRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/conversations/{conversationId}/suggestions/feedback")
	...
	public static Builder builder(String conversationId, Feedback body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostConversationSuggestionsFeedbackRequest request;

		private Builder() {
			request = new PostConversationSuggestionsFeedbackRequest();
		}
		...
		public Builder withBody(Feedback body) {
		...
		public Builder withRequiredParams(String conversationId, Feedback body) {
			request.setConversationId(conversationId);
			request.setBody(body);
		...
		public PostConversationSuggestionsFeedbackRequest build() {
