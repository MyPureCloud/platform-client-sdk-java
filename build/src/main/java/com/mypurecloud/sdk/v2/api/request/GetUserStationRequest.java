...
public class GetUserStationRequest {
	...
	public GetUserStationRequest withUserId(String userId) {
    ...
    public GetUserStationRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.userId == null) {
            throw new IllegalStateException("Missing the required parameter 'userId' when building request for GetUserStationRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/users/{userId}/station")
	...
	public static class Builder {
		private final GetUserStationRequest request;

		private Builder() {
			request = new GetUserStationRequest();
		}
		...
		public GetUserStationRequest build() {
