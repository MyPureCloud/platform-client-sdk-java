...
public class GetRoutingSkillexpressionRequest {
	...
	public GetRoutingSkillexpressionRequest withExpressionId(String expressionId) {
	...
	public GetRoutingSkillexpressionRequest withIncludeArchived(Boolean includeArchived) {
	    this.setIncludeArchived(includeArchived);
	    return this;
	} 
	...
	public GetRoutingSkillexpressionRequest withFormat(String format) {
	...
	public enum formatValues { 
		...
		@JsonCreator
		public static formatValues fromString(String key) {
			if (key == null) return null;

			for (formatValues value : formatValues.values()) {
				if (key.equalsIgnoreCase(value.toString())) {
					return value;
				}
			}

			return formatValues.values()[0];
		}
    ...
    public GetRoutingSkillexpressionRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.expressionId == null) {
            throw new IllegalStateException("Missing the required parameter 'expressionId' when building request for GetRoutingSkillexpressionRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/routing/skillexpressions/{expressionId}")
                .withPathParameter("expressionId", expressionId)
        

                .withQueryParameters("includeArchived", "", includeArchived)
        

                .withQueryParameters("format", "", format)
	...
	public static Builder builder(String expressionId) {
	    return new Builder()
	            .withRequiredParams(expressionId);
	}


	public static class Builder {
		private final GetRoutingSkillexpressionRequest request;

		private Builder() {
			request = new GetRoutingSkillexpressionRequest();
		}


		public Builder withExpressionId(String expressionId) {
		...
		public Builder withFormat(formatValues format) {
		...
		public Builder withRequiredParams(String expressionId) {
			request.setExpressionId(expressionId);
		...
		public GetRoutingSkillexpressionRequest build() {
            
            // verify the required parameter 'expressionId' is set
            if (request.expressionId == null) {
                throw new IllegalStateException("Missing the required parameter 'expressionId' when building request for GetRoutingSkillexpressionRequest.");
            }
