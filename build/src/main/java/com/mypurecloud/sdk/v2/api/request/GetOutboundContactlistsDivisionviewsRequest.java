...
public class GetOutboundContactlistsDivisionviewsRequest {
	...
	public GetOutboundContactlistsDivisionviewsRequest withIncludeImportStatus(Boolean includeImportStatus) {
	...
	public GetOutboundContactlistsDivisionviewsRequest withIncludeSize(Boolean includeSize) {
	...
	public GetOutboundContactlistsDivisionviewsRequest withPageSize(Integer pageSize) {
	...
	public GetOutboundContactlistsDivisionviewsRequest withPageNumber(Integer pageNumber) {
	...
	public GetOutboundContactlistsDivisionviewsRequest withFilterType(String filterType) {
	...
	public GetOutboundContactlistsDivisionviewsRequest withName(String name) {
	    this.setName(name);
	    return this;
	} 
	...
	public GetOutboundContactlistsDivisionviewsRequest withId(List<String> id) {
	    this.setId(id);
	    return this;
	} 
	...
	public GetOutboundContactlistsDivisionviewsRequest withSortBy(String sortBy) {
	...
	public GetOutboundContactlistsDivisionviewsRequest withSortOrder(String sortOrder) {
    ...
    public GetOutboundContactlistsDivisionviewsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/outbound/contactlists/divisionviews")
	...
	public static class Builder {
		private final GetOutboundContactlistsDivisionviewsRequest request;

		private Builder() {
			request = new GetOutboundContactlistsDivisionviewsRequest();
		}
		...
		public GetOutboundContactlistsDivisionviewsRequest build() {
