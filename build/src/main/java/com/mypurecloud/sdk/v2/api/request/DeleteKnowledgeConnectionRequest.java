...
public class DeleteKnowledgeConnectionRequest {
	...
	public DeleteKnowledgeConnectionRequest withConnectionId(String connectionId) {
    ...
    public DeleteKnowledgeConnectionRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.connectionId == null) {
            throw new IllegalStateException("Missing the required parameter 'connectionId' when building request for DeleteKnowledgeConnectionRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/knowledge/connections/{connectionId}")
	...
	public static class Builder {
		private final DeleteKnowledgeConnectionRequest request;

		private Builder() {
			request = new DeleteKnowledgeConnectionRequest();
		}
		...
		public DeleteKnowledgeConnectionRequest build() {
