...
public class PostEmployeeperformanceExternalmetricsDataRequest {

	private ExternalMetricDataWriteRequest body;
	public ExternalMetricDataWriteRequest getBody() {
		return this.body;
	}

	public void setBody(ExternalMetricDataWriteRequest body) {
		this.body = body;
	}

	public PostEmployeeperformanceExternalmetricsDataRequest withBody(ExternalMetricDataWriteRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostEmployeeperformanceExternalmetricsDataRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<ExternalMetricDataWriteRequest> withHttpInfo() {
        

        return ApiRequestBuilder.create("POST", "/api/v2/employeeperformance/externalmetrics/data")
                .withBody(body)
	...
	public static class Builder {
		private final PostEmployeeperformanceExternalmetricsDataRequest request;

		private Builder() {
			request = new PostEmployeeperformanceExternalmetricsDataRequest();
		}


		public Builder withBody(ExternalMetricDataWriteRequest body) {
		...
		public PostEmployeeperformanceExternalmetricsDataRequest build() {
