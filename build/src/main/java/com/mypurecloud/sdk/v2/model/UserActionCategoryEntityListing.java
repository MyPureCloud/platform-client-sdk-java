...
import com.mypurecloud.sdk.v2.model.UserActionCategory;
...
public class UserActionCategoryEntityListing  implements Serializable, PagedResource<UserActionCategory> {
  
  private List<UserActionCategory> entities = new ArrayList<UserActionCategory>();
  ...
  /**
   **/
  public UserActionCategoryEntityListing entities(List<UserActionCategory> entities) {
  ...
  public List<UserActionCategory> getEntities() {
    return entities;
  }
  public void setEntities(List<UserActionCategory> entities) {
    this.entities = entities;
  }
