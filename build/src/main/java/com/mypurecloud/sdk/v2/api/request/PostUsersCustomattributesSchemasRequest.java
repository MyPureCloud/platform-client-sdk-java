...
public class PostUsersCustomattributesSchemasRequest {
	...
	public PostUsersCustomattributesSchemasRequest withBody(DataSchema body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostUsersCustomattributesSchemasRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<DataSchema> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostUsersCustomattributesSchemasRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/users/customattributes/schemas")
                .withBody(body)
	...
	public static class Builder {
		private final PostUsersCustomattributesSchemasRequest request;

		private Builder() {
			request = new PostUsersCustomattributesSchemasRequest();
		}
		...
		public PostUsersCustomattributesSchemasRequest build() {
