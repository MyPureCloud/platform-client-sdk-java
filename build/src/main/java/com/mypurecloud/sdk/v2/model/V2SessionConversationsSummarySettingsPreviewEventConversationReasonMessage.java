...
public class V2SessionConversationsSummarySettingsPreviewEventConversationReasonMessage  implements Serializable {
  ...
  public V2SessionConversationsSummarySettingsPreviewEventConversationReasonMessage(Boolean initWithEmptyList) {
  ...
  /**
   **/
  public V2SessionConversationsSummarySettingsPreviewEventConversationReasonMessage text(String text) {
    this.text = text;
    return this;
  }
  ...
  /**
   **/
  public V2SessionConversationsSummarySettingsPreviewEventConversationReasonMessage score(BigDecimal score) {
    this.score = score;
    return this;
  }
