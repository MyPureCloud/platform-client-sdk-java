...
public class GetKnowledgeKnowledgebaseCategoryRequest {
	...
	public GetKnowledgeKnowledgebaseCategoryRequest withKnowledgeBaseId(String knowledgeBaseId) {
	...
	public GetKnowledgeKnowledgebaseCategoryRequest withCategoryId(String categoryId) {
    ...
    public GetKnowledgeKnowledgebaseCategoryRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.knowledgeBaseId == null) {
            throw new IllegalStateException("Missing the required parameter 'knowledgeBaseId' when building request for GetKnowledgeKnowledgebaseCategoryRequest.");
        }
        
        // verify the required parameter 'categoryId' is set
        if (this.categoryId == null) {
            throw new IllegalStateException("Missing the required parameter 'categoryId' when building request for GetKnowledgeKnowledgebaseCategoryRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/categories/{categoryId}")
	...
	public static class Builder {
		private final GetKnowledgeKnowledgebaseCategoryRequest request;

		private Builder() {
			request = new GetKnowledgeKnowledgebaseCategoryRequest();
		}
		...
		public GetKnowledgeKnowledgebaseCategoryRequest build() {
