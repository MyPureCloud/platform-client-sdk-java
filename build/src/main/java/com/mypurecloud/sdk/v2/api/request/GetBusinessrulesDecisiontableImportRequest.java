...
public class GetBusinessrulesDecisiontableImportRequest {
	...
	public GetBusinessrulesDecisiontableImportRequest withTableId(String tableId) {
	...
	public GetBusinessrulesDecisiontableImportRequest withImportJobId(String importJobId) {
    ...
    public GetBusinessrulesDecisiontableImportRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.tableId == null) {
            throw new IllegalStateException("Missing the required parameter 'tableId' when building request for GetBusinessrulesDecisiontableImportRequest.");
        }
        
        // verify the required parameter 'importJobId' is set
        if (this.importJobId == null) {
            throw new IllegalStateException("Missing the required parameter 'importJobId' when building request for GetBusinessrulesDecisiontableImportRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/businessrules/decisiontables/{tableId}/imports/{importJobId}")
	...
	public static class Builder {
		private final GetBusinessrulesDecisiontableImportRequest request;

		private Builder() {
			request = new GetBusinessrulesDecisiontableImportRequest();
		}
		...
		public GetBusinessrulesDecisiontableImportRequest build() {
