...
public class PutTelephonyProvidersEdgesEdgegroupRequest {
	...
	public PutTelephonyProvidersEdgesEdgegroupRequest withEdgeGroupId(String edgeGroupId) {
	...
	public void setBody(EdgeGroup body) {
		this.body = body;
	}

	public PutTelephonyProvidersEdgesEdgegroupRequest withBody(EdgeGroup body) {
	    this.setBody(body);
	    return this;
	}
    ...
    public PutTelephonyProvidersEdgesEdgegroupRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<EdgeGroup> withHttpInfo() throws ApiException {
        
        // verify the required parameter 'edgeGroupId' is set
        if (this.edgeGroupId == null) {
            throw new ApiException(400, "Missing the required parameter 'edgeGroupId' when building request for PutTelephonyProvidersEdgesEdgegroupRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new ApiException(400, "Missing the required parameter 'body' when building request for PutTelephonyProvidersEdgesEdgegroupRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/telephony/providers/edges/edgegroups/{edgeGroupId}")
