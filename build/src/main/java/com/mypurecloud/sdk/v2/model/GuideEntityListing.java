...
public class GuideEntityListing  implements Serializable, PagedResource<Guide> {
  
  private List<Guide> entities = null;
  ...
  /**
   **/
  public GuideEntityListing entities(List<Guide> entities) {
  ...
  public List<Guide> getEntities() {
    return entities;
  }
  public void setEntities(List<Guide> entities) {
    this.entities = entities;
  }
  ...
  /**
   **/
  public GuideEntityListing pageSize(Integer pageSize) {
  ...
  /**
   **/
  public GuideEntityListing pageNumber(Integer pageNumber) {
  ...
  /**
   **/
  public GuideEntityListing total(Long total) {
    this.total = total;
    return this;
  }
  ...
  /**
   **/
  public GuideEntityListing nextUri(String nextUri) {
  ...
  /**
   **/
  public GuideEntityListing lastUri(String lastUri) {
  ...
  /**
   **/
  public GuideEntityListing pageCount(Integer pageCount) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    GuideEntityListing guideEntityListing = (GuideEntityListing) o;

    return Objects.equals(this.entities, guideEntityListing.entities) &&
