...
public class GetJourneyViewsEventdefinitionRequest {
	...
	public GetJourneyViewsEventdefinitionRequest withEventDefinitionId(String eventDefinitionId) {
    ...
    public GetJourneyViewsEventdefinitionRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.eventDefinitionId == null) {
            throw new IllegalStateException("Missing the required parameter 'eventDefinitionId' when building request for GetJourneyViewsEventdefinitionRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/journey/views/eventdefinitions/{eventDefinitionId}")
	...
	public static class Builder {
		private final GetJourneyViewsEventdefinitionRequest request;

		private Builder() {
			request = new GetJourneyViewsEventdefinitionRequest();
		}
		...
		public GetJourneyViewsEventdefinitionRequest build() {
