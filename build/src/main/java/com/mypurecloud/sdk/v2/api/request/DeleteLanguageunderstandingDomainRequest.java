...
public class DeleteLanguageunderstandingDomainRequest {
	...
	public DeleteLanguageunderstandingDomainRequest withDomainId(String domainId) {
    ...
    public DeleteLanguageunderstandingDomainRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.domainId == null) {
            throw new IllegalStateException("Missing the required parameter 'domainId' when building request for DeleteLanguageunderstandingDomainRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/languageunderstanding/domains/{domainId}")
	...
	public static class Builder {
		private final DeleteLanguageunderstandingDomainRequest request;

		private Builder() {
			request = new DeleteLanguageunderstandingDomainRequest();
		}
		...
		public DeleteLanguageunderstandingDomainRequest build() {
