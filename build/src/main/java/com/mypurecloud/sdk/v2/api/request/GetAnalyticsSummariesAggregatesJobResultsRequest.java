...
public class GetAnalyticsSummariesAggregatesJobResultsRequest {
	...
	public GetAnalyticsSummariesAggregatesJobResultsRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
	...
	public GetAnalyticsSummariesAggregatesJobResultsRequest withCursor(String cursor) {
    ...
    public GetAnalyticsSummariesAggregatesJobResultsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetAnalyticsSummariesAggregatesJobResultsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/analytics/summaries/aggregates/jobs/{jobId}/results")
	...
	public static class Builder {
		private final GetAnalyticsSummariesAggregatesJobResultsRequest request;

		private Builder() {
			request = new GetAnalyticsSummariesAggregatesJobResultsRequest();
		}
		...
		public GetAnalyticsSummariesAggregatesJobResultsRequest build() {
