...
public class GetAnalyticsFlowexecutionsAggregatesJobResultsRequest {
	...
	public GetAnalyticsFlowexecutionsAggregatesJobResultsRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
	...
	public GetAnalyticsFlowexecutionsAggregatesJobResultsRequest withCursor(String cursor) {
    ...
    public GetAnalyticsFlowexecutionsAggregatesJobResultsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetAnalyticsFlowexecutionsAggregatesJobResultsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/analytics/flowexecutions/aggregates/jobs/{jobId}/results")
	...
	public static class Builder {
		private final GetAnalyticsFlowexecutionsAggregatesJobResultsRequest request;

		private Builder() {
			request = new GetAnalyticsFlowexecutionsAggregatesJobResultsRequest();
		}
		...
		public GetAnalyticsFlowexecutionsAggregatesJobResultsRequest build() {
