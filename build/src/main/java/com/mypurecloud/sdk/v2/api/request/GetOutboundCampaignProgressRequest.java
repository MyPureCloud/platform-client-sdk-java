...
public class GetOutboundCampaignProgressRequest {
	...
	public GetOutboundCampaignProgressRequest withCampaignId(String campaignId) {
    ...
    public GetOutboundCampaignProgressRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.campaignId == null) {
            throw new IllegalStateException("Missing the required parameter 'campaignId' when building request for GetOutboundCampaignProgressRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/outbound/campaigns/{campaignId}/progress")
	...
	public static class Builder {
		private final GetOutboundCampaignProgressRequest request;

		private Builder() {
			request = new GetOutboundCampaignProgressRequest();
		}
		...
		public GetOutboundCampaignProgressRequest build() {
