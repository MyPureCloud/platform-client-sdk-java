...
public class DependencyTrackingBuildNotificationNotificationUser  implements Serializable {
  ...
  /**
   **/
  public DependencyTrackingBuildNotificationNotificationUser id(String id) {
    this.id = id;
    return this;
  }
