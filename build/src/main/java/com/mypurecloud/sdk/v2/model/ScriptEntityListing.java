...
public class ScriptEntityListing  implements Serializable, PagedResource<Script> {
  ...
  /**
   **/
  public ScriptEntityListing entities(List<Script> entities) {
  ...
  /**
   **/
  public ScriptEntityListing pageSize(Integer pageSize) {
  ...
  /**
   **/
  public ScriptEntityListing pageNumber(Integer pageNumber) {
  ...
  /**
   **/
  public ScriptEntityListing total(Long total) {
    this.total = total;
    return this;
  }
  ...
  /**
   **/
  public ScriptEntityListing nextUri(String nextUri) {
  ...
  /**
   **/
  public ScriptEntityListing pageCount(Integer pageCount) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.entities, scriptEntityListing.entities) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(entities, pageSize, pageNumber, total, truncatedDivisions, firstUri, nextUri, previousUri, lastUri, selfUri, pageCount);
  }
