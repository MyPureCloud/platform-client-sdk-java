...
public class GetIdentityprovidersPurecloudRequest {
    ...
    public GetIdentityprovidersPurecloudRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/identityproviders/purecloud")                .withCustomHeaders(customHeaders)
	...
	public static class Builder {
		private final GetIdentityprovidersPurecloudRequest request;

		private Builder() {
			request = new GetIdentityprovidersPurecloudRequest();
		}




		public GetIdentityprovidersPurecloudRequest build() {
			return request;
		}
	}
}
