...
public class GetWorkforcemanagementAdherenceHistoricalJobRequest {
	...
	public GetWorkforcemanagementAdherenceHistoricalJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetWorkforcemanagementAdherenceHistoricalJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetWorkforcemanagementAdherenceHistoricalJobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/adherence/historical/jobs/{jobId}")
	...
	public static class Builder {
		private final GetWorkforcemanagementAdherenceHistoricalJobRequest request;

		private Builder() {
			request = new GetWorkforcemanagementAdherenceHistoricalJobRequest();
		}
		...
		public GetWorkforcemanagementAdherenceHistoricalJobRequest build() {
