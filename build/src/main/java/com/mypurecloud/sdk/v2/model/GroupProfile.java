...
public class GroupProfile  implements Serializable {
   ...
   * The state of the user resource
   **/
  public GroupProfile state(StateEnum state) {
    this.state = state;
    return this;
  }
  
  @ApiModelProperty(example = "null", value = "The state of the user resource")
  @JsonProperty("state")
  ...
  @ApiModelProperty(example = "null", value = "Datetime of the last modification. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss.SSSZ")
   ...
   **/
  public GroupProfile version(Long version) {
    this.version = version;
    return this;
  }
  
  @ApiModelProperty(example = "null", required = true, value = "The version of the group resource")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, state, dateModified, version, selfUri);
  }
