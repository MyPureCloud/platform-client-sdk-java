...
public class PutTaskmanagementWorkitemsSchemaRequest {
	...
	public PutTaskmanagementWorkitemsSchemaRequest withSchemaId(String schemaId) {
	...
	public PutTaskmanagementWorkitemsSchemaRequest withBody(DataSchema body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutTaskmanagementWorkitemsSchemaRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<DataSchema> withHttpInfo() {
        ...
        if (this.schemaId == null) {
            throw new IllegalStateException("Missing the required parameter 'schemaId' when building request for PutTaskmanagementWorkitemsSchemaRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutTaskmanagementWorkitemsSchemaRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/taskmanagement/workitems/schemas/{schemaId}")
	...
	public static class Builder {
		private final PutTaskmanagementWorkitemsSchemaRequest request;

		private Builder() {
			request = new PutTaskmanagementWorkitemsSchemaRequest();
		}
		...
		public PutTaskmanagementWorkitemsSchemaRequest build() {
