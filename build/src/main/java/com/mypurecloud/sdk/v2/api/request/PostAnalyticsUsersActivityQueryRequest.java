...
public class PostAnalyticsUsersActivityQueryRequest {

	private UserActivityQuery body;
	public UserActivityQuery getBody() {
		return this.body;
	}

	public void setBody(UserActivityQuery body) {
		this.body = body;
	}

	public PostAnalyticsUsersActivityQueryRequest withBody(UserActivityQuery body) {
	    this.setBody(body);
	    return this;
	} 
	...
	public PostAnalyticsUsersActivityQueryRequest withPageSize(Integer pageSize) {
	...
	public PostAnalyticsUsersActivityQueryRequest withPageNumber(Integer pageNumber) {
    ...
    public PostAnalyticsUsersActivityQueryRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<UserActivityQuery> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostAnalyticsUsersActivityQueryRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/analytics/users/activity/query")
	...
	public static Builder builder(UserActivityQuery body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostAnalyticsUsersActivityQueryRequest request;

		private Builder() {
			request = new PostAnalyticsUsersActivityQueryRequest();
		}


		public Builder withBody(UserActivityQuery body) {
		...
		public Builder withRequiredParams(UserActivityQuery body) {
			request.setBody(body);
		...
		public PostAnalyticsUsersActivityQueryRequest build() {
