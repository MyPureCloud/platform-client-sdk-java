...
public class PostConversationParticipantTransferRequest {
    ...
    public ApiRequest<TransferToAddressRequest> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("POST", "/api/v2/conversations/{conversationId}/participants/{participantId}/transfer")
	...
	public static class Builder {
		private final PostConversationParticipantTransferRequest request;

		private Builder() {
			request = new PostConversationParticipantTransferRequest();
		}
