...
public class GetAnalyticsConversationsAggregatesJobResultsRequest {
	...
	public GetAnalyticsConversationsAggregatesJobResultsRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
	...
	public GetAnalyticsConversationsAggregatesJobResultsRequest withCursor(String cursor) {
    ...
    public GetAnalyticsConversationsAggregatesJobResultsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetAnalyticsConversationsAggregatesJobResultsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/analytics/conversations/aggregates/jobs/{jobId}/results")
	...
	public static class Builder {
		private final GetAnalyticsConversationsAggregatesJobResultsRequest request;

		private Builder() {
			request = new GetAnalyticsConversationsAggregatesJobResultsRequest();
		}
		...
		public GetAnalyticsConversationsAggregatesJobResultsRequest build() {
