...
public class PostOutboundContactlisttemplatesRequest {

	private ContactListTemplate body;
	public ContactListTemplate getBody() {
		return this.body;
	}

	public void setBody(ContactListTemplate body) {
		this.body = body;
	}

	public PostOutboundContactlisttemplatesRequest withBody(ContactListTemplate body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostOutboundContactlisttemplatesRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<ContactListTemplate> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostOutboundContactlisttemplatesRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/outbound/contactlisttemplates")
                .withBody(body)
	...
	public static Builder builder(ContactListTemplate body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostOutboundContactlisttemplatesRequest request;

		private Builder() {
			request = new PostOutboundContactlisttemplatesRequest();
		}


		public Builder withBody(ContactListTemplate body) {
		...
		public Builder withRequiredParams(ContactListTemplate body) {
			request.setBody(body);
		...
		public PostOutboundContactlisttemplatesRequest build() {
