...
public class PostKnowledgeGuestSessionDocumentCopiesRequest {
    ...
    public ApiRequest<KnowledgeGuestDocumentCopy> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("POST", "/api/v2/knowledge/guest/sessions/{sessionId}/documents/{documentId}/copies")
	...
	public static class Builder {
		private final PostKnowledgeGuestSessionDocumentCopiesRequest request;

		private Builder() {
			request = new PostKnowledgeGuestSessionDocumentCopiesRequest();
		}
