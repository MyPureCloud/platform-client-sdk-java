...
public class GetCasemanagementCaseplanVersionStageplanStepplansRequest {
	...
	public GetCasemanagementCaseplanVersionStageplanStepplansRequest withCaseplanId(String caseplanId) {
	...
	public GetCasemanagementCaseplanVersionStageplanStepplansRequest withVersionId(String versionId) {
	...
	public GetCasemanagementCaseplanVersionStageplanStepplansRequest withStageplanId(String stageplanId) {
	...
	public GetCasemanagementCaseplanVersionStageplanStepplansRequest withBefore(String before) {
	...
	public GetCasemanagementCaseplanVersionStageplanStepplansRequest withAfter(String after) {
	    this.setAfter(after);
	    return this;
	} 
	...
	public GetCasemanagementCaseplanVersionStageplanStepplansRequest withPageSize(String pageSize) {
	...
	public GetCasemanagementCaseplanVersionStageplanStepplansRequest withExpands(List<String> expands) {
    ...
    public GetCasemanagementCaseplanVersionStageplanStepplansRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.caseplanId == null) {
            throw new IllegalStateException("Missing the required parameter 'caseplanId' when building request for GetCasemanagementCaseplanVersionStageplanStepplansRequest.");
        }
        
        // verify the required parameter 'versionId' is set
        if (this.versionId == null) {
            throw new IllegalStateException("Missing the required parameter 'versionId' when building request for GetCasemanagementCaseplanVersionStageplanStepplansRequest.");
        }
        
        // verify the required parameter 'stageplanId' is set
        if (this.stageplanId == null) {
            throw new IllegalStateException("Missing the required parameter 'stageplanId' when building request for GetCasemanagementCaseplanVersionStageplanStepplansRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/casemanagement/caseplans/{caseplanId}/versions/{versionId}/stageplans/{stageplanId}/stepplans")
	...
	public static class Builder {
		private final GetCasemanagementCaseplanVersionStageplanStepplansRequest request;

		private Builder() {
			request = new GetCasemanagementCaseplanVersionStageplanStepplansRequest();
		}
		...
		public GetCasemanagementCaseplanVersionStageplanStepplansRequest build() {
