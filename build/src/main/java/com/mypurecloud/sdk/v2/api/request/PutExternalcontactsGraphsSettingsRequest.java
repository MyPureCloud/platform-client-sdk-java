...
public class PutExternalcontactsGraphsSettingsRequest {

	private GraphSettings body;
	public GraphSettings getBody() {
		return this.body;
	}

	public void setBody(GraphSettings body) {
		this.body = body;
	}

	public PutExternalcontactsGraphsSettingsRequest withBody(GraphSettings body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutExternalcontactsGraphsSettingsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<GraphSettings> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutExternalcontactsGraphsSettingsRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/externalcontacts/graphs/settings")
                .withBody(body)
	...
	public static Builder builder(GraphSettings body) {
	    return new Builder()
	...
	public static class Builder {
		private final PutExternalcontactsGraphsSettingsRequest request;

		private Builder() {
			request = new PutExternalcontactsGraphsSettingsRequest();
		}


		public Builder withBody(GraphSettings body) {
		...
		public Builder withRequiredParams(GraphSettings body) {
			request.setBody(body);
		...
		public PutExternalcontactsGraphsSettingsRequest build() {
