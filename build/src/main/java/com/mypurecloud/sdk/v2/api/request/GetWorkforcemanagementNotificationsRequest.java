...
public class GetWorkforcemanagementNotificationsRequest {
    ...
    public GetWorkforcemanagementNotificationsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/notifications")
	...
	public static class Builder {
		private final GetWorkforcemanagementNotificationsRequest request;

		private Builder() {
			request = new GetWorkforcemanagementNotificationsRequest();
		}
		...
		public GetWorkforcemanagementNotificationsRequest build() {
