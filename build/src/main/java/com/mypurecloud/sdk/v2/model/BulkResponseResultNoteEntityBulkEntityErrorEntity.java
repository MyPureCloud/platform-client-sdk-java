...
public class BulkResponseResultNoteEntityBulkEntityErrorEntity  implements Serializable {
  ...
  public BulkResponseResultNoteEntityBulkEntityErrorEntity() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
    }
  }

  public BulkResponseResultNoteEntityBulkEntityErrorEntity(Boolean initWithEmptyList) {
   ...
   **/
  public BulkResponseResultNoteEntityBulkEntityErrorEntity id(String id) {
    this.id = id;
    return this;
  }
   ...
   **/
  public BulkResponseResultNoteEntityBulkEntityErrorEntity success(Boolean success) {
   ...
   **/
  public BulkResponseResultNoteEntityBulkEntityErrorEntity entity(Note entity) {
    this.entity = entity;
    return this;
  }
   ...
   **/
  public BulkResponseResultNoteEntityBulkEntityErrorEntity error(BulkEntityErrorEntity error) {
    this.error = error;
    return this;
  }
   ...
   **/
  public BulkResponseResultNoteEntityBulkEntityErrorEntity status(Integer status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    BulkResponseResultNoteEntityBulkEntityErrorEntity bulkResponseResultNoteEntityBulkEntityErrorEntity = (BulkResponseResultNoteEntityBulkEntityErrorEntity) o;

    return Objects.equals(this.id, bulkResponseResultNoteEntityBulkEntityErrorEntity.id) &&
            Objects.equals(this.success, bulkResponseResultNoteEntityBulkEntityErrorEntity.success) &&
            Objects.equals(this.entity, bulkResponseResultNoteEntityBulkEntityErrorEntity.entity) &&
            Objects.equals(this.error, bulkResponseResultNoteEntityBulkEntityErrorEntity.error) &&
            Objects.equals(this.status, bulkResponseResultNoteEntityBulkEntityErrorEntity.status);
  }
