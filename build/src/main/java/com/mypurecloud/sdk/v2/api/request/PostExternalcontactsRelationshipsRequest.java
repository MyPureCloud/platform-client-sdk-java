...
public class PostExternalcontactsRelationshipsRequest {
	...
	public PostExternalcontactsRelationshipsRequest withBody(Relationship body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostExternalcontactsRelationshipsRequest withCustomHeader(String name, String value) {
