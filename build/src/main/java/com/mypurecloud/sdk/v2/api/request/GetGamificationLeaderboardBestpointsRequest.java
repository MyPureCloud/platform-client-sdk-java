...
public class GetGamificationLeaderboardBestpointsRequest {
    ...
    public GetGamificationLeaderboardBestpointsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/gamification/leaderboard/bestpoints")
	...
	public static class Builder {
		private final GetGamificationLeaderboardBestpointsRequest request;

		private Builder() {
			request = new GetGamificationLeaderboardBestpointsRequest();
		}
		...
		public GetGamificationLeaderboardBestpointsRequest build() {
