...
public class PostExternalcontactsIdentifierlookupContactsRequest {
	...
	public PostExternalcontactsIdentifierlookupContactsRequest withExpand(List<String> expand) {
    ...
    public ApiRequest<ContactIdentifier> withHttpInfo() {
        ...
        if (this.identifier == null) {
            throw new IllegalStateException("Missing the required parameter 'identifier' when building request for PostExternalcontactsIdentifierlookupContactsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/externalcontacts/identifierlookup/contacts")
	...
	public static class Builder {
		private final PostExternalcontactsIdentifierlookupContactsRequest request;

		private Builder() {
			request = new PostExternalcontactsIdentifierlookupContactsRequest();
		}
		...
		public PostExternalcontactsIdentifierlookupContactsRequest build() {
