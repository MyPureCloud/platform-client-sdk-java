...
public class PatchWorkforcemanagementBusinessunitWorkplanbidRequest {
	...
	public PatchWorkforcemanagementBusinessunitWorkplanbidRequest withBidId(String bidId) {
	    this.setBidId(bidId);
	    return this;
	} 

	private UpdateWorkPlanBid body;
	public UpdateWorkPlanBid getBody() {
		return this.body;
	}

	public void setBody(UpdateWorkPlanBid body) {
		this.body = body;
	}

	public PatchWorkforcemanagementBusinessunitWorkplanbidRequest withBody(UpdateWorkPlanBid body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public ApiRequest<UpdateWorkPlanBid> withHttpInfo() {
        
        // verify the required parameter 'businessUnitId' is set
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PatchWorkforcemanagementBusinessunitWorkplanbidRequest.");
        }
        
        // verify the required parameter 'bidId' is set
        if (this.bidId == null) {
            throw new IllegalStateException("Missing the required parameter 'bidId' when building request for PatchWorkforcemanagementBusinessunitWorkplanbidRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchWorkforcemanagementBusinessunitWorkplanbidRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/workplanbids/{bidId}")
	...
	public static Builder builder(String businessUnitId, String bidId, UpdateWorkPlanBid body) {
	    return new Builder()
	...
	public static class Builder {
		private final PatchWorkforcemanagementBusinessunitWorkplanbidRequest request;

		private Builder() {
			request = new PatchWorkforcemanagementBusinessunitWorkplanbidRequest();
		}
		...
		public Builder withBody(UpdateWorkPlanBid body) {
		...
		public Builder withRequiredParams(String businessUnitId, String bidId, UpdateWorkPlanBid body) {
			request.setBusinessUnitId(businessUnitId);
			request.setBidId(bidId);
			request.setBody(body);
		...
		public PatchWorkforcemanagementBusinessunitWorkplanbidRequest build() {
