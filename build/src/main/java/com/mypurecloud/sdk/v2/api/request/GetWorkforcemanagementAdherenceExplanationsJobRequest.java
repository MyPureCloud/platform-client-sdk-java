...
public class GetWorkforcemanagementAdherenceExplanationsJobRequest {
	...
	public GetWorkforcemanagementAdherenceExplanationsJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetWorkforcemanagementAdherenceExplanationsJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetWorkforcemanagementAdherenceExplanationsJobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/adherence/explanations/jobs/{jobId}")
	...
	public static class Builder {
		private final GetWorkforcemanagementAdherenceExplanationsJobRequest request;

		private Builder() {
			request = new GetWorkforcemanagementAdherenceExplanationsJobRequest();
		}
		...
		public GetWorkforcemanagementAdherenceExplanationsJobRequest build() {
