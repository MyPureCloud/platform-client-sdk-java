...
public class GetQualityPublishedformsEvaluationsDivisionviewsRequest {
	...
	public GetQualityPublishedformsEvaluationsDivisionviewsRequest withId(List<String> id) {
	    this.setId(id);
	    return this;
	} 
	...
	public GetQualityPublishedformsEvaluationsDivisionviewsRequest withPageSize(Integer pageSize) {
	...
	public GetQualityPublishedformsEvaluationsDivisionviewsRequest withPageNumber(Integer pageNumber) {
	...
	public GetQualityPublishedformsEvaluationsDivisionviewsRequest withName(String name) {
	    this.setName(name);
	    return this;
	} 
	...
	public GetQualityPublishedformsEvaluationsDivisionviewsRequest withDivisionId(String divisionId) {
    ...
    public GetQualityPublishedformsEvaluationsDivisionviewsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.id == null) {
            throw new IllegalStateException("Missing the required parameter 'id' when building request for GetQualityPublishedformsEvaluationsDivisionviewsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/quality/publishedforms/evaluations/divisionviews")
	...
	public static class Builder {
		private final GetQualityPublishedformsEvaluationsDivisionviewsRequest request;

		private Builder() {
			request = new GetQualityPublishedformsEvaluationsDivisionviewsRequest();
		}
		...
		public GetQualityPublishedformsEvaluationsDivisionviewsRequest build() {
