...
public class ActionAggregationSort  implements Serializable {
 ...
 @JsonDeserialize(using = FunctionEnumDeserializer.class)
   ...
   * Name of the metric used for sorting values.
   **/
  public ActionAggregationSort name(NameEnum name) {
    this.name = name;
    return this;
  }
   ...
   * Aggregation function used for the sort metric.
   **/
  public ActionAggregationSort function(FunctionEnum function) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ActionAggregationSort actionAggregationSort = (ActionAggregationSort) o;

    return Objects.equals(this.name, actionAggregationSort.name) &&
            Objects.equals(this.function, actionAggregationSort.function);
  }
