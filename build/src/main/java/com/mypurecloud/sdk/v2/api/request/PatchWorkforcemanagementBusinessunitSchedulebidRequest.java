...
public class PatchWorkforcemanagementBusinessunitSchedulebidRequest {
	...
	public PatchWorkforcemanagementBusinessunitSchedulebidRequest withBusinessUnitId(String businessUnitId) {
	...
	public PatchWorkforcemanagementBusinessunitSchedulebidRequest withBidId(String bidId) {
	    this.setBidId(bidId);
	    return this;
	} 

	private UpdateScheduleBid body;
	public UpdateScheduleBid getBody() {
		return this.body;
	}

	public void setBody(UpdateScheduleBid body) {
		this.body = body;
	}

	public PatchWorkforcemanagementBusinessunitSchedulebidRequest withBody(UpdateScheduleBid body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchWorkforcemanagementBusinessunitSchedulebidRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<UpdateScheduleBid> withHttpInfo() {
        
        // verify the required parameter 'businessUnitId' is set
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PatchWorkforcemanagementBusinessunitSchedulebidRequest.");
        }
        
        // verify the required parameter 'bidId' is set
        if (this.bidId == null) {
            throw new IllegalStateException("Missing the required parameter 'bidId' when building request for PatchWorkforcemanagementBusinessunitSchedulebidRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchWorkforcemanagementBusinessunitSchedulebidRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/schedulebids/{bidId}")
	...
	public static Builder builder(String businessUnitId, String bidId, UpdateScheduleBid body) {
	    return new Builder()
	...
	public static class Builder {
		private final PatchWorkforcemanagementBusinessunitSchedulebidRequest request;

		private Builder() {
			request = new PatchWorkforcemanagementBusinessunitSchedulebidRequest();
		}
		...
		public Builder withBody(UpdateScheduleBid body) {
		...
		public Builder withRequiredParams(String businessUnitId, String bidId, UpdateScheduleBid body) {
			request.setBusinessUnitId(businessUnitId);
			request.setBidId(bidId);
			request.setBody(body);
		...
		public PatchWorkforcemanagementBusinessunitSchedulebidRequest build() {
