...
public class GetGamificationContestRequest {
	...
	public GetGamificationContestRequest withContestId(String contestId) {
    ...
    public GetGamificationContestRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.contestId == null) {
            throw new IllegalStateException("Missing the required parameter 'contestId' when building request for GetGamificationContestRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/gamification/contests/{contestId}")
	...
	public static class Builder {
		private final GetGamificationContestRequest request;

		private Builder() {
			request = new GetGamificationContestRequest();
		}
		...
		public GetGamificationContestRequest build() {
