 ...
 * A Typing event.
 */
@ApiModel(description = "A Typing event.")
...
public class EventTyping  implements Serializable {
 ...
 @JsonDeserialize(using = TypeEnumDeserializer.class)
   ...
   * Describes the type of Typing event.
   **/
  public EventTyping type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.type, eventTyping.type) &&
            Objects.equals(this.duration, eventTyping.duration);
  }
