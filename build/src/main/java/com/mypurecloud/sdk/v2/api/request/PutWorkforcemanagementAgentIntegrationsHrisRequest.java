...
public class PutWorkforcemanagementAgentIntegrationsHrisRequest {
	...
	public PutWorkforcemanagementAgentIntegrationsHrisRequest withAgentId(String agentId) {
	    this.setAgentId(agentId);
	    return this;
	} 

	private AgentIntegrationsRequest body;
	public AgentIntegrationsRequest getBody() {
		return this.body;
	}

	public void setBody(AgentIntegrationsRequest body) {
		this.body = body;
	}

	public PutWorkforcemanagementAgentIntegrationsHrisRequest withBody(AgentIntegrationsRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public ApiRequest<AgentIntegrationsRequest> withHttpInfo() {
        
        // verify the required parameter 'agentId' is set
        if (this.agentId == null) {
            throw new IllegalStateException("Missing the required parameter 'agentId' when building request for PutWorkforcemanagementAgentIntegrationsHrisRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutWorkforcemanagementAgentIntegrationsHrisRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/workforcemanagement/agents/{agentId}/integrations/hris")
	...
	public static Builder builder(String agentId, AgentIntegrationsRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PutWorkforcemanagementAgentIntegrationsHrisRequest request;

		private Builder() {
			request = new PutWorkforcemanagementAgentIntegrationsHrisRequest();
		}
		...
		public Builder withBody(AgentIntegrationsRequest body) {
		...
		public Builder withRequiredParams(String agentId, AgentIntegrationsRequest body) {
			request.setAgentId(agentId);
			request.setBody(body);
		...
		public PutWorkforcemanagementAgentIntegrationsHrisRequest build() {
