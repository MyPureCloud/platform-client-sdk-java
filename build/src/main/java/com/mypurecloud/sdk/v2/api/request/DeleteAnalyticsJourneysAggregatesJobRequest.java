...
public class DeleteAnalyticsJourneysAggregatesJobRequest {
	...
	public DeleteAnalyticsJourneysAggregatesJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public DeleteAnalyticsJourneysAggregatesJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for DeleteAnalyticsJourneysAggregatesJobRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/analytics/journeys/aggregates/jobs/{jobId}")
	...
	public static class Builder {
		private final DeleteAnalyticsJourneysAggregatesJobRequest request;

		private Builder() {
			request = new DeleteAnalyticsJourneysAggregatesJobRequest();
		}
		...
		public DeleteAnalyticsJourneysAggregatesJobRequest build() {
