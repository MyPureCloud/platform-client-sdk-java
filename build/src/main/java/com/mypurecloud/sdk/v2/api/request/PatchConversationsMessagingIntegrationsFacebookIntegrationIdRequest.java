...
public class PatchConversationsMessagingIntegrationsFacebookIntegrationIdRequest {
	...
	public PatchConversationsMessagingIntegrationsFacebookIntegrationIdRequest withIntegrationId(String integrationId) {
	    this.setIntegrationId(integrationId);
	    return this;
	} 
	
	private FacebookIntegrationUpdateRequest body;
	public FacebookIntegrationUpdateRequest getBody() {
		return this.body;
	}

	public void setBody(FacebookIntegrationUpdateRequest body) {
		this.body = body;
	}

	public PatchConversationsMessagingIntegrationsFacebookIntegrationIdRequest withBody(FacebookIntegrationUpdateRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchConversationsMessagingIntegrationsFacebookIntegrationIdRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<FacebookIntegrationUpdateRequest> withHttpInfo() {
        
        // verify the required parameter 'integrationId' is set
        if (this.integrationId == null) {
            throw new IllegalStateException("Missing the required parameter 'integrationId' when building request for PatchConversationsMessagingIntegrationsFacebookIntegrationIdRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchConversationsMessagingIntegrationsFacebookIntegrationIdRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/conversations/messaging/integrations/facebook/{integrationId}")
	...
	public static Builder builder(String integrationId, FacebookIntegrationUpdateRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PatchConversationsMessagingIntegrationsFacebookIntegrationIdRequest request;

		private Builder() {
			request = new PatchConversationsMessagingIntegrationsFacebookIntegrationIdRequest();
		}
		...
		public Builder withBody(FacebookIntegrationUpdateRequest body) {
		...
		public Builder withRequiredParams(String integrationId, FacebookIntegrationUpdateRequest body) {
			request.setIntegrationId(integrationId);
						request.setBody(body);
		...
		public PatchConversationsMessagingIntegrationsFacebookIntegrationIdRequest build() {
