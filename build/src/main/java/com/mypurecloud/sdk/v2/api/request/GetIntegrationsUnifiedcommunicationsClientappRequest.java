...
public class GetIntegrationsUnifiedcommunicationsClientappRequest {
	...
	public GetIntegrationsUnifiedcommunicationsClientappRequest withUcIntegrationId(String ucIntegrationId) {
    ...
    public GetIntegrationsUnifiedcommunicationsClientappRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.ucIntegrationId == null) {
            throw new IllegalStateException("Missing the required parameter 'ucIntegrationId' when building request for GetIntegrationsUnifiedcommunicationsClientappRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/integrations/unifiedcommunications/clientapps/{ucIntegrationId}")
	...
	public static Builder builder(String ucIntegrationId) {
	    return new Builder()
	            .withRequiredParams(ucIntegrationId);
	}


	public static class Builder {
		private final GetIntegrationsUnifiedcommunicationsClientappRequest request;

		private Builder() {
			request = new GetIntegrationsUnifiedcommunicationsClientappRequest();
		}
		...
		public Builder withRequiredParams(String ucIntegrationId) {
			request.setUcIntegrationId(ucIntegrationId);
		...
		public GetIntegrationsUnifiedcommunicationsClientappRequest build() {
