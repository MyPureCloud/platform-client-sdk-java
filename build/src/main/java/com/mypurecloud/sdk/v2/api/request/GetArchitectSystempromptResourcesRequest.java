...
public class GetArchitectSystempromptResourcesRequest {
	...
	public GetArchitectSystempromptResourcesRequest withPromptId(String promptId) {
	...
	public GetArchitectSystempromptResourcesRequest withPageNumber(Integer pageNumber) {
	...
	public GetArchitectSystempromptResourcesRequest withPageSize(Integer pageSize) {
	...
	public GetArchitectSystempromptResourcesRequest withSortBy(String sortBy) {
	...
	public GetArchitectSystempromptResourcesRequest withSortOrder(String sortOrder) {
    ...
    public GetArchitectSystempromptResourcesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/architect/systemprompts/{promptId}/resources")
