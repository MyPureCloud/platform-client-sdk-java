...
public class PostAnalyticsAgentcopilotsAggregatesJobsRequest {

	private AgentCopilotAsyncAggregationQuery body;
	public AgentCopilotAsyncAggregationQuery getBody() {
		return this.body;
	}

	public void setBody(AgentCopilotAsyncAggregationQuery body) {
		this.body = body;
	}

	public PostAnalyticsAgentcopilotsAggregatesJobsRequest withBody(AgentCopilotAsyncAggregationQuery body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostAnalyticsAgentcopilotsAggregatesJobsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<AgentCopilotAsyncAggregationQuery> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostAnalyticsAgentcopilotsAggregatesJobsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/analytics/agentcopilots/aggregates/jobs")
                .withBody(body)
	...
	public static Builder builder(AgentCopilotAsyncAggregationQuery body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostAnalyticsAgentcopilotsAggregatesJobsRequest request;

		private Builder() {
			request = new PostAnalyticsAgentcopilotsAggregatesJobsRequest();
		}


		public Builder withBody(AgentCopilotAsyncAggregationQuery body) {
		...
		public Builder withRequiredParams(AgentCopilotAsyncAggregationQuery body) {
			request.setBody(body);
		...
		public PostAnalyticsAgentcopilotsAggregatesJobsRequest build() {
