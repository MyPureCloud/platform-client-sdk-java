...
public class PostConversationsMessageCommunicationSocialmediaMessagesRequest {
	...
	public PostConversationsMessageCommunicationSocialmediaMessagesRequest withConversationId(String conversationId) {
	...
	public PostConversationsMessageCommunicationSocialmediaMessagesRequest withCommunicationId(String communicationId) {
	    this.setCommunicationId(communicationId);
	    return this;
	} 

	private AdditionalSocialMediaMessage body;
	public AdditionalSocialMediaMessage getBody() {
		return this.body;
	}

	public void setBody(AdditionalSocialMediaMessage body) {
		this.body = body;
	}

	public PostConversationsMessageCommunicationSocialmediaMessagesRequest withBody(AdditionalSocialMediaMessage body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostConversationsMessageCommunicationSocialmediaMessagesRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<AdditionalSocialMediaMessage> withHttpInfo() {
        
        // verify the required parameter 'conversationId' is set
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PostConversationsMessageCommunicationSocialmediaMessagesRequest.");
        }
        
        // verify the required parameter 'communicationId' is set
        if (this.communicationId == null) {
            throw new IllegalStateException("Missing the required parameter 'communicationId' when building request for PostConversationsMessageCommunicationSocialmediaMessagesRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostConversationsMessageCommunicationSocialmediaMessagesRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/conversations/messages/{conversationId}/communications/{communicationId}/socialmedia/messages")
	...
	public static Builder builder(String conversationId, String communicationId, AdditionalSocialMediaMessage body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostConversationsMessageCommunicationSocialmediaMessagesRequest request;

		private Builder() {
			request = new PostConversationsMessageCommunicationSocialmediaMessagesRequest();
		}
		...
		public Builder withBody(AdditionalSocialMediaMessage body) {
		...
		public Builder withRequiredParams(String conversationId, String communicationId, AdditionalSocialMediaMessage body) {
			request.setConversationId(conversationId);
			request.setCommunicationId(communicationId);
			request.setBody(body);
		...
		public PostConversationsMessageCommunicationSocialmediaMessagesRequest build() {
