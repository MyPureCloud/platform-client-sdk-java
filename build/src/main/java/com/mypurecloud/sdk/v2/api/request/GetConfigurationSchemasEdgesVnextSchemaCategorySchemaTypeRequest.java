...
public class GetConfigurationSchemasEdgesVnextSchemaCategorySchemaTypeRequest {
    ...
    public GetConfigurationSchemasEdgesVnextSchemaCategorySchemaTypeRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/configuration/schemas/edges/vnext/{schemaCategory}/{schemaType}")
