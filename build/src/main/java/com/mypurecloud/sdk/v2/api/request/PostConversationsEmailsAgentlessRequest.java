...
public class PostConversationsEmailsAgentlessRequest {

	private AgentlessEmailSendRequestDto body;
	public AgentlessEmailSendRequestDto getBody() {
		return this.body;
	}

	public void setBody(AgentlessEmailSendRequestDto body) {
		this.body = body;
	}

	public PostConversationsEmailsAgentlessRequest withBody(AgentlessEmailSendRequestDto body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostConversationsEmailsAgentlessRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<AgentlessEmailSendRequestDto> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostConversationsEmailsAgentlessRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/conversations/emails/agentless")
                .withBody(body)
	...
	public static Builder builder(AgentlessEmailSendRequestDto body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostConversationsEmailsAgentlessRequest request;

		private Builder() {
			request = new PostConversationsEmailsAgentlessRequest();
		}


		public Builder withBody(AgentlessEmailSendRequestDto body) {
		...
		public Builder withRequiredParams(AgentlessEmailSendRequestDto body) {
			request.setBody(body);
		...
		public PostConversationsEmailsAgentlessRequest build() {
