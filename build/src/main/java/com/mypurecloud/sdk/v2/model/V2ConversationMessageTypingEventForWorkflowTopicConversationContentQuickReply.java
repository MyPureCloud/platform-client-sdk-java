...
public class V2ConversationMessageTypingEventForWorkflowTopicConversationContentQuickReply  implements Serializable {
 ...
 @JsonDeserialize(using = ActionEnumDeserializer.class)
  ...
  /**
   **/
  public V2ConversationMessageTypingEventForWorkflowTopicConversationContentQuickReply text(String text) {
    this.text = text;
    return this;
  }
