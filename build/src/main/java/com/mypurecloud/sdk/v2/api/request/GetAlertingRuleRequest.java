...
public class GetAlertingRuleRequest {
	...
	public GetAlertingRuleRequest withRuleId(String ruleId) {
    ...
    public GetAlertingRuleRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.ruleId == null) {
            throw new IllegalStateException("Missing the required parameter 'ruleId' when building request for GetAlertingRuleRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/alerting/rules/{ruleId}")
	...
	public static class Builder {
		private final GetAlertingRuleRequest request;

		private Builder() {
			request = new GetAlertingRuleRequest();
		}
		...
		public GetAlertingRuleRequest build() {
