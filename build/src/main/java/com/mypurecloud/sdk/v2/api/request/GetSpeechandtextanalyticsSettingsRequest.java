...
public class GetSpeechandtextanalyticsSettingsRequest {
    ...
    public GetSpeechandtextanalyticsSettingsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/speechandtextanalytics/settings")
	...
	public static class Builder {
		private final GetSpeechandtextanalyticsSettingsRequest request;

		private Builder() {
			request = new GetSpeechandtextanalyticsSettingsRequest();
		}
		...
		public GetSpeechandtextanalyticsSettingsRequest build() {
