...
public class PostExternalcontactsImportJobsRequest {

	private ContactImportJobRequest body;
	public ContactImportJobRequest getBody() {
		return this.body;
	}

	public void setBody(ContactImportJobRequest body) {
		this.body = body;
	}

	public PostExternalcontactsImportJobsRequest withBody(ContactImportJobRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostExternalcontactsImportJobsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<ContactImportJobRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostExternalcontactsImportJobsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/externalcontacts/import/jobs")
                .withBody(body)
	...
	public static Builder builder(ContactImportJobRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostExternalcontactsImportJobsRequest request;

		private Builder() {
			request = new PostExternalcontactsImportJobsRequest();
		}


		public Builder withBody(ContactImportJobRequest body) {
		...
		public Builder withRequiredParams(ContactImportJobRequest body) {
			request.setBody(body);
		...
		public PostExternalcontactsImportJobsRequest build() {
