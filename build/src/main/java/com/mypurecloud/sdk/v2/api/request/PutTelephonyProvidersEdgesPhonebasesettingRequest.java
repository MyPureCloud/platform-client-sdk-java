...
public class PutTelephonyProvidersEdgesPhonebasesettingRequest {
	...
	public PutTelephonyProvidersEdgesPhonebasesettingRequest withPhoneBaseId(String phoneBaseId) {
	...
	public void setBody(PhoneBase body) {
		this.body = body;
	}

	public PutTelephonyProvidersEdgesPhonebasesettingRequest withBody(PhoneBase body) {
	    this.setBody(body);
	    return this;
	}
    ...
    public PutTelephonyProvidersEdgesPhonebasesettingRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<PhoneBase> withHttpInfo() throws ApiException {
        
        // verify the required parameter 'phoneBaseId' is set
        if (this.phoneBaseId == null) {
            throw new ApiException(400, "Missing the required parameter 'phoneBaseId' when building request for PutTelephonyProvidersEdgesPhonebasesettingRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new ApiException(400, "Missing the required parameter 'body' when building request for PutTelephonyProvidersEdgesPhonebasesettingRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/telephony/providers/edges/phonebasesettings/{phoneBaseId}")
