...
public class PostConversationsCallParticipantConsultAgentRequest {
    ...
    public ApiRequest<ConsultTransferToAgent> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("POST", "/api/v2/conversations/calls/{conversationId}/participants/{participantId}/consult/agent")
	...
	public static class Builder {
		private final PostConversationsCallParticipantConsultAgentRequest request;

		private Builder() {
			request = new PostConversationsCallParticipantConsultAgentRequest();
		}
