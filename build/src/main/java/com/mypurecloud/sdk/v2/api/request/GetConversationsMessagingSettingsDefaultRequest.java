...
public class GetConversationsMessagingSettingsDefaultRequest {
    ...
    public GetConversationsMessagingSettingsDefaultRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/conversations/messaging/settings/default")
	...
	public static class Builder {
		private final GetConversationsMessagingSettingsDefaultRequest request;

		private Builder() {
			request = new GetConversationsMessagingSettingsDefaultRequest();
		}
		...
		public GetConversationsMessagingSettingsDefaultRequest build() {
