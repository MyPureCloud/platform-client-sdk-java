...
public class GetAnalyticsUsersAggregatesJobResultsRequest {
	...
	public GetAnalyticsUsersAggregatesJobResultsRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
	...
	public GetAnalyticsUsersAggregatesJobResultsRequest withCursor(String cursor) {
    ...
    public GetAnalyticsUsersAggregatesJobResultsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetAnalyticsUsersAggregatesJobResultsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/analytics/users/aggregates/jobs/{jobId}/results")
	...
	public static class Builder {
		private final GetAnalyticsUsersAggregatesJobResultsRequest request;

		private Builder() {
			request = new GetAnalyticsUsersAggregatesJobResultsRequest();
		}
		...
		public GetAnalyticsUsersAggregatesJobResultsRequest build() {
