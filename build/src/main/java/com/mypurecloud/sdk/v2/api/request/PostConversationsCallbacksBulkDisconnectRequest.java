...
public class PostConversationsCallbacksBulkDisconnectRequest {
    
	private BulkCallbackDisconnectRequest body;
	public BulkCallbackDisconnectRequest getBody() {
		return this.body;
	}

	public void setBody(BulkCallbackDisconnectRequest body) {
		this.body = body;
	}

	public PostConversationsCallbacksBulkDisconnectRequest withBody(BulkCallbackDisconnectRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostConversationsCallbacksBulkDisconnectRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<BulkCallbackDisconnectRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostConversationsCallbacksBulkDisconnectRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/conversations/callbacks/bulk/disconnect")
                .withBody(body)
	...
	public static Builder builder(BulkCallbackDisconnectRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostConversationsCallbacksBulkDisconnectRequest request;

		private Builder() {
			request = new PostConversationsCallbacksBulkDisconnectRequest();
		}

		
		public Builder withBody(BulkCallbackDisconnectRequest body) {
		...
		public Builder withRequiredParams(BulkCallbackDisconnectRequest body) {
			request.setBody(body);
		...
		public PostConversationsCallbacksBulkDisconnectRequest build() {
