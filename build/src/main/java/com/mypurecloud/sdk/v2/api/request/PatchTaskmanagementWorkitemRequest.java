...
public class PatchTaskmanagementWorkitemRequest {
	...
	public PatchTaskmanagementWorkitemRequest withWorkitemId(String workitemId) {
	    this.setWorkitemId(workitemId);
	    return this;
	} 

	private WorkitemUpdate body;
	public WorkitemUpdate getBody() {
		return this.body;
	}

	public void setBody(WorkitemUpdate body) {
		this.body = body;
	}

	public PatchTaskmanagementWorkitemRequest withBody(WorkitemUpdate body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchTaskmanagementWorkitemRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<WorkitemUpdate> withHttpInfo() {
        
        // verify the required parameter 'workitemId' is set
        if (this.workitemId == null) {
            throw new IllegalStateException("Missing the required parameter 'workitemId' when building request for PatchTaskmanagementWorkitemRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchTaskmanagementWorkitemRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/taskmanagement/workitems/{workitemId}")
	...
	public static Builder builder(String workitemId, WorkitemUpdate body) {
	    return new Builder()
	...
	public static class Builder {
		private final PatchTaskmanagementWorkitemRequest request;

		private Builder() {
			request = new PatchTaskmanagementWorkitemRequest();
		}
		...
		public Builder withBody(WorkitemUpdate body) {
		...
		public Builder withRequiredParams(String workitemId, WorkitemUpdate body) {
			request.setWorkitemId(workitemId);
			request.setBody(body);
		...
		public PatchTaskmanagementWorkitemRequest build() {
