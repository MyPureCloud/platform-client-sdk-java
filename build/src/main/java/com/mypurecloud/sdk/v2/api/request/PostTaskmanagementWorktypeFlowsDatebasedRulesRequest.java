...
public class PostTaskmanagementWorktypeFlowsDatebasedRulesRequest {
	...
	public PostTaskmanagementWorktypeFlowsDatebasedRulesRequest withWorktypeId(String worktypeId) {
	    this.setWorktypeId(worktypeId);
	    return this;
	} 

	private WorkitemDateBasedRuleCreate body;
	public WorkitemDateBasedRuleCreate getBody() {
		return this.body;
	}

	public void setBody(WorkitemDateBasedRuleCreate body) {
		this.body = body;
	}

	public PostTaskmanagementWorktypeFlowsDatebasedRulesRequest withBody(WorkitemDateBasedRuleCreate body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostTaskmanagementWorktypeFlowsDatebasedRulesRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<WorkitemDateBasedRuleCreate> withHttpInfo() {
        
        // verify the required parameter 'worktypeId' is set
        if (this.worktypeId == null) {
            throw new IllegalStateException("Missing the required parameter 'worktypeId' when building request for PostTaskmanagementWorktypeFlowsDatebasedRulesRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostTaskmanagementWorktypeFlowsDatebasedRulesRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/taskmanagement/worktypes/{worktypeId}/flows/datebased/rules")
	...
	public static Builder builder(String worktypeId, WorkitemDateBasedRuleCreate body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostTaskmanagementWorktypeFlowsDatebasedRulesRequest request;

		private Builder() {
			request = new PostTaskmanagementWorktypeFlowsDatebasedRulesRequest();
		}
		...
		public Builder withBody(WorkitemDateBasedRuleCreate body) {
		...
		public Builder withRequiredParams(String worktypeId, WorkitemDateBasedRuleCreate body) {
			request.setWorktypeId(worktypeId);
			request.setBody(body);
		...
		public PostTaskmanagementWorktypeFlowsDatebasedRulesRequest build() {
