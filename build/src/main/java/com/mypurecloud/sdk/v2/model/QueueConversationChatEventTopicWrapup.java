...
public class QueueConversationChatEventTopicWrapup  implements Serializable {
  ...
  public QueueConversationChatEventTopicWrapup() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
      tags = new ArrayList<String>();
    }
  }

  public QueueConversationChatEventTopicWrapup(Boolean initWithEmptyList) {
   ...
   **/
  public QueueConversationChatEventTopicWrapup durationSeconds(Long durationSeconds) {
