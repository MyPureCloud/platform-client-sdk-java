...
public class GetAnalyticsReportingSchedulesRequest {
	...
	public GetAnalyticsReportingSchedulesRequest withPageNumber(Integer pageNumber) {
	...
	public GetAnalyticsReportingSchedulesRequest withPageSize(Integer pageSize) {
    ...
    public GetAnalyticsReportingSchedulesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/analytics/reporting/schedules")
