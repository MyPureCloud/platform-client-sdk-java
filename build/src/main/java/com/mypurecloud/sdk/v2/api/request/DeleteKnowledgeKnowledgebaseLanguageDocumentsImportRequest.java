...
public class DeleteKnowledgeKnowledgebaseLanguageDocumentsImportRequest {
	...
	public static class Builder {
		private final DeleteKnowledgeKnowledgebaseLanguageDocumentsImportRequest request;

		private Builder() {
			request = new DeleteKnowledgeKnowledgebaseLanguageDocumentsImportRequest();
		}
