...
public class DeleteKnowledgeSourceSynchronizationUploadRequest {
	...
	public DeleteKnowledgeSourceSynchronizationUploadRequest withSourceId(String sourceId) {
	...
	public DeleteKnowledgeSourceSynchronizationUploadRequest withSynchronizationId(String synchronizationId) {
	...
	public DeleteKnowledgeSourceSynchronizationUploadRequest withFileId(String fileId) {
    ...
    public DeleteKnowledgeSourceSynchronizationUploadRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.sourceId == null) {
            throw new IllegalStateException("Missing the required parameter 'sourceId' when building request for DeleteKnowledgeSourceSynchronizationUploadRequest.");
        }
        
        // verify the required parameter 'synchronizationId' is set
        if (this.synchronizationId == null) {
            throw new IllegalStateException("Missing the required parameter 'synchronizationId' when building request for DeleteKnowledgeSourceSynchronizationUploadRequest.");
        }
        
        // verify the required parameter 'fileId' is set
        if (this.fileId == null) {
            throw new IllegalStateException("Missing the required parameter 'fileId' when building request for DeleteKnowledgeSourceSynchronizationUploadRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/knowledge/sources/{sourceId}/synchronizations/{synchronizationId}/uploads/{fileId}")
	...
	public static class Builder {
		private final DeleteKnowledgeSourceSynchronizationUploadRequest request;

		private Builder() {
			request = new DeleteKnowledgeSourceSynchronizationUploadRequest();
		}
		...
		public DeleteKnowledgeSourceSynchronizationUploadRequest build() {
