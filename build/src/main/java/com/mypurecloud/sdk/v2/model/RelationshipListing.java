...
public class RelationshipListing  implements Serializable, PagedResource<Relationship> {
  ...
  /**
   **/
  public RelationshipListing entities(List<Relationship> entities) {
  ...
  public void setEntities(List<Relationship> entities) {
    this.entities = entities;
  }
  ...
  /**
   **/
  public RelationshipListing pageSize(Integer pageSize) {
  ...
  /**
   **/
  public RelationshipListing pageNumber(Integer pageNumber) {
  ...
  /**
   **/
  public RelationshipListing total(Long total) {
    this.total = total;
    return this;
  }
  ...
  /**
   **/
  public RelationshipListing partialResults(Boolean partialResults) {
  ...
  /**
   **/
  public RelationshipListing nextUri(String nextUri) {
  ...
  /**
   **/
  public RelationshipListing pageCount(Integer pageCount) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RelationshipListing relationshipListing = (RelationshipListing) o;

    return Objects.equals(this.entities, relationshipListing.entities) &&
            Objects.equals(this.pageSize, relationshipListing.pageSize) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(entities, pageSize, pageNumber, total, partialResults, previousUri, nextUri, lastUri, firstUri, selfUri, pageCount);
  }
