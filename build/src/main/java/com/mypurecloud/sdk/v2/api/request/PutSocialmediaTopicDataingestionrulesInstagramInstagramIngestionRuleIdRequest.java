...
public class PutSocialmediaTopicDataingestionrulesInstagramInstagramIngestionRuleIdRequest {
	...
	public PutSocialmediaTopicDataingestionrulesInstagramInstagramIngestionRuleIdRequest withTopicId(String topicId) {
	...
	public PutSocialmediaTopicDataingestionrulesInstagramInstagramIngestionRuleIdRequest withInstagramIngestionRuleId(String instagramIngestionRuleId) {
	...
	public PutSocialmediaTopicDataingestionrulesInstagramInstagramIngestionRuleIdRequest withBody(InstagramDataIngestionRuleRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutSocialmediaTopicDataingestionrulesInstagramInstagramIngestionRuleIdRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<InstagramDataIngestionRuleRequest> withHttpInfo() {
        ...
        if (this.topicId == null) {
            throw new IllegalStateException("Missing the required parameter 'topicId' when building request for PutSocialmediaTopicDataingestionrulesInstagramInstagramIngestionRuleIdRequest.");
        }
        
        // verify the required parameter 'instagramIngestionRuleId' is set
        if (this.instagramIngestionRuleId == null) {
            throw new IllegalStateException("Missing the required parameter 'instagramIngestionRuleId' when building request for PutSocialmediaTopicDataingestionrulesInstagramInstagramIngestionRuleIdRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/socialmedia/topics/{topicId}/dataingestionrules/instagram/{instagramIngestionRuleId}")
	...
	public static class Builder {
		private final PutSocialmediaTopicDataingestionrulesInstagramInstagramIngestionRuleIdRequest request;

		private Builder() {
			request = new PutSocialmediaTopicDataingestionrulesInstagramInstagramIngestionRuleIdRequest();
		}
		...
		public PutSocialmediaTopicDataingestionrulesInstagramInstagramIngestionRuleIdRequest build() {
