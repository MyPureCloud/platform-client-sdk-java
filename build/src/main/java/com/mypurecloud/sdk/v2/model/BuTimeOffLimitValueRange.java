...
public class BuTimeOffLimitValueRange  implements Serializable {
 ...
 @JsonDeserialize(using = GranularityEnumDeserializer.class)
   ...
   **/
  public BuTimeOffLimitValueRange id(String id) {
    this.id = id;
    return this;
  }
   ...
   **/
  public BuTimeOffLimitValueRange timeOffLimit(BuTimeOffLimitReference timeOffLimit) {
   ...
   **/
  public BuTimeOffLimitValueRange startDate(LocalDate startDate) {
   ...
   * Granularity choice for time-off limit
   **/
  public BuTimeOffLimitValueRange granularity(GranularityEnum granularity) {
   ...
   **/
  public BuTimeOffLimitValueRange limitMinutesPerInterval(List<Integer> limitMinutesPerInterval) {
    this.limitMinutesPerInterval = limitMinutesPerInterval;
    return this;
  }
  
  @ApiModelProperty(example = "null", required = true, value = "A list of time-off limit values in minutes per granularity interval")
   ...
   **/
  public BuTimeOffLimitValueRange allocatedMinutesPerInterval(List<Integer> allocatedMinutesPerInterval) {
    this.allocatedMinutesPerInterval = allocatedMinutesPerInterval;
    return this;
  }
  
  @ApiModelProperty(example = "null", required = true, value = "A list of allocated time-off minutes per granularity interval")
   ...
   **/
  public BuTimeOffLimitValueRange waitlistedMinutesPerInterval(List<Integer> waitlistedMinutesPerInterval) {
    this.waitlistedMinutesPerInterval = waitlistedMinutesPerInterval;
    return this;
  }
  
  @ApiModelProperty(example = "null", required = true, value = "A list of waitlisted time-off minutes per granularity interval")
   ...
   **/
  public BuTimeOffLimitValueRange waitlistedRequestsPerInterval(List<Integer> waitlistedRequestsPerInterval) {
    this.waitlistedRequestsPerInterval = waitlistedRequestsPerInterval;
    return this;
  }
  
  @ApiModelProperty(example = "null", required = true, value = "The current number of waitlisted time-off requests for every interval per granularity")
   ...
   **/
  public BuTimeOffLimitValueRange metadata(WfmVersionedEntityMetadata metadata) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    BuTimeOffLimitValueRange buTimeOffLimitValueRange = (BuTimeOffLimitValueRange) o;

    return Objects.equals(this.id, buTimeOffLimitValueRange.id) &&
            Objects.equals(this.timeOffLimit, buTimeOffLimitValueRange.timeOffLimit) &&
            Objects.equals(this.startDate, buTimeOffLimitValueRange.startDate) &&
            Objects.equals(this.granularity, buTimeOffLimitValueRange.granularity) &&
            Objects.equals(this.limitMinutesPerInterval, buTimeOffLimitValueRange.limitMinutesPerInterval) &&
            Objects.equals(this.allocatedMinutesPerInterval, buTimeOffLimitValueRange.allocatedMinutesPerInterval) &&
            Objects.equals(this.waitlistedMinutesPerInterval, buTimeOffLimitValueRange.waitlistedMinutesPerInterval) &&
            Objects.equals(this.waitlistedRequestsPerInterval, buTimeOffLimitValueRange.waitlistedRequestsPerInterval) &&
            Objects.equals(this.metadata, buTimeOffLimitValueRange.metadata) &&
            Objects.equals(this.selfUri, buTimeOffLimitValueRange.selfUri);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, timeOffLimit, startDate, granularity, limitMinutesPerInterval, allocatedMinutesPerInterval, waitlistedMinutesPerInterval, waitlistedRequestsPerInterval, metadata, selfUri);
  }
