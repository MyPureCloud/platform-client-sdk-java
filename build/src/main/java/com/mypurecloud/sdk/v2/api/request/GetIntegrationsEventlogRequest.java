...
public class GetIntegrationsEventlogRequest {
	...
	public GetIntegrationsEventlogRequest withPageSize(Integer pageSize) {
	...
	public GetIntegrationsEventlogRequest withPageNumber(Integer pageNumber) {
	...
	public GetIntegrationsEventlogRequest withSortBy(String sortBy) {
	...
	public GetIntegrationsEventlogRequest withSortOrder(String sortOrder) {
	...
	public GetIntegrationsEventlogRequest withEntityId(String entityId) {
    ...
    public GetIntegrationsEventlogRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/integrations/eventlog")
	...
	public static class Builder {
		private final GetIntegrationsEventlogRequest request;

		private Builder() {
			request = new GetIntegrationsEventlogRequest();
		}
		...
		public GetIntegrationsEventlogRequest build() {
