...
public class GetJourneySegmentRequest {
	...
	public GetJourneySegmentRequest withSegmentId(String segmentId) {
    ...
    public GetJourneySegmentRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.segmentId == null) {
            throw new IllegalStateException("Missing the required parameter 'segmentId' when building request for GetJourneySegmentRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/journey/segments/{segmentId}")
	...
	public static class Builder {
		private final GetJourneySegmentRequest request;

		private Builder() {
			request = new GetJourneySegmentRequest();
		}
		...
		public GetJourneySegmentRequest build() {
