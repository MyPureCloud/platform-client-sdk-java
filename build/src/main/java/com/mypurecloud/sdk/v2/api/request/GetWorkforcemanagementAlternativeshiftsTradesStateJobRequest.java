...
public class GetWorkforcemanagementAlternativeshiftsTradesStateJobRequest {
	...
	public GetWorkforcemanagementAlternativeshiftsTradesStateJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetWorkforcemanagementAlternativeshiftsTradesStateJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetWorkforcemanagementAlternativeshiftsTradesStateJobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/alternativeshifts/trades/state/jobs/{jobId}")
	...
	public static class Builder {
		private final GetWorkforcemanagementAlternativeshiftsTradesStateJobRequest request;

		private Builder() {
			request = new GetWorkforcemanagementAlternativeshiftsTradesStateJobRequest();
		}
		...
		public GetWorkforcemanagementAlternativeshiftsTradesStateJobRequest build() {
