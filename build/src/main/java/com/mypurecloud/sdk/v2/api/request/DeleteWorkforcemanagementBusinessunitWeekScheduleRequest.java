...
public class DeleteWorkforcemanagementBusinessunitWeekScheduleRequest {
	...
	public DeleteWorkforcemanagementBusinessunitWeekScheduleRequest withBusinessUnitId(String businessUnitId) {
	...
	public DeleteWorkforcemanagementBusinessunitWeekScheduleRequest withWeekId(LocalDate weekId) {
	...
	public DeleteWorkforcemanagementBusinessunitWeekScheduleRequest withScheduleId(String scheduleId) {
    ...
    public DeleteWorkforcemanagementBusinessunitWeekScheduleRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for DeleteWorkforcemanagementBusinessunitWeekScheduleRequest.");
        }
        
        // verify the required parameter 'weekId' is set
        if (this.weekId == null) {
            throw new IllegalStateException("Missing the required parameter 'weekId' when building request for DeleteWorkforcemanagementBusinessunitWeekScheduleRequest.");
        }
        
        // verify the required parameter 'scheduleId' is set
        if (this.scheduleId == null) {
            throw new IllegalStateException("Missing the required parameter 'scheduleId' when building request for DeleteWorkforcemanagementBusinessunitWeekScheduleRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/weeks/{weekId}/schedules/{scheduleId}")
	...
	public static class Builder {
		private final DeleteWorkforcemanagementBusinessunitWeekScheduleRequest request;

		private Builder() {
			request = new DeleteWorkforcemanagementBusinessunitWeekScheduleRequest();
		}
		...
		public DeleteWorkforcemanagementBusinessunitWeekScheduleRequest build() {
