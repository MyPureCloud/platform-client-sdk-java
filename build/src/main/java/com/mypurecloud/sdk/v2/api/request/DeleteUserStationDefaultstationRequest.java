...
public class DeleteUserStationDefaultstationRequest {
	...
	public DeleteUserStationDefaultstationRequest withUserId(String userId) {
    ...
    public DeleteUserStationDefaultstationRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.userId == null) {
            throw new IllegalStateException("Missing the required parameter 'userId' when building request for DeleteUserStationDefaultstationRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/users/{userId}/station/defaultstation")
	...
	public static class Builder {
		private final DeleteUserStationDefaultstationRequest request;

		private Builder() {
			request = new DeleteUserStationDefaultstationRequest();
		}
		...
		public DeleteUserStationDefaultstationRequest build() {
