...
public class PatchRoutingSmsPhonenumberRequest {
	...
	public PatchRoutingSmsPhonenumberRequest withPhoneNumberId(String phoneNumberId) {
	    this.setPhoneNumberId(phoneNumberId);
	    return this;
	} 

	private SmsPhoneNumberPatchRequest body;
	public SmsPhoneNumberPatchRequest getBody() {
		return this.body;
	}

	public void setBody(SmsPhoneNumberPatchRequest body) {
		this.body = body;
	}

	public PatchRoutingSmsPhonenumberRequest withBody(SmsPhoneNumberPatchRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchRoutingSmsPhonenumberRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<SmsPhoneNumberPatchRequest> withHttpInfo() {
        
        // verify the required parameter 'phoneNumberId' is set
        if (this.phoneNumberId == null) {
            throw new IllegalStateException("Missing the required parameter 'phoneNumberId' when building request for PatchRoutingSmsPhonenumberRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchRoutingSmsPhonenumberRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/routing/sms/phonenumbers/{phoneNumberId}")
	...
	public static Builder builder(String phoneNumberId, SmsPhoneNumberPatchRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PatchRoutingSmsPhonenumberRequest request;

		private Builder() {
			request = new PatchRoutingSmsPhonenumberRequest();
		}
		...
		public Builder withBody(SmsPhoneNumberPatchRequest body) {
		...
		public Builder withRequiredParams(String phoneNumberId, SmsPhoneNumberPatchRequest body) {
			request.setPhoneNumberId(phoneNumberId);
			request.setBody(body);
		...
		public PatchRoutingSmsPhonenumberRequest build() {
