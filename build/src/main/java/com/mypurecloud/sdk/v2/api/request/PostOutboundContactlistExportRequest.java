...
public class PostOutboundContactlistExportRequest {
	...
	public PostOutboundContactlistExportRequest withContactListId(String contactListId) {
    ...
    public PostOutboundContactlistExportRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.contactListId == null) {
            throw new IllegalStateException("Missing the required parameter 'contactListId' when building request for PostOutboundContactlistExportRequest.");
        }
