...
public class GDPRSubjectEntityListing  implements Serializable, PagedResource<GDPRSubject> {
  ...
  public GDPRSubjectEntityListing() {
  ...
  /**
   **/
  public GDPRSubjectEntityListing entities(List<GDPRSubject> entities) {
  ...
  public List<GDPRSubject> getEntities() {
    return entities;
  }
  public void setEntities(List<GDPRSubject> entities) {
    this.entities = entities;
  }
