...
public class GetOutboundCampaignsAllRequest {
	...
	public GetOutboundCampaignsAllRequest withPageSize(Integer pageSize) {
	...
	public GetOutboundCampaignsAllRequest withPageNumber(Integer pageNumber) {
	...
	public GetOutboundCampaignsAllRequest withId(List<String> id) {
	    this.setId(id);
	    return this;
	} 
	...
	public GetOutboundCampaignsAllRequest withName(String name) {
	    this.setName(name);
	    return this;
	} 
	...
	public GetOutboundCampaignsAllRequest withDivisionId(List<String> divisionId) {
	...
	public GetOutboundCampaignsAllRequest withMediaType(List<String> mediaType) {
	...
	public GetOutboundCampaignsAllRequest withSortOrder(String sortOrder) {
    ...
    public GetOutboundCampaignsAllRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/outbound/campaigns/all")
	...
	public static class Builder {
		private final GetOutboundCampaignsAllRequest request;

		private Builder() {
			request = new GetOutboundCampaignsAllRequest();
		}
		...
		public GetOutboundCampaignsAllRequest build() {
