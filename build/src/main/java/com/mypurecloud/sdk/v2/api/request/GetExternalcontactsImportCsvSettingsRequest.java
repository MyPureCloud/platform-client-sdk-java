...
public class GetExternalcontactsImportCsvSettingsRequest {
	...
	public GetExternalcontactsImportCsvSettingsRequest withAfter(String after) {
	    this.setAfter(after);
	    return this;
	} 
	...
	public GetExternalcontactsImportCsvSettingsRequest withPageSize(String pageSize) {
	    this.setPageSize(pageSize);
	    return this;
	} 

	private String externalSettingsId;
	public String getExternalSettingsId() {
		return this.externalSettingsId;
	}
	...
	public GetExternalcontactsImportCsvSettingsRequest withExternalSettingsId(String externalSettingsId) {
	    this.setExternalSettingsId(externalSettingsId);
	    return this;
	} 
    ...
    public GetExternalcontactsImportCsvSettingsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/externalcontacts/import/csv/settings")
                ...
                .withQueryParameters("externalSettingsId", "", externalSettingsId)
	...
	public static class Builder {
		private final GetExternalcontactsImportCsvSettingsRequest request;

		private Builder() {
			request = new GetExternalcontactsImportCsvSettingsRequest();
		}
		...
		public Builder withExternalSettingsId(String externalSettingsId) {
			request.setExternalSettingsId(externalSettingsId);
			return this;
		}
		...
		public GetExternalcontactsImportCsvSettingsRequest build() {
