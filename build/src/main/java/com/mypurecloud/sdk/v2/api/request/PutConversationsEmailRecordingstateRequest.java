...
public class PutConversationsEmailRecordingstateRequest {
	...
	public PutConversationsEmailRecordingstateRequest withConversationId(String conversationId) {
	...
	public PutConversationsEmailRecordingstateRequest withBody(SetRecordingState body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutConversationsEmailRecordingstateRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<SetRecordingState> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PutConversationsEmailRecordingstateRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutConversationsEmailRecordingstateRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/conversations/emails/{conversationId}/recordingstate")
	...
	public static class Builder {
		private final PutConversationsEmailRecordingstateRequest request;

		private Builder() {
			request = new PutConversationsEmailRecordingstateRequest();
		}
		...
		public PutConversationsEmailRecordingstateRequest build() {
