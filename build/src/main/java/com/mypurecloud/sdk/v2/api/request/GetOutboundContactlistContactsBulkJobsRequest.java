...
public class GetOutboundContactlistContactsBulkJobsRequest {
	...
	public GetOutboundContactlistContactsBulkJobsRequest withContactListId(String contactListId) {
    ...
    public GetOutboundContactlistContactsBulkJobsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.contactListId == null) {
            throw new IllegalStateException("Missing the required parameter 'contactListId' when building request for GetOutboundContactlistContactsBulkJobsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/outbound/contactlists/{contactListId}/contacts/bulk/jobs")
	...
	public static class Builder {
		private final GetOutboundContactlistContactsBulkJobsRequest request;

		private Builder() {
			request = new GetOutboundContactlistContactsBulkJobsRequest();
		}
		...
		public GetOutboundContactlistContactsBulkJobsRequest build() {
