...
public class DirectoryUserDevicesListing  implements Serializable, PagedResource<UserDevice> {
  ...
  /**
   **/
  public DirectoryUserDevicesListing entities(List<UserDevice> entities) {
  ...
  public List<UserDevice> getEntities() {
    return entities;
  }
  public void setEntities(List<UserDevice> entities) {
    this.entities = entities;
  }
