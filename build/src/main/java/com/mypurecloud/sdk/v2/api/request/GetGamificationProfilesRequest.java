...
public class GetGamificationProfilesRequest {
    ...
    public GetGamificationProfilesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/gamification/profiles")
	...
	public static class Builder {
		private final GetGamificationProfilesRequest request;

		private Builder() {
			request = new GetGamificationProfilesRequest();
		}
		...
		public GetGamificationProfilesRequest build() {
