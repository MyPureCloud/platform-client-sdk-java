...
public class BulkOrganizationsResponse  implements Serializable {
  ...
  private List<BulkResponseResultExternalOrganizationExternalOrganizationBulkEntityErrorExternalOrganization> results = null;
  private Integer errorCount = null;
  private List<Integer> errorIndexes = null;

  public BulkOrganizationsResponse() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
      results = new ArrayList<BulkResponseResultExternalOrganizationExternalOrganizationBulkEntityErrorExternalOrganization>();
      errorIndexes = new ArrayList<Integer>();
    }
  }

  public BulkOrganizationsResponse(Boolean initWithEmptyList) {
