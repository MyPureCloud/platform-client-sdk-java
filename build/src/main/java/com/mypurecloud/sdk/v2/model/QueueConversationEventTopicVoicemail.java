...
public class QueueConversationEventTopicVoicemail  implements Serializable {
 ...
 @JsonDeserialize(using = UploadStatusEnumDeserializer.class)
  ...
  public QueueConversationEventTopicVoicemail() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
    }
  }

  public QueueConversationEventTopicVoicemail(Boolean initWithEmptyList) {
   ...
   * The voicemail id
   **/
  public QueueConversationEventTopicVoicemail id(String id) {
    this.id = id;
    return this;
  }
   ...
   * current state of the voicemail upload
   **/
  public QueueConversationEventTopicVoicemail uploadStatus(UploadStatusEnum uploadStatus) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    QueueConversationEventTopicVoicemail queueConversationEventTopicVoicemail = (QueueConversationEventTopicVoicemail) o;

    return Objects.equals(this.id, queueConversationEventTopicVoicemail.id) &&
            Objects.equals(this.uploadStatus, queueConversationEventTopicVoicemail.uploadStatus);
  }
