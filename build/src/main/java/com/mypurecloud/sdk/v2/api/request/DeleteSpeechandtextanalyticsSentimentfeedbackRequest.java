...
public class DeleteSpeechandtextanalyticsSentimentfeedbackRequest {
    ...
    public DeleteSpeechandtextanalyticsSentimentfeedbackRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("DELETE", "/api/v2/speechandtextanalytics/sentimentfeedback")
	...
	public static class Builder {
		private final DeleteSpeechandtextanalyticsSentimentfeedbackRequest request;

		private Builder() {
			request = new DeleteSpeechandtextanalyticsSentimentfeedbackRequest();
		}
		...
		public DeleteSpeechandtextanalyticsSentimentfeedbackRequest build() {
