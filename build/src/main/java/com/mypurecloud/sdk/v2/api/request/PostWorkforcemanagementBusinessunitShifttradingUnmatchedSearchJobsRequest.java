...
public class PostWorkforcemanagementBusinessunitShifttradingUnmatchedSearchJobsRequest {
	...
	private SearchUnmatchedShiftTradeListJobRequest body;
	public SearchUnmatchedShiftTradeListJobRequest getBody() {
		return this.body;
	}

	public void setBody(SearchUnmatchedShiftTradeListJobRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementBusinessunitShifttradingUnmatchedSearchJobsRequest withBody(SearchUnmatchedShiftTradeListJobRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public ApiRequest<SearchUnmatchedShiftTradeListJobRequest> withHttpInfo() {
        
        // verify the required parameter 'businessUnitId' is set
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PostWorkforcemanagementBusinessunitShifttradingUnmatchedSearchJobsRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementBusinessunitShifttradingUnmatchedSearchJobsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/shifttrading/unmatched/search/jobs")
	...
	public static Builder builder(String businessUnitId, SearchUnmatchedShiftTradeListJobRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementBusinessunitShifttradingUnmatchedSearchJobsRequest request;

		private Builder() {
			request = new PostWorkforcemanagementBusinessunitShifttradingUnmatchedSearchJobsRequest();
		}
		...
		public Builder withBody(SearchUnmatchedShiftTradeListJobRequest body) {
		...
		public Builder withRequiredParams(String businessUnitId, SearchUnmatchedShiftTradeListJobRequest body) {
			request.setBusinessUnitId(businessUnitId);
			request.setBody(body);
		...
		public PostWorkforcemanagementBusinessunitShifttradingUnmatchedSearchJobsRequest build() {
