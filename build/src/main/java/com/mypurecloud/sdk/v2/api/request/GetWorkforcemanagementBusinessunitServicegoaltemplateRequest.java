...
public class GetWorkforcemanagementBusinessunitServicegoaltemplateRequest {
	...
	public GetWorkforcemanagementBusinessunitServicegoaltemplateRequest withServiceGoalTemplateId(String serviceGoalTemplateId) {
	    this.setServiceGoalTemplateId(serviceGoalTemplateId);
	    return this;
	} 
	...
	public GetWorkforcemanagementBusinessunitServicegoaltemplateRequest withExpand(List<String> expand) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for GetWorkforcemanagementBusinessunitServicegoaltemplateRequest.");
        }
        
        // verify the required parameter 'serviceGoalTemplateId' is set
        if (this.serviceGoalTemplateId == null) {
            throw new IllegalStateException("Missing the required parameter 'serviceGoalTemplateId' when building request for GetWorkforcemanagementBusinessunitServicegoaltemplateRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/servicegoaltemplates/{serviceGoalTemplateId}")
                .withPathParameter("businessUnitId", businessUnitId)
        
                .withPathParameter("serviceGoalTemplateId", serviceGoalTemplateId)
	...
	public static class Builder {
		private final GetWorkforcemanagementBusinessunitServicegoaltemplateRequest request;

		private Builder() {
			request = new GetWorkforcemanagementBusinessunitServicegoaltemplateRequest();
		}
		...
		public Builder withServiceGoalTemplateId(String serviceGoalTemplateId) {
		...
		public GetWorkforcemanagementBusinessunitServicegoaltemplateRequest build() {
