...
public class GetConversationsMessagingOauthAppleCallbackRequest {
	...
	public GetConversationsMessagingOauthAppleCallbackRequest withCode(String code) {
	    this.setCode(code);
	    return this;
	} 
	...
	public GetConversationsMessagingOauthAppleCallbackRequest withState(String state) {
	    this.setState(state);
	    return this;
	} 
	...
	public GetConversationsMessagingOauthAppleCallbackRequest withError(String error) {
	    this.setError(error);
	    return this;
	} 
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.code == null) {
            throw new IllegalStateException("Missing the required parameter 'code' when building request for GetConversationsMessagingOauthAppleCallbackRequest.");
        }
        
        // verify the required parameter 'state' is set
        if (this.state == null) {
            throw new IllegalStateException("Missing the required parameter 'state' when building request for GetConversationsMessagingOauthAppleCallbackRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/conversations/messaging/oauth/apple/callback")

                .withQueryParameters("code", "", code)
        

                .withQueryParameters("state", "", state)
        

                .withQueryParameters("error", "", error)
	...
	public static Builder builder(String code, String state) {
	    return new Builder()
	            .withRequiredParams(code, state);
	}


	public static class Builder {
		private final GetConversationsMessagingOauthAppleCallbackRequest request;

		private Builder() {
			request = new GetConversationsMessagingOauthAppleCallbackRequest();
		}
		...
		public Builder withRequiredParams(String code, String state) {
			request.setCode(code);
			request.setState(state);
		...
		public GetConversationsMessagingOauthAppleCallbackRequest build() {
