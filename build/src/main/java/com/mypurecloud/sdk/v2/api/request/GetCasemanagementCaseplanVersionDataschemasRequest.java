...
public class GetCasemanagementCaseplanVersionDataschemasRequest {
	...
	public GetCasemanagementCaseplanVersionDataschemasRequest withCaseplanId(String caseplanId) {
	...
	public GetCasemanagementCaseplanVersionDataschemasRequest withVersionId(String versionId) {
    ...
    public GetCasemanagementCaseplanVersionDataschemasRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.caseplanId == null) {
            throw new IllegalStateException("Missing the required parameter 'caseplanId' when building request for GetCasemanagementCaseplanVersionDataschemasRequest.");
        }
        
        // verify the required parameter 'versionId' is set
        if (this.versionId == null) {
            throw new IllegalStateException("Missing the required parameter 'versionId' when building request for GetCasemanagementCaseplanVersionDataschemasRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/casemanagement/caseplans/{caseplanId}/versions/{versionId}/dataschemas")
	...
	public static class Builder {
		private final GetCasemanagementCaseplanVersionDataschemasRequest request;

		private Builder() {
			request = new GetCasemanagementCaseplanVersionDataschemasRequest();
		}
		...
		public GetCasemanagementCaseplanVersionDataschemasRequest build() {
