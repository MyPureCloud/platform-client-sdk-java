...
public class DeleteRoutingUtilizationLabelRequest {
	...
	public DeleteRoutingUtilizationLabelRequest withLabelId(String labelId) {
	...
	public DeleteRoutingUtilizationLabelRequest withForceDelete(Boolean forceDelete) {
    ...
    public DeleteRoutingUtilizationLabelRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.labelId == null) {
            throw new IllegalStateException("Missing the required parameter 'labelId' when building request for DeleteRoutingUtilizationLabelRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/routing/utilization/labels/{labelId}")
	...
	public static class Builder {
		private final DeleteRoutingUtilizationLabelRequest request;

		private Builder() {
			request = new DeleteRoutingUtilizationLabelRequest();
		}
		...
		public DeleteRoutingUtilizationLabelRequest build() {
