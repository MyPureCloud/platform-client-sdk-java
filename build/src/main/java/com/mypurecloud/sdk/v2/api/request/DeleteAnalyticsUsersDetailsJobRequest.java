...
public class DeleteAnalyticsUsersDetailsJobRequest {
	...
	public DeleteAnalyticsUsersDetailsJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public DeleteAnalyticsUsersDetailsJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for DeleteAnalyticsUsersDetailsJobRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/analytics/users/details/jobs/{jobId}")
	...
	public static class Builder {
		private final DeleteAnalyticsUsersDetailsJobRequest request;

		private Builder() {
			request = new DeleteAnalyticsUsersDetailsJobRequest();
		}
		...
		public DeleteAnalyticsUsersDetailsJobRequest build() {
