...
public class SegmentAssignedEvent  implements Serializable {
   ...
   **/
  public SegmentAssignedEvent segment(JourneySegment segment) {
  ...
  @ApiModelProperty(example = "null", value = "When visit was created (e.g. timestamp of the first event in visit). Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss.SSSZ")
