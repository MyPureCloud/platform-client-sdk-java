...
public class PutConversationsMessagingIdentityresolutionIntegrationsWhatsappIntegrationIdRequest {
	...
	public PutConversationsMessagingIdentityresolutionIntegrationsWhatsappIntegrationIdRequest withIntegrationId(String integrationId) {
	    this.setIntegrationId(integrationId);
	    return this;
	} 

	private WhatsAppIdentityResolutionConfig body;
	public WhatsAppIdentityResolutionConfig getBody() {
		return this.body;
	}

	public void setBody(WhatsAppIdentityResolutionConfig body) {
		this.body = body;
	}

	public PutConversationsMessagingIdentityresolutionIntegrationsWhatsappIntegrationIdRequest withBody(WhatsAppIdentityResolutionConfig body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutConversationsMessagingIdentityresolutionIntegrationsWhatsappIntegrationIdRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<WhatsAppIdentityResolutionConfig> withHttpInfo() {
        
        // verify the required parameter 'integrationId' is set
        if (this.integrationId == null) {
            throw new IllegalStateException("Missing the required parameter 'integrationId' when building request for PutConversationsMessagingIdentityresolutionIntegrationsWhatsappIntegrationIdRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutConversationsMessagingIdentityresolutionIntegrationsWhatsappIntegrationIdRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/conversations/messaging/identityresolution/integrations/whatsapp/{integrationId}")
	...
	public static Builder builder(String integrationId, WhatsAppIdentityResolutionConfig body) {
	    return new Builder()
	...
	public static class Builder {
		private final PutConversationsMessagingIdentityresolutionIntegrationsWhatsappIntegrationIdRequest request;

		private Builder() {
			request = new PutConversationsMessagingIdentityresolutionIntegrationsWhatsappIntegrationIdRequest();
		}
		...
		public Builder withBody(WhatsAppIdentityResolutionConfig body) {
		...
		public Builder withRequiredParams(String integrationId, WhatsAppIdentityResolutionConfig body) {
			request.setIntegrationId(integrationId);
			request.setBody(body);
		...
		public PutConversationsMessagingIdentityresolutionIntegrationsWhatsappIntegrationIdRequest build() {
