...
public class GetAuthorizationSubjectsMeRequest {
    ...
    public GetAuthorizationSubjectsMeRequest withCustomHeader(String name, String value) {
	...
	public static class Builder {
		private final GetAuthorizationSubjectsMeRequest request;
		...
		public GetAuthorizationSubjectsMeRequest build() {
