...
public class FeedbackUpdateRequest  implements Serializable {
 ...
 @JsonDeserialize(using = RatingEnumDeserializer.class)
   ...
   * Agent’s rating for the system-generated summary.
   **/
  public FeedbackUpdateRequest rating(RatingEnum rating) {
    this.rating = rating;
    return this;
  }
   ...
   **/
  public FeedbackUpdateRequest summary(String summary) {
    this.summary = summary;
    return this;
  }
  
  @ApiModelProperty(example = "Customer wants to cancel the ticket and he is happy with the service.", value = "Agent's summary for the conversation")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.rating, feedbackUpdateRequest.rating) &&
            Objects.equals(this.summary, feedbackUpdateRequest.summary);
  }
