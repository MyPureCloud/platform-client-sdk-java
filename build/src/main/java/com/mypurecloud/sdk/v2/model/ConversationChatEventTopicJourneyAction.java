...
public class ConversationChatEventTopicJourneyAction  implements Serializable {
  
  private String id = null;
  private ConversationChatEventTopicJourneyActionMap actionMap = null;

  public ConversationChatEventTopicJourneyAction() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
    }
  }

  public ConversationChatEventTopicJourneyAction(Boolean initWithEmptyList) {
   ...
   **/
  public ConversationChatEventTopicJourneyAction id(String id) {
    this.id = id;
    return this;
  }
  ...
  public ConversationChatEventTopicJourneyActionMap getActionMap() {
    return actionMap;
  }
  public void setActionMap(ConversationChatEventTopicJourneyActionMap actionMap) {
    this.actionMap = actionMap;
  }
