...
public class DeleteUserCustomattributeRequest {
	...
	public DeleteUserCustomattributeRequest withUserId(String userId) {
	...
	public DeleteUserCustomattributeRequest withSchemaId(String schemaId) {
    ...
    public DeleteUserCustomattributeRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.userId == null) {
            throw new IllegalStateException("Missing the required parameter 'userId' when building request for DeleteUserCustomattributeRequest.");
        }
        
        // verify the required parameter 'schemaId' is set
        if (this.schemaId == null) {
            throw new IllegalStateException("Missing the required parameter 'schemaId' when building request for DeleteUserCustomattributeRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/users/{userId}/customattributes/{schemaId}")
	...
	public static Builder builder(String userId, String schemaId) {
	    return new Builder()
	            .withRequiredParams(userId, schemaId);
	}


	public static class Builder {
		private final DeleteUserCustomattributeRequest request;

		private Builder() {
			request = new DeleteUserCustomattributeRequest();
		}
		...
		public Builder withRequiredParams(String userId, String schemaId) {
			request.setUserId(userId);
			request.setSchemaId(schemaId);
		...
		public DeleteUserCustomattributeRequest build() {
