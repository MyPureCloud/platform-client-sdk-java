...
public class GetWorkforcemanagementManagementunitWeekShorttermforecastsRequest {
	...
	public GetWorkforcemanagementManagementunitWeekShorttermforecastsRequest withManagementUnitId(String managementUnitId) {
	...
	public GetWorkforcemanagementManagementunitWeekShorttermforecastsRequest withWeekDateId(String weekDateId) {
    ...
    public GetWorkforcemanagementManagementunitWeekShorttermforecastsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.managementUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'managementUnitId' when building request for GetWorkforcemanagementManagementunitWeekShorttermforecastsRequest.");
        }
        
        // verify the required parameter 'weekDateId' is set
        if (this.weekDateId == null) {
            throw new IllegalStateException("Missing the required parameter 'weekDateId' when building request for GetWorkforcemanagementManagementunitWeekShorttermforecastsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/managementunits/{managementUnitId}/weeks/{weekDateId}/shorttermforecasts")
	...
	public static class Builder {
		private final GetWorkforcemanagementManagementunitWeekShorttermforecastsRequest request;

		private Builder() {
			request = new GetWorkforcemanagementManagementunitWeekShorttermforecastsRequest();
		}
		...
		public GetWorkforcemanagementManagementunitWeekShorttermforecastsRequest build() {
