...
public class PostRecordingKeyconfigurationsValidateRequest {
	...
	public PostRecordingKeyconfigurationsValidateRequest withBody(RecordingEncryptionConfiguration body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostRecordingKeyconfigurationsValidateRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<RecordingEncryptionConfiguration> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostRecordingKeyconfigurationsValidateRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/recording/keyconfigurations/validate")
                .withBody(body)
	...
	public static class Builder {
		private final PostRecordingKeyconfigurationsValidateRequest request;

		private Builder() {
			request = new PostRecordingKeyconfigurationsValidateRequest();
		}
		...
		public PostRecordingKeyconfigurationsValidateRequest build() {
