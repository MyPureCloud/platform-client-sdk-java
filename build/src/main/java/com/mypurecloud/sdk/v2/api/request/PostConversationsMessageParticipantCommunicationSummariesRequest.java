...
public class PostConversationsMessageParticipantCommunicationSummariesRequest {
	...
	public PostConversationsMessageParticipantCommunicationSummariesRequest withConversationId(String conversationId) {
	...
	public PostConversationsMessageParticipantCommunicationSummariesRequest withParticipantId(String participantId) {
	...
	public PostConversationsMessageParticipantCommunicationSummariesRequest withCommunicationId(String communicationId) {
	    this.setCommunicationId(communicationId);
	    return this;
	} 

	private OnDemandConversationSummaryRequest body;
	public OnDemandConversationSummaryRequest getBody() {
		return this.body;
	}

	public void setBody(OnDemandConversationSummaryRequest body) {
		this.body = body;
	}

	public PostConversationsMessageParticipantCommunicationSummariesRequest withBody(OnDemandConversationSummaryRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostConversationsMessageParticipantCommunicationSummariesRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<OnDemandConversationSummaryRequest> withHttpInfo() {
        
        // verify the required parameter 'conversationId' is set
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PostConversationsMessageParticipantCommunicationSummariesRequest.");
        }
        
        // verify the required parameter 'participantId' is set
        if (this.participantId == null) {
            throw new IllegalStateException("Missing the required parameter 'participantId' when building request for PostConversationsMessageParticipantCommunicationSummariesRequest.");
        }
        
        // verify the required parameter 'communicationId' is set
        if (this.communicationId == null) {
            throw new IllegalStateException("Missing the required parameter 'communicationId' when building request for PostConversationsMessageParticipantCommunicationSummariesRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/conversations/messages/{conversationId}/participants/{participantId}/communications/{communicationId}/summaries")
	...
	public static Builder builder(String conversationId, String participantId, String communicationId) {
	    return new Builder()
	            .withRequiredParams(conversationId, participantId, communicationId);
	}


	public static class Builder {
		private final PostConversationsMessageParticipantCommunicationSummariesRequest request;

		private Builder() {
			request = new PostConversationsMessageParticipantCommunicationSummariesRequest();
		}
		...
		public Builder withBody(OnDemandConversationSummaryRequest body) {
		...
		public PostConversationsMessageParticipantCommunicationSummariesRequest build() {
