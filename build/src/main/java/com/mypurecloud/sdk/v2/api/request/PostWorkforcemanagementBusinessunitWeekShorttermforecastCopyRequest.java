...
public class PostWorkforcemanagementBusinessunitWeekShorttermforecastCopyRequest {
	...
	public void setBody(CopyBuForecastRequest body) {
		this.body = body;
	}
    ...
    public ApiRequest<CopyBuForecastRequest> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/weeks/{weekDateId}/shorttermforecasts/{forecastId}/copy")
	...
	public static Builder builder(String businessUnitId, LocalDate weekDateId, String forecastId, CopyBuForecastRequest body) {
	    return new Builder()
	            .withRequiredParams(businessUnitId, weekDateId, forecastId, body);
	}
	...
	public static class Builder {
		...
		private Builder() {
			request = new PostWorkforcemanagementBusinessunitWeekShorttermforecastCopyRequest();
		}
		...
		public Builder withBody(CopyBuForecastRequest body) {
		...
		public Builder withRequiredParams(String businessUnitId, LocalDate weekDateId, String forecastId, CopyBuForecastRequest body) {
			request.setBusinessUnitId(businessUnitId);
						request.setWeekDateId(weekDateId);
						request.setForecastId(forecastId);
						request.setBody(body);
