...
public class PatchArchitectGrammarRequest {
    ...
    public ApiRequest<Grammar> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("PATCH", "/api/v2/architect/grammars/{grammarId}")
	...
	public static class Builder {
		private final PatchArchitectGrammarRequest request;

		private Builder() {
			request = new PatchArchitectGrammarRequest();
		}
