...
public class PostAnalyticsUsersDetailsJobsRequest {
    
	private AsyncUserDetailsQuery body;
	public AsyncUserDetailsQuery getBody() {
		return this.body;
	}

	public void setBody(AsyncUserDetailsQuery body) {
		this.body = body;
	}

	public PostAnalyticsUsersDetailsJobsRequest withBody(AsyncUserDetailsQuery body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostAnalyticsUsersDetailsJobsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<AsyncUserDetailsQuery> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostAnalyticsUsersDetailsJobsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/analytics/users/details/jobs")
                .withBody(body)
	...
	public static Builder builder(AsyncUserDetailsQuery body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostAnalyticsUsersDetailsJobsRequest request;

		private Builder() {
			request = new PostAnalyticsUsersDetailsJobsRequest();
		}

		
		public Builder withBody(AsyncUserDetailsQuery body) {
		...
		public Builder withRequiredParams(AsyncUserDetailsQuery body) {
			request.setBody(body);
		...
		public PostAnalyticsUsersDetailsJobsRequest build() {
