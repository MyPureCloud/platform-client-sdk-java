...
public class PostWorkforcemanagementUnavailabletimesValidationJobsRequest {

	private ValidateAgentUnavailableTimesRequest body;
	public ValidateAgentUnavailableTimesRequest getBody() {
		return this.body;
	}

	public void setBody(ValidateAgentUnavailableTimesRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementUnavailabletimesValidationJobsRequest withBody(ValidateAgentUnavailableTimesRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementUnavailabletimesValidationJobsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<ValidateAgentUnavailableTimesRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementUnavailabletimesValidationJobsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/unavailabletimes/validation/jobs")
                .withBody(body)
	...
	public static Builder builder(ValidateAgentUnavailableTimesRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementUnavailabletimesValidationJobsRequest request;

		private Builder() {
			request = new PostWorkforcemanagementUnavailabletimesValidationJobsRequest();
		}


		public Builder withBody(ValidateAgentUnavailableTimesRequest body) {
		...
		public Builder withRequiredParams(ValidateAgentUnavailableTimesRequest body) {
			request.setBody(body);
		...
		public PostWorkforcemanagementUnavailabletimesValidationJobsRequest build() {
