...
public class PostWorkforcemanagementBusinessunitAdherenceExplanationsQueryRequest {
	...
	private BuQueryAdherenceExplanationsRequest body;
	public BuQueryAdherenceExplanationsRequest getBody() {
		return this.body;
	}

	public void setBody(BuQueryAdherenceExplanationsRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementBusinessunitAdherenceExplanationsQueryRequest withBody(BuQueryAdherenceExplanationsRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public ApiRequest<BuQueryAdherenceExplanationsRequest> withHttpInfo() {
        
        // verify the required parameter 'businessUnitId' is set
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PostWorkforcemanagementBusinessunitAdherenceExplanationsQueryRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementBusinessunitAdherenceExplanationsQueryRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/adherence/explanations/query")
	...
	public static Builder builder(String businessUnitId, BuQueryAdherenceExplanationsRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementBusinessunitAdherenceExplanationsQueryRequest request;

		private Builder() {
			request = new PostWorkforcemanagementBusinessunitAdherenceExplanationsQueryRequest();
		}
		...
		public Builder withBody(BuQueryAdherenceExplanationsRequest body) {
		...
		public Builder withRequiredParams(String businessUnitId, BuQueryAdherenceExplanationsRequest body) {
			request.setBusinessUnitId(businessUnitId);
			request.setBody(body);
		...
		public PostWorkforcemanagementBusinessunitAdherenceExplanationsQueryRequest build() {
