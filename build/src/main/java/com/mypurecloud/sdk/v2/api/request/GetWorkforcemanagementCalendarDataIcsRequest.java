...
public class GetWorkforcemanagementCalendarDataIcsRequest {
	...
	public GetWorkforcemanagementCalendarDataIcsRequest withCalendarId(String calendarId) {
    ...
    public GetWorkforcemanagementCalendarDataIcsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.calendarId == null) {
            throw new IllegalStateException("Missing the required parameter 'calendarId' when building request for GetWorkforcemanagementCalendarDataIcsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/calendar/data/ics")
                .withQueryParameters("calendarId", "", calendarId)
        
                .withCustomHeaders(customHeaders)
                .withContentTypes("application/json")
                .withAccepts("text/calendar")
                .withAuthNames()
                .build();
    }
	...
	public static Builder builder(String calendarId) {
	    return new Builder()
	            .withRequiredParams(calendarId);
	}
	

	public static class Builder {
		private final GetWorkforcemanagementCalendarDataIcsRequest request;

		private Builder() {
			request = new GetWorkforcemanagementCalendarDataIcsRequest();
		}

		
		public Builder withCalendarId(String calendarId) {
		...
		public Builder withRequiredParams(String calendarId) {
			request.setCalendarId(calendarId);
		...
		public GetWorkforcemanagementCalendarDataIcsRequest build() {
