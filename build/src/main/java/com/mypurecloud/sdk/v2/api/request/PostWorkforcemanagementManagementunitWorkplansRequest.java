...
public class PostWorkforcemanagementManagementunitWorkplansRequest {
    ...
    public ApiRequest<CreateWorkPlan> withHttpInfo() {
	...
	public static class Builder {
		private final PostWorkforcemanagementManagementunitWorkplansRequest request;

		private Builder() {
			request = new PostWorkforcemanagementManagementunitWorkplansRequest();
		}
		...
		public PostWorkforcemanagementManagementunitWorkplansRequest build() {
