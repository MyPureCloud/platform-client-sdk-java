...
public class GetWorkforcemanagementBusinessunitAlternativeshiftsTradeRequest {
	...
	public GetWorkforcemanagementBusinessunitAlternativeshiftsTradeRequest withBusinessUnitId(String businessUnitId) {
	...
	public GetWorkforcemanagementBusinessunitAlternativeshiftsTradeRequest withTradeId(String tradeId) {
    ...
    public GetWorkforcemanagementBusinessunitAlternativeshiftsTradeRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for GetWorkforcemanagementBusinessunitAlternativeshiftsTradeRequest.");
        }
        
        // verify the required parameter 'tradeId' is set
        if (this.tradeId == null) {
            throw new IllegalStateException("Missing the required parameter 'tradeId' when building request for GetWorkforcemanagementBusinessunitAlternativeshiftsTradeRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/alternativeshifts/trades/{tradeId}")
	...
	public static Builder builder(String businessUnitId, String tradeId) {
	    return new Builder()
	            .withRequiredParams(businessUnitId, tradeId);
	}


	public static class Builder {
		private final GetWorkforcemanagementBusinessunitAlternativeshiftsTradeRequest request;

		private Builder() {
			request = new GetWorkforcemanagementBusinessunitAlternativeshiftsTradeRequest();
		}
		...
		public Builder withRequiredParams(String businessUnitId, String tradeId) {
			request.setBusinessUnitId(businessUnitId);
			request.setTradeId(tradeId);
		...
		public GetWorkforcemanagementBusinessunitAlternativeshiftsTradeRequest build() {
