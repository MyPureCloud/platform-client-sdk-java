...
public class PostExternalcontactsBulkOrganizationsDivisionviewsRequest {

	private BulkIdsRequest body;
	public BulkIdsRequest getBody() {
		return this.body;
	}

	public void setBody(BulkIdsRequest body) {
		this.body = body;
	}

	public PostExternalcontactsBulkOrganizationsDivisionviewsRequest withBody(BulkIdsRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostExternalcontactsBulkOrganizationsDivisionviewsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<BulkIdsRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostExternalcontactsBulkOrganizationsDivisionviewsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/externalcontacts/bulk/organizations/divisionviews")
                .withBody(body)
	...
	public static Builder builder(BulkIdsRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostExternalcontactsBulkOrganizationsDivisionviewsRequest request;

		private Builder() {
			request = new PostExternalcontactsBulkOrganizationsDivisionviewsRequest();
		}


		public Builder withBody(BulkIdsRequest body) {
		...
		public Builder withRequiredParams(BulkIdsRequest body) {
			request.setBody(body);
		...
		public PostExternalcontactsBulkOrganizationsDivisionviewsRequest build() {
