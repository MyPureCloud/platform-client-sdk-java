...
public class PostIntegrationsActionTestRequest {
	...
	public PostIntegrationsActionTestRequest withActionId(String actionId) {
	...
	public PostIntegrationsActionTestRequest withBody(Object body) {
	    this.setBody(body);
	    return this;
	} 
	...
	public PostIntegrationsActionTestRequest withFlatten(Boolean flatten) {
    ...
    public PostIntegrationsActionTestRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Object> withHttpInfo() {
        ...
        if (this.actionId == null) {
            throw new IllegalStateException("Missing the required parameter 'actionId' when building request for PostIntegrationsActionTestRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostIntegrationsActionTestRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/integrations/actions/{actionId}/test")
	...
	public static class Builder {
		private final PostIntegrationsActionTestRequest request;

		private Builder() {
			request = new PostIntegrationsActionTestRequest();
		}
		...
		public PostIntegrationsActionTestRequest build() {
