...
public class GetWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionRequest {
	...
	public GetWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionRequest withBusinessUnitId(String businessUnitId) {
    ...
    public GetWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for GetWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/mainforecast/continuousforecast/session")
	...
	public static class Builder {
		private final GetWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionRequest request;

		private Builder() {
			request = new GetWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionRequest();
		}
		...
		public GetWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionRequest build() {
