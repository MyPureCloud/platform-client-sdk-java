...
public class PostWorkforcemanagementBusinessunitCapacityplansRequest {
	...
	public PostWorkforcemanagementBusinessunitCapacityplansRequest withBusinessUnitId(String businessUnitId) {
	    this.setBusinessUnitId(businessUnitId);
	    return this;
	} 

	private CapacityPlanRequest body;
	public CapacityPlanRequest getBody() {
		return this.body;
	}

	public void setBody(CapacityPlanRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementBusinessunitCapacityplansRequest withBody(CapacityPlanRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementBusinessunitCapacityplansRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<CapacityPlanRequest> withHttpInfo() {
        
        // verify the required parameter 'businessUnitId' is set
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PostWorkforcemanagementBusinessunitCapacityplansRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementBusinessunitCapacityplansRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/capacityplans")
	...
	public static Builder builder(String businessUnitId, CapacityPlanRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementBusinessunitCapacityplansRequest request;

		private Builder() {
			request = new PostWorkforcemanagementBusinessunitCapacityplansRequest();
		}
		...
		public Builder withBody(CapacityPlanRequest body) {
		...
		public Builder withRequiredParams(String businessUnitId, CapacityPlanRequest body) {
			request.setBusinessUnitId(businessUnitId);
			request.setBody(body);
		...
		public PostWorkforcemanagementBusinessunitCapacityplansRequest build() {
