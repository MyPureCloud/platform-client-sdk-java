...
public class SetWrapperRoutePathRequest  implements Serializable {
  ...
  public SetWrapperRoutePathRequest() {
  ...
  /**
   **/
  public SetWrapperRoutePathRequest values(List<RoutePathRequest> values) {
    this.values = values;
    return this;
  }
  ...
  @JsonProperty("values")
  public List<RoutePathRequest> getValues() {
    return values;
  }
  public void setValues(List<RoutePathRequest> values) {
    this.values = values;
  }
