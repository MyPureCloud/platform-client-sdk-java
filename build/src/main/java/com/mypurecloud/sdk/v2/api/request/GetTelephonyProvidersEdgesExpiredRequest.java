...
public class GetTelephonyProvidersEdgesExpiredRequest {
    ...
    public GetTelephonyProvidersEdgesExpiredRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/telephony/providers/edges/expired")
	...
	public static class Builder {
		private final GetTelephonyProvidersEdgesExpiredRequest request;

		private Builder() {
			request = new GetTelephonyProvidersEdgesExpiredRequest();
		}
		...
		public GetTelephonyProvidersEdgesExpiredRequest build() {
