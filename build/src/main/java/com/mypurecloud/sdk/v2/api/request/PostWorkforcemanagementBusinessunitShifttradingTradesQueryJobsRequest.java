...
public class PostWorkforcemanagementBusinessunitShifttradingTradesQueryJobsRequest {
	...
	public PostWorkforcemanagementBusinessunitShifttradingTradesQueryJobsRequest withBusinessUnitId(String businessUnitId) {
	    this.setBusinessUnitId(businessUnitId);
	    return this;
	} 

	private QueryShiftTradeListJobRequest body;
	public QueryShiftTradeListJobRequest getBody() {
		return this.body;
	}

	public void setBody(QueryShiftTradeListJobRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementBusinessunitShifttradingTradesQueryJobsRequest withBody(QueryShiftTradeListJobRequest body) {
	    this.setBody(body);
	    return this;
	} 
	...
	public PostWorkforcemanagementBusinessunitShifttradingTradesQueryJobsRequest withForceAsync(Boolean forceAsync) {
	...
	public PostWorkforcemanagementBusinessunitShifttradingTradesQueryJobsRequest withForceDownloadService(Boolean forceDownloadService) {
    ...
    public PostWorkforcemanagementBusinessunitShifttradingTradesQueryJobsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<QueryShiftTradeListJobRequest> withHttpInfo() {
        
        // verify the required parameter 'businessUnitId' is set
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PostWorkforcemanagementBusinessunitShifttradingTradesQueryJobsRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementBusinessunitShifttradingTradesQueryJobsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/shifttrading/trades/query/jobs")
	...
	public static Builder builder(String businessUnitId, QueryShiftTradeListJobRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementBusinessunitShifttradingTradesQueryJobsRequest request;

		private Builder() {
			request = new PostWorkforcemanagementBusinessunitShifttradingTradesQueryJobsRequest();
		}
		...
		public Builder withBody(QueryShiftTradeListJobRequest body) {
		...
		public Builder withRequiredParams(String businessUnitId, QueryShiftTradeListJobRequest body) {
			request.setBusinessUnitId(businessUnitId);
			request.setBody(body);
		...
		public PostWorkforcemanagementBusinessunitShifttradingTradesQueryJobsRequest build() {
