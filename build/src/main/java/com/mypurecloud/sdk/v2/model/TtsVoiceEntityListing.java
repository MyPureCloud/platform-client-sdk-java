...
public class TtsVoiceEntityListing  implements Serializable, PagedResource<TtsVoiceEntity> {
  ...
  /**
   **/
  public TtsVoiceEntityListing entities(List<TtsVoiceEntity> entities) {
  ...
  public List<TtsVoiceEntity> getEntities() {
    return entities;
  }
  public void setEntities(List<TtsVoiceEntity> entities) {
    this.entities = entities;
  }
