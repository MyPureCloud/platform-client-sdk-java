...
public class GetOutboundCampaignsDivisionviewRequest {
	...
	public GetOutboundCampaignsDivisionviewRequest withCampaignId(String campaignId) {
    ...
    public GetOutboundCampaignsDivisionviewRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.campaignId == null) {
            throw new IllegalStateException("Missing the required parameter 'campaignId' when building request for GetOutboundCampaignsDivisionviewRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/outbound/campaigns/divisionviews/{campaignId}")
	...
	public static class Builder {
		private final GetOutboundCampaignsDivisionviewRequest request;

		private Builder() {
			request = new GetOutboundCampaignsDivisionviewRequest();
		}
		...
		public GetOutboundCampaignsDivisionviewRequest build() {
