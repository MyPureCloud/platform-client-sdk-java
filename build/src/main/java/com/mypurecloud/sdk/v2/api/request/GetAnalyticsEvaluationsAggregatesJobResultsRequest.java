...
public class GetAnalyticsEvaluationsAggregatesJobResultsRequest {
	...
	public GetAnalyticsEvaluationsAggregatesJobResultsRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
	...
	public GetAnalyticsEvaluationsAggregatesJobResultsRequest withCursor(String cursor) {
    ...
    public GetAnalyticsEvaluationsAggregatesJobResultsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetAnalyticsEvaluationsAggregatesJobResultsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/analytics/evaluations/aggregates/jobs/{jobId}/results")
	...
	public static class Builder {
		private final GetAnalyticsEvaluationsAggregatesJobResultsRequest request;

		private Builder() {
			request = new GetAnalyticsEvaluationsAggregatesJobResultsRequest();
		}
		...
		public GetAnalyticsEvaluationsAggregatesJobResultsRequest build() {
