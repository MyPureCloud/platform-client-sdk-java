...
public class GetFlowsInstancesSettingsLoglevelsCharacteristicsRequest {
    ...
    public GetFlowsInstancesSettingsLoglevelsCharacteristicsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/flows/instances/settings/loglevels/characteristics")
	...
	public static class Builder {
		private final GetFlowsInstancesSettingsLoglevelsCharacteristicsRequest request;

		private Builder() {
			request = new GetFlowsInstancesSettingsLoglevelsCharacteristicsRequest();
		}
		...
		public GetFlowsInstancesSettingsLoglevelsCharacteristicsRequest build() {
