...
public class GetTelephonyProvidersEdgesSiteNumberplanRequest {
	...
	public GetTelephonyProvidersEdgesSiteNumberplanRequest withSiteId(String siteId) {
	...
	public void setNumberPlanId(String numberPlanId) {
		this.numberPlanId = numberPlanId;
	}

	public GetTelephonyProvidersEdgesSiteNumberplanRequest withNumberPlanId(String numberPlanId) {
	    this.setNumberPlanId(numberPlanId);
	    return this;
	}
    ...
    public GetTelephonyProvidersEdgesSiteNumberplanRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() throws ApiException {
        ...
        if (this.siteId == null) {
            throw new ApiException(400, "Missing the required parameter 'siteId' when building request for GetTelephonyProvidersEdgesSiteNumberplanRequest.");
        }
        
        // verify the required parameter 'numberPlanId' is set
        if (this.numberPlanId == null) {
            throw new ApiException(400, "Missing the required parameter 'numberPlanId' when building request for GetTelephonyProvidersEdgesSiteNumberplanRequest.");
        }
