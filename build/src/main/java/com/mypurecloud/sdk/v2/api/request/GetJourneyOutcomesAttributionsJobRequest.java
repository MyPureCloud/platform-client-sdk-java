...
public class GetJourneyOutcomesAttributionsJobRequest {
	...
	public GetJourneyOutcomesAttributionsJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetJourneyOutcomesAttributionsJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetJourneyOutcomesAttributionsJobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/journey/outcomes/attributions/jobs/{jobId}")
	...
	public static class Builder {
		private final GetJourneyOutcomesAttributionsJobRequest request;

		private Builder() {
			request = new GetJourneyOutcomesAttributionsJobRequest();
		}
		...
		public GetJourneyOutcomesAttributionsJobRequest build() {
