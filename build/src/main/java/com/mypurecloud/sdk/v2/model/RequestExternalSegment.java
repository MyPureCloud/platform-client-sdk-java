...
public class RequestExternalSegment  implements Serializable {
 ...
 @JsonDeserialize(using = SourceEnumDeserializer.class)
  ...
  public RequestExternalSegment(Boolean initWithEmptyList) {
   ...
   **/
  public RequestExternalSegment id(String id) {
    this.id = id;
    return this;
  }
   ...
   **/
  public RequestExternalSegment name(String name) {
    this.name = name;
    return this;
  }
   ...
   * The external system where the segment originates from.
   **/
  public RequestExternalSegment source(SourceEnum source) {
    this.source = source;
    return this;
  }
  
  @ApiModelProperty(example = "null", value = "The external system where the segment originates from.")
  @JsonProperty("source")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RequestExternalSegment requestExternalSegment = (RequestExternalSegment) o;

    return Objects.equals(this.id, requestExternalSegment.id) &&
            Objects.equals(this.name, requestExternalSegment.name) &&
            Objects.equals(this.source, requestExternalSegment.source);
  }
