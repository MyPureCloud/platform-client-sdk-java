...
public class GetOutboundImporttemplatesRequest {
	...
	public GetOutboundImporttemplatesRequest withPageSize(Integer pageSize) {
	...
	public GetOutboundImporttemplatesRequest withPageNumber(Integer pageNumber) {
	...
	public GetOutboundImporttemplatesRequest withAllowEmptyResult(Boolean allowEmptyResult) {
	...
	public GetOutboundImporttemplatesRequest withFilterType(String filterType) {
	...
	public GetOutboundImporttemplatesRequest withName(String name) {
	    this.setName(name);
	    return this;
	} 
	...
	public GetOutboundImporttemplatesRequest withSortBy(String sortBy) {
	...
	public GetOutboundImporttemplatesRequest withSortOrder(String sortOrder) {
	...
	public GetOutboundImporttemplatesRequest withContactListTemplateId(String contactListTemplateId) {
    ...
    public GetOutboundImporttemplatesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/outbound/importtemplates")
                ...
                .withQueryParameters("contactListTemplateId", "", contactListTemplateId)
	...
	public static class Builder {
		private final GetOutboundImporttemplatesRequest request;
		...
		public GetOutboundImporttemplatesRequest build() {
