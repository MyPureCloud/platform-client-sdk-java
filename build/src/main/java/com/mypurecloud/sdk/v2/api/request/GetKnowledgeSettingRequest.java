...
public class GetKnowledgeSettingRequest {
	...
	public GetKnowledgeSettingRequest withKnowledgeSettingId(String knowledgeSettingId) {
    ...
    public GetKnowledgeSettingRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.knowledgeSettingId == null) {
            throw new IllegalStateException("Missing the required parameter 'knowledgeSettingId' when building request for GetKnowledgeSettingRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/knowledge/settings/{knowledgeSettingId}")
	...
	public static class Builder {
		private final GetKnowledgeSettingRequest request;

		private Builder() {
			request = new GetKnowledgeSettingRequest();
		}
		...
		public GetKnowledgeSettingRequest build() {
