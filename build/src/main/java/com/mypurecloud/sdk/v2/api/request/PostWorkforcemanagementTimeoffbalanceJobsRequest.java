...
public class PostWorkforcemanagementTimeoffbalanceJobsRequest {
	...
	public PostWorkforcemanagementTimeoffbalanceJobsRequest withBody(TimeOffBalanceRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementTimeoffbalanceJobsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<TimeOffBalanceRequest> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementTimeoffbalanceJobsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/timeoffbalance/jobs")
                .withBody(body)
	...
	public static Builder builder(TimeOffBalanceRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementTimeoffbalanceJobsRequest request;

		private Builder() {
			request = new PostWorkforcemanagementTimeoffbalanceJobsRequest();
		}
		...
		public Builder withRequiredParams(TimeOffBalanceRequest body) {
			request.setBody(body);
		...
		public PostWorkforcemanagementTimeoffbalanceJobsRequest build() {
