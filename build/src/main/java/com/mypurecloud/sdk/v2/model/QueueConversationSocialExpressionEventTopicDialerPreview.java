...
public class QueueConversationSocialExpressionEventTopicDialerPreview  implements Serializable {
  ...
  /**
   **/
  public QueueConversationSocialExpressionEventTopicDialerPreview id(String id) {
    this.id = id;
    return this;
  }
  ...
  /**
   **/
  public QueueConversationSocialExpressionEventTopicDialerPreview additionalProperties(Map<String, Object> additionalProperties) {
