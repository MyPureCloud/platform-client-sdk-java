...
public class GetIntegrationsBotconnectorIntegrationIdBotsSummariesRequest {
	...
	public GetIntegrationsBotconnectorIntegrationIdBotsSummariesRequest withIntegrationId(String integrationId) {
	...
	public GetIntegrationsBotconnectorIntegrationIdBotsSummariesRequest withPageNumber(Integer pageNumber) {
	...
	public GetIntegrationsBotconnectorIntegrationIdBotsSummariesRequest withPageSize(Integer pageSize) {
    ...
    public GetIntegrationsBotconnectorIntegrationIdBotsSummariesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.integrationId == null) {
            throw new IllegalStateException("Missing the required parameter 'integrationId' when building request for GetIntegrationsBotconnectorIntegrationIdBotsSummariesRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/integrations/botconnector/{integrationId}/bots/summaries")
	...
	public static class Builder {
		private final GetIntegrationsBotconnectorIntegrationIdBotsSummariesRequest request;

		private Builder() {
			request = new GetIntegrationsBotconnectorIntegrationIdBotsSummariesRequest();
		}
		...
		public GetIntegrationsBotconnectorIntegrationIdBotsSummariesRequest build() {
