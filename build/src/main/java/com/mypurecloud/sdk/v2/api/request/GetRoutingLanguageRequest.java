...
public class GetRoutingLanguageRequest {
    ...
    public ApiRequest<Void> withHttpInfo() throws ApiException {
        ...
        if (this.languageId == null) {
            throw new ApiException(400, "Missing the required parameter 'languageId' when building request for GetRoutingLanguageRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/routing/languages/{languageId}")
	...
	public static class Builder {
		private final GetRoutingLanguageRequest request;

		private Builder() {
			request = new GetRoutingLanguageRequest();
		}
