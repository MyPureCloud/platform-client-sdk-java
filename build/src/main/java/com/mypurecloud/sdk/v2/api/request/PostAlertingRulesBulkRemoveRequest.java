...
public class PostAlertingRulesBulkRemoveRequest {

	private CommonRuleBulkDeleteRequest body;
	public CommonRuleBulkDeleteRequest getBody() {
		return this.body;
	}

	public void setBody(CommonRuleBulkDeleteRequest body) {
		this.body = body;
	}

	public PostAlertingRulesBulkRemoveRequest withBody(CommonRuleBulkDeleteRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostAlertingRulesBulkRemoveRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<CommonRuleBulkDeleteRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostAlertingRulesBulkRemoveRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/alerting/rules/bulk/remove")
                .withBody(body)
	...
	public static Builder builder(CommonRuleBulkDeleteRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostAlertingRulesBulkRemoveRequest request;

		private Builder() {
			request = new PostAlertingRulesBulkRemoveRequest();
		}


		public Builder withBody(CommonRuleBulkDeleteRequest body) {
		...
		public Builder withRequiredParams(CommonRuleBulkDeleteRequest body) {
			request.setBody(body);
		...
		public PostAlertingRulesBulkRemoveRequest build() {
