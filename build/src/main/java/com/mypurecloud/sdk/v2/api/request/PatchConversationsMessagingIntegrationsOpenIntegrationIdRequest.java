...
public class PatchConversationsMessagingIntegrationsOpenIntegrationIdRequest {
	...
	public PatchConversationsMessagingIntegrationsOpenIntegrationIdRequest withIntegrationId(String integrationId) {
	    this.setIntegrationId(integrationId);
	    return this;
	} 
	
	private OpenIntegrationUpdateRequest body;
	public OpenIntegrationUpdateRequest getBody() {
		return this.body;
	}

	public void setBody(OpenIntegrationUpdateRequest body) {
		this.body = body;
	}

	public PatchConversationsMessagingIntegrationsOpenIntegrationIdRequest withBody(OpenIntegrationUpdateRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchConversationsMessagingIntegrationsOpenIntegrationIdRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<OpenIntegrationUpdateRequest> withHttpInfo() {
        
        // verify the required parameter 'integrationId' is set
        if (this.integrationId == null) {
            throw new IllegalStateException("Missing the required parameter 'integrationId' when building request for PatchConversationsMessagingIntegrationsOpenIntegrationIdRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchConversationsMessagingIntegrationsOpenIntegrationIdRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/conversations/messaging/integrations/open/{integrationId}")
	...
	public static Builder builder(String integrationId, OpenIntegrationUpdateRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PatchConversationsMessagingIntegrationsOpenIntegrationIdRequest request;

		private Builder() {
			request = new PatchConversationsMessagingIntegrationsOpenIntegrationIdRequest();
		}
		...
		public Builder withBody(OpenIntegrationUpdateRequest body) {
		...
		public Builder withRequiredParams(String integrationId, OpenIntegrationUpdateRequest body) {
			request.setIntegrationId(integrationId);
						request.setBody(body);
		...
		public PatchConversationsMessagingIntegrationsOpenIntegrationIdRequest build() {
