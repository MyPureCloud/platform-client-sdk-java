...
public class PutConversationsEmailMessagesDraftRequest {
	...
	public PutConversationsEmailMessagesDraftRequest withConversationId(String conversationId) {
    ...
    public ApiRequest<EmailMessage> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PutConversationsEmailMessagesDraftRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutConversationsEmailMessagesDraftRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/conversations/emails/{conversationId}/messages/draft")
