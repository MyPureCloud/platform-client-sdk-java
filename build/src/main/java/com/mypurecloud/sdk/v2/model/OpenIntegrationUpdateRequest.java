...
public class OpenIntegrationUpdateRequest  implements Serializable {
   ...
   **/
  public OpenIntegrationUpdateRequest name(String name) {
    this.name = name;
    return this;
  }
   ...
   **/
  public OpenIntegrationUpdateRequest supportedContent(SupportedContentReference supportedContent) {
   ...
   **/
  public OpenIntegrationUpdateRequest messagingSetting(MessagingSettingRequestReference messagingSetting) {
   ...
   **/
  public OpenIntegrationUpdateRequest outboundNotificationWebhookUrl(String outboundNotificationWebhookUrl) {
    this.outboundNotificationWebhookUrl = outboundNotificationWebhookUrl;
    return this;
  }
  
  @ApiModelProperty(example = "null", value = "The outbound notification webhook URL for the Open messaging integration.")
   ...
   **/
  public OpenIntegrationUpdateRequest outboundNotificationWebhookSignatureSecretToken(String outboundNotificationWebhookSignatureSecretToken) {
    this.outboundNotificationWebhookSignatureSecretToken = outboundNotificationWebhookSignatureSecretToken;
    return this;
  }
  
  @ApiModelProperty(example = "null", value = "The outbound notification webhook signature secret token.")
   ...
   **/
  public OpenIntegrationUpdateRequest webhookHeaders(Map<String, String> webhookHeaders) {
