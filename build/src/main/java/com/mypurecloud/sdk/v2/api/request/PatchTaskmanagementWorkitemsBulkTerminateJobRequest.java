...
public class PatchTaskmanagementWorkitemsBulkTerminateJobRequest {
	...
	public PatchTaskmanagementWorkitemsBulkTerminateJobRequest withBulkJobId(String bulkJobId) {
	...
	public PatchTaskmanagementWorkitemsBulkTerminateJobRequest withBody(BulkJobUpdate body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchTaskmanagementWorkitemsBulkTerminateJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<BulkJobUpdate> withHttpInfo() {
        ...
        if (this.bulkJobId == null) {
            throw new IllegalStateException("Missing the required parameter 'bulkJobId' when building request for PatchTaskmanagementWorkitemsBulkTerminateJobRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchTaskmanagementWorkitemsBulkTerminateJobRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/taskmanagement/workitems/bulk/terminate/jobs/{bulkJobId}")
	...
	public static class Builder {
		private final PatchTaskmanagementWorkitemsBulkTerminateJobRequest request;

		private Builder() {
			request = new PatchTaskmanagementWorkitemsBulkTerminateJobRequest();
		}
		...
		public PatchTaskmanagementWorkitemsBulkTerminateJobRequest build() {
