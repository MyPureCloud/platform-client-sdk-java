...
public class DeleteKnowledgeKnowledgebaseSynchronizeJobRequest {
	...
	public DeleteKnowledgeKnowledgebaseSynchronizeJobRequest withKnowledgeBaseId(String knowledgeBaseId) {
	...
	public DeleteKnowledgeKnowledgebaseSynchronizeJobRequest withSyncJobId(String syncJobId) {
    ...
    public DeleteKnowledgeKnowledgebaseSynchronizeJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.knowledgeBaseId == null) {
            throw new IllegalStateException("Missing the required parameter 'knowledgeBaseId' when building request for DeleteKnowledgeKnowledgebaseSynchronizeJobRequest.");
        }
        
        // verify the required parameter 'syncJobId' is set
        if (this.syncJobId == null) {
            throw new IllegalStateException("Missing the required parameter 'syncJobId' when building request for DeleteKnowledgeKnowledgebaseSynchronizeJobRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/synchronize/jobs/{syncJobId}")
                .withPathParameter("knowledgeBaseId", knowledgeBaseId)
        
                .withPathParameter("syncJobId", syncJobId)
	...
	public static Builder builder(String knowledgeBaseId, String syncJobId) {
	    return new Builder()
	            .withRequiredParams(knowledgeBaseId, syncJobId);
	}


	public static class Builder {
		private final DeleteKnowledgeKnowledgebaseSynchronizeJobRequest request;

		private Builder() {
			request = new DeleteKnowledgeKnowledgebaseSynchronizeJobRequest();
		}
		...
		public Builder withRequiredParams(String knowledgeBaseId, String syncJobId) {
			request.setKnowledgeBaseId(knowledgeBaseId);
			request.setSyncJobId(syncJobId);
		...
		public DeleteKnowledgeKnowledgebaseSynchronizeJobRequest build() {
