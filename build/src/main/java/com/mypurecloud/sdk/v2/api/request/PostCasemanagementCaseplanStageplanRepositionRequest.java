...
public class PostCasemanagementCaseplanStageplanRepositionRequest {
	...
	public PostCasemanagementCaseplanStageplanRepositionRequest withCaseplanId(String caseplanId) {
	...
	public PostCasemanagementCaseplanStageplanRepositionRequest withStageplanId(String stageplanId) {
	    this.setStageplanId(stageplanId);
	    return this;
	} 

	private StageplanReposition body;
	public StageplanReposition getBody() {
		return this.body;
	}

	public void setBody(StageplanReposition body) {
		this.body = body;
	}

	public PostCasemanagementCaseplanStageplanRepositionRequest withBody(StageplanReposition body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostCasemanagementCaseplanStageplanRepositionRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<StageplanReposition> withHttpInfo() {
        
        // verify the required parameter 'caseplanId' is set
        if (this.caseplanId == null) {
            throw new IllegalStateException("Missing the required parameter 'caseplanId' when building request for PostCasemanagementCaseplanStageplanRepositionRequest.");
        }
        
        // verify the required parameter 'stageplanId' is set
        if (this.stageplanId == null) {
            throw new IllegalStateException("Missing the required parameter 'stageplanId' when building request for PostCasemanagementCaseplanStageplanRepositionRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostCasemanagementCaseplanStageplanRepositionRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/casemanagement/caseplans/{caseplanId}/stageplans/{stageplanId}/reposition")
	...
	public static Builder builder(String caseplanId, String stageplanId, StageplanReposition body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostCasemanagementCaseplanStageplanRepositionRequest request;

		private Builder() {
			request = new PostCasemanagementCaseplanStageplanRepositionRequest();
		}
		...
		public Builder withBody(StageplanReposition body) {
		...
		public Builder withRequiredParams(String caseplanId, String stageplanId, StageplanReposition body) {
			request.setCaseplanId(caseplanId);
			request.setStageplanId(stageplanId);
			request.setBody(body);
		...
		public PostCasemanagementCaseplanStageplanRepositionRequest build() {
