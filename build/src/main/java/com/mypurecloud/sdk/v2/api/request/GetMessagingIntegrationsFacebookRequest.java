...
public class GetMessagingIntegrationsFacebookRequest {
	...
	public GetMessagingIntegrationsFacebookRequest withPageSize(Integer pageSize) {
	...
	public GetMessagingIntegrationsFacebookRequest withPageNumber(Integer pageNumber) {
    ...
    public GetMessagingIntegrationsFacebookRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/messaging/integrations/facebook")
	...
	public static class Builder {
		private final GetMessagingIntegrationsFacebookRequest request;

		private Builder() {
			request = new GetMessagingIntegrationsFacebookRequest();
		}
		...
		public GetMessagingIntegrationsFacebookRequest build() {
