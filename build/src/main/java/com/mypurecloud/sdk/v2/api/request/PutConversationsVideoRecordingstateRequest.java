...
public class PutConversationsVideoRecordingstateRequest {
	...
	public PutConversationsVideoRecordingstateRequest withConversationId(String conversationId) {
	...
	public PutConversationsVideoRecordingstateRequest withBody(SetRecordingState body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutConversationsVideoRecordingstateRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<SetRecordingState> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PutConversationsVideoRecordingstateRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutConversationsVideoRecordingstateRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/conversations/videos/{conversationId}/recordingstate")
	...
	public static class Builder {
		private final PutConversationsVideoRecordingstateRequest request;

		private Builder() {
			request = new PutConversationsVideoRecordingstateRequest();
		}
		...
		public PutConversationsVideoRecordingstateRequest build() {
