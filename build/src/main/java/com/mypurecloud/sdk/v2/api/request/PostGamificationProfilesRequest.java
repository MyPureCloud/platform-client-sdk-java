...
public class PostGamificationProfilesRequest {
	...
	public void setBody(CreatePerformanceProfile body) {
		this.body = body;
	}

	public PostGamificationProfilesRequest withBody(CreatePerformanceProfile body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostGamificationProfilesRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<CreatePerformanceProfile> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostGamificationProfilesRequest.");
        }
