...
public class GetSpeechandtextanalyticsSentimentDialectsRequest {
    ...
    public GetSpeechandtextanalyticsSentimentDialectsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/speechandtextanalytics/sentiment/dialects")
	...
	public static class Builder {
		private final GetSpeechandtextanalyticsSentimentDialectsRequest request;

		private Builder() {
			request = new GetSpeechandtextanalyticsSentimentDialectsRequest();
		}
		...
		public GetSpeechandtextanalyticsSentimentDialectsRequest build() {
