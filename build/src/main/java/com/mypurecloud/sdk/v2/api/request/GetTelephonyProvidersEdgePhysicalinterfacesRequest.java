...
public class GetTelephonyProvidersEdgePhysicalinterfacesRequest {
	...
	public GetTelephonyProvidersEdgePhysicalinterfacesRequest withEdgeId(String edgeId) {
    ...
    public GetTelephonyProvidersEdgePhysicalinterfacesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.edgeId == null) {
            throw new IllegalStateException("Missing the required parameter 'edgeId' when building request for GetTelephonyProvidersEdgePhysicalinterfacesRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/telephony/providers/edges/{edgeId}/physicalinterfaces")
	...
	public static class Builder {
		private final GetTelephonyProvidersEdgePhysicalinterfacesRequest request;

		private Builder() {
			request = new GetTelephonyProvidersEdgePhysicalinterfacesRequest();
		}
		...
		public GetTelephonyProvidersEdgePhysicalinterfacesRequest build() {
