...
public class PostConversationsChatCommunicationTypingRequest {
	...
	public PostConversationsChatCommunicationTypingRequest withConversationId(String conversationId) {
	...
	public PostConversationsChatCommunicationTypingRequest withCommunicationId(String communicationId) {
    ...
    public PostConversationsChatCommunicationTypingRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PostConversationsChatCommunicationTypingRequest.");
        }
        
        // verify the required parameter 'communicationId' is set
        if (this.communicationId == null) {
            throw new IllegalStateException("Missing the required parameter 'communicationId' when building request for PostConversationsChatCommunicationTypingRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/conversations/chats/{conversationId}/communications/{communicationId}/typing")
	...
	public static class Builder {
		private final PostConversationsChatCommunicationTypingRequest request;

		private Builder() {
			request = new PostConversationsChatCommunicationTypingRequest();
		}
		...
		public PostConversationsChatCommunicationTypingRequest build() {
