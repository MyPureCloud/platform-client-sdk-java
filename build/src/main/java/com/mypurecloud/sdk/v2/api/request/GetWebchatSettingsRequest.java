...
public class GetWebchatSettingsRequest {
    ...
    public GetWebchatSettingsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/webchat/settings")
	...
	public static class Builder {
		private final GetWebchatSettingsRequest request;

		private Builder() {
			request = new GetWebchatSettingsRequest();
		}
		...
		public GetWebchatSettingsRequest build() {
