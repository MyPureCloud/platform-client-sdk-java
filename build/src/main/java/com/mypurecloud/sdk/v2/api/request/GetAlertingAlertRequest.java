...
public class GetAlertingAlertRequest {
	...
	public GetAlertingAlertRequest withAlertId(String alertId) {
    ...
    public GetAlertingAlertRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.alertId == null) {
            throw new IllegalStateException("Missing the required parameter 'alertId' when building request for GetAlertingAlertRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/alerting/alerts/{alertId}")
	...
	public static class Builder {
		private final GetAlertingAlertRequest request;

		private Builder() {
			request = new GetAlertingAlertRequest();
		}
		...
		public GetAlertingAlertRequest build() {
