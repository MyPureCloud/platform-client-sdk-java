...
public class NluFeedbackListing  implements Serializable, PagedResource<NluFeedbackResponse> {
  ...
  /**
   **/
  public NluFeedbackListing entities(List<NluFeedbackResponse> entities) {
  ...
  public List<NluFeedbackResponse> getEntities() {
    return entities;
  }
  public void setEntities(List<NluFeedbackResponse> entities) {
    this.entities = entities;
  }
