...
public class DeleteBusinessrulesDecisiontableVersionRowRequest {
	...
	public DeleteBusinessrulesDecisiontableVersionRowRequest withTableId(String tableId) {
	...
	public DeleteBusinessrulesDecisiontableVersionRowRequest withTableVersion(Integer tableVersion) {
	...
	public DeleteBusinessrulesDecisiontableVersionRowRequest withRowId(String rowId) {
	    this.setRowId(rowId);
	    return this;
	} 
    ...
    public DeleteBusinessrulesDecisiontableVersionRowRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.tableId == null) {
            throw new IllegalStateException("Missing the required parameter 'tableId' when building request for DeleteBusinessrulesDecisiontableVersionRowRequest.");
        }
        
        // verify the required parameter 'tableVersion' is set
        if (this.tableVersion == null) {
            throw new IllegalStateException("Missing the required parameter 'tableVersion' when building request for DeleteBusinessrulesDecisiontableVersionRowRequest.");
        }
        
        // verify the required parameter 'rowId' is set
        if (this.rowId == null) {
            throw new IllegalStateException("Missing the required parameter 'rowId' when building request for DeleteBusinessrulesDecisiontableVersionRowRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/businessrules/decisiontables/{tableId}/versions/{tableVersion}/rows/{rowId}")
	...
	public static class Builder {
		private final DeleteBusinessrulesDecisiontableVersionRowRequest request;

		private Builder() {
			request = new DeleteBusinessrulesDecisiontableVersionRowRequest();
		}
		...
		public DeleteBusinessrulesDecisiontableVersionRowRequest build() {
