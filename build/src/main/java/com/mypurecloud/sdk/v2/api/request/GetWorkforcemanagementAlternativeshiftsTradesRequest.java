...
public class GetWorkforcemanagementAlternativeshiftsTradesRequest {
	...
	public GetWorkforcemanagementAlternativeshiftsTradesRequest withForceAsync(Boolean forceAsync) {
    ...
    public GetWorkforcemanagementAlternativeshiftsTradesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/alternativeshifts/trades")
	...
	public static class Builder {
		private final GetWorkforcemanagementAlternativeshiftsTradesRequest request;

		private Builder() {
			request = new GetWorkforcemanagementAlternativeshiftsTradesRequest();
		}
		...
		public GetWorkforcemanagementAlternativeshiftsTradesRequest build() {
