...
public class GetConversationsInternalmessagesRequest {
    ...
    public GetConversationsInternalmessagesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/conversations/internalmessages")
	...
	public static class Builder {
		private final GetConversationsInternalmessagesRequest request;

		private Builder() {
			request = new GetConversationsInternalmessagesRequest();
		}
		...
		public GetConversationsInternalmessagesRequest build() {
