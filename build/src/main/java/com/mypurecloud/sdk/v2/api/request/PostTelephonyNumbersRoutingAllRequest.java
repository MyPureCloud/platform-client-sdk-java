...
public class PostTelephonyNumbersRoutingAllRequest {

	private DisasterRecoveryAllRoutingRequest body;
	public DisasterRecoveryAllRoutingRequest getBody() {
		return this.body;
	}

	public void setBody(DisasterRecoveryAllRoutingRequest body) {
		this.body = body;
	}

	public PostTelephonyNumbersRoutingAllRequest withBody(DisasterRecoveryAllRoutingRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostTelephonyNumbersRoutingAllRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<DisasterRecoveryAllRoutingRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostTelephonyNumbersRoutingAllRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/telephony/numbers/routing/all")
                .withBody(body)
	...
	public static Builder builder(DisasterRecoveryAllRoutingRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostTelephonyNumbersRoutingAllRequest request;

		private Builder() {
			request = new PostTelephonyNumbersRoutingAllRequest();
		}


		public Builder withBody(DisasterRecoveryAllRoutingRequest body) {
		...
		public Builder withRequiredParams(DisasterRecoveryAllRoutingRequest body) {
			request.setBody(body);
		...
		public PostTelephonyNumbersRoutingAllRequest build() {
