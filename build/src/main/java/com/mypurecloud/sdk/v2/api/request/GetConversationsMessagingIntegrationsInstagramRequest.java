...
public class GetConversationsMessagingIntegrationsInstagramRequest {
	...
	public GetConversationsMessagingIntegrationsInstagramRequest withPageSize(Integer pageSize) {
	...
	public GetConversationsMessagingIntegrationsInstagramRequest withPageNumber(Integer pageNumber) {
	...
	public GetConversationsMessagingIntegrationsInstagramRequest withExpand(String expand) {
	...
	public GetConversationsMessagingIntegrationsInstagramRequest withSupportedContentId(String supportedContentId) {
	...
	public GetConversationsMessagingIntegrationsInstagramRequest withMessagingSettingId(String messagingSettingId) {
    ...
    public GetConversationsMessagingIntegrationsInstagramRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/conversations/messaging/integrations/instagram")
	...
	public static class Builder {
		private final GetConversationsMessagingIntegrationsInstagramRequest request;

		private Builder() {
			request = new GetConversationsMessagingIntegrationsInstagramRequest();
		}
		...
		public GetConversationsMessagingIntegrationsInstagramRequest build() {
