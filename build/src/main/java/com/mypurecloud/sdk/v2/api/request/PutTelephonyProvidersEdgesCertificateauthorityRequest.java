...
public class PutTelephonyProvidersEdgesCertificateauthorityRequest {
	...
	public PutTelephonyProvidersEdgesCertificateauthorityRequest withCertificateId(String certificateId) {
	...
	public void setBody(DomainCertificateAuthority body) {
		this.body = body;
	}

	public PutTelephonyProvidersEdgesCertificateauthorityRequest withBody(DomainCertificateAuthority body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutTelephonyProvidersEdgesCertificateauthorityRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<DomainCertificateAuthority> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("PUT", "/api/v2/telephony/providers/edges/certificateauthorities/{certificateId}")
