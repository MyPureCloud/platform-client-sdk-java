...
public class PostWorkforcemanagementManagementunitWeekSchedulesPartialuploadRequest {
	...
	public PostWorkforcemanagementManagementunitWeekSchedulesPartialuploadRequest withManagementUnitId(String managementUnitId) {
	...
	public PostWorkforcemanagementManagementunitWeekSchedulesPartialuploadRequest withWeekId(String weekId) {
	    this.setWeekId(weekId);
	    return this;
	} 
	
	private UserSchedulesPartialUploadRequest body;
	public UserSchedulesPartialUploadRequest getBody() {
		return this.body;
	}

	public void setBody(UserSchedulesPartialUploadRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementManagementunitWeekSchedulesPartialuploadRequest withBody(UserSchedulesPartialUploadRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementManagementunitWeekSchedulesPartialuploadRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<UserSchedulesPartialUploadRequest> withHttpInfo() {
        
        // verify the required parameter 'managementUnitId' is set
        if (this.managementUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'managementUnitId' when building request for PostWorkforcemanagementManagementunitWeekSchedulesPartialuploadRequest.");
        }
        
        // verify the required parameter 'weekId' is set
        if (this.weekId == null) {
            throw new IllegalStateException("Missing the required parameter 'weekId' when building request for PostWorkforcemanagementManagementunitWeekSchedulesPartialuploadRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/managementunits/{managementUnitId}/weeks/{weekId}/schedules/partialupload")
	...
	public static class Builder {
		private final PostWorkforcemanagementManagementunitWeekSchedulesPartialuploadRequest request;

		private Builder() {
			request = new PostWorkforcemanagementManagementunitWeekSchedulesPartialuploadRequest();
		}
		...
		public Builder withBody(UserSchedulesPartialUploadRequest body) {
		...
		public PostWorkforcemanagementManagementunitWeekSchedulesPartialuploadRequest build() {
