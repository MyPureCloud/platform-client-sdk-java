...
public class GetTelephonyProvidersEdgesDidpoolsRequest {
	...
	public GetTelephonyProvidersEdgesDidpoolsRequest withPageSize(Integer pageSize) {
	...
	public GetTelephonyProvidersEdgesDidpoolsRequest withPageNumber(Integer pageNumber) {
	...
	public GetTelephonyProvidersEdgesDidpoolsRequest withSortBy(String sortBy) {
    ...
    public GetTelephonyProvidersEdgesDidpoolsRequest withCustomHeader(String name, String value) {
	...
	public static class Builder {
		private final GetTelephonyProvidersEdgesDidpoolsRequest request;

		private Builder() {
			request = new GetTelephonyProvidersEdgesDidpoolsRequest();
		}
		...
		public GetTelephonyProvidersEdgesDidpoolsRequest build() {
