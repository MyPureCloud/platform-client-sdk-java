...
public class GetExternalcontactsOrganizationsSchemasCoretypeRequest {
	...
	public GetExternalcontactsOrganizationsSchemasCoretypeRequest withCoreTypeName(String coreTypeName) {
    ...
    public GetExternalcontactsOrganizationsSchemasCoretypeRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.coreTypeName == null) {
            throw new IllegalStateException("Missing the required parameter 'coreTypeName' when building request for GetExternalcontactsOrganizationsSchemasCoretypeRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/externalcontacts/organizations/schemas/coretypes/{coreTypeName}")
	...
	public static class Builder {
		private final GetExternalcontactsOrganizationsSchemasCoretypeRequest request;

		private Builder() {
			request = new GetExternalcontactsOrganizationsSchemasCoretypeRequest();
		}
		...
		public GetExternalcontactsOrganizationsSchemasCoretypeRequest build() {
