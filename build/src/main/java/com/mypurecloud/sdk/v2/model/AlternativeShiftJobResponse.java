...
public class AlternativeShiftJobResponse  implements Serializable {
 ...
 @JsonDeserialize(using = TypeEnumDeserializer.class)
  ...
  public AlternativeShiftJobResponse() {
   ...
   * The status of the alternative shift job
   **/
  public AlternativeShiftJobResponse status(StatusEnum status) {
    this.status = status;
    return this;
  }
   ...
   * The type of job
   **/
  public AlternativeShiftJobResponse type(TypeEnum type) {
    this.type = type;
    return this;
  }
   ...
   **/
  public AlternativeShiftJobResponse downloadUrl(String downloadUrl) {
   ...
   **/
  public AlternativeShiftJobResponse error(ErrorBody error) {
    this.error = error;
    return this;
  }
   ...
   **/
  public AlternativeShiftJobResponse viewOffersResults(AlternativeShiftOffersViewResponseTemplate viewOffersResults) {
   ...
   **/
  public AlternativeShiftJobResponse viewTradesResults(AlternativeShiftTradesViewResponseTemplate viewTradesResults) {
   ...
   **/
  public AlternativeShiftJobResponse bulkUpdateTradesResults(AlternativeShiftBulkUpdateTradesResponseTemplate bulkUpdateTradesResults) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    AlternativeShiftJobResponse alternativeShiftJobResponse = (AlternativeShiftJobResponse) o;

    return Objects.equals(this.id, alternativeShiftJobResponse.id) &&
            Objects.equals(this.status, alternativeShiftJobResponse.status) &&
            Objects.equals(this.type, alternativeShiftJobResponse.type) &&
            Objects.equals(this.downloadUrl, alternativeShiftJobResponse.downloadUrl) &&
            Objects.equals(this.error, alternativeShiftJobResponse.error) &&
            Objects.equals(this.viewOffersResults, alternativeShiftJobResponse.viewOffersResults) &&
            Objects.equals(this.viewTradesResults, alternativeShiftJobResponse.viewTradesResults) &&
            Objects.equals(this.bulkUpdateTradesResults, alternativeShiftJobResponse.bulkUpdateTradesResults) &&
            Objects.equals(this.selfUri, alternativeShiftJobResponse.selfUri);
  }
