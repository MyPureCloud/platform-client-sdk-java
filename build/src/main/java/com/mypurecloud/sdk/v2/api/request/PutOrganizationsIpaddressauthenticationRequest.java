...
public class PutOrganizationsIpaddressauthenticationRequest {
	...
	public void setBody(IpAddressAuthentication body) {
		this.body = body;
	}

	public PutOrganizationsIpaddressauthenticationRequest withBody(IpAddressAuthentication body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutOrganizationsIpaddressauthenticationRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<IpAddressAuthentication> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutOrganizationsIpaddressauthenticationRequest.");
        }
