...
public class PatchKnowledgeKnowledgebaseUnansweredGroupPhrasegroupRequest {
	...
	public PatchKnowledgeKnowledgebaseUnansweredGroupPhrasegroupRequest withKnowledgeBaseId(String knowledgeBaseId) {
	...
	public PatchKnowledgeKnowledgebaseUnansweredGroupPhrasegroupRequest withGroupId(String groupId) {
	...
	public void setPhraseGroupId(String phraseGroupId) {
		this.phraseGroupId = phraseGroupId;
	}

	public PatchKnowledgeKnowledgebaseUnansweredGroupPhrasegroupRequest withPhraseGroupId(String phraseGroupId) {
	    this.setPhraseGroupId(phraseGroupId);
	    return this;
	} 

	private UnansweredPhraseGroupPatchRequestBody body;
	public UnansweredPhraseGroupPatchRequestBody getBody() {
		return this.body;
	}

	public void setBody(UnansweredPhraseGroupPatchRequestBody body) {
		this.body = body;
	}

	public PatchKnowledgeKnowledgebaseUnansweredGroupPhrasegroupRequest withBody(UnansweredPhraseGroupPatchRequestBody body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchKnowledgeKnowledgebaseUnansweredGroupPhrasegroupRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<UnansweredPhraseGroupPatchRequestBody> withHttpInfo() {
        
        // verify the required parameter 'knowledgeBaseId' is set
        if (this.knowledgeBaseId == null) {
            throw new IllegalStateException("Missing the required parameter 'knowledgeBaseId' when building request for PatchKnowledgeKnowledgebaseUnansweredGroupPhrasegroupRequest.");
        }
        
        // verify the required parameter 'groupId' is set
        if (this.groupId == null) {
            throw new IllegalStateException("Missing the required parameter 'groupId' when building request for PatchKnowledgeKnowledgebaseUnansweredGroupPhrasegroupRequest.");
        }
        
        // verify the required parameter 'phraseGroupId' is set
        if (this.phraseGroupId == null) {
            throw new IllegalStateException("Missing the required parameter 'phraseGroupId' when building request for PatchKnowledgeKnowledgebaseUnansweredGroupPhrasegroupRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchKnowledgeKnowledgebaseUnansweredGroupPhrasegroupRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/unanswered/groups/{groupId}/phrasegroups/{phraseGroupId}")
                .withPathParameter("knowledgeBaseId", knowledgeBaseId)
        
                .withPathParameter("groupId", groupId)
        
                .withPathParameter("phraseGroupId", phraseGroupId)
	...
	public static Builder builder(String knowledgeBaseId, String groupId, String phraseGroupId, UnansweredPhraseGroupPatchRequestBody body) {
	    return new Builder()
	            .withRequiredParams(knowledgeBaseId, groupId, phraseGroupId, body);
	}


	public static class Builder {
		private final PatchKnowledgeKnowledgebaseUnansweredGroupPhrasegroupRequest request;

		private Builder() {
			request = new PatchKnowledgeKnowledgebaseUnansweredGroupPhrasegroupRequest();
		}
		...
		public Builder withPhraseGroupId(String phraseGroupId) {
			request.setPhraseGroupId(phraseGroupId);
			return this;
		}

		public Builder withBody(UnansweredPhraseGroupPatchRequestBody body) {
		...
		public Builder withRequiredParams(String knowledgeBaseId, String groupId, String phraseGroupId, UnansweredPhraseGroupPatchRequestBody body) {
			request.setKnowledgeBaseId(knowledgeBaseId);
			request.setGroupId(groupId);
			request.setPhraseGroupId(phraseGroupId);
			request.setBody(body);
		...
		public PatchKnowledgeKnowledgebaseUnansweredGroupPhrasegroupRequest build() {
