...
public class PostOutboundCampaignrulesRequest {
	...
	public PostOutboundCampaignrulesRequest withBody(CampaignRule body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostOutboundCampaignrulesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<CampaignRule> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostOutboundCampaignrulesRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/outbound/campaignrules")
                .withBody(body)
	...
	public static Builder builder(CampaignRule body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostOutboundCampaignrulesRequest request;

		private Builder() {
			request = new PostOutboundCampaignrulesRequest();
		}
		...
		public Builder withRequiredParams(CampaignRule body) {
			request.setBody(body);
		...
		public PostOutboundCampaignrulesRequest build() {
