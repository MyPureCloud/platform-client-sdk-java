...
public class GetKnowledgeKnowledgebaseDocumentVersionsRequest {
	...
	public GetKnowledgeKnowledgebaseDocumentVersionsRequest withKnowledgeBaseId(String knowledgeBaseId) {
	...
	public GetKnowledgeKnowledgebaseDocumentVersionsRequest withDocumentId(String documentId) {
	...
	public GetKnowledgeKnowledgebaseDocumentVersionsRequest withBefore(String before) {
	...
	public GetKnowledgeKnowledgebaseDocumentVersionsRequest withAfter(String after) {
	    this.setAfter(after);
	    return this;
	} 
	...
	public GetKnowledgeKnowledgebaseDocumentVersionsRequest withPageSize(String pageSize) {
	...
	public GetKnowledgeKnowledgebaseDocumentVersionsRequest withExpand(List<String> expand) {
    ...
    public GetKnowledgeKnowledgebaseDocumentVersionsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.knowledgeBaseId == null) {
            throw new IllegalStateException("Missing the required parameter 'knowledgeBaseId' when building request for GetKnowledgeKnowledgebaseDocumentVersionsRequest.");
        }
        
        // verify the required parameter 'documentId' is set
        if (this.documentId == null) {
            throw new IllegalStateException("Missing the required parameter 'documentId' when building request for GetKnowledgeKnowledgebaseDocumentVersionsRequest.");
        }
	...
	public static class Builder {
		private final GetKnowledgeKnowledgebaseDocumentVersionsRequest request;

		private Builder() {
			request = new GetKnowledgeKnowledgebaseDocumentVersionsRequest();
		}
		...
		public GetKnowledgeKnowledgebaseDocumentVersionsRequest build() {
