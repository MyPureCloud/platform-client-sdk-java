 ...
 */
@ApiModel(description = "Learning module job request")

public class LearningModuleJobRequest  implements Serializable {
 ...
 @JsonDeserialize(using = ActionEnumDeserializer.class)
  ...
  public LearningModuleJobRequest() {
   ...
   * The type for the learning module job
   **/
  public LearningModuleJobRequest action(ActionEnum action) {
    this.action = action;
    return this;
  }
  
  @ApiModelProperty(example = "null", required = true, value = "The type for the learning module job")
  @JsonProperty("action")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    LearningModuleJobRequest learningModuleJobRequest = (LearningModuleJobRequest) o;

    return Objects.equals(this.action, learningModuleJobRequest.action);
  }
