...
public class PostWorkforcemanagementAgentsOpportunitiesQueryRequest {
	...
	public PostWorkforcemanagementAgentsOpportunitiesQueryRequest withBody(QueryOpportunitiesRequest body) {
	    this.setBody(body);
	    return this;
	} 
	...
	public PostWorkforcemanagementAgentsOpportunitiesQueryRequest withExpand(String expand) {
	...
	public PostWorkforcemanagementAgentsOpportunitiesQueryRequest withForceDownloadService(Boolean forceDownloadService) {
    ...
    public PostWorkforcemanagementAgentsOpportunitiesQueryRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<QueryOpportunitiesRequest> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementAgentsOpportunitiesQueryRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/agents/opportunities/query")
	...
	public static Builder builder(QueryOpportunitiesRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementAgentsOpportunitiesQueryRequest request;

		private Builder() {
			request = new PostWorkforcemanagementAgentsOpportunitiesQueryRequest();
		}
		...
		public Builder withRequiredParams(QueryOpportunitiesRequest body) {
			request.setBody(body);
		...
		public PostWorkforcemanagementAgentsOpportunitiesQueryRequest build() {
