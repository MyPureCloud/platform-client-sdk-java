...
public class GetConversationSuggestionsRequest {
	...
	public GetConversationSuggestionsRequest withConversationId(String conversationId) {
	...
	public GetConversationSuggestionsRequest withBefore(String before) {
	...
	public GetConversationSuggestionsRequest withAfter(String after) {
	    this.setAfter(after);
	    return this;
	} 
	...
	public GetConversationSuggestionsRequest withPageSize(String pageSize) {
	...
	public GetConversationSuggestionsRequest withType(String type) {
	    this.setType(type);
	    return this;
	} 
	...
	public GetConversationSuggestionsRequest withState(String state) {
	    this.setState(state);
	    return this;
	} 
    ...
    public GetConversationSuggestionsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for GetConversationSuggestionsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/conversations/{conversationId}/suggestions")
	...
	public static class Builder {
		private final GetConversationSuggestionsRequest request;

		private Builder() {
			request = new GetConversationSuggestionsRequest();
		}
		...
		public GetConversationSuggestionsRequest build() {
