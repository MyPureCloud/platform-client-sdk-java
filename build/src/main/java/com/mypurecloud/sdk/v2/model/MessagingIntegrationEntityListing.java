...
import com.mypurecloud.sdk.v2.model.MessagingIntegration;
...
public class MessagingIntegrationEntityListing  implements Serializable, PagedResource<MessagingIntegration> {
  ...
  public MessagingIntegrationEntityListing() {
  ...
  /**
   **/
  public MessagingIntegrationEntityListing entities(List<MessagingIntegration> entities) {
  ...
  public List<MessagingIntegration> getEntities() {
    return entities;
  }
  public void setEntities(List<MessagingIntegration> entities) {
    this.entities = entities;
  }
