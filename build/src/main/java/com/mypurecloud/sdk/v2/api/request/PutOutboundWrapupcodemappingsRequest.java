...
public class PutOutboundWrapupcodemappingsRequest {
	...
	public void setBody(WrapUpCodeMapping body) {
		this.body = body;
	}

	public PutOutboundWrapupcodemappingsRequest withBody(WrapUpCodeMapping body) {
	    this.setBody(body);
	    return this;
	}
    ...
    public PutOutboundWrapupcodemappingsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<WrapUpCodeMapping> withHttpInfo() throws ApiException {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new ApiException(400, "Missing the required parameter 'body' when building request for PutOutboundWrapupcodemappingsRequest.");
        }
