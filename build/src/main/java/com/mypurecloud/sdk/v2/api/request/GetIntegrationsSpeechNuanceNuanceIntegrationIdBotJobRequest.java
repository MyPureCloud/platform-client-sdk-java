...
public class GetIntegrationsSpeechNuanceNuanceIntegrationIdBotJobRequest {
	...
	public GetIntegrationsSpeechNuanceNuanceIntegrationIdBotJobRequest withNuanceIntegrationId(String nuanceIntegrationId) {
	...
	public GetIntegrationsSpeechNuanceNuanceIntegrationIdBotJobRequest withBotId(String botId) {
	    this.setBotId(botId);
	    return this;
	} 
	...
	public GetIntegrationsSpeechNuanceNuanceIntegrationIdBotJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetIntegrationsSpeechNuanceNuanceIntegrationIdBotJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.nuanceIntegrationId == null) {
            throw new IllegalStateException("Missing the required parameter 'nuanceIntegrationId' when building request for GetIntegrationsSpeechNuanceNuanceIntegrationIdBotJobRequest.");
        }
        
        // verify the required parameter 'botId' is set
        if (this.botId == null) {
            throw new IllegalStateException("Missing the required parameter 'botId' when building request for GetIntegrationsSpeechNuanceNuanceIntegrationIdBotJobRequest.");
        }
        
        // verify the required parameter 'jobId' is set
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetIntegrationsSpeechNuanceNuanceIntegrationIdBotJobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/integrations/speech/nuance/{nuanceIntegrationId}/bots/{botId}/jobs/{jobId}")
	...
	public static class Builder {
		private final GetIntegrationsSpeechNuanceNuanceIntegrationIdBotJobRequest request;

		private Builder() {
			request = new GetIntegrationsSpeechNuanceNuanceIntegrationIdBotJobRequest();
		}
		...
		public GetIntegrationsSpeechNuanceNuanceIntegrationIdBotJobRequest build() {
