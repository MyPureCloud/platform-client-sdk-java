...
public class PostLearningScheduleslotsJobsRequest {

	private LearningScheduleSlotsJobRequest body;
	public LearningScheduleSlotsJobRequest getBody() {
		return this.body;
	}

	public void setBody(LearningScheduleSlotsJobRequest body) {
		this.body = body;
	}

	public PostLearningScheduleslotsJobsRequest withBody(LearningScheduleSlotsJobRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostLearningScheduleslotsJobsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<LearningScheduleSlotsJobRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostLearningScheduleslotsJobsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/learning/scheduleslots/jobs")
                .withBody(body)
	...
	public static Builder builder(LearningScheduleSlotsJobRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostLearningScheduleslotsJobsRequest request;

		private Builder() {
			request = new PostLearningScheduleslotsJobsRequest();
		}


		public Builder withBody(LearningScheduleSlotsJobRequest body) {
		...
		public Builder withRequiredParams(LearningScheduleSlotsJobRequest body) {
			request.setBody(body);
		...
		public PostLearningScheduleslotsJobsRequest build() {
