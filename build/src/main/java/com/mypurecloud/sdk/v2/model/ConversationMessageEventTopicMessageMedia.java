...
public class ConversationMessageEventTopicMessageMedia  implements Serializable {
  ...
  public ConversationMessageEventTopicMessageMedia() {
   ...
   **/
  public ConversationMessageEventTopicMessageMedia url(String url) {
    this.url = url;
    return this;
  }
   ...
   **/
  public ConversationMessageEventTopicMessageMedia mediaType(String mediaType) {
   ...
   **/
  public ConversationMessageEventTopicMessageMedia contentLengthBytes(Long contentLengthBytes) {
   ...
   **/
  public ConversationMessageEventTopicMessageMedia name(String name) {
    this.name = name;
    return this;
  }
   ...
   **/
  public ConversationMessageEventTopicMessageMedia id(String id) {
    this.id = id;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ConversationMessageEventTopicMessageMedia conversationMessageEventTopicMessageMedia = (ConversationMessageEventTopicMessageMedia) o;

    return Objects.equals(this.url, conversationMessageEventTopicMessageMedia.url) &&
            Objects.equals(this.mediaType, conversationMessageEventTopicMessageMedia.mediaType) &&
            Objects.equals(this.contentLengthBytes, conversationMessageEventTopicMessageMedia.contentLengthBytes) &&
            Objects.equals(this.name, conversationMessageEventTopicMessageMedia.name) &&
            Objects.equals(this.id, conversationMessageEventTopicMessageMedia.id);
  }
