...
public class DeleteUserRoutingskillRequest {
    ...
    public DeleteUserRoutingskillRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("DELETE", "/api/v2/users/{userId}/routingskills/{skillId}")
