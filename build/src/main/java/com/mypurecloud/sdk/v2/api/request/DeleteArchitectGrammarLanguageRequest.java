...
public class DeleteArchitectGrammarLanguageRequest {
	...
	public DeleteArchitectGrammarLanguageRequest withGrammarId(String grammarId) {
	...
	public DeleteArchitectGrammarLanguageRequest withLanguageCode(String languageCode) {
    ...
    public DeleteArchitectGrammarLanguageRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.grammarId == null) {
            throw new IllegalStateException("Missing the required parameter 'grammarId' when building request for DeleteArchitectGrammarLanguageRequest.");
        }
        
        // verify the required parameter 'languageCode' is set
        if (this.languageCode == null) {
            throw new IllegalStateException("Missing the required parameter 'languageCode' when building request for DeleteArchitectGrammarLanguageRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/architect/grammars/{grammarId}/languages/{languageCode}")
	...
	public static class Builder {
		private final DeleteArchitectGrammarLanguageRequest request;

		private Builder() {
			request = new DeleteArchitectGrammarLanguageRequest();
		}
		...
		public DeleteArchitectGrammarLanguageRequest build() {
