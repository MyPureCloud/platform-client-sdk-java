...
public class DeleteAnalyticsCopilotsAggregatesJobRequest {
	...
	public DeleteAnalyticsCopilotsAggregatesJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public DeleteAnalyticsCopilotsAggregatesJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for DeleteAnalyticsCopilotsAggregatesJobRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/analytics/copilots/aggregates/jobs/{jobId}")
	...
	public static class Builder {
		private final DeleteAnalyticsCopilotsAggregatesJobRequest request;

		private Builder() {
			request = new DeleteAnalyticsCopilotsAggregatesJobRequest();
		}
		...
		public DeleteAnalyticsCopilotsAggregatesJobRequest build() {
