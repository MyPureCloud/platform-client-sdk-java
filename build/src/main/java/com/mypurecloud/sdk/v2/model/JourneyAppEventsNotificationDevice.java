...
public class JourneyAppEventsNotificationDevice  implements Serializable {
 ...
 @JsonDeserialize(using = CategoryEnumDeserializer.class)
  ...
  /**
   **/
  public JourneyAppEventsNotificationDevice screenHeight(Integer screenHeight) {
  ...
  /**
   **/
  public JourneyAppEventsNotificationDevice screenWidth(Integer screenWidth) {
  ...
  /**
   **/
  public JourneyAppEventsNotificationDevice screenDensity(Integer screenDensity) {
