...
public class PostConversationCommunicationAgentchecklistsFinalizeRequest {
	...
	public PostConversationCommunicationAgentchecklistsFinalizeRequest withConversationId(String conversationId) {
	...
	public PostConversationCommunicationAgentchecklistsFinalizeRequest withCommunicationId(String communicationId) {
	    this.setCommunicationId(communicationId);
	    return this;
	} 

	private ChecklistFinalizePayload body;
	public ChecklistFinalizePayload getBody() {
		return this.body;
	}

	public void setBody(ChecklistFinalizePayload body) {
		this.body = body;
	}

	public PostConversationCommunicationAgentchecklistsFinalizeRequest withBody(ChecklistFinalizePayload body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostConversationCommunicationAgentchecklistsFinalizeRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<ChecklistFinalizePayload> withHttpInfo() {
        
        // verify the required parameter 'conversationId' is set
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PostConversationCommunicationAgentchecklistsFinalizeRequest.");
        }
        
        // verify the required parameter 'communicationId' is set
        if (this.communicationId == null) {
            throw new IllegalStateException("Missing the required parameter 'communicationId' when building request for PostConversationCommunicationAgentchecklistsFinalizeRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostConversationCommunicationAgentchecklistsFinalizeRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/conversations/{conversationId}/communications/{communicationId}/agentchecklists/finalize")
	...
	public static Builder builder(String conversationId, String communicationId, ChecklistFinalizePayload body) {
	    return new Builder()
	            .withRequiredParams(conversationId, communicationId, body);
	}


	public static class Builder {
		private final PostConversationCommunicationAgentchecklistsFinalizeRequest request;

		private Builder() {
			request = new PostConversationCommunicationAgentchecklistsFinalizeRequest();
		}
		...
		public Builder withBody(ChecklistFinalizePayload body) {
		...
		public Builder withRequiredParams(String conversationId, String communicationId, ChecklistFinalizePayload body) {
			request.setConversationId(conversationId);
			request.setCommunicationId(communicationId);
			request.setBody(body);
		...
		public PostConversationCommunicationAgentchecklistsFinalizeRequest build() {
