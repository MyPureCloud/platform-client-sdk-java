...
public class GetExternalcontactsContactsSchemasLimitsRequest {
    ...
    public GetExternalcontactsContactsSchemasLimitsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/externalcontacts/contacts/schemas/limits")
	...
	public static class Builder {
		private final GetExternalcontactsContactsSchemasLimitsRequest request;

		private Builder() {
			request = new GetExternalcontactsContactsSchemasLimitsRequest();
		}
		...
		public GetExternalcontactsContactsSchemasLimitsRequest build() {
