...
public class PostFlowsValidateJobsRequest {

	private RegisterArchitectValidateJob body;
	public RegisterArchitectValidateJob getBody() {
		return this.body;
	}

	public void setBody(RegisterArchitectValidateJob body) {
		this.body = body;
	}

	public PostFlowsValidateJobsRequest withBody(RegisterArchitectValidateJob body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostFlowsValidateJobsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<RegisterArchitectValidateJob> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostFlowsValidateJobsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/flows/validate/jobs")
                .withBody(body)
	...
	public static Builder builder(RegisterArchitectValidateJob body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostFlowsValidateJobsRequest request;

		private Builder() {
			request = new PostFlowsValidateJobsRequest();
		}


		public Builder withBody(RegisterArchitectValidateJob body) {
		...
		public Builder withRequiredParams(RegisterArchitectValidateJob body) {
			request.setBody(body);
		...
		public PostFlowsValidateJobsRequest build() {
