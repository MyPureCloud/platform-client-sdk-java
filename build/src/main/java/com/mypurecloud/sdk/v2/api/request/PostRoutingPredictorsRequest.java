...
public class PostRoutingPredictorsRequest {
    
	private CreatePredictorRequest body;
	public CreatePredictorRequest getBody() {
		return this.body;
	}

	public void setBody(CreatePredictorRequest body) {
		this.body = body;
	}

	public PostRoutingPredictorsRequest withBody(CreatePredictorRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostRoutingPredictorsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<CreatePredictorRequest> withHttpInfo() {
        

        return ApiRequestBuilder.create("POST", "/api/v2/routing/predictors")
                .withBody(body)
	...
	public static class Builder {
		private final PostRoutingPredictorsRequest request;

		private Builder() {
			request = new PostRoutingPredictorsRequest();
		}

		
		public Builder withBody(CreatePredictorRequest body) {
		...
		public PostRoutingPredictorsRequest build() {
