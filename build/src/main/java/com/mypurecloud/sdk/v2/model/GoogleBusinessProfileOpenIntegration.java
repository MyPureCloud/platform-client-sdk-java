...
public class GoogleBusinessProfileOpenIntegration  implements Serializable {
 ...
 @JsonDeserialize(using = CreateStatusEnumDeserializer.class)
   ...
   **/
  public GoogleBusinessProfileOpenIntegration name(String name) {
    this.name = name;
    return this;
  }
   ...
   **/
  public GoogleBusinessProfileOpenIntegration supportedContent(SupportedContentReference supportedContent) {
   ...
   **/
  public GoogleBusinessProfileOpenIntegration status(String status) {
    this.status = status;
    return this;
  }
  
  @ApiModelProperty(example = "null", value = "The status of the Google Business Profile Open Integration")
  @JsonProperty("status")
  ...
  @ApiModelProperty(example = "null", value = "The recipient associated to the Google Business Profile Open Integration. This recipient is used to associate a flow to an integration")
   ...
   **/
  public GoogleBusinessProfileOpenIntegration dateCreated(Date dateCreated) {
   ...
   **/
  public GoogleBusinessProfileOpenIntegration dateModified(Date dateModified) {
   ...
   **/
  public GoogleBusinessProfileOpenIntegration createdBy(DomainEntityRef createdBy) {
   ...
   **/
  public GoogleBusinessProfileOpenIntegration modifiedBy(DomainEntityRef modifiedBy) {
   ...
   **/
  public GoogleBusinessProfileOpenIntegration token(GoogleAuthTokenReference token) {
    this.token = token;
    return this;
  }
   ...
   **/
  public GoogleBusinessProfileOpenIntegration account(GoogleBusinessProfileAccountReference account) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    GoogleBusinessProfileOpenIntegration googleBusinessProfileOpenIntegration = (GoogleBusinessProfileOpenIntegration) o;

    return Objects.equals(this.id, googleBusinessProfileOpenIntegration.id) &&
            Objects.equals(this.name, googleBusinessProfileOpenIntegration.name) &&
            Objects.equals(this.supportedContent, googleBusinessProfileOpenIntegration.supportedContent) &&
            Objects.equals(this.messagingSetting, googleBusinessProfileOpenIntegration.messagingSetting) &&
            Objects.equals(this.status, googleBusinessProfileOpenIntegration.status) &&
            Objects.equals(this.recipient, googleBusinessProfileOpenIntegration.recipient) &&
            Objects.equals(this.dateCreated, googleBusinessProfileOpenIntegration.dateCreated) &&
            Objects.equals(this.dateModified, googleBusinessProfileOpenIntegration.dateModified) &&
            Objects.equals(this.createdBy, googleBusinessProfileOpenIntegration.createdBy) &&
            Objects.equals(this.modifiedBy, googleBusinessProfileOpenIntegration.modifiedBy) &&
            Objects.equals(this.createStatus, googleBusinessProfileOpenIntegration.createStatus) &&
            Objects.equals(this.createError, googleBusinessProfileOpenIntegration.createError) &&
            Objects.equals(this.token, googleBusinessProfileOpenIntegration.token) &&
            Objects.equals(this.account, googleBusinessProfileOpenIntegration.account) &&
            Objects.equals(this.selfUri, googleBusinessProfileOpenIntegration.selfUri);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, supportedContent, messagingSetting, status, recipient, dateCreated, dateModified, createdBy, modifiedBy, createStatus, createError, token, account, selfUri);
  }
