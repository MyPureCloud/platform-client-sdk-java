...
public class PostTelephonyProvidersEdgesPhonesRequest {
	...
	public PostTelephonyProvidersEdgesPhonesRequest withBody(Phone body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostTelephonyProvidersEdgesPhonesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Phone> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostTelephonyProvidersEdgesPhonesRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/telephony/providers/edges/phones")
                .withBody(body)
	...
	public static Builder builder(Phone body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostTelephonyProvidersEdgesPhonesRequest request;

		private Builder() {
			request = new PostTelephonyProvidersEdgesPhonesRequest();
		}
		...
		public Builder withRequiredParams(Phone body) {
			request.setBody(body);
		...
		public PostTelephonyProvidersEdgesPhonesRequest build() {
