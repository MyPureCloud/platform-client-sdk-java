...
public class PostKnowledgeKnowledgebaseDocumentVersionsRequest {
	...
	public PostKnowledgeKnowledgebaseDocumentVersionsRequest withKnowledgeBaseId(String knowledgeBaseId) {
	...
	public PostKnowledgeKnowledgebaseDocumentVersionsRequest withDocumentId(String documentId) {
	    this.setDocumentId(documentId);
	    return this;
	} 

	private KnowledgeDocumentVersion body;
	public KnowledgeDocumentVersion getBody() {
		return this.body;
	}

	public void setBody(KnowledgeDocumentVersion body) {
		this.body = body;
	}

	public PostKnowledgeKnowledgebaseDocumentVersionsRequest withBody(KnowledgeDocumentVersion body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostKnowledgeKnowledgebaseDocumentVersionsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<KnowledgeDocumentVersion> withHttpInfo() {
        
        // verify the required parameter 'knowledgeBaseId' is set
        if (this.knowledgeBaseId == null) {
            throw new IllegalStateException("Missing the required parameter 'knowledgeBaseId' when building request for PostKnowledgeKnowledgebaseDocumentVersionsRequest.");
        }
        
        // verify the required parameter 'documentId' is set
        if (this.documentId == null) {
            throw new IllegalStateException("Missing the required parameter 'documentId' when building request for PostKnowledgeKnowledgebaseDocumentVersionsRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostKnowledgeKnowledgebaseDocumentVersionsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/documents/{documentId}/versions")
	...
	public static Builder builder(String knowledgeBaseId, String documentId, KnowledgeDocumentVersion body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostKnowledgeKnowledgebaseDocumentVersionsRequest request;

		private Builder() {
			request = new PostKnowledgeKnowledgebaseDocumentVersionsRequest();
		}
		...
		public Builder withBody(KnowledgeDocumentVersion body) {
		...
		public Builder withRequiredParams(String knowledgeBaseId, String documentId, KnowledgeDocumentVersion body) {
			request.setKnowledgeBaseId(knowledgeBaseId);
			request.setDocumentId(documentId);
			request.setBody(body);
		...
		public PostKnowledgeKnowledgebaseDocumentVersionsRequest build() {
