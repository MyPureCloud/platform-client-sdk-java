...
public class GetWorkforcemanagementHistoricaldataImportstatusRequest {
    ...
    public GetWorkforcemanagementHistoricaldataImportstatusRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/historicaldata/importstatus")
	...
	public static class Builder {
		private final GetWorkforcemanagementHistoricaldataImportstatusRequest request;

		private Builder() {
			request = new GetWorkforcemanagementHistoricaldataImportstatusRequest();
		}
		...
		public GetWorkforcemanagementHistoricaldataImportstatusRequest build() {
