...
public class PostExternalcontactsIdentifierlookupOrganizationsRequest {

	private ExternalOrganizationIdentifier identifier;
	...
	public PostExternalcontactsIdentifierlookupOrganizationsRequest withExpand(List<String> expand) {
    ...
    public ApiRequest<ExternalOrganizationIdentifier> withHttpInfo() {
        
        // verify the required parameter 'identifier' is set
        if (this.identifier == null) {
            throw new IllegalStateException("Missing the required parameter 'identifier' when building request for PostExternalcontactsIdentifierlookupOrganizationsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/externalcontacts/identifierlookup/organizations")
	...
	public static Builder builder(ExternalOrganizationIdentifier identifier) {
	    return new Builder()
	            .withRequiredParams(identifier);
	}


	public static class Builder {
		private final PostExternalcontactsIdentifierlookupOrganizationsRequest request;

		private Builder() {
			request = new PostExternalcontactsIdentifierlookupOrganizationsRequest();
		}


		public Builder withIdentifier(ExternalOrganizationIdentifier identifier) {
		...
		public Builder withRequiredParams(ExternalOrganizationIdentifier identifier) {
			request.setIdentifier(identifier);
		...
		public PostExternalcontactsIdentifierlookupOrganizationsRequest build() {
