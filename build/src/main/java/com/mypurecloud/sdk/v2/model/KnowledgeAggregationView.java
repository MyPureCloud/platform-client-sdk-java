...
public class KnowledgeAggregationView  implements Serializable {
 ...
 @JsonDeserialize(using = FunctionEnumDeserializer.class)
  ...
  public KnowledgeAggregationView() {
   ...
   * Target metric name
   **/
  public KnowledgeAggregationView target(TargetEnum target) {
    this.target = target;
    return this;
  }
   ...
   **/
  public KnowledgeAggregationView name(String name) {
    this.name = name;
    return this;
  }
   ...
   * Type of view you wish to create
   **/
  public KnowledgeAggregationView function(FunctionEnum function) {
   ...
   **/
  public KnowledgeAggregationView range(AggregationRange range) {
    this.range = range;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    KnowledgeAggregationView knowledgeAggregationView = (KnowledgeAggregationView) o;

    return Objects.equals(this.target, knowledgeAggregationView.target) &&
            Objects.equals(this.name, knowledgeAggregationView.name) &&
            Objects.equals(this.function, knowledgeAggregationView.function) &&
            Objects.equals(this.range, knowledgeAggregationView.range);
  }
