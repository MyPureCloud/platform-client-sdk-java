...
public class OutboundPreviewCampaignPostContactVoiceAttributes  implements Serializable {
 ...
 @JsonDeserialize(using = ContactPhoneTypeEnumDeserializer.class)
  ...
  public OutboundPreviewCampaignPostContactVoiceAttributes() {
  ...
  /**
   **/
  public OutboundPreviewCampaignPostContactVoiceAttributes contactPhoneNumber(String contactPhoneNumber) {
  ...
  /**
   **/
  public OutboundPreviewCampaignPostContactVoiceAttributes contactPhoneType(ContactPhoneTypeEnum contactPhoneType) {
  ...
  /**
   **/
  public OutboundPreviewCampaignPostContactVoiceAttributes callerIdPhoneNumber(String callerIdPhoneNumber) {
  ...
  /**
   **/
  public OutboundPreviewCampaignPostContactVoiceAttributes callerIdName(String callerIdName) {
  ...
  /**
   **/
  public OutboundPreviewCampaignPostContactVoiceAttributes agentOwnedColumnName(String agentOwnedColumnName) {
  ...
  /**
   **/
  public OutboundPreviewCampaignPostContactVoiceAttributes previewModeColumnName(String previewModeColumnName) {
  ...
  /**
   **/
  public OutboundPreviewCampaignPostContactVoiceAttributes isDeliveredAsPreview(Boolean isDeliveredAsPreview) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    OutboundPreviewCampaignPostContactVoiceAttributes outboundPreviewCampaignPostContactVoiceAttributes = (OutboundPreviewCampaignPostContactVoiceAttributes) o;

    return Objects.equals(this.contactPhoneNumber, outboundPreviewCampaignPostContactVoiceAttributes.contactPhoneNumber) &&
            Objects.equals(this.contactPhoneType, outboundPreviewCampaignPostContactVoiceAttributes.contactPhoneType) &&
            Objects.equals(this.callerIdPhoneNumber, outboundPreviewCampaignPostContactVoiceAttributes.callerIdPhoneNumber) &&
            Objects.equals(this.callerIdName, outboundPreviewCampaignPostContactVoiceAttributes.callerIdName) &&
            Objects.equals(this.agentOwnedColumnName, outboundPreviewCampaignPostContactVoiceAttributes.agentOwnedColumnName) &&
            Objects.equals(this.previewModeColumnName, outboundPreviewCampaignPostContactVoiceAttributes.previewModeColumnName) &&
            Objects.equals(this.isDeliveredAsPreview, outboundPreviewCampaignPostContactVoiceAttributes.isDeliveredAsPreview);
  }
