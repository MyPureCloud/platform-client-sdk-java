...
public class GetSocialmediaTopicDataingestionrulesFacebookFacebookIngestionRuleIdVersionRequest {
	...
	public GetSocialmediaTopicDataingestionrulesFacebookFacebookIngestionRuleIdVersionRequest withTopicId(String topicId) {
	...
	public GetSocialmediaTopicDataingestionrulesFacebookFacebookIngestionRuleIdVersionRequest withFacebookIngestionRuleId(String facebookIngestionRuleId) {
	...
	public GetSocialmediaTopicDataingestionrulesFacebookFacebookIngestionRuleIdVersionRequest withDataIngestionRuleVersion(String dataIngestionRuleVersion) {
	...
	public GetSocialmediaTopicDataingestionrulesFacebookFacebookIngestionRuleIdVersionRequest withIncludeDeleted(Boolean includeDeleted) {
    ...
    public GetSocialmediaTopicDataingestionrulesFacebookFacebookIngestionRuleIdVersionRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.topicId == null) {
            throw new IllegalStateException("Missing the required parameter 'topicId' when building request for GetSocialmediaTopicDataingestionrulesFacebookFacebookIngestionRuleIdVersionRequest.");
        }
        
        // verify the required parameter 'facebookIngestionRuleId' is set
        if (this.facebookIngestionRuleId == null) {
            throw new IllegalStateException("Missing the required parameter 'facebookIngestionRuleId' when building request for GetSocialmediaTopicDataingestionrulesFacebookFacebookIngestionRuleIdVersionRequest.");
        }
        
        // verify the required parameter 'dataIngestionRuleVersion' is set
        if (this.dataIngestionRuleVersion == null) {
            throw new IllegalStateException("Missing the required parameter 'dataIngestionRuleVersion' when building request for GetSocialmediaTopicDataingestionrulesFacebookFacebookIngestionRuleIdVersionRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/socialmedia/topics/{topicId}/dataingestionrules/facebook/{facebookIngestionRuleId}/versions/{dataIngestionRuleVersion}")
	...
	public static Builder builder(String topicId, String facebookIngestionRuleId, String dataIngestionRuleVersion) {
	    return new Builder()
	            .withRequiredParams(topicId, facebookIngestionRuleId, dataIngestionRuleVersion);
	}


	public static class Builder {
		private final GetSocialmediaTopicDataingestionrulesFacebookFacebookIngestionRuleIdVersionRequest request;

		private Builder() {
			request = new GetSocialmediaTopicDataingestionrulesFacebookFacebookIngestionRuleIdVersionRequest();
		}
		...
		public Builder withRequiredParams(String topicId, String facebookIngestionRuleId, String dataIngestionRuleVersion) {
			request.setTopicId(topicId);
			request.setFacebookIngestionRuleId(facebookIngestionRuleId);
			request.setDataIngestionRuleVersion(dataIngestionRuleVersion);
		...
		public GetSocialmediaTopicDataingestionrulesFacebookFacebookIngestionRuleIdVersionRequest build() {
