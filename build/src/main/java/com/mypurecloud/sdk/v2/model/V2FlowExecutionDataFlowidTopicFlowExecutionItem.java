...
public class V2FlowExecutionDataFlowidTopicFlowExecutionItem  implements Serializable {
   ...
   **/
  public V2FlowExecutionDataFlowidTopicFlowExecutionItem objectType(String objectType) {
   ...
   **/
  public V2FlowExecutionDataFlowidTopicFlowExecutionItem objectId(String objectId) {
   ...
   **/
  public V2FlowExecutionDataFlowidTopicFlowExecutionItem outputPathId(String outputPathId) {
   ...
   **/
  public V2FlowExecutionDataFlowidTopicFlowExecutionItem executionId(String executionId) {
   ...
   **/
  public V2FlowExecutionDataFlowidTopicFlowExecutionItem startDateTime(Date startDateTime) {
   ...
   **/
  public V2FlowExecutionDataFlowidTopicFlowExecutionItem error(V2FlowExecutionDataFlowidTopicFlowErrorWarningInfo error) {
    this.error = error;
    return this;
  }
   ...
   * Event generated when a Flow's Execution History is received and logged.
   **/
  public V2FlowExecutionDataFlowidTopicFlowExecutionItem warning(V2FlowExecutionDataFlowidTopicFlowErrorWarningInfo warning) {
   ...
   **/
  public V2FlowExecutionDataFlowidTopicFlowExecutionItem languageTag(String languageTag) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V2FlowExecutionDataFlowidTopicFlowExecutionItem v2FlowExecutionDataFlowidTopicFlowExecutionItem = (V2FlowExecutionDataFlowidTopicFlowExecutionItem) o;

    return Objects.equals(this.objectType, v2FlowExecutionDataFlowidTopicFlowExecutionItem.objectType) &&
            Objects.equals(this.objectId, v2FlowExecutionDataFlowidTopicFlowExecutionItem.objectId) &&
            Objects.equals(this.outputPathId, v2FlowExecutionDataFlowidTopicFlowExecutionItem.outputPathId) &&
            Objects.equals(this.executionId, v2FlowExecutionDataFlowidTopicFlowExecutionItem.executionId) &&
            Objects.equals(this.startDateTime, v2FlowExecutionDataFlowidTopicFlowExecutionItem.startDateTime) &&
            Objects.equals(this.error, v2FlowExecutionDataFlowidTopicFlowExecutionItem.error) &&
            Objects.equals(this.warning, v2FlowExecutionDataFlowidTopicFlowExecutionItem.warning) &&
            Objects.equals(this.languageTag, v2FlowExecutionDataFlowidTopicFlowExecutionItem.languageTag);
  }
