...
public class GetWorkforcemanagementAlternativeshiftsTradesJobRequest {
	...
	public GetWorkforcemanagementAlternativeshiftsTradesJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetWorkforcemanagementAlternativeshiftsTradesJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetWorkforcemanagementAlternativeshiftsTradesJobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/alternativeshifts/trades/jobs/{jobId}")
	...
	public static class Builder {
		private final GetWorkforcemanagementAlternativeshiftsTradesJobRequest request;

		private Builder() {
			request = new GetWorkforcemanagementAlternativeshiftsTradesJobRequest();
		}
		...
		public GetWorkforcemanagementAlternativeshiftsTradesJobRequest build() {
