...
public class GetTelephonyProvidersEdgesSitesRequest {
    ...
    public GetTelephonyProvidersEdgesSitesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/telephony/providers/edges/sites")
                ...
                .withQueryParameters("location.id", "", locationId)
	...
	public static class Builder {
		private final GetTelephonyProvidersEdgesSitesRequest request;

		private Builder() {
			request = new GetTelephonyProvidersEdgesSitesRequest();
		}
