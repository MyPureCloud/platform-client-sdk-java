...
public class PostExternalcontactsContactsRequest {
	...
	public PostExternalcontactsContactsRequest withBody(ExternalContact body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostExternalcontactsContactsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<ExternalContact> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostExternalcontactsContactsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/externalcontacts/contacts")
                .withBody(body)
	...
	public static Builder builder(ExternalContact body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostExternalcontactsContactsRequest request;

		private Builder() {
			request = new PostExternalcontactsContactsRequest();
		}
		...
		public Builder withRequiredParams(ExternalContact body) {
			request.setBody(body);
		...
		public PostExternalcontactsContactsRequest build() {
