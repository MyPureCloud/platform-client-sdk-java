...
import com.mypurecloud.sdk.v2.model.ConnectionOption;
...
public class ConnectionOptionListing  implements Serializable {
  ...
  /**
   **/
  public ConnectionOptionListing entities(List<ConnectionOption> entities) {
  ...
  public List<ConnectionOption> getEntities() {
    return entities;
  }
  public void setEntities(List<ConnectionOption> entities) {
    this.entities = entities;
  }
