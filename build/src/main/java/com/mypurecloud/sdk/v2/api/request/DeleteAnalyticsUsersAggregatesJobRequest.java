...
public class DeleteAnalyticsUsersAggregatesJobRequest {
	...
	public DeleteAnalyticsUsersAggregatesJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public DeleteAnalyticsUsersAggregatesJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for DeleteAnalyticsUsersAggregatesJobRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/analytics/users/aggregates/jobs/{jobId}")
	...
	public static class Builder {
		private final DeleteAnalyticsUsersAggregatesJobRequest request;

		private Builder() {
			request = new DeleteAnalyticsUsersAggregatesJobRequest();
		}
		...
		public DeleteAnalyticsUsersAggregatesJobRequest build() {
