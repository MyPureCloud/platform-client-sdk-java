...
public class PostAnalyticsAgentsStatusQueryRequest {

	private AgentStateQueryRequest body;
	public AgentStateQueryRequest getBody() {
		return this.body;
	}

	public void setBody(AgentStateQueryRequest body) {
		this.body = body;
	}

	public PostAnalyticsAgentsStatusQueryRequest withBody(AgentStateQueryRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostAnalyticsAgentsStatusQueryRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<AgentStateQueryRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostAnalyticsAgentsStatusQueryRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/analytics/agents/status/query")
                .withBody(body)
	...
	public static Builder builder(AgentStateQueryRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostAnalyticsAgentsStatusQueryRequest request;

		private Builder() {
			request = new PostAnalyticsAgentsStatusQueryRequest();
		}


		public Builder withBody(AgentStateQueryRequest body) {
		...
		public Builder withRequiredParams(AgentStateQueryRequest body) {
			request.setBody(body);
		...
		public PostAnalyticsAgentsStatusQueryRequest build() {
