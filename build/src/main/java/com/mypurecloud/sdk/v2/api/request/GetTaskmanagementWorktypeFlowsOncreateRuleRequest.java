...
public class GetTaskmanagementWorktypeFlowsOncreateRuleRequest {
	...
	public GetTaskmanagementWorktypeFlowsOncreateRuleRequest withWorktypeId(String worktypeId) {
	...
	public GetTaskmanagementWorktypeFlowsOncreateRuleRequest withRuleId(String ruleId) {
    ...
    public GetTaskmanagementWorktypeFlowsOncreateRuleRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.worktypeId == null) {
            throw new IllegalStateException("Missing the required parameter 'worktypeId' when building request for GetTaskmanagementWorktypeFlowsOncreateRuleRequest.");
        }
        
        // verify the required parameter 'ruleId' is set
        if (this.ruleId == null) {
            throw new IllegalStateException("Missing the required parameter 'ruleId' when building request for GetTaskmanagementWorktypeFlowsOncreateRuleRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/taskmanagement/worktypes/{worktypeId}/flows/oncreate/rules/{ruleId}")
	...
	public static class Builder {
		private final GetTaskmanagementWorktypeFlowsOncreateRuleRequest request;

		private Builder() {
			request = new GetTaskmanagementWorktypeFlowsOncreateRuleRequest();
		}
		...
		public GetTaskmanagementWorktypeFlowsOncreateRuleRequest build() {
