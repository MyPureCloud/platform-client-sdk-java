...
public class ConversationChatEventTopicDetail  implements Serializable {
  ...
  public ConversationChatEventTopicDetail() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
    }
  }

  public ConversationChatEventTopicDetail(Boolean initWithEmptyList) {
  ...
  /**
   **/
  public ConversationChatEventTopicDetail errorCode(String errorCode) {
