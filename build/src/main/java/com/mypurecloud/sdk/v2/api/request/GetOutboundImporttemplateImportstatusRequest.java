...
public class GetOutboundImporttemplateImportstatusRequest {
	...
	public GetOutboundImporttemplateImportstatusRequest withImportTemplateId(String importTemplateId) {
	    this.setImportTemplateId(importTemplateId);
	    return this;
	} 

	private String listNamePrefix;
	public String getListNamePrefix() {
		return this.listNamePrefix;
	}
	...
	public GetOutboundImporttemplateImportstatusRequest withListNamePrefix(String listNamePrefix) {
	    this.setListNamePrefix(listNamePrefix);
	    return this;
	} 
    ...
    public GetOutboundImporttemplateImportstatusRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.importTemplateId == null) {
            throw new IllegalStateException("Missing the required parameter 'importTemplateId' when building request for GetOutboundImporttemplateImportstatusRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/outbound/importtemplates/{importTemplateId}/importstatus")
                .withPathParameter("importTemplateId", importTemplateId)
        

                .withQueryParameters("listNamePrefix", "", listNamePrefix)
	...
	public static Builder builder(String importTemplateId) {
	    return new Builder()
	            .withRequiredParams(importTemplateId);
	}


	public static class Builder {
		private final GetOutboundImporttemplateImportstatusRequest request;

		private Builder() {
			request = new GetOutboundImporttemplateImportstatusRequest();
		}
		...
		public Builder withListNamePrefix(String listNamePrefix) {
			request.setListNamePrefix(listNamePrefix);
			return this;
		}



		public Builder withRequiredParams(String importTemplateId) {
			request.setImportTemplateId(importTemplateId);
		...
		public GetOutboundImporttemplateImportstatusRequest build() {
