...
public class PostVoicemailMessagesRequest {
	...
	public void setBody(CopyVoicemailMessage body) {
		this.body = body;
	}

	public PostVoicemailMessagesRequest withBody(CopyVoicemailMessage body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostVoicemailMessagesRequest withCustomHeader(String name, String value) {
