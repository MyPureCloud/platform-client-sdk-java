...
public class GetTaskmanagementWorkitemsSchemaVersionsRequest {
	...
	public GetTaskmanagementWorkitemsSchemaVersionsRequest withSchemaId(String schemaId) {
    ...
    public GetTaskmanagementWorkitemsSchemaVersionsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.schemaId == null) {
            throw new IllegalStateException("Missing the required parameter 'schemaId' when building request for GetTaskmanagementWorkitemsSchemaVersionsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/taskmanagement/workitems/schemas/{schemaId}/versions")
	...
	public static class Builder {
		private final GetTaskmanagementWorkitemsSchemaVersionsRequest request;

		private Builder() {
			request = new GetTaskmanagementWorkitemsSchemaVersionsRequest();
		}
		...
		public GetTaskmanagementWorkitemsSchemaVersionsRequest build() {
