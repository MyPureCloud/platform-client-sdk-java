...
public class PostWorkforcemanagementAdherenceHistoricalRequest {
    
	private WfmHistoricalAdherenceQueryForUsers body;
	public WfmHistoricalAdherenceQueryForUsers getBody() {
		return this.body;
	}

	public void setBody(WfmHistoricalAdherenceQueryForUsers body) {
		this.body = body;
	}

	public PostWorkforcemanagementAdherenceHistoricalRequest withBody(WfmHistoricalAdherenceQueryForUsers body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementAdherenceHistoricalRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<WfmHistoricalAdherenceQueryForUsers> withHttpInfo() {
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/adherence/historical")
                .withBody(body)
	...
	public static class Builder {
		private final PostWorkforcemanagementAdherenceHistoricalRequest request;

		private Builder() {
			request = new PostWorkforcemanagementAdherenceHistoricalRequest();
		}

		
		public Builder withBody(WfmHistoricalAdherenceQueryForUsers body) {
		...
		public PostWorkforcemanagementAdherenceHistoricalRequest build() {
