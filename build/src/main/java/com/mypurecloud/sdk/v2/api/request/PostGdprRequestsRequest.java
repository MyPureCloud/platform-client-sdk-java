...
public class PostGdprRequestsRequest {
	...
	public void setBody(GDPRRequest body) {
		this.body = body;
	}

	public PostGdprRequestsRequest withBody(GDPRRequest body) {
	    this.setBody(body);
	    return this;
	} 
	...
	public PostGdprRequestsRequest withDeleteConfirmed(Boolean deleteConfirmed) {
    ...
    public PostGdprRequestsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<GDPRRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostGdprRequestsRequest.");
        }
