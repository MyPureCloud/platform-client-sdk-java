...
public class DeleteKnowledgeKnowledgebaseCategoryRequest {
	...
	public DeleteKnowledgeKnowledgebaseCategoryRequest withKnowledgeBaseId(String knowledgeBaseId) {
	...
	public DeleteKnowledgeKnowledgebaseCategoryRequest withCategoryId(String categoryId) {
    ...
    public DeleteKnowledgeKnowledgebaseCategoryRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.knowledgeBaseId == null) {
            throw new IllegalStateException("Missing the required parameter 'knowledgeBaseId' when building request for DeleteKnowledgeKnowledgebaseCategoryRequest.");
        }
        
        // verify the required parameter 'categoryId' is set
        if (this.categoryId == null) {
            throw new IllegalStateException("Missing the required parameter 'categoryId' when building request for DeleteKnowledgeKnowledgebaseCategoryRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/categories/{categoryId}")
	...
	public static Builder builder(String knowledgeBaseId, String categoryId) {
	    return new Builder()
	            .withRequiredParams(knowledgeBaseId, categoryId);
	}


	public static class Builder {
		private final DeleteKnowledgeKnowledgebaseCategoryRequest request;

		private Builder() {
			request = new DeleteKnowledgeKnowledgebaseCategoryRequest();
		}
		...
		public Builder withRequiredParams(String knowledgeBaseId, String categoryId) {
			request.setKnowledgeBaseId(knowledgeBaseId);
			request.setCategoryId(categoryId);
		...
		public DeleteKnowledgeKnowledgebaseCategoryRequest build() {
