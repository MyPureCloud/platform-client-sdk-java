...
public class PutJourneyViewsEventdefinitionRequest {
	...
	public PutJourneyViewsEventdefinitionRequest withEventDefinitionId(String eventDefinitionId) {
	    this.setEventDefinitionId(eventDefinitionId);
	    return this;
	} 

	private UpdateExternalEventRequest body;
	public UpdateExternalEventRequest getBody() {
		return this.body;
	}

	public void setBody(UpdateExternalEventRequest body) {
		this.body = body;
	}

	public PutJourneyViewsEventdefinitionRequest withBody(UpdateExternalEventRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutJourneyViewsEventdefinitionRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<UpdateExternalEventRequest> withHttpInfo() {
        
        // verify the required parameter 'eventDefinitionId' is set
        if (this.eventDefinitionId == null) {
            throw new IllegalStateException("Missing the required parameter 'eventDefinitionId' when building request for PutJourneyViewsEventdefinitionRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/journey/views/eventdefinitions/{eventDefinitionId}")
	...
	public static class Builder {
		private final PutJourneyViewsEventdefinitionRequest request;

		private Builder() {
			request = new PutJourneyViewsEventdefinitionRequest();
		}
		...
		public Builder withBody(UpdateExternalEventRequest body) {
		...
		public PutJourneyViewsEventdefinitionRequest build() {
