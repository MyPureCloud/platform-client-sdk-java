...
public class GetWorkforcemanagementShrinkageJobRequest {
	...
	public GetWorkforcemanagementShrinkageJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetWorkforcemanagementShrinkageJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetWorkforcemanagementShrinkageJobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/shrinkage/jobs/{jobId}")
	...
	public static class Builder {
		private final GetWorkforcemanagementShrinkageJobRequest request;

		private Builder() {
			request = new GetWorkforcemanagementShrinkageJobRequest();
		}
		...
		public GetWorkforcemanagementShrinkageJobRequest build() {
