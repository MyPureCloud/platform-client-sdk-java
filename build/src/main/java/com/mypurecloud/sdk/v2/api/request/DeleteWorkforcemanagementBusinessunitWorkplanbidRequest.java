...
public class DeleteWorkforcemanagementBusinessunitWorkplanbidRequest {
	...
	public DeleteWorkforcemanagementBusinessunitWorkplanbidRequest withBusinessUnitId(String businessUnitId) {
	...
	public DeleteWorkforcemanagementBusinessunitWorkplanbidRequest withBidId(String bidId) {
	    this.setBidId(bidId);
	    return this;
	} 
    ...
    public DeleteWorkforcemanagementBusinessunitWorkplanbidRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for DeleteWorkforcemanagementBusinessunitWorkplanbidRequest.");
        }
        
        // verify the required parameter 'bidId' is set
        if (this.bidId == null) {
            throw new IllegalStateException("Missing the required parameter 'bidId' when building request for DeleteWorkforcemanagementBusinessunitWorkplanbidRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/workplanbids/{bidId}")
	...
	public static class Builder {
		private final DeleteWorkforcemanagementBusinessunitWorkplanbidRequest request;

		private Builder() {
			request = new DeleteWorkforcemanagementBusinessunitWorkplanbidRequest();
		}
		...
		public DeleteWorkforcemanagementBusinessunitWorkplanbidRequest build() {
