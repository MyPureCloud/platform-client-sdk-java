...
public class DomainEntityListing  implements Serializable, PagedResource<DomainEntity> {
  
  private List<DomainEntity> entities = null;
  ...
  /**
   **/
  public DomainEntityListing entities(List<DomainEntity> entities) {
