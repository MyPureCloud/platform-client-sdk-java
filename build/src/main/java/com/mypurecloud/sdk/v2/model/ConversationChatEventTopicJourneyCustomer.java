...
public class ConversationChatEventTopicJourneyCustomer  implements Serializable {
  
  private String id = null;
  private String idType = null;

  public ConversationChatEventTopicJourneyCustomer() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
    }
  }

  public ConversationChatEventTopicJourneyCustomer(Boolean initWithEmptyList) {
   ...
   **/
  public ConversationChatEventTopicJourneyCustomer id(String id) {
    this.id = id;
    return this;
  }
   ...
   **/
  public ConversationChatEventTopicJourneyCustomer idType(String idType) {
    this.idType = idType;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ConversationChatEventTopicJourneyCustomer conversationChatEventTopicJourneyCustomer = (ConversationChatEventTopicJourneyCustomer) o;

    return Objects.equals(this.id, conversationChatEventTopicJourneyCustomer.id) &&
            Objects.equals(this.idType, conversationChatEventTopicJourneyCustomer.idType);
  }
