...
public class GetTelephonyProvidersEdgesPhysicalinterfacesRequest {
	...
	public GetTelephonyProvidersEdgesPhysicalinterfacesRequest withEdgeIds(String edgeIds) {
    ...
    public GetTelephonyProvidersEdgesPhysicalinterfacesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.edgeIds == null) {
            throw new IllegalStateException("Missing the required parameter 'edgeIds' when building request for GetTelephonyProvidersEdgesPhysicalinterfacesRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/telephony/providers/edges/physicalinterfaces")
	...
	public static class Builder {
		private final GetTelephonyProvidersEdgesPhysicalinterfacesRequest request;

		private Builder() {
			request = new GetTelephonyProvidersEdgesPhysicalinterfacesRequest();
		}
		...
		public GetTelephonyProvidersEdgesPhysicalinterfacesRequest build() {
