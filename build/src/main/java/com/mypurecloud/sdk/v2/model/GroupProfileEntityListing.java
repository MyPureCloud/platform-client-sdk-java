...
public class GroupProfileEntityListing  implements Serializable, PagedResource<GroupProfile> {
  
  private List<GroupProfile> entities = null;
  ...
  public GroupProfileEntityListing() {
  ...
  /**
   **/
  public GroupProfileEntityListing entities(List<GroupProfile> entities) {
  ...
  public List<GroupProfile> getEntities() {
    return entities;
  }
  public void setEntities(List<GroupProfile> entities) {
    this.entities = entities;
  }
