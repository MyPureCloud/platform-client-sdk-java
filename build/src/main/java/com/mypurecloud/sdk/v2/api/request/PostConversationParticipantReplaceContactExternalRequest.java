...
public class PostConversationParticipantReplaceContactExternalRequest {
	...
	private TransferToExternalContactRequest body;
	public TransferToExternalContactRequest getBody() {
		return this.body;
	}

	public void setBody(TransferToExternalContactRequest body) {
		this.body = body;
	}
    ...
    public ApiRequest<TransferToExternalContactRequest> withHttpInfo() {
        
        // verify the required parameter 'conversationId' is set
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PostConversationParticipantReplaceContactExternalRequest.");
        }
        
        // verify the required parameter 'participantId' is set
        if (this.participantId == null) {
            throw new IllegalStateException("Missing the required parameter 'participantId' when building request for PostConversationParticipantReplaceContactExternalRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostConversationParticipantReplaceContactExternalRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/conversations/{conversationId}/participants/{participantId}/replace/contact/external")
	...
	public static Builder builder(String conversationId, String participantId, TransferToExternalContactRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostConversationParticipantReplaceContactExternalRequest request;

		private Builder() {
			request = new PostConversationParticipantReplaceContactExternalRequest();
		}
		...
		public Builder withBody(TransferToExternalContactRequest body) {
		...
		public Builder withRequiredParams(String conversationId, String participantId, TransferToExternalContactRequest body) {
			request.setConversationId(conversationId);
			request.setParticipantId(participantId);
			request.setBody(body);
		...
		public PostConversationParticipantReplaceContactExternalRequest build() {
