...
public class GetResponsemanagementResponsesDivisionviewRequest {
	...
	public GetResponsemanagementResponsesDivisionviewRequest withResponseId(String responseId) {
    ...
    public GetResponsemanagementResponsesDivisionviewRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.responseId == null) {
            throw new IllegalStateException("Missing the required parameter 'responseId' when building request for GetResponsemanagementResponsesDivisionviewRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/responsemanagement/responses/divisionviews/{responseId}")
	...
	public static class Builder {
		private final GetResponsemanagementResponsesDivisionviewRequest request;

		private Builder() {
			request = new GetResponsemanagementResponsesDivisionviewRequest();
		}
		...
		public GetResponsemanagementResponsesDivisionviewRequest build() {
