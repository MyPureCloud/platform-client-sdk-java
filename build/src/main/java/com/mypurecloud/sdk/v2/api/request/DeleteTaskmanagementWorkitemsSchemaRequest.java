...
public class DeleteTaskmanagementWorkitemsSchemaRequest {
	...
	public DeleteTaskmanagementWorkitemsSchemaRequest withSchemaId(String schemaId) {
    ...
    public DeleteTaskmanagementWorkitemsSchemaRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.schemaId == null) {
            throw new IllegalStateException("Missing the required parameter 'schemaId' when building request for DeleteTaskmanagementWorkitemsSchemaRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/taskmanagement/workitems/schemas/{schemaId}")
	...
	public static class Builder {
		private final DeleteTaskmanagementWorkitemsSchemaRequest request;

		private Builder() {
			request = new DeleteTaskmanagementWorkitemsSchemaRequest();
		}
		...
		public DeleteTaskmanagementWorkitemsSchemaRequest build() {
