...
public class PostConversationsEmailMessagesRequest {
    ...
    public ApiRequest<EmailMessage> withHttpInfo() throws ApiException {
        ...
        if (this.emailId == null) {
            throw new ApiException(400, "Missing the required parameter 'emailId' when building request for PostConversationsEmailMessagesRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new ApiException(400, "Missing the required parameter 'body' when building request for PostConversationsEmailMessagesRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/conversations/emails/{emailId}/messages")
	...
	public static class Builder {
		private final PostConversationsEmailMessagesRequest request;

		private Builder() {
			request = new PostConversationsEmailMessagesRequest();
		}
