...
public class DeleteKnowledgeKnowledgebaseDocumentRequest {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("DELETE", "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/documents/{documentId}")
	...
	public static class Builder {
		private final DeleteKnowledgeKnowledgebaseDocumentRequest request;

		private Builder() {
			request = new DeleteKnowledgeKnowledgebaseDocumentRequest();
		}
