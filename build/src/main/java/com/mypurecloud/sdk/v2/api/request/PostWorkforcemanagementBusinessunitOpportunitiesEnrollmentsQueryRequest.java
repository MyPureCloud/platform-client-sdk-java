...
public class PostWorkforcemanagementBusinessunitOpportunitiesEnrollmentsQueryRequest {
	...
	public PostWorkforcemanagementBusinessunitOpportunitiesEnrollmentsQueryRequest withBusinessUnitId(String businessUnitId) {
	    this.setBusinessUnitId(businessUnitId);
	    return this;
	} 

	private QueryOpportunityEnrollmentsRequest body;
	public QueryOpportunityEnrollmentsRequest getBody() {
		return this.body;
	}

	public void setBody(QueryOpportunityEnrollmentsRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementBusinessunitOpportunitiesEnrollmentsQueryRequest withBody(QueryOpportunityEnrollmentsRequest body) {
	    this.setBody(body);
	    return this;
	} 
	...
	public PostWorkforcemanagementBusinessunitOpportunitiesEnrollmentsQueryRequest withExpand(String expand) {
	...
	public PostWorkforcemanagementBusinessunitOpportunitiesEnrollmentsQueryRequest withForceDownloadService(Boolean forceDownloadService) {
    ...
    public PostWorkforcemanagementBusinessunitOpportunitiesEnrollmentsQueryRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<QueryOpportunityEnrollmentsRequest> withHttpInfo() {
        
        // verify the required parameter 'businessUnitId' is set
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PostWorkforcemanagementBusinessunitOpportunitiesEnrollmentsQueryRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementBusinessunitOpportunitiesEnrollmentsQueryRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/opportunities/enrollments/query")
	...
	public static Builder builder(String businessUnitId, QueryOpportunityEnrollmentsRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementBusinessunitOpportunitiesEnrollmentsQueryRequest request;

		private Builder() {
			request = new PostWorkforcemanagementBusinessunitOpportunitiesEnrollmentsQueryRequest();
		}
		...
		public Builder withBody(QueryOpportunityEnrollmentsRequest body) {
		...
		public Builder withRequiredParams(String businessUnitId, QueryOpportunityEnrollmentsRequest body) {
			request.setBusinessUnitId(businessUnitId);
			request.setBody(body);
		...
		public PostWorkforcemanagementBusinessunitOpportunitiesEnrollmentsQueryRequest build() {
