...
public class GetWorkforcemanagementManagementunitSchedulingRunsRequest {
	...
	public GetWorkforcemanagementManagementunitSchedulingRunsRequest withManagementUnitId(String managementUnitId) {
    ...
    public GetWorkforcemanagementManagementunitSchedulingRunsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.managementUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'managementUnitId' when building request for GetWorkforcemanagementManagementunitSchedulingRunsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/managementunits/{managementUnitId}/scheduling/runs")
	...
	public static class Builder {
		private final GetWorkforcemanagementManagementunitSchedulingRunsRequest request;

		private Builder() {
			request = new GetWorkforcemanagementManagementunitSchedulingRunsRequest();
		}
		...
		public GetWorkforcemanagementManagementunitSchedulingRunsRequest build() {
