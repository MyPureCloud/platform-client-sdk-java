...
public class GetGamificationScorecardsRequest {
	...
	public GetGamificationScorecardsRequest withWorkday(LocalDate workday) {
	...
	public GetGamificationScorecardsRequest withExpand(List<String> expand) {
    ...
    public GetGamificationScorecardsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.workday == null) {
            throw new IllegalStateException("Missing the required parameter 'workday' when building request for GetGamificationScorecardsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/gamification/scorecards")
	...
	public static class Builder {
		private final GetGamificationScorecardsRequest request;

		private Builder() {
			request = new GetGamificationScorecardsRequest();
		}
		...
		public GetGamificationScorecardsRequest build() {
