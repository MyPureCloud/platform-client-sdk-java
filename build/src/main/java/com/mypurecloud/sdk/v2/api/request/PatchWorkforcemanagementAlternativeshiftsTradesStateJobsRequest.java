...
public class PatchWorkforcemanagementAlternativeshiftsTradesStateJobsRequest {

	private AdminBulkUpdateAlternativeShiftTradeStateRequest body;
	public AdminBulkUpdateAlternativeShiftTradeStateRequest getBody() {
		return this.body;
	}

	public void setBody(AdminBulkUpdateAlternativeShiftTradeStateRequest body) {
		this.body = body;
	}

	public PatchWorkforcemanagementAlternativeshiftsTradesStateJobsRequest withBody(AdminBulkUpdateAlternativeShiftTradeStateRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchWorkforcemanagementAlternativeshiftsTradesStateJobsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<AdminBulkUpdateAlternativeShiftTradeStateRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchWorkforcemanagementAlternativeshiftsTradesStateJobsRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/workforcemanagement/alternativeshifts/trades/state/jobs")
                .withBody(body)
	...
	public static Builder builder(AdminBulkUpdateAlternativeShiftTradeStateRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PatchWorkforcemanagementAlternativeshiftsTradesStateJobsRequest request;

		private Builder() {
			request = new PatchWorkforcemanagementAlternativeshiftsTradesStateJobsRequest();
		}


		public Builder withBody(AdminBulkUpdateAlternativeShiftTradeStateRequest body) {
		...
		public Builder withRequiredParams(AdminBulkUpdateAlternativeShiftTradeStateRequest body) {
			request.setBody(body);
		...
		public PatchWorkforcemanagementAlternativeshiftsTradesStateJobsRequest build() {
