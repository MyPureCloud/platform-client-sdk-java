...
public class DeleteAnalyticsResolutionsAggregatesJobRequest {
	...
	public DeleteAnalyticsResolutionsAggregatesJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public DeleteAnalyticsResolutionsAggregatesJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for DeleteAnalyticsResolutionsAggregatesJobRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/analytics/resolutions/aggregates/jobs/{jobId}")
	...
	public static class Builder {
		private final DeleteAnalyticsResolutionsAggregatesJobRequest request;

		private Builder() {
			request = new DeleteAnalyticsResolutionsAggregatesJobRequest();
		}
		...
		public DeleteAnalyticsResolutionsAggregatesJobRequest build() {
