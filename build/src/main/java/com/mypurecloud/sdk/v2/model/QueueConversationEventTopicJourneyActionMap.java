...
public class QueueConversationEventTopicJourneyActionMap  implements Serializable {
  
  private String id = null;
  private Long version = null;

  public QueueConversationEventTopicJourneyActionMap() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
    }
  }

  public QueueConversationEventTopicJourneyActionMap(Boolean initWithEmptyList) {
   ...
   **/
  public QueueConversationEventTopicJourneyActionMap id(String id) {
    this.id = id;
    return this;
  }
   ...
   **/
  public QueueConversationEventTopicJourneyActionMap version(Long version) {
