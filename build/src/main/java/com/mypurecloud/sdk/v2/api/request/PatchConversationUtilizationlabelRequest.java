...
public class PatchConversationUtilizationlabelRequest {
	...
	public PatchConversationUtilizationlabelRequest withConversationId(String conversationId) {
	    this.setConversationId(conversationId);
	    return this;
	} 

	private ConversationUtilizationLabelUpdate body;
	public ConversationUtilizationLabelUpdate getBody() {
		return this.body;
	}

	public void setBody(ConversationUtilizationLabelUpdate body) {
		this.body = body;
	}

	public PatchConversationUtilizationlabelRequest withBody(ConversationUtilizationLabelUpdate body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchConversationUtilizationlabelRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<ConversationUtilizationLabelUpdate> withHttpInfo() {
        
        // verify the required parameter 'conversationId' is set
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PatchConversationUtilizationlabelRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchConversationUtilizationlabelRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/conversations/{conversationId}/utilizationlabel")
	...
	public static Builder builder(String conversationId, ConversationUtilizationLabelUpdate body) {
	    return new Builder()
	...
	public static class Builder {
		private final PatchConversationUtilizationlabelRequest request;

		private Builder() {
			request = new PatchConversationUtilizationlabelRequest();
		}
		...
		public Builder withBody(ConversationUtilizationLabelUpdate body) {
		...
		public Builder withRequiredParams(String conversationId, ConversationUtilizationLabelUpdate body) {
			request.setConversationId(conversationId);
			request.setBody(body);
		...
		public PatchConversationUtilizationlabelRequest build() {
