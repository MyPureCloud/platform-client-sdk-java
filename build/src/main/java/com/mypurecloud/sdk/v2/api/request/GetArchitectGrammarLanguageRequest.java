...
public class GetArchitectGrammarLanguageRequest {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/architect/grammars/{grammarId}/languages/{languageCode}")
	...
	public static class Builder {
		private final GetArchitectGrammarLanguageRequest request;

		private Builder() {
			request = new GetArchitectGrammarLanguageRequest();
		}
