...
public class PostKnowledgeKnowledgebaseSourcesServicenowRequest {
	...
	public PostKnowledgeKnowledgebaseSourcesServicenowRequest withKnowledgeBaseId(String knowledgeBaseId) {
	...
	public PostKnowledgeKnowledgebaseSourcesServicenowRequest withBody(ServiceNowSourceRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostKnowledgeKnowledgebaseSourcesServicenowRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<ServiceNowSourceRequest> withHttpInfo() {
        ...
        if (this.knowledgeBaseId == null) {
            throw new IllegalStateException("Missing the required parameter 'knowledgeBaseId' when building request for PostKnowledgeKnowledgebaseSourcesServicenowRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostKnowledgeKnowledgebaseSourcesServicenowRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/sources/servicenow")
	...
	public static Builder builder(String knowledgeBaseId, ServiceNowSourceRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostKnowledgeKnowledgebaseSourcesServicenowRequest request;

		private Builder() {
			request = new PostKnowledgeKnowledgebaseSourcesServicenowRequest();
		}
		...
		public Builder withRequiredParams(String knowledgeBaseId, ServiceNowSourceRequest body) {
			request.setKnowledgeBaseId(knowledgeBaseId);
			request.setBody(body);
		...
		public PostKnowledgeKnowledgebaseSourcesServicenowRequest build() {
