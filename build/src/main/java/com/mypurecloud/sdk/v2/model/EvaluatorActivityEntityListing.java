...
import com.mypurecloud.sdk.v2.model.EvaluatorActivity;
...
public class EvaluatorActivityEntityListing  implements Serializable, PagedResource<EvaluatorActivity> {
  
  private List<EvaluatorActivity> entities = null;
  ...
  public EvaluatorActivityEntityListing() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
      entities = new ArrayList<EvaluatorActivity>();
    }
  }

  public EvaluatorActivityEntityListing(Boolean initWithEmptyList) {
  ...
  /**
   **/
  public EvaluatorActivityEntityListing entities(List<EvaluatorActivity> entities) {
