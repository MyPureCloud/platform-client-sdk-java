...
public class GetQualityProgramAgentscoringrulesRequest {
	...
	public GetQualityProgramAgentscoringrulesRequest withProgramId(String programId) {
    ...
    public GetQualityProgramAgentscoringrulesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.programId == null) {
            throw new IllegalStateException("Missing the required parameter 'programId' when building request for GetQualityProgramAgentscoringrulesRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/quality/programs/{programId}/agentscoringrules")
	...
	public static class Builder {
		private final GetQualityProgramAgentscoringrulesRequest request;

		private Builder() {
			request = new GetQualityProgramAgentscoringrulesRequest();
		}
		...
		public GetQualityProgramAgentscoringrulesRequest build() {
