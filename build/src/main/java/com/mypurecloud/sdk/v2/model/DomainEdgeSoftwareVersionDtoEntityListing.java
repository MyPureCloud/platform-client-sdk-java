...
public class DomainEdgeSoftwareVersionDtoEntityListing  implements Serializable, PagedResource<DomainEdgeSoftwareVersionDto> {
  
  private List<DomainEdgeSoftwareVersionDto> entities = new ArrayList<DomainEdgeSoftwareVersionDto>();
  ...
  /**
   **/
  public DomainEdgeSoftwareVersionDtoEntityListing entities(List<DomainEdgeSoftwareVersionDto> entities) {
  ...
  public List<DomainEdgeSoftwareVersionDto> getEntities() {
    return entities;
  }
  public void setEntities(List<DomainEdgeSoftwareVersionDto> entities) {
    this.entities = entities;
  }
