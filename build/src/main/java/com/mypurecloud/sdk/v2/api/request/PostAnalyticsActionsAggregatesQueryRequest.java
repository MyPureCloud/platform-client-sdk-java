...
public class PostAnalyticsActionsAggregatesQueryRequest {

	private ActionAggregationQuery body;
	public ActionAggregationQuery getBody() {
		return this.body;
	}

	public void setBody(ActionAggregationQuery body) {
		this.body = body;
	}

	public PostAnalyticsActionsAggregatesQueryRequest withBody(ActionAggregationQuery body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostAnalyticsActionsAggregatesQueryRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<ActionAggregationQuery> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostAnalyticsActionsAggregatesQueryRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/analytics/actions/aggregates/query")
                .withBody(body)
	...
	public static Builder builder(ActionAggregationQuery body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostAnalyticsActionsAggregatesQueryRequest request;

		private Builder() {
			request = new PostAnalyticsActionsAggregatesQueryRequest();
		}


		public Builder withBody(ActionAggregationQuery body) {
		...
		public Builder withRequiredParams(ActionAggregationQuery body) {
			request.setBody(body);
		...
		public PostAnalyticsActionsAggregatesQueryRequest build() {
