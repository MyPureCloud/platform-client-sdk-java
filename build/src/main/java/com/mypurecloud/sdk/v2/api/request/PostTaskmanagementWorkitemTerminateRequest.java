...
public class PostTaskmanagementWorkitemTerminateRequest {
	...
	public PostTaskmanagementWorkitemTerminateRequest withWorkitemId(String workitemId) {
	    this.setWorkitemId(workitemId);
	    return this;
	} 

	private WorkitemTerminate body;
	public WorkitemTerminate getBody() {
		return this.body;
	}

	public void setBody(WorkitemTerminate body) {
		this.body = body;
	}

	public PostTaskmanagementWorkitemTerminateRequest withBody(WorkitemTerminate body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostTaskmanagementWorkitemTerminateRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<WorkitemTerminate> withHttpInfo() {
        
        // verify the required parameter 'workitemId' is set
        if (this.workitemId == null) {
            throw new IllegalStateException("Missing the required parameter 'workitemId' when building request for PostTaskmanagementWorkitemTerminateRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/taskmanagement/workitems/{workitemId}/terminate")
	...
	public static class Builder {
		private final PostTaskmanagementWorkitemTerminateRequest request;

		private Builder() {
			request = new PostTaskmanagementWorkitemTerminateRequest();
		}
		...
		public Builder withBody(WorkitemTerminate body) {
		...
		public PostTaskmanagementWorkitemTerminateRequest build() {
