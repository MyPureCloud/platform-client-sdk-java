...
public class GetBusinessrulesDecisiontableVersionRequest {
	...
	public GetBusinessrulesDecisiontableVersionRequest withTableId(String tableId) {
	...
	public GetBusinessrulesDecisiontableVersionRequest withTableVersion(Integer tableVersion) {
    ...
    public GetBusinessrulesDecisiontableVersionRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.tableId == null) {
            throw new IllegalStateException("Missing the required parameter 'tableId' when building request for GetBusinessrulesDecisiontableVersionRequest.");
        }
        
        // verify the required parameter 'tableVersion' is set
        if (this.tableVersion == null) {
            throw new IllegalStateException("Missing the required parameter 'tableVersion' when building request for GetBusinessrulesDecisiontableVersionRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/businessrules/decisiontables/{tableId}/versions/{tableVersion}")
	...
	public static class Builder {
		private final GetBusinessrulesDecisiontableVersionRequest request;

		private Builder() {
			request = new GetBusinessrulesDecisiontableVersionRequest();
		}
		...
		public GetBusinessrulesDecisiontableVersionRequest build() {
