...
public class GetWorkforcemanagementBusinessunitDecisionmetricsJobRequest {
	...
	public GetWorkforcemanagementBusinessunitDecisionmetricsJobRequest withBusinessUnitId(String businessUnitId) {
	...
	public GetWorkforcemanagementBusinessunitDecisionmetricsJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetWorkforcemanagementBusinessunitDecisionmetricsJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for GetWorkforcemanagementBusinessunitDecisionmetricsJobRequest.");
        }
        
        // verify the required parameter 'jobId' is set
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetWorkforcemanagementBusinessunitDecisionmetricsJobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/decisionmetrics/jobs/{jobId}")
	...
	public static class Builder {
		private final GetWorkforcemanagementBusinessunitDecisionmetricsJobRequest request;

		private Builder() {
			request = new GetWorkforcemanagementBusinessunitDecisionmetricsJobRequest();
		}
		...
		public GetWorkforcemanagementBusinessunitDecisionmetricsJobRequest build() {
