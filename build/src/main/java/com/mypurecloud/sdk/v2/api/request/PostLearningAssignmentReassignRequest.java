...
public class PostLearningAssignmentReassignRequest {
	...
	public PostLearningAssignmentReassignRequest withAssignmentId(String assignmentId) {
    ...
    public PostLearningAssignmentReassignRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.assignmentId == null) {
            throw new IllegalStateException("Missing the required parameter 'assignmentId' when building request for PostLearningAssignmentReassignRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/learning/assignments/{assignmentId}/reassign")
	...
	public static class Builder {
		private final PostLearningAssignmentReassignRequest request;

		private Builder() {
			request = new PostLearningAssignmentReassignRequest();
		}
		...
		public PostLearningAssignmentReassignRequest build() {
