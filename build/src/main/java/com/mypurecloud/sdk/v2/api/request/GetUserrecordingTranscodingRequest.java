...
public class GetUserrecordingTranscodingRequest {
	...
	public GetUserrecordingTranscodingRequest withRecordingId(String recordingId) {
	...
	public GetUserrecordingTranscodingRequest withFormatId(String formatId) {
    ...
    public GetUserrecordingTranscodingRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.recordingId == null) {
            throw new IllegalStateException("Missing the required parameter 'recordingId' when building request for GetUserrecordingTranscodingRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/userrecordings/{recordingId}/transcoding")
	...
	public static class Builder {
		private final GetUserrecordingTranscodingRequest request;

		private Builder() {
			request = new GetUserrecordingTranscodingRequest();
		}
		...
		public GetUserrecordingTranscodingRequest build() {
