...
public class PostWorkforcemanagementBusinessunitUnavailabletimesSchedulesQueryRequest {
	...
	private QueryAgentScheduleUnavailableTimesRequest body;
	public QueryAgentScheduleUnavailableTimesRequest getBody() {
		return this.body;
	}

	public void setBody(QueryAgentScheduleUnavailableTimesRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementBusinessunitUnavailabletimesSchedulesQueryRequest withBody(QueryAgentScheduleUnavailableTimesRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public ApiRequest<QueryAgentScheduleUnavailableTimesRequest> withHttpInfo() {
        
        // verify the required parameter 'businessUnitId' is set
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PostWorkforcemanagementBusinessunitUnavailabletimesSchedulesQueryRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementBusinessunitUnavailabletimesSchedulesQueryRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/unavailabletimes/schedules/query")
	...
	public static Builder builder(String businessUnitId, QueryAgentScheduleUnavailableTimesRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementBusinessunitUnavailabletimesSchedulesQueryRequest request;

		private Builder() {
			request = new PostWorkforcemanagementBusinessunitUnavailabletimesSchedulesQueryRequest();
		}
		...
		public Builder withBody(QueryAgentScheduleUnavailableTimesRequest body) {
		...
		public Builder withRequiredParams(String businessUnitId, QueryAgentScheduleUnavailableTimesRequest body) {
			request.setBusinessUnitId(businessUnitId);
			request.setBody(body);
		...
		public PostWorkforcemanagementBusinessunitUnavailabletimesSchedulesQueryRequest build() {
