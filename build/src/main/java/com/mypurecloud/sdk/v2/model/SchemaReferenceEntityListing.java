...
import com.mypurecloud.sdk.v2.model.DomainSchemaReference;
...
public class SchemaReferenceEntityListing  implements Serializable, PagedResource<DomainSchemaReference> {
  ...
  /**
   **/
  public SchemaReferenceEntityListing entities(List<DomainSchemaReference> entities) {
  ...
  public List<DomainSchemaReference> getEntities() {
    return entities;
  }
  public void setEntities(List<DomainSchemaReference> entities) {
    this.entities = entities;
  }
