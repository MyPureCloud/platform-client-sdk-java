...
public class TranscriptAggregateQueryResponse  implements Serializable {
  ...
  public TranscriptAggregateQueryResponse() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
      results = new ArrayList<TranscriptAggregateDataContainer>();
    }
  }

  public TranscriptAggregateQueryResponse(Boolean initWithEmptyList) {
  ...
  /**
   **/
  public TranscriptAggregateQueryResponse results(List<TranscriptAggregateDataContainer> results) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TranscriptAggregateQueryResponse transcriptAggregateQueryResponse = (TranscriptAggregateQueryResponse) o;

    return Objects.equals(this.results, transcriptAggregateQueryResponse.results);
  }
