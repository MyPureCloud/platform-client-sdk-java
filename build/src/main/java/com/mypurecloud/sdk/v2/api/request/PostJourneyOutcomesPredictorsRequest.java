...
public class PostJourneyOutcomesPredictorsRequest {

	private OutcomePredictorRequest body;
	public OutcomePredictorRequest getBody() {
		return this.body;
	}

	public void setBody(OutcomePredictorRequest body) {
		this.body = body;
	}

	public PostJourneyOutcomesPredictorsRequest withBody(OutcomePredictorRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostJourneyOutcomesPredictorsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<OutcomePredictorRequest> withHttpInfo() {
        

        return ApiRequestBuilder.create("POST", "/api/v2/journey/outcomes/predictors")
                .withBody(body)
	...
	public static class Builder {
		private final PostJourneyOutcomesPredictorsRequest request;

		private Builder() {
			request = new PostJourneyOutcomesPredictorsRequest();
		}


		public Builder withBody(OutcomePredictorRequest body) {
		...
		public PostJourneyOutcomesPredictorsRequest build() {
