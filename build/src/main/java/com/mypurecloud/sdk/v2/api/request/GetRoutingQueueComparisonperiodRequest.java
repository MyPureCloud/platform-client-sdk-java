...
public class GetRoutingQueueComparisonperiodRequest {
	...
	public GetRoutingQueueComparisonperiodRequest withQueueId(String queueId) {
	    this.setQueueId(queueId);
	    return this;
	} 
	
	private String comparisonPeriodId;
	public String getComparisonPeriodId() {
		return this.comparisonPeriodId;
	}

	public void setComparisonPeriodId(String comparisonPeriodId) {
		this.comparisonPeriodId = comparisonPeriodId;
	}

	public GetRoutingQueueComparisonperiodRequest withComparisonPeriodId(String comparisonPeriodId) {
	    this.setComparisonPeriodId(comparisonPeriodId);
	    return this;
	} 
    ...
    public GetRoutingQueueComparisonperiodRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.queueId == null) {
            throw new IllegalStateException("Missing the required parameter 'queueId' when building request for GetRoutingQueueComparisonperiodRequest.");
        }
        
        // verify the required parameter 'comparisonPeriodId' is set
        if (this.comparisonPeriodId == null) {
            throw new IllegalStateException("Missing the required parameter 'comparisonPeriodId' when building request for GetRoutingQueueComparisonperiodRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/routing/queues/{queueId}/comparisonperiods/{comparisonPeriodId}")
                .withPathParameter("queueId", queueId)
        
                .withPathParameter("comparisonPeriodId", comparisonPeriodId)
	...
	public static Builder builder(String queueId, String comparisonPeriodId) {
	    return new Builder()
	            .withRequiredParams(queueId, comparisonPeriodId);
	}
	

	public static class Builder {
		private final GetRoutingQueueComparisonperiodRequest request;

		private Builder() {
			request = new GetRoutingQueueComparisonperiodRequest();
		}
		...
		public Builder withComparisonPeriodId(String comparisonPeriodId) {
			request.setComparisonPeriodId(comparisonPeriodId);
			return this;
		}
		

		
		public Builder withRequiredParams(String queueId, String comparisonPeriodId) {
			request.setQueueId(queueId);
						request.setComparisonPeriodId(comparisonPeriodId);
		...
		public GetRoutingQueueComparisonperiodRequest build() {
            ...
            // verify the required parameter 'comparisonPeriodId' is set
            if (request.comparisonPeriodId == null) {
                throw new IllegalStateException("Missing the required parameter 'comparisonPeriodId' when building request for GetRoutingQueueComparisonperiodRequest.");
            }
