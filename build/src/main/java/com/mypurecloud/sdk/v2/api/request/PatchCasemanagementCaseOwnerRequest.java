...
public class PatchCasemanagementCaseOwnerRequest {
	...
	public PatchCasemanagementCaseOwnerRequest withCaseId(String caseId) {
	    this.setCaseId(caseId);
	    return this;
	} 

	private CaseOwnerUpdate body;
	public CaseOwnerUpdate getBody() {
		return this.body;
	}

	public void setBody(CaseOwnerUpdate body) {
		this.body = body;
	}

	public PatchCasemanagementCaseOwnerRequest withBody(CaseOwnerUpdate body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchCasemanagementCaseOwnerRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<CaseOwnerUpdate> withHttpInfo() {
        
        // verify the required parameter 'caseId' is set
        if (this.caseId == null) {
            throw new IllegalStateException("Missing the required parameter 'caseId' when building request for PatchCasemanagementCaseOwnerRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchCasemanagementCaseOwnerRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/casemanagement/cases/{caseId}/owner")
	...
	public static Builder builder(String caseId, CaseOwnerUpdate body) {
	    return new Builder()
	...
	public static class Builder {
		private final PatchCasemanagementCaseOwnerRequest request;

		private Builder() {
			request = new PatchCasemanagementCaseOwnerRequest();
		}
		...
		public Builder withBody(CaseOwnerUpdate body) {
		...
		public Builder withRequiredParams(String caseId, CaseOwnerUpdate body) {
			request.setCaseId(caseId);
			request.setBody(body);
		...
		public PatchCasemanagementCaseOwnerRequest build() {
