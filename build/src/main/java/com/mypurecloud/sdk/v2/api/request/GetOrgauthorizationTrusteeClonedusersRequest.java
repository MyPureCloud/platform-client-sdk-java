...
public class GetOrgauthorizationTrusteeClonedusersRequest {
	...
	public GetOrgauthorizationTrusteeClonedusersRequest withTrusteeOrgId(String trusteeOrgId) {
    ...
    public GetOrgauthorizationTrusteeClonedusersRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.trusteeOrgId == null) {
            throw new IllegalStateException("Missing the required parameter 'trusteeOrgId' when building request for GetOrgauthorizationTrusteeClonedusersRequest.");
        }
