...
public class GetAnalyticsTaskmanagementAggregatesJobResultsRequest {
	...
	public GetAnalyticsTaskmanagementAggregatesJobResultsRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
	...
	public GetAnalyticsTaskmanagementAggregatesJobResultsRequest withCursor(String cursor) {
    ...
    public GetAnalyticsTaskmanagementAggregatesJobResultsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetAnalyticsTaskmanagementAggregatesJobResultsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/analytics/taskmanagement/aggregates/jobs/{jobId}/results")
	...
	public static class Builder {
		private final GetAnalyticsTaskmanagementAggregatesJobResultsRequest request;

		private Builder() {
			request = new GetAnalyticsTaskmanagementAggregatesJobResultsRequest();
		}
		...
		public GetAnalyticsTaskmanagementAggregatesJobResultsRequest build() {
