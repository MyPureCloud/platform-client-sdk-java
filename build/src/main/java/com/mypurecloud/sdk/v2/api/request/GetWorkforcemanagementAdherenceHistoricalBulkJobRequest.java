...
public class GetWorkforcemanagementAdherenceHistoricalBulkJobRequest {
	...
	public GetWorkforcemanagementAdherenceHistoricalBulkJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetWorkforcemanagementAdherenceHistoricalBulkJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetWorkforcemanagementAdherenceHistoricalBulkJobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/adherence/historical/bulk/jobs/{jobId}")
	...
	public static class Builder {
		private final GetWorkforcemanagementAdherenceHistoricalBulkJobRequest request;

		private Builder() {
			request = new GetWorkforcemanagementAdherenceHistoricalBulkJobRequest();
		}
		...
		public GetWorkforcemanagementAdherenceHistoricalBulkJobRequest build() {
