...
public class PutConversationTagsRequest {
	...
	public PutConversationTagsRequest withConversationId(String conversationId) {
	    this.setConversationId(conversationId);
	    return this;
	} 
	
	private ConversationTagsUpdate body;
	public ConversationTagsUpdate getBody() {
		return this.body;
	}

	public void setBody(ConversationTagsUpdate body) {
		this.body = body;
	}

	public PutConversationTagsRequest withBody(ConversationTagsUpdate body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutConversationTagsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<ConversationTagsUpdate> withHttpInfo() {
        
        // verify the required parameter 'conversationId' is set
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PutConversationTagsRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutConversationTagsRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/conversations/{conversationId}/tags")
	...
	public static Builder builder(String conversationId, ConversationTagsUpdate body) {
	    return new Builder()
	...
	public static class Builder {
		private final PutConversationTagsRequest request;

		private Builder() {
			request = new PutConversationTagsRequest();
		}
		...
		public Builder withBody(ConversationTagsUpdate body) {
		...
		public Builder withRequiredParams(String conversationId, ConversationTagsUpdate body) {
			request.setConversationId(conversationId);
						request.setBody(body);
		...
		public PutConversationTagsRequest build() {
