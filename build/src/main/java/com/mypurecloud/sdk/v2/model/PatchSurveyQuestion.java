...
public class PatchSurveyQuestion  implements Serializable {
 ...
 @JsonDeserialize(using = CustomerPropertyEnumDeserializer.class)
   ...
   * Type of survey question.
   **/
  public PatchSurveyQuestion type(TypeEnum type) {
    this.type = type;
    return this;
  }
   ...
   * Label of question.
   **/
  public PatchSurveyQuestion label(String label) {
    this.label = label;
    return this;
  }
   ...
   * The customer property that the answer maps to.
   **/
  public PatchSurveyQuestion customerProperty(CustomerPropertyEnum customerProperty) {
   ...
   **/
  public PatchSurveyQuestion choices(List<String> choices) {
   ...
   **/
  public PatchSurveyQuestion isMandatory(Boolean isMandatory) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PatchSurveyQuestion patchSurveyQuestion = (PatchSurveyQuestion) o;
    return Objects.equals(this.type, patchSurveyQuestion.type) &&
        Objects.equals(this.label, patchSurveyQuestion.label) &&
        Objects.equals(this.customerProperty, patchSurveyQuestion.customerProperty) &&
        Objects.equals(this.choices, patchSurveyQuestion.choices) &&
        Objects.equals(this.isMandatory, patchSurveyQuestion.isMandatory);
  }
