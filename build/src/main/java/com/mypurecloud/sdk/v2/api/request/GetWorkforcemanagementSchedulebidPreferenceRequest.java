...
public class GetWorkforcemanagementSchedulebidPreferenceRequest {
	...
	public GetWorkforcemanagementSchedulebidPreferenceRequest withBidId(String bidId) {
	    this.setBidId(bidId);
	    return this;
	} 
    ...
    public GetWorkforcemanagementSchedulebidPreferenceRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.bidId == null) {
            throw new IllegalStateException("Missing the required parameter 'bidId' when building request for GetWorkforcemanagementSchedulebidPreferenceRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/schedulebids/{bidId}/preference")
	...
	public static class Builder {
		private final GetWorkforcemanagementSchedulebidPreferenceRequest request;

		private Builder() {
			request = new GetWorkforcemanagementSchedulebidPreferenceRequest();
		}
		...
		public GetWorkforcemanagementSchedulebidPreferenceRequest build() {
