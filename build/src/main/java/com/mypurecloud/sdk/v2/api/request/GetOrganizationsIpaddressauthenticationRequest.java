...
public class GetOrganizationsIpaddressauthenticationRequest {
    ...
    public GetOrganizationsIpaddressauthenticationRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/organizations/ipaddressauthentication")
	...
	public static class Builder {
		private final GetOrganizationsIpaddressauthenticationRequest request;

		private Builder() {
			request = new GetOrganizationsIpaddressauthenticationRequest();
		}
		...
		public GetOrganizationsIpaddressauthenticationRequest build() {
