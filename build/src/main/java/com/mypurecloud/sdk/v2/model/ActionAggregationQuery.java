...
public class ActionAggregationQuery  implements Serializable {
 ...
 @JsonDeserialize(using = MetricsEnumDeserializer.class)
  ...
  private List<ActionAggregationView> views = null;
 ...
 @JsonDeserialize(using = AlternateTimeDimensionEnumDeserializer.class)
  ...
  public ActionAggregationQuery() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
      groupBy = new ArrayList<GroupByEnum>();
      metrics = new ArrayList<MetricsEnum>();
      views = new ArrayList<ActionAggregationView>();
    }
  }

  public ActionAggregationQuery(Boolean initWithEmptyList) {
   ...
   **/
  public ActionAggregationQuery interval(String interval) {
   ...
   **/
  public ActionAggregationQuery granularity(String granularity) {
   ...
   **/
  public ActionAggregationQuery timeZone(String timeZone) {
   ...
   **/
  public ActionAggregationQuery groupBy(List<GroupByEnum> groupBy) {
   ...
   **/
  public ActionAggregationQuery filter(ActionAggregateQueryFilter filter) {
    this.filter = filter;
    return this;
  }
   ...
   **/
  public ActionAggregationQuery metrics(List<MetricsEnum> metrics) {
   ...
   **/
  public ActionAggregationQuery flattenMultivaluedDimensions(Boolean flattenMultivaluedDimensions) {
   ...
   **/
  public ActionAggregationQuery views(List<ActionAggregationView> views) {
    this.views = views;
    return this;
  }
   ...
   * Dimension to use as the alternative timestamp for data in the aggregate.  Choosing \"eventTime\" uses the actual time of the data event.
   **/
  public ActionAggregationQuery alternateTimeDimension(AlternateTimeDimensionEnum alternateTimeDimension) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ActionAggregationQuery actionAggregationQuery = (ActionAggregationQuery) o;

    return Objects.equals(this.interval, actionAggregationQuery.interval) &&
            Objects.equals(this.granularity, actionAggregationQuery.granularity) &&
            Objects.equals(this.timeZone, actionAggregationQuery.timeZone) &&
            Objects.equals(this.groupBy, actionAggregationQuery.groupBy) &&
            Objects.equals(this.filter, actionAggregationQuery.filter) &&
            Objects.equals(this.metrics, actionAggregationQuery.metrics) &&
            Objects.equals(this.flattenMultivaluedDimensions, actionAggregationQuery.flattenMultivaluedDimensions) &&
            Objects.equals(this.views, actionAggregationQuery.views) &&
            Objects.equals(this.alternateTimeDimension, actionAggregationQuery.alternateTimeDimension);
  }
