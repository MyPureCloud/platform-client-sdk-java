...
public class DeleteTelephonyProvidersEdgesAlertablepresencesRequest {
    ...
    public DeleteTelephonyProvidersEdgesAlertablepresencesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("DELETE", "/api/v2/telephony/providers/edges/alertablepresences")
	...
	public static class Builder {
		private final DeleteTelephonyProvidersEdgesAlertablepresencesRequest request;

		private Builder() {
			request = new DeleteTelephonyProvidersEdgesAlertablepresencesRequest();
		}
		...
		public DeleteTelephonyProvidersEdgesAlertablepresencesRequest build() {
