...
public class GetConversationRecordingAnnotationsRequest {
    ...
    public ApiRequest<Void> withHttpInfo() throws ApiException {
        ...
        if (this.conversationId == null) {
            throw new ApiException(400, "Missing the required parameter 'conversationId' when building request for GetConversationRecordingAnnotationsRequest.");
        }
        
        // verify the required parameter 'recordingId' is set
        if (this.recordingId == null) {
            throw new ApiException(400, "Missing the required parameter 'recordingId' when building request for GetConversationRecordingAnnotationsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/conversations/{conversationId}/recordings/{recordingId}/annotations")
	...
	public static class Builder {
		private final GetConversationRecordingAnnotationsRequest request;

		private Builder() {
			request = new GetConversationRecordingAnnotationsRequest();
		}
