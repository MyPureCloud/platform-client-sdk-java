...
public class GetScimV2GroupsRequest {
	...
	public GetScimV2GroupsRequest withFilter(String filter) {
	...
	public GetScimV2GroupsRequest withStartIndex(Integer startIndex) {
	...
	public GetScimV2GroupsRequest withCount(Integer count) {
	    this.setCount(count);
	    return this;
	} 
    ...
    public GetScimV2GroupsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.filter == null) {
            throw new IllegalStateException("Missing the required parameter 'filter' when building request for GetScimV2GroupsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/scim/v2/groups")
	...
	public static class Builder {
		private final GetScimV2GroupsRequest request;

		private Builder() {
			request = new GetScimV2GroupsRequest();
		}
		...
		public GetScimV2GroupsRequest build() {
