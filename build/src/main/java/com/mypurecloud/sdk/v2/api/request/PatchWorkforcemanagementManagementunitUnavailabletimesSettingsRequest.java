...
public class PatchWorkforcemanagementManagementunitUnavailabletimesSettingsRequest {
	...
	public PatchWorkforcemanagementManagementunitUnavailabletimesSettingsRequest withManagementUnitId(String managementUnitId) {
	    this.setManagementUnitId(managementUnitId);
	    return this;
	} 

	private UpdateManagementUnitsSettingsRequest body;
	public UpdateManagementUnitsSettingsRequest getBody() {
		return this.body;
	}

	public void setBody(UpdateManagementUnitsSettingsRequest body) {
		this.body = body;
	}

	public PatchWorkforcemanagementManagementunitUnavailabletimesSettingsRequest withBody(UpdateManagementUnitsSettingsRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchWorkforcemanagementManagementunitUnavailabletimesSettingsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<UpdateManagementUnitsSettingsRequest> withHttpInfo() {
        
        // verify the required parameter 'managementUnitId' is set
        if (this.managementUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'managementUnitId' when building request for PatchWorkforcemanagementManagementunitUnavailabletimesSettingsRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchWorkforcemanagementManagementunitUnavailabletimesSettingsRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/workforcemanagement/managementunits/{managementUnitId}/unavailabletimes/settings")
	...
	public static Builder builder(String managementUnitId, UpdateManagementUnitsSettingsRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PatchWorkforcemanagementManagementunitUnavailabletimesSettingsRequest request;

		private Builder() {
			request = new PatchWorkforcemanagementManagementunitUnavailabletimesSettingsRequest();
		}
		...
		public Builder withBody(UpdateManagementUnitsSettingsRequest body) {
		...
		public Builder withRequiredParams(String managementUnitId, UpdateManagementUnitsSettingsRequest body) {
			request.setManagementUnitId(managementUnitId);
			request.setBody(body);
		...
		public PatchWorkforcemanagementManagementunitUnavailabletimesSettingsRequest build() {
