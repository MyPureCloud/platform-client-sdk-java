...
public class GetArchitectSchedulegroupRequest {
	...
	public GetArchitectSchedulegroupRequest withScheduleGroupId(String scheduleGroupId) {
    ...
    public GetArchitectSchedulegroupRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.scheduleGroupId == null) {
            throw new IllegalStateException("Missing the required parameter 'scheduleGroupId' when building request for GetArchitectSchedulegroupRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/architect/schedulegroups/{scheduleGroupId}")
	...
	public static class Builder {
		private final GetArchitectSchedulegroupRequest request;

		private Builder() {
			request = new GetArchitectSchedulegroupRequest();
		}
		...
		public GetArchitectSchedulegroupRequest build() {
