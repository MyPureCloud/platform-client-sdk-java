...
public class GetWorkforcemanagementIntegrationsHrisRequest {
    ...
    public GetWorkforcemanagementIntegrationsHrisRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/integrations/hris")
	...
	public static class Builder {
		private final GetWorkforcemanagementIntegrationsHrisRequest request;

		private Builder() {
			request = new GetWorkforcemanagementIntegrationsHrisRequest();
		}
		...
		public GetWorkforcemanagementIntegrationsHrisRequest build() {
