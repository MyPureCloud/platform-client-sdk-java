...
public class GetAnalyticsKnowledgeAggregatesJobRequest {
	...
	public GetAnalyticsKnowledgeAggregatesJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetAnalyticsKnowledgeAggregatesJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetAnalyticsKnowledgeAggregatesJobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/analytics/knowledge/aggregates/jobs/{jobId}")
	...
	public static class Builder {
		private final GetAnalyticsKnowledgeAggregatesJobRequest request;

		private Builder() {
			request = new GetAnalyticsKnowledgeAggregatesJobRequest();
		}
		...
		public GetAnalyticsKnowledgeAggregatesJobRequest build() {
