...
public class GetExternalcontactsScanNotesRequest {
	...
	public GetExternalcontactsScanNotesRequest withLimit(Integer limit) {
	    this.setLimit(limit);
	    return this;
	} 
	...
	public GetExternalcontactsScanNotesRequest withCursor(String cursor) {
    ...
    public GetExternalcontactsScanNotesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/externalcontacts/scan/notes")
	...
	public static class Builder {
		private final GetExternalcontactsScanNotesRequest request;

		private Builder() {
			request = new GetExternalcontactsScanNotesRequest();
		}
		...
		public GetExternalcontactsScanNotesRequest build() {
