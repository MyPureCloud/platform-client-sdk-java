...
public class PostWorkforcemanagementManagementunitWeekScheduleCopyRequest {
	...
	public PostWorkforcemanagementManagementunitWeekScheduleCopyRequest withManagementUnitId(String managementUnitId) {
	...
	public PostWorkforcemanagementManagementunitWeekScheduleCopyRequest withWeekId(String weekId) {
	...
	public PostWorkforcemanagementManagementunitWeekScheduleCopyRequest withScheduleId(String scheduleId) {
	...
	public PostWorkforcemanagementManagementunitWeekScheduleCopyRequest withForceAsync(Boolean forceAsync) {
	...
	public PostWorkforcemanagementManagementunitWeekScheduleCopyRequest withForceDownloadService(Boolean forceDownloadService) {
	    this.setForceDownloadService(forceDownloadService);
	    return this;
	} 
	
	private CopyWeekScheduleRequest body;
	public CopyWeekScheduleRequest getBody() {
		return this.body;
	}

	public void setBody(CopyWeekScheduleRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementManagementunitWeekScheduleCopyRequest withBody(CopyWeekScheduleRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementManagementunitWeekScheduleCopyRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<CopyWeekScheduleRequest> withHttpInfo() {
        
        // verify the required parameter 'managementUnitId' is set
        if (this.managementUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'managementUnitId' when building request for PostWorkforcemanagementManagementunitWeekScheduleCopyRequest.");
        }
        
        // verify the required parameter 'weekId' is set
        if (this.weekId == null) {
            throw new IllegalStateException("Missing the required parameter 'weekId' when building request for PostWorkforcemanagementManagementunitWeekScheduleCopyRequest.");
        }
        
        // verify the required parameter 'scheduleId' is set
        if (this.scheduleId == null) {
            throw new IllegalStateException("Missing the required parameter 'scheduleId' when building request for PostWorkforcemanagementManagementunitWeekScheduleCopyRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/managementunits/{managementUnitId}/weeks/{weekId}/schedules/{scheduleId}/copy")
	...
	public static class Builder {
		private final PostWorkforcemanagementManagementunitWeekScheduleCopyRequest request;

		private Builder() {
			request = new PostWorkforcemanagementManagementunitWeekScheduleCopyRequest();
		}
		...
		public Builder withBody(CopyWeekScheduleRequest body) {
		...
		public PostWorkforcemanagementManagementunitWeekScheduleCopyRequest build() {
