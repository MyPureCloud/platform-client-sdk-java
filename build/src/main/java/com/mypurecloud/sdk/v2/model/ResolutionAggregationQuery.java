...
public class ResolutionAggregationQuery  implements Serializable {
 ...
 @JsonDeserialize(using = AlternateTimeDimensionEnumDeserializer.class)
  ...
  public ResolutionAggregationQuery() {
  ...
  public ResolutionAggregationQuery(Boolean initWithEmptyList) {
   ...
   **/
  public ResolutionAggregationQuery interval(String interval) {
   ...
   **/
  public ResolutionAggregationQuery granularity(String granularity) {
   ...
   **/
  public ResolutionAggregationQuery timeZone(String timeZone) {
   ...
   **/
  public ResolutionAggregationQuery groupBy(List<GroupByEnum> groupBy) {
   ...
   **/
  public ResolutionAggregationQuery filter(ResolutionAggregateQueryFilter filter) {
    this.filter = filter;
    return this;
  }
   ...
   **/
  public ResolutionAggregationQuery metrics(List<MetricsEnum> metrics) {
   ...
   **/
  public ResolutionAggregationQuery flattenMultivaluedDimensions(Boolean flattenMultivaluedDimensions) {
   ...
   **/
  public ResolutionAggregationQuery views(List<ResolutionAggregationView> views) {
    this.views = views;
    return this;
  }
   ...
   * Dimension to use as the alternative timestamp for data in the aggregate.  Choosing \"eventTime\" uses the actual time of the data event and choosing \"wrapUpDate\" uses the date when conversation is ended
   **/
  public ResolutionAggregationQuery alternateTimeDimension(AlternateTimeDimensionEnum alternateTimeDimension) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ResolutionAggregationQuery resolutionAggregationQuery = (ResolutionAggregationQuery) o;

    return Objects.equals(this.interval, resolutionAggregationQuery.interval) &&
            Objects.equals(this.granularity, resolutionAggregationQuery.granularity) &&
            Objects.equals(this.timeZone, resolutionAggregationQuery.timeZone) &&
            Objects.equals(this.groupBy, resolutionAggregationQuery.groupBy) &&
            Objects.equals(this.filter, resolutionAggregationQuery.filter) &&
            Objects.equals(this.metrics, resolutionAggregationQuery.metrics) &&
            Objects.equals(this.flattenMultivaluedDimensions, resolutionAggregationQuery.flattenMultivaluedDimensions) &&
            Objects.equals(this.views, resolutionAggregationQuery.views) &&
            Objects.equals(this.alternateTimeDimension, resolutionAggregationQuery.alternateTimeDimension);
  }
