...
public class PostWorkforcemanagementBusinessunitActivitycodesRequest {
	...
	public PostWorkforcemanagementBusinessunitActivitycodesRequest withBody(CreateActivityCodeRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementBusinessunitActivitycodesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<CreateActivityCodeRequest> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementBusinessunitActivitycodesRequest.");
        }
	...
	public static Builder builder(String businessUnitId, CreateActivityCodeRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementBusinessunitActivitycodesRequest request;

		private Builder() {
			request = new PostWorkforcemanagementBusinessunitActivitycodesRequest();
		}
		...
		public Builder withRequiredParams(String businessUnitId, CreateActivityCodeRequest body) {
			request.setBusinessUnitId(businessUnitId);
			request.setBody(body);
