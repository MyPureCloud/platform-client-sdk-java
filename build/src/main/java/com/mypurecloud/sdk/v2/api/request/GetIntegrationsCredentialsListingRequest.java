...
public class GetIntegrationsCredentialsListingRequest {
	...
	public GetIntegrationsCredentialsListingRequest withBefore(String before) {
	...
	public GetIntegrationsCredentialsListingRequest withAfter(String after) {
	    this.setAfter(after);
	    return this;
	} 
	...
	public GetIntegrationsCredentialsListingRequest withPageSize(String pageSize) {
    ...
    public GetIntegrationsCredentialsListingRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/integrations/credentials/listing")
	...
	public static class Builder {
		private final GetIntegrationsCredentialsListingRequest request;

		private Builder() {
			request = new GetIntegrationsCredentialsListingRequest();
		}
		...
		public GetIntegrationsCredentialsListingRequest build() {
