...
public class DeleteWorkforcemanagementManagementunitSchedulingRunRequest {
	...
	public DeleteWorkforcemanagementManagementunitSchedulingRunRequest withManagementUnitId(String managementUnitId) {
	...
	public DeleteWorkforcemanagementManagementunitSchedulingRunRequest withRunId(String runId) {
	    this.setRunId(runId);
	    return this;
	} 
    ...
    public DeleteWorkforcemanagementManagementunitSchedulingRunRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.managementUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'managementUnitId' when building request for DeleteWorkforcemanagementManagementunitSchedulingRunRequest.");
        }
        
        // verify the required parameter 'runId' is set
        if (this.runId == null) {
            throw new IllegalStateException("Missing the required parameter 'runId' when building request for DeleteWorkforcemanagementManagementunitSchedulingRunRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/workforcemanagement/managementunits/{managementUnitId}/scheduling/runs/{runId}")
	...
	public static class Builder {
		private final DeleteWorkforcemanagementManagementunitSchedulingRunRequest request;

		private Builder() {
			request = new DeleteWorkforcemanagementManagementunitSchedulingRunRequest();
		}
		...
		public DeleteWorkforcemanagementManagementunitSchedulingRunRequest build() {
