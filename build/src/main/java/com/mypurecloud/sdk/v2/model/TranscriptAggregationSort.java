...
public class TranscriptAggregationSort  implements Serializable {
 ...
 @JsonDeserialize(using = FunctionEnumDeserializer.class)
  ...
  public TranscriptAggregationSort() {
   ...
   * Name of the metric used for sorting values.
   **/
  public TranscriptAggregationSort name(NameEnum name) {
    this.name = name;
    return this;
  }
   ...
   * Aggregation function used for the sort metric.
   **/
  public TranscriptAggregationSort function(FunctionEnum function) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TranscriptAggregationSort transcriptAggregationSort = (TranscriptAggregationSort) o;

    return Objects.equals(this.name, transcriptAggregationSort.name) &&
            Objects.equals(this.function, transcriptAggregationSort.function);
  }
  ...
  public String toString() {
    ...
    sb.append("class TranscriptAggregationSort {\n");
