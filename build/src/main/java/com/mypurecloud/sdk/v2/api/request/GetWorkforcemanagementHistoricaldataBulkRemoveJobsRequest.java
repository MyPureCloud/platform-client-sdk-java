...
public class GetWorkforcemanagementHistoricaldataBulkRemoveJobsRequest {
    ...
    public GetWorkforcemanagementHistoricaldataBulkRemoveJobsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/historicaldata/bulk/remove/jobs")
	...
	public static class Builder {
		private final GetWorkforcemanagementHistoricaldataBulkRemoveJobsRequest request;

		private Builder() {
			request = new GetWorkforcemanagementHistoricaldataBulkRemoveJobsRequest();
		}
		...
		public GetWorkforcemanagementHistoricaldataBulkRemoveJobsRequest build() {
