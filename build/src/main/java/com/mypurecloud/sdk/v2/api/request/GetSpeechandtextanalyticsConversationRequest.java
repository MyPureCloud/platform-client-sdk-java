...
public class GetSpeechandtextanalyticsConversationRequest {
	...
	public GetSpeechandtextanalyticsConversationRequest withConversationId(String conversationId) {
    ...
    public GetSpeechandtextanalyticsConversationRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for GetSpeechandtextanalyticsConversationRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/speechandtextanalytics/conversations/{conversationId}")
	...
	public static class Builder {
		private final GetSpeechandtextanalyticsConversationRequest request;

		private Builder() {
			request = new GetSpeechandtextanalyticsConversationRequest();
		}
		...
		public GetSpeechandtextanalyticsConversationRequest build() {
