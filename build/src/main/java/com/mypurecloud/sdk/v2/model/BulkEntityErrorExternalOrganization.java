...
public class BulkEntityErrorExternalOrganization  implements Serializable {
  ...
  public BulkEntityErrorExternalOrganization() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
      details = new ArrayList<BulkErrorDetail>();
    }
  }

  public BulkEntityErrorExternalOrganization(Boolean initWithEmptyList) {
   ...
   **/
  public BulkEntityErrorExternalOrganization code(String code) {
    this.code = code;
    return this;
  }
   ...
   **/
  public BulkEntityErrorExternalOrganization message(String message) {
   ...
   **/
  public BulkEntityErrorExternalOrganization status(Integer status) {
    this.status = status;
    return this;
  }
   ...
   **/
  public BulkEntityErrorExternalOrganization retryable(Boolean retryable) {
   ...
   **/
  public BulkEntityErrorExternalOrganization details(List<BulkErrorDetail> details) {
   ...
   **/
  public BulkEntityErrorExternalOrganization entity(ExternalOrganization entity) {
    this.entity = entity;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    BulkEntityErrorExternalOrganization bulkEntityErrorExternalOrganization = (BulkEntityErrorExternalOrganization) o;

    return Objects.equals(this.code, bulkEntityErrorExternalOrganization.code) &&
            Objects.equals(this.message, bulkEntityErrorExternalOrganization.message) &&
            Objects.equals(this.status, bulkEntityErrorExternalOrganization.status) &&
            Objects.equals(this.retryable, bulkEntityErrorExternalOrganization.retryable) &&
            Objects.equals(this.details, bulkEntityErrorExternalOrganization.details) &&
            Objects.equals(this.entity, bulkEntityErrorExternalOrganization.entity);
  }
