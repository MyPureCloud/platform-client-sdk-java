...
public class DeleteConversationsMessagingIntegrationsAppleIntegrationIdRequest {
	...
	public DeleteConversationsMessagingIntegrationsAppleIntegrationIdRequest withIntegrationId(String integrationId) {
    ...
    public DeleteConversationsMessagingIntegrationsAppleIntegrationIdRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.integrationId == null) {
            throw new IllegalStateException("Missing the required parameter 'integrationId' when building request for DeleteConversationsMessagingIntegrationsAppleIntegrationIdRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/conversations/messaging/integrations/apple/{integrationId}")
	...
	public static class Builder {
		private final DeleteConversationsMessagingIntegrationsAppleIntegrationIdRequest request;

		private Builder() {
			request = new DeleteConversationsMessagingIntegrationsAppleIntegrationIdRequest();
		}
		...
		public DeleteConversationsMessagingIntegrationsAppleIntegrationIdRequest build() {
