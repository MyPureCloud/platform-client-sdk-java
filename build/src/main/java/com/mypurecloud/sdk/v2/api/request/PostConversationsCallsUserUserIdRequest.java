...
public class PostConversationsCallsUserUserIdRequest {
	...
	public PostConversationsCallsUserUserIdRequest withUserId(String userId) {
	...
	public void setBody(CreateCallRequest body) {
		this.body = body;
	}

	public PostConversationsCallsUserUserIdRequest withBody(CreateCallRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostConversationsCallsUserUserIdRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<CreateCallRequest> withHttpInfo() {
        
        // verify the required parameter 'userId' is set
        if (this.userId == null) {
            throw new IllegalStateException("Missing the required parameter 'userId' when building request for PostConversationsCallsUserUserIdRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostConversationsCallsUserUserIdRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/conversations/calls/user/{userId}")
	...
	public static Builder builder(String userId, CreateCallRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostConversationsCallsUserUserIdRequest request;

		private Builder() {
			request = new PostConversationsCallsUserUserIdRequest();
		}
		...
		public Builder withBody(CreateCallRequest body) {
		...
		public Builder withRequiredParams(String userId, CreateCallRequest body) {
			request.setUserId(userId);
			request.setBody(body);
		...
		public PostConversationsCallsUserUserIdRequest build() {
