...
public class DeleteOutboundImporttemplateRequest {
	...
	public DeleteOutboundImporttemplateRequest withImportTemplateId(String importTemplateId) {
    ...
    public DeleteOutboundImporttemplateRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.importTemplateId == null) {
            throw new IllegalStateException("Missing the required parameter 'importTemplateId' when building request for DeleteOutboundImporttemplateRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/outbound/importtemplates/{importTemplateId}")
	...
	public static class Builder {
		private final DeleteOutboundImporttemplateRequest request;

		private Builder() {
			request = new DeleteOutboundImporttemplateRequest();
		}
		...
		public DeleteOutboundImporttemplateRequest build() {
