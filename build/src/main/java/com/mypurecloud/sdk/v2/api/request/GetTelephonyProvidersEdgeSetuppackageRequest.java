...
public class GetTelephonyProvidersEdgeSetuppackageRequest {
	...
	public GetTelephonyProvidersEdgeSetuppackageRequest withEdgeId(String edgeId) {
    ...
    public GetTelephonyProvidersEdgeSetuppackageRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.edgeId == null) {
            throw new IllegalStateException("Missing the required parameter 'edgeId' when building request for GetTelephonyProvidersEdgeSetuppackageRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/telephony/providers/edges/{edgeId}/setuppackage")
	...
	public static class Builder {
		private final GetTelephonyProvidersEdgeSetuppackageRequest request;

		private Builder() {
			request = new GetTelephonyProvidersEdgeSetuppackageRequest();
		}
		...
		public GetTelephonyProvidersEdgeSetuppackageRequest build() {
