...
public class GetWorkforcemanagementManagementunitDecisionmetricsRequest {
	...
	public GetWorkforcemanagementManagementunitDecisionmetricsRequest withManagementUnitId(String managementUnitId) {
    ...
    public GetWorkforcemanagementManagementunitDecisionmetricsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.managementUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'managementUnitId' when building request for GetWorkforcemanagementManagementunitDecisionmetricsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/managementunits/{managementUnitId}/decisionmetrics")
	...
	public static class Builder {
		private final GetWorkforcemanagementManagementunitDecisionmetricsRequest request;

		private Builder() {
			request = new GetWorkforcemanagementManagementunitDecisionmetricsRequest();
		}
		...
		public GetWorkforcemanagementManagementunitDecisionmetricsRequest build() {
