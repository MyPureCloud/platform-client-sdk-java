...
public class PostWorkforcemanagementIntegrationsHriTimeofftypesJobsRequest {

	private String hrisIntegrationId;
	...
	public PostWorkforcemanagementIntegrationsHriTimeofftypesJobsRequest withHrisIntegrationId(String hrisIntegrationId) {
	    this.setHrisIntegrationId(hrisIntegrationId);
	    return this;
	} 
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.hrisIntegrationId == null) {
            throw new IllegalStateException("Missing the required parameter 'hrisIntegrationId' when building request for PostWorkforcemanagementIntegrationsHriTimeofftypesJobsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/integrations/hris/{hrisIntegrationId}/timeofftypes/jobs")
                .withPathParameter("hrisIntegrationId", hrisIntegrationId)
	...
	public static Builder builder(String hrisIntegrationId) {
	    return new Builder()
	            .withRequiredParams(hrisIntegrationId);
	}


	public static class Builder {
		private final PostWorkforcemanagementIntegrationsHriTimeofftypesJobsRequest request;

		private Builder() {
			request = new PostWorkforcemanagementIntegrationsHriTimeofftypesJobsRequest();
		}


		public Builder withHrisIntegrationId(String hrisIntegrationId) {
			request.setHrisIntegrationId(hrisIntegrationId);
			return this;
		}



		public Builder withRequiredParams(String hrisIntegrationId) {
			request.setHrisIntegrationId(hrisIntegrationId);
		...
		public PostWorkforcemanagementIntegrationsHriTimeofftypesJobsRequest build() {
            
            // verify the required parameter 'hrisIntegrationId' is set
            if (request.hrisIntegrationId == null) {
                throw new IllegalStateException("Missing the required parameter 'hrisIntegrationId' when building request for PostWorkforcemanagementIntegrationsHriTimeofftypesJobsRequest.");
            }
