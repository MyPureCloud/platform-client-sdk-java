...
public class PostWorkforcemanagementBusinessunitWeekSchedulesImportUploadurlRequest {
	...
	public PostWorkforcemanagementBusinessunitWeekSchedulesImportUploadurlRequest withBusinessUnitId(String businessUnitId) {
	...
	public PostWorkforcemanagementBusinessunitWeekSchedulesImportUploadurlRequest withWeekId(LocalDate weekId) {
	...
	public PostWorkforcemanagementBusinessunitWeekSchedulesImportUploadurlRequest withBody(UploadUrlRequestBody body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementBusinessunitWeekSchedulesImportUploadurlRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<UploadUrlRequestBody> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PostWorkforcemanagementBusinessunitWeekSchedulesImportUploadurlRequest.");
        }
        
        // verify the required parameter 'weekId' is set
        if (this.weekId == null) {
            throw new IllegalStateException("Missing the required parameter 'weekId' when building request for PostWorkforcemanagementBusinessunitWeekSchedulesImportUploadurlRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementBusinessunitWeekSchedulesImportUploadurlRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/weeks/{weekId}/schedules/import/uploadurl")
	...
	public static Builder builder(String businessUnitId, LocalDate weekId, UploadUrlRequestBody body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementBusinessunitWeekSchedulesImportUploadurlRequest request;

		private Builder() {
			request = new PostWorkforcemanagementBusinessunitWeekSchedulesImportUploadurlRequest();
		}
		...
		public Builder withRequiredParams(String businessUnitId, LocalDate weekId, UploadUrlRequestBody body) {
			request.setBusinessUnitId(businessUnitId);
						request.setWeekId(weekId);
						request.setBody(body);
		...
		public PostWorkforcemanagementBusinessunitWeekSchedulesImportUploadurlRequest build() {
