...
public class DataTableImportJob  implements Serializable {
  ...
  @ApiModelProperty(example = "null", value = "The timestamp of when the import began. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss.SSSZ")
  ...
  @ApiModelProperty(example = "null", value = "The timestamp of when the import stopped (either successfully or unsuccessfully). Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss.SSSZ")
   ...
   **/
  public DataTableImportJob countRecordsProcessed(Integer countRecordsProcessed) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, dataTableImportJob.id) &&
        ...
        Objects.equals(this.countRecordsProcessed, dataTableImportJob.countRecordsProcessed) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, owner, status, dateCreated, dateCompleted, uploadURI, importMode, errorInformation, countRecordsProcessed, countRecordsFailed, selfUri);
  }
