...
public class GetKnowledgeKnowledgebaseDocumentsFeedbackRequest {
	...
	public GetKnowledgeKnowledgebaseDocumentsFeedbackRequest withKnowledgeBaseId(String knowledgeBaseId) {
	...
	public GetKnowledgeKnowledgebaseDocumentsFeedbackRequest withBefore(String before) {
	...
	public GetKnowledgeKnowledgebaseDocumentsFeedbackRequest withAfter(String after) {
	    this.setAfter(after);
	    return this;
	} 
	...
	public GetKnowledgeKnowledgebaseDocumentsFeedbackRequest withPageSize(String pageSize) {
	...
	public GetKnowledgeKnowledgebaseDocumentsFeedbackRequest withOnlyCommented(Boolean onlyCommented) {
	...
	public GetKnowledgeKnowledgebaseDocumentsFeedbackRequest withDocumentVersionId(String documentVersionId) {
	...
	public GetKnowledgeKnowledgebaseDocumentsFeedbackRequest withDocumentVariationId(String documentVariationId) {
	...
	public GetKnowledgeKnowledgebaseDocumentsFeedbackRequest withAppType(String appType) {
	...
	public GetKnowledgeKnowledgebaseDocumentsFeedbackRequest withQueryType(String queryType) {
	...
	public GetKnowledgeKnowledgebaseDocumentsFeedbackRequest withUserId(String userId) {
	...
	public GetKnowledgeKnowledgebaseDocumentsFeedbackRequest withQueueId(String queueId) {
	...
	public GetKnowledgeKnowledgebaseDocumentsFeedbackRequest withState(String state) {
	    this.setState(state);
	    return this;
	} 
    ...
    public GetKnowledgeKnowledgebaseDocumentsFeedbackRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.knowledgeBaseId == null) {
            throw new IllegalStateException("Missing the required parameter 'knowledgeBaseId' when building request for GetKnowledgeKnowledgebaseDocumentsFeedbackRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/documents/feedback")
	...
	public static class Builder {
		private final GetKnowledgeKnowledgebaseDocumentsFeedbackRequest request;

		private Builder() {
			request = new GetKnowledgeKnowledgebaseDocumentsFeedbackRequest();
		}
		...
		public GetKnowledgeKnowledgebaseDocumentsFeedbackRequest build() {
