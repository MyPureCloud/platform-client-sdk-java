...
public class GetTelephonyProvidersEdgesDidpoolsDidsRequest {
	...
	public GetTelephonyProvidersEdgesDidpoolsDidsRequest withType(String type) {
	    this.setType(type);
	    return this;
	} 
	...
	public GetTelephonyProvidersEdgesDidpoolsDidsRequest withId(List<String> id) {
	    this.setId(id);
	    return this;
	} 
	...
	public GetTelephonyProvidersEdgesDidpoolsDidsRequest withNumberMatch(String numberMatch) {
	...
	public GetTelephonyProvidersEdgesDidpoolsDidsRequest withPageSize(Integer pageSize) {
	...
	public GetTelephonyProvidersEdgesDidpoolsDidsRequest withPageNumber(Integer pageNumber) {
	...
	public GetTelephonyProvidersEdgesDidpoolsDidsRequest withSortOrder(String sortOrder) {
    ...
    public GetTelephonyProvidersEdgesDidpoolsDidsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.type == null) {
            throw new IllegalStateException("Missing the required parameter 'type' when building request for GetTelephonyProvidersEdgesDidpoolsDidsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/telephony/providers/edges/didpools/dids")
                ...
                .withQueryParameters("numberMatch", "", numberMatch)
	...
	public static class Builder {
		private final GetTelephonyProvidersEdgesDidpoolsDidsRequest request;

		private Builder() {
			request = new GetTelephonyProvidersEdgesDidpoolsDidsRequest();
		}
		...
		public Builder withNumberMatch(String numberMatch) {
			request.setNumberMatch(numberMatch);
			return this;
		}
		...
		public GetTelephonyProvidersEdgesDidpoolsDidsRequest build() {
