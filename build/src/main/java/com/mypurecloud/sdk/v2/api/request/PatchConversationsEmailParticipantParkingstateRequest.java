...
public class PatchConversationsEmailParticipantParkingstateRequest {
	...
	public PatchConversationsEmailParticipantParkingstateRequest withConversationId(String conversationId) {
	...
	public PatchConversationsEmailParticipantParkingstateRequest withParticipantId(String participantId) {
	    this.setParticipantId(participantId);
	    return this;
	} 

	private ParkingStateRequest body;
	public ParkingStateRequest getBody() {
		return this.body;
	}

	public void setBody(ParkingStateRequest body) {
		this.body = body;
	}

	public PatchConversationsEmailParticipantParkingstateRequest withBody(ParkingStateRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchConversationsEmailParticipantParkingstateRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<ParkingStateRequest> withHttpInfo() {
        
        // verify the required parameter 'conversationId' is set
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PatchConversationsEmailParticipantParkingstateRequest.");
        }
        
        // verify the required parameter 'participantId' is set
        if (this.participantId == null) {
            throw new IllegalStateException("Missing the required parameter 'participantId' when building request for PatchConversationsEmailParticipantParkingstateRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchConversationsEmailParticipantParkingstateRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/conversations/emails/{conversationId}/participants/{participantId}/parkingstate")
	...
	public static Builder builder(String conversationId, String participantId, ParkingStateRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PatchConversationsEmailParticipantParkingstateRequest request;

		private Builder() {
			request = new PatchConversationsEmailParticipantParkingstateRequest();
		}
		...
		public Builder withBody(ParkingStateRequest body) {
		...
		public Builder withRequiredParams(String conversationId, String participantId, ParkingStateRequest body) {
			request.setConversationId(conversationId);
			request.setParticipantId(participantId);
			request.setBody(body);
		...
		public PatchConversationsEmailParticipantParkingstateRequest build() {
