...
public class ArchitectPromptNotificationArchitectOperation  implements Serializable {
 ...
 @JsonDeserialize(using = ActionStatusEnumDeserializer.class)
  ...
  public ArchitectPromptNotificationArchitectOperation() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
      errorDetails = new ArrayList<ArchitectPromptNotificationErrorDetail>();
    }
  }

  public ArchitectPromptNotificationArchitectOperation(Boolean initWithEmptyList) {
