...
public class GetAnalyticsAgentutilizationsAggregatesJobRequest {
	...
	public GetAnalyticsAgentutilizationsAggregatesJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetAnalyticsAgentutilizationsAggregatesJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetAnalyticsAgentutilizationsAggregatesJobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/analytics/agentutilizations/aggregates/jobs/{jobId}")
	...
	public static class Builder {
		private final GetAnalyticsAgentutilizationsAggregatesJobRequest request;

		private Builder() {
			request = new GetAnalyticsAgentutilizationsAggregatesJobRequest();
		}
		...
		public GetAnalyticsAgentutilizationsAggregatesJobRequest build() {
