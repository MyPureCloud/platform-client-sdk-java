...
public class AuthzDivisionGrantEntityListing  implements Serializable {
  ...
  public AuthzDivisionGrantEntityListing() {
  ...
  /**
   **/
  public AuthzDivisionGrantEntityListing entities(List<AuthzGrant> entities) {
  ...
  public List<AuthzGrant> getEntities() {
    return entities;
  }
  public void setEntities(List<AuthzGrant> entities) {
    this.entities = entities;
  }
