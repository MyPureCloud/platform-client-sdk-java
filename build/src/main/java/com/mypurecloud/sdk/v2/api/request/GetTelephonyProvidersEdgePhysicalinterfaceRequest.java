...
public class GetTelephonyProvidersEdgePhysicalinterfaceRequest {
    ...
    public ApiRequest<Void> withHttpInfo() throws ApiException {
        ...
        if (this.edgeId == null) {
            throw new ApiException(400, "Missing the required parameter 'edgeId' when building request for GetTelephonyProvidersEdgePhysicalinterfaceRequest.");
        }
        
        // verify the required parameter 'interfaceId' is set
        if (this.interfaceId == null) {
            throw new ApiException(400, "Missing the required parameter 'interfaceId' when building request for GetTelephonyProvidersEdgePhysicalinterfaceRequest.");
        }
