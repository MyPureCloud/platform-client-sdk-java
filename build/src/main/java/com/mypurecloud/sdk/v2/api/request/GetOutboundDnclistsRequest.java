...
public class GetOutboundDnclistsRequest {
	...
	public GetOutboundDnclistsRequest withAllowEmptyResult(Boolean allowEmptyResult) {
    ...
    public GetOutboundDnclistsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/outbound/dnclists")
