...
public class GetWorkforcemanagementManagementunitSchedulingRunRequest {
	...
	public GetWorkforcemanagementManagementunitSchedulingRunRequest withManagementUnitId(String managementUnitId) {
	...
	public GetWorkforcemanagementManagementunitSchedulingRunRequest withRunId(String runId) {
	    this.setRunId(runId);
	    return this;
	} 
    ...
    public GetWorkforcemanagementManagementunitSchedulingRunRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.managementUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'managementUnitId' when building request for GetWorkforcemanagementManagementunitSchedulingRunRequest.");
        }
        
        // verify the required parameter 'runId' is set
        if (this.runId == null) {
            throw new IllegalStateException("Missing the required parameter 'runId' when building request for GetWorkforcemanagementManagementunitSchedulingRunRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/managementunits/{managementUnitId}/scheduling/runs/{runId}")
	...
	public static class Builder {
		private final GetWorkforcemanagementManagementunitSchedulingRunRequest request;

		private Builder() {
			request = new GetWorkforcemanagementManagementunitSchedulingRunRequest();
		}
		...
		public GetWorkforcemanagementManagementunitSchedulingRunRequest build() {
