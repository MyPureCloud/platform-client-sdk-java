...
public class GetRoutingUserUtilizationRequest {
	...
	public GetRoutingUserUtilizationRequest withUserId(String userId) {
    ...
    public GetRoutingUserUtilizationRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.userId == null) {
            throw new IllegalStateException("Missing the required parameter 'userId' when building request for GetRoutingUserUtilizationRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/routing/users/{userId}/utilization")
	...
	public static class Builder {
		private final GetRoutingUserUtilizationRequest request;

		private Builder() {
			request = new GetRoutingUserUtilizationRequest();
		}
		...
		public GetRoutingUserUtilizationRequest build() {
