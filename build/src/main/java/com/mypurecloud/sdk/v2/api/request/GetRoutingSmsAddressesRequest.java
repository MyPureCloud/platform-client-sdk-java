...
public class GetRoutingSmsAddressesRequest {
	...
	public GetRoutingSmsAddressesRequest withPageSize(Integer pageSize) {
	...
	public GetRoutingSmsAddressesRequest withPageNumber(Integer pageNumber) {
    ...
    public GetRoutingSmsAddressesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/routing/sms/addresses")
	...
	public static class Builder {
		private final GetRoutingSmsAddressesRequest request;

		private Builder() {
			request = new GetRoutingSmsAddressesRequest();
		}
		...
		public GetRoutingSmsAddressesRequest build() {
