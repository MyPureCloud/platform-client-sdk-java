...
public class GetChatsUserSettingsRequest {
	...
	public GetChatsUserSettingsRequest withUserId(String userId) {
    ...
    public GetChatsUserSettingsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.userId == null) {
            throw new IllegalStateException("Missing the required parameter 'userId' when building request for GetChatsUserSettingsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/chats/users/{userId}/settings")
	...
	public static class Builder {
		private final GetChatsUserSettingsRequest request;

		private Builder() {
			request = new GetChatsUserSettingsRequest();
		}
		...
		public GetChatsUserSettingsRequest build() {
