...
public class GetFlowVersionConfigurationRequest {
    ...
    public GetFlowVersionConfigurationRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.flowId == null) {
            throw new IllegalStateException("Missing the required parameter 'flowId' when building request for GetFlowVersionConfigurationRequest.");
        }
        
        // verify the required parameter 'versionId' is set
        if (this.versionId == null) {
            throw new IllegalStateException("Missing the required parameter 'versionId' when building request for GetFlowVersionConfigurationRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/flows/{flowId}/versions/{versionId}/configuration")
	...
	public static class Builder {
		private final GetFlowVersionConfigurationRequest request;

		private Builder() {
			request = new GetFlowVersionConfigurationRequest();
		}
