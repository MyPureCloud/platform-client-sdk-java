...
import com.mypurecloud.sdk.v2.model.WorkitemsQueueEventsNotificationPropertyChange;
import com.mypurecloud.sdk.v2.model.WorkitemsQueueEventsNotificationScoredAgent;
...
public class WorkitemsQueueEventsNotificationWorkitem  implements Serializable {
 ...
 @JsonDeserialize(using = OperationEnumDeserializer.class)
  ...
  private List<WorkitemsQueueEventsNotificationDelta> changes = null;
  private List<WorkitemsQueueEventsNotificationPropertyChange> propertyChanges = null;
 ...
 @JsonDeserialize(using = AssignmentStateEnumDeserializer.class)
  ...
  private List<WorkitemsQueueEventsNotificationSession> sessions = null;
  ...
  private List<WorkitemsQueueEventsNotificationScoredAgent> scoredAgents = null;
  private String utilizationLabelId = null;
  private String caseId = null;

  public WorkitemsQueueEventsNotificationWorkitem() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
      changes = new ArrayList<WorkitemsQueueEventsNotificationDelta>();
      propertyChanges = new ArrayList<WorkitemsQueueEventsNotificationPropertyChange>();
      sessions = new ArrayList<WorkitemsQueueEventsNotificationSession>();
      skillIds = new ArrayList<String>();
      preferredAgentIds = new ArrayList<String>();
      scoredAgents = new ArrayList<WorkitemsQueueEventsNotificationScoredAgent>();
    }
  }

  public WorkitemsQueueEventsNotificationWorkitem(Boolean initWithEmptyList) {
  ...
  /**
   **/
  public WorkitemsQueueEventsNotificationWorkitem priority(Long priority) {
  ...
  /**
   **/
  public WorkitemsQueueEventsNotificationWorkitem dateAssignmentStateChanged(String dateAssignmentStateChanged) {
  ...
  /**
   **/
  public WorkitemsQueueEventsNotificationWorkitem durationSeconds(Long durationSeconds) {
  ...
  /**
   **/
  public WorkitemsQueueEventsNotificationWorkitem ttl(Long ttl) {
    this.ttl = ttl;
    return this;
  }
  ...
  /**
   **/
  public WorkitemsQueueEventsNotificationWorkitem propertyChanges(List<WorkitemsQueueEventsNotificationPropertyChange> propertyChanges) {
  ...
  public List<WorkitemsQueueEventsNotificationPropertyChange> getPropertyChanges() {
    return propertyChanges;
  }
  public void setPropertyChanges(List<WorkitemsQueueEventsNotificationPropertyChange> propertyChanges) {
    this.propertyChanges = propertyChanges;
  }
  ...
  /**
   **/
  public WorkitemsQueueEventsNotificationWorkitem alertTimeoutSeconds(Long alertTimeoutSeconds) {
  ...
  /**
   **/
  public WorkitemsQueueEventsNotificationWorkitem wrapup(WorkitemsQueueEventsNotificationWrapup wrapup) {
    this.wrapup = wrapup;
    return this;
  }
  ...
  @ApiModelProperty(example = "null", value = "")
  @JsonProperty("wrapup")
  public WorkitemsQueueEventsNotificationWrapup getWrapup() {
    return wrapup;
  }
  public void setWrapup(WorkitemsQueueEventsNotificationWrapup wrapup) {
    this.wrapup = wrapup;
  }
  ...
  /**
   **/
  public WorkitemsQueueEventsNotificationWorkitem scriptId(String scriptId) {
  ...
  /**
   **/
  public WorkitemsQueueEventsNotificationWorkitem workbinName(String workbinName) {
  ...
  /**
   **/
  public WorkitemsQueueEventsNotificationWorkitem typeName(String typeName) {
  ...
  /**
   **/
  public WorkitemsQueueEventsNotificationWorkitem preferredAgentIds(List<String> preferredAgentIds) {
  ...
  /**
   **/
  public WorkitemsQueueEventsNotificationWorkitem divisionId(String divisionId) {
  ...
  /**
   **/
  public WorkitemsQueueEventsNotificationWorkitem scoredAgents(List<WorkitemsQueueEventsNotificationScoredAgent> scoredAgents) {
  ...
  public List<WorkitemsQueueEventsNotificationScoredAgent> getScoredAgents() {
    return scoredAgents;
  }
  public void setScoredAgents(List<WorkitemsQueueEventsNotificationScoredAgent> scoredAgents) {
    this.scoredAgents = scoredAgents;
  }
  ...
  /**
   **/
  public WorkitemsQueueEventsNotificationWorkitem utilizationLabelId(String utilizationLabelId) {
  ...
  /**
   **/
  public WorkitemsQueueEventsNotificationWorkitem caseId(String caseId) {
    this.caseId = caseId;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, workitemsQueueEventsNotificationWorkitem.id) &&
            ...
            Objects.equals(this.dateAssignmentStateChanged, workitemsQueueEventsNotificationWorkitem.dateAssignmentStateChanged) &&
            ...
            Objects.equals(this.propertyChanges, workitemsQueueEventsNotificationWorkitem.propertyChanges) &&
            ...
            Objects.equals(this.scriptId, workitemsQueueEventsNotificationWorkitem.scriptId) &&
            Objects.equals(this.workbinName, workitemsQueueEventsNotificationWorkitem.workbinName) &&
            Objects.equals(this.typeName, workitemsQueueEventsNotificationWorkitem.typeName) &&
            Objects.equals(this.preferredAgentIds, workitemsQueueEventsNotificationWorkitem.preferredAgentIds) &&
            Objects.equals(this.divisionId, workitemsQueueEventsNotificationWorkitem.divisionId) &&
            Objects.equals(this.scoredAgents, workitemsQueueEventsNotificationWorkitem.scoredAgents) &&
            Objects.equals(this.utilizationLabelId, workitemsQueueEventsNotificationWorkitem.utilizationLabelId) &&
            Objects.equals(this.caseId, workitemsQueueEventsNotificationWorkitem.caseId);
  }
