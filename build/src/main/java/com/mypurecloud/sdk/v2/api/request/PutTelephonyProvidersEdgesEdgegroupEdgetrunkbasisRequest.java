...
public class PutTelephonyProvidersEdgesEdgegroupEdgetrunkbasisRequest {
	...
	public PutTelephonyProvidersEdgesEdgegroupEdgetrunkbasisRequest withEdgegroupId(String edgegroupId) {
	...
	public PutTelephonyProvidersEdgesEdgegroupEdgetrunkbasisRequest withEdgetrunkbaseId(String edgetrunkbaseId) {
	...
	public PutTelephonyProvidersEdgesEdgegroupEdgetrunkbasisRequest withBody(EdgeTrunkBase body) {
	    this.setBody(body);
	    return this;
	}
    ...
    public PutTelephonyProvidersEdgesEdgegroupEdgetrunkbasisRequest withCustomHeader(String name, String value) {
