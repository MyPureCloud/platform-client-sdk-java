...
public class DeleteAnalyticsTaskmanagementAggregatesJobRequest {
	...
	public DeleteAnalyticsTaskmanagementAggregatesJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public DeleteAnalyticsTaskmanagementAggregatesJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for DeleteAnalyticsTaskmanagementAggregatesJobRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/analytics/taskmanagement/aggregates/jobs/{jobId}")
	...
	public static class Builder {
		private final DeleteAnalyticsTaskmanagementAggregatesJobRequest request;

		private Builder() {
			request = new DeleteAnalyticsTaskmanagementAggregatesJobRequest();
		}
		...
		public DeleteAnalyticsTaskmanagementAggregatesJobRequest build() {
