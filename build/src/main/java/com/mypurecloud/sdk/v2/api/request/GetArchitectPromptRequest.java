...
public class GetArchitectPromptRequest {
	...
	public GetArchitectPromptRequest withIncludeMediaUris(Boolean includeMediaUris) {
	...
	public GetArchitectPromptRequest withIncludeResources(Boolean includeResources) {
	...
	public GetArchitectPromptRequest withLanguage(List<String> language) {
