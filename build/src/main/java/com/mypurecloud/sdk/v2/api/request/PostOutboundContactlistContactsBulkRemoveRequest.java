...
public class PostOutboundContactlistContactsBulkRemoveRequest {
	...
	public PostOutboundContactlistContactsBulkRemoveRequest withContactListId(String contactListId) {
	    this.setContactListId(contactListId);
	    return this;
	} 

	private ContactBulkSearchParameters body;
	public ContactBulkSearchParameters getBody() {
		return this.body;
	}

	public void setBody(ContactBulkSearchParameters body) {
		this.body = body;
	}

	public PostOutboundContactlistContactsBulkRemoveRequest withBody(ContactBulkSearchParameters body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostOutboundContactlistContactsBulkRemoveRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<ContactBulkSearchParameters> withHttpInfo() {
        
        // verify the required parameter 'contactListId' is set
        if (this.contactListId == null) {
            throw new IllegalStateException("Missing the required parameter 'contactListId' when building request for PostOutboundContactlistContactsBulkRemoveRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostOutboundContactlistContactsBulkRemoveRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/outbound/contactlists/{contactListId}/contacts/bulk/remove")
	...
	public static Builder builder(String contactListId, ContactBulkSearchParameters body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostOutboundContactlistContactsBulkRemoveRequest request;

		private Builder() {
			request = new PostOutboundContactlistContactsBulkRemoveRequest();
		}
		...
		public Builder withBody(ContactBulkSearchParameters body) {
		...
		public Builder withRequiredParams(String contactListId, ContactBulkSearchParameters body) {
			request.setContactListId(contactListId);
			request.setBody(body);
		...
		public PostOutboundContactlistContactsBulkRemoveRequest build() {
