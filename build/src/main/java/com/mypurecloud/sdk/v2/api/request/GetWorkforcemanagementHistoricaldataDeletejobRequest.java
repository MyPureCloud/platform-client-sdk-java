...
public class GetWorkforcemanagementHistoricaldataDeletejobRequest {
    ...
    public GetWorkforcemanagementHistoricaldataDeletejobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/historicaldata/deletejob")
	...
	public static class Builder {
		private final GetWorkforcemanagementHistoricaldataDeletejobRequest request;

		private Builder() {
			request = new GetWorkforcemanagementHistoricaldataDeletejobRequest();
		}
		...
		public GetWorkforcemanagementHistoricaldataDeletejobRequest build() {
