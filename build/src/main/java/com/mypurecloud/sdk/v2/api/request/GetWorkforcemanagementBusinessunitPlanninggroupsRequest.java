...
public class GetWorkforcemanagementBusinessunitPlanninggroupsRequest {
	...
	public GetWorkforcemanagementBusinessunitPlanninggroupsRequest withBusinessUnitId(String businessUnitId) {
    ...
    public GetWorkforcemanagementBusinessunitPlanninggroupsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for GetWorkforcemanagementBusinessunitPlanninggroupsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/planninggroups")
	...
	public static class Builder {
		private final GetWorkforcemanagementBusinessunitPlanninggroupsRequest request;

		private Builder() {
			request = new GetWorkforcemanagementBusinessunitPlanninggroupsRequest();
		}
		...
		public GetWorkforcemanagementBusinessunitPlanninggroupsRequest build() {
