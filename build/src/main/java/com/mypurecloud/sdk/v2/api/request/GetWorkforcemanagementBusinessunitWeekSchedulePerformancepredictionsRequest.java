...
public class GetWorkforcemanagementBusinessunitWeekSchedulePerformancepredictionsRequest {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for GetWorkforcemanagementBusinessunitWeekSchedulePerformancepredictionsRequest.");
        }
        
        // verify the required parameter 'weekId' is set
        if (this.weekId == null) {
            throw new IllegalStateException("Missing the required parameter 'weekId' when building request for GetWorkforcemanagementBusinessunitWeekSchedulePerformancepredictionsRequest.");
        }
        
        // verify the required parameter 'scheduleId' is set
        if (this.scheduleId == null) {
            throw new IllegalStateException("Missing the required parameter 'scheduleId' when building request for GetWorkforcemanagementBusinessunitWeekSchedulePerformancepredictionsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/weeks/{weekId}/schedules/{scheduleId}/performancepredictions")
	...
	public static class Builder {
		private final GetWorkforcemanagementBusinessunitWeekSchedulePerformancepredictionsRequest request;

		private Builder() {
			request = new GetWorkforcemanagementBusinessunitWeekSchedulePerformancepredictionsRequest();
		}
		...
		public GetWorkforcemanagementBusinessunitWeekSchedulePerformancepredictionsRequest build() {
