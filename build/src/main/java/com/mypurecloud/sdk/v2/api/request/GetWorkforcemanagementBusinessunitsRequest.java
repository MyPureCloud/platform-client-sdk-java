...
public class GetWorkforcemanagementBusinessunitsRequest {
	...
	public GetWorkforcemanagementBusinessunitsRequest withFeature(String feature) {
	...
	public GetWorkforcemanagementBusinessunitsRequest withDivisionId(String divisionId) {
    ...
    public GetWorkforcemanagementBusinessunitsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/businessunits")
	...
	public static class Builder {
		private final GetWorkforcemanagementBusinessunitsRequest request;

		private Builder() {
			request = new GetWorkforcemanagementBusinessunitsRequest();
		}
		...
		public GetWorkforcemanagementBusinessunitsRequest build() {
