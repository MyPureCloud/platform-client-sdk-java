...
public class GetExternalcontactsGraphsClusterscanStatisticsRequest {
	...
	public GetExternalcontactsGraphsClusterscanStatisticsRequest withScanId(String scanId) {
    ...
    public GetExternalcontactsGraphsClusterscanStatisticsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.scanId == null) {
            throw new IllegalStateException("Missing the required parameter 'scanId' when building request for GetExternalcontactsGraphsClusterscanStatisticsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/externalcontacts/graphs/clusterscans/{scanId}/statistics")
	...
	public static class Builder {
		private final GetExternalcontactsGraphsClusterscanStatisticsRequest request;

		private Builder() {
			request = new GetExternalcontactsGraphsClusterscanStatisticsRequest();
		}
		...
		public GetExternalcontactsGraphsClusterscanStatisticsRequest build() {
