...
public class GetWorkforcemanagementBusinessunitShifttradingWeeksSummaryJobRequest {
	...
	public GetWorkforcemanagementBusinessunitShifttradingWeeksSummaryJobRequest withBusinessUnitId(String businessUnitId) {
	...
	public GetWorkforcemanagementBusinessunitShifttradingWeeksSummaryJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetWorkforcemanagementBusinessunitShifttradingWeeksSummaryJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for GetWorkforcemanagementBusinessunitShifttradingWeeksSummaryJobRequest.");
        }
        
        // verify the required parameter 'jobId' is set
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetWorkforcemanagementBusinessunitShifttradingWeeksSummaryJobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/shifttrading/weeks/summary/jobs/{jobId}")
	...
	public static class Builder {
		private final GetWorkforcemanagementBusinessunitShifttradingWeeksSummaryJobRequest request;

		private Builder() {
			request = new GetWorkforcemanagementBusinessunitShifttradingWeeksSummaryJobRequest();
		}
		...
		public GetWorkforcemanagementBusinessunitShifttradingWeeksSummaryJobRequest build() {
