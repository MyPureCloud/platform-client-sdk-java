...
public class KnowledgeV3ConversationContext  implements Serializable {
 ...
 @JsonDeserialize(using = MessageTypeEnumDeserializer.class)
   ...
   **/
  public KnowledgeV3ConversationContext conversationId(String conversationId) {
   ...
   * The media type of the conversation.
   **/
  public KnowledgeV3ConversationContext mediaType(MediaTypeEnum mediaType) {
   ...
   * The message type of the conversation.
   **/
  public KnowledgeV3ConversationContext messageType(MessageTypeEnum messageType) {
   ...
   **/
  public KnowledgeV3ConversationContext queueId(String queueId) {
   ...
   **/
  public KnowledgeV3ConversationContext externalContactId(String externalContactId) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    KnowledgeV3ConversationContext knowledgeV3ConversationContext = (KnowledgeV3ConversationContext) o;

    return Objects.equals(this.conversationId, knowledgeV3ConversationContext.conversationId) &&
            Objects.equals(this.mediaType, knowledgeV3ConversationContext.mediaType) &&
            Objects.equals(this.messageType, knowledgeV3ConversationContext.messageType) &&
            Objects.equals(this.queueId, knowledgeV3ConversationContext.queueId) &&
            Objects.equals(this.externalContactId, knowledgeV3ConversationContext.externalContactId);
  }
