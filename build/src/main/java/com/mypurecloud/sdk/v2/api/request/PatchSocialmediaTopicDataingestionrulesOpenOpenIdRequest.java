...
public class PatchSocialmediaTopicDataingestionrulesOpenOpenIdRequest {
	...
	public PatchSocialmediaTopicDataingestionrulesOpenOpenIdRequest withTopicId(String topicId) {
	...
	public PatchSocialmediaTopicDataingestionrulesOpenOpenIdRequest withOpenId(String openId) {
	...
	public PatchSocialmediaTopicDataingestionrulesOpenOpenIdRequest withBody(DataIngestionRuleStatusPatchRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchSocialmediaTopicDataingestionrulesOpenOpenIdRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<DataIngestionRuleStatusPatchRequest> withHttpInfo() {
        ...
        if (this.topicId == null) {
            throw new IllegalStateException("Missing the required parameter 'topicId' when building request for PatchSocialmediaTopicDataingestionrulesOpenOpenIdRequest.");
        }
        
        // verify the required parameter 'openId' is set
        if (this.openId == null) {
            throw new IllegalStateException("Missing the required parameter 'openId' when building request for PatchSocialmediaTopicDataingestionrulesOpenOpenIdRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/socialmedia/topics/{topicId}/dataingestionrules/open/{openId}")
	...
	public static class Builder {
		private final PatchSocialmediaTopicDataingestionrulesOpenOpenIdRequest request;

		private Builder() {
			request = new PatchSocialmediaTopicDataingestionrulesOpenOpenIdRequest();
		}
		...
		public PatchSocialmediaTopicDataingestionrulesOpenOpenIdRequest build() {
