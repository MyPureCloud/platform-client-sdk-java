...
public class GetIntegrationsEventlogEventIdRequest {
	...
	public GetIntegrationsEventlogEventIdRequest withEventId(String eventId) {
    ...
    public GetIntegrationsEventlogEventIdRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.eventId == null) {
            throw new IllegalStateException("Missing the required parameter 'eventId' when building request for GetIntegrationsEventlogEventIdRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/integrations/eventlog/{eventId}")
	...
	public static class Builder {
		private final GetIntegrationsEventlogEventIdRequest request;

		private Builder() {
			request = new GetIntegrationsEventlogEventIdRequest();
		}
		...
		public GetIntegrationsEventlogEventIdRequest build() {
