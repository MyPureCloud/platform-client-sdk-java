...
public class GetScriptsPublishedScriptIdRequest {
	...
	public GetScriptsPublishedScriptIdRequest withScriptId(String scriptId) {
	...
	public GetScriptsPublishedScriptIdRequest withScriptDataVersion(String scriptDataVersion) {
    ...
    public GetScriptsPublishedScriptIdRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.scriptId == null) {
            throw new IllegalStateException("Missing the required parameter 'scriptId' when building request for GetScriptsPublishedScriptIdRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/scripts/published/{scriptId}")
	...
	public static class Builder {
		private final GetScriptsPublishedScriptIdRequest request;

		private Builder() {
			request = new GetScriptsPublishedScriptIdRequest();
		}
		...
		public GetScriptsPublishedScriptIdRequest build() {
