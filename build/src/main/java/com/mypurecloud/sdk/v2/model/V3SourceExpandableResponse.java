...
public class V3SourceExpandableResponse  implements Serializable {
 ...
 @JsonDeserialize(using = StatusEnumDeserializer.class)
   ...
   **/
  public V3SourceExpandableResponse name(String name) {
    this.name = name;
    return this;
  }
   ...
   **/
  public V3SourceExpandableResponse connectionId(String connectionId) {
   ...
   * The type of the source.
   **/
  public V3SourceExpandableResponse type(TypeEnum type) {
    this.type = type;
    return this;
  }
   ...
   * The trigger type of the source.
   **/
  public V3SourceExpandableResponse triggerType(TriggerTypeEnum triggerType) {
   ...
   * The current status of the source.
   **/
  public V3SourceExpandableResponse status(StatusEnum status) {
    this.status = status;
    return this;
  }
   ...
   **/
  public V3SourceExpandableResponse createdBy(UserReference createdBy) {
   ...
   **/
  public V3SourceExpandableResponse modifiedBy(UserReference modifiedBy) {
   ...
   **/
  public V3SourceExpandableResponse dateCreated(Date dateCreated) {
   ...
   **/
  public V3SourceExpandableResponse dateModified(Date dateModified) {
   ...
   **/
  public V3SourceExpandableResponse lastSync(V3SourceLastSynchronization lastSync) {
   ...
   **/
  public V3SourceExpandableResponse scheduleSettings(V3SourceScheduleSettings scheduleSettings) {
   ...
   **/
  public V3SourceExpandableResponse filters(V3SourceFilter filters) {
   ...
   **/
  public V3SourceExpandableResponse filterDetails(V3SourceFilterDetails filterDetails) {
   ...
   **/
  public V3SourceExpandableResponse connection(ConnectionResponse connection) {
   ...
   **/
  public V3SourceExpandableResponse error(ErrorBody error) {
    this.error = error;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V3SourceExpandableResponse v3SourceExpandableResponse = (V3SourceExpandableResponse) o;

    return Objects.equals(this.id, v3SourceExpandableResponse.id) &&
            Objects.equals(this.name, v3SourceExpandableResponse.name) &&
            Objects.equals(this.connectionId, v3SourceExpandableResponse.connectionId) &&
            Objects.equals(this.type, v3SourceExpandableResponse.type) &&
            Objects.equals(this.triggerType, v3SourceExpandableResponse.triggerType) &&
            Objects.equals(this.status, v3SourceExpandableResponse.status) &&
            Objects.equals(this.createdBy, v3SourceExpandableResponse.createdBy) &&
            Objects.equals(this.modifiedBy, v3SourceExpandableResponse.modifiedBy) &&
            Objects.equals(this.dateCreated, v3SourceExpandableResponse.dateCreated) &&
            Objects.equals(this.dateModified, v3SourceExpandableResponse.dateModified) &&
            Objects.equals(this.lastSync, v3SourceExpandableResponse.lastSync) &&
            Objects.equals(this.scheduleSettings, v3SourceExpandableResponse.scheduleSettings) &&
            Objects.equals(this.filters, v3SourceExpandableResponse.filters) &&
            Objects.equals(this.filterDetails, v3SourceExpandableResponse.filterDetails) &&
            Objects.equals(this.connection, v3SourceExpandableResponse.connection) &&
            Objects.equals(this.error, v3SourceExpandableResponse.error) &&
            Objects.equals(this.selfUri, v3SourceExpandableResponse.selfUri);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, connectionId, type, triggerType, status, createdBy, modifiedBy, dateCreated, dateModified, lastSync, scheduleSettings, filters, filterDetails, connection, error, selfUri);
  }
