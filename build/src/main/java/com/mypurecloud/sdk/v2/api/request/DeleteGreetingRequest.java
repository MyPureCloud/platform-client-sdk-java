...
public class DeleteGreetingRequest {
	...
	public DeleteGreetingRequest withGreetingId(String greetingId) {
    ...
    public DeleteGreetingRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() throws ApiException {
        ...
        if (this.greetingId == null) {
            throw new ApiException(400, "Missing the required parameter 'greetingId' when building request for DeleteGreetingRequest.");
        }
