...
public class DeleteTelephonyProvidersEdgeSoftwareupdateRequest {
	...
	public DeleteTelephonyProvidersEdgeSoftwareupdateRequest withEdgeId(String edgeId) {
    ...
    public DeleteTelephonyProvidersEdgeSoftwareupdateRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.edgeId == null) {
            throw new IllegalStateException("Missing the required parameter 'edgeId' when building request for DeleteTelephonyProvidersEdgeSoftwareupdateRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/telephony/providers/edges/{edgeId}/softwareupdate")
	...
	public static class Builder {
		private final DeleteTelephonyProvidersEdgeSoftwareupdateRequest request;

		private Builder() {
			request = new DeleteTelephonyProvidersEdgeSoftwareupdateRequest();
		}
		...
		public DeleteTelephonyProvidersEdgeSoftwareupdateRequest build() {
