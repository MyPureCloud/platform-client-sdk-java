...
public class GetRoutingEmailDomainRouteIdentityresolutionRequest {
	...
	public GetRoutingEmailDomainRouteIdentityresolutionRequest withDomainName(String domainName) {
	...
	public GetRoutingEmailDomainRouteIdentityresolutionRequest withRouteId(String routeId) {
    ...
    public GetRoutingEmailDomainRouteIdentityresolutionRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.domainName == null) {
            throw new IllegalStateException("Missing the required parameter 'domainName' when building request for GetRoutingEmailDomainRouteIdentityresolutionRequest.");
        }
        
        // verify the required parameter 'routeId' is set
        if (this.routeId == null) {
            throw new IllegalStateException("Missing the required parameter 'routeId' when building request for GetRoutingEmailDomainRouteIdentityresolutionRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/routing/email/domains/{domainName}/routes/{routeId}/identityresolution")
	...
	public static class Builder {
		private final GetRoutingEmailDomainRouteIdentityresolutionRequest request;

		private Builder() {
			request = new GetRoutingEmailDomainRouteIdentityresolutionRequest();
		}
		...
		public GetRoutingEmailDomainRouteIdentityresolutionRequest build() {
