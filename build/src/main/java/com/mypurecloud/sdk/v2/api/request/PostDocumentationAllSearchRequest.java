...
public class PostDocumentationAllSearchRequest {

	private DocumentationV2SearchRequest body;
	public DocumentationV2SearchRequest getBody() {
		return this.body;
	}

	public void setBody(DocumentationV2SearchRequest body) {
		this.body = body;
	}

	public PostDocumentationAllSearchRequest withBody(DocumentationV2SearchRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostDocumentationAllSearchRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<DocumentationV2SearchRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostDocumentationAllSearchRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/documentation/all/search")
                .withBody(body)
	...
	public static Builder builder(DocumentationV2SearchRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostDocumentationAllSearchRequest request;

		private Builder() {
			request = new PostDocumentationAllSearchRequest();
		}


		public Builder withBody(DocumentationV2SearchRequest body) {
		...
		public Builder withRequiredParams(DocumentationV2SearchRequest body) {
			request.setBody(body);
		...
		public PostDocumentationAllSearchRequest build() {
