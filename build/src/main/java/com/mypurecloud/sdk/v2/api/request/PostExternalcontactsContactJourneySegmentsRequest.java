...
public class PostExternalcontactsContactJourneySegmentsRequest {
	...
	public PostExternalcontactsContactJourneySegmentsRequest withContactId(String contactId) {
	    this.setContactId(contactId);
	    return this;
	} 

	private UpdateSegmentAssignmentRequest body;
	public UpdateSegmentAssignmentRequest getBody() {
		return this.body;
	}

	public void setBody(UpdateSegmentAssignmentRequest body) {
		this.body = body;
	}
    ...
    public ApiRequest<UpdateSegmentAssignmentRequest> withHttpInfo() {
        
        // verify the required parameter 'contactId' is set
        if (this.contactId == null) {
            throw new IllegalStateException("Missing the required parameter 'contactId' when building request for PostExternalcontactsContactJourneySegmentsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/externalcontacts/contacts/{contactId}/journey/segments")
	...
	public static class Builder {
		private final PostExternalcontactsContactJourneySegmentsRequest request;

		private Builder() {
			request = new PostExternalcontactsContactJourneySegmentsRequest();
		}
		...
		public Builder withBody(UpdateSegmentAssignmentRequest body) {
		...
		public PostExternalcontactsContactJourneySegmentsRequest build() {
