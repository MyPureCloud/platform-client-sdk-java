...
public class PostWorkforcemanagementTimeoffrequestsEstimateRequest {
	...
	public PostWorkforcemanagementTimeoffrequestsEstimateRequest withBody(EstimateAvailableTimeOffRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementTimeoffrequestsEstimateRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<EstimateAvailableTimeOffRequest> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementTimeoffrequestsEstimateRequest.");
        }
	...
	public static Builder builder(EstimateAvailableTimeOffRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementTimeoffrequestsEstimateRequest request;

		private Builder() {
			request = new PostWorkforcemanagementTimeoffrequestsEstimateRequest();
		}
		...
		public Builder withRequiredParams(EstimateAvailableTimeOffRequest body) {
			request.setBody(body);
		...
		public PostWorkforcemanagementTimeoffrequestsEstimateRequest build() {
