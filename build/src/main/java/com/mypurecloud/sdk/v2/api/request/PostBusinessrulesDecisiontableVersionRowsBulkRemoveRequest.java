...
public class PostBusinessrulesDecisiontableVersionRowsBulkRemoveRequest {
	...
	public PostBusinessrulesDecisiontableVersionRowsBulkRemoveRequest withTableId(String tableId) {
	...
	public PostBusinessrulesDecisiontableVersionRowsBulkRemoveRequest withTableVersion(Integer tableVersion) {
	    this.setTableVersion(tableVersion);
	    return this;
	} 

	private BulkDeleteDecisionTableRowsRequest body;
	public BulkDeleteDecisionTableRowsRequest getBody() {
		return this.body;
	}

	public void setBody(BulkDeleteDecisionTableRowsRequest body) {
		this.body = body;
	}

	public PostBusinessrulesDecisiontableVersionRowsBulkRemoveRequest withBody(BulkDeleteDecisionTableRowsRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostBusinessrulesDecisiontableVersionRowsBulkRemoveRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<BulkDeleteDecisionTableRowsRequest> withHttpInfo() {
        
        // verify the required parameter 'tableId' is set
        if (this.tableId == null) {
            throw new IllegalStateException("Missing the required parameter 'tableId' when building request for PostBusinessrulesDecisiontableVersionRowsBulkRemoveRequest.");
        }
        
        // verify the required parameter 'tableVersion' is set
        if (this.tableVersion == null) {
            throw new IllegalStateException("Missing the required parameter 'tableVersion' when building request for PostBusinessrulesDecisiontableVersionRowsBulkRemoveRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostBusinessrulesDecisiontableVersionRowsBulkRemoveRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/businessrules/decisiontables/{tableId}/versions/{tableVersion}/rows/bulk/remove")
	...
	public static Builder builder(String tableId, Integer tableVersion, BulkDeleteDecisionTableRowsRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostBusinessrulesDecisiontableVersionRowsBulkRemoveRequest request;

		private Builder() {
			request = new PostBusinessrulesDecisiontableVersionRowsBulkRemoveRequest();
		}
		...
		public Builder withBody(BulkDeleteDecisionTableRowsRequest body) {
		...
		public Builder withRequiredParams(String tableId, Integer tableVersion, BulkDeleteDecisionTableRowsRequest body) {
			request.setTableId(tableId);
			request.setTableVersion(tableVersion);
			request.setBody(body);
		...
		public PostBusinessrulesDecisiontableVersionRowsBulkRemoveRequest build() {
