...
public class GetGreetingUsersDownloadsRequest {
	...
	public GetGreetingUsersDownloadsRequest withGreetingId(String greetingId) {
	...
	public GetGreetingUsersDownloadsRequest withFormatId(String formatId) {
    ...
    public GetGreetingUsersDownloadsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.greetingId == null) {
            throw new IllegalStateException("Missing the required parameter 'greetingId' when building request for GetGreetingUsersDownloadsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/greetings/{greetingId}/users/downloads")
	...
	public static class Builder {
		private final GetGreetingUsersDownloadsRequest request;

		private Builder() {
			request = new GetGreetingUsersDownloadsRequest();
		}
		...
		public GetGreetingUsersDownloadsRequest build() {
