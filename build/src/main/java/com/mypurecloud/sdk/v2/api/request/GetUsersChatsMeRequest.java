...
public class GetUsersChatsMeRequest {

	private Boolean excludeClosed;
	public Boolean getExcludeClosed() {
		return this.excludeClosed;
	}
	...
	public GetUsersChatsMeRequest withExcludeClosed(Boolean excludeClosed) {
	    this.setExcludeClosed(excludeClosed);
	    return this;
	} 

	private Boolean includePresence;
	public Boolean getIncludePresence() {
		return this.includePresence;
	}

	public void setIncludePresence(Boolean includePresence) {
		this.includePresence = includePresence;
	}

	public GetUsersChatsMeRequest withIncludePresence(Boolean includePresence) {
	    this.setIncludePresence(includePresence);
	    return this;
	} 
	...
	public GetUsersChatsMeRequest withAfter(String after) {
	    this.setAfter(after);
	    return this;
	} 
    ...
    public GetUsersChatsMeRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/users/chats/me")

                .withQueryParameters("excludeClosed", "", excludeClosed)
	...
	public static class Builder {
		private final GetUsersChatsMeRequest request;

		private Builder() {
			request = new GetUsersChatsMeRequest();
		}


		public Builder withExcludeClosed(Boolean excludeClosed) {
			request.setExcludeClosed(excludeClosed);
			return this;
		}
		...
		public GetUsersChatsMeRequest build() {
