...
public class GetWorkforcemanagementBusinessunitCapacityplanStaffingrequirementsRequest {
	...
	public GetWorkforcemanagementBusinessunitCapacityplanStaffingrequirementsRequest withBusinessUnitId(String businessUnitId) {
	...
	public GetWorkforcemanagementBusinessunitCapacityplanStaffingrequirementsRequest withCapacityPlanId(String capacityPlanId) {
    ...
    public GetWorkforcemanagementBusinessunitCapacityplanStaffingrequirementsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for GetWorkforcemanagementBusinessunitCapacityplanStaffingrequirementsRequest.");
        }
        
        // verify the required parameter 'capacityPlanId' is set
        if (this.capacityPlanId == null) {
            throw new IllegalStateException("Missing the required parameter 'capacityPlanId' when building request for GetWorkforcemanagementBusinessunitCapacityplanStaffingrequirementsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/capacityplans/{capacityPlanId}/staffingrequirements")
	...
	public static class Builder {
		private final GetWorkforcemanagementBusinessunitCapacityplanStaffingrequirementsRequest request;

		private Builder() {
			request = new GetWorkforcemanagementBusinessunitCapacityplanStaffingrequirementsRequest();
		}
		...
		public GetWorkforcemanagementBusinessunitCapacityplanStaffingrequirementsRequest build() {
