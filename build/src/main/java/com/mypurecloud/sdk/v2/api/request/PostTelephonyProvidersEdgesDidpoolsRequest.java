...
public class PostTelephonyProvidersEdgesDidpoolsRequest {
	...
	public PostTelephonyProvidersEdgesDidpoolsRequest withBody(DIDPool body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostTelephonyProvidersEdgesDidpoolsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<DIDPool> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostTelephonyProvidersEdgesDidpoolsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/telephony/providers/edges/didpools")
                .withBody(body)
	...
	public static Builder builder(DIDPool body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostTelephonyProvidersEdgesDidpoolsRequest request;

		private Builder() {
			request = new PostTelephonyProvidersEdgesDidpoolsRequest();
		}
		...
		public Builder withRequiredParams(DIDPool body) {
			request.setBody(body);
		...
		public PostTelephonyProvidersEdgesDidpoolsRequest build() {
