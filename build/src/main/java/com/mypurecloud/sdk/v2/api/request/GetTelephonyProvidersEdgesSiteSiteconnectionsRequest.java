...
public class GetTelephonyProvidersEdgesSiteSiteconnectionsRequest {
	...
	public GetTelephonyProvidersEdgesSiteSiteconnectionsRequest withSiteId(String siteId) {
    ...
    public GetTelephonyProvidersEdgesSiteSiteconnectionsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.siteId == null) {
            throw new IllegalStateException("Missing the required parameter 'siteId' when building request for GetTelephonyProvidersEdgesSiteSiteconnectionsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/telephony/providers/edges/sites/{siteId}/siteconnections")
	...
	public static class Builder {
		private final GetTelephonyProvidersEdgesSiteSiteconnectionsRequest request;

		private Builder() {
			request = new GetTelephonyProvidersEdgesSiteSiteconnectionsRequest();
		}
		...
		public GetTelephonyProvidersEdgesSiteSiteconnectionsRequest build() {
