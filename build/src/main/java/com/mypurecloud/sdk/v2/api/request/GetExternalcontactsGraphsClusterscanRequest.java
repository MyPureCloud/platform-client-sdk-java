...
public class GetExternalcontactsGraphsClusterscanRequest {
	...
	public GetExternalcontactsGraphsClusterscanRequest withScanId(String scanId) {
	...
	public GetExternalcontactsGraphsClusterscanRequest withExpand(List<String> expand) {
    ...
    public GetExternalcontactsGraphsClusterscanRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.scanId == null) {
            throw new IllegalStateException("Missing the required parameter 'scanId' when building request for GetExternalcontactsGraphsClusterscanRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/externalcontacts/graphs/clusterscans/{scanId}")
	...
	public static class Builder {
		private final GetExternalcontactsGraphsClusterscanRequest request;

		private Builder() {
			request = new GetExternalcontactsGraphsClusterscanRequest();
		}
		...
		public GetExternalcontactsGraphsClusterscanRequest build() {
