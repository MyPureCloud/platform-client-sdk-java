...
public class GetKnowledgeSourceSynchronizationUploadsRequest {
	...
	public GetKnowledgeSourceSynchronizationUploadsRequest withSourceId(String sourceId) {
	...
	public GetKnowledgeSourceSynchronizationUploadsRequest withSynchronizationId(String synchronizationId) {
	...
	public GetKnowledgeSourceSynchronizationUploadsRequest withBefore(String before) {
	...
	public GetKnowledgeSourceSynchronizationUploadsRequest withAfter(String after) {
	    this.setAfter(after);
	    return this;
	} 
	...
	public GetKnowledgeSourceSynchronizationUploadsRequest withPageSize(String pageSize) {
    ...
    public GetKnowledgeSourceSynchronizationUploadsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.sourceId == null) {
            throw new IllegalStateException("Missing the required parameter 'sourceId' when building request for GetKnowledgeSourceSynchronizationUploadsRequest.");
        }
        
        // verify the required parameter 'synchronizationId' is set
        if (this.synchronizationId == null) {
            throw new IllegalStateException("Missing the required parameter 'synchronizationId' when building request for GetKnowledgeSourceSynchronizationUploadsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/knowledge/sources/{sourceId}/synchronizations/{synchronizationId}/uploads")
	...
	public static Builder builder(String sourceId, String synchronizationId) {
	    return new Builder()
	            .withRequiredParams(sourceId, synchronizationId);
	}


	public static class Builder {
		private final GetKnowledgeSourceSynchronizationUploadsRequest request;

		private Builder() {
			request = new GetKnowledgeSourceSynchronizationUploadsRequest();
		}
		...
		public Builder withRequiredParams(String sourceId, String synchronizationId) {
			request.setSourceId(sourceId);
			request.setSynchronizationId(synchronizationId);
		...
		public GetKnowledgeSourceSynchronizationUploadsRequest build() {
