...
public class PostConversationsCustomattributesSearchRequest {

	private ConversationCustomAttributesSearchRequest body;
	public ConversationCustomAttributesSearchRequest getBody() {
		return this.body;
	}

	public void setBody(ConversationCustomAttributesSearchRequest body) {
		this.body = body;
	}

	public PostConversationsCustomattributesSearchRequest withBody(ConversationCustomAttributesSearchRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostConversationsCustomattributesSearchRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<ConversationCustomAttributesSearchRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostConversationsCustomattributesSearchRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/conversations/customattributes/search")
                .withBody(body)
	...
	public static Builder builder(ConversationCustomAttributesSearchRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostConversationsCustomattributesSearchRequest request;

		private Builder() {
			request = new PostConversationsCustomattributesSearchRequest();
		}


		public Builder withBody(ConversationCustomAttributesSearchRequest body) {
		...
		public Builder withRequiredParams(ConversationCustomAttributesSearchRequest body) {
			request.setBody(body);
		...
		public PostConversationsCustomattributesSearchRequest build() {
