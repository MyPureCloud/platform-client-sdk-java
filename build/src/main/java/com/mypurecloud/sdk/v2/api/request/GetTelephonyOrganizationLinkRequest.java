...
public class GetTelephonyOrganizationLinkRequest {
    ...
    public GetTelephonyOrganizationLinkRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/telephony/organization/link")
	...
	public static class Builder {
		private final GetTelephonyOrganizationLinkRequest request;

		private Builder() {
			request = new GetTelephonyOrganizationLinkRequest();
		}
		...
		public GetTelephonyOrganizationLinkRequest build() {
