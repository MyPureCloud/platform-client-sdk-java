...
public class PostRoutingSkillgroupMembersDivisionsRequest {
	...
	public PostRoutingSkillgroupMembersDivisionsRequest withSkillGroupId(String skillGroupId) {
	    this.setSkillGroupId(skillGroupId);
	    return this;
	} 

	private SkillGroupMemberDivisions body;
	public SkillGroupMemberDivisions getBody() {
		return this.body;
	}

	public void setBody(SkillGroupMemberDivisions body) {
		this.body = body;
	}

	public PostRoutingSkillgroupMembersDivisionsRequest withBody(SkillGroupMemberDivisions body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostRoutingSkillgroupMembersDivisionsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<SkillGroupMemberDivisions> withHttpInfo() {
        
        // verify the required parameter 'skillGroupId' is set
        if (this.skillGroupId == null) {
            throw new IllegalStateException("Missing the required parameter 'skillGroupId' when building request for PostRoutingSkillgroupMembersDivisionsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/routing/skillgroups/{skillGroupId}/members/divisions")
                .withPathParameter("skillGroupId", skillGroupId)
	...
	public static Builder builder(String skillGroupId) {
	    return new Builder()
	            .withRequiredParams(skillGroupId);
	}


	public static class Builder {
		private final PostRoutingSkillgroupMembersDivisionsRequest request;

		private Builder() {
			request = new PostRoutingSkillgroupMembersDivisionsRequest();
		}


		public Builder withSkillGroupId(String skillGroupId) {
			request.setSkillGroupId(skillGroupId);
			return this;
		}

		public Builder withBody(SkillGroupMemberDivisions body) {
		...
		public Builder withRequiredParams(String skillGroupId) {
			request.setSkillGroupId(skillGroupId);
		...
		public PostRoutingSkillgroupMembersDivisionsRequest build() {
