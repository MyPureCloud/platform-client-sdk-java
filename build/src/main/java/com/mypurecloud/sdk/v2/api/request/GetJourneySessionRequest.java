...
public class GetJourneySessionRequest {
	...
	public GetJourneySessionRequest withSessionId(String sessionId) {
    ...
    public GetJourneySessionRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.sessionId == null) {
            throw new IllegalStateException("Missing the required parameter 'sessionId' when building request for GetJourneySessionRequest.");
        }
