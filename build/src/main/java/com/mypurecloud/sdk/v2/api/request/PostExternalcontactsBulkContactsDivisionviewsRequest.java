...
public class PostExternalcontactsBulkContactsDivisionviewsRequest {
	...
	public PostExternalcontactsBulkContactsDivisionviewsRequest withBody(BulkIdsRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostExternalcontactsBulkContactsDivisionviewsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<BulkIdsRequest> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostExternalcontactsBulkContactsDivisionviewsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/externalcontacts/bulk/contacts/divisionviews")
                .withBody(body)
	...
	public static class Builder {
		private final PostExternalcontactsBulkContactsDivisionviewsRequest request;

		private Builder() {
			request = new PostExternalcontactsBulkContactsDivisionviewsRequest();
		}
		...
		public PostExternalcontactsBulkContactsDivisionviewsRequest build() {
