...
public class DeleteArchitectGrammarLanguageFilesVoiceRequest {
	...
	public DeleteArchitectGrammarLanguageFilesVoiceRequest withGrammarId(String grammarId) {
	...
	public DeleteArchitectGrammarLanguageFilesVoiceRequest withLanguageCode(String languageCode) {
    ...
    public DeleteArchitectGrammarLanguageFilesVoiceRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.grammarId == null) {
            throw new IllegalStateException("Missing the required parameter 'grammarId' when building request for DeleteArchitectGrammarLanguageFilesVoiceRequest.");
        }
        
        // verify the required parameter 'languageCode' is set
        if (this.languageCode == null) {
            throw new IllegalStateException("Missing the required parameter 'languageCode' when building request for DeleteArchitectGrammarLanguageFilesVoiceRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/architect/grammars/{grammarId}/languages/{languageCode}/files/voice")
	...
	public static class Builder {
		private final DeleteArchitectGrammarLanguageFilesVoiceRequest request;

		private Builder() {
			request = new DeleteArchitectGrammarLanguageFilesVoiceRequest();
		}
		...
		public DeleteArchitectGrammarLanguageFilesVoiceRequest build() {
