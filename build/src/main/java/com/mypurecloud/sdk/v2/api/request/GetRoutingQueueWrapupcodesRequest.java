...
public class GetRoutingQueueWrapupcodesRequest {
	...
	public GetRoutingQueueWrapupcodesRequest withQueueId(String queueId) {
    ...
    public GetRoutingQueueWrapupcodesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.queueId == null) {
            throw new IllegalStateException("Missing the required parameter 'queueId' when building request for GetRoutingQueueWrapupcodesRequest.");
        }
	...
	public static class Builder {
		private final GetRoutingQueueWrapupcodesRequest request;

		private Builder() {
			request = new GetRoutingQueueWrapupcodesRequest();
		}
		...
		public GetRoutingQueueWrapupcodesRequest build() {
