...
public class GetRoutingAssessmentRequest {
	...
	public GetRoutingAssessmentRequest withAssessmentId(String assessmentId) {
    ...
    public GetRoutingAssessmentRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.assessmentId == null) {
            throw new IllegalStateException("Missing the required parameter 'assessmentId' when building request for GetRoutingAssessmentRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/routing/assessments/{assessmentId}")
	...
	public static class Builder {
		private final GetRoutingAssessmentRequest request;

		private Builder() {
			request = new GetRoutingAssessmentRequest();
		}
		...
		public GetRoutingAssessmentRequest build() {
