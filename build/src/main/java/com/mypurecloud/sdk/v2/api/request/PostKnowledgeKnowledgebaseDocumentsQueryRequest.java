...
public class PostKnowledgeKnowledgebaseDocumentsQueryRequest {
	...
	public PostKnowledgeKnowledgebaseDocumentsQueryRequest withKnowledgeBaseId(String knowledgeBaseId) {
	...
	public PostKnowledgeKnowledgebaseDocumentsQueryRequest withExpand(List<String> expand) {
	...
	public KnowledgeDocumentQuery getBody() {
		return this.body;
	}

	public void setBody(KnowledgeDocumentQuery body) {
		this.body = body;
	}

	public PostKnowledgeKnowledgebaseDocumentsQueryRequest withBody(KnowledgeDocumentQuery body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostKnowledgeKnowledgebaseDocumentsQueryRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<KnowledgeDocumentQuery> withHttpInfo() {
        
        // verify the required parameter 'knowledgeBaseId' is set
        if (this.knowledgeBaseId == null) {
            throw new IllegalStateException("Missing the required parameter 'knowledgeBaseId' when building request for PostKnowledgeKnowledgebaseDocumentsQueryRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/documents/query")
	...
	public static class Builder {
		private final PostKnowledgeKnowledgebaseDocumentsQueryRequest request;

		private Builder() {
			request = new PostKnowledgeKnowledgebaseDocumentsQueryRequest();
		}
		...
		public Builder withBody(KnowledgeDocumentQuery body) {
		...
		public PostKnowledgeKnowledgebaseDocumentsQueryRequest build() {
