...
public class KnowledgeDocumentCreateRequest  implements Serializable {
  ...
  public KnowledgeDocumentCreateRequest(Boolean initWithEmptyList) {
   ...
   * Document title.
   **/
  public KnowledgeDocumentCreateRequest title(String title) {
    this.title = title;
    return this;
  }
   ...
   **/
  public KnowledgeDocumentCreateRequest visible(Boolean visible) {
   ...
   **/
  public KnowledgeDocumentCreateRequest alternatives(List<KnowledgeDocumentAlternative> alternatives) {
   ...
   **/
  public KnowledgeDocumentCreateRequest categoryId(String categoryId) {
   ...
   **/
  public KnowledgeDocumentCreateRequest labelIds(List<String> labelIds) {
   ...
   **/
  public KnowledgeDocumentCreateRequest externalId(String externalId) {
   ...
   **/
  public KnowledgeDocumentCreateRequest externalUrl(String externalUrl) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    KnowledgeDocumentCreateRequest knowledgeDocumentCreateRequest = (KnowledgeDocumentCreateRequest) o;

    return Objects.equals(this.id, knowledgeDocumentCreateRequest.id) &&
            Objects.equals(this.title, knowledgeDocumentCreateRequest.title) &&
            Objects.equals(this.visible, knowledgeDocumentCreateRequest.visible) &&
            Objects.equals(this.alternatives, knowledgeDocumentCreateRequest.alternatives) &&
            Objects.equals(this.categoryId, knowledgeDocumentCreateRequest.categoryId) &&
            Objects.equals(this.labelIds, knowledgeDocumentCreateRequest.labelIds) &&
            Objects.equals(this.externalId, knowledgeDocumentCreateRequest.externalId) &&
            Objects.equals(this.externalUrl, knowledgeDocumentCreateRequest.externalUrl) &&
            Objects.equals(this.selfUri, knowledgeDocumentCreateRequest.selfUri);
  }
