...
public class DeleteArchitectSchedulegroupRequest {
	...
	public DeleteArchitectSchedulegroupRequest withScheduleGroupId(String scheduleGroupId) {
    ...
    public DeleteArchitectSchedulegroupRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.scheduleGroupId == null) {
            throw new IllegalStateException("Missing the required parameter 'scheduleGroupId' when building request for DeleteArchitectSchedulegroupRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/architect/schedulegroups/{scheduleGroupId}")
	...
	public static Builder builder(String scheduleGroupId) {
	    return new Builder()
	            .withRequiredParams(scheduleGroupId);
	}
	

	public static class Builder {
		private final DeleteArchitectSchedulegroupRequest request;

		private Builder() {
			request = new DeleteArchitectSchedulegroupRequest();
		}
		...
		public Builder withRequiredParams(String scheduleGroupId) {
			request.setScheduleGroupId(scheduleGroupId);
		...
		public DeleteArchitectSchedulegroupRequest build() {
