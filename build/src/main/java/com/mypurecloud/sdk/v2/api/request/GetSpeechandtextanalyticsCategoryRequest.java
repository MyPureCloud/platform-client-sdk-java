...
public class GetSpeechandtextanalyticsCategoryRequest {
	...
	public GetSpeechandtextanalyticsCategoryRequest withCategoryId(String categoryId) {
    ...
    public GetSpeechandtextanalyticsCategoryRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.categoryId == null) {
            throw new IllegalStateException("Missing the required parameter 'categoryId' when building request for GetSpeechandtextanalyticsCategoryRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/speechandtextanalytics/categories/{categoryId}")
	...
	public static class Builder {
		private final GetSpeechandtextanalyticsCategoryRequest request;

		private Builder() {
			request = new GetSpeechandtextanalyticsCategoryRequest();
		}
		...
		public GetSpeechandtextanalyticsCategoryRequest build() {
