...
public class GetIntegrationsActionTemplateRequest {
	...
	public GetIntegrationsActionTemplateRequest withActionId(String actionId) {
	...
	public GetIntegrationsActionTemplateRequest withFileName(String fileName) {
    ...
    public GetIntegrationsActionTemplateRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.actionId == null) {
            throw new IllegalStateException("Missing the required parameter 'actionId' when building request for GetIntegrationsActionTemplateRequest.");
        }
        
        // verify the required parameter 'fileName' is set
        if (this.fileName == null) {
            throw new IllegalStateException("Missing the required parameter 'fileName' when building request for GetIntegrationsActionTemplateRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/integrations/actions/{actionId}/templates/{fileName}")
	...
	public static class Builder {
		private final GetIntegrationsActionTemplateRequest request;

		private Builder() {
			request = new GetIntegrationsActionTemplateRequest();
		}
		...
		public GetIntegrationsActionTemplateRequest build() {
