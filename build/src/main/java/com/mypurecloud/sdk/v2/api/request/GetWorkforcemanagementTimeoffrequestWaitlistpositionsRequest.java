...
public class GetWorkforcemanagementTimeoffrequestWaitlistpositionsRequest {
	...
	public GetWorkforcemanagementTimeoffrequestWaitlistpositionsRequest withTimeOffRequestId(String timeOffRequestId) {
    ...
    public GetWorkforcemanagementTimeoffrequestWaitlistpositionsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.timeOffRequestId == null) {
            throw new IllegalStateException("Missing the required parameter 'timeOffRequestId' when building request for GetWorkforcemanagementTimeoffrequestWaitlistpositionsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/timeoffrequests/{timeOffRequestId}/waitlistpositions")
	...
	public static class Builder {
		private final GetWorkforcemanagementTimeoffrequestWaitlistpositionsRequest request;

		private Builder() {
			request = new GetWorkforcemanagementTimeoffrequestWaitlistpositionsRequest();
		}
		...
		public GetWorkforcemanagementTimeoffrequestWaitlistpositionsRequest build() {
