...
import com.fasterxml.jackson.annotation.JsonValue;
import com.mypurecloud.sdk.v2.model.UserActivityQueryFilter;
import com.mypurecloud.sdk.v2.model.UserActivityQueryMetric;
...
public class UserActivityQuery  implements Serializable {
  ...
  private List<UserActivityQueryMetric> metrics = new ArrayList<UserActivityQueryMetric>();
 ...
 @JsonDeserialize(using = OrderEnumDeserializer.class)
   ...
   **/
  public UserActivityQuery metrics(List<UserActivityQueryMetric> metrics) {
  ...
  public void setMetrics(List<UserActivityQueryMetric> metrics) {
    this.metrics = metrics;
  }
   ...
   **/
  public UserActivityQuery groupBy(List<GroupByEnum> groupBy) {
   ...
   **/
  public UserActivityQuery filter(UserActivityQueryFilter filter) {
    this.filter = filter;
    return this;
  }
  ...
  public void setFilter(UserActivityQueryFilter filter) {
    this.filter = filter;
  }
   ...
   * Sort the result set in ascending/descending order. Default is ascending
   **/
  public UserActivityQuery order(OrderEnum order) {
    this.order = order;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    UserActivityQuery userActivityQuery = (UserActivityQuery) o;

    return Objects.equals(this.metrics, userActivityQuery.metrics) &&
            Objects.equals(this.groupBy, userActivityQuery.groupBy) &&
            Objects.equals(this.filter, userActivityQuery.filter) &&
            Objects.equals(this.order, userActivityQuery.order);
  }
