...
public class CampaignSequenceEntityListing  implements Serializable, PagedResource<CampaignSequence> {
  
  private List<CampaignSequence> entities = null;
  ...
  public CampaignSequenceEntityListing() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
      entities = new ArrayList<CampaignSequence>();
    }
  }

  public CampaignSequenceEntityListing(Boolean initWithEmptyList) {
  ...
  /**
   **/
  public CampaignSequenceEntityListing entities(List<CampaignSequence> entities) {
