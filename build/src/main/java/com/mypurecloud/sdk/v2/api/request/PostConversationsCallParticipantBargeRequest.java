...
public class PostConversationsCallParticipantBargeRequest {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("POST", "/api/v2/conversations/calls/{conversationId}/participants/{participantId}/barge")
	...
	public static class Builder {
		private final PostConversationsCallParticipantBargeRequest request;

		private Builder() {
			request = new PostConversationsCallParticipantBargeRequest();
		}
