...
public class PostKnowledgeSourcesRequest {

	private V3SourceCreateRequest body;
	public V3SourceCreateRequest getBody() {
		return this.body;
	}

	public void setBody(V3SourceCreateRequest body) {
		this.body = body;
	}

	public PostKnowledgeSourcesRequest withBody(V3SourceCreateRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostKnowledgeSourcesRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<V3SourceCreateRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostKnowledgeSourcesRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/knowledge/sources")
                .withBody(body)
	...
	public static Builder builder(V3SourceCreateRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostKnowledgeSourcesRequest request;

		private Builder() {
			request = new PostKnowledgeSourcesRequest();
		}


		public Builder withBody(V3SourceCreateRequest body) {
		...
		public Builder withRequiredParams(V3SourceCreateRequest body) {
			request.setBody(body);
		...
		public PostKnowledgeSourcesRequest build() {
