...
public class GetUsersStationsMeRequest {
    ...
    public GetUsersStationsMeRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/users/stations/me")
	...
	public static class Builder {
		private final GetUsersStationsMeRequest request;

		private Builder() {
			request = new GetUsersStationsMeRequest();
		}
		...
		public GetUsersStationsMeRequest build() {
