...
public class SummaryAsyncAggregationQuery  implements Serializable {
 ...
 @JsonDeserialize(using = QueryTypeEnumDeserializer.class)
  ...
  public SummaryAsyncAggregationQuery(Boolean initWithEmptyList) {
   ...
   **/
  public SummaryAsyncAggregationQuery interval(String interval) {
   ...
   **/
  public SummaryAsyncAggregationQuery granularity(String granularity) {
   ...
   **/
  public SummaryAsyncAggregationQuery timeZone(String timeZone) {
   ...
   **/
  public SummaryAsyncAggregationQuery groupBy(List<GroupByEnum> groupBy) {
   ...
   **/
  public SummaryAsyncAggregationQuery filter(SummaryAggregateQueryFilter filter) {
    this.filter = filter;
    return this;
  }
   ...
   **/
  public SummaryAsyncAggregationQuery metrics(List<MetricsEnum> metrics) {
   ...
   **/
  public SummaryAsyncAggregationQuery flattenMultivaluedDimensions(Boolean flattenMultivaluedDimensions) {
   ...
   **/
  public SummaryAsyncAggregationQuery views(List<SummaryAggregationView> views) {
    this.views = views;
    return this;
  }
   ...
   * Dimension to use as the alternative timestamp for data in the aggregate.  Choosing \"eventTime\" uses the actual time of the data event.
   **/
  public SummaryAsyncAggregationQuery alternateTimeDimension(AlternateTimeDimensionEnum alternateTimeDimension) {
   ...
   * Query type to use. Use groupBy for all matching results, and topN/bottomN for N results ordered by the sortMetric. Default is groupBy.
   **/
  public SummaryAsyncAggregationQuery queryType(QueryTypeEnum queryType) {
   ...
   **/
  public SummaryAsyncAggregationQuery sortMetric(SummaryAggregationSort sortMetric) {
   ...
   **/
  public SummaryAsyncAggregationQuery limit(Integer limit) {
    this.limit = limit;
    return this;
  }
   ...
   **/
  public SummaryAsyncAggregationQuery pageSize(Integer pageSize) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SummaryAsyncAggregationQuery summaryAsyncAggregationQuery = (SummaryAsyncAggregationQuery) o;

    return Objects.equals(this.interval, summaryAsyncAggregationQuery.interval) &&
            Objects.equals(this.granularity, summaryAsyncAggregationQuery.granularity) &&
            Objects.equals(this.timeZone, summaryAsyncAggregationQuery.timeZone) &&
            Objects.equals(this.groupBy, summaryAsyncAggregationQuery.groupBy) &&
            Objects.equals(this.filter, summaryAsyncAggregationQuery.filter) &&
            Objects.equals(this.metrics, summaryAsyncAggregationQuery.metrics) &&
            Objects.equals(this.flattenMultivaluedDimensions, summaryAsyncAggregationQuery.flattenMultivaluedDimensions) &&
            Objects.equals(this.views, summaryAsyncAggregationQuery.views) &&
            Objects.equals(this.alternateTimeDimension, summaryAsyncAggregationQuery.alternateTimeDimension) &&
            Objects.equals(this.queryType, summaryAsyncAggregationQuery.queryType) &&
            Objects.equals(this.sortMetric, summaryAsyncAggregationQuery.sortMetric) &&
            Objects.equals(this.limit, summaryAsyncAggregationQuery.limit) &&
            Objects.equals(this.pageSize, summaryAsyncAggregationQuery.pageSize);
  }
