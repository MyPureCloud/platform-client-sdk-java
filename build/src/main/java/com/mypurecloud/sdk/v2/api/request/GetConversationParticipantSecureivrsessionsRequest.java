...
public class GetConversationParticipantSecureivrsessionsRequest {
	...
	public GetConversationParticipantSecureivrsessionsRequest withConversationId(String conversationId) {
	...
	public GetConversationParticipantSecureivrsessionsRequest withParticipantId(String participantId) {
    ...
    public GetConversationParticipantSecureivrsessionsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for GetConversationParticipantSecureivrsessionsRequest.");
        }
        
        // verify the required parameter 'participantId' is set
        if (this.participantId == null) {
            throw new IllegalStateException("Missing the required parameter 'participantId' when building request for GetConversationParticipantSecureivrsessionsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/conversations/{conversationId}/participants/{participantId}/secureivrsessions")
	...
	public static class Builder {
		private final GetConversationParticipantSecureivrsessionsRequest request;

		private Builder() {
			request = new GetConversationParticipantSecureivrsessionsRequest();
		}
		...
		public GetConversationParticipantSecureivrsessionsRequest build() {
