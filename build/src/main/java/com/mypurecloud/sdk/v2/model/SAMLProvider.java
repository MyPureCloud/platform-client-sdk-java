...
public class SAMLProvider  implements Serializable {
 ...
 @JsonDeserialize(using = SsoBindingEnumDeserializer.class)
  ...
  public SAMLProvider(Boolean initWithEmptyList) {
  ...
  /**
   **/
  public SAMLProvider disabled(Boolean disabled) {
  ...
  /**
   **/
  public SAMLProvider issuerURI(String issuerURI) {
  ...
  /**
   **/
  public SAMLProvider ssoTargetURI(String ssoTargetURI) {
  ...
  /**
   **/
  public SAMLProvider sloURI(String sloURI) {
    this.sloURI = sloURI;
    return this;
  }
  ...
  /**
   **/
  public SAMLProvider sloBinding(String sloBinding) {
  ...
  /**
   **/
  public SAMLProvider relyingPartyIdentifier(String relyingPartyIdentifier) {
  ...
  /**
   **/
  public SAMLProvider certificate(String certificate) {
  ...
  /**
   **/
  public SAMLProvider certificates(List<String> certificates) {
  ...
  /**
   **/
  public SAMLProvider logoImageData(String logoImageData) {
  ...
  /**
   **/
  public SAMLProvider nameIdentifierFormat(NameIdentifierFormatEnum nameIdentifierFormat) {
  ...
  /**
   **/
  public SAMLProvider ssoBinding(SsoBindingEnum ssoBinding) {
  ...
  /**
   **/
  public SAMLProvider signAuthnRequests(Boolean signAuthnRequests) {
  ...
  /**
   **/
  public SAMLProvider providerName(String providerName) {
  ...
  /**
   **/
  public SAMLProvider displayOnLogin(Boolean displayOnLogin) {
  ...
  /**
   **/
  public SAMLProvider metadataURL(String metadataURL) {
  ...
  /**
   **/
  public SAMLProvider forceAuthn(Boolean forceAuthn) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, sAMLProvider.id) &&
            Objects.equals(this.name, sAMLProvider.name) &&
            Objects.equals(this.disabled, sAMLProvider.disabled) &&
            Objects.equals(this.issuerURI, sAMLProvider.issuerURI) &&
            Objects.equals(this.ssoTargetURI, sAMLProvider.ssoTargetURI) &&
            Objects.equals(this.sloURI, sAMLProvider.sloURI) &&
            Objects.equals(this.sloBinding, sAMLProvider.sloBinding) &&
            Objects.equals(this.relyingPartyIdentifier, sAMLProvider.relyingPartyIdentifier) &&
            Objects.equals(this.certificate, sAMLProvider.certificate) &&
            Objects.equals(this.certificates, sAMLProvider.certificates) &&
            Objects.equals(this.logoImageData, sAMLProvider.logoImageData) &&
            Objects.equals(this.nameIdentifierFormat, sAMLProvider.nameIdentifierFormat) &&
            Objects.equals(this.ssoBinding, sAMLProvider.ssoBinding) &&
            Objects.equals(this.signAuthnRequests, sAMLProvider.signAuthnRequests) &&
            Objects.equals(this.providerName, sAMLProvider.providerName) &&
            Objects.equals(this.displayOnLogin, sAMLProvider.displayOnLogin) &&
            Objects.equals(this.metadataURL, sAMLProvider.metadataURL) &&
            Objects.equals(this.forceAuthn, sAMLProvider.forceAuthn) &&
            Objects.equals(this.selfUri, sAMLProvider.selfUri);
  }
