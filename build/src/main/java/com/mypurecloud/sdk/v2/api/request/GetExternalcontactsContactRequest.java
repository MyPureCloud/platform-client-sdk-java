...
public class GetExternalcontactsContactRequest {
	...
	public GetExternalcontactsContactRequest withContactId(String contactId) {
	...
	public GetExternalcontactsContactRequest withExpand(List<String> expand) {
    ...
    public GetExternalcontactsContactRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.contactId == null) {
            throw new IllegalStateException("Missing the required parameter 'contactId' when building request for GetExternalcontactsContactRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/externalcontacts/contacts/{contactId}")
