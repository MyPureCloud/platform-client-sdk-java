...
public class PatchWorkforcemanagementManagementunitAgentsWorkplansBulkRequest {
	...
	public PatchWorkforcemanagementManagementunitAgentsWorkplansBulkRequest withManagementUnitId(String managementUnitId) {
	    this.setManagementUnitId(managementUnitId);
	    return this;
	} 

	private UpdateMuAgentWorkPlansBatchRequest body;
	public UpdateMuAgentWorkPlansBatchRequest getBody() {
		return this.body;
	}

	public void setBody(UpdateMuAgentWorkPlansBatchRequest body) {
		this.body = body;
	}

	public PatchWorkforcemanagementManagementunitAgentsWorkplansBulkRequest withBody(UpdateMuAgentWorkPlansBatchRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchWorkforcemanagementManagementunitAgentsWorkplansBulkRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<UpdateMuAgentWorkPlansBatchRequest> withHttpInfo() {
	...
	public static class Builder {
		private final PatchWorkforcemanagementManagementunitAgentsWorkplansBulkRequest request;

		private Builder() {
			request = new PatchWorkforcemanagementManagementunitAgentsWorkplansBulkRequest();
		}
		...
		public Builder withBody(UpdateMuAgentWorkPlansBatchRequest body) {
		...
		public PatchWorkforcemanagementManagementunitAgentsWorkplansBulkRequest build() {
