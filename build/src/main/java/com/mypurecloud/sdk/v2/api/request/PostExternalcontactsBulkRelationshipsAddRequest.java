...
public class PostExternalcontactsBulkRelationshipsAddRequest {
	...
	public PostExternalcontactsBulkRelationshipsAddRequest withBody(BulkRelationshipsRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostExternalcontactsBulkRelationshipsAddRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<BulkRelationshipsRequest> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostExternalcontactsBulkRelationshipsAddRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/externalcontacts/bulk/relationships/add")
                .withBody(body)
	...
	public static class Builder {
		private final PostExternalcontactsBulkRelationshipsAddRequest request;

		private Builder() {
			request = new PostExternalcontactsBulkRelationshipsAddRequest();
		}
		...
		public PostExternalcontactsBulkRelationshipsAddRequest build() {
