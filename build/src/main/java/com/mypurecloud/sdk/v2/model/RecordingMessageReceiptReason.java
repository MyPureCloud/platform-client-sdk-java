...
public class RecordingMessageReceiptReason  implements Serializable {
 ...
 @JsonDeserialize(using = CodeEnumDeserializer.class)
  ...
  public RecordingMessageReceiptReason() {
   ...
   * The reason code for the failed message receipt
   **/
  public RecordingMessageReceiptReason code(CodeEnum code) {
    this.code = code;
    return this;
  }
   ...
   **/
  public RecordingMessageReceiptReason message(String message) {
    this.message = message;
    return this;
  }
  
  @ApiModelProperty(example = "null", value = "Description of the reason for the failed message receipt")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RecordingMessageReceiptReason recordingMessageReceiptReason = (RecordingMessageReceiptReason) o;

    return Objects.equals(this.code, recordingMessageReceiptReason.code) &&
            Objects.equals(this.message, recordingMessageReceiptReason.message);
  }
