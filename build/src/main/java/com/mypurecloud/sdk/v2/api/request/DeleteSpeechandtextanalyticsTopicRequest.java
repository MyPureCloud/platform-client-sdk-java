...
public class DeleteSpeechandtextanalyticsTopicRequest {
	...
	public DeleteSpeechandtextanalyticsTopicRequest withTopicId(String topicId) {
    ...
    public DeleteSpeechandtextanalyticsTopicRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.topicId == null) {
            throw new IllegalStateException("Missing the required parameter 'topicId' when building request for DeleteSpeechandtextanalyticsTopicRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/speechandtextanalytics/topics/{topicId}")
	...
	public static class Builder {
		private final DeleteSpeechandtextanalyticsTopicRequest request;

		private Builder() {
			request = new DeleteSpeechandtextanalyticsTopicRequest();
		}
		...
		public DeleteSpeechandtextanalyticsTopicRequest build() {
