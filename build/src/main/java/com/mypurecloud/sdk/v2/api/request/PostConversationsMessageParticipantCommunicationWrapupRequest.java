...
public class PostConversationsMessageParticipantCommunicationWrapupRequest {
	...
	public PostConversationsMessageParticipantCommunicationWrapupRequest withConversationId(String conversationId) {
	...
	public PostConversationsMessageParticipantCommunicationWrapupRequest withParticipantId(String participantId) {
	...
	public PostConversationsMessageParticipantCommunicationWrapupRequest withCommunicationId(String communicationId) {
    ...
    public PostConversationsMessageParticipantCommunicationWrapupRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<WrapupInput> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PostConversationsMessageParticipantCommunicationWrapupRequest.");
        }
        
        // verify the required parameter 'participantId' is set
        if (this.participantId == null) {
            throw new IllegalStateException("Missing the required parameter 'participantId' when building request for PostConversationsMessageParticipantCommunicationWrapupRequest.");
        }
        
        // verify the required parameter 'communicationId' is set
        if (this.communicationId == null) {
            throw new IllegalStateException("Missing the required parameter 'communicationId' when building request for PostConversationsMessageParticipantCommunicationWrapupRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/conversations/messages/{conversationId}/participants/{participantId}/communications/{communicationId}/wrapup")
	...
	public static class Builder {
		private final PostConversationsMessageParticipantCommunicationWrapupRequest request;

		private Builder() {
			request = new PostConversationsMessageParticipantCommunicationWrapupRequest();
		}
		...
		public PostConversationsMessageParticipantCommunicationWrapupRequest build() {
