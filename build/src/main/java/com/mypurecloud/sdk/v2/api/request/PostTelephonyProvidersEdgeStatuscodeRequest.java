...
public class PostTelephonyProvidersEdgeStatuscodeRequest {
	...
	public PostTelephonyProvidersEdgeStatuscodeRequest withEdgeId(String edgeId) {
	    this.setEdgeId(edgeId);
	    return this;
	}

	private EdgeServiceStateRequest body;
	public EdgeServiceStateRequest getBody() {
		return this.body;
	}

	public void setBody(EdgeServiceStateRequest body) {
		this.body = body;
	}

	public PostTelephonyProvidersEdgeStatuscodeRequest withBody(EdgeServiceStateRequest body) {
	    this.setBody(body);
	    return this;
	}
    ...
    public PostTelephonyProvidersEdgeStatuscodeRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<EdgeServiceStateRequest> withHttpInfo() throws ApiException {
        
        // verify the required parameter 'edgeId' is set
        if (this.edgeId == null) {
            throw new ApiException(400, "Missing the required parameter 'edgeId' when building request for PostTelephonyProvidersEdgeStatuscodeRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/telephony/providers/edges/{edgeId}/statuscode")
	...
	public static class Builder {
		private final PostTelephonyProvidersEdgeStatuscodeRequest request;

		private Builder() {
			request = new PostTelephonyProvidersEdgeStatuscodeRequest();
		}
		...
		public Builder withBody(EdgeServiceStateRequest body) {
		...
		public PostTelephonyProvidersEdgeStatuscodeRequest build() {
			return request;
		}
	}
}
