...
public class GetTelephonyProvidersEdgesLinebasesettingsRequest {
	...
	public GetTelephonyProvidersEdgesLinebasesettingsRequest withPageNumber(Integer pageNumber) {
	...
	public GetTelephonyProvidersEdgesLinebasesettingsRequest withPageSize(Integer pageSize) {
	...
	public GetTelephonyProvidersEdgesLinebasesettingsRequest withSortBy(String sortBy) {
	...
	public GetTelephonyProvidersEdgesLinebasesettingsRequest withSortOrder(String sortOrder) {
	...
	public GetTelephonyProvidersEdgesLinebasesettingsRequest withExpand(List<String> expand) {
    ...
    public GetTelephonyProvidersEdgesLinebasesettingsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/telephony/providers/edges/linebasesettings")
	...
	public static class Builder {
		private final GetTelephonyProvidersEdgesLinebasesettingsRequest request;

		private Builder() {
			request = new GetTelephonyProvidersEdgesLinebasesettingsRequest();
		}
		...
		public GetTelephonyProvidersEdgesLinebasesettingsRequest build() {
