...
public class GetConversationsCustomattributesSchemasLimitsRequest {
    ...
    public GetConversationsCustomattributesSchemasLimitsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/conversations/customattributes/schemas/limits")
	...
	public static class Builder {
		private final GetConversationsCustomattributesSchemasLimitsRequest request;

		private Builder() {
			request = new GetConversationsCustomattributesSchemasLimitsRequest();
		}
		...
		public GetConversationsCustomattributesSchemasLimitsRequest build() {
