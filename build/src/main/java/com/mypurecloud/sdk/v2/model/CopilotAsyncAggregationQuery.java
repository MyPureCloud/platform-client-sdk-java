...
import com.fasterxml.jackson.annotation.JsonValue;
import com.mypurecloud.sdk.v2.model.CopilotAggregateQueryFilter;
import com.mypurecloud.sdk.v2.model.CopilotAggregationView;
...
public class CopilotAsyncAggregationQuery  implements Serializable {
 ...
 @JsonDeserialize(using = GroupByEnumDeserializer.class)
  ...
  private CopilotAggregateQueryFilter filter = null;
 ...
 @JsonDeserialize(using = MetricsEnumDeserializer.class)
  public enum MetricsEnum {
    OUTDATEDSDKVERSION("OutdatedSdkVersion"),
    NCOPILOTMESSAGES("nCopilotMessages"),
    NCOPILOTSESSIONS("nCopilotSessions"),
    NCOPILOTTOOLINVOCATIONS("nCopilotToolInvocations"),
    NCOPILOTUSERS("nCopilotUsers");
  ...
  private List<CopilotAggregationView> views = null;
 ...
 @JsonDeserialize(using = AlternateTimeDimensionEnumDeserializer.class)
  ...
  public CopilotAsyncAggregationQuery() {
   ...
   **/
  public CopilotAsyncAggregationQuery interval(String interval) {
   ...
   **/
  public CopilotAsyncAggregationQuery granularity(String granularity) {
   ...
   **/
  public CopilotAsyncAggregationQuery timeZone(String timeZone) {
   ...
   **/
  public CopilotAsyncAggregationQuery groupBy(List<GroupByEnum> groupBy) {
   ...
   **/
  public CopilotAsyncAggregationQuery filter(CopilotAggregateQueryFilter filter) {
    this.filter = filter;
    return this;
  }
  ...
  @JsonProperty("filter")
  public CopilotAggregateQueryFilter getFilter() {
    return filter;
  }
  public void setFilter(CopilotAggregateQueryFilter filter) {
    this.filter = filter;
  }
   ...
   **/
  public CopilotAsyncAggregationQuery metrics(List<MetricsEnum> metrics) {
   ...
   **/
  public CopilotAsyncAggregationQuery flattenMultivaluedDimensions(Boolean flattenMultivaluedDimensions) {
   ...
   **/
  public CopilotAsyncAggregationQuery views(List<CopilotAggregationView> views) {
    this.views = views;
    return this;
  }
  ...
  @JsonProperty("views")
  public List<CopilotAggregationView> getViews() {
    return views;
  }
  public void setViews(List<CopilotAggregationView> views) {
    this.views = views;
  }
   ...
   * Dimension to use as the alternative timestamp for data in the aggregate.  Choosing \"eventTime\" uses the actual time of the data event.
   **/
  public CopilotAsyncAggregationQuery alternateTimeDimension(AlternateTimeDimensionEnum alternateTimeDimension) {
   ...
   **/
  public CopilotAsyncAggregationQuery pageSize(Integer pageSize) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CopilotAsyncAggregationQuery copilotAsyncAggregationQuery = (CopilotAsyncAggregationQuery) o;

    return Objects.equals(this.interval, copilotAsyncAggregationQuery.interval) &&
            Objects.equals(this.granularity, copilotAsyncAggregationQuery.granularity) &&
            Objects.equals(this.timeZone, copilotAsyncAggregationQuery.timeZone) &&
            Objects.equals(this.groupBy, copilotAsyncAggregationQuery.groupBy) &&
            Objects.equals(this.filter, copilotAsyncAggregationQuery.filter) &&
            Objects.equals(this.metrics, copilotAsyncAggregationQuery.metrics) &&
            Objects.equals(this.flattenMultivaluedDimensions, copilotAsyncAggregationQuery.flattenMultivaluedDimensions) &&
            Objects.equals(this.views, copilotAsyncAggregationQuery.views) &&
            Objects.equals(this.alternateTimeDimension, copilotAsyncAggregationQuery.alternateTimeDimension) &&
            Objects.equals(this.pageSize, copilotAsyncAggregationQuery.pageSize);
  }
  ...
  public String toString() {
    ...
    sb.append("class CopilotAsyncAggregationQuery {\n");
