...
public class GetConversationsVideoParticipantCommunicationWrapupRequest {
	...
	public GetConversationsVideoParticipantCommunicationWrapupRequest withConversationId(String conversationId) {
	...
	public GetConversationsVideoParticipantCommunicationWrapupRequest withParticipantId(String participantId) {
	...
	public GetConversationsVideoParticipantCommunicationWrapupRequest withCommunicationId(String communicationId) {
	...
	public GetConversationsVideoParticipantCommunicationWrapupRequest withProvisional(Boolean provisional) {
    ...
    public GetConversationsVideoParticipantCommunicationWrapupRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for GetConversationsVideoParticipantCommunicationWrapupRequest.");
        }
        
        // verify the required parameter 'participantId' is set
        if (this.participantId == null) {
            throw new IllegalStateException("Missing the required parameter 'participantId' when building request for GetConversationsVideoParticipantCommunicationWrapupRequest.");
        }
        
        // verify the required parameter 'communicationId' is set
        if (this.communicationId == null) {
            throw new IllegalStateException("Missing the required parameter 'communicationId' when building request for GetConversationsVideoParticipantCommunicationWrapupRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/conversations/videos/{conversationId}/participants/{participantId}/communications/{communicationId}/wrapup")
	...
	public static class Builder {
		private final GetConversationsVideoParticipantCommunicationWrapupRequest request;

		private Builder() {
			request = new GetConversationsVideoParticipantCommunicationWrapupRequest();
		}
		...
		public GetConversationsVideoParticipantCommunicationWrapupRequest build() {
