...
public class PostConversationsMessageMessagesBulkRequest {
	...
	public PostConversationsMessageMessagesBulkRequest withConversationId(String conversationId) {
	...
	public PostConversationsMessageMessagesBulkRequest withBody(List<String> body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostConversationsMessageMessagesBulkRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<List<String>> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PostConversationsMessageMessagesBulkRequest.");
        }
	...
	public static class Builder {
		private final PostConversationsMessageMessagesBulkRequest request;

		private Builder() {
			request = new PostConversationsMessageMessagesBulkRequest();
		}
		...
		public PostConversationsMessageMessagesBulkRequest build() {
