...
public class DeleteTokenRequest {
	...
	public DeleteTokenRequest withUserId(String userId) {
    ...
    public DeleteTokenRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.userId == null) {
            throw new IllegalStateException("Missing the required parameter 'userId' when building request for DeleteTokenRequest.");
        }
