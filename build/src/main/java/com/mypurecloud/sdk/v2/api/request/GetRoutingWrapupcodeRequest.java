...
public class GetRoutingWrapupcodeRequest {
	...
	public GetRoutingWrapupcodeRequest withCodeId(String codeId) {
    ...
    public GetRoutingWrapupcodeRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.codeId == null) {
            throw new IllegalStateException("Missing the required parameter 'codeId' when building request for GetRoutingWrapupcodeRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/routing/wrapupcodes/{codeId}")
	...
	public static class Builder {
		private final GetRoutingWrapupcodeRequest request;

		private Builder() {
			request = new GetRoutingWrapupcodeRequest();
		}
		...
		public GetRoutingWrapupcodeRequest build() {
