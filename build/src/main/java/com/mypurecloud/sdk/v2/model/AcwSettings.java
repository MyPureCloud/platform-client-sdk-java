...
public class AcwSettings  implements Serializable {
 ...
 @JsonDeserialize(using = WrapupPromptEnumDeserializer.class)
  ...
  @ApiModelProperty(example = "null", value = "The amount of time the agent can stay in ACW (Min: 1 sec, Max: 60 min).  Can only be used when ACW is AGENT_REQUESTED, MANDATORY_TIMEOUT or MANDATORY_FORCED_TIMEOUT.")
