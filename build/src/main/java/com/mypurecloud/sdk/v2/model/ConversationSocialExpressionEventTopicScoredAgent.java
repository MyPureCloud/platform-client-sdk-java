...
public class ConversationSocialExpressionEventTopicScoredAgent  implements Serializable {
  ...
  public ConversationSocialExpressionEventTopicScoredAgent() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
    }
  }

  public ConversationSocialExpressionEventTopicScoredAgent(Boolean initWithEmptyList) {
   ...
   **/
  public ConversationSocialExpressionEventTopicScoredAgent score(Long score) {
    this.score = score;
    return this;
  }
