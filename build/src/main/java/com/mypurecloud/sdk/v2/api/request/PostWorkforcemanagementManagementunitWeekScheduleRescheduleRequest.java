...
public class PostWorkforcemanagementManagementunitWeekScheduleRescheduleRequest {
	...
	public PostWorkforcemanagementManagementunitWeekScheduleRescheduleRequest withManagementUnitId(String managementUnitId) {
	...
	public PostWorkforcemanagementManagementunitWeekScheduleRescheduleRequest withWeekId(String weekId) {
	...
	public PostWorkforcemanagementManagementunitWeekScheduleRescheduleRequest withScheduleId(String scheduleId) {
    ...
    public PostWorkforcemanagementManagementunitWeekScheduleRescheduleRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<RescheduleRequest> withHttpInfo() {
        ...
        if (this.managementUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'managementUnitId' when building request for PostWorkforcemanagementManagementunitWeekScheduleRescheduleRequest.");
        }
        
        // verify the required parameter 'weekId' is set
        if (this.weekId == null) {
            throw new IllegalStateException("Missing the required parameter 'weekId' when building request for PostWorkforcemanagementManagementunitWeekScheduleRescheduleRequest.");
        }
        
        // verify the required parameter 'scheduleId' is set
        if (this.scheduleId == null) {
            throw new IllegalStateException("Missing the required parameter 'scheduleId' when building request for PostWorkforcemanagementManagementunitWeekScheduleRescheduleRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/managementunits/{managementUnitId}/weeks/{weekId}/schedules/{scheduleId}/reschedule")
	...
	public static class Builder {
		private final PostWorkforcemanagementManagementunitWeekScheduleRescheduleRequest request;

		private Builder() {
			request = new PostWorkforcemanagementManagementunitWeekScheduleRescheduleRequest();
		}
		...
		public PostWorkforcemanagementManagementunitWeekScheduleRescheduleRequest build() {
