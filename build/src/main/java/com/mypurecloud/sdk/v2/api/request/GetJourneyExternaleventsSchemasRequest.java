...
public class GetJourneyExternaleventsSchemasRequest {
    ...
    public GetJourneyExternaleventsSchemasRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/journey/externalevents/schemas")
	...
	public static class Builder {
		private final GetJourneyExternaleventsSchemasRequest request;

		private Builder() {
			request = new GetJourneyExternaleventsSchemasRequest();
		}
		...
		public GetJourneyExternaleventsSchemasRequest build() {
