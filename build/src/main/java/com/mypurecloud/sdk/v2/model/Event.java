...
public class Event  implements Serializable {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, correlationId, customerId, customerIdType, session, eventType, genericActionEvent, outcomeAchievedEvent, segmentAssignedEvent, webActionEvent, webEvent, createdDate);
  }
