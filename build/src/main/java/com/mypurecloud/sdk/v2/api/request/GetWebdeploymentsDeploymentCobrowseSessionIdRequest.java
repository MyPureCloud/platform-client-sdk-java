...
public class GetWebdeploymentsDeploymentCobrowseSessionIdRequest {
	...
	public GetWebdeploymentsDeploymentCobrowseSessionIdRequest withDeploymentId(String deploymentId) {
	...
	public GetWebdeploymentsDeploymentCobrowseSessionIdRequest withSessionId(String sessionId) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.deploymentId == null) {
            throw new IllegalStateException("Missing the required parameter 'deploymentId' when building request for GetWebdeploymentsDeploymentCobrowseSessionIdRequest.");
        }
        
        // verify the required parameter 'sessionId' is set
        if (this.sessionId == null) {
            throw new IllegalStateException("Missing the required parameter 'sessionId' when building request for GetWebdeploymentsDeploymentCobrowseSessionIdRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/webdeployments/deployments/{deploymentId}/cobrowse/{sessionId}")
	...
	public static class Builder {
		private final GetWebdeploymentsDeploymentCobrowseSessionIdRequest request;

		private Builder() {
			request = new GetWebdeploymentsDeploymentCobrowseSessionIdRequest();
		}
		...
		public GetWebdeploymentsDeploymentCobrowseSessionIdRequest build() {
