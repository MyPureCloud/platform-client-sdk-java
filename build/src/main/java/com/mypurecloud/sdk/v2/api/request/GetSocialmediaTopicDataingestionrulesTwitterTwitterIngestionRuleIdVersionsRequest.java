...
public class GetSocialmediaTopicDataingestionrulesTwitterTwitterIngestionRuleIdVersionsRequest {
	...
	public GetSocialmediaTopicDataingestionrulesTwitterTwitterIngestionRuleIdVersionsRequest withTopicId(String topicId) {
	...
	public GetSocialmediaTopicDataingestionrulesTwitterTwitterIngestionRuleIdVersionsRequest withTwitterIngestionRuleId(String twitterIngestionRuleId) {
	...
	public GetSocialmediaTopicDataingestionrulesTwitterTwitterIngestionRuleIdVersionsRequest withPageNumber(Integer pageNumber) {
	...
	public GetSocialmediaTopicDataingestionrulesTwitterTwitterIngestionRuleIdVersionsRequest withPageSize(Integer pageSize) {
	...
	public GetSocialmediaTopicDataingestionrulesTwitterTwitterIngestionRuleIdVersionsRequest withIncludeDeleted(Boolean includeDeleted) {
    ...
    public GetSocialmediaTopicDataingestionrulesTwitterTwitterIngestionRuleIdVersionsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.topicId == null) {
            throw new IllegalStateException("Missing the required parameter 'topicId' when building request for GetSocialmediaTopicDataingestionrulesTwitterTwitterIngestionRuleIdVersionsRequest.");
        }
        
        // verify the required parameter 'twitterIngestionRuleId' is set
        if (this.twitterIngestionRuleId == null) {
            throw new IllegalStateException("Missing the required parameter 'twitterIngestionRuleId' when building request for GetSocialmediaTopicDataingestionrulesTwitterTwitterIngestionRuleIdVersionsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/socialmedia/topics/{topicId}/dataingestionrules/twitter/{twitterIngestionRuleId}/versions")
	...
	public static class Builder {
		private final GetSocialmediaTopicDataingestionrulesTwitterTwitterIngestionRuleIdVersionsRequest request;

		private Builder() {
			request = new GetSocialmediaTopicDataingestionrulesTwitterTwitterIngestionRuleIdVersionsRequest();
		}
		...
		public GetSocialmediaTopicDataingestionrulesTwitterTwitterIngestionRuleIdVersionsRequest build() {
