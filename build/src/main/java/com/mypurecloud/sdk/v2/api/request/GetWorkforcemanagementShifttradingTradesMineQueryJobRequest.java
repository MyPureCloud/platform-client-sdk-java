...
public class GetWorkforcemanagementShifttradingTradesMineQueryJobRequest {
	...
	public GetWorkforcemanagementShifttradingTradesMineQueryJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetWorkforcemanagementShifttradingTradesMineQueryJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetWorkforcemanagementShifttradingTradesMineQueryJobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/shifttrading/trades/mine/query/jobs/{jobId}")
	...
	public static class Builder {
		private final GetWorkforcemanagementShifttradingTradesMineQueryJobRequest request;

		private Builder() {
			request = new GetWorkforcemanagementShifttradingTradesMineQueryJobRequest();
		}
		...
		public GetWorkforcemanagementShifttradingTradesMineQueryJobRequest build() {
