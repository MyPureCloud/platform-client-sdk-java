...
public class PolicyUser  implements Serializable {
 ...
 @JsonDeserialize(using = StateEnumDeserializer.class)
   ...
   * User ID
   **/
  public PolicyUser id(String id) {
    this.id = id;
    return this;
  }
  ...
  /**
   **/
  public PolicyUser name(String name) {
    this.name = name;
    return this;
  }
   ...
   **/
  public PolicyUser division(Division division) {
  ...
  /**
   **/
  public PolicyUser chat(Chat chat) {
    this.chat = chat;
    return this;
  }
  ...
  /**
   **/
  public PolicyUser department(String department) {
  ...
  /**
   **/
  public PolicyUser email(String email) {
    this.email = email;
    return this;
  }
   ...
   **/
  public PolicyUser addresses(List<Contact> addresses) {
  ...
  /**
   **/
  public PolicyUser title(String title) {
    this.title = title;
    return this;
  }
  ...
  /**
   **/
  public PolicyUser manager(User manager) {
  ...
  /**
   **/
  public PolicyUser images(List<Image> images) {
    this.images = images;
    return this;
  }
   ...
   **/
  public PolicyUser version(Integer version) {
  ...
  /**
   **/
  public PolicyUser certifications(List<String> certifications) {
  ...
  /**
   **/
  public PolicyUser biography(Biography biography) {
  ...
  /**
   **/
  public PolicyUser employerInfo(EmployerInfo employerInfo) {
   ...
   **/
  public PolicyUser preferredName(String preferredName) {
   ...
   * acd auto answer
   **/
  public PolicyUser acdAutoAnswer(Boolean acdAutoAnswer) {
  ...
  /**
   **/
  public PolicyUser lastTokenIssued(OAuthLastTokenIssued lastTokenIssued) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, policyUser.id) &&
            Objects.equals(this.name, policyUser.name) &&
            Objects.equals(this.division, policyUser.division) &&
            Objects.equals(this.chat, policyUser.chat) &&
            Objects.equals(this.department, policyUser.department) &&
            Objects.equals(this.email, policyUser.email) &&
            Objects.equals(this.primaryContactInfo, policyUser.primaryContactInfo) &&
            Objects.equals(this.addresses, policyUser.addresses) &&
            Objects.equals(this.state, policyUser.state) &&
            Objects.equals(this.title, policyUser.title) &&
            Objects.equals(this.username, policyUser.username) &&
            Objects.equals(this.manager, policyUser.manager) &&
            Objects.equals(this.images, policyUser.images) &&
            Objects.equals(this.version, policyUser.version) &&
            Objects.equals(this.certifications, policyUser.certifications) &&
            Objects.equals(this.biography, policyUser.biography) &&
            Objects.equals(this.employerInfo, policyUser.employerInfo) &&
            Objects.equals(this.preferredName, policyUser.preferredName) &&
            Objects.equals(this.routingStatus, policyUser.routingStatus) &&
            Objects.equals(this.presence, policyUser.presence) &&
            Objects.equals(this.integrationPresence, policyUser.integrationPresence) &&
            Objects.equals(this.conversationSummary, policyUser.conversationSummary) &&
            Objects.equals(this.outOfOffice, policyUser.outOfOffice) &&
            Objects.equals(this.geolocation, policyUser.geolocation) &&
            Objects.equals(this.station, policyUser.station) &&
            Objects.equals(this.authorization, policyUser.authorization) &&
            Objects.equals(this.profileSkills, policyUser.profileSkills) &&
            Objects.equals(this.locations, policyUser.locations) &&
            Objects.equals(this.groups, policyUser.groups) &&
            Objects.equals(this.team, policyUser.team) &&
            Objects.equals(this.workPlanBidRanks, policyUser.workPlanBidRanks) &&
            Objects.equals(this.skills, policyUser.skills) &&
            Objects.equals(this.languages, policyUser.languages) &&
            Objects.equals(this.acdAutoAnswer, policyUser.acdAutoAnswer) &&
            Objects.equals(this.languagePreference, policyUser.languagePreference) &&
            Objects.equals(this.lastTokenIssued, policyUser.lastTokenIssued) &&
            Objects.equals(this.dateLastLogin, policyUser.dateLastLogin) &&
            Objects.equals(this.dateWelcomeSent, policyUser.dateWelcomeSent) &&
            Objects.equals(this.selfUri, policyUser.selfUri);
  }
