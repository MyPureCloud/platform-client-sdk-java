...
public class PostConversationCommunicationAgentchecklistRequest {
	...
	public PostConversationCommunicationAgentchecklistRequest withConversationId(String conversationId) {
	...
	public PostConversationCommunicationAgentchecklistRequest withCommunicationId(String communicationId) {
	...
	public PostConversationCommunicationAgentchecklistRequest withAgentChecklistId(String agentChecklistId) {
	    this.setAgentChecklistId(agentChecklistId);
	    return this;
	} 

	private ChecklistActivationPayload body;
	public ChecklistActivationPayload getBody() {
		return this.body;
	}

	public void setBody(ChecklistActivationPayload body) {
		this.body = body;
	}

	public PostConversationCommunicationAgentchecklistRequest withBody(ChecklistActivationPayload body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostConversationCommunicationAgentchecklistRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<ChecklistActivationPayload> withHttpInfo() {
        
        // verify the required parameter 'conversationId' is set
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PostConversationCommunicationAgentchecklistRequest.");
        }
        
        // verify the required parameter 'communicationId' is set
        if (this.communicationId == null) {
            throw new IllegalStateException("Missing the required parameter 'communicationId' when building request for PostConversationCommunicationAgentchecklistRequest.");
        }
        
        // verify the required parameter 'agentChecklistId' is set
        if (this.agentChecklistId == null) {
            throw new IllegalStateException("Missing the required parameter 'agentChecklistId' when building request for PostConversationCommunicationAgentchecklistRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostConversationCommunicationAgentchecklistRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/conversations/{conversationId}/communications/{communicationId}/agentchecklists/{agentChecklistId}")
	...
	public static Builder builder(String conversationId, String communicationId, String agentChecklistId, ChecklistActivationPayload body) {
	    return new Builder()
	            .withRequiredParams(conversationId, communicationId, agentChecklistId, body);
	}


	public static class Builder {
		private final PostConversationCommunicationAgentchecklistRequest request;

		private Builder() {
			request = new PostConversationCommunicationAgentchecklistRequest();
		}
		...
		public Builder withBody(ChecklistActivationPayload body) {
		...
		public Builder withRequiredParams(String conversationId, String communicationId, String agentChecklistId, ChecklistActivationPayload body) {
			request.setConversationId(conversationId);
			request.setCommunicationId(communicationId);
			request.setAgentChecklistId(agentChecklistId);
			request.setBody(body);
		...
		public PostConversationCommunicationAgentchecklistRequest build() {
