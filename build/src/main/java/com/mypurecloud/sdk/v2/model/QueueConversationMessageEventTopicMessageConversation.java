...
public class QueueConversationMessageEventTopicMessageConversation  implements Serializable {
  ...
  private List<QueueConversationMessageEventTopicConversationDivisionMembership> divisions = null;

  public QueueConversationMessageEventTopicMessageConversation() {
  ...
  /**
   **/
  public QueueConversationMessageEventTopicMessageConversation id(String id) {
    this.id = id;
    return this;
  }
  ...
  /**
   **/
  public QueueConversationMessageEventTopicMessageConversation name(String name) {
    this.name = name;
    return this;
  }
  ...
  /**
   **/
  public QueueConversationMessageEventTopicMessageConversation participants(List<QueueConversationMessageEventTopicMessageMediaParticipant> participants) {
  ...
  public void setParticipants(List<QueueConversationMessageEventTopicMessageMediaParticipant> participants) {
    this.participants = participants;
  }
  ...
  /**
   **/
  public QueueConversationMessageEventTopicMessageConversation otherMediaUris(List<String> otherMediaUris) {
  ...
  /**
   **/
  public QueueConversationMessageEventTopicMessageConversation address(String address) {
  ...
  /**
   **/
  public QueueConversationMessageEventTopicMessageConversation accessAttributes(List<String> accessAttributes) {
  ...
  /**
   **/
  public QueueConversationMessageEventTopicMessageConversation inactivityTimeout(Date inactivityTimeout) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    QueueConversationMessageEventTopicMessageConversation queueConversationMessageEventTopicMessageConversation = (QueueConversationMessageEventTopicMessageConversation) o;

    return Objects.equals(this.id, queueConversationMessageEventTopicMessageConversation.id) &&
            ...
            Objects.equals(this.accessAttributes, queueConversationMessageEventTopicMessageConversation.accessAttributes) &&
            Objects.equals(this.inactivityTimeout, queueConversationMessageEventTopicMessageConversation.inactivityTimeout) &&
