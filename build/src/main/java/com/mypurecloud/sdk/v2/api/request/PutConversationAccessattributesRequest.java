...
public class PutConversationAccessattributesRequest {
	...
	public PutConversationAccessattributesRequest withConversationId(String conversationId) {
	    this.setConversationId(conversationId);
	    return this;
	} 

	private ConversationAccessAttributesUpdate body;
	public ConversationAccessAttributesUpdate getBody() {
		return this.body;
	}

	public void setBody(ConversationAccessAttributesUpdate body) {
		this.body = body;
	}

	public PutConversationAccessattributesRequest withBody(ConversationAccessAttributesUpdate body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutConversationAccessattributesRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<ConversationAccessAttributesUpdate> withHttpInfo() {
        
        // verify the required parameter 'conversationId' is set
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PutConversationAccessattributesRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutConversationAccessattributesRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/conversations/{conversationId}/accessattributes")
	...
	public static Builder builder(String conversationId, ConversationAccessAttributesUpdate body) {
	    return new Builder()
	...
	public static class Builder {
		private final PutConversationAccessattributesRequest request;

		private Builder() {
			request = new PutConversationAccessattributesRequest();
		}
		...
		public Builder withBody(ConversationAccessAttributesUpdate body) {
		...
		public Builder withRequiredParams(String conversationId, ConversationAccessAttributesUpdate body) {
			request.setConversationId(conversationId);
			request.setBody(body);
		...
		public PutConversationAccessattributesRequest build() {
