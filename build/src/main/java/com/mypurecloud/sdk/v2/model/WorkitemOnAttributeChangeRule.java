...
public class WorkitemOnAttributeChangeRule  implements Serializable {
 ...
 @JsonDeserialize(using = TypeEnumDeserializer.class)
  ...
  /**
   **/
  public WorkitemOnAttributeChangeRule name(String name) {
    this.name = name;
    return this;
  }
   ...
   * The type of the rule.
   **/
  public WorkitemOnAttributeChangeRule type(TypeEnum type) {
    this.type = type;
    return this;
  }
   ...
   **/
  public WorkitemOnAttributeChangeRule action(WorkitemRuleAction action) {
    this.action = action;
    return this;
  }
   ...
   **/
  public WorkitemOnAttributeChangeRule worktype(WorktypeReference worktype) {
   ...
   **/
  public WorkitemOnAttributeChangeRule condition(WorkitemOnAttributeChangeCondition condition) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    WorkitemOnAttributeChangeRule workitemOnAttributeChangeRule = (WorkitemOnAttributeChangeRule) o;

    return Objects.equals(this.id, workitemOnAttributeChangeRule.id) &&
            Objects.equals(this.name, workitemOnAttributeChangeRule.name) &&
            Objects.equals(this.type, workitemOnAttributeChangeRule.type) &&
            Objects.equals(this.action, workitemOnAttributeChangeRule.action) &&
            Objects.equals(this.worktype, workitemOnAttributeChangeRule.worktype) &&
            Objects.equals(this.condition, workitemOnAttributeChangeRule.condition) &&
            Objects.equals(this.selfUri, workitemOnAttributeChangeRule.selfUri);
  }
