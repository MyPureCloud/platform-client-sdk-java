...
public class GetProcessautomationScheduledtriggersRequest {
	...
	public GetProcessautomationScheduledtriggersRequest withBefore(String before) {
	...
	public GetProcessautomationScheduledtriggersRequest withAfter(String after) {
	    this.setAfter(after);
	    return this;
	} 
	...
	public GetProcessautomationScheduledtriggersRequest withPageSize(String pageSize) {
	...
	public GetProcessautomationScheduledtriggersRequest withEnabled(Boolean enabled) {
    ...
    public GetProcessautomationScheduledtriggersRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/processautomation/scheduledtriggers")
	...
	public static class Builder {
		private final GetProcessautomationScheduledtriggersRequest request;

		private Builder() {
			request = new GetProcessautomationScheduledtriggersRequest();
		}
		...
		public GetProcessautomationScheduledtriggersRequest build() {
