...
public class PostWorkforcemanagementBusinessunitWeekScheduleUpdateRequest {
	...
	public PostWorkforcemanagementBusinessunitWeekScheduleUpdateRequest withWeekId(LocalDate weekId) {
	...
	private ProcessScheduleUpdateUploadRequest body;
	public ProcessScheduleUpdateUploadRequest getBody() {
		return this.body;
	}

	public void setBody(ProcessScheduleUpdateUploadRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementBusinessunitWeekScheduleUpdateRequest withBody(ProcessScheduleUpdateUploadRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public ApiRequest<ProcessScheduleUpdateUploadRequest> withHttpInfo() {
        
        // verify the required parameter 'businessUnitId' is set
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PostWorkforcemanagementBusinessunitWeekScheduleUpdateRequest.");
        }
        
        // verify the required parameter 'weekId' is set
        if (this.weekId == null) {
            throw new IllegalStateException("Missing the required parameter 'weekId' when building request for PostWorkforcemanagementBusinessunitWeekScheduleUpdateRequest.");
        }
        
        // verify the required parameter 'scheduleId' is set
        if (this.scheduleId == null) {
            throw new IllegalStateException("Missing the required parameter 'scheduleId' when building request for PostWorkforcemanagementBusinessunitWeekScheduleUpdateRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementBusinessunitWeekScheduleUpdateRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/weeks/{weekId}/schedules/{scheduleId}/update")
	...
	public static Builder builder(String businessUnitId, LocalDate weekId, String scheduleId, ProcessScheduleUpdateUploadRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementBusinessunitWeekScheduleUpdateRequest request;

		private Builder() {
			request = new PostWorkforcemanagementBusinessunitWeekScheduleUpdateRequest();
		}
		...
		public Builder withBody(ProcessScheduleUpdateUploadRequest body) {
		...
		public Builder withRequiredParams(String businessUnitId, LocalDate weekId, String scheduleId, ProcessScheduleUpdateUploadRequest body) {
			request.setBusinessUnitId(businessUnitId);
						request.setWeekId(weekId);
						request.setScheduleId(scheduleId);
						request.setBody(body);
		...
		public PostWorkforcemanagementBusinessunitWeekScheduleUpdateRequest build() {
