...
public class PostAnalyticsResolutionsAggregatesQueryRequest {

	private ResolutionAggregationQuery body;
	public ResolutionAggregationQuery getBody() {
		return this.body;
	}

	public void setBody(ResolutionAggregationQuery body) {
		this.body = body;
	}

	public PostAnalyticsResolutionsAggregatesQueryRequest withBody(ResolutionAggregationQuery body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostAnalyticsResolutionsAggregatesQueryRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<ResolutionAggregationQuery> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostAnalyticsResolutionsAggregatesQueryRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/analytics/resolutions/aggregates/query")
                .withBody(body)
	...
	public static Builder builder(ResolutionAggregationQuery body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostAnalyticsResolutionsAggregatesQueryRequest request;

		private Builder() {
			request = new PostAnalyticsResolutionsAggregatesQueryRequest();
		}


		public Builder withBody(ResolutionAggregationQuery body) {
		...
		public Builder withRequiredParams(ResolutionAggregationQuery body) {
			request.setBody(body);
		...
		public PostAnalyticsResolutionsAggregatesQueryRequest build() {
