...
public class PostAnalyticsRoutingActivityQueryRequest {

	private RoutingActivityQuery body;
	public RoutingActivityQuery getBody() {
		return this.body;
	}

	public void setBody(RoutingActivityQuery body) {
		this.body = body;
	}

	public PostAnalyticsRoutingActivityQueryRequest withBody(RoutingActivityQuery body) {
	    this.setBody(body);
	    return this;
	} 
	...
	public PostAnalyticsRoutingActivityQueryRequest withPageSize(Integer pageSize) {
	...
	public PostAnalyticsRoutingActivityQueryRequest withPageNumber(Integer pageNumber) {
    ...
    public PostAnalyticsRoutingActivityQueryRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<RoutingActivityQuery> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostAnalyticsRoutingActivityQueryRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/analytics/routing/activity/query")
	...
	public static Builder builder(RoutingActivityQuery body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostAnalyticsRoutingActivityQueryRequest request;

		private Builder() {
			request = new PostAnalyticsRoutingActivityQueryRequest();
		}


		public Builder withBody(RoutingActivityQuery body) {
		...
		public Builder withRequiredParams(RoutingActivityQuery body) {
			request.setBody(body);
		...
		public PostAnalyticsRoutingActivityQueryRequest build() {
