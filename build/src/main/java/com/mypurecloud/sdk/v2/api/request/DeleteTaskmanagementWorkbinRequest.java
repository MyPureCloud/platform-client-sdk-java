...
public class DeleteTaskmanagementWorkbinRequest {
	...
	public DeleteTaskmanagementWorkbinRequest withWorkbinId(String workbinId) {
    ...
    public DeleteTaskmanagementWorkbinRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.workbinId == null) {
            throw new IllegalStateException("Missing the required parameter 'workbinId' when building request for DeleteTaskmanagementWorkbinRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/taskmanagement/workbins/{workbinId}")
	...
	public static class Builder {
		private final DeleteTaskmanagementWorkbinRequest request;

		private Builder() {
			request = new DeleteTaskmanagementWorkbinRequest();
		}
		...
		public DeleteTaskmanagementWorkbinRequest build() {
