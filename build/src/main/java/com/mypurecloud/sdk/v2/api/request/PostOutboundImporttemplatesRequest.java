...
public class PostOutboundImporttemplatesRequest {
	...
	public void setBody(ImportTemplate body) {
		this.body = body;
	}

	public PostOutboundImporttemplatesRequest withBody(ImportTemplate body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostOutboundImporttemplatesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<ImportTemplate> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostOutboundImporttemplatesRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/outbound/importtemplates")
                .withBody(body)
	...
	public static Builder builder(ImportTemplate body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostOutboundImporttemplatesRequest request;

		private Builder() {
			request = new PostOutboundImporttemplatesRequest();
		}


		public Builder withBody(ImportTemplate body) {
		...
		public Builder withRequiredParams(ImportTemplate body) {
			request.setBody(body);
		...
		public PostOutboundImporttemplatesRequest build() {
