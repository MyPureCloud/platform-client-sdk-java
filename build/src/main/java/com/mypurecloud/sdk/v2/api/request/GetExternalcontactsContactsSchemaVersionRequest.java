...
public class GetExternalcontactsContactsSchemaVersionRequest {
	...
	public GetExternalcontactsContactsSchemaVersionRequest withSchemaId(String schemaId) {
	...
	public GetExternalcontactsContactsSchemaVersionRequest withVersionId(String versionId) {
    ...
    public GetExternalcontactsContactsSchemaVersionRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.schemaId == null) {
            throw new IllegalStateException("Missing the required parameter 'schemaId' when building request for GetExternalcontactsContactsSchemaVersionRequest.");
        }
        
        // verify the required parameter 'versionId' is set
        if (this.versionId == null) {
            throw new IllegalStateException("Missing the required parameter 'versionId' when building request for GetExternalcontactsContactsSchemaVersionRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/externalcontacts/contacts/schemas/{schemaId}/versions/{versionId}")
	...
	public static class Builder {
		private final GetExternalcontactsContactsSchemaVersionRequest request;

		private Builder() {
			request = new GetExternalcontactsContactsSchemaVersionRequest();
		}
		...
		public GetExternalcontactsContactsSchemaVersionRequest build() {
