...
public class GetVoicemailUserMailboxRequest {
	...
	public GetVoicemailUserMailboxRequest withUserId(String userId) {
    ...
    public GetVoicemailUserMailboxRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.userId == null) {
            throw new IllegalStateException("Missing the required parameter 'userId' when building request for GetVoicemailUserMailboxRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/voicemail/users/{userId}/mailbox")
	...
	public static class Builder {
		private final GetVoicemailUserMailboxRequest request;

		private Builder() {
			request = new GetVoicemailUserMailboxRequest();
		}
		...
		public GetVoicemailUserMailboxRequest build() {
