...
public class SiteSearchCriteria  implements Serializable {
 ...
 @JsonDeserialize(using = TypeEnumDeserializer.class)
  ...
  public SiteSearchCriteria(Boolean initWithEmptyList) {
   ...
   **/
  public SiteSearchCriteria endValue(String endValue) {
   ...
   **/
  public SiteSearchCriteria values(List<String> values) {
    this.values = values;
    return this;
  }
   ...
   **/
  public SiteSearchCriteria startValue(String startValue) {
   ...
   **/
  public SiteSearchCriteria value(String value) {
    this.value = value;
    return this;
  }
   ...
   * How to apply this search criteria against other criteria
   **/
  public SiteSearchCriteria operator(OperatorEnum operator) {
   ...
   **/
  public SiteSearchCriteria group(List<SiteSearchCriteria> group) {
    this.group = group;
    return this;
  }
  ...
  @JsonProperty("group")
  public List<SiteSearchCriteria> getGroup() {
    return group;
  }
  public void setGroup(List<SiteSearchCriteria> group) {
    this.group = group;
  }
   ...
   **/
  public SiteSearchCriteria dateFormat(String dateFormat) {
   ...
   * Search Type
   **/
  public SiteSearchCriteria type(TypeEnum type) {
    this.type = type;
    return this;
  }
   ...
   **/
  public SiteSearchCriteria fields(List<String> fields) {
    this.fields = fields;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SiteSearchCriteria siteSearchCriteria = (SiteSearchCriteria) o;

    return Objects.equals(this.endValue, siteSearchCriteria.endValue) &&
            Objects.equals(this.values, siteSearchCriteria.values) &&
            Objects.equals(this.startValue, siteSearchCriteria.startValue) &&
            Objects.equals(this.value, siteSearchCriteria.value) &&
            Objects.equals(this.operator, siteSearchCriteria.operator) &&
            Objects.equals(this.group, siteSearchCriteria.group) &&
            Objects.equals(this.dateFormat, siteSearchCriteria.dateFormat) &&
            Objects.equals(this.type, siteSearchCriteria.type) &&
            Objects.equals(this.fields, siteSearchCriteria.fields);
  }
