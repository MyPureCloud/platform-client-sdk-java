...
public class GetScriptsPublishedScriptIdPagesRequest {
    ...
    public GetScriptsPublishedScriptIdPagesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.scriptId == null) {
            throw new IllegalStateException("Missing the required parameter 'scriptId' when building request for GetScriptsPublishedScriptIdPagesRequest.");
        }
	...
	public static class Builder {
		private final GetScriptsPublishedScriptIdPagesRequest request;

		private Builder() {
			request = new GetScriptsPublishedScriptIdPagesRequest();
		}
		...
		public GetScriptsPublishedScriptIdPagesRequest build() {
