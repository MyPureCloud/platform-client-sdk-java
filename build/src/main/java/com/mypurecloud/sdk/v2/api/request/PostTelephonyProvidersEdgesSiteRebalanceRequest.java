...
public class PostTelephonyProvidersEdgesSiteRebalanceRequest {
	...
	public PostTelephonyProvidersEdgesSiteRebalanceRequest withSiteId(String siteId) {
    ...
    public PostTelephonyProvidersEdgesSiteRebalanceRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() throws ApiException {
        ...
        if (this.siteId == null) {
            throw new ApiException(400, "Missing the required parameter 'siteId' when building request for PostTelephonyProvidersEdgesSiteRebalanceRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/telephony/providers/edges/sites/{siteId}/rebalance")
	...
	public static class Builder {
		private final PostTelephonyProvidersEdgesSiteRebalanceRequest request;

		private Builder() {
			request = new PostTelephonyProvidersEdgesSiteRebalanceRequest();
		}
