...
public class DeleteCasemanagementCaseplanStageplanRequest {
	...
	public DeleteCasemanagementCaseplanStageplanRequest withCaseplanId(String caseplanId) {
	...
	public DeleteCasemanagementCaseplanStageplanRequest withStageplanId(String stageplanId) {
    ...
    public DeleteCasemanagementCaseplanStageplanRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.caseplanId == null) {
            throw new IllegalStateException("Missing the required parameter 'caseplanId' when building request for DeleteCasemanagementCaseplanStageplanRequest.");
        }
        
        // verify the required parameter 'stageplanId' is set
        if (this.stageplanId == null) {
            throw new IllegalStateException("Missing the required parameter 'stageplanId' when building request for DeleteCasemanagementCaseplanStageplanRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/casemanagement/caseplans/{caseplanId}/stageplans/{stageplanId}")
	...
	public static Builder builder(String caseplanId, String stageplanId) {
	    return new Builder()
	            .withRequiredParams(caseplanId, stageplanId);
	}


	public static class Builder {
		private final DeleteCasemanagementCaseplanStageplanRequest request;

		private Builder() {
			request = new DeleteCasemanagementCaseplanStageplanRequest();
		}
		...
		public Builder withRequiredParams(String caseplanId, String stageplanId) {
			request.setCaseplanId(caseplanId);
			request.setStageplanId(stageplanId);
		...
		public DeleteCasemanagementCaseplanStageplanRequest build() {
