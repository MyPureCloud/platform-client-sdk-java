...
public class PutExternalcontactsGraphsClusterscanClusterMergeRequest {
	...
	public PutExternalcontactsGraphsClusterscanClusterMergeRequest withScanId(String scanId) {
	...
	public PutExternalcontactsGraphsClusterscanClusterMergeRequest withClusterId(String clusterId) {
    ...
    public PutExternalcontactsGraphsClusterscanClusterMergeRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.scanId == null) {
            throw new IllegalStateException("Missing the required parameter 'scanId' when building request for PutExternalcontactsGraphsClusterscanClusterMergeRequest.");
        }
        
        // verify the required parameter 'clusterId' is set
        if (this.clusterId == null) {
            throw new IllegalStateException("Missing the required parameter 'clusterId' when building request for PutExternalcontactsGraphsClusterscanClusterMergeRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/externalcontacts/graphs/clusterscans/{scanId}/clusters/{clusterId}/merge")
                .withPathParameter("scanId", scanId)
        
                .withPathParameter("clusterId", clusterId)
	...
	public static Builder builder(String scanId, String clusterId) {
	    return new Builder()
	            .withRequiredParams(scanId, clusterId);
	}


	public static class Builder {
		private final PutExternalcontactsGraphsClusterscanClusterMergeRequest request;

		private Builder() {
			request = new PutExternalcontactsGraphsClusterscanClusterMergeRequest();
		}
		...
		public Builder withRequiredParams(String scanId, String clusterId) {
			request.setScanId(scanId);
			request.setClusterId(clusterId);
		...
		public PutExternalcontactsGraphsClusterscanClusterMergeRequest build() {
