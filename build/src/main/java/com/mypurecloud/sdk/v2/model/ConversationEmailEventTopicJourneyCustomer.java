...
public class ConversationEmailEventTopicJourneyCustomer  implements Serializable {
  
  private String id = null;
  private String idType = null;

  public ConversationEmailEventTopicJourneyCustomer() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
    }
  }

  public ConversationEmailEventTopicJourneyCustomer(Boolean initWithEmptyList) {
   ...
   **/
  public ConversationEmailEventTopicJourneyCustomer id(String id) {
    this.id = id;
    return this;
  }
   ...
   **/
  public ConversationEmailEventTopicJourneyCustomer idType(String idType) {
    this.idType = idType;
    return this;
  }
