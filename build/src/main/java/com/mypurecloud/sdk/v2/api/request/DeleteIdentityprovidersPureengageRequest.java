...
public class DeleteIdentityprovidersPureengageRequest {
    ...
    public DeleteIdentityprovidersPureengageRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("DELETE", "/api/v2/identityproviders/pureengage")
	...
	public static class Builder {
		private final DeleteIdentityprovidersPureengageRequest request;

		private Builder() {
			request = new DeleteIdentityprovidersPureengageRequest();
		}
		...
		public DeleteIdentityprovidersPureengageRequest build() {
