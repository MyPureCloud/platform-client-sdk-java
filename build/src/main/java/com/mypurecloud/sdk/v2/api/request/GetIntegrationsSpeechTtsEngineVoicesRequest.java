...
public class GetIntegrationsSpeechTtsEngineVoicesRequest {
	...
	public GetIntegrationsSpeechTtsEngineVoicesRequest withEngineId(String engineId) {
	...
	public GetIntegrationsSpeechTtsEngineVoicesRequest withPageNumber(Integer pageNumber) {
	...
	public GetIntegrationsSpeechTtsEngineVoicesRequest withPageSize(Integer pageSize) {
    ...
    public GetIntegrationsSpeechTtsEngineVoicesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.engineId == null) {
            throw new IllegalStateException("Missing the required parameter 'engineId' when building request for GetIntegrationsSpeechTtsEngineVoicesRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/integrations/speech/tts/engines/{engineId}/voices")
	...
	public static class Builder {
		private final GetIntegrationsSpeechTtsEngineVoicesRequest request;

		private Builder() {
			request = new GetIntegrationsSpeechTtsEngineVoicesRequest();
		}
		...
		public GetIntegrationsSpeechTtsEngineVoicesRequest build() {
