...
public class GetAuthorizationPoliciesTargetsRequest {
    ...
    public GetAuthorizationPoliciesTargetsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/authorization/policies/targets")
	...
	public static class Builder {
		private final GetAuthorizationPoliciesTargetsRequest request;

		private Builder() {
			request = new GetAuthorizationPoliciesTargetsRequest();
		}
		...
		public GetAuthorizationPoliciesTargetsRequest build() {
