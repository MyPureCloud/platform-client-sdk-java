...
public class PostRoutingSmsPhonenumbersAlphanumericRequest {

	private SmsAlphanumericProvision body;
	public SmsAlphanumericProvision getBody() {
		return this.body;
	}

	public void setBody(SmsAlphanumericProvision body) {
		this.body = body;
	}

	public PostRoutingSmsPhonenumbersAlphanumericRequest withBody(SmsAlphanumericProvision body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostRoutingSmsPhonenumbersAlphanumericRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<SmsAlphanumericProvision> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostRoutingSmsPhonenumbersAlphanumericRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/routing/sms/phonenumbers/alphanumeric")
                .withBody(body)
	...
	public static Builder builder(SmsAlphanumericProvision body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostRoutingSmsPhonenumbersAlphanumericRequest request;

		private Builder() {
			request = new PostRoutingSmsPhonenumbersAlphanumericRequest();
		}


		public Builder withBody(SmsAlphanumericProvision body) {
		...
		public Builder withRequiredParams(SmsAlphanumericProvision body) {
			request.setBody(body);
		...
		public PostRoutingSmsPhonenumbersAlphanumericRequest build() {
