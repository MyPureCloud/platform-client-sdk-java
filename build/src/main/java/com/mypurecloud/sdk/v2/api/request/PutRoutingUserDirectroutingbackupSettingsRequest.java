...
public class PutRoutingUserDirectroutingbackupSettingsRequest {
	...
	public PutRoutingUserDirectroutingbackupSettingsRequest withUserId(String userId) {
	    this.setUserId(userId);
	    return this;
	} 

	private AgentDirectRoutingBackupSettings body;
	public AgentDirectRoutingBackupSettings getBody() {
		return this.body;
	}

	public void setBody(AgentDirectRoutingBackupSettings body) {
		this.body = body;
	}

	public PutRoutingUserDirectroutingbackupSettingsRequest withBody(AgentDirectRoutingBackupSettings body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutRoutingUserDirectroutingbackupSettingsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<AgentDirectRoutingBackupSettings> withHttpInfo() {
        
        // verify the required parameter 'userId' is set
        if (this.userId == null) {
            throw new IllegalStateException("Missing the required parameter 'userId' when building request for PutRoutingUserDirectroutingbackupSettingsRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutRoutingUserDirectroutingbackupSettingsRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/routing/users/{userId}/directroutingbackup/settings")
	...
	public static Builder builder(String userId, AgentDirectRoutingBackupSettings body) {
	    return new Builder()
	...
	public static class Builder {
		private final PutRoutingUserDirectroutingbackupSettingsRequest request;

		private Builder() {
			request = new PutRoutingUserDirectroutingbackupSettingsRequest();
		}
		...
		public Builder withBody(AgentDirectRoutingBackupSettings body) {
		...
		public Builder withRequiredParams(String userId, AgentDirectRoutingBackupSettings body) {
			request.setUserId(userId);
			request.setBody(body);
		...
		public PutRoutingUserDirectroutingbackupSettingsRequest build() {
