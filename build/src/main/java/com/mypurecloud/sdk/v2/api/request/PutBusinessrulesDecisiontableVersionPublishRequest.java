...
public class PutBusinessrulesDecisiontableVersionPublishRequest {
	...
	public PutBusinessrulesDecisiontableVersionPublishRequest withTableId(String tableId) {
	...
	public PutBusinessrulesDecisiontableVersionPublishRequest withTableVersion(Integer tableVersion) {
    ...
    public PutBusinessrulesDecisiontableVersionPublishRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.tableId == null) {
            throw new IllegalStateException("Missing the required parameter 'tableId' when building request for PutBusinessrulesDecisiontableVersionPublishRequest.");
        }
        
        // verify the required parameter 'tableVersion' is set
        if (this.tableVersion == null) {
            throw new IllegalStateException("Missing the required parameter 'tableVersion' when building request for PutBusinessrulesDecisiontableVersionPublishRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/businessrules/decisiontables/{tableId}/versions/{tableVersion}/publish")
	...
	public static class Builder {
		private final PutBusinessrulesDecisiontableVersionPublishRequest request;

		private Builder() {
			request = new PutBusinessrulesDecisiontableVersionPublishRequest();
		}
		...
		public PutBusinessrulesDecisiontableVersionPublishRequest build() {
