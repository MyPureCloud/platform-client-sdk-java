...
public class ConversationCallbackEventTopicWrapup  implements Serializable {
  ...
  public ConversationCallbackEventTopicWrapup() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
      tags = new ArrayList<String>();
    }
  }

  public ConversationCallbackEventTopicWrapup(Boolean initWithEmptyList) {
   ...
   **/
  public ConversationCallbackEventTopicWrapup durationSeconds(Long durationSeconds) {
