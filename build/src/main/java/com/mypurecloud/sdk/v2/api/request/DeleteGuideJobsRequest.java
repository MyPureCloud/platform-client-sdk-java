...
public class DeleteGuideJobsRequest {
	...
	public DeleteGuideJobsRequest withGuideId(String guideId) {
    ...
    public DeleteGuideJobsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.guideId == null) {
            throw new IllegalStateException("Missing the required parameter 'guideId' when building request for DeleteGuideJobsRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/guides/{guideId}/jobs")
	...
	public static class Builder {
		private final DeleteGuideJobsRequest request;

		private Builder() {
			request = new DeleteGuideJobsRequest();
		}
		...
		public DeleteGuideJobsRequest build() {
