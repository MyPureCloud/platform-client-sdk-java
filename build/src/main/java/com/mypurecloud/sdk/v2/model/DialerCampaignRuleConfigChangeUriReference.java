...
public class DialerCampaignRuleConfigChangeUriReference  implements Serializable {
  
  private String id = null;
  private String name = null;

  public DialerCampaignRuleConfigChangeUriReference() {
   ...
   **/
  public DialerCampaignRuleConfigChangeUriReference id(String id) {
    this.id = id;
    return this;
  }
   ...
   **/
  public DialerCampaignRuleConfigChangeUriReference name(String name) {
    this.name = name;
    return this;
  }
