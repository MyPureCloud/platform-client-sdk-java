...
public class DeleteSocialmediaTopicRequest {
	...
	public DeleteSocialmediaTopicRequest withTopicId(String topicId) {
	...
	public DeleteSocialmediaTopicRequest withHardDelete(Boolean hardDelete) {
    ...
    public DeleteSocialmediaTopicRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.topicId == null) {
            throw new IllegalStateException("Missing the required parameter 'topicId' when building request for DeleteSocialmediaTopicRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/socialmedia/topics/{topicId}")
	...
	public static class Builder {
		private final DeleteSocialmediaTopicRequest request;

		private Builder() {
			request = new DeleteSocialmediaTopicRequest();
		}
		...
		public DeleteSocialmediaTopicRequest build() {
