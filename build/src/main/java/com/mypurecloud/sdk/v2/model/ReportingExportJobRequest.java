...
public class ReportingExportJobRequest  implements Serializable {
 ...
 @JsonDeserialize(using = ViewTypeEnumDeserializer.class)
  public enum ViewTypeEnum {
    ...
    QUEUE_WORKITEM_ACTIVITY_SUMMARY_VIEW("QUEUE_WORKITEM_ACTIVITY_SUMMARY_VIEW"),
    QUEUE_WORKITEM_ACTIVITY_DETAIL_VIEW("QUEUE_WORKITEM_ACTIVITY_DETAIL_VIEW"),
    DIGITAL_ADOPTION_VIEW("DIGITAL_ADOPTION_VIEW"),
    ...
    AGENTIC_VIRTUAL_AGENT_PERFORMANCE_VIEW("AGENTIC_VIRTUAL_AGENT_PERFORMANCE_VIEW"),
    CALLBACK_QUEUE_PERFORMANCE_SUMMARY_VIEW("CALLBACK_QUEUE_PERFORMANCE_SUMMARY_VIEW"),
    CALLBACK_QUEUE_PERFORMANCE_DETAIL_VIEW("CALLBACK_QUEUE_PERFORMANCE_DETAIL_VIEW");
 ...
 @JsonDeserialize(using = DurationFormatEnumDeserializer.class)
   ...
   * Indicates the duration format for the exports
   **/
  public ReportingExportJobRequest durationFormat(DurationFormatEnum durationFormat) {
