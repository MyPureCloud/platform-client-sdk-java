...
public class GetWorkforcemanagementBusinessunitSchedulebidGroupPreferencesRequest {
	...
	public GetWorkforcemanagementBusinessunitSchedulebidGroupPreferencesRequest withBusinessUnitId(String businessUnitId) {
	...
	public GetWorkforcemanagementBusinessunitSchedulebidGroupPreferencesRequest withBidId(String bidId) {
	    this.setBidId(bidId);
	    return this;
	} 
	...
	public GetWorkforcemanagementBusinessunitSchedulebidGroupPreferencesRequest withBidGroupId(String bidGroupId) {
	...
	public GetWorkforcemanagementBusinessunitSchedulebidGroupPreferencesRequest withForceDownloadService(Boolean forceDownloadService) {
	...
	public GetWorkforcemanagementBusinessunitSchedulebidGroupPreferencesRequest withExpand(List<String> expand) {
	    this.setExpand(expand);
	    return this;
	} 

	public enum expandValues { 
		AGENTSSCHEDULEBIDPREFERENCES_AGENTSCHEDULEBIDPREFERENCEPRIORITIES("agentsScheduleBidPreferences.agentScheduleBidPreferencePriorities");
    ...
    public GetWorkforcemanagementBusinessunitSchedulebidGroupPreferencesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for GetWorkforcemanagementBusinessunitSchedulebidGroupPreferencesRequest.");
        }
        
        // verify the required parameter 'bidId' is set
        if (this.bidId == null) {
            throw new IllegalStateException("Missing the required parameter 'bidId' when building request for GetWorkforcemanagementBusinessunitSchedulebidGroupPreferencesRequest.");
        }
        
        // verify the required parameter 'bidGroupId' is set
        if (this.bidGroupId == null) {
            throw new IllegalStateException("Missing the required parameter 'bidGroupId' when building request for GetWorkforcemanagementBusinessunitSchedulebidGroupPreferencesRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/schedulebids/{bidId}/groups/{bidGroupId}/preferences")
	...
	public static class Builder {
		private final GetWorkforcemanagementBusinessunitSchedulebidGroupPreferencesRequest request;

		private Builder() {
			request = new GetWorkforcemanagementBusinessunitSchedulebidGroupPreferencesRequest();
		}
		...
		public GetWorkforcemanagementBusinessunitSchedulebidGroupPreferencesRequest build() {
