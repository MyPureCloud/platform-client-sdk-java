...
public class PostExternalcontactsOrganizationsRequest {
	...
	public PostExternalcontactsOrganizationsRequest withBody(ExternalOrganization body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostExternalcontactsOrganizationsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<ExternalOrganization> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostExternalcontactsOrganizationsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/externalcontacts/organizations")
                .withBody(body)
	...
	public static Builder builder(ExternalOrganization body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostExternalcontactsOrganizationsRequest request;

		private Builder() {
			request = new PostExternalcontactsOrganizationsRequest();
		}
		...
		public Builder withRequiredParams(ExternalOrganization body) {
			request.setBody(body);
