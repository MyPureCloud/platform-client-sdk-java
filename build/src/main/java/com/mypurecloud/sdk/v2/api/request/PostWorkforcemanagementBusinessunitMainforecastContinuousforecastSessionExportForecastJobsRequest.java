...
public class PostWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionExportForecastJobsRequest {
	...
	public PostWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionExportForecastJobsRequest withBusinessUnitId(String businessUnitId) {
	...
	public PostWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionExportForecastJobsRequest withBody(AggregatedExportJobRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionExportForecastJobsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<AggregatedExportJobRequest> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PostWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionExportForecastJobsRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionExportForecastJobsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/mainforecast/continuousforecast/session/export/forecast/jobs")
	...
	public static class Builder {
		private final PostWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionExportForecastJobsRequest request;

		private Builder() {
			request = new PostWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionExportForecastJobsRequest();
		}
		...
		public PostWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionExportForecastJobsRequest build() {
