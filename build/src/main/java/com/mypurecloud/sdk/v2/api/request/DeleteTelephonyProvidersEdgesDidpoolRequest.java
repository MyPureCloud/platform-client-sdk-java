...
public class DeleteTelephonyProvidersEdgesDidpoolRequest {
	...
	public DeleteTelephonyProvidersEdgesDidpoolRequest withDidPoolId(String didPoolId) {
    ...
    public DeleteTelephonyProvidersEdgesDidpoolRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() throws ApiException {
        ...
        if (this.didPoolId == null) {
            throw new ApiException(400, "Missing the required parameter 'didPoolId' when building request for DeleteTelephonyProvidersEdgesDidpoolRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/telephony/providers/edges/didpools/{didPoolId}")
	...
	public static class Builder {
		private final DeleteTelephonyProvidersEdgesDidpoolRequest request;

		private Builder() {
			request = new DeleteTelephonyProvidersEdgesDidpoolRequest();
		}
