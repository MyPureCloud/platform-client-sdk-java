...
public class GetSocialmediaTopicDataingestionrulesFacebookFacebookIngestionRuleIdVersionsRequest {
	...
	public GetSocialmediaTopicDataingestionrulesFacebookFacebookIngestionRuleIdVersionsRequest withTopicId(String topicId) {
	...
	public GetSocialmediaTopicDataingestionrulesFacebookFacebookIngestionRuleIdVersionsRequest withFacebookIngestionRuleId(String facebookIngestionRuleId) {
	...
	public GetSocialmediaTopicDataingestionrulesFacebookFacebookIngestionRuleIdVersionsRequest withPageNumber(Integer pageNumber) {
	...
	public GetSocialmediaTopicDataingestionrulesFacebookFacebookIngestionRuleIdVersionsRequest withPageSize(Integer pageSize) {
	...
	public GetSocialmediaTopicDataingestionrulesFacebookFacebookIngestionRuleIdVersionsRequest withIncludeDeleted(Boolean includeDeleted) {
    ...
    public GetSocialmediaTopicDataingestionrulesFacebookFacebookIngestionRuleIdVersionsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.topicId == null) {
            throw new IllegalStateException("Missing the required parameter 'topicId' when building request for GetSocialmediaTopicDataingestionrulesFacebookFacebookIngestionRuleIdVersionsRequest.");
        }
        
        // verify the required parameter 'facebookIngestionRuleId' is set
        if (this.facebookIngestionRuleId == null) {
            throw new IllegalStateException("Missing the required parameter 'facebookIngestionRuleId' when building request for GetSocialmediaTopicDataingestionrulesFacebookFacebookIngestionRuleIdVersionsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/socialmedia/topics/{topicId}/dataingestionrules/facebook/{facebookIngestionRuleId}/versions")
	...
	public static class Builder {
		private final GetSocialmediaTopicDataingestionrulesFacebookFacebookIngestionRuleIdVersionsRequest request;

		private Builder() {
			request = new GetSocialmediaTopicDataingestionrulesFacebookFacebookIngestionRuleIdVersionsRequest();
		}
		...
		public GetSocialmediaTopicDataingestionrulesFacebookFacebookIngestionRuleIdVersionsRequest build() {
