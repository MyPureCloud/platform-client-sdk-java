...
public class PutConversationSecureattributesRequest {
	...
	public PutConversationSecureattributesRequest withConversationId(String conversationId) {
	    this.setConversationId(conversationId);
	    return this;
	} 

	private ConversationSecureAttributes body;
	public ConversationSecureAttributes getBody() {
		return this.body;
	}

	public void setBody(ConversationSecureAttributes body) {
		this.body = body;
	}

	public PutConversationSecureattributesRequest withBody(ConversationSecureAttributes body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutConversationSecureattributesRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<ConversationSecureAttributes> withHttpInfo() {
        
        // verify the required parameter 'conversationId' is set
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PutConversationSecureattributesRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutConversationSecureattributesRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/conversations/{conversationId}/secureattributes")
	...
	public static Builder builder(String conversationId, ConversationSecureAttributes body) {
	    return new Builder()
	...
	public static class Builder {
		private final PutConversationSecureattributesRequest request;

		private Builder() {
			request = new PutConversationSecureattributesRequest();
		}
		...
		public Builder withBody(ConversationSecureAttributes body) {
		...
		public Builder withRequiredParams(String conversationId, ConversationSecureAttributes body) {
			request.setConversationId(conversationId);
			request.setBody(body);
		...
		public PutConversationSecureattributesRequest build() {
