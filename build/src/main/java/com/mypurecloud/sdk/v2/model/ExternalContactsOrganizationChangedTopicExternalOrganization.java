...
public class ExternalContactsOrganizationChangedTopicExternalOrganization  implements Serializable {
  ...
  private List<ExternalContactsOrganizationChangedTopicTicker> tickers = new ArrayList<ExternalContactsOrganizationChangedTopicTicker>();
  ...
  /**
   **/
  public ExternalContactsOrganizationChangedTopicExternalOrganization employeeCount(Integer employeeCount) {
  ...
  /**
   **/
  public ExternalContactsOrganizationChangedTopicExternalOrganization revenue(Integer revenue) {
