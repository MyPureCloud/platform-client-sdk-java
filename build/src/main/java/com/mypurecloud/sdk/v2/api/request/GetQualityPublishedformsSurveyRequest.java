...
public class GetQualityPublishedformsSurveyRequest {
	...
	public GetQualityPublishedformsSurveyRequest withFormId(String formId) {
    ...
    public GetQualityPublishedformsSurveyRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.formId == null) {
            throw new IllegalStateException("Missing the required parameter 'formId' when building request for GetQualityPublishedformsSurveyRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/quality/publishedforms/surveys/{formId}")
	...
	public static class Builder {
		private final GetQualityPublishedformsSurveyRequest request;

		private Builder() {
			request = new GetQualityPublishedformsSurveyRequest();
		}
		...
		public GetQualityPublishedformsSurveyRequest build() {
