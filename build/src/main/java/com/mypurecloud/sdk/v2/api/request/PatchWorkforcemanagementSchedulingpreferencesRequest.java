...
public class PatchWorkforcemanagementSchedulingpreferencesRequest {

	private UpdateAgentSchedulingPreferencesRequest body;
	public UpdateAgentSchedulingPreferencesRequest getBody() {
		return this.body;
	}

	public void setBody(UpdateAgentSchedulingPreferencesRequest body) {
		this.body = body;
	}

	public PatchWorkforcemanagementSchedulingpreferencesRequest withBody(UpdateAgentSchedulingPreferencesRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchWorkforcemanagementSchedulingpreferencesRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<UpdateAgentSchedulingPreferencesRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchWorkforcemanagementSchedulingpreferencesRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/workforcemanagement/schedulingpreferences")
                .withBody(body)
	...
	public static Builder builder(UpdateAgentSchedulingPreferencesRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PatchWorkforcemanagementSchedulingpreferencesRequest request;

		private Builder() {
			request = new PatchWorkforcemanagementSchedulingpreferencesRequest();
		}


		public Builder withBody(UpdateAgentSchedulingPreferencesRequest body) {
		...
		public Builder withRequiredParams(UpdateAgentSchedulingPreferencesRequest body) {
			request.setBody(body);
		...
		public PatchWorkforcemanagementSchedulingpreferencesRequest build() {
