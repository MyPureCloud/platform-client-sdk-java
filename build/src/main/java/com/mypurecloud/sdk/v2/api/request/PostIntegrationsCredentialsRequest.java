...
public class PostIntegrationsCredentialsRequest {
	...
	public PostIntegrationsCredentialsRequest withBody(Credential body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostIntegrationsCredentialsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Credential> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("POST", "/api/v2/integrations/credentials")
                .withBody(body)
	...
	public static class Builder {
		private final PostIntegrationsCredentialsRequest request;

		private Builder() {
			request = new PostIntegrationsCredentialsRequest();
		}
		...
		public PostIntegrationsCredentialsRequest build() {
