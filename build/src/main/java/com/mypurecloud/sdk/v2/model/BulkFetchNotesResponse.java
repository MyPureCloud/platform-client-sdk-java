...
import com.mypurecloud.sdk.v2.model.BulkResponseResultNoteEntityBulkEntityErrorEntity;
...
public class BulkFetchNotesResponse  implements Serializable {
  ...
  private List<BulkResponseResultNoteEntityBulkEntityErrorEntity> results = null;
  private Integer errorCount = null;
  private List<Integer> errorIndexes = null;

  public BulkFetchNotesResponse() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
      results = new ArrayList<BulkResponseResultNoteEntityBulkEntityErrorEntity>();
      errorIndexes = new ArrayList<Integer>();
    }
  }

  public BulkFetchNotesResponse(Boolean initWithEmptyList) {
   ...
   **/
  public BulkFetchNotesResponse results(List<BulkResponseResultNoteEntityBulkEntityErrorEntity> results) {
  ...
  public List<BulkResponseResultNoteEntityBulkEntityErrorEntity> getResults() {
    return results;
  }
  public void setResults(List<BulkResponseResultNoteEntityBulkEntityErrorEntity> results) {
    this.results = results;
  }
   ...
   **/
  public BulkFetchNotesResponse errorCount(Integer errorCount) {
   ...
   **/
  public BulkFetchNotesResponse errorIndexes(List<Integer> errorIndexes) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    BulkFetchNotesResponse bulkFetchNotesResponse = (BulkFetchNotesResponse) o;

    return Objects.equals(this.results, bulkFetchNotesResponse.results) &&
            Objects.equals(this.errorCount, bulkFetchNotesResponse.errorCount) &&
            Objects.equals(this.errorIndexes, bulkFetchNotesResponse.errorIndexes);
  }
