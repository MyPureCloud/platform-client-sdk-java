...
public class GetRoutingEmailOutboundDomainSearchRequest {
	...
	public GetRoutingEmailOutboundDomainSearchRequest withDomainId(String domainId) {
    ...
    public GetRoutingEmailOutboundDomainSearchRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.domainId == null) {
            throw new IllegalStateException("Missing the required parameter 'domainId' when building request for GetRoutingEmailOutboundDomainSearchRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/routing/email/outbound/domains/{domainId}/search")
	...
	public static class Builder {
		private final GetRoutingEmailOutboundDomainSearchRequest request;

		private Builder() {
			request = new GetRoutingEmailOutboundDomainSearchRequest();
		}
		...
		public GetRoutingEmailOutboundDomainSearchRequest build() {
