...
public class PostBusinessrulesDecisiontableVersionRollbackRequest {
	...
	public PostBusinessrulesDecisiontableVersionRollbackRequest withTableId(String tableId) {
	...
	public PostBusinessrulesDecisiontableVersionRollbackRequest withTableVersion(Integer tableVersion) {
	    this.setTableVersion(tableVersion);
	    return this;
	} 

	private RollbackDecisionTableVersionRequest body;
	public RollbackDecisionTableVersionRequest getBody() {
		return this.body;
	}

	public void setBody(RollbackDecisionTableVersionRequest body) {
		this.body = body;
	}

	public PostBusinessrulesDecisiontableVersionRollbackRequest withBody(RollbackDecisionTableVersionRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostBusinessrulesDecisiontableVersionRollbackRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<RollbackDecisionTableVersionRequest> withHttpInfo() {
        
        // verify the required parameter 'tableId' is set
        if (this.tableId == null) {
            throw new IllegalStateException("Missing the required parameter 'tableId' when building request for PostBusinessrulesDecisiontableVersionRollbackRequest.");
        }
        
        // verify the required parameter 'tableVersion' is set
        if (this.tableVersion == null) {
            throw new IllegalStateException("Missing the required parameter 'tableVersion' when building request for PostBusinessrulesDecisiontableVersionRollbackRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/businessrules/decisiontables/{tableId}/versions/{tableVersion}/rollback")
	...
	public static class Builder {
		private final PostBusinessrulesDecisiontableVersionRollbackRequest request;

		private Builder() {
			request = new PostBusinessrulesDecisiontableVersionRollbackRequest();
		}
		...
		public Builder withBody(RollbackDecisionTableVersionRequest body) {
		...
		public PostBusinessrulesDecisiontableVersionRollbackRequest build() {
