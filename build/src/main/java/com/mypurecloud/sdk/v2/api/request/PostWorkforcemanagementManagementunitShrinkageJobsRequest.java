...
public class PostWorkforcemanagementManagementunitShrinkageJobsRequest {
	...
	public PostWorkforcemanagementManagementunitShrinkageJobsRequest withManagementUnitId(String managementUnitId) {
	    this.setManagementUnitId(managementUnitId);
	    return this;
	} 

	private WfmHistoricalShrinkageRequest body;
	public WfmHistoricalShrinkageRequest getBody() {
		return this.body;
	}

	public void setBody(WfmHistoricalShrinkageRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementManagementunitShrinkageJobsRequest withBody(WfmHistoricalShrinkageRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementManagementunitShrinkageJobsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<WfmHistoricalShrinkageRequest> withHttpInfo() {
        
        // verify the required parameter 'managementUnitId' is set
        if (this.managementUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'managementUnitId' when building request for PostWorkforcemanagementManagementunitShrinkageJobsRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementManagementunitShrinkageJobsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/managementunits/{managementUnitId}/shrinkage/jobs")
	...
	public static Builder builder(String managementUnitId, WfmHistoricalShrinkageRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementManagementunitShrinkageJobsRequest request;

		private Builder() {
			request = new PostWorkforcemanagementManagementunitShrinkageJobsRequest();
		}
		...
		public Builder withBody(WfmHistoricalShrinkageRequest body) {
		...
		public Builder withRequiredParams(String managementUnitId, WfmHistoricalShrinkageRequest body) {
			request.setManagementUnitId(managementUnitId);
			request.setBody(body);
		...
		public PostWorkforcemanagementManagementunitShrinkageJobsRequest build() {
