...
public class PostAnalyticsJourneysAggregatesJobsRequest {

	private JourneyAsyncAggregationQuery body;
	public JourneyAsyncAggregationQuery getBody() {
		return this.body;
	}

	public void setBody(JourneyAsyncAggregationQuery body) {
		this.body = body;
	}

	public PostAnalyticsJourneysAggregatesJobsRequest withBody(JourneyAsyncAggregationQuery body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostAnalyticsJourneysAggregatesJobsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<JourneyAsyncAggregationQuery> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostAnalyticsJourneysAggregatesJobsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/analytics/journeys/aggregates/jobs")
                .withBody(body)
	...
	public static Builder builder(JourneyAsyncAggregationQuery body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostAnalyticsJourneysAggregatesJobsRequest request;

		private Builder() {
			request = new PostAnalyticsJourneysAggregatesJobsRequest();
		}


		public Builder withBody(JourneyAsyncAggregationQuery body) {
		...
		public Builder withRequiredParams(JourneyAsyncAggregationQuery body) {
			request.setBody(body);
		...
		public PostAnalyticsJourneysAggregatesJobsRequest build() {
