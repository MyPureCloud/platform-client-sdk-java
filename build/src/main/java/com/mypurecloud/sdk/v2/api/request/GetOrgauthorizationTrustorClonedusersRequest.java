...
public class GetOrgauthorizationTrustorClonedusersRequest {
	...
	public GetOrgauthorizationTrustorClonedusersRequest withTrustorOrgId(String trustorOrgId) {
    ...
    public GetOrgauthorizationTrustorClonedusersRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.trustorOrgId == null) {
            throw new IllegalStateException("Missing the required parameter 'trustorOrgId' when building request for GetOrgauthorizationTrustorClonedusersRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/orgauthorization/trustors/{trustorOrgId}/clonedusers")
	...
	public static class Builder {
		private final GetOrgauthorizationTrustorClonedusersRequest request;

		private Builder() {
			request = new GetOrgauthorizationTrustorClonedusersRequest();
		}
		...
		public GetOrgauthorizationTrustorClonedusersRequest build() {
