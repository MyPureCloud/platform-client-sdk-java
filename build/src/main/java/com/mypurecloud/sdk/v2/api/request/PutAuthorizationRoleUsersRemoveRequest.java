...
public class PutAuthorizationRoleUsersRemoveRequest {
    ...
    public ApiRequest<List<String>> withHttpInfo() throws ApiException {
        ...
        if (this.roleId == null) {
            throw new ApiException(400, "Missing the required parameter 'roleId' when building request for PutAuthorizationRoleUsersRemoveRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new ApiException(400, "Missing the required parameter 'body' when building request for PutAuthorizationRoleUsersRemoveRequest.");
        }
