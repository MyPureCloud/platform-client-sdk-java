...
public class EvaluationSearchSubAggregationDTO  implements Serializable {
 ...
 @JsonDeserialize(using = TypeEnumDeserializer.class)
  ...
  public EvaluationSearchSubAggregationDTO() {
   ...
   **/
  public EvaluationSearchSubAggregationDTO name(String name) {
    this.name = name;
    return this;
  }
   ...
   * The field to aggregate on.ALLOWED FIELDS BY AGGREGATION TYPE:TERM/COUNT: evaluationStatus, aiScoringFailureType, questionAiAnswerFailureType,TERM: formId, formIdReleased, contextId, questionGroupId, questionId, questionAnswerId, released, questionGroupMarkedNA, questionMarkedNA, questionAiScored, questionEaScored,SUM/AVERAGE/STATS/RANGE: totalScore, totalCriticalScore, questionGroupScorePercentage,criticalQuestionGroupScorePercentage, questionScore,SUM: disputeCount, rescoreCount, eaSuggestionCount, eaAcceptedSuggestionCount,aiSuggestionCount, aiAcceptedSuggestionCount,DATE_HISTOGRAM: conversationDate, createdDate, submittedDate, releaseDate
   **/
  public EvaluationSearchSubAggregationDTO field(FieldEnum field) {
    this.field = field;
    return this;
  }
   ...
   * The Type of Aggregation to Perform
   **/
  public EvaluationSearchSubAggregationDTO type(TypeEnum type) {
    this.type = type;
    return this;
  }
   ...
   **/
  public EvaluationSearchSubAggregationDTO size(Integer size) {
    this.size = size;
    return this;
  }
   ...
   **/
  public EvaluationSearchSubAggregationDTO calendarInterval(String calendarInterval) {
   ...
   **/
  public EvaluationSearchSubAggregationDTO format(String format) {
    this.format = format;
    return this;
  }
   ...
   **/
  public EvaluationSearchSubAggregationDTO ranges(List<QueryApiSearchAggregationRange> ranges) {
    this.ranges = ranges;
    return this;
  }
   ...
   **/
  public EvaluationSearchSubAggregationDTO subAggregations(List<EvaluationSearchSubAggregationDTO> subAggregations) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EvaluationSearchSubAggregationDTO evaluationSearchSubAggregationDTO = (EvaluationSearchSubAggregationDTO) o;

    return Objects.equals(this.name, evaluationSearchSubAggregationDTO.name) &&
            Objects.equals(this.field, evaluationSearchSubAggregationDTO.field) &&
            Objects.equals(this.type, evaluationSearchSubAggregationDTO.type) &&
            Objects.equals(this.size, evaluationSearchSubAggregationDTO.size) &&
            Objects.equals(this.calendarInterval, evaluationSearchSubAggregationDTO.calendarInterval) &&
            Objects.equals(this.format, evaluationSearchSubAggregationDTO.format) &&
            Objects.equals(this.ranges, evaluationSearchSubAggregationDTO.ranges) &&
            Objects.equals(this.subAggregations, evaluationSearchSubAggregationDTO.subAggregations);
  }
