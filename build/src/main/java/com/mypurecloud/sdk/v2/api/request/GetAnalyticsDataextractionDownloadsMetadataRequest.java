...
public class GetAnalyticsDataextractionDownloadsMetadataRequest {
	...
	public GetAnalyticsDataextractionDownloadsMetadataRequest withBefore(String before) {
	...
	public GetAnalyticsDataextractionDownloadsMetadataRequest withAfter(String after) {
	    this.setAfter(after);
	    return this;
	} 
	...
	public GetAnalyticsDataextractionDownloadsMetadataRequest withPageSize(String pageSize) {
	...
	public GetAnalyticsDataextractionDownloadsMetadataRequest withDataSchema(String dataSchema) {
	...
	public GetAnalyticsDataextractionDownloadsMetadataRequest withDateStart(Date dateStart) {
	...
	public GetAnalyticsDataextractionDownloadsMetadataRequest withDateEnd(Date dateEnd) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/analytics/dataextraction/downloads/metadata")
                ...
                .withQueryParameters("dataSchema", "", dataSchema)
	...
	public static class Builder {
		private final GetAnalyticsDataextractionDownloadsMetadataRequest request;

		private Builder() {
			request = new GetAnalyticsDataextractionDownloadsMetadataRequest();
		}
		...
		public Builder withDataSchema(String dataSchema) {
		...
		public GetAnalyticsDataextractionDownloadsMetadataRequest build() {
