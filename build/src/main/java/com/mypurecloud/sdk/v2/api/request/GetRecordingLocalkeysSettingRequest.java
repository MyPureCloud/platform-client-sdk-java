...
public class GetRecordingLocalkeysSettingRequest {
	...
	public GetRecordingLocalkeysSettingRequest withSettingsId(String settingsId) {
    ...
    public GetRecordingLocalkeysSettingRequest withCustomHeader(String name, String value) {
