...
public class PostConversationParticipantInternalmessagesUsersCommunicationsRequest {
	...
	private MessagingConferWithUserRequest body;
	public MessagingConferWithUserRequest getBody() {
		return this.body;
	}

	public void setBody(MessagingConferWithUserRequest body) {
		this.body = body;
	}

	public PostConversationParticipantInternalmessagesUsersCommunicationsRequest withBody(MessagingConferWithUserRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public ApiRequest<MessagingConferWithUserRequest> withHttpInfo() {
        
        // verify the required parameter 'conversationId' is set
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PostConversationParticipantInternalmessagesUsersCommunicationsRequest.");
        }
        
        // verify the required parameter 'participantId' is set
        if (this.participantId == null) {
            throw new IllegalStateException("Missing the required parameter 'participantId' when building request for PostConversationParticipantInternalmessagesUsersCommunicationsRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostConversationParticipantInternalmessagesUsersCommunicationsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/conversations/{conversationId}/participants/{participantId}/internalmessages/users/communications")
	...
	public static Builder builder(String conversationId, String participantId, MessagingConferWithUserRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostConversationParticipantInternalmessagesUsersCommunicationsRequest request;

		private Builder() {
			request = new PostConversationParticipantInternalmessagesUsersCommunicationsRequest();
		}
		...
		public Builder withBody(MessagingConferWithUserRequest body) {
		...
		public Builder withRequiredParams(String conversationId, String participantId, MessagingConferWithUserRequest body) {
			request.setConversationId(conversationId);
			request.setParticipantId(participantId);
			request.setBody(body);
		...
		public PostConversationParticipantInternalmessagesUsersCommunicationsRequest build() {
