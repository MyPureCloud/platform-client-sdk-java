...
public class PostSocialmediaTopicDataingestionrulesFacebookRequest {
	...
	public PostSocialmediaTopicDataingestionrulesFacebookRequest withTopicId(String topicId) {
    ...
    public ApiRequest<FacebookDataIngestionRuleRequest> withHttpInfo() {
        ...
        if (this.topicId == null) {
            throw new IllegalStateException("Missing the required parameter 'topicId' when building request for PostSocialmediaTopicDataingestionrulesFacebookRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/socialmedia/topics/{topicId}/dataingestionrules/facebook")
	...
	public static class Builder {
		private final PostSocialmediaTopicDataingestionrulesFacebookRequest request;

		private Builder() {
			request = new PostSocialmediaTopicDataingestionrulesFacebookRequest();
		}
		...
		public PostSocialmediaTopicDataingestionrulesFacebookRequest build() {
