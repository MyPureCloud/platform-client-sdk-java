...
public class PostTaskmanagementWorkitemAcdCancelRequest {
	...
	public PostTaskmanagementWorkitemAcdCancelRequest withWorkitemId(String workitemId) {
    ...
    public PostTaskmanagementWorkitemAcdCancelRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.workitemId == null) {
            throw new IllegalStateException("Missing the required parameter 'workitemId' when building request for PostTaskmanagementWorkitemAcdCancelRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/taskmanagement/workitems/{workitemId}/acd/cancel")
	...
	public static class Builder {
		private final PostTaskmanagementWorkitemAcdCancelRequest request;

		private Builder() {
			request = new PostTaskmanagementWorkitemAcdCancelRequest();
		}
		...
		public PostTaskmanagementWorkitemAcdCancelRequest build() {
