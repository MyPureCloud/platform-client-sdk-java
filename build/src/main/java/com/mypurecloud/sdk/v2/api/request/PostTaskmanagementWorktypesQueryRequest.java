...
public class PostTaskmanagementWorktypesQueryRequest {

	private WorktypeQueryRequest body;
	public WorktypeQueryRequest getBody() {
		return this.body;
	}

	public void setBody(WorktypeQueryRequest body) {
		this.body = body;
	}

	public PostTaskmanagementWorktypesQueryRequest withBody(WorktypeQueryRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostTaskmanagementWorktypesQueryRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<WorktypeQueryRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostTaskmanagementWorktypesQueryRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/taskmanagement/worktypes/query")
                .withBody(body)
	...
	public static Builder builder(WorktypeQueryRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostTaskmanagementWorktypesQueryRequest request;

		private Builder() {
			request = new PostTaskmanagementWorktypesQueryRequest();
		}


		public Builder withBody(WorktypeQueryRequest body) {
		...
		public Builder withRequiredParams(WorktypeQueryRequest body) {
			request.setBody(body);
		...
		public PostTaskmanagementWorktypesQueryRequest build() {
