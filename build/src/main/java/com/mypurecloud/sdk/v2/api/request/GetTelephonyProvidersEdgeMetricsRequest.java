...
public class GetTelephonyProvidersEdgeMetricsRequest {
	...
	public GetTelephonyProvidersEdgeMetricsRequest withEdgeId(String edgeId) {
    ...
    public GetTelephonyProvidersEdgeMetricsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.edgeId == null) {
            throw new IllegalStateException("Missing the required parameter 'edgeId' when building request for GetTelephonyProvidersEdgeMetricsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/telephony/providers/edges/{edgeId}/metrics")
	...
	public static class Builder {
		private final GetTelephonyProvidersEdgeMetricsRequest request;

		private Builder() {
			request = new GetTelephonyProvidersEdgeMetricsRequest();
		}
		...
		public GetTelephonyProvidersEdgeMetricsRequest build() {
