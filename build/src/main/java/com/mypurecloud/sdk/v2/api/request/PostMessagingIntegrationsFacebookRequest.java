...
public class PostMessagingIntegrationsFacebookRequest {
	...
	public PostMessagingIntegrationsFacebookRequest withBody(FacebookIntegrationRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostMessagingIntegrationsFacebookRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<FacebookIntegrationRequest> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostMessagingIntegrationsFacebookRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/messaging/integrations/facebook")
                .withBody(body)
	...
	public static class Builder {
		private final PostMessagingIntegrationsFacebookRequest request;

		private Builder() {
			request = new PostMessagingIntegrationsFacebookRequest();
		}
		...
		public PostMessagingIntegrationsFacebookRequest build() {
