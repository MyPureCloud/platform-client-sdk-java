...
public class PostConversationsCallParticipantReplaceRequest {
    ...
    public ApiRequest<TransferRequest> withHttpInfo() throws ApiException {
        ...
        if (this.callId == null) {
            throw new ApiException(400, "Missing the required parameter 'callId' when building request for PostConversationsCallParticipantReplaceRequest.");
        }
        
        // verify the required parameter 'participantId' is set
        if (this.participantId == null) {
            throw new ApiException(400, "Missing the required parameter 'participantId' when building request for PostConversationsCallParticipantReplaceRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new ApiException(400, "Missing the required parameter 'body' when building request for PostConversationsCallParticipantReplaceRequest.");
        }
