...
public class PostWorkforcemanagementBusinessunitOpportunitiesBulkStatusesUpdateRequest {
	...
	public PostWorkforcemanagementBusinessunitOpportunitiesBulkStatusesUpdateRequest withBusinessUnitId(String businessUnitId) {
	    this.setBusinessUnitId(businessUnitId);
	    return this;
	} 

	private BulkOpportunitiesStatusUpdateRequest body;
	public BulkOpportunitiesStatusUpdateRequest getBody() {
		return this.body;
	}

	public void setBody(BulkOpportunitiesStatusUpdateRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementBusinessunitOpportunitiesBulkStatusesUpdateRequest withBody(BulkOpportunitiesStatusUpdateRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementBusinessunitOpportunitiesBulkStatusesUpdateRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<BulkOpportunitiesStatusUpdateRequest> withHttpInfo() {
        
        // verify the required parameter 'businessUnitId' is set
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PostWorkforcemanagementBusinessunitOpportunitiesBulkStatusesUpdateRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementBusinessunitOpportunitiesBulkStatusesUpdateRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/opportunities/bulk/statuses/update")
	...
	public static Builder builder(String businessUnitId, BulkOpportunitiesStatusUpdateRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementBusinessunitOpportunitiesBulkStatusesUpdateRequest request;

		private Builder() {
			request = new PostWorkforcemanagementBusinessunitOpportunitiesBulkStatusesUpdateRequest();
		}
		...
		public Builder withBody(BulkOpportunitiesStatusUpdateRequest body) {
		...
		public Builder withRequiredParams(String businessUnitId, BulkOpportunitiesStatusUpdateRequest body) {
			request.setBusinessUnitId(businessUnitId);
			request.setBody(body);
		...
		public PostWorkforcemanagementBusinessunitOpportunitiesBulkStatusesUpdateRequest build() {
