...
public class PostWorkforcemanagementManagementunitsRequest {
    
	private CreateManagementUnitApiRequest body;
	public CreateManagementUnitApiRequest getBody() {
		return this.body;
	}

	public void setBody(CreateManagementUnitApiRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementManagementunitsRequest withBody(CreateManagementUnitApiRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementManagementunitsRequest withCustomHeader(String name, String value) {
	...
	public static class Builder {
		private final PostWorkforcemanagementManagementunitsRequest request;

		private Builder() {
			request = new PostWorkforcemanagementManagementunitsRequest();
		}

		
		public Builder withBody(CreateManagementUnitApiRequest body) {
