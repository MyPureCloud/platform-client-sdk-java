...
public class GetConversationCommunicationInternalmessagesRequest {
	...
	public GetConversationCommunicationInternalmessagesRequest withPageSize(Integer pageSize) {
	...
	public GetConversationCommunicationInternalmessagesRequest withPageNumber(Integer pageNumber) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for GetConversationCommunicationInternalmessagesRequest.");
        }
        
        // verify the required parameter 'communicationId' is set
        if (this.communicationId == null) {
            throw new IllegalStateException("Missing the required parameter 'communicationId' when building request for GetConversationCommunicationInternalmessagesRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/conversations/{conversationId}/communications/{communicationId}/internalmessages")
	...
	public static class Builder {
		private final GetConversationCommunicationInternalmessagesRequest request;

		private Builder() {
			request = new GetConversationCommunicationInternalmessagesRequest();
		}
		...
		public GetConversationCommunicationInternalmessagesRequest build() {
