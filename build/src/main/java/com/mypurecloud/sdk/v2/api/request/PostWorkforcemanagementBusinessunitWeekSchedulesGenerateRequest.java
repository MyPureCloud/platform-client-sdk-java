...
public class PostWorkforcemanagementBusinessunitWeekSchedulesGenerateRequest {
	...
	public PostWorkforcemanagementBusinessunitWeekSchedulesGenerateRequest withBusinessUnitId(String businessUnitId) {
	...
	public PostWorkforcemanagementBusinessunitWeekSchedulesGenerateRequest withWeekId(LocalDate weekId) {
	    this.setWeekId(weekId);
	    return this;
	} 
	
	private BuGenerateScheduleRequest body;
	public BuGenerateScheduleRequest getBody() {
		return this.body;
	}

	public void setBody(BuGenerateScheduleRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementBusinessunitWeekSchedulesGenerateRequest withBody(BuGenerateScheduleRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementBusinessunitWeekSchedulesGenerateRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<BuGenerateScheduleRequest> withHttpInfo() {
        
        // verify the required parameter 'businessUnitId' is set
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PostWorkforcemanagementBusinessunitWeekSchedulesGenerateRequest.");
        }
        
        // verify the required parameter 'weekId' is set
        if (this.weekId == null) {
            throw new IllegalStateException("Missing the required parameter 'weekId' when building request for PostWorkforcemanagementBusinessunitWeekSchedulesGenerateRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementBusinessunitWeekSchedulesGenerateRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/weeks/{weekId}/schedules/generate")
	...
	public static Builder builder(String businessUnitId, LocalDate weekId, BuGenerateScheduleRequest body) {
	    return new Builder()
	            .withRequiredParams(businessUnitId, weekId, body);
	}
	

	public static class Builder {
		private final PostWorkforcemanagementBusinessunitWeekSchedulesGenerateRequest request;

		private Builder() {
			request = new PostWorkforcemanagementBusinessunitWeekSchedulesGenerateRequest();
		}
		...
		public Builder withBody(BuGenerateScheduleRequest body) {
		...
		public Builder withRequiredParams(String businessUnitId, LocalDate weekId, BuGenerateScheduleRequest body) {
			request.setBusinessUnitId(businessUnitId);
						request.setWeekId(weekId);
						request.setBody(body);
		...
		public PostWorkforcemanagementBusinessunitWeekSchedulesGenerateRequest build() {
