...
public class GetJourneyOutcomesPredictorRequest {
	...
	public GetJourneyOutcomesPredictorRequest withPredictorId(String predictorId) {
    ...
    public GetJourneyOutcomesPredictorRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.predictorId == null) {
            throw new IllegalStateException("Missing the required parameter 'predictorId' when building request for GetJourneyOutcomesPredictorRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/journey/outcomes/predictors/{predictorId}")
	...
	public static class Builder {
		private final GetJourneyOutcomesPredictorRequest request;

		private Builder() {
			request = new GetJourneyOutcomesPredictorRequest();
		}
		...
		public GetJourneyOutcomesPredictorRequest build() {
