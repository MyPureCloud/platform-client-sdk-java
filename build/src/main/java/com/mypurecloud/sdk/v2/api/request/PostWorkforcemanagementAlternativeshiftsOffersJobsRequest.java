...
public class PostWorkforcemanagementAlternativeshiftsOffersJobsRequest {

	private AlternativeShiftOffersRequest body;
	public AlternativeShiftOffersRequest getBody() {
		return this.body;
	}

	public void setBody(AlternativeShiftOffersRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementAlternativeshiftsOffersJobsRequest withBody(AlternativeShiftOffersRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementAlternativeshiftsOffersJobsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<AlternativeShiftOffersRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementAlternativeshiftsOffersJobsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/alternativeshifts/offers/jobs")
                .withBody(body)
	...
	public static Builder builder(AlternativeShiftOffersRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementAlternativeshiftsOffersJobsRequest request;

		private Builder() {
			request = new PostWorkforcemanagementAlternativeshiftsOffersJobsRequest();
		}


		public Builder withBody(AlternativeShiftOffersRequest body) {
		...
		public Builder withRequiredParams(AlternativeShiftOffersRequest body) {
			request.setBody(body);
		...
		public PostWorkforcemanagementAlternativeshiftsOffersJobsRequest build() {
