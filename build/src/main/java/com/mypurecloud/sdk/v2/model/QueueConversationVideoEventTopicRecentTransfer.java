...
public class QueueConversationVideoEventTopicRecentTransfer  implements Serializable {
 ...
 @JsonDeserialize(using = TransferTypeEnumDeserializer.class)
   ...
   **/
  public QueueConversationVideoEventTopicRecentTransfer id(String id) {
    this.id = id;
    return this;
  }
  ...
  /**
   **/
  public QueueConversationVideoEventTopicRecentTransfer state(StateEnum state) {
    this.state = state;
    return this;
  }
   ...
   **/
  public QueueConversationVideoEventTopicRecentTransfer dateIssued(Date dateIssued) {
  ...
  /**
   **/
  public QueueConversationVideoEventTopicRecentTransfer initiator(QueueConversationVideoEventTopicInitiator initiator) {
  ...
  public QueueConversationVideoEventTopicInitiator getInitiator() {
    return initiator;
  }
  public void setInitiator(QueueConversationVideoEventTopicInitiator initiator) {
    this.initiator = initiator;
  }
  ...
  public QueueConversationVideoEventTopicDestination getDestination() {
    return destination;
  }
  public void setDestination(QueueConversationVideoEventTopicDestination destination) {
    this.destination = destination;
  }
   ...
   * The type of transfer to perform.
   **/
  public QueueConversationVideoEventTopicRecentTransfer transferType(TransferTypeEnum transferType) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    QueueConversationVideoEventTopicRecentTransfer queueConversationVideoEventTopicRecentTransfer = (QueueConversationVideoEventTopicRecentTransfer) o;

    return Objects.equals(this.id, queueConversationVideoEventTopicRecentTransfer.id) &&
