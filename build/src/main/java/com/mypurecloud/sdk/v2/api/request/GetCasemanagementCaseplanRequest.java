...
public class GetCasemanagementCaseplanRequest {
	...
	public GetCasemanagementCaseplanRequest withCaseplanId(String caseplanId) {
    ...
    public GetCasemanagementCaseplanRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.caseplanId == null) {
            throw new IllegalStateException("Missing the required parameter 'caseplanId' when building request for GetCasemanagementCaseplanRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/casemanagement/caseplans/{caseplanId}")
	...
	public static class Builder {
		private final GetCasemanagementCaseplanRequest request;

		private Builder() {
			request = new GetCasemanagementCaseplanRequest();
		}
		...
		public GetCasemanagementCaseplanRequest build() {
