...
public class DeleteOutboundCampaignProgressRequest {
	...
	public DeleteOutboundCampaignProgressRequest withCampaignId(String campaignId) {
    ...
    public DeleteOutboundCampaignProgressRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.campaignId == null) {
            throw new IllegalStateException("Missing the required parameter 'campaignId' when building request for DeleteOutboundCampaignProgressRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/outbound/campaigns/{campaignId}/progress")
	...
	public static class Builder {
		private final DeleteOutboundCampaignProgressRequest request;

		private Builder() {
			request = new DeleteOutboundCampaignProgressRequest();
		}
		...
		public DeleteOutboundCampaignProgressRequest build() {
