...
public class GetTaskmanagementWorktypeFlowsDatebasedRulesRequest {
	...
	public GetTaskmanagementWorktypeFlowsDatebasedRulesRequest withWorktypeId(String worktypeId) {
	...
	public GetTaskmanagementWorktypeFlowsDatebasedRulesRequest withAfter(String after) {
	    this.setAfter(after);
	    return this;
	} 
	...
	public GetTaskmanagementWorktypeFlowsDatebasedRulesRequest withPageSize(Integer pageSize) {
    ...
    public GetTaskmanagementWorktypeFlowsDatebasedRulesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.worktypeId == null) {
            throw new IllegalStateException("Missing the required parameter 'worktypeId' when building request for GetTaskmanagementWorktypeFlowsDatebasedRulesRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/taskmanagement/worktypes/{worktypeId}/flows/datebased/rules")
	...
	public static class Builder {
		private final GetTaskmanagementWorktypeFlowsDatebasedRulesRequest request;

		private Builder() {
			request = new GetTaskmanagementWorktypeFlowsDatebasedRulesRequest();
		}
		...
		public GetTaskmanagementWorktypeFlowsDatebasedRulesRequest build() {
