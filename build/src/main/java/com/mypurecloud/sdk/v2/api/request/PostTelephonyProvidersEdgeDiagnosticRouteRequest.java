...
public class PostTelephonyProvidersEdgeDiagnosticRouteRequest {
	...
	public PostTelephonyProvidersEdgeDiagnosticRouteRequest withEdgeId(String edgeId) {
	...
	public PostTelephonyProvidersEdgeDiagnosticRouteRequest withBody(EdgeNetworkDiagnosticRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostTelephonyProvidersEdgeDiagnosticRouteRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<EdgeNetworkDiagnosticRequest> withHttpInfo() {
        ...
        if (this.edgeId == null) {
            throw new IllegalStateException("Missing the required parameter 'edgeId' when building request for PostTelephonyProvidersEdgeDiagnosticRouteRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostTelephonyProvidersEdgeDiagnosticRouteRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/telephony/providers/edges/{edgeId}/diagnostic/route")
	...
	public static class Builder {
		private final PostTelephonyProvidersEdgeDiagnosticRouteRequest request;

		private Builder() {
			request = new PostTelephonyProvidersEdgeDiagnosticRouteRequest();
		}
		...
		public PostTelephonyProvidersEdgeDiagnosticRouteRequest build() {
