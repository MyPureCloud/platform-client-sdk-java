...
public class PatchWorkforcemanagementBusinessunitStaffinggroupRequest {
	...
	public PatchWorkforcemanagementBusinessunitStaffinggroupRequest withBusinessUnitId(String businessUnitId) {
	...
	public PatchWorkforcemanagementBusinessunitStaffinggroupRequest withStaffingGroupId(String staffingGroupId) {
	    this.setStaffingGroupId(staffingGroupId);
	    return this;
	} 

	private UpdateStaffingGroupRequest body;
	public UpdateStaffingGroupRequest getBody() {
		return this.body;
	}

	public void setBody(UpdateStaffingGroupRequest body) {
		this.body = body;
	}

	public PatchWorkforcemanagementBusinessunitStaffinggroupRequest withBody(UpdateStaffingGroupRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchWorkforcemanagementBusinessunitStaffinggroupRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<UpdateStaffingGroupRequest> withHttpInfo() {
        
        // verify the required parameter 'businessUnitId' is set
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PatchWorkforcemanagementBusinessunitStaffinggroupRequest.");
        }
        
        // verify the required parameter 'staffingGroupId' is set
        if (this.staffingGroupId == null) {
            throw new IllegalStateException("Missing the required parameter 'staffingGroupId' when building request for PatchWorkforcemanagementBusinessunitStaffinggroupRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchWorkforcemanagementBusinessunitStaffinggroupRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/staffinggroups/{staffingGroupId}")
	...
	public static Builder builder(String businessUnitId, String staffingGroupId, UpdateStaffingGroupRequest body) {
	    return new Builder()
	            .withRequiredParams(businessUnitId, staffingGroupId, body);
	}


	public static class Builder {
		private final PatchWorkforcemanagementBusinessunitStaffinggroupRequest request;

		private Builder() {
			request = new PatchWorkforcemanagementBusinessunitStaffinggroupRequest();
		}
		...
		public Builder withBody(UpdateStaffingGroupRequest body) {
		...
		public Builder withRequiredParams(String businessUnitId, String staffingGroupId, UpdateStaffingGroupRequest body) {
			request.setBusinessUnitId(businessUnitId);
			request.setStaffingGroupId(staffingGroupId);
			request.setBody(body);
		...
		public PatchWorkforcemanagementBusinessunitStaffinggroupRequest build() {
