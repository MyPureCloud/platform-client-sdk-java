...
public class GetAnalyticsConversationsDetailsJobRequest {
	...
	public GetAnalyticsConversationsDetailsJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetAnalyticsConversationsDetailsJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetAnalyticsConversationsDetailsJobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/analytics/conversations/details/jobs/{jobId}")
	...
	public static class Builder {
		private final GetAnalyticsConversationsDetailsJobRequest request;

		private Builder() {
			request = new GetAnalyticsConversationsDetailsJobRequest();
		}
		...
		public GetAnalyticsConversationsDetailsJobRequest build() {
