...
public class GetOutboundContactlistfilterRequest {
	...
	public GetOutboundContactlistfilterRequest withContactListFilterId(String contactListFilterId) {
    ...
    public GetOutboundContactlistfilterRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.contactListFilterId == null) {
            throw new IllegalStateException("Missing the required parameter 'contactListFilterId' when building request for GetOutboundContactlistfilterRequest.");
        }
