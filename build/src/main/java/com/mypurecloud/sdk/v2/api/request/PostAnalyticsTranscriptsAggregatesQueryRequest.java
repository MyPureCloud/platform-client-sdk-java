...
public class PostAnalyticsTranscriptsAggregatesQueryRequest {
    
	private TranscriptAggregationQuery body;
	public TranscriptAggregationQuery getBody() {
		return this.body;
	}

	public void setBody(TranscriptAggregationQuery body) {
		this.body = body;
	}

	public PostAnalyticsTranscriptsAggregatesQueryRequest withBody(TranscriptAggregationQuery body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostAnalyticsTranscriptsAggregatesQueryRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<TranscriptAggregationQuery> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostAnalyticsTranscriptsAggregatesQueryRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/analytics/transcripts/aggregates/query")
                .withBody(body)
	...
	public static Builder builder(TranscriptAggregationQuery body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostAnalyticsTranscriptsAggregatesQueryRequest request;

		private Builder() {
			request = new PostAnalyticsTranscriptsAggregatesQueryRequest();
		}

		
		public Builder withBody(TranscriptAggregationQuery body) {
		...
		public Builder withRequiredParams(TranscriptAggregationQuery body) {
			request.setBody(body);
		...
		public PostAnalyticsTranscriptsAggregatesQueryRequest build() {
