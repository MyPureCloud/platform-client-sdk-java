...
public class PostAnalyticsFlowexecutionsAggregatesQueryRequest {

	private FlowExecutionAggregationQuery body;
	public FlowExecutionAggregationQuery getBody() {
		return this.body;
	}

	public void setBody(FlowExecutionAggregationQuery body) {
		this.body = body;
	}

	public PostAnalyticsFlowexecutionsAggregatesQueryRequest withBody(FlowExecutionAggregationQuery body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostAnalyticsFlowexecutionsAggregatesQueryRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<FlowExecutionAggregationQuery> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostAnalyticsFlowexecutionsAggregatesQueryRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/analytics/flowexecutions/aggregates/query")
                .withBody(body)
	...
	public static Builder builder(FlowExecutionAggregationQuery body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostAnalyticsFlowexecutionsAggregatesQueryRequest request;

		private Builder() {
			request = new PostAnalyticsFlowexecutionsAggregatesQueryRequest();
		}


		public Builder withBody(FlowExecutionAggregationQuery body) {
		...
		public Builder withRequiredParams(FlowExecutionAggregationQuery body) {
			request.setBody(body);
		...
		public PostAnalyticsFlowexecutionsAggregatesQueryRequest build() {
