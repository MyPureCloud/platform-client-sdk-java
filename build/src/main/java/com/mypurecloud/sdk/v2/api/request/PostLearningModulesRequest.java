...
public class PostLearningModulesRequest {
	...
	public PostLearningModulesRequest withBody(LearningModuleRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostLearningModulesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<LearningModuleRequest> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostLearningModulesRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/learning/modules")
                .withBody(body)
	...
	public static Builder builder(LearningModuleRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostLearningModulesRequest request;

		private Builder() {
			request = new PostLearningModulesRequest();
		}
		...
		public Builder withRequiredParams(LearningModuleRequest body) {
			request.setBody(body);
		...
		public PostLearningModulesRequest build() {
