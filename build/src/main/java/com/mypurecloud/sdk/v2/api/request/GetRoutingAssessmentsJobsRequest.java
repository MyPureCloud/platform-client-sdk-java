...
public class GetRoutingAssessmentsJobsRequest {
	...
	public GetRoutingAssessmentsJobsRequest withDivisionId(List<String> divisionId) {
    ...
    public GetRoutingAssessmentsJobsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/routing/assessments/jobs")
	...
	public static class Builder {
		private final GetRoutingAssessmentsJobsRequest request;

		private Builder() {
			request = new GetRoutingAssessmentsJobsRequest();
		}
		...
		public GetRoutingAssessmentsJobsRequest build() {
