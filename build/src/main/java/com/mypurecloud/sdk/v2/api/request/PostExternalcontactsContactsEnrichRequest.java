...
public class PostExternalcontactsContactsEnrichRequest {

	private ContactEnrichRequest body;
	public ContactEnrichRequest getBody() {
		return this.body;
	}

	public void setBody(ContactEnrichRequest body) {
		this.body = body;
	}

	public PostExternalcontactsContactsEnrichRequest withBody(ContactEnrichRequest body) {
	    this.setBody(body);
	    return this;
	} 
	...
	public PostExternalcontactsContactsEnrichRequest withDryRun(Boolean dryRun) {
    ...
    public PostExternalcontactsContactsEnrichRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<ContactEnrichRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostExternalcontactsContactsEnrichRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/externalcontacts/contacts/enrich")
	...
	public static Builder builder(ContactEnrichRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostExternalcontactsContactsEnrichRequest request;

		private Builder() {
			request = new PostExternalcontactsContactsEnrichRequest();
		}


		public Builder withBody(ContactEnrichRequest body) {
		...
		public Builder withRequiredParams(ContactEnrichRequest body) {
			request.setBody(body);
		...
		public PostExternalcontactsContactsEnrichRequest build() {
