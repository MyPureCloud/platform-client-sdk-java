...
public class GetWorkforcemanagementBusinessunitWeekScheduleGenerationresultsRequest {
	...
	public GetWorkforcemanagementBusinessunitWeekScheduleGenerationresultsRequest withBusinessUnitId(String businessUnitId) {
	...
	public GetWorkforcemanagementBusinessunitWeekScheduleGenerationresultsRequest withWeekId(LocalDate weekId) {
	...
	public GetWorkforcemanagementBusinessunitWeekScheduleGenerationresultsRequest withScheduleId(String scheduleId) {
    ...
    public GetWorkforcemanagementBusinessunitWeekScheduleGenerationresultsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for GetWorkforcemanagementBusinessunitWeekScheduleGenerationresultsRequest.");
        }
        
        // verify the required parameter 'weekId' is set
        if (this.weekId == null) {
            throw new IllegalStateException("Missing the required parameter 'weekId' when building request for GetWorkforcemanagementBusinessunitWeekScheduleGenerationresultsRequest.");
        }
        
        // verify the required parameter 'scheduleId' is set
        if (this.scheduleId == null) {
            throw new IllegalStateException("Missing the required parameter 'scheduleId' when building request for GetWorkforcemanagementBusinessunitWeekScheduleGenerationresultsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/weeks/{weekId}/schedules/{scheduleId}/generationresults")
	...
	public static class Builder {
		private final GetWorkforcemanagementBusinessunitWeekScheduleGenerationresultsRequest request;

		private Builder() {
			request = new GetWorkforcemanagementBusinessunitWeekScheduleGenerationresultsRequest();
		}
		...
		public GetWorkforcemanagementBusinessunitWeekScheduleGenerationresultsRequest build() {
