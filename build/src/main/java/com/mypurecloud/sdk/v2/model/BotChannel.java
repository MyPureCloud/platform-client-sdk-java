...
public class BotChannel  implements Serializable {
 ...
 @JsonDeserialize(using = OutputModesEnumDeserializer.class)
   ...
   * The name of the channel.
   **/
  public BotChannel name(NameEnum name) {
    this.name = name;
    return this;
  }
   ...
   **/
  public BotChannel inputModes(List<InputModesEnum> inputModes) {
   ...
   **/
  public BotChannel outputModes(List<OutputModesEnum> outputModes) {
   ...
   **/
  public BotChannel userAgent(TextBotUserAgent userAgent) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.name, botChannel.name) &&
            Objects.equals(this.inputModes, botChannel.inputModes) &&
            Objects.equals(this.outputModes, botChannel.outputModes) &&
            Objects.equals(this.userAgent, botChannel.userAgent);
  }
