...
public class GetWorkforcemanagementUnavailabletimesValidationJobRequest {
	...
	public GetWorkforcemanagementUnavailabletimesValidationJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetWorkforcemanagementUnavailabletimesValidationJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetWorkforcemanagementUnavailabletimesValidationJobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/unavailabletimes/validation/jobs/{jobId}")
	...
	public static class Builder {
		private final GetWorkforcemanagementUnavailabletimesValidationJobRequest request;

		private Builder() {
			request = new GetWorkforcemanagementUnavailabletimesValidationJobRequest();
		}
		...
		public GetWorkforcemanagementUnavailabletimesValidationJobRequest build() {
