...
public class PostConversationsEmailInboundmessagesRequest {
	...
	public PostConversationsEmailInboundmessagesRequest withConversationId(String conversationId) {
	    this.setConversationId(conversationId);
	    return this;
	} 
	
	private InboundMessageRequest body;
	public InboundMessageRequest getBody() {
		return this.body;
	}

	public void setBody(InboundMessageRequest body) {
		this.body = body;
	}

	public PostConversationsEmailInboundmessagesRequest withBody(InboundMessageRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostConversationsEmailInboundmessagesRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<InboundMessageRequest> withHttpInfo() {
        
        // verify the required parameter 'conversationId' is set
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PostConversationsEmailInboundmessagesRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostConversationsEmailInboundmessagesRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/conversations/emails/{conversationId}/inboundmessages")
	...
	public static Builder builder(String conversationId, InboundMessageRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostConversationsEmailInboundmessagesRequest request;

		private Builder() {
			request = new PostConversationsEmailInboundmessagesRequest();
		}
		...
		public Builder withBody(InboundMessageRequest body) {
		...
		public Builder withRequiredParams(String conversationId, InboundMessageRequest body) {
			request.setConversationId(conversationId);
						request.setBody(body);
		...
		public PostConversationsEmailInboundmessagesRequest build() {
