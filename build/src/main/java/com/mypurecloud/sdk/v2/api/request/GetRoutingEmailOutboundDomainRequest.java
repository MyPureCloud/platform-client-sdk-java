...
public class GetRoutingEmailOutboundDomainRequest {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/routing/email/outbound/domains/{domainId}")
	...
	public static class Builder {
		private final GetRoutingEmailOutboundDomainRequest request;

		private Builder() {
			request = new GetRoutingEmailOutboundDomainRequest();
		}
