...
public class QueueConversationSocialExpressionEventTopicJourneyCustomerSession  implements Serializable {
  ...
  public QueueConversationSocialExpressionEventTopicJourneyCustomerSession() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
    }
  }

  public QueueConversationSocialExpressionEventTopicJourneyCustomerSession(Boolean initWithEmptyList) {
