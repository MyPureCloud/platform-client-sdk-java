...
public class PostGuidesUploadsRequest {
	...
	public PostGuidesUploadsRequest withBody(UploadUrlRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostGuidesUploadsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<UploadUrlRequest> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostGuidesUploadsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/guides/uploads")
                .withBody(body)
	...
	public static class Builder {
		private final PostGuidesUploadsRequest request;

		private Builder() {
			request = new PostGuidesUploadsRequest();
		}
		...
		public PostGuidesUploadsRequest build() {
