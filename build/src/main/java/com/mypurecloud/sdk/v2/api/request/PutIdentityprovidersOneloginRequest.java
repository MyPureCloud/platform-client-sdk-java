...
public class PutIdentityprovidersOneloginRequest {
	...
	public void setBody(OneLogin body) {
		this.body = body;
	}

	public PutIdentityprovidersOneloginRequest withBody(OneLogin body) {
	    this.setBody(body);
	    return this;
	}
    ...
    public PutIdentityprovidersOneloginRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<OneLogin> withHttpInfo() throws ApiException {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new ApiException(400, "Missing the required parameter 'body' when building request for PutIdentityprovidersOneloginRequest.");
        }
