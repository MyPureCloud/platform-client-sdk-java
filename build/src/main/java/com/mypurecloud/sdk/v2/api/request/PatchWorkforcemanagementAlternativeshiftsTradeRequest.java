...
public class PatchWorkforcemanagementAlternativeshiftsTradeRequest {
	...
	public PatchWorkforcemanagementAlternativeshiftsTradeRequest withTradeId(String tradeId) {
	    this.setTradeId(tradeId);
	    return this;
	} 

	private AgentUpdateAlternativeShiftTradeRequest body;
	public AgentUpdateAlternativeShiftTradeRequest getBody() {
		return this.body;
	}

	public void setBody(AgentUpdateAlternativeShiftTradeRequest body) {
		this.body = body;
	}

	public PatchWorkforcemanagementAlternativeshiftsTradeRequest withBody(AgentUpdateAlternativeShiftTradeRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchWorkforcemanagementAlternativeshiftsTradeRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<AgentUpdateAlternativeShiftTradeRequest> withHttpInfo() {
	...
	public static class Builder {
		private final PatchWorkforcemanagementAlternativeshiftsTradeRequest request;

		private Builder() {
			request = new PatchWorkforcemanagementAlternativeshiftsTradeRequest();
		}
		...
		public Builder withBody(AgentUpdateAlternativeShiftTradeRequest body) {
		...
		public PatchWorkforcemanagementAlternativeshiftsTradeRequest build() {
