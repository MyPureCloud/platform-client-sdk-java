...
public class GetExternalcontactsScanContactsRequest {
	...
	public GetExternalcontactsScanContactsRequest withLimit(Integer limit) {
	    this.setLimit(limit);
	    return this;
	} 
	...
	public GetExternalcontactsScanContactsRequest withCursor(String cursor) {
	...
	public GetExternalcontactsScanContactsRequest withDivisionId(String divisionId) {
    ...
    public GetExternalcontactsScanContactsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/externalcontacts/scan/contacts")
	...
	public static class Builder {
		private final GetExternalcontactsScanContactsRequest request;

		private Builder() {
			request = new GetExternalcontactsScanContactsRequest();
		}
		...
		public GetExternalcontactsScanContactsRequest build() {
