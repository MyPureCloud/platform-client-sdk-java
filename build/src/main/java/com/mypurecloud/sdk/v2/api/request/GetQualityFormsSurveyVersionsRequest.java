...
public class GetQualityFormsSurveyVersionsRequest {
	...
	public GetQualityFormsSurveyVersionsRequest withFormId(String formId) {
	...
	public GetQualityFormsSurveyVersionsRequest withPageSize(Integer pageSize) {
	...
	public GetQualityFormsSurveyVersionsRequest withPageNumber(Integer pageNumber) {
    ...
    public GetQualityFormsSurveyVersionsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.formId == null) {
            throw new IllegalStateException("Missing the required parameter 'formId' when building request for GetQualityFormsSurveyVersionsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/quality/forms/surveys/{formId}/versions")
	...
	public static class Builder {
		private final GetQualityFormsSurveyVersionsRequest request;

		private Builder() {
			request = new GetQualityFormsSurveyVersionsRequest();
		}
		...
		public GetQualityFormsSurveyVersionsRequest build() {
