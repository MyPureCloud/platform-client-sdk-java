...
public class PostWorkforcemanagementBusinessunitDecisionmetricsUpdateUploadurlRequest {
	...
	public PostWorkforcemanagementBusinessunitDecisionmetricsUpdateUploadurlRequest withBusinessUnitId(String businessUnitId) {
	...
	public PostWorkforcemanagementBusinessunitDecisionmetricsUpdateUploadurlRequest withBody(UploadUrlRequestBody body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementBusinessunitDecisionmetricsUpdateUploadurlRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<UploadUrlRequestBody> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PostWorkforcemanagementBusinessunitDecisionmetricsUpdateUploadurlRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementBusinessunitDecisionmetricsUpdateUploadurlRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/decisionmetrics/update/uploadurl")
	...
	public static Builder builder(String businessUnitId, UploadUrlRequestBody body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementBusinessunitDecisionmetricsUpdateUploadurlRequest request;

		private Builder() {
			request = new PostWorkforcemanagementBusinessunitDecisionmetricsUpdateUploadurlRequest();
		}
		...
		public Builder withRequiredParams(String businessUnitId, UploadUrlRequestBody body) {
			request.setBusinessUnitId(businessUnitId);
			request.setBody(body);
		...
		public PostWorkforcemanagementBusinessunitDecisionmetricsUpdateUploadurlRequest build() {
