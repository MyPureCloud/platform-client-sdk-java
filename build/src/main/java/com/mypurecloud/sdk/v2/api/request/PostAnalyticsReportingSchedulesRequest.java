...
public class PostAnalyticsReportingSchedulesRequest {
	...
	public PostAnalyticsReportingSchedulesRequest withBody(ReportSchedule body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostAnalyticsReportingSchedulesRequest withCustomHeader(String name, String value) {
