...
public class DeleteExternalcontactsOrganizationTrustorRequest {
	...
	public DeleteExternalcontactsOrganizationTrustorRequest withExternalOrganizationId(String externalOrganizationId) {
    ...
    public DeleteExternalcontactsOrganizationTrustorRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.externalOrganizationId == null) {
            throw new IllegalStateException("Missing the required parameter 'externalOrganizationId' when building request for DeleteExternalcontactsOrganizationTrustorRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/externalcontacts/organizations/{externalOrganizationId}/trustor")
	...
	public static class Builder {
		private final DeleteExternalcontactsOrganizationTrustorRequest request;

		private Builder() {
			request = new DeleteExternalcontactsOrganizationTrustorRequest();
		}
		...
		public DeleteExternalcontactsOrganizationTrustorRequest build() {
