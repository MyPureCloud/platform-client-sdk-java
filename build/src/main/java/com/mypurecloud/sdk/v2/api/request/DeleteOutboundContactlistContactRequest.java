...
public class DeleteOutboundContactlistContactRequest {
	...
	public DeleteOutboundContactlistContactRequest withContactListId(String contactListId) {
	...
	public DeleteOutboundContactlistContactRequest withContactId(String contactId) {
    ...
    public DeleteOutboundContactlistContactRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.contactListId == null) {
            throw new IllegalStateException("Missing the required parameter 'contactListId' when building request for DeleteOutboundContactlistContactRequest.");
        }
        
        // verify the required parameter 'contactId' is set
        if (this.contactId == null) {
            throw new IllegalStateException("Missing the required parameter 'contactId' when building request for DeleteOutboundContactlistContactRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/outbound/contactlists/{contactListId}/contacts/{contactId}")
	...
	public static Builder builder(String contactListId, String contactId) {
	    return new Builder()
	            .withRequiredParams(contactListId, contactId);
	}
	

	public static class Builder {
		private final DeleteOutboundContactlistContactRequest request;

		private Builder() {
			request = new DeleteOutboundContactlistContactRequest();
		}
		...
		public Builder withRequiredParams(String contactListId, String contactId) {
			request.setContactListId(contactListId);
						request.setContactId(contactId);
		...
		public DeleteOutboundContactlistContactRequest build() {
