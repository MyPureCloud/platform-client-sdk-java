...
public class DeleteOutboundContactlistContactRequest {
    ...
    public ApiRequest<Void> withHttpInfo() throws ApiException {
        ...
        if (this.contactListId == null) {
            throw new ApiException(400, "Missing the required parameter 'contactListId' when building request for DeleteOutboundContactlistContactRequest.");
        }
        
        // verify the required parameter 'contactId' is set
        if (this.contactId == null) {
            throw new ApiException(400, "Missing the required parameter 'contactId' when building request for DeleteOutboundContactlistContactRequest.");
        }
