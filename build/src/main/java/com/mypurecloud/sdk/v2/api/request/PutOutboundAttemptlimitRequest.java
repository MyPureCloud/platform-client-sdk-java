...
public class PutOutboundAttemptlimitRequest {
    ...
    public ApiRequest<AttemptLimits> withHttpInfo() throws ApiException {
        ...
        if (this.attemptLimitsId == null) {
            throw new ApiException(400, "Missing the required parameter 'attemptLimitsId' when building request for PutOutboundAttemptlimitRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new ApiException(400, "Missing the required parameter 'body' when building request for PutOutboundAttemptlimitRequest.");
        }
