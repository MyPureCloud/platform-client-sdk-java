...
public class PutConversationParticipantFlaggedreasonRequest {
	...
	public PutConversationParticipantFlaggedreasonRequest withConversationId(String conversationId) {
	...
	public PutConversationParticipantFlaggedreasonRequest withParticipantId(String participantId) {
    ...
    public PutConversationParticipantFlaggedreasonRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PutConversationParticipantFlaggedreasonRequest.");
        }
        
        // verify the required parameter 'participantId' is set
        if (this.participantId == null) {
            throw new IllegalStateException("Missing the required parameter 'participantId' when building request for PutConversationParticipantFlaggedreasonRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/conversations/{conversationId}/participants/{participantId}/flaggedreason")
	...
	public static class Builder {
		private final PutConversationParticipantFlaggedreasonRequest request;

		private Builder() {
			request = new PutConversationParticipantFlaggedreasonRequest();
		}
		...
		public PutConversationParticipantFlaggedreasonRequest build() {
