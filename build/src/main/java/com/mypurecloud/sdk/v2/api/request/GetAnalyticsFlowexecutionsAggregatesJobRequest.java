...
public class GetAnalyticsFlowexecutionsAggregatesJobRequest {
	...
	public GetAnalyticsFlowexecutionsAggregatesJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetAnalyticsFlowexecutionsAggregatesJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetAnalyticsFlowexecutionsAggregatesJobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/analytics/flowexecutions/aggregates/jobs/{jobId}")
	...
	public static class Builder {
		private final GetAnalyticsFlowexecutionsAggregatesJobRequest request;

		private Builder() {
			request = new GetAnalyticsFlowexecutionsAggregatesJobRequest();
		}
		...
		public GetAnalyticsFlowexecutionsAggregatesJobRequest build() {
