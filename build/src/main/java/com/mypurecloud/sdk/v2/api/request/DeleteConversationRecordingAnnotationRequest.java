...
public class DeleteConversationRecordingAnnotationRequest {
    ...
    public ApiRequest<Void> withHttpInfo() throws ApiException {
        ...
        if (this.conversationId == null) {
            throw new ApiException(400, "Missing the required parameter 'conversationId' when building request for DeleteConversationRecordingAnnotationRequest.");
        }
        
        // verify the required parameter 'recordingId' is set
        if (this.recordingId == null) {
            throw new ApiException(400, "Missing the required parameter 'recordingId' when building request for DeleteConversationRecordingAnnotationRequest.");
        }
        
        // verify the required parameter 'annotationId' is set
        if (this.annotationId == null) {
            throw new ApiException(400, "Missing the required parameter 'annotationId' when building request for DeleteConversationRecordingAnnotationRequest.");
        }
