...
public class PatchConversationCustomattributesRequest {
	...
	public PatchConversationCustomattributesRequest withConversationId(String conversationId) {
	    this.setConversationId(conversationId);
	    return this;
	} 

	private CustomAttributesPatchRequest body;
	public CustomAttributesPatchRequest getBody() {
		return this.body;
	}

	public void setBody(CustomAttributesPatchRequest body) {
		this.body = body;
	}

	public PatchConversationCustomattributesRequest withBody(CustomAttributesPatchRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchConversationCustomattributesRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<CustomAttributesPatchRequest> withHttpInfo() {
        
        // verify the required parameter 'conversationId' is set
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PatchConversationCustomattributesRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/conversations/{conversationId}/customattributes")
	...
	public static class Builder {
		private final PatchConversationCustomattributesRequest request;

		private Builder() {
			request = new PatchConversationCustomattributesRequest();
		}
		...
		public Builder withBody(CustomAttributesPatchRequest body) {
		...
		public PatchConversationCustomattributesRequest build() {
