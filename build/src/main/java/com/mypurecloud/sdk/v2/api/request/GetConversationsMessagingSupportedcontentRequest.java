...
public class GetConversationsMessagingSupportedcontentRequest {
	...
	public GetConversationsMessagingSupportedcontentRequest withPageSize(Integer pageSize) {
	...
	public GetConversationsMessagingSupportedcontentRequest withPageNumber(Integer pageNumber) {
    ...
    public GetConversationsMessagingSupportedcontentRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/conversations/messaging/supportedcontent")
	...
	public static class Builder {
		private final GetConversationsMessagingSupportedcontentRequest request;

		private Builder() {
			request = new GetConversationsMessagingSupportedcontentRequest();
		}
		...
		public GetConversationsMessagingSupportedcontentRequest build() {
