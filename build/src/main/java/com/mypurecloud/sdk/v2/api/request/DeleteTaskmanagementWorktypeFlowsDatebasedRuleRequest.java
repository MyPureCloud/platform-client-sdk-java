...
public class DeleteTaskmanagementWorktypeFlowsDatebasedRuleRequest {
	...
	public DeleteTaskmanagementWorktypeFlowsDatebasedRuleRequest withWorktypeId(String worktypeId) {
	...
	public DeleteTaskmanagementWorktypeFlowsDatebasedRuleRequest withRuleId(String ruleId) {
    ...
    public DeleteTaskmanagementWorktypeFlowsDatebasedRuleRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.worktypeId == null) {
            throw new IllegalStateException("Missing the required parameter 'worktypeId' when building request for DeleteTaskmanagementWorktypeFlowsDatebasedRuleRequest.");
        }
        
        // verify the required parameter 'ruleId' is set
        if (this.ruleId == null) {
            throw new IllegalStateException("Missing the required parameter 'ruleId' when building request for DeleteTaskmanagementWorktypeFlowsDatebasedRuleRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/taskmanagement/worktypes/{worktypeId}/flows/datebased/rules/{ruleId}")
	...
	public static Builder builder(String worktypeId, String ruleId) {
	    return new Builder()
	            .withRequiredParams(worktypeId, ruleId);
	}


	public static class Builder {
		private final DeleteTaskmanagementWorktypeFlowsDatebasedRuleRequest request;

		private Builder() {
			request = new DeleteTaskmanagementWorktypeFlowsDatebasedRuleRequest();
		}
		...
		public Builder withRequiredParams(String worktypeId, String ruleId) {
			request.setWorktypeId(worktypeId);
			request.setRuleId(ruleId);
		...
		public DeleteTaskmanagementWorktypeFlowsDatebasedRuleRequest build() {
