...
public class V2ConversationMessageTypingEventForWorkflowTopicConversationContentAttachment  implements Serializable {
 ...
 @JsonDeserialize(using = MediaTypeEnumDeserializer.class)
  ...
  /**
   **/
  public V2ConversationMessageTypingEventForWorkflowTopicConversationContentAttachment id(String id) {
    this.id = id;
    return this;
  }
