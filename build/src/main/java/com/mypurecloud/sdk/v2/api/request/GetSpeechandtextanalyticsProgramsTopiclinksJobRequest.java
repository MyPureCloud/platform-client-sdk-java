...
public class GetSpeechandtextanalyticsProgramsTopiclinksJobRequest {
	...
	public GetSpeechandtextanalyticsProgramsTopiclinksJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetSpeechandtextanalyticsProgramsTopiclinksJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetSpeechandtextanalyticsProgramsTopiclinksJobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/speechandtextanalytics/programs/topiclinks/jobs/{jobId}")
	...
	public static class Builder {
		private final GetSpeechandtextanalyticsProgramsTopiclinksJobRequest request;

		private Builder() {
			request = new GetSpeechandtextanalyticsProgramsTopiclinksJobRequest();
		}
		...
		public GetSpeechandtextanalyticsProgramsTopiclinksJobRequest build() {
