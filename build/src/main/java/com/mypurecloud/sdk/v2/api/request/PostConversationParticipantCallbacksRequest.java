...
public class PostConversationParticipantCallbacksRequest {
	...
	public PostConversationParticipantCallbacksRequest withConversationId(String conversationId) {
	...
	public PostConversationParticipantCallbacksRequest withParticipantId(String participantId) {
    ...
    public PostConversationParticipantCallbacksRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<CreateCallbackOnConversationCommand> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PostConversationParticipantCallbacksRequest.");
        }
        
        // verify the required parameter 'participantId' is set
        if (this.participantId == null) {
            throw new IllegalStateException("Missing the required parameter 'participantId' when building request for PostConversationParticipantCallbacksRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/conversations/{conversationId}/participants/{participantId}/callbacks")
	...
	public static class Builder {
		private final PostConversationParticipantCallbacksRequest request;

		private Builder() {
			request = new PostConversationParticipantCallbacksRequest();
		}
		...
		public PostConversationParticipantCallbacksRequest build() {
