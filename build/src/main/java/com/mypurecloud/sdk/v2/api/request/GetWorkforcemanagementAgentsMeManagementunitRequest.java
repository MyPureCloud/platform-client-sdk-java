...
public class GetWorkforcemanagementAgentsMeManagementunitRequest {
    ...
    public GetWorkforcemanagementAgentsMeManagementunitRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/agents/me/managementunit")
	...
	public static class Builder {
		private final GetWorkforcemanagementAgentsMeManagementunitRequest request;

		private Builder() {
			request = new GetWorkforcemanagementAgentsMeManagementunitRequest();
		}
		...
		public GetWorkforcemanagementAgentsMeManagementunitRequest build() {
