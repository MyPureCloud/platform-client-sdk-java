...
public class GetTelephonyProvidersEdgesSiteOutboundrouteRequest {
	...
	public GetTelephonyProvidersEdgesSiteOutboundrouteRequest withSiteId(String siteId) {
	...
	public GetTelephonyProvidersEdgesSiteOutboundrouteRequest withOutboundRouteId(String outboundRouteId) {
    ...
    public GetTelephonyProvidersEdgesSiteOutboundrouteRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() throws ApiException {
        ...
        if (this.siteId == null) {
            throw new ApiException(400, "Missing the required parameter 'siteId' when building request for GetTelephonyProvidersEdgesSiteOutboundrouteRequest.");
        }
        
        // verify the required parameter 'outboundRouteId' is set
        if (this.outboundRouteId == null) {
            throw new ApiException(400, "Missing the required parameter 'outboundRouteId' when building request for GetTelephonyProvidersEdgesSiteOutboundrouteRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/telephony/providers/edges/sites/{siteId}/outboundroutes/{outboundRouteId}")
	...
	public static class Builder {
		...
		private Builder() {
			request = new GetTelephonyProvidersEdgesSiteOutboundrouteRequest();
		}
