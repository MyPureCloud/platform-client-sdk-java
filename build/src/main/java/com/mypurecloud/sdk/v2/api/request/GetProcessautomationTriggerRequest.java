...
public class GetProcessautomationTriggerRequest {
	...
	public GetProcessautomationTriggerRequest withTriggerId(String triggerId) {
    ...
    public GetProcessautomationTriggerRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.triggerId == null) {
            throw new IllegalStateException("Missing the required parameter 'triggerId' when building request for GetProcessautomationTriggerRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/processautomation/triggers/{triggerId}")
	...
	public static class Builder {
		private final GetProcessautomationTriggerRequest request;

		private Builder() {
			request = new GetProcessautomationTriggerRequest();
		}
		...
		public GetProcessautomationTriggerRequest build() {
