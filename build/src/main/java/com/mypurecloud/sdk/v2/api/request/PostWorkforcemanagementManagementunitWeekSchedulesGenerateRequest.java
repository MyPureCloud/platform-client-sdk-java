...
public class PostWorkforcemanagementManagementunitWeekSchedulesGenerateRequest {
	...
	public PostWorkforcemanagementManagementunitWeekSchedulesGenerateRequest withManagementUnitId(String managementUnitId) {
	...
	public PostWorkforcemanagementManagementunitWeekSchedulesGenerateRequest withWeekId(String weekId) {
	    this.setWeekId(weekId);
	    return this;
	} 
	
	private GenerateWeekScheduleRequest body;
	public GenerateWeekScheduleRequest getBody() {
		return this.body;
	}

	public void setBody(GenerateWeekScheduleRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementManagementunitWeekSchedulesGenerateRequest withBody(GenerateWeekScheduleRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementManagementunitWeekSchedulesGenerateRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<GenerateWeekScheduleRequest> withHttpInfo() {
        
        // verify the required parameter 'managementUnitId' is set
        if (this.managementUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'managementUnitId' when building request for PostWorkforcemanagementManagementunitWeekSchedulesGenerateRequest.");
        }
        
        // verify the required parameter 'weekId' is set
        if (this.weekId == null) {
            throw new IllegalStateException("Missing the required parameter 'weekId' when building request for PostWorkforcemanagementManagementunitWeekSchedulesGenerateRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/managementunits/{managementUnitId}/weeks/{weekId}/schedules/generate")
	...
	public static class Builder {
		private final PostWorkforcemanagementManagementunitWeekSchedulesGenerateRequest request;

		private Builder() {
			request = new PostWorkforcemanagementManagementunitWeekSchedulesGenerateRequest();
		}
		...
		public Builder withBody(GenerateWeekScheduleRequest body) {
		...
		public PostWorkforcemanagementManagementunitWeekSchedulesGenerateRequest build() {
