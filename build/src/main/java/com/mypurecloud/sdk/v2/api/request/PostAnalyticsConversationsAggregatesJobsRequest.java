...
public class PostAnalyticsConversationsAggregatesJobsRequest {

	private ConversationAsyncAggregationQuery body;
	public ConversationAsyncAggregationQuery getBody() {
		return this.body;
	}

	public void setBody(ConversationAsyncAggregationQuery body) {
		this.body = body;
	}

	public PostAnalyticsConversationsAggregatesJobsRequest withBody(ConversationAsyncAggregationQuery body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostAnalyticsConversationsAggregatesJobsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<ConversationAsyncAggregationQuery> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostAnalyticsConversationsAggregatesJobsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/analytics/conversations/aggregates/jobs")
                .withBody(body)
	...
	public static Builder builder(ConversationAsyncAggregationQuery body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostAnalyticsConversationsAggregatesJobsRequest request;

		private Builder() {
			request = new PostAnalyticsConversationsAggregatesJobsRequest();
		}


		public Builder withBody(ConversationAsyncAggregationQuery body) {
		...
		public Builder withRequiredParams(ConversationAsyncAggregationQuery body) {
			request.setBody(body);
		...
		public PostAnalyticsConversationsAggregatesJobsRequest build() {
