...
public class DeleteSpeechandtextanalyticsDictionaryfeedbackDictionaryFeedbackIdRequest {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.dictionaryFeedbackId == null) {
            throw new IllegalStateException("Missing the required parameter 'dictionaryFeedbackId' when building request for DeleteSpeechandtextanalyticsDictionaryfeedbackDictionaryFeedbackIdRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/speechandtextanalytics/dictionaryfeedback/{dictionaryFeedbackId}")
	...
	public static class Builder {
		private final DeleteSpeechandtextanalyticsDictionaryfeedbackDictionaryFeedbackIdRequest request;

		private Builder() {
			request = new DeleteSpeechandtextanalyticsDictionaryfeedbackDictionaryFeedbackIdRequest();
		}
		...
		public DeleteSpeechandtextanalyticsDictionaryfeedbackDictionaryFeedbackIdRequest build() {
