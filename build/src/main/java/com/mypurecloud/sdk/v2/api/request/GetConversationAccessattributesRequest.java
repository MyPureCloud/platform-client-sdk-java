...
public class GetConversationAccessattributesRequest {
	...
	public GetConversationAccessattributesRequest withConversationId(String conversationId) {
    ...
    public GetConversationAccessattributesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for GetConversationAccessattributesRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/conversations/{conversationId}/accessattributes")
	...
	public static class Builder {
		private final GetConversationAccessattributesRequest request;

		private Builder() {
			request = new GetConversationAccessattributesRequest();
		}
		...
		public GetConversationAccessattributesRequest build() {
