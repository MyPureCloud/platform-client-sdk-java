...
public class GetWorkforcemanagementBusinessunitWorkplanbidGroupRequest {
	...
	public GetWorkforcemanagementBusinessunitWorkplanbidGroupRequest withBusinessUnitId(String businessUnitId) {
	...
	public GetWorkforcemanagementBusinessunitWorkplanbidGroupRequest withBidId(String bidId) {
	    this.setBidId(bidId);
	    return this;
	} 
	...
	public GetWorkforcemanagementBusinessunitWorkplanbidGroupRequest withBidGroupId(String bidGroupId) {
    ...
    public GetWorkforcemanagementBusinessunitWorkplanbidGroupRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for GetWorkforcemanagementBusinessunitWorkplanbidGroupRequest.");
        }
        
        // verify the required parameter 'bidId' is set
        if (this.bidId == null) {
            throw new IllegalStateException("Missing the required parameter 'bidId' when building request for GetWorkforcemanagementBusinessunitWorkplanbidGroupRequest.");
        }
        
        // verify the required parameter 'bidGroupId' is set
        if (this.bidGroupId == null) {
            throw new IllegalStateException("Missing the required parameter 'bidGroupId' when building request for GetWorkforcemanagementBusinessunitWorkplanbidGroupRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/workplanbids/{bidId}/groups/{bidGroupId}")
	...
	public static class Builder {
		private final GetWorkforcemanagementBusinessunitWorkplanbidGroupRequest request;

		private Builder() {
			request = new GetWorkforcemanagementBusinessunitWorkplanbidGroupRequest();
		}
		...
		public GetWorkforcemanagementBusinessunitWorkplanbidGroupRequest build() {
