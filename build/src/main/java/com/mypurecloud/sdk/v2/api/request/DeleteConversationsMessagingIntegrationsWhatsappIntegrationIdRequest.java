...
public class DeleteConversationsMessagingIntegrationsWhatsappIntegrationIdRequest {
	...
	public DeleteConversationsMessagingIntegrationsWhatsappIntegrationIdRequest withIntegrationId(String integrationId) {
    ...
    public DeleteConversationsMessagingIntegrationsWhatsappIntegrationIdRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.integrationId == null) {
            throw new IllegalStateException("Missing the required parameter 'integrationId' when building request for DeleteConversationsMessagingIntegrationsWhatsappIntegrationIdRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/conversations/messaging/integrations/whatsapp/{integrationId}")
	...
	public static class Builder {
		private final DeleteConversationsMessagingIntegrationsWhatsappIntegrationIdRequest request;

		private Builder() {
			request = new DeleteConversationsMessagingIntegrationsWhatsappIntegrationIdRequest();
		}
		...
		public DeleteConversationsMessagingIntegrationsWhatsappIntegrationIdRequest build() {
