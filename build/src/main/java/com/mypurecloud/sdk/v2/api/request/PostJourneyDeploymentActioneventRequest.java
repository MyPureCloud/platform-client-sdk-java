...
public class PostJourneyDeploymentActioneventRequest {
	...
	public PostJourneyDeploymentActioneventRequest withDeploymentId(String deploymentId) {
	    this.setDeploymentId(deploymentId);
	    return this;
	} 

	private ActionEventRequest body;
	public ActionEventRequest getBody() {
		return this.body;
	}

	public void setBody(ActionEventRequest body) {
		this.body = body;
	}

	public PostJourneyDeploymentActioneventRequest withBody(ActionEventRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostJourneyDeploymentActioneventRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<ActionEventRequest> withHttpInfo() {
        
        // verify the required parameter 'deploymentId' is set
        if (this.deploymentId == null) {
            throw new IllegalStateException("Missing the required parameter 'deploymentId' when building request for PostJourneyDeploymentActioneventRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostJourneyDeploymentActioneventRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/journey/deployments/{deploymentId}/actionevent")
	...
	public static Builder builder(String deploymentId, ActionEventRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostJourneyDeploymentActioneventRequest request;

		private Builder() {
			request = new PostJourneyDeploymentActioneventRequest();
		}
		...
		public Builder withBody(ActionEventRequest body) {
		...
		public Builder withRequiredParams(String deploymentId, ActionEventRequest body) {
			request.setDeploymentId(deploymentId);
			request.setBody(body);
		...
		public PostJourneyDeploymentActioneventRequest build() {
