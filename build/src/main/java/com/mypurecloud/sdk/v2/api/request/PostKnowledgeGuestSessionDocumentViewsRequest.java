...
public class PostKnowledgeGuestSessionDocumentViewsRequest {
	...
	public PostKnowledgeGuestSessionDocumentViewsRequest withSessionId(String sessionId) {
	...
	public PostKnowledgeGuestSessionDocumentViewsRequest withDocumentId(String documentId) {
	...
	public void setBody(KnowledgeGuestDocumentView body) {
		this.body = body;
	}

	public PostKnowledgeGuestSessionDocumentViewsRequest withBody(KnowledgeGuestDocumentView body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostKnowledgeGuestSessionDocumentViewsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<KnowledgeGuestDocumentView> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("POST", "/api/v2/knowledge/guest/sessions/{sessionId}/documents/{documentId}/views")
	...
	public static class Builder {
		...
		private Builder() {
			request = new PostKnowledgeGuestSessionDocumentViewsRequest();
		}
		...
		public Builder withBody(KnowledgeGuestDocumentView body) {
