...
public class PostRoutingEmailOutboundDomainsRequest {
	...
	public PostRoutingEmailOutboundDomainsRequest withBody(OutboundDomainCreateRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostRoutingEmailOutboundDomainsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<OutboundDomainCreateRequest> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostRoutingEmailOutboundDomainsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/routing/email/outbound/domains")
                .withBody(body)
	...
	public static class Builder {
		private final PostRoutingEmailOutboundDomainsRequest request;

		private Builder() {
			request = new PostRoutingEmailOutboundDomainsRequest();
		}
		...
		public PostRoutingEmailOutboundDomainsRequest build() {
