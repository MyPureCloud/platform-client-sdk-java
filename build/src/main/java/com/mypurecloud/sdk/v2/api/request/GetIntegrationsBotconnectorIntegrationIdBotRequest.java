...
public class GetIntegrationsBotconnectorIntegrationIdBotRequest {
	...
	public GetIntegrationsBotconnectorIntegrationIdBotRequest withIntegrationId(String integrationId) {
	...
	public GetIntegrationsBotconnectorIntegrationIdBotRequest withBotId(String botId) {
	    this.setBotId(botId);
	    return this;
	} 
	...
	public GetIntegrationsBotconnectorIntegrationIdBotRequest withVersion(String version) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.integrationId == null) {
            throw new IllegalStateException("Missing the required parameter 'integrationId' when building request for GetIntegrationsBotconnectorIntegrationIdBotRequest.");
        }
        
        // verify the required parameter 'botId' is set
        if (this.botId == null) {
            throw new IllegalStateException("Missing the required parameter 'botId' when building request for GetIntegrationsBotconnectorIntegrationIdBotRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/integrations/botconnector/{integrationId}/bots/{botId}")
	...
	public static class Builder {
		private final GetIntegrationsBotconnectorIntegrationIdBotRequest request;

		private Builder() {
			request = new GetIntegrationsBotconnectorIntegrationIdBotRequest();
		}
		...
		public GetIntegrationsBotconnectorIntegrationIdBotRequest build() {
