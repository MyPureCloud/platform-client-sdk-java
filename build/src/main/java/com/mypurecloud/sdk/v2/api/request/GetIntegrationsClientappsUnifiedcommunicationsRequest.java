...
public class GetIntegrationsClientappsUnifiedcommunicationsRequest {
	...
	public GetIntegrationsClientappsUnifiedcommunicationsRequest withPageSize(Integer pageSize) {
	...
	public GetIntegrationsClientappsUnifiedcommunicationsRequest withPageNumber(Integer pageNumber) {
	...
	public GetIntegrationsClientappsUnifiedcommunicationsRequest withSortBy(String sortBy) {
	...
	public GetIntegrationsClientappsUnifiedcommunicationsRequest withExpand(List<String> expand) {
	...
	public GetIntegrationsClientappsUnifiedcommunicationsRequest withNextPage(String nextPage) {
	...
	public GetIntegrationsClientappsUnifiedcommunicationsRequest withPreviousPage(String previousPage) {
    ...
    public GetIntegrationsClientappsUnifiedcommunicationsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/integrations/clientapps/unifiedcommunications")
	...
	public static class Builder {
		private final GetIntegrationsClientappsUnifiedcommunicationsRequest request;

		private Builder() {
			request = new GetIntegrationsClientappsUnifiedcommunicationsRequest();
		}
		...
		public GetIntegrationsClientappsUnifiedcommunicationsRequest build() {
