...
public class GetAnalyticsUsersDetailsJobRequest {
	...
	public GetAnalyticsUsersDetailsJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetAnalyticsUsersDetailsJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetAnalyticsUsersDetailsJobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/analytics/users/details/jobs/{jobId}")
	...
	public static class Builder {
		private final GetAnalyticsUsersDetailsJobRequest request;

		private Builder() {
			request = new GetAnalyticsUsersDetailsJobRequest();
		}
		...
		public GetAnalyticsUsersDetailsJobRequest build() {
