...
public class PostWorkforcemanagementAgentAdherenceExplanationsRequest {
	...
	public PostWorkforcemanagementAgentAdherenceExplanationsRequest withAgentId(String agentId) {
	    this.setAgentId(agentId);
	    return this;
	} 

	private AddAdherenceExplanationAdminRequest body;
	public AddAdherenceExplanationAdminRequest getBody() {
		return this.body;
	}

	public void setBody(AddAdherenceExplanationAdminRequest body) {
		this.body = body;
	}
    ...
    public ApiRequest<AddAdherenceExplanationAdminRequest> withHttpInfo() {
        
        // verify the required parameter 'agentId' is set
        if (this.agentId == null) {
            throw new IllegalStateException("Missing the required parameter 'agentId' when building request for PostWorkforcemanagementAgentAdherenceExplanationsRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementAgentAdherenceExplanationsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/agents/{agentId}/adherence/explanations")
	...
	public static Builder builder(String agentId, AddAdherenceExplanationAdminRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementAgentAdherenceExplanationsRequest request;

		private Builder() {
			request = new PostWorkforcemanagementAgentAdherenceExplanationsRequest();
		}
		...
		public Builder withBody(AddAdherenceExplanationAdminRequest body) {
		...
		public Builder withRequiredParams(String agentId, AddAdherenceExplanationAdminRequest body) {
			request.setAgentId(agentId);
			request.setBody(body);
		...
		public PostWorkforcemanagementAgentAdherenceExplanationsRequest build() {
