...
public class PostQualityFormsEvaluationsRequest {
	...
	public PostQualityFormsEvaluationsRequest withBody(EvaluationForm body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostQualityFormsEvaluationsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<EvaluationForm> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("POST", "/api/v2/quality/forms/evaluations")
                .withBody(body)
	...
	public static class Builder {
		...
		private Builder() {
			request = new PostQualityFormsEvaluationsRequest();
		}
