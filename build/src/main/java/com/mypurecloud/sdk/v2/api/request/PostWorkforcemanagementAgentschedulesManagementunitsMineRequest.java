...
public class PostWorkforcemanagementAgentschedulesManagementunitsMineRequest {

	private AgentMuScheduleQuery body;
	public AgentMuScheduleQuery getBody() {
		return this.body;
	}

	public void setBody(AgentMuScheduleQuery body) {
		this.body = body;
	}

	public PostWorkforcemanagementAgentschedulesManagementunitsMineRequest withBody(AgentMuScheduleQuery body) {
	    this.setBody(body);
	    return this;
	} 
	...
	public PostWorkforcemanagementAgentschedulesManagementunitsMineRequest withForceAsync(Boolean forceAsync) {
	...
	public PostWorkforcemanagementAgentschedulesManagementunitsMineRequest withForceDownloadService(Boolean forceDownloadService) {
    ...
    public PostWorkforcemanagementAgentschedulesManagementunitsMineRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<AgentMuScheduleQuery> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementAgentschedulesManagementunitsMineRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/agentschedules/managementunits/mine")
	...
	public static Builder builder(AgentMuScheduleQuery body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementAgentschedulesManagementunitsMineRequest request;

		private Builder() {
			request = new PostWorkforcemanagementAgentschedulesManagementunitsMineRequest();
		}


		public Builder withBody(AgentMuScheduleQuery body) {
		...
		public Builder withRequiredParams(AgentMuScheduleQuery body) {
			request.setBody(body);
		...
		public PostWorkforcemanagementAgentschedulesManagementunitsMineRequest build() {
