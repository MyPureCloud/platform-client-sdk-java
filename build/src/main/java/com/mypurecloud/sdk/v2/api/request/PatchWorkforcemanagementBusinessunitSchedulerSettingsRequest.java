...
public class PatchWorkforcemanagementBusinessunitSchedulerSettingsRequest {
	...
	private BuSchedulerSettingsRequest body;
	public BuSchedulerSettingsRequest getBody() {
		return this.body;
	}

	public void setBody(BuSchedulerSettingsRequest body) {
		this.body = body;
	}
    ...
    public ApiRequest<BuSchedulerSettingsRequest> withHttpInfo() {
        
        // verify the required parameter 'businessUnitId' is set
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PatchWorkforcemanagementBusinessunitSchedulerSettingsRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchWorkforcemanagementBusinessunitSchedulerSettingsRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/scheduler/settings")
	...
	public static Builder builder(String businessUnitId, BuSchedulerSettingsRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PatchWorkforcemanagementBusinessunitSchedulerSettingsRequest request;

		private Builder() {
			request = new PatchWorkforcemanagementBusinessunitSchedulerSettingsRequest();
		}
		...
		public Builder withBody(BuSchedulerSettingsRequest body) {
		...
		public Builder withRequiredParams(String businessUnitId, BuSchedulerSettingsRequest body) {
			request.setBusinessUnitId(businessUnitId);
			request.setBody(body);
		...
		public PatchWorkforcemanagementBusinessunitSchedulerSettingsRequest build() {
