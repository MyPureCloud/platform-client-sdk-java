...
public class GetConversationCommunicationAgentchecklistRequest {
	...
	public GetConversationCommunicationAgentchecklistRequest withConversationId(String conversationId) {
	...
	public GetConversationCommunicationAgentchecklistRequest withCommunicationId(String communicationId) {
	...
	public GetConversationCommunicationAgentchecklistRequest withAgentChecklistId(String agentChecklistId) {
    ...
    public GetConversationCommunicationAgentchecklistRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for GetConversationCommunicationAgentchecklistRequest.");
        }
        
        // verify the required parameter 'communicationId' is set
        if (this.communicationId == null) {
            throw new IllegalStateException("Missing the required parameter 'communicationId' when building request for GetConversationCommunicationAgentchecklistRequest.");
        }
        
        // verify the required parameter 'agentChecklistId' is set
        if (this.agentChecklistId == null) {
            throw new IllegalStateException("Missing the required parameter 'agentChecklistId' when building request for GetConversationCommunicationAgentchecklistRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/conversations/{conversationId}/communications/{communicationId}/agentchecklists/{agentChecklistId}")
	...
	public static Builder builder(String conversationId, String communicationId, String agentChecklistId) {
	    return new Builder()
	            .withRequiredParams(conversationId, communicationId, agentChecklistId);
	}


	public static class Builder {
		private final GetConversationCommunicationAgentchecklistRequest request;

		private Builder() {
			request = new GetConversationCommunicationAgentchecklistRequest();
		}
		...
		public Builder withRequiredParams(String conversationId, String communicationId, String agentChecklistId) {
			request.setConversationId(conversationId);
			request.setCommunicationId(communicationId);
			request.setAgentChecklistId(agentChecklistId);
		...
		public GetConversationCommunicationAgentchecklistRequest build() {
