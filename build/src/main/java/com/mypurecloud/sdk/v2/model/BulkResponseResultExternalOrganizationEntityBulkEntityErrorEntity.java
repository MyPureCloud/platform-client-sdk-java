...
public class BulkResponseResultExternalOrganizationEntityBulkEntityErrorEntity  implements Serializable {
  ...
  public BulkResponseResultExternalOrganizationEntityBulkEntityErrorEntity(Boolean initWithEmptyList) {
   ...
   **/
  public BulkResponseResultExternalOrganizationEntityBulkEntityErrorEntity id(String id) {
    this.id = id;
    return this;
  }
   ...
   **/
  public BulkResponseResultExternalOrganizationEntityBulkEntityErrorEntity success(Boolean success) {
   ...
   **/
  public BulkResponseResultExternalOrganizationEntityBulkEntityErrorEntity entity(ExternalOrganization entity) {
    this.entity = entity;
    return this;
  }
   ...
   **/
  public BulkResponseResultExternalOrganizationEntityBulkEntityErrorEntity error(BulkEntityErrorEntity error) {
    this.error = error;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    BulkResponseResultExternalOrganizationEntityBulkEntityErrorEntity bulkResponseResultExternalOrganizationEntityBulkEntityErrorEntity = (BulkResponseResultExternalOrganizationEntityBulkEntityErrorEntity) o;
