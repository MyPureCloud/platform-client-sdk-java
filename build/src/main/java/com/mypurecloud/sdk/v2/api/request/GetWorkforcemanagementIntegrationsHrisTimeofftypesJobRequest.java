...
public class GetWorkforcemanagementIntegrationsHrisTimeofftypesJobRequest {
	...
	public GetWorkforcemanagementIntegrationsHrisTimeofftypesJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetWorkforcemanagementIntegrationsHrisTimeofftypesJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetWorkforcemanagementIntegrationsHrisTimeofftypesJobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/integrations/hris/timeofftypes/jobs/{jobId}")
	...
	public static class Builder {
		private final GetWorkforcemanagementIntegrationsHrisTimeofftypesJobRequest request;

		private Builder() {
			request = new GetWorkforcemanagementIntegrationsHrisTimeofftypesJobRequest();
		}
		...
		public GetWorkforcemanagementIntegrationsHrisTimeofftypesJobRequest build() {
