...
public class GetWorkforcemanagementBusinessunitPlanninggroupRequest {
	...
	public GetWorkforcemanagementBusinessunitPlanninggroupRequest withBusinessUnitId(String businessUnitId) {
	...
	public GetWorkforcemanagementBusinessunitPlanninggroupRequest withPlanningGroupId(String planningGroupId) {
    ...
    public GetWorkforcemanagementBusinessunitPlanninggroupRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for GetWorkforcemanagementBusinessunitPlanninggroupRequest.");
        }
        
        // verify the required parameter 'planningGroupId' is set
        if (this.planningGroupId == null) {
            throw new IllegalStateException("Missing the required parameter 'planningGroupId' when building request for GetWorkforcemanagementBusinessunitPlanninggroupRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/planninggroups/{planningGroupId}")
	...
	public static class Builder {
		private final GetWorkforcemanagementBusinessunitPlanninggroupRequest request;

		private Builder() {
			request = new GetWorkforcemanagementBusinessunitPlanninggroupRequest();
		}
		...
		public GetWorkforcemanagementBusinessunitPlanninggroupRequest build() {
