...
public class PutIntegrationsCredentialRequest {
    ...
    public ApiRequest<Credential> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("PUT", "/api/v2/integrations/credentials/{credentialId}")
	...
	public static class Builder {
		private final PutIntegrationsCredentialRequest request;

		private Builder() {
			request = new PutIntegrationsCredentialRequest();
		}
