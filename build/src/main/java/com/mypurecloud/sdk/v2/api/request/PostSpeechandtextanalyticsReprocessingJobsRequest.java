...
public class PostSpeechandtextanalyticsReprocessingJobsRequest {

	private CreateReprocessJobRequest body;
	public CreateReprocessJobRequest getBody() {
		return this.body;
	}

	public void setBody(CreateReprocessJobRequest body) {
		this.body = body;
	}

	public PostSpeechandtextanalyticsReprocessingJobsRequest withBody(CreateReprocessJobRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostSpeechandtextanalyticsReprocessingJobsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<CreateReprocessJobRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostSpeechandtextanalyticsReprocessingJobsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/speechandtextanalytics/reprocessing/jobs")
                .withBody(body)
	...
	public static Builder builder(CreateReprocessJobRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostSpeechandtextanalyticsReprocessingJobsRequest request;

		private Builder() {
			request = new PostSpeechandtextanalyticsReprocessingJobsRequest();
		}


		public Builder withBody(CreateReprocessJobRequest body) {
		...
		public Builder withRequiredParams(CreateReprocessJobRequest body) {
			request.setBody(body);
		...
		public PostSpeechandtextanalyticsReprocessingJobsRequest build() {
