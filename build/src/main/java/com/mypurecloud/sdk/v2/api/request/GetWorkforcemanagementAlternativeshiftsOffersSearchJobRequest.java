...
public class GetWorkforcemanagementAlternativeshiftsOffersSearchJobRequest {
	...
	public GetWorkforcemanagementAlternativeshiftsOffersSearchJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetWorkforcemanagementAlternativeshiftsOffersSearchJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetWorkforcemanagementAlternativeshiftsOffersSearchJobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/alternativeshifts/offers/search/jobs/{jobId}")
	...
	public static class Builder {
		private final GetWorkforcemanagementAlternativeshiftsOffersSearchJobRequest request;

		private Builder() {
			request = new GetWorkforcemanagementAlternativeshiftsOffersSearchJobRequest();
		}
		...
		public GetWorkforcemanagementAlternativeshiftsOffersSearchJobRequest build() {
