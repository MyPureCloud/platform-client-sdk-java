...
public class PostTelephonyPrefixesBulkRequest {

	private BulkPrefixesRequest body;
	public BulkPrefixesRequest getBody() {
		return this.body;
	}

	public void setBody(BulkPrefixesRequest body) {
		this.body = body;
	}

	public PostTelephonyPrefixesBulkRequest withBody(BulkPrefixesRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostTelephonyPrefixesBulkRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<BulkPrefixesRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostTelephonyPrefixesBulkRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/telephony/prefixes/bulk")
                .withBody(body)
	...
	public static Builder builder(BulkPrefixesRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostTelephonyPrefixesBulkRequest request;

		private Builder() {
			request = new PostTelephonyPrefixesBulkRequest();
		}


		public Builder withBody(BulkPrefixesRequest body) {
		...
		public Builder withRequiredParams(BulkPrefixesRequest body) {
			request.setBody(body);
		...
		public PostTelephonyPrefixesBulkRequest build() {
