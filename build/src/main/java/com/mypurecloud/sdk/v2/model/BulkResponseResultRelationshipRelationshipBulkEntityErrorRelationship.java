...
import com.mypurecloud.sdk.v2.model.BulkEntityErrorRelationship;
...
public class BulkResponseResultRelationshipRelationshipBulkEntityErrorRelationship  implements Serializable {
   ...
   **/
  public BulkResponseResultRelationshipRelationshipBulkEntityErrorRelationship id(String id) {
    this.id = id;
    return this;
  }
   ...
   **/
  public BulkResponseResultRelationshipRelationshipBulkEntityErrorRelationship success(Boolean success) {
   ...
   **/
  public BulkResponseResultRelationshipRelationshipBulkEntityErrorRelationship entity(Relationship entity) {
    this.entity = entity;
    return this;
  }
   ...
   **/
  public BulkResponseResultRelationshipRelationshipBulkEntityErrorRelationship error(BulkEntityErrorRelationship error) {
    this.error = error;
    return this;
  }
  ...
  @JsonProperty("error")
  public BulkEntityErrorRelationship getError() {
    return error;
  }
  public void setError(BulkEntityErrorRelationship error) {
    this.error = error;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    BulkResponseResultRelationshipRelationshipBulkEntityErrorRelationship bulkResponseResultRelationshipRelationshipBulkEntityErrorRelationship = (BulkResponseResultRelationshipRelationshipBulkEntityErrorRelationship) o;
