...
public class TaskManagementAggregationQuery  implements Serializable {
 ...
 @JsonDeserialize(using = AlternateTimeDimensionEnumDeserializer.class)
  ...
  public TaskManagementAggregationQuery(Boolean initWithEmptyList) {
   ...
   **/
  public TaskManagementAggregationQuery interval(String interval) {
   ...
   **/
  public TaskManagementAggregationQuery granularity(String granularity) {
   ...
   **/
  public TaskManagementAggregationQuery timeZone(String timeZone) {
   ...
   **/
  public TaskManagementAggregationQuery groupBy(List<GroupByEnum> groupBy) {
   ...
   **/
  public TaskManagementAggregationQuery filter(TaskManagementAggregateQueryFilter filter) {
    this.filter = filter;
    return this;
  }
   ...
   **/
  public TaskManagementAggregationQuery metrics(List<MetricsEnum> metrics) {
   ...
   **/
  public TaskManagementAggregationQuery flattenMultivaluedDimensions(Boolean flattenMultivaluedDimensions) {
   ...
   **/
  public TaskManagementAggregationQuery views(List<TaskManagementAggregationView> views) {
    this.views = views;
    return this;
  }
   ...
   * Dimension to use as the alternative timestamp for data in the aggregate.  Choosing \"eventTime\" uses the actual time of the data event.
   **/
  public TaskManagementAggregationQuery alternateTimeDimension(AlternateTimeDimensionEnum alternateTimeDimension) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TaskManagementAggregationQuery taskManagementAggregationQuery = (TaskManagementAggregationQuery) o;

    return Objects.equals(this.interval, taskManagementAggregationQuery.interval) &&
            Objects.equals(this.granularity, taskManagementAggregationQuery.granularity) &&
            Objects.equals(this.timeZone, taskManagementAggregationQuery.timeZone) &&
            Objects.equals(this.groupBy, taskManagementAggregationQuery.groupBy) &&
            Objects.equals(this.filter, taskManagementAggregationQuery.filter) &&
            Objects.equals(this.metrics, taskManagementAggregationQuery.metrics) &&
            Objects.equals(this.flattenMultivaluedDimensions, taskManagementAggregationQuery.flattenMultivaluedDimensions) &&
            Objects.equals(this.views, taskManagementAggregationQuery.views) &&
            Objects.equals(this.alternateTimeDimension, taskManagementAggregationQuery.alternateTimeDimension);
  }
