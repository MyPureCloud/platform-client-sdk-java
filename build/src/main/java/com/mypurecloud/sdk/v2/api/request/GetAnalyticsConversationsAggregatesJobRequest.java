...
public class GetAnalyticsConversationsAggregatesJobRequest {
	...
	public GetAnalyticsConversationsAggregatesJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetAnalyticsConversationsAggregatesJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetAnalyticsConversationsAggregatesJobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/analytics/conversations/aggregates/jobs/{jobId}")
	...
	public static class Builder {
		private final GetAnalyticsConversationsAggregatesJobRequest request;

		private Builder() {
			request = new GetAnalyticsConversationsAggregatesJobRequest();
		}
		...
		public GetAnalyticsConversationsAggregatesJobRequest build() {
