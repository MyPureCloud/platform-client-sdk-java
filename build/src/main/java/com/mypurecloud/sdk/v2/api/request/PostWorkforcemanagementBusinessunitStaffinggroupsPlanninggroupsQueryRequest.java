...
public class PostWorkforcemanagementBusinessunitStaffinggroupsPlanninggroupsQueryRequest {
	...
	public PostWorkforcemanagementBusinessunitStaffinggroupsPlanninggroupsQueryRequest withBusinessUnitId(String businessUnitId) {
	    this.setBusinessUnitId(businessUnitId);
	    return this;
	} 

	private QueryPlanningGroupToStaffingGroupsRequest body;
	public QueryPlanningGroupToStaffingGroupsRequest getBody() {
		return this.body;
	}

	public void setBody(QueryPlanningGroupToStaffingGroupsRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementBusinessunitStaffinggroupsPlanninggroupsQueryRequest withBody(QueryPlanningGroupToStaffingGroupsRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementBusinessunitStaffinggroupsPlanninggroupsQueryRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<QueryPlanningGroupToStaffingGroupsRequest> withHttpInfo() {
        
        // verify the required parameter 'businessUnitId' is set
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PostWorkforcemanagementBusinessunitStaffinggroupsPlanninggroupsQueryRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementBusinessunitStaffinggroupsPlanninggroupsQueryRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/staffinggroups/planninggroups/query")
	...
	public static Builder builder(String businessUnitId, QueryPlanningGroupToStaffingGroupsRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementBusinessunitStaffinggroupsPlanninggroupsQueryRequest request;

		private Builder() {
			request = new PostWorkforcemanagementBusinessunitStaffinggroupsPlanninggroupsQueryRequest();
		}
		...
		public Builder withBody(QueryPlanningGroupToStaffingGroupsRequest body) {
		...
		public Builder withRequiredParams(String businessUnitId, QueryPlanningGroupToStaffingGroupsRequest body) {
			request.setBusinessUnitId(businessUnitId);
			request.setBody(body);
		...
		public PostWorkforcemanagementBusinessunitStaffinggroupsPlanninggroupsQueryRequest build() {
