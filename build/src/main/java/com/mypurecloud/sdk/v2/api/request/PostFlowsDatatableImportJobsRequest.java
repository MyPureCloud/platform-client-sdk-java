...
public class PostFlowsDatatableImportJobsRequest {
    ...
    public ApiRequest<DataTableImportJob> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("POST", "/api/v2/flows/datatables/{datatableId}/import/jobs")
	...
	public static class Builder {
		private final PostFlowsDatatableImportJobsRequest request;

		private Builder() {
			request = new PostFlowsDatatableImportJobsRequest();
		}
