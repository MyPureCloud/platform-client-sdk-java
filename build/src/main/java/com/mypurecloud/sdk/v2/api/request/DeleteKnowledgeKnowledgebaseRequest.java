...
public class DeleteKnowledgeKnowledgebaseRequest {
	...
	public DeleteKnowledgeKnowledgebaseRequest withKnowledgeBaseId(String knowledgeBaseId) {
    ...
    public DeleteKnowledgeKnowledgebaseRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.knowledgeBaseId == null) {
            throw new IllegalStateException("Missing the required parameter 'knowledgeBaseId' when building request for DeleteKnowledgeKnowledgebaseRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}")
	...
	public static class Builder {
		private final DeleteKnowledgeKnowledgebaseRequest request;

		private Builder() {
			request = new DeleteKnowledgeKnowledgebaseRequest();
		}
		...
		public DeleteKnowledgeKnowledgebaseRequest build() {
