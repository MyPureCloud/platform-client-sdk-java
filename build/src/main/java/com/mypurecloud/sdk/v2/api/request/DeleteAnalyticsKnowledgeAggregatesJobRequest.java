...
public class DeleteAnalyticsKnowledgeAggregatesJobRequest {
	...
	public DeleteAnalyticsKnowledgeAggregatesJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public DeleteAnalyticsKnowledgeAggregatesJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for DeleteAnalyticsKnowledgeAggregatesJobRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/analytics/knowledge/aggregates/jobs/{jobId}")
	...
	public static class Builder {
		private final DeleteAnalyticsKnowledgeAggregatesJobRequest request;

		private Builder() {
			request = new DeleteAnalyticsKnowledgeAggregatesJobRequest();
		}
		...
		public DeleteAnalyticsKnowledgeAggregatesJobRequest build() {
