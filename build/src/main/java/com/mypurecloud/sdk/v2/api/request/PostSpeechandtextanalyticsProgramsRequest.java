...
public class PostSpeechandtextanalyticsProgramsRequest {
	...
	public PostSpeechandtextanalyticsProgramsRequest withBody(ProgramRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostSpeechandtextanalyticsProgramsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<ProgramRequest> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostSpeechandtextanalyticsProgramsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/speechandtextanalytics/programs")
                .withBody(body)
	...
	public static Builder builder(ProgramRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostSpeechandtextanalyticsProgramsRequest request;

		private Builder() {
			request = new PostSpeechandtextanalyticsProgramsRequest();
		}
		...
		public Builder withRequiredParams(ProgramRequest body) {
			request.setBody(body);
		...
		public PostSpeechandtextanalyticsProgramsRequest build() {
