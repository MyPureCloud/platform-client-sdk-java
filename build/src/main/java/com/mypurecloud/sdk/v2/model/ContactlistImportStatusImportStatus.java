...
public class ContactlistImportStatusImportStatus  implements Serializable {
 ...
 @JsonDeserialize(using = ImportStateEnumDeserializer.class)
  ...
  public ContactlistImportStatusImportStatus(Boolean initWithEmptyList) {
   ...
   **/
  public ContactlistImportStatusImportStatus totalRecords(Long totalRecords) {
   ...
   **/
  public ContactlistImportStatusImportStatus completedRecords(Long completedRecords) {
   ...
   **/
  public ContactlistImportStatusImportStatus percentageComplete(Long percentageComplete) {
