...
public class BulkEntityErrorRelationship  implements Serializable {
  ...
  public BulkEntityErrorRelationship(Boolean initWithEmptyList) {
   ...
   **/
  public BulkEntityErrorRelationship code(String code) {
    this.code = code;
    return this;
  }
   ...
   **/
  public BulkEntityErrorRelationship message(String message) {
   ...
   **/
  public BulkEntityErrorRelationship status(Integer status) {
    this.status = status;
    return this;
  }
   ...
   **/
  public BulkEntityErrorRelationship retryable(Boolean retryable) {
   ...
   **/
  public BulkEntityErrorRelationship details(List<BulkErrorDetail> details) {
   ...
   **/
  public BulkEntityErrorRelationship entity(Relationship entity) {
    this.entity = entity;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    BulkEntityErrorRelationship bulkEntityErrorRelationship = (BulkEntityErrorRelationship) o;

    return Objects.equals(this.code, bulkEntityErrorRelationship.code) &&
            Objects.equals(this.message, bulkEntityErrorRelationship.message) &&
            Objects.equals(this.status, bulkEntityErrorRelationship.status) &&
            Objects.equals(this.retryable, bulkEntityErrorRelationship.retryable) &&
            Objects.equals(this.details, bulkEntityErrorRelationship.details) &&
            Objects.equals(this.entity, bulkEntityErrorRelationship.entity);
  }
