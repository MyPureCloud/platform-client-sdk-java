...
public class PutAnalyticsDataretentionSettingsRequest {

	private UpdateAnalyticsDataRetentionRequest body;
	public UpdateAnalyticsDataRetentionRequest getBody() {
		return this.body;
	}

	public void setBody(UpdateAnalyticsDataRetentionRequest body) {
		this.body = body;
	}

	public PutAnalyticsDataretentionSettingsRequest withBody(UpdateAnalyticsDataRetentionRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutAnalyticsDataretentionSettingsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<UpdateAnalyticsDataRetentionRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutAnalyticsDataretentionSettingsRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/analytics/dataretention/settings")
                .withBody(body)
	...
	public static Builder builder(UpdateAnalyticsDataRetentionRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PutAnalyticsDataretentionSettingsRequest request;

		private Builder() {
			request = new PutAnalyticsDataretentionSettingsRequest();
		}


		public Builder withBody(UpdateAnalyticsDataRetentionRequest body) {
		...
		public Builder withRequiredParams(UpdateAnalyticsDataRetentionRequest body) {
			request.setBody(body);
		...
		public PutAnalyticsDataretentionSettingsRequest build() {
