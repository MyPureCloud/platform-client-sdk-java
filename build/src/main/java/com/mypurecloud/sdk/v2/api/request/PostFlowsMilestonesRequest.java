...
public class PostFlowsMilestonesRequest {
	...
	public PostFlowsMilestonesRequest withBody(FlowMilestone body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostFlowsMilestonesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<FlowMilestone> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("POST", "/api/v2/flows/milestones")
                .withBody(body)
	...
	public static class Builder {
		private final PostFlowsMilestonesRequest request;

		private Builder() {
			request = new PostFlowsMilestonesRequest();
		}
		...
		public PostFlowsMilestonesRequest build() {
