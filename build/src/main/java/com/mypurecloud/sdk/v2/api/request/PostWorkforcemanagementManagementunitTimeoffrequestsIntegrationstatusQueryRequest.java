...
public class PostWorkforcemanagementManagementunitTimeoffrequestsIntegrationstatusQueryRequest {
	...
	public PostWorkforcemanagementManagementunitTimeoffrequestsIntegrationstatusQueryRequest withManagementUnitId(String managementUnitId) {
	    this.setManagementUnitId(managementUnitId);
	    return this;
	} 

	private QueryTimeOffIntegrationStatusRequest body;
	public QueryTimeOffIntegrationStatusRequest getBody() {
		return this.body;
	}

	public void setBody(QueryTimeOffIntegrationStatusRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementManagementunitTimeoffrequestsIntegrationstatusQueryRequest withBody(QueryTimeOffIntegrationStatusRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementManagementunitTimeoffrequestsIntegrationstatusQueryRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<QueryTimeOffIntegrationStatusRequest> withHttpInfo() {
        
        // verify the required parameter 'managementUnitId' is set
        if (this.managementUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'managementUnitId' when building request for PostWorkforcemanagementManagementunitTimeoffrequestsIntegrationstatusQueryRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementManagementunitTimeoffrequestsIntegrationstatusQueryRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/managementunits/{managementUnitId}/timeoffrequests/integrationstatus/query")
	...
	public static Builder builder(String managementUnitId, QueryTimeOffIntegrationStatusRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementManagementunitTimeoffrequestsIntegrationstatusQueryRequest request;

		private Builder() {
			request = new PostWorkforcemanagementManagementunitTimeoffrequestsIntegrationstatusQueryRequest();
		}
		...
		public Builder withBody(QueryTimeOffIntegrationStatusRequest body) {
		...
		public Builder withRequiredParams(String managementUnitId, QueryTimeOffIntegrationStatusRequest body) {
			request.setManagementUnitId(managementUnitId);
			request.setBody(body);
		...
		public PostWorkforcemanagementManagementunitTimeoffrequestsIntegrationstatusQueryRequest build() {
