...
public class PostWorkforcemanagementBusinessunitShifttradingTradesStateBulkJobsRequest {
	...
	public PostWorkforcemanagementBusinessunitShifttradingTradesStateBulkJobsRequest withBusinessUnitId(String businessUnitId) {
	    this.setBusinessUnitId(businessUnitId);
	    return this;
	} 

	private BulkUpdateShiftTradeListJobRequest body;
	public BulkUpdateShiftTradeListJobRequest getBody() {
		return this.body;
	}

	public void setBody(BulkUpdateShiftTradeListJobRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementBusinessunitShifttradingTradesStateBulkJobsRequest withBody(BulkUpdateShiftTradeListJobRequest body) {
	    this.setBody(body);
	    return this;
	} 
	...
	public PostWorkforcemanagementBusinessunitShifttradingTradesStateBulkJobsRequest withForceAsync(Boolean forceAsync) {
	...
	public PostWorkforcemanagementBusinessunitShifttradingTradesStateBulkJobsRequest withForceDownloadService(Boolean forceDownloadService) {
    ...
    public PostWorkforcemanagementBusinessunitShifttradingTradesStateBulkJobsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<BulkUpdateShiftTradeListJobRequest> withHttpInfo() {
        
        // verify the required parameter 'businessUnitId' is set
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PostWorkforcemanagementBusinessunitShifttradingTradesStateBulkJobsRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementBusinessunitShifttradingTradesStateBulkJobsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/shifttrading/trades/state/bulk/jobs")
	...
	public static Builder builder(String businessUnitId, BulkUpdateShiftTradeListJobRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementBusinessunitShifttradingTradesStateBulkJobsRequest request;

		private Builder() {
			request = new PostWorkforcemanagementBusinessunitShifttradingTradesStateBulkJobsRequest();
		}
		...
		public Builder withBody(BulkUpdateShiftTradeListJobRequest body) {
		...
		public Builder withRequiredParams(String businessUnitId, BulkUpdateShiftTradeListJobRequest body) {
			request.setBusinessUnitId(businessUnitId);
			request.setBody(body);
		...
		public PostWorkforcemanagementBusinessunitShifttradingTradesStateBulkJobsRequest build() {
