...
public class PostEmployeeperformanceExternalmetricsDefinitionsRequest {

	private ExternalMetricDefinitionCreateRequest body;
	public ExternalMetricDefinitionCreateRequest getBody() {
		return this.body;
	}

	public void setBody(ExternalMetricDefinitionCreateRequest body) {
		this.body = body;
	}

	public PostEmployeeperformanceExternalmetricsDefinitionsRequest withBody(ExternalMetricDefinitionCreateRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostEmployeeperformanceExternalmetricsDefinitionsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<ExternalMetricDefinitionCreateRequest> withHttpInfo() {
        

        return ApiRequestBuilder.create("POST", "/api/v2/employeeperformance/externalmetrics/definitions")
                .withBody(body)
	...
	public static class Builder {
		private final PostEmployeeperformanceExternalmetricsDefinitionsRequest request;

		private Builder() {
			request = new PostEmployeeperformanceExternalmetricsDefinitionsRequest();
		}


		public Builder withBody(ExternalMetricDefinitionCreateRequest body) {
		...
		public PostEmployeeperformanceExternalmetricsDefinitionsRequest build() {
