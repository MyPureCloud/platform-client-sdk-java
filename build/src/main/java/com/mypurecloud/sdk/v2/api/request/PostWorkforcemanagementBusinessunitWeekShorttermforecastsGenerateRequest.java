...
public class PostWorkforcemanagementBusinessunitWeekShorttermforecastsGenerateRequest {
	...
	public PostWorkforcemanagementBusinessunitWeekShorttermforecastsGenerateRequest withBusinessUnitId(String businessUnitId) {
	...
	public PostWorkforcemanagementBusinessunitWeekShorttermforecastsGenerateRequest withWeekDateId(LocalDate weekDateId) {
	    this.setWeekDateId(weekDateId);
	    return this;
	} 
	
	private GenerateBuForecastRequest body;
	public GenerateBuForecastRequest getBody() {
		return this.body;
	}

	public void setBody(GenerateBuForecastRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementBusinessunitWeekShorttermforecastsGenerateRequest withBody(GenerateBuForecastRequest body) {
	    this.setBody(body);
	    return this;
	} 
	...
	public PostWorkforcemanagementBusinessunitWeekShorttermforecastsGenerateRequest withForceAsync(Boolean forceAsync) {
    ...
    public PostWorkforcemanagementBusinessunitWeekShorttermforecastsGenerateRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<GenerateBuForecastRequest> withHttpInfo() {
        
        // verify the required parameter 'businessUnitId' is set
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PostWorkforcemanagementBusinessunitWeekShorttermforecastsGenerateRequest.");
        }
        
        // verify the required parameter 'weekDateId' is set
        if (this.weekDateId == null) {
            throw new IllegalStateException("Missing the required parameter 'weekDateId' when building request for PostWorkforcemanagementBusinessunitWeekShorttermforecastsGenerateRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementBusinessunitWeekShorttermforecastsGenerateRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/weeks/{weekDateId}/shorttermforecasts/generate")
	...
	public static Builder builder(String businessUnitId, LocalDate weekDateId, GenerateBuForecastRequest body) {
	    return new Builder()
	            .withRequiredParams(businessUnitId, weekDateId, body);
	}
	

	public static class Builder {
		private final PostWorkforcemanagementBusinessunitWeekShorttermforecastsGenerateRequest request;

		private Builder() {
			request = new PostWorkforcemanagementBusinessunitWeekShorttermforecastsGenerateRequest();
		}
		...
		public Builder withBody(GenerateBuForecastRequest body) {
		...
		public Builder withRequiredParams(String businessUnitId, LocalDate weekDateId, GenerateBuForecastRequest body) {
			request.setBusinessUnitId(businessUnitId);
						request.setWeekDateId(weekDateId);
						request.setBody(body);
		...
		public PostWorkforcemanagementBusinessunitWeekShorttermforecastsGenerateRequest build() {
