...
public class PostRoutingSkillexpressionsValidateRequest {

	private SkillExpressionData body;
	public SkillExpressionData getBody() {
		return this.body;
	}

	public void setBody(SkillExpressionData body) {
		this.body = body;
	}

	public PostRoutingSkillexpressionsValidateRequest withBody(SkillExpressionData body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostRoutingSkillexpressionsValidateRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<SkillExpressionData> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostRoutingSkillexpressionsValidateRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/routing/skillexpressions/validate")
                .withBody(body)
	...
	public static Builder builder(SkillExpressionData body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostRoutingSkillexpressionsValidateRequest request;

		private Builder() {
			request = new PostRoutingSkillexpressionsValidateRequest();
		}


		public Builder withBody(SkillExpressionData body) {
		...
		public Builder withRequiredParams(SkillExpressionData body) {
			request.setBody(body);
		...
		public PostRoutingSkillexpressionsValidateRequest build() {
