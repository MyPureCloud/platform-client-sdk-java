...
public class GetIntegrationsActionDraftTemplateRequest {
	...
	public GetIntegrationsActionDraftTemplateRequest withActionId(String actionId) {
	...
	public GetIntegrationsActionDraftTemplateRequest withFileName(String fileName) {
    ...
    public GetIntegrationsActionDraftTemplateRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.actionId == null) {
            throw new IllegalStateException("Missing the required parameter 'actionId' when building request for GetIntegrationsActionDraftTemplateRequest.");
        }
        
        // verify the required parameter 'fileName' is set
        if (this.fileName == null) {
            throw new IllegalStateException("Missing the required parameter 'fileName' when building request for GetIntegrationsActionDraftTemplateRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/integrations/actions/{actionId}/draft/templates/{fileName}")
	...
	public static class Builder {
		private final GetIntegrationsActionDraftTemplateRequest request;

		private Builder() {
			request = new GetIntegrationsActionDraftTemplateRequest();
		}
		...
		public GetIntegrationsActionDraftTemplateRequest build() {
