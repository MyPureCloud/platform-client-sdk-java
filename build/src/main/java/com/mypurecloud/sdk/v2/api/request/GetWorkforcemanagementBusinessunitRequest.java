...
public class GetWorkforcemanagementBusinessunitRequest {
	...
	public GetWorkforcemanagementBusinessunitRequest withBusinessUnitId(String businessUnitId) {
	...
	public GetWorkforcemanagementBusinessunitRequest withExpand(List<String> expand) {
	...
	public GetWorkforcemanagementBusinessunitRequest withIncludeSchedulingDefaultMessageSeverities(Boolean includeSchedulingDefaultMessageSeverities) {
    ...
    public GetWorkforcemanagementBusinessunitRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for GetWorkforcemanagementBusinessunitRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/businessunits/{businessUnitId}")
	...
	public static class Builder {
		private final GetWorkforcemanagementBusinessunitRequest request;

		private Builder() {
			request = new GetWorkforcemanagementBusinessunitRequest();
		}
		...
		public GetWorkforcemanagementBusinessunitRequest build() {
