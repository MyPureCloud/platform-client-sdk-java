...
public class GetAnalyticsBotsAggregatesJobResultsRequest {
	...
	public GetAnalyticsBotsAggregatesJobResultsRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
	...
	public GetAnalyticsBotsAggregatesJobResultsRequest withCursor(String cursor) {
    ...
    public GetAnalyticsBotsAggregatesJobResultsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetAnalyticsBotsAggregatesJobResultsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/analytics/bots/aggregates/jobs/{jobId}/results")
	...
	public static class Builder {
		private final GetAnalyticsBotsAggregatesJobResultsRequest request;

		private Builder() {
			request = new GetAnalyticsBotsAggregatesJobResultsRequest();
		}
		...
		public GetAnalyticsBotsAggregatesJobResultsRequest build() {
