...
public class GetKnowledgeConnectionOptionsRequest {
	...
	public GetKnowledgeConnectionOptionsRequest withParentId(String parentId) {
    ...
    public GetKnowledgeConnectionOptionsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.connectionId == null) {
            throw new IllegalStateException("Missing the required parameter 'connectionId' when building request for GetKnowledgeConnectionOptionsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/knowledge/connections/{connectionId}/options")
	...
	public static Builder builder(String connectionId) {
	    return new Builder()
	            .withRequiredParams(connectionId);
	}


	public static class Builder {
		private final GetKnowledgeConnectionOptionsRequest request;

		private Builder() {
			request = new GetKnowledgeConnectionOptionsRequest();
		}
		...
		public Builder withRequiredParams(String connectionId) {
			request.setConnectionId(connectionId);
		...
		public GetKnowledgeConnectionOptionsRequest build() {
