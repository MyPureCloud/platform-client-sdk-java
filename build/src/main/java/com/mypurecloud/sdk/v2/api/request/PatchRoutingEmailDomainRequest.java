...
public class PatchRoutingEmailDomainRequest {
	...
	public PatchRoutingEmailDomainRequest withDomainId(String domainId) {
	...
	public PatchRoutingEmailDomainRequest withBody(InboundDomainPatchRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchRoutingEmailDomainRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<InboundDomainPatchRequest> withHttpInfo() {
        ...
        if (this.domainId == null) {
            throw new IllegalStateException("Missing the required parameter 'domainId' when building request for PatchRoutingEmailDomainRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchRoutingEmailDomainRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/routing/email/domains/{domainId}")
	...
	public static class Builder {
		private final PatchRoutingEmailDomainRequest request;

		private Builder() {
			request = new PatchRoutingEmailDomainRequest();
		}
		...
		public PatchRoutingEmailDomainRequest build() {
