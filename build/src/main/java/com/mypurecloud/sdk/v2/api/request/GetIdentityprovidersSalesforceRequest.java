...
public class GetIdentityprovidersSalesforceRequest {
    ...
    public GetIdentityprovidersSalesforceRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() throws ApiException {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/identityproviders/salesforce")                .withCustomHeaders(customHeaders)
	...
	public static class Builder {
		private final GetIdentityprovidersSalesforceRequest request;

		private Builder() {
			request = new GetIdentityprovidersSalesforceRequest();
		}




		public GetIdentityprovidersSalesforceRequest build() {
			return request;
		}
	}
}
