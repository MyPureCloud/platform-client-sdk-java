...
public class GetFlowsInstancesSettingsExecutiondataRequest {
    ...
    public GetFlowsInstancesSettingsExecutiondataRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/flows/instances/settings/executiondata")
	...
	public static class Builder {
		private final GetFlowsInstancesSettingsExecutiondataRequest request;

		private Builder() {
			request = new GetFlowsInstancesSettingsExecutiondataRequest();
		}
		...
		public GetFlowsInstancesSettingsExecutiondataRequest build() {
