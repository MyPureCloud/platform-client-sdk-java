...
public class PostWorkforcemanagementTimeofflimitsAvailableQueryRequest {

	private AvailableTimeOffRequest body;
	public AvailableTimeOffRequest getBody() {
		return this.body;
	}

	public void setBody(AvailableTimeOffRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementTimeofflimitsAvailableQueryRequest withBody(AvailableTimeOffRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementTimeofflimitsAvailableQueryRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<AvailableTimeOffRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementTimeofflimitsAvailableQueryRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/timeofflimits/available/query")
                .withBody(body)
	...
	public static Builder builder(AvailableTimeOffRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementTimeofflimitsAvailableQueryRequest request;

		private Builder() {
			request = new PostWorkforcemanagementTimeofflimitsAvailableQueryRequest();
		}


		public Builder withBody(AvailableTimeOffRequest body) {
		...
		public Builder withRequiredParams(AvailableTimeOffRequest body) {
			request.setBody(body);
		...
		public PostWorkforcemanagementTimeofflimitsAvailableQueryRequest build() {
