...
public class DeleteTelephonyProvidersEdgesTrunkbasesettingRequest {
	...
	public DeleteTelephonyProvidersEdgesTrunkbasesettingRequest withTrunkBaseSettingsId(String trunkBaseSettingsId) {
    ...
    public DeleteTelephonyProvidersEdgesTrunkbasesettingRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("DELETE", "/api/v2/telephony/providers/edges/trunkbasesettings/{trunkBaseSettingsId}")
	...
	public static class Builder {
		private final DeleteTelephonyProvidersEdgesTrunkbasesettingRequest request;

		private Builder() {
			request = new DeleteTelephonyProvidersEdgesTrunkbasesettingRequest();
		}
		...
		public DeleteTelephonyProvidersEdgesTrunkbasesettingRequest build() {
            
            // verify the required parameter 'trunkBaseSettingsId' is set
            if (request.trunkBaseSettingsId == null) {
                throw new IllegalStateException("Missing the required parameter 'trunkBaseSettingsId' when building request for DeleteTelephonyProvidersEdgesTrunkbasesettingRequest.");
            }
