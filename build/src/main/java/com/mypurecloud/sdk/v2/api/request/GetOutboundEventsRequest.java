...
public class GetOutboundEventsRequest {
	...
	public GetOutboundEventsRequest withPageSize(Integer pageSize) {
	...
	public GetOutboundEventsRequest withPageNumber(Integer pageNumber) {
	...
	public GetOutboundEventsRequest withFilterType(String filterType) {
	...
	public GetOutboundEventsRequest withCategory(String category) {
	...
	public GetOutboundEventsRequest withLevel(String level) {
	    this.setLevel(level);
	    return this;
	} 
	...
	public GetOutboundEventsRequest withSortBy(String sortBy) {
	...
	public GetOutboundEventsRequest withSortOrder(String sortOrder) {
    ...
    public GetOutboundEventsRequest withCustomHeader(String name, String value) {
