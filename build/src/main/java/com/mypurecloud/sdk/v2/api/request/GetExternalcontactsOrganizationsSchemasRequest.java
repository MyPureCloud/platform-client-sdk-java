...
public class GetExternalcontactsOrganizationsSchemasRequest {
    ...
    public GetExternalcontactsOrganizationsSchemasRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/externalcontacts/organizations/schemas")
	...
	public static class Builder {
		private final GetExternalcontactsOrganizationsSchemasRequest request;

		private Builder() {
			request = new GetExternalcontactsOrganizationsSchemasRequest();
		}
		...
		public GetExternalcontactsOrganizationsSchemasRequest build() {
