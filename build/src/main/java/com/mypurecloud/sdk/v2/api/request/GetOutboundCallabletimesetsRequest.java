...
public class GetOutboundCallabletimesetsRequest {
	...
	public GetOutboundCallabletimesetsRequest withPageSize(Integer pageSize) {
	...
	public GetOutboundCallabletimesetsRequest withPageNumber(Integer pageNumber) {
	...
	public GetOutboundCallabletimesetsRequest withAllowEmptyResult(Boolean allowEmptyResult) {
	...
	public GetOutboundCallabletimesetsRequest withFilterType(String filterType) {
	...
	public GetOutboundCallabletimesetsRequest withName(String name) {
	    this.setName(name);
	    return this;
	} 
	...
	public GetOutboundCallabletimesetsRequest withSortBy(String sortBy) {
	...
	public GetOutboundCallabletimesetsRequest withSortOrder(String sortOrder) {
    ...
    public GetOutboundCallabletimesetsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/outbound/callabletimesets")
	...
	public static class Builder {
		private final GetOutboundCallabletimesetsRequest request;

		private Builder() {
			request = new GetOutboundCallabletimesetsRequest();
		}
		...
		public GetOutboundCallabletimesetsRequest build() {
