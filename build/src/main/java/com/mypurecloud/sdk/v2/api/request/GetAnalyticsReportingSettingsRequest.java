...
public class GetAnalyticsReportingSettingsRequest {
    ...
    public GetAnalyticsReportingSettingsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/analytics/reporting/settings")
	...
	public static class Builder {
		private final GetAnalyticsReportingSettingsRequest request;

		private Builder() {
			request = new GetAnalyticsReportingSettingsRequest();
		}
		...
		public GetAnalyticsReportingSettingsRequest build() {
