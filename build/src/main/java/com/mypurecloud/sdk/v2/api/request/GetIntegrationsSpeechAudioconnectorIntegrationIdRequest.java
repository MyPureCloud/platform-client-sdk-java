...
public class GetIntegrationsSpeechAudioconnectorIntegrationIdRequest {
	...
	public GetIntegrationsSpeechAudioconnectorIntegrationIdRequest withIntegrationId(String integrationId) {
    ...
    public GetIntegrationsSpeechAudioconnectorIntegrationIdRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.integrationId == null) {
            throw new IllegalStateException("Missing the required parameter 'integrationId' when building request for GetIntegrationsSpeechAudioconnectorIntegrationIdRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/integrations/speech/audioconnector/{integrationId}")
	...
	public static class Builder {
		private final GetIntegrationsSpeechAudioconnectorIntegrationIdRequest request;

		private Builder() {
			request = new GetIntegrationsSpeechAudioconnectorIntegrationIdRequest();
		}
		...
		public GetIntegrationsSpeechAudioconnectorIntegrationIdRequest build() {
