...
public class GetConversationsMessagingIntegrationsWhatsappRequest {
	...
	public GetConversationsMessagingIntegrationsWhatsappRequest withPageSize(Integer pageSize) {
	...
	public GetConversationsMessagingIntegrationsWhatsappRequest withPageNumber(Integer pageNumber) {
	...
	public GetConversationsMessagingIntegrationsWhatsappRequest withExpand(String expand) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/conversations/messaging/integrations/whatsapp")
	...
	public static class Builder {
		private final GetConversationsMessagingIntegrationsWhatsappRequest request;

		private Builder() {
			request = new GetConversationsMessagingIntegrationsWhatsappRequest();
		}
		...
		public GetConversationsMessagingIntegrationsWhatsappRequest build() {
