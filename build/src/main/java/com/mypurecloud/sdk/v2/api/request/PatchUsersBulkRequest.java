...
public class PatchUsersBulkRequest {
    
	private List<PatchUser> body;
	public List<PatchUser> getBody() {
		return this.body;
	}

	public void setBody(List<PatchUser> body) {
		this.body = body;
	}

	public PatchUsersBulkRequest withBody(List<PatchUser> body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchUsersBulkRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<List<PatchUser>> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchUsersBulkRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/users/bulk")
                .withBody(body)
	...
	public static Builder builder(List<PatchUser> body) {
	    return new Builder()
	...
	public static class Builder {
		private final PatchUsersBulkRequest request;

		private Builder() {
			request = new PatchUsersBulkRequest();
		}

		
		public Builder withBody(List<PatchUser> body) {
		...
		public Builder withRequiredParams(List<PatchUser> body) {
			request.setBody(body);
		...
		public PatchUsersBulkRequest build() {
