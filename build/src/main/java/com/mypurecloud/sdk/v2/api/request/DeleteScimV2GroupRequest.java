...
public class DeleteScimV2GroupRequest {
	...
	public DeleteScimV2GroupRequest withGroupId(String groupId) {
	...
	public DeleteScimV2GroupRequest withIfMatch(String ifMatch) {
    ...
    public DeleteScimV2GroupRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.groupId == null) {
            throw new IllegalStateException("Missing the required parameter 'groupId' when building request for DeleteScimV2GroupRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/scim/v2/groups/{groupId}")
	...
	public static class Builder {
		private final DeleteScimV2GroupRequest request;

		private Builder() {
			request = new DeleteScimV2GroupRequest();
		}
		...
		public DeleteScimV2GroupRequest build() {
