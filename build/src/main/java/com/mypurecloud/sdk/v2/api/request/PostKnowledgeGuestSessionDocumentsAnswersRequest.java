...
public class PostKnowledgeGuestSessionDocumentsAnswersRequest {
	...
	public PostKnowledgeGuestSessionDocumentsAnswersRequest withSessionId(String sessionId) {
	...
	public PostKnowledgeGuestSessionDocumentsAnswersRequest withBody(KnowledgeDocumentsAnswerFilter body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostKnowledgeGuestSessionDocumentsAnswersRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<KnowledgeDocumentsAnswerFilter> withHttpInfo() {
        ...
        if (this.sessionId == null) {
            throw new IllegalStateException("Missing the required parameter 'sessionId' when building request for PostKnowledgeGuestSessionDocumentsAnswersRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostKnowledgeGuestSessionDocumentsAnswersRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/knowledge/guest/sessions/{sessionId}/documents/answers")
	...
	public static Builder builder(String sessionId, KnowledgeDocumentsAnswerFilter body) {
	    return new Builder()
	            .withRequiredParams(sessionId, body);
	}


	public static class Builder {
		private final PostKnowledgeGuestSessionDocumentsAnswersRequest request;

		private Builder() {
			request = new PostKnowledgeGuestSessionDocumentsAnswersRequest();
		}
		...
		public Builder withRequiredParams(String sessionId, KnowledgeDocumentsAnswerFilter body) {
			request.setSessionId(sessionId);
			request.setBody(body);
		...
		public PostKnowledgeGuestSessionDocumentsAnswersRequest build() {
