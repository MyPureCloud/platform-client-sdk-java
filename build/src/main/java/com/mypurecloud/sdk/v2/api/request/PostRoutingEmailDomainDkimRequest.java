...
public class PostRoutingEmailDomainDkimRequest {
	...
	public PostRoutingEmailDomainDkimRequest withDomainId(String domainId) {
    ...
    public PostRoutingEmailDomainDkimRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.domainId == null) {
            throw new IllegalStateException("Missing the required parameter 'domainId' when building request for PostRoutingEmailDomainDkimRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/routing/email/domains/{domainId}/dkim")
	...
	public static class Builder {
		private final PostRoutingEmailDomainDkimRequest request;

		private Builder() {
			request = new PostRoutingEmailDomainDkimRequest();
		}
		...
		public PostRoutingEmailDomainDkimRequest build() {
