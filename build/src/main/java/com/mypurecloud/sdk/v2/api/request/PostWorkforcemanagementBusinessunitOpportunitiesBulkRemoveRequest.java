...
public class PostWorkforcemanagementBusinessunitOpportunitiesBulkRemoveRequest {
	...
	public PostWorkforcemanagementBusinessunitOpportunitiesBulkRemoveRequest withBusinessUnitId(String businessUnitId) {
	...
	public PostWorkforcemanagementBusinessunitOpportunitiesBulkRemoveRequest withBody(BulkOpportunitiesRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementBusinessunitOpportunitiesBulkRemoveRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<BulkOpportunitiesRequest> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PostWorkforcemanagementBusinessunitOpportunitiesBulkRemoveRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementBusinessunitOpportunitiesBulkRemoveRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/opportunities/bulk/remove")
	...
	public static class Builder {
		private final PostWorkforcemanagementBusinessunitOpportunitiesBulkRemoveRequest request;

		private Builder() {
			request = new PostWorkforcemanagementBusinessunitOpportunitiesBulkRemoveRequest();
		}
		...
		public PostWorkforcemanagementBusinessunitOpportunitiesBulkRemoveRequest build() {
