...
public class GetWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionSessionIdSnapshotSnapshotIdRequest {
	...
	public GetWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionSessionIdSnapshotSnapshotIdRequest withBusinessUnitId(String businessUnitId) {
	...
	public GetWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionSessionIdSnapshotSnapshotIdRequest withSessionId(String sessionId) {
	...
	public GetWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionSessionIdSnapshotSnapshotIdRequest withSnapshotId(String snapshotId) {
    ...
    public GetWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionSessionIdSnapshotSnapshotIdRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for GetWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionSessionIdSnapshotSnapshotIdRequest.");
        }
        
        // verify the required parameter 'sessionId' is set
        if (this.sessionId == null) {
            throw new IllegalStateException("Missing the required parameter 'sessionId' when building request for GetWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionSessionIdSnapshotSnapshotIdRequest.");
        }
        
        // verify the required parameter 'snapshotId' is set
        if (this.snapshotId == null) {
            throw new IllegalStateException("Missing the required parameter 'snapshotId' when building request for GetWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionSessionIdSnapshotSnapshotIdRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/mainforecast/continuousforecast/session/{sessionId}/snapshot/{snapshotId}")
                .withPathParameter("businessUnitId", businessUnitId)
        
                .withPathParameter("sessionId", sessionId)
        
                .withPathParameter("snapshotId", snapshotId)
	...
	public static Builder builder(String businessUnitId, String sessionId, String snapshotId) {
	    return new Builder()
	            .withRequiredParams(businessUnitId, sessionId, snapshotId);
	}


	public static class Builder {
		private final GetWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionSessionIdSnapshotSnapshotIdRequest request;

		private Builder() {
			request = new GetWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionSessionIdSnapshotSnapshotIdRequest();
		}
		...
		public Builder withSnapshotId(String snapshotId) {
		...
		public Builder withRequiredParams(String businessUnitId, String sessionId, String snapshotId) {
			request.setBusinessUnitId(businessUnitId);
			request.setSessionId(sessionId);
			request.setSnapshotId(snapshotId);
		...
		public GetWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionSessionIdSnapshotSnapshotIdRequest build() {
