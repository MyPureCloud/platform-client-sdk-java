...
public class GetUserRoutingstatusRequest {
	...
	public GetUserRoutingstatusRequest withUserId(String userId) {
    ...
    public GetUserRoutingstatusRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.userId == null) {
            throw new IllegalStateException("Missing the required parameter 'userId' when building request for GetUserRoutingstatusRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/users/{userId}/routingstatus")
	...
	public static class Builder {
		private final GetUserRoutingstatusRequest request;

		private Builder() {
			request = new GetUserRoutingstatusRequest();
		}
		...
		public GetUserRoutingstatusRequest build() {
