...
public class PostConversationsChatCommunicationMessagesRequest {
    ...
    public ApiRequest<CreateWebChatMessageRequest> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("POST", "/api/v2/conversations/chats/{conversationId}/communications/{communicationId}/messages")
	...
	public static class Builder {
		...
		private Builder() {
			request = new PostConversationsChatCommunicationMessagesRequest();
		}
