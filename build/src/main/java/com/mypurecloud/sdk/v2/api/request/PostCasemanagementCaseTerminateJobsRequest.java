...
public class PostCasemanagementCaseTerminateJobsRequest {
	...
	public PostCasemanagementCaseTerminateJobsRequest withCaseId(String caseId) {
    ...
    public PostCasemanagementCaseTerminateJobsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.caseId == null) {
            throw new IllegalStateException("Missing the required parameter 'caseId' when building request for PostCasemanagementCaseTerminateJobsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/casemanagement/cases/{caseId}/terminate/jobs")
	...
	public static class Builder {
		private final PostCasemanagementCaseTerminateJobsRequest request;

		private Builder() {
			request = new PostCasemanagementCaseTerminateJobsRequest();
		}
		...
		public PostCasemanagementCaseTerminateJobsRequest build() {
