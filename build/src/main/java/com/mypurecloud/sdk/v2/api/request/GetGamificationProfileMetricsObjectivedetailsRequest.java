...
public class GetGamificationProfileMetricsObjectivedetailsRequest {
	...
	public GetGamificationProfileMetricsObjectivedetailsRequest withProfileId(String profileId) {
	...
	public GetGamificationProfileMetricsObjectivedetailsRequest withWorkday(LocalDate workday) {
    ...
    public GetGamificationProfileMetricsObjectivedetailsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.profileId == null) {
            throw new IllegalStateException("Missing the required parameter 'profileId' when building request for GetGamificationProfileMetricsObjectivedetailsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/gamification/profiles/{profileId}/metrics/objectivedetails")
	...
	public static class Builder {
		private final GetGamificationProfileMetricsObjectivedetailsRequest request;

		private Builder() {
			request = new GetGamificationProfileMetricsObjectivedetailsRequest();
		}
		...
		public GetGamificationProfileMetricsObjectivedetailsRequest build() {
