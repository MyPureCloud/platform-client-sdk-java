...
public class DeleteAnalyticsFlowsAggregatesJobRequest {
	...
	public DeleteAnalyticsFlowsAggregatesJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public DeleteAnalyticsFlowsAggregatesJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for DeleteAnalyticsFlowsAggregatesJobRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/analytics/flows/aggregates/jobs/{jobId}")
	...
	public static class Builder {
		private final DeleteAnalyticsFlowsAggregatesJobRequest request;

		private Builder() {
			request = new DeleteAnalyticsFlowsAggregatesJobRequest();
		}
		...
		public DeleteAnalyticsFlowsAggregatesJobRequest build() {
