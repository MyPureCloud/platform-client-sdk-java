...
public class DeleteOrgauthorizationTrusteeUserRequest {
	...
	public DeleteOrgauthorizationTrusteeUserRequest withTrusteeOrgId(String trusteeOrgId) {
	...
	public DeleteOrgauthorizationTrusteeUserRequest withTrusteeUserId(String trusteeUserId) {
    ...
    public DeleteOrgauthorizationTrusteeUserRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.trusteeOrgId == null) {
            throw new IllegalStateException("Missing the required parameter 'trusteeOrgId' when building request for DeleteOrgauthorizationTrusteeUserRequest.");
        }
        
        // verify the required parameter 'trusteeUserId' is set
        if (this.trusteeUserId == null) {
            throw new IllegalStateException("Missing the required parameter 'trusteeUserId' when building request for DeleteOrgauthorizationTrusteeUserRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/orgauthorization/trustees/{trusteeOrgId}/users/{trusteeUserId}")
	...
	public static class Builder {
		private final DeleteOrgauthorizationTrusteeUserRequest request;

		private Builder() {
			request = new DeleteOrgauthorizationTrusteeUserRequest();
		}
		...
		public DeleteOrgauthorizationTrusteeUserRequest build() {
