...
public class GetOutboundMessagingcampaignProgressRequest {
	...
	public GetOutboundMessagingcampaignProgressRequest withMessagingCampaignId(String messagingCampaignId) {
    ...
    public GetOutboundMessagingcampaignProgressRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.messagingCampaignId == null) {
            throw new IllegalStateException("Missing the required parameter 'messagingCampaignId' when building request for GetOutboundMessagingcampaignProgressRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/outbound/messagingcampaigns/{messagingCampaignId}/progress")
	...
	public static class Builder {
		private final GetOutboundMessagingcampaignProgressRequest request;

		private Builder() {
			request = new GetOutboundMessagingcampaignProgressRequest();
		}
		...
		public GetOutboundMessagingcampaignProgressRequest build() {
