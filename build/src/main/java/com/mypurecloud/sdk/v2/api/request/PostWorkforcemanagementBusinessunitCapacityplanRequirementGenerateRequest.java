...
public class PostWorkforcemanagementBusinessunitCapacityplanRequirementGenerateRequest {
	...
	public PostWorkforcemanagementBusinessunitCapacityplanRequirementGenerateRequest withBusinessUnitId(String businessUnitId) {
	...
	public PostWorkforcemanagementBusinessunitCapacityplanRequirementGenerateRequest withCapacityPlanId(String capacityPlanId) {
    ...
    public PostWorkforcemanagementBusinessunitCapacityplanRequirementGenerateRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PostWorkforcemanagementBusinessunitCapacityplanRequirementGenerateRequest.");
        }
        
        // verify the required parameter 'capacityPlanId' is set
        if (this.capacityPlanId == null) {
            throw new IllegalStateException("Missing the required parameter 'capacityPlanId' when building request for PostWorkforcemanagementBusinessunitCapacityplanRequirementGenerateRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/capacityplans/{capacityPlanId}/requirement/generate")
	...
	public static class Builder {
		private final PostWorkforcemanagementBusinessunitCapacityplanRequirementGenerateRequest request;

		private Builder() {
			request = new PostWorkforcemanagementBusinessunitCapacityplanRequirementGenerateRequest();
		}
		...
		public PostWorkforcemanagementBusinessunitCapacityplanRequirementGenerateRequest build() {
