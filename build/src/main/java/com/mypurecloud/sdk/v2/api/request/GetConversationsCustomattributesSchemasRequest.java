...
public class GetConversationsCustomattributesSchemasRequest {
    ...
    public GetConversationsCustomattributesSchemasRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/conversations/customattributes/schemas")
	...
	public static class Builder {
		private final GetConversationsCustomattributesSchemasRequest request;

		private Builder() {
			request = new GetConversationsCustomattributesSchemasRequest();
		}
		...
		public GetConversationsCustomattributesSchemasRequest build() {
