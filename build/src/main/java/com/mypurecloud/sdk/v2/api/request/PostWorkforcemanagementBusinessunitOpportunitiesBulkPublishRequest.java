...
public class PostWorkforcemanagementBusinessunitOpportunitiesBulkPublishRequest {
	...
	public PostWorkforcemanagementBusinessunitOpportunitiesBulkPublishRequest withBusinessUnitId(String businessUnitId) {
	    this.setBusinessUnitId(businessUnitId);
	    return this;
	} 

	private BulkOpportunitiesRequest body;
	public BulkOpportunitiesRequest getBody() {
		return this.body;
	}

	public void setBody(BulkOpportunitiesRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementBusinessunitOpportunitiesBulkPublishRequest withBody(BulkOpportunitiesRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementBusinessunitOpportunitiesBulkPublishRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<BulkOpportunitiesRequest> withHttpInfo() {
        
        // verify the required parameter 'businessUnitId' is set
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PostWorkforcemanagementBusinessunitOpportunitiesBulkPublishRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementBusinessunitOpportunitiesBulkPublishRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/opportunities/bulk/publish")
	...
	public static Builder builder(String businessUnitId, BulkOpportunitiesRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementBusinessunitOpportunitiesBulkPublishRequest request;

		private Builder() {
			request = new PostWorkforcemanagementBusinessunitOpportunitiesBulkPublishRequest();
		}
		...
		public Builder withBody(BulkOpportunitiesRequest body) {
		...
		public Builder withRequiredParams(String businessUnitId, BulkOpportunitiesRequest body) {
			request.setBusinessUnitId(businessUnitId);
			request.setBody(body);
		...
		public PostWorkforcemanagementBusinessunitOpportunitiesBulkPublishRequest build() {
