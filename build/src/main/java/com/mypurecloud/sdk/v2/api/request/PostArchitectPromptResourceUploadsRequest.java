...
public class PostArchitectPromptResourceUploadsRequest {
	...
	public PostArchitectPromptResourceUploadsRequest withPromptId(String promptId) {
	...
	public PostArchitectPromptResourceUploadsRequest withLanguageCode(String languageCode) {
    ...
    public PostArchitectPromptResourceUploadsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.promptId == null) {
            throw new IllegalStateException("Missing the required parameter 'promptId' when building request for PostArchitectPromptResourceUploadsRequest.");
        }
        
        // verify the required parameter 'languageCode' is set
        if (this.languageCode == null) {
            throw new IllegalStateException("Missing the required parameter 'languageCode' when building request for PostArchitectPromptResourceUploadsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/architect/prompts/{promptId}/resources/{languageCode}/uploads")
	...
	public static class Builder {
		private final PostArchitectPromptResourceUploadsRequest request;

		private Builder() {
			request = new PostArchitectPromptResourceUploadsRequest();
		}
		...
		public PostArchitectPromptResourceUploadsRequest build() {
