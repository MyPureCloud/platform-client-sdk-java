...
public class PutConversationsMessagingIdentityresolutionIntegrationsOpenIntegrationIdRequest {
	...
	public PutConversationsMessagingIdentityresolutionIntegrationsOpenIntegrationIdRequest withIntegrationId(String integrationId) {
	    this.setIntegrationId(integrationId);
	    return this;
	} 

	private OpenMessagingIdentityResolutionConfig body;
	public OpenMessagingIdentityResolutionConfig getBody() {
		return this.body;
	}

	public void setBody(OpenMessagingIdentityResolutionConfig body) {
		this.body = body;
	}

	public PutConversationsMessagingIdentityresolutionIntegrationsOpenIntegrationIdRequest withBody(OpenMessagingIdentityResolutionConfig body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutConversationsMessagingIdentityresolutionIntegrationsOpenIntegrationIdRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<OpenMessagingIdentityResolutionConfig> withHttpInfo() {
        
        // verify the required parameter 'integrationId' is set
        if (this.integrationId == null) {
            throw new IllegalStateException("Missing the required parameter 'integrationId' when building request for PutConversationsMessagingIdentityresolutionIntegrationsOpenIntegrationIdRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutConversationsMessagingIdentityresolutionIntegrationsOpenIntegrationIdRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/conversations/messaging/identityresolution/integrations/open/{integrationId}")
	...
	public static Builder builder(String integrationId, OpenMessagingIdentityResolutionConfig body) {
	    return new Builder()
	...
	public static class Builder {
		private final PutConversationsMessagingIdentityresolutionIntegrationsOpenIntegrationIdRequest request;

		private Builder() {
			request = new PutConversationsMessagingIdentityresolutionIntegrationsOpenIntegrationIdRequest();
		}
		...
		public Builder withBody(OpenMessagingIdentityResolutionConfig body) {
		...
		public Builder withRequiredParams(String integrationId, OpenMessagingIdentityResolutionConfig body) {
			request.setIntegrationId(integrationId);
			request.setBody(body);
		...
		public PutConversationsMessagingIdentityresolutionIntegrationsOpenIntegrationIdRequest build() {
