...
public class EmergencyGroup  implements Serializable {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, description, version, dateCreated, dateModified, modifiedBy, createdBy, state, modifiedByApp, createdByApp, enabled, emergencyCallFlows, selfUri);
  }
