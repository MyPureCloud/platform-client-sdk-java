...
public class PostWorkforcemanagementBusinessunitSchedulebidCopyRequest {
	...
	public PostWorkforcemanagementBusinessunitSchedulebidCopyRequest withBusinessUnitId(String businessUnitId) {
	...
	public PostWorkforcemanagementBusinessunitSchedulebidCopyRequest withBidId(String bidId) {
	    this.setBidId(bidId);
	    return this;
	} 

	private CopyScheduleBid body;
	public CopyScheduleBid getBody() {
		return this.body;
	}

	public void setBody(CopyScheduleBid body) {
		this.body = body;
	}

	public PostWorkforcemanagementBusinessunitSchedulebidCopyRequest withBody(CopyScheduleBid body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementBusinessunitSchedulebidCopyRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<CopyScheduleBid> withHttpInfo() {
        
        // verify the required parameter 'businessUnitId' is set
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PostWorkforcemanagementBusinessunitSchedulebidCopyRequest.");
        }
        
        // verify the required parameter 'bidId' is set
        if (this.bidId == null) {
            throw new IllegalStateException("Missing the required parameter 'bidId' when building request for PostWorkforcemanagementBusinessunitSchedulebidCopyRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementBusinessunitSchedulebidCopyRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/schedulebids/{bidId}/copy")
	...
	public static Builder builder(String businessUnitId, String bidId, CopyScheduleBid body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementBusinessunitSchedulebidCopyRequest request;

		private Builder() {
			request = new PostWorkforcemanagementBusinessunitSchedulebidCopyRequest();
		}
		...
		public Builder withBody(CopyScheduleBid body) {
		...
		public Builder withRequiredParams(String businessUnitId, String bidId, CopyScheduleBid body) {
			request.setBusinessUnitId(businessUnitId);
			request.setBidId(bidId);
			request.setBody(body);
		...
		public PostWorkforcemanagementBusinessunitSchedulebidCopyRequest build() {
