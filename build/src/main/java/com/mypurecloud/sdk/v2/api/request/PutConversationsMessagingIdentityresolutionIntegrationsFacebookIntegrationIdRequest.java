...
public class PutConversationsMessagingIdentityresolutionIntegrationsFacebookIntegrationIdRequest {
	...
	private FacebookIdentityResolutionConfig body;
	public FacebookIdentityResolutionConfig getBody() {
		return this.body;
	}

	public void setBody(FacebookIdentityResolutionConfig body) {
		this.body = body;
	}

	public PutConversationsMessagingIdentityresolutionIntegrationsFacebookIntegrationIdRequest withBody(FacebookIdentityResolutionConfig body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public ApiRequest<FacebookIdentityResolutionConfig> withHttpInfo() {
        
        // verify the required parameter 'integrationId' is set
        if (this.integrationId == null) {
            throw new IllegalStateException("Missing the required parameter 'integrationId' when building request for PutConversationsMessagingIdentityresolutionIntegrationsFacebookIntegrationIdRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutConversationsMessagingIdentityresolutionIntegrationsFacebookIntegrationIdRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/conversations/messaging/identityresolution/integrations/facebook/{integrationId}")
	...
	public static Builder builder(String integrationId, FacebookIdentityResolutionConfig body) {
	    return new Builder()
	...
	public static class Builder {
		private final PutConversationsMessagingIdentityresolutionIntegrationsFacebookIntegrationIdRequest request;

		private Builder() {
			request = new PutConversationsMessagingIdentityresolutionIntegrationsFacebookIntegrationIdRequest();
		}
		...
		public Builder withBody(FacebookIdentityResolutionConfig body) {
		...
		public Builder withRequiredParams(String integrationId, FacebookIdentityResolutionConfig body) {
			request.setIntegrationId(integrationId);
			request.setBody(body);
		...
		public PutConversationsMessagingIdentityresolutionIntegrationsFacebookIntegrationIdRequest build() {
