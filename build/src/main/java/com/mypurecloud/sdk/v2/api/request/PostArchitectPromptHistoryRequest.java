...
public class PostArchitectPromptHistoryRequest {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("POST", "/api/v2/architect/prompts/{promptId}/history")
	...
	public static class Builder {
		private final PostArchitectPromptHistoryRequest request;

		private Builder() {
			request = new PostArchitectPromptHistoryRequest();
		}
