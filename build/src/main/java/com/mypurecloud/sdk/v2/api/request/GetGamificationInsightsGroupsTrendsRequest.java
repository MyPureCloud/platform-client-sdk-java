...
public class GetGamificationInsightsGroupsTrendsRequest {
	...
	public GetGamificationInsightsGroupsTrendsRequest withFilterType(String filterType) {
	...
	public GetGamificationInsightsGroupsTrendsRequest withFilterId(String filterId) {
	...
	public GetGamificationInsightsGroupsTrendsRequest withGranularity(String granularity) {
	...
	public GetGamificationInsightsGroupsTrendsRequest withComparativePeriodStartWorkday(LocalDate comparativePeriodStartWorkday) {
	...
	public GetGamificationInsightsGroupsTrendsRequest withComparativePeriodEndWorkday(LocalDate comparativePeriodEndWorkday) {
	...
	public GetGamificationInsightsGroupsTrendsRequest withPrimaryPeriodStartWorkday(LocalDate primaryPeriodStartWorkday) {
	...
	public GetGamificationInsightsGroupsTrendsRequest withPrimaryPeriodEndWorkday(LocalDate primaryPeriodEndWorkday) {
    ...
    public GetGamificationInsightsGroupsTrendsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.filterType == null) {
            throw new IllegalStateException("Missing the required parameter 'filterType' when building request for GetGamificationInsightsGroupsTrendsRequest.");
        }
        
        // verify the required parameter 'filterId' is set
        if (this.filterId == null) {
            throw new IllegalStateException("Missing the required parameter 'filterId' when building request for GetGamificationInsightsGroupsTrendsRequest.");
        }
        
        // verify the required parameter 'granularity' is set
        if (this.granularity == null) {
            throw new IllegalStateException("Missing the required parameter 'granularity' when building request for GetGamificationInsightsGroupsTrendsRequest.");
        }
        
        // verify the required parameter 'comparativePeriodStartWorkday' is set
        if (this.comparativePeriodStartWorkday == null) {
            throw new IllegalStateException("Missing the required parameter 'comparativePeriodStartWorkday' when building request for GetGamificationInsightsGroupsTrendsRequest.");
        }
        
        // verify the required parameter 'comparativePeriodEndWorkday' is set
        if (this.comparativePeriodEndWorkday == null) {
            throw new IllegalStateException("Missing the required parameter 'comparativePeriodEndWorkday' when building request for GetGamificationInsightsGroupsTrendsRequest.");
        }
        
        // verify the required parameter 'primaryPeriodStartWorkday' is set
        if (this.primaryPeriodStartWorkday == null) {
            throw new IllegalStateException("Missing the required parameter 'primaryPeriodStartWorkday' when building request for GetGamificationInsightsGroupsTrendsRequest.");
        }
        
        // verify the required parameter 'primaryPeriodEndWorkday' is set
        if (this.primaryPeriodEndWorkday == null) {
            throw new IllegalStateException("Missing the required parameter 'primaryPeriodEndWorkday' when building request for GetGamificationInsightsGroupsTrendsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/gamification/insights/groups/trends")
	...
	public static class Builder {
		private final GetGamificationInsightsGroupsTrendsRequest request;

		private Builder() {
			request = new GetGamificationInsightsGroupsTrendsRequest();
		}
		...
		public GetGamificationInsightsGroupsTrendsRequest build() {
