...
public class PostConversationsMessagingIntegrationsTwitterRequest {
	...
	public PostConversationsMessagingIntegrationsTwitterRequest withBody(TwitterIntegrationRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostConversationsMessagingIntegrationsTwitterRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<TwitterIntegrationRequest> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostConversationsMessagingIntegrationsTwitterRequest.");
        }
	...
	public static class Builder {
		private final PostConversationsMessagingIntegrationsTwitterRequest request;

		private Builder() {
			request = new PostConversationsMessagingIntegrationsTwitterRequest();
		}
		...
		public PostConversationsMessagingIntegrationsTwitterRequest build() {
