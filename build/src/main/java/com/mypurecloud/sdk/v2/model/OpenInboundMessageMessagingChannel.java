...
public class OpenInboundMessageMessagingChannel  implements Serializable {
  ...
  public OpenInboundMessageMessagingChannel(Boolean initWithEmptyList) {
   ...
   **/
  public OpenInboundMessageMessagingChannel metadata(ConversationChannelMetadata metadata) {
