...
public class DeletePresenceSourceRequest {
	...
	public DeletePresenceSourceRequest withSourceId(String sourceId) {
    ...
    public DeletePresenceSourceRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.sourceId == null) {
            throw new IllegalStateException("Missing the required parameter 'sourceId' when building request for DeletePresenceSourceRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/presence/sources/{sourceId}")
	...
	public static class Builder {
		private final DeletePresenceSourceRequest request;

		private Builder() {
			request = new DeletePresenceSourceRequest();
		}
		...
		public DeletePresenceSourceRequest build() {
