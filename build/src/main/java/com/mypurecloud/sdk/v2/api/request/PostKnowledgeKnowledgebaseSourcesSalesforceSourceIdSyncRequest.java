...
public class PostKnowledgeKnowledgebaseSourcesSalesforceSourceIdSyncRequest {
	...
	public PostKnowledgeKnowledgebaseSourcesSalesforceSourceIdSyncRequest withKnowledgeBaseId(String knowledgeBaseId) {
	...
	public PostKnowledgeKnowledgebaseSourcesSalesforceSourceIdSyncRequest withSourceId(String sourceId) {
	...
	public PostKnowledgeKnowledgebaseSourcesSalesforceSourceIdSyncRequest withBody(Object body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostKnowledgeKnowledgebaseSourcesSalesforceSourceIdSyncRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Object> withHttpInfo() {
        ...
        if (this.knowledgeBaseId == null) {
            throw new IllegalStateException("Missing the required parameter 'knowledgeBaseId' when building request for PostKnowledgeKnowledgebaseSourcesSalesforceSourceIdSyncRequest.");
        }
        
        // verify the required parameter 'sourceId' is set
        if (this.sourceId == null) {
            throw new IllegalStateException("Missing the required parameter 'sourceId' when building request for PostKnowledgeKnowledgebaseSourcesSalesforceSourceIdSyncRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/sources/salesforce/{sourceId}/sync")
	...
	public static Builder builder(String knowledgeBaseId, String sourceId) {
	    return new Builder()
	            .withRequiredParams(knowledgeBaseId, sourceId);
	}


	public static class Builder {
		private final PostKnowledgeKnowledgebaseSourcesSalesforceSourceIdSyncRequest request;

		private Builder() {
			request = new PostKnowledgeKnowledgebaseSourcesSalesforceSourceIdSyncRequest();
		}
		...
		public Builder withRequiredParams(String knowledgeBaseId, String sourceId) {
			request.setKnowledgeBaseId(knowledgeBaseId);
			request.setSourceId(sourceId);
		...
		public PostKnowledgeKnowledgebaseSourcesSalesforceSourceIdSyncRequest build() {
