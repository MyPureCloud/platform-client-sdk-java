...
public class GetConversationSuggestionRequest {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/conversations/{conversationId}/suggestions/{suggestionId}")
                .withPathParameter("conversationId", conversationId)
        
                .withPathParameter("suggestionId", suggestionId)
	...
	public static Builder builder(String conversationId, String suggestionId) {
	    return new Builder()
	            .withRequiredParams(conversationId, suggestionId);
	}


	public static class Builder {
		private final GetConversationSuggestionRequest request;

		private Builder() {
			request = new GetConversationSuggestionRequest();
		}
