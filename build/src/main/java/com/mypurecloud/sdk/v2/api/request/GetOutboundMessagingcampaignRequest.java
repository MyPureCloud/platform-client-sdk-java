...
public class GetOutboundMessagingcampaignRequest {
	...
	public GetOutboundMessagingcampaignRequest withMessagingCampaignId(String messagingCampaignId) {
    ...
    public GetOutboundMessagingcampaignRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.messagingCampaignId == null) {
            throw new IllegalStateException("Missing the required parameter 'messagingCampaignId' when building request for GetOutboundMessagingcampaignRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/outbound/messagingcampaigns/{messagingCampaignId}")
	...
	public static class Builder {
		private final GetOutboundMessagingcampaignRequest request;

		private Builder() {
			request = new GetOutboundMessagingcampaignRequest();
		}
		...
		public GetOutboundMessagingcampaignRequest build() {
