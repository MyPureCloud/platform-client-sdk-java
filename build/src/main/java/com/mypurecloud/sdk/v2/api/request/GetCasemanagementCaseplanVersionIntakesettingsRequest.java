...
public class GetCasemanagementCaseplanVersionIntakesettingsRequest {
	...
	public GetCasemanagementCaseplanVersionIntakesettingsRequest withCaseplanId(String caseplanId) {
	...
	public GetCasemanagementCaseplanVersionIntakesettingsRequest withVersionId(String versionId) {
    ...
    public GetCasemanagementCaseplanVersionIntakesettingsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.caseplanId == null) {
            throw new IllegalStateException("Missing the required parameter 'caseplanId' when building request for GetCasemanagementCaseplanVersionIntakesettingsRequest.");
        }
        
        // verify the required parameter 'versionId' is set
        if (this.versionId == null) {
            throw new IllegalStateException("Missing the required parameter 'versionId' when building request for GetCasemanagementCaseplanVersionIntakesettingsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/casemanagement/caseplans/{caseplanId}/versions/{versionId}/intakesettings")
	...
	public static class Builder {
		private final GetCasemanagementCaseplanVersionIntakesettingsRequest request;

		private Builder() {
			request = new GetCasemanagementCaseplanVersionIntakesettingsRequest();
		}
		...
		public GetCasemanagementCaseplanVersionIntakesettingsRequest build() {
