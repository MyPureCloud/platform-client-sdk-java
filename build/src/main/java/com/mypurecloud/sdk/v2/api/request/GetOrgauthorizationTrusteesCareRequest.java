...
public class GetOrgauthorizationTrusteesCareRequest {
    ...
    public GetOrgauthorizationTrusteesCareRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/orgauthorization/trustees/care")
	...
	public static class Builder {
		private final GetOrgauthorizationTrusteesCareRequest request;

		private Builder() {
			request = new GetOrgauthorizationTrusteesCareRequest();
		}
		...
		public GetOrgauthorizationTrusteesCareRequest build() {
