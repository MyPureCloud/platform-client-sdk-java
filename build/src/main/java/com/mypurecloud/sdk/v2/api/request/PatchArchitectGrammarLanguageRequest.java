...
public class PatchArchitectGrammarLanguageRequest {
	...
	public PatchArchitectGrammarLanguageRequest withGrammarId(String grammarId) {
	...
	public PatchArchitectGrammarLanguageRequest withLanguageCode(String languageCode) {
	    this.setLanguageCode(languageCode);
	    return this;
	} 

	private GrammarLanguageUpdate body;
	public GrammarLanguageUpdate getBody() {
		return this.body;
	}

	public void setBody(GrammarLanguageUpdate body) {
		this.body = body;
	}

	public PatchArchitectGrammarLanguageRequest withBody(GrammarLanguageUpdate body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchArchitectGrammarLanguageRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<GrammarLanguageUpdate> withHttpInfo() {
        
        // verify the required parameter 'grammarId' is set
        if (this.grammarId == null) {
            throw new IllegalStateException("Missing the required parameter 'grammarId' when building request for PatchArchitectGrammarLanguageRequest.");
        }
        
        // verify the required parameter 'languageCode' is set
        if (this.languageCode == null) {
            throw new IllegalStateException("Missing the required parameter 'languageCode' when building request for PatchArchitectGrammarLanguageRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/architect/grammars/{grammarId}/languages/{languageCode}")
                .withPathParameter("grammarId", grammarId)
	...
	public static Builder builder(String grammarId, String languageCode) {
	    return new Builder()
	            .withRequiredParams(grammarId, languageCode);
	}


	public static class Builder {
		private final PatchArchitectGrammarLanguageRequest request;

		private Builder() {
			request = new PatchArchitectGrammarLanguageRequest();
		}


		public Builder withGrammarId(String grammarId) {
			request.setGrammarId(grammarId);
			return this;
		}
		...
		public Builder withBody(GrammarLanguageUpdate body) {
		...
		public PatchArchitectGrammarLanguageRequest build() {
            
            // verify the required parameter 'grammarId' is set
            if (request.grammarId == null) {
                throw new IllegalStateException("Missing the required parameter 'grammarId' when building request for PatchArchitectGrammarLanguageRequest.");
            }
