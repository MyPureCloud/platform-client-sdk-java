...
public class DeleteTelephonyProvidersEdgesSiteRequest {
	...
	public DeleteTelephonyProvidersEdgesSiteRequest withSiteId(String siteId) {
    ...
    public DeleteTelephonyProvidersEdgesSiteRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.siteId == null) {
            throw new IllegalStateException("Missing the required parameter 'siteId' when building request for DeleteTelephonyProvidersEdgesSiteRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/telephony/providers/edges/sites/{siteId}")
	...
	public static class Builder {
		private final DeleteTelephonyProvidersEdgesSiteRequest request;

		private Builder() {
			request = new DeleteTelephonyProvidersEdgesSiteRequest();
		}
		...
		public DeleteTelephonyProvidersEdgesSiteRequest build() {
