...
public class GetExternalcontactsImportSettingsRequest {
	...
	public GetExternalcontactsImportSettingsRequest withAfter(String after) {
	    this.setAfter(after);
	    return this;
	} 
	...
	public GetExternalcontactsImportSettingsRequest withPageSize(String pageSize) {
	...
	public GetExternalcontactsImportSettingsRequest withSortOrder(String sortOrder) {
	...
	public GetExternalcontactsImportSettingsRequest withName(String name) {
	    this.setName(name);
	    return this;
	} 
    ...
    public GetExternalcontactsImportSettingsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/externalcontacts/import/settings")
	...
	public static class Builder {
		private final GetExternalcontactsImportSettingsRequest request;

		private Builder() {
			request = new GetExternalcontactsImportSettingsRequest();
		}
		...
		public GetExternalcontactsImportSettingsRequest build() {
