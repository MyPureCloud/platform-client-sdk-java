...
public class PostExternalcontactsExternalsourcesRequest {
	...
	public PostExternalcontactsExternalsourcesRequest withBody(ExternalSource body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostExternalcontactsExternalsourcesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<ExternalSource> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostExternalcontactsExternalsourcesRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/externalcontacts/externalsources")
                .withBody(body)
	...
	public static Builder builder(ExternalSource body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostExternalcontactsExternalsourcesRequest request;

		private Builder() {
			request = new PostExternalcontactsExternalsourcesRequest();
		}
		...
		public Builder withRequiredParams(ExternalSource body) {
			request.setBody(body);
		...
		public PostExternalcontactsExternalsourcesRequest build() {
