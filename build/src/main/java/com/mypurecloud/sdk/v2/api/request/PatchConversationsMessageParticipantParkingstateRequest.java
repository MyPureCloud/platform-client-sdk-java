...
public class PatchConversationsMessageParticipantParkingstateRequest {
	...
	public PatchConversationsMessageParticipantParkingstateRequest withBody(ParkingStateRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public ApiRequest<ParkingStateRequest> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PatchConversationsMessageParticipantParkingstateRequest.");
        }
        
        // verify the required parameter 'participantId' is set
        if (this.participantId == null) {
            throw new IllegalStateException("Missing the required parameter 'participantId' when building request for PatchConversationsMessageParticipantParkingstateRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchConversationsMessageParticipantParkingstateRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/conversations/messages/{conversationId}/participants/{participantId}/parkingstate")
	...
	public static class Builder {
		private final PatchConversationsMessageParticipantParkingstateRequest request;

		private Builder() {
			request = new PatchConversationsMessageParticipantParkingstateRequest();
		}
		...
		public PatchConversationsMessageParticipantParkingstateRequest build() {
