...
public class GetWorkforcemanagementBusinessunitWeekShorttermforecastGenerationresultsRequest {
	...
	public GetWorkforcemanagementBusinessunitWeekShorttermforecastGenerationresultsRequest withBusinessUnitId(String businessUnitId) {
	...
	public GetWorkforcemanagementBusinessunitWeekShorttermforecastGenerationresultsRequest withWeekDateId(LocalDate weekDateId) {
	...
	public GetWorkforcemanagementBusinessunitWeekShorttermforecastGenerationresultsRequest withForecastId(String forecastId) {
    ...
    public GetWorkforcemanagementBusinessunitWeekShorttermforecastGenerationresultsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for GetWorkforcemanagementBusinessunitWeekShorttermforecastGenerationresultsRequest.");
        }
        
        // verify the required parameter 'weekDateId' is set
        if (this.weekDateId == null) {
            throw new IllegalStateException("Missing the required parameter 'weekDateId' when building request for GetWorkforcemanagementBusinessunitWeekShorttermforecastGenerationresultsRequest.");
        }
        
        // verify the required parameter 'forecastId' is set
        if (this.forecastId == null) {
            throw new IllegalStateException("Missing the required parameter 'forecastId' when building request for GetWorkforcemanagementBusinessunitWeekShorttermforecastGenerationresultsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/weeks/{weekDateId}/shorttermforecasts/{forecastId}/generationresults")
	...
	public static class Builder {
		private final GetWorkforcemanagementBusinessunitWeekShorttermforecastGenerationresultsRequest request;

		private Builder() {
			request = new GetWorkforcemanagementBusinessunitWeekShorttermforecastGenerationresultsRequest();
		}
		...
		public GetWorkforcemanagementBusinessunitWeekShorttermforecastGenerationresultsRequest build() {
