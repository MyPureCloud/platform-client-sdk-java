...
public class GetKnowledgeSourceSynchronizationDeletionsRequest {
	...
	public GetKnowledgeSourceSynchronizationDeletionsRequest withSourceId(String sourceId) {
	...
	public GetKnowledgeSourceSynchronizationDeletionsRequest withSynchronizationId(String synchronizationId) {
	...
	public GetKnowledgeSourceSynchronizationDeletionsRequest withBefore(String before) {
	...
	public GetKnowledgeSourceSynchronizationDeletionsRequest withAfter(String after) {
	    this.setAfter(after);
	    return this;
	} 
	...
	public GetKnowledgeSourceSynchronizationDeletionsRequest withPageSize(String pageSize) {
    ...
    public GetKnowledgeSourceSynchronizationDeletionsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.sourceId == null) {
            throw new IllegalStateException("Missing the required parameter 'sourceId' when building request for GetKnowledgeSourceSynchronizationDeletionsRequest.");
        }
        
        // verify the required parameter 'synchronizationId' is set
        if (this.synchronizationId == null) {
            throw new IllegalStateException("Missing the required parameter 'synchronizationId' when building request for GetKnowledgeSourceSynchronizationDeletionsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/knowledge/sources/{sourceId}/synchronizations/{synchronizationId}/deletions")
	...
	public static class Builder {
		private final GetKnowledgeSourceSynchronizationDeletionsRequest request;

		private Builder() {
			request = new GetKnowledgeSourceSynchronizationDeletionsRequest();
		}
		...
		public GetKnowledgeSourceSynchronizationDeletionsRequest build() {
