...
public class GetRoutingPredictorModelsRequest {
	...
	public GetRoutingPredictorModelsRequest withPredictorId(String predictorId) {
    ...
    public GetRoutingPredictorModelsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.predictorId == null) {
            throw new IllegalStateException("Missing the required parameter 'predictorId' when building request for GetRoutingPredictorModelsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/routing/predictors/{predictorId}/models")
	...
	public static class Builder {
		private final GetRoutingPredictorModelsRequest request;

		private Builder() {
			request = new GetRoutingPredictorModelsRequest();
		}
		...
		public GetRoutingPredictorModelsRequest build() {
