...
public class PostCasemanagementCaseplansRequest {

	private CaseplanCreate body;
	public CaseplanCreate getBody() {
		return this.body;
	}

	public void setBody(CaseplanCreate body) {
		this.body = body;
	}

	public PostCasemanagementCaseplansRequest withBody(CaseplanCreate body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostCasemanagementCaseplansRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<CaseplanCreate> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostCasemanagementCaseplansRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/casemanagement/caseplans")
                .withBody(body)
	...
	public static Builder builder(CaseplanCreate body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostCasemanagementCaseplansRequest request;

		private Builder() {
			request = new PostCasemanagementCaseplansRequest();
		}


		public Builder withBody(CaseplanCreate body) {
		...
		public Builder withRequiredParams(CaseplanCreate body) {
			request.setBody(body);
		...
		public PostCasemanagementCaseplansRequest build() {
