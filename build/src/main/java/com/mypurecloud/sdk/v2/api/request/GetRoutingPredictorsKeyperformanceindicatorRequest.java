...
public class GetRoutingPredictorsKeyperformanceindicatorRequest {
	...
	public GetRoutingPredictorsKeyperformanceindicatorRequest withKpiId(String kpiId) {
	    this.setKpiId(kpiId);
	    return this;
	} 
	...
	public GetRoutingPredictorsKeyperformanceindicatorRequest withExpand(List<String> expand) {
    ...
    public GetRoutingPredictorsKeyperformanceindicatorRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.kpiId == null) {
            throw new IllegalStateException("Missing the required parameter 'kpiId' when building request for GetRoutingPredictorsKeyperformanceindicatorRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/routing/predictors/keyperformanceindicators/{kpiId}")
	...
	public static class Builder {
		private final GetRoutingPredictorsKeyperformanceindicatorRequest request;

		private Builder() {
			request = new GetRoutingPredictorsKeyperformanceindicatorRequest();
		}
		...
		public GetRoutingPredictorsKeyperformanceindicatorRequest build() {
