...
public class DeleteRoutingDirectroutingbackupSettingsMeRequest {
    ...
    public DeleteRoutingDirectroutingbackupSettingsMeRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("DELETE", "/api/v2/routing/directroutingbackup/settings/me")
	...
	public static class Builder {
		private final DeleteRoutingDirectroutingbackupSettingsMeRequest request;

		private Builder() {
			request = new DeleteRoutingDirectroutingbackupSettingsMeRequest();
		}
		...
		public DeleteRoutingDirectroutingbackupSettingsMeRequest build() {
