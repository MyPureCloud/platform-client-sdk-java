...
public class GetFlowsInstancesQuerycapabilitiesRequest {
	...
	public GetFlowsInstancesQuerycapabilitiesRequest withExpand(String expand) {
    ...
    public GetFlowsInstancesQuerycapabilitiesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/flows/instances/querycapabilities")
	...
	public static class Builder {
		private final GetFlowsInstancesQuerycapabilitiesRequest request;

		private Builder() {
			request = new GetFlowsInstancesQuerycapabilitiesRequest();
		}
		...
		public GetFlowsInstancesQuerycapabilitiesRequest build() {
