...
public class GetRecordingsScreensessionsRequest {
	...
	public GetRecordingsScreensessionsRequest withPageSize(Integer pageSize) {
	...
	public GetRecordingsScreensessionsRequest withPageNumber(Integer pageNumber) {
    ...
    public GetRecordingsScreensessionsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/recordings/screensessions")
	...
	public static class Builder {
		private final GetRecordingsScreensessionsRequest request;

		private Builder() {
			request = new GetRecordingsScreensessionsRequest();
		}
