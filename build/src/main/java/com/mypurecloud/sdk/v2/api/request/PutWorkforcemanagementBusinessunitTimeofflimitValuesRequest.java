...
public class PutWorkforcemanagementBusinessunitTimeofflimitValuesRequest {
	...
	public PutWorkforcemanagementBusinessunitTimeofflimitValuesRequest withBusinessUnitId(String businessUnitId) {
	...
	public PutWorkforcemanagementBusinessunitTimeofflimitValuesRequest withTimeOffLimitId(String timeOffLimitId) {
	    this.setTimeOffLimitId(timeOffLimitId);
	    return this;
	} 

	private BuSetTimeOffLimitValuesRequest body;
	public BuSetTimeOffLimitValuesRequest getBody() {
		return this.body;
	}

	public void setBody(BuSetTimeOffLimitValuesRequest body) {
		this.body = body;
	}

	public PutWorkforcemanagementBusinessunitTimeofflimitValuesRequest withBody(BuSetTimeOffLimitValuesRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutWorkforcemanagementBusinessunitTimeofflimitValuesRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<BuSetTimeOffLimitValuesRequest> withHttpInfo() {
        
        // verify the required parameter 'businessUnitId' is set
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PutWorkforcemanagementBusinessunitTimeofflimitValuesRequest.");
        }
	...
	public static class Builder {
		private final PutWorkforcemanagementBusinessunitTimeofflimitValuesRequest request;

		private Builder() {
			request = new PutWorkforcemanagementBusinessunitTimeofflimitValuesRequest();
		}
		...
		public Builder withBody(BuSetTimeOffLimitValuesRequest body) {
		...
		public PutWorkforcemanagementBusinessunitTimeofflimitValuesRequest build() {
