...
public class CredentialTypeListing  implements Serializable, PagedResource<CredentialType> {
  
  private List<CredentialType> entities = null;
  ...
  public CredentialTypeListing() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
      entities = new ArrayList<CredentialType>();
    }
  }
  ...
  /**
   **/
  public CredentialTypeListing entities(List<CredentialType> entities) {
  ...
  public List<CredentialType> getEntities() {
    return entities;
  }
  public void setEntities(List<CredentialType> entities) {
    this.entities = entities;
  }
