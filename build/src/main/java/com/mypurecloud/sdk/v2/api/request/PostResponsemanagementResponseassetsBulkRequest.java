...
public class PostResponsemanagementResponseassetsBulkRequest {

	private ResponseAssetBulkRequest body;
	public ResponseAssetBulkRequest getBody() {
		return this.body;
	}

	public void setBody(ResponseAssetBulkRequest body) {
		this.body = body;
	}

	public PostResponsemanagementResponseassetsBulkRequest withBody(ResponseAssetBulkRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostResponsemanagementResponseassetsBulkRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<ResponseAssetBulkRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostResponsemanagementResponseassetsBulkRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/responsemanagement/responseassets/bulk")
                .withBody(body)
	...
	public static Builder builder(ResponseAssetBulkRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostResponsemanagementResponseassetsBulkRequest request;

		private Builder() {
			request = new PostResponsemanagementResponseassetsBulkRequest();
		}


		public Builder withBody(ResponseAssetBulkRequest body) {
		...
		public Builder withRequiredParams(ResponseAssetBulkRequest body) {
			request.setBody(body);
		...
		public PostResponsemanagementResponseassetsBulkRequest build() {
