...
public class PatchConversationsCallParticipantRequest {
    ...
    public ApiRequest<MediaParticipantRequest> withHttpInfo() throws ApiException {
        ...
        if (this.callId == null) {
            throw new ApiException(400, "Missing the required parameter 'callId' when building request for PatchConversationsCallParticipantRequest.");
        }
        
        // verify the required parameter 'participantId' is set
        if (this.participantId == null) {
            throw new ApiException(400, "Missing the required parameter 'participantId' when building request for PatchConversationsCallParticipantRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new ApiException(400, "Missing the required parameter 'body' when building request for PatchConversationsCallParticipantRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/conversations/calls/{callId}/participants/{participantId}")
	...
	public static class Builder {
		private final PatchConversationsCallParticipantRequest request;

		private Builder() {
			request = new PatchConversationsCallParticipantRequest();
		}
