...
public class GetRoutingPredictorsKeyperformanceindicatorsRequest {
	...
	public GetRoutingPredictorsKeyperformanceindicatorsRequest withExpand(List<String> expand) {
    ...
    public GetRoutingPredictorsKeyperformanceindicatorsRequest withCustomHeader(String name, String value) {
	...
	public static class Builder {
		private final GetRoutingPredictorsKeyperformanceindicatorsRequest request;
		...
		public GetRoutingPredictorsKeyperformanceindicatorsRequest build() {
