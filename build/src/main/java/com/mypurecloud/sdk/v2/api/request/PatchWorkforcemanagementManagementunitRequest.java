...
public class PatchWorkforcemanagementManagementunitRequest {
	...
	public void setBody(UpdateManagementUnitRequest body) {
		this.body = body;
	}

	public PatchWorkforcemanagementManagementunitRequest withBody(UpdateManagementUnitRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchWorkforcemanagementManagementunitRequest withCustomHeader(String name, String value) {
	...
	public static class Builder {
		...
		private Builder() {
			request = new PatchWorkforcemanagementManagementunitRequest();
		}
		...
		public Builder withBody(UpdateManagementUnitRequest body) {
