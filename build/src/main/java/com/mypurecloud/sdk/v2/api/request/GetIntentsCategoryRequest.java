...
public class GetIntentsCategoryRequest {
	...
	public GetIntentsCategoryRequest withCategoryId(String categoryId) {
    ...
    public GetIntentsCategoryRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.categoryId == null) {
            throw new IllegalStateException("Missing the required parameter 'categoryId' when building request for GetIntentsCategoryRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/intents/categories/{categoryId}")
	...
	public static class Builder {
		private final GetIntentsCategoryRequest request;

		private Builder() {
			request = new GetIntentsCategoryRequest();
		}
		...
		public GetIntentsCategoryRequest build() {
