...
public class DeleteWorkforcemanagementBusinessunitTimeofflimitRequest {
	...
	public DeleteWorkforcemanagementBusinessunitTimeofflimitRequest withBusinessUnitId(String businessUnitId) {
	...
	public DeleteWorkforcemanagementBusinessunitTimeofflimitRequest withTimeOffLimitId(String timeOffLimitId) {
    ...
    public DeleteWorkforcemanagementBusinessunitTimeofflimitRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for DeleteWorkforcemanagementBusinessunitTimeofflimitRequest.");
        }
        
        // verify the required parameter 'timeOffLimitId' is set
        if (this.timeOffLimitId == null) {
            throw new IllegalStateException("Missing the required parameter 'timeOffLimitId' when building request for DeleteWorkforcemanagementBusinessunitTimeofflimitRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/timeofflimits/{timeOffLimitId}")
	...
	public static class Builder {
		private final DeleteWorkforcemanagementBusinessunitTimeofflimitRequest request;

		private Builder() {
			request = new DeleteWorkforcemanagementBusinessunitTimeofflimitRequest();
		}
		...
		public DeleteWorkforcemanagementBusinessunitTimeofflimitRequest build() {
