...
public class GetOutboundContactlistExportRequest {
	...
	public GetOutboundContactlistExportRequest withContactListId(String contactListId) {
	...
	public GetOutboundContactlistExportRequest withDownload(String download) {
    ...
    public GetOutboundContactlistExportRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.contactListId == null) {
            throw new IllegalStateException("Missing the required parameter 'contactListId' when building request for GetOutboundContactlistExportRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/outbound/contactlists/{contactListId}/export")
