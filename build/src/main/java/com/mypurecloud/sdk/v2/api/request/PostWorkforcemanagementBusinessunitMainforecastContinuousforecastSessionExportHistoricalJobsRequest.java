...
public class PostWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionExportHistoricalJobsRequest {
	...
	public PostWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionExportHistoricalJobsRequest withBusinessUnitId(String businessUnitId) {
	    this.setBusinessUnitId(businessUnitId);
	    return this;
	} 

	private AggregatedExportJobRequest body;
	public AggregatedExportJobRequest getBody() {
		return this.body;
	}

	public void setBody(AggregatedExportJobRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionExportHistoricalJobsRequest withBody(AggregatedExportJobRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionExportHistoricalJobsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<AggregatedExportJobRequest> withHttpInfo() {
        
        // verify the required parameter 'businessUnitId' is set
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PostWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionExportHistoricalJobsRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionExportHistoricalJobsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/mainforecast/continuousforecast/session/export/historical/jobs")
	...
	public static Builder builder(String businessUnitId, AggregatedExportJobRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionExportHistoricalJobsRequest request;

		private Builder() {
			request = new PostWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionExportHistoricalJobsRequest();
		}
		...
		public Builder withBody(AggregatedExportJobRequest body) {
		...
		public Builder withRequiredParams(String businessUnitId, AggregatedExportJobRequest body) {
			request.setBusinessUnitId(businessUnitId);
			request.setBody(body);
		...
		public PostWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionExportHistoricalJobsRequest build() {
