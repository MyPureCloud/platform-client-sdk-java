...
public class PutExternalcontactsImportSettingRequest {
	...
	public PutExternalcontactsImportSettingRequest withSettingsId(String settingsId) {
	    this.setSettingsId(settingsId);
	    return this;
	} 

	private ContactImportSettings body;
	public ContactImportSettings getBody() {
		return this.body;
	}

	public void setBody(ContactImportSettings body) {
		this.body = body;
	}

	public PutExternalcontactsImportSettingRequest withBody(ContactImportSettings body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutExternalcontactsImportSettingRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<ContactImportSettings> withHttpInfo() {
        
        // verify the required parameter 'settingsId' is set
        if (this.settingsId == null) {
            throw new IllegalStateException("Missing the required parameter 'settingsId' when building request for PutExternalcontactsImportSettingRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutExternalcontactsImportSettingRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/externalcontacts/import/settings/{settingsId}")
	...
	public static Builder builder(String settingsId, ContactImportSettings body) {
	    return new Builder()
	...
	public static class Builder {
		private final PutExternalcontactsImportSettingRequest request;

		private Builder() {
			request = new PutExternalcontactsImportSettingRequest();
		}
		...
		public Builder withBody(ContactImportSettings body) {
		...
		public Builder withRequiredParams(String settingsId, ContactImportSettings body) {
			request.setSettingsId(settingsId);
			request.setBody(body);
		...
		public PutExternalcontactsImportSettingRequest build() {
