...
public class GetExternalcontactsRelationshipsExportRequest {
	...
	public GetExternalcontactsRelationshipsExportRequest withExportId(String exportId) {
    ...
    public GetExternalcontactsRelationshipsExportRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.exportId == null) {
            throw new IllegalStateException("Missing the required parameter 'exportId' when building request for GetExternalcontactsRelationshipsExportRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/externalcontacts/relationships/exports/{exportId}")
	...
	public static class Builder {
		private final GetExternalcontactsRelationshipsExportRequest request;

		private Builder() {
			request = new GetExternalcontactsRelationshipsExportRequest();
		}
		...
		public GetExternalcontactsRelationshipsExportRequest build() {
