...
public class DeleteOutboundCallabletimesetRequest {
	...
	public DeleteOutboundCallabletimesetRequest withCallableTimeSetId(String callableTimeSetId) {
    ...
    public DeleteOutboundCallabletimesetRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() throws ApiException {
        ...
        if (this.callableTimeSetId == null) {
            throw new ApiException(400, "Missing the required parameter 'callableTimeSetId' when building request for DeleteOutboundCallabletimesetRequest.");
        }
