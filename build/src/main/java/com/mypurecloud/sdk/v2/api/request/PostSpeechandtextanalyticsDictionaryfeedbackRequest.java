...
public class PostSpeechandtextanalyticsDictionaryfeedbackRequest {
	...
	public PostSpeechandtextanalyticsDictionaryfeedbackRequest withBody(DictionaryFeedback body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public ApiRequest<DictionaryFeedback> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostSpeechandtextanalyticsDictionaryfeedbackRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/speechandtextanalytics/dictionaryfeedback")
                .withBody(body)
	...
	public static Builder builder(DictionaryFeedback body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostSpeechandtextanalyticsDictionaryfeedbackRequest request;

		private Builder() {
			request = new PostSpeechandtextanalyticsDictionaryfeedbackRequest();
		}
		...
		public Builder withRequiredParams(DictionaryFeedback body) {
			request.setBody(body);
		...
		public PostSpeechandtextanalyticsDictionaryfeedbackRequest build() {
