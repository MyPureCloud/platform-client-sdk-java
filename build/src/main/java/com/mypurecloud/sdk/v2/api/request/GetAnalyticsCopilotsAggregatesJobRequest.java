...
public class GetAnalyticsCopilotsAggregatesJobRequest {
	...
	public GetAnalyticsCopilotsAggregatesJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetAnalyticsCopilotsAggregatesJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetAnalyticsCopilotsAggregatesJobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/analytics/copilots/aggregates/jobs/{jobId}")
	...
	public static class Builder {
		private final GetAnalyticsCopilotsAggregatesJobRequest request;

		private Builder() {
			request = new GetAnalyticsCopilotsAggregatesJobRequest();
		}
		...
		public GetAnalyticsCopilotsAggregatesJobRequest build() {
