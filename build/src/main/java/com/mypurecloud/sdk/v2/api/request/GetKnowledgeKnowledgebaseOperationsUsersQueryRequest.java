...
public class GetKnowledgeKnowledgebaseOperationsUsersQueryRequest {
	...
	public GetKnowledgeKnowledgebaseOperationsUsersQueryRequest withKnowledgeBaseId(String knowledgeBaseId) {
    ...
    public GetKnowledgeKnowledgebaseOperationsUsersQueryRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.knowledgeBaseId == null) {
            throw new IllegalStateException("Missing the required parameter 'knowledgeBaseId' when building request for GetKnowledgeKnowledgebaseOperationsUsersQueryRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/operations/users/query")
	...
	public static class Builder {
		private final GetKnowledgeKnowledgebaseOperationsUsersQueryRequest request;

		private Builder() {
			request = new GetKnowledgeKnowledgebaseOperationsUsersQueryRequest();
		}
		...
		public GetKnowledgeKnowledgebaseOperationsUsersQueryRequest build() {
