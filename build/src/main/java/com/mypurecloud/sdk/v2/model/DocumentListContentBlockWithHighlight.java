...
public class DocumentListContentBlockWithHighlight  implements Serializable {
 ...
 @JsonDeserialize(using = TypeEnumDeserializer.class)
  ...
  public DocumentListContentBlockWithHighlight() {
   ...
   * The type of the list block.
   **/
  public DocumentListContentBlockWithHighlight type(TypeEnum type) {
    this.type = type;
    return this;
  }
   ...
   **/
  public DocumentListContentBlockWithHighlight text(DocumentText text) {
    this.text = text;
    return this;
  }
   ...
   **/
  public DocumentListContentBlockWithHighlight image(DocumentBodyImage image) {
    this.image = image;
    return this;
  }
   ...
   **/
  public DocumentListContentBlockWithHighlight video(DocumentBodyVideo video) {
    this.video = video;
    return this;
  }
   ...
   **/
  public DocumentListContentBlockWithHighlight list(DocumentBodyListWithHighlight list) {
    this.list = list;
    return this;
  }
   ...
   **/
  public DocumentListContentBlockWithHighlight answerHighlight(DocumentContentHighlightIndex answerHighlight) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DocumentListContentBlockWithHighlight documentListContentBlockWithHighlight = (DocumentListContentBlockWithHighlight) o;

    return Objects.equals(this.type, documentListContentBlockWithHighlight.type) &&
            Objects.equals(this.text, documentListContentBlockWithHighlight.text) &&
            Objects.equals(this.image, documentListContentBlockWithHighlight.image) &&
            Objects.equals(this.video, documentListContentBlockWithHighlight.video) &&
            Objects.equals(this.list, documentListContentBlockWithHighlight.list) &&
            Objects.equals(this.answerHighlight, documentListContentBlockWithHighlight.answerHighlight);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, text, image, video, list, answerHighlight);
  }
