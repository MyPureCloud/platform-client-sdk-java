...
public class GetAlertingRoutingstatusAlertsRequest {
	...
	public GetAlertingRoutingstatusAlertsRequest withExpand(List<String> expand) {
    ...
    public GetAlertingRoutingstatusAlertsRequest withCustomHeader(String name, String value) {
