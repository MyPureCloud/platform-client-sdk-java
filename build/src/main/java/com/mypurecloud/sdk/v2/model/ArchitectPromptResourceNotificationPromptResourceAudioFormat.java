...
public class ArchitectPromptResourceNotificationPromptResourceAudioFormat  implements Serializable {
 ...
 @JsonDeserialize(using = EncodingEnumDeserializer.class)
  ...
  public ArchitectPromptResourceNotificationPromptResourceAudioFormat() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
    }
  }

  public ArchitectPromptResourceNotificationPromptResourceAudioFormat(Boolean initWithEmptyList) {
   ...
   **/
  public ArchitectPromptResourceNotificationPromptResourceAudioFormat channels(Long channels) {
   ...
   **/
  public ArchitectPromptResourceNotificationPromptResourceAudioFormat bitsPerSample(Long bitsPerSample) {
   ...
   **/
  public ArchitectPromptResourceNotificationPromptResourceAudioFormat sampleRate(Long sampleRate) {
   ...
   * Audio encoding format.
   **/
  public ArchitectPromptResourceNotificationPromptResourceAudioFormat encoding(EncodingEnum encoding) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ArchitectPromptResourceNotificationPromptResourceAudioFormat architectPromptResourceNotificationPromptResourceAudioFormat = (ArchitectPromptResourceNotificationPromptResourceAudioFormat) o;

    return Objects.equals(this.channels, architectPromptResourceNotificationPromptResourceAudioFormat.channels) &&
            Objects.equals(this.bitsPerSample, architectPromptResourceNotificationPromptResourceAudioFormat.bitsPerSample) &&
            Objects.equals(this.sampleRate, architectPromptResourceNotificationPromptResourceAudioFormat.sampleRate) &&
            Objects.equals(this.encoding, architectPromptResourceNotificationPromptResourceAudioFormat.encoding);
  }
  ...
  public String toString() {
    ...
    sb.append("class ArchitectPromptResourceNotificationPromptResourceAudioFormat {\n");
