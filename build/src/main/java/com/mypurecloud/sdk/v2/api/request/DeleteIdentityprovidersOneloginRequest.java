...
public class DeleteIdentityprovidersOneloginRequest {
    ...
    public DeleteIdentityprovidersOneloginRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("DELETE", "/api/v2/identityproviders/onelogin")                .withCustomHeaders(customHeaders)
	...
	public static class Builder {
		private final DeleteIdentityprovidersOneloginRequest request;

		private Builder() {
			request = new DeleteIdentityprovidersOneloginRequest();
		}




		public DeleteIdentityprovidersOneloginRequest build() {
