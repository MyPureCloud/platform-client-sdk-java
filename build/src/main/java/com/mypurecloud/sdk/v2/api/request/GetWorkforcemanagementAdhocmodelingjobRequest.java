...
public class GetWorkforcemanagementAdhocmodelingjobRequest {
	...
	public GetWorkforcemanagementAdhocmodelingjobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetWorkforcemanagementAdhocmodelingjobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetWorkforcemanagementAdhocmodelingjobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/adhocmodelingjobs/{jobId}")
	...
	public static class Builder {
		private final GetWorkforcemanagementAdhocmodelingjobRequest request;

		private Builder() {
			request = new GetWorkforcemanagementAdhocmodelingjobRequest();
		}
		...
		public GetWorkforcemanagementAdhocmodelingjobRequest build() {
