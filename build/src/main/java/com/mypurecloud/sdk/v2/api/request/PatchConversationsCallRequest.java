...
public class PatchConversationsCallRequest {
	...
	public PatchConversationsCallRequest withConversationId(String conversationId) {
    ...
    public ApiRequest<Conversation> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PatchConversationsCallRequest.");
        }
        ...
        return ApiRequestBuilder.create("PATCH", "/api/v2/conversations/calls/{conversationId}")
