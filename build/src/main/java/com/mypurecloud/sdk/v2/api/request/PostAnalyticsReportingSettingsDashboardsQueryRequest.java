...
public class PostAnalyticsReportingSettingsDashboardsQueryRequest {

	private DashboardConfigurationQueryRequest body;
	public DashboardConfigurationQueryRequest getBody() {
		return this.body;
	}

	public void setBody(DashboardConfigurationQueryRequest body) {
		this.body = body;
	}

	public PostAnalyticsReportingSettingsDashboardsQueryRequest withBody(DashboardConfigurationQueryRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostAnalyticsReportingSettingsDashboardsQueryRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<DashboardConfigurationQueryRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostAnalyticsReportingSettingsDashboardsQueryRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/analytics/reporting/settings/dashboards/query")
                .withBody(body)
	...
	public static Builder builder(DashboardConfigurationQueryRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostAnalyticsReportingSettingsDashboardsQueryRequest request;

		private Builder() {
			request = new PostAnalyticsReportingSettingsDashboardsQueryRequest();
		}


		public Builder withBody(DashboardConfigurationQueryRequest body) {
		...
		public Builder withRequiredParams(DashboardConfigurationQueryRequest body) {
			request.setBody(body);
		...
		public PostAnalyticsReportingSettingsDashboardsQueryRequest build() {
