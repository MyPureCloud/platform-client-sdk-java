...
public class GetKnowledgeKnowledgebaseDocumentVersionVariationRequest {
	...
	public GetKnowledgeKnowledgebaseDocumentVersionVariationRequest withKnowledgeBaseId(String knowledgeBaseId) {
	...
	public GetKnowledgeKnowledgebaseDocumentVersionVariationRequest withDocumentId(String documentId) {
	...
	public GetKnowledgeKnowledgebaseDocumentVersionVariationRequest withVersionId(String versionId) {
	...
	public GetKnowledgeKnowledgebaseDocumentVersionVariationRequest withVariationId(String variationId) {
    ...
    public GetKnowledgeKnowledgebaseDocumentVersionVariationRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.knowledgeBaseId == null) {
            throw new IllegalStateException("Missing the required parameter 'knowledgeBaseId' when building request for GetKnowledgeKnowledgebaseDocumentVersionVariationRequest.");
        }
        
        // verify the required parameter 'documentId' is set
        if (this.documentId == null) {
            throw new IllegalStateException("Missing the required parameter 'documentId' when building request for GetKnowledgeKnowledgebaseDocumentVersionVariationRequest.");
        }
        
        // verify the required parameter 'versionId' is set
        if (this.versionId == null) {
            throw new IllegalStateException("Missing the required parameter 'versionId' when building request for GetKnowledgeKnowledgebaseDocumentVersionVariationRequest.");
        }
        
        // verify the required parameter 'variationId' is set
        if (this.variationId == null) {
            throw new IllegalStateException("Missing the required parameter 'variationId' when building request for GetKnowledgeKnowledgebaseDocumentVersionVariationRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/documents/{documentId}/versions/{versionId}/variations/{variationId}")
	...
	public static Builder builder(String knowledgeBaseId, String documentId, String versionId, String variationId) {
	    return new Builder()
	            .withRequiredParams(knowledgeBaseId, documentId, versionId, variationId);
	}


	public static class Builder {
		private final GetKnowledgeKnowledgebaseDocumentVersionVariationRequest request;

		private Builder() {
			request = new GetKnowledgeKnowledgebaseDocumentVersionVariationRequest();
		}
		...
		public Builder withRequiredParams(String knowledgeBaseId, String documentId, String versionId, String variationId) {
			request.setKnowledgeBaseId(knowledgeBaseId);
			request.setDocumentId(documentId);
			request.setVersionId(versionId);
			request.setVariationId(variationId);
		...
		public GetKnowledgeKnowledgebaseDocumentVersionVariationRequest build() {
