...
public class PatchWorkforcemanagementManagementunitWorkplanrotationRequest {
	...
	private UpdateWorkPlanRotationRequest body;
	public UpdateWorkPlanRotationRequest getBody() {
		return this.body;
	}

	public void setBody(UpdateWorkPlanRotationRequest body) {
		this.body = body;
	}
    ...
    public ApiRequest<UpdateWorkPlanRotationRequest> withHttpInfo() {
        
        // verify the required parameter 'managementUnitId' is set
        if (this.managementUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'managementUnitId' when building request for PatchWorkforcemanagementManagementunitWorkplanrotationRequest.");
        }
	...
	public static class Builder {
		private final PatchWorkforcemanagementManagementunitWorkplanrotationRequest request;

		private Builder() {
			request = new PatchWorkforcemanagementManagementunitWorkplanrotationRequest();
		}
		...
		public Builder withBody(UpdateWorkPlanRotationRequest body) {
		...
		public PatchWorkforcemanagementManagementunitWorkplanrotationRequest build() {
