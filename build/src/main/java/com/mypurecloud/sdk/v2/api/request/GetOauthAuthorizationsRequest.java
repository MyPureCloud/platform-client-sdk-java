...
public class GetOauthAuthorizationsRequest {
    ...
    public GetOauthAuthorizationsRequest withCustomHeader(String name, String value) {
	...
	public static class Builder {
		private final GetOauthAuthorizationsRequest request;
		...
		public GetOauthAuthorizationsRequest build() {
