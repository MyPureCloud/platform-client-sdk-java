...
public class Email  implements Serializable {
 ...
 @JsonDeserialize(using = DisconnectTypeEnumDeserializer.class)
  ...
  @ApiModelProperty(example = "null", value = "Represents the time when an email was put into parked state. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss[.mmm]Z")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.state, email.state) &&
            ...
            Objects.equals(this.queueMediaSettings, email.queueMediaSettings) &&
            Objects.equals(this.parkTime, email.parkTime);
  }

  @Override
  public int hashCode() {
    return Objects.hash(state, initialState, id, held, subject, messagesSent, segments, direction, recordingId, errorInfo, disconnectType, startHoldTime, startAlertingTime, connectedTime, disconnectedTime, autoGenerated, provider, scriptId, peerId, messageId, draftAttachments, spam, wrapup, afterCallWork, afterCallWorkRequired, queueMediaSettings, parkTime);
  }
