...
public class PostExternalcontactsImportCsvSettingsRequest {
	...
	public PostExternalcontactsImportCsvSettingsRequest withBody(CsvSettings body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostExternalcontactsImportCsvSettingsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<CsvSettings> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostExternalcontactsImportCsvSettingsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/externalcontacts/import/csv/settings")
                .withBody(body)
	...
	public static Builder builder(CsvSettings body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostExternalcontactsImportCsvSettingsRequest request;

		private Builder() {
			request = new PostExternalcontactsImportCsvSettingsRequest();
		}
		...
		public Builder withRequiredParams(CsvSettings body) {
			request.setBody(body);
		...
		public PostExternalcontactsImportCsvSettingsRequest build() {
