...
public class PostOutboundDnclistsUploadsRequest {

	private DNCListUploadUrlRequest body;
	public DNCListUploadUrlRequest getBody() {
		return this.body;
	}

	public void setBody(DNCListUploadUrlRequest body) {
		this.body = body;
	}

	public PostOutboundDnclistsUploadsRequest withBody(DNCListUploadUrlRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostOutboundDnclistsUploadsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<DNCListUploadUrlRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostOutboundDnclistsUploadsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/outbound/dnclists/uploads")
                .withBody(body)
	...
	public static Builder builder(DNCListUploadUrlRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostOutboundDnclistsUploadsRequest request;

		private Builder() {
			request = new PostOutboundDnclistsUploadsRequest();
		}


		public Builder withBody(DNCListUploadUrlRequest body) {
		...
		public Builder withRequiredParams(DNCListUploadUrlRequest body) {
			request.setBody(body);
		...
		public PostOutboundDnclistsUploadsRequest build() {
