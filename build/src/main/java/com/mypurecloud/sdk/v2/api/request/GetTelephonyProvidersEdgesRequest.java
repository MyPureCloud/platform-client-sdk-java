...
public class GetTelephonyProvidersEdgesRequest {
	...
	public GetTelephonyProvidersEdgesRequest withPageSize(Integer pageSize) {
	...
	public GetTelephonyProvidersEdgesRequest withPageNumber(Integer pageNumber) {
	...
	public GetTelephonyProvidersEdgesRequest withName(String name) {
	    this.setName(name);
	    return this;
	} 
	...
	public GetTelephonyProvidersEdgesRequest withSiteId(String siteId) {
	...
	public GetTelephonyProvidersEdgesRequest withEdgeGroupId(String edgeGroupId) {
	...
	public GetTelephonyProvidersEdgesRequest withSortBy(String sortBy) {
	...
	public GetTelephonyProvidersEdgesRequest withManaged(Boolean managed) {
    ...
    public GetTelephonyProvidersEdgesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/telephony/providers/edges")
                ...
                .withQueryParameters("edgeGroup.id", "", edgeGroupId)
	...
	public static class Builder {
		private final GetTelephonyProvidersEdgesRequest request;

		private Builder() {
			request = new GetTelephonyProvidersEdgesRequest();
		}
		...
		public GetTelephonyProvidersEdgesRequest build() {
