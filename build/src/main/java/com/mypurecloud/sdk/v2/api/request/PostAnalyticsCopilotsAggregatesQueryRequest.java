...
public class PostAnalyticsCopilotsAggregatesQueryRequest {

	private CopilotAggregationQuery body;
	public CopilotAggregationQuery getBody() {
		return this.body;
	}

	public void setBody(CopilotAggregationQuery body) {
		this.body = body;
	}

	public PostAnalyticsCopilotsAggregatesQueryRequest withBody(CopilotAggregationQuery body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostAnalyticsCopilotsAggregatesQueryRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<CopilotAggregationQuery> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostAnalyticsCopilotsAggregatesQueryRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/analytics/copilots/aggregates/query")
                .withBody(body)
	...
	public static Builder builder(CopilotAggregationQuery body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostAnalyticsCopilotsAggregatesQueryRequest request;

		private Builder() {
			request = new PostAnalyticsCopilotsAggregatesQueryRequest();
		}


		public Builder withBody(CopilotAggregationQuery body) {
		...
		public Builder withRequiredParams(CopilotAggregationQuery body) {
			request.setBody(body);
		...
		public PostAnalyticsCopilotsAggregatesQueryRequest build() {
