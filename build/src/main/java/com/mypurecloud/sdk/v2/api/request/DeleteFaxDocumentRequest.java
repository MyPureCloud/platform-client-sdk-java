...
public class DeleteFaxDocumentRequest {
	...
	public DeleteFaxDocumentRequest withDocumentId(String documentId) {
    ...
    public DeleteFaxDocumentRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() throws ApiException {
        ...
        if (this.documentId == null) {
            throw new ApiException(400, "Missing the required parameter 'documentId' when building request for DeleteFaxDocumentRequest.");
        }
