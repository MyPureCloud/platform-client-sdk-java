...
public class PatchConversationsCallbacksRequest {
    
	private PatchCallbackRequest body;
	public PatchCallbackRequest getBody() {
		return this.body;
	}

	public void setBody(PatchCallbackRequest body) {
		this.body = body;
	}

	public PatchConversationsCallbacksRequest withBody(PatchCallbackRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchConversationsCallbacksRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<PatchCallbackRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchConversationsCallbacksRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/conversations/callbacks")
                .withBody(body)
	...
	public static Builder builder(PatchCallbackRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PatchConversationsCallbacksRequest request;

		private Builder() {
			request = new PatchConversationsCallbacksRequest();
		}

		
		public Builder withBody(PatchCallbackRequest body) {
		...
		public Builder withRequiredParams(PatchCallbackRequest body) {
			request.setBody(body);
		...
		public PatchConversationsCallbacksRequest build() {
