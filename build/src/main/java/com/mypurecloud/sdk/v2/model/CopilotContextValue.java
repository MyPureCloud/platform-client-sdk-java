...
public class CopilotContextValue  implements Serializable {
 ...
 @JsonDeserialize(using = TypeEnumDeserializer.class)
  ...
  public CopilotContextValue(Boolean initWithEmptyList) {
   ...
   * Name of the context.
   **/
  public CopilotContextValue name(String name) {
    this.name = name;
    return this;
  }
  
  @ApiModelProperty(example = "null", required = true, value = "Name of the context.")
  @JsonProperty("name")
   ...
   * Type of the context.
   **/
  public CopilotContextValue type(TypeEnum type) {
    this.type = type;
    return this;
  }
  
  @ApiModelProperty(example = "null", required = true, value = "Type of the context.")
  @JsonProperty("type")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CopilotContextValue copilotContextValue = (CopilotContextValue) o;
