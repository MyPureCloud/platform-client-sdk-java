...
public class PostRoutingPredictorsKeyperformanceindicatorsRequest {

	private CreateKpiRequest body;
	public CreateKpiRequest getBody() {
		return this.body;
	}

	public void setBody(CreateKpiRequest body) {
		this.body = body;
	}

	public PostRoutingPredictorsKeyperformanceindicatorsRequest withBody(CreateKpiRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostRoutingPredictorsKeyperformanceindicatorsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<CreateKpiRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostRoutingPredictorsKeyperformanceindicatorsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/routing/predictors/keyperformanceindicators")
                .withBody(body)
	...
	public static Builder builder(CreateKpiRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostRoutingPredictorsKeyperformanceindicatorsRequest request;

		private Builder() {
			request = new PostRoutingPredictorsKeyperformanceindicatorsRequest();
		}


		public Builder withBody(CreateKpiRequest body) {
		...
		public Builder withRequiredParams(CreateKpiRequest body) {
			request.setBody(body);
		...
		public PostRoutingPredictorsKeyperformanceindicatorsRequest build() {
