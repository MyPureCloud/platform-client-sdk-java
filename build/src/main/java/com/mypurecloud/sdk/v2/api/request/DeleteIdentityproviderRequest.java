...
public class DeleteIdentityproviderRequest {
	...
	public DeleteIdentityproviderRequest withProviderId(String providerId) {
    ...
    public DeleteIdentityproviderRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.providerId == null) {
            throw new IllegalStateException("Missing the required parameter 'providerId' when building request for DeleteIdentityproviderRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/identityproviders/{providerId}")
	...
	public static class Builder {
		private final DeleteIdentityproviderRequest request;
