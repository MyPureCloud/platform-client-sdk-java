...
public class PostConversationsMessagingSettingsRequest {
	...
	public PostConversationsMessagingSettingsRequest withBody(MessagingSettingRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostConversationsMessagingSettingsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<MessagingSettingRequest> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostConversationsMessagingSettingsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/conversations/messaging/settings")
                .withBody(body)
	...
	public static class Builder {
		private final PostConversationsMessagingSettingsRequest request;

		private Builder() {
			request = new PostConversationsMessagingSettingsRequest();
		}
		...
		public PostConversationsMessagingSettingsRequest build() {
