...
public class PostJourneyViewsEncodingsValidateRequest {

	private List<Label> body;
	public List<Label> getBody() {
		return this.body;
	}

	public void setBody(List<Label> body) {
		this.body = body;
	}

	public PostJourneyViewsEncodingsValidateRequest withBody(List<Label> body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostJourneyViewsEncodingsValidateRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<List<Label>> withHttpInfo() {
        

        return ApiRequestBuilder.create("POST", "/api/v2/journey/views/encodings/validate")
                .withBody(body)
	...
	public static class Builder {
		private final PostJourneyViewsEncodingsValidateRequest request;

		private Builder() {
			request = new PostJourneyViewsEncodingsValidateRequest();
		}


		public Builder withBody(List<Label> body) {
		...
		public PostJourneyViewsEncodingsValidateRequest build() {
