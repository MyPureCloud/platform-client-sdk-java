...
public class GetConversationsMessagingIntegrationsFacebookRequest {
	...
	public GetConversationsMessagingIntegrationsFacebookRequest withPageSize(Integer pageSize) {
	...
	public GetConversationsMessagingIntegrationsFacebookRequest withPageNumber(Integer pageNumber) {
	...
	public GetConversationsMessagingIntegrationsFacebookRequest withExpand(String expand) {
	...
	public GetConversationsMessagingIntegrationsFacebookRequest withSupportedContentId(String supportedContentId) {
    ...
    public GetConversationsMessagingIntegrationsFacebookRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/conversations/messaging/integrations/facebook")
	...
	public static class Builder {
		private final GetConversationsMessagingIntegrationsFacebookRequest request;

		private Builder() {
			request = new GetConversationsMessagingIntegrationsFacebookRequest();
		}
		...
		public GetConversationsMessagingIntegrationsFacebookRequest build() {
