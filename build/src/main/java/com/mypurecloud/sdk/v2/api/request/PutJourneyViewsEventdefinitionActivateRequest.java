...
public class PutJourneyViewsEventdefinitionActivateRequest {
	...
	public PutJourneyViewsEventdefinitionActivateRequest withEventDefinitionId(String eventDefinitionId) {
	    this.setEventDefinitionId(eventDefinitionId);
	    return this;
	} 

	private ActivateExternalEventRequest body;
	public ActivateExternalEventRequest getBody() {
		return this.body;
	}

	public void setBody(ActivateExternalEventRequest body) {
		this.body = body;
	}

	public PutJourneyViewsEventdefinitionActivateRequest withBody(ActivateExternalEventRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutJourneyViewsEventdefinitionActivateRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<ActivateExternalEventRequest> withHttpInfo() {
        
        // verify the required parameter 'eventDefinitionId' is set
        if (this.eventDefinitionId == null) {
            throw new IllegalStateException("Missing the required parameter 'eventDefinitionId' when building request for PutJourneyViewsEventdefinitionActivateRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/journey/views/eventdefinitions/{eventDefinitionId}/activate")
	...
	public static class Builder {
		private final PutJourneyViewsEventdefinitionActivateRequest request;

		private Builder() {
			request = new PutJourneyViewsEventdefinitionActivateRequest();
		}
		...
		public Builder withBody(ActivateExternalEventRequest body) {
		...
		public PutJourneyViewsEventdefinitionActivateRequest build() {
