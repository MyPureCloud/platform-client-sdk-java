...
public class PostRecordingsDeletionprotectionRequest {
	...
	public PostRecordingsDeletionprotectionRequest withBody(ConversationDeletionProtectionQuery body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostRecordingsDeletionprotectionRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<ConversationDeletionProtectionQuery> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostRecordingsDeletionprotectionRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/recordings/deletionprotection")
                .withBody(body)
	...
	public static Builder builder(ConversationDeletionProtectionQuery body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostRecordingsDeletionprotectionRequest request;

		private Builder() {
			request = new PostRecordingsDeletionprotectionRequest();
		}
		...
		public Builder withRequiredParams(ConversationDeletionProtectionQuery body) {
			request.setBody(body);
		...
		public PostRecordingsDeletionprotectionRequest build() {
