...
public class PostIntegrationsWorkforcemanagementVendorconnectionRequest {
    
	private VendorConnectionRequest body;
	public VendorConnectionRequest getBody() {
		return this.body;
	}

	public void setBody(VendorConnectionRequest body) {
		this.body = body;
	}

	public PostIntegrationsWorkforcemanagementVendorconnectionRequest withBody(VendorConnectionRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostIntegrationsWorkforcemanagementVendorconnectionRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<VendorConnectionRequest> withHttpInfo() {
        

        return ApiRequestBuilder.create("POST", "/api/v2/integrations/workforcemanagement/vendorconnection")
                .withBody(body)
	...
	public static class Builder {
		private final PostIntegrationsWorkforcemanagementVendorconnectionRequest request;

		private Builder() {
			request = new PostIntegrationsWorkforcemanagementVendorconnectionRequest();
		}

		
		public Builder withBody(VendorConnectionRequest body) {
		...
		public PostIntegrationsWorkforcemanagementVendorconnectionRequest build() {
