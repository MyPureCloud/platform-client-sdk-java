...
public class ContactListingResponse  implements Serializable, PagedResource<DialerContact> {
  ...
  private List<DialerContact> entities = new ArrayList<DialerContact>();
  ...
  @Override
  public int hashCode() {
    return Objects.hash(entities, pageSize, pageNumber, total, contactsCount, nextUri, previousUri, lastUri, firstUri, selfUri, pageCount);
  }
