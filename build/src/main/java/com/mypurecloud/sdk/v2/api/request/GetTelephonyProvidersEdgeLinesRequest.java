...
public class GetTelephonyProvidersEdgeLinesRequest {
	...
	public GetTelephonyProvidersEdgeLinesRequest withEdgeId(String edgeId) {
	...
	public GetTelephonyProvidersEdgeLinesRequest withPageSize(Integer pageSize) {
	...
	public GetTelephonyProvidersEdgeLinesRequest withPageNumber(Integer pageNumber) {
    ...
    public GetTelephonyProvidersEdgeLinesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.edgeId == null) {
            throw new IllegalStateException("Missing the required parameter 'edgeId' when building request for GetTelephonyProvidersEdgeLinesRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/telephony/providers/edges/{edgeId}/lines")
