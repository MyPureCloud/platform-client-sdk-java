...
public class GetExternalcontactsGraphsClusterscansRequest {
	...
	public GetExternalcontactsGraphsClusterscansRequest withLimit(Integer limit) {
	    this.setLimit(limit);
	    return this;
	} 
	...
	public GetExternalcontactsGraphsClusterscansRequest withCursor(String cursor) {
	...
	public GetExternalcontactsGraphsClusterscansRequest withExpand(List<String> expand) {
	    this.setExpand(expand);
	    return this;
	} 

	public enum expandValues { 
		STATISTICS_AGGREGATED("statistics.aggregated");
    ...
    public GetExternalcontactsGraphsClusterscansRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/externalcontacts/graphs/clusterscans")
	...
	public static class Builder {
		private final GetExternalcontactsGraphsClusterscansRequest request;

		private Builder() {
			request = new GetExternalcontactsGraphsClusterscansRequest();
		}
		...
		public GetExternalcontactsGraphsClusterscansRequest build() {
