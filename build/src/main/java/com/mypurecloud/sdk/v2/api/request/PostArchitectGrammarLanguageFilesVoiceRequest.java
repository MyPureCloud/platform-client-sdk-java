...
public class PostArchitectGrammarLanguageFilesVoiceRequest {
    ...
    public ApiRequest<GrammarFileUploadRequest> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("POST", "/api/v2/architect/grammars/{grammarId}/languages/{languageCode}/files/voice")
	...
	public static Builder builder(String grammarId, String languageCode, GrammarFileUploadRequest body) {
	    return new Builder()
	            .withRequiredParams(grammarId, languageCode, body);
	}


	public static class Builder {
		private final PostArchitectGrammarLanguageFilesVoiceRequest request;

		private Builder() {
			request = new PostArchitectGrammarLanguageFilesVoiceRequest();
		}
