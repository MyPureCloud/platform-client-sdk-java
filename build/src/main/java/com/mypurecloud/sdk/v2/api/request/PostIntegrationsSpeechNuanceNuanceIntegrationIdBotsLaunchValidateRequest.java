...
public class PostIntegrationsSpeechNuanceNuanceIntegrationIdBotsLaunchValidateRequest {
	...
	public PostIntegrationsSpeechNuanceNuanceIntegrationIdBotsLaunchValidateRequest withNuanceIntegrationId(String nuanceIntegrationId) {
	...
	public void setSettings(BotExecutionConfiguration settings) {
		this.settings = settings;
	}

	public PostIntegrationsSpeechNuanceNuanceIntegrationIdBotsLaunchValidateRequest withSettings(BotExecutionConfiguration settings) {
    ...
    public PostIntegrationsSpeechNuanceNuanceIntegrationIdBotsLaunchValidateRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<BotExecutionConfiguration> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("POST", "/api/v2/integrations/speech/nuance/{nuanceIntegrationId}/bots/launch/validate")
	...
	public static Builder builder(String nuanceIntegrationId, BotExecutionConfiguration settings) {
	    return new Builder()
	...
	public static class Builder {
		...
		private Builder() {
			request = new PostIntegrationsSpeechNuanceNuanceIntegrationIdBotsLaunchValidateRequest();
		}
		...
		public Builder withSettings(BotExecutionConfiguration settings) {
		...
		public Builder withRequiredParams(String nuanceIntegrationId, BotExecutionConfiguration settings) {
			request.setNuanceIntegrationId(nuanceIntegrationId);
			request.setSettings(settings);
