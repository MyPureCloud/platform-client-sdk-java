...
public class PatchGamificationContestRequest {
	...
	public PatchGamificationContestRequest withContestId(String contestId) {
	    this.setContestId(contestId);
	    return this;
	} 

	private ContestsFinalizeRequest body;
	public ContestsFinalizeRequest getBody() {
		return this.body;
	}

	public void setBody(ContestsFinalizeRequest body) {
		this.body = body;
	}

	public PatchGamificationContestRequest withBody(ContestsFinalizeRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchGamificationContestRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<ContestsFinalizeRequest> withHttpInfo() {
        
        // verify the required parameter 'contestId' is set
        if (this.contestId == null) {
            throw new IllegalStateException("Missing the required parameter 'contestId' when building request for PatchGamificationContestRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchGamificationContestRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/gamification/contests/{contestId}")
	...
	public static Builder builder(String contestId, ContestsFinalizeRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PatchGamificationContestRequest request;

		private Builder() {
			request = new PatchGamificationContestRequest();
		}
		...
		public Builder withBody(ContestsFinalizeRequest body) {
		...
		public Builder withRequiredParams(String contestId, ContestsFinalizeRequest body) {
			request.setContestId(contestId);
			request.setBody(body);
		...
		public PatchGamificationContestRequest build() {
