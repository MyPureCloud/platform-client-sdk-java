...
public class QueueConversationCallEventTopicWrapup  implements Serializable {
  ...
  public QueueConversationCallEventTopicWrapup() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
      tags = new ArrayList<String>();
    }
  }

  public QueueConversationCallEventTopicWrapup(Boolean initWithEmptyList) {
   ...
   **/
  public QueueConversationCallEventTopicWrapup durationSeconds(Long durationSeconds) {
