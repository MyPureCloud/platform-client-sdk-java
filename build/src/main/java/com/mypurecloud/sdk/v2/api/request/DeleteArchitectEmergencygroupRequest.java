...
public class DeleteArchitectEmergencygroupRequest {
	...
	public DeleteArchitectEmergencygroupRequest withEmergencyGroupId(String emergencyGroupId) {
    ...
    public DeleteArchitectEmergencygroupRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.emergencyGroupId == null) {
            throw new IllegalStateException("Missing the required parameter 'emergencyGroupId' when building request for DeleteArchitectEmergencygroupRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/architect/emergencygroups/{emergencyGroupId}")
	...
	public static class Builder {
		private final DeleteArchitectEmergencygroupRequest request;

		private Builder() {
			request = new DeleteArchitectEmergencygroupRequest();
		}
		...
		public DeleteArchitectEmergencygroupRequest build() {
