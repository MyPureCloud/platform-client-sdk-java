...
public class PatchExternalcontactsRelationshipRequest {
	...
	public PatchExternalcontactsRelationshipRequest withRelationshipId(String relationshipId) {
	...
	public PatchExternalcontactsRelationshipRequest withBody(ExternalContactsPatchRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchExternalcontactsRelationshipRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<ExternalContactsPatchRequest> withHttpInfo() {
        ...
        if (this.relationshipId == null) {
            throw new IllegalStateException("Missing the required parameter 'relationshipId' when building request for PatchExternalcontactsRelationshipRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchExternalcontactsRelationshipRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/externalcontacts/relationships/{relationshipId}")
	...
	public static Builder builder(String relationshipId, ExternalContactsPatchRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PatchExternalcontactsRelationshipRequest request;

		private Builder() {
			request = new PatchExternalcontactsRelationshipRequest();
		}
		...
		public Builder withRequiredParams(String relationshipId, ExternalContactsPatchRequest body) {
			request.setRelationshipId(relationshipId);
			request.setBody(body);
		...
		public PatchExternalcontactsRelationshipRequest build() {
