...
public class DeleteTelephonyProvidersEdgesCertificateauthorityRequest {
	...
	public DeleteTelephonyProvidersEdgesCertificateauthorityRequest withCertificateId(String certificateId) {
    ...
    public DeleteTelephonyProvidersEdgesCertificateauthorityRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() throws ApiException {
        ...
        if (this.certificateId == null) {
            throw new ApiException(400, "Missing the required parameter 'certificateId' when building request for DeleteTelephonyProvidersEdgesCertificateauthorityRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/telephony/providers/edges/certificateauthorities/{certificateId}")
	...
	public static class Builder {
		private final DeleteTelephonyProvidersEdgesCertificateauthorityRequest request;

		private Builder() {
			request = new DeleteTelephonyProvidersEdgesCertificateauthorityRequest();
		}
