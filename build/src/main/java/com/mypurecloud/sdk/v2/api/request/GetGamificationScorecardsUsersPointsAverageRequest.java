...
public class GetGamificationScorecardsUsersPointsAverageRequest {
	...
	public GetGamificationScorecardsUsersPointsAverageRequest withFilterType(String filterType) {
	...
	public GetGamificationScorecardsUsersPointsAverageRequest withFilterId(String filterId) {
	...
	public GetGamificationScorecardsUsersPointsAverageRequest withWorkday(LocalDate workday) {
    ...
    public GetGamificationScorecardsUsersPointsAverageRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.filterType == null) {
            throw new IllegalStateException("Missing the required parameter 'filterType' when building request for GetGamificationScorecardsUsersPointsAverageRequest.");
        }
        
        // verify the required parameter 'filterId' is set
        if (this.filterId == null) {
            throw new IllegalStateException("Missing the required parameter 'filterId' when building request for GetGamificationScorecardsUsersPointsAverageRequest.");
        }
        
        // verify the required parameter 'workday' is set
        if (this.workday == null) {
            throw new IllegalStateException("Missing the required parameter 'workday' when building request for GetGamificationScorecardsUsersPointsAverageRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/gamification/scorecards/users/points/average")
	...
	public static class Builder {
		private final GetGamificationScorecardsUsersPointsAverageRequest request;

		private Builder() {
			request = new GetGamificationScorecardsUsersPointsAverageRequest();
		}
		...
		public GetGamificationScorecardsUsersPointsAverageRequest build() {
