...
public class PostLanguageunderstandingMinerExecuteRequest {
	...
	public PostLanguageunderstandingMinerExecuteRequest withMinerId(String minerId) {
	    this.setMinerId(minerId);
	    return this;
	} 
	
	private MinerExecuteRequest body;
	public MinerExecuteRequest getBody() {
		return this.body;
	}

	public void setBody(MinerExecuteRequest body) {
		this.body = body;
	}

	public PostLanguageunderstandingMinerExecuteRequest withBody(MinerExecuteRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostLanguageunderstandingMinerExecuteRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<MinerExecuteRequest> withHttpInfo() {
        
        // verify the required parameter 'minerId' is set
        if (this.minerId == null) {
            throw new IllegalStateException("Missing the required parameter 'minerId' when building request for PostLanguageunderstandingMinerExecuteRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/languageunderstanding/miners/{minerId}/execute")
	...
	public static class Builder {
		private final PostLanguageunderstandingMinerExecuteRequest request;

		private Builder() {
			request = new PostLanguageunderstandingMinerExecuteRequest();
		}
		...
		public Builder withBody(MinerExecuteRequest body) {
		...
		public PostLanguageunderstandingMinerExecuteRequest build() {
