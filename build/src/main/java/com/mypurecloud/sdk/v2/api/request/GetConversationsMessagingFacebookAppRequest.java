...
public class GetConversationsMessagingFacebookAppRequest {
    ...
    public GetConversationsMessagingFacebookAppRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/conversations/messaging/facebook/app")
	...
	public static class Builder {
		private final GetConversationsMessagingFacebookAppRequest request;

		private Builder() {
			request = new GetConversationsMessagingFacebookAppRequest();
		}
		...
		public GetConversationsMessagingFacebookAppRequest build() {
