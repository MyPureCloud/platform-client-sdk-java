...
public class PostConversationsVideoAgentconferenceCommunicationRequest {
	...
	public PostConversationsVideoAgentconferenceCommunicationRequest withConversationId(String conversationId) {
	...
	public PostConversationsVideoAgentconferenceCommunicationRequest withCommunicationId(String communicationId) {
    ...
    public PostConversationsVideoAgentconferenceCommunicationRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PostConversationsVideoAgentconferenceCommunicationRequest.");
        }
        
        // verify the required parameter 'communicationId' is set
        if (this.communicationId == null) {
            throw new IllegalStateException("Missing the required parameter 'communicationId' when building request for PostConversationsVideoAgentconferenceCommunicationRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/conversations/videos/{conversationId}/agentconference/communications/{communicationId}")
	...
	public static class Builder {
		private final PostConversationsVideoAgentconferenceCommunicationRequest request;

		private Builder() {
			request = new PostConversationsVideoAgentconferenceCommunicationRequest();
		}
		...
		public PostConversationsVideoAgentconferenceCommunicationRequest build() {
