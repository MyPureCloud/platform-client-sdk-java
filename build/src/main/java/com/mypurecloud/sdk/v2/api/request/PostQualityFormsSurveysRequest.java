...
public class PostQualityFormsSurveysRequest {
	...
	public PostQualityFormsSurveysRequest withBody(SurveyForm body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostQualityFormsSurveysRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<SurveyForm> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostQualityFormsSurveysRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/quality/forms/surveys")
                .withBody(body)
	...
	public static Builder builder(SurveyForm body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostQualityFormsSurveysRequest request;

		private Builder() {
			request = new PostQualityFormsSurveysRequest();
		}
		...
		public Builder withRequiredParams(SurveyForm body) {
			request.setBody(body);
		...
		public PostQualityFormsSurveysRequest build() {
