...
public class GetTelephonyProvidersEdgesTimezonesRequest {
	...
	public GetTelephonyProvidersEdgesTimezonesRequest withPageSize(Integer pageSize) {
	...
	public GetTelephonyProvidersEdgesTimezonesRequest withPageNumber(Integer pageNumber) {
    ...
    public GetTelephonyProvidersEdgesTimezonesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/telephony/providers/edges/timezones")
	...
	public static class Builder {
		private final GetTelephonyProvidersEdgesTimezonesRequest request;

		private Builder() {
			request = new GetTelephonyProvidersEdgesTimezonesRequest();
		}
		...
		public GetTelephonyProvidersEdgesTimezonesRequest build() {
