...
public class LearningAssignmentRuleRunTopicLearningModuleReference  implements Serializable {
  
  private String id = null;
  private String name = null;

  public LearningAssignmentRuleRunTopicLearningModuleReference() {
  ...
  /**
   **/
  public LearningAssignmentRuleRunTopicLearningModuleReference id(String id) {
    this.id = id;
    return this;
  }
