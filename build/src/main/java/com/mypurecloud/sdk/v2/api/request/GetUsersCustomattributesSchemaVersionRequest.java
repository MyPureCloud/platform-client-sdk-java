...
public class GetUsersCustomattributesSchemaVersionRequest {
	...
	public GetUsersCustomattributesSchemaVersionRequest withSchemaId(String schemaId) {
	...
	public GetUsersCustomattributesSchemaVersionRequest withVersionId(String versionId) {
    ...
    public GetUsersCustomattributesSchemaVersionRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.schemaId == null) {
            throw new IllegalStateException("Missing the required parameter 'schemaId' when building request for GetUsersCustomattributesSchemaVersionRequest.");
        }
        
        // verify the required parameter 'versionId' is set
        if (this.versionId == null) {
            throw new IllegalStateException("Missing the required parameter 'versionId' when building request for GetUsersCustomattributesSchemaVersionRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/users/customattributes/schemas/{schemaId}/versions/{versionId}")
	...
	public static class Builder {
		private final GetUsersCustomattributesSchemaVersionRequest request;

		private Builder() {
			request = new GetUsersCustomattributesSchemaVersionRequest();
		}
		...
		public GetUsersCustomattributesSchemaVersionRequest build() {
