...
public class PostRoutingEmailOutboundDomainTestconnectionRequest {
	...
	public PostRoutingEmailOutboundDomainTestconnectionRequest withDomainId(String domainId) {
	    this.setDomainId(domainId);
	    return this;
	} 

	private TestMessage body;
	public TestMessage getBody() {
		return this.body;
	}

	public void setBody(TestMessage body) {
		this.body = body;
	}

	public PostRoutingEmailOutboundDomainTestconnectionRequest withBody(TestMessage body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public ApiRequest<TestMessage> withHttpInfo() {
        
        // verify the required parameter 'domainId' is set
        if (this.domainId == null) {
            throw new IllegalStateException("Missing the required parameter 'domainId' when building request for PostRoutingEmailOutboundDomainTestconnectionRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/routing/email/outbound/domains/{domainId}/testconnection")
	...
	public static class Builder {
		private final PostRoutingEmailOutboundDomainTestconnectionRequest request;

		private Builder() {
			request = new PostRoutingEmailOutboundDomainTestconnectionRequest();
		}
		...
		public Builder withBody(TestMessage body) {
		...
		public PostRoutingEmailOutboundDomainTestconnectionRequest build() {
