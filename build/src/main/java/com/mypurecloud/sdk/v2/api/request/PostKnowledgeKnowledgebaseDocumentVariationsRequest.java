...
public class PostKnowledgeKnowledgebaseDocumentVariationsRequest {
	...
	public PostKnowledgeKnowledgebaseDocumentVariationsRequest withKnowledgeBaseId(String knowledgeBaseId) {
	...
	public PostKnowledgeKnowledgebaseDocumentVariationsRequest withDocumentId(String documentId) {
    ...
    public PostKnowledgeKnowledgebaseDocumentVariationsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<DocumentVariation> withHttpInfo() {
        ...
        if (this.knowledgeBaseId == null) {
            throw new IllegalStateException("Missing the required parameter 'knowledgeBaseId' when building request for PostKnowledgeKnowledgebaseDocumentVariationsRequest.");
        }
        
        // verify the required parameter 'documentId' is set
        if (this.documentId == null) {
            throw new IllegalStateException("Missing the required parameter 'documentId' when building request for PostKnowledgeKnowledgebaseDocumentVariationsRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostKnowledgeKnowledgebaseDocumentVariationsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/documents/{documentId}/variations")
	...
	public static class Builder {
		private final PostKnowledgeKnowledgebaseDocumentVariationsRequest request;

		private Builder() {
			request = new PostKnowledgeKnowledgebaseDocumentVariationsRequest();
		}
		...
		public PostKnowledgeKnowledgebaseDocumentVariationsRequest build() {
