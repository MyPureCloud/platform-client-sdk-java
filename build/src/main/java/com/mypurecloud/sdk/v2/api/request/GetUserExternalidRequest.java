...
public class GetUserExternalidRequest {
	...
	public GetUserExternalidRequest withUserId(String userId) {
    ...
    public GetUserExternalidRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.userId == null) {
            throw new IllegalStateException("Missing the required parameter 'userId' when building request for GetUserExternalidRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/users/{userId}/externalid")
	...
	public static class Builder {
		private final GetUserExternalidRequest request;

		private Builder() {
			request = new GetUserExternalidRequest();
		}
		...
		public GetUserExternalidRequest build() {
