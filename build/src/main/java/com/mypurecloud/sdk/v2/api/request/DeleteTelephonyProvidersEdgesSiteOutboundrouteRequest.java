...
public class DeleteTelephonyProvidersEdgesSiteOutboundrouteRequest {
	...
	public DeleteTelephonyProvidersEdgesSiteOutboundrouteRequest withSiteId(String siteId) {
	...
	public void setOutboundRouteId(String outboundRouteId) {
		this.outboundRouteId = outboundRouteId;
	}

	public DeleteTelephonyProvidersEdgesSiteOutboundrouteRequest withOutboundRouteId(String outboundRouteId) {
	    this.setOutboundRouteId(outboundRouteId);
	    return this;
	} 
    ...
    public DeleteTelephonyProvidersEdgesSiteOutboundrouteRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.siteId == null) {
            throw new IllegalStateException("Missing the required parameter 'siteId' when building request for DeleteTelephonyProvidersEdgesSiteOutboundrouteRequest.");
        }
        
        // verify the required parameter 'outboundRouteId' is set
        if (this.outboundRouteId == null) {
            throw new IllegalStateException("Missing the required parameter 'outboundRouteId' when building request for DeleteTelephonyProvidersEdgesSiteOutboundrouteRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/telephony/providers/edges/sites/{siteId}/outboundroutes/{outboundRouteId}")
	...
	public static Builder builder(String siteId, String outboundRouteId) {
	    return new Builder()
	            .withRequiredParams(siteId, outboundRouteId);
	}
	

	public static class Builder {
		private final DeleteTelephonyProvidersEdgesSiteOutboundrouteRequest request;

		private Builder() {
			request = new DeleteTelephonyProvidersEdgesSiteOutboundrouteRequest();
		}
		...
		public Builder withRequiredParams(String siteId, String outboundRouteId) {
			request.setSiteId(siteId);
						request.setOutboundRouteId(outboundRouteId);
		...
		public DeleteTelephonyProvidersEdgesSiteOutboundrouteRequest build() {
            ...
            // verify the required parameter 'outboundRouteId' is set
            if (request.outboundRouteId == null) {
                throw new IllegalStateException("Missing the required parameter 'outboundRouteId' when building request for DeleteTelephonyProvidersEdgesSiteOutboundrouteRequest.");
            }
