...
public class PostWorkforcemanagementAgentsIntegrationsHrisQueryRequest {

	private QueryAgentsIntegrationsRequest body;
	public QueryAgentsIntegrationsRequest getBody() {
		return this.body;
	}

	public void setBody(QueryAgentsIntegrationsRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementAgentsIntegrationsHrisQueryRequest withBody(QueryAgentsIntegrationsRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementAgentsIntegrationsHrisQueryRequest withCustomHeader(String name, String value) {
	...
	public static class Builder {
		private final PostWorkforcemanagementAgentsIntegrationsHrisQueryRequest request;

		private Builder() {
			request = new PostWorkforcemanagementAgentsIntegrationsHrisQueryRequest();
		}


		public Builder withBody(QueryAgentsIntegrationsRequest body) {
