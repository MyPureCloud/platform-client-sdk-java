...
public class PostConversationsMessageInboundOpenReceiptRequest {
	...
	public PostConversationsMessageInboundOpenReceiptRequest withIntegrationId(String integrationId) {
	    this.setIntegrationId(integrationId);
	    return this;
	} 

	private OpenInboundNormalizedReceipt body;
	public OpenInboundNormalizedReceipt getBody() {
		return this.body;
	}

	public void setBody(OpenInboundNormalizedReceipt body) {
		this.body = body;
	}
    ...
    public ApiRequest<OpenInboundNormalizedReceipt> withHttpInfo() {
        
        // verify the required parameter 'integrationId' is set
        if (this.integrationId == null) {
            throw new IllegalStateException("Missing the required parameter 'integrationId' when building request for PostConversationsMessageInboundOpenReceiptRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostConversationsMessageInboundOpenReceiptRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/conversations/messages/{integrationId}/inbound/open/receipt")
	...
	public static Builder builder(String integrationId, OpenInboundNormalizedReceipt body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostConversationsMessageInboundOpenReceiptRequest request;

		private Builder() {
			request = new PostConversationsMessageInboundOpenReceiptRequest();
		}
		...
		public Builder withBody(OpenInboundNormalizedReceipt body) {
		...
		public Builder withRequiredParams(String integrationId, OpenInboundNormalizedReceipt body) {
			request.setIntegrationId(integrationId);
			request.setBody(body);
		...
		public PostConversationsMessageInboundOpenReceiptRequest build() {
