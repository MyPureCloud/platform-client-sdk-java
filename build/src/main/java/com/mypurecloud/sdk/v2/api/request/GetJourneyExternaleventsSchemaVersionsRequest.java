...
public class GetJourneyExternaleventsSchemaVersionsRequest {
	...
	public GetJourneyExternaleventsSchemaVersionsRequest withSchemaId(String schemaId) {
    ...
    public GetJourneyExternaleventsSchemaVersionsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.schemaId == null) {
            throw new IllegalStateException("Missing the required parameter 'schemaId' when building request for GetJourneyExternaleventsSchemaVersionsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/journey/externalevents/schemas/{schemaId}/versions")
	...
	public static class Builder {
		private final GetJourneyExternaleventsSchemaVersionsRequest request;

		private Builder() {
			request = new GetJourneyExternaleventsSchemaVersionsRequest();
		}
		...
		public GetJourneyExternaleventsSchemaVersionsRequest build() {
