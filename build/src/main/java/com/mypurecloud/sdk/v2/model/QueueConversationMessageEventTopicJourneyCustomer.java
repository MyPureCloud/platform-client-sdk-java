...
public class QueueConversationMessageEventTopicJourneyCustomer  implements Serializable {
  
  private String id = null;
  private String idType = null;

  public QueueConversationMessageEventTopicJourneyCustomer() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
    }
  }

  public QueueConversationMessageEventTopicJourneyCustomer(Boolean initWithEmptyList) {
   ...
   **/
  public QueueConversationMessageEventTopicJourneyCustomer id(String id) {
    this.id = id;
    return this;
  }
   ...
   **/
  public QueueConversationMessageEventTopicJourneyCustomer idType(String idType) {
    this.idType = idType;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    QueueConversationMessageEventTopicJourneyCustomer queueConversationMessageEventTopicJourneyCustomer = (QueueConversationMessageEventTopicJourneyCustomer) o;

    return Objects.equals(this.id, queueConversationMessageEventTopicJourneyCustomer.id) &&
            Objects.equals(this.idType, queueConversationMessageEventTopicJourneyCustomer.idType);
  }
