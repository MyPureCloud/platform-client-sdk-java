...
public class PostBusinessrulesDecisiontableExportsRequest {
	...
	public PostBusinessrulesDecisiontableExportsRequest withTableId(String tableId) {
	    this.setTableId(tableId);
	    return this;
	} 

	private DecisionTableExportJobRequest body;
	public DecisionTableExportJobRequest getBody() {
		return this.body;
	}

	public void setBody(DecisionTableExportJobRequest body) {
		this.body = body;
	}

	public PostBusinessrulesDecisiontableExportsRequest withBody(DecisionTableExportJobRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostBusinessrulesDecisiontableExportsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<DecisionTableExportJobRequest> withHttpInfo() {
        
        // verify the required parameter 'tableId' is set
        if (this.tableId == null) {
            throw new IllegalStateException("Missing the required parameter 'tableId' when building request for PostBusinessrulesDecisiontableExportsRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostBusinessrulesDecisiontableExportsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/businessrules/decisiontables/{tableId}/exports")
	...
	public static Builder builder(String tableId, DecisionTableExportJobRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostBusinessrulesDecisiontableExportsRequest request;

		private Builder() {
			request = new PostBusinessrulesDecisiontableExportsRequest();
		}
		...
		public Builder withBody(DecisionTableExportJobRequest body) {
		...
		public Builder withRequiredParams(String tableId, DecisionTableExportJobRequest body) {
			request.setTableId(tableId);
			request.setBody(body);
		...
		public PostBusinessrulesDecisiontableExportsRequest build() {
