...
public class PostLearningAssignmentsBulkaddRequest {
    
	private List<LearningAssignmentItem> body;
	public List<LearningAssignmentItem> getBody() {
		return this.body;
	}

	public void setBody(List<LearningAssignmentItem> body) {
		this.body = body;
	}

	public PostLearningAssignmentsBulkaddRequest withBody(List<LearningAssignmentItem> body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostLearningAssignmentsBulkaddRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<List<LearningAssignmentItem>> withHttpInfo() {
        

        return ApiRequestBuilder.create("POST", "/api/v2/learning/assignments/bulkadd")
                .withBody(body)
	...
	public static class Builder {
		private final PostLearningAssignmentsBulkaddRequest request;

		private Builder() {
			request = new PostLearningAssignmentsBulkaddRequest();
		}

		
		public Builder withBody(List<LearningAssignmentItem> body) {
		...
		public PostLearningAssignmentsBulkaddRequest build() {
