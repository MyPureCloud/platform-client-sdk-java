...
public class PostAssistantsAgentchecklistsRequest {
	...
	public PostAssistantsAgentchecklistsRequest withBody(AgentChecklist body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostAssistantsAgentchecklistsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<AgentChecklist> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostAssistantsAgentchecklistsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/assistants/agentchecklists")
                .withBody(body)
	...
	public static Builder builder(AgentChecklist body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostAssistantsAgentchecklistsRequest request;

		private Builder() {
			request = new PostAssistantsAgentchecklistsRequest();
		}
		...
		public Builder withRequiredParams(AgentChecklist body) {
			request.setBody(body);
		...
		public PostAssistantsAgentchecklistsRequest build() {
