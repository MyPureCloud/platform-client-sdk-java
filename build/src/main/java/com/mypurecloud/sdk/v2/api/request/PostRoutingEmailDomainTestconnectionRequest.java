...
public class PostRoutingEmailDomainTestconnectionRequest {
	...
	public PostRoutingEmailDomainTestconnectionRequest withDomainId(String domainId) {
	...
	public PostRoutingEmailDomainTestconnectionRequest withBody(TestMessage body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostRoutingEmailDomainTestconnectionRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<TestMessage> withHttpInfo() {
        ...
        if (this.domainId == null) {
            throw new IllegalStateException("Missing the required parameter 'domainId' when building request for PostRoutingEmailDomainTestconnectionRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/routing/email/domains/{domainId}/testconnection")
	...
	public static class Builder {
		private final PostRoutingEmailDomainTestconnectionRequest request;

		private Builder() {
			request = new PostRoutingEmailDomainTestconnectionRequest();
		}
		...
		public PostRoutingEmailDomainTestconnectionRequest build() {
