...
public class PutSpeechandtextanalyticsDictionaryfeedbackDictionaryFeedbackIdRequest {

	private String dictionaryFeedbackId;
	public String getDictionaryFeedbackId() {
		return this.dictionaryFeedbackId;
	}

	public void setDictionaryFeedbackId(String dictionaryFeedbackId) {
		this.dictionaryFeedbackId = dictionaryFeedbackId;
	}
	...
	public PutSpeechandtextanalyticsDictionaryfeedbackDictionaryFeedbackIdRequest withDictionaryFeedbackId(String dictionaryFeedbackId) {
	    this.setDictionaryFeedbackId(dictionaryFeedbackId);
	    return this;
	} 

	private DictionaryFeedback body;
	public DictionaryFeedback getBody() {
		return this.body;
	}

	public void setBody(DictionaryFeedback body) {
		this.body = body;
	}
    ...
    public ApiRequest<DictionaryFeedback> withHttpInfo() {
        
        // verify the required parameter 'dictionaryFeedbackId' is set
        if (this.dictionaryFeedbackId == null) {
            throw new IllegalStateException("Missing the required parameter 'dictionaryFeedbackId' when building request for PutSpeechandtextanalyticsDictionaryfeedbackDictionaryFeedbackIdRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/speechandtextanalytics/dictionaryfeedback/{dictionaryFeedbackId}")
                .withPathParameter("dictionaryFeedbackId", dictionaryFeedbackId)
	...
	public static Builder builder(String dictionaryFeedbackId) {
	    return new Builder()
	            .withRequiredParams(dictionaryFeedbackId);
	}


	public static class Builder {
		private final PutSpeechandtextanalyticsDictionaryfeedbackDictionaryFeedbackIdRequest request;

		private Builder() {
			request = new PutSpeechandtextanalyticsDictionaryfeedbackDictionaryFeedbackIdRequest();
		}


		public Builder withDictionaryFeedbackId(String dictionaryFeedbackId) {
			request.setDictionaryFeedbackId(dictionaryFeedbackId);
			return this;
		}

		public Builder withBody(DictionaryFeedback body) {
		...
		public Builder withRequiredParams(String dictionaryFeedbackId) {
			request.setDictionaryFeedbackId(dictionaryFeedbackId);
		...
		public PutSpeechandtextanalyticsDictionaryfeedbackDictionaryFeedbackIdRequest build() {
            
            // verify the required parameter 'dictionaryFeedbackId' is set
            if (request.dictionaryFeedbackId == null) {
                throw new IllegalStateException("Missing the required parameter 'dictionaryFeedbackId' when building request for PutSpeechandtextanalyticsDictionaryfeedbackDictionaryFeedbackIdRequest.");
            }
