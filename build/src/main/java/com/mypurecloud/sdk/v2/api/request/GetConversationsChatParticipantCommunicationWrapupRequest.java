...
public class GetConversationsChatParticipantCommunicationWrapupRequest {
	...
	public GetConversationsChatParticipantCommunicationWrapupRequest withConversationId(String conversationId) {
	...
	public GetConversationsChatParticipantCommunicationWrapupRequest withParticipantId(String participantId) {
	...
	public GetConversationsChatParticipantCommunicationWrapupRequest withCommunicationId(String communicationId) {
	...
	public GetConversationsChatParticipantCommunicationWrapupRequest withProvisional(Boolean provisional) {
    ...
    public GetConversationsChatParticipantCommunicationWrapupRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for GetConversationsChatParticipantCommunicationWrapupRequest.");
        }
        
        // verify the required parameter 'participantId' is set
        if (this.participantId == null) {
            throw new IllegalStateException("Missing the required parameter 'participantId' when building request for GetConversationsChatParticipantCommunicationWrapupRequest.");
        }
        
        // verify the required parameter 'communicationId' is set
        if (this.communicationId == null) {
            throw new IllegalStateException("Missing the required parameter 'communicationId' when building request for GetConversationsChatParticipantCommunicationWrapupRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/conversations/chats/{conversationId}/participants/{participantId}/communications/{communicationId}/wrapup")
	...
	public static class Builder {
		private final GetConversationsChatParticipantCommunicationWrapupRequest request;

		private Builder() {
			request = new GetConversationsChatParticipantCommunicationWrapupRequest();
		}
		...
		public GetConversationsChatParticipantCommunicationWrapupRequest build() {
