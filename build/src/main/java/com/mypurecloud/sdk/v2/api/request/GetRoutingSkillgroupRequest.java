...
public class GetRoutingSkillgroupRequest {
	...
	public GetRoutingSkillgroupRequest withSkillGroupId(String skillGroupId) {
    ...
    public GetRoutingSkillgroupRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.skillGroupId == null) {
            throw new IllegalStateException("Missing the required parameter 'skillGroupId' when building request for GetRoutingSkillgroupRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/routing/skillgroups/{skillGroupId}")
	...
	public static class Builder {
		private final GetRoutingSkillgroupRequest request;

		private Builder() {
			request = new GetRoutingSkillgroupRequest();
		}
		...
		public GetRoutingSkillgroupRequest build() {
