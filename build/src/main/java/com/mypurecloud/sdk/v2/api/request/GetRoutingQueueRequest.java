...
public class GetRoutingQueueRequest {
	...
	public GetRoutingQueueRequest withQueueId(String queueId) {
    ...
    public GetRoutingQueueRequest withCustomHeader(String name, String value) {
	...
	public static class Builder {
		private final GetRoutingQueueRequest request;

		private Builder() {
			request = new GetRoutingQueueRequest();
		}
		...
		public GetRoutingQueueRequest build() {
