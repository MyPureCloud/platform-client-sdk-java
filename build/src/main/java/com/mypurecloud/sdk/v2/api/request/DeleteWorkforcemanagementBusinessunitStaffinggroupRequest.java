...
public class DeleteWorkforcemanagementBusinessunitStaffinggroupRequest {
	...
	public DeleteWorkforcemanagementBusinessunitStaffinggroupRequest withBusinessUnitId(String businessUnitId) {
	    this.setBusinessUnitId(businessUnitId);
	    return this;
	} 

	private String staffingGroupId;
	...
	public DeleteWorkforcemanagementBusinessunitStaffinggroupRequest withStaffingGroupId(String staffingGroupId) {
	    this.setStaffingGroupId(staffingGroupId);
	    return this;
	} 
    ...
    public DeleteWorkforcemanagementBusinessunitStaffinggroupRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for DeleteWorkforcemanagementBusinessunitStaffinggroupRequest.");
        }
        
        // verify the required parameter 'staffingGroupId' is set
        if (this.staffingGroupId == null) {
            throw new IllegalStateException("Missing the required parameter 'staffingGroupId' when building request for DeleteWorkforcemanagementBusinessunitStaffinggroupRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/staffinggroups/{staffingGroupId}")
                .withPathParameter("businessUnitId", businessUnitId)
        
                .withPathParameter("staffingGroupId", staffingGroupId)
	...
	public static Builder builder(String businessUnitId, String staffingGroupId) {
	    return new Builder()
	            .withRequiredParams(businessUnitId, staffingGroupId);
	}


	public static class Builder {
		private final DeleteWorkforcemanagementBusinessunitStaffinggroupRequest request;

		private Builder() {
			request = new DeleteWorkforcemanagementBusinessunitStaffinggroupRequest();
		}
		...
		public Builder withStaffingGroupId(String staffingGroupId) {
			request.setStaffingGroupId(staffingGroupId);
			return this;
		}



		public Builder withRequiredParams(String businessUnitId, String staffingGroupId) {
			request.setBusinessUnitId(businessUnitId);
			request.setStaffingGroupId(staffingGroupId);
		...
		public DeleteWorkforcemanagementBusinessunitStaffinggroupRequest build() {
            ...
            // verify the required parameter 'staffingGroupId' is set
            if (request.staffingGroupId == null) {
                throw new IllegalStateException("Missing the required parameter 'staffingGroupId' when building request for DeleteWorkforcemanagementBusinessunitStaffinggroupRequest.");
            }
