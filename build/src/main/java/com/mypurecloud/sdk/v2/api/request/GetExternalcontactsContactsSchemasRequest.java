...
public class GetExternalcontactsContactsSchemasRequest {
    ...
    public GetExternalcontactsContactsSchemasRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/externalcontacts/contacts/schemas")
	...
	public static class Builder {
		private final GetExternalcontactsContactsSchemasRequest request;

		private Builder() {
			request = new GetExternalcontactsContactsSchemasRequest();
		}
		...
		public GetExternalcontactsContactsSchemasRequest build() {
