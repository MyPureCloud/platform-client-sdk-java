...
public class GetDependenciesTypeEntityTypeIdEntityIdConnectionsRequiredbyRequest {
	...
	public GetDependenciesTypeEntityTypeIdEntityIdConnectionsRequiredbyRequest withEntityType(String entityType) {
	...
	public GetDependenciesTypeEntityTypeIdEntityIdConnectionsRequiredbyRequest withEntityId(String entityId) {
	...
	public GetDependenciesTypeEntityTypeIdEntityIdConnectionsRequiredbyRequest withPageSize(String pageSize) {
	...
	public GetDependenciesTypeEntityTypeIdEntityIdConnectionsRequiredbyRequest withBeforeSourceType(String beforeSourceType) {
	...
	public GetDependenciesTypeEntityTypeIdEntityIdConnectionsRequiredbyRequest withBeforeSourceId(String beforeSourceId) {
	...
	public GetDependenciesTypeEntityTypeIdEntityIdConnectionsRequiredbyRequest withAfterSourceType(String afterSourceType) {
	...
	public GetDependenciesTypeEntityTypeIdEntityIdConnectionsRequiredbyRequest withAfterSourceId(String afterSourceId) {
    ...
    public GetDependenciesTypeEntityTypeIdEntityIdConnectionsRequiredbyRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.entityType == null) {
            throw new IllegalStateException("Missing the required parameter 'entityType' when building request for GetDependenciesTypeEntityTypeIdEntityIdConnectionsRequiredbyRequest.");
        }
        
        // verify the required parameter 'entityId' is set
        if (this.entityId == null) {
            throw new IllegalStateException("Missing the required parameter 'entityId' when building request for GetDependenciesTypeEntityTypeIdEntityIdConnectionsRequiredbyRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/dependencies/type/{entityType}/id/{entityId}/connections/requiredby")
	...
	public static class Builder {
		private final GetDependenciesTypeEntityTypeIdEntityIdConnectionsRequiredbyRequest request;

		private Builder() {
			request = new GetDependenciesTypeEntityTypeIdEntityIdConnectionsRequiredbyRequest();
		}
		...
		public GetDependenciesTypeEntityTypeIdEntityIdConnectionsRequiredbyRequest build() {
