...
public class GetWorkforcemanagementBusinessunitTimeofflimitGranularityconversionJobsRequest {
	...
	public GetWorkforcemanagementBusinessunitTimeofflimitGranularityconversionJobsRequest withBusinessUnitId(String businessUnitId) {
	...
	public GetWorkforcemanagementBusinessunitTimeofflimitGranularityconversionJobsRequest withTimeOffLimitId(String timeOffLimitId) {
	...
	public GetWorkforcemanagementBusinessunitTimeofflimitGranularityconversionJobsRequest withStatuses(String statuses) {
    ...
    public GetWorkforcemanagementBusinessunitTimeofflimitGranularityconversionJobsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for GetWorkforcemanagementBusinessunitTimeofflimitGranularityconversionJobsRequest.");
        }
        
        // verify the required parameter 'timeOffLimitId' is set
        if (this.timeOffLimitId == null) {
            throw new IllegalStateException("Missing the required parameter 'timeOffLimitId' when building request for GetWorkforcemanagementBusinessunitTimeofflimitGranularityconversionJobsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/timeofflimits/{timeOffLimitId}/granularityconversion/jobs")
	...
	public static class Builder {
		private final GetWorkforcemanagementBusinessunitTimeofflimitGranularityconversionJobsRequest request;

		private Builder() {
			request = new GetWorkforcemanagementBusinessunitTimeofflimitGranularityconversionJobsRequest();
		}
		...
		public Builder withStatuses(statusesValues statuses) {
		    request.setStatuses(statuses.toString());
		...
		public GetWorkforcemanagementBusinessunitTimeofflimitGranularityconversionJobsRequest build() {
