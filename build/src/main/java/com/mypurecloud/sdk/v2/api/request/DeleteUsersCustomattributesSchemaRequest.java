...
public class DeleteUsersCustomattributesSchemaRequest {
	...
	public DeleteUsersCustomattributesSchemaRequest withSchemaId(String schemaId) {
    ...
    public DeleteUsersCustomattributesSchemaRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.schemaId == null) {
            throw new IllegalStateException("Missing the required parameter 'schemaId' when building request for DeleteUsersCustomattributesSchemaRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/users/customattributes/schemas/{schemaId}")
	...
	public static class Builder {
		private final DeleteUsersCustomattributesSchemaRequest request;

		private Builder() {
			request = new DeleteUsersCustomattributesSchemaRequest();
		}
		...
		public DeleteUsersCustomattributesSchemaRequest build() {
