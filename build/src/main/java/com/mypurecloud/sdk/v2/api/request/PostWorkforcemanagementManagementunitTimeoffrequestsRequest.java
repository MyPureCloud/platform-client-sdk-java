...
public class PostWorkforcemanagementManagementunitTimeoffrequestsRequest {
	...
	public PostWorkforcemanagementManagementunitTimeoffrequestsRequest withManagementUnitId(String managementUnitId) {
	    this.setManagementUnitId(managementUnitId);
	    return this;
	} 

	private CreateAdminTimeOffRequest body;
	public CreateAdminTimeOffRequest getBody() {
		return this.body;
	}

	public void setBody(CreateAdminTimeOffRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementManagementunitTimeoffrequestsRequest withBody(CreateAdminTimeOffRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementManagementunitTimeoffrequestsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<CreateAdminTimeOffRequest> withHttpInfo() {
        
        // verify the required parameter 'managementUnitId' is set
        if (this.managementUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'managementUnitId' when building request for PostWorkforcemanagementManagementunitTimeoffrequestsRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementManagementunitTimeoffrequestsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/managementunits/{managementUnitId}/timeoffrequests")
	...
	public static Builder builder(String managementUnitId, CreateAdminTimeOffRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementManagementunitTimeoffrequestsRequest request;

		private Builder() {
			request = new PostWorkforcemanagementManagementunitTimeoffrequestsRequest();
		}
		...
		public Builder withBody(CreateAdminTimeOffRequest body) {
		...
		public Builder withRequiredParams(String managementUnitId, CreateAdminTimeOffRequest body) {
			request.setManagementUnitId(managementUnitId);
			request.setBody(body);
		...
		public PostWorkforcemanagementManagementunitTimeoffrequestsRequest build() {
