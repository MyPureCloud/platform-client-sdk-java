...
public class PatchWorkforcemanagementBusinessunitMinimumstaffingSettingsRequest {
	...
	public PatchWorkforcemanagementBusinessunitMinimumstaffingSettingsRequest withBusinessUnitId(String businessUnitId) {
	    this.setBusinessUnitId(businessUnitId);
	    return this;
	} 

	private MinimumStaffingRequest body;
	public MinimumStaffingRequest getBody() {
		return this.body;
	}

	public void setBody(MinimumStaffingRequest body) {
		this.body = body;
	}

	public PatchWorkforcemanagementBusinessunitMinimumstaffingSettingsRequest withBody(MinimumStaffingRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchWorkforcemanagementBusinessunitMinimumstaffingSettingsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<MinimumStaffingRequest> withHttpInfo() {
        
        // verify the required parameter 'businessUnitId' is set
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PatchWorkforcemanagementBusinessunitMinimumstaffingSettingsRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchWorkforcemanagementBusinessunitMinimumstaffingSettingsRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/minimumstaffing/settings")
	...
	public static Builder builder(String businessUnitId, MinimumStaffingRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PatchWorkforcemanagementBusinessunitMinimumstaffingSettingsRequest request;

		private Builder() {
			request = new PatchWorkforcemanagementBusinessunitMinimumstaffingSettingsRequest();
		}
		...
		public Builder withBody(MinimumStaffingRequest body) {
		...
		public Builder withRequiredParams(String businessUnitId, MinimumStaffingRequest body) {
			request.setBusinessUnitId(businessUnitId);
			request.setBody(body);
		...
		public PatchWorkforcemanagementBusinessunitMinimumstaffingSettingsRequest build() {
