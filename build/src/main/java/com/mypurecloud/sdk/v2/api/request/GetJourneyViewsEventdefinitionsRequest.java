...
public class GetJourneyViewsEventdefinitionsRequest {
    ...
    public GetJourneyViewsEventdefinitionsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/journey/views/eventdefinitions")
	...
	public static class Builder {
		private final GetJourneyViewsEventdefinitionsRequest request;

		private Builder() {
			request = new GetJourneyViewsEventdefinitionsRequest();
		}
		...
		public GetJourneyViewsEventdefinitionsRequest build() {
