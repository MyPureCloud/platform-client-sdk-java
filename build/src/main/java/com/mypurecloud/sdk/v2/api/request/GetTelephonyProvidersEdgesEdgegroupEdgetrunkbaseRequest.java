...
public class GetTelephonyProvidersEdgesEdgegroupEdgetrunkbaseRequest {
	...
	public GetTelephonyProvidersEdgesEdgegroupEdgetrunkbaseRequest withEdgegroupId(String edgegroupId) {
	...
	public GetTelephonyProvidersEdgesEdgegroupEdgetrunkbaseRequest withEdgetrunkbaseId(String edgetrunkbaseId) {
    ...
    public GetTelephonyProvidersEdgesEdgegroupEdgetrunkbaseRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.edgegroupId == null) {
            throw new IllegalStateException("Missing the required parameter 'edgegroupId' when building request for GetTelephonyProvidersEdgesEdgegroupEdgetrunkbaseRequest.");
        }
        
        // verify the required parameter 'edgetrunkbaseId' is set
        if (this.edgetrunkbaseId == null) {
            throw new IllegalStateException("Missing the required parameter 'edgetrunkbaseId' when building request for GetTelephonyProvidersEdgesEdgegroupEdgetrunkbaseRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/telephony/providers/edges/edgegroups/{edgegroupId}/edgetrunkbases/{edgetrunkbaseId}")
	...
	public static Builder builder(String edgegroupId, String edgetrunkbaseId) {
	    return new Builder()
	            .withRequiredParams(edgegroupId, edgetrunkbaseId);
	}
	

	public static class Builder {
		private final GetTelephonyProvidersEdgesEdgegroupEdgetrunkbaseRequest request;

		private Builder() {
			request = new GetTelephonyProvidersEdgesEdgegroupEdgetrunkbaseRequest();
		}
		...
		public Builder withRequiredParams(String edgegroupId, String edgetrunkbaseId) {
			request.setEdgegroupId(edgegroupId);
						request.setEdgetrunkbaseId(edgetrunkbaseId);
		...
		public GetTelephonyProvidersEdgesEdgegroupEdgetrunkbaseRequest build() {
