...
public class GetRoutingQueuesDivisionviewsAllRequest {
	...
	public GetRoutingQueuesDivisionviewsAllRequest withPageSize(Integer pageSize) {
	...
	public GetRoutingQueuesDivisionviewsAllRequest withPageNumber(Integer pageNumber) {
	...
	public GetRoutingQueuesDivisionviewsAllRequest withSortOrder(String sortOrder) {
    ...
    public GetRoutingQueuesDivisionviewsAllRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/routing/queues/divisionviews/all")
	...
	public static class Builder {
		private final GetRoutingQueuesDivisionviewsAllRequest request;

		private Builder() {
			request = new GetRoutingQueuesDivisionviewsAllRequest();
		}
		...
		public GetRoutingQueuesDivisionviewsAllRequest build() {
