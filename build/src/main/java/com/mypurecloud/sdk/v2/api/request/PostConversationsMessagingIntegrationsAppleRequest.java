...
public class PostConversationsMessagingIntegrationsAppleRequest {

	private AppleIntegrationRequest body;
	public AppleIntegrationRequest getBody() {
		return this.body;
	}

	public void setBody(AppleIntegrationRequest body) {
		this.body = body;
	}

	public PostConversationsMessagingIntegrationsAppleRequest withBody(AppleIntegrationRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public ApiRequest<AppleIntegrationRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostConversationsMessagingIntegrationsAppleRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/conversations/messaging/integrations/apple")
                .withBody(body)
	...
	public static Builder builder(AppleIntegrationRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostConversationsMessagingIntegrationsAppleRequest request;

		private Builder() {
			request = new PostConversationsMessagingIntegrationsAppleRequest();
		}


		public Builder withBody(AppleIntegrationRequest body) {
		...
		public Builder withRequiredParams(AppleIntegrationRequest body) {
			request.setBody(body);
		...
		public PostConversationsMessagingIntegrationsAppleRequest build() {
