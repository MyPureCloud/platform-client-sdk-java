...
public class GetContentmanagementWorkspaceDocumentsRequest {
	...
	public GetContentmanagementWorkspaceDocumentsRequest withWorkspaceId(String workspaceId) {
	...
	public GetContentmanagementWorkspaceDocumentsRequest withExpand(List<String> expand) {
	...
	public GetContentmanagementWorkspaceDocumentsRequest withPageSize(Integer pageSize) {
	...
	public GetContentmanagementWorkspaceDocumentsRequest withPageNumber(Integer pageNumber) {
	...
	public GetContentmanagementWorkspaceDocumentsRequest withSortBy(String sortBy) {
	...
	public GetContentmanagementWorkspaceDocumentsRequest withSortOrder(String sortOrder) {
    ...
    public GetContentmanagementWorkspaceDocumentsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.workspaceId == null) {
            throw new IllegalStateException("Missing the required parameter 'workspaceId' when building request for GetContentmanagementWorkspaceDocumentsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/contentmanagement/workspaces/{workspaceId}/documents")
	...
	public static class Builder {
		private final GetContentmanagementWorkspaceDocumentsRequest request;

		private Builder() {
			request = new GetContentmanagementWorkspaceDocumentsRequest();
		}
		...
		public GetContentmanagementWorkspaceDocumentsRequest build() {
