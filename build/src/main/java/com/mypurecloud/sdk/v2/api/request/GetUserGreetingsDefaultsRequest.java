...
public class GetUserGreetingsDefaultsRequest {
	...
	public GetUserGreetingsDefaultsRequest withUserId(String userId) {
    ...
    public GetUserGreetingsDefaultsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.userId == null) {
            throw new IllegalStateException("Missing the required parameter 'userId' when building request for GetUserGreetingsDefaultsRequest.");
        }
