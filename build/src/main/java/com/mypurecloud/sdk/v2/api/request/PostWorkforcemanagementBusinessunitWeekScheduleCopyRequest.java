...
public class PostWorkforcemanagementBusinessunitWeekScheduleCopyRequest {
    ...
    public ApiRequest<BuCopyScheduleRequest> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/weeks/{weekId}/schedules/{scheduleId}/copy")
	...
	public static class Builder {
		...
		private Builder() {
			request = new PostWorkforcemanagementBusinessunitWeekScheduleCopyRequest();
		}
