...
public class TrainingListing  implements Serializable {
  ...
  public TrainingListing() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
      entities = new ArrayList<KnowledgeTraining>();
    }
  }
  ...
  /**
   **/
  public TrainingListing entities(List<KnowledgeTraining> entities) {
  ...
  public List<KnowledgeTraining> getEntities() {
    return entities;
  }
  public void setEntities(List<KnowledgeTraining> entities) {
    this.entities = entities;
  }
