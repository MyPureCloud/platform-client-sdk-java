...
public class HistoryListing  implements Serializable {
 ...
 @JsonDeserialize(using = ActionStatusEnumDeserializer.class)
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, complete, user, client, errorMessage, errorCode, errorDetails, errorMessageParams, actionName, actionStatus, name, description, system, started, completed, entities, pageNumber, total, pageSize, pageCount);
  }
