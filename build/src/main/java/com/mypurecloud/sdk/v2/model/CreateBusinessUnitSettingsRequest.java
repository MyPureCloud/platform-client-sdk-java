...
public class CreateBusinessUnitSettingsRequest  implements Serializable {
 ...
 @JsonDeserialize(using = StartDayOfWeekEnumDeserializer.class)
   ...
   * The start day of week for this business unit
   **/
  public CreateBusinessUnitSettingsRequest startDayOfWeek(StartDayOfWeekEnum startDayOfWeek) {
   ...
   **/
  public CreateBusinessUnitSettingsRequest timeZone(String timeZone) {
   ...
   **/
  public CreateBusinessUnitSettingsRequest shortTermForecasting(BuShortTermForecastingSettings shortTermForecasting) {
   ...
   * Scheduling settings
   **/
  public CreateBusinessUnitSettingsRequest scheduling(BuSchedulingSettingsRequest scheduling) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CreateBusinessUnitSettingsRequest createBusinessUnitSettingsRequest = (CreateBusinessUnitSettingsRequest) o;
