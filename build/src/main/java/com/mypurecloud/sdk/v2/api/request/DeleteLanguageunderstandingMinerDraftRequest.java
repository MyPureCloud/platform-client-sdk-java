...
public class DeleteLanguageunderstandingMinerDraftRequest {
	...
	public DeleteLanguageunderstandingMinerDraftRequest withMinerId(String minerId) {
	...
	public DeleteLanguageunderstandingMinerDraftRequest withDraftId(String draftId) {
    ...
    public DeleteLanguageunderstandingMinerDraftRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.minerId == null) {
            throw new IllegalStateException("Missing the required parameter 'minerId' when building request for DeleteLanguageunderstandingMinerDraftRequest.");
        }
        
        // verify the required parameter 'draftId' is set
        if (this.draftId == null) {
            throw new IllegalStateException("Missing the required parameter 'draftId' when building request for DeleteLanguageunderstandingMinerDraftRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/languageunderstanding/miners/{minerId}/drafts/{draftId}")
	...
	public static class Builder {
		private final DeleteLanguageunderstandingMinerDraftRequest request;

		private Builder() {
			request = new DeleteLanguageunderstandingMinerDraftRequest();
		}
		...
		public DeleteLanguageunderstandingMinerDraftRequest build() {
