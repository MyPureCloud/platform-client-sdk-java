...
public class GetRoutingSmsAddressRequest {
	...
	public GetRoutingSmsAddressRequest withAddressId(String addressId) {
    ...
    public GetRoutingSmsAddressRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.addressId == null) {
            throw new IllegalStateException("Missing the required parameter 'addressId' when building request for GetRoutingSmsAddressRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/routing/sms/addresses/{addressId}")
	...
	public static class Builder {
		private final GetRoutingSmsAddressRequest request;

		private Builder() {
			request = new GetRoutingSmsAddressRequest();
		}
		...
		public GetRoutingSmsAddressRequest build() {
