...
public class DeleteConversationsCallParticipantCommunicationPostflowactionRequest {
	...
	public DeleteConversationsCallParticipantCommunicationPostflowactionRequest withConversationId(String conversationId) {
	...
	public DeleteConversationsCallParticipantCommunicationPostflowactionRequest withParticipantId(String participantId) {
	...
	public DeleteConversationsCallParticipantCommunicationPostflowactionRequest withCommunicationId(String communicationId) {
    ...
    public DeleteConversationsCallParticipantCommunicationPostflowactionRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for DeleteConversationsCallParticipantCommunicationPostflowactionRequest.");
        }
        
        // verify the required parameter 'participantId' is set
        if (this.participantId == null) {
            throw new IllegalStateException("Missing the required parameter 'participantId' when building request for DeleteConversationsCallParticipantCommunicationPostflowactionRequest.");
        }
        
        // verify the required parameter 'communicationId' is set
        if (this.communicationId == null) {
            throw new IllegalStateException("Missing the required parameter 'communicationId' when building request for DeleteConversationsCallParticipantCommunicationPostflowactionRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/conversations/calls/{conversationId}/participants/{participantId}/communications/{communicationId}/postflowaction")
	...
	public static class Builder {
		private final DeleteConversationsCallParticipantCommunicationPostflowactionRequest request;

		private Builder() {
			request = new DeleteConversationsCallParticipantCommunicationPostflowactionRequest();
		}
		...
		public DeleteConversationsCallParticipantCommunicationPostflowactionRequest build() {
