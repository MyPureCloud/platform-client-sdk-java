...
public class GetGamificationScorecardsPointsTrendsRequest {
	...
	public GetGamificationScorecardsPointsTrendsRequest withStartWorkday(LocalDate startWorkday) {
	...
	public GetGamificationScorecardsPointsTrendsRequest withEndWorkday(LocalDate endWorkday) {
	...
	public GetGamificationScorecardsPointsTrendsRequest withDayOfWeek(String dayOfWeek) {
    ...
    public GetGamificationScorecardsPointsTrendsRequest withCustomHeader(String name, String value) {
