...
public class GetCasemanagementCaseTerminateJobRequest {
	...
	public GetCasemanagementCaseTerminateJobRequest withCaseId(String caseId) {
	...
	public GetCasemanagementCaseTerminateJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetCasemanagementCaseTerminateJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.caseId == null) {
            throw new IllegalStateException("Missing the required parameter 'caseId' when building request for GetCasemanagementCaseTerminateJobRequest.");
        }
        
        // verify the required parameter 'jobId' is set
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetCasemanagementCaseTerminateJobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/casemanagement/cases/{caseId}/terminate/jobs/{jobId}")
	...
	public static Builder builder(String caseId, String jobId) {
	    return new Builder()
	            .withRequiredParams(caseId, jobId);
	}


	public static class Builder {
		private final GetCasemanagementCaseTerminateJobRequest request;

		private Builder() {
			request = new GetCasemanagementCaseTerminateJobRequest();
		}
		...
		public Builder withRequiredParams(String caseId, String jobId) {
			request.setCaseId(caseId);
			request.setJobId(jobId);
		...
		public GetCasemanagementCaseTerminateJobRequest build() {
