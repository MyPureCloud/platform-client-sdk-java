...
public class GetOutboundRulesetsRequest {
	...
	public GetOutboundRulesetsRequest withPageSize(Integer pageSize) {
	...
	public GetOutboundRulesetsRequest withPageNumber(Integer pageNumber) {
	...
	public GetOutboundRulesetsRequest withAllowEmptyResult(Boolean allowEmptyResult) {
	...
	public GetOutboundRulesetsRequest withFilterType(String filterType) {
	...
	public GetOutboundRulesetsRequest withName(String name) {
	    this.setName(name);
	    return this;
	} 
	...
	public GetOutboundRulesetsRequest withSortBy(String sortBy) {
	...
	public GetOutboundRulesetsRequest withSortOrder(String sortOrder) {
    ...
    public GetOutboundRulesetsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/outbound/rulesets")
	...
	public static class Builder {
		private final GetOutboundRulesetsRequest request;

		private Builder() {
			request = new GetOutboundRulesetsRequest();
		}
