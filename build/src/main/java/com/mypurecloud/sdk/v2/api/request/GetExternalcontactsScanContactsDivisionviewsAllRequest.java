...
public class GetExternalcontactsScanContactsDivisionviewsAllRequest {
	...
	public GetExternalcontactsScanContactsDivisionviewsAllRequest withLimit(Integer limit) {
	    this.setLimit(limit);
	    return this;
	} 
	...
	public GetExternalcontactsScanContactsDivisionviewsAllRequest withCursor(String cursor) {
    ...
    public GetExternalcontactsScanContactsDivisionviewsAllRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/externalcontacts/scan/contacts/divisionviews/all")
	...
	public static class Builder {
		private final GetExternalcontactsScanContactsDivisionviewsAllRequest request;

		private Builder() {
			request = new GetExternalcontactsScanContactsDivisionviewsAllRequest();
		}
		...
		public GetExternalcontactsScanContactsDivisionviewsAllRequest build() {
