...
public class QueueConversationVideoEventTopicAfterCallWork  implements Serializable {
  ...
  /**
   **/
  public QueueConversationVideoEventTopicAfterCallWork state(StateEnum state) {
    this.state = state;
    return this;
  }
  ...
  /**
   **/
  public QueueConversationVideoEventTopicAfterCallWork startTime(Date startTime) {
  ...
  /**
   **/
  public QueueConversationVideoEventTopicAfterCallWork endTime(Date endTime) {
