...
public class GetAlertingRoutingstatusRuleRequest {
	...
	public GetAlertingRoutingstatusRuleRequest withRuleId(String ruleId) {
	...
	public GetAlertingRoutingstatusRuleRequest withExpand(List<String> expand) {
    ...
    public GetAlertingRoutingstatusRuleRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.ruleId == null) {
            throw new IllegalStateException("Missing the required parameter 'ruleId' when building request for GetAlertingRoutingstatusRuleRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/alerting/routingstatus/rules/{ruleId}")
	...
	public static class Builder {
		private final GetAlertingRoutingstatusRuleRequest request;

		private Builder() {
			request = new GetAlertingRoutingstatusRuleRequest();
		}
		...
		public GetAlertingRoutingstatusRuleRequest build() {
