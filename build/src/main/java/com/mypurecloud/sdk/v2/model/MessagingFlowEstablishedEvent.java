...
public class MessagingFlowEstablishedEvent  implements Serializable {
  ...
  public MessagingFlowEstablishedEvent() {
   ...
   **/
  public MessagingFlowEstablishedEvent eventId(String eventId) {
   ...
   **/
  public MessagingFlowEstablishedEvent eventDateTime(Date eventDateTime) {
   ...
   **/
  public MessagingFlowEstablishedEvent conversationId(String conversationId) {
   ...
   **/
  public MessagingFlowEstablishedEvent communicationId(String communicationId) {
   ...
   **/
  public MessagingFlowEstablishedEvent initialConfiguration(MessagingInitialConfiguration initialConfiguration) {
   ...
   **/
  public MessagingFlowEstablishedEvent sourceConfiguration(SourceConfiguration sourceConfiguration) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    MessagingFlowEstablishedEvent messagingFlowEstablishedEvent = (MessagingFlowEstablishedEvent) o;

    return Objects.equals(this.eventId, messagingFlowEstablishedEvent.eventId) &&
            Objects.equals(this.eventDateTime, messagingFlowEstablishedEvent.eventDateTime) &&
            Objects.equals(this.conversationId, messagingFlowEstablishedEvent.conversationId) &&
            Objects.equals(this.communicationId, messagingFlowEstablishedEvent.communicationId) &&
            Objects.equals(this.initialConfiguration, messagingFlowEstablishedEvent.initialConfiguration) &&
            Objects.equals(this.sourceConfiguration, messagingFlowEstablishedEvent.sourceConfiguration);
  }

  @Override
  public int hashCode() {
    return Objects.hash(eventId, eventDateTime, conversationId, communicationId, initialConfiguration, sourceConfiguration);
  }
