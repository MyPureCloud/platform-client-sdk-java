...
public class PostRoutingUtilizationTagsRequest {

	private CreateUtilizationTagRequest body;
	public CreateUtilizationTagRequest getBody() {
		return this.body;
	}

	public void setBody(CreateUtilizationTagRequest body) {
		this.body = body;
	}

	public PostRoutingUtilizationTagsRequest withBody(CreateUtilizationTagRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostRoutingUtilizationTagsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<CreateUtilizationTagRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostRoutingUtilizationTagsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/routing/utilization/tags")
                .withBody(body)
	...
	public static Builder builder(CreateUtilizationTagRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostRoutingUtilizationTagsRequest request;

		private Builder() {
			request = new PostRoutingUtilizationTagsRequest();
		}


		public Builder withBody(CreateUtilizationTagRequest body) {
		...
		public Builder withRequiredParams(CreateUtilizationTagRequest body) {
			request.setBody(body);
		...
		public PostRoutingUtilizationTagsRequest build() {
