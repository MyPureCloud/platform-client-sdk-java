...
public class PutTelephonyProvidersEdgesDidRequest {
	...
	public PutTelephonyProvidersEdgesDidRequest withDidId(String didId) {
	    this.setDidId(didId);
	    return this;
	}
	...
	public void setBody(DID body) {
		this.body = body;
	}

	public PutTelephonyProvidersEdgesDidRequest withBody(DID body) {
	    this.setBody(body);
	    return this;
	}
    ...
    public PutTelephonyProvidersEdgesDidRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<DID> withHttpInfo() throws ApiException {
        
        // verify the required parameter 'didId' is set
        if (this.didId == null) {
            throw new ApiException(400, "Missing the required parameter 'didId' when building request for PutTelephonyProvidersEdgesDidRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new ApiException(400, "Missing the required parameter 'body' when building request for PutTelephonyProvidersEdgesDidRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/telephony/providers/edges/dids/{didId}")
	...
	public static Builder builder(String didId, DID body) {
	    return new Builder()
	            .withRequiredParams(didId, body);
	}
	...
	public static class Builder {
		...
		private Builder() {
			request = new PutTelephonyProvidersEdgesDidRequest();
		}
		...
		public Builder withBody(DID body) {
			request.setBody(body);
			return this;
		}

		public Builder withRequiredParams(String didId, DID body) {
			request.setDidId(didId);
			request.setBody(body);
			return this;
		}
