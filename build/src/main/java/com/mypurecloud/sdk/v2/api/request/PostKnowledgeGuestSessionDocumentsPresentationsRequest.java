...
public class PostKnowledgeGuestSessionDocumentsPresentationsRequest {
	...
	public PostKnowledgeGuestSessionDocumentsPresentationsRequest withSessionId(String sessionId) {
	    this.setSessionId(sessionId);
	    return this;
	} 

	private KnowledgeGuestDocumentPresentation body;
	public KnowledgeGuestDocumentPresentation getBody() {
		return this.body;
	}

	public void setBody(KnowledgeGuestDocumentPresentation body) {
		this.body = body;
	}
    ...
    public ApiRequest<KnowledgeGuestDocumentPresentation> withHttpInfo() {
        
        // verify the required parameter 'sessionId' is set
        if (this.sessionId == null) {
            throw new IllegalStateException("Missing the required parameter 'sessionId' when building request for PostKnowledgeGuestSessionDocumentsPresentationsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/knowledge/guest/sessions/{sessionId}/documents/presentations")
	...
	public static class Builder {
		private final PostKnowledgeGuestSessionDocumentsPresentationsRequest request;

		private Builder() {
			request = new PostKnowledgeGuestSessionDocumentsPresentationsRequest();
		}
		...
		public Builder withBody(KnowledgeGuestDocumentPresentation body) {
		...
		public PostKnowledgeGuestSessionDocumentsPresentationsRequest build() {
