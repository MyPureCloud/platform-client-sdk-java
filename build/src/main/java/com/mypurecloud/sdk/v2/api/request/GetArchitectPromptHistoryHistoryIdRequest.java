...
public class GetArchitectPromptHistoryHistoryIdRequest {
	...
	public GetArchitectPromptHistoryHistoryIdRequest withPromptId(String promptId) {
	...
	public GetArchitectPromptHistoryHistoryIdRequest withHistoryId(String historyId) {
	...
	public GetArchitectPromptHistoryHistoryIdRequest withPageNumber(Integer pageNumber) {
	...
	public GetArchitectPromptHistoryHistoryIdRequest withPageSize(Integer pageSize) {
	...
	public GetArchitectPromptHistoryHistoryIdRequest withSortOrder(String sortOrder) {
	...
	public GetArchitectPromptHistoryHistoryIdRequest withSortBy(String sortBy) {
	...
	public GetArchitectPromptHistoryHistoryIdRequest withAction(List<String> action) {
    ...
    public GetArchitectPromptHistoryHistoryIdRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/architect/prompts/{promptId}/history/{historyId}")
	...
	public static class Builder {
		...
		private Builder() {
			request = new GetArchitectPromptHistoryHistoryIdRequest();
		}
