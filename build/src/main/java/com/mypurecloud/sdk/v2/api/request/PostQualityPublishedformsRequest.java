...
public class PostQualityPublishedformsRequest {
    ...
    public PostQualityPublishedformsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<PublishForm> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostQualityPublishedformsRequest.");
        }
