...
public class RoutingActivityEntityData  implements Serializable {
  ...
  public RoutingActivityEntityData() {
   ...
   **/
  public RoutingActivityEntityData activityDate(Date activityDate) {
   ...
   **/
  public RoutingActivityEntityData organizationPresenceId(String organizationPresenceId) {
   ...
   **/
  public RoutingActivityEntityData presenceDate(Date presenceDate) {
   ...
   * Queue identifier
   **/
  public RoutingActivityEntityData queueId(String queueId) {
   ...
   **/
  public RoutingActivityEntityData queueMembershipStatus(String queueMembershipStatus) {
   ...
   **/
  public RoutingActivityEntityData routingStatus(String routingStatus) {
   ...
   **/
  public RoutingActivityEntityData routingStatusDate(Date routingStatusDate) {
   ...
   * System presence
   **/
  public RoutingActivityEntityData systemPresence(String systemPresence) {
   ...
   **/
  public RoutingActivityEntityData teamId(String teamId) {
    this.teamId = teamId;
    return this;
  }
   ...
   **/
  public RoutingActivityEntityData userId(String userId) {
    this.userId = userId;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RoutingActivityEntityData routingActivityEntityData = (RoutingActivityEntityData) o;

    return Objects.equals(this.activityDate, routingActivityEntityData.activityDate) &&
            Objects.equals(this.organizationPresenceId, routingActivityEntityData.organizationPresenceId) &&
            Objects.equals(this.presenceDate, routingActivityEntityData.presenceDate) &&
            Objects.equals(this.queueId, routingActivityEntityData.queueId) &&
            Objects.equals(this.queueMembershipStatus, routingActivityEntityData.queueMembershipStatus) &&
            Objects.equals(this.routingStatus, routingActivityEntityData.routingStatus) &&
            Objects.equals(this.routingStatusDate, routingActivityEntityData.routingStatusDate) &&
            Objects.equals(this.systemPresence, routingActivityEntityData.systemPresence) &&
            Objects.equals(this.teamId, routingActivityEntityData.teamId) &&
            Objects.equals(this.userId, routingActivityEntityData.userId);
  }
