...
public class AssignedSegment  implements Serializable {
  ...
  public AssignedSegment(Boolean initWithEmptyList) {
   ...
   **/
  public AssignedSegment id(String id) {
    this.id = id;
    return this;
  }
  
  @ApiModelProperty(example = "null", required = true, value = "The ID of the segment assigned.")
  @JsonProperty("id")
  public String getId() {
    return id;
  }
