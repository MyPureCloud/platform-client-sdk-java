...
public class GetConversationsMessageRequest {
	...
	public GetConversationsMessageRequest withConversationId(String conversationId) {
    ...
    public GetConversationsMessageRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for GetConversationsMessageRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/conversations/messages/{conversationId}")
	...
	public static class Builder {
		private final GetConversationsMessageRequest request;

		private Builder() {
			request = new GetConversationsMessageRequest();
		}
		...
		public GetConversationsMessageRequest build() {
