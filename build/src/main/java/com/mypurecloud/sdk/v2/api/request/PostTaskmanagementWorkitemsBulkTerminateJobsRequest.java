...
public class PostTaskmanagementWorkitemsBulkTerminateJobsRequest {

	private BulkJobTerminateRequest body;
	public BulkJobTerminateRequest getBody() {
		return this.body;
	}

	public void setBody(BulkJobTerminateRequest body) {
		this.body = body;
	}

	public PostTaskmanagementWorkitemsBulkTerminateJobsRequest withBody(BulkJobTerminateRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostTaskmanagementWorkitemsBulkTerminateJobsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<BulkJobTerminateRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostTaskmanagementWorkitemsBulkTerminateJobsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/taskmanagement/workitems/bulk/terminate/jobs")
                .withBody(body)
	...
	public static Builder builder(BulkJobTerminateRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostTaskmanagementWorkitemsBulkTerminateJobsRequest request;

		private Builder() {
			request = new PostTaskmanagementWorkitemsBulkTerminateJobsRequest();
		}


		public Builder withBody(BulkJobTerminateRequest body) {
		...
		public Builder withRequiredParams(BulkJobTerminateRequest body) {
			request.setBody(body);
		...
		public PostTaskmanagementWorkitemsBulkTerminateJobsRequest build() {
