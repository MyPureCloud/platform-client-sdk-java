...
public class RequestEntityTypeCriteria  implements Serializable {
 ...
 @JsonDeserialize(using = EntityTypeEnumDeserializer.class)
   ...
   * The criteria key.
   **/
  public RequestEntityTypeCriteria key(String key) {
    this.key = key;
    return this;
  }
   ...
   * The criteria values.
   **/
  public RequestEntityTypeCriteria values(List<String> values) {
    this.values = values;
    return this;
  }
   ...
   **/
  public RequestEntityTypeCriteria shouldIgnoreCase(Boolean shouldIgnoreCase) {
   ...
   * The comparison operator.
   **/
  public RequestEntityTypeCriteria operator(OperatorEnum operator) {
   ...
   * The entity to match the pattern against.
   **/
  public RequestEntityTypeCriteria entityType(EntityTypeEnum entityType) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RequestEntityTypeCriteria requestEntityTypeCriteria = (RequestEntityTypeCriteria) o;

    return Objects.equals(this.key, requestEntityTypeCriteria.key) &&
            Objects.equals(this.values, requestEntityTypeCriteria.values) &&
            Objects.equals(this.shouldIgnoreCase, requestEntityTypeCriteria.shouldIgnoreCase) &&
            Objects.equals(this.operator, requestEntityTypeCriteria.operator) &&
            Objects.equals(this.entityType, requestEntityTypeCriteria.entityType);
  }
