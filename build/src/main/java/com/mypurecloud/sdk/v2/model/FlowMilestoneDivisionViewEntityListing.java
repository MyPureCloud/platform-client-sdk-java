...
import com.mypurecloud.sdk.v2.model.FlowMilestoneDivisionView;
...
public class FlowMilestoneDivisionViewEntityListing  implements Serializable, PagedResource<FlowMilestoneDivisionView> {
  ...
  public FlowMilestoneDivisionViewEntityListing() {
  ...
  /**
   **/
  public FlowMilestoneDivisionViewEntityListing entities(List<FlowMilestoneDivisionView> entities) {
  ...
  public List<FlowMilestoneDivisionView> getEntities() {
    return entities;
  }
  public void setEntities(List<FlowMilestoneDivisionView> entities) {
    this.entities = entities;
  }
