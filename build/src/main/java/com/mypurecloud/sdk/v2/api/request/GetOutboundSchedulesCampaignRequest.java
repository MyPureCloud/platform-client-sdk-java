...
public class GetOutboundSchedulesCampaignRequest {
	...
	public GetOutboundSchedulesCampaignRequest withCampaignId(String campaignId) {
    ...
    public GetOutboundSchedulesCampaignRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.campaignId == null) {
            throw new IllegalStateException("Missing the required parameter 'campaignId' when building request for GetOutboundSchedulesCampaignRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/outbound/schedules/campaigns/{campaignId}")
	...
	public static class Builder {
		private final GetOutboundSchedulesCampaignRequest request;

		private Builder() {
			request = new GetOutboundSchedulesCampaignRequest();
		}
		...
		public GetOutboundSchedulesCampaignRequest build() {
