...
public class FacebookIntegrationEntityListing  implements Serializable, PagedResource<FacebookIntegration> {
  ...
  public FacebookIntegrationEntityListing() {
  ...
  /**
   **/
  public FacebookIntegrationEntityListing entities(List<FacebookIntegration> entities) {
  ...
  public List<FacebookIntegration> getEntities() {
    return entities;
  }
  public void setEntities(List<FacebookIntegration> entities) {
    this.entities = entities;
  }
