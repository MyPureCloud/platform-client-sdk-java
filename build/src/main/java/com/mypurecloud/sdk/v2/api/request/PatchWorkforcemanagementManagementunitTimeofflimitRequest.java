...
public class PatchWorkforcemanagementManagementunitTimeofflimitRequest {
	...
	public PatchWorkforcemanagementManagementunitTimeofflimitRequest withManagementUnitId(String managementUnitId) {
	...
	public PatchWorkforcemanagementManagementunitTimeofflimitRequest withTimeOffLimitId(String timeOffLimitId) {
	    this.setTimeOffLimitId(timeOffLimitId);
	    return this;
	} 

	private UpdateTimeOffLimitRequest body;
	public UpdateTimeOffLimitRequest getBody() {
		return this.body;
	}

	public void setBody(UpdateTimeOffLimitRequest body) {
		this.body = body;
	}

	public PatchWorkforcemanagementManagementunitTimeofflimitRequest withBody(UpdateTimeOffLimitRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchWorkforcemanagementManagementunitTimeofflimitRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<UpdateTimeOffLimitRequest> withHttpInfo() {
        
        // verify the required parameter 'managementUnitId' is set
        if (this.managementUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'managementUnitId' when building request for PatchWorkforcemanagementManagementunitTimeofflimitRequest.");
        }
        
        // verify the required parameter 'timeOffLimitId' is set
        if (this.timeOffLimitId == null) {
            throw new IllegalStateException("Missing the required parameter 'timeOffLimitId' when building request for PatchWorkforcemanagementManagementunitTimeofflimitRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchWorkforcemanagementManagementunitTimeofflimitRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/workforcemanagement/managementunits/{managementUnitId}/timeofflimits/{timeOffLimitId}")
	...
	public static Builder builder(String managementUnitId, String timeOffLimitId, UpdateTimeOffLimitRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PatchWorkforcemanagementManagementunitTimeofflimitRequest request;

		private Builder() {
			request = new PatchWorkforcemanagementManagementunitTimeofflimitRequest();
		}
		...
		public Builder withBody(UpdateTimeOffLimitRequest body) {
		...
		public Builder withRequiredParams(String managementUnitId, String timeOffLimitId, UpdateTimeOffLimitRequest body) {
			request.setManagementUnitId(managementUnitId);
			request.setTimeOffLimitId(timeOffLimitId);
			request.setBody(body);
		...
		public PatchWorkforcemanagementManagementunitTimeofflimitRequest build() {
