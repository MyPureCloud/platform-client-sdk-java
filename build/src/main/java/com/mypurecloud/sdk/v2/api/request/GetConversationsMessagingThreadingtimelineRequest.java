...
public class GetConversationsMessagingThreadingtimelineRequest {
    ...
    public GetConversationsMessagingThreadingtimelineRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/conversations/messaging/threadingtimeline")
	...
	public static class Builder {
		private final GetConversationsMessagingThreadingtimelineRequest request;

		private Builder() {
			request = new GetConversationsMessagingThreadingtimelineRequest();
		}
		...
		public GetConversationsMessagingThreadingtimelineRequest build() {
