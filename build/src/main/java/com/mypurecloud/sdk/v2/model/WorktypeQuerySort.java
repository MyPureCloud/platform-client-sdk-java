...
public class WorktypeQuerySort  implements Serializable {
 ...
 @JsonDeserialize(using = NameEnumDeserializer.class)
  ...
  public WorktypeQuerySort() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
    }
  }

  public WorktypeQuerySort(Boolean initWithEmptyList) {
   ...
   * Specify an attribute for sorting. It's possible to use an attribute both for sorting and in the query at the same time, but these restrictions apply: Only the operators EQ, LT, LTE, GT, GTE, BETWEEN and BEGINS_WITH are supported and the attribute can't be present in more than one filter.
   **/
  public WorktypeQuerySort name(NameEnum name) {
    this.name = name;
    return this;
  }
   ...
   * Sort Ascending
   **/
  public WorktypeQuerySort ascending(Boolean ascending) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    WorktypeQuerySort worktypeQuerySort = (WorktypeQuerySort) o;

    return Objects.equals(this.name, worktypeQuerySort.name) &&
            Objects.equals(this.ascending, worktypeQuerySort.ascending);
  }
