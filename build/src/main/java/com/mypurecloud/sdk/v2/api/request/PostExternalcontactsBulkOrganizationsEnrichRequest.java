...
public class PostExternalcontactsBulkOrganizationsEnrichRequest {

	private BulkOrganizationsEnrichRequest body;
	public BulkOrganizationsEnrichRequest getBody() {
		return this.body;
	}

	public void setBody(BulkOrganizationsEnrichRequest body) {
		this.body = body;
	}

	public PostExternalcontactsBulkOrganizationsEnrichRequest withBody(BulkOrganizationsEnrichRequest body) {
	    this.setBody(body);
	    return this;
	} 
	...
	public PostExternalcontactsBulkOrganizationsEnrichRequest withDryRun(Boolean dryRun) {
    ...
    public PostExternalcontactsBulkOrganizationsEnrichRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<BulkOrganizationsEnrichRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostExternalcontactsBulkOrganizationsEnrichRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/externalcontacts/bulk/organizations/enrich")

                .withQueryParameters("dryRun", "", dryRun)
	...
	public static Builder builder(BulkOrganizationsEnrichRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostExternalcontactsBulkOrganizationsEnrichRequest request;

		private Builder() {
			request = new PostExternalcontactsBulkOrganizationsEnrichRequest();
		}


		public Builder withBody(BulkOrganizationsEnrichRequest body) {
		...
		public Builder withRequiredParams(BulkOrganizationsEnrichRequest body) {
			request.setBody(body);
		...
		public PostExternalcontactsBulkOrganizationsEnrichRequest build() {
