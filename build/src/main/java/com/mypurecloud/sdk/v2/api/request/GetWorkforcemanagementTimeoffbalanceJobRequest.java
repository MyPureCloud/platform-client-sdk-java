...
public class GetWorkforcemanagementTimeoffbalanceJobRequest {
	...
	public GetWorkforcemanagementTimeoffbalanceJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetWorkforcemanagementTimeoffbalanceJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetWorkforcemanagementTimeoffbalanceJobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/timeoffbalance/jobs/{jobId}")
	...
	public static class Builder {
		private final GetWorkforcemanagementTimeoffbalanceJobRequest request;

		private Builder() {
			request = new GetWorkforcemanagementTimeoffbalanceJobRequest();
		}
		...
		public GetWorkforcemanagementTimeoffbalanceJobRequest build() {
