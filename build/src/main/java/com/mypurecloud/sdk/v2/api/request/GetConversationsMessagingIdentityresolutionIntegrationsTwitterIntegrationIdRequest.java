...
public class GetConversationsMessagingIdentityresolutionIntegrationsTwitterIntegrationIdRequest {
	...
	public GetConversationsMessagingIdentityresolutionIntegrationsTwitterIntegrationIdRequest withIntegrationId(String integrationId) {
    ...
    public GetConversationsMessagingIdentityresolutionIntegrationsTwitterIntegrationIdRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.integrationId == null) {
            throw new IllegalStateException("Missing the required parameter 'integrationId' when building request for GetConversationsMessagingIdentityresolutionIntegrationsTwitterIntegrationIdRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/conversations/messaging/identityresolution/integrations/twitter/{integrationId}")
	...
	public static class Builder {
		private final GetConversationsMessagingIdentityresolutionIntegrationsTwitterIntegrationIdRequest request;

		private Builder() {
			request = new GetConversationsMessagingIdentityresolutionIntegrationsTwitterIntegrationIdRequest();
		}
		...
		public GetConversationsMessagingIdentityresolutionIntegrationsTwitterIntegrationIdRequest build() {
