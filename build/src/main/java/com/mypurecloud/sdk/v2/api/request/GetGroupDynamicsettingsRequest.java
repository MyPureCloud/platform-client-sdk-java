...
public class GetGroupDynamicsettingsRequest {
	...
	public GetGroupDynamicsettingsRequest withGroupId(String groupId) {
    ...
    public GetGroupDynamicsettingsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.groupId == null) {
            throw new IllegalStateException("Missing the required parameter 'groupId' when building request for GetGroupDynamicsettingsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/groups/{groupId}/dynamicsettings")
	...
	public static class Builder {
		private final GetGroupDynamicsettingsRequest request;

		private Builder() {
			request = new GetGroupDynamicsettingsRequest();
		}
		...
		public GetGroupDynamicsettingsRequest build() {
