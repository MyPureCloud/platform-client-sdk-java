...
public class PostWorkforcemanagementShifttradingTradeJobsRequest {
	...
	public PostWorkforcemanagementShifttradingTradeJobsRequest withTradeId(String tradeId) {
	    this.setTradeId(tradeId);
	    return this;
	} 

	private UpdateShiftTradeJobRequest body;
	public UpdateShiftTradeJobRequest getBody() {
		return this.body;
	}

	public void setBody(UpdateShiftTradeJobRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementShifttradingTradeJobsRequest withBody(UpdateShiftTradeJobRequest body) {
	    this.setBody(body);
	    return this;
	} 
	...
	public PostWorkforcemanagementShifttradingTradeJobsRequest withForceAsync(Boolean forceAsync) {
    ...
    public PostWorkforcemanagementShifttradingTradeJobsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<UpdateShiftTradeJobRequest> withHttpInfo() {
        
        // verify the required parameter 'tradeId' is set
        if (this.tradeId == null) {
            throw new IllegalStateException("Missing the required parameter 'tradeId' when building request for PostWorkforcemanagementShifttradingTradeJobsRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementShifttradingTradeJobsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/shifttrading/trades/{tradeId}/jobs")
	...
	public static Builder builder(String tradeId, UpdateShiftTradeJobRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementShifttradingTradeJobsRequest request;

		private Builder() {
			request = new PostWorkforcemanagementShifttradingTradeJobsRequest();
		}
		...
		public Builder withBody(UpdateShiftTradeJobRequest body) {
		...
		public Builder withRequiredParams(String tradeId, UpdateShiftTradeJobRequest body) {
			request.setTradeId(tradeId);
			request.setBody(body);
		...
		public PostWorkforcemanagementShifttradingTradeJobsRequest build() {
