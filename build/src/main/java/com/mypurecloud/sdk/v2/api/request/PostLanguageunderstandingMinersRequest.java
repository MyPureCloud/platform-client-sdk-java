...
public class PostLanguageunderstandingMinersRequest {
    
	private Miner body;
	public Miner getBody() {
		return this.body;
	}

	public void setBody(Miner body) {
		this.body = body;
	}

	public PostLanguageunderstandingMinersRequest withBody(Miner body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostLanguageunderstandingMinersRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<Miner> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostLanguageunderstandingMinersRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/languageunderstanding/miners")
                .withBody(body)
	...
	public static Builder builder(Miner body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostLanguageunderstandingMinersRequest request;

		private Builder() {
			request = new PostLanguageunderstandingMinersRequest();
		}

		
		public Builder withBody(Miner body) {
		...
		public Builder withRequiredParams(Miner body) {
			request.setBody(body);
		...
		public PostLanguageunderstandingMinersRequest build() {
