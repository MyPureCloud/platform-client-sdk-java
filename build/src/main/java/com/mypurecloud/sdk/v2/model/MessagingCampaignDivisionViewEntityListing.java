...
public class MessagingCampaignDivisionViewEntityListing  implements Serializable, PagedResource<MessagingCampaignDivisionView> {
  ...
  public MessagingCampaignDivisionViewEntityListing() {
  ...
  /**
   **/
  public MessagingCampaignDivisionViewEntityListing entities(List<MessagingCampaignDivisionView> entities) {
  ...
  public List<MessagingCampaignDivisionView> getEntities() {
    return entities;
  }
  public void setEntities(List<MessagingCampaignDivisionView> entities) {
    this.entities = entities;
  }
