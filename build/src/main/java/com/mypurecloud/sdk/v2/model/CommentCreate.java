...
public class CommentCreate  implements Serializable {
  ...
  public CommentCreate(Boolean initWithEmptyList) {
  ...
  @ApiModelProperty(example = "null", required = true, value = "Comment body, which cannot be empty and has a maximum length of 4,096 characters.")
