...
public class GetAnalyticsCasemanagementAggregatesJobRequest {
	...
	public GetAnalyticsCasemanagementAggregatesJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetAnalyticsCasemanagementAggregatesJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetAnalyticsCasemanagementAggregatesJobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/analytics/casemanagement/aggregates/jobs/{jobId}")
	...
	public static class Builder {
		private final GetAnalyticsCasemanagementAggregatesJobRequest request;

		private Builder() {
			request = new GetAnalyticsCasemanagementAggregatesJobRequest();
		}
		...
		public GetAnalyticsCasemanagementAggregatesJobRequest build() {
