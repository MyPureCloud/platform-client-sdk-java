...
public class UpdateTimeOffPlanRequest  implements Serializable {
 ...
 @JsonDeserialize(using = AutoApprovalRuleEnumDeserializer.class)
  ...
  @ApiModelProperty(example = "null", value = "Deprecated. Auto approval rule for the time off plan.")
  ...
  @ApiModelProperty(example = "null", value = "Deprecated. Whether this time off plan should be used by agents.")
  @JsonProperty("active")
  ...
  @ApiModelProperty(example = "null", required = true, value = "Deprecated. Version metadata for the time off plan")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.name, updateTimeOffPlanRequest.name) &&
            ...
            Objects.equals(this.hrisTimeOffType, updateTimeOffPlanRequest.hrisTimeOffType) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, activityCodeIds, timeOffLimitIds, autoApprovalRule, daysBeforeStartToExpireFromWaitlist, hrisTimeOffType, active, metadata);
  }
