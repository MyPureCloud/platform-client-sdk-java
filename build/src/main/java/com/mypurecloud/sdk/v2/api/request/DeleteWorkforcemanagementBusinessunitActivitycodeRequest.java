...
public class DeleteWorkforcemanagementBusinessunitActivitycodeRequest {
    ...
    public DeleteWorkforcemanagementBusinessunitActivitycodeRequest withCustomHeader(String name, String value) {
	...
	public static class Builder {
		private final DeleteWorkforcemanagementBusinessunitActivitycodeRequest request;

		private Builder() {
			request = new DeleteWorkforcemanagementBusinessunitActivitycodeRequest();
		}
