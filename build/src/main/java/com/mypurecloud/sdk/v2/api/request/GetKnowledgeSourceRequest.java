...
public class GetKnowledgeSourceRequest {
	...
	public GetKnowledgeSourceRequest withSourceId(String sourceId) {
	...
	public GetKnowledgeSourceRequest withExpand(List<String> expand) {
    ...
    public GetKnowledgeSourceRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.sourceId == null) {
            throw new IllegalStateException("Missing the required parameter 'sourceId' when building request for GetKnowledgeSourceRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/knowledge/sources/{sourceId}")
	...
	public static class Builder {
		private final GetKnowledgeSourceRequest request;

		private Builder() {
			request = new GetKnowledgeSourceRequest();
		}
		...
		public GetKnowledgeSourceRequest build() {
