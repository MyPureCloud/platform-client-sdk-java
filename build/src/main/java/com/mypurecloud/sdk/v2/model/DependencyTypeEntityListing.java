...
public class DependencyTypeEntityListing  implements Serializable, PagedResource<DependencyType> {
  
  private List<DependencyType> entities = null;
  ...
  public DependencyTypeEntityListing() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
      entities = new ArrayList<DependencyType>();
    }
  }

  public DependencyTypeEntityListing(Boolean initWithEmptyList) {
  ...
  /**
   **/
  public DependencyTypeEntityListing entities(List<DependencyType> entities) {
  ...
  public List<DependencyType> getEntities() {
    return entities;
  }
  public void setEntities(List<DependencyType> entities) {
    this.entities = entities;
  }
