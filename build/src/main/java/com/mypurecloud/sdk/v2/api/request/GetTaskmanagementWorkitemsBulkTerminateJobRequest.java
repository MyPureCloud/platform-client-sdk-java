...
public class GetTaskmanagementWorkitemsBulkTerminateJobRequest {
	...
	public GetTaskmanagementWorkitemsBulkTerminateJobRequest withBulkJobId(String bulkJobId) {
    ...
    public GetTaskmanagementWorkitemsBulkTerminateJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.bulkJobId == null) {
            throw new IllegalStateException("Missing the required parameter 'bulkJobId' when building request for GetTaskmanagementWorkitemsBulkTerminateJobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/taskmanagement/workitems/bulk/terminate/jobs/{bulkJobId}")
	...
	public static class Builder {
		private final GetTaskmanagementWorkitemsBulkTerminateJobRequest request;

		private Builder() {
			request = new GetTaskmanagementWorkitemsBulkTerminateJobRequest();
		}
		...
		public GetTaskmanagementWorkitemsBulkTerminateJobRequest build() {
