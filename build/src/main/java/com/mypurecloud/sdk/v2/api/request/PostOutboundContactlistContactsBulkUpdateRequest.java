...
public class PostOutboundContactlistContactsBulkUpdateRequest {
	...
	public PostOutboundContactlistContactsBulkUpdateRequest withContactListId(String contactListId) {
	    this.setContactListId(contactListId);
	    return this;
	} 

	private ContactBulkEditRequest body;
	public ContactBulkEditRequest getBody() {
		return this.body;
	}

	public void setBody(ContactBulkEditRequest body) {
		this.body = body;
	}

	public PostOutboundContactlistContactsBulkUpdateRequest withBody(ContactBulkEditRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostOutboundContactlistContactsBulkUpdateRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<ContactBulkEditRequest> withHttpInfo() {
        
        // verify the required parameter 'contactListId' is set
        if (this.contactListId == null) {
            throw new IllegalStateException("Missing the required parameter 'contactListId' when building request for PostOutboundContactlistContactsBulkUpdateRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostOutboundContactlistContactsBulkUpdateRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/outbound/contactlists/{contactListId}/contacts/bulk/update")
	...
	public static Builder builder(String contactListId, ContactBulkEditRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostOutboundContactlistContactsBulkUpdateRequest request;

		private Builder() {
			request = new PostOutboundContactlistContactsBulkUpdateRequest();
		}
		...
		public Builder withBody(ContactBulkEditRequest body) {
		...
		public Builder withRequiredParams(String contactListId, ContactBulkEditRequest body) {
			request.setContactListId(contactListId);
			request.setBody(body);
		...
		public PostOutboundContactlistContactsBulkUpdateRequest build() {
