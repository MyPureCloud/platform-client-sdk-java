...
public class AgentUtilizationAggregationView  implements Serializable {
 ...
 @JsonDeserialize(using = FunctionEnumDeserializer.class)
   ...
   * Target metric name
   **/
  public AgentUtilizationAggregationView target(TargetEnum target) {
    this.target = target;
    return this;
  }
   ...
   **/
  public AgentUtilizationAggregationView name(String name) {
    this.name = name;
    return this;
  }
   ...
   * Type of view you wish to create
   **/
  public AgentUtilizationAggregationView function(FunctionEnum function) {
   ...
   **/
  public AgentUtilizationAggregationView range(AggregationRange range) {
    this.range = range;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    AgentUtilizationAggregationView agentUtilizationAggregationView = (AgentUtilizationAggregationView) o;

    return Objects.equals(this.target, agentUtilizationAggregationView.target) &&
            Objects.equals(this.name, agentUtilizationAggregationView.name) &&
            Objects.equals(this.function, agentUtilizationAggregationView.function) &&
            Objects.equals(this.range, agentUtilizationAggregationView.range);
  }
  ...
  public String toString() {
    ...
    sb.append("class AgentUtilizationAggregationView {\n");
