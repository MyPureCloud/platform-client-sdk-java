...
import com.mypurecloud.sdk.v2.model.FlowExecutionAggregationView;
...
public class FlowExecutionAsyncAggregationQuery  implements Serializable {
 ...
 @JsonDeserialize(using = AlternateTimeDimensionEnumDeserializer.class)
  ...
  public FlowExecutionAsyncAggregationQuery(Boolean initWithEmptyList) {
   ...
   **/
  public FlowExecutionAsyncAggregationQuery interval(String interval) {
   ...
   **/
  public FlowExecutionAsyncAggregationQuery granularity(String granularity) {
   ...
   **/
  public FlowExecutionAsyncAggregationQuery timeZone(String timeZone) {
   ...
   **/
  public FlowExecutionAsyncAggregationQuery groupBy(List<GroupByEnum> groupBy) {
   ...
   **/
  public FlowExecutionAsyncAggregationQuery filter(FlowExecutionAggregateQueryFilter filter) {
    this.filter = filter;
    return this;
  }
  ...
  @JsonProperty("filter")
  public FlowExecutionAggregateQueryFilter getFilter() {
    return filter;
  }
  public void setFilter(FlowExecutionAggregateQueryFilter filter) {
    this.filter = filter;
  }
   ...
   **/
  public FlowExecutionAsyncAggregationQuery metrics(List<MetricsEnum> metrics) {
   ...
   **/
  public FlowExecutionAsyncAggregationQuery flattenMultivaluedDimensions(Boolean flattenMultivaluedDimensions) {
   ...
   **/
  public FlowExecutionAsyncAggregationQuery views(List<FlowExecutionAggregationView> views) {
    this.views = views;
    return this;
  }
  ...
  @JsonProperty("views")
  public List<FlowExecutionAggregationView> getViews() {
    return views;
  }
  public void setViews(List<FlowExecutionAggregationView> views) {
    this.views = views;
  }
   ...
   * Dimension to use as the alternative timestamp for data in the aggregate.  Choosing \"eventTime\" uses the actual time of the data event.
   **/
  public FlowExecutionAsyncAggregationQuery alternateTimeDimension(AlternateTimeDimensionEnum alternateTimeDimension) {
   ...
   **/
  public FlowExecutionAsyncAggregationQuery pageSize(Integer pageSize) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    FlowExecutionAsyncAggregationQuery flowExecutionAsyncAggregationQuery = (FlowExecutionAsyncAggregationQuery) o;

    return Objects.equals(this.interval, flowExecutionAsyncAggregationQuery.interval) &&
            Objects.equals(this.granularity, flowExecutionAsyncAggregationQuery.granularity) &&
            Objects.equals(this.timeZone, flowExecutionAsyncAggregationQuery.timeZone) &&
            Objects.equals(this.groupBy, flowExecutionAsyncAggregationQuery.groupBy) &&
            Objects.equals(this.filter, flowExecutionAsyncAggregationQuery.filter) &&
            Objects.equals(this.metrics, flowExecutionAsyncAggregationQuery.metrics) &&
            Objects.equals(this.flattenMultivaluedDimensions, flowExecutionAsyncAggregationQuery.flattenMultivaluedDimensions) &&
            Objects.equals(this.views, flowExecutionAsyncAggregationQuery.views) &&
            Objects.equals(this.alternateTimeDimension, flowExecutionAsyncAggregationQuery.alternateTimeDimension) &&
            Objects.equals(this.pageSize, flowExecutionAsyncAggregationQuery.pageSize);
  }
