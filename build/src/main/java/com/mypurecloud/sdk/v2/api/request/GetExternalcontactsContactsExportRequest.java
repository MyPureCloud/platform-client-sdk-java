...
public class GetExternalcontactsContactsExportRequest {
	...
	public GetExternalcontactsContactsExportRequest withExportId(String exportId) {
    ...
    public GetExternalcontactsContactsExportRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.exportId == null) {
            throw new IllegalStateException("Missing the required parameter 'exportId' when building request for GetExternalcontactsContactsExportRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/externalcontacts/contacts/exports/{exportId}")
                .withPathParameter("exportId", exportId)
	...
	public static Builder builder(String exportId) {
	    return new Builder()
	            .withRequiredParams(exportId);
	}


	public static class Builder {
		private final GetExternalcontactsContactsExportRequest request;

		private Builder() {
			request = new GetExternalcontactsContactsExportRequest();
		}
		...
		public Builder withRequiredParams(String exportId) {
			request.setExportId(exportId);
		...
		public GetExternalcontactsContactsExportRequest build() {
