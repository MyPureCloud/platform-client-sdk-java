...
public class DeleteOutboundSchedulesWhatsappcampaignRequest {

	private String whatsAppCampaignId;
	public String getWhatsAppCampaignId() {
		return this.whatsAppCampaignId;
	}

	public void setWhatsAppCampaignId(String whatsAppCampaignId) {
		this.whatsAppCampaignId = whatsAppCampaignId;
	}

	public DeleteOutboundSchedulesWhatsappcampaignRequest withWhatsAppCampaignId(String whatsAppCampaignId) {
	    this.setWhatsAppCampaignId(whatsAppCampaignId);
	    return this;
	} 
    ...
    public DeleteOutboundSchedulesWhatsappcampaignRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.whatsAppCampaignId == null) {
            throw new IllegalStateException("Missing the required parameter 'whatsAppCampaignId' when building request for DeleteOutboundSchedulesWhatsappcampaignRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/outbound/schedules/whatsappcampaigns/{whatsAppCampaignId}")
                .withPathParameter("whatsAppCampaignId", whatsAppCampaignId)
	...
	public static Builder builder(String whatsAppCampaignId) {
	    return new Builder()
	            .withRequiredParams(whatsAppCampaignId);
	}


	public static class Builder {
		private final DeleteOutboundSchedulesWhatsappcampaignRequest request;

		private Builder() {
			request = new DeleteOutboundSchedulesWhatsappcampaignRequest();
		}


		public Builder withWhatsAppCampaignId(String whatsAppCampaignId) {
			request.setWhatsAppCampaignId(whatsAppCampaignId);
			return this;
		}



		public Builder withRequiredParams(String whatsAppCampaignId) {
			request.setWhatsAppCampaignId(whatsAppCampaignId);
		...
		public DeleteOutboundSchedulesWhatsappcampaignRequest build() {
            
            // verify the required parameter 'whatsAppCampaignId' is set
            if (request.whatsAppCampaignId == null) {
                throw new IllegalStateException("Missing the required parameter 'whatsAppCampaignId' when building request for DeleteOutboundSchedulesWhatsappcampaignRequest.");
            }
