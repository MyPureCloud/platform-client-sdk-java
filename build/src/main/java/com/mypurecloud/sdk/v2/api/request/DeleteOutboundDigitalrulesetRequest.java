...
public class DeleteOutboundDigitalrulesetRequest {
	...
	public DeleteOutboundDigitalrulesetRequest withDigitalRuleSetId(String digitalRuleSetId) {
    ...
    public DeleteOutboundDigitalrulesetRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("DELETE", "/api/v2/outbound/digitalrulesets/{digitalRuleSetId}")
	...
	public static Builder builder(String digitalRuleSetId) {
	    return new Builder()
	            .withRequiredParams(digitalRuleSetId);
	}
	...
	public static class Builder {
		...
		private Builder() {
			request = new DeleteOutboundDigitalrulesetRequest();
		}
		...
		public Builder withRequiredParams(String digitalRuleSetId) {
			request.setDigitalRuleSetId(digitalRuleSetId);
