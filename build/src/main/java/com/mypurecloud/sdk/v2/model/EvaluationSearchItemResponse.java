...
import com.mypurecloud.sdk.v2.model.EvaluationFormSearchResponse;
...
public class EvaluationSearchItemResponse  implements Serializable {
  
  private String id = null;
  private String name = null;
  private ConversationReference conversation = null;
  private EvaluationFormSearchResponse evaluationForm = null;
 ...
 @JsonDeserialize(using = ResourceTypeEnumDeserializer.class)
  ...
  public EvaluationSearchItemResponse() {
  ...
  public EvaluationSearchItemResponse(Boolean initWithEmptyList) {
  ...
  /**
   **/
  public EvaluationSearchItemResponse name(String name) {
    this.name = name;
    return this;
  }
  ...
  /**
   **/
  public EvaluationSearchItemResponse conversation(ConversationReference conversation) {
   ...
   **/
  public EvaluationSearchItemResponse evaluationForm(EvaluationFormSearchResponse evaluationForm) {
  ...
  public EvaluationFormSearchResponse getEvaluationForm() {
    return evaluationForm;
  }
  public void setEvaluationForm(EvaluationFormSearchResponse evaluationForm) {
    this.evaluationForm = evaluationForm;
  }
  ...
  /**
   **/
  public EvaluationSearchItemResponse evaluator(User evaluator) {
  ...
  /**
   **/
  public EvaluationSearchItemResponse agent(User agent) {
    this.agent = agent;
    return this;
  }
  ...
  /**
   **/
  public EvaluationSearchItemResponse calibration(AddressableEntityRef calibration) {
  ...
  public void setCalibration(AddressableEntityRef calibration) {
    this.calibration = calibration;
  }
  ...
  /**
   **/
  public EvaluationSearchItemResponse status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  /**
   **/
  public EvaluationSearchItemResponse answers(EvaluationScoringSet answers) {
  ...
  /**
   **/
  public EvaluationSearchItemResponse agentHasRead(Boolean agentHasRead) {
  ...
  /**
   **/
  public EvaluationSearchItemResponse assignee(User assignee) {
   ...
   **/
  public EvaluationSearchItemResponse assigneeApplicable(Boolean assigneeApplicable) {
   ...
   **/
  public EvaluationSearchItemResponse releaseDate(Date releaseDate) {
   ...
   * Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss[.mmm]Z
   **/
  public EvaluationSearchItemResponse assignedDate(Date assignedDate) {
  ...
  @ApiModelProperty(example = "null", value = "Date the first version of this evaluation was created. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss[.mmm]Z")
   ...
   * Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss[.mmm]Z
   **/
  public EvaluationSearchItemResponse changedDate(Date changedDate) {
  ...
  @ApiModelProperty(example = "null", value = "Date the evaluation was last submitted. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss[.mmm]Z")
   ...
   **/
  public EvaluationSearchItemResponse revisionCreatedDate(Date revisionCreatedDate) {
  ...
  /**
   **/
  public EvaluationSearchItemResponse queue(Queue queue) {
    this.queue = queue;
    return this;
  }
   ...
   **/
  public EvaluationSearchItemResponse mediaType(List<MediaTypeEnum> mediaType) {
   ...
   **/
  public EvaluationSearchItemResponse rescore(Boolean rescore) {
   ...
   **/
  public EvaluationSearchItemResponse conversationDate(Date conversationDate) {
   ...
   **/
  public EvaluationSearchItemResponse conversationEndDate(Date conversationEndDate) {
   ...
   **/
  public EvaluationSearchItemResponse neverRelease(Boolean neverRelease) {
   ...
   **/
  public EvaluationSearchItemResponse assigned(Boolean assigned) {
   ...
   **/
  public EvaluationSearchItemResponse dateAssigneeChanged(Date dateAssigneeChanged) {
   ...
   **/
  public EvaluationSearchItemResponse resourceId(String resourceId) {
   ...
   * The type of resource. Only used for email evaluations. Will be null for evaluations on all other resources.
   **/
  public EvaluationSearchItemResponse resourceType(ResourceTypeEnum resourceType) {
   ...
   **/
  public EvaluationSearchItemResponse redacted(Boolean redacted) {
  ...
  /**
   **/
  public EvaluationSearchItemResponse isScoringIndex(Boolean isScoringIndex) {
   ...
   **/
  public EvaluationSearchItemResponse authorizedActions(List<String> authorizedActions) {
   ...
   **/
  public EvaluationSearchItemResponse hasAssistanceFailed(Boolean hasAssistanceFailed) {
   ...
   **/
  public EvaluationSearchItemResponse declinedReview(Boolean declinedReview) {
   ...
   **/
  public EvaluationSearchItemResponse evaluationContextId(String evaluationContextId) {
   ...
   **/
  public EvaluationSearchItemResponse retractedEvaluation(EvaluationReference retractedEvaluation) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EvaluationSearchItemResponse evaluationSearchItemResponse = (EvaluationSearchItemResponse) o;

    return Objects.equals(this.id, evaluationSearchItemResponse.id) &&
            Objects.equals(this.name, evaluationSearchItemResponse.name) &&
            Objects.equals(this.conversation, evaluationSearchItemResponse.conversation) &&
            Objects.equals(this.evaluationForm, evaluationSearchItemResponse.evaluationForm) &&
            Objects.equals(this.evaluator, evaluationSearchItemResponse.evaluator) &&
            Objects.equals(this.agent, evaluationSearchItemResponse.agent) &&
            Objects.equals(this.calibration, evaluationSearchItemResponse.calibration) &&
            Objects.equals(this.status, evaluationSearchItemResponse.status) &&
            Objects.equals(this.answers, evaluationSearchItemResponse.answers) &&
            Objects.equals(this.agentHasRead, evaluationSearchItemResponse.agentHasRead) &&
            Objects.equals(this.assignee, evaluationSearchItemResponse.assignee) &&
            Objects.equals(this.assigneeApplicable, evaluationSearchItemResponse.assigneeApplicable) &&
            Objects.equals(this.releaseDate, evaluationSearchItemResponse.releaseDate) &&
            Objects.equals(this.assignedDate, evaluationSearchItemResponse.assignedDate) &&
            Objects.equals(this.createdDate, evaluationSearchItemResponse.createdDate) &&
            Objects.equals(this.changedDate, evaluationSearchItemResponse.changedDate) &&
            Objects.equals(this.submittedDate, evaluationSearchItemResponse.submittedDate) &&
            Objects.equals(this.revisionCreatedDate, evaluationSearchItemResponse.revisionCreatedDate) &&
            Objects.equals(this.queue, evaluationSearchItemResponse.queue) &&
            Objects.equals(this.mediaType, evaluationSearchItemResponse.mediaType) &&
            Objects.equals(this.divisionIds, evaluationSearchItemResponse.divisionIds) &&
            Objects.equals(this.rescore, evaluationSearchItemResponse.rescore) &&
            Objects.equals(this.conversationDate, evaluationSearchItemResponse.conversationDate) &&
            Objects.equals(this.conversationEndDate, evaluationSearchItemResponse.conversationEndDate) &&
            Objects.equals(this.neverRelease, evaluationSearchItemResponse.neverRelease) &&
            Objects.equals(this.assigned, evaluationSearchItemResponse.assigned) &&
            Objects.equals(this.dateAssigneeChanged, evaluationSearchItemResponse.dateAssigneeChanged) &&
            Objects.equals(this.resourceId, evaluationSearchItemResponse.resourceId) &&
            Objects.equals(this.resourceType, evaluationSearchItemResponse.resourceType) &&
            Objects.equals(this.redacted, evaluationSearchItemResponse.redacted) &&
            Objects.equals(this.isScoringIndex, evaluationSearchItemResponse.isScoringIndex) &&
            Objects.equals(this.authorizedActions, evaluationSearchItemResponse.authorizedActions) &&
            Objects.equals(this.hasAssistanceFailed, evaluationSearchItemResponse.hasAssistanceFailed) &&
            Objects.equals(this.evaluationSource, evaluationSearchItemResponse.evaluationSource) &&
            Objects.equals(this.disputeCount, evaluationSearchItemResponse.disputeCount) &&
            Objects.equals(this.version, evaluationSearchItemResponse.version) &&
            Objects.equals(this.versionHistory, evaluationSearchItemResponse.versionHistory) &&
            Objects.equals(this.declinedReview, evaluationSearchItemResponse.declinedReview) &&
            Objects.equals(this.evaluationContextId, evaluationSearchItemResponse.evaluationContextId) &&
            Objects.equals(this.retractedEvaluation, evaluationSearchItemResponse.retractedEvaluation) &&
            Objects.equals(this.aiScoring, evaluationSearchItemResponse.aiScoring) &&
            Objects.equals(this.selfUri, evaluationSearchItemResponse.selfUri);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, conversation, evaluationForm, evaluator, agent, calibration, status, answers, agentHasRead, assignee, assigneeApplicable, releaseDate, assignedDate, createdDate, changedDate, submittedDate, revisionCreatedDate, queue, mediaType, divisionIds, rescore, conversationDate, conversationEndDate, neverRelease, assigned, dateAssigneeChanged, resourceId, resourceType, redacted, isScoringIndex, authorizedActions, hasAssistanceFailed, evaluationSource, disputeCount, version, versionHistory, declinedReview, evaluationContextId, retractedEvaluation, aiScoring, selfUri);
  }
