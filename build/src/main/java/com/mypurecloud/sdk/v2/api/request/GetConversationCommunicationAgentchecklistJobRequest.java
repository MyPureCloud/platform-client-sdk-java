...
public class GetConversationCommunicationAgentchecklistJobRequest {
	...
	public GetConversationCommunicationAgentchecklistJobRequest withConversationId(String conversationId) {
	...
	public GetConversationCommunicationAgentchecklistJobRequest withCommunicationId(String communicationId) {
	...
	public GetConversationCommunicationAgentchecklistJobRequest withAgentChecklistId(String agentChecklistId) {
	...
	public GetConversationCommunicationAgentchecklistJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetConversationCommunicationAgentchecklistJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for GetConversationCommunicationAgentchecklistJobRequest.");
        }
        
        // verify the required parameter 'communicationId' is set
        if (this.communicationId == null) {
            throw new IllegalStateException("Missing the required parameter 'communicationId' when building request for GetConversationCommunicationAgentchecklistJobRequest.");
        }
        
        // verify the required parameter 'agentChecklistId' is set
        if (this.agentChecklistId == null) {
            throw new IllegalStateException("Missing the required parameter 'agentChecklistId' when building request for GetConversationCommunicationAgentchecklistJobRequest.");
        }
        
        // verify the required parameter 'jobId' is set
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetConversationCommunicationAgentchecklistJobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/conversations/{conversationId}/communications/{communicationId}/agentchecklists/{agentChecklistId}/jobs/{jobId}")
	...
	public static Builder builder(String conversationId, String communicationId, String agentChecklistId, String jobId) {
	    return new Builder()
	            .withRequiredParams(conversationId, communicationId, agentChecklistId, jobId);
	}


	public static class Builder {
		private final GetConversationCommunicationAgentchecklistJobRequest request;

		private Builder() {
			request = new GetConversationCommunicationAgentchecklistJobRequest();
		}
		...
		public Builder withRequiredParams(String conversationId, String communicationId, String agentChecklistId, String jobId) {
			request.setConversationId(conversationId);
			request.setCommunicationId(communicationId);
			request.setAgentChecklistId(agentChecklistId);
			request.setJobId(jobId);
		...
		public GetConversationCommunicationAgentchecklistJobRequest build() {
