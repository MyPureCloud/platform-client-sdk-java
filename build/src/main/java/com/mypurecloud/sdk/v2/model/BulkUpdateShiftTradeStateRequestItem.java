...
public class BulkUpdateShiftTradeStateRequestItem  implements Serializable {
   ...
   **/
  public BulkUpdateShiftTradeStateRequestItem id(String id) {
    this.id = id;
    return this;
  }
   ...
   * The new state to set on the shift trade
   **/
  public BulkUpdateShiftTradeStateRequestItem state(StateEnum state) {
    this.state = state;
    return this;
  }
   ...
   **/
  public BulkUpdateShiftTradeStateRequestItem metadata(WfmVersionedEntityMetadata metadata) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, state, metadata);
  }
