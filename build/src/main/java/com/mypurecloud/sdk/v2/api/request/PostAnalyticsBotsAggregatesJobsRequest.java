...
public class PostAnalyticsBotsAggregatesJobsRequest {

	private BotAsyncAggregationQuery body;
	public BotAsyncAggregationQuery getBody() {
		return this.body;
	}

	public void setBody(BotAsyncAggregationQuery body) {
		this.body = body;
	}

	public PostAnalyticsBotsAggregatesJobsRequest withBody(BotAsyncAggregationQuery body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostAnalyticsBotsAggregatesJobsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<BotAsyncAggregationQuery> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostAnalyticsBotsAggregatesJobsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/analytics/bots/aggregates/jobs")
                .withBody(body)
	...
	public static Builder builder(BotAsyncAggregationQuery body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostAnalyticsBotsAggregatesJobsRequest request;

		private Builder() {
			request = new PostAnalyticsBotsAggregatesJobsRequest();
		}


		public Builder withBody(BotAsyncAggregationQuery body) {
		...
		public Builder withRequiredParams(BotAsyncAggregationQuery body) {
			request.setBody(body);
		...
		public PostAnalyticsBotsAggregatesJobsRequest build() {
