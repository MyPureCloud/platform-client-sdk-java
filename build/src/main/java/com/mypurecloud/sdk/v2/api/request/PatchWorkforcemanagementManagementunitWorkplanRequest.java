...
public class PatchWorkforcemanagementManagementunitWorkplanRequest {
	...
	public PatchWorkforcemanagementManagementunitWorkplanRequest withWorkPlanId(String workPlanId) {
    ...
    public ApiRequest<WorkPlan> withHttpInfo() {
        
        // verify the required parameter 'managementUnitId' is set
        if (this.managementUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'managementUnitId' when building request for PatchWorkforcemanagementManagementunitWorkplanRequest.");
        }
	...
	public static class Builder {
		private final PatchWorkforcemanagementManagementunitWorkplanRequest request;

		private Builder() {
			request = new PatchWorkforcemanagementManagementunitWorkplanRequest();
		}
		...
		public PatchWorkforcemanagementManagementunitWorkplanRequest build() {
