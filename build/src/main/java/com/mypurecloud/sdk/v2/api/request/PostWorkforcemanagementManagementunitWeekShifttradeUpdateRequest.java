...
public class PostWorkforcemanagementManagementunitWeekShifttradeUpdateRequest {
	...
	public PostWorkforcemanagementManagementunitWeekShifttradeUpdateRequest withManagementUnitId(String managementUnitId) {
	...
	public PostWorkforcemanagementManagementunitWeekShifttradeUpdateRequest withWeekDateId(LocalDate weekDateId) {
	    this.setWeekDateId(weekDateId);
	    return this;
	} 
	
	private UpdateShiftTradeRequest body;
	public UpdateShiftTradeRequest getBody() {
		return this.body;
	}

	public void setBody(UpdateShiftTradeRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementManagementunitWeekShifttradeUpdateRequest withBody(UpdateShiftTradeRequest body) {
	    this.setBody(body);
	    return this;
	} 
	...
	public PostWorkforcemanagementManagementunitWeekShifttradeUpdateRequest withTradeId(String tradeId) {
    ...
    public PostWorkforcemanagementManagementunitWeekShifttradeUpdateRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<UpdateShiftTradeRequest> withHttpInfo() {
        
        // verify the required parameter 'managementUnitId' is set
        if (this.managementUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'managementUnitId' when building request for PostWorkforcemanagementManagementunitWeekShifttradeUpdateRequest.");
        }
        
        // verify the required parameter 'weekDateId' is set
        if (this.weekDateId == null) {
            throw new IllegalStateException("Missing the required parameter 'weekDateId' when building request for PostWorkforcemanagementManagementunitWeekShifttradeUpdateRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementManagementunitWeekShifttradeUpdateRequest.");
        }
        
        // verify the required parameter 'tradeId' is set
        if (this.tradeId == null) {
            throw new IllegalStateException("Missing the required parameter 'tradeId' when building request for PostWorkforcemanagementManagementunitWeekShifttradeUpdateRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/managementunits/{managementUnitId}/weeks/{weekDateId}/shifttrades/{tradeId}/update")
	...
	public static Builder builder(String managementUnitId, LocalDate weekDateId, UpdateShiftTradeRequest body, String tradeId) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementManagementunitWeekShifttradeUpdateRequest request;

		private Builder() {
			request = new PostWorkforcemanagementManagementunitWeekShifttradeUpdateRequest();
		}
		...
		public Builder withBody(UpdateShiftTradeRequest body) {
		...
		public Builder withRequiredParams(String managementUnitId, LocalDate weekDateId, UpdateShiftTradeRequest body, String tradeId) {
			request.setManagementUnitId(managementUnitId);
						request.setWeekDateId(weekDateId);
						request.setBody(body);
						request.setTradeId(tradeId);
		...
		public PostWorkforcemanagementManagementunitWeekShifttradeUpdateRequest build() {
