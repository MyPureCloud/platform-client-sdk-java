...
public class PostRecordingsScreensessionsAcknowledgeRequest {
    
	private AcknowledgeScreenRecordingRequest body;
	public AcknowledgeScreenRecordingRequest getBody() {
		return this.body;
	}

	public void setBody(AcknowledgeScreenRecordingRequest body) {
		this.body = body;
	}

	public PostRecordingsScreensessionsAcknowledgeRequest withBody(AcknowledgeScreenRecordingRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostRecordingsScreensessionsAcknowledgeRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<AcknowledgeScreenRecordingRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostRecordingsScreensessionsAcknowledgeRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/recordings/screensessions/acknowledge")
                .withBody(body)
	...
	public static Builder builder(AcknowledgeScreenRecordingRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostRecordingsScreensessionsAcknowledgeRequest request;

		private Builder() {
			request = new PostRecordingsScreensessionsAcknowledgeRequest();
		}

		
		public Builder withBody(AcknowledgeScreenRecordingRequest body) {
		...
		public Builder withRequiredParams(AcknowledgeScreenRecordingRequest body) {
			request.setBody(body);
		...
		public PostRecordingsScreensessionsAcknowledgeRequest build() {
