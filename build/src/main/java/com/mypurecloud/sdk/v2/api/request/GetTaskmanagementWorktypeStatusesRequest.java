...
public class GetTaskmanagementWorktypeStatusesRequest {
	...
	public GetTaskmanagementWorktypeStatusesRequest withWorktypeId(String worktypeId) {
    ...
    public GetTaskmanagementWorktypeStatusesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.worktypeId == null) {
            throw new IllegalStateException("Missing the required parameter 'worktypeId' when building request for GetTaskmanagementWorktypeStatusesRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/taskmanagement/worktypes/{worktypeId}/statuses")
	...
	public static class Builder {
		private final GetTaskmanagementWorktypeStatusesRequest request;

		private Builder() {
			request = new GetTaskmanagementWorktypeStatusesRequest();
		}
		...
		public GetTaskmanagementWorktypeStatusesRequest build() {
