...
public class GetWorkforcemanagementManagementunitAdherenceRequest {
	...
	public GetWorkforcemanagementManagementunitAdherenceRequest withManagementUnitId(String managementUnitId) {
	...
	public GetWorkforcemanagementManagementunitAdherenceRequest withForceDownloadService(Boolean forceDownloadService) {
    ...
    public GetWorkforcemanagementManagementunitAdherenceRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.managementUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'managementUnitId' when building request for GetWorkforcemanagementManagementunitAdherenceRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/managementunits/{managementUnitId}/adherence")
	...
	public static class Builder {
		private final GetWorkforcemanagementManagementunitAdherenceRequest request;

		private Builder() {
			request = new GetWorkforcemanagementManagementunitAdherenceRequest();
		}
		...
		public GetWorkforcemanagementManagementunitAdherenceRequest build() {
