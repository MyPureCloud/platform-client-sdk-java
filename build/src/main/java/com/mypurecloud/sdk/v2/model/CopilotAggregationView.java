...
public class CopilotAggregationView  implements Serializable {
 ...
 @JsonDeserialize(using = FunctionEnumDeserializer.class)
   ...
   * Target metric name
   **/
  public CopilotAggregationView target(TargetEnum target) {
    this.target = target;
    return this;
  }
   ...
   **/
  public CopilotAggregationView name(String name) {
    this.name = name;
    return this;
  }
   ...
   * Type of view you wish to create
   **/
  public CopilotAggregationView function(FunctionEnum function) {
   ...
   **/
  public CopilotAggregationView range(AggregationRange range) {
    this.range = range;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CopilotAggregationView copilotAggregationView = (CopilotAggregationView) o;

    return Objects.equals(this.target, copilotAggregationView.target) &&
            Objects.equals(this.name, copilotAggregationView.name) &&
            Objects.equals(this.function, copilotAggregationView.function) &&
            Objects.equals(this.range, copilotAggregationView.range);
  }
