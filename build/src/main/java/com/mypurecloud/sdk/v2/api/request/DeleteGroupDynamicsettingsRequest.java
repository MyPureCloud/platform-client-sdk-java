...
public class DeleteGroupDynamicsettingsRequest {
	...
	public DeleteGroupDynamicsettingsRequest withGroupId(String groupId) {
    ...
    public DeleteGroupDynamicsettingsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.groupId == null) {
            throw new IllegalStateException("Missing the required parameter 'groupId' when building request for DeleteGroupDynamicsettingsRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/groups/{groupId}/dynamicsettings")
	...
	public static class Builder {
		private final DeleteGroupDynamicsettingsRequest request;

		private Builder() {
			request = new DeleteGroupDynamicsettingsRequest();
		}
		...
		public DeleteGroupDynamicsettingsRequest build() {
