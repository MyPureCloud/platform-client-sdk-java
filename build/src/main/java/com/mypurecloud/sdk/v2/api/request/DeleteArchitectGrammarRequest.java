...
public class DeleteArchitectGrammarRequest {
	...
	public DeleteArchitectGrammarRequest withGrammarId(String grammarId) {
    ...
    public DeleteArchitectGrammarRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.grammarId == null) {
            throw new IllegalStateException("Missing the required parameter 'grammarId' when building request for DeleteArchitectGrammarRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/architect/grammars/{grammarId}")
	...
	public static Builder builder(String grammarId) {
	    return new Builder()
	            .withRequiredParams(grammarId);
	}


	public static class Builder {
		private final DeleteArchitectGrammarRequest request;

		private Builder() {
			request = new DeleteArchitectGrammarRequest();
		}
		...
		public DeleteArchitectGrammarRequest build() {
