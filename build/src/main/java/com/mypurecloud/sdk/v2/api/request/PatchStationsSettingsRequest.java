...
public class PatchStationsSettingsRequest {
	...
	public void setBody(StationSettings body) {
		this.body = body;
	}

	public PatchStationsSettingsRequest withBody(StationSettings body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchStationsSettingsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<StationSettings> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchStationsSettingsRequest.");
        }
