...
public class PostExternalcontactsBulkContactsUnresolvedRequest {
	...
	public PostExternalcontactsBulkContactsUnresolvedRequest withBody(BulkIdsRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostExternalcontactsBulkContactsUnresolvedRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<BulkIdsRequest> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostExternalcontactsBulkContactsUnresolvedRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/externalcontacts/bulk/contacts/unresolved")
                .withBody(body)
	...
	public static class Builder {
		private final PostExternalcontactsBulkContactsUnresolvedRequest request;

		private Builder() {
			request = new PostExternalcontactsBulkContactsUnresolvedRequest();
		}
		...
		public PostExternalcontactsBulkContactsUnresolvedRequest build() {
