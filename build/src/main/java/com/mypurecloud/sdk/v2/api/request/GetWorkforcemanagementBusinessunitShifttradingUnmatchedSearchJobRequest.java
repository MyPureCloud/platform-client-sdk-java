...
public class GetWorkforcemanagementBusinessunitShifttradingUnmatchedSearchJobRequest {
	...
	public GetWorkforcemanagementBusinessunitShifttradingUnmatchedSearchJobRequest withBusinessUnitId(String businessUnitId) {
	...
	public GetWorkforcemanagementBusinessunitShifttradingUnmatchedSearchJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetWorkforcemanagementBusinessunitShifttradingUnmatchedSearchJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for GetWorkforcemanagementBusinessunitShifttradingUnmatchedSearchJobRequest.");
        }
        
        // verify the required parameter 'jobId' is set
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetWorkforcemanagementBusinessunitShifttradingUnmatchedSearchJobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/shifttrading/unmatched/search/jobs/{jobId}")
	...
	public static class Builder {
		private final GetWorkforcemanagementBusinessunitShifttradingUnmatchedSearchJobRequest request;

		private Builder() {
			request = new GetWorkforcemanagementBusinessunitShifttradingUnmatchedSearchJobRequest();
		}
		...
		public GetWorkforcemanagementBusinessunitShifttradingUnmatchedSearchJobRequest build() {
