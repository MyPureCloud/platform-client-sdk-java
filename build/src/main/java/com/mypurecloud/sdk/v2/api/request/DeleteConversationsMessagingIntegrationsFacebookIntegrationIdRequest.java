...
public class DeleteConversationsMessagingIntegrationsFacebookIntegrationIdRequest {
	...
	public DeleteConversationsMessagingIntegrationsFacebookIntegrationIdRequest withIntegrationId(String integrationId) {
    ...
    public DeleteConversationsMessagingIntegrationsFacebookIntegrationIdRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.integrationId == null) {
            throw new IllegalStateException("Missing the required parameter 'integrationId' when building request for DeleteConversationsMessagingIntegrationsFacebookIntegrationIdRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/conversations/messaging/integrations/facebook/{integrationId}")
	...
	public static class Builder {
		private final DeleteConversationsMessagingIntegrationsFacebookIntegrationIdRequest request;

		private Builder() {
			request = new DeleteConversationsMessagingIntegrationsFacebookIntegrationIdRequest();
		}
		...
		public DeleteConversationsMessagingIntegrationsFacebookIntegrationIdRequest build() {
