...
public class GetWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionExportHistoricalJobRequest {
	...
	public GetWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionExportHistoricalJobRequest withBusinessUnitId(String businessUnitId) {
	...
	public GetWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionExportHistoricalJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionExportHistoricalJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for GetWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionExportHistoricalJobRequest.");
        }
        
        // verify the required parameter 'jobId' is set
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionExportHistoricalJobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/mainforecast/continuousforecast/session/export/historical/jobs/{jobId}")
	...
	public static Builder builder(String businessUnitId, String jobId) {
	    return new Builder()
	            .withRequiredParams(businessUnitId, jobId);
	}


	public static class Builder {
		private final GetWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionExportHistoricalJobRequest request;

		private Builder() {
			request = new GetWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionExportHistoricalJobRequest();
		}
		...
		public Builder withRequiredParams(String businessUnitId, String jobId) {
			request.setBusinessUnitId(businessUnitId);
			request.setJobId(jobId);
		...
		public GetWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionExportHistoricalJobRequest build() {
