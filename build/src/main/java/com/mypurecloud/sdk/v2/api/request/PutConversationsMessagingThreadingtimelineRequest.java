...
public class PutConversationsMessagingThreadingtimelineRequest {
    
	private ConversationThreadingWindow body;
	public ConversationThreadingWindow getBody() {
		return this.body;
	}

	public void setBody(ConversationThreadingWindow body) {
		this.body = body;
	}

	public PutConversationsMessagingThreadingtimelineRequest withBody(ConversationThreadingWindow body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutConversationsMessagingThreadingtimelineRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<ConversationThreadingWindow> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutConversationsMessagingThreadingtimelineRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/conversations/messaging/threadingtimeline")
                .withBody(body)
	...
	public static Builder builder(ConversationThreadingWindow body) {
	    return new Builder()
	...
	public static class Builder {
		private final PutConversationsMessagingThreadingtimelineRequest request;

		private Builder() {
			request = new PutConversationsMessagingThreadingtimelineRequest();
		}

		
		public Builder withBody(ConversationThreadingWindow body) {
		...
		public Builder withRequiredParams(ConversationThreadingWindow body) {
			request.setBody(body);
		...
		public PutConversationsMessagingThreadingtimelineRequest build() {
