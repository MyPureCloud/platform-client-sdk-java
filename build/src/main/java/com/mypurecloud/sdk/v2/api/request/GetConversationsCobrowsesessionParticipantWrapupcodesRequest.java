...
public class GetConversationsCobrowsesessionParticipantWrapupcodesRequest {
	...
	public GetConversationsCobrowsesessionParticipantWrapupcodesRequest withParticipantId(String participantId) {
    ...
    public GetConversationsCobrowsesessionParticipantWrapupcodesRequest withCustomHeader(String name, String value) {
	...
	public static class Builder {
		private final GetConversationsCobrowsesessionParticipantWrapupcodesRequest request;
