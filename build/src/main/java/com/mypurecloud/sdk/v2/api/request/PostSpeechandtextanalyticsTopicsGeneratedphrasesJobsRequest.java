...
public class PostSpeechandtextanalyticsTopicsGeneratedphrasesJobsRequest {

	private GenAIPhrasesJobRequest body;
	public GenAIPhrasesJobRequest getBody() {
		return this.body;
	}

	public void setBody(GenAIPhrasesJobRequest body) {
		this.body = body;
	}

	public PostSpeechandtextanalyticsTopicsGeneratedphrasesJobsRequest withBody(GenAIPhrasesJobRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostSpeechandtextanalyticsTopicsGeneratedphrasesJobsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<GenAIPhrasesJobRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostSpeechandtextanalyticsTopicsGeneratedphrasesJobsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/speechandtextanalytics/topics/generatedphrases/jobs")
                .withBody(body)
	...
	public static Builder builder(GenAIPhrasesJobRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostSpeechandtextanalyticsTopicsGeneratedphrasesJobsRequest request;

		private Builder() {
			request = new PostSpeechandtextanalyticsTopicsGeneratedphrasesJobsRequest();
		}


		public Builder withBody(GenAIPhrasesJobRequest body) {
		...
		public Builder withRequiredParams(GenAIPhrasesJobRequest body) {
			request.setBody(body);
		...
		public PostSpeechandtextanalyticsTopicsGeneratedphrasesJobsRequest build() {
