...
public class GetConversationsVideoDetailsRequest {
	...
	public GetConversationsVideoDetailsRequest withConferenceId(String conferenceId) {
    ...
    public GetConversationsVideoDetailsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.conferenceId == null) {
            throw new IllegalStateException("Missing the required parameter 'conferenceId' when building request for GetConversationsVideoDetailsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/conversations/videos/{conferenceId}/details")
                .withPathParameter("conferenceId", conferenceId)
	...
	public static Builder builder(String conferenceId) {
	    return new Builder()
	            .withRequiredParams(conferenceId);
	}


	public static class Builder {
		private final GetConversationsVideoDetailsRequest request;

		private Builder() {
			request = new GetConversationsVideoDetailsRequest();
		}


		public Builder withConferenceId(String conferenceId) {
		...
		public Builder withRequiredParams(String conferenceId) {
			request.setConferenceId(conferenceId);
		...
		public GetConversationsVideoDetailsRequest build() {
            
            // verify the required parameter 'conferenceId' is set
            if (request.conferenceId == null) {
                throw new IllegalStateException("Missing the required parameter 'conferenceId' when building request for GetConversationsVideoDetailsRequest.");
            }
