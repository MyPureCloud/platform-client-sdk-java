...
public class CopilotAggregationSort  implements Serializable {
 ...
 @JsonDeserialize(using = FunctionEnumDeserializer.class)
   ...
   * Name of the metric used for sorting values.
   **/
  public CopilotAggregationSort name(NameEnum name) {
    this.name = name;
    return this;
  }
   ...
   * Aggregation function used for the sort metric.
   **/
  public CopilotAggregationSort function(FunctionEnum function) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CopilotAggregationSort copilotAggregationSort = (CopilotAggregationSort) o;

    return Objects.equals(this.name, copilotAggregationSort.name) &&
            Objects.equals(this.function, copilotAggregationSort.function);
  }
