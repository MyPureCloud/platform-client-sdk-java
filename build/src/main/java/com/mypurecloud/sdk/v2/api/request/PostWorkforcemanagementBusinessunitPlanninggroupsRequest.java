...
public class PostWorkforcemanagementBusinessunitPlanninggroupsRequest {
	...
	public PostWorkforcemanagementBusinessunitPlanninggroupsRequest withBusinessUnitId(String businessUnitId) {
	    this.setBusinessUnitId(businessUnitId);
	    return this;
	} 

	private CreatePlanningGroupRequest body;
	public CreatePlanningGroupRequest getBody() {
		return this.body;
	}

	public void setBody(CreatePlanningGroupRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementBusinessunitPlanninggroupsRequest withBody(CreatePlanningGroupRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementBusinessunitPlanninggroupsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<CreatePlanningGroupRequest> withHttpInfo() {
        
        // verify the required parameter 'businessUnitId' is set
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PostWorkforcemanagementBusinessunitPlanninggroupsRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementBusinessunitPlanninggroupsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/planninggroups")
	...
	public static Builder builder(String businessUnitId, CreatePlanningGroupRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementBusinessunitPlanninggroupsRequest request;

		private Builder() {
			request = new PostWorkforcemanagementBusinessunitPlanninggroupsRequest();
		}
		...
		public Builder withBody(CreatePlanningGroupRequest body) {
		...
		public Builder withRequiredParams(String businessUnitId, CreatePlanningGroupRequest body) {
			request.setBusinessUnitId(businessUnitId);
			request.setBody(body);
		...
		public PostWorkforcemanagementBusinessunitPlanninggroupsRequest build() {
