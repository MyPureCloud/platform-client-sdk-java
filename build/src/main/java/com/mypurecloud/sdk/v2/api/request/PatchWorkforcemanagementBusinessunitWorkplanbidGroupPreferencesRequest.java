...
public class PatchWorkforcemanagementBusinessunitWorkplanbidGroupPreferencesRequest {
	...
	public PatchWorkforcemanagementBusinessunitWorkplanbidGroupPreferencesRequest withBusinessUnitId(String businessUnitId) {
	...
	public PatchWorkforcemanagementBusinessunitWorkplanbidGroupPreferencesRequest withBidId(String bidId) {
	    this.setBidId(bidId);
	    return this;
	} 
	...
	public PatchWorkforcemanagementBusinessunitWorkplanbidGroupPreferencesRequest withBidGroupId(String bidGroupId) {
	    this.setBidGroupId(bidGroupId);
	    return this;
	} 

	private AgentsBidAssignedWorkPlanOverrideRequest body;
	public AgentsBidAssignedWorkPlanOverrideRequest getBody() {
		return this.body;
	}

	public void setBody(AgentsBidAssignedWorkPlanOverrideRequest body) {
		this.body = body;
	}

	public PatchWorkforcemanagementBusinessunitWorkplanbidGroupPreferencesRequest withBody(AgentsBidAssignedWorkPlanOverrideRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchWorkforcemanagementBusinessunitWorkplanbidGroupPreferencesRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<AgentsBidAssignedWorkPlanOverrideRequest> withHttpInfo() {
        
        // verify the required parameter 'businessUnitId' is set
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PatchWorkforcemanagementBusinessunitWorkplanbidGroupPreferencesRequest.");
        }
        
        // verify the required parameter 'bidId' is set
        if (this.bidId == null) {
            throw new IllegalStateException("Missing the required parameter 'bidId' when building request for PatchWorkforcemanagementBusinessunitWorkplanbidGroupPreferencesRequest.");
        }
        
        // verify the required parameter 'bidGroupId' is set
        if (this.bidGroupId == null) {
            throw new IllegalStateException("Missing the required parameter 'bidGroupId' when building request for PatchWorkforcemanagementBusinessunitWorkplanbidGroupPreferencesRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchWorkforcemanagementBusinessunitWorkplanbidGroupPreferencesRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/workplanbids/{bidId}/groups/{bidGroupId}/preferences")
	...
	public static Builder builder(String businessUnitId, String bidId, String bidGroupId, AgentsBidAssignedWorkPlanOverrideRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PatchWorkforcemanagementBusinessunitWorkplanbidGroupPreferencesRequest request;

		private Builder() {
			request = new PatchWorkforcemanagementBusinessunitWorkplanbidGroupPreferencesRequest();
		}
		...
		public Builder withBody(AgentsBidAssignedWorkPlanOverrideRequest body) {
		...
		public Builder withRequiredParams(String businessUnitId, String bidId, String bidGroupId, AgentsBidAssignedWorkPlanOverrideRequest body) {
			request.setBusinessUnitId(businessUnitId);
			request.setBidId(bidId);
			request.setBidGroupId(bidGroupId);
			request.setBody(body);
		...
		public PatchWorkforcemanagementBusinessunitWorkplanbidGroupPreferencesRequest build() {
