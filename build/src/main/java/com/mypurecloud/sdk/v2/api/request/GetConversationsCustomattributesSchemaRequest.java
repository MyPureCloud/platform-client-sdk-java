...
public class GetConversationsCustomattributesSchemaRequest {
	...
	public GetConversationsCustomattributesSchemaRequest withSchemaId(String schemaId) {
    ...
    public GetConversationsCustomattributesSchemaRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.schemaId == null) {
            throw new IllegalStateException("Missing the required parameter 'schemaId' when building request for GetConversationsCustomattributesSchemaRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/conversations/customattributes/schemas/{schemaId}")
	...
	public static class Builder {
		private final GetConversationsCustomattributesSchemaRequest request;

		private Builder() {
			request = new GetConversationsCustomattributesSchemaRequest();
		}
		...
		public GetConversationsCustomattributesSchemaRequest build() {
