...
public class GetTelephonyProvidersEdgeDiagnosticNslookupRequest {
	...
	public GetTelephonyProvidersEdgeDiagnosticNslookupRequest withEdgeId(String edgeId) {
    ...
    public GetTelephonyProvidersEdgeDiagnosticNslookupRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.edgeId == null) {
            throw new IllegalStateException("Missing the required parameter 'edgeId' when building request for GetTelephonyProvidersEdgeDiagnosticNslookupRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/telephony/providers/edges/{edgeId}/diagnostic/nslookup")
	...
	public static class Builder {
		private final GetTelephonyProvidersEdgeDiagnosticNslookupRequest request;

		private Builder() {
			request = new GetTelephonyProvidersEdgeDiagnosticNslookupRequest();
		}
		...
		public GetTelephonyProvidersEdgeDiagnosticNslookupRequest build() {
