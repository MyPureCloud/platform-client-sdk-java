...
public class GetTaskmanagementWorkitemsBulkTerminateJobResultsRequest {
	...
	public GetTaskmanagementWorkitemsBulkTerminateJobResultsRequest withBulkJobId(String bulkJobId) {
    ...
    public GetTaskmanagementWorkitemsBulkTerminateJobResultsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.bulkJobId == null) {
            throw new IllegalStateException("Missing the required parameter 'bulkJobId' when building request for GetTaskmanagementWorkitemsBulkTerminateJobResultsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/taskmanagement/workitems/bulk/terminate/jobs/{bulkJobId}/results")
	...
	public static Builder builder(String bulkJobId) {
	    return new Builder()
	            .withRequiredParams(bulkJobId);
	}


	public static class Builder {
		private final GetTaskmanagementWorkitemsBulkTerminateJobResultsRequest request;

		private Builder() {
			request = new GetTaskmanagementWorkitemsBulkTerminateJobResultsRequest();
		}
		...
		public Builder withRequiredParams(String bulkJobId) {
			request.setBulkJobId(bulkJobId);
		...
		public GetTaskmanagementWorkitemsBulkTerminateJobResultsRequest build() {
