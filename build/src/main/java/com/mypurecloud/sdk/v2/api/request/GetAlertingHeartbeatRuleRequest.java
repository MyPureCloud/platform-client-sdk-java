...
public class GetAlertingHeartbeatRuleRequest {
	...
	public GetAlertingHeartbeatRuleRequest withRuleId(String ruleId) {
	...
	public GetAlertingHeartbeatRuleRequest withExpand(List<String> expand) {
    ...
    public GetAlertingHeartbeatRuleRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.ruleId == null) {
            throw new IllegalStateException("Missing the required parameter 'ruleId' when building request for GetAlertingHeartbeatRuleRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/alerting/heartbeat/rules/{ruleId}")
