...
public class DeleteTeamRequest {
	...
	public DeleteTeamRequest withTeamId(String teamId) {
    ...
    public DeleteTeamRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.teamId == null) {
            throw new IllegalStateException("Missing the required parameter 'teamId' when building request for DeleteTeamRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/teams/{teamId}")
	...
	public static class Builder {
		private final DeleteTeamRequest request;
