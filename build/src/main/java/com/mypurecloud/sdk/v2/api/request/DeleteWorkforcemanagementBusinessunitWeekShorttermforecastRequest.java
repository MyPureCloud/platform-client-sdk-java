...
public class DeleteWorkforcemanagementBusinessunitWeekShorttermforecastRequest {
	...
	public DeleteWorkforcemanagementBusinessunitWeekShorttermforecastRequest withBusinessUnitId(String businessUnitId) {
	...
	public DeleteWorkforcemanagementBusinessunitWeekShorttermforecastRequest withWeekDateId(LocalDate weekDateId) {
	...
	public DeleteWorkforcemanagementBusinessunitWeekShorttermforecastRequest withForecastId(String forecastId) {
    ...
    public DeleteWorkforcemanagementBusinessunitWeekShorttermforecastRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for DeleteWorkforcemanagementBusinessunitWeekShorttermforecastRequest.");
        }
        
        // verify the required parameter 'weekDateId' is set
        if (this.weekDateId == null) {
            throw new IllegalStateException("Missing the required parameter 'weekDateId' when building request for DeleteWorkforcemanagementBusinessunitWeekShorttermforecastRequest.");
        }
        
        // verify the required parameter 'forecastId' is set
        if (this.forecastId == null) {
            throw new IllegalStateException("Missing the required parameter 'forecastId' when building request for DeleteWorkforcemanagementBusinessunitWeekShorttermforecastRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/weeks/{weekDateId}/shorttermforecasts/{forecastId}")
	...
	public static class Builder {
		private final DeleteWorkforcemanagementBusinessunitWeekShorttermforecastRequest request;

		private Builder() {
			request = new DeleteWorkforcemanagementBusinessunitWeekShorttermforecastRequest();
		}
		...
		public DeleteWorkforcemanagementBusinessunitWeekShorttermforecastRequest build() {
