...
public class GetWorkforcemanagementAgentManagementunitRequest {
	...
	public GetWorkforcemanagementAgentManagementunitRequest withAgentId(String agentId) {
    ...
    public GetWorkforcemanagementAgentManagementunitRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.agentId == null) {
            throw new IllegalStateException("Missing the required parameter 'agentId' when building request for GetWorkforcemanagementAgentManagementunitRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/agents/{agentId}/managementunit")
	...
	public static class Builder {
		private final GetWorkforcemanagementAgentManagementunitRequest request;

		private Builder() {
			request = new GetWorkforcemanagementAgentManagementunitRequest();
		}
		...
		public GetWorkforcemanagementAgentManagementunitRequest build() {
