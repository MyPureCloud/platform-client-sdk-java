...
public class PostTelephonyProvidersEdgeDiagnosticTracepathRequest {
	...
	public PostTelephonyProvidersEdgeDiagnosticTracepathRequest withEdgeId(String edgeId) {
	...
	public PostTelephonyProvidersEdgeDiagnosticTracepathRequest withBody(EdgeNetworkDiagnosticRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostTelephonyProvidersEdgeDiagnosticTracepathRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<EdgeNetworkDiagnosticRequest> withHttpInfo() {
        ...
        if (this.edgeId == null) {
            throw new IllegalStateException("Missing the required parameter 'edgeId' when building request for PostTelephonyProvidersEdgeDiagnosticTracepathRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostTelephonyProvidersEdgeDiagnosticTracepathRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/telephony/providers/edges/{edgeId}/diagnostic/tracepath")
	...
	public static class Builder {
		private final PostTelephonyProvidersEdgeDiagnosticTracepathRequest request;

		private Builder() {
			request = new PostTelephonyProvidersEdgeDiagnosticTracepathRequest();
		}
		...
		public PostTelephonyProvidersEdgeDiagnosticTracepathRequest build() {
