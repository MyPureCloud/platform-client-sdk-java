...
public class PutArchitectIvrIdentityresolutionRequest {
	...
	public PutArchitectIvrIdentityresolutionRequest withIvrId(String ivrId) {
	    this.setIvrId(ivrId);
	    return this;
	} 
    ...
    public PutArchitectIvrIdentityresolutionRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<IVRIdentityResolutionConfig> withHttpInfo() {
        ...
        if (this.ivrId == null) {
            throw new IllegalStateException("Missing the required parameter 'ivrId' when building request for PutArchitectIvrIdentityresolutionRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutArchitectIvrIdentityresolutionRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/architect/ivrs/{ivrId}/identityresolution")
	...
	public static class Builder {
		private final PutArchitectIvrIdentityresolutionRequest request;

		private Builder() {
			request = new PutArchitectIvrIdentityresolutionRequest();
		}
		...
		public PutArchitectIvrIdentityresolutionRequest build() {
