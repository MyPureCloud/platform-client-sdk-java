...
public class GetTaskmanagementWorkbinHistoryRequest {
	...
	public GetTaskmanagementWorkbinHistoryRequest withWorkbinId(String workbinId) {
	...
	public GetTaskmanagementWorkbinHistoryRequest withAfter(String after) {
	    this.setAfter(after);
	    return this;
	} 
	...
	public GetTaskmanagementWorkbinHistoryRequest withPageSize(Integer pageSize) {
	...
	public GetTaskmanagementWorkbinHistoryRequest withSortOrder(String sortOrder) {
    ...
    public GetTaskmanagementWorkbinHistoryRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.workbinId == null) {
            throw new IllegalStateException("Missing the required parameter 'workbinId' when building request for GetTaskmanagementWorkbinHistoryRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/taskmanagement/workbins/{workbinId}/history")
	...
	public static class Builder {
		private final GetTaskmanagementWorkbinHistoryRequest request;

		private Builder() {
			request = new GetTaskmanagementWorkbinHistoryRequest();
		}
		...
		public GetTaskmanagementWorkbinHistoryRequest build() {
