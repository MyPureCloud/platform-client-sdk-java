...
public class PostGamificationProfilesUsersMeQueryRequest {
	...
	public PostGamificationProfilesUsersMeQueryRequest withBody(UserProfilesInDateRangeRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostGamificationProfilesUsersMeQueryRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<UserProfilesInDateRangeRequest> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("POST", "/api/v2/gamification/profiles/users/me/query")
                .withBody(body)
	...
	public static Builder builder(UserProfilesInDateRangeRequest body) {
	    return new Builder()
	...
	public static class Builder {
		...
		private Builder() {
			request = new PostGamificationProfilesUsersMeQueryRequest();
		}
		...
		public Builder withRequiredParams(UserProfilesInDateRangeRequest body) {
			request.setBody(body);
