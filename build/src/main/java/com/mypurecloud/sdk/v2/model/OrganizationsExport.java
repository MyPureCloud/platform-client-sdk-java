...
import com.mypurecloud.sdk.v2.model.OrganizationsExportQueryConditions;
...
public class OrganizationsExport  implements Serializable {
 ...
 @JsonDeserialize(using = StatusEnumDeserializer.class)
  ...
  private OrganizationsExportQueryConditions queryConditions = null;
  private String selfUri = null;

  public OrganizationsExport() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
      divisionIds = new ArrayList<String>();
    }
  }

  public OrganizationsExport(Boolean initWithEmptyList) {
   ...
   **/
  public OrganizationsExport divisionIds(List<String> divisionIds) {
   ...
   **/
  public OrganizationsExport queryConditions(OrganizationsExportQueryConditions queryConditions) {
  ...
  public OrganizationsExportQueryConditions getQueryConditions() {
    return queryConditions;
  }
  public void setQueryConditions(OrganizationsExportQueryConditions queryConditions) {
    this.queryConditions = queryConditions;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    OrganizationsExport organizationsExport = (OrganizationsExport) o;

    return Objects.equals(this.id, organizationsExport.id) &&
            Objects.equals(this.divisionIds, organizationsExport.divisionIds) &&
            Objects.equals(this.createdBy, organizationsExport.createdBy) &&
            Objects.equals(this.dateCreated, organizationsExport.dateCreated) &&
            Objects.equals(this.dateCompletion, organizationsExport.dateCompletion) &&
            Objects.equals(this.status, organizationsExport.status) &&
            Objects.equals(this.downloadUrl, organizationsExport.downloadUrl) &&
            Objects.equals(this.resultRowCount, organizationsExport.resultRowCount) &&
            Objects.equals(this.queryConditions, organizationsExport.queryConditions) &&
            Objects.equals(this.selfUri, organizationsExport.selfUri);
  }
  ...
  public String toString() {
    ...
    sb.append("class OrganizationsExport {\n");
