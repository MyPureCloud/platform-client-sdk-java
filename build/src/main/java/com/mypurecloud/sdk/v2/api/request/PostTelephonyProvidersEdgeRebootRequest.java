...
public class PostTelephonyProvidersEdgeRebootRequest {
    ...
    public ApiRequest<EdgeRebootParameters> withHttpInfo() {
        
        // verify the required parameter 'edgeId' is set
        if (this.edgeId == null) {
            throw new IllegalStateException("Missing the required parameter 'edgeId' when building request for PostTelephonyProvidersEdgeRebootRequest.");
        }
