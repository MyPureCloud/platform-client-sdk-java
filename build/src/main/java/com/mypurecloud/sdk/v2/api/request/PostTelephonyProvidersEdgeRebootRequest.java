...
public class PostTelephonyProvidersEdgeRebootRequest {
	...
	public void setBody(EdgeRebootParameters body) {
		this.body = body;
	}
    ...
    public PostTelephonyProvidersEdgeRebootRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<EdgeRebootParameters> withHttpInfo() throws ApiException {
        
        // verify the required parameter 'edgeId' is set
        if (this.edgeId == null) {
            throw new ApiException(400, "Missing the required parameter 'edgeId' when building request for PostTelephonyProvidersEdgeRebootRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/telephony/providers/edges/{edgeId}/reboot")
