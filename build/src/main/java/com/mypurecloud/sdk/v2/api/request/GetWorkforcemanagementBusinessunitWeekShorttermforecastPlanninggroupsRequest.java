...
public class GetWorkforcemanagementBusinessunitWeekShorttermforecastPlanninggroupsRequest {
	...
	public GetWorkforcemanagementBusinessunitWeekShorttermforecastPlanninggroupsRequest withBusinessUnitId(String businessUnitId) {
	...
	public GetWorkforcemanagementBusinessunitWeekShorttermforecastPlanninggroupsRequest withWeekDateId(LocalDate weekDateId) {
	...
	public GetWorkforcemanagementBusinessunitWeekShorttermforecastPlanninggroupsRequest withForecastId(String forecastId) {
    ...
    public GetWorkforcemanagementBusinessunitWeekShorttermforecastPlanninggroupsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for GetWorkforcemanagementBusinessunitWeekShorttermforecastPlanninggroupsRequest.");
        }
        
        // verify the required parameter 'weekDateId' is set
        if (this.weekDateId == null) {
            throw new IllegalStateException("Missing the required parameter 'weekDateId' when building request for GetWorkforcemanagementBusinessunitWeekShorttermforecastPlanninggroupsRequest.");
        }
        
        // verify the required parameter 'forecastId' is set
        if (this.forecastId == null) {
            throw new IllegalStateException("Missing the required parameter 'forecastId' when building request for GetWorkforcemanagementBusinessunitWeekShorttermforecastPlanninggroupsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/weeks/{weekDateId}/shorttermforecasts/{forecastId}/planninggroups")
	...
	public static class Builder {
		private final GetWorkforcemanagementBusinessunitWeekShorttermforecastPlanninggroupsRequest request;

		private Builder() {
			request = new GetWorkforcemanagementBusinessunitWeekShorttermforecastPlanninggroupsRequest();
		}
		...
		public GetWorkforcemanagementBusinessunitWeekShorttermforecastPlanninggroupsRequest build() {
