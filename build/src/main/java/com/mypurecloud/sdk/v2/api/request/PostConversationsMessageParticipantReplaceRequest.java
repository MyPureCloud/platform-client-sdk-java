...
public class PostConversationsMessageParticipantReplaceRequest {
	...
	public PostConversationsMessageParticipantReplaceRequest withConversationId(String conversationId) {
	...
	public PostConversationsMessageParticipantReplaceRequest withParticipantId(String participantId) {
	...
	public PostConversationsMessageParticipantReplaceRequest withBody(TransferRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostConversationsMessageParticipantReplaceRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<TransferRequest> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PostConversationsMessageParticipantReplaceRequest.");
        }
        
        // verify the required parameter 'participantId' is set
        if (this.participantId == null) {
            throw new IllegalStateException("Missing the required parameter 'participantId' when building request for PostConversationsMessageParticipantReplaceRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostConversationsMessageParticipantReplaceRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/conversations/messages/{conversationId}/participants/{participantId}/replace")
	...
	public static class Builder {
		private final PostConversationsMessageParticipantReplaceRequest request;

		private Builder() {
			request = new PostConversationsMessageParticipantReplaceRequest();
		}
		...
		public PostConversationsMessageParticipantReplaceRequest build() {
