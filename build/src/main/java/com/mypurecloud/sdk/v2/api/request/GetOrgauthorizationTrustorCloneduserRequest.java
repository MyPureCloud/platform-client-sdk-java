...
public class GetOrgauthorizationTrustorCloneduserRequest {
	...
	public GetOrgauthorizationTrustorCloneduserRequest withTrustorOrgId(String trustorOrgId) {
	...
	public GetOrgauthorizationTrustorCloneduserRequest withTrusteeUserId(String trusteeUserId) {
    ...
    public GetOrgauthorizationTrustorCloneduserRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.trustorOrgId == null) {
            throw new IllegalStateException("Missing the required parameter 'trustorOrgId' when building request for GetOrgauthorizationTrustorCloneduserRequest.");
        }
        
        // verify the required parameter 'trusteeUserId' is set
        if (this.trusteeUserId == null) {
            throw new IllegalStateException("Missing the required parameter 'trusteeUserId' when building request for GetOrgauthorizationTrustorCloneduserRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/orgauthorization/trustors/{trustorOrgId}/clonedusers/{trusteeUserId}")
	...
	public static class Builder {
		private final GetOrgauthorizationTrustorCloneduserRequest request;

		private Builder() {
			request = new GetOrgauthorizationTrustorCloneduserRequest();
		}
		...
		public GetOrgauthorizationTrustorCloneduserRequest build() {
