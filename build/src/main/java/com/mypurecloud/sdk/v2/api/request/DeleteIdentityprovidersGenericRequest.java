...
public class DeleteIdentityprovidersGenericRequest {
    ...
    public DeleteIdentityprovidersGenericRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("DELETE", "/api/v2/identityproviders/generic")
	...
	public static class Builder {
		private final DeleteIdentityprovidersGenericRequest request;

		private Builder() {
			request = new DeleteIdentityprovidersGenericRequest();
		}
		...
		public DeleteIdentityprovidersGenericRequest build() {
