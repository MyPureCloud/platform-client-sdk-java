...
public class PatchKnowledgeKnowledgebaseDocumentRequest {
    ...
    public ApiRequest<KnowledgeDocumentReq> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("PATCH", "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/documents/{documentId}")
	...
	public static class Builder {
		private final PatchKnowledgeKnowledgebaseDocumentRequest request;

		private Builder() {
			request = new PatchKnowledgeKnowledgebaseDocumentRequest();
		}
