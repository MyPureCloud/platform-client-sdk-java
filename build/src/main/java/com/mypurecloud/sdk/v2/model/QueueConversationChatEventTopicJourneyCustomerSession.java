...
public class QueueConversationChatEventTopicJourneyCustomerSession  implements Serializable {
  
  private String id = null;
  private String type = null;

  public QueueConversationChatEventTopicJourneyCustomerSession() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
    }
  }

  public QueueConversationChatEventTopicJourneyCustomerSession(Boolean initWithEmptyList) {
   ...
   **/
  public QueueConversationChatEventTopicJourneyCustomerSession id(String id) {
    this.id = id;
    return this;
  }
   ...
   **/
  public QueueConversationChatEventTopicJourneyCustomerSession type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    QueueConversationChatEventTopicJourneyCustomerSession queueConversationChatEventTopicJourneyCustomerSession = (QueueConversationChatEventTopicJourneyCustomerSession) o;

    return Objects.equals(this.id, queueConversationChatEventTopicJourneyCustomerSession.id) &&
            Objects.equals(this.type, queueConversationChatEventTopicJourneyCustomerSession.type);
  }
