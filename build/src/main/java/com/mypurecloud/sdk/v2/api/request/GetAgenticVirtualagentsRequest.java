...
public class GetAgenticVirtualagentsRequest {
	...
	public GetAgenticVirtualagentsRequest withName(String name) {
	    this.setName(name);
	    return this;
	} 
	...
	public GetAgenticVirtualagentsRequest withNameContains(String nameContains) {
	...
	public GetAgenticVirtualagentsRequest withStatus(String status) {
	...
	public GetAgenticVirtualagentsRequest withSortBy(String sortBy) {
	...
	public GetAgenticVirtualagentsRequest withSortOrder(String sortOrder) {
	...
	public GetAgenticVirtualagentsRequest withPageNumber(Integer pageNumber) {
	...
	public GetAgenticVirtualagentsRequest withPageSize(Integer pageSize) {
    ...
    public GetAgenticVirtualagentsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/agentic/virtualagents")
	...
	public static class Builder {
		private final GetAgenticVirtualagentsRequest request;

		private Builder() {
			request = new GetAgenticVirtualagentsRequest();
		}
		...
		public GetAgenticVirtualagentsRequest build() {
