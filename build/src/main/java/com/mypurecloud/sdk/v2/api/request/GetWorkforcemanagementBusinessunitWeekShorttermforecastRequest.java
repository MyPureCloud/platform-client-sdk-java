...
public class GetWorkforcemanagementBusinessunitWeekShorttermforecastRequest {
	...
	public GetWorkforcemanagementBusinessunitWeekShorttermforecastRequest withBusinessUnitId(String businessUnitId) {
	...
	public GetWorkforcemanagementBusinessunitWeekShorttermforecastRequest withWeekDateId(LocalDate weekDateId) {
	...
	public GetWorkforcemanagementBusinessunitWeekShorttermforecastRequest withForecastId(String forecastId) {
	...
	public GetWorkforcemanagementBusinessunitWeekShorttermforecastRequest withExpand(List<String> expand) {
    ...
    public GetWorkforcemanagementBusinessunitWeekShorttermforecastRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for GetWorkforcemanagementBusinessunitWeekShorttermforecastRequest.");
        }
        
        // verify the required parameter 'weekDateId' is set
        if (this.weekDateId == null) {
            throw new IllegalStateException("Missing the required parameter 'weekDateId' when building request for GetWorkforcemanagementBusinessunitWeekShorttermforecastRequest.");
        }
        
        // verify the required parameter 'forecastId' is set
        if (this.forecastId == null) {
            throw new IllegalStateException("Missing the required parameter 'forecastId' when building request for GetWorkforcemanagementBusinessunitWeekShorttermforecastRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/weeks/{weekDateId}/shorttermforecasts/{forecastId}")
	...
	public static class Builder {
		private final GetWorkforcemanagementBusinessunitWeekShorttermforecastRequest request;

		private Builder() {
			request = new GetWorkforcemanagementBusinessunitWeekShorttermforecastRequest();
		}
		...
		public GetWorkforcemanagementBusinessunitWeekShorttermforecastRequest build() {
