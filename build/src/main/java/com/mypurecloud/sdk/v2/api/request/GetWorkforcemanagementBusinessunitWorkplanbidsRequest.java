...
public class GetWorkforcemanagementBusinessunitWorkplanbidsRequest {
	...
	public GetWorkforcemanagementBusinessunitWorkplanbidsRequest withBusinessUnitId(String businessUnitId) {
    ...
    public GetWorkforcemanagementBusinessunitWorkplanbidsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for GetWorkforcemanagementBusinessunitWorkplanbidsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/workplanbids")
	...
	public static class Builder {
		private final GetWorkforcemanagementBusinessunitWorkplanbidsRequest request;

		private Builder() {
			request = new GetWorkforcemanagementBusinessunitWorkplanbidsRequest();
		}
		...
		public GetWorkforcemanagementBusinessunitWorkplanbidsRequest build() {
