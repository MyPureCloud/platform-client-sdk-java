...
public class PutUserVerifierRequest {
    ...
    public ApiRequest<UpdateVerifierRequest> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("PUT", "/api/v2/users/{userId}/verifiers/{verifierId}")
	...
	public static Builder builder(String userId, String verifierId, UpdateVerifierRequest body) {
	    return new Builder()
	            .withRequiredParams(userId, verifierId, body);
	}


	public static class Builder {
		private final PutUserVerifierRequest request;

		private Builder() {
			request = new PutUserVerifierRequest();
		}
