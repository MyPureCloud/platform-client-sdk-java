...
public class GetOutboundDnclistsDivisionviewRequest {
	...
	public GetOutboundDnclistsDivisionviewRequest withDncListId(String dncListId) {
	...
	public GetOutboundDnclistsDivisionviewRequest withIncludeImportStatus(Boolean includeImportStatus) {
	...
	public GetOutboundDnclistsDivisionviewRequest withIncludeSize(Boolean includeSize) {
    ...
    public GetOutboundDnclistsDivisionviewRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.dncListId == null) {
            throw new IllegalStateException("Missing the required parameter 'dncListId' when building request for GetOutboundDnclistsDivisionviewRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/outbound/dnclists/divisionviews/{dncListId}")
	...
	public static class Builder {
		private final GetOutboundDnclistsDivisionviewRequest request;

		private Builder() {
			request = new GetOutboundDnclistsDivisionviewRequest();
		}
		...
		public GetOutboundDnclistsDivisionviewRequest build() {
