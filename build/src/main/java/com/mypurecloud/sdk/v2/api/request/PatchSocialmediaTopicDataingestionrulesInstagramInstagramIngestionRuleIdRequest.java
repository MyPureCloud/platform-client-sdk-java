...
public class PatchSocialmediaTopicDataingestionrulesInstagramInstagramIngestionRuleIdRequest {
	...
	public PatchSocialmediaTopicDataingestionrulesInstagramInstagramIngestionRuleIdRequest withTopicId(String topicId) {
	...
	public PatchSocialmediaTopicDataingestionrulesInstagramInstagramIngestionRuleIdRequest withInstagramIngestionRuleId(String instagramIngestionRuleId) {
	    this.setInstagramIngestionRuleId(instagramIngestionRuleId);
	    return this;
	} 

	private DataIngestionRuleStatusPatchRequest body;
	public DataIngestionRuleStatusPatchRequest getBody() {
		return this.body;
	}

	public void setBody(DataIngestionRuleStatusPatchRequest body) {
		this.body = body;
	}

	public PatchSocialmediaTopicDataingestionrulesInstagramInstagramIngestionRuleIdRequest withBody(DataIngestionRuleStatusPatchRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchSocialmediaTopicDataingestionrulesInstagramInstagramIngestionRuleIdRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<DataIngestionRuleStatusPatchRequest> withHttpInfo() {
        
        // verify the required parameter 'topicId' is set
        if (this.topicId == null) {
            throw new IllegalStateException("Missing the required parameter 'topicId' when building request for PatchSocialmediaTopicDataingestionrulesInstagramInstagramIngestionRuleIdRequest.");
        }
        
        // verify the required parameter 'instagramIngestionRuleId' is set
        if (this.instagramIngestionRuleId == null) {
            throw new IllegalStateException("Missing the required parameter 'instagramIngestionRuleId' when building request for PatchSocialmediaTopicDataingestionrulesInstagramInstagramIngestionRuleIdRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/socialmedia/topics/{topicId}/dataingestionrules/instagram/{instagramIngestionRuleId}")
	...
	public static Builder builder(String topicId, String instagramIngestionRuleId) {
	    return new Builder()
	            .withRequiredParams(topicId, instagramIngestionRuleId);
	}


	public static class Builder {
		private final PatchSocialmediaTopicDataingestionrulesInstagramInstagramIngestionRuleIdRequest request;

		private Builder() {
			request = new PatchSocialmediaTopicDataingestionrulesInstagramInstagramIngestionRuleIdRequest();
		}
		...
		public Builder withBody(DataIngestionRuleStatusPatchRequest body) {
		...
		public Builder withRequiredParams(String topicId, String instagramIngestionRuleId) {
			request.setTopicId(topicId);
			request.setInstagramIngestionRuleId(instagramIngestionRuleId);
		...
		public PatchSocialmediaTopicDataingestionrulesInstagramInstagramIngestionRuleIdRequest build() {
