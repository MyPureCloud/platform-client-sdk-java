...
public class GetAnalyticsDataretentionSettingsRequest {
    ...
    public GetAnalyticsDataretentionSettingsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/analytics/dataretention/settings")
	...
	public static class Builder {
		private final GetAnalyticsDataretentionSettingsRequest request;

		private Builder() {
			request = new GetAnalyticsDataretentionSettingsRequest();
		}
		...
		public GetAnalyticsDataretentionSettingsRequest build() {
