...
public class PostWorkforcemanagementBusinessunitWeekSchedulesImportRequest {
    ...
    public ApiRequest<WfmProcessUploadRequest> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/weeks/{weekId}/schedules/import")
	...
	public static class Builder {
		private final PostWorkforcemanagementBusinessunitWeekSchedulesImportRequest request;

		private Builder() {
			request = new PostWorkforcemanagementBusinessunitWeekSchedulesImportRequest();
		}
