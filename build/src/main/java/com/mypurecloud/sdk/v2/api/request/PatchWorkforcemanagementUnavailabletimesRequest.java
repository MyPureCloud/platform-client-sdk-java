...
public class PatchWorkforcemanagementUnavailabletimesRequest {

	private UpdateUnavailableTimesRequest body;
	public UpdateUnavailableTimesRequest getBody() {
		return this.body;
	}

	public void setBody(UpdateUnavailableTimesRequest body) {
		this.body = body;
	}

	public PatchWorkforcemanagementUnavailabletimesRequest withBody(UpdateUnavailableTimesRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchWorkforcemanagementUnavailabletimesRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<UpdateUnavailableTimesRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchWorkforcemanagementUnavailabletimesRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/workforcemanagement/unavailabletimes")
                .withBody(body)
	...
	public static Builder builder(UpdateUnavailableTimesRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PatchWorkforcemanagementUnavailabletimesRequest request;

		private Builder() {
			request = new PatchWorkforcemanagementUnavailabletimesRequest();
		}


		public Builder withBody(UpdateUnavailableTimesRequest body) {
		...
		public Builder withRequiredParams(UpdateUnavailableTimesRequest body) {
			request.setBody(body);
		...
		public PatchWorkforcemanagementUnavailabletimesRequest build() {
