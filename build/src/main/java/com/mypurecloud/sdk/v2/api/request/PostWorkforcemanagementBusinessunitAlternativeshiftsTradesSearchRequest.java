...
public class PostWorkforcemanagementBusinessunitAlternativeshiftsTradesSearchRequest {
	...
	public PostWorkforcemanagementBusinessunitAlternativeshiftsTradesSearchRequest withBusinessUnitId(String businessUnitId) {
	    this.setBusinessUnitId(businessUnitId);
	    return this;
	} 

	private SearchAlternativeShiftTradesRequest body;
	public SearchAlternativeShiftTradesRequest getBody() {
		return this.body;
	}

	public void setBody(SearchAlternativeShiftTradesRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementBusinessunitAlternativeshiftsTradesSearchRequest withBody(SearchAlternativeShiftTradesRequest body) {
	    this.setBody(body);
	    return this;
	} 
	...
	public PostWorkforcemanagementBusinessunitAlternativeshiftsTradesSearchRequest withForceAsync(Boolean forceAsync) {
    ...
    public PostWorkforcemanagementBusinessunitAlternativeshiftsTradesSearchRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<SearchAlternativeShiftTradesRequest> withHttpInfo() {
        
        // verify the required parameter 'businessUnitId' is set
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PostWorkforcemanagementBusinessunitAlternativeshiftsTradesSearchRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementBusinessunitAlternativeshiftsTradesSearchRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/alternativeshifts/trades/search")
	...
	public static Builder builder(String businessUnitId, SearchAlternativeShiftTradesRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementBusinessunitAlternativeshiftsTradesSearchRequest request;

		private Builder() {
			request = new PostWorkforcemanagementBusinessunitAlternativeshiftsTradesSearchRequest();
		}
		...
		public Builder withBody(SearchAlternativeShiftTradesRequest body) {
		...
		public Builder withRequiredParams(String businessUnitId, SearchAlternativeShiftTradesRequest body) {
			request.setBusinessUnitId(businessUnitId);
			request.setBody(body);
		...
		public PostWorkforcemanagementBusinessunitAlternativeshiftsTradesSearchRequest build() {
