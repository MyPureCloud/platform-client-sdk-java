...
public class PutSpeechandtextanalyticsProgramMappingsRequest {
	...
	public PutSpeechandtextanalyticsProgramMappingsRequest withProgramId(String programId) {
	    this.setProgramId(programId);
	    return this;
	} 
	
	private ProgramMappingsRequest body;
	public ProgramMappingsRequest getBody() {
		return this.body;
	}

	public void setBody(ProgramMappingsRequest body) {
		this.body = body;
	}

	public PutSpeechandtextanalyticsProgramMappingsRequest withBody(ProgramMappingsRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutSpeechandtextanalyticsProgramMappingsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<ProgramMappingsRequest> withHttpInfo() {
        
        // verify the required parameter 'programId' is set
        if (this.programId == null) {
            throw new IllegalStateException("Missing the required parameter 'programId' when building request for PutSpeechandtextanalyticsProgramMappingsRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutSpeechandtextanalyticsProgramMappingsRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/speechandtextanalytics/programs/{programId}/mappings")
	...
	public static Builder builder(String programId, ProgramMappingsRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PutSpeechandtextanalyticsProgramMappingsRequest request;

		private Builder() {
			request = new PutSpeechandtextanalyticsProgramMappingsRequest();
		}
		...
		public Builder withBody(ProgramMappingsRequest body) {
		...
		public Builder withRequiredParams(String programId, ProgramMappingsRequest body) {
			request.setProgramId(programId);
						request.setBody(body);
		...
		public PutSpeechandtextanalyticsProgramMappingsRequest build() {
