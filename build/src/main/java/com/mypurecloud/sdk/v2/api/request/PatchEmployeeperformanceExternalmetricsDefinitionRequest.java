...
public class PatchEmployeeperformanceExternalmetricsDefinitionRequest {
	...
	public PatchEmployeeperformanceExternalmetricsDefinitionRequest withMetricId(String metricId) {
	    this.setMetricId(metricId);
	    return this;
	} 

	private ExternalMetricDefinitionUpdateRequest body;
	public ExternalMetricDefinitionUpdateRequest getBody() {
		return this.body;
	}

	public void setBody(ExternalMetricDefinitionUpdateRequest body) {
		this.body = body;
	}

	public PatchEmployeeperformanceExternalmetricsDefinitionRequest withBody(ExternalMetricDefinitionUpdateRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchEmployeeperformanceExternalmetricsDefinitionRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<ExternalMetricDefinitionUpdateRequest> withHttpInfo() {
        
        // verify the required parameter 'metricId' is set
        if (this.metricId == null) {
            throw new IllegalStateException("Missing the required parameter 'metricId' when building request for PatchEmployeeperformanceExternalmetricsDefinitionRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchEmployeeperformanceExternalmetricsDefinitionRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/employeeperformance/externalmetrics/definitions/{metricId}")
	...
	public static Builder builder(String metricId, ExternalMetricDefinitionUpdateRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PatchEmployeeperformanceExternalmetricsDefinitionRequest request;

		private Builder() {
			request = new PatchEmployeeperformanceExternalmetricsDefinitionRequest();
		}
		...
		public Builder withBody(ExternalMetricDefinitionUpdateRequest body) {
		...
		public Builder withRequiredParams(String metricId, ExternalMetricDefinitionUpdateRequest body) {
			request.setMetricId(metricId);
			request.setBody(body);
		...
		public PatchEmployeeperformanceExternalmetricsDefinitionRequest build() {
