...
public class PutScimV2UserRequest {
	...
	public PutScimV2UserRequest withUserId(String userId) {
	...
	public PutScimV2UserRequest withBody(ScimV2User body) {
	    this.setBody(body);
	    return this;
	} 
	...
	public PutScimV2UserRequest withIfMatch(String ifMatch) {
    ...
    public PutScimV2UserRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<ScimV2User> withHttpInfo() {
        ...
        if (this.userId == null) {
            throw new IllegalStateException("Missing the required parameter 'userId' when building request for PutScimV2UserRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutScimV2UserRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/scim/v2/users/{userId}")
