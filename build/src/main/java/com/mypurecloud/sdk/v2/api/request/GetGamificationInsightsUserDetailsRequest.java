...
public class GetGamificationInsightsUserDetailsRequest {
	...
	public GetGamificationInsightsUserDetailsRequest withUserId(String userId) {
	...
	public GetGamificationInsightsUserDetailsRequest withFilterType(String filterType) {
	...
	public GetGamificationInsightsUserDetailsRequest withFilterId(String filterId) {
	...
	public GetGamificationInsightsUserDetailsRequest withGranularity(String granularity) {
	...
	public GetGamificationInsightsUserDetailsRequest withComparativePeriodStartWorkday(LocalDate comparativePeriodStartWorkday) {
	...
	public GetGamificationInsightsUserDetailsRequest withPrimaryPeriodStartWorkday(LocalDate primaryPeriodStartWorkday) {
    ...
    public GetGamificationInsightsUserDetailsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/gamification/insights/users/{userId}/details")
	...
	public static Builder builder(String userId, String filterType, String filterId, String granularity, LocalDate comparativePeriodStartWorkday, LocalDate primaryPeriodStartWorkday) {
	    return new Builder()
	            .withRequiredParams(userId, filterType, filterId, granularity, comparativePeriodStartWorkday, primaryPeriodStartWorkday);
	}
	...
	public static class Builder {
		...
		private Builder() {
			request = new GetGamificationInsightsUserDetailsRequest();
		}
		...
		public Builder withRequiredParams(String userId, String filterType, String filterId, String granularity, LocalDate comparativePeriodStartWorkday, LocalDate primaryPeriodStartWorkday) {
			request.setUserId(userId);
			request.setFilterType(filterType);
			request.setFilterId(filterId);
			request.setGranularity(granularity);
