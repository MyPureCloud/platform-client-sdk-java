...
public class GetJourneyActiontargetRequest {
	...
	public GetJourneyActiontargetRequest withActionTargetId(String actionTargetId) {
    ...
    public GetJourneyActiontargetRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.actionTargetId == null) {
            throw new IllegalStateException("Missing the required parameter 'actionTargetId' when building request for GetJourneyActiontargetRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/journey/actiontargets/{actionTargetId}")
	...
	public static class Builder {
		private final GetJourneyActiontargetRequest request;

		private Builder() {
			request = new GetJourneyActiontargetRequest();
		}
		...
		public GetJourneyActiontargetRequest build() {
