...
public class PutAuthorizationPoliciesTargetRequest {
	...
	public PutAuthorizationPoliciesTargetRequest withTargetName(String targetName) {
	...
	public PutAuthorizationPoliciesTargetRequest withBody(AuthorizationPolicy body) {
	    this.setBody(body);
	    return this;
	} 
	...
	public PutAuthorizationPoliciesTargetRequest withSkipLockoutCheck(Boolean skipLockoutCheck) {
    ...
    public PutAuthorizationPoliciesTargetRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<AuthorizationPolicy> withHttpInfo() {
        ...
        if (this.targetName == null) {
            throw new IllegalStateException("Missing the required parameter 'targetName' when building request for PutAuthorizationPoliciesTargetRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutAuthorizationPoliciesTargetRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/authorization/policies/targets/{targetName}")
	...
	public static class Builder {
		private final PutAuthorizationPoliciesTargetRequest request;

		private Builder() {
			request = new PutAuthorizationPoliciesTargetRequest();
		}
		...
		public PutAuthorizationPoliciesTargetRequest build() {
