...
public class PostOutboundContactlistfiltersBulkRetrieveRequest {

	private ContactListFilterBulkRetrieveBody body;
	public ContactListFilterBulkRetrieveBody getBody() {
		return this.body;
	}

	public void setBody(ContactListFilterBulkRetrieveBody body) {
		this.body = body;
	}
    ...
    public ApiRequest<ContactListFilterBulkRetrieveBody> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostOutboundContactlistfiltersBulkRetrieveRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/outbound/contactlistfilters/bulk/retrieve")
                .withBody(body)
	...
	public static Builder builder(ContactListFilterBulkRetrieveBody body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostOutboundContactlistfiltersBulkRetrieveRequest request;

		private Builder() {
			request = new PostOutboundContactlistfiltersBulkRetrieveRequest();
		}


		public Builder withBody(ContactListFilterBulkRetrieveBody body) {
		...
		public Builder withRequiredParams(ContactListFilterBulkRetrieveBody body) {
			request.setBody(body);
		...
		public PostOutboundContactlistfiltersBulkRetrieveRequest build() {
