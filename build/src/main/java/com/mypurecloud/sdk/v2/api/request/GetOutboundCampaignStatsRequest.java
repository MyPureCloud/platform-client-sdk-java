...
public class GetOutboundCampaignStatsRequest {
	...
	public GetOutboundCampaignStatsRequest withCampaignId(String campaignId) {
    ...
    public GetOutboundCampaignStatsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.campaignId == null) {
            throw new IllegalStateException("Missing the required parameter 'campaignId' when building request for GetOutboundCampaignStatsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/outbound/campaigns/{campaignId}/stats")
	...
	public static class Builder {
		private final GetOutboundCampaignStatsRequest request;

		private Builder() {
			request = new GetOutboundCampaignStatsRequest();
		}
		...
		public GetOutboundCampaignStatsRequest build() {
