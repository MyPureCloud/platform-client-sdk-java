...
public class QueueConversationSocialExpressionEventTopicScreenMonitoring  implements Serializable {
 ...
 @JsonDeserialize(using = MonitoringTypeEnumDeserializer.class)
   ...
   **/
  public QueueConversationSocialExpressionEventTopicScreenMonitoring id(String id) {
    this.id = id;
    return this;
  }
  ...
  /**
   **/
  public QueueConversationSocialExpressionEventTopicScreenMonitoring state(StateEnum state) {
    this.state = state;
    return this;
  }
  ...
  /**
   **/
  public QueueConversationSocialExpressionEventTopicScreenMonitoring initialState(InitialStateEnum initialState) {
   ...
   * The source provider.
   **/
  public QueueConversationSocialExpressionEventTopicScreenMonitoring provider(String provider) {
   ...
   * System defined string indicating what caused the communication to disconnect. Will be null until the communication disconnects.
   **/
  public QueueConversationSocialExpressionEventTopicScreenMonitoring disconnectType(DisconnectTypeEnum disconnectType) {
   ...
   **/
  public QueueConversationSocialExpressionEventTopicScreenMonitoring connectedTime(Date connectedTime) {
   ...
   **/
  public QueueConversationSocialExpressionEventTopicScreenMonitoring disconnectedTime(Date disconnectedTime) {
   ...
   **/
  public QueueConversationSocialExpressionEventTopicScreenMonitoring targetUserId(String targetUserId) {
   ...
   **/
  public QueueConversationSocialExpressionEventTopicScreenMonitoring screenMonitoringId(String screenMonitoringId) {
   ...
   * The screen monitoring type.
   **/
  public QueueConversationSocialExpressionEventTopicScreenMonitoring monitoringType(MonitoringTypeEnum monitoringType) {
   ...
   **/
  public QueueConversationSocialExpressionEventTopicScreenMonitoring count(Long count) {
    this.count = count;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    QueueConversationSocialExpressionEventTopicScreenMonitoring queueConversationSocialExpressionEventTopicScreenMonitoring = (QueueConversationSocialExpressionEventTopicScreenMonitoring) o;

    return Objects.equals(this.id, queueConversationSocialExpressionEventTopicScreenMonitoring.id) &&
            Objects.equals(this.state, queueConversationSocialExpressionEventTopicScreenMonitoring.state) &&
            Objects.equals(this.initialState, queueConversationSocialExpressionEventTopicScreenMonitoring.initialState) &&
            Objects.equals(this.provider, queueConversationSocialExpressionEventTopicScreenMonitoring.provider) &&
            Objects.equals(this.disconnectType, queueConversationSocialExpressionEventTopicScreenMonitoring.disconnectType) &&
            Objects.equals(this.connectedTime, queueConversationSocialExpressionEventTopicScreenMonitoring.connectedTime) &&
            Objects.equals(this.disconnectedTime, queueConversationSocialExpressionEventTopicScreenMonitoring.disconnectedTime) &&
            Objects.equals(this.targetUserId, queueConversationSocialExpressionEventTopicScreenMonitoring.targetUserId) &&
            Objects.equals(this.screenMonitoringId, queueConversationSocialExpressionEventTopicScreenMonitoring.screenMonitoringId) &&
            Objects.equals(this.monitoringType, queueConversationSocialExpressionEventTopicScreenMonitoring.monitoringType) &&
            Objects.equals(this.count, queueConversationSocialExpressionEventTopicScreenMonitoring.count);
  }
  ...
  public String toString() {
    ...
    sb.append("class QueueConversationSocialExpressionEventTopicScreenMonitoring {\n");
