...
public class PostUserRoutinglanguagesRequest {
	...
	public PostUserRoutinglanguagesRequest withUserId(String userId) {
	    this.setUserId(userId);
	    return this;
	} 
	
	private UserRoutingLanguagePost body;
	public UserRoutingLanguagePost getBody() {
		return this.body;
	}

	public void setBody(UserRoutingLanguagePost body) {
		this.body = body;
	}

	public PostUserRoutinglanguagesRequest withBody(UserRoutingLanguagePost body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostUserRoutinglanguagesRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<UserRoutingLanguagePost> withHttpInfo() {
        
        // verify the required parameter 'userId' is set
        if (this.userId == null) {
            throw new IllegalStateException("Missing the required parameter 'userId' when building request for PostUserRoutinglanguagesRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostUserRoutinglanguagesRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/users/{userId}/routinglanguages")
	...
	public static Builder builder(String userId, UserRoutingLanguagePost body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostUserRoutinglanguagesRequest request;

		private Builder() {
			request = new PostUserRoutinglanguagesRequest();
		}
		...
		public Builder withBody(UserRoutingLanguagePost body) {
		...
		public Builder withRequiredParams(String userId, UserRoutingLanguagePost body) {
			request.setUserId(userId);
						request.setBody(body);
		...
		public PostUserRoutinglanguagesRequest build() {
