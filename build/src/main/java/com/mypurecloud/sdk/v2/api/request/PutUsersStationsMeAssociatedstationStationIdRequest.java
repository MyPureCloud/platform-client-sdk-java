...
public class PutUsersStationsMeAssociatedstationStationIdRequest {
	...
	public PutUsersStationsMeAssociatedstationStationIdRequest withStationId(String stationId) {
    ...
    public PutUsersStationsMeAssociatedstationStationIdRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.stationId == null) {
            throw new IllegalStateException("Missing the required parameter 'stationId' when building request for PutUsersStationsMeAssociatedstationStationIdRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/users/stations/me/associatedstation/{stationId}")
	...
	public static class Builder {
		private final PutUsersStationsMeAssociatedstationStationIdRequest request;

		private Builder() {
			request = new PutUsersStationsMeAssociatedstationStationIdRequest();
		}
		...
		public PutUsersStationsMeAssociatedstationStationIdRequest build() {
