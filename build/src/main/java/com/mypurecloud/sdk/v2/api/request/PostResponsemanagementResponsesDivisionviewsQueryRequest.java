...
public class PostResponsemanagementResponsesDivisionviewsQueryRequest {
	...
	public PostResponsemanagementResponsesDivisionviewsQueryRequest withBody(ResponseQueryRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostResponsemanagementResponsesDivisionviewsQueryRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<ResponseQueryRequest> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostResponsemanagementResponsesDivisionviewsQueryRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/responsemanagement/responses/divisionviews/query")
                .withBody(body)
	...
	public static class Builder {
		private final PostResponsemanagementResponsesDivisionviewsQueryRequest request;

		private Builder() {
			request = new PostResponsemanagementResponsesDivisionviewsQueryRequest();
		}
		...
		public PostResponsemanagementResponsesDivisionviewsQueryRequest build() {
