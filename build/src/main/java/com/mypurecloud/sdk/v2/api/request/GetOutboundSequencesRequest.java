...
public class GetOutboundSequencesRequest {
	...
	public GetOutboundSequencesRequest withPageSize(Integer pageSize) {
	...
	public GetOutboundSequencesRequest withPageNumber(Integer pageNumber) {
	...
	public GetOutboundSequencesRequest withAllowEmptyResult(Boolean allowEmptyResult) {
	...
	public GetOutboundSequencesRequest withFilterType(String filterType) {
	...
	public GetOutboundSequencesRequest withName(String name) {
	    this.setName(name);
	    return this;
	} 
	...
	public GetOutboundSequencesRequest withSortBy(String sortBy) {
	...
	public GetOutboundSequencesRequest withSortOrder(String sortOrder) {
    ...
    public GetOutboundSequencesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/outbound/sequences")
	...
	public static class Builder {
		private final GetOutboundSequencesRequest request;

		private Builder() {
			request = new GetOutboundSequencesRequest();
		}
		...
		public GetOutboundSequencesRequest build() {
