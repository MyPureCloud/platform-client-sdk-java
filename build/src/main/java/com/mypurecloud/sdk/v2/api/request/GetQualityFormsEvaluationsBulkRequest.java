...
public class GetQualityFormsEvaluationsBulkRequest {
	...
	public GetQualityFormsEvaluationsBulkRequest withId(List<String> id) {
	    this.setId(id);
	    return this;
	} 

	private Boolean includeLatestVersionFormName;
	public Boolean getIncludeLatestVersionFormName() {
		return this.includeLatestVersionFormName;
	}

	public void setIncludeLatestVersionFormName(Boolean includeLatestVersionFormName) {
		this.includeLatestVersionFormName = includeLatestVersionFormName;
	}

	public GetQualityFormsEvaluationsBulkRequest withIncludeLatestVersionFormName(Boolean includeLatestVersionFormName) {
	    this.setIncludeLatestVersionFormName(includeLatestVersionFormName);
	    return this;
	} 
    ...
    public GetQualityFormsEvaluationsBulkRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.id == null) {
            throw new IllegalStateException("Missing the required parameter 'id' when building request for GetQualityFormsEvaluationsBulkRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/quality/forms/evaluations/bulk")

                .withQueryParameters("id", "multi", id)
        

                .withQueryParameters("includeLatestVersionFormName", "", includeLatestVersionFormName)
	...
	public static class Builder {
		private final GetQualityFormsEvaluationsBulkRequest request;

		private Builder() {
			request = new GetQualityFormsEvaluationsBulkRequest();
		}
		...
		public Builder withIncludeLatestVersionFormName(Boolean includeLatestVersionFormName) {
			request.setIncludeLatestVersionFormName(includeLatestVersionFormName);
			return this;
		}
		...
		public GetQualityFormsEvaluationsBulkRequest build() {
