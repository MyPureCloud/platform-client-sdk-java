...
public class GetWorkforcemanagementManagementunitWorkplanRequest {
	...
	public GetWorkforcemanagementManagementunitWorkplanRequest withManagementUnitId(String managementUnitId) {
	...
	public GetWorkforcemanagementManagementunitWorkplanRequest withWorkPlanId(String workPlanId) {
	    this.setWorkPlanId(workPlanId);
	    return this;
	} 
    ...
    public GetWorkforcemanagementManagementunitWorkplanRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.managementUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'managementUnitId' when building request for GetWorkforcemanagementManagementunitWorkplanRequest.");
        }
        
        // verify the required parameter 'workPlanId' is set
        if (this.workPlanId == null) {
            throw new IllegalStateException("Missing the required parameter 'workPlanId' when building request for GetWorkforcemanagementManagementunitWorkplanRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/managementunits/{managementUnitId}/workplans/{workPlanId}")
	...
	public static class Builder {
		private final GetWorkforcemanagementManagementunitWorkplanRequest request;

		private Builder() {
			request = new GetWorkforcemanagementManagementunitWorkplanRequest();
		}
		...
		public GetWorkforcemanagementManagementunitWorkplanRequest build() {
