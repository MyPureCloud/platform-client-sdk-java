...
public class PutTelephonyProvidersEdgesDidpoolRequest {
	...
	public PutTelephonyProvidersEdgesDidpoolRequest withDidPoolId(String didPoolId) {
	...
	public void setBody(DIDPool body) {
		this.body = body;
	}

	public PutTelephonyProvidersEdgesDidpoolRequest withBody(DIDPool body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutTelephonyProvidersEdgesDidpoolRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<DIDPool> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("PUT", "/api/v2/telephony/providers/edges/didpools/{didPoolId}")
