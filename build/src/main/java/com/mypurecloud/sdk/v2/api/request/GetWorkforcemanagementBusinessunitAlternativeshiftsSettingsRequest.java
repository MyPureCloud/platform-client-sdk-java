...
public class GetWorkforcemanagementBusinessunitAlternativeshiftsSettingsRequest {
	...
	public GetWorkforcemanagementBusinessunitAlternativeshiftsSettingsRequest withBusinessUnitId(String businessUnitId) {
    ...
    public GetWorkforcemanagementBusinessunitAlternativeshiftsSettingsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for GetWorkforcemanagementBusinessunitAlternativeshiftsSettingsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/alternativeshifts/settings")
	...
	public static class Builder {
		private final GetWorkforcemanagementBusinessunitAlternativeshiftsSettingsRequest request;

		private Builder() {
			request = new GetWorkforcemanagementBusinessunitAlternativeshiftsSettingsRequest();
		}
		...
		public GetWorkforcemanagementBusinessunitAlternativeshiftsSettingsRequest build() {
