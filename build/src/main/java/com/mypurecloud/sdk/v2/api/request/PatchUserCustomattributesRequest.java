...
public class PatchUserCustomattributesRequest {
	...
	public PatchUserCustomattributesRequest withUserId(String userId) {
    ...
    public PatchUserCustomattributesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<UserCustomAttributesUpdateRequest> withHttpInfo() {
        ...
        if (this.userId == null) {
            throw new IllegalStateException("Missing the required parameter 'userId' when building request for PatchUserCustomattributesRequest.");
        }
        
        // verify the required parameter 'userCustomAttributes' is set
        if (this.userCustomAttributes == null) {
            throw new IllegalStateException("Missing the required parameter 'userCustomAttributes' when building request for PatchUserCustomattributesRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/users/{userId}/customattributes")
	...
	public static class Builder {
		private final PatchUserCustomattributesRequest request;

		private Builder() {
			request = new PatchUserCustomattributesRequest();
		}
		...
		public PatchUserCustomattributesRequest build() {
