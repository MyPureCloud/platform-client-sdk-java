...
import com.mypurecloud.sdk.v2.model.InternalMessageMediaParticipant;
...
public class InternalMessageConversation  implements Serializable {
  
  private String id = null;
  private String name = null;
  private List<InternalMessageMediaParticipant> participants = null;
  ...
  public InternalMessageConversation() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
      participants = new ArrayList<InternalMessageMediaParticipant>();
  ...
  public InternalMessageConversation(Boolean initWithEmptyList) {
  ...
  /**
   **/
  public InternalMessageConversation name(String name) {
    this.name = name;
    return this;
  }
   ...
   **/
  public InternalMessageConversation participants(List<InternalMessageMediaParticipant> participants) {
  ...
  public List<InternalMessageMediaParticipant> getParticipants() {
    return participants;
  }
  public void setParticipants(List<InternalMessageMediaParticipant> participants) {
    this.participants = participants;
  }
   ...
   **/
  public InternalMessageConversation otherMediaUris(List<String> otherMediaUris) {
   ...
   **/
  public InternalMessageConversation recentTransfers(List<TransferResponse> recentTransfers) {
   ...
   **/
  public InternalMessageConversation utilizationLabelId(String utilizationLabelId) {
   ...
   **/
  public InternalMessageConversation inactivityTimeout(Date inactivityTimeout) {
   ...
   **/
  public InternalMessageConversation divisions(List<ConversationDivisionMembership> divisions) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    InternalMessageConversation internalMessageConversation = (InternalMessageConversation) o;

    return Objects.equals(this.id, internalMessageConversation.id) &&
            Objects.equals(this.name, internalMessageConversation.name) &&
            Objects.equals(this.participants, internalMessageConversation.participants) &&
            Objects.equals(this.otherMediaUris, internalMessageConversation.otherMediaUris) &&
            Objects.equals(this.recentTransfers, internalMessageConversation.recentTransfers) &&
            Objects.equals(this.utilizationLabelId, internalMessageConversation.utilizationLabelId) &&
            Objects.equals(this.inactivityTimeout, internalMessageConversation.inactivityTimeout) &&
            Objects.equals(this.divisions, internalMessageConversation.divisions) &&
            Objects.equals(this.selfUri, internalMessageConversation.selfUri);
  }
