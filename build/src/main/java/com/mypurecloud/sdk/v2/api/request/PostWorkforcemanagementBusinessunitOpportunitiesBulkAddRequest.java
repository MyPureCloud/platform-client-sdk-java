...
public class PostWorkforcemanagementBusinessunitOpportunitiesBulkAddRequest {
	...
	public PostWorkforcemanagementBusinessunitOpportunitiesBulkAddRequest withBusinessUnitId(String businessUnitId) {
	    this.setBusinessUnitId(businessUnitId);
	    return this;
	} 

	private BulkAddOpportunitiesRequest body;
	public BulkAddOpportunitiesRequest getBody() {
		return this.body;
	}

	public void setBody(BulkAddOpportunitiesRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementBusinessunitOpportunitiesBulkAddRequest withBody(BulkAddOpportunitiesRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementBusinessunitOpportunitiesBulkAddRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<BulkAddOpportunitiesRequest> withHttpInfo() {
        
        // verify the required parameter 'businessUnitId' is set
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PostWorkforcemanagementBusinessunitOpportunitiesBulkAddRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementBusinessunitOpportunitiesBulkAddRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/opportunities/bulk/add")
	...
	public static Builder builder(String businessUnitId, BulkAddOpportunitiesRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementBusinessunitOpportunitiesBulkAddRequest request;

		private Builder() {
			request = new PostWorkforcemanagementBusinessunitOpportunitiesBulkAddRequest();
		}
		...
		public Builder withBody(BulkAddOpportunitiesRequest body) {
		...
		public Builder withRequiredParams(String businessUnitId, BulkAddOpportunitiesRequest body) {
			request.setBusinessUnitId(businessUnitId);
			request.setBody(body);
		...
		public PostWorkforcemanagementBusinessunitOpportunitiesBulkAddRequest build() {
