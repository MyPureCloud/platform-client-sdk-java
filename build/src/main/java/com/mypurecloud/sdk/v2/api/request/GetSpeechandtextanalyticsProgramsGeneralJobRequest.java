...
public class GetSpeechandtextanalyticsProgramsGeneralJobRequest {
	...
	public GetSpeechandtextanalyticsProgramsGeneralJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetSpeechandtextanalyticsProgramsGeneralJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetSpeechandtextanalyticsProgramsGeneralJobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/speechandtextanalytics/programs/general/jobs/{jobId}")
	...
	public static class Builder {
		private final GetSpeechandtextanalyticsProgramsGeneralJobRequest request;

		private Builder() {
			request = new GetSpeechandtextanalyticsProgramsGeneralJobRequest();
		}
		...
		public GetSpeechandtextanalyticsProgramsGeneralJobRequest build() {
