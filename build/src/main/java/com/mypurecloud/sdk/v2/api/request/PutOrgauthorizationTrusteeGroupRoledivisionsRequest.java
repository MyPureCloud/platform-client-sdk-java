...
public class PutOrgauthorizationTrusteeGroupRoledivisionsRequest {
	...
	public PutOrgauthorizationTrusteeGroupRoledivisionsRequest withTrusteeOrgId(String trusteeOrgId) {
	...
	public PutOrgauthorizationTrusteeGroupRoledivisionsRequest withBody(RoleDivisionGrants body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public ApiRequest<RoleDivisionGrants> withHttpInfo() {
        ...
        if (this.trusteeOrgId == null) {
            throw new IllegalStateException("Missing the required parameter 'trusteeOrgId' when building request for PutOrgauthorizationTrusteeGroupRoledivisionsRequest.");
        }
        
        // verify the required parameter 'trusteeGroupId' is set
        if (this.trusteeGroupId == null) {
            throw new IllegalStateException("Missing the required parameter 'trusteeGroupId' when building request for PutOrgauthorizationTrusteeGroupRoledivisionsRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutOrgauthorizationTrusteeGroupRoledivisionsRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/orgauthorization/trustees/{trusteeOrgId}/groups/{trusteeGroupId}/roledivisions")
	...
	public static Builder builder(String trusteeOrgId, String trusteeGroupId, RoleDivisionGrants body) {
	    return new Builder()
	...
	public static class Builder {
		private final PutOrgauthorizationTrusteeGroupRoledivisionsRequest request;

		private Builder() {
			request = new PutOrgauthorizationTrusteeGroupRoledivisionsRequest();
		}
		...
		public Builder withRequiredParams(String trusteeOrgId, String trusteeGroupId, RoleDivisionGrants body) {
			request.setTrusteeOrgId(trusteeOrgId);
			request.setTrusteeGroupId(trusteeGroupId);
			request.setBody(body);
		...
		public PutOrgauthorizationTrusteeGroupRoledivisionsRequest build() {
