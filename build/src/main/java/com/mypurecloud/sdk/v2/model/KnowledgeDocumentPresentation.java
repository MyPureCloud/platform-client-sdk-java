...
public class KnowledgeDocumentPresentation  implements Serializable {
 ...
 @JsonDeserialize(using = QueryTypeEnumDeserializer.class)
   ...
   **/
  public KnowledgeDocumentPresentation documents(List<KnowledgeDocumentVersionVariationReference> documents) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(documents, searchId, queryType, sessionId, conversationContext, application);
  }
