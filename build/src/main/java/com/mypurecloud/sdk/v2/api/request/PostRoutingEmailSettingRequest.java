...
public class PostRoutingEmailSettingRequest {
	...
	public PostRoutingEmailSettingRequest withBody(EmailSetting body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostRoutingEmailSettingRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<EmailSetting> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostRoutingEmailSettingRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/routing/email/setting")
                .withBody(body)
	...
	public static Builder builder(EmailSetting body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostRoutingEmailSettingRequest request;

		private Builder() {
			request = new PostRoutingEmailSettingRequest();
		}
		...
		public Builder withRequiredParams(EmailSetting body) {
			request.setBody(body);
		...
		public PostRoutingEmailSettingRequest build() {
