...
public class PutIntegrationsSpeechNuanceNuanceIntegrationIdBotsLaunchSettingsRequest {
	...
	public PutIntegrationsSpeechNuanceNuanceIntegrationIdBotsLaunchSettingsRequest withNuanceIntegrationId(String nuanceIntegrationId) {
	    this.setNuanceIntegrationId(nuanceIntegrationId);
	    return this;
	} 

	private NuanceBotLaunchSettings settings;
	public NuanceBotLaunchSettings getSettings() {
		return this.settings;
	}

	public void setSettings(NuanceBotLaunchSettings settings) {
		this.settings = settings;
	}

	public PutIntegrationsSpeechNuanceNuanceIntegrationIdBotsLaunchSettingsRequest withSettings(NuanceBotLaunchSettings settings) {
    ...
    public PutIntegrationsSpeechNuanceNuanceIntegrationIdBotsLaunchSettingsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<NuanceBotLaunchSettings> withHttpInfo() {
        
        // verify the required parameter 'nuanceIntegrationId' is set
        if (this.nuanceIntegrationId == null) {
            throw new IllegalStateException("Missing the required parameter 'nuanceIntegrationId' when building request for PutIntegrationsSpeechNuanceNuanceIntegrationIdBotsLaunchSettingsRequest.");
        }
        
        // verify the required parameter 'settings' is set
        if (this.settings == null) {
            throw new IllegalStateException("Missing the required parameter 'settings' when building request for PutIntegrationsSpeechNuanceNuanceIntegrationIdBotsLaunchSettingsRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/integrations/speech/nuance/{nuanceIntegrationId}/bots/launch/settings")
	...
	public static Builder builder(String nuanceIntegrationId, NuanceBotLaunchSettings settings) {
	    return new Builder()
	            .withRequiredParams(nuanceIntegrationId, settings);
	}


	public static class Builder {
		private final PutIntegrationsSpeechNuanceNuanceIntegrationIdBotsLaunchSettingsRequest request;

		private Builder() {
			request = new PutIntegrationsSpeechNuanceNuanceIntegrationIdBotsLaunchSettingsRequest();
		}
		...
		public Builder withSettings(NuanceBotLaunchSettings settings) {
		...
		public Builder withRequiredParams(String nuanceIntegrationId, NuanceBotLaunchSettings settings) {
			request.setNuanceIntegrationId(nuanceIntegrationId);
			request.setSettings(settings);
		...
		public PutIntegrationsSpeechNuanceNuanceIntegrationIdBotsLaunchSettingsRequest build() {
