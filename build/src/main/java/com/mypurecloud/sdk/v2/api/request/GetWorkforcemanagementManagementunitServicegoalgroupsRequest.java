...
public class GetWorkforcemanagementManagementunitServicegoalgroupsRequest {
	...
	public GetWorkforcemanagementManagementunitServicegoalgroupsRequest withManagementUnitId(String managementUnitId) {
    ...
    public GetWorkforcemanagementManagementunitServicegoalgroupsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.managementUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'managementUnitId' when building request for GetWorkforcemanagementManagementunitServicegoalgroupsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/managementunits/{managementUnitId}/servicegoalgroups")
	...
	public static class Builder {
		private final GetWorkforcemanagementManagementunitServicegoalgroupsRequest request;

		private Builder() {
			request = new GetWorkforcemanagementManagementunitServicegoalgroupsRequest();
		}
		...
		public GetWorkforcemanagementManagementunitServicegoalgroupsRequest build() {
