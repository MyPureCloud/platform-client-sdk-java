...
public class PutOrgauthorizationTrusteeUserRoledivisionsRequest {
	...
	public PutOrgauthorizationTrusteeUserRoledivisionsRequest withTrusteeOrgId(String trusteeOrgId) {
	...
	public PutOrgauthorizationTrusteeUserRoledivisionsRequest withTrusteeUserId(String trusteeUserId) {
	...
	public PutOrgauthorizationTrusteeUserRoledivisionsRequest withBody(RoleDivisionGrants body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutOrgauthorizationTrusteeUserRoledivisionsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<RoleDivisionGrants> withHttpInfo() {
        ...
        if (this.trusteeOrgId == null) {
            throw new IllegalStateException("Missing the required parameter 'trusteeOrgId' when building request for PutOrgauthorizationTrusteeUserRoledivisionsRequest.");
        }
        
        // verify the required parameter 'trusteeUserId' is set
        if (this.trusteeUserId == null) {
            throw new IllegalStateException("Missing the required parameter 'trusteeUserId' when building request for PutOrgauthorizationTrusteeUserRoledivisionsRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutOrgauthorizationTrusteeUserRoledivisionsRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/orgauthorization/trustees/{trusteeOrgId}/users/{trusteeUserId}/roledivisions")
	...
	public static Builder builder(String trusteeOrgId, String trusteeUserId, RoleDivisionGrants body) {
	    return new Builder()
	...
	public static class Builder {
		private final PutOrgauthorizationTrusteeUserRoledivisionsRequest request;

		private Builder() {
			request = new PutOrgauthorizationTrusteeUserRoledivisionsRequest();
		}
		...
		public Builder withRequiredParams(String trusteeOrgId, String trusteeUserId, RoleDivisionGrants body) {
			request.setTrusteeOrgId(trusteeOrgId);
						request.setTrusteeUserId(trusteeUserId);
						request.setBody(body);
		...
		public PutOrgauthorizationTrusteeUserRoledivisionsRequest build() {
