...
public class QueueConversationCallbackEventTopicJourneyCustomer  implements Serializable {
  
  private String id = null;
  private String idType = null;

  public QueueConversationCallbackEventTopicJourneyCustomer() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
    }
  }

  public QueueConversationCallbackEventTopicJourneyCustomer(Boolean initWithEmptyList) {
   ...
   **/
  public QueueConversationCallbackEventTopicJourneyCustomer id(String id) {
    this.id = id;
    return this;
  }
   ...
   **/
  public QueueConversationCallbackEventTopicJourneyCustomer idType(String idType) {
    this.idType = idType;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    QueueConversationCallbackEventTopicJourneyCustomer queueConversationCallbackEventTopicJourneyCustomer = (QueueConversationCallbackEventTopicJourneyCustomer) o;

    return Objects.equals(this.id, queueConversationCallbackEventTopicJourneyCustomer.id) &&
            Objects.equals(this.idType, queueConversationCallbackEventTopicJourneyCustomer.idType);
  }
