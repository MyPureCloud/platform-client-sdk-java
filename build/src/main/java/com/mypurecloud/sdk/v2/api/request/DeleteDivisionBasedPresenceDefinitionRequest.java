...
public class DeleteDivisionBasedPresenceDefinitionRequest {
	...
	public DeleteDivisionBasedPresenceDefinitionRequest withDefinitionId(String definitionId) {
    ...
    public DeleteDivisionBasedPresenceDefinitionRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.definitionId == null) {
            throw new IllegalStateException("Missing the required parameter 'definitionId' when building request for DeleteDivisionBasedPresenceDefinitionRequest.");
        }
	...
	public static class Builder {
		private final DeleteDivisionBasedPresenceDefinitionRequest request;

		private Builder() {
			request = new DeleteDivisionBasedPresenceDefinitionRequest();
		}
		...
		public DeleteDivisionBasedPresenceDefinitionRequest build() {
