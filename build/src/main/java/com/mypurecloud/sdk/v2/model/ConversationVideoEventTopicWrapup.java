...
public class ConversationVideoEventTopicWrapup  implements Serializable {
  ...
  public ConversationVideoEventTopicWrapup() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
      tags = new ArrayList<String>();
    }
  }

  public ConversationVideoEventTopicWrapup(Boolean initWithEmptyList) {
   ...
   **/
  public ConversationVideoEventTopicWrapup durationSeconds(Long durationSeconds) {
