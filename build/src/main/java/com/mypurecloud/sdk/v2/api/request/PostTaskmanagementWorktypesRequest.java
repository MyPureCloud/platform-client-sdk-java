...
public class PostTaskmanagementWorktypesRequest {

	private WorktypeCreate body;
	public WorktypeCreate getBody() {
		return this.body;
	}

	public void setBody(WorktypeCreate body) {
		this.body = body;
	}

	public PostTaskmanagementWorktypesRequest withBody(WorktypeCreate body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostTaskmanagementWorktypesRequest withCustomHeader(String name, String value) {
	...
	public static class Builder {
		private final PostTaskmanagementWorktypesRequest request;

		private Builder() {
			request = new PostTaskmanagementWorktypesRequest();
		}


		public Builder withBody(WorktypeCreate body) {
