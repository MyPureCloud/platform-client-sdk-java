...
public class DeleteWorkforcemanagementManagementunitWeekShorttermforecastRequest {
	...
	public DeleteWorkforcemanagementManagementunitWeekShorttermforecastRequest withManagementUnitId(String managementUnitId) {
	...
	public DeleteWorkforcemanagementManagementunitWeekShorttermforecastRequest withWeekDateId(String weekDateId) {
	...
	public DeleteWorkforcemanagementManagementunitWeekShorttermforecastRequest withForecastId(String forecastId) {
    ...
    public DeleteWorkforcemanagementManagementunitWeekShorttermforecastRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.managementUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'managementUnitId' when building request for DeleteWorkforcemanagementManagementunitWeekShorttermforecastRequest.");
        }
        
        // verify the required parameter 'weekDateId' is set
        if (this.weekDateId == null) {
            throw new IllegalStateException("Missing the required parameter 'weekDateId' when building request for DeleteWorkforcemanagementManagementunitWeekShorttermforecastRequest.");
        }
        
        // verify the required parameter 'forecastId' is set
        if (this.forecastId == null) {
            throw new IllegalStateException("Missing the required parameter 'forecastId' when building request for DeleteWorkforcemanagementManagementunitWeekShorttermforecastRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/workforcemanagement/managementunits/{managementUnitId}/weeks/{weekDateId}/shorttermforecasts/{forecastId}")
	...
	public static class Builder {
		private final DeleteWorkforcemanagementManagementunitWeekShorttermforecastRequest request;

		private Builder() {
			request = new DeleteWorkforcemanagementManagementunitWeekShorttermforecastRequest();
		}
		...
		public DeleteWorkforcemanagementManagementunitWeekShorttermforecastRequest build() {
