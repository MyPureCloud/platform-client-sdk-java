...
public class QueueConversationVideoEventTopicVoicemail  implements Serializable {
 ...
 @JsonDeserialize(using = UploadStatusEnumDeserializer.class)
  ...
  public QueueConversationVideoEventTopicVoicemail() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
    }
  }

  public QueueConversationVideoEventTopicVoicemail(Boolean initWithEmptyList) {
   ...
   * The voicemail id
   **/
  public QueueConversationVideoEventTopicVoicemail id(String id) {
    this.id = id;
    return this;
  }
   ...
   * current state of the voicemail upload
   **/
  public QueueConversationVideoEventTopicVoicemail uploadStatus(UploadStatusEnum uploadStatus) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    QueueConversationVideoEventTopicVoicemail queueConversationVideoEventTopicVoicemail = (QueueConversationVideoEventTopicVoicemail) o;

    return Objects.equals(this.id, queueConversationVideoEventTopicVoicemail.id) &&
            Objects.equals(this.uploadStatus, queueConversationVideoEventTopicVoicemail.uploadStatus);
  }
