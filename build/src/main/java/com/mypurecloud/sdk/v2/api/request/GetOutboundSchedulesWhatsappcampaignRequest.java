...
public class GetOutboundSchedulesWhatsappcampaignRequest {
	...
	public GetOutboundSchedulesWhatsappcampaignRequest withWhatsAppCampaignId(String whatsAppCampaignId) {
    ...
    public GetOutboundSchedulesWhatsappcampaignRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.whatsAppCampaignId == null) {
            throw new IllegalStateException("Missing the required parameter 'whatsAppCampaignId' when building request for GetOutboundSchedulesWhatsappcampaignRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/outbound/schedules/whatsappcampaigns/{whatsAppCampaignId}")
	...
	public static class Builder {
		private final GetOutboundSchedulesWhatsappcampaignRequest request;

		private Builder() {
			request = new GetOutboundSchedulesWhatsappcampaignRequest();
		}
		...
		public GetOutboundSchedulesWhatsappcampaignRequest build() {
