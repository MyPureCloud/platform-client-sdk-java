...
public class GetExternalcontactsExternalsourceRequest {
	...
	public GetExternalcontactsExternalsourceRequest withExternalSourceId(String externalSourceId) {
    ...
    public GetExternalcontactsExternalsourceRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.externalSourceId == null) {
            throw new IllegalStateException("Missing the required parameter 'externalSourceId' when building request for GetExternalcontactsExternalsourceRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/externalcontacts/externalsources/{externalSourceId}")
	...
	public static class Builder {
		private final GetExternalcontactsExternalsourceRequest request;

		private Builder() {
			request = new GetExternalcontactsExternalsourceRequest();
		}
		...
		public GetExternalcontactsExternalsourceRequest build() {
