...
public class DeleteOutboundContactlistfilterRequest {
	...
	public DeleteOutboundContactlistfilterRequest withContactListFilterId(String contactListFilterId) {
    ...
    public DeleteOutboundContactlistfilterRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.contactListFilterId == null) {
            throw new IllegalStateException("Missing the required parameter 'contactListFilterId' when building request for DeleteOutboundContactlistfilterRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/outbound/contactlistfilters/{contactListFilterId}")
	...
	public static class Builder {
		private final DeleteOutboundContactlistfilterRequest request;

		private Builder() {
			request = new DeleteOutboundContactlistfilterRequest();
		}
		...
		public DeleteOutboundContactlistfilterRequest build() {
