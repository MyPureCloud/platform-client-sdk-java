...
public class GetRoutingEmailDomainMailfromRequest {
	...
	public GetRoutingEmailDomainMailfromRequest withDomainId(String domainId) {
    ...
    public GetRoutingEmailDomainMailfromRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.domainId == null) {
            throw new IllegalStateException("Missing the required parameter 'domainId' when building request for GetRoutingEmailDomainMailfromRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/routing/email/domains/{domainId}/mailfrom")
	...
	public static class Builder {
		private final GetRoutingEmailDomainMailfromRequest request;

		private Builder() {
			request = new GetRoutingEmailDomainMailfromRequest();
		}
		...
		public GetRoutingEmailDomainMailfromRequest build() {
