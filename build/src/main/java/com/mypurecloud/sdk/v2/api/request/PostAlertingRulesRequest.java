...
public class PostAlertingRulesRequest {

	private CommonRule body;
	public CommonRule getBody() {
		return this.body;
	}

	public void setBody(CommonRule body) {
		this.body = body;
	}

	public PostAlertingRulesRequest withBody(CommonRule body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostAlertingRulesRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<CommonRule> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostAlertingRulesRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/alerting/rules")
                .withBody(body)
	...
	public static Builder builder(CommonRule body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostAlertingRulesRequest request;

		private Builder() {
			request = new PostAlertingRulesRequest();
		}


		public Builder withBody(CommonRule body) {
		...
		public Builder withRequiredParams(CommonRule body) {
			request.setBody(body);
		...
		public PostAlertingRulesRequest build() {
