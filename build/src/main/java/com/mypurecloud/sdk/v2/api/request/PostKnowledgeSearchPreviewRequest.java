...
public class PostKnowledgeSearchPreviewRequest {

	private KnowledgeSearchPreviewRequest body;
	public KnowledgeSearchPreviewRequest getBody() {
		return this.body;
	}

	public void setBody(KnowledgeSearchPreviewRequest body) {
		this.body = body;
	}

	public PostKnowledgeSearchPreviewRequest withBody(KnowledgeSearchPreviewRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostKnowledgeSearchPreviewRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<KnowledgeSearchPreviewRequest> withHttpInfo() {
        

        return ApiRequestBuilder.create("POST", "/api/v2/knowledge/search/preview")
                .withBody(body)
	...
	public static class Builder {
		private final PostKnowledgeSearchPreviewRequest request;

		private Builder() {
			request = new PostKnowledgeSearchPreviewRequest();
		}


		public Builder withBody(KnowledgeSearchPreviewRequest body) {
		...
		public PostKnowledgeSearchPreviewRequest build() {
