...
public class PostCasemanagementCasesAssociationsQueryRequest {

	private CaseAssociationQuery body;
	public CaseAssociationQuery getBody() {
		return this.body;
	}

	public void setBody(CaseAssociationQuery body) {
		this.body = body;
	}

	public PostCasemanagementCasesAssociationsQueryRequest withBody(CaseAssociationQuery body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostCasemanagementCasesAssociationsQueryRequest withCustomHeader(String name, String value) {
	...
	public static class Builder {
		private final PostCasemanagementCasesAssociationsQueryRequest request;

		private Builder() {
			request = new PostCasemanagementCasesAssociationsQueryRequest();
		}


		public Builder withBody(CaseAssociationQuery body) {
