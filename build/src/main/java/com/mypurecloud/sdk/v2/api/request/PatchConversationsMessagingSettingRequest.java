...
public class PatchConversationsMessagingSettingRequest {
	...
	public PatchConversationsMessagingSettingRequest withMessageSettingId(String messageSettingId) {
	    this.setMessageSettingId(messageSettingId);
	    return this;
	} 

	private MessagingSettingPatchRequest body;
	public MessagingSettingPatchRequest getBody() {
		return this.body;
	}

	public void setBody(MessagingSettingPatchRequest body) {
		this.body = body;
	}

	public PatchConversationsMessagingSettingRequest withBody(MessagingSettingPatchRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchConversationsMessagingSettingRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<MessagingSettingPatchRequest> withHttpInfo() {
        
        // verify the required parameter 'messageSettingId' is set
        if (this.messageSettingId == null) {
            throw new IllegalStateException("Missing the required parameter 'messageSettingId' when building request for PatchConversationsMessagingSettingRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchConversationsMessagingSettingRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/conversations/messaging/settings/{messageSettingId}")
	...
	public static Builder builder(String messageSettingId, MessagingSettingPatchRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PatchConversationsMessagingSettingRequest request;

		private Builder() {
			request = new PatchConversationsMessagingSettingRequest();
		}
		...
		public Builder withBody(MessagingSettingPatchRequest body) {
		...
		public Builder withRequiredParams(String messageSettingId, MessagingSettingPatchRequest body) {
			request.setMessageSettingId(messageSettingId);
			request.setBody(body);
		...
		public PatchConversationsMessagingSettingRequest build() {
