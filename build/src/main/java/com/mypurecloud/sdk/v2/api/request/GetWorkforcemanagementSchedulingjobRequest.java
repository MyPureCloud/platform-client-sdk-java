...
public class GetWorkforcemanagementSchedulingjobRequest {
	...
	public GetWorkforcemanagementSchedulingjobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetWorkforcemanagementSchedulingjobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetWorkforcemanagementSchedulingjobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/schedulingjobs/{jobId}")
	...
	public static class Builder {
		private final GetWorkforcemanagementSchedulingjobRequest request;

		private Builder() {
			request = new GetWorkforcemanagementSchedulingjobRequest();
		}
		...
		public GetWorkforcemanagementSchedulingjobRequest build() {
