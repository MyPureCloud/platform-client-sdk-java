...
public class PostExternalcontactsOrganizationsSchemasRequest {
	...
	public PostExternalcontactsOrganizationsSchemasRequest withBody(DataSchema body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostExternalcontactsOrganizationsSchemasRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<DataSchema> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostExternalcontactsOrganizationsSchemasRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/externalcontacts/organizations/schemas")
                .withBody(body)
	...
	public static class Builder {
		private final PostExternalcontactsOrganizationsSchemasRequest request;

		private Builder() {
			request = new PostExternalcontactsOrganizationsSchemasRequest();
		}
		...
		public PostExternalcontactsOrganizationsSchemasRequest build() {
