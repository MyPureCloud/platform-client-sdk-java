...
public class DeleteCoachingAppointmentRequest {
	...
	public DeleteCoachingAppointmentRequest withAppointmentId(String appointmentId) {
    ...
    public DeleteCoachingAppointmentRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.appointmentId == null) {
            throw new IllegalStateException("Missing the required parameter 'appointmentId' when building request for DeleteCoachingAppointmentRequest.");
        }
	...
	public static class Builder {
		private final DeleteCoachingAppointmentRequest request;

		private Builder() {
			request = new DeleteCoachingAppointmentRequest();
		}
		...
		public DeleteCoachingAppointmentRequest build() {
