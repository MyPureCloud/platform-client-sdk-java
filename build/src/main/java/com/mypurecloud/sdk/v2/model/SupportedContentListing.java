...
public class SupportedContentListing  implements Serializable, PagedResource<SupportedContent> {
  
  private List<SupportedContent> entities = null;
  ...
  public SupportedContentListing() {
  ...
  /**
   **/
  public SupportedContentListing entities(List<SupportedContent> entities) {
  ...
  public List<SupportedContent> getEntities() {
    return entities;
  }
  public void setEntities(List<SupportedContent> entities) {
    this.entities = entities;
  }
