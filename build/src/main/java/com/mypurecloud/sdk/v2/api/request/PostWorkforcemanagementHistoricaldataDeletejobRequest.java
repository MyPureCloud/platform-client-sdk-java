...
public class PostWorkforcemanagementHistoricaldataDeletejobRequest {
    ...
    public PostWorkforcemanagementHistoricaldataDeletejobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/historicaldata/deletejob")
	...
	public static class Builder {
		private final PostWorkforcemanagementHistoricaldataDeletejobRequest request;

		private Builder() {
			request = new PostWorkforcemanagementHistoricaldataDeletejobRequest();
		}
		...
		public PostWorkforcemanagementHistoricaldataDeletejobRequest build() {
