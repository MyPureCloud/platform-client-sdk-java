...
public class PatchConversationCustomattributesBulkRequest {
	...
	public PatchConversationCustomattributesBulkRequest withConversationId(String conversationId) {
	    this.setConversationId(conversationId);
	    return this;
	} 

	private List<CustomAttributesPatchRequest> body;
	public List<CustomAttributesPatchRequest> getBody() {
		return this.body;
	}

	public void setBody(List<CustomAttributesPatchRequest> body) {
		this.body = body;
	}

	public PatchConversationCustomattributesBulkRequest withBody(List<CustomAttributesPatchRequest> body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchConversationCustomattributesBulkRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<List<CustomAttributesPatchRequest>> withHttpInfo() {
        
        // verify the required parameter 'conversationId' is set
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PatchConversationCustomattributesBulkRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/conversations/{conversationId}/customattributes/bulk")
	...
	public static class Builder {
		private final PatchConversationCustomattributesBulkRequest request;

		private Builder() {
			request = new PatchConversationCustomattributesBulkRequest();
		}
		...
		public Builder withBody(List<CustomAttributesPatchRequest> body) {
		...
		public PatchConversationCustomattributesBulkRequest build() {
