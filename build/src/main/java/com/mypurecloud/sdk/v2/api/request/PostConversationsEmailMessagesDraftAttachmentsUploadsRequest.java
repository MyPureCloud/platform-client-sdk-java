...
public class PostConversationsEmailMessagesDraftAttachmentsUploadsRequest {
	...
	public PostConversationsEmailMessagesDraftAttachmentsUploadsRequest withConversationId(String conversationId) {
	    this.setConversationId(conversationId);
	    return this;
	} 

	private UploadAttachmentRequest body;
	public UploadAttachmentRequest getBody() {
		return this.body;
	}

	public void setBody(UploadAttachmentRequest body) {
		this.body = body;
	}

	public PostConversationsEmailMessagesDraftAttachmentsUploadsRequest withBody(UploadAttachmentRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostConversationsEmailMessagesDraftAttachmentsUploadsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<UploadAttachmentRequest> withHttpInfo() {
        
        // verify the required parameter 'conversationId' is set
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PostConversationsEmailMessagesDraftAttachmentsUploadsRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostConversationsEmailMessagesDraftAttachmentsUploadsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/conversations/emails/{conversationId}/messages/draft/attachments/uploads")
	...
	public static Builder builder(String conversationId, UploadAttachmentRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostConversationsEmailMessagesDraftAttachmentsUploadsRequest request;

		private Builder() {
			request = new PostConversationsEmailMessagesDraftAttachmentsUploadsRequest();
		}
		...
		public Builder withBody(UploadAttachmentRequest body) {
		...
		public Builder withRequiredParams(String conversationId, UploadAttachmentRequest body) {
			request.setConversationId(conversationId);
			request.setBody(body);
		...
		public PostConversationsEmailMessagesDraftAttachmentsUploadsRequest build() {
