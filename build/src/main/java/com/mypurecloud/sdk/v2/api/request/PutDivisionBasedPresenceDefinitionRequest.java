...
public class PutDivisionBasedPresenceDefinitionRequest {
	...
	public PutDivisionBasedPresenceDefinitionRequest withDefinitionId(String definitionId) {
	...
	public PutDivisionBasedPresenceDefinitionRequest withBody(OrganizationPresenceDefinition body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutDivisionBasedPresenceDefinitionRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<OrganizationPresenceDefinition> withHttpInfo() {
        ...
        if (this.definitionId == null) {
            throw new IllegalStateException("Missing the required parameter 'definitionId' when building request for PutDivisionBasedPresenceDefinitionRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutDivisionBasedPresenceDefinitionRequest.");
        }
	...
	public static class Builder {
		private final PutDivisionBasedPresenceDefinitionRequest request;

		private Builder() {
			request = new PutDivisionBasedPresenceDefinitionRequest();
		}
		...
		public PutDivisionBasedPresenceDefinitionRequest build() {
