...
public class GetIntegrationsSpeechTtsEngineVoiceRequest {
	...
	public GetIntegrationsSpeechTtsEngineVoiceRequest withEngineId(String engineId) {
	...
	public GetIntegrationsSpeechTtsEngineVoiceRequest withVoiceId(String voiceId) {
    ...
    public GetIntegrationsSpeechTtsEngineVoiceRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.engineId == null) {
            throw new IllegalStateException("Missing the required parameter 'engineId' when building request for GetIntegrationsSpeechTtsEngineVoiceRequest.");
        }
        
        // verify the required parameter 'voiceId' is set
        if (this.voiceId == null) {
            throw new IllegalStateException("Missing the required parameter 'voiceId' when building request for GetIntegrationsSpeechTtsEngineVoiceRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/integrations/speech/tts/engines/{engineId}/voices/{voiceId}")
                .withPathParameter("engineId", engineId)
        
                .withPathParameter("voiceId", voiceId)
	...
	public static Builder builder(String engineId, String voiceId) {
	    return new Builder()
	            .withRequiredParams(engineId, voiceId);
	}
	

	public static class Builder {
		private final GetIntegrationsSpeechTtsEngineVoiceRequest request;

		private Builder() {
			request = new GetIntegrationsSpeechTtsEngineVoiceRequest();
		}
		...
		public Builder withRequiredParams(String engineId, String voiceId) {
			request.setEngineId(engineId);
						request.setVoiceId(voiceId);
		...
		public GetIntegrationsSpeechTtsEngineVoiceRequest build() {
