...
public class PostKnowledgeKnowledgebaseSynchronizeJobsRequest {
	...
	public PostKnowledgeKnowledgebaseSynchronizeJobsRequest withKnowledgeBaseId(String knowledgeBaseId) {
	    this.setKnowledgeBaseId(knowledgeBaseId);
	    return this;
	} 

	private KnowledgeSyncJobRequest body;
	public KnowledgeSyncJobRequest getBody() {
		return this.body;
	}

	public void setBody(KnowledgeSyncJobRequest body) {
		this.body = body;
	}

	public PostKnowledgeKnowledgebaseSynchronizeJobsRequest withBody(KnowledgeSyncJobRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostKnowledgeKnowledgebaseSynchronizeJobsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<KnowledgeSyncJobRequest> withHttpInfo() {
        
        // verify the required parameter 'knowledgeBaseId' is set
        if (this.knowledgeBaseId == null) {
            throw new IllegalStateException("Missing the required parameter 'knowledgeBaseId' when building request for PostKnowledgeKnowledgebaseSynchronizeJobsRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostKnowledgeKnowledgebaseSynchronizeJobsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/synchronize/jobs")
	...
	public static Builder builder(String knowledgeBaseId, KnowledgeSyncJobRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostKnowledgeKnowledgebaseSynchronizeJobsRequest request;

		private Builder() {
			request = new PostKnowledgeKnowledgebaseSynchronizeJobsRequest();
		}
		...
		public Builder withBody(KnowledgeSyncJobRequest body) {
		...
		public Builder withRequiredParams(String knowledgeBaseId, KnowledgeSyncJobRequest body) {
			request.setKnowledgeBaseId(knowledgeBaseId);
			request.setBody(body);
		...
		public PostKnowledgeKnowledgebaseSynchronizeJobsRequest build() {
