...
public class PutOutboundMessagingcampaignRequest {
	...
	public PutOutboundMessagingcampaignRequest withMessagingCampaignId(String messagingCampaignId) {
	    this.setMessagingCampaignId(messagingCampaignId);
	    return this;
	} 
	
	private MessagingCampaign body;
	public MessagingCampaign getBody() {
		return this.body;
	}

	public void setBody(MessagingCampaign body) {
		this.body = body;
	}

	public PutOutboundMessagingcampaignRequest withBody(MessagingCampaign body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutOutboundMessagingcampaignRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<MessagingCampaign> withHttpInfo() {
        
        // verify the required parameter 'messagingCampaignId' is set
        if (this.messagingCampaignId == null) {
            throw new IllegalStateException("Missing the required parameter 'messagingCampaignId' when building request for PutOutboundMessagingcampaignRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutOutboundMessagingcampaignRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/outbound/messagingcampaigns/{messagingCampaignId}")
	...
	public static Builder builder(String messagingCampaignId, MessagingCampaign body) {
	    return new Builder()
	            .withRequiredParams(messagingCampaignId, body);
	}
	

	public static class Builder {
		private final PutOutboundMessagingcampaignRequest request;

		private Builder() {
			request = new PutOutboundMessagingcampaignRequest();
		}
		...
		public Builder withBody(MessagingCampaign body) {
		...
		public Builder withRequiredParams(String messagingCampaignId, MessagingCampaign body) {
			request.setMessagingCampaignId(messagingCampaignId);
						request.setBody(body);
		...
		public PutOutboundMessagingcampaignRequest build() {
