...
public class UsersRulesUpdateRuleRequest  implements Serializable {
  ...
  private List<UsersRulesCriteria> lockedCriteria = null;
  ...
  /**
   **/
  public UsersRulesUpdateRuleRequest lockedCriteria(List<UsersRulesCriteria> lockedCriteria) {
  ...
  public List<UsersRulesCriteria> getLockedCriteria() {
    return lockedCriteria;
  }
  public void setLockedCriteria(List<UsersRulesCriteria> lockedCriteria) {
    this.lockedCriteria = lockedCriteria;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.name, usersRulesUpdateRuleRequest.name) &&
            ...
            Objects.equals(this.lockedCriteria, usersRulesUpdateRuleRequest.lockedCriteria);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, description, criteria, lockedCriteria);
  }
