...
public class PostArchitectGrammarLanguageFilesDtmfRequest {
    ...
    public ApiRequest<GrammarFileUploadRequest> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("POST", "/api/v2/architect/grammars/{grammarId}/languages/{languageCode}/files/dtmf")
	...
	public static class Builder {
		private final PostArchitectGrammarLanguageFilesDtmfRequest request;

		private Builder() {
			request = new PostArchitectGrammarLanguageFilesDtmfRequest();
		}
