...
public class PostExternalcontactsBulkOrganizationsAddRequest {
	...
	public PostExternalcontactsBulkOrganizationsAddRequest withBody(BulkOrganizationsRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostExternalcontactsBulkOrganizationsAddRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<BulkOrganizationsRequest> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostExternalcontactsBulkOrganizationsAddRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/externalcontacts/bulk/organizations/add")
                .withBody(body)
	...
	public static class Builder {
		private final PostExternalcontactsBulkOrganizationsAddRequest request;

		private Builder() {
			request = new PostExternalcontactsBulkOrganizationsAddRequest();
		}
		...
		public PostExternalcontactsBulkOrganizationsAddRequest build() {
