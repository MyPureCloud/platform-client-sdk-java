...
public class DialerEventEntityListing  implements Serializable, PagedResource<EventLog> {
  ...
  public DialerEventEntityListing() {
  ...
  /**
   **/
  public DialerEventEntityListing entities(List<EventLog> entities) {
  ...
  public List<EventLog> getEntities() {
    return entities;
  }
  public void setEntities(List<EventLog> entities) {
    this.entities = entities;
  }
