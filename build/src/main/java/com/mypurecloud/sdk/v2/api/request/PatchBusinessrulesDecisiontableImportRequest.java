...
public class PatchBusinessrulesDecisiontableImportRequest {
	...
	public PatchBusinessrulesDecisiontableImportRequest withTableId(String tableId) {
	...
	public PatchBusinessrulesDecisiontableImportRequest withImportJobId(String importJobId) {
	    this.setImportJobId(importJobId);
	    return this;
	} 

	private UpdateDecisionTableImportJobRequest body;
	public UpdateDecisionTableImportJobRequest getBody() {
		return this.body;
	}

	public void setBody(UpdateDecisionTableImportJobRequest body) {
		this.body = body;
	}
    ...
    public PatchBusinessrulesDecisiontableImportRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<UpdateDecisionTableImportJobRequest> withHttpInfo() {
        
        // verify the required parameter 'tableId' is set
        if (this.tableId == null) {
            throw new IllegalStateException("Missing the required parameter 'tableId' when building request for PatchBusinessrulesDecisiontableImportRequest.");
        }
        
        // verify the required parameter 'importJobId' is set
        if (this.importJobId == null) {
            throw new IllegalStateException("Missing the required parameter 'importJobId' when building request for PatchBusinessrulesDecisiontableImportRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchBusinessrulesDecisiontableImportRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/businessrules/decisiontables/{tableId}/imports/{importJobId}")
	...
	public static Builder builder(String tableId, String importJobId, UpdateDecisionTableImportJobRequest body) {
	    return new Builder()
	            .withRequiredParams(tableId, importJobId, body);
	}


	public static class Builder {
		private final PatchBusinessrulesDecisiontableImportRequest request;

		private Builder() {
			request = new PatchBusinessrulesDecisiontableImportRequest();
		}
		...
		public Builder withBody(UpdateDecisionTableImportJobRequest body) {
		...
		public Builder withRequiredParams(String tableId, String importJobId, UpdateDecisionTableImportJobRequest body) {
			request.setTableId(tableId);
			request.setImportJobId(importJobId);
			request.setBody(body);
		...
		public PatchBusinessrulesDecisiontableImportRequest build() {
