...
public class PostGamificationProfileActivateRequest {
	...
	public PostGamificationProfileActivateRequest withPerformanceProfileId(String performanceProfileId) {
    ...
    public PostGamificationProfileActivateRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.performanceProfileId == null) {
            throw new IllegalStateException("Missing the required parameter 'performanceProfileId' when building request for PostGamificationProfileActivateRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/gamification/profiles/{performanceProfileId}/activate")
	...
	public static class Builder {
		private final PostGamificationProfileActivateRequest request;

		private Builder() {
			request = new PostGamificationProfileActivateRequest();
		}
		...
		public PostGamificationProfileActivateRequest build() {
