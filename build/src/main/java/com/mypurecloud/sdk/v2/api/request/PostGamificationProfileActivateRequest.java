...
public class PostGamificationProfileActivateRequest {
	...
	public PostGamificationProfileActivateRequest withProfileId(String profileId) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.profileId == null) {
            throw new IllegalStateException("Missing the required parameter 'profileId' when building request for PostGamificationProfileActivateRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/gamification/profiles/{profileId}/activate")
