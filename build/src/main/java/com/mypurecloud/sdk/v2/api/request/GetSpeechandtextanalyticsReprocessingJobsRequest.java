...
public class GetSpeechandtextanalyticsReprocessingJobsRequest {
	...
	public GetSpeechandtextanalyticsReprocessingJobsRequest withPageSize(Integer pageSize) {
	...
	public GetSpeechandtextanalyticsReprocessingJobsRequest withPageNumber(Integer pageNumber) {
	...
	public GetSpeechandtextanalyticsReprocessingJobsRequest withSortOrder(String sortOrder) {
	...
	public GetSpeechandtextanalyticsReprocessingJobsRequest withName(String name) {
	    this.setName(name);
	    return this;
	} 
    ...
    public GetSpeechandtextanalyticsReprocessingJobsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/speechandtextanalytics/reprocessing/jobs")
	...
	public static class Builder {
		private final GetSpeechandtextanalyticsReprocessingJobsRequest request;

		private Builder() {
			request = new GetSpeechandtextanalyticsReprocessingJobsRequest();
		}
		...
		public GetSpeechandtextanalyticsReprocessingJobsRequest build() {
