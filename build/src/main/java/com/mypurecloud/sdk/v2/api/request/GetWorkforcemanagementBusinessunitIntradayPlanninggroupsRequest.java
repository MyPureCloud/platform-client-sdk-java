...
public class GetWorkforcemanagementBusinessunitIntradayPlanninggroupsRequest {
	...
	public GetWorkforcemanagementBusinessunitIntradayPlanninggroupsRequest withBusinessUnitId(String businessUnitId) {
	...
	public GetWorkforcemanagementBusinessunitIntradayPlanninggroupsRequest withDate(LocalDate date) {
	    this.setDate(date);
	    return this;
	} 
    ...
    public GetWorkforcemanagementBusinessunitIntradayPlanninggroupsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for GetWorkforcemanagementBusinessunitIntradayPlanninggroupsRequest.");
        }
        
        // verify the required parameter 'date' is set
        if (this.date == null) {
            throw new IllegalStateException("Missing the required parameter 'date' when building request for GetWorkforcemanagementBusinessunitIntradayPlanninggroupsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/intraday/planninggroups")
	...
	public static Builder builder(String businessUnitId, LocalDate date) {
	    return new Builder()
	            .withRequiredParams(businessUnitId, date);
	}
	

	public static class Builder {
		private final GetWorkforcemanagementBusinessunitIntradayPlanninggroupsRequest request;

		private Builder() {
			request = new GetWorkforcemanagementBusinessunitIntradayPlanninggroupsRequest();
		}
		...
		public Builder withRequiredParams(String businessUnitId, LocalDate date) {
			request.setBusinessUnitId(businessUnitId);
						request.setDate(date);
		...
		public GetWorkforcemanagementBusinessunitIntradayPlanninggroupsRequest build() {
