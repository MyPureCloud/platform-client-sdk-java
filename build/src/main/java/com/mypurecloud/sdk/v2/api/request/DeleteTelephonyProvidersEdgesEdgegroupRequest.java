...
public class DeleteTelephonyProvidersEdgesEdgegroupRequest {
	...
	public DeleteTelephonyProvidersEdgesEdgegroupRequest withEdgeGroupId(String edgeGroupId) {
    ...
    public DeleteTelephonyProvidersEdgesEdgegroupRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() throws ApiException {
        ...
        if (this.edgeGroupId == null) {
            throw new ApiException(400, "Missing the required parameter 'edgeGroupId' when building request for DeleteTelephonyProvidersEdgesEdgegroupRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/telephony/providers/edges/edgegroups/{edgeGroupId}")
	...
	public static class Builder {
		private final DeleteTelephonyProvidersEdgesEdgegroupRequest request;

		private Builder() {
			request = new DeleteTelephonyProvidersEdgesEdgegroupRequest();
		}
