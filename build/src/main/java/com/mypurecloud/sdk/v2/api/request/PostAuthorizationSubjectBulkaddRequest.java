...
public class PostAuthorizationSubjectBulkaddRequest {
	...
	public PostAuthorizationSubjectBulkaddRequest withSubjectId(String subjectId) {
	...
	public PostAuthorizationSubjectBulkaddRequest withBody(RoleDivisionGrants body) {
	    this.setBody(body);
	    return this;
	} 
	...
	public PostAuthorizationSubjectBulkaddRequest withSubjectType(String subjectType) {
    ...
    public PostAuthorizationSubjectBulkaddRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<RoleDivisionGrants> withHttpInfo() {
        ...
        if (this.subjectId == null) {
            throw new IllegalStateException("Missing the required parameter 'subjectId' when building request for PostAuthorizationSubjectBulkaddRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostAuthorizationSubjectBulkaddRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/authorization/subjects/{subjectId}/bulkadd")
	...
	public static class Builder {
		private final PostAuthorizationSubjectBulkaddRequest request;

		private Builder() {
			request = new PostAuthorizationSubjectBulkaddRequest();
		}
		...
		public PostAuthorizationSubjectBulkaddRequest build() {
