...
public class PostJourneyActionmapsEstimatesJobsRequest {
	...
	public void setBody(ActionMapEstimateRequest body) {
		this.body = body;
	}

	public PostJourneyActionmapsEstimatesJobsRequest withBody(ActionMapEstimateRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostJourneyActionmapsEstimatesJobsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<ActionMapEstimateRequest> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("POST", "/api/v2/journey/actionmaps/estimates/jobs")
                .withBody(body)
	...
	public static Builder builder(ActionMapEstimateRequest body) {
	    return new Builder()
	...
	public static class Builder {
		...
		private Builder() {
			request = new PostJourneyActionmapsEstimatesJobsRequest();
		}


		public Builder withBody(ActionMapEstimateRequest body) {
		...
		public Builder withRequiredParams(ActionMapEstimateRequest body) {
			request.setBody(body);
