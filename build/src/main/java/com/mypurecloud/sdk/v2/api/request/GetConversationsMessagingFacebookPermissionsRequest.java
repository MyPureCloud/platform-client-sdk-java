...
public class GetConversationsMessagingFacebookPermissionsRequest {
    ...
    public GetConversationsMessagingFacebookPermissionsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/conversations/messaging/facebook/permissions")
	...
	public static class Builder {
		private final GetConversationsMessagingFacebookPermissionsRequest request;

		private Builder() {
			request = new GetConversationsMessagingFacebookPermissionsRequest();
		}
		...
		public GetConversationsMessagingFacebookPermissionsRequest build() {
