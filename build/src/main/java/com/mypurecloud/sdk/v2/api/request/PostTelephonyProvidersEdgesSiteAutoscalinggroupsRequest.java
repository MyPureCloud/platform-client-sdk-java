...
public class PostTelephonyProvidersEdgesSiteAutoscalinggroupsRequest {
	...
	public PostTelephonyProvidersEdgesSiteAutoscalinggroupsRequest withSiteId(String siteId) {
	    this.setSiteId(siteId);
	    return this;
	}

	
	private CreateAsgRequest body;
	public CreateAsgRequest getBody() {
		return this.body;
	}

	public void setBody(CreateAsgRequest body) {
		this.body = body;
	}

	public PostTelephonyProvidersEdgesSiteAutoscalinggroupsRequest withBody(CreateAsgRequest body) {
	    this.setBody(body);
	    return this;
	}
    ...
    public PostTelephonyProvidersEdgesSiteAutoscalinggroupsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<CreateAsgRequest> withHttpInfo() {
        
        // verify the required parameter 'siteId' is set
        if (this.siteId == null) {
            throw new IllegalStateException("Missing the required parameter 'siteId' when building request for PostTelephonyProvidersEdgesSiteAutoscalinggroupsRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostTelephonyProvidersEdgesSiteAutoscalinggroupsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/telephony/providers/edges/sites/{siteId}/autoscalinggroups")
	...
	public static Builder builder(String siteId, CreateAsgRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostTelephonyProvidersEdgesSiteAutoscalinggroupsRequest request;

		private Builder() {
			request = new PostTelephonyProvidersEdgesSiteAutoscalinggroupsRequest();
		}
		...
		public Builder withBody(CreateAsgRequest body) {
		...
		public Builder withRequiredParams(String siteId, CreateAsgRequest body) {
			request.setSiteId(siteId);
						request.setBody(body);
		...
		public PostTelephonyProvidersEdgesSiteAutoscalinggroupsRequest build() {
