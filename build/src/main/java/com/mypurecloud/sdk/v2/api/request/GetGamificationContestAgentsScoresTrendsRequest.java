...
public class GetGamificationContestAgentsScoresTrendsRequest {
	...
	public GetGamificationContestAgentsScoresTrendsRequest withContestId(String contestId) {
    ...
    public GetGamificationContestAgentsScoresTrendsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.contestId == null) {
            throw new IllegalStateException("Missing the required parameter 'contestId' when building request for GetGamificationContestAgentsScoresTrendsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/gamification/contests/{contestId}/agents/scores/trends")
	...
	public static class Builder {
		private final GetGamificationContestAgentsScoresTrendsRequest request;

		private Builder() {
			request = new GetGamificationContestAgentsScoresTrendsRequest();
		}
		...
		public GetGamificationContestAgentsScoresTrendsRequest build() {
