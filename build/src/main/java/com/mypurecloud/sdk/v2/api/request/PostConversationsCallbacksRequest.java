...
public class PostConversationsCallbacksRequest {
	...
	public PostConversationsCallbacksRequest withBody(CreateCallbackCommand body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostConversationsCallbacksRequest withCustomHeader(String name, String value) {
