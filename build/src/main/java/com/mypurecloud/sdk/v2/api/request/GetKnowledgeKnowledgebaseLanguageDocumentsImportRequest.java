...
public class GetKnowledgeKnowledgebaseLanguageDocumentsImportRequest {
	...
	public GetKnowledgeKnowledgebaseLanguageDocumentsImportRequest withKnowledgeBaseId(String knowledgeBaseId) {
	...
	public GetKnowledgeKnowledgebaseLanguageDocumentsImportRequest withLanguageCode(String languageCode) {
	...
	public GetKnowledgeKnowledgebaseLanguageDocumentsImportRequest withImportId(String importId) {
    ...
    public GetKnowledgeKnowledgebaseLanguageDocumentsImportRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.knowledgeBaseId == null) {
            throw new IllegalStateException("Missing the required parameter 'knowledgeBaseId' when building request for GetKnowledgeKnowledgebaseLanguageDocumentsImportRequest.");
        }
        
        // verify the required parameter 'languageCode' is set
        if (this.languageCode == null) {
            throw new IllegalStateException("Missing the required parameter 'languageCode' when building request for GetKnowledgeKnowledgebaseLanguageDocumentsImportRequest.");
        }
        
        // verify the required parameter 'importId' is set
        if (this.importId == null) {
            throw new IllegalStateException("Missing the required parameter 'importId' when building request for GetKnowledgeKnowledgebaseLanguageDocumentsImportRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/languages/{languageCode}/documents/imports/{importId}")
	...
	public static Builder builder(String knowledgeBaseId, String languageCode, String importId) {
	    return new Builder()
	            .withRequiredParams(knowledgeBaseId, languageCode, importId);
	}
	

	public static class Builder {
		private final GetKnowledgeKnowledgebaseLanguageDocumentsImportRequest request;

		private Builder() {
			request = new GetKnowledgeKnowledgebaseLanguageDocumentsImportRequest();
		}
		...
		public GetKnowledgeKnowledgebaseLanguageDocumentsImportRequest build() {
