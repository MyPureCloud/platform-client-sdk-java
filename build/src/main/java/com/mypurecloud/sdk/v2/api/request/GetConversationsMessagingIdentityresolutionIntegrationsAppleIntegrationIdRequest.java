...
public class GetConversationsMessagingIdentityresolutionIntegrationsAppleIntegrationIdRequest {
	...
	public GetConversationsMessagingIdentityresolutionIntegrationsAppleIntegrationIdRequest withIntegrationId(String integrationId) {
    ...
    public GetConversationsMessagingIdentityresolutionIntegrationsAppleIntegrationIdRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.integrationId == null) {
            throw new IllegalStateException("Missing the required parameter 'integrationId' when building request for GetConversationsMessagingIdentityresolutionIntegrationsAppleIntegrationIdRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/conversations/messaging/identityresolution/integrations/apple/{integrationId}")
	...
	public static class Builder {
		private final GetConversationsMessagingIdentityresolutionIntegrationsAppleIntegrationIdRequest request;

		private Builder() {
			request = new GetConversationsMessagingIdentityresolutionIntegrationsAppleIntegrationIdRequest();
		}
		...
		public GetConversationsMessagingIdentityresolutionIntegrationsAppleIntegrationIdRequest build() {
