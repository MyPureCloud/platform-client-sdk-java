...
public class GetUsersRuleRequest {
	...
	public GetUsersRuleRequest withRuleId(String ruleId) {
    ...
    public GetUsersRuleRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.ruleId == null) {
            throw new IllegalStateException("Missing the required parameter 'ruleId' when building request for GetUsersRuleRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/users/rules/{ruleId}")
	...
	public static class Builder {
		private final GetUsersRuleRequest request;

		private Builder() {
			request = new GetUsersRuleRequest();
		}
		...
		public GetUsersRuleRequest build() {
