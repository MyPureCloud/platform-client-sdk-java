...
public class FlowExecutionAggregationSort  implements Serializable {
 ...
 @JsonDeserialize(using = FunctionEnumDeserializer.class)
  ...
  public FlowExecutionAggregationSort() {
   ...
   * Name of the metric used for sorting values.
   **/
  public FlowExecutionAggregationSort name(NameEnum name) {
    this.name = name;
    return this;
  }
   ...
   * Aggregation function used for the sort metric.
   **/
  public FlowExecutionAggregationSort function(FunctionEnum function) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    FlowExecutionAggregationSort flowExecutionAggregationSort = (FlowExecutionAggregationSort) o;

    return Objects.equals(this.name, flowExecutionAggregationSort.name) &&
            Objects.equals(this.function, flowExecutionAggregationSort.function);
  }
