...
public class PostBusinessrulesDecisiontableVersionSnapshotRequest {
	...
	public PostBusinessrulesDecisiontableVersionSnapshotRequest withTableId(String tableId) {
	...
	public PostBusinessrulesDecisiontableVersionSnapshotRequest withTableVersion(Integer tableVersion) {
	    this.setTableVersion(tableVersion);
	    return this;
	} 

	private CreateDecisionTableSnapshotRequest body;
	public CreateDecisionTableSnapshotRequest getBody() {
		return this.body;
	}

	public void setBody(CreateDecisionTableSnapshotRequest body) {
		this.body = body;
	}

	public PostBusinessrulesDecisiontableVersionSnapshotRequest withBody(CreateDecisionTableSnapshotRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostBusinessrulesDecisiontableVersionSnapshotRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<CreateDecisionTableSnapshotRequest> withHttpInfo() {
        
        // verify the required parameter 'tableId' is set
        if (this.tableId == null) {
            throw new IllegalStateException("Missing the required parameter 'tableId' when building request for PostBusinessrulesDecisiontableVersionSnapshotRequest.");
        }
        
        // verify the required parameter 'tableVersion' is set
        if (this.tableVersion == null) {
            throw new IllegalStateException("Missing the required parameter 'tableVersion' when building request for PostBusinessrulesDecisiontableVersionSnapshotRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostBusinessrulesDecisiontableVersionSnapshotRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/businessrules/decisiontables/{tableId}/versions/{tableVersion}/snapshot")
	...
	public static Builder builder(String tableId, Integer tableVersion, CreateDecisionTableSnapshotRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostBusinessrulesDecisiontableVersionSnapshotRequest request;

		private Builder() {
			request = new PostBusinessrulesDecisiontableVersionSnapshotRequest();
		}
		...
		public Builder withBody(CreateDecisionTableSnapshotRequest body) {
		...
		public Builder withRequiredParams(String tableId, Integer tableVersion, CreateDecisionTableSnapshotRequest body) {
			request.setTableId(tableId);
			request.setTableVersion(tableVersion);
			request.setBody(body);
		...
		public PostBusinessrulesDecisiontableVersionSnapshotRequest build() {
