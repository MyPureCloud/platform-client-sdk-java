...
public class GetConversationsCobrowsesessionParticipantWrapupRequest {
    ...
    public ApiRequest<Void> withHttpInfo() throws ApiException {
        ...
        if (this.cobrowseId == null) {
            throw new ApiException(400, "Missing the required parameter 'cobrowseId' when building request for GetConversationsCobrowsesessionParticipantWrapupRequest.");
        }
        
        // verify the required parameter 'participantId' is set
        if (this.participantId == null) {
            throw new ApiException(400, "Missing the required parameter 'participantId' when building request for GetConversationsCobrowsesessionParticipantWrapupRequest.");
        }
