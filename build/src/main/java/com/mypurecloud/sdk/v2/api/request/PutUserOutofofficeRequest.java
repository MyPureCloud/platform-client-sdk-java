...
public class PutUserOutofofficeRequest {
    ...
    public ApiRequest<OutOfOffice> withHttpInfo() throws ApiException {
        
        // verify the required parameter 'userId' is set
        if (this.userId == null) {
            throw new ApiException(400, "Missing the required parameter 'userId' when building request for PutUserOutofofficeRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new ApiException(400, "Missing the required parameter 'body' when building request for PutUserOutofofficeRequest.");
        }
