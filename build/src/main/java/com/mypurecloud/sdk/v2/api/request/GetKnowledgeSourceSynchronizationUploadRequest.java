...
public class GetKnowledgeSourceSynchronizationUploadRequest {
	...
	public GetKnowledgeSourceSynchronizationUploadRequest withSourceId(String sourceId) {
	...
	public GetKnowledgeSourceSynchronizationUploadRequest withSynchronizationId(String synchronizationId) {
	...
	public GetKnowledgeSourceSynchronizationUploadRequest withFileId(String fileId) {
    ...
    public GetKnowledgeSourceSynchronizationUploadRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.sourceId == null) {
            throw new IllegalStateException("Missing the required parameter 'sourceId' when building request for GetKnowledgeSourceSynchronizationUploadRequest.");
        }
        
        // verify the required parameter 'synchronizationId' is set
        if (this.synchronizationId == null) {
            throw new IllegalStateException("Missing the required parameter 'synchronizationId' when building request for GetKnowledgeSourceSynchronizationUploadRequest.");
        }
        
        // verify the required parameter 'fileId' is set
        if (this.fileId == null) {
            throw new IllegalStateException("Missing the required parameter 'fileId' when building request for GetKnowledgeSourceSynchronizationUploadRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/knowledge/sources/{sourceId}/synchronizations/{synchronizationId}/uploads/{fileId}")
	...
	public static class Builder {
		private final GetKnowledgeSourceSynchronizationUploadRequest request;

		private Builder() {
			request = new GetKnowledgeSourceSynchronizationUploadRequest();
		}
		...
		public GetKnowledgeSourceSynchronizationUploadRequest build() {
