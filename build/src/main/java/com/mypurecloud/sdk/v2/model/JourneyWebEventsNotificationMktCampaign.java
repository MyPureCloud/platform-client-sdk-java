...
public class JourneyWebEventsNotificationMktCampaign  implements Serializable {
  ...
  public JourneyWebEventsNotificationMktCampaign() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
    }
  }

  public JourneyWebEventsNotificationMktCampaign(Boolean initWithEmptyList) {
  ...
  /**
   **/
  public JourneyWebEventsNotificationMktCampaign content(String content) {
