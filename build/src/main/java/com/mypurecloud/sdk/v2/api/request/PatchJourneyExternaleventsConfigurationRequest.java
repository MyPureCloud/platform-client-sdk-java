...
public class PatchJourneyExternaleventsConfigurationRequest {
	...
	public PatchJourneyExternaleventsConfigurationRequest withConfigId(String configId) {
	    this.setConfigId(configId);
	    return this;
	} 

	private UpdateExternalEventsConfigurationRequest body;
	public UpdateExternalEventsConfigurationRequest getBody() {
		return this.body;
	}

	public void setBody(UpdateExternalEventsConfigurationRequest body) {
		this.body = body;
	}
    ...
    public PatchJourneyExternaleventsConfigurationRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<UpdateExternalEventsConfigurationRequest> withHttpInfo() {
        
        // verify the required parameter 'configId' is set
        if (this.configId == null) {
            throw new IllegalStateException("Missing the required parameter 'configId' when building request for PatchJourneyExternaleventsConfigurationRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/journey/externalevents/configurations/{configId}")
	...
	public static class Builder {
		private final PatchJourneyExternaleventsConfigurationRequest request;

		private Builder() {
			request = new PatchJourneyExternaleventsConfigurationRequest();
		}
		...
		public Builder withBody(UpdateExternalEventsConfigurationRequest body) {
		...
		public PatchJourneyExternaleventsConfigurationRequest build() {
