...
public class GetOutboundCampaignAgentownedmappingpreviewResultsRequest {
	...
	public GetOutboundCampaignAgentownedmappingpreviewResultsRequest withCampaignId(String campaignId) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.campaignId == null) {
            throw new IllegalStateException("Missing the required parameter 'campaignId' when building request for GetOutboundCampaignAgentownedmappingpreviewResultsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/outbound/campaigns/{campaignId}/agentownedmappingpreview/results")
	...
	public static class Builder {
		private final GetOutboundCampaignAgentownedmappingpreviewResultsRequest request;

		private Builder() {
			request = new GetOutboundCampaignAgentownedmappingpreviewResultsRequest();
		}
		...
		public GetOutboundCampaignAgentownedmappingpreviewResultsRequest build() {
