...
public class GetFlowsJobRequest {
	...
	public GetFlowsJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
	...
	public GetFlowsJobRequest withExpand(List<String> expand) {
    ...
    public GetFlowsJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetFlowsJobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/flows/jobs/{jobId}")
	...
	public static class Builder {
		private final GetFlowsJobRequest request;

		private Builder() {
			request = new GetFlowsJobRequest();
		}
		...
		public GetFlowsJobRequest build() {
