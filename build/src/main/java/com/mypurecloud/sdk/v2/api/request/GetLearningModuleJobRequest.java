...
public class GetLearningModuleJobRequest {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/learning/modules/{moduleId}/jobs/{jobId}")
	...
	public static Builder builder(String moduleId, String jobId) {
	    return new Builder()
	            .withRequiredParams(moduleId, jobId);
	}


	public static class Builder {
		private final GetLearningModuleJobRequest request;

		private Builder() {
			request = new GetLearningModuleJobRequest();
		}
