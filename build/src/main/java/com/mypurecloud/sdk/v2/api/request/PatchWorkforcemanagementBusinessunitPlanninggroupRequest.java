...
public class PatchWorkforcemanagementBusinessunitPlanninggroupRequest {
	...
	public PatchWorkforcemanagementBusinessunitPlanninggroupRequest withBusinessUnitId(String businessUnitId) {
	    this.setBusinessUnitId(businessUnitId);
	    return this;
	} 
	
	private String planningGroupId;
	...
	public PatchWorkforcemanagementBusinessunitPlanninggroupRequest withPlanningGroupId(String planningGroupId) {
	    this.setPlanningGroupId(planningGroupId);
	    return this;
	} 
	
	private UpdatePlanningGroupRequest body;
	public UpdatePlanningGroupRequest getBody() {
		return this.body;
	}

	public void setBody(UpdatePlanningGroupRequest body) {
		this.body = body;
	}

	public PatchWorkforcemanagementBusinessunitPlanninggroupRequest withBody(UpdatePlanningGroupRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchWorkforcemanagementBusinessunitPlanninggroupRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<UpdatePlanningGroupRequest> withHttpInfo() {
        
        // verify the required parameter 'businessUnitId' is set
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PatchWorkforcemanagementBusinessunitPlanninggroupRequest.");
        }
        ...
        return ApiRequestBuilder.create("PATCH", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/planninggroups/{planningGroupId}")
                ...
                .withPathParameter("planningGroupId", planningGroupId)
	...
	public static class Builder {
		private final PatchWorkforcemanagementBusinessunitPlanninggroupRequest request;

		private Builder() {
			request = new PatchWorkforcemanagementBusinessunitPlanninggroupRequest();
		}
		...
		public Builder withPlanningGroupId(String planningGroupId) {
			request.setPlanningGroupId(planningGroupId);
			return this;
		}
		
		public Builder withBody(UpdatePlanningGroupRequest body) {
		...
		public PatchWorkforcemanagementBusinessunitPlanninggroupRequest build() {
