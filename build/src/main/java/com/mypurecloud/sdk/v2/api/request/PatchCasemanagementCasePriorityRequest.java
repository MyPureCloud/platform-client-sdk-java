...
public class PatchCasemanagementCasePriorityRequest {
	...
	public PatchCasemanagementCasePriorityRequest withCaseId(String caseId) {
	    this.setCaseId(caseId);
	    return this;
	} 

	private CasePriorityUpdate body;
	public CasePriorityUpdate getBody() {
		return this.body;
	}

	public void setBody(CasePriorityUpdate body) {
		this.body = body;
	}

	public PatchCasemanagementCasePriorityRequest withBody(CasePriorityUpdate body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchCasemanagementCasePriorityRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<CasePriorityUpdate> withHttpInfo() {
        
        // verify the required parameter 'caseId' is set
        if (this.caseId == null) {
            throw new IllegalStateException("Missing the required parameter 'caseId' when building request for PatchCasemanagementCasePriorityRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchCasemanagementCasePriorityRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/casemanagement/cases/{caseId}/priority")
	...
	public static Builder builder(String caseId, CasePriorityUpdate body) {
	    return new Builder()
	...
	public static class Builder {
		private final PatchCasemanagementCasePriorityRequest request;

		private Builder() {
			request = new PatchCasemanagementCasePriorityRequest();
		}
		...
		public Builder withBody(CasePriorityUpdate body) {
		...
		public Builder withRequiredParams(String caseId, CasePriorityUpdate body) {
			request.setCaseId(caseId);
			request.setBody(body);
		...
		public PatchCasemanagementCasePriorityRequest build() {
