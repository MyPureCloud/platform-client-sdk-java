...
public class PutRoutingSettingsTranscriptionRequest {
	...
	public PutRoutingSettingsTranscriptionRequest withBody(TranscriptionSettings body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutRoutingSettingsTranscriptionRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<TranscriptionSettings> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutRoutingSettingsTranscriptionRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/routing/settings/transcription")
                .withBody(body)
	...
	public static class Builder {
		private final PutRoutingSettingsTranscriptionRequest request;

		private Builder() {
			request = new PutRoutingSettingsTranscriptionRequest();
		}
		...
		public PutRoutingSettingsTranscriptionRequest build() {
