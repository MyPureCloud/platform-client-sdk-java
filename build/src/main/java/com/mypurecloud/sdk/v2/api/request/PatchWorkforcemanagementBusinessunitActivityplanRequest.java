...
public class PatchWorkforcemanagementBusinessunitActivityplanRequest {
	...
	public PatchWorkforcemanagementBusinessunitActivityplanRequest withBusinessUnitId(String businessUnitId) {
	...
	public PatchWorkforcemanagementBusinessunitActivityplanRequest withActivityPlanId(String activityPlanId) {
	    this.setActivityPlanId(activityPlanId);
	    return this;
	} 

	private UpdateActivityPlanRequest body;
	public UpdateActivityPlanRequest getBody() {
		return this.body;
	}

	public void setBody(UpdateActivityPlanRequest body) {
		this.body = body;
	}

	public PatchWorkforcemanagementBusinessunitActivityplanRequest withBody(UpdateActivityPlanRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchWorkforcemanagementBusinessunitActivityplanRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<UpdateActivityPlanRequest> withHttpInfo() {
        
        // verify the required parameter 'businessUnitId' is set
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PatchWorkforcemanagementBusinessunitActivityplanRequest.");
        }
        
        // verify the required parameter 'activityPlanId' is set
        if (this.activityPlanId == null) {
            throw new IllegalStateException("Missing the required parameter 'activityPlanId' when building request for PatchWorkforcemanagementBusinessunitActivityplanRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchWorkforcemanagementBusinessunitActivityplanRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/activityplans/{activityPlanId}")
                .withPathParameter("businessUnitId", businessUnitId)
        
                .withPathParameter("activityPlanId", activityPlanId)
	...
	public static Builder builder(String businessUnitId, String activityPlanId, UpdateActivityPlanRequest body) {
	    return new Builder()
	            .withRequiredParams(businessUnitId, activityPlanId, body);
	}


	public static class Builder {
		private final PatchWorkforcemanagementBusinessunitActivityplanRequest request;

		private Builder() {
			request = new PatchWorkforcemanagementBusinessunitActivityplanRequest();
		}
		...
		public Builder withActivityPlanId(String activityPlanId) {
			request.setActivityPlanId(activityPlanId);
			return this;
		}

		public Builder withBody(UpdateActivityPlanRequest body) {
		...
		public Builder withRequiredParams(String businessUnitId, String activityPlanId, UpdateActivityPlanRequest body) {
			request.setBusinessUnitId(businessUnitId);
			request.setActivityPlanId(activityPlanId);
			request.setBody(body);
		...
		public PatchWorkforcemanagementBusinessunitActivityplanRequest build() {
            ...
            // verify the required parameter 'activityPlanId' is set
            if (request.activityPlanId == null) {
                throw new IllegalStateException("Missing the required parameter 'activityPlanId' when building request for PatchWorkforcemanagementBusinessunitActivityplanRequest.");
            }
