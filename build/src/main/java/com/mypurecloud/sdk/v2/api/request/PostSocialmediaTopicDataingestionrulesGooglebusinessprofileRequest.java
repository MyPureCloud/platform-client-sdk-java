...
public class PostSocialmediaTopicDataingestionrulesGooglebusinessprofileRequest {
	...
	public PostSocialmediaTopicDataingestionrulesGooglebusinessprofileRequest withBody(GoogleBusinessProfileDataIngestionRuleRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public ApiRequest<GoogleBusinessProfileDataIngestionRuleRequest> withHttpInfo() {
        ...
        if (this.topicId == null) {
            throw new IllegalStateException("Missing the required parameter 'topicId' when building request for PostSocialmediaTopicDataingestionrulesGooglebusinessprofileRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/socialmedia/topics/{topicId}/dataingestionrules/googlebusinessprofile")
	...
	public static class Builder {
		private final PostSocialmediaTopicDataingestionrulesGooglebusinessprofileRequest request;

		private Builder() {
			request = new PostSocialmediaTopicDataingestionrulesGooglebusinessprofileRequest();
		}
		...
		public PostSocialmediaTopicDataingestionrulesGooglebusinessprofileRequest build() {
