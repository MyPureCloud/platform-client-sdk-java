...
public class DeleteAnalyticsCasemanagementAggregatesJobRequest {
	...
	public DeleteAnalyticsCasemanagementAggregatesJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public DeleteAnalyticsCasemanagementAggregatesJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for DeleteAnalyticsCasemanagementAggregatesJobRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/analytics/casemanagement/aggregates/jobs/{jobId}")
	...
	public static class Builder {
		private final DeleteAnalyticsCasemanagementAggregatesJobRequest request;

		private Builder() {
			request = new DeleteAnalyticsCasemanagementAggregatesJobRequest();
		}
		...
		public DeleteAnalyticsCasemanagementAggregatesJobRequest build() {
