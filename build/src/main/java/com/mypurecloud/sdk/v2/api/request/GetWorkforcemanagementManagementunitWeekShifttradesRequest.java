...
public class GetWorkforcemanagementManagementunitWeekShifttradesRequest {
	...
	public GetWorkforcemanagementManagementunitWeekShifttradesRequest withManagementUnitId(String managementUnitId) {
	...
	public GetWorkforcemanagementManagementunitWeekShifttradesRequest withWeekDateId(LocalDate weekDateId) {
	    this.setWeekDateId(weekDateId);
	    return this;
	} 
	
	private Boolean evaluateMatches;
	public Boolean getEvaluateMatches() {
		return this.evaluateMatches;
	}

	public void setEvaluateMatches(Boolean evaluateMatches) {
		this.evaluateMatches = evaluateMatches;
	}

	public GetWorkforcemanagementManagementunitWeekShifttradesRequest withEvaluateMatches(Boolean evaluateMatches) {
	    this.setEvaluateMatches(evaluateMatches);
	    return this;
	} 
    ...
    public GetWorkforcemanagementManagementunitWeekShifttradesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.managementUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'managementUnitId' when building request for GetWorkforcemanagementManagementunitWeekShifttradesRequest.");
        }
        
        // verify the required parameter 'weekDateId' is set
        if (this.weekDateId == null) {
            throw new IllegalStateException("Missing the required parameter 'weekDateId' when building request for GetWorkforcemanagementManagementunitWeekShifttradesRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/managementunits/{managementUnitId}/weeks/{weekDateId}/shifttrades")
	...
	public static Builder builder(String managementUnitId, LocalDate weekDateId) {
	    return new Builder()
	...
	public static class Builder {
		private final GetWorkforcemanagementManagementunitWeekShifttradesRequest request;

		private Builder() {
			request = new GetWorkforcemanagementManagementunitWeekShifttradesRequest();
		}
		...
		public Builder withRequiredParams(String managementUnitId, LocalDate weekDateId) {
			request.setManagementUnitId(managementUnitId);
						request.setWeekDateId(weekDateId);
		...
		public GetWorkforcemanagementManagementunitWeekShifttradesRequest build() {
