...
public class GetTaskmanagementWorkitemsBulkAddJobResultsRequest {
	...
	public GetTaskmanagementWorkitemsBulkAddJobResultsRequest withBulkJobId(String bulkJobId) {
    ...
    public GetTaskmanagementWorkitemsBulkAddJobResultsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.bulkJobId == null) {
            throw new IllegalStateException("Missing the required parameter 'bulkJobId' when building request for GetTaskmanagementWorkitemsBulkAddJobResultsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/taskmanagement/workitems/bulk/add/jobs/{bulkJobId}/results")
	...
	public static class Builder {
		private final GetTaskmanagementWorkitemsBulkAddJobResultsRequest request;

		private Builder() {
			request = new GetTaskmanagementWorkitemsBulkAddJobResultsRequest();
		}
		...
		public GetTaskmanagementWorkitemsBulkAddJobResultsRequest build() {
