...
public class PatchRoutingSettingsTranscriptionRequest {

	private TranscriptionSettings body;
	public TranscriptionSettings getBody() {
		return this.body;
	}

	public void setBody(TranscriptionSettings body) {
		this.body = body;
	}

	public PatchRoutingSettingsTranscriptionRequest withBody(TranscriptionSettings body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchRoutingSettingsTranscriptionRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<TranscriptionSettings> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchRoutingSettingsTranscriptionRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/routing/settings/transcription")
                .withBody(body)
	...
	public static Builder builder(TranscriptionSettings body) {
	    return new Builder()
	...
	public static class Builder {
		private final PatchRoutingSettingsTranscriptionRequest request;

		private Builder() {
			request = new PatchRoutingSettingsTranscriptionRequest();
		}


		public Builder withBody(TranscriptionSettings body) {
		...
		public Builder withRequiredParams(TranscriptionSettings body) {
			request.setBody(body);
		...
		public PatchRoutingSettingsTranscriptionRequest build() {
