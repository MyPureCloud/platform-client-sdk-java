...
public class GetExternalcontactsOrganizationsExportsRequest {
	...
	public GetExternalcontactsOrganizationsExportsRequest withDivisionIds(List<String> divisionIds) {
	...
	public GetExternalcontactsOrganizationsExportsRequest withAfter(String after) {
	    this.setAfter(after);
	    return this;
	} 
	...
	public GetExternalcontactsOrganizationsExportsRequest withPageSize(Integer pageSize) {
    ...
    public GetExternalcontactsOrganizationsExportsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/externalcontacts/organizations/exports")
	...
	public static class Builder {
		private final GetExternalcontactsOrganizationsExportsRequest request;

		private Builder() {
			request = new GetExternalcontactsOrganizationsExportsRequest();
		}
		...
		public GetExternalcontactsOrganizationsExportsRequest build() {
