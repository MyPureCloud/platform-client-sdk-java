...
public class CallbackConversationEntityListing  implements Serializable, PagedResource<CallbackConversation> {
  ...
  /**
   **/
  public CallbackConversationEntityListing entities(List<CallbackConversation> entities) {
  ...
  public List<CallbackConversation> getEntities() {
    return entities;
  }
  public void setEntities(List<CallbackConversation> entities) {
    this.entities = entities;
  }
