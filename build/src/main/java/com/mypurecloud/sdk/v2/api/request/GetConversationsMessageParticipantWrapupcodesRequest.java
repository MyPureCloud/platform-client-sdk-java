...
public class GetConversationsMessageParticipantWrapupcodesRequest {
	...
	public GetConversationsMessageParticipantWrapupcodesRequest withConversationId(String conversationId) {
	...
	public GetConversationsMessageParticipantWrapupcodesRequest withParticipantId(String participantId) {
    ...
    public GetConversationsMessageParticipantWrapupcodesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for GetConversationsMessageParticipantWrapupcodesRequest.");
        }
        
        // verify the required parameter 'participantId' is set
        if (this.participantId == null) {
            throw new IllegalStateException("Missing the required parameter 'participantId' when building request for GetConversationsMessageParticipantWrapupcodesRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/conversations/messages/{conversationId}/participants/{participantId}/wrapupcodes")
	...
	public static class Builder {
		private final GetConversationsMessageParticipantWrapupcodesRequest request;

		private Builder() {
			request = new GetConversationsMessageParticipantWrapupcodesRequest();
		}
		...
		public GetConversationsMessageParticipantWrapupcodesRequest build() {
