...
public class GetTaskmanagementWorkitemsSchemasCoretypeRequest {
	...
	public GetTaskmanagementWorkitemsSchemasCoretypeRequest withCoreTypeName(String coreTypeName) {
    ...
    public GetTaskmanagementWorkitemsSchemasCoretypeRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.coreTypeName == null) {
            throw new IllegalStateException("Missing the required parameter 'coreTypeName' when building request for GetTaskmanagementWorkitemsSchemasCoretypeRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/taskmanagement/workitems/schemas/coretypes/{coreTypeName}")
	...
	public static class Builder {
		private final GetTaskmanagementWorkitemsSchemasCoretypeRequest request;

		private Builder() {
			request = new GetTaskmanagementWorkitemsSchemasCoretypeRequest();
		}
		...
		public GetTaskmanagementWorkitemsSchemasCoretypeRequest build() {
