...
public class GetIntegrationsBotconnectorBotsRequest {
	...
	public GetIntegrationsBotconnectorBotsRequest withIntegrationId(String integrationId) {
	...
	public GetIntegrationsBotconnectorBotsRequest withPageNumber(Integer pageNumber) {
	...
	public GetIntegrationsBotconnectorBotsRequest withPageSize(Integer pageSize) {
    ...
    public GetIntegrationsBotconnectorBotsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.integrationId == null) {
            throw new IllegalStateException("Missing the required parameter 'integrationId' when building request for GetIntegrationsBotconnectorBotsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/integrations/botconnectors/{integrationId}/bots")
	...
	public static class Builder {
		private final GetIntegrationsBotconnectorBotsRequest request;

		private Builder() {
			request = new GetIntegrationsBotconnectorBotsRequest();
		}
		...
		public GetIntegrationsBotconnectorBotsRequest build() {
