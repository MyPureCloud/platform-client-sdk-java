...
public class GetIntentsAssignmentsExternalcontactRequest {
	...
	public GetIntentsAssignmentsExternalcontactRequest withExternalContactId(String externalContactId) {
	...
	public GetIntentsAssignmentsExternalcontactRequest withPageSize(Integer pageSize) {
	...
	public GetIntentsAssignmentsExternalcontactRequest withPageNumber(Integer pageNumber) {
    ...
    public GetIntentsAssignmentsExternalcontactRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.externalContactId == null) {
            throw new IllegalStateException("Missing the required parameter 'externalContactId' when building request for GetIntentsAssignmentsExternalcontactRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/intents/assignments/externalcontacts/{externalContactId}")
	...
	public static class Builder {
		private final GetIntentsAssignmentsExternalcontactRequest request;

		private Builder() {
			request = new GetIntentsAssignmentsExternalcontactRequest();
		}
		...
		public GetIntentsAssignmentsExternalcontactRequest build() {
