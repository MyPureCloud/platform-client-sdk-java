...
public class PatchWorkforcemanagementTimeoffrequestRequest {
	...
	private AgentTimeOffRequestPatch body;
	public AgentTimeOffRequestPatch getBody() {
		return this.body;
	}

	public void setBody(AgentTimeOffRequestPatch body) {
		this.body = body;
	}

	public PatchWorkforcemanagementTimeoffrequestRequest withBody(AgentTimeOffRequestPatch body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public ApiRequest<AgentTimeOffRequestPatch> withHttpInfo() {
	...
	public static class Builder {
		...
		public Builder withBody(AgentTimeOffRequestPatch body) {
