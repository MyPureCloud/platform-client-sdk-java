...
public class GetWorkforcemanagementManagementunitTimeoffplanRequest {
	...
	public GetWorkforcemanagementManagementunitTimeoffplanRequest withManagementUnitId(String managementUnitId) {
	...
	public GetWorkforcemanagementManagementunitTimeoffplanRequest withTimeOffPlanId(String timeOffPlanId) {
    ...
    public GetWorkforcemanagementManagementunitTimeoffplanRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.managementUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'managementUnitId' when building request for GetWorkforcemanagementManagementunitTimeoffplanRequest.");
        }
        
        // verify the required parameter 'timeOffPlanId' is set
        if (this.timeOffPlanId == null) {
            throw new IllegalStateException("Missing the required parameter 'timeOffPlanId' when building request for GetWorkforcemanagementManagementunitTimeoffplanRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/managementunits/{managementUnitId}/timeoffplans/{timeOffPlanId}")
	...
	public static class Builder {
		private final GetWorkforcemanagementManagementunitTimeoffplanRequest request;

		private Builder() {
			request = new GetWorkforcemanagementManagementunitTimeoffplanRequest();
		}
		...
		public GetWorkforcemanagementManagementunitTimeoffplanRequest build() {
