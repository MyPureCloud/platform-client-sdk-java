...
public class GetConversationsMessagingIntegrationsOpenRequest {
	...
	public GetConversationsMessagingIntegrationsOpenRequest withPageSize(Integer pageSize) {
	...
	public GetConversationsMessagingIntegrationsOpenRequest withPageNumber(Integer pageNumber) {
	...
	public GetConversationsMessagingIntegrationsOpenRequest withExpand(String expand) {
	...
	public GetConversationsMessagingIntegrationsOpenRequest withSupportedContentId(String supportedContentId) {
	...
	public GetConversationsMessagingIntegrationsOpenRequest withMessagingSettingId(String messagingSettingId) {
    ...
    public GetConversationsMessagingIntegrationsOpenRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/conversations/messaging/integrations/open")
	...
	public static class Builder {
		private final GetConversationsMessagingIntegrationsOpenRequest request;

		private Builder() {
			request = new GetConversationsMessagingIntegrationsOpenRequest();
		}
		...
		public GetConversationsMessagingIntegrationsOpenRequest build() {
