...
public class PatchChatsSettingsRequest {
	...
	public PatchChatsSettingsRequest withBody(ChatSettings body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchChatsSettingsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<ChatSettings> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchChatsSettingsRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/chats/settings")
                .withBody(body)
	...
	public static class Builder {
		private final PatchChatsSettingsRequest request;

		private Builder() {
			request = new PatchChatsSettingsRequest();
		}
		...
		public PatchChatsSettingsRequest build() {
