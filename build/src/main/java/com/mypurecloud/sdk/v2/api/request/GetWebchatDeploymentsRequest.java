...
public class GetWebchatDeploymentsRequest {
    ...
    public GetWebchatDeploymentsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/webchat/deployments")
	...
	public static class Builder {
		private final GetWebchatDeploymentsRequest request;

		private Builder() {
			request = new GetWebchatDeploymentsRequest();
		}
		...
		public GetWebchatDeploymentsRequest build() {
