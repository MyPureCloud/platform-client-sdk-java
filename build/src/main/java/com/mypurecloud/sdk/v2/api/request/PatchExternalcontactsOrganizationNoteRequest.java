...
public class PatchExternalcontactsOrganizationNoteRequest {
	...
	public PatchExternalcontactsOrganizationNoteRequest withExternalOrganizationId(String externalOrganizationId) {
	...
	public PatchExternalcontactsOrganizationNoteRequest withNoteId(String noteId) {
	    this.setNoteId(noteId);
	    return this;
	} 

	private ExternalContactsPatchRequest body;
	public ExternalContactsPatchRequest getBody() {
		return this.body;
	}

	public void setBody(ExternalContactsPatchRequest body) {
		this.body = body;
	}

	public PatchExternalcontactsOrganizationNoteRequest withBody(ExternalContactsPatchRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchExternalcontactsOrganizationNoteRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<ExternalContactsPatchRequest> withHttpInfo() {
        
        // verify the required parameter 'externalOrganizationId' is set
        if (this.externalOrganizationId == null) {
            throw new IllegalStateException("Missing the required parameter 'externalOrganizationId' when building request for PatchExternalcontactsOrganizationNoteRequest.");
        }
        
        // verify the required parameter 'noteId' is set
        if (this.noteId == null) {
            throw new IllegalStateException("Missing the required parameter 'noteId' when building request for PatchExternalcontactsOrganizationNoteRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchExternalcontactsOrganizationNoteRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/externalcontacts/organizations/{externalOrganizationId}/notes/{noteId}")
	...
	public static Builder builder(String externalOrganizationId, String noteId, ExternalContactsPatchRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PatchExternalcontactsOrganizationNoteRequest request;

		private Builder() {
			request = new PatchExternalcontactsOrganizationNoteRequest();
		}
		...
		public Builder withBody(ExternalContactsPatchRequest body) {
		...
		public Builder withRequiredParams(String externalOrganizationId, String noteId, ExternalContactsPatchRequest body) {
			request.setExternalOrganizationId(externalOrganizationId);
			request.setNoteId(noteId);
			request.setBody(body);
		...
		public PatchExternalcontactsOrganizationNoteRequest build() {
