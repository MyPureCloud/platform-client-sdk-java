...
public class PostAnalyticsAgentutilizationsAggregatesQueryRequest {

	private AgentUtilizationAggregationQuery body;
	public AgentUtilizationAggregationQuery getBody() {
		return this.body;
	}

	public void setBody(AgentUtilizationAggregationQuery body) {
		this.body = body;
	}

	public PostAnalyticsAgentutilizationsAggregatesQueryRequest withBody(AgentUtilizationAggregationQuery body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostAnalyticsAgentutilizationsAggregatesQueryRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<AgentUtilizationAggregationQuery> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostAnalyticsAgentutilizationsAggregatesQueryRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/analytics/agentutilizations/aggregates/query")
                .withBody(body)
	...
	public static Builder builder(AgentUtilizationAggregationQuery body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostAnalyticsAgentutilizationsAggregatesQueryRequest request;

		private Builder() {
			request = new PostAnalyticsAgentutilizationsAggregatesQueryRequest();
		}


		public Builder withBody(AgentUtilizationAggregationQuery body) {
		...
		public Builder withRequiredParams(AgentUtilizationAggregationQuery body) {
			request.setBody(body);
		...
		public PostAnalyticsAgentutilizationsAggregatesQueryRequest build() {
