...
public class GetConversationsKeyconfigurationRequest {
	...
	public GetConversationsKeyconfigurationRequest withKeyconfigurationsId(String keyconfigurationsId) {
    ...
    public GetConversationsKeyconfigurationRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.keyconfigurationsId == null) {
            throw new IllegalStateException("Missing the required parameter 'keyconfigurationsId' when building request for GetConversationsKeyconfigurationRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/conversations/keyconfigurations/{keyconfigurationsId}")
	...
	public static Builder builder(String keyconfigurationsId) {
	    return new Builder()
	            .withRequiredParams(keyconfigurationsId);
	}


	public static class Builder {
		private final GetConversationsKeyconfigurationRequest request;

		private Builder() {
			request = new GetConversationsKeyconfigurationRequest();
		}
		...
		public Builder withRequiredParams(String keyconfigurationsId) {
			request.setKeyconfigurationsId(keyconfigurationsId);
		...
		public GetConversationsKeyconfigurationRequest build() {
