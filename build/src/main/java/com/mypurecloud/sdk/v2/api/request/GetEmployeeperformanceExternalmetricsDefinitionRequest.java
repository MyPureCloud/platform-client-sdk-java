...
public class GetEmployeeperformanceExternalmetricsDefinitionRequest {
	...
	public GetEmployeeperformanceExternalmetricsDefinitionRequest withMetricId(String metricId) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.metricId == null) {
            throw new IllegalStateException("Missing the required parameter 'metricId' when building request for GetEmployeeperformanceExternalmetricsDefinitionRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/employeeperformance/externalmetrics/definitions/{metricId}")
	...
	public static class Builder {
		private final GetEmployeeperformanceExternalmetricsDefinitionRequest request;

		private Builder() {
			request = new GetEmployeeperformanceExternalmetricsDefinitionRequest();
		}
		...
		public GetEmployeeperformanceExternalmetricsDefinitionRequest build() {
