...
public class GetKnowledgeConnectionRequest {
	...
	public GetKnowledgeConnectionRequest withConnectionId(String connectionId) {
	...
	public GetKnowledgeConnectionRequest withExpand(List<String> expand) {
    ...
    public GetKnowledgeConnectionRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.connectionId == null) {
            throw new IllegalStateException("Missing the required parameter 'connectionId' when building request for GetKnowledgeConnectionRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/knowledge/connections/{connectionId}")
	...
	public static class Builder {
		private final GetKnowledgeConnectionRequest request;

		private Builder() {
			request = new GetKnowledgeConnectionRequest();
		}
		...
		public GetKnowledgeConnectionRequest build() {
