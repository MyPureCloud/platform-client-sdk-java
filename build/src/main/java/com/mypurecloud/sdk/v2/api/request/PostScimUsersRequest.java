...
public class PostScimUsersRequest {
	...
	public PostScimUsersRequest withBody(ScimV2CreateUser body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostScimUsersRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<ScimV2CreateUser> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostScimUsersRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/scim/users")
                .withBody(body)
	...
	public static class Builder {
		private final PostScimUsersRequest request;

		private Builder() {
			request = new PostScimUsersRequest();
		}
		...
		public PostScimUsersRequest build() {
