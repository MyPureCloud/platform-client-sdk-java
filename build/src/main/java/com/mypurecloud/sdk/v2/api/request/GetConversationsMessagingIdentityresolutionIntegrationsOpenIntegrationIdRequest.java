...
public class GetConversationsMessagingIdentityresolutionIntegrationsOpenIntegrationIdRequest {
	...
	public GetConversationsMessagingIdentityresolutionIntegrationsOpenIntegrationIdRequest withIntegrationId(String integrationId) {
    ...
    public GetConversationsMessagingIdentityresolutionIntegrationsOpenIntegrationIdRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.integrationId == null) {
            throw new IllegalStateException("Missing the required parameter 'integrationId' when building request for GetConversationsMessagingIdentityresolutionIntegrationsOpenIntegrationIdRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/conversations/messaging/identityresolution/integrations/open/{integrationId}")
	...
	public static class Builder {
		private final GetConversationsMessagingIdentityresolutionIntegrationsOpenIntegrationIdRequest request;

		private Builder() {
			request = new GetConversationsMessagingIdentityresolutionIntegrationsOpenIntegrationIdRequest();
		}
		...
		public GetConversationsMessagingIdentityresolutionIntegrationsOpenIntegrationIdRequest build() {
