...
public class PostConversationParticipantDigitsRequest {
	...
	public PostConversationParticipantDigitsRequest withConversationId(String conversationId) {
	...
	public PostConversationParticipantDigitsRequest withParticipantId(String participantId) {
	    this.setParticipantId(participantId);
	    return this;
	} 
	
	private Digits body;
	public Digits getBody() {
		return this.body;
	}

	public void setBody(Digits body) {
		this.body = body;
	}

	public PostConversationParticipantDigitsRequest withBody(Digits body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostConversationParticipantDigitsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<Digits> withHttpInfo() {
        
        // verify the required parameter 'conversationId' is set
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PostConversationParticipantDigitsRequest.");
        }
        
        // verify the required parameter 'participantId' is set
        if (this.participantId == null) {
            throw new IllegalStateException("Missing the required parameter 'participantId' when building request for PostConversationParticipantDigitsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/conversations/{conversationId}/participants/{participantId}/digits")
	...
	public static class Builder {
		private final PostConversationParticipantDigitsRequest request;

		private Builder() {
			request = new PostConversationParticipantDigitsRequest();
		}
		...
		public Builder withBody(Digits body) {
		...
		public PostConversationParticipantDigitsRequest build() {
