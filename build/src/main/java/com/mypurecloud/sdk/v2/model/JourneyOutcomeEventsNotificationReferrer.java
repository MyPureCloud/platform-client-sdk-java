...
public class JourneyOutcomeEventsNotificationReferrer  implements Serializable {
 ...
 @JsonDeserialize(using = MediumEnumDeserializer.class)
  ...
  public JourneyOutcomeEventsNotificationReferrer() {
  ...
  /**
   **/
  public JourneyOutcomeEventsNotificationReferrer url(String url) {
    this.url = url;
    return this;
  }
