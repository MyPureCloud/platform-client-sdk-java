...
public class DeleteOutboundFilespecificationtemplatesBulkRequest {
	...
	public DeleteOutboundFilespecificationtemplatesBulkRequest withId(List<String> id) {
	    this.setId(id);
	    return this;
	} 
    ...
    public DeleteOutboundFilespecificationtemplatesBulkRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.id == null) {
            throw new IllegalStateException("Missing the required parameter 'id' when building request for DeleteOutboundFilespecificationtemplatesBulkRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/outbound/filespecificationtemplates/bulk")
	...
	public static class Builder {
		private final DeleteOutboundFilespecificationtemplatesBulkRequest request;

		private Builder() {
			request = new DeleteOutboundFilespecificationtemplatesBulkRequest();
		}
		...
		public DeleteOutboundFilespecificationtemplatesBulkRequest build() {
