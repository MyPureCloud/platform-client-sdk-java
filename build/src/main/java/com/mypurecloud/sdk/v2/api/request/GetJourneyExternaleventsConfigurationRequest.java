...
public class GetJourneyExternaleventsConfigurationRequest {
	...
	public GetJourneyExternaleventsConfigurationRequest withConfigId(String configId) {
    ...
    public GetJourneyExternaleventsConfigurationRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.configId == null) {
            throw new IllegalStateException("Missing the required parameter 'configId' when building request for GetJourneyExternaleventsConfigurationRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/journey/externalevents/configurations/{configId}")
                .withPathParameter("configId", configId)
	...
	public static Builder builder(String configId) {
	    return new Builder()
	            .withRequiredParams(configId);
	}


	public static class Builder {
		private final GetJourneyExternaleventsConfigurationRequest request;

		private Builder() {
			request = new GetJourneyExternaleventsConfigurationRequest();
		}
		...
		public Builder withRequiredParams(String configId) {
			request.setConfigId(configId);
		...
		public GetJourneyExternaleventsConfigurationRequest build() {
