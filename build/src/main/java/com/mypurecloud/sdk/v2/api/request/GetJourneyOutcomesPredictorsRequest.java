...
public class GetJourneyOutcomesPredictorsRequest {
    ...
    public GetJourneyOutcomesPredictorsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/journey/outcomes/predictors")
	...
	public static class Builder {
		private final GetJourneyOutcomesPredictorsRequest request;

		private Builder() {
			request = new GetJourneyOutcomesPredictorsRequest();
		}
		...
		public GetJourneyOutcomesPredictorsRequest build() {
