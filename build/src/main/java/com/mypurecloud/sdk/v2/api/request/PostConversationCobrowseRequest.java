...
public class PostConversationCobrowseRequest {
	...
	public PostConversationCobrowseRequest withConversationId(String conversationId) {
    ...
    public PostConversationCobrowseRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PostConversationCobrowseRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/conversations/{conversationId}/cobrowse")
	...
	public static class Builder {
		private final PostConversationCobrowseRequest request;

		private Builder() {
			request = new PostConversationCobrowseRequest();
		}
		...
		public PostConversationCobrowseRequest build() {
