...
public class GetGdprRequestsRequest {
	...
	public GetGdprRequestsRequest withPageSize(Integer pageSize) {
	...
	public GetGdprRequestsRequest withPageNumber(Integer pageNumber) {
    ...
    public GetGdprRequestsRequest withCustomHeader(String name, String value) {
