...
public class DeleteConversationParticipantFlaggedreasonRequest {
	...
	public DeleteConversationParticipantFlaggedreasonRequest withConversationId(String conversationId) {
	...
	public DeleteConversationParticipantFlaggedreasonRequest withParticipantId(String participantId) {
    ...
    public DeleteConversationParticipantFlaggedreasonRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for DeleteConversationParticipantFlaggedreasonRequest.");
        }
        
        // verify the required parameter 'participantId' is set
        if (this.participantId == null) {
            throw new IllegalStateException("Missing the required parameter 'participantId' when building request for DeleteConversationParticipantFlaggedreasonRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/conversations/{conversationId}/participants/{participantId}/flaggedreason")
	...
	public static class Builder {
		private final DeleteConversationParticipantFlaggedreasonRequest request;

		private Builder() {
			request = new DeleteConversationParticipantFlaggedreasonRequest();
		}
		...
		public DeleteConversationParticipantFlaggedreasonRequest build() {
