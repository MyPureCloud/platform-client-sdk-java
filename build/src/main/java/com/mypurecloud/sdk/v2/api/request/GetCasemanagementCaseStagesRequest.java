...
public class GetCasemanagementCaseStagesRequest {
	...
	public GetCasemanagementCaseStagesRequest withCaseId(String caseId) {
	...
	public GetCasemanagementCaseStagesRequest withBefore(String before) {
	...
	public GetCasemanagementCaseStagesRequest withAfter(String after) {
	    this.setAfter(after);
	    return this;
	} 
	...
	public GetCasemanagementCaseStagesRequest withPageSize(String pageSize) {
    ...
    public GetCasemanagementCaseStagesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.caseId == null) {
            throw new IllegalStateException("Missing the required parameter 'caseId' when building request for GetCasemanagementCaseStagesRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/casemanagement/cases/{caseId}/stages")
	...
	public static class Builder {
		private final GetCasemanagementCaseStagesRequest request;

		private Builder() {
			request = new GetCasemanagementCaseStagesRequest();
		}
		...
		public GetCasemanagementCaseStagesRequest build() {
