...
public class PostWorkforcemanagementManagementunitAgentschedulesSearchRequest {
    ...
    public PostWorkforcemanagementManagementunitAgentschedulesSearchRequest withCustomHeader(String name, String value) {
	...
	public static class Builder {
		...
		private Builder() {
			request = new PostWorkforcemanagementManagementunitAgentschedulesSearchRequest();
		}
