...
public class GetOutboundCampaignRequest {
	...
	public GetOutboundCampaignRequest withCampaignId(String campaignId) {
    ...
    public GetOutboundCampaignRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.campaignId == null) {
            throw new IllegalStateException("Missing the required parameter 'campaignId' when building request for GetOutboundCampaignRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/outbound/campaigns/{campaignId}")
	...
	public static class Builder {
		private final GetOutboundCampaignRequest request;

		private Builder() {
			request = new GetOutboundCampaignRequest();
		}
		...
		public GetOutboundCampaignRequest build() {
