...
public class PostRoutingEmailDomainVerificationRequest {
	...
	public PostRoutingEmailDomainVerificationRequest withDomainId(String domainId) {
    ...
    public PostRoutingEmailDomainVerificationRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.domainId == null) {
            throw new IllegalStateException("Missing the required parameter 'domainId' when building request for PostRoutingEmailDomainVerificationRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/routing/email/domains/{domainId}/verification")
	...
	public static class Builder {
		private final PostRoutingEmailDomainVerificationRequest request;

		private Builder() {
			request = new PostRoutingEmailDomainVerificationRequest();
		}
		...
		public PostRoutingEmailDomainVerificationRequest build() {
