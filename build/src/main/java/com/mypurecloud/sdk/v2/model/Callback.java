...
public class Callback  implements Serializable {
 ...
 @JsonDeserialize(using = DisconnectTypeEnumDeserializer.class)
  ...
  public Callback(Boolean initWithEmptyList) {
   ...
   * The initial connection state of this communication.
   **/
  public Callback initialState(InitialStateEnum initialState) {
   ...
   **/
  public Callback queueMediaSettings(ConversationQueueMediaSettings queueMediaSettings) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.state, callback.state) &&
            Objects.equals(this.initialState, callback.initialState) &&
            ...
            Objects.equals(this.queueMediaSettings, callback.queueMediaSettings);
  }
