...
public class PatchTaskmanagementWorktypeFlowsOncreateRuleRequest {
	...
	public PatchTaskmanagementWorktypeFlowsOncreateRuleRequest withWorktypeId(String worktypeId) {
	...
	public PatchTaskmanagementWorktypeFlowsOncreateRuleRequest withRuleId(String ruleId) {
	    this.setRuleId(ruleId);
	    return this;
	} 

	private WorkitemOnCreateRuleUpdate body;
	public WorkitemOnCreateRuleUpdate getBody() {
		return this.body;
	}

	public void setBody(WorkitemOnCreateRuleUpdate body) {
		this.body = body;
	}

	public PatchTaskmanagementWorktypeFlowsOncreateRuleRequest withBody(WorkitemOnCreateRuleUpdate body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchTaskmanagementWorktypeFlowsOncreateRuleRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<WorkitemOnCreateRuleUpdate> withHttpInfo() {
        
        // verify the required parameter 'worktypeId' is set
        if (this.worktypeId == null) {
            throw new IllegalStateException("Missing the required parameter 'worktypeId' when building request for PatchTaskmanagementWorktypeFlowsOncreateRuleRequest.");
        }
        
        // verify the required parameter 'ruleId' is set
        if (this.ruleId == null) {
            throw new IllegalStateException("Missing the required parameter 'ruleId' when building request for PatchTaskmanagementWorktypeFlowsOncreateRuleRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchTaskmanagementWorktypeFlowsOncreateRuleRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/taskmanagement/worktypes/{worktypeId}/flows/oncreate/rules/{ruleId}")
	...
	public static Builder builder(String worktypeId, String ruleId, WorkitemOnCreateRuleUpdate body) {
	    return new Builder()
	...
	public static class Builder {
		private final PatchTaskmanagementWorktypeFlowsOncreateRuleRequest request;

		private Builder() {
			request = new PatchTaskmanagementWorktypeFlowsOncreateRuleRequest();
		}
		...
		public Builder withBody(WorkitemOnCreateRuleUpdate body) {
		...
		public Builder withRequiredParams(String worktypeId, String ruleId, WorkitemOnCreateRuleUpdate body) {
			request.setWorktypeId(worktypeId);
			request.setRuleId(ruleId);
			request.setBody(body);
		...
		public PatchTaskmanagementWorktypeFlowsOncreateRuleRequest build() {
