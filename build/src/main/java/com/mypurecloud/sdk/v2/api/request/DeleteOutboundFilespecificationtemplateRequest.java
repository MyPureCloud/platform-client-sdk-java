...
public class DeleteOutboundFilespecificationtemplateRequest {
    ...
    public DeleteOutboundFilespecificationtemplateRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.fileSpecificationTemplateId == null) {
            throw new IllegalStateException("Missing the required parameter 'fileSpecificationTemplateId' when building request for DeleteOutboundFilespecificationtemplateRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/outbound/filespecificationtemplates/{fileSpecificationTemplateId}")
	...
	public static class Builder {
		private final DeleteOutboundFilespecificationtemplateRequest request;

		private Builder() {
			request = new DeleteOutboundFilespecificationtemplateRequest();
		}
		...
		public DeleteOutboundFilespecificationtemplateRequest build() {
