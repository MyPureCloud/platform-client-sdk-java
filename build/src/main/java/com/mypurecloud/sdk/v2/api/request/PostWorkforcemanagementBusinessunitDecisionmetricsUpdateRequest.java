...
public class PostWorkforcemanagementBusinessunitDecisionmetricsUpdateRequest {
	...
	public PostWorkforcemanagementBusinessunitDecisionmetricsUpdateRequest withBusinessUnitId(String businessUnitId) {
	    this.setBusinessUnitId(businessUnitId);
	    return this;
	} 

	private DecisionMetricsUpdateJobRequest body;
	public DecisionMetricsUpdateJobRequest getBody() {
		return this.body;
	}

	public void setBody(DecisionMetricsUpdateJobRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementBusinessunitDecisionmetricsUpdateRequest withBody(DecisionMetricsUpdateJobRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementBusinessunitDecisionmetricsUpdateRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<DecisionMetricsUpdateJobRequest> withHttpInfo() {
        
        // verify the required parameter 'businessUnitId' is set
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PostWorkforcemanagementBusinessunitDecisionmetricsUpdateRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementBusinessunitDecisionmetricsUpdateRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/decisionmetrics/update")
	...
	public static Builder builder(String businessUnitId, DecisionMetricsUpdateJobRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementBusinessunitDecisionmetricsUpdateRequest request;

		private Builder() {
			request = new PostWorkforcemanagementBusinessunitDecisionmetricsUpdateRequest();
		}
		...
		public Builder withBody(DecisionMetricsUpdateJobRequest body) {
		...
		public Builder withRequiredParams(String businessUnitId, DecisionMetricsUpdateJobRequest body) {
			request.setBusinessUnitId(businessUnitId);
			request.setBody(body);
		...
		public PostWorkforcemanagementBusinessunitDecisionmetricsUpdateRequest build() {
