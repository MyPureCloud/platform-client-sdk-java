...
public class GetUserProfileskillsRequest {
	...
	public GetUserProfileskillsRequest withUserId(String userId) {
    ...
    public GetUserProfileskillsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/users/{userId}/profileskills")
	...
	public static class Builder {
		private final GetUserProfileskillsRequest request;

		private Builder() {
			request = new GetUserProfileskillsRequest();
		}
		...
		public GetUserProfileskillsRequest build() {
