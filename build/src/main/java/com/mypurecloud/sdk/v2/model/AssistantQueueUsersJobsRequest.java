...
public class AssistantQueueUsersJobsRequest  implements Serializable {
 ...
 @JsonDeserialize(using = ActionEnumDeserializer.class)
  ...
  public AssistantQueueUsersJobsRequest() {
   ...
   * Action to perform by the job.
   **/
  public AssistantQueueUsersJobsRequest action(ActionEnum action) {
    this.action = action;
    return this;
  }
  
  @ApiModelProperty(example = "null", required = true, value = "Action to perform by the job.")
  @JsonProperty("action")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    AssistantQueueUsersJobsRequest assistantQueueUsersJobsRequest = (AssistantQueueUsersJobsRequest) o;

    return Objects.equals(this.action, assistantQueueUsersJobsRequest.action);
  }
