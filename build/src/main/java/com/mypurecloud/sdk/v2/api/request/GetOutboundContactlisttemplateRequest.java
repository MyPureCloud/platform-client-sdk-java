...
public class GetOutboundContactlisttemplateRequest {
	...
	public GetOutboundContactlisttemplateRequest withContactListTemplateId(String contactListTemplateId) {
    ...
    public GetOutboundContactlisttemplateRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.contactListTemplateId == null) {
            throw new IllegalStateException("Missing the required parameter 'contactListTemplateId' when building request for GetOutboundContactlisttemplateRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/outbound/contactlisttemplates/{contactListTemplateId}")
	...
	public static class Builder {
		private final GetOutboundContactlisttemplateRequest request;

		private Builder() {
			request = new GetOutboundContactlisttemplateRequest();
		}
		...
		public GetOutboundContactlisttemplateRequest build() {
