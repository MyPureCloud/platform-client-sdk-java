...
public class PostAnalyticsSummariesAggregatesQueryRequest {

	private SummaryAggregationQuery body;
	public SummaryAggregationQuery getBody() {
		return this.body;
	}

	public void setBody(SummaryAggregationQuery body) {
		this.body = body;
	}

	public PostAnalyticsSummariesAggregatesQueryRequest withBody(SummaryAggregationQuery body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostAnalyticsSummariesAggregatesQueryRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<SummaryAggregationQuery> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostAnalyticsSummariesAggregatesQueryRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/analytics/summaries/aggregates/query")
                .withBody(body)
	...
	public static Builder builder(SummaryAggregationQuery body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostAnalyticsSummariesAggregatesQueryRequest request;

		private Builder() {
			request = new PostAnalyticsSummariesAggregatesQueryRequest();
		}


		public Builder withBody(SummaryAggregationQuery body) {
		...
		public Builder withRequiredParams(SummaryAggregationQuery body) {
			request.setBody(body);
		...
		public PostAnalyticsSummariesAggregatesQueryRequest build() {
