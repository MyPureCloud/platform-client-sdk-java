...
public class EvaluationAggregateQueryPredicate  implements Serializable {
 ...
 @JsonDeserialize(using = OperatorEnumDeserializer.class)
  ...
  public EvaluationAggregateQueryPredicate() {
   ...
   * Optional type, can usually be inferred
   **/
  public EvaluationAggregateQueryPredicate type(TypeEnum type) {
    this.type = type;
    return this;
  }
   ...
   * Left hand side for dimension predicates
   **/
  public EvaluationAggregateQueryPredicate dimension(DimensionEnum dimension) {
   ...
   * Optional operator, default is matches
   **/
  public EvaluationAggregateQueryPredicate operator(OperatorEnum operator) {
   ...
   **/
  public EvaluationAggregateQueryPredicate value(String value) {
    this.value = value;
    return this;
  }
   ...
   * Right hand side for dimension predicates
   **/
  public EvaluationAggregateQueryPredicate range(NumericRange range) {
    this.range = range;
    return this;
  }
