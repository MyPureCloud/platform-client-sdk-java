...
public class DeleteWorkforcemanagementBusinessunitServicegoaltemplateRequest {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for DeleteWorkforcemanagementBusinessunitServicegoaltemplateRequest.");
        }
        
        // verify the required parameter 'serviceGoalTemplateId' is set
        if (this.serviceGoalTemplateId == null) {
            throw new IllegalStateException("Missing the required parameter 'serviceGoalTemplateId' when building request for DeleteWorkforcemanagementBusinessunitServicegoaltemplateRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/servicegoaltemplates/{serviceGoalTemplateId}")
	...
	public static class Builder {
		private final DeleteWorkforcemanagementBusinessunitServicegoaltemplateRequest request;

		private Builder() {
			request = new DeleteWorkforcemanagementBusinessunitServicegoaltemplateRequest();
		}
		...
		public DeleteWorkforcemanagementBusinessunitServicegoaltemplateRequest build() {
