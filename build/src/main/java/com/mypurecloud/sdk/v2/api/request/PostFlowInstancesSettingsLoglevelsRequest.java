...
public class PostFlowInstancesSettingsLoglevelsRequest {
    ...
    public ApiRequest<FlowLogLevelRequest> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("POST", "/api/v2/flows/{flowId}/instances/settings/loglevels")
	...
	public static class Builder {
		private final PostFlowInstancesSettingsLoglevelsRequest request;

		private Builder() {
			request = new PostFlowInstancesSettingsLoglevelsRequest();
		}
