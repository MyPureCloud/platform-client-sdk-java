...
public class PostConversationsMessagingIntegrationsWhatsappRequest {
    
	private WhatsAppIntegrationRequest body;
	public WhatsAppIntegrationRequest getBody() {
		return this.body;
	}

	public void setBody(WhatsAppIntegrationRequest body) {
		this.body = body;
	}

	public PostConversationsMessagingIntegrationsWhatsappRequest withBody(WhatsAppIntegrationRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostConversationsMessagingIntegrationsWhatsappRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<WhatsAppIntegrationRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostConversationsMessagingIntegrationsWhatsappRequest.");
        }
	...
	public static Builder builder(WhatsAppIntegrationRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostConversationsMessagingIntegrationsWhatsappRequest request;

		private Builder() {
			request = new PostConversationsMessagingIntegrationsWhatsappRequest();
		}
		...
		public Builder withRequiredParams(WhatsAppIntegrationRequest body) {
			request.setBody(body);
		...
		public PostConversationsMessagingIntegrationsWhatsappRequest build() {
