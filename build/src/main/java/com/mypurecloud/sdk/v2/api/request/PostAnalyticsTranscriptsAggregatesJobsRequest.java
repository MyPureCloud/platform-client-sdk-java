...
public class PostAnalyticsTranscriptsAggregatesJobsRequest {

	private TranscriptAsyncAggregationQuery body;
	public TranscriptAsyncAggregationQuery getBody() {
		return this.body;
	}

	public void setBody(TranscriptAsyncAggregationQuery body) {
		this.body = body;
	}

	public PostAnalyticsTranscriptsAggregatesJobsRequest withBody(TranscriptAsyncAggregationQuery body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostAnalyticsTranscriptsAggregatesJobsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<TranscriptAsyncAggregationQuery> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostAnalyticsTranscriptsAggregatesJobsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/analytics/transcripts/aggregates/jobs")
                .withBody(body)
	...
	public static Builder builder(TranscriptAsyncAggregationQuery body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostAnalyticsTranscriptsAggregatesJobsRequest request;

		private Builder() {
			request = new PostAnalyticsTranscriptsAggregatesJobsRequest();
		}


		public Builder withBody(TranscriptAsyncAggregationQuery body) {
		...
		public Builder withRequiredParams(TranscriptAsyncAggregationQuery body) {
			request.setBody(body);
		...
		public PostAnalyticsTranscriptsAggregatesJobsRequest build() {
