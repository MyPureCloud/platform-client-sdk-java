...
public class PatchWorkforcemanagementManagementunitSchedulingRunRequest {
	...
	public PatchWorkforcemanagementManagementunitSchedulingRunRequest withManagementUnitId(String managementUnitId) {
	...
	public PatchWorkforcemanagementManagementunitSchedulingRunRequest withRunId(String runId) {
	    this.setRunId(runId);
	    return this;
	} 
	
	private UpdateSchedulingRunRequest body;
	public UpdateSchedulingRunRequest getBody() {
		return this.body;
	}

	public void setBody(UpdateSchedulingRunRequest body) {
		this.body = body;
	}

	public PatchWorkforcemanagementManagementunitSchedulingRunRequest withBody(UpdateSchedulingRunRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchWorkforcemanagementManagementunitSchedulingRunRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<UpdateSchedulingRunRequest> withHttpInfo() {
        
        // verify the required parameter 'managementUnitId' is set
        if (this.managementUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'managementUnitId' when building request for PatchWorkforcemanagementManagementunitSchedulingRunRequest.");
        }
        
        // verify the required parameter 'runId' is set
        if (this.runId == null) {
            throw new IllegalStateException("Missing the required parameter 'runId' when building request for PatchWorkforcemanagementManagementunitSchedulingRunRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/workforcemanagement/managementunits/{managementUnitId}/scheduling/runs/{runId}")
	...
	public static Builder builder(String managementUnitId, String runId) {
	    return new Builder()
	            .withRequiredParams(managementUnitId, runId);
	}
	

	public static class Builder {
		private final PatchWorkforcemanagementManagementunitSchedulingRunRequest request;

		private Builder() {
			request = new PatchWorkforcemanagementManagementunitSchedulingRunRequest();
		}
		...
		public Builder withBody(UpdateSchedulingRunRequest body) {
		...
		public Builder withRequiredParams(String managementUnitId, String runId) {
			request.setManagementUnitId(managementUnitId);
						request.setRunId(runId);
		...
		public PatchWorkforcemanagementManagementunitSchedulingRunRequest build() {
