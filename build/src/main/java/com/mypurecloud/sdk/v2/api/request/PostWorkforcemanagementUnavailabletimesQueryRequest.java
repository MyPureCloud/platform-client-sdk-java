...
public class PostWorkforcemanagementUnavailabletimesQueryRequest {
	...
	public PostWorkforcemanagementUnavailabletimesQueryRequest withBody(QueryAgentUnavailableTimesRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementUnavailabletimesQueryRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<QueryAgentUnavailableTimesRequest> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementUnavailabletimesQueryRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/unavailabletimes/query")
                .withBody(body)
	...
	public static Builder builder(QueryAgentUnavailableTimesRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementUnavailabletimesQueryRequest request;

		private Builder() {
			request = new PostWorkforcemanagementUnavailabletimesQueryRequest();
		}
		...
		public Builder withRequiredParams(QueryAgentUnavailableTimesRequest body) {
			request.setBody(body);
		...
		public PostWorkforcemanagementUnavailabletimesQueryRequest build() {
