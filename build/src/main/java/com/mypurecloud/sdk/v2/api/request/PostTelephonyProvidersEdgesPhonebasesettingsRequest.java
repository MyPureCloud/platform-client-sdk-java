...
public class PostTelephonyProvidersEdgesPhonebasesettingsRequest {
	...
	public PostTelephonyProvidersEdgesPhonebasesettingsRequest withBody(PhoneBase body) {
	    this.setBody(body);
	    return this;
	}
    ...
    public PostTelephonyProvidersEdgesPhonebasesettingsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<PhoneBase> withHttpInfo() throws ApiException {
        ...
        if (this.body == null) {
            throw new ApiException(400, "Missing the required parameter 'body' when building request for PostTelephonyProvidersEdgesPhonebasesettingsRequest.");
        }
