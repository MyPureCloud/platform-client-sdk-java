...
public class SummaryAggregationQuery  implements Serializable {
 ...
 @JsonDeserialize(using = GroupByEnumDeserializer.class)
  ...
  private SummaryAggregateQueryFilter filter = null;
 ...
 @JsonDeserialize(using = MetricsEnumDeserializer.class)
  ...
  private List<SummaryAggregationView> views = new ArrayList<SummaryAggregationView>();
 ...
 @JsonDeserialize(using = QueryTypeEnumDeserializer.class)
   ...
   **/
  public SummaryAggregationQuery interval(String interval) {
   ...
   **/
  public SummaryAggregationQuery granularity(String granularity) {
   ...
   **/
  public SummaryAggregationQuery timeZone(String timeZone) {
   ...
   **/
  public SummaryAggregationQuery groupBy(List<GroupByEnum> groupBy) {
   ...
   **/
  public SummaryAggregationQuery filter(SummaryAggregateQueryFilter filter) {
    this.filter = filter;
    return this;
  }
  ...
  @JsonProperty("filter")
  public SummaryAggregateQueryFilter getFilter() {
    return filter;
  }
  public void setFilter(SummaryAggregateQueryFilter filter) {
    this.filter = filter;
  }
   ...
   **/
  public SummaryAggregationQuery metrics(List<MetricsEnum> metrics) {
   ...
   **/
  public SummaryAggregationQuery flattenMultivaluedDimensions(Boolean flattenMultivaluedDimensions) {
   ...
   **/
  public SummaryAggregationQuery views(List<SummaryAggregationView> views) {
    this.views = views;
    return this;
  }
  ...
  @JsonProperty("views")
  public List<SummaryAggregationView> getViews() {
    return views;
  }
  public void setViews(List<SummaryAggregationView> views) {
    this.views = views;
  }
   ...
   * Dimension to use as the alternative timestamp for data in the aggregate.  Choosing \"eventTime\" uses the actual time of the data event.
   **/
  public SummaryAggregationQuery alternateTimeDimension(AlternateTimeDimensionEnum alternateTimeDimension) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SummaryAggregationQuery summaryAggregationQuery = (SummaryAggregationQuery) o;

    return Objects.equals(this.interval, summaryAggregationQuery.interval) &&
            Objects.equals(this.granularity, summaryAggregationQuery.granularity) &&
            Objects.equals(this.timeZone, summaryAggregationQuery.timeZone) &&
            Objects.equals(this.groupBy, summaryAggregationQuery.groupBy) &&
            Objects.equals(this.filter, summaryAggregationQuery.filter) &&
            Objects.equals(this.metrics, summaryAggregationQuery.metrics) &&
            Objects.equals(this.flattenMultivaluedDimensions, summaryAggregationQuery.flattenMultivaluedDimensions) &&
