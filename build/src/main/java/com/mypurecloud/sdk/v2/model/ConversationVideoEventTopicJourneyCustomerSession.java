...
public class ConversationVideoEventTopicJourneyCustomerSession  implements Serializable {
  
  private String id = null;
  private String type = null;

  public ConversationVideoEventTopicJourneyCustomerSession() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
    }
  }

  public ConversationVideoEventTopicJourneyCustomerSession(Boolean initWithEmptyList) {
   ...
   **/
  public ConversationVideoEventTopicJourneyCustomerSession id(String id) {
    this.id = id;
    return this;
  }
   ...
   **/
  public ConversationVideoEventTopicJourneyCustomerSession type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ConversationVideoEventTopicJourneyCustomerSession conversationVideoEventTopicJourneyCustomerSession = (ConversationVideoEventTopicJourneyCustomerSession) o;

    return Objects.equals(this.id, conversationVideoEventTopicJourneyCustomerSession.id) &&
            Objects.equals(this.type, conversationVideoEventTopicJourneyCustomerSession.type);
  }
