...
public class ActionTemplateListing  implements Serializable, PagedResource<ActionTemplate> {
  ...
  /**
   **/
  public ActionTemplateListing entities(List<ActionTemplate> entities) {
  ...
  public List<ActionTemplate> getEntities() {
    return entities;
  }
  public void setEntities(List<ActionTemplate> entities) {
    this.entities = entities;
  }
