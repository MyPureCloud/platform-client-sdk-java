...
public class PostWorkforcemanagementBusinessunitOpportunitiesExternalactivitiesQueryRequest {
	...
	public PostWorkforcemanagementBusinessunitOpportunitiesExternalactivitiesQueryRequest withBusinessUnitId(String businessUnitId) {
	    this.setBusinessUnitId(businessUnitId);
	    return this;
	} 

	private BulkOpportunitiesExternalActivitiesRequest body;
	public BulkOpportunitiesExternalActivitiesRequest getBody() {
		return this.body;
	}

	public void setBody(BulkOpportunitiesExternalActivitiesRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementBusinessunitOpportunitiesExternalactivitiesQueryRequest withBody(BulkOpportunitiesExternalActivitiesRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementBusinessunitOpportunitiesExternalactivitiesQueryRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<BulkOpportunitiesExternalActivitiesRequest> withHttpInfo() {
        
        // verify the required parameter 'businessUnitId' is set
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PostWorkforcemanagementBusinessunitOpportunitiesExternalactivitiesQueryRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementBusinessunitOpportunitiesExternalactivitiesQueryRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/opportunities/externalactivities/query")
	...
	public static Builder builder(String businessUnitId, BulkOpportunitiesExternalActivitiesRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementBusinessunitOpportunitiesExternalactivitiesQueryRequest request;

		private Builder() {
			request = new PostWorkforcemanagementBusinessunitOpportunitiesExternalactivitiesQueryRequest();
		}
		...
		public Builder withBody(BulkOpportunitiesExternalActivitiesRequest body) {
		...
		public Builder withRequiredParams(String businessUnitId, BulkOpportunitiesExternalActivitiesRequest body) {
			request.setBusinessUnitId(businessUnitId);
			request.setBody(body);
		...
		public PostWorkforcemanagementBusinessunitOpportunitiesExternalactivitiesQueryRequest build() {
