...
public class GetSocialmediaTopicDataingestionrulesRequest {
	...
	public GetSocialmediaTopicDataingestionrulesRequest withTopicId(String topicId) {
	...
	public GetSocialmediaTopicDataingestionrulesRequest withPageNumber(Integer pageNumber) {
	...
	public GetSocialmediaTopicDataingestionrulesRequest withPageSize(Integer pageSize) {
	...
	public GetSocialmediaTopicDataingestionrulesRequest withIncludeDeleted(Boolean includeDeleted) {
    ...
    public GetSocialmediaTopicDataingestionrulesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.topicId == null) {
            throw new IllegalStateException("Missing the required parameter 'topicId' when building request for GetSocialmediaTopicDataingestionrulesRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/socialmedia/topics/{topicId}/dataingestionrules")
	...
	public static class Builder {
		private final GetSocialmediaTopicDataingestionrulesRequest request;

		private Builder() {
			request = new GetSocialmediaTopicDataingestionrulesRequest();
		}
		...
		public GetSocialmediaTopicDataingestionrulesRequest build() {
