...
public class PostExternalcontactsBulkContactsUpdateRequest {
	...
	public PostExternalcontactsBulkContactsUpdateRequest withBody(BulkContactsRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostExternalcontactsBulkContactsUpdateRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<BulkContactsRequest> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostExternalcontactsBulkContactsUpdateRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/externalcontacts/bulk/contacts/update")
                .withBody(body)
	...
	public static class Builder {
		private final PostExternalcontactsBulkContactsUpdateRequest request;

		private Builder() {
			request = new PostExternalcontactsBulkContactsUpdateRequest();
		}
		...
		public PostExternalcontactsBulkContactsUpdateRequest build() {
