...
public class GetQualityFormsSurveysRequest {
	...
	public GetQualityFormsSurveysRequest withPageSize(Integer pageSize) {
	...
	public GetQualityFormsSurveysRequest withPageNumber(Integer pageNumber) {
	...
	public GetQualityFormsSurveysRequest withSortBy(String sortBy) {
	...
	public GetQualityFormsSurveysRequest withNextPage(String nextPage) {
	...
	public GetQualityFormsSurveysRequest withPreviousPage(String previousPage) {
	...
	public GetQualityFormsSurveysRequest withExpand(String expand) {
	...
	public GetQualityFormsSurveysRequest withName(String name) {
	    this.setName(name);
	    return this;
	} 
	...
	public GetQualityFormsSurveysRequest withSortOrder(String sortOrder) {
    ...
    public GetQualityFormsSurveysRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/quality/forms/surveys")
	...
	public static class Builder {
		private final GetQualityFormsSurveysRequest request;

		private Builder() {
			request = new GetQualityFormsSurveysRequest();
		}
		...
		public GetQualityFormsSurveysRequest build() {
