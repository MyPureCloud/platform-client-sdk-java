...
public class DeleteConversationCustomattributeRequest {
	...
	public DeleteConversationCustomattributeRequest withConversationId(String conversationId) {
	...
	public DeleteConversationCustomattributeRequest withAttributesId(String attributesId) {
	    this.setAttributesId(attributesId);
	    return this;
	} 
    ...
    public DeleteConversationCustomattributeRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for DeleteConversationCustomattributeRequest.");
        }
        
        // verify the required parameter 'attributesId' is set
        if (this.attributesId == null) {
            throw new IllegalStateException("Missing the required parameter 'attributesId' when building request for DeleteConversationCustomattributeRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/conversations/{conversationId}/customattributes/{attributesId}")
                .withPathParameter("conversationId", conversationId)
        
                .withPathParameter("attributesId", attributesId)
	...
	public static Builder builder(String conversationId, String attributesId) {
	    return new Builder()
	            .withRequiredParams(conversationId, attributesId);
	}


	public static class Builder {
		private final DeleteConversationCustomattributeRequest request;

		private Builder() {
			request = new DeleteConversationCustomattributeRequest();
		}
		...
		public Builder withAttributesId(String attributesId) {
		...
		public Builder withRequiredParams(String conversationId, String attributesId) {
			request.setConversationId(conversationId);
			request.setAttributesId(attributesId);
		...
		public DeleteConversationCustomattributeRequest build() {
