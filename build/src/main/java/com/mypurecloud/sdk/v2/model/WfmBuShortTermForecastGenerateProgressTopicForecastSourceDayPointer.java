...
public class WfmBuShortTermForecastGenerateProgressTopicForecastSourceDayPointer  implements Serializable {
 ...
 @JsonDeserialize(using = DayOfWeekEnumDeserializer.class)
  ...
  public WfmBuShortTermForecastGenerateProgressTopicForecastSourceDayPointer() {
  ...
  /**
   **/
  public WfmBuShortTermForecastGenerateProgressTopicForecastSourceDayPointer weight(Long weight) {
    this.weight = weight;
    return this;
  }
