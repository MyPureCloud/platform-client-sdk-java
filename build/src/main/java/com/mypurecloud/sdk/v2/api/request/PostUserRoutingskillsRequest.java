...
public class PostUserRoutingskillsRequest {
    ...
    public ApiRequest<UserRoutingSkillPost> withHttpInfo() throws ApiException {
        
        // verify the required parameter 'userId' is set
        if (this.userId == null) {
            throw new ApiException(400, "Missing the required parameter 'userId' when building request for PostUserRoutingskillsRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new ApiException(400, "Missing the required parameter 'body' when building request for PostUserRoutingskillsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/users/{userId}/routingskills")
