...
public class DeleteAnalyticsTranscriptsAggregatesJobRequest {
	...
	public DeleteAnalyticsTranscriptsAggregatesJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public DeleteAnalyticsTranscriptsAggregatesJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for DeleteAnalyticsTranscriptsAggregatesJobRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/analytics/transcripts/aggregates/jobs/{jobId}")
	...
	public static class Builder {
		private final DeleteAnalyticsTranscriptsAggregatesJobRequest request;

		private Builder() {
			request = new DeleteAnalyticsTranscriptsAggregatesJobRequest();
		}
		...
		public DeleteAnalyticsTranscriptsAggregatesJobRequest build() {
