...
public class GetWorkforcemanagementBusinessunitTimeofflimitsRequest {
	...
	public GetWorkforcemanagementBusinessunitTimeofflimitsRequest withBusinessUnitId(String businessUnitId) {
	...
	public GetWorkforcemanagementBusinessunitTimeofflimitsRequest withManagementUnitId(String managementUnitId) {
    ...
    public GetWorkforcemanagementBusinessunitTimeofflimitsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for GetWorkforcemanagementBusinessunitTimeofflimitsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/timeofflimits")
	...
	public static class Builder {
		private final GetWorkforcemanagementBusinessunitTimeofflimitsRequest request;

		private Builder() {
			request = new GetWorkforcemanagementBusinessunitTimeofflimitsRequest();
		}
		...
		public GetWorkforcemanagementBusinessunitTimeofflimitsRequest build() {
