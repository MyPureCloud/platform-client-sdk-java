...
public class GetJourneyViewVersionJobsLatestRequest {
	...
	public GetJourneyViewVersionJobsLatestRequest withViewId(String viewId) {
	...
	public GetJourneyViewVersionJobsLatestRequest withJourneyVersionId(String journeyVersionId) {
    ...
    public GetJourneyViewVersionJobsLatestRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.viewId == null) {
            throw new IllegalStateException("Missing the required parameter 'viewId' when building request for GetJourneyViewVersionJobsLatestRequest.");
        }
        
        // verify the required parameter 'journeyVersionId' is set
        if (this.journeyVersionId == null) {
            throw new IllegalStateException("Missing the required parameter 'journeyVersionId' when building request for GetJourneyViewVersionJobsLatestRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/journey/views/{viewId}/versions/{journeyVersionId}/jobs/latest")
	...
	public static class Builder {
		private final GetJourneyViewVersionJobsLatestRequest request;

		private Builder() {
			request = new GetJourneyViewVersionJobsLatestRequest();
		}
		...
		public GetJourneyViewVersionJobsLatestRequest build() {
