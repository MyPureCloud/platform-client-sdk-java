...
public class DeleteChatsRoomMessageRequest {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("DELETE", "/api/v2/chats/rooms/{roomJid}/messages/{messageId}")
	...
	public static Builder builder(String roomJid, String messageId) {
	    return new Builder()
	            .withRequiredParams(roomJid, messageId);
	}


	public static class Builder {
		private final DeleteChatsRoomMessageRequest request;

		private Builder() {
			request = new DeleteChatsRoomMessageRequest();
		}
