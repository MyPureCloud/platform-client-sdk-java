...
public class OutboundMessagingCampaignPostContactSmsEventTopicSMSAttributes  implements Serializable {
  ...
  public OutboundMessagingCampaignPostContactSmsEventTopicSMSAttributes() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
    }
  }

  public OutboundMessagingCampaignPostContactSmsEventTopicSMSAttributes(Boolean initWithEmptyList) {
