...
import com.mypurecloud.sdk.v2.model.ConversationCallbackEventTopicQueueMediaSettings;
...
public class ConversationCallbackEventTopicCallbackMediaParticipant  implements Serializable {
 ...
 @JsonDeserialize(using = FlaggedReasonEnumDeserializer.class)
  ...
  public ConversationCallbackEventTopicCallbackMediaParticipant(Boolean initWithEmptyList) {
  ...
  /**
   **/
  public ConversationCallbackEventTopicCallbackMediaParticipant wrapupTimeoutMs(Long wrapupTimeoutMs) {
  ...
  /**
   **/
  public ConversationCallbackEventTopicCallbackMediaParticipant alertingTimeoutMs(Long alertingTimeoutMs) {
  ...
  /**
   **/
  public ConversationCallbackEventTopicCallbackMediaParticipant resumeTime(Date resumeTime) {
  ...
  /**
   **/
  public ConversationCallbackEventTopicCallbackMediaParticipant queueMediaSettings(ConversationCallbackEventTopicQueueMediaSettings queueMediaSettings) {
  ...
  public ConversationCallbackEventTopicQueueMediaSettings getQueueMediaSettings() {
    return queueMediaSettings;
  }
  public void setQueueMediaSettings(ConversationCallbackEventTopicQueueMediaSettings queueMediaSettings) {
    this.queueMediaSettings = queueMediaSettings;
  }
  ...
  /**
   **/
  public ConversationCallbackEventTopicCallbackMediaParticipant timeoutSeconds(Long timeoutSeconds) {
