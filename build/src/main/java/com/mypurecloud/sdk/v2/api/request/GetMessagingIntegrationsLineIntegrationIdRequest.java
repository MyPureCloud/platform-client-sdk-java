...
public class GetMessagingIntegrationsLineIntegrationIdRequest {
	...
	public GetMessagingIntegrationsLineIntegrationIdRequest withIntegrationId(String integrationId) {
    ...
    public GetMessagingIntegrationsLineIntegrationIdRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.integrationId == null) {
            throw new IllegalStateException("Missing the required parameter 'integrationId' when building request for GetMessagingIntegrationsLineIntegrationIdRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/messaging/integrations/line/{integrationId}")
	...
	public static class Builder {
		private final GetMessagingIntegrationsLineIntegrationIdRequest request;

		private Builder() {
			request = new GetMessagingIntegrationsLineIntegrationIdRequest();
		}
		...
		public GetMessagingIntegrationsLineIntegrationIdRequest build() {
