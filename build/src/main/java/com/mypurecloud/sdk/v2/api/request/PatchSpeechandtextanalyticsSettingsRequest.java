...
public class PatchSpeechandtextanalyticsSettingsRequest {
	...
	public PatchSpeechandtextanalyticsSettingsRequest withBody(SpeechTextAnalyticsSettingsRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchSpeechandtextanalyticsSettingsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<SpeechTextAnalyticsSettingsRequest> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchSpeechandtextanalyticsSettingsRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/speechandtextanalytics/settings")
                .withBody(body)
	...
	public static class Builder {
		private final PatchSpeechandtextanalyticsSettingsRequest request;

		private Builder() {
			request = new PatchSpeechandtextanalyticsSettingsRequest();
		}
		...
		public PatchSpeechandtextanalyticsSettingsRequest build() {
