...
public class PostWorkforcemanagementBusinessunitSchedulebidsRequest {
	...
	public PostWorkforcemanagementBusinessunitSchedulebidsRequest withBusinessUnitId(String businessUnitId) {
	    this.setBusinessUnitId(businessUnitId);
	    return this;
	} 

	private CreateScheduleBid body;
	public CreateScheduleBid getBody() {
		return this.body;
	}

	public void setBody(CreateScheduleBid body) {
		this.body = body;
	}

	public PostWorkforcemanagementBusinessunitSchedulebidsRequest withBody(CreateScheduleBid body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementBusinessunitSchedulebidsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<CreateScheduleBid> withHttpInfo() {
        
        // verify the required parameter 'businessUnitId' is set
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PostWorkforcemanagementBusinessunitSchedulebidsRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementBusinessunitSchedulebidsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/schedulebids")
	...
	public static Builder builder(String businessUnitId, CreateScheduleBid body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementBusinessunitSchedulebidsRequest request;

		private Builder() {
			request = new PostWorkforcemanagementBusinessunitSchedulebidsRequest();
		}
		...
		public Builder withBody(CreateScheduleBid body) {
		...
		public Builder withRequiredParams(String businessUnitId, CreateScheduleBid body) {
			request.setBusinessUnitId(businessUnitId);
			request.setBody(body);
		...
		public PostWorkforcemanagementBusinessunitSchedulebidsRequest build() {
