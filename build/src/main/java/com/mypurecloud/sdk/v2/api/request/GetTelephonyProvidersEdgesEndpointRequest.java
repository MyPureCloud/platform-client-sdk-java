...
public class GetTelephonyProvidersEdgesEndpointRequest {
	...
	public GetTelephonyProvidersEdgesEndpointRequest withEndpointId(String endpointId) {
    ...
    public GetTelephonyProvidersEdgesEndpointRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.endpointId == null) {
            throw new IllegalStateException("Missing the required parameter 'endpointId' when building request for GetTelephonyProvidersEdgesEndpointRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/telephony/providers/edges/endpoints/{endpointId}")
	...
	public static class Builder {
		private final GetTelephonyProvidersEdgesEndpointRequest request;

		private Builder() {
			request = new GetTelephonyProvidersEdgesEndpointRequest();
		}
		...
		public GetTelephonyProvidersEdgesEndpointRequest build() {
