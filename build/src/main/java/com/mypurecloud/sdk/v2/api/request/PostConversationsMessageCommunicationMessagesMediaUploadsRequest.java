...
public class PostConversationsMessageCommunicationMessagesMediaUploadsRequest {
	...
	private UploadMediaRequest body;
	public UploadMediaRequest getBody() {
		return this.body;
	}

	public void setBody(UploadMediaRequest body) {
		this.body = body;
	}
    ...
    public ApiRequest<UploadMediaRequest> withHttpInfo() {
        
        // verify the required parameter 'conversationId' is set
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PostConversationsMessageCommunicationMessagesMediaUploadsRequest.");
        }
        
        // verify the required parameter 'communicationId' is set
        if (this.communicationId == null) {
            throw new IllegalStateException("Missing the required parameter 'communicationId' when building request for PostConversationsMessageCommunicationMessagesMediaUploadsRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostConversationsMessageCommunicationMessagesMediaUploadsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/conversations/messages/{conversationId}/communications/{communicationId}/messages/media/uploads")
	...
	public static Builder builder(String conversationId, String communicationId, UploadMediaRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostConversationsMessageCommunicationMessagesMediaUploadsRequest request;

		private Builder() {
			request = new PostConversationsMessageCommunicationMessagesMediaUploadsRequest();
		}
		...
		public Builder withBody(UploadMediaRequest body) {
		...
		public Builder withRequiredParams(String conversationId, String communicationId, UploadMediaRequest body) {
			request.setConversationId(conversationId);
			request.setCommunicationId(communicationId);
			request.setBody(body);
		...
		public PostConversationsMessageCommunicationMessagesMediaUploadsRequest build() {
