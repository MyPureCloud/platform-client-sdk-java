...
public class PostCasemanagementCaseAssociationsRequest {
	...
	public PostCasemanagementCaseAssociationsRequest withCaseId(String caseId) {
	    this.setCaseId(caseId);
	    return this;
	} 

	private CaseAssociationCreate body;
	public CaseAssociationCreate getBody() {
		return this.body;
	}

	public void setBody(CaseAssociationCreate body) {
		this.body = body;
	}

	public PostCasemanagementCaseAssociationsRequest withBody(CaseAssociationCreate body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostCasemanagementCaseAssociationsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<CaseAssociationCreate> withHttpInfo() {
	...
	public static class Builder {
		private final PostCasemanagementCaseAssociationsRequest request;

		private Builder() {
			request = new PostCasemanagementCaseAssociationsRequest();
		}
		...
		public Builder withBody(CaseAssociationCreate body) {
		...
		public PostCasemanagementCaseAssociationsRequest build() {
