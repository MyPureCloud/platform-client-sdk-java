...
public class GetQualityFormsSurveyRequest {
	...
	public GetQualityFormsSurveyRequest withFormId(String formId) {
    ...
    public GetQualityFormsSurveyRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.formId == null) {
            throw new IllegalStateException("Missing the required parameter 'formId' when building request for GetQualityFormsSurveyRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/quality/forms/surveys/{formId}")
	...
	public static class Builder {
		private final GetQualityFormsSurveyRequest request;

		private Builder() {
			request = new GetQualityFormsSurveyRequest();
		}
		...
		public GetQualityFormsSurveyRequest build() {
