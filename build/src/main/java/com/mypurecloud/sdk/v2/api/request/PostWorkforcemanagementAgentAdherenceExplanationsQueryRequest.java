...
public class PostWorkforcemanagementAgentAdherenceExplanationsQueryRequest {
	...
	public PostWorkforcemanagementAgentAdherenceExplanationsQueryRequest withAgentId(String agentId) {
	    this.setAgentId(agentId);
	    return this;
	} 

	private AgentQueryAdherenceExplanationsRequest body;
	public AgentQueryAdherenceExplanationsRequest getBody() {
		return this.body;
	}

	public void setBody(AgentQueryAdherenceExplanationsRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementAgentAdherenceExplanationsQueryRequest withBody(AgentQueryAdherenceExplanationsRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public ApiRequest<AgentQueryAdherenceExplanationsRequest> withHttpInfo() {
        
        // verify the required parameter 'agentId' is set
        if (this.agentId == null) {
            throw new IllegalStateException("Missing the required parameter 'agentId' when building request for PostWorkforcemanagementAgentAdherenceExplanationsQueryRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementAgentAdherenceExplanationsQueryRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/agents/{agentId}/adherence/explanations/query")
	...
	public static Builder builder(String agentId, AgentQueryAdherenceExplanationsRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementAgentAdherenceExplanationsQueryRequest request;

		private Builder() {
			request = new PostWorkforcemanagementAgentAdherenceExplanationsQueryRequest();
		}
		...
		public Builder withBody(AgentQueryAdherenceExplanationsRequest body) {
		...
		public Builder withRequiredParams(String agentId, AgentQueryAdherenceExplanationsRequest body) {
			request.setAgentId(agentId);
			request.setBody(body);
		...
		public PostWorkforcemanagementAgentAdherenceExplanationsQueryRequest build() {
