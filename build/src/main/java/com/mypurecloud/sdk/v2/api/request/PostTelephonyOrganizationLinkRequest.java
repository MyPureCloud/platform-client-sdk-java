...
public class PostTelephonyOrganizationLinkRequest {

	private CreateOrganizationLink body;
	public CreateOrganizationLink getBody() {
		return this.body;
	}

	public void setBody(CreateOrganizationLink body) {
		this.body = body;
	}

	public PostTelephonyOrganizationLinkRequest withBody(CreateOrganizationLink body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostTelephonyOrganizationLinkRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<CreateOrganizationLink> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostTelephonyOrganizationLinkRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/telephony/organization/link")
                .withBody(body)
	...
	public static Builder builder(CreateOrganizationLink body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostTelephonyOrganizationLinkRequest request;

		private Builder() {
			request = new PostTelephonyOrganizationLinkRequest();
		}


		public Builder withBody(CreateOrganizationLink body) {
		...
		public Builder withRequiredParams(CreateOrganizationLink body) {
			request.setBody(body);
		...
		public PostTelephonyOrganizationLinkRequest build() {
