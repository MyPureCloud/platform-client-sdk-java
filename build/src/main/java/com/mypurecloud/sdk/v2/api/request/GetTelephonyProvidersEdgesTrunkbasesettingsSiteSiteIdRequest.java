...
public class GetTelephonyProvidersEdgesTrunkbasesettingsSiteSiteIdRequest {
	...
	public GetTelephonyProvidersEdgesTrunkbasesettingsSiteSiteIdRequest withSiteId(String siteId) {
	...
	public GetTelephonyProvidersEdgesTrunkbasesettingsSiteSiteIdRequest withPageNumber(Integer pageNumber) {
	...
	public GetTelephonyProvidersEdgesTrunkbasesettingsSiteSiteIdRequest withPageSize(Integer pageSize) {
	...
	public GetTelephonyProvidersEdgesTrunkbasesettingsSiteSiteIdRequest withSortBy(String sortBy) {
	...
	public GetTelephonyProvidersEdgesTrunkbasesettingsSiteSiteIdRequest withSortOrder(String sortOrder) {
    ...
    public GetTelephonyProvidersEdgesTrunkbasesettingsSiteSiteIdRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.siteId == null) {
            throw new IllegalStateException("Missing the required parameter 'siteId' when building request for GetTelephonyProvidersEdgesTrunkbasesettingsSiteSiteIdRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/telephony/providers/edges/trunkbasesettings/site/{siteId}")
	...
	public static class Builder {
		private final GetTelephonyProvidersEdgesTrunkbasesettingsSiteSiteIdRequest request;

		private Builder() {
			request = new GetTelephonyProvidersEdgesTrunkbasesettingsSiteSiteIdRequest();
		}
		...
		public GetTelephonyProvidersEdgesTrunkbasesettingsSiteSiteIdRequest build() {
