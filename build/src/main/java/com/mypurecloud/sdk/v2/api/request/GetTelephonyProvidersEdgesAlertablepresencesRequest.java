...
public class GetTelephonyProvidersEdgesAlertablepresencesRequest {
	...
	public GetTelephonyProvidersEdgesAlertablepresencesRequest withType(String type) {
	    this.setType(type);
	    return this;
	} 
    ...
    public GetTelephonyProvidersEdgesAlertablepresencesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/telephony/providers/edges/alertablepresences")
	...
	public static class Builder {
		private final GetTelephonyProvidersEdgesAlertablepresencesRequest request;

		private Builder() {
			request = new GetTelephonyProvidersEdgesAlertablepresencesRequest();
		}
		...
		public GetTelephonyProvidersEdgesAlertablepresencesRequest build() {
