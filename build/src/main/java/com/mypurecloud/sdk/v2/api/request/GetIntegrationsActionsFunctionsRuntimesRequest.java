...
public class GetIntegrationsActionsFunctionsRuntimesRequest {
    ...
    public GetIntegrationsActionsFunctionsRuntimesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/integrations/actions/functions/runtimes")
	...
	public static class Builder {
		private final GetIntegrationsActionsFunctionsRuntimesRequest request;

		private Builder() {
			request = new GetIntegrationsActionsFunctionsRuntimesRequest();
		}
		...
		public GetIntegrationsActionsFunctionsRuntimesRequest build() {
