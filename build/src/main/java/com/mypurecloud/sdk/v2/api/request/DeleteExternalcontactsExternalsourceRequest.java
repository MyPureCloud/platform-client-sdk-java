...
public class DeleteExternalcontactsExternalsourceRequest {
	...
	public DeleteExternalcontactsExternalsourceRequest withExternalSourceId(String externalSourceId) {
    ...
    public DeleteExternalcontactsExternalsourceRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.externalSourceId == null) {
            throw new IllegalStateException("Missing the required parameter 'externalSourceId' when building request for DeleteExternalcontactsExternalsourceRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/externalcontacts/externalsources/{externalSourceId}")
	...
	public static Builder builder(String externalSourceId) {
	    return new Builder()
	            .withRequiredParams(externalSourceId);
	}


	public static class Builder {
		private final DeleteExternalcontactsExternalsourceRequest request;

		private Builder() {
			request = new DeleteExternalcontactsExternalsourceRequest();
		}
		...
		public Builder withRequiredParams(String externalSourceId) {
			request.setExternalSourceId(externalSourceId);
		...
		public DeleteExternalcontactsExternalsourceRequest build() {
