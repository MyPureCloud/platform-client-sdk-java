...
public class GetWorkforcemanagementBusinessunitTimeoffplansRequest {
	...
	public GetWorkforcemanagementBusinessunitTimeoffplansRequest withBusinessUnitId(String businessUnitId) {
	...
	public GetWorkforcemanagementBusinessunitTimeoffplansRequest withManagementUnitId(String managementUnitId) {
	...
	public GetWorkforcemanagementBusinessunitTimeoffplansRequest withForceDownloadService(Boolean forceDownloadService) {
	...
	public GetWorkforcemanagementBusinessunitTimeoffplansRequest withExpand(List<String> expand) {
    ...
    public GetWorkforcemanagementBusinessunitTimeoffplansRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for GetWorkforcemanagementBusinessunitTimeoffplansRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/timeoffplans")
	...
	public static class Builder {
		private final GetWorkforcemanagementBusinessunitTimeoffplansRequest request;

		private Builder() {
			request = new GetWorkforcemanagementBusinessunitTimeoffplansRequest();
		}
		...
		public GetWorkforcemanagementBusinessunitTimeoffplansRequest build() {
