...
public class GetUsersCustomattributesSchemaRequest {
	...
	public GetUsersCustomattributesSchemaRequest withSchemaId(String schemaId) {
    ...
    public GetUsersCustomattributesSchemaRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.schemaId == null) {
            throw new IllegalStateException("Missing the required parameter 'schemaId' when building request for GetUsersCustomattributesSchemaRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/users/customattributes/schemas/{schemaId}")
	...
	public static class Builder {
		private final GetUsersCustomattributesSchemaRequest request;

		private Builder() {
			request = new GetUsersCustomattributesSchemaRequest();
		}
		...
		public GetUsersCustomattributesSchemaRequest build() {
