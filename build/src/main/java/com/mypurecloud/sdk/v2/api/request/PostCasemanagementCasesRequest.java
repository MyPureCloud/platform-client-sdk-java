...
public class PostCasemanagementCasesRequest {

	private CaseCreate body;
	public CaseCreate getBody() {
		return this.body;
	}

	public void setBody(CaseCreate body) {
		this.body = body;
	}

	public PostCasemanagementCasesRequest withBody(CaseCreate body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostCasemanagementCasesRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<CaseCreate> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostCasemanagementCasesRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/casemanagement/cases")
                .withBody(body)
	...
	public static Builder builder(CaseCreate body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostCasemanagementCasesRequest request;

		private Builder() {
			request = new PostCasemanagementCasesRequest();
		}


		public Builder withBody(CaseCreate body) {
		...
		public Builder withRequiredParams(CaseCreate body) {
			request.setBody(body);
		...
		public PostCasemanagementCasesRequest build() {
