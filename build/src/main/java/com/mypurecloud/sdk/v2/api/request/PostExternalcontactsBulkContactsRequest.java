...
public class PostExternalcontactsBulkContactsRequest {
	...
	public PostExternalcontactsBulkContactsRequest withBody(BulkIdsRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostExternalcontactsBulkContactsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<BulkIdsRequest> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostExternalcontactsBulkContactsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/externalcontacts/bulk/contacts")
                .withBody(body)
	...
	public static class Builder {
		private final PostExternalcontactsBulkContactsRequest request;

		private Builder() {
			request = new PostExternalcontactsBulkContactsRequest();
		}
		...
		public PostExternalcontactsBulkContactsRequest build() {
