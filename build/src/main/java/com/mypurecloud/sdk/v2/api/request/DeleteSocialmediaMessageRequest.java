...
public class DeleteSocialmediaMessageRequest {
	...
	public DeleteSocialmediaMessageRequest withMessageId(String messageId) {
    ...
    public DeleteSocialmediaMessageRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.messageId == null) {
            throw new IllegalStateException("Missing the required parameter 'messageId' when building request for DeleteSocialmediaMessageRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/socialmedia/messages/{messageId}")
	...
	public static class Builder {
		private final DeleteSocialmediaMessageRequest request;

		private Builder() {
			request = new DeleteSocialmediaMessageRequest();
		}
		...
		public DeleteSocialmediaMessageRequest build() {
