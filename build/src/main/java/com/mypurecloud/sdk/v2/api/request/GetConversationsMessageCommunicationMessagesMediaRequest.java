...
public class GetConversationsMessageCommunicationMessagesMediaRequest {
	...
	public GetConversationsMessageCommunicationMessagesMediaRequest withStatus(String status) {
	...
	public GetConversationsMessageCommunicationMessagesMediaRequest withPageNumber(Integer pageNumber) {
	...
	public GetConversationsMessageCommunicationMessagesMediaRequest withPageSize(Integer pageSize) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for GetConversationsMessageCommunicationMessagesMediaRequest.");
        }
        
        // verify the required parameter 'communicationId' is set
        if (this.communicationId == null) {
            throw new IllegalStateException("Missing the required parameter 'communicationId' when building request for GetConversationsMessageCommunicationMessagesMediaRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/conversations/messages/{conversationId}/communications/{communicationId}/messages/media")
	...
	public static class Builder {
		private final GetConversationsMessageCommunicationMessagesMediaRequest request;

		private Builder() {
			request = new GetConversationsMessageCommunicationMessagesMediaRequest();
		}
		...
		public GetConversationsMessageCommunicationMessagesMediaRequest build() {
