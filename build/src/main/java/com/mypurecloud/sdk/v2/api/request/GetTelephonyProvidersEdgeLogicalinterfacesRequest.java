...
public class GetTelephonyProvidersEdgeLogicalinterfacesRequest {
	...
	public GetTelephonyProvidersEdgeLogicalinterfacesRequest withEdgeId(String edgeId) {
	...
	public GetTelephonyProvidersEdgeLogicalinterfacesRequest withExpand(List<String> expand) {
    ...
    public GetTelephonyProvidersEdgeLogicalinterfacesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.edgeId == null) {
            throw new IllegalStateException("Missing the required parameter 'edgeId' when building request for GetTelephonyProvidersEdgeLogicalinterfacesRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/telephony/providers/edges/{edgeId}/logicalinterfaces")
	...
	public static class Builder {
		private final GetTelephonyProvidersEdgeLogicalinterfacesRequest request;

		private Builder() {
			request = new GetTelephonyProvidersEdgeLogicalinterfacesRequest();
		}
		...
		public GetTelephonyProvidersEdgeLogicalinterfacesRequest build() {
