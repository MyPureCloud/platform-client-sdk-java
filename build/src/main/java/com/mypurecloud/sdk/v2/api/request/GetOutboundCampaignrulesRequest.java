...
public class GetOutboundCampaignrulesRequest {
	...
	public GetOutboundCampaignrulesRequest withPageSize(Integer pageSize) {
	...
	public GetOutboundCampaignrulesRequest withPageNumber(Integer pageNumber) {
	...
	public GetOutboundCampaignrulesRequest withAllowEmptyResult(Boolean allowEmptyResult) {
	...
	public GetOutboundCampaignrulesRequest withFilterType(String filterType) {
	...
	public GetOutboundCampaignrulesRequest withName(String name) {
	    this.setName(name);
	    return this;
	} 
	...
	public GetOutboundCampaignrulesRequest withSortBy(String sortBy) {
	...
	public GetOutboundCampaignrulesRequest withSortOrder(String sortOrder) {
    ...
    public GetOutboundCampaignrulesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/outbound/campaignrules")
	...
	public static class Builder {
		private final GetOutboundCampaignrulesRequest request;

		private Builder() {
			request = new GetOutboundCampaignrulesRequest();
		}
		...
		public GetOutboundCampaignrulesRequest build() {
