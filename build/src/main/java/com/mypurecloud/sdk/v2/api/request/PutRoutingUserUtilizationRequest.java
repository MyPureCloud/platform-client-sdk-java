...
public class PutRoutingUserUtilizationRequest {
    ...
    public ApiRequest<Utilization> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("PUT", "/api/v2/routing/users/{userId}/utilization")
	...
	public static class Builder {
		private final PutRoutingUserUtilizationRequest request;

		private Builder() {
			request = new PutRoutingUserUtilizationRequest();
		}
