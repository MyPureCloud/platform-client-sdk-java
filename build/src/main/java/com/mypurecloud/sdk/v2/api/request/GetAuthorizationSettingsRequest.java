...
public class GetAuthorizationSettingsRequest {
    ...
    public GetAuthorizationSettingsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/authorization/settings")
	...
	public static class Builder {
		private final GetAuthorizationSettingsRequest request;

		private Builder() {
			request = new GetAuthorizationSettingsRequest();
		}
		...
		public GetAuthorizationSettingsRequest build() {
