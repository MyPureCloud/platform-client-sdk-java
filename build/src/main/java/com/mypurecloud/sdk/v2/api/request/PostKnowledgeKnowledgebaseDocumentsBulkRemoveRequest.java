...
public class PostKnowledgeKnowledgebaseDocumentsBulkRemoveRequest {
	...
	public PostKnowledgeKnowledgebaseDocumentsBulkRemoveRequest withKnowledgeBaseId(String knowledgeBaseId) {
	    this.setKnowledgeBaseId(knowledgeBaseId);
	    return this;
	} 

	private KnowledgeDocumentBulkRemoveRequest body;
	public KnowledgeDocumentBulkRemoveRequest getBody() {
		return this.body;
	}

	public void setBody(KnowledgeDocumentBulkRemoveRequest body) {
		this.body = body;
	}

	public PostKnowledgeKnowledgebaseDocumentsBulkRemoveRequest withBody(KnowledgeDocumentBulkRemoveRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostKnowledgeKnowledgebaseDocumentsBulkRemoveRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<KnowledgeDocumentBulkRemoveRequest> withHttpInfo() {
        
        // verify the required parameter 'knowledgeBaseId' is set
        if (this.knowledgeBaseId == null) {
            throw new IllegalStateException("Missing the required parameter 'knowledgeBaseId' when building request for PostKnowledgeKnowledgebaseDocumentsBulkRemoveRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostKnowledgeKnowledgebaseDocumentsBulkRemoveRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/documents/bulk/remove")
	...
	public static Builder builder(String knowledgeBaseId, KnowledgeDocumentBulkRemoveRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostKnowledgeKnowledgebaseDocumentsBulkRemoveRequest request;

		private Builder() {
			request = new PostKnowledgeKnowledgebaseDocumentsBulkRemoveRequest();
		}
		...
		public Builder withBody(KnowledgeDocumentBulkRemoveRequest body) {
		...
		public Builder withRequiredParams(String knowledgeBaseId, KnowledgeDocumentBulkRemoveRequest body) {
			request.setKnowledgeBaseId(knowledgeBaseId);
			request.setBody(body);
		...
		public PostKnowledgeKnowledgebaseDocumentsBulkRemoveRequest build() {
