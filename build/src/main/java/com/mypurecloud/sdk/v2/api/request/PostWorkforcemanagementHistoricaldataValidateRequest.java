...
public class PostWorkforcemanagementHistoricaldataValidateRequest {
    
	private ValidationServiceRequest body;
	public ValidationServiceRequest getBody() {
		return this.body;
	}

	public void setBody(ValidationServiceRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementHistoricaldataValidateRequest withBody(ValidationServiceRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementHistoricaldataValidateRequest withCustomHeader(String name, String value) {
	...
	public static class Builder {
		private final PostWorkforcemanagementHistoricaldataValidateRequest request;

		private Builder() {
			request = new PostWorkforcemanagementHistoricaldataValidateRequest();
		}

		
		public Builder withBody(ValidationServiceRequest body) {
