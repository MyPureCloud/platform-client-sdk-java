...
public class GetSpeechandtextanalyticsProgramsPublishjobRequest {
	...
	public GetSpeechandtextanalyticsProgramsPublishjobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetSpeechandtextanalyticsProgramsPublishjobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetSpeechandtextanalyticsProgramsPublishjobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/speechandtextanalytics/programs/publishjobs/{jobId}")
	...
	public static class Builder {
		private final GetSpeechandtextanalyticsProgramsPublishjobRequest request;

		private Builder() {
			request = new GetSpeechandtextanalyticsProgramsPublishjobRequest();
		}
		...
		public GetSpeechandtextanalyticsProgramsPublishjobRequest build() {
