...
public class GetWorkforcemanagementAdherenceRequest {
	...
	public GetWorkforcemanagementAdherenceRequest withUserId(List<String> userId) {
    ...
    public GetWorkforcemanagementAdherenceRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() throws ApiException {
        ...
        if (this.userId == null) {
            throw new ApiException(400, "Missing the required parameter 'userId' when building request for GetWorkforcemanagementAdherenceRequest.");
        }
