...
public class PatchWorkforcemanagementBusinessunitSchedulebidGroupPreferencesRequest {
	...
	public PatchWorkforcemanagementBusinessunitSchedulebidGroupPreferencesRequest withBusinessUnitId(String businessUnitId) {
	...
	public PatchWorkforcemanagementBusinessunitSchedulebidGroupPreferencesRequest withBidId(String bidId) {
	    this.setBidId(bidId);
	    return this;
	} 
	...
	public void setBidGroupId(String bidGroupId) {
		this.bidGroupId = bidGroupId;
	}

	public PatchWorkforcemanagementBusinessunitSchedulebidGroupPreferencesRequest withBidGroupId(String bidGroupId) {
	    this.setBidGroupId(bidGroupId);
	    return this;
	} 

	private AgentsBidAssignedScheduleSetOverrideRequest body;
	public AgentsBidAssignedScheduleSetOverrideRequest getBody() {
		return this.body;
	}

	public void setBody(AgentsBidAssignedScheduleSetOverrideRequest body) {
		this.body = body;
	}

	public PatchWorkforcemanagementBusinessunitSchedulebidGroupPreferencesRequest withBody(AgentsBidAssignedScheduleSetOverrideRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchWorkforcemanagementBusinessunitSchedulebidGroupPreferencesRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<AgentsBidAssignedScheduleSetOverrideRequest> withHttpInfo() {
        
        // verify the required parameter 'businessUnitId' is set
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PatchWorkforcemanagementBusinessunitSchedulebidGroupPreferencesRequest.");
        }
        
        // verify the required parameter 'bidId' is set
        if (this.bidId == null) {
            throw new IllegalStateException("Missing the required parameter 'bidId' when building request for PatchWorkforcemanagementBusinessunitSchedulebidGroupPreferencesRequest.");
        }
        
        // verify the required parameter 'bidGroupId' is set
        if (this.bidGroupId == null) {
            throw new IllegalStateException("Missing the required parameter 'bidGroupId' when building request for PatchWorkforcemanagementBusinessunitSchedulebidGroupPreferencesRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchWorkforcemanagementBusinessunitSchedulebidGroupPreferencesRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/schedulebids/{bidId}/groups/{bidGroupId}/preferences")
                .withPathParameter("businessUnitId", businessUnitId)
        
                .withPathParameter("bidId", bidId)
        
                .withPathParameter("bidGroupId", bidGroupId)
	...
	public static Builder builder(String businessUnitId, String bidId, String bidGroupId, AgentsBidAssignedScheduleSetOverrideRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PatchWorkforcemanagementBusinessunitSchedulebidGroupPreferencesRequest request;

		private Builder() {
			request = new PatchWorkforcemanagementBusinessunitSchedulebidGroupPreferencesRequest();
		}
		...
		public Builder withBidId(String bidId) {
			request.setBidId(bidId);
			return this;
		}

		public Builder withBidGroupId(String bidGroupId) {
			request.setBidGroupId(bidGroupId);
			return this;
		}

		public Builder withBody(AgentsBidAssignedScheduleSetOverrideRequest body) {
		...
		public Builder withRequiredParams(String businessUnitId, String bidId, String bidGroupId, AgentsBidAssignedScheduleSetOverrideRequest body) {
			request.setBusinessUnitId(businessUnitId);
			request.setBidId(bidId);
			request.setBidGroupId(bidGroupId);
			request.setBody(body);
		...
		public PatchWorkforcemanagementBusinessunitSchedulebidGroupPreferencesRequest build() {
