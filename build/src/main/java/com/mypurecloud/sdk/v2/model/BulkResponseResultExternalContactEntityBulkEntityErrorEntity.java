...
public class BulkResponseResultExternalContactEntityBulkEntityErrorEntity  implements Serializable {
  ...
  public BulkResponseResultExternalContactEntityBulkEntityErrorEntity(Boolean initWithEmptyList) {
   ...
   **/
  public BulkResponseResultExternalContactEntityBulkEntityErrorEntity id(String id) {
    this.id = id;
    return this;
  }
   ...
   **/
  public BulkResponseResultExternalContactEntityBulkEntityErrorEntity success(Boolean success) {
   ...
   **/
  public BulkResponseResultExternalContactEntityBulkEntityErrorEntity entity(ExternalContact entity) {
    this.entity = entity;
    return this;
  }
   ...
   **/
  public BulkResponseResultExternalContactEntityBulkEntityErrorEntity error(BulkEntityErrorEntity error) {
    this.error = error;
    return this;
  }
   ...
   **/
  public BulkResponseResultExternalContactEntityBulkEntityErrorEntity status(Integer status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    BulkResponseResultExternalContactEntityBulkEntityErrorEntity bulkResponseResultExternalContactEntityBulkEntityErrorEntity = (BulkResponseResultExternalContactEntityBulkEntityErrorEntity) o;

    return Objects.equals(this.id, bulkResponseResultExternalContactEntityBulkEntityErrorEntity.id) &&
            Objects.equals(this.success, bulkResponseResultExternalContactEntityBulkEntityErrorEntity.success) &&
            Objects.equals(this.entity, bulkResponseResultExternalContactEntityBulkEntityErrorEntity.entity) &&
            Objects.equals(this.error, bulkResponseResultExternalContactEntityBulkEntityErrorEntity.error) &&
            Objects.equals(this.status, bulkResponseResultExternalContactEntityBulkEntityErrorEntity.status);
  }
