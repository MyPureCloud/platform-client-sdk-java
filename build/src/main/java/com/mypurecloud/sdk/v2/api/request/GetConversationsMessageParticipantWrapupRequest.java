...
public class GetConversationsMessageParticipantWrapupRequest {
	...
	public GetConversationsMessageParticipantWrapupRequest withConversationId(String conversationId) {
	...
	public GetConversationsMessageParticipantWrapupRequest withParticipantId(String participantId) {
	...
	public GetConversationsMessageParticipantWrapupRequest withProvisional(Boolean provisional) {
    ...
    public GetConversationsMessageParticipantWrapupRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for GetConversationsMessageParticipantWrapupRequest.");
        }
        
        // verify the required parameter 'participantId' is set
        if (this.participantId == null) {
            throw new IllegalStateException("Missing the required parameter 'participantId' when building request for GetConversationsMessageParticipantWrapupRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/conversations/messages/{conversationId}/participants/{participantId}/wrapup")
	...
	public static class Builder {
		private final GetConversationsMessageParticipantWrapupRequest request;

		private Builder() {
			request = new GetConversationsMessageParticipantWrapupRequest();
		}
		...
		public GetConversationsMessageParticipantWrapupRequest build() {
