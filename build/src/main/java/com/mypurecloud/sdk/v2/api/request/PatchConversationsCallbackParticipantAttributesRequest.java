...
public class PatchConversationsCallbackParticipantAttributesRequest {
	...
	public PatchConversationsCallbackParticipantAttributesRequest withCallbackId(String callbackId) {
	...
	public PatchConversationsCallbackParticipantAttributesRequest withParticipantId(String participantId) {
	...
	public PatchConversationsCallbackParticipantAttributesRequest withBody(ParticipantAttributes body) {
	    this.setBody(body);
	    return this;
	}
    ...
    public PatchConversationsCallbackParticipantAttributesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<ParticipantAttributes> withHttpInfo() throws ApiException {
        ...
        if (this.callbackId == null) {
            throw new ApiException(400, "Missing the required parameter 'callbackId' when building request for PatchConversationsCallbackParticipantAttributesRequest.");
        }
        
        // verify the required parameter 'participantId' is set
        if (this.participantId == null) {
            throw new ApiException(400, "Missing the required parameter 'participantId' when building request for PatchConversationsCallbackParticipantAttributesRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new ApiException(400, "Missing the required parameter 'body' when building request for PatchConversationsCallbackParticipantAttributesRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/conversations/callbacks/{callbackId}/participants/{participantId}/attributes")
	...
	public static Builder builder(String callbackId, String participantId, ParticipantAttributes body) {
	    return new Builder()
	...
	public static class Builder {
		...
		private Builder() {
			request = new PatchConversationsCallbackParticipantAttributesRequest();
		}
		...
		public Builder withRequiredParams(String callbackId, String participantId, ParticipantAttributes body) {
			request.setCallbackId(callbackId);
			request.setParticipantId(participantId);
			request.setBody(body);
			return this;
