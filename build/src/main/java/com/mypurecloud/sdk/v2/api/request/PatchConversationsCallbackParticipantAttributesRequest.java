...
public class PatchConversationsCallbackParticipantAttributesRequest {
	...
	public PatchConversationsCallbackParticipantAttributesRequest withConversationId(String conversationId) {
    ...
    public ApiRequest<ParticipantAttributes> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("PATCH", "/api/v2/conversations/callbacks/{conversationId}/participants/{participantId}/attributes")
