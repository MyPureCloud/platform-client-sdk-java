...
public class GetExternalcontactsOrganizationIdentifiersRequest {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.externalOrganizationId == null) {
            throw new IllegalStateException("Missing the required parameter 'externalOrganizationId' when building request for GetExternalcontactsOrganizationIdentifiersRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/externalcontacts/organizations/{externalOrganizationId}/identifiers")
	...
	public static class Builder {
		private final GetExternalcontactsOrganizationIdentifiersRequest request;

		private Builder() {
			request = new GetExternalcontactsOrganizationIdentifiersRequest();
		}
		...
		public GetExternalcontactsOrganizationIdentifiersRequest build() {
