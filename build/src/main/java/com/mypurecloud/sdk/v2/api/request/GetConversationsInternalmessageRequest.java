...
public class GetConversationsInternalmessageRequest {
	...
	public GetConversationsInternalmessageRequest withConversationId(String conversationId) {
    ...
    public GetConversationsInternalmessageRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for GetConversationsInternalmessageRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/conversations/internalmessages/{conversationId}")
	...
	public static class Builder {
		private final GetConversationsInternalmessageRequest request;

		private Builder() {
			request = new GetConversationsInternalmessageRequest();
		}
		...
		public GetConversationsInternalmessageRequest build() {
