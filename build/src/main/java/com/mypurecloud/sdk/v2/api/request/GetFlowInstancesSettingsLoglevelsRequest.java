...
public class GetFlowInstancesSettingsLoglevelsRequest {
	...
	public GetFlowInstancesSettingsLoglevelsRequest withFlowId(String flowId) {
	...
	public GetFlowInstancesSettingsLoglevelsRequest withExpand(List<String> expand) {
    ...
    public GetFlowInstancesSettingsLoglevelsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.flowId == null) {
            throw new IllegalStateException("Missing the required parameter 'flowId' when building request for GetFlowInstancesSettingsLoglevelsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/flows/{flowId}/instances/settings/loglevels")
	...
	public static class Builder {
		private final GetFlowInstancesSettingsLoglevelsRequest request;

		private Builder() {
			request = new GetFlowInstancesSettingsLoglevelsRequest();
		}
		...
		public GetFlowInstancesSettingsLoglevelsRequest build() {
