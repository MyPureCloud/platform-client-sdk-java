...
public class PostRecordingsScreensessionsMetadataRequest {
    
	private ScreenRecordingMetaDataRequest body;
	public ScreenRecordingMetaDataRequest getBody() {
		return this.body;
	}

	public void setBody(ScreenRecordingMetaDataRequest body) {
		this.body = body;
	}

	public PostRecordingsScreensessionsMetadataRequest withBody(ScreenRecordingMetaDataRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostRecordingsScreensessionsMetadataRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<ScreenRecordingMetaDataRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostRecordingsScreensessionsMetadataRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/recordings/screensessions/metadata")
                .withBody(body)
	...
	public static Builder builder(ScreenRecordingMetaDataRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostRecordingsScreensessionsMetadataRequest request;

		private Builder() {
			request = new PostRecordingsScreensessionsMetadataRequest();
		}

		
		public Builder withBody(ScreenRecordingMetaDataRequest body) {
		...
		public Builder withRequiredParams(ScreenRecordingMetaDataRequest body) {
			request.setBody(body);
		...
		public PostRecordingsScreensessionsMetadataRequest build() {
