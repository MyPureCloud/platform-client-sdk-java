...
public class EdgeLogicalInterfacesChangeTopicErrorInfo  implements Serializable {
  ...
  public EdgeLogicalInterfacesChangeTopicErrorInfo() {
  ...
  /**
   **/
  public EdgeLogicalInterfacesChangeTopicErrorInfo message(String message) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(message, messageWithParams, messageParams, code);
  }
