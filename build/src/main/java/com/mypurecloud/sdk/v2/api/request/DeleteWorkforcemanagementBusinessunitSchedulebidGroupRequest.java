...
public class DeleteWorkforcemanagementBusinessunitSchedulebidGroupRequest {
	...
	public DeleteWorkforcemanagementBusinessunitSchedulebidGroupRequest withBusinessUnitId(String businessUnitId) {
	...
	public DeleteWorkforcemanagementBusinessunitSchedulebidGroupRequest withBidId(String bidId) {
	    this.setBidId(bidId);
	    return this;
	} 
	...
	public DeleteWorkforcemanagementBusinessunitSchedulebidGroupRequest withBidGroupId(String bidGroupId) {
    ...
    public DeleteWorkforcemanagementBusinessunitSchedulebidGroupRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for DeleteWorkforcemanagementBusinessunitSchedulebidGroupRequest.");
        }
        
        // verify the required parameter 'bidId' is set
        if (this.bidId == null) {
            throw new IllegalStateException("Missing the required parameter 'bidId' when building request for DeleteWorkforcemanagementBusinessunitSchedulebidGroupRequest.");
        }
        
        // verify the required parameter 'bidGroupId' is set
        if (this.bidGroupId == null) {
            throw new IllegalStateException("Missing the required parameter 'bidGroupId' when building request for DeleteWorkforcemanagementBusinessunitSchedulebidGroupRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/schedulebids/{bidId}/groups/{bidGroupId}")
	...
	public static class Builder {
		private final DeleteWorkforcemanagementBusinessunitSchedulebidGroupRequest request;

		private Builder() {
			request = new DeleteWorkforcemanagementBusinessunitSchedulebidGroupRequest();
		}
		...
		public DeleteWorkforcemanagementBusinessunitSchedulebidGroupRequest build() {
