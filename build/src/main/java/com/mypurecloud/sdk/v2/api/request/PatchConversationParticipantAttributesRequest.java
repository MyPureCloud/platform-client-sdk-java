...
public class PatchConversationParticipantAttributesRequest {
	...
	public PatchConversationParticipantAttributesRequest withConversationId(String conversationId) {
	...
	public PatchConversationParticipantAttributesRequest withParticipantId(String participantId) {
	...
	public PatchConversationParticipantAttributesRequest withBody(ParticipantAttributes body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchConversationParticipantAttributesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<ParticipantAttributes> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PatchConversationParticipantAttributesRequest.");
        }
        
        // verify the required parameter 'participantId' is set
        if (this.participantId == null) {
            throw new IllegalStateException("Missing the required parameter 'participantId' when building request for PatchConversationParticipantAttributesRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchConversationParticipantAttributesRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/conversations/{conversationId}/participants/{participantId}/attributes")
	...
	public static class Builder {
		private final PatchConversationParticipantAttributesRequest request;

		private Builder() {
			request = new PatchConversationParticipantAttributesRequest();
		}
		...
		public PatchConversationParticipantAttributesRequest build() {
