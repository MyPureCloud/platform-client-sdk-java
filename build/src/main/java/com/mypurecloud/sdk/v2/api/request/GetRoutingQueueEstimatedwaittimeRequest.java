...
public class GetRoutingQueueEstimatedwaittimeRequest {
    ...
    public GetRoutingQueueEstimatedwaittimeRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() throws ApiException {
        ...
        if (this.queueId == null) {
            throw new ApiException(400, "Missing the required parameter 'queueId' when building request for GetRoutingQueueEstimatedwaittimeRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/routing/queues/{queueId}/estimatedwaittime")
