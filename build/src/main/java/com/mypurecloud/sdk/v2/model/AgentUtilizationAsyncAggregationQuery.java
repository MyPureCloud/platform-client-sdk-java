...
import com.fasterxml.jackson.annotation.JsonValue;
import com.mypurecloud.sdk.v2.model.AgentUtilizationAggregateQueryFilter;
import com.mypurecloud.sdk.v2.model.AgentUtilizationAggregationView;
...
public class AgentUtilizationAsyncAggregationQuery  implements Serializable {
 ...
 @JsonDeserialize(using = GroupByEnumDeserializer.class)
  ...
  private AgentUtilizationAggregateQueryFilter filter = null;
 ...
 @JsonDeserialize(using = MetricsEnumDeserializer.class)
  public enum MetricsEnum {
    OUTDATEDSDKVERSION("OutdatedSdkVersion"),
    OAGENTAVAILABLEUTILIZATION("oAgentAvailableUtilization"),
    OAGENTMAXUTILIZATION("oAgentMaxUtilization"),
    OAGENTUTILIZATIONPERCENTAGE("oAgentUtilizationPercentage");
  ...
  private List<AgentUtilizationAggregationView> views = null;
 ...
 @JsonDeserialize(using = AlternateTimeDimensionEnumDeserializer.class)
  ...
  public AgentUtilizationAsyncAggregationQuery() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
      groupBy = new ArrayList<GroupByEnum>();
      metrics = new ArrayList<MetricsEnum>();
      views = new ArrayList<AgentUtilizationAggregationView>();
    }
  }

  public AgentUtilizationAsyncAggregationQuery(Boolean initWithEmptyList) {
   ...
   **/
  public AgentUtilizationAsyncAggregationQuery interval(String interval) {
   ...
   **/
  public AgentUtilizationAsyncAggregationQuery granularity(String granularity) {
   ...
   **/
  public AgentUtilizationAsyncAggregationQuery timeZone(String timeZone) {
   ...
   **/
  public AgentUtilizationAsyncAggregationQuery groupBy(List<GroupByEnum> groupBy) {
   ...
   **/
  public AgentUtilizationAsyncAggregationQuery filter(AgentUtilizationAggregateQueryFilter filter) {
    this.filter = filter;
    return this;
  }
  ...
  @JsonProperty("filter")
  public AgentUtilizationAggregateQueryFilter getFilter() {
    return filter;
  }
  public void setFilter(AgentUtilizationAggregateQueryFilter filter) {
    this.filter = filter;
  }
   ...
   **/
  public AgentUtilizationAsyncAggregationQuery metrics(List<MetricsEnum> metrics) {
   ...
   **/
  public AgentUtilizationAsyncAggregationQuery flattenMultivaluedDimensions(Boolean flattenMultivaluedDimensions) {
   ...
   **/
  public AgentUtilizationAsyncAggregationQuery views(List<AgentUtilizationAggregationView> views) {
    this.views = views;
    return this;
  }
  ...
  @JsonProperty("views")
  public List<AgentUtilizationAggregationView> getViews() {
    return views;
  }
  public void setViews(List<AgentUtilizationAggregationView> views) {
    this.views = views;
  }
   ...
   * Dimension to use as the alternative timestamp for data in the aggregate.  Choosing \"eventTime\" uses the actual time of the data event.
   **/
  public AgentUtilizationAsyncAggregationQuery alternateTimeDimension(AlternateTimeDimensionEnum alternateTimeDimension) {
   ...
   **/
  public AgentUtilizationAsyncAggregationQuery pageSize(Integer pageSize) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    AgentUtilizationAsyncAggregationQuery agentUtilizationAsyncAggregationQuery = (AgentUtilizationAsyncAggregationQuery) o;

    return Objects.equals(this.interval, agentUtilizationAsyncAggregationQuery.interval) &&
            Objects.equals(this.granularity, agentUtilizationAsyncAggregationQuery.granularity) &&
            Objects.equals(this.timeZone, agentUtilizationAsyncAggregationQuery.timeZone) &&
            Objects.equals(this.groupBy, agentUtilizationAsyncAggregationQuery.groupBy) &&
            Objects.equals(this.filter, agentUtilizationAsyncAggregationQuery.filter) &&
            Objects.equals(this.metrics, agentUtilizationAsyncAggregationQuery.metrics) &&
            Objects.equals(this.flattenMultivaluedDimensions, agentUtilizationAsyncAggregationQuery.flattenMultivaluedDimensions) &&
            Objects.equals(this.views, agentUtilizationAsyncAggregationQuery.views) &&
            Objects.equals(this.alternateTimeDimension, agentUtilizationAsyncAggregationQuery.alternateTimeDimension) &&
            Objects.equals(this.pageSize, agentUtilizationAsyncAggregationQuery.pageSize);
  }
  ...
  public String toString() {
    ...
    sb.append("class AgentUtilizationAsyncAggregationQuery {\n");
