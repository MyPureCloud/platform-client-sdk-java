...
public class GetConversationsSettingsRequest {
    ...
    public GetConversationsSettingsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/conversations/settings")
	...
	public static class Builder {
		private final GetConversationsSettingsRequest request;

		private Builder() {
			request = new GetConversationsSettingsRequest();
		}
		...
		public GetConversationsSettingsRequest build() {
