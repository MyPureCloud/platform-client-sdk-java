...
public class PatchSocialmediaTopicDataingestionrulesTwitterTwitterIngestionRuleIdRequest {
	...
	public PatchSocialmediaTopicDataingestionrulesTwitterTwitterIngestionRuleIdRequest withBody(DataIngestionRuleStatusPatchRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public ApiRequest<DataIngestionRuleStatusPatchRequest> withHttpInfo() {
        ...
        if (this.topicId == null) {
            throw new IllegalStateException("Missing the required parameter 'topicId' when building request for PatchSocialmediaTopicDataingestionrulesTwitterTwitterIngestionRuleIdRequest.");
        }
        
        // verify the required parameter 'twitterIngestionRuleId' is set
        if (this.twitterIngestionRuleId == null) {
            throw new IllegalStateException("Missing the required parameter 'twitterIngestionRuleId' when building request for PatchSocialmediaTopicDataingestionrulesTwitterTwitterIngestionRuleIdRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/socialmedia/topics/{topicId}/dataingestionrules/twitter/{twitterIngestionRuleId}")
	...
	public static class Builder {
		private final PatchSocialmediaTopicDataingestionrulesTwitterTwitterIngestionRuleIdRequest request;

		private Builder() {
			request = new PatchSocialmediaTopicDataingestionrulesTwitterTwitterIngestionRuleIdRequest();
		}
		...
		public PatchSocialmediaTopicDataingestionrulesTwitterTwitterIngestionRuleIdRequest build() {
