...
public class GetConversationsCustomattributesSchemasCoretypesRequest {
    ...
    public GetConversationsCustomattributesSchemasCoretypesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/conversations/customattributes/schemas/coretypes")
	...
	public static class Builder {
		private final GetConversationsCustomattributesSchemasCoretypesRequest request;

		private Builder() {
			request = new GetConversationsCustomattributesSchemasCoretypesRequest();
		}
		...
		public GetConversationsCustomattributesSchemasCoretypesRequest build() {
