...
public class GetTelephonyProvidersEdgesMetricsRequest {
	...
	public GetTelephonyProvidersEdgesMetricsRequest withEdgeIds(String edgeIds) {
    ...
    public GetTelephonyProvidersEdgesMetricsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.edgeIds == null) {
            throw new IllegalStateException("Missing the required parameter 'edgeIds' when building request for GetTelephonyProvidersEdgesMetricsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/telephony/providers/edges/metrics")
	...
	public static class Builder {
		private final GetTelephonyProvidersEdgesMetricsRequest request;

		private Builder() {
			request = new GetTelephonyProvidersEdgesMetricsRequest();
		}
		...
		public GetTelephonyProvidersEdgesMetricsRequest build() {
