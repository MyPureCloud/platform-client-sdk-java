...
public class GetWorkforcemanagementAgentAdherenceExplanationRequest {
	...
	public GetWorkforcemanagementAgentAdherenceExplanationRequest withAgentId(String agentId) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.agentId == null) {
            throw new IllegalStateException("Missing the required parameter 'agentId' when building request for GetWorkforcemanagementAgentAdherenceExplanationRequest.");
        }
        
        // verify the required parameter 'explanationId' is set
        if (this.explanationId == null) {
            throw new IllegalStateException("Missing the required parameter 'explanationId' when building request for GetWorkforcemanagementAgentAdherenceExplanationRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/agents/{agentId}/adherence/explanations/{explanationId}")
	...
	public static Builder builder(String agentId, String explanationId) {
	    return new Builder()
	            .withRequiredParams(agentId, explanationId);
	}


	public static class Builder {
		private final GetWorkforcemanagementAgentAdherenceExplanationRequest request;

		private Builder() {
			request = new GetWorkforcemanagementAgentAdherenceExplanationRequest();
		}
		...
		public Builder withRequiredParams(String agentId, String explanationId) {
			request.setAgentId(agentId);
			request.setExplanationId(explanationId);
		...
		public GetWorkforcemanagementAgentAdherenceExplanationRequest build() {
