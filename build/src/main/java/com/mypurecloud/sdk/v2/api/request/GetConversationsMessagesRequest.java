...
public class GetConversationsMessagesRequest {
    ...
    public GetConversationsMessagesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/conversations/messages")
	...
	public static class Builder {
		private final GetConversationsMessagesRequest request;

		private Builder() {
			request = new GetConversationsMessagesRequest();
		}
		...
		public GetConversationsMessagesRequest build() {
