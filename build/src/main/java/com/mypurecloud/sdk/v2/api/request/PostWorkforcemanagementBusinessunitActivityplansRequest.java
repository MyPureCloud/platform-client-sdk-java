...
public class PostWorkforcemanagementBusinessunitActivityplansRequest {
	...
	public PostWorkforcemanagementBusinessunitActivityplansRequest withBusinessUnitId(String businessUnitId) {
	    this.setBusinessUnitId(businessUnitId);
	    return this;
	} 

	private CreateActivityPlanRequest body;
	public CreateActivityPlanRequest getBody() {
		return this.body;
	}

	public void setBody(CreateActivityPlanRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementBusinessunitActivityplansRequest withBody(CreateActivityPlanRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementBusinessunitActivityplansRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<CreateActivityPlanRequest> withHttpInfo() {
        
        // verify the required parameter 'businessUnitId' is set
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PostWorkforcemanagementBusinessunitActivityplansRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementBusinessunitActivityplansRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/activityplans")
	...
	public static Builder builder(String businessUnitId, CreateActivityPlanRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementBusinessunitActivityplansRequest request;

		private Builder() {
			request = new PostWorkforcemanagementBusinessunitActivityplansRequest();
		}
		...
		public Builder withBody(CreateActivityPlanRequest body) {
		...
		public Builder withRequiredParams(String businessUnitId, CreateActivityPlanRequest body) {
			request.setBusinessUnitId(businessUnitId);
			request.setBody(body);
		...
		public PostWorkforcemanagementBusinessunitActivityplansRequest build() {
