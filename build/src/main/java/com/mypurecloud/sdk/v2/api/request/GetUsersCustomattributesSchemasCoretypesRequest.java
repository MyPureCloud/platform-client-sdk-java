...
public class GetUsersCustomattributesSchemasCoretypesRequest {
    ...
    public GetUsersCustomattributesSchemasCoretypesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/users/customattributes/schemas/coretypes")
	...
	public static class Builder {
		private final GetUsersCustomattributesSchemasCoretypesRequest request;

		private Builder() {
			request = new GetUsersCustomattributesSchemasCoretypesRequest();
		}
		...
		public GetUsersCustomattributesSchemasCoretypesRequest build() {
