...
public class DeleteOutboundDnclistCustomexclusioncolumnsRequest {
	...
	public DeleteOutboundDnclistCustomexclusioncolumnsRequest withDncListId(String dncListId) {
	...
	public DeleteOutboundDnclistCustomexclusioncolumnsRequest withExpiredOnly(Boolean expiredOnly) {
    ...
    public DeleteOutboundDnclistCustomexclusioncolumnsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.dncListId == null) {
            throw new IllegalStateException("Missing the required parameter 'dncListId' when building request for DeleteOutboundDnclistCustomexclusioncolumnsRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/outbound/dnclists/{dncListId}/customexclusioncolumns")
	...
	public static class Builder {
		private final DeleteOutboundDnclistCustomexclusioncolumnsRequest request;

		private Builder() {
			request = new DeleteOutboundDnclistCustomexclusioncolumnsRequest();
		}
		...
		public DeleteOutboundDnclistCustomexclusioncolumnsRequest build() {
