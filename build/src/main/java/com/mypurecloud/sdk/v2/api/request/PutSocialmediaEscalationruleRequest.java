...
public class PutSocialmediaEscalationruleRequest {
	...
	public PutSocialmediaEscalationruleRequest withEscalationRuleId(String escalationRuleId) {
	    this.setEscalationRuleId(escalationRuleId);
	    return this;
	} 

	private EscalationRuleRequest body;
	public EscalationRuleRequest getBody() {
		return this.body;
	}

	public void setBody(EscalationRuleRequest body) {
		this.body = body;
	}

	public PutSocialmediaEscalationruleRequest withBody(EscalationRuleRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutSocialmediaEscalationruleRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<EscalationRuleRequest> withHttpInfo() {
        
        // verify the required parameter 'escalationRuleId' is set
        if (this.escalationRuleId == null) {
            throw new IllegalStateException("Missing the required parameter 'escalationRuleId' when building request for PutSocialmediaEscalationruleRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/socialmedia/escalationrules/{escalationRuleId}")
	...
	public static class Builder {
		private final PutSocialmediaEscalationruleRequest request;

		private Builder() {
			request = new PutSocialmediaEscalationruleRequest();
		}
		...
		public Builder withBody(EscalationRuleRequest body) {
		...
		public PutSocialmediaEscalationruleRequest build() {
