...
public class PostUsersMeVerifiersTotpRequest {

	private CreateVerifierRequest body;
	public CreateVerifierRequest getBody() {
		return this.body;
	}

	public void setBody(CreateVerifierRequest body) {
		this.body = body;
	}

	public PostUsersMeVerifiersTotpRequest withBody(CreateVerifierRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostUsersMeVerifiersTotpRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<CreateVerifierRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostUsersMeVerifiersTotpRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/users/me/verifiers/totp")
                .withBody(body)
	...
	public static Builder builder(CreateVerifierRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostUsersMeVerifiersTotpRequest request;

		private Builder() {
			request = new PostUsersMeVerifiersTotpRequest();
		}


		public Builder withBody(CreateVerifierRequest body) {
		...
		public Builder withRequiredParams(CreateVerifierRequest body) {
			request.setBody(body);
		...
		public PostUsersMeVerifiersTotpRequest build() {
