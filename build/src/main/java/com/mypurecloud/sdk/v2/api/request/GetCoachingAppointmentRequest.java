...
public class GetCoachingAppointmentRequest {
	...
	public GetCoachingAppointmentRequest withAppointmentId(String appointmentId) {
    ...
    public GetCoachingAppointmentRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.appointmentId == null) {
            throw new IllegalStateException("Missing the required parameter 'appointmentId' when building request for GetCoachingAppointmentRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/coaching/appointments/{appointmentId}")
	...
	public static class Builder {
		private final GetCoachingAppointmentRequest request;

		private Builder() {
			request = new GetCoachingAppointmentRequest();
		}
		...
		public GetCoachingAppointmentRequest build() {
