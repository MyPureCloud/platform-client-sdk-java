...
public class GetUsageEventsDefinitionsRequest {
    ...
    public GetUsageEventsDefinitionsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/usage/events/definitions")
	...
	public static class Builder {
		private final GetUsageEventsDefinitionsRequest request;

		private Builder() {
			request = new GetUsageEventsDefinitionsRequest();
		}
		...
		public GetUsageEventsDefinitionsRequest build() {
