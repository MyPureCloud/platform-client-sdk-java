...
public class PostWorkforcemanagementShifttradingTradesMineQueryJobsRequest {

	private QueryAgentShiftTradeListJobRequest body;
	public QueryAgentShiftTradeListJobRequest getBody() {
		return this.body;
	}

	public void setBody(QueryAgentShiftTradeListJobRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementShifttradingTradesMineQueryJobsRequest withBody(QueryAgentShiftTradeListJobRequest body) {
	    this.setBody(body);
	    return this;
	} 
	...
	public PostWorkforcemanagementShifttradingTradesMineQueryJobsRequest withForceAsync(Boolean forceAsync) {
	...
	public PostWorkforcemanagementShifttradingTradesMineQueryJobsRequest withForceDownloadService(Boolean forceDownloadService) {
    ...
    public PostWorkforcemanagementShifttradingTradesMineQueryJobsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<QueryAgentShiftTradeListJobRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementShifttradingTradesMineQueryJobsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/shifttrading/trades/mine/query/jobs")
	...
	public static Builder builder(QueryAgentShiftTradeListJobRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementShifttradingTradesMineQueryJobsRequest request;

		private Builder() {
			request = new PostWorkforcemanagementShifttradingTradesMineQueryJobsRequest();
		}


		public Builder withBody(QueryAgentShiftTradeListJobRequest body) {
		...
		public Builder withRequiredParams(QueryAgentShiftTradeListJobRequest body) {
			request.setBody(body);
		...
		public PostWorkforcemanagementShifttradingTradesMineQueryJobsRequest build() {
