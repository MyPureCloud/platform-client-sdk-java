...
public class GetUsersRuleDependentsRequest {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/users/rules/{ruleId}/dependents")
	...
	public static class Builder {
		private final GetUsersRuleDependentsRequest request;

		private Builder() {
			request = new GetUsersRuleDependentsRequest();
		}
