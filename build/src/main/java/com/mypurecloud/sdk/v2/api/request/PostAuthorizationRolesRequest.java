...
public class PostAuthorizationRolesRequest {
	...
	public void setBody(DomainOrganizationRoleCreate body) {
		this.body = body;
	}

	public PostAuthorizationRolesRequest withBody(DomainOrganizationRoleCreate body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostAuthorizationRolesRequest withCustomHeader(String name, String value) {
