...
public class PostWorkforcemanagementManagementunitWeekShifttradeMatchRequest {
	...
	public PostWorkforcemanagementManagementunitWeekShifttradeMatchRequest withManagementUnitId(String managementUnitId) {
	...
	public PostWorkforcemanagementManagementunitWeekShifttradeMatchRequest withWeekDateId(LocalDate weekDateId) {
	...
	public void setBody(MatchShiftTradeRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementManagementunitWeekShifttradeMatchRequest withBody(MatchShiftTradeRequest body) {
	    this.setBody(body);
	    return this;
	} 
	...
	public PostWorkforcemanagementManagementunitWeekShifttradeMatchRequest withTradeId(String tradeId) {
    ...
    public PostWorkforcemanagementManagementunitWeekShifttradeMatchRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<MatchShiftTradeRequest> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/managementunits/{managementUnitId}/weeks/{weekDateId}/shifttrades/{tradeId}/match")
	...
	public static Builder builder(String managementUnitId, LocalDate weekDateId, MatchShiftTradeRequest body, String tradeId) {
	    return new Builder()
	...
	public static class Builder {
		...
		private Builder() {
			request = new PostWorkforcemanagementManagementunitWeekShifttradeMatchRequest();
		}
		...
		public Builder withBody(MatchShiftTradeRequest body) {
		...
		public Builder withRequiredParams(String managementUnitId, LocalDate weekDateId, MatchShiftTradeRequest body, String tradeId) {
			request.setManagementUnitId(managementUnitId);
						request.setWeekDateId(weekDateId);
						request.setBody(body);
						request.setTradeId(tradeId);
