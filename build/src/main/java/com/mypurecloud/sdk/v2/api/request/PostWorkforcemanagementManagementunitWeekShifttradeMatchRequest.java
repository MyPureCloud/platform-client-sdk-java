...
public class PostWorkforcemanagementManagementunitWeekShifttradeMatchRequest {
	...
	public static Builder builder(String managementUnitId, LocalDate weekDateId, String tradeId, MatchShiftTradeRequest body) {
	    return new Builder()
	...
	public static class Builder {
		...
		public Builder withRequiredParams(String managementUnitId, LocalDate weekDateId, String tradeId, MatchShiftTradeRequest body) {
			request.setManagementUnitId(managementUnitId);
			request.setWeekDateId(weekDateId);
			request.setTradeId(tradeId);
			request.setBody(body);
