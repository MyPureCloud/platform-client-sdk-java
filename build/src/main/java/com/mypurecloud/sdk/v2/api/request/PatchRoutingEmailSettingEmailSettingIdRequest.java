...
public class PatchRoutingEmailSettingEmailSettingIdRequest {
	...
	public PatchRoutingEmailSettingEmailSettingIdRequest withEmailSettingId(String emailSettingId) {
	    this.setEmailSettingId(emailSettingId);
	    return this;
	} 

	private EmailSetting body;
	public EmailSetting getBody() {
		return this.body;
	}

	public void setBody(EmailSetting body) {
		this.body = body;
	}

	public PatchRoutingEmailSettingEmailSettingIdRequest withBody(EmailSetting body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchRoutingEmailSettingEmailSettingIdRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<EmailSetting> withHttpInfo() {
        
        // verify the required parameter 'emailSettingId' is set
        if (this.emailSettingId == null) {
            throw new IllegalStateException("Missing the required parameter 'emailSettingId' when building request for PatchRoutingEmailSettingEmailSettingIdRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchRoutingEmailSettingEmailSettingIdRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/routing/email/setting/{emailSettingId}")
                .withPathParameter("emailSettingId", emailSettingId)
	...
	public static Builder builder(String emailSettingId, EmailSetting body) {
	    return new Builder()
	            .withRequiredParams(emailSettingId, body);
	}


	public static class Builder {
		private final PatchRoutingEmailSettingEmailSettingIdRequest request;

		private Builder() {
			request = new PatchRoutingEmailSettingEmailSettingIdRequest();
		}


		public Builder withEmailSettingId(String emailSettingId) {
			request.setEmailSettingId(emailSettingId);
			return this;
		}

		public Builder withBody(EmailSetting body) {
		...
		public Builder withRequiredParams(String emailSettingId, EmailSetting body) {
			request.setEmailSettingId(emailSettingId);
			request.setBody(body);
		...
		public PatchRoutingEmailSettingEmailSettingIdRequest build() {
            
            // verify the required parameter 'emailSettingId' is set
            if (request.emailSettingId == null) {
                throw new IllegalStateException("Missing the required parameter 'emailSettingId' when building request for PatchRoutingEmailSettingEmailSettingIdRequest.");
            }
