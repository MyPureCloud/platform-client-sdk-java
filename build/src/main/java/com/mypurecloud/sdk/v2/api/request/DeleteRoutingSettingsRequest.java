...
public class DeleteRoutingSettingsRequest {
    ...
    public DeleteRoutingSettingsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("DELETE", "/api/v2/routing/settings")
	...
	public static class Builder {
		private final DeleteRoutingSettingsRequest request;

		private Builder() {
			request = new DeleteRoutingSettingsRequest();
		}
		...
		public DeleteRoutingSettingsRequest build() {
