...
public class GetSocialmediaTopicRequest {
	...
	public GetSocialmediaTopicRequest withTopicId(String topicId) {
	...
	public GetSocialmediaTopicRequest withIncludeDeleted(Boolean includeDeleted) {
    ...
    public GetSocialmediaTopicRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.topicId == null) {
            throw new IllegalStateException("Missing the required parameter 'topicId' when building request for GetSocialmediaTopicRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/socialmedia/topics/{topicId}")
	...
	public static class Builder {
		private final GetSocialmediaTopicRequest request;

		private Builder() {
			request = new GetSocialmediaTopicRequest();
		}
		...
		public GetSocialmediaTopicRequest build() {
