...
public class PostKnowledgeGuestSessionDocumentFeedbackRequest {
	...
	public PostKnowledgeGuestSessionDocumentFeedbackRequest withSessionId(String sessionId) {
	...
	public PostKnowledgeGuestSessionDocumentFeedbackRequest withDocumentId(String documentId) {
	    this.setDocumentId(documentId);
	    return this;
	} 

	private KnowledgeGuestDocumentFeedback body;
	public KnowledgeGuestDocumentFeedback getBody() {
		return this.body;
	}

	public void setBody(KnowledgeGuestDocumentFeedback body) {
		this.body = body;
	}
    ...
    public PostKnowledgeGuestSessionDocumentFeedbackRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<KnowledgeGuestDocumentFeedback> withHttpInfo() {
        
        // verify the required parameter 'sessionId' is set
        if (this.sessionId == null) {
            throw new IllegalStateException("Missing the required parameter 'sessionId' when building request for PostKnowledgeGuestSessionDocumentFeedbackRequest.");
        }
        
        // verify the required parameter 'documentId' is set
        if (this.documentId == null) {
            throw new IllegalStateException("Missing the required parameter 'documentId' when building request for PostKnowledgeGuestSessionDocumentFeedbackRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/knowledge/guest/sessions/{sessionId}/documents/{documentId}/feedback")
	...
	public static Builder builder(String sessionId, String documentId) {
	    return new Builder()
	            .withRequiredParams(sessionId, documentId);
	}


	public static class Builder {
		private final PostKnowledgeGuestSessionDocumentFeedbackRequest request;

		private Builder() {
			request = new PostKnowledgeGuestSessionDocumentFeedbackRequest();
		}
		...
		public Builder withBody(KnowledgeGuestDocumentFeedback body) {
		...
		public PostKnowledgeGuestSessionDocumentFeedbackRequest build() {
