...
public class DeleteRoutingEmailOutboundDomainRequest {
	...
	public DeleteRoutingEmailOutboundDomainRequest withDomainId(String domainId) {
    ...
    public DeleteRoutingEmailOutboundDomainRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.domainId == null) {
            throw new IllegalStateException("Missing the required parameter 'domainId' when building request for DeleteRoutingEmailOutboundDomainRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/routing/email/outbound/domains/{domainId}")
	...
	public static class Builder {
		private final DeleteRoutingEmailOutboundDomainRequest request;

		private Builder() {
			request = new DeleteRoutingEmailOutboundDomainRequest();
		}
		...
		public DeleteRoutingEmailOutboundDomainRequest build() {
