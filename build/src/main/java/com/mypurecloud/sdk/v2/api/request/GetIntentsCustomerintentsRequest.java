...
public class GetIntentsCustomerintentsRequest {
	...
	public GetIntentsCustomerintentsRequest withPageSize(Integer pageSize) {
	...
	public GetIntentsCustomerintentsRequest withPageNumber(Integer pageNumber) {
	...
	public GetIntentsCustomerintentsRequest withQueryValue(String queryValue) {
	...
	public GetIntentsCustomerintentsRequest withCategoryId(String categoryId) {
    ...
    public GetIntentsCustomerintentsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/intents/customerintents")
                ...
                .withQueryParameters("categoryId", "", categoryId)
	...
	public static class Builder {
		private final GetIntentsCustomerintentsRequest request;

		private Builder() {
			request = new GetIntentsCustomerintentsRequest();
		}
		...
		public GetIntentsCustomerintentsRequest build() {
