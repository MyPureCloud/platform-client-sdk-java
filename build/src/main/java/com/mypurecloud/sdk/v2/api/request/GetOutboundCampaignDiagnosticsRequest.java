...
public class GetOutboundCampaignDiagnosticsRequest {
	...
	public GetOutboundCampaignDiagnosticsRequest withCampaignId(String campaignId) {
    ...
    public GetOutboundCampaignDiagnosticsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.campaignId == null) {
            throw new IllegalStateException("Missing the required parameter 'campaignId' when building request for GetOutboundCampaignDiagnosticsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/outbound/campaigns/{campaignId}/diagnostics")
	...
	public static class Builder {
		private final GetOutboundCampaignDiagnosticsRequest request;

		private Builder() {
			request = new GetOutboundCampaignDiagnosticsRequest();
		}
		...
		public GetOutboundCampaignDiagnosticsRequest build() {
