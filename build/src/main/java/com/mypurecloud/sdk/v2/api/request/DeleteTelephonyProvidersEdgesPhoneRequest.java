...
public class DeleteTelephonyProvidersEdgesPhoneRequest {
	...
	public DeleteTelephonyProvidersEdgesPhoneRequest withPhoneId(String phoneId) {
    ...
    public DeleteTelephonyProvidersEdgesPhoneRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.phoneId == null) {
            throw new IllegalStateException("Missing the required parameter 'phoneId' when building request for DeleteTelephonyProvidersEdgesPhoneRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/telephony/providers/edges/phones/{phoneId}")
	...
	public static class Builder {
		private final DeleteTelephonyProvidersEdgesPhoneRequest request;

		private Builder() {
			request = new DeleteTelephonyProvidersEdgesPhoneRequest();
		}
		...
		public DeleteTelephonyProvidersEdgesPhoneRequest build() {
