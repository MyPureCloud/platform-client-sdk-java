...
public class CoachingAnnotation  implements Serializable {
  ...
  @ApiModelProperty(example = "null", value = "The date/time the annotation was created. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss.SSSZ")
  ...
  @ApiModelProperty(example = "null", value = "The date/time the annotation was last modified. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss.SSSZ")
