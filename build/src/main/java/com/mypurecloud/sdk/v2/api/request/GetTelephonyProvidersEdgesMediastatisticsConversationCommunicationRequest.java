...
public class GetTelephonyProvidersEdgesMediastatisticsConversationCommunicationRequest {
	...
	public GetTelephonyProvidersEdgesMediastatisticsConversationCommunicationRequest withConversationId(String conversationId) {
	...
	public GetTelephonyProvidersEdgesMediastatisticsConversationCommunicationRequest withCommunicationId(String communicationId) {
    ...
    public GetTelephonyProvidersEdgesMediastatisticsConversationCommunicationRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for GetTelephonyProvidersEdgesMediastatisticsConversationCommunicationRequest.");
        }
        
        // verify the required parameter 'communicationId' is set
        if (this.communicationId == null) {
            throw new IllegalStateException("Missing the required parameter 'communicationId' when building request for GetTelephonyProvidersEdgesMediastatisticsConversationCommunicationRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/telephony/providers/edges/mediastatistics/conversations/{conversationId}/communications/{communicationId}")
	...
	public static class Builder {
		private final GetTelephonyProvidersEdgesMediastatisticsConversationCommunicationRequest request;

		private Builder() {
			request = new GetTelephonyProvidersEdgesMediastatisticsConversationCommunicationRequest();
		}
		...
		public GetTelephonyProvidersEdgesMediastatisticsConversationCommunicationRequest build() {
