...
public class GetTelephonyProvidersEdgesEdgegroupsRequest {
	...
	public GetTelephonyProvidersEdgesEdgegroupsRequest withPageSize(Integer pageSize) {
	...
	public GetTelephonyProvidersEdgesEdgegroupsRequest withPageNumber(Integer pageNumber) {
	...
	public GetTelephonyProvidersEdgesEdgegroupsRequest withName(String name) {
	    this.setName(name);
	    return this;
	} 
	...
	public GetTelephonyProvidersEdgesEdgegroupsRequest withSortBy(String sortBy) {
	...
	public GetTelephonyProvidersEdgesEdgegroupsRequest withManaged(Boolean managed) {
    ...
    public GetTelephonyProvidersEdgesEdgegroupsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/telephony/providers/edges/edgegroups")
	...
	public static class Builder {
		private final GetTelephonyProvidersEdgesEdgegroupsRequest request;

		private Builder() {
			request = new GetTelephonyProvidersEdgesEdgegroupsRequest();
		}
		...
		public GetTelephonyProvidersEdgesEdgegroupsRequest build() {
