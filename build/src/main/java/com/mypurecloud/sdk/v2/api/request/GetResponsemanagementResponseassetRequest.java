...
public class GetResponsemanagementResponseassetRequest {
	...
	public GetResponsemanagementResponseassetRequest withResponseAssetId(String responseAssetId) {
    ...
    public GetResponsemanagementResponseassetRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.responseAssetId == null) {
            throw new IllegalStateException("Missing the required parameter 'responseAssetId' when building request for GetResponsemanagementResponseassetRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/responsemanagement/responseassets/{responseAssetId}")
	...
	public static class Builder {
		private final GetResponsemanagementResponseassetRequest request;

		private Builder() {
			request = new GetResponsemanagementResponseassetRequest();
		}
		...
		public GetResponsemanagementResponseassetRequest build() {
