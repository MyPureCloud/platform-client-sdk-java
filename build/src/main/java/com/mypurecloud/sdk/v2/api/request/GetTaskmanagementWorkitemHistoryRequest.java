...
public class GetTaskmanagementWorkitemHistoryRequest {
	...
	public GetTaskmanagementWorkitemHistoryRequest withWorkitemId(String workitemId) {
	...
	public GetTaskmanagementWorkitemHistoryRequest withAfter(String after) {
	    this.setAfter(after);
	    return this;
	} 
	...
	public GetTaskmanagementWorkitemHistoryRequest withPageSize(Integer pageSize) {
	...
	public GetTaskmanagementWorkitemHistoryRequest withSortOrder(String sortOrder) {
    ...
    public GetTaskmanagementWorkitemHistoryRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.workitemId == null) {
            throw new IllegalStateException("Missing the required parameter 'workitemId' when building request for GetTaskmanagementWorkitemHistoryRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/taskmanagement/workitems/{workitemId}/history")
	...
	public static class Builder {
		private final GetTaskmanagementWorkitemHistoryRequest request;

		private Builder() {
			request = new GetTaskmanagementWorkitemHistoryRequest();
		}
		...
		public GetTaskmanagementWorkitemHistoryRequest build() {
