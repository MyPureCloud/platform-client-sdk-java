...
public class PostSpeechandtextanalyticsSentimentfeedbackRequest {
    
	private SentimentFeedback body;
	public SentimentFeedback getBody() {
		return this.body;
	}

	public void setBody(SentimentFeedback body) {
		this.body = body;
	}

	public PostSpeechandtextanalyticsSentimentfeedbackRequest withBody(SentimentFeedback body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostSpeechandtextanalyticsSentimentfeedbackRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<SentimentFeedback> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostSpeechandtextanalyticsSentimentfeedbackRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/speechandtextanalytics/sentimentfeedback")
                .withBody(body)
	...
	public static Builder builder(SentimentFeedback body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostSpeechandtextanalyticsSentimentfeedbackRequest request;

		private Builder() {
			request = new PostSpeechandtextanalyticsSentimentfeedbackRequest();
		}

		
		public Builder withBody(SentimentFeedback body) {
		...
		public Builder withRequiredParams(SentimentFeedback body) {
			request.setBody(body);
		...
		public PostSpeechandtextanalyticsSentimentfeedbackRequest build() {
