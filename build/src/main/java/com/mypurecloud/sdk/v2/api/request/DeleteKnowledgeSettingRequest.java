...
public class DeleteKnowledgeSettingRequest {
	...
	public DeleteKnowledgeSettingRequest withKnowledgeSettingId(String knowledgeSettingId) {
    ...
    public DeleteKnowledgeSettingRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.knowledgeSettingId == null) {
            throw new IllegalStateException("Missing the required parameter 'knowledgeSettingId' when building request for DeleteKnowledgeSettingRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/knowledge/settings/{knowledgeSettingId}")
	...
	public static Builder builder(String knowledgeSettingId) {
	    return new Builder()
	            .withRequiredParams(knowledgeSettingId);
	}


	public static class Builder {
		private final DeleteKnowledgeSettingRequest request;

		private Builder() {
			request = new DeleteKnowledgeSettingRequest();
		}
		...
		public Builder withRequiredParams(String knowledgeSettingId) {
			request.setKnowledgeSettingId(knowledgeSettingId);
		...
		public DeleteKnowledgeSettingRequest build() {
