...
public class GetIntegrationsSpeechDialogflowcxAgentRequest {
	...
	public GetIntegrationsSpeechDialogflowcxAgentRequest withAgentId(String agentId) {
    ...
    public GetIntegrationsSpeechDialogflowcxAgentRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.agentId == null) {
            throw new IllegalStateException("Missing the required parameter 'agentId' when building request for GetIntegrationsSpeechDialogflowcxAgentRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/integrations/speech/dialogflowcx/agents/{agentId}")
	...
	public static class Builder {
		private final GetIntegrationsSpeechDialogflowcxAgentRequest request;

		private Builder() {
			request = new GetIntegrationsSpeechDialogflowcxAgentRequest();
		}
		...
		public GetIntegrationsSpeechDialogflowcxAgentRequest build() {
