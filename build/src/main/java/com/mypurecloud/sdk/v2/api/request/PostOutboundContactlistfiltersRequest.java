...
public class PostOutboundContactlistfiltersRequest {
	...
	public PostOutboundContactlistfiltersRequest withBody(ContactListFilter body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostOutboundContactlistfiltersRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<ContactListFilter> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostOutboundContactlistfiltersRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/outbound/contactlistfilters")
                .withBody(body)
	...
	public static class Builder {
		private final PostOutboundContactlistfiltersRequest request;

		private Builder() {
			request = new PostOutboundContactlistfiltersRequest();
		}
		...
		public PostOutboundContactlistfiltersRequest build() {
