...
public class PutConversationsMessagingSupportedcontentDefaultRequest {
    
	private SupportedContentReference body;
	public SupportedContentReference getBody() {
		return this.body;
	}

	public void setBody(SupportedContentReference body) {
		this.body = body;
	}
    ...
    public ApiRequest<SupportedContentReference> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutConversationsMessagingSupportedcontentDefaultRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/conversations/messaging/supportedcontent/default")
                .withBody(body)
	...
	public static Builder builder(SupportedContentReference body) {
	    return new Builder()
	...
	public static class Builder {
		private final PutConversationsMessagingSupportedcontentDefaultRequest request;

		private Builder() {
			request = new PutConversationsMessagingSupportedcontentDefaultRequest();
		}

		
		public Builder withBody(SupportedContentReference body) {
		...
		public Builder withRequiredParams(SupportedContentReference body) {
			request.setBody(body);
		...
		public PutConversationsMessagingSupportedcontentDefaultRequest build() {
