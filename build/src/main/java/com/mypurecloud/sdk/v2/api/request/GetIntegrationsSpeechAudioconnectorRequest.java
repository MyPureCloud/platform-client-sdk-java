...
public class GetIntegrationsSpeechAudioconnectorRequest {
	...
	public GetIntegrationsSpeechAudioconnectorRequest withPageNumber(Integer pageNumber) {
	...
	public GetIntegrationsSpeechAudioconnectorRequest withPageSize(Integer pageSize) {
    ...
    public GetIntegrationsSpeechAudioconnectorRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/integrations/speech/audioconnector")
	...
	public static class Builder {
		private final GetIntegrationsSpeechAudioconnectorRequest request;

		private Builder() {
			request = new GetIntegrationsSpeechAudioconnectorRequest();
		}
		...
		public GetIntegrationsSpeechAudioconnectorRequest build() {
