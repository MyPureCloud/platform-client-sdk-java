...
public class PostWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionExportSnapshotJobsRequest {
	...
	public PostWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionExportSnapshotJobsRequest withBusinessUnitId(String businessUnitId) {
	    this.setBusinessUnitId(businessUnitId);
	    return this;
	} 

	private AggregatedExportSnapshotJobRequest body;
	public AggregatedExportSnapshotJobRequest getBody() {
		return this.body;
	}

	public void setBody(AggregatedExportSnapshotJobRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionExportSnapshotJobsRequest withBody(AggregatedExportSnapshotJobRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionExportSnapshotJobsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<AggregatedExportSnapshotJobRequest> withHttpInfo() {
        
        // verify the required parameter 'businessUnitId' is set
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PostWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionExportSnapshotJobsRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionExportSnapshotJobsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/mainforecast/continuousforecast/session/export/snapshot/jobs")
	...
	public static Builder builder(String businessUnitId, AggregatedExportSnapshotJobRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionExportSnapshotJobsRequest request;

		private Builder() {
			request = new PostWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionExportSnapshotJobsRequest();
		}
		...
		public Builder withBody(AggregatedExportSnapshotJobRequest body) {
		...
		public Builder withRequiredParams(String businessUnitId, AggregatedExportSnapshotJobRequest body) {
			request.setBusinessUnitId(businessUnitId);
			request.setBody(body);
		...
		public PostWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionExportSnapshotJobsRequest build() {
