...
public class GetExternalcontactsScanOrganizationsRequest {
	...
	public GetExternalcontactsScanOrganizationsRequest withLimit(Integer limit) {
	    this.setLimit(limit);
	    return this;
	} 
	...
	public GetExternalcontactsScanOrganizationsRequest withCursor(String cursor) {
	...
	public GetExternalcontactsScanOrganizationsRequest withDivisionId(String divisionId) {
    ...
    public GetExternalcontactsScanOrganizationsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/externalcontacts/scan/organizations")
	...
	public static class Builder {
		private final GetExternalcontactsScanOrganizationsRequest request;

		private Builder() {
			request = new GetExternalcontactsScanOrganizationsRequest();
		}
		...
		public GetExternalcontactsScanOrganizationsRequest build() {
