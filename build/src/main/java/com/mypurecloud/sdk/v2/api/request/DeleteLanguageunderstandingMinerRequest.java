...
public class DeleteLanguageunderstandingMinerRequest {
	...
	public DeleteLanguageunderstandingMinerRequest withMinerId(String minerId) {
    ...
    public DeleteLanguageunderstandingMinerRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.minerId == null) {
            throw new IllegalStateException("Missing the required parameter 'minerId' when building request for DeleteLanguageunderstandingMinerRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/languageunderstanding/miners/{minerId}")
	...
	public static class Builder {
		private final DeleteLanguageunderstandingMinerRequest request;

		private Builder() {
			request = new DeleteLanguageunderstandingMinerRequest();
		}
		...
		public DeleteLanguageunderstandingMinerRequest build() {
