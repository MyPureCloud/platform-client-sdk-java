...
public class JourneyAggregationSort  implements Serializable {
 ...
 @JsonDeserialize(using = FunctionEnumDeserializer.class)
   ...
   * Name of the metric used for sorting values.
   **/
  public JourneyAggregationSort name(NameEnum name) {
    this.name = name;
    return this;
  }
   ...
   * Aggregation function used for the sort metric.
   **/
  public JourneyAggregationSort function(FunctionEnum function) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    JourneyAggregationSort journeyAggregationSort = (JourneyAggregationSort) o;

    return Objects.equals(this.name, journeyAggregationSort.name) &&
            Objects.equals(this.function, journeyAggregationSort.function);
  }
