...
public class GetExternalcontactsScanNotesDivisionviewsAllRequest {
	...
	public GetExternalcontactsScanNotesDivisionviewsAllRequest withLimit(Integer limit) {
	    this.setLimit(limit);
	    return this;
	} 
	...
	public GetExternalcontactsScanNotesDivisionviewsAllRequest withCursor(String cursor) {
    ...
    public GetExternalcontactsScanNotesDivisionviewsAllRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/externalcontacts/scan/notes/divisionviews/all")
	...
	public static class Builder {
		private final GetExternalcontactsScanNotesDivisionviewsAllRequest request;

		private Builder() {
			request = new GetExternalcontactsScanNotesDivisionviewsAllRequest();
		}
		...
		public GetExternalcontactsScanNotesDivisionviewsAllRequest build() {
