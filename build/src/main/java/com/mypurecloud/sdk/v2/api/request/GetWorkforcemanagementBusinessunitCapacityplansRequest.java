...
public class GetWorkforcemanagementBusinessunitCapacityplansRequest {
	...
	public GetWorkforcemanagementBusinessunitCapacityplansRequest withBusinessUnitId(String businessUnitId) {
    ...
    public GetWorkforcemanagementBusinessunitCapacityplansRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for GetWorkforcemanagementBusinessunitCapacityplansRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/capacityplans")
	...
	public static class Builder {
		private final GetWorkforcemanagementBusinessunitCapacityplansRequest request;

		private Builder() {
			request = new GetWorkforcemanagementBusinessunitCapacityplansRequest();
		}
		...
		public GetWorkforcemanagementBusinessunitCapacityplansRequest build() {
