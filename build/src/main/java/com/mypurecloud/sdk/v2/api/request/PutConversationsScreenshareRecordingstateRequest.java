...
public class PutConversationsScreenshareRecordingstateRequest {
	...
	public PutConversationsScreenshareRecordingstateRequest withConversationId(String conversationId) {
	    this.setConversationId(conversationId);
	    return this;
	} 

	private SetRecordingState body;
	public SetRecordingState getBody() {
		return this.body;
	}

	public void setBody(SetRecordingState body) {
		this.body = body;
	}

	public PutConversationsScreenshareRecordingstateRequest withBody(SetRecordingState body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutConversationsScreenshareRecordingstateRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<SetRecordingState> withHttpInfo() {
        
        // verify the required parameter 'conversationId' is set
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PutConversationsScreenshareRecordingstateRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutConversationsScreenshareRecordingstateRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/conversations/screenshares/{conversationId}/recordingstate")
	...
	public static Builder builder(String conversationId, SetRecordingState body) {
	    return new Builder()
	...
	public static class Builder {
		private final PutConversationsScreenshareRecordingstateRequest request;

		private Builder() {
			request = new PutConversationsScreenshareRecordingstateRequest();
		}
		...
		public Builder withBody(SetRecordingState body) {
		...
		public Builder withRequiredParams(String conversationId, SetRecordingState body) {
			request.setConversationId(conversationId);
			request.setBody(body);
		...
		public PutConversationsScreenshareRecordingstateRequest build() {
