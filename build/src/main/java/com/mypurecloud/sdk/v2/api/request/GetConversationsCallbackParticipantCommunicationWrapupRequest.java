...
public class GetConversationsCallbackParticipantCommunicationWrapupRequest {
	...
	public GetConversationsCallbackParticipantCommunicationWrapupRequest withConversationId(String conversationId) {
	...
	public GetConversationsCallbackParticipantCommunicationWrapupRequest withParticipantId(String participantId) {
	...
	public GetConversationsCallbackParticipantCommunicationWrapupRequest withCommunicationId(String communicationId) {
	...
	public GetConversationsCallbackParticipantCommunicationWrapupRequest withProvisional(Boolean provisional) {
    ...
    public GetConversationsCallbackParticipantCommunicationWrapupRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for GetConversationsCallbackParticipantCommunicationWrapupRequest.");
        }
        
        // verify the required parameter 'participantId' is set
        if (this.participantId == null) {
            throw new IllegalStateException("Missing the required parameter 'participantId' when building request for GetConversationsCallbackParticipantCommunicationWrapupRequest.");
        }
        
        // verify the required parameter 'communicationId' is set
        if (this.communicationId == null) {
            throw new IllegalStateException("Missing the required parameter 'communicationId' when building request for GetConversationsCallbackParticipantCommunicationWrapupRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/conversations/callbacks/{conversationId}/participants/{participantId}/communications/{communicationId}/wrapup")
	...
	public static class Builder {
		private final GetConversationsCallbackParticipantCommunicationWrapupRequest request;

		private Builder() {
			request = new GetConversationsCallbackParticipantCommunicationWrapupRequest();
		}
		...
		public GetConversationsCallbackParticipantCommunicationWrapupRequest build() {
