...
public class GetWorkforcemanagementManagementunitWeekScheduleRequest {
	...
	public GetWorkforcemanagementManagementunitWeekScheduleRequest withManagementUnitId(String managementUnitId) {
	...
	public GetWorkforcemanagementManagementunitWeekScheduleRequest withWeekId(String weekId) {
	...
	public GetWorkforcemanagementManagementunitWeekScheduleRequest withScheduleId(String scheduleId) {
	...
	public GetWorkforcemanagementManagementunitWeekScheduleRequest withExpand(String expand) {
	...
	public GetWorkforcemanagementManagementunitWeekScheduleRequest withForceDownloadService(Boolean forceDownloadService) {
    ...
    public GetWorkforcemanagementManagementunitWeekScheduleRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.managementUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'managementUnitId' when building request for GetWorkforcemanagementManagementunitWeekScheduleRequest.");
        }
        
        // verify the required parameter 'weekId' is set
        if (this.weekId == null) {
            throw new IllegalStateException("Missing the required parameter 'weekId' when building request for GetWorkforcemanagementManagementunitWeekScheduleRequest.");
        }
        
        // verify the required parameter 'scheduleId' is set
        if (this.scheduleId == null) {
            throw new IllegalStateException("Missing the required parameter 'scheduleId' when building request for GetWorkforcemanagementManagementunitWeekScheduleRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/managementunits/{managementUnitId}/weeks/{weekId}/schedules/{scheduleId}")
	...
	public static class Builder {
		private final GetWorkforcemanagementManagementunitWeekScheduleRequest request;

		private Builder() {
			request = new GetWorkforcemanagementManagementunitWeekScheduleRequest();
		}
		...
		public GetWorkforcemanagementManagementunitWeekScheduleRequest build() {
