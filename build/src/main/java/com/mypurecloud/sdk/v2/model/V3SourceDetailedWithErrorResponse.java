...
public class V3SourceDetailedWithErrorResponse  implements Serializable {
 ...
 @JsonDeserialize(using = StatusEnumDeserializer.class)
  ...
  public V3SourceDetailedWithErrorResponse() {
   ...
   **/
  public V3SourceDetailedWithErrorResponse name(String name) {
    this.name = name;
    return this;
  }
   ...
   **/
  public V3SourceDetailedWithErrorResponse connectionId(String connectionId) {
   ...
   * The type of the source.
   **/
  public V3SourceDetailedWithErrorResponse type(TypeEnum type) {
    this.type = type;
    return this;
  }
   ...
   * The trigger type of the source.
   **/
  public V3SourceDetailedWithErrorResponse triggerType(TriggerTypeEnum triggerType) {
   ...
   * The current status of the source.
   **/
  public V3SourceDetailedWithErrorResponse status(StatusEnum status) {
    this.status = status;
    return this;
  }
   ...
   **/
  public V3SourceDetailedWithErrorResponse createdBy(UserReference createdBy) {
   ...
   **/
  public V3SourceDetailedWithErrorResponse modifiedBy(UserReference modifiedBy) {
   ...
   **/
  public V3SourceDetailedWithErrorResponse dateCreated(Date dateCreated) {
   ...
   **/
  public V3SourceDetailedWithErrorResponse dateModified(Date dateModified) {
   ...
   **/
  public V3SourceDetailedWithErrorResponse lastSync(V3SourceLastSynchronization lastSync) {
   ...
   **/
  public V3SourceDetailedWithErrorResponse scheduleSettings(V3SourceScheduleSettings scheduleSettings) {
   ...
   **/
  public V3SourceDetailedWithErrorResponse filters(V3SourceFilter filters) {
   ...
   **/
  public V3SourceDetailedWithErrorResponse filterDetails(V3SourceFilterDetails filterDetails) {
   ...
   **/
  public V3SourceDetailedWithErrorResponse error(ErrorBody error) {
    this.error = error;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V3SourceDetailedWithErrorResponse v3SourceDetailedWithErrorResponse = (V3SourceDetailedWithErrorResponse) o;

    return Objects.equals(this.id, v3SourceDetailedWithErrorResponse.id) &&
            Objects.equals(this.name, v3SourceDetailedWithErrorResponse.name) &&
            Objects.equals(this.connectionId, v3SourceDetailedWithErrorResponse.connectionId) &&
            Objects.equals(this.type, v3SourceDetailedWithErrorResponse.type) &&
            Objects.equals(this.triggerType, v3SourceDetailedWithErrorResponse.triggerType) &&
            Objects.equals(this.status, v3SourceDetailedWithErrorResponse.status) &&
            Objects.equals(this.createdBy, v3SourceDetailedWithErrorResponse.createdBy) &&
            Objects.equals(this.modifiedBy, v3SourceDetailedWithErrorResponse.modifiedBy) &&
            Objects.equals(this.dateCreated, v3SourceDetailedWithErrorResponse.dateCreated) &&
            Objects.equals(this.dateModified, v3SourceDetailedWithErrorResponse.dateModified) &&
            Objects.equals(this.lastSync, v3SourceDetailedWithErrorResponse.lastSync) &&
            Objects.equals(this.scheduleSettings, v3SourceDetailedWithErrorResponse.scheduleSettings) &&
            Objects.equals(this.filters, v3SourceDetailedWithErrorResponse.filters) &&
            Objects.equals(this.filterDetails, v3SourceDetailedWithErrorResponse.filterDetails) &&
            Objects.equals(this.error, v3SourceDetailedWithErrorResponse.error) &&
            Objects.equals(this.selfUri, v3SourceDetailedWithErrorResponse.selfUri);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, connectionId, type, triggerType, status, createdBy, modifiedBy, dateCreated, dateModified, lastSync, scheduleSettings, filters, filterDetails, error, selfUri);
  }
