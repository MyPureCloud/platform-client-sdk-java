...
public class ConversationEventTopicDisconnectReason  implements Serializable {
 ...
 @JsonDeserialize(using = TypeEnumDeserializer.class)
   ...
   * Disconnect reason protocol type.
   **/
  public ConversationEventTopicDisconnectReason type(TypeEnum type) {
    this.type = type;
    return this;
  }
   ...
   **/
  public ConversationEventTopicDisconnectReason code(Long code) {
    this.code = code;
    return this;
  }
   ...
   **/
  public ConversationEventTopicDisconnectReason phrase(String phrase) {
    this.phrase = phrase;
    return this;
  }
   ...
   **/
  public ConversationEventTopicDisconnectReason reason(String reason) {
    this.reason = reason;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ConversationEventTopicDisconnectReason conversationEventTopicDisconnectReason = (ConversationEventTopicDisconnectReason) o;

    return Objects.equals(this.type, conversationEventTopicDisconnectReason.type) &&
            Objects.equals(this.code, conversationEventTopicDisconnectReason.code) &&
            Objects.equals(this.phrase, conversationEventTopicDisconnectReason.phrase) &&
            Objects.equals(this.reason, conversationEventTopicDisconnectReason.reason);
  }
