...
public class GetUsersCustomattributesSchemasLimitsRequest {
    ...
    public GetUsersCustomattributesSchemasLimitsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/users/customattributes/schemas/limits")
	...
	public static class Builder {
		private final GetUsersCustomattributesSchemasLimitsRequest request;

		private Builder() {
			request = new GetUsersCustomattributesSchemasLimitsRequest();
		}
		...
		public GetUsersCustomattributesSchemasLimitsRequest build() {
