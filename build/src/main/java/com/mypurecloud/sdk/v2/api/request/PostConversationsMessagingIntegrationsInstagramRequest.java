...
public class PostConversationsMessagingIntegrationsInstagramRequest {

	private InstagramIntegrationRequest body;
	public InstagramIntegrationRequest getBody() {
		return this.body;
	}

	public void setBody(InstagramIntegrationRequest body) {
		this.body = body;
	}

	public PostConversationsMessagingIntegrationsInstagramRequest withBody(InstagramIntegrationRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostConversationsMessagingIntegrationsInstagramRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<InstagramIntegrationRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostConversationsMessagingIntegrationsInstagramRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/conversations/messaging/integrations/instagram")
                .withBody(body)
	...
	public static Builder builder(InstagramIntegrationRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostConversationsMessagingIntegrationsInstagramRequest request;

		private Builder() {
			request = new PostConversationsMessagingIntegrationsInstagramRequest();
		}


		public Builder withBody(InstagramIntegrationRequest body) {
		...
		public Builder withRequiredParams(InstagramIntegrationRequest body) {
			request.setBody(body);
		...
		public PostConversationsMessagingIntegrationsInstagramRequest build() {
