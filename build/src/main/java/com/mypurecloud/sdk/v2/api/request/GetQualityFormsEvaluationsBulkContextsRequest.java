...
public class GetQualityFormsEvaluationsBulkContextsRequest {
	...
	public GetQualityFormsEvaluationsBulkContextsRequest withContextId(List<String> contextId) {
    ...
    public GetQualityFormsEvaluationsBulkContextsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.contextId == null) {
            throw new IllegalStateException("Missing the required parameter 'contextId' when building request for GetQualityFormsEvaluationsBulkContextsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/quality/forms/evaluations/bulk/contexts")
	...
	public static class Builder {
		private final GetQualityFormsEvaluationsBulkContextsRequest request;

		private Builder() {
			request = new GetQualityFormsEvaluationsBulkContextsRequest();
		}
		...
		public GetQualityFormsEvaluationsBulkContextsRequest build() {
