...
public class DeleteExternalcontactsContactsSchemaRequest {
	...
	public DeleteExternalcontactsContactsSchemaRequest withSchemaId(String schemaId) {
    ...
    public DeleteExternalcontactsContactsSchemaRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.schemaId == null) {
            throw new IllegalStateException("Missing the required parameter 'schemaId' when building request for DeleteExternalcontactsContactsSchemaRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/externalcontacts/contacts/schemas/{schemaId}")
	...
	public static class Builder {
		private final DeleteExternalcontactsContactsSchemaRequest request;

		private Builder() {
			request = new DeleteExternalcontactsContactsSchemaRequest();
		}
		...
		public DeleteExternalcontactsContactsSchemaRequest build() {
