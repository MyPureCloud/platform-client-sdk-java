...
public class GetIdentityprovidersIdentitynowRequest {
    ...
    public GetIdentityprovidersIdentitynowRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/identityproviders/identitynow")                .withCustomHeaders(customHeaders)
	...
	public static class Builder {
		private final GetIdentityprovidersIdentitynowRequest request;

		private Builder() {
			request = new GetIdentityprovidersIdentitynowRequest();
		}




		public GetIdentityprovidersIdentitynowRequest build() {
