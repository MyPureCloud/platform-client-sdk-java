...
public class GetTelephonyProvidersEdgeRequest {
	...
	public GetTelephonyProvidersEdgeRequest withEdgeId(String edgeId) {
	...
	public GetTelephonyProvidersEdgeRequest withExpand(List<String> expand) {
    ...
    public GetTelephonyProvidersEdgeRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.edgeId == null) {
            throw new IllegalStateException("Missing the required parameter 'edgeId' when building request for GetTelephonyProvidersEdgeRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/telephony/providers/edges/{edgeId}")
	...
	public static class Builder {
		private final GetTelephonyProvidersEdgeRequest request;

		private Builder() {
			request = new GetTelephonyProvidersEdgeRequest();
		}
		...
		public GetTelephonyProvidersEdgeRequest build() {
