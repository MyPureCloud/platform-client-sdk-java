...
public class PostRecordingBatchrequestsRequest {
    
	private BatchDownloadJobSubmission body;
	public BatchDownloadJobSubmission getBody() {
		return this.body;
	}

	public void setBody(BatchDownloadJobSubmission body) {
		this.body = body;
	}

	public PostRecordingBatchrequestsRequest withBody(BatchDownloadJobSubmission body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostRecordingBatchrequestsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<BatchDownloadJobSubmission> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostRecordingBatchrequestsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/recording/batchrequests")
                .withBody(body)
	...
	public static Builder builder(BatchDownloadJobSubmission body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostRecordingBatchrequestsRequest request;

		private Builder() {
			request = new PostRecordingBatchrequestsRequest();
		}

		
		public Builder withBody(BatchDownloadJobSubmission body) {
		...
		public Builder withRequiredParams(BatchDownloadJobSubmission body) {
			request.setBody(body);
		...
		public PostRecordingBatchrequestsRequest build() {
