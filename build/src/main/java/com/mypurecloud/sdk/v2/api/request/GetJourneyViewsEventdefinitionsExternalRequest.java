...
public class GetJourneyViewsEventdefinitionsExternalRequest {
    ...
    public GetJourneyViewsEventdefinitionsExternalRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/journey/views/eventdefinitions/external")
	...
	public static class Builder {
		private final GetJourneyViewsEventdefinitionsExternalRequest request;

		private Builder() {
			request = new GetJourneyViewsEventdefinitionsExternalRequest();
		}
		...
		public GetJourneyViewsEventdefinitionsExternalRequest build() {
