...
public class DeleteWorkforcemanagementBusinessunitPlanninggroupRequest {
	...
	public DeleteWorkforcemanagementBusinessunitPlanninggroupRequest withBusinessUnitId(String businessUnitId) {
	...
	public DeleteWorkforcemanagementBusinessunitPlanninggroupRequest withPlanningGroupId(String planningGroupId) {
    ...
    public DeleteWorkforcemanagementBusinessunitPlanninggroupRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for DeleteWorkforcemanagementBusinessunitPlanninggroupRequest.");
        }
        
        // verify the required parameter 'planningGroupId' is set
        if (this.planningGroupId == null) {
            throw new IllegalStateException("Missing the required parameter 'planningGroupId' when building request for DeleteWorkforcemanagementBusinessunitPlanninggroupRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/planninggroups/{planningGroupId}")
	...
	public static class Builder {
		private final DeleteWorkforcemanagementBusinessunitPlanninggroupRequest request;

		private Builder() {
			request = new DeleteWorkforcemanagementBusinessunitPlanninggroupRequest();
		}
		...
		public DeleteWorkforcemanagementBusinessunitPlanninggroupRequest build() {
