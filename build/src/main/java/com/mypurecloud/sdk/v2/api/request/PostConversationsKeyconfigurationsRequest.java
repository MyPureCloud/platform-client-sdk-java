...
public class PostConversationsKeyconfigurationsRequest {
	...
	public PostConversationsKeyconfigurationsRequest withBody(ConversationEncryptionConfiguration body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostConversationsKeyconfigurationsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<ConversationEncryptionConfiguration> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostConversationsKeyconfigurationsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/conversations/keyconfigurations")
                .withBody(body)
	...
	public static class Builder {
		private final PostConversationsKeyconfigurationsRequest request;

		private Builder() {
			request = new PostConversationsKeyconfigurationsRequest();
		}
		...
		public PostConversationsKeyconfigurationsRequest build() {
