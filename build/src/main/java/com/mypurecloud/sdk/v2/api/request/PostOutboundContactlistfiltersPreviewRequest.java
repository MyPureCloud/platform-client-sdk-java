...
public class PostOutboundContactlistfiltersPreviewRequest {
	...
	public PostOutboundContactlistfiltersPreviewRequest withBody(ContactListFilter body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostOutboundContactlistfiltersPreviewRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<ContactListFilter> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostOutboundContactlistfiltersPreviewRequest.");
        }
