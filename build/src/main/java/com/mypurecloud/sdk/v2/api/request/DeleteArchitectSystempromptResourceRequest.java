...
public class DeleteArchitectSystempromptResourceRequest {
	...
	public DeleteArchitectSystempromptResourceRequest withPromptId(String promptId) {
	...
	public DeleteArchitectSystempromptResourceRequest withLanguageCode(String languageCode) {
    ...
    public DeleteArchitectSystempromptResourceRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.promptId == null) {
            throw new IllegalStateException("Missing the required parameter 'promptId' when building request for DeleteArchitectSystempromptResourceRequest.");
        }
        
        // verify the required parameter 'languageCode' is set
        if (this.languageCode == null) {
            throw new IllegalStateException("Missing the required parameter 'languageCode' when building request for DeleteArchitectSystempromptResourceRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/architect/systemprompts/{promptId}/resources/{languageCode}")
	...
	public static class Builder {
		private final DeleteArchitectSystempromptResourceRequest request;

		private Builder() {
			request = new DeleteArchitectSystempromptResourceRequest();
		}
		...
		public DeleteArchitectSystempromptResourceRequest build() {
