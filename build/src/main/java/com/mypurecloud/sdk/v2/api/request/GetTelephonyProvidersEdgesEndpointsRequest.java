...
public class GetTelephonyProvidersEdgesEndpointsRequest {
	...
	public GetTelephonyProvidersEdgesEndpointsRequest withPageSize(Integer pageSize) {
	...
	public GetTelephonyProvidersEdgesEndpointsRequest withPageNumber(Integer pageNumber) {
	...
	public GetTelephonyProvidersEdgesEndpointsRequest withName(String name) {
	    this.setName(name);
	    return this;
	} 
	...
	public GetTelephonyProvidersEdgesEndpointsRequest withSortBy(String sortBy) {
    ...
    public GetTelephonyProvidersEdgesEndpointsRequest withCustomHeader(String name, String value) {
	...
	public static class Builder {
		private final GetTelephonyProvidersEdgesEndpointsRequest request;

		private Builder() {
			request = new GetTelephonyProvidersEdgesEndpointsRequest();
		}
		...
		public GetTelephonyProvidersEdgesEndpointsRequest build() {
