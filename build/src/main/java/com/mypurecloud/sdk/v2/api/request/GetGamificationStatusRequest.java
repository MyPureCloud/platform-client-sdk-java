...
public class GetGamificationStatusRequest {
    ...
    public GetGamificationStatusRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/gamification/status")
	...
	public static class Builder {
		private final GetGamificationStatusRequest request;

		private Builder() {
			request = new GetGamificationStatusRequest();
		}
		...
		public GetGamificationStatusRequest build() {
