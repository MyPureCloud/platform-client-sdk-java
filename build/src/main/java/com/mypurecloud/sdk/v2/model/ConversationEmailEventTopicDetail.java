...
public class ConversationEmailEventTopicDetail  implements Serializable {
  ...
  public ConversationEmailEventTopicDetail() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
    }
  }

  public ConversationEmailEventTopicDetail(Boolean initWithEmptyList) {
  ...
  /**
   **/
  public ConversationEmailEventTopicDetail errorCode(String errorCode) {
