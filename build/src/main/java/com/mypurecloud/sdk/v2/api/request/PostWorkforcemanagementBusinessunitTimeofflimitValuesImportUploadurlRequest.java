...
public class PostWorkforcemanagementBusinessunitTimeofflimitValuesImportUploadurlRequest {
	...
	public PostWorkforcemanagementBusinessunitTimeofflimitValuesImportUploadurlRequest withBusinessUnitId(String businessUnitId) {
	    this.setBusinessUnitId(businessUnitId);
	    return this;
	} 

	private String timeOffLimitId;
	...
	public PostWorkforcemanagementBusinessunitTimeofflimitValuesImportUploadurlRequest withTimeOffLimitId(String timeOffLimitId) {
	    this.setTimeOffLimitId(timeOffLimitId);
	    return this;
	} 

	private BuTimeOffLimitValuesImportUploadUrlRequest body;
	public BuTimeOffLimitValuesImportUploadUrlRequest getBody() {
		return this.body;
	}

	public void setBody(BuTimeOffLimitValuesImportUploadUrlRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementBusinessunitTimeofflimitValuesImportUploadurlRequest withBody(BuTimeOffLimitValuesImportUploadUrlRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementBusinessunitTimeofflimitValuesImportUploadurlRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<BuTimeOffLimitValuesImportUploadUrlRequest> withHttpInfo() {
        
        // verify the required parameter 'businessUnitId' is set
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PostWorkforcemanagementBusinessunitTimeofflimitValuesImportUploadurlRequest.");
        }
        
        // verify the required parameter 'timeOffLimitId' is set
        if (this.timeOffLimitId == null) {
            throw new IllegalStateException("Missing the required parameter 'timeOffLimitId' when building request for PostWorkforcemanagementBusinessunitTimeofflimitValuesImportUploadurlRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementBusinessunitTimeofflimitValuesImportUploadurlRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/timeofflimits/{timeOffLimitId}/values/import/uploadurl")
                .withPathParameter("businessUnitId", businessUnitId)
        
                .withPathParameter("timeOffLimitId", timeOffLimitId)
	...
	public static Builder builder(String businessUnitId, String timeOffLimitId, BuTimeOffLimitValuesImportUploadUrlRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementBusinessunitTimeofflimitValuesImportUploadurlRequest request;

		private Builder() {
			request = new PostWorkforcemanagementBusinessunitTimeofflimitValuesImportUploadurlRequest();
		}
		...
		public Builder withTimeOffLimitId(String timeOffLimitId) {
			request.setTimeOffLimitId(timeOffLimitId);
			return this;
		}

		public Builder withBody(BuTimeOffLimitValuesImportUploadUrlRequest body) {
		...
		public Builder withRequiredParams(String businessUnitId, String timeOffLimitId, BuTimeOffLimitValuesImportUploadUrlRequest body) {
			request.setBusinessUnitId(businessUnitId);
			request.setTimeOffLimitId(timeOffLimitId);
			request.setBody(body);
		...
		public PostWorkforcemanagementBusinessunitTimeofflimitValuesImportUploadurlRequest build() {
