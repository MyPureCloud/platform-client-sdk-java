...
public class StatEventFlowTopicStatsNotification  implements Serializable {
  ...
  private List<StatEventFlowTopicIntervalMetrics> data = null;

  public StatEventFlowTopicStatsNotification() {
  ...
  /**
   **/
  public StatEventFlowTopicStatsNotification group(Map<String, String> group) {
    this.group = group;
    return this;
  }
