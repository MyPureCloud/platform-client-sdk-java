...
public class GetExternalcontactsSettingsRequest {
    ...
    public GetExternalcontactsSettingsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/externalcontacts/settings")
	...
	public static class Builder {
		private final GetExternalcontactsSettingsRequest request;

		private Builder() {
			request = new GetExternalcontactsSettingsRequest();
		}
		...
		public GetExternalcontactsSettingsRequest build() {
