...
public class GetAnalyticsReportingDashboardsUserRequest {
	...
	public GetAnalyticsReportingDashboardsUserRequest withUserId(String userId) {
    ...
    public GetAnalyticsReportingDashboardsUserRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.userId == null) {
            throw new IllegalStateException("Missing the required parameter 'userId' when building request for GetAnalyticsReportingDashboardsUserRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/analytics/reporting/dashboards/users/{userId}")
	...
	public static class Builder {
		private final GetAnalyticsReportingDashboardsUserRequest request;

		private Builder() {
			request = new GetAnalyticsReportingDashboardsUserRequest();
		}
		...
		public GetAnalyticsReportingDashboardsUserRequest build() {
