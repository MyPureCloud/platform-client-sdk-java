...
public class GetQualityConversationsAuditsQueryTransactionIdRequest {
	...
	public GetQualityConversationsAuditsQueryTransactionIdRequest withTransactionId(String transactionId) {
    ...
    public GetQualityConversationsAuditsQueryTransactionIdRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.transactionId == null) {
            throw new IllegalStateException("Missing the required parameter 'transactionId' when building request for GetQualityConversationsAuditsQueryTransactionIdRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/quality/conversations/audits/query/{transactionId}")
	...
	public static class Builder {
		private final GetQualityConversationsAuditsQueryTransactionIdRequest request;

		private Builder() {
			request = new GetQualityConversationsAuditsQueryTransactionIdRequest();
		}
		...
		public GetQualityConversationsAuditsQueryTransactionIdRequest build() {
