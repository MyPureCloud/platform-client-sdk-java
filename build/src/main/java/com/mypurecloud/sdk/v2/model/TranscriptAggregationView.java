...
public class TranscriptAggregationView  implements Serializable {
 ...
 @JsonDeserialize(using = FunctionEnumDeserializer.class)
  ...
  public TranscriptAggregationView() {
   ...
   * Target metric name
   **/
  public TranscriptAggregationView target(TargetEnum target) {
    this.target = target;
    return this;
  }
   ...
   **/
  public TranscriptAggregationView name(String name) {
    this.name = name;
    return this;
  }
   ...
   * Type of view you wish to create
   **/
  public TranscriptAggregationView function(FunctionEnum function) {
   ...
   **/
  public TranscriptAggregationView range(AggregationRange range) {
    this.range = range;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TranscriptAggregationView transcriptAggregationView = (TranscriptAggregationView) o;

    return Objects.equals(this.target, transcriptAggregationView.target) &&
            Objects.equals(this.name, transcriptAggregationView.name) &&
            Objects.equals(this.function, transcriptAggregationView.function) &&
            Objects.equals(this.range, transcriptAggregationView.range);
  }
