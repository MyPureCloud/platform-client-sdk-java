...
public class PatchWorkforcemanagementManagementunitWeekShifttradeRequest {
	...
	public static Builder builder(String managementUnitId, LocalDate weekDateId, String tradeId, PatchShiftTradeRequest body) {
	    return new Builder()
	            .withRequiredParams(managementUnitId, weekDateId, tradeId, body);
	}
	...
	public static class Builder {
		...
		public Builder withRequiredParams(String managementUnitId, LocalDate weekDateId, String tradeId, PatchShiftTradeRequest body) {
			request.setManagementUnitId(managementUnitId);
			request.setWeekDateId(weekDateId);
			request.setTradeId(tradeId);
			request.setBody(body);
