...
public class PatchWorkforcemanagementManagementunitWeekShifttradeRequest {
	...
	public PatchWorkforcemanagementManagementunitWeekShifttradeRequest withManagementUnitId(String managementUnitId) {
	...
	public PatchWorkforcemanagementManagementunitWeekShifttradeRequest withWeekDateId(LocalDate weekDateId) {
	    this.setWeekDateId(weekDateId);
	    return this;
	} 
	
	private PatchShiftTradeRequest body;
	public PatchShiftTradeRequest getBody() {
		return this.body;
	}

	public void setBody(PatchShiftTradeRequest body) {
		this.body = body;
	}

	public PatchWorkforcemanagementManagementunitWeekShifttradeRequest withBody(PatchShiftTradeRequest body) {
	    this.setBody(body);
	    return this;
	} 
	...
	public PatchWorkforcemanagementManagementunitWeekShifttradeRequest withTradeId(String tradeId) {
    ...
    public PatchWorkforcemanagementManagementunitWeekShifttradeRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<PatchShiftTradeRequest> withHttpInfo() {
        
        // verify the required parameter 'managementUnitId' is set
        if (this.managementUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'managementUnitId' when building request for PatchWorkforcemanagementManagementunitWeekShifttradeRequest.");
        }
        
        // verify the required parameter 'weekDateId' is set
        if (this.weekDateId == null) {
            throw new IllegalStateException("Missing the required parameter 'weekDateId' when building request for PatchWorkforcemanagementManagementunitWeekShifttradeRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchWorkforcemanagementManagementunitWeekShifttradeRequest.");
        }
        
        // verify the required parameter 'tradeId' is set
        if (this.tradeId == null) {
            throw new IllegalStateException("Missing the required parameter 'tradeId' when building request for PatchWorkforcemanagementManagementunitWeekShifttradeRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/workforcemanagement/managementunits/{managementUnitId}/weeks/{weekDateId}/shifttrades/{tradeId}")
	...
	public static Builder builder(String managementUnitId, LocalDate weekDateId, PatchShiftTradeRequest body, String tradeId) {
	    return new Builder()
	            .withRequiredParams(managementUnitId, weekDateId, body, tradeId);
	}
	

	public static class Builder {
		private final PatchWorkforcemanagementManagementunitWeekShifttradeRequest request;

		private Builder() {
			request = new PatchWorkforcemanagementManagementunitWeekShifttradeRequest();
		}
		...
		public Builder withBody(PatchShiftTradeRequest body) {
		...
		public Builder withRequiredParams(String managementUnitId, LocalDate weekDateId, PatchShiftTradeRequest body, String tradeId) {
			request.setManagementUnitId(managementUnitId);
						request.setWeekDateId(weekDateId);
						request.setBody(body);
						request.setTradeId(tradeId);
		...
		public PatchWorkforcemanagementManagementunitWeekShifttradeRequest build() {
