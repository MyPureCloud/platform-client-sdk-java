...
public class GetConversationsMessageParticipantCommunicationWrapupRequest {
	...
	public GetConversationsMessageParticipantCommunicationWrapupRequest withConversationId(String conversationId) {
	...
	public GetConversationsMessageParticipantCommunicationWrapupRequest withParticipantId(String participantId) {
	...
	public GetConversationsMessageParticipantCommunicationWrapupRequest withCommunicationId(String communicationId) {
	...
	public GetConversationsMessageParticipantCommunicationWrapupRequest withProvisional(Boolean provisional) {
    ...
    public GetConversationsMessageParticipantCommunicationWrapupRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for GetConversationsMessageParticipantCommunicationWrapupRequest.");
        }
        
        // verify the required parameter 'participantId' is set
        if (this.participantId == null) {
            throw new IllegalStateException("Missing the required parameter 'participantId' when building request for GetConversationsMessageParticipantCommunicationWrapupRequest.");
        }
        
        // verify the required parameter 'communicationId' is set
        if (this.communicationId == null) {
            throw new IllegalStateException("Missing the required parameter 'communicationId' when building request for GetConversationsMessageParticipantCommunicationWrapupRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/conversations/messages/{conversationId}/participants/{participantId}/communications/{communicationId}/wrapup")
	...
	public static class Builder {
		private final GetConversationsMessageParticipantCommunicationWrapupRequest request;

		private Builder() {
			request = new GetConversationsMessageParticipantCommunicationWrapupRequest();
		}
		...
		public GetConversationsMessageParticipantCommunicationWrapupRequest build() {
