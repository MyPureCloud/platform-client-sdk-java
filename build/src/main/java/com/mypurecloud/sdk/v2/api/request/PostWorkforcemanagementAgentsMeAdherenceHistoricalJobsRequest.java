...
public class PostWorkforcemanagementAgentsMeAdherenceHistoricalJobsRequest {
	...
	public PostWorkforcemanagementAgentsMeAdherenceHistoricalJobsRequest withExpand(List<String> expand) {
	...
	public WfmHistoricalAdherenceQueryForAgent getBody() {
		return this.body;
	}

	public void setBody(WfmHistoricalAdherenceQueryForAgent body) {
		this.body = body;
	}

	public PostWorkforcemanagementAgentsMeAdherenceHistoricalJobsRequest withBody(WfmHistoricalAdherenceQueryForAgent body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementAgentsMeAdherenceHistoricalJobsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<WfmHistoricalAdherenceQueryForAgent> withHttpInfo() {
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/agents/me/adherence/historical/jobs")
	...
	public static class Builder {
		private final PostWorkforcemanagementAgentsMeAdherenceHistoricalJobsRequest request;

		private Builder() {
			request = new PostWorkforcemanagementAgentsMeAdherenceHistoricalJobsRequest();
		}
		...
		public Builder withBody(WfmHistoricalAdherenceQueryForAgent body) {
		...
		public PostWorkforcemanagementAgentsMeAdherenceHistoricalJobsRequest build() {
