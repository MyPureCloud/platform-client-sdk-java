...
public class PostOutboundFilespecificationtemplatesRequest {
	...
	public PostOutboundFilespecificationtemplatesRequest withBody(FileSpecificationTemplate body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostOutboundFilespecificationtemplatesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<FileSpecificationTemplate> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostOutboundFilespecificationtemplatesRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/outbound/filespecificationtemplates")
                .withBody(body)
	...
	public static Builder builder(FileSpecificationTemplate body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostOutboundFilespecificationtemplatesRequest request;

		private Builder() {
			request = new PostOutboundFilespecificationtemplatesRequest();
		}
		...
		public Builder withRequiredParams(FileSpecificationTemplate body) {
			request.setBody(body);
		...
		public PostOutboundFilespecificationtemplatesRequest build() {
