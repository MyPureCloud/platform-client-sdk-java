...
public class GetWorkforcemanagementBusinessunitSchedulebidGroupRequest {
	...
	public GetWorkforcemanagementBusinessunitSchedulebidGroupRequest withBusinessUnitId(String businessUnitId) {
	...
	public GetWorkforcemanagementBusinessunitSchedulebidGroupRequest withBidId(String bidId) {
	    this.setBidId(bidId);
	    return this;
	} 
	...
	public GetWorkforcemanagementBusinessunitSchedulebidGroupRequest withBidGroupId(String bidGroupId) {
    ...
    public GetWorkforcemanagementBusinessunitSchedulebidGroupRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for GetWorkforcemanagementBusinessunitSchedulebidGroupRequest.");
        }
        
        // verify the required parameter 'bidId' is set
        if (this.bidId == null) {
            throw new IllegalStateException("Missing the required parameter 'bidId' when building request for GetWorkforcemanagementBusinessunitSchedulebidGroupRequest.");
        }
        
        // verify the required parameter 'bidGroupId' is set
        if (this.bidGroupId == null) {
            throw new IllegalStateException("Missing the required parameter 'bidGroupId' when building request for GetWorkforcemanagementBusinessunitSchedulebidGroupRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/schedulebids/{bidId}/groups/{bidGroupId}")
	...
	public static class Builder {
		private final GetWorkforcemanagementBusinessunitSchedulebidGroupRequest request;

		private Builder() {
			request = new GetWorkforcemanagementBusinessunitSchedulebidGroupRequest();
		}
		...
		public GetWorkforcemanagementBusinessunitSchedulebidGroupRequest build() {
