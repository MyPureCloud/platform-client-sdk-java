...
public class PostOutboundCampaignAgentownedmappingpreviewRequest {
	...
	public PostOutboundCampaignAgentownedmappingpreviewRequest withCampaignId(String campaignId) {
    ...
    public PostOutboundCampaignAgentownedmappingpreviewRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.campaignId == null) {
            throw new IllegalStateException("Missing the required parameter 'campaignId' when building request for PostOutboundCampaignAgentownedmappingpreviewRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/outbound/campaigns/{campaignId}/agentownedmappingpreview")
	...
	public static class Builder {
		private final PostOutboundCampaignAgentownedmappingpreviewRequest request;

		private Builder() {
			request = new PostOutboundCampaignAgentownedmappingpreviewRequest();
		}
		...
		public PostOutboundCampaignAgentownedmappingpreviewRequest build() {
