...
public class DeleteTaskmanagementWorktypeFlowsOncreateRuleRequest {
	...
	public DeleteTaskmanagementWorktypeFlowsOncreateRuleRequest withWorktypeId(String worktypeId) {
	...
	public DeleteTaskmanagementWorktypeFlowsOncreateRuleRequest withRuleId(String ruleId) {
    ...
    public DeleteTaskmanagementWorktypeFlowsOncreateRuleRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.worktypeId == null) {
            throw new IllegalStateException("Missing the required parameter 'worktypeId' when building request for DeleteTaskmanagementWorktypeFlowsOncreateRuleRequest.");
        }
        
        // verify the required parameter 'ruleId' is set
        if (this.ruleId == null) {
            throw new IllegalStateException("Missing the required parameter 'ruleId' when building request for DeleteTaskmanagementWorktypeFlowsOncreateRuleRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/taskmanagement/worktypes/{worktypeId}/flows/oncreate/rules/{ruleId}")
	...
	public static class Builder {
		private final DeleteTaskmanagementWorktypeFlowsOncreateRuleRequest request;

		private Builder() {
			request = new DeleteTaskmanagementWorktypeFlowsOncreateRuleRequest();
		}
		...
		public DeleteTaskmanagementWorktypeFlowsOncreateRuleRequest build() {
