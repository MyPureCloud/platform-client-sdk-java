...
public class GetArchitectIvrIdentityresolutionRequest {
	...
	public GetArchitectIvrIdentityresolutionRequest withIvrId(String ivrId) {
	    this.setIvrId(ivrId);
	    return this;
	} 
    ...
    public GetArchitectIvrIdentityresolutionRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.ivrId == null) {
            throw new IllegalStateException("Missing the required parameter 'ivrId' when building request for GetArchitectIvrIdentityresolutionRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/architect/ivrs/{ivrId}/identityresolution")
	...
	public static class Builder {
		private final GetArchitectIvrIdentityresolutionRequest request;

		private Builder() {
			request = new GetArchitectIvrIdentityresolutionRequest();
		}
		...
		public GetArchitectIvrIdentityresolutionRequest build() {
