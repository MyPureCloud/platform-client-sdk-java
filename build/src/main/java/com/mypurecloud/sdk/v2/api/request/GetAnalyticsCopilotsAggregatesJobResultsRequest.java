...
public class GetAnalyticsCopilotsAggregatesJobResultsRequest {
	...
	public GetAnalyticsCopilotsAggregatesJobResultsRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
	...
	public GetAnalyticsCopilotsAggregatesJobResultsRequest withCursor(String cursor) {
    ...
    public GetAnalyticsCopilotsAggregatesJobResultsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetAnalyticsCopilotsAggregatesJobResultsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/analytics/copilots/aggregates/jobs/{jobId}/results")
	...
	public static class Builder {
		private final GetAnalyticsCopilotsAggregatesJobResultsRequest request;

		private Builder() {
			request = new GetAnalyticsCopilotsAggregatesJobResultsRequest();
		}
		...
		public GetAnalyticsCopilotsAggregatesJobResultsRequest build() {
