...
public class PostUsersSearchQueuemembersManageRequest {
	...
	public PostUsersSearchQueuemembersManageRequest withBody(UserSearchRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostUsersSearchQueuemembersManageRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<UserSearchRequest> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostUsersSearchQueuemembersManageRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/users/search/queuemembers/manage")
                .withBody(body)
	...
	public static class Builder {
		private final PostUsersSearchQueuemembersManageRequest request;

		private Builder() {
			request = new PostUsersSearchQueuemembersManageRequest();
		}
		...
		public PostUsersSearchQueuemembersManageRequest build() {
