...
public class PostConversationsMessageParticipantMonitorRequest {
	...
	public PostConversationsMessageParticipantMonitorRequest withConversationId(String conversationId) {
	...
	public PostConversationsMessageParticipantMonitorRequest withParticipantId(String participantId) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PostConversationsMessageParticipantMonitorRequest.");
        }
        
        // verify the required parameter 'participantId' is set
        if (this.participantId == null) {
            throw new IllegalStateException("Missing the required parameter 'participantId' when building request for PostConversationsMessageParticipantMonitorRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/conversations/messages/{conversationId}/participants/{participantId}/monitor")
	...
	public static class Builder {
		private final PostConversationsMessageParticipantMonitorRequest request;

		private Builder() {
			request = new PostConversationsMessageParticipantMonitorRequest();
		}
		...
		public PostConversationsMessageParticipantMonitorRequest build() {
