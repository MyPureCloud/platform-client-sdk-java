...
public class GetExternalcontactsScanOrganizationsDivisionviewsAllRequest {
	...
	public GetExternalcontactsScanOrganizationsDivisionviewsAllRequest withLimit(Integer limit) {
	    this.setLimit(limit);
	    return this;
	} 
	...
	public GetExternalcontactsScanOrganizationsDivisionviewsAllRequest withCursor(String cursor) {
    ...
    public GetExternalcontactsScanOrganizationsDivisionviewsAllRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/externalcontacts/scan/organizations/divisionviews/all")
	...
	public static class Builder {
		private final GetExternalcontactsScanOrganizationsDivisionviewsAllRequest request;

		private Builder() {
			request = new GetExternalcontactsScanOrganizationsDivisionviewsAllRequest();
		}
		...
		public GetExternalcontactsScanOrganizationsDivisionviewsAllRequest build() {
