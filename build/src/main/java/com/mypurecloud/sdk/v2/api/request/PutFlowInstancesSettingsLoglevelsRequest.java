...
public class PutFlowInstancesSettingsLoglevelsRequest {
	...
	public PutFlowInstancesSettingsLoglevelsRequest withFlowId(String flowId) {
	...
	public PutFlowInstancesSettingsLoglevelsRequest withBody(FlowLogLevelRequest body) {
	    this.setBody(body);
	    return this;
	} 
	...
	public PutFlowInstancesSettingsLoglevelsRequest withExpand(List<String> expand) {
    ...
    public PutFlowInstancesSettingsLoglevelsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<FlowLogLevelRequest> withHttpInfo() {
        ...
        if (this.flowId == null) {
            throw new IllegalStateException("Missing the required parameter 'flowId' when building request for PutFlowInstancesSettingsLoglevelsRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutFlowInstancesSettingsLoglevelsRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/flows/{flowId}/instances/settings/loglevels")
	...
	public static class Builder {
		private final PutFlowInstancesSettingsLoglevelsRequest request;

		private Builder() {
			request = new PutFlowInstancesSettingsLoglevelsRequest();
		}
		...
		public PutFlowInstancesSettingsLoglevelsRequest build() {
