...
public class PostOutboundContactlisttemplatesBulkAddRequest {

	private List<ContactListTemplate> body;
	public List<ContactListTemplate> getBody() {
		return this.body;
	}

	public void setBody(List<ContactListTemplate> body) {
		this.body = body;
	}

	public PostOutboundContactlisttemplatesBulkAddRequest withBody(List<ContactListTemplate> body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostOutboundContactlisttemplatesBulkAddRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<List<ContactListTemplate>> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostOutboundContactlisttemplatesBulkAddRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/outbound/contactlisttemplates/bulk/add")
                .withBody(body)
	...
	public static Builder builder(List<ContactListTemplate> body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostOutboundContactlisttemplatesBulkAddRequest request;

		private Builder() {
			request = new PostOutboundContactlisttemplatesBulkAddRequest();
		}


		public Builder withBody(List<ContactListTemplate> body) {
		...
		public Builder withRequiredParams(List<ContactListTemplate> body) {
			request.setBody(body);
		...
		public PostOutboundContactlisttemplatesBulkAddRequest build() {
