...
public class GetArchitectSchedulegroupsRequest {
	...
	public GetArchitectSchedulegroupsRequest withPageNumber(Integer pageNumber) {
	...
	public GetArchitectSchedulegroupsRequest withPageSize(Integer pageSize) {
	...
	public GetArchitectSchedulegroupsRequest withSortBy(String sortBy) {
	...
	public GetArchitectSchedulegroupsRequest withSortOrder(String sortOrder) {
	...
	public GetArchitectSchedulegroupsRequest withDivisionId(List<String> divisionId) {
    ...
    public GetArchitectSchedulegroupsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/architect/schedulegroups")
	...
	public static class Builder {
		private final GetArchitectSchedulegroupsRequest request;

		private Builder() {
			request = new GetArchitectSchedulegroupsRequest();
		}
		...
		public GetArchitectSchedulegroupsRequest build() {
