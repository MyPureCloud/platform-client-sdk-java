...
public class GetJourneyActionmapRequest {
	...
	public GetJourneyActionmapRequest withActionMapId(String actionMapId) {
    ...
    public GetJourneyActionmapRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.actionMapId == null) {
            throw new IllegalStateException("Missing the required parameter 'actionMapId' when building request for GetJourneyActionmapRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/journey/actionmaps/{actionMapId}")
	...
	public static class Builder {
		private final GetJourneyActionmapRequest request;

		private Builder() {
			request = new GetJourneyActionmapRequest();
		}
		...
		public GetJourneyActionmapRequest build() {
