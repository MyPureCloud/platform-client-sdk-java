...
public class CampaignSchedule  implements Serializable {
  ...
  private DivisionedDomainEntityRef campaign = null;
  ...
  public CampaignSchedule(Boolean initWithEmptyList) {
   ...
   **/
  public CampaignSchedule recurrences(List<Reoccurrence> recurrences) {
  ...
  @ApiModelProperty(example = "null", value = "The time zone for this CampaignSchedule. Defaults to UTC if empty or not provided. See here for a list of valid time zones https://www.iana.org/time-zones. Time zones are represented as a string of the zone name as found in the IANA time zone database. For example: UTC, Etc/UTC, or Europe/London")
   ...
   **/
  public CampaignSchedule campaign(DivisionedDomainEntityRef campaign) {
  ...
  public DivisionedDomainEntityRef getCampaign() {
    return campaign;
  }
  public void setCampaign(DivisionedDomainEntityRef campaign) {
    this.campaign = campaign;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, campaignSchedule.id) &&
            ...
            Objects.equals(this.recurrences, campaignSchedule.recurrences) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, dateCreated, dateModified, version, intervals, recurrences, timeZone, campaign, selfUri);
  }
