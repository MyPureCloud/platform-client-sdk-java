...
public class DeleteOutboundDnclistEmailaddressesRequest {
	...
	public DeleteOutboundDnclistEmailaddressesRequest withDncListId(String dncListId) {
	...
	public DeleteOutboundDnclistEmailaddressesRequest withExpiredOnly(Boolean expiredOnly) {
    ...
    public DeleteOutboundDnclistEmailaddressesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.dncListId == null) {
            throw new IllegalStateException("Missing the required parameter 'dncListId' when building request for DeleteOutboundDnclistEmailaddressesRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/outbound/dnclists/{dncListId}/emailaddresses")
	...
	public static class Builder {
		private final DeleteOutboundDnclistEmailaddressesRequest request;

		private Builder() {
			request = new DeleteOutboundDnclistEmailaddressesRequest();
		}
		...
		public DeleteOutboundDnclistEmailaddressesRequest build() {
