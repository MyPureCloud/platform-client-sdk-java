...
public class OrphanRecordingListing  implements Serializable, PagedResource<OrphanRecording> {
  ...
  public OrphanRecordingListing() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
      entities = new ArrayList<OrphanRecording>();
    }
  }

  public OrphanRecordingListing(Boolean initWithEmptyList) {
  ...
  /**
   **/
  public OrphanRecordingListing entities(List<OrphanRecording> entities) {
