...
public class GetWorkforcemanagementBusinessunitOpportunityRequest {
	...
	public GetWorkforcemanagementBusinessunitOpportunityRequest withBusinessUnitId(String businessUnitId) {
	...
	public GetWorkforcemanagementBusinessunitOpportunityRequest withOpportunityId(String opportunityId) {
	...
	public GetWorkforcemanagementBusinessunitOpportunityRequest withExpand(String expand) {
    ...
    public GetWorkforcemanagementBusinessunitOpportunityRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for GetWorkforcemanagementBusinessunitOpportunityRequest.");
        }
        
        // verify the required parameter 'opportunityId' is set
        if (this.opportunityId == null) {
            throw new IllegalStateException("Missing the required parameter 'opportunityId' when building request for GetWorkforcemanagementBusinessunitOpportunityRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/opportunities/{opportunityId}")
	...
	public static Builder builder(String businessUnitId, String opportunityId) {
	    return new Builder()
	            .withRequiredParams(businessUnitId, opportunityId);
	}


	public static class Builder {
		private final GetWorkforcemanagementBusinessunitOpportunityRequest request;

		private Builder() {
			request = new GetWorkforcemanagementBusinessunitOpportunityRequest();
		}
		...
		public Builder withRequiredParams(String businessUnitId, String opportunityId) {
			request.setBusinessUnitId(businessUnitId);
			request.setOpportunityId(opportunityId);
		...
		public GetWorkforcemanagementBusinessunitOpportunityRequest build() {
