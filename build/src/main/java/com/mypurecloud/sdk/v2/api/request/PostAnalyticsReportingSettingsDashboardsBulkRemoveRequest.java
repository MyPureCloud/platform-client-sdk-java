...
public class PostAnalyticsReportingSettingsDashboardsBulkRemoveRequest {

	private DashboardConfigurationBulkRequest body;
	public DashboardConfigurationBulkRequest getBody() {
		return this.body;
	}

	public void setBody(DashboardConfigurationBulkRequest body) {
		this.body = body;
	}

	public PostAnalyticsReportingSettingsDashboardsBulkRemoveRequest withBody(DashboardConfigurationBulkRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostAnalyticsReportingSettingsDashboardsBulkRemoveRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<DashboardConfigurationBulkRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostAnalyticsReportingSettingsDashboardsBulkRemoveRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/analytics/reporting/settings/dashboards/bulk/remove")
                .withBody(body)
	...
	public static Builder builder(DashboardConfigurationBulkRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostAnalyticsReportingSettingsDashboardsBulkRemoveRequest request;

		private Builder() {
			request = new PostAnalyticsReportingSettingsDashboardsBulkRemoveRequest();
		}


		public Builder withBody(DashboardConfigurationBulkRequest body) {
		...
		public Builder withRequiredParams(DashboardConfigurationBulkRequest body) {
			request.setBody(body);
		...
		public PostAnalyticsReportingSettingsDashboardsBulkRemoveRequest build() {
