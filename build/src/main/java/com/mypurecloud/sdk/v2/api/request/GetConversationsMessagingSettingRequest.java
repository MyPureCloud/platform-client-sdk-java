...
public class GetConversationsMessagingSettingRequest {
	...
	public GetConversationsMessagingSettingRequest withMessageSettingId(String messageSettingId) {
    ...
    public GetConversationsMessagingSettingRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.messageSettingId == null) {
            throw new IllegalStateException("Missing the required parameter 'messageSettingId' when building request for GetConversationsMessagingSettingRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/conversations/messaging/settings/{messageSettingId}")
	...
	public static class Builder {
		private final GetConversationsMessagingSettingRequest request;

		private Builder() {
			request = new GetConversationsMessagingSettingRequest();
		}
		...
		public GetConversationsMessagingSettingRequest build() {
