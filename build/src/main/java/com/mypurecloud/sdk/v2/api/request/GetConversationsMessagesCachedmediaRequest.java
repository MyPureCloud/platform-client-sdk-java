...
public class GetConversationsMessagesCachedmediaRequest {
	...
	public GetConversationsMessagesCachedmediaRequest withPageSize(Integer pageSize) {
	...
	public GetConversationsMessagesCachedmediaRequest withPageNumber(Integer pageNumber) {
	...
	public GetConversationsMessagesCachedmediaRequest withUrl(String url) {
	    this.setUrl(url);
	    return this;
	} 
    ...
    public GetConversationsMessagesCachedmediaRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/conversations/messages/cachedmedia")
	...
	public static class Builder {
		private final GetConversationsMessagesCachedmediaRequest request;

		private Builder() {
			request = new GetConversationsMessagesCachedmediaRequest();
		}
		...
		public GetConversationsMessagesCachedmediaRequest build() {
