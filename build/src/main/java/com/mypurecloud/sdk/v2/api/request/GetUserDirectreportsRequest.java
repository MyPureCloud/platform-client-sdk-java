...
public class GetUserDirectreportsRequest {
	...
	public GetUserDirectreportsRequest withUserId(String userId) {
	...
	public GetUserDirectreportsRequest withExpand(List<String> expand) {
    ...
    public GetUserDirectreportsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.userId == null) {
            throw new IllegalStateException("Missing the required parameter 'userId' when building request for GetUserDirectreportsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/users/{userId}/directreports")
	...
	public static class Builder {
		private final GetUserDirectreportsRequest request;

		private Builder() {
			request = new GetUserDirectreportsRequest();
		}
		...
		public GetUserDirectreportsRequest build() {
