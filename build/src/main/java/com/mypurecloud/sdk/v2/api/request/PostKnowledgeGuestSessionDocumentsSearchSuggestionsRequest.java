...
public class PostKnowledgeGuestSessionDocumentsSearchSuggestionsRequest {
	...
	public PostKnowledgeGuestSessionDocumentsSearchSuggestionsRequest withSessionId(String sessionId) {
    ...
    public ApiRequest<KnowledgeGuestDocumentSuggestionRequest> withHttpInfo() {
        ...
        if (this.sessionId == null) {
            throw new IllegalStateException("Missing the required parameter 'sessionId' when building request for PostKnowledgeGuestSessionDocumentsSearchSuggestionsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/knowledge/guest/sessions/{sessionId}/documents/search/suggestions")
	...
	public static class Builder {
		private final PostKnowledgeGuestSessionDocumentsSearchSuggestionsRequest request;

		private Builder() {
			request = new PostKnowledgeGuestSessionDocumentsSearchSuggestionsRequest();
		}
		...
		public PostKnowledgeGuestSessionDocumentsSearchSuggestionsRequest build() {
