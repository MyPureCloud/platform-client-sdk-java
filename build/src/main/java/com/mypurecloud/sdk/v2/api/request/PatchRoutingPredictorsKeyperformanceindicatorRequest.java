...
public class PatchRoutingPredictorsKeyperformanceindicatorRequest {
	...
	public PatchRoutingPredictorsKeyperformanceindicatorRequest withKpiId(String kpiId) {
	    this.setKpiId(kpiId);
	    return this;
	} 

	private UpdateKpiRequest body;
	public UpdateKpiRequest getBody() {
		return this.body;
	}

	public void setBody(UpdateKpiRequest body) {
		this.body = body;
	}

	public PatchRoutingPredictorsKeyperformanceindicatorRequest withBody(UpdateKpiRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchRoutingPredictorsKeyperformanceindicatorRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<UpdateKpiRequest> withHttpInfo() {
        
        // verify the required parameter 'kpiId' is set
        if (this.kpiId == null) {
            throw new IllegalStateException("Missing the required parameter 'kpiId' when building request for PatchRoutingPredictorsKeyperformanceindicatorRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/routing/predictors/keyperformanceindicators/{kpiId}")
                .withPathParameter("kpiId", kpiId)
	...
	public static Builder builder(String kpiId) {
	    return new Builder()
	            .withRequiredParams(kpiId);
	}


	public static class Builder {
		private final PatchRoutingPredictorsKeyperformanceindicatorRequest request;

		private Builder() {
			request = new PatchRoutingPredictorsKeyperformanceindicatorRequest();
		}
		...
		public Builder withBody(UpdateKpiRequest body) {
		...
		public Builder withRequiredParams(String kpiId) {
			request.setKpiId(kpiId);
		...
		public PatchRoutingPredictorsKeyperformanceindicatorRequest build() {
