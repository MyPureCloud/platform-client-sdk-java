...
public class GetConversationsVideosMeetingRequest {
	...
	public GetConversationsVideosMeetingRequest withMeetingId(String meetingId) {
    ...
    public GetConversationsVideosMeetingRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.meetingId == null) {
            throw new IllegalStateException("Missing the required parameter 'meetingId' when building request for GetConversationsVideosMeetingRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/conversations/videos/meetings/{meetingId}")
                .withPathParameter("meetingId", meetingId)
	...
	public static Builder builder(String meetingId) {
	    return new Builder()
	            .withRequiredParams(meetingId);
	}


	public static class Builder {
		private final GetConversationsVideosMeetingRequest request;

		private Builder() {
			request = new GetConversationsVideosMeetingRequest();
		}
		...
		public Builder withRequiredParams(String meetingId) {
			request.setMeetingId(meetingId);
		...
		public GetConversationsVideosMeetingRequest build() {
