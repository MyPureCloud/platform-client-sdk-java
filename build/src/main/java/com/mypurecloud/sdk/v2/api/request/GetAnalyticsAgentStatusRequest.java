...
public class GetAnalyticsAgentStatusRequest {
	...
	public GetAnalyticsAgentStatusRequest withUserId(String userId) {
    ...
    public GetAnalyticsAgentStatusRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.userId == null) {
            throw new IllegalStateException("Missing the required parameter 'userId' when building request for GetAnalyticsAgentStatusRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/analytics/agents/{userId}/status")
	...
	public static class Builder {
		private final GetAnalyticsAgentStatusRequest request;

		private Builder() {
			request = new GetAnalyticsAgentStatusRequest();
		}
		...
		public GetAnalyticsAgentStatusRequest build() {
