...
public class DeleteOrgauthorizationTrustorUserRequest {
	...
	public DeleteOrgauthorizationTrustorUserRequest withTrustorOrgId(String trustorOrgId) {
	...
	public DeleteOrgauthorizationTrustorUserRequest withTrusteeUserId(String trusteeUserId) {
    ...
    public DeleteOrgauthorizationTrustorUserRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.trustorOrgId == null) {
            throw new IllegalStateException("Missing the required parameter 'trustorOrgId' when building request for DeleteOrgauthorizationTrustorUserRequest.");
        }
        
        // verify the required parameter 'trusteeUserId' is set
        if (this.trusteeUserId == null) {
            throw new IllegalStateException("Missing the required parameter 'trusteeUserId' when building request for DeleteOrgauthorizationTrustorUserRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/orgauthorization/trustors/{trustorOrgId}/users/{trusteeUserId}")
	...
	public static class Builder {
		private final DeleteOrgauthorizationTrustorUserRequest request;

		private Builder() {
			request = new DeleteOrgauthorizationTrustorUserRequest();
		}
		...
		public DeleteOrgauthorizationTrustorUserRequest build() {
