...
public class PatchRoutingSkillRequest {
	...
	public PatchRoutingSkillRequest withSkillId(String skillId) {
	    this.setSkillId(skillId);
	    return this;
	} 

	private UpdateSkillDivisionRequest body;
	public UpdateSkillDivisionRequest getBody() {
		return this.body;
	}

	public void setBody(UpdateSkillDivisionRequest body) {
		this.body = body;
	}

	public PatchRoutingSkillRequest withBody(UpdateSkillDivisionRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchRoutingSkillRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<UpdateSkillDivisionRequest> withHttpInfo() {
        
        // verify the required parameter 'skillId' is set
        if (this.skillId == null) {
            throw new IllegalStateException("Missing the required parameter 'skillId' when building request for PatchRoutingSkillRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchRoutingSkillRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/routing/skills/{skillId}")
	...
	public static Builder builder(String skillId, UpdateSkillDivisionRequest body) {
	    return new Builder()
	            .withRequiredParams(skillId, body);
	}


	public static class Builder {
		private final PatchRoutingSkillRequest request;

		private Builder() {
			request = new PatchRoutingSkillRequest();
		}
		...
		public Builder withBody(UpdateSkillDivisionRequest body) {
		...
		public Builder withRequiredParams(String skillId, UpdateSkillDivisionRequest body) {
			request.setSkillId(skillId);
			request.setBody(body);
		...
		public PatchRoutingSkillRequest build() {
