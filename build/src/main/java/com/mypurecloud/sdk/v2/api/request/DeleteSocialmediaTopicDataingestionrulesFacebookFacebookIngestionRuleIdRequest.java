...
public class DeleteSocialmediaTopicDataingestionrulesFacebookFacebookIngestionRuleIdRequest {
	...
	public DeleteSocialmediaTopicDataingestionrulesFacebookFacebookIngestionRuleIdRequest withTopicId(String topicId) {
	...
	public DeleteSocialmediaTopicDataingestionrulesFacebookFacebookIngestionRuleIdRequest withFacebookIngestionRuleId(String facebookIngestionRuleId) {
	...
	public DeleteSocialmediaTopicDataingestionrulesFacebookFacebookIngestionRuleIdRequest withHardDelete(Boolean hardDelete) {
    ...
    public DeleteSocialmediaTopicDataingestionrulesFacebookFacebookIngestionRuleIdRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.topicId == null) {
            throw new IllegalStateException("Missing the required parameter 'topicId' when building request for DeleteSocialmediaTopicDataingestionrulesFacebookFacebookIngestionRuleIdRequest.");
        }
        
        // verify the required parameter 'facebookIngestionRuleId' is set
        if (this.facebookIngestionRuleId == null) {
            throw new IllegalStateException("Missing the required parameter 'facebookIngestionRuleId' when building request for DeleteSocialmediaTopicDataingestionrulesFacebookFacebookIngestionRuleIdRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/socialmedia/topics/{topicId}/dataingestionrules/facebook/{facebookIngestionRuleId}")
	...
	public static class Builder {
		private final DeleteSocialmediaTopicDataingestionrulesFacebookFacebookIngestionRuleIdRequest request;

		private Builder() {
			request = new DeleteSocialmediaTopicDataingestionrulesFacebookFacebookIngestionRuleIdRequest();
		}
		...
		public DeleteSocialmediaTopicDataingestionrulesFacebookFacebookIngestionRuleIdRequest build() {
