...
public class PostIntegrationsBotconnectorsOutgoingMessagesRequest {

	private OutgoingMessageRequest body;
	public OutgoingMessageRequest getBody() {
		return this.body;
	}

	public void setBody(OutgoingMessageRequest body) {
		this.body = body;
	}

	public PostIntegrationsBotconnectorsOutgoingMessagesRequest withBody(OutgoingMessageRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostIntegrationsBotconnectorsOutgoingMessagesRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<OutgoingMessageRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostIntegrationsBotconnectorsOutgoingMessagesRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/integrations/botconnectors/outgoing/messages")
                .withBody(body)
	...
	public static Builder builder(OutgoingMessageRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostIntegrationsBotconnectorsOutgoingMessagesRequest request;

		private Builder() {
			request = new PostIntegrationsBotconnectorsOutgoingMessagesRequest();
		}


		public Builder withBody(OutgoingMessageRequest body) {
		...
		public Builder withRequiredParams(OutgoingMessageRequest body) {
			request.setBody(body);
		...
		public PostIntegrationsBotconnectorsOutgoingMessagesRequest build() {
