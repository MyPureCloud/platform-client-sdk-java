...
public class V2ConversationMessageTypingEventForUserTopicConversationNotificationTemplateHeader  implements Serializable {
 ...
 @JsonDeserialize(using = TypeEnumDeserializer.class)
  ...
  /**
   **/
  public V2ConversationMessageTypingEventForUserTopicConversationNotificationTemplateHeader type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  @ApiModelProperty(example = "null", value = "")
  @JsonProperty("media")
  public V2ConversationMessageTypingEventForUserTopicConversationContentAttachment getMedia() {
    return media;
  }
  public void setMedia(V2ConversationMessageTypingEventForUserTopicConversationContentAttachment media) {
    this.media = media;
  }
