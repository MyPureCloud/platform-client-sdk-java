...
public class GetOutboundSettingsRequest {
    ...
    public GetOutboundSettingsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/outbound/settings")
	...
	public static class Builder {
		private final GetOutboundSettingsRequest request;

		private Builder() {
			request = new GetOutboundSettingsRequest();
		}
		...
		public GetOutboundSettingsRequest build() {
