...
public class GetConversationRequest {
	...
	public GetConversationRequest withConversationId(String conversationId) {
    ...
    public GetConversationRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for GetConversationRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/conversations/{conversationId}")
	...
	public static class Builder {
		private final GetConversationRequest request;
