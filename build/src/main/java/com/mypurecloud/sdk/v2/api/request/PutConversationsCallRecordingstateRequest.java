...
public class PutConversationsCallRecordingstateRequest {
	...
	public PutConversationsCallRecordingstateRequest withConversationId(String conversationId) {
	...
	public PutConversationsCallRecordingstateRequest withBody(SetRecordingState body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutConversationsCallRecordingstateRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<SetRecordingState> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PutConversationsCallRecordingstateRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutConversationsCallRecordingstateRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/conversations/calls/{conversationId}/recordingstate")
	...
	public static class Builder {
		private final PutConversationsCallRecordingstateRequest request;

		private Builder() {
			request = new PutConversationsCallRecordingstateRequest();
		}
		...
		public PutConversationsCallRecordingstateRequest build() {
