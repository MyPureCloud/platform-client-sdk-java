...
public class GetGamificationTemplatesRequest {
    ...
    public GetGamificationTemplatesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/gamification/templates")
	...
	public static class Builder {
		private final GetGamificationTemplatesRequest request;

		private Builder() {
			request = new GetGamificationTemplatesRequest();
		}
		...
		public GetGamificationTemplatesRequest build() {
