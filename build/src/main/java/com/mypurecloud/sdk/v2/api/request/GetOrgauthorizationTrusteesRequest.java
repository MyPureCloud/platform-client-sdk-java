...
public class GetOrgauthorizationTrusteesRequest {
	...
	public GetOrgauthorizationTrusteesRequest withPageSize(Integer pageSize) {
	...
	public GetOrgauthorizationTrusteesRequest withPageNumber(Integer pageNumber) {
    ...
    public GetOrgauthorizationTrusteesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/orgauthorization/trustees")
	...
	public static class Builder {
		private final GetOrgauthorizationTrusteesRequest request;

		private Builder() {
			request = new GetOrgauthorizationTrusteesRequest();
		}
		...
		public GetOrgauthorizationTrusteesRequest build() {
