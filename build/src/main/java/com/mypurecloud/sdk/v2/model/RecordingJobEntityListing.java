...
public class RecordingJobEntityListing  implements Serializable, PagedResource<RecordingJob> {
  
  private List<RecordingJob> entities = null;
  ...
  public RecordingJobEntityListing() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
      entities = new ArrayList<RecordingJob>();
    }
  }

  public RecordingJobEntityListing(Boolean initWithEmptyList) {
  ...
  /**
   **/
  public RecordingJobEntityListing entities(List<RecordingJob> entities) {
  ...
  public List<RecordingJob> getEntities() {
    return entities;
  }
  public void setEntities(List<RecordingJob> entities) {
    this.entities = entities;
  }
