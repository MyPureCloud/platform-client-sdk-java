...
public class PostFlowsDatatableImportCsvJobsRequest {
	...
	public PostFlowsDatatableImportCsvJobsRequest withDatatableId(String datatableId) {
	...
	public PostFlowsDatatableImportCsvJobsRequest withBody(DataTableImportJob body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostFlowsDatatableImportCsvJobsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<DataTableImportJob> withHttpInfo() {
        ...
        if (this.datatableId == null) {
            throw new IllegalStateException("Missing the required parameter 'datatableId' when building request for PostFlowsDatatableImportCsvJobsRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostFlowsDatatableImportCsvJobsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/flows/datatables/{datatableId}/import/csv/jobs")
	...
	public static class Builder {
		private final PostFlowsDatatableImportCsvJobsRequest request;

		private Builder() {
			request = new PostFlowsDatatableImportCsvJobsRequest();
		}
		...
		public PostFlowsDatatableImportCsvJobsRequest build() {
