...
public class PostConversationsMessageInboundOpenStructuredResponseRequest {
	...
	public PostConversationsMessageInboundOpenStructuredResponseRequest withIntegrationId(String integrationId) {
	    this.setIntegrationId(integrationId);
	    return this;
	} 

	private OpenInboundStructuredResponseMessage body;
	public OpenInboundStructuredResponseMessage getBody() {
		return this.body;
	}

	public void setBody(OpenInboundStructuredResponseMessage body) {
		this.body = body;
	}

	public PostConversationsMessageInboundOpenStructuredResponseRequest withBody(OpenInboundStructuredResponseMessage body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostConversationsMessageInboundOpenStructuredResponseRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<OpenInboundStructuredResponseMessage> withHttpInfo() {
        
        // verify the required parameter 'integrationId' is set
        if (this.integrationId == null) {
            throw new IllegalStateException("Missing the required parameter 'integrationId' when building request for PostConversationsMessageInboundOpenStructuredResponseRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostConversationsMessageInboundOpenStructuredResponseRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/conversations/messages/{integrationId}/inbound/open/structured/response")
	...
	public static Builder builder(String integrationId, OpenInboundStructuredResponseMessage body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostConversationsMessageInboundOpenStructuredResponseRequest request;

		private Builder() {
			request = new PostConversationsMessageInboundOpenStructuredResponseRequest();
		}
		...
		public Builder withBody(OpenInboundStructuredResponseMessage body) {
		...
		public Builder withRequiredParams(String integrationId, OpenInboundStructuredResponseMessage body) {
			request.setIntegrationId(integrationId);
			request.setBody(body);
		...
		public PostConversationsMessageInboundOpenStructuredResponseRequest build() {
