...
public class SurveyAggregationSort  implements Serializable {
 ...
 @JsonDeserialize(using = FunctionEnumDeserializer.class)
   ...
   * Name of the metric used for sorting values.
   **/
  public SurveyAggregationSort name(NameEnum name) {
    this.name = name;
    return this;
  }
   ...
   * Aggregation function used for the sort metric.
   **/
  public SurveyAggregationSort function(FunctionEnum function) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SurveyAggregationSort surveyAggregationSort = (SurveyAggregationSort) o;

    return Objects.equals(this.name, surveyAggregationSort.name) &&
            Objects.equals(this.function, surveyAggregationSort.function);
  }
