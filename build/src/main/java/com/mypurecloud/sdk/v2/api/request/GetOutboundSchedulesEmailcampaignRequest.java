...
public class GetOutboundSchedulesEmailcampaignRequest {
	...
	public GetOutboundSchedulesEmailcampaignRequest withEmailCampaignId(String emailCampaignId) {
    ...
    public GetOutboundSchedulesEmailcampaignRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.emailCampaignId == null) {
            throw new IllegalStateException("Missing the required parameter 'emailCampaignId' when building request for GetOutboundSchedulesEmailcampaignRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/outbound/schedules/emailcampaigns/{emailCampaignId}")
	...
	public static class Builder {
		private final GetOutboundSchedulesEmailcampaignRequest request;

		private Builder() {
			request = new GetOutboundSchedulesEmailcampaignRequest();
		}
		...
		public GetOutboundSchedulesEmailcampaignRequest build() {
