...
public class EvaluationAggregationQueryMe  implements Serializable {
 ...
 @JsonDeserialize(using = AlternateTimeDimensionEnumDeserializer.class)
  ...
  public EvaluationAggregationQueryMe(Boolean initWithEmptyList) {
   ...
   **/
  public EvaluationAggregationQueryMe interval(String interval) {
   ...
   **/
  public EvaluationAggregationQueryMe timeZone(String timeZone) {
   ...
   **/
  public EvaluationAggregationQueryMe groupBy(List<GroupByEnum> groupBy) {
   ...
   **/
  public EvaluationAggregationQueryMe metrics(List<MetricsEnum> metrics) {
   ...
   * Dimension to use as the alternative timestamp for data in the aggregate.  Choosing \"eventTime\" uses the actual time of the data event.
   **/
  public EvaluationAggregationQueryMe alternateTimeDimension(AlternateTimeDimensionEnum alternateTimeDimension) {
   ...
   **/
  public EvaluationAggregationQueryMe contextId(String contextId) {
    this.contextId = contextId;
    return this;
  }
  
  @ApiModelProperty(example = "null", value = "Evaluation context Id")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(interval, timeZone, groupBy, metrics, alternateTimeDimension, contextId);
  }
