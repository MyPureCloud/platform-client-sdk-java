...
public class ConversationEventTopicCallback  implements Serializable {
 ...
 @JsonDeserialize(using = DisconnectTypeEnumDeserializer.class)
  ...
  public ConversationEventTopicCallback() {
  ...
  /**
   **/
  public ConversationEventTopicCallback initialState(InitialStateEnum initialState) {
   ...
   **/
  public ConversationEventTopicCallback timeoutSeconds(Long timeoutSeconds) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.state, conversationEventTopicCallback.state) &&
            Objects.equals(this.initialState, conversationEventTopicCallback.initialState) &&
