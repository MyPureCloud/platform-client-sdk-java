...
public class QueueConversationMessageEventTopicMessageMetadataContent  implements Serializable {
  ...
  public QueueConversationMessageEventTopicMessageMetadataContent() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
    }
  }

  public QueueConversationMessageEventTopicMessageMetadataContent(Boolean initWithEmptyList) {
