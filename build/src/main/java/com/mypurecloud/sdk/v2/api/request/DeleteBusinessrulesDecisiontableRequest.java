...
public class DeleteBusinessrulesDecisiontableRequest {
	...
	public DeleteBusinessrulesDecisiontableRequest withTableId(String tableId) {
	...
	public DeleteBusinessrulesDecisiontableRequest withForceDelete(Boolean forceDelete) {
    ...
    public DeleteBusinessrulesDecisiontableRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.tableId == null) {
            throw new IllegalStateException("Missing the required parameter 'tableId' when building request for DeleteBusinessrulesDecisiontableRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/businessrules/decisiontables/{tableId}")
	...
	public static class Builder {
		private final DeleteBusinessrulesDecisiontableRequest request;

		private Builder() {
			request = new DeleteBusinessrulesDecisiontableRequest();
		}
		...
		public DeleteBusinessrulesDecisiontableRequest build() {
