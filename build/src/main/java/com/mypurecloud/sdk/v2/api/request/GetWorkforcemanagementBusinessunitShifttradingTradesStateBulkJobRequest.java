...
public class GetWorkforcemanagementBusinessunitShifttradingTradesStateBulkJobRequest {
	...
	public GetWorkforcemanagementBusinessunitShifttradingTradesStateBulkJobRequest withBusinessUnitId(String businessUnitId) {
	...
	public GetWorkforcemanagementBusinessunitShifttradingTradesStateBulkJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetWorkforcemanagementBusinessunitShifttradingTradesStateBulkJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for GetWorkforcemanagementBusinessunitShifttradingTradesStateBulkJobRequest.");
        }
        
        // verify the required parameter 'jobId' is set
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetWorkforcemanagementBusinessunitShifttradingTradesStateBulkJobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/shifttrading/trades/state/bulk/jobs/{jobId}")
	...
	public static class Builder {
		private final GetWorkforcemanagementBusinessunitShifttradingTradesStateBulkJobRequest request;

		private Builder() {
			request = new GetWorkforcemanagementBusinessunitShifttradingTradesStateBulkJobRequest();
		}
		...
		public GetWorkforcemanagementBusinessunitShifttradingTradesStateBulkJobRequest build() {
