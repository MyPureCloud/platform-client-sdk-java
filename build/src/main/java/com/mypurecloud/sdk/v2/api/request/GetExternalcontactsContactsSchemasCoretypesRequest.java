...
public class GetExternalcontactsContactsSchemasCoretypesRequest {
    ...
    public GetExternalcontactsContactsSchemasCoretypesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/externalcontacts/contacts/schemas/coretypes")
	...
	public static class Builder {
		private final GetExternalcontactsContactsSchemasCoretypesRequest request;

		private Builder() {
			request = new GetExternalcontactsContactsSchemasCoretypesRequest();
		}
		...
		public GetExternalcontactsContactsSchemasCoretypesRequest build() {
