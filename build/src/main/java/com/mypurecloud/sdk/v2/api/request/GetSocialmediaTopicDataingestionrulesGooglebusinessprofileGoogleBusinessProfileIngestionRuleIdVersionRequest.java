...
public class GetSocialmediaTopicDataingestionrulesGooglebusinessprofileGoogleBusinessProfileIngestionRuleIdVersionRequest {
	...
	public GetSocialmediaTopicDataingestionrulesGooglebusinessprofileGoogleBusinessProfileIngestionRuleIdVersionRequest withTopicId(String topicId) {
	    this.setTopicId(topicId);
	    return this;
	} 

	private String googleBusinessProfileIngestionRuleId;
	public String getGoogleBusinessProfileIngestionRuleId() {
		return this.googleBusinessProfileIngestionRuleId;
	}

	public void setGoogleBusinessProfileIngestionRuleId(String googleBusinessProfileIngestionRuleId) {
		this.googleBusinessProfileIngestionRuleId = googleBusinessProfileIngestionRuleId;
	}

	public GetSocialmediaTopicDataingestionrulesGooglebusinessprofileGoogleBusinessProfileIngestionRuleIdVersionRequest withGoogleBusinessProfileIngestionRuleId(String googleBusinessProfileIngestionRuleId) {
	    this.setGoogleBusinessProfileIngestionRuleId(googleBusinessProfileIngestionRuleId);
	    return this;
	} 
	...
	public GetSocialmediaTopicDataingestionrulesGooglebusinessprofileGoogleBusinessProfileIngestionRuleIdVersionRequest withDataIngestionRuleVersion(String dataIngestionRuleVersion) {
	...
	public GetSocialmediaTopicDataingestionrulesGooglebusinessprofileGoogleBusinessProfileIngestionRuleIdVersionRequest withIncludeDeleted(Boolean includeDeleted) {
    ...
    public GetSocialmediaTopicDataingestionrulesGooglebusinessprofileGoogleBusinessProfileIngestionRuleIdVersionRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.topicId == null) {
            throw new IllegalStateException("Missing the required parameter 'topicId' when building request for GetSocialmediaTopicDataingestionrulesGooglebusinessprofileGoogleBusinessProfileIngestionRuleIdVersionRequest.");
        }
        
        // verify the required parameter 'googleBusinessProfileIngestionRuleId' is set
        if (this.googleBusinessProfileIngestionRuleId == null) {
            throw new IllegalStateException("Missing the required parameter 'googleBusinessProfileIngestionRuleId' when building request for GetSocialmediaTopicDataingestionrulesGooglebusinessprofileGoogleBusinessProfileIngestionRuleIdVersionRequest.");
        }
        
        // verify the required parameter 'dataIngestionRuleVersion' is set
        if (this.dataIngestionRuleVersion == null) {
            throw new IllegalStateException("Missing the required parameter 'dataIngestionRuleVersion' when building request for GetSocialmediaTopicDataingestionrulesGooglebusinessprofileGoogleBusinessProfileIngestionRuleIdVersionRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/socialmedia/topics/{topicId}/dataingestionrules/googlebusinessprofile/{googleBusinessProfileIngestionRuleId}/versions/{dataIngestionRuleVersion}")
                .withPathParameter("topicId", topicId)
        
                .withPathParameter("googleBusinessProfileIngestionRuleId", googleBusinessProfileIngestionRuleId)
	...
	public static Builder builder(String topicId, String googleBusinessProfileIngestionRuleId, String dataIngestionRuleVersion) {
	    return new Builder()
	            .withRequiredParams(topicId, googleBusinessProfileIngestionRuleId, dataIngestionRuleVersion);
	}


	public static class Builder {
		private final GetSocialmediaTopicDataingestionrulesGooglebusinessprofileGoogleBusinessProfileIngestionRuleIdVersionRequest request;

		private Builder() {
			request = new GetSocialmediaTopicDataingestionrulesGooglebusinessprofileGoogleBusinessProfileIngestionRuleIdVersionRequest();
		}
		...
		public Builder withGoogleBusinessProfileIngestionRuleId(String googleBusinessProfileIngestionRuleId) {
			request.setGoogleBusinessProfileIngestionRuleId(googleBusinessProfileIngestionRuleId);
			return this;
		}
		...
		public Builder withRequiredParams(String topicId, String googleBusinessProfileIngestionRuleId, String dataIngestionRuleVersion) {
			request.setTopicId(topicId);
			request.setGoogleBusinessProfileIngestionRuleId(googleBusinessProfileIngestionRuleId);
			request.setDataIngestionRuleVersion(dataIngestionRuleVersion);
		...
		public GetSocialmediaTopicDataingestionrulesGooglebusinessprofileGoogleBusinessProfileIngestionRuleIdVersionRequest build() {
            ...
            // verify the required parameter 'googleBusinessProfileIngestionRuleId' is set
            if (request.googleBusinessProfileIngestionRuleId == null) {
                throw new IllegalStateException("Missing the required parameter 'googleBusinessProfileIngestionRuleId' when building request for GetSocialmediaTopicDataingestionrulesGooglebusinessprofileGoogleBusinessProfileIngestionRuleIdVersionRequest.");
            }
