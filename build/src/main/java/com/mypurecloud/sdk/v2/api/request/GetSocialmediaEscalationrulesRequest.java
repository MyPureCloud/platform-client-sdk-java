...
public class GetSocialmediaEscalationrulesRequest {
	...
	public GetSocialmediaEscalationrulesRequest withDivisionId(String divisionId) {
	...
	public GetSocialmediaEscalationrulesRequest withPageNumber(Integer pageNumber) {
	...
	public GetSocialmediaEscalationrulesRequest withPageSize(Integer pageSize) {
    ...
    public GetSocialmediaEscalationrulesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.divisionId == null) {
            throw new IllegalStateException("Missing the required parameter 'divisionId' when building request for GetSocialmediaEscalationrulesRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/socialmedia/escalationrules")
	...
	public static class Builder {
		private final GetSocialmediaEscalationrulesRequest request;

		private Builder() {
			request = new GetSocialmediaEscalationrulesRequest();
		}
		...
		public GetSocialmediaEscalationrulesRequest build() {
