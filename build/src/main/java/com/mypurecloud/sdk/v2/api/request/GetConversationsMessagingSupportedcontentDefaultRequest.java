...
public class GetConversationsMessagingSupportedcontentDefaultRequest {
    ...
    public GetConversationsMessagingSupportedcontentDefaultRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/conversations/messaging/supportedcontent/default")
	...
	public static class Builder {
		private final GetConversationsMessagingSupportedcontentDefaultRequest request;

		private Builder() {
			request = new GetConversationsMessagingSupportedcontentDefaultRequest();
		}
		...
		public GetConversationsMessagingSupportedcontentDefaultRequest build() {
