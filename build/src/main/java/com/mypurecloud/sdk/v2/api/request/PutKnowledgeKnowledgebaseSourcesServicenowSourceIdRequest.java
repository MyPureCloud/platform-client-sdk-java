...
public class PutKnowledgeKnowledgebaseSourcesServicenowSourceIdRequest {
	...
	public PutKnowledgeKnowledgebaseSourcesServicenowSourceIdRequest withKnowledgeBaseId(String knowledgeBaseId) {
	...
	public PutKnowledgeKnowledgebaseSourcesServicenowSourceIdRequest withSourceId(String sourceId) {
	    this.setSourceId(sourceId);
	    return this;
	} 

	private ServiceNowSourceRequest body;
	public ServiceNowSourceRequest getBody() {
		return this.body;
	}

	public void setBody(ServiceNowSourceRequest body) {
		this.body = body;
	}

	public PutKnowledgeKnowledgebaseSourcesServicenowSourceIdRequest withBody(ServiceNowSourceRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutKnowledgeKnowledgebaseSourcesServicenowSourceIdRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<ServiceNowSourceRequest> withHttpInfo() {
        
        // verify the required parameter 'knowledgeBaseId' is set
        if (this.knowledgeBaseId == null) {
            throw new IllegalStateException("Missing the required parameter 'knowledgeBaseId' when building request for PutKnowledgeKnowledgebaseSourcesServicenowSourceIdRequest.");
        }
        
        // verify the required parameter 'sourceId' is set
        if (this.sourceId == null) {
            throw new IllegalStateException("Missing the required parameter 'sourceId' when building request for PutKnowledgeKnowledgebaseSourcesServicenowSourceIdRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutKnowledgeKnowledgebaseSourcesServicenowSourceIdRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/sources/servicenow/{sourceId}")
	...
	public static Builder builder(String knowledgeBaseId, String sourceId, ServiceNowSourceRequest body) {
	    return new Builder()
	            .withRequiredParams(knowledgeBaseId, sourceId, body);
	}


	public static class Builder {
		private final PutKnowledgeKnowledgebaseSourcesServicenowSourceIdRequest request;

		private Builder() {
			request = new PutKnowledgeKnowledgebaseSourcesServicenowSourceIdRequest();
		}
		...
		public Builder withBody(ServiceNowSourceRequest body) {
		...
		public Builder withRequiredParams(String knowledgeBaseId, String sourceId, ServiceNowSourceRequest body) {
			request.setKnowledgeBaseId(knowledgeBaseId);
			request.setSourceId(sourceId);
			request.setBody(body);
		...
		public PutKnowledgeKnowledgebaseSourcesServicenowSourceIdRequest build() {
