...
public class AgentUtilizationAggregationQuery  implements Serializable {
 ...
 @JsonDeserialize(using = AlternateTimeDimensionEnumDeserializer.class)
  ...
  public AgentUtilizationAggregationQuery() {
  ...
  public AgentUtilizationAggregationQuery(Boolean initWithEmptyList) {
   ...
   **/
  public AgentUtilizationAggregationQuery interval(String interval) {
   ...
   **/
  public AgentUtilizationAggregationQuery granularity(String granularity) {
   ...
   **/
  public AgentUtilizationAggregationQuery timeZone(String timeZone) {
   ...
   **/
  public AgentUtilizationAggregationQuery groupBy(List<GroupByEnum> groupBy) {
   ...
   **/
  public AgentUtilizationAggregationQuery filter(AgentUtilizationAggregateQueryFilter filter) {
    this.filter = filter;
    return this;
  }
   ...
   **/
  public AgentUtilizationAggregationQuery metrics(List<MetricsEnum> metrics) {
   ...
   **/
  public AgentUtilizationAggregationQuery flattenMultivaluedDimensions(Boolean flattenMultivaluedDimensions) {
   ...
   **/
  public AgentUtilizationAggregationQuery views(List<AgentUtilizationAggregationView> views) {
    this.views = views;
    return this;
  }
   ...
   * Dimension to use as the alternative timestamp for data in the aggregate.  Choosing \"eventTime\" uses the actual time of the data event.
   **/
  public AgentUtilizationAggregationQuery alternateTimeDimension(AlternateTimeDimensionEnum alternateTimeDimension) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    AgentUtilizationAggregationQuery agentUtilizationAggregationQuery = (AgentUtilizationAggregationQuery) o;

    return Objects.equals(this.interval, agentUtilizationAggregationQuery.interval) &&
            Objects.equals(this.granularity, agentUtilizationAggregationQuery.granularity) &&
            Objects.equals(this.timeZone, agentUtilizationAggregationQuery.timeZone) &&
            Objects.equals(this.groupBy, agentUtilizationAggregationQuery.groupBy) &&
            Objects.equals(this.filter, agentUtilizationAggregationQuery.filter) &&
            Objects.equals(this.metrics, agentUtilizationAggregationQuery.metrics) &&
            Objects.equals(this.flattenMultivaluedDimensions, agentUtilizationAggregationQuery.flattenMultivaluedDimensions) &&
            Objects.equals(this.views, agentUtilizationAggregationQuery.views) &&
            Objects.equals(this.alternateTimeDimension, agentUtilizationAggregationQuery.alternateTimeDimension);
  }
