...
public class GetConversationAssistantCopilotcontextRequest {
	...
	public GetConversationAssistantCopilotcontextRequest withConversationId(String conversationId) {
    ...
    public GetConversationAssistantCopilotcontextRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for GetConversationAssistantCopilotcontextRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/conversations/{conversationId}/assistant/copilotcontext")
	...
	public static class Builder {
		private final GetConversationAssistantCopilotcontextRequest request;

		private Builder() {
			request = new GetConversationAssistantCopilotcontextRequest();
		}
		...
		public GetConversationAssistantCopilotcontextRequest build() {
