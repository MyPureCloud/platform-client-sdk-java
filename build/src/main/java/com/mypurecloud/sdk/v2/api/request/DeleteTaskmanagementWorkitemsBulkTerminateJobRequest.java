...
public class DeleteTaskmanagementWorkitemsBulkTerminateJobRequest {
	...
	public DeleteTaskmanagementWorkitemsBulkTerminateJobRequest withBulkJobId(String bulkJobId) {
    ...
    public DeleteTaskmanagementWorkitemsBulkTerminateJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.bulkJobId == null) {
            throw new IllegalStateException("Missing the required parameter 'bulkJobId' when building request for DeleteTaskmanagementWorkitemsBulkTerminateJobRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/taskmanagement/workitems/bulk/terminate/jobs/{bulkJobId}")
	...
	public static class Builder {
		private final DeleteTaskmanagementWorkitemsBulkTerminateJobRequest request;

		private Builder() {
			request = new DeleteTaskmanagementWorkitemsBulkTerminateJobRequest();
		}
		...
		public DeleteTaskmanagementWorkitemsBulkTerminateJobRequest build() {
