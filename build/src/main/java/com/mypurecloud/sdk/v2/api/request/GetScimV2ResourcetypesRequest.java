...
public class GetScimV2ResourcetypesRequest {
	...
	public GetScimV2ResourcetypesRequest withFilter(String filter) {
    ...
    public GetScimV2ResourcetypesRequest withCustomHeader(String name, String value) {
	...
	public static class Builder {
		private final GetScimV2ResourcetypesRequest request;

		private Builder() {
			request = new GetScimV2ResourcetypesRequest();
		}
		...
		public GetScimV2ResourcetypesRequest build() {
