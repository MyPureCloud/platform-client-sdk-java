...
public class PostAuthorizationPoliciesTargetRequest {
	...
	public PostAuthorizationPoliciesTargetRequest withTargetName(String targetName) {
	...
	public PostAuthorizationPoliciesTargetRequest withBody(AuthorizationPolicy body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostAuthorizationPoliciesTargetRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<AuthorizationPolicy> withHttpInfo() {
        ...
        if (this.targetName == null) {
            throw new IllegalStateException("Missing the required parameter 'targetName' when building request for PostAuthorizationPoliciesTargetRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostAuthorizationPoliciesTargetRequest.");
        }
	...
	public static class Builder {
		private final PostAuthorizationPoliciesTargetRequest request;

		private Builder() {
			request = new PostAuthorizationPoliciesTargetRequest();
		}
		...
		public PostAuthorizationPoliciesTargetRequest build() {
