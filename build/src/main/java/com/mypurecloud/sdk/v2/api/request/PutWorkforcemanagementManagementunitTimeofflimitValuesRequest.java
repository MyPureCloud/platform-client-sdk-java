...
public class PutWorkforcemanagementManagementunitTimeofflimitValuesRequest {
	...
	public PutWorkforcemanagementManagementunitTimeofflimitValuesRequest withManagementUnitId(String managementUnitId) {
	...
	public PutWorkforcemanagementManagementunitTimeofflimitValuesRequest withTimeOffLimitId(String timeOffLimitId) {
	    this.setTimeOffLimitId(timeOffLimitId);
	    return this;
	} 

	private SetTimeOffLimitValuesRequest body;
	public SetTimeOffLimitValuesRequest getBody() {
		return this.body;
	}

	public void setBody(SetTimeOffLimitValuesRequest body) {
		this.body = body;
	}

	public PutWorkforcemanagementManagementunitTimeofflimitValuesRequest withBody(SetTimeOffLimitValuesRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutWorkforcemanagementManagementunitTimeofflimitValuesRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<SetTimeOffLimitValuesRequest> withHttpInfo() {
        
        // verify the required parameter 'managementUnitId' is set
        if (this.managementUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'managementUnitId' when building request for PutWorkforcemanagementManagementunitTimeofflimitValuesRequest.");
        }
        
        // verify the required parameter 'timeOffLimitId' is set
        if (this.timeOffLimitId == null) {
            throw new IllegalStateException("Missing the required parameter 'timeOffLimitId' when building request for PutWorkforcemanagementManagementunitTimeofflimitValuesRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutWorkforcemanagementManagementunitTimeofflimitValuesRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/workforcemanagement/managementunits/{managementUnitId}/timeofflimits/{timeOffLimitId}/values")
	...
	public static Builder builder(String managementUnitId, String timeOffLimitId, SetTimeOffLimitValuesRequest body) {
	    return new Builder()
	            .withRequiredParams(managementUnitId, timeOffLimitId, body);
	}


	public static class Builder {
		private final PutWorkforcemanagementManagementunitTimeofflimitValuesRequest request;

		private Builder() {
			request = new PutWorkforcemanagementManagementunitTimeofflimitValuesRequest();
		}
		...
		public Builder withBody(SetTimeOffLimitValuesRequest body) {
		...
		public Builder withRequiredParams(String managementUnitId, String timeOffLimitId, SetTimeOffLimitValuesRequest body) {
			request.setManagementUnitId(managementUnitId);
			request.setTimeOffLimitId(timeOffLimitId);
			request.setBody(body);
		...
		public PutWorkforcemanagementManagementunitTimeofflimitValuesRequest build() {
