...
public class PostAnalyticsCopilotsAggregatesJobsRequest {

	private CopilotAsyncAggregationQuery body;
	public CopilotAsyncAggregationQuery getBody() {
		return this.body;
	}

	public void setBody(CopilotAsyncAggregationQuery body) {
		this.body = body;
	}

	public PostAnalyticsCopilotsAggregatesJobsRequest withBody(CopilotAsyncAggregationQuery body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostAnalyticsCopilotsAggregatesJobsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<CopilotAsyncAggregationQuery> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostAnalyticsCopilotsAggregatesJobsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/analytics/copilots/aggregates/jobs")
                .withBody(body)
	...
	public static Builder builder(CopilotAsyncAggregationQuery body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostAnalyticsCopilotsAggregatesJobsRequest request;

		private Builder() {
			request = new PostAnalyticsCopilotsAggregatesJobsRequest();
		}


		public Builder withBody(CopilotAsyncAggregationQuery body) {
		...
		public Builder withRequiredParams(CopilotAsyncAggregationQuery body) {
			request.setBody(body);
		...
		public PostAnalyticsCopilotsAggregatesJobsRequest build() {
