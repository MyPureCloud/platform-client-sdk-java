...
public class PostConversationsMessageInboundOpenEventRequest {
    ...
    public ApiRequest<OpenInboundNormalizedEvent> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("POST", "/api/v2/conversations/messages/{integrationId}/inbound/open/event")
	...
	public static class Builder {
		private final PostConversationsMessageInboundOpenEventRequest request;

		private Builder() {
			request = new PostConversationsMessageInboundOpenEventRequest();
		}
