...
public class PostOutboundCampaignsRequest {
	...
	public PostOutboundCampaignsRequest withBody(Campaign body) {
	    this.setBody(body);
	    return this;
	} 
	...
	public PostOutboundCampaignsRequest withUseMaxCallsPerAgentDecimal(Boolean useMaxCallsPerAgentDecimal) {
    ...
    public PostOutboundCampaignsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Campaign> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostOutboundCampaignsRequest.");
        }
