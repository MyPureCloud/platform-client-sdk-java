...
public class PostWorkforcemanagementUsersActivityRequest {

	private UsersActivityRequest body;
	public UsersActivityRequest getBody() {
		return this.body;
	}

	public void setBody(UsersActivityRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementUsersActivityRequest withBody(UsersActivityRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementUsersActivityRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<UsersActivityRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementUsersActivityRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/users/activity")
                .withBody(body)
	...
	public static Builder builder(UsersActivityRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementUsersActivityRequest request;

		private Builder() {
			request = new PostWorkforcemanagementUsersActivityRequest();
		}


		public Builder withBody(UsersActivityRequest body) {
		...
		public Builder withRequiredParams(UsersActivityRequest body) {
			request.setBody(body);
		...
		public PostWorkforcemanagementUsersActivityRequest build() {
