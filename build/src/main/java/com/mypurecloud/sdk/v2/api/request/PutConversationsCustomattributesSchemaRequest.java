...
public class PutConversationsCustomattributesSchemaRequest {
	...
	public PutConversationsCustomattributesSchemaRequest withSchemaId(String schemaId) {
	    this.setSchemaId(schemaId);
	    return this;
	} 

	private ConversationSchemaUpdateRequest body;
	public ConversationSchemaUpdateRequest getBody() {
		return this.body;
	}

	public void setBody(ConversationSchemaUpdateRequest body) {
		this.body = body;
	}

	public PutConversationsCustomattributesSchemaRequest withBody(ConversationSchemaUpdateRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutConversationsCustomattributesSchemaRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<ConversationSchemaUpdateRequest> withHttpInfo() {
        
        // verify the required parameter 'schemaId' is set
        if (this.schemaId == null) {
            throw new IllegalStateException("Missing the required parameter 'schemaId' when building request for PutConversationsCustomattributesSchemaRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutConversationsCustomattributesSchemaRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/conversations/customattributes/schemas/{schemaId}")
	...
	public static Builder builder(String schemaId, ConversationSchemaUpdateRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PutConversationsCustomattributesSchemaRequest request;

		private Builder() {
			request = new PutConversationsCustomattributesSchemaRequest();
		}
		...
		public Builder withBody(ConversationSchemaUpdateRequest body) {
		...
		public Builder withRequiredParams(String schemaId, ConversationSchemaUpdateRequest body) {
			request.setSchemaId(schemaId);
			request.setBody(body);
		...
		public PutConversationsCustomattributesSchemaRequest build() {
