...
public class GetRoutingAssessmentsRequest {
	...
	public GetRoutingAssessmentsRequest withBefore(String before) {
	...
	public GetRoutingAssessmentsRequest withAfter(String after) {
	    this.setAfter(after);
	    return this;
	} 
	...
	public GetRoutingAssessmentsRequest withLimit(String limit) {
	    this.setLimit(limit);
	    return this;
	} 
	...
	public GetRoutingAssessmentsRequest withPageSize(String pageSize) {
	...
	public GetRoutingAssessmentsRequest withQueueId(List<String> queueId) {
    ...
    public GetRoutingAssessmentsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/routing/assessments")
	...
	public static class Builder {
		private final GetRoutingAssessmentsRequest request;

		private Builder() {
			request = new GetRoutingAssessmentsRequest();
		}
		...
		public GetRoutingAssessmentsRequest build() {
