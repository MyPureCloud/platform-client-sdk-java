...
public class PutUserCustomattributesRequest {
	...
	public PutUserCustomattributesRequest withUserId(String userId) {
	    this.setUserId(userId);
	    return this;
	} 

	private UserCustomAttributesUpdateRequest userCustomAttributes;
	public UserCustomAttributesUpdateRequest getUserCustomAttributes() {
		return this.userCustomAttributes;
	}

	public void setUserCustomAttributes(UserCustomAttributesUpdateRequest userCustomAttributes) {
		this.userCustomAttributes = userCustomAttributes;
	}

	public PutUserCustomattributesRequest withUserCustomAttributes(UserCustomAttributesUpdateRequest userCustomAttributes) {
	    this.setUserCustomAttributes(userCustomAttributes);
	    return this;
	} 
    ...
    public PutUserCustomattributesRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<UserCustomAttributesUpdateRequest> withHttpInfo() {
        
        // verify the required parameter 'userId' is set
        if (this.userId == null) {
            throw new IllegalStateException("Missing the required parameter 'userId' when building request for PutUserCustomattributesRequest.");
        }
        
        // verify the required parameter 'userCustomAttributes' is set
        if (this.userCustomAttributes == null) {
            throw new IllegalStateException("Missing the required parameter 'userCustomAttributes' when building request for PutUserCustomattributesRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/users/{userId}/customattributes")
                .withPathParameter("userId", userId)
        
                .withBody(userCustomAttributes)
	...
	public static Builder builder(String userId, UserCustomAttributesUpdateRequest userCustomAttributes) {
	    return new Builder()
	            .withRequiredParams(userId, userCustomAttributes);
	}


	public static class Builder {
		private final PutUserCustomattributesRequest request;

		private Builder() {
			request = new PutUserCustomattributesRequest();
		}
		...
		public Builder withUserCustomAttributes(UserCustomAttributesUpdateRequest userCustomAttributes) {
			request.setUserCustomAttributes(userCustomAttributes);
			return this;
		}



		public Builder withRequiredParams(String userId, UserCustomAttributesUpdateRequest userCustomAttributes) {
			request.setUserId(userId);
			request.setUserCustomAttributes(userCustomAttributes);
		...
		public PutUserCustomattributesRequest build() {
