...
public class PutOutboundSchedulesMessagingcampaignRequest {
	...
	public PutOutboundSchedulesMessagingcampaignRequest withMessagingCampaignId(String messagingCampaignId) {
	    this.setMessagingCampaignId(messagingCampaignId);
	    return this;
	} 

	private MessagingCampaignSchedule body;
	public MessagingCampaignSchedule getBody() {
		return this.body;
	}

	public void setBody(MessagingCampaignSchedule body) {
		this.body = body;
	}

	public PutOutboundSchedulesMessagingcampaignRequest withBody(MessagingCampaignSchedule body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutOutboundSchedulesMessagingcampaignRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<MessagingCampaignSchedule> withHttpInfo() {
        
        // verify the required parameter 'messagingCampaignId' is set
        if (this.messagingCampaignId == null) {
            throw new IllegalStateException("Missing the required parameter 'messagingCampaignId' when building request for PutOutboundSchedulesMessagingcampaignRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutOutboundSchedulesMessagingcampaignRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/outbound/schedules/messagingcampaigns/{messagingCampaignId}")
	...
	public static Builder builder(String messagingCampaignId, MessagingCampaignSchedule body) {
	    return new Builder()
	...
	public static class Builder {
		private final PutOutboundSchedulesMessagingcampaignRequest request;

		private Builder() {
			request = new PutOutboundSchedulesMessagingcampaignRequest();
		}
		...
		public Builder withBody(MessagingCampaignSchedule body) {
		...
		public Builder withRequiredParams(String messagingCampaignId, MessagingCampaignSchedule body) {
			request.setMessagingCampaignId(messagingCampaignId);
			request.setBody(body);
		...
		public PutOutboundSchedulesMessagingcampaignRequest build() {
