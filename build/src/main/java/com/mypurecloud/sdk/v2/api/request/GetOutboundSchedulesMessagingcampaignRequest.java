...
public class GetOutboundSchedulesMessagingcampaignRequest {
	...
	public GetOutboundSchedulesMessagingcampaignRequest withMessagingCampaignId(String messagingCampaignId) {
    ...
    public GetOutboundSchedulesMessagingcampaignRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.messagingCampaignId == null) {
            throw new IllegalStateException("Missing the required parameter 'messagingCampaignId' when building request for GetOutboundSchedulesMessagingcampaignRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/outbound/schedules/messagingcampaigns/{messagingCampaignId}")
	...
	public static class Builder {
		private final GetOutboundSchedulesMessagingcampaignRequest request;

		private Builder() {
			request = new GetOutboundSchedulesMessagingcampaignRequest();
		}
		...
		public GetOutboundSchedulesMessagingcampaignRequest build() {
