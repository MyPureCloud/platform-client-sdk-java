...
public class GetTaskmanagementWorkitemUserWrapupsRequest {
	...
	public GetTaskmanagementWorkitemUserWrapupsRequest withWorkitemId(String workitemId) {
	...
	public GetTaskmanagementWorkitemUserWrapupsRequest withUserId(String userId) {
	...
	public GetTaskmanagementWorkitemUserWrapupsRequest withExpands(String expands) {
	...
	public GetTaskmanagementWorkitemUserWrapupsRequest withAfter(String after) {
	    this.setAfter(after);
	    return this;
	} 
	...
	public GetTaskmanagementWorkitemUserWrapupsRequest withPageSize(Integer pageSize) {
	...
	public GetTaskmanagementWorkitemUserWrapupsRequest withSortOrder(String sortOrder) {
    ...
    public GetTaskmanagementWorkitemUserWrapupsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.workitemId == null) {
            throw new IllegalStateException("Missing the required parameter 'workitemId' when building request for GetTaskmanagementWorkitemUserWrapupsRequest.");
        }
        
        // verify the required parameter 'userId' is set
        if (this.userId == null) {
            throw new IllegalStateException("Missing the required parameter 'userId' when building request for GetTaskmanagementWorkitemUserWrapupsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/taskmanagement/workitems/{workitemId}/users/{userId}/wrapups")
	...
	public static Builder builder(String workitemId, String userId) {
	    return new Builder()
	            .withRequiredParams(workitemId, userId);
	}


	public static class Builder {
		private final GetTaskmanagementWorkitemUserWrapupsRequest request;

		private Builder() {
			request = new GetTaskmanagementWorkitemUserWrapupsRequest();
		}
		...
		public Builder withRequiredParams(String workitemId, String userId) {
			request.setWorkitemId(workitemId);
			request.setUserId(userId);
		...
		public GetTaskmanagementWorkitemUserWrapupsRequest build() {
