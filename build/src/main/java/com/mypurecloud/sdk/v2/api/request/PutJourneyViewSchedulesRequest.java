...
public class PutJourneyViewSchedulesRequest {
	...
	public PutJourneyViewSchedulesRequest withViewId(String viewId) {
	...
	public PutJourneyViewSchedulesRequest withBody(JourneyViewSchedule body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutJourneyViewSchedulesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<JourneyViewSchedule> withHttpInfo() {
        ...
        if (this.viewId == null) {
            throw new IllegalStateException("Missing the required parameter 'viewId' when building request for PutJourneyViewSchedulesRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutJourneyViewSchedulesRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/journey/views/{viewId}/schedules")
	...
	public static class Builder {
		private final PutJourneyViewSchedulesRequest request;

		private Builder() {
			request = new PutJourneyViewSchedulesRequest();
		}
		...
		public PutJourneyViewSchedulesRequest build() {
