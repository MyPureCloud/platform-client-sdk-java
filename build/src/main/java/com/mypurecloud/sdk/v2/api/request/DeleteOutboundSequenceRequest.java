...
public class DeleteOutboundSequenceRequest {
	...
	public DeleteOutboundSequenceRequest withSequenceId(String sequenceId) {
    ...
    public DeleteOutboundSequenceRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.sequenceId == null) {
            throw new IllegalStateException("Missing the required parameter 'sequenceId' when building request for DeleteOutboundSequenceRequest.");
        }
