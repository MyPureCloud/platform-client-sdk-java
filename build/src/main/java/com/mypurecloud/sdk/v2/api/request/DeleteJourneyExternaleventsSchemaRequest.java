...
public class DeleteJourneyExternaleventsSchemaRequest {
	...
	public DeleteJourneyExternaleventsSchemaRequest withSchemaId(String schemaId) {
    ...
    public DeleteJourneyExternaleventsSchemaRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.schemaId == null) {
            throw new IllegalStateException("Missing the required parameter 'schemaId' when building request for DeleteJourneyExternaleventsSchemaRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/journey/externalevents/schemas/{schemaId}")
	...
	public static class Builder {
		private final DeleteJourneyExternaleventsSchemaRequest request;

		private Builder() {
			request = new DeleteJourneyExternaleventsSchemaRequest();
		}
		...
		public DeleteJourneyExternaleventsSchemaRequest build() {
