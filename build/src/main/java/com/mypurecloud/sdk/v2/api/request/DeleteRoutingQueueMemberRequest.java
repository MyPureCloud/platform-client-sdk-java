...
public class DeleteRoutingQueueMemberRequest {
	...
	public DeleteRoutingQueueMemberRequest withQueueId(String queueId) {
	...
	public DeleteRoutingQueueMemberRequest withMemberId(String memberId) {
    ...
    public DeleteRoutingQueueMemberRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.queueId == null) {
            throw new IllegalStateException("Missing the required parameter 'queueId' when building request for DeleteRoutingQueueMemberRequest.");
        }
        
        // verify the required parameter 'memberId' is set
        if (this.memberId == null) {
            throw new IllegalStateException("Missing the required parameter 'memberId' when building request for DeleteRoutingQueueMemberRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/routing/queues/{queueId}/members/{memberId}")
	...
	public static class Builder {
		private final DeleteRoutingQueueMemberRequest request;

		private Builder() {
			request = new DeleteRoutingQueueMemberRequest();
		}
		...
		public DeleteRoutingQueueMemberRequest build() {
