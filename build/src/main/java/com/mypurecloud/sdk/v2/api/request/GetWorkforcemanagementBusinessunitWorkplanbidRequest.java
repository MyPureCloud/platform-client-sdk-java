...
public class GetWorkforcemanagementBusinessunitWorkplanbidRequest {
	...
	public GetWorkforcemanagementBusinessunitWorkplanbidRequest withBusinessUnitId(String businessUnitId) {
	...
	public GetWorkforcemanagementBusinessunitWorkplanbidRequest withBidId(String bidId) {
	    this.setBidId(bidId);
	    return this;
	} 
    ...
    public GetWorkforcemanagementBusinessunitWorkplanbidRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for GetWorkforcemanagementBusinessunitWorkplanbidRequest.");
        }
        
        // verify the required parameter 'bidId' is set
        if (this.bidId == null) {
            throw new IllegalStateException("Missing the required parameter 'bidId' when building request for GetWorkforcemanagementBusinessunitWorkplanbidRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/workplanbids/{bidId}")
	...
	public static class Builder {
		private final GetWorkforcemanagementBusinessunitWorkplanbidRequest request;

		private Builder() {
			request = new GetWorkforcemanagementBusinessunitWorkplanbidRequest();
		}
		...
		public GetWorkforcemanagementBusinessunitWorkplanbidRequest build() {
