...
public class PostTelephonyProvidersEdgeOfflineconfigurationRequest {
	...
	public PostTelephonyProvidersEdgeOfflineconfigurationRequest withEdgeId(String edgeId) {
	    this.setEdgeId(edgeId);
	    return this;
	} 

	private EdgeOfflineConfiguration body;
	public EdgeOfflineConfiguration getBody() {
		return this.body;
	}

	public void setBody(EdgeOfflineConfiguration body) {
		this.body = body;
	}

	public PostTelephonyProvidersEdgeOfflineconfigurationRequest withBody(EdgeOfflineConfiguration body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostTelephonyProvidersEdgeOfflineconfigurationRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<EdgeOfflineConfiguration> withHttpInfo() {
        
        // verify the required parameter 'edgeId' is set
        if (this.edgeId == null) {
            throw new IllegalStateException("Missing the required parameter 'edgeId' when building request for PostTelephonyProvidersEdgeOfflineconfigurationRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostTelephonyProvidersEdgeOfflineconfigurationRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/telephony/providers/edges/{edgeId}/offlineconfiguration")
	...
	public static Builder builder(String edgeId, EdgeOfflineConfiguration body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostTelephonyProvidersEdgeOfflineconfigurationRequest request;

		private Builder() {
			request = new PostTelephonyProvidersEdgeOfflineconfigurationRequest();
		}
		...
		public Builder withBody(EdgeOfflineConfiguration body) {
		...
		public Builder withRequiredParams(String edgeId, EdgeOfflineConfiguration body) {
			request.setEdgeId(edgeId);
			request.setBody(body);
		...
		public PostTelephonyProvidersEdgeOfflineconfigurationRequest build() {
