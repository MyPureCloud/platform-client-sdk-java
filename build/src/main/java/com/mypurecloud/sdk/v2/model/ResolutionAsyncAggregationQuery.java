...
import com.fasterxml.jackson.annotation.JsonValue;
import com.mypurecloud.sdk.v2.model.ResolutionAggregateQueryFilter;
import com.mypurecloud.sdk.v2.model.ResolutionAggregationView;
...
public class ResolutionAsyncAggregationQuery  implements Serializable {
 ...
 @JsonDeserialize(using = GroupByEnumDeserializer.class)
  ...
  private ResolutionAggregateQueryFilter filter = null;
 ...
 @JsonDeserialize(using = MetricsEnumDeserializer.class)
  ...
  private List<ResolutionAggregationView> views = null;
 ...
 @JsonDeserialize(using = AlternateTimeDimensionEnumDeserializer.class)
  ...
  public ResolutionAsyncAggregationQuery() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
      groupBy = new ArrayList<GroupByEnum>();
      metrics = new ArrayList<MetricsEnum>();
      views = new ArrayList<ResolutionAggregationView>();
    }
  }

  public ResolutionAsyncAggregationQuery(Boolean initWithEmptyList) {
   ...
   **/
  public ResolutionAsyncAggregationQuery interval(String interval) {
   ...
   **/
  public ResolutionAsyncAggregationQuery granularity(String granularity) {
   ...
   **/
  public ResolutionAsyncAggregationQuery timeZone(String timeZone) {
   ...
   **/
  public ResolutionAsyncAggregationQuery groupBy(List<GroupByEnum> groupBy) {
   ...
   **/
  public ResolutionAsyncAggregationQuery filter(ResolutionAggregateQueryFilter filter) {
    this.filter = filter;
    return this;
  }
  ...
  @JsonProperty("filter")
  public ResolutionAggregateQueryFilter getFilter() {
    return filter;
  }
  public void setFilter(ResolutionAggregateQueryFilter filter) {
    this.filter = filter;
  }
   ...
   **/
  public ResolutionAsyncAggregationQuery metrics(List<MetricsEnum> metrics) {
   ...
   **/
  public ResolutionAsyncAggregationQuery flattenMultivaluedDimensions(Boolean flattenMultivaluedDimensions) {
   ...
   **/
  public ResolutionAsyncAggregationQuery views(List<ResolutionAggregationView> views) {
    this.views = views;
    return this;
  }
  ...
  @JsonProperty("views")
  public List<ResolutionAggregationView> getViews() {
    return views;
  }
  public void setViews(List<ResolutionAggregationView> views) {
    this.views = views;
  }
   ...
   **/
  public ResolutionAsyncAggregationQuery pageSize(Integer pageSize) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ResolutionAsyncAggregationQuery resolutionAsyncAggregationQuery = (ResolutionAsyncAggregationQuery) o;

    return Objects.equals(this.interval, resolutionAsyncAggregationQuery.interval) &&
            Objects.equals(this.granularity, resolutionAsyncAggregationQuery.granularity) &&
            Objects.equals(this.timeZone, resolutionAsyncAggregationQuery.timeZone) &&
            Objects.equals(this.groupBy, resolutionAsyncAggregationQuery.groupBy) &&
            Objects.equals(this.filter, resolutionAsyncAggregationQuery.filter) &&
            Objects.equals(this.metrics, resolutionAsyncAggregationQuery.metrics) &&
            Objects.equals(this.flattenMultivaluedDimensions, resolutionAsyncAggregationQuery.flattenMultivaluedDimensions) &&
            Objects.equals(this.views, resolutionAsyncAggregationQuery.views) &&
            Objects.equals(this.alternateTimeDimension, resolutionAsyncAggregationQuery.alternateTimeDimension) &&
            Objects.equals(this.pageSize, resolutionAsyncAggregationQuery.pageSize);
  }
