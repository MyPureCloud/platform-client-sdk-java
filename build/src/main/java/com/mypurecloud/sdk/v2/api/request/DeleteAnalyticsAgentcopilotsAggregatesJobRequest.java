...
public class DeleteAnalyticsAgentcopilotsAggregatesJobRequest {
	...
	public DeleteAnalyticsAgentcopilotsAggregatesJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public DeleteAnalyticsAgentcopilotsAggregatesJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for DeleteAnalyticsAgentcopilotsAggregatesJobRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/analytics/agentcopilots/aggregates/jobs/{jobId}")
	...
	public static class Builder {
		private final DeleteAnalyticsAgentcopilotsAggregatesJobRequest request;

		private Builder() {
			request = new DeleteAnalyticsAgentcopilotsAggregatesJobRequest();
		}
		...
		public DeleteAnalyticsAgentcopilotsAggregatesJobRequest build() {
