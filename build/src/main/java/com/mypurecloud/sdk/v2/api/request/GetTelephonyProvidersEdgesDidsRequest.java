...
public class GetTelephonyProvidersEdgesDidsRequest {
	...
	public GetTelephonyProvidersEdgesDidsRequest withId(List<String> id) {
	    this.setId(id);
	    return this;
	} 
    ...
    public GetTelephonyProvidersEdgesDidsRequest withCustomHeader(String name, String value) {
