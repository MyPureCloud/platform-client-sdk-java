...
public class GetRoutingEmailSettingEmailSettingIdRequest {
	...
	public GetRoutingEmailSettingEmailSettingIdRequest withEmailSettingId(String emailSettingId) {
    ...
    public GetRoutingEmailSettingEmailSettingIdRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.emailSettingId == null) {
            throw new IllegalStateException("Missing the required parameter 'emailSettingId' when building request for GetRoutingEmailSettingEmailSettingIdRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/routing/email/setting/{emailSettingId}")
	...
	public static class Builder {
		private final GetRoutingEmailSettingEmailSettingIdRequest request;

		private Builder() {
			request = new GetRoutingEmailSettingEmailSettingIdRequest();
		}
		...
		public GetRoutingEmailSettingEmailSettingIdRequest build() {
