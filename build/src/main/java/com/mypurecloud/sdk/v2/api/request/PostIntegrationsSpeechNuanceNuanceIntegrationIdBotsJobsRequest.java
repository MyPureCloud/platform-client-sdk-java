...
public class PostIntegrationsSpeechNuanceNuanceIntegrationIdBotsJobsRequest {
	...
	public PostIntegrationsSpeechNuanceNuanceIntegrationIdBotsJobsRequest withNuanceIntegrationId(String nuanceIntegrationId) {
	...
	public PostIntegrationsSpeechNuanceNuanceIntegrationIdBotsJobsRequest withPageNumber(Integer pageNumber) {
	...
	public PostIntegrationsSpeechNuanceNuanceIntegrationIdBotsJobsRequest withPageSize(Integer pageSize) {
	    this.setPageSize(pageSize);
	    return this;
	} 

	private Boolean onlyRegisteredBots;
	public Boolean getOnlyRegisteredBots() {
		return this.onlyRegisteredBots;
	}

	public void setOnlyRegisteredBots(Boolean onlyRegisteredBots) {
		this.onlyRegisteredBots = onlyRegisteredBots;
	}

	public PostIntegrationsSpeechNuanceNuanceIntegrationIdBotsJobsRequest withOnlyRegisteredBots(Boolean onlyRegisteredBots) {
	    this.setOnlyRegisteredBots(onlyRegisteredBots);
	    return this;
	} 
    ...
    public PostIntegrationsSpeechNuanceNuanceIntegrationIdBotsJobsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.nuanceIntegrationId == null) {
            throw new IllegalStateException("Missing the required parameter 'nuanceIntegrationId' when building request for PostIntegrationsSpeechNuanceNuanceIntegrationIdBotsJobsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/integrations/speech/nuance/{nuanceIntegrationId}/bots/jobs")
                ...
                .withQueryParameters("onlyRegisteredBots", "", onlyRegisteredBots)
	...
	public static Builder builder(String nuanceIntegrationId) {
	    return new Builder()
	            .withRequiredParams(nuanceIntegrationId);
	}


	public static class Builder {
		private final PostIntegrationsSpeechNuanceNuanceIntegrationIdBotsJobsRequest request;

		private Builder() {
			request = new PostIntegrationsSpeechNuanceNuanceIntegrationIdBotsJobsRequest();
		}
		...
		public Builder withOnlyRegisteredBots(Boolean onlyRegisteredBots) {
			request.setOnlyRegisteredBots(onlyRegisteredBots);
			return this;
		}



		public Builder withRequiredParams(String nuanceIntegrationId) {
			request.setNuanceIntegrationId(nuanceIntegrationId);
		...
		public PostIntegrationsSpeechNuanceNuanceIntegrationIdBotsJobsRequest build() {
