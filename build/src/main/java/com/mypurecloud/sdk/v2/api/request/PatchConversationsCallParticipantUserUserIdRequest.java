...
public class PatchConversationsCallParticipantUserUserIdRequest {
	...
	public PatchConversationsCallParticipantUserUserIdRequest withConversationId(String conversationId) {
	...
	public PatchConversationsCallParticipantUserUserIdRequest withParticipantId(String participantId) {
	...
	public PatchConversationsCallParticipantUserUserIdRequest withUserId(String userId) {
	...
	public PatchConversationsCallParticipantUserUserIdRequest withBody(MediaParticipantRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public ApiRequest<MediaParticipantRequest> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PatchConversationsCallParticipantUserUserIdRequest.");
        }
        
        // verify the required parameter 'participantId' is set
        if (this.participantId == null) {
            throw new IllegalStateException("Missing the required parameter 'participantId' when building request for PatchConversationsCallParticipantUserUserIdRequest.");
        }
        
        // verify the required parameter 'userId' is set
        if (this.userId == null) {
            throw new IllegalStateException("Missing the required parameter 'userId' when building request for PatchConversationsCallParticipantUserUserIdRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchConversationsCallParticipantUserUserIdRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/conversations/calls/{conversationId}/participants/{participantId}/user/{userId}")
	...
	public static Builder builder(String conversationId, String participantId, String userId, MediaParticipantRequest body) {
	    return new Builder()
	            .withRequiredParams(conversationId, participantId, userId, body);
	}


	public static class Builder {
		private final PatchConversationsCallParticipantUserUserIdRequest request;

		private Builder() {
			request = new PatchConversationsCallParticipantUserUserIdRequest();
		}
		...
		public Builder withRequiredParams(String conversationId, String participantId, String userId, MediaParticipantRequest body) {
			request.setConversationId(conversationId);
			request.setParticipantId(participantId);
			request.setUserId(userId);
			request.setBody(body);
		...
		public PatchConversationsCallParticipantUserUserIdRequest build() {
