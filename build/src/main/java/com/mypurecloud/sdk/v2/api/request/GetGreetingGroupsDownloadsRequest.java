...
public class GetGreetingGroupsDownloadsRequest {
	...
	public GetGreetingGroupsDownloadsRequest withGreetingId(String greetingId) {
	...
	public GetGreetingGroupsDownloadsRequest withFormatId(String formatId) {
    ...
    public GetGreetingGroupsDownloadsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.greetingId == null) {
            throw new IllegalStateException("Missing the required parameter 'greetingId' when building request for GetGreetingGroupsDownloadsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/greetings/{greetingId}/groups/downloads")
	...
	public static class Builder {
		private final GetGreetingGroupsDownloadsRequest request;

		private Builder() {
			request = new GetGreetingGroupsDownloadsRequest();
		}
		...
		public GetGreetingGroupsDownloadsRequest build() {
