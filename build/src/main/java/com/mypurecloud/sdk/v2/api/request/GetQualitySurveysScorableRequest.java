...
public class GetQualitySurveysScorableRequest {
	...
	public GetQualitySurveysScorableRequest withCustomerSurveyUrl(String customerSurveyUrl) {
    ...
    public GetQualitySurveysScorableRequest withCustomHeader(String name, String value) {
	...
	public static class Builder {
		private final GetQualitySurveysScorableRequest request;

		private Builder() {
			request = new GetQualitySurveysScorableRequest();
		}
