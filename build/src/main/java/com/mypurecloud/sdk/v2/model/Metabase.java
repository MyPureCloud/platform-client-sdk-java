...
public class Metabase  implements Serializable {
 ...
 @JsonDeserialize(using = TypeEnumDeserializer.class)
   ...
   **/
  public Metabase name(String name) {
    this.name = name;
    return this;
  }
   ...
   **/
  public Metabase division(Division division) {
   ...
   **/
  public Metabase version(Integer version) {
   ...
   **/
  public Metabase dateCreated(Date dateCreated) {
   ...
   **/
  public Metabase dateModified(Date dateModified) {
   ...
   **/
  public Metabase modifiedBy(String modifiedBy) {
   ...
   **/
  public Metabase createdBy(String createdBy) {
   ...
   **/
  public Metabase modifiedByApp(String modifiedByApp) {
   ...
   **/
  public Metabase createdByApp(String createdByApp) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, division, description, version, dateCreated, dateModified, modifiedBy, createdBy, state, modifiedByApp, createdByApp, type, selfUri);
  }
