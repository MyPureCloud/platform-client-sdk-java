...
public class CreateScheduleBid  implements Serializable {
 ...
 @JsonDeserialize(using = RankingTiebreakerTypeEnumDeserializer.class)
  ...
  public CreateScheduleBid() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
    }
  }

  public CreateScheduleBid(Boolean initWithEmptyList) {
   ...
   **/
  public CreateScheduleBid name(String name) {
    this.name = name;
    return this;
  }
   ...
   **/
  public CreateScheduleBid forecast(BuShortTermForecastWeekReference forecast) {
   ...
   **/
  public CreateScheduleBid bidWindowStartDate(LocalDate bidWindowStartDate) {
    this.bidWindowStartDate = bidWindowStartDate;
    return this;
  }
  
  @ApiModelProperty(example = "null", required = true, value = "The bid start date where agents start participating in schedule bidding relative to the business unit time zone in yyyy-MM-dd format. Dates are represented as an ISO-8601 string. For example: yyyy-MM-dd")
   ...
   **/
  public CreateScheduleBid bidWindowEndDate(LocalDate bidWindowEndDate) {
   ...
   **/
  public CreateScheduleBid effectiveDate(LocalDate effectiveDate) {
   ...
   **/
  public CreateScheduleBid weeksToSchedule(Integer weeksToSchedule) {
    this.weeksToSchedule = weeksToSchedule;
    return this;
  }
  
  @ApiModelProperty(example = "null", required = true, value = "The number of weeks to generate schedule set through this bid")
   ...
   **/
  public CreateScheduleBid endOverridesAndRotations(Boolean endOverridesAndRotations) {
   ...
   * The type of agent ranking selected for this bid
   **/
  public CreateScheduleBid agentRankingType(AgentRankingTypeEnum agentRankingType) {
   ...
   * Ranking tiebreaker to be used
   **/
  public CreateScheduleBid rankingTiebreakerType(RankingTiebreakerTypeEnum rankingTiebreakerType) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CreateScheduleBid createScheduleBid = (CreateScheduleBid) o;

    return Objects.equals(this.name, createScheduleBid.name) &&
            Objects.equals(this.forecast, createScheduleBid.forecast) &&
            Objects.equals(this.bidWindowStartDate, createScheduleBid.bidWindowStartDate) &&
            Objects.equals(this.bidWindowEndDate, createScheduleBid.bidWindowEndDate) &&
            Objects.equals(this.effectiveDate, createScheduleBid.effectiveDate) &&
            Objects.equals(this.weeksToSchedule, createScheduleBid.weeksToSchedule) &&
            Objects.equals(this.endOverridesAndRotations, createScheduleBid.endOverridesAndRotations) &&
            Objects.equals(this.agentRankingType, createScheduleBid.agentRankingType) &&
            Objects.equals(this.rankingTiebreakerType, createScheduleBid.rankingTiebreakerType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, forecast, bidWindowStartDate, bidWindowEndDate, effectiveDate, weeksToSchedule, endOverridesAndRotations, agentRankingType, rankingTiebreakerType);
  }
