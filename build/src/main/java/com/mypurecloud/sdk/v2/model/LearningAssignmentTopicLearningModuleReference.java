...
public class LearningAssignmentTopicLearningModuleReference  implements Serializable {
  
  private String id = null;
  private String name = null;

  public LearningAssignmentTopicLearningModuleReference() {
  ...
  /**
   **/
  public LearningAssignmentTopicLearningModuleReference id(String id) {
    this.id = id;
    return this;
  }
