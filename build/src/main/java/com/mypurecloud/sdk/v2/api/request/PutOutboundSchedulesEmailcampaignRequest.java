...
public class PutOutboundSchedulesEmailcampaignRequest {
	...
	public PutOutboundSchedulesEmailcampaignRequest withEmailCampaignId(String emailCampaignId) {
	    this.setEmailCampaignId(emailCampaignId);
	    return this;
	} 
	...
	public void setBody(EmailCampaignSchedule body) {
		this.body = body;
	}

	public PutOutboundSchedulesEmailcampaignRequest withBody(EmailCampaignSchedule body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutOutboundSchedulesEmailcampaignRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<EmailCampaignSchedule> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("PUT", "/api/v2/outbound/schedules/emailcampaigns/{emailCampaignId}")
                .withPathParameter("emailCampaignId", emailCampaignId)
	...
	public static Builder builder(String emailCampaignId, EmailCampaignSchedule body) {
	    return new Builder()
	            .withRequiredParams(emailCampaignId, body);
	}
	...
	public static class Builder {
		...
		private Builder() {
			request = new PutOutboundSchedulesEmailcampaignRequest();
		}


		public Builder withEmailCampaignId(String emailCampaignId) {
			request.setEmailCampaignId(emailCampaignId);
			return this;
		}

		public Builder withBody(EmailCampaignSchedule body) {
		...
		public Builder withRequiredParams(String emailCampaignId, EmailCampaignSchedule body) {
			request.setEmailCampaignId(emailCampaignId);
			request.setBody(body);
		...
		public PutOutboundSchedulesEmailcampaignRequest build() {
            ...
            // verify the required parameter 'emailCampaignId' is set
            if (request.emailCampaignId == null) {
                throw new IllegalStateException("Missing the required parameter 'emailCampaignId' when building request for PutOutboundSchedulesEmailcampaignRequest.");
            }
