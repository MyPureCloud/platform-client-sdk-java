...
public class DeleteTaskmanagementWorktypeFlowsOnattributechangeRuleRequest {
	...
	public DeleteTaskmanagementWorktypeFlowsOnattributechangeRuleRequest withWorktypeId(String worktypeId) {
	...
	public DeleteTaskmanagementWorktypeFlowsOnattributechangeRuleRequest withRuleId(String ruleId) {
    ...
    public DeleteTaskmanagementWorktypeFlowsOnattributechangeRuleRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.worktypeId == null) {
            throw new IllegalStateException("Missing the required parameter 'worktypeId' when building request for DeleteTaskmanagementWorktypeFlowsOnattributechangeRuleRequest.");
        }
        
        // verify the required parameter 'ruleId' is set
        if (this.ruleId == null) {
            throw new IllegalStateException("Missing the required parameter 'ruleId' when building request for DeleteTaskmanagementWorktypeFlowsOnattributechangeRuleRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/taskmanagement/worktypes/{worktypeId}/flows/onattributechange/rules/{ruleId}")
	...
	public static class Builder {
		private final DeleteTaskmanagementWorktypeFlowsOnattributechangeRuleRequest request;

		private Builder() {
			request = new DeleteTaskmanagementWorktypeFlowsOnattributechangeRuleRequest();
		}
		...
		public DeleteTaskmanagementWorktypeFlowsOnattributechangeRuleRequest build() {
