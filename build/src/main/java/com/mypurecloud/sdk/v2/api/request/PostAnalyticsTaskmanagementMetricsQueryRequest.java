...
public class PostAnalyticsTaskmanagementMetricsQueryRequest {

	private TaskManagementObservationQuery body;
	public TaskManagementObservationQuery getBody() {
		return this.body;
	}

	public void setBody(TaskManagementObservationQuery body) {
		this.body = body;
	}

	public PostAnalyticsTaskmanagementMetricsQueryRequest withBody(TaskManagementObservationQuery body) {
	    this.setBody(body);
	    return this;
	} 
	...
	public PostAnalyticsTaskmanagementMetricsQueryRequest withAfter(String after) {
	    this.setAfter(after);
	    return this;
	} 
	...
	public PostAnalyticsTaskmanagementMetricsQueryRequest withPageSize(Integer pageSize) {
    ...
    public PostAnalyticsTaskmanagementMetricsQueryRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<TaskManagementObservationQuery> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostAnalyticsTaskmanagementMetricsQueryRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/analytics/taskmanagement/metrics/query")
	...
	public static Builder builder(TaskManagementObservationQuery body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostAnalyticsTaskmanagementMetricsQueryRequest request;

		private Builder() {
			request = new PostAnalyticsTaskmanagementMetricsQueryRequest();
		}


		public Builder withBody(TaskManagementObservationQuery body) {
		...
		public Builder withRequiredParams(TaskManagementObservationQuery body) {
			request.setBody(body);
		...
		public PostAnalyticsTaskmanagementMetricsQueryRequest build() {
