...
public class GetWorkforcemanagementSchedulebidSchedulesetsRequest {
	...
	public GetWorkforcemanagementSchedulebidSchedulesetsRequest withBidId(String bidId) {
	    this.setBidId(bidId);
	    return this;
	} 
    ...
    public GetWorkforcemanagementSchedulebidSchedulesetsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.bidId == null) {
            throw new IllegalStateException("Missing the required parameter 'bidId' when building request for GetWorkforcemanagementSchedulebidSchedulesetsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/schedulebids/{bidId}/schedulesets")
	...
	public static class Builder {
		private final GetWorkforcemanagementSchedulebidSchedulesetsRequest request;

		private Builder() {
			request = new GetWorkforcemanagementSchedulebidSchedulesetsRequest();
		}
		...
		public GetWorkforcemanagementSchedulebidSchedulesetsRequest build() {
