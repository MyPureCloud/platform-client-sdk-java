...
public class DeleteConversationsMessagingSupportedcontentSupportedContentIdRequest {
	...
	public DeleteConversationsMessagingSupportedcontentSupportedContentIdRequest withSupportedContentId(String supportedContentId) {
    ...
    public DeleteConversationsMessagingSupportedcontentSupportedContentIdRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.supportedContentId == null) {
            throw new IllegalStateException("Missing the required parameter 'supportedContentId' when building request for DeleteConversationsMessagingSupportedcontentSupportedContentIdRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/conversations/messaging/supportedcontent/{supportedContentId}")
	...
	public static class Builder {
		private final DeleteConversationsMessagingSupportedcontentSupportedContentIdRequest request;

		private Builder() {
			request = new DeleteConversationsMessagingSupportedcontentSupportedContentIdRequest();
		}
		...
		public DeleteConversationsMessagingSupportedcontentSupportedContentIdRequest build() {
