...
public class BotAggregationQuery  implements Serializable {
 ...
 @JsonDeserialize(using = QueryTypeEnumDeserializer.class)
  ...
  public BotAggregationQuery(Boolean initWithEmptyList) {
   ...
   **/
  public BotAggregationQuery interval(String interval) {
   ...
   **/
  public BotAggregationQuery granularity(String granularity) {
   ...
   **/
  public BotAggregationQuery timeZone(String timeZone) {
   ...
   **/
  public BotAggregationQuery groupBy(List<GroupByEnum> groupBy) {
   ...
   **/
  public BotAggregationQuery filter(BotAggregateQueryFilter filter) {
    this.filter = filter;
    return this;
  }
   ...
   **/
  public BotAggregationQuery metrics(List<MetricsEnum> metrics) {
   ...
   **/
  public BotAggregationQuery flattenMultivaluedDimensions(Boolean flattenMultivaluedDimensions) {
   ...
   **/
  public BotAggregationQuery views(List<BotAggregationView> views) {
    this.views = views;
    return this;
  }
   ...
   * Dimension to use as the alternative timestamp for data in the aggregate.  Choosing \"eventTime\" uses the actual time of the data event.
   **/
  public BotAggregationQuery alternateTimeDimension(AlternateTimeDimensionEnum alternateTimeDimension) {
   ...
   * Query type to use. Use groupBy for all matching results, and topN/bottomN for N results ordered by the sortMetric. Default is groupBy.
   **/
  public BotAggregationQuery queryType(QueryTypeEnum queryType) {
   ...
   **/
  public BotAggregationQuery sortMetric(BotAggregationSort sortMetric) {
   ...
   **/
  public BotAggregationQuery limit(Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    BotAggregationQuery botAggregationQuery = (BotAggregationQuery) o;

    return Objects.equals(this.interval, botAggregationQuery.interval) &&
            Objects.equals(this.granularity, botAggregationQuery.granularity) &&
            Objects.equals(this.timeZone, botAggregationQuery.timeZone) &&
            Objects.equals(this.groupBy, botAggregationQuery.groupBy) &&
            Objects.equals(this.filter, botAggregationQuery.filter) &&
            Objects.equals(this.metrics, botAggregationQuery.metrics) &&
            Objects.equals(this.flattenMultivaluedDimensions, botAggregationQuery.flattenMultivaluedDimensions) &&
            Objects.equals(this.views, botAggregationQuery.views) &&
            Objects.equals(this.alternateTimeDimension, botAggregationQuery.alternateTimeDimension) &&
            Objects.equals(this.queryType, botAggregationQuery.queryType) &&
            Objects.equals(this.sortMetric, botAggregationQuery.sortMetric) &&
            Objects.equals(this.limit, botAggregationQuery.limit);
  }
