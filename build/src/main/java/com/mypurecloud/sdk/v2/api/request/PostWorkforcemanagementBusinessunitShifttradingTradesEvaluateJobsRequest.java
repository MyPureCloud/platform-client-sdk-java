...
public class PostWorkforcemanagementBusinessunitShifttradingTradesEvaluateJobsRequest {
	...
	public PostWorkforcemanagementBusinessunitShifttradingTradesEvaluateJobsRequest withBusinessUnitId(String businessUnitId) {
	    this.setBusinessUnitId(businessUnitId);
	    return this;
	} 

	private EvaluateShiftTradeListJobRequest body;
	public EvaluateShiftTradeListJobRequest getBody() {
		return this.body;
	}

	public void setBody(EvaluateShiftTradeListJobRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementBusinessunitShifttradingTradesEvaluateJobsRequest withBody(EvaluateShiftTradeListJobRequest body) {
	    this.setBody(body);
	    return this;
	} 
	...
	public PostWorkforcemanagementBusinessunitShifttradingTradesEvaluateJobsRequest withForceAsync(Boolean forceAsync) {
	...
	public PostWorkforcemanagementBusinessunitShifttradingTradesEvaluateJobsRequest withForceDownloadService(Boolean forceDownloadService) {
    ...
    public PostWorkforcemanagementBusinessunitShifttradingTradesEvaluateJobsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<EvaluateShiftTradeListJobRequest> withHttpInfo() {
        
        // verify the required parameter 'businessUnitId' is set
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PostWorkforcemanagementBusinessunitShifttradingTradesEvaluateJobsRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementBusinessunitShifttradingTradesEvaluateJobsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/shifttrading/trades/evaluate/jobs")
	...
	public static Builder builder(String businessUnitId, EvaluateShiftTradeListJobRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementBusinessunitShifttradingTradesEvaluateJobsRequest request;

		private Builder() {
			request = new PostWorkforcemanagementBusinessunitShifttradingTradesEvaluateJobsRequest();
		}
		...
		public Builder withBody(EvaluateShiftTradeListJobRequest body) {
		...
		public Builder withRequiredParams(String businessUnitId, EvaluateShiftTradeListJobRequest body) {
			request.setBusinessUnitId(businessUnitId);
			request.setBody(body);
		...
		public PostWorkforcemanagementBusinessunitShifttradingTradesEvaluateJobsRequest build() {
