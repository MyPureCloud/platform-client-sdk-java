...
public class GetJourneyViewsSchedulesRequest {
	...
	public GetJourneyViewsSchedulesRequest withPageNumber(Integer pageNumber) {
	...
	public GetJourneyViewsSchedulesRequest withPageSize(Integer pageSize) {
    ...
    public GetJourneyViewsSchedulesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/journey/views/schedules")
	...
	public static class Builder {
		private final GetJourneyViewsSchedulesRequest request;

		private Builder() {
			request = new GetJourneyViewsSchedulesRequest();
		}
		...
		public GetJourneyViewsSchedulesRequest build() {
