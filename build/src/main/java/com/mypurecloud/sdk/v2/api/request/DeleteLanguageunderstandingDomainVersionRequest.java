...
public class DeleteLanguageunderstandingDomainVersionRequest {
	...
	public DeleteLanguageunderstandingDomainVersionRequest withDomainId(String domainId) {
	...
	public DeleteLanguageunderstandingDomainVersionRequest withDomainVersionId(String domainVersionId) {
    ...
    public DeleteLanguageunderstandingDomainVersionRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.domainId == null) {
            throw new IllegalStateException("Missing the required parameter 'domainId' when building request for DeleteLanguageunderstandingDomainVersionRequest.");
        }
        
        // verify the required parameter 'domainVersionId' is set
        if (this.domainVersionId == null) {
            throw new IllegalStateException("Missing the required parameter 'domainVersionId' when building request for DeleteLanguageunderstandingDomainVersionRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/languageunderstanding/domains/{domainId}/versions/{domainVersionId}")
	...
	public static class Builder {
		private final DeleteLanguageunderstandingDomainVersionRequest request;

		private Builder() {
			request = new DeleteLanguageunderstandingDomainVersionRequest();
		}
		...
		public DeleteLanguageunderstandingDomainVersionRequest build() {
