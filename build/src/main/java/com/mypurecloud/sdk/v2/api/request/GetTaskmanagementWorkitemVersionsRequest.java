...
public class GetTaskmanagementWorkitemVersionsRequest {
	...
	public GetTaskmanagementWorkitemVersionsRequest withWorkitemId(String workitemId) {
	...
	public GetTaskmanagementWorkitemVersionsRequest withAfter(String after) {
	    this.setAfter(after);
	    return this;
	} 
	...
	public GetTaskmanagementWorkitemVersionsRequest withPageSize(Integer pageSize) {
	...
	public GetTaskmanagementWorkitemVersionsRequest withSortOrder(String sortOrder) {
    ...
    public GetTaskmanagementWorkitemVersionsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.workitemId == null) {
            throw new IllegalStateException("Missing the required parameter 'workitemId' when building request for GetTaskmanagementWorkitemVersionsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/taskmanagement/workitems/{workitemId}/versions")
	...
	public static class Builder {
		private final GetTaskmanagementWorkitemVersionsRequest request;

		private Builder() {
			request = new GetTaskmanagementWorkitemVersionsRequest();
		}
		...
		public GetTaskmanagementWorkitemVersionsRequest build() {
