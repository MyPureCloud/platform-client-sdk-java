...
public class GetMessagingIntegrationsRequest {
	...
	public GetMessagingIntegrationsRequest withPageSize(Integer pageSize) {
	...
	public GetMessagingIntegrationsRequest withPageNumber(Integer pageNumber) {
    ...
    public GetMessagingIntegrationsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/messaging/integrations")
	...
	public static class Builder {
		private final GetMessagingIntegrationsRequest request;

		private Builder() {
			request = new GetMessagingIntegrationsRequest();
		}
		...
		public GetMessagingIntegrationsRequest build() {
