...
public class PatchConversationsMessagingIntegrationsTwitterIntegrationIdRequest {
	...
	public PatchConversationsMessagingIntegrationsTwitterIntegrationIdRequest withIntegrationId(String integrationId) {
	    this.setIntegrationId(integrationId);
	    return this;
	} 

	private TwitterIntegrationUpdateRequest body;
	public TwitterIntegrationUpdateRequest getBody() {
		return this.body;
	}

	public void setBody(TwitterIntegrationUpdateRequest body) {
		this.body = body;
	}

	public PatchConversationsMessagingIntegrationsTwitterIntegrationIdRequest withBody(TwitterIntegrationUpdateRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchConversationsMessagingIntegrationsTwitterIntegrationIdRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<TwitterIntegrationUpdateRequest> withHttpInfo() {
        
        // verify the required parameter 'integrationId' is set
        if (this.integrationId == null) {
            throw new IllegalStateException("Missing the required parameter 'integrationId' when building request for PatchConversationsMessagingIntegrationsTwitterIntegrationIdRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchConversationsMessagingIntegrationsTwitterIntegrationIdRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/conversations/messaging/integrations/twitter/{integrationId}")
	...
	public static Builder builder(String integrationId, TwitterIntegrationUpdateRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PatchConversationsMessagingIntegrationsTwitterIntegrationIdRequest request;

		private Builder() {
			request = new PatchConversationsMessagingIntegrationsTwitterIntegrationIdRequest();
		}
		...
		public Builder withBody(TwitterIntegrationUpdateRequest body) {
		...
		public Builder withRequiredParams(String integrationId, TwitterIntegrationUpdateRequest body) {
			request.setIntegrationId(integrationId);
			request.setBody(body);
		...
		public PatchConversationsMessagingIntegrationsTwitterIntegrationIdRequest build() {
