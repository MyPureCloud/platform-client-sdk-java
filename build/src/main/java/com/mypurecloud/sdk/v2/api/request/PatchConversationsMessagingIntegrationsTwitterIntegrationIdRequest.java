...
public class PatchConversationsMessagingIntegrationsTwitterIntegrationIdRequest {
	...
	private TwitterIntegrationRequest body;
	public TwitterIntegrationRequest getBody() {
		return this.body;
	}

	public void setBody(TwitterIntegrationRequest body) {
		this.body = body;
	}

	public PatchConversationsMessagingIntegrationsTwitterIntegrationIdRequest withBody(TwitterIntegrationRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public ApiRequest<TwitterIntegrationRequest> withHttpInfo() {
	...
	public static Builder builder(String integrationId, TwitterIntegrationRequest body) {
	    return new Builder()
	...
	public static class Builder {
		...
		public Builder withRequiredParams(String integrationId, TwitterIntegrationRequest body) {
			request.setIntegrationId(integrationId);
						request.setBody(body);
