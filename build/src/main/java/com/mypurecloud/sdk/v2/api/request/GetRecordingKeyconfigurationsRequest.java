...
public class GetRecordingKeyconfigurationsRequest {
    ...
    public GetRecordingKeyconfigurationsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/recording/keyconfigurations")
	...
	public static class Builder {
		private final GetRecordingKeyconfigurationsRequest request;

		private Builder() {
			request = new GetRecordingKeyconfigurationsRequest();
		}
		...
		public GetRecordingKeyconfigurationsRequest build() {
