...
public class PutWorkforcemanagementSchedulebidPreferenceRequest {
	...
	public PutWorkforcemanagementSchedulebidPreferenceRequest withBidId(String bidId) {
	    this.setBidId(bidId);
	    return this;
	} 

	private UpdateAgentScheduleBiddingPreference body;
	public UpdateAgentScheduleBiddingPreference getBody() {
		return this.body;
	}

	public void setBody(UpdateAgentScheduleBiddingPreference body) {
		this.body = body;
	}

	public PutWorkforcemanagementSchedulebidPreferenceRequest withBody(UpdateAgentScheduleBiddingPreference body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutWorkforcemanagementSchedulebidPreferenceRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<UpdateAgentScheduleBiddingPreference> withHttpInfo() {
        
        // verify the required parameter 'bidId' is set
        if (this.bidId == null) {
            throw new IllegalStateException("Missing the required parameter 'bidId' when building request for PutWorkforcemanagementSchedulebidPreferenceRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutWorkforcemanagementSchedulebidPreferenceRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/workforcemanagement/schedulebids/{bidId}/preference")
	...
	public static Builder builder(String bidId, UpdateAgentScheduleBiddingPreference body) {
	    return new Builder()
	...
	public static class Builder {
		private final PutWorkforcemanagementSchedulebidPreferenceRequest request;

		private Builder() {
			request = new PutWorkforcemanagementSchedulebidPreferenceRequest();
		}
		...
		public Builder withBody(UpdateAgentScheduleBiddingPreference body) {
		...
		public Builder withRequiredParams(String bidId, UpdateAgentScheduleBiddingPreference body) {
			request.setBidId(bidId);
			request.setBody(body);
		...
		public PutWorkforcemanagementSchedulebidPreferenceRequest build() {
