...
public class GetWorkforcemanagementBusinessunitAlternativeshiftsTradesSearchJobRequest {
	...
	public GetWorkforcemanagementBusinessunitAlternativeshiftsTradesSearchJobRequest withBusinessUnitId(String businessUnitId) {
	...
	public GetWorkforcemanagementBusinessunitAlternativeshiftsTradesSearchJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetWorkforcemanagementBusinessunitAlternativeshiftsTradesSearchJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for GetWorkforcemanagementBusinessunitAlternativeshiftsTradesSearchJobRequest.");
        }
        
        // verify the required parameter 'jobId' is set
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetWorkforcemanagementBusinessunitAlternativeshiftsTradesSearchJobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/alternativeshifts/trades/search/jobs/{jobId}")
	...
	public static class Builder {
		private final GetWorkforcemanagementBusinessunitAlternativeshiftsTradesSearchJobRequest request;

		private Builder() {
			request = new GetWorkforcemanagementBusinessunitAlternativeshiftsTradesSearchJobRequest();
		}
		...
		public GetWorkforcemanagementBusinessunitAlternativeshiftsTradesSearchJobRequest build() {
