...
public class QueueConversationVideoEventTopicScreenMonitoring  implements Serializable {
 ...
 @JsonDeserialize(using = MonitoringTypeEnumDeserializer.class)
  ...
  public QueueConversationVideoEventTopicScreenMonitoring() {
   ...
   **/
  public QueueConversationVideoEventTopicScreenMonitoring id(String id) {
    this.id = id;
    return this;
  }
  ...
  /**
   **/
  public QueueConversationVideoEventTopicScreenMonitoring state(StateEnum state) {
    this.state = state;
    return this;
  }
  ...
  /**
   **/
  public QueueConversationVideoEventTopicScreenMonitoring initialState(InitialStateEnum initialState) {
   ...
   * The source provider.
   **/
  public QueueConversationVideoEventTopicScreenMonitoring provider(String provider) {
   ...
   * System defined string indicating what caused the communication to disconnect. Will be null until the communication disconnects.
   **/
  public QueueConversationVideoEventTopicScreenMonitoring disconnectType(DisconnectTypeEnum disconnectType) {
   ...
   **/
  public QueueConversationVideoEventTopicScreenMonitoring connectedTime(Date connectedTime) {
   ...
   **/
  public QueueConversationVideoEventTopicScreenMonitoring disconnectedTime(Date disconnectedTime) {
   ...
   **/
  public QueueConversationVideoEventTopicScreenMonitoring targetUserId(String targetUserId) {
   ...
   **/
  public QueueConversationVideoEventTopicScreenMonitoring screenMonitoringId(String screenMonitoringId) {
   ...
   * The screen monitoring type.
   **/
  public QueueConversationVideoEventTopicScreenMonitoring monitoringType(MonitoringTypeEnum monitoringType) {
   ...
   **/
  public QueueConversationVideoEventTopicScreenMonitoring count(Long count) {
    this.count = count;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    QueueConversationVideoEventTopicScreenMonitoring queueConversationVideoEventTopicScreenMonitoring = (QueueConversationVideoEventTopicScreenMonitoring) o;

    return Objects.equals(this.id, queueConversationVideoEventTopicScreenMonitoring.id) &&
            Objects.equals(this.state, queueConversationVideoEventTopicScreenMonitoring.state) &&
            Objects.equals(this.initialState, queueConversationVideoEventTopicScreenMonitoring.initialState) &&
            Objects.equals(this.provider, queueConversationVideoEventTopicScreenMonitoring.provider) &&
            Objects.equals(this.disconnectType, queueConversationVideoEventTopicScreenMonitoring.disconnectType) &&
            Objects.equals(this.connectedTime, queueConversationVideoEventTopicScreenMonitoring.connectedTime) &&
            Objects.equals(this.disconnectedTime, queueConversationVideoEventTopicScreenMonitoring.disconnectedTime) &&
            Objects.equals(this.targetUserId, queueConversationVideoEventTopicScreenMonitoring.targetUserId) &&
            Objects.equals(this.screenMonitoringId, queueConversationVideoEventTopicScreenMonitoring.screenMonitoringId) &&
            Objects.equals(this.monitoringType, queueConversationVideoEventTopicScreenMonitoring.monitoringType) &&
            Objects.equals(this.count, queueConversationVideoEventTopicScreenMonitoring.count);
  }
  ...
  public String toString() {
    ...
    sb.append("class QueueConversationVideoEventTopicScreenMonitoring {\n");
