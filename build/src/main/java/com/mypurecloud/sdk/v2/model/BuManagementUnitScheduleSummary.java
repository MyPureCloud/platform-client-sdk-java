...
public class BuManagementUnitScheduleSummary  implements Serializable {
  ...
  @ApiModelProperty(example = "null", value = "The start of the schedule change in the management unit. Only populated in schedule update notifications. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss.SSSZ")
  ...
  @ApiModelProperty(example = "null", value = "The end of the schedule change in the management unit. Only populated in schedule update notifications. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss.SSSZ")
