...
public class PostExternalcontactsBulkOrganizationsRequest {
	...
	public PostExternalcontactsBulkOrganizationsRequest withBody(BulkIdsRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostExternalcontactsBulkOrganizationsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<BulkIdsRequest> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostExternalcontactsBulkOrganizationsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/externalcontacts/bulk/organizations")
                .withBody(body)
	...
	public static class Builder {
		private final PostExternalcontactsBulkOrganizationsRequest request;

		private Builder() {
			request = new PostExternalcontactsBulkOrganizationsRequest();
		}
		...
		public PostExternalcontactsBulkOrganizationsRequest build() {
