...
public class EvaluationAsyncAggregationQuery  implements Serializable {
 ...
 @JsonDeserialize(using = MetricsEnumDeserializer.class)
  ...
  private List<EvaluationAggregationView> views = new ArrayList<EvaluationAggregationView>();
 ...
 @JsonDeserialize(using = AlternateTimeDimensionEnumDeserializer.class)
   ...
   **/
  public EvaluationAsyncAggregationQuery interval(String interval) {
   ...
   **/
  public EvaluationAsyncAggregationQuery granularity(String granularity) {
   ...
   **/
  public EvaluationAsyncAggregationQuery timeZone(String timeZone) {
   ...
   **/
  public EvaluationAsyncAggregationQuery groupBy(List<GroupByEnum> groupBy) {
   ...
   **/
  public EvaluationAsyncAggregationQuery filter(EvaluationAggregateQueryFilter filter) {
    this.filter = filter;
    return this;
  }
   ...
   **/
  public EvaluationAsyncAggregationQuery metrics(List<MetricsEnum> metrics) {
   ...
   **/
  public EvaluationAsyncAggregationQuery flattenMultivaluedDimensions(Boolean flattenMultivaluedDimensions) {
   ...
   **/
  public EvaluationAsyncAggregationQuery views(List<EvaluationAggregationView> views) {
    this.views = views;
    return this;
  }
   ...
   * Dimension to use as the alternative timestamp for data in the aggregate.  Choosing \"eventTime\" uses the actual time of the data event.
   **/
  public EvaluationAsyncAggregationQuery alternateTimeDimension(AlternateTimeDimensionEnum alternateTimeDimension) {
   ...
   **/
  public EvaluationAsyncAggregationQuery pageSize(Integer pageSize) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EvaluationAsyncAggregationQuery evaluationAsyncAggregationQuery = (EvaluationAsyncAggregationQuery) o;

    return Objects.equals(this.interval, evaluationAsyncAggregationQuery.interval) &&
            Objects.equals(this.granularity, evaluationAsyncAggregationQuery.granularity) &&
            Objects.equals(this.timeZone, evaluationAsyncAggregationQuery.timeZone) &&
            Objects.equals(this.groupBy, evaluationAsyncAggregationQuery.groupBy) &&
            Objects.equals(this.filter, evaluationAsyncAggregationQuery.filter) &&
            Objects.equals(this.metrics, evaluationAsyncAggregationQuery.metrics) &&
            Objects.equals(this.flattenMultivaluedDimensions, evaluationAsyncAggregationQuery.flattenMultivaluedDimensions) &&
            Objects.equals(this.views, evaluationAsyncAggregationQuery.views) &&
            Objects.equals(this.alternateTimeDimension, evaluationAsyncAggregationQuery.alternateTimeDimension) &&
            Objects.equals(this.pageSize, evaluationAsyncAggregationQuery.pageSize);
  }
