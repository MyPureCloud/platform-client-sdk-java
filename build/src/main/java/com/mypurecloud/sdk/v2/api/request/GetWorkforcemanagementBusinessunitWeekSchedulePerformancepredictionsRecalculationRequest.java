...
public class GetWorkforcemanagementBusinessunitWeekSchedulePerformancepredictionsRecalculationRequest {
	...
	private String recalculationId;
	public String getRecalculationId() {
		return this.recalculationId;
	}

	public void setRecalculationId(String recalculationId) {
	...
	public GetWorkforcemanagementBusinessunitWeekSchedulePerformancepredictionsRecalculationRequest withRecalculationId(String recalculationId) {
	    this.setRecalculationId(recalculationId);
	    return this;
	} 
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for GetWorkforcemanagementBusinessunitWeekSchedulePerformancepredictionsRecalculationRequest.");
        }
        
        // verify the required parameter 'weekId' is set
        if (this.weekId == null) {
            throw new IllegalStateException("Missing the required parameter 'weekId' when building request for GetWorkforcemanagementBusinessunitWeekSchedulePerformancepredictionsRecalculationRequest.");
        }
        
        // verify the required parameter 'scheduleId' is set
        if (this.scheduleId == null) {
            throw new IllegalStateException("Missing the required parameter 'scheduleId' when building request for GetWorkforcemanagementBusinessunitWeekSchedulePerformancepredictionsRecalculationRequest.");
        }
        
        // verify the required parameter 'recalculationId' is set
        if (this.recalculationId == null) {
            throw new IllegalStateException("Missing the required parameter 'recalculationId' when building request for GetWorkforcemanagementBusinessunitWeekSchedulePerformancepredictionsRecalculationRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/weeks/{weekId}/schedules/{scheduleId}/performancepredictions/recalculations/{recalculationId}")
                ...
                .withPathParameter("recalculationId", recalculationId)
	...
	public static Builder builder(String businessUnitId, String weekId, String scheduleId, String recalculationId) {
	    return new Builder()
	            .withRequiredParams(businessUnitId, weekId, scheduleId, recalculationId);
	}


	public static class Builder {
		private final GetWorkforcemanagementBusinessunitWeekSchedulePerformancepredictionsRecalculationRequest request;

		private Builder() {
			request = new GetWorkforcemanagementBusinessunitWeekSchedulePerformancepredictionsRecalculationRequest();
		}
		...
		public Builder withRecalculationId(String recalculationId) {
			request.setRecalculationId(recalculationId);
			return this;
		}



		public Builder withRequiredParams(String businessUnitId, String weekId, String scheduleId, String recalculationId) {
			request.setBusinessUnitId(businessUnitId);
			request.setWeekId(weekId);
			request.setScheduleId(scheduleId);
			request.setRecalculationId(recalculationId);
		...
		public GetWorkforcemanagementBusinessunitWeekSchedulePerformancepredictionsRecalculationRequest build() {
            ...
            // verify the required parameter 'recalculationId' is set
            if (request.recalculationId == null) {
                throw new IllegalStateException("Missing the required parameter 'recalculationId' when building request for GetWorkforcemanagementBusinessunitWeekSchedulePerformancepredictionsRecalculationRequest.");
            }
