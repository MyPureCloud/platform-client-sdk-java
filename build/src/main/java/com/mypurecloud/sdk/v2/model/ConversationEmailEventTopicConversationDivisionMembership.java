...
public class ConversationEmailEventTopicConversationDivisionMembership  implements Serializable {
  ...
  private List<ConversationEmailEventTopicDivisionEntityRef> entities = null;

  public ConversationEmailEventTopicConversationDivisionMembership() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
      entities = new ArrayList<ConversationEmailEventTopicDivisionEntityRef>();
    }
  }

  public ConversationEmailEventTopicConversationDivisionMembership(Boolean initWithEmptyList) {
