...
public class PatchChatsUsersMeSettingsRequest {
    ...
    public PatchChatsUsersMeSettingsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<UserSettingsForChat> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchChatsUsersMeSettingsRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/chats/users/me/settings")
                .withBody(body)
	...
	public static class Builder {
		private final PatchChatsUsersMeSettingsRequest request;

		private Builder() {
			request = new PatchChatsUsersMeSettingsRequest();
		}
		...
		public PatchChatsUsersMeSettingsRequest build() {
