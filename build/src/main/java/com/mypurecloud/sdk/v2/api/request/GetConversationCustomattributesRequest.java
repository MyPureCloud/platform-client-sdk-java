...
public class GetConversationCustomattributesRequest {
	...
	public GetConversationCustomattributesRequest withConversationId(String conversationId) {
    ...
    public GetConversationCustomattributesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for GetConversationCustomattributesRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/conversations/{conversationId}/customattributes")
	...
	public static class Builder {
		private final GetConversationCustomattributesRequest request;

		private Builder() {
			request = new GetConversationCustomattributesRequest();
		}
		...
		public GetConversationCustomattributesRequest build() {
