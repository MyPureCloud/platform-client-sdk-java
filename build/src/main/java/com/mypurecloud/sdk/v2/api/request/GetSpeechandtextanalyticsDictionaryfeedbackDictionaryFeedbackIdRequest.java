...
public class GetSpeechandtextanalyticsDictionaryfeedbackDictionaryFeedbackIdRequest {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.dictionaryFeedbackId == null) {
            throw new IllegalStateException("Missing the required parameter 'dictionaryFeedbackId' when building request for GetSpeechandtextanalyticsDictionaryfeedbackDictionaryFeedbackIdRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/speechandtextanalytics/dictionaryfeedback/{dictionaryFeedbackId}")
	...
	public static class Builder {
		private final GetSpeechandtextanalyticsDictionaryfeedbackDictionaryFeedbackIdRequest request;

		private Builder() {
			request = new GetSpeechandtextanalyticsDictionaryfeedbackDictionaryFeedbackIdRequest();
		}
		...
		public GetSpeechandtextanalyticsDictionaryfeedbackDictionaryFeedbackIdRequest build() {
