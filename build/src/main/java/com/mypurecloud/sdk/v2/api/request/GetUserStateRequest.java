...
public class GetUserStateRequest {
	...
	public GetUserStateRequest withUserId(String userId) {
    ...
    public GetUserStateRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.userId == null) {
            throw new IllegalStateException("Missing the required parameter 'userId' when building request for GetUserStateRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/users/{userId}/state")
	...
	public static class Builder {
		private final GetUserStateRequest request;

		private Builder() {
			request = new GetUserStateRequest();
		}
		...
		public GetUserStateRequest build() {
