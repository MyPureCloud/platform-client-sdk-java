...
public class GetGroupIndividualsRequest {
	...
	public GetGroupIndividualsRequest withGroupId(String groupId) {
    ...
    public GetGroupIndividualsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.groupId == null) {
            throw new IllegalStateException("Missing the required parameter 'groupId' when building request for GetGroupIndividualsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/groups/{groupId}/individuals")
	...
	public static class Builder {
		private final GetGroupIndividualsRequest request;

		private Builder() {
			request = new GetGroupIndividualsRequest();
		}
		...
		public GetGroupIndividualsRequest build() {
