...
public class DeleteFlowsInstancesSettingsLoglevelsDefaultRequest {
    ...
    public DeleteFlowsInstancesSettingsLoglevelsDefaultRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("DELETE", "/api/v2/flows/instances/settings/loglevels/default")
	...
	public static class Builder {
		private final DeleteFlowsInstancesSettingsLoglevelsDefaultRequest request;

		private Builder() {
			request = new DeleteFlowsInstancesSettingsLoglevelsDefaultRequest();
		}
		...
		public DeleteFlowsInstancesSettingsLoglevelsDefaultRequest build() {
