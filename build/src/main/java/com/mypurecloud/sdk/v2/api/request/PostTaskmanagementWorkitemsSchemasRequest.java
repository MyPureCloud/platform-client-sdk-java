...
public class PostTaskmanagementWorkitemsSchemasRequest {
	...
	public PostTaskmanagementWorkitemsSchemasRequest withBody(DataSchema body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostTaskmanagementWorkitemsSchemasRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<DataSchema> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostTaskmanagementWorkitemsSchemasRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/taskmanagement/workitems/schemas")
                .withBody(body)
	...
	public static class Builder {
		private final PostTaskmanagementWorkitemsSchemasRequest request;

		private Builder() {
			request = new PostTaskmanagementWorkitemsSchemasRequest();
		}
		...
		public PostTaskmanagementWorkitemsSchemasRequest build() {
