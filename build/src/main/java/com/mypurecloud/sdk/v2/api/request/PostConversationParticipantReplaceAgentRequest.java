...
public class PostConversationParticipantReplaceAgentRequest {
    ...
    public ApiRequest<TransferToAgentRequest> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("POST", "/api/v2/conversations/{conversationId}/participants/{participantId}/replace/agent")
	...
	public static class Builder {
		private final PostConversationParticipantReplaceAgentRequest request;

		private Builder() {
			request = new PostConversationParticipantReplaceAgentRequest();
		}
