...
public class PostCasemanagementCasesQueryJobsRequest {

	private CaseQueryJobCreate body;
	public CaseQueryJobCreate getBody() {
		return this.body;
	}

	public void setBody(CaseQueryJobCreate body) {
		this.body = body;
	}

	public PostCasemanagementCasesQueryJobsRequest withBody(CaseQueryJobCreate body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostCasemanagementCasesQueryJobsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<CaseQueryJobCreate> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostCasemanagementCasesQueryJobsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/casemanagement/cases/query/jobs")
                .withBody(body)
	...
	public static Builder builder(CaseQueryJobCreate body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostCasemanagementCasesQueryJobsRequest request;

		private Builder() {
			request = new PostCasemanagementCasesQueryJobsRequest();
		}


		public Builder withBody(CaseQueryJobCreate body) {
		...
		public Builder withRequiredParams(CaseQueryJobCreate body) {
			request.setBody(body);
		...
		public PostCasemanagementCasesQueryJobsRequest build() {
