...
public class GetSpeechandtextanalyticsConversationSummariesRequest {
	...
	public GetSpeechandtextanalyticsConversationSummariesRequest withConversationId(String conversationId) {
    ...
    public GetSpeechandtextanalyticsConversationSummariesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for GetSpeechandtextanalyticsConversationSummariesRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/speechandtextanalytics/conversations/{conversationId}/summaries")
	...
	public static class Builder {
		private final GetSpeechandtextanalyticsConversationSummariesRequest request;

		private Builder() {
			request = new GetSpeechandtextanalyticsConversationSummariesRequest();
		}
		...
		public GetSpeechandtextanalyticsConversationSummariesRequest build() {
