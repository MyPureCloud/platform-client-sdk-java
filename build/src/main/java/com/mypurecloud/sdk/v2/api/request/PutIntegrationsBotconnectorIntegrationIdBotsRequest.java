...
public class PutIntegrationsBotconnectorIntegrationIdBotsRequest {
	...
	public PutIntegrationsBotconnectorIntegrationIdBotsRequest withIntegrationId(String integrationId) {
    ...
    public ApiRequest<BotList> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("PUT", "/api/v2/integrations/botconnector/{integrationId}/bots")
	...
	public static Builder builder(String integrationId, BotList botList) {
	    return new Builder()
	            .withRequiredParams(integrationId, botList);
	}
	...
	public static class Builder {
		...
		private Builder() {
			request = new PutIntegrationsBotconnectorIntegrationIdBotsRequest();
		}
		...
		public Builder withBotList(BotList botList) {
			request.setBotList(botList);
			return this;
		}
		

		
		public Builder withRequiredParams(String integrationId, BotList botList) {
			request.setIntegrationId(integrationId);
						request.setBotList(botList);
