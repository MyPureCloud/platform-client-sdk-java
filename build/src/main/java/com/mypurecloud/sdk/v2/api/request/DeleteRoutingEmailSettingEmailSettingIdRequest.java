...
public class DeleteRoutingEmailSettingEmailSettingIdRequest {
	...
	public DeleteRoutingEmailSettingEmailSettingIdRequest withEmailSettingId(String emailSettingId) {
    ...
    public DeleteRoutingEmailSettingEmailSettingIdRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.emailSettingId == null) {
            throw new IllegalStateException("Missing the required parameter 'emailSettingId' when building request for DeleteRoutingEmailSettingEmailSettingIdRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/routing/email/setting/{emailSettingId}")
	...
	public static Builder builder(String emailSettingId) {
	    return new Builder()
	            .withRequiredParams(emailSettingId);
	}


	public static class Builder {
		private final DeleteRoutingEmailSettingEmailSettingIdRequest request;

		private Builder() {
			request = new DeleteRoutingEmailSettingEmailSettingIdRequest();
		}
		...
		public Builder withRequiredParams(String emailSettingId) {
			request.setEmailSettingId(emailSettingId);
		...
		public DeleteRoutingEmailSettingEmailSettingIdRequest build() {
