...
public class DeleteOutboundDnclistPhonenumbersRequest {
	...
	public DeleteOutboundDnclistPhonenumbersRequest withDncListId(String dncListId) {
	...
	public DeleteOutboundDnclistPhonenumbersRequest withExpiredOnly(Boolean expiredOnly) {
    ...
    public DeleteOutboundDnclistPhonenumbersRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.dncListId == null) {
            throw new IllegalStateException("Missing the required parameter 'dncListId' when building request for DeleteOutboundDnclistPhonenumbersRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/outbound/dnclists/{dncListId}/phonenumbers")
	...
	public static class Builder {
		private final DeleteOutboundDnclistPhonenumbersRequest request;

		private Builder() {
			request = new DeleteOutboundDnclistPhonenumbersRequest();
		}
		...
		public DeleteOutboundDnclistPhonenumbersRequest build() {
