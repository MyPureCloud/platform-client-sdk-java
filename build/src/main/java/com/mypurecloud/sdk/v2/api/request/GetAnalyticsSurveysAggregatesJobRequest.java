...
public class GetAnalyticsSurveysAggregatesJobRequest {
	...
	public GetAnalyticsSurveysAggregatesJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetAnalyticsSurveysAggregatesJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetAnalyticsSurveysAggregatesJobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/analytics/surveys/aggregates/jobs/{jobId}")
	...
	public static class Builder {
		private final GetAnalyticsSurveysAggregatesJobRequest request;

		private Builder() {
			request = new GetAnalyticsSurveysAggregatesJobRequest();
		}
		...
		public GetAnalyticsSurveysAggregatesJobRequest build() {
