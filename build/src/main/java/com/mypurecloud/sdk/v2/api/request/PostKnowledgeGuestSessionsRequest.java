...
public class PostKnowledgeGuestSessionsRequest {

	private KnowledgeGuestSession body;
	public KnowledgeGuestSession getBody() {
		return this.body;
	}

	public void setBody(KnowledgeGuestSession body) {
		this.body = body;
	}

	public PostKnowledgeGuestSessionsRequest withBody(KnowledgeGuestSession body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostKnowledgeGuestSessionsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<KnowledgeGuestSession> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostKnowledgeGuestSessionsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/knowledge/guest/sessions")
                .withBody(body)
	...
	public static Builder builder(KnowledgeGuestSession body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostKnowledgeGuestSessionsRequest request;

		private Builder() {
			request = new PostKnowledgeGuestSessionsRequest();
		}


		public Builder withBody(KnowledgeGuestSession body) {
		...
		public Builder withRequiredParams(KnowledgeGuestSession body) {
			request.setBody(body);
		...
		public PostKnowledgeGuestSessionsRequest build() {
