...
public class PatchRoutingEmailOutboundDomainRequest {
	...
	public PatchRoutingEmailOutboundDomainRequest withBody(OutboundDomain body) {
	    this.setBody(body);
	    return this;
	} 
	...
	public static Builder builder(String domainId, OutboundDomain body) {
	    return new Builder()
	...
	public static class Builder {
		...
		public Builder withRequiredParams(String domainId, OutboundDomain body) {
			request.setDomainId(domainId);
						request.setBody(body);
