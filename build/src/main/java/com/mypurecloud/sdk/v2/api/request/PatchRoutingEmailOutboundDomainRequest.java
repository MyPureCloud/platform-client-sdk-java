...
public class PatchRoutingEmailOutboundDomainRequest {
	...
	public PatchRoutingEmailOutboundDomainRequest withDomainId(String domainId) {
	    this.setDomainId(domainId);
	    return this;
	} 

	private OutboundDomainPatchRequest body;
	public OutboundDomainPatchRequest getBody() {
		return this.body;
	}

	public void setBody(OutboundDomainPatchRequest body) {
		this.body = body;
	}

	public PatchRoutingEmailOutboundDomainRequest withBody(OutboundDomainPatchRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchRoutingEmailOutboundDomainRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<OutboundDomainPatchRequest> withHttpInfo() {
        
        // verify the required parameter 'domainId' is set
        if (this.domainId == null) {
            throw new IllegalStateException("Missing the required parameter 'domainId' when building request for PatchRoutingEmailOutboundDomainRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchRoutingEmailOutboundDomainRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/routing/email/outbound/domains/{domainId}")
	...
	public static Builder builder(String domainId, OutboundDomainPatchRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PatchRoutingEmailOutboundDomainRequest request;

		private Builder() {
			request = new PatchRoutingEmailOutboundDomainRequest();
		}
		...
		public Builder withBody(OutboundDomainPatchRequest body) {
		...
		public Builder withRequiredParams(String domainId, OutboundDomainPatchRequest body) {
			request.setDomainId(domainId);
			request.setBody(body);
		...
		public PatchRoutingEmailOutboundDomainRequest build() {
