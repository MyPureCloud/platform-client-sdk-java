...
public class PostOutboundSequencesRequest {
    ...
    public ApiRequest<CampaignSequence> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostOutboundSequencesRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/outbound/sequences")
                .withBody(body)
	...
	public static class Builder {
		private final PostOutboundSequencesRequest request;

		private Builder() {
			request = new PostOutboundSequencesRequest();
		}
