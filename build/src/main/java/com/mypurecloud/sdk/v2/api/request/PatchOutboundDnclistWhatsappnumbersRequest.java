...
public class PatchOutboundDnclistWhatsappnumbersRequest {
	...
	public PatchOutboundDnclistWhatsappnumbersRequest withDncListId(String dncListId) {
	    this.setDncListId(dncListId);
	    return this;
	} 

	private DncPatchWhatsAppNumbersRequest body;
	public DncPatchWhatsAppNumbersRequest getBody() {
		return this.body;
	}

	public void setBody(DncPatchWhatsAppNumbersRequest body) {
		this.body = body;
	}

	public PatchOutboundDnclistWhatsappnumbersRequest withBody(DncPatchWhatsAppNumbersRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchOutboundDnclistWhatsappnumbersRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<DncPatchWhatsAppNumbersRequest> withHttpInfo() {
        
        // verify the required parameter 'dncListId' is set
        if (this.dncListId == null) {
            throw new IllegalStateException("Missing the required parameter 'dncListId' when building request for PatchOutboundDnclistWhatsappnumbersRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchOutboundDnclistWhatsappnumbersRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/outbound/dnclists/{dncListId}/whatsappnumbers")
	...
	public static Builder builder(String dncListId, DncPatchWhatsAppNumbersRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PatchOutboundDnclistWhatsappnumbersRequest request;

		private Builder() {
			request = new PatchOutboundDnclistWhatsappnumbersRequest();
		}
		...
		public Builder withBody(DncPatchWhatsAppNumbersRequest body) {
		...
		public Builder withRequiredParams(String dncListId, DncPatchWhatsAppNumbersRequest body) {
			request.setDncListId(dncListId);
			request.setBody(body);
		...
		public PatchOutboundDnclistWhatsappnumbersRequest build() {
