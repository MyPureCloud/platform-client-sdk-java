...
public class PutConversationsCallParticipantCommunicationUuidataRequest {
	...
	public void setBody(SetUuiDataRequest body) {
		this.body = body;
	}
    ...
    public PutConversationsCallParticipantCommunicationUuidataRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<SetUuiDataRequest> withHttpInfo() {
        
        // verify the required parameter 'conversationId' is set
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PutConversationsCallParticipantCommunicationUuidataRequest.");
        }
        
        // verify the required parameter 'participantId' is set
        if (this.participantId == null) {
            throw new IllegalStateException("Missing the required parameter 'participantId' when building request for PutConversationsCallParticipantCommunicationUuidataRequest.");
        }
        
        // verify the required parameter 'communicationId' is set
        if (this.communicationId == null) {
            throw new IllegalStateException("Missing the required parameter 'communicationId' when building request for PutConversationsCallParticipantCommunicationUuidataRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutConversationsCallParticipantCommunicationUuidataRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/conversations/calls/{conversationId}/participants/{participantId}/communications/{communicationId}/uuidata")
	...
	public static Builder builder(String conversationId, String participantId, String communicationId, SetUuiDataRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PutConversationsCallParticipantCommunicationUuidataRequest request;

		private Builder() {
			request = new PutConversationsCallParticipantCommunicationUuidataRequest();
		}
		...
		public Builder withBody(SetUuiDataRequest body) {
		...
		public Builder withRequiredParams(String conversationId, String participantId, String communicationId, SetUuiDataRequest body) {
			request.setConversationId(conversationId);
						request.setParticipantId(participantId);
						request.setCommunicationId(communicationId);
						request.setBody(body);
