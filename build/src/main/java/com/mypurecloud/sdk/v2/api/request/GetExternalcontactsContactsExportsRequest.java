...
public class GetExternalcontactsContactsExportsRequest {
	...
	public GetExternalcontactsContactsExportsRequest withDivisionIds(List<String> divisionIds) {
	...
	public GetExternalcontactsContactsExportsRequest withAfter(String after) {
	    this.setAfter(after);
	    return this;
	} 
	...
	public GetExternalcontactsContactsExportsRequest withPageSize(Integer pageSize) {
    ...
    public GetExternalcontactsContactsExportsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/externalcontacts/contacts/exports")
	...
	public static class Builder {
		private final GetExternalcontactsContactsExportsRequest request;

		private Builder() {
			request = new GetExternalcontactsContactsExportsRequest();
		}
		...
		public GetExternalcontactsContactsExportsRequest build() {
