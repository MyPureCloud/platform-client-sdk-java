...
public class PatchFlowsInstancesSettingsExecutiondataRequest {
	...
	public PatchFlowsInstancesSettingsExecutiondataRequest withBody(ExecutionDataSettingsRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchFlowsInstancesSettingsExecutiondataRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<ExecutionDataSettingsRequest> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchFlowsInstancesSettingsExecutiondataRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/flows/instances/settings/executiondata")
                .withBody(body)
	...
	public static class Builder {
		private final PatchFlowsInstancesSettingsExecutiondataRequest request;

		private Builder() {
			request = new PatchFlowsInstancesSettingsExecutiondataRequest();
		}
		...
		public PatchFlowsInstancesSettingsExecutiondataRequest build() {
