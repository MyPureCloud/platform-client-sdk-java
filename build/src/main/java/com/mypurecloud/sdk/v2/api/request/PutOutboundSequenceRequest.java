...
public class PutOutboundSequenceRequest {
	...
	public PutOutboundSequenceRequest withSequenceId(String sequenceId) {
	...
	public PutOutboundSequenceRequest withBody(CampaignSequence body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutOutboundSequenceRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<CampaignSequence> withHttpInfo() {
        
        // verify the required parameter 'sequenceId' is set
        if (this.sequenceId == null) {
            throw new IllegalStateException("Missing the required parameter 'sequenceId' when building request for PutOutboundSequenceRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutOutboundSequenceRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/outbound/sequences/{sequenceId}")
