...
public class PatchWorkforcemanagementBusinessunitServicegoaltemplateRequest {
	...
	public void setBody(UpdateServiceGoalTemplate body) {
		this.body = body;
	}
	...
	public static class Builder {
		...
		private Builder() {
			request = new PatchWorkforcemanagementBusinessunitServicegoaltemplateRequest();
		}
		...
		public Builder withBody(UpdateServiceGoalTemplate body) {
