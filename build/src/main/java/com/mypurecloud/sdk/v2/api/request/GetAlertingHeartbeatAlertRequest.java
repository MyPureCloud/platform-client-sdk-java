...
public class GetAlertingHeartbeatAlertRequest {
	...
	public GetAlertingHeartbeatAlertRequest withAlertId(String alertId) {
	...
	public GetAlertingHeartbeatAlertRequest withExpand(List<String> expand) {
    ...
    public GetAlertingHeartbeatAlertRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/alerting/heartbeat/alerts/{alertId}")
	...
	public static class Builder {
		private final GetAlertingHeartbeatAlertRequest request;

		private Builder() {
			request = new GetAlertingHeartbeatAlertRequest();
		}
		...
		public GetAlertingHeartbeatAlertRequest build() {
