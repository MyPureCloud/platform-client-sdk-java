...
public class GetRoutingEmailOutboundDomainsRequest {
	...
	public GetRoutingEmailOutboundDomainsRequest withExpand(String expand) {
    ...
    public GetRoutingEmailOutboundDomainsRequest withCustomHeader(String name, String value) {
	...
	public static class Builder {
		private final GetRoutingEmailOutboundDomainsRequest request;
		...
		public GetRoutingEmailOutboundDomainsRequest build() {
