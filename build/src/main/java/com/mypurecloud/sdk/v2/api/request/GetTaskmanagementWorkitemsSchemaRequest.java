...
public class GetTaskmanagementWorkitemsSchemaRequest {
	...
	public GetTaskmanagementWorkitemsSchemaRequest withSchemaId(String schemaId) {
    ...
    public GetTaskmanagementWorkitemsSchemaRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.schemaId == null) {
            throw new IllegalStateException("Missing the required parameter 'schemaId' when building request for GetTaskmanagementWorkitemsSchemaRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/taskmanagement/workitems/schemas/{schemaId}")
	...
	public static class Builder {
		private final GetTaskmanagementWorkitemsSchemaRequest request;

		private Builder() {
			request = new GetTaskmanagementWorkitemsSchemaRequest();
		}
		...
		public GetTaskmanagementWorkitemsSchemaRequest build() {
