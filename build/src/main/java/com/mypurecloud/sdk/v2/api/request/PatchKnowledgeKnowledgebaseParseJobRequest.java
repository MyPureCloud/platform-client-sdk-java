...
public class PatchKnowledgeKnowledgebaseParseJobRequest {
    ...
    public ApiRequest<KnowledgeParseJobRequestPatch> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("PATCH", "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/parse/jobs/{parseJobId}")
	...
	public static class Builder {
		private final PatchKnowledgeKnowledgebaseParseJobRequest request;

		private Builder() {
			request = new PatchKnowledgeKnowledgebaseParseJobRequest();
		}
