...
public class GetRoutingMessageRecipientRequest {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/routing/message/recipients/{recipientId}")
	...
	public static Builder builder(String recipientId) {
	    return new Builder()
	            .withRequiredParams(recipientId);
	}
	

	public static class Builder {
		private final GetRoutingMessageRecipientRequest request;

		private Builder() {
			request = new GetRoutingMessageRecipientRequest();
		}
