...
public class WorkbinQuerySort  implements Serializable {
 ...
 @JsonDeserialize(using = NameEnumDeserializer.class)
  ...
  public WorkbinQuerySort() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
    }
  }

  public WorkbinQuerySort(Boolean initWithEmptyList) {
   ...
   * Specify an attribute for sorting. It's possible to use an attribute both for sorting and in the query at the same time, but these restrictions apply: Only the operators EQ, LT, LTE, GT, GTE, BETWEEN and BEGINS_WITH are supported and the attribute can't be present in more than one filter.
   **/
  public WorkbinQuerySort name(NameEnum name) {
    this.name = name;
    return this;
  }
   ...
   * Sort Ascending
   **/
  public WorkbinQuerySort ascending(Boolean ascending) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    WorkbinQuerySort workbinQuerySort = (WorkbinQuerySort) o;

    return Objects.equals(this.name, workbinQuerySort.name) &&
            Objects.equals(this.ascending, workbinQuerySort.ascending);
  }
