...
public class DeleteAlertingAlertRequest {
	...
	public DeleteAlertingAlertRequest withAlertId(String alertId) {
    ...
    public DeleteAlertingAlertRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.alertId == null) {
            throw new IllegalStateException("Missing the required parameter 'alertId' when building request for DeleteAlertingAlertRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/alerting/alerts/{alertId}")
	...
	public static class Builder {
		private final DeleteAlertingAlertRequest request;

		private Builder() {
			request = new DeleteAlertingAlertRequest();
		}
		...
		public DeleteAlertingAlertRequest build() {
