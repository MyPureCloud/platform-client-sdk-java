...
public class GetWorkforcemanagementBusinessunitWorkplanbidGroupPreferencesRequest {
	...
	public GetWorkforcemanagementBusinessunitWorkplanbidGroupPreferencesRequest withBidId(String bidId) {
	    this.setBidId(bidId);
	    return this;
	} 
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for GetWorkforcemanagementBusinessunitWorkplanbidGroupPreferencesRequest.");
        }
        
        // verify the required parameter 'bidId' is set
        if (this.bidId == null) {
            throw new IllegalStateException("Missing the required parameter 'bidId' when building request for GetWorkforcemanagementBusinessunitWorkplanbidGroupPreferencesRequest.");
        }
        
        // verify the required parameter 'bidGroupId' is set
        if (this.bidGroupId == null) {
            throw new IllegalStateException("Missing the required parameter 'bidGroupId' when building request for GetWorkforcemanagementBusinessunitWorkplanbidGroupPreferencesRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/workplanbids/{bidId}/groups/{bidGroupId}/preferences")
	...
	public static class Builder {
		private final GetWorkforcemanagementBusinessunitWorkplanbidGroupPreferencesRequest request;

		private Builder() {
			request = new GetWorkforcemanagementBusinessunitWorkplanbidGroupPreferencesRequest();
		}
		...
		public GetWorkforcemanagementBusinessunitWorkplanbidGroupPreferencesRequest build() {
