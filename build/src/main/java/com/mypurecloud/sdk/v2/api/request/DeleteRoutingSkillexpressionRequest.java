...
public class DeleteRoutingSkillexpressionRequest {
	...
	public DeleteRoutingSkillexpressionRequest withExpressionId(String expressionId) {
    ...
    public DeleteRoutingSkillexpressionRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.expressionId == null) {
            throw new IllegalStateException("Missing the required parameter 'expressionId' when building request for DeleteRoutingSkillexpressionRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/routing/skillexpressions/{expressionId}")
	...
	public static class Builder {
		private final DeleteRoutingSkillexpressionRequest request;

		private Builder() {
			request = new DeleteRoutingSkillexpressionRequest();
		}
		...
		public DeleteRoutingSkillexpressionRequest build() {
