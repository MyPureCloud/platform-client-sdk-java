...
public class DeleteWorkforcemanagementManagementunitWeekScheduleRequest {
	...
	public DeleteWorkforcemanagementManagementunitWeekScheduleRequest withManagementUnitId(String managementUnitId) {
	...
	public DeleteWorkforcemanagementManagementunitWeekScheduleRequest withWeekId(String weekId) {
	...
	public DeleteWorkforcemanagementManagementunitWeekScheduleRequest withScheduleId(String scheduleId) {
    ...
    public DeleteWorkforcemanagementManagementunitWeekScheduleRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.managementUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'managementUnitId' when building request for DeleteWorkforcemanagementManagementunitWeekScheduleRequest.");
        }
        
        // verify the required parameter 'weekId' is set
        if (this.weekId == null) {
            throw new IllegalStateException("Missing the required parameter 'weekId' when building request for DeleteWorkforcemanagementManagementunitWeekScheduleRequest.");
        }
        
        // verify the required parameter 'scheduleId' is set
        if (this.scheduleId == null) {
            throw new IllegalStateException("Missing the required parameter 'scheduleId' when building request for DeleteWorkforcemanagementManagementunitWeekScheduleRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/workforcemanagement/managementunits/{managementUnitId}/weeks/{weekId}/schedules/{scheduleId}")
	...
	public static class Builder {
		private final DeleteWorkforcemanagementManagementunitWeekScheduleRequest request;

		private Builder() {
			request = new DeleteWorkforcemanagementManagementunitWeekScheduleRequest();
		}
		...
		public DeleteWorkforcemanagementManagementunitWeekScheduleRequest build() {
