...
public class GetTelephonyProvidersEdgeLineRequest {
	...
	public GetTelephonyProvidersEdgeLineRequest withEdgeId(String edgeId) {
	...
	public GetTelephonyProvidersEdgeLineRequest withLineId(String lineId) {
    ...
    public GetTelephonyProvidersEdgeLineRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.edgeId == null) {
            throw new IllegalStateException("Missing the required parameter 'edgeId' when building request for GetTelephonyProvidersEdgeLineRequest.");
        }
        
        // verify the required parameter 'lineId' is set
        if (this.lineId == null) {
            throw new IllegalStateException("Missing the required parameter 'lineId' when building request for GetTelephonyProvidersEdgeLineRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/telephony/providers/edges/{edgeId}/lines/{lineId}")
	...
	public static Builder builder(String edgeId, String lineId) {
	    return new Builder()
	            .withRequiredParams(edgeId, lineId);
	}
	

	public static class Builder {
		private final GetTelephonyProvidersEdgeLineRequest request;

		private Builder() {
			request = new GetTelephonyProvidersEdgeLineRequest();
		}
		...
		public Builder withRequiredParams(String edgeId, String lineId) {
			request.setEdgeId(edgeId);
						request.setLineId(lineId);
		...
		public GetTelephonyProvidersEdgeLineRequest build() {
