...
public class QueueConversationSocialExpressionEventTopicJourneyAction  implements Serializable {
  ...
  public QueueConversationSocialExpressionEventTopicJourneyAction() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
    }
  }

  public QueueConversationSocialExpressionEventTopicJourneyAction(Boolean initWithEmptyList) {
