...
public class PatchKnowledgeConnectionRequest {
	...
	public PatchKnowledgeConnectionRequest withConnectionId(String connectionId) {
	    this.setConnectionId(connectionId);
	    return this;
	} 

	private ConnectionUpdateRequest body;
	public ConnectionUpdateRequest getBody() {
		return this.body;
	}

	public void setBody(ConnectionUpdateRequest body) {
		this.body = body;
	}

	public PatchKnowledgeConnectionRequest withBody(ConnectionUpdateRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchKnowledgeConnectionRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<ConnectionUpdateRequest> withHttpInfo() {
        
        // verify the required parameter 'connectionId' is set
        if (this.connectionId == null) {
            throw new IllegalStateException("Missing the required parameter 'connectionId' when building request for PatchKnowledgeConnectionRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/knowledge/connections/{connectionId}")
	...
	public static class Builder {
		private final PatchKnowledgeConnectionRequest request;

		private Builder() {
			request = new PatchKnowledgeConnectionRequest();
		}
		...
		public Builder withBody(ConnectionUpdateRequest body) {
		...
		public PatchKnowledgeConnectionRequest build() {
