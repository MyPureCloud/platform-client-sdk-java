...
public class PostKnowledgeKnowledgebaseLabelsRequest {
	...
	public PostKnowledgeKnowledgebaseLabelsRequest withKnowledgeBaseId(String knowledgeBaseId) {
	    this.setKnowledgeBaseId(knowledgeBaseId);
	    return this;
	} 

	private LabelCreateRequest body;
	public LabelCreateRequest getBody() {
		return this.body;
	}

	public void setBody(LabelCreateRequest body) {
		this.body = body;
	}

	public PostKnowledgeKnowledgebaseLabelsRequest withBody(LabelCreateRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostKnowledgeKnowledgebaseLabelsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<LabelCreateRequest> withHttpInfo() {
        
        // verify the required parameter 'knowledgeBaseId' is set
        if (this.knowledgeBaseId == null) {
            throw new IllegalStateException("Missing the required parameter 'knowledgeBaseId' when building request for PostKnowledgeKnowledgebaseLabelsRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostKnowledgeKnowledgebaseLabelsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/labels")
	...
	public static Builder builder(String knowledgeBaseId, LabelCreateRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostKnowledgeKnowledgebaseLabelsRequest request;

		private Builder() {
			request = new PostKnowledgeKnowledgebaseLabelsRequest();
		}
		...
		public Builder withBody(LabelCreateRequest body) {
		...
		public Builder withRequiredParams(String knowledgeBaseId, LabelCreateRequest body) {
			request.setKnowledgeBaseId(knowledgeBaseId);
			request.setBody(body);
		...
		public PostKnowledgeKnowledgebaseLabelsRequest build() {
