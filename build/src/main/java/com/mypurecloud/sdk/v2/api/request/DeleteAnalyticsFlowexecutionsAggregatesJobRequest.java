...
public class DeleteAnalyticsFlowexecutionsAggregatesJobRequest {
	...
	public DeleteAnalyticsFlowexecutionsAggregatesJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public DeleteAnalyticsFlowexecutionsAggregatesJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for DeleteAnalyticsFlowexecutionsAggregatesJobRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/analytics/flowexecutions/aggregates/jobs/{jobId}")
	...
	public static class Builder {
		private final DeleteAnalyticsFlowexecutionsAggregatesJobRequest request;

		private Builder() {
			request = new DeleteAnalyticsFlowexecutionsAggregatesJobRequest();
		}
		...
		public DeleteAnalyticsFlowexecutionsAggregatesJobRequest build() {
