...
public class RateLimitAggregationView  implements Serializable {
 ...
 @JsonDeserialize(using = FunctionEnumDeserializer.class)
  ...
  public RateLimitAggregationView() {
   ...
   * Target metric name
   **/
  public RateLimitAggregationView target(TargetEnum target) {
    this.target = target;
    return this;
  }
   ...
   **/
  public RateLimitAggregationView name(String name) {
    this.name = name;
    return this;
  }
   ...
   * Type of view you wish to create
   **/
  public RateLimitAggregationView function(FunctionEnum function) {
   ...
   **/
  public RateLimitAggregationView range(AggregationRange range) {
    this.range = range;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RateLimitAggregationView rateLimitAggregationView = (RateLimitAggregationView) o;

    return Objects.equals(this.target, rateLimitAggregationView.target) &&
            Objects.equals(this.name, rateLimitAggregationView.name) &&
            Objects.equals(this.function, rateLimitAggregationView.function) &&
            Objects.equals(this.range, rateLimitAggregationView.range);
  }
