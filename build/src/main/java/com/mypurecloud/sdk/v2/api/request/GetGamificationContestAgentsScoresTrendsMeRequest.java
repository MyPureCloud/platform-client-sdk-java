...
public class GetGamificationContestAgentsScoresTrendsMeRequest {
	...
	public GetGamificationContestAgentsScoresTrendsMeRequest withContestId(String contestId) {
    ...
    public GetGamificationContestAgentsScoresTrendsMeRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.contestId == null) {
            throw new IllegalStateException("Missing the required parameter 'contestId' when building request for GetGamificationContestAgentsScoresTrendsMeRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/gamification/contests/{contestId}/agents/scores/trends/me")
	...
	public static class Builder {
		private final GetGamificationContestAgentsScoresTrendsMeRequest request;

		private Builder() {
			request = new GetGamificationContestAgentsScoresTrendsMeRequest();
		}
		...
		public GetGamificationContestAgentsScoresTrendsMeRequest build() {
