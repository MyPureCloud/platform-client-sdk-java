...
public class PostWorkforcemanagementAgentschedulesMineRequest {
    
	private BuGetCurrentAgentScheduleRequest body;
	public BuGetCurrentAgentScheduleRequest getBody() {
		return this.body;
	}

	public void setBody(BuGetCurrentAgentScheduleRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementAgentschedulesMineRequest withBody(BuGetCurrentAgentScheduleRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementAgentschedulesMineRequest withCustomHeader(String name, String value) {
	...
	public static class Builder {
		private final PostWorkforcemanagementAgentschedulesMineRequest request;

		private Builder() {
			request = new PostWorkforcemanagementAgentschedulesMineRequest();
		}

		
		public Builder withBody(BuGetCurrentAgentScheduleRequest body) {
