...
public class GetWorkforcemanagementShifttradingTradesJobRequest {
	...
	public GetWorkforcemanagementShifttradingTradesJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetWorkforcemanagementShifttradingTradesJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetWorkforcemanagementShifttradingTradesJobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/shifttrading/trades/jobs/{jobId}")
	...
	public static class Builder {
		private final GetWorkforcemanagementShifttradingTradesJobRequest request;

		private Builder() {
			request = new GetWorkforcemanagementShifttradingTradesJobRequest();
		}
		...
		public GetWorkforcemanagementShifttradingTradesJobRequest build() {
