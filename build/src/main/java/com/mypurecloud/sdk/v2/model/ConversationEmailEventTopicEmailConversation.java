...
public class ConversationEmailEventTopicEmailConversation  implements Serializable {
  ...
  private List<ConversationEmailEventTopicConversationDivisionMembership> divisions = null;

  public ConversationEmailEventTopicEmailConversation() {
  ...
  /**
   **/
  public ConversationEmailEventTopicEmailConversation id(String id) {
    this.id = id;
    return this;
  }
  ...
  public List<ConversationEmailEventTopicEmailMediaParticipant> getParticipants() {
    return participants;
  }
  public void setParticipants(List<ConversationEmailEventTopicEmailMediaParticipant> participants) {
    this.participants = participants;
  }
  ...
  /**
   **/
  public ConversationEmailEventTopicEmailConversation address(String address) {
  ...
  /**
   **/
  public ConversationEmailEventTopicEmailConversation utilizationLabelId(String utilizationLabelId) {
  ...
  /**
   **/
  public ConversationEmailEventTopicEmailConversation accessAttributes(List<String> accessAttributes) {
  ...
  /**
   **/
  public ConversationEmailEventTopicEmailConversation inactivityTimeout(Date inactivityTimeout) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, conversationEmailEventTopicEmailConversation.id) &&
            ...
            Objects.equals(this.accessAttributes, conversationEmailEventTopicEmailConversation.accessAttributes) &&
            Objects.equals(this.inactivityTimeout, conversationEmailEventTopicEmailConversation.inactivityTimeout) &&
