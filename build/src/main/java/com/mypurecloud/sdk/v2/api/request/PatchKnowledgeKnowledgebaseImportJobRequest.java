...
public class PatchKnowledgeKnowledgebaseImportJobRequest {
    ...
    public ApiRequest<ImportStatusRequest> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("PATCH", "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/import/jobs/{importJobId}")
	...
	public static Builder builder(String knowledgeBaseId, String importJobId, ImportStatusRequest body) {
	    return new Builder()
	            .withRequiredParams(knowledgeBaseId, importJobId, body);
	}
	...
	public static class Builder {
		...
		private Builder() {
			request = new PatchKnowledgeKnowledgebaseImportJobRequest();
		}
