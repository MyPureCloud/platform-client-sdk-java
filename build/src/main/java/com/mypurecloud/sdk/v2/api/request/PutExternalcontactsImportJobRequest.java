...
public class PutExternalcontactsImportJobRequest {
	...
	public PutExternalcontactsImportJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 

	private ContactImportJobStatusUpdateRequest body;
	public ContactImportJobStatusUpdateRequest getBody() {
		return this.body;
	}

	public void setBody(ContactImportJobStatusUpdateRequest body) {
		this.body = body;
	}

	public PutExternalcontactsImportJobRequest withBody(ContactImportJobStatusUpdateRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutExternalcontactsImportJobRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<ContactImportJobStatusUpdateRequest> withHttpInfo() {
        
        // verify the required parameter 'jobId' is set
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for PutExternalcontactsImportJobRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutExternalcontactsImportJobRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/externalcontacts/import/jobs/{jobId}")
	...
	public static Builder builder(String jobId, ContactImportJobStatusUpdateRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PutExternalcontactsImportJobRequest request;

		private Builder() {
			request = new PutExternalcontactsImportJobRequest();
		}
		...
		public Builder withBody(ContactImportJobStatusUpdateRequest body) {
		...
		public Builder withRequiredParams(String jobId, ContactImportJobStatusUpdateRequest body) {
			request.setJobId(jobId);
			request.setBody(body);
		...
		public PutExternalcontactsImportJobRequest build() {
