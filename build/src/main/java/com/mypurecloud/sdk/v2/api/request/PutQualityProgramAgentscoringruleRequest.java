...
public class PutQualityProgramAgentscoringruleRequest {
	...
	public PutQualityProgramAgentscoringruleRequest withProgramId(String programId) {
	...
	public PutQualityProgramAgentscoringruleRequest withRuleId(String ruleId) {
	    this.setRuleId(ruleId);
	    return this;
	} 

	private AgentScoringRule body;
	public AgentScoringRule getBody() {
		return this.body;
	}

	public void setBody(AgentScoringRule body) {
		this.body = body;
	}

	public PutQualityProgramAgentscoringruleRequest withBody(AgentScoringRule body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutQualityProgramAgentscoringruleRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<AgentScoringRule> withHttpInfo() {
        
        // verify the required parameter 'programId' is set
        if (this.programId == null) {
            throw new IllegalStateException("Missing the required parameter 'programId' when building request for PutQualityProgramAgentscoringruleRequest.");
        }
        
        // verify the required parameter 'ruleId' is set
        if (this.ruleId == null) {
            throw new IllegalStateException("Missing the required parameter 'ruleId' when building request for PutQualityProgramAgentscoringruleRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutQualityProgramAgentscoringruleRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/quality/programs/{programId}/agentscoringrules/{ruleId}")
	...
	public static Builder builder(String programId, String ruleId, AgentScoringRule body) {
	    return new Builder()
	            .withRequiredParams(programId, ruleId, body);
	}


	public static class Builder {
		private final PutQualityProgramAgentscoringruleRequest request;

		private Builder() {
			request = new PutQualityProgramAgentscoringruleRequest();
		}
		...
		public Builder withBody(AgentScoringRule body) {
		...
		public Builder withRequiredParams(String programId, String ruleId, AgentScoringRule body) {
			request.setProgramId(programId);
			request.setRuleId(ruleId);
			request.setBody(body);
		...
		public PutQualityProgramAgentscoringruleRequest build() {
