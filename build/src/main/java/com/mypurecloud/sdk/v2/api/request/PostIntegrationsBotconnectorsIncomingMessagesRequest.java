...
public class PostIntegrationsBotconnectorsIncomingMessagesRequest {

	private IncomingMessageRequest body;
	public IncomingMessageRequest getBody() {
		return this.body;
	}

	public void setBody(IncomingMessageRequest body) {
		this.body = body;
	}

	public PostIntegrationsBotconnectorsIncomingMessagesRequest withBody(IncomingMessageRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostIntegrationsBotconnectorsIncomingMessagesRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<IncomingMessageRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostIntegrationsBotconnectorsIncomingMessagesRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/integrations/botconnectors/incoming/messages")
                .withBody(body)
	...
	public static Builder builder(IncomingMessageRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostIntegrationsBotconnectorsIncomingMessagesRequest request;

		private Builder() {
			request = new PostIntegrationsBotconnectorsIncomingMessagesRequest();
		}


		public Builder withBody(IncomingMessageRequest body) {
		...
		public Builder withRequiredParams(IncomingMessageRequest body) {
			request.setBody(body);
		...
		public PostIntegrationsBotconnectorsIncomingMessagesRequest build() {
