...
public class PostWorkforcemanagementBusinessunitAgentschedulesSearchRequest {
	...
	public PostWorkforcemanagementBusinessunitAgentschedulesSearchRequest withBusinessUnitId(String businessUnitId) {
	...
	public PostWorkforcemanagementBusinessunitAgentschedulesSearchRequest withForceAsync(Boolean forceAsync) {
    ...
    public PostWorkforcemanagementBusinessunitAgentschedulesSearchRequest withCustomHeader(String name, String value) {
	...
	public static class Builder {
		private final PostWorkforcemanagementBusinessunitAgentschedulesSearchRequest request;

		private Builder() {
			request = new PostWorkforcemanagementBusinessunitAgentschedulesSearchRequest();
		}
		...
		public PostWorkforcemanagementBusinessunitAgentschedulesSearchRequest build() {
