...
public class DomainEntityListingResponseDivisionView  implements Serializable, PagedResource<ResponseDivisionView> {
  
  private List<ResponseDivisionView> entities = null;
  ...
  public DomainEntityListingResponseDivisionView() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
      entities = new ArrayList<ResponseDivisionView>();
    }
  }

  public DomainEntityListingResponseDivisionView(Boolean initWithEmptyList) {
  ...
  /**
   **/
  public DomainEntityListingResponseDivisionView entities(List<ResponseDivisionView> entities) {
  ...
  public List<ResponseDivisionView> getEntities() {
    return entities;
  }
  public void setEntities(List<ResponseDivisionView> entities) {
    this.entities = entities;
  }
  ...
  /**
   **/
  public DomainEntityListingResponseDivisionView pageSize(Integer pageSize) {
  ...
  /**
   **/
  public DomainEntityListingResponseDivisionView pageNumber(Integer pageNumber) {
  ...
  /**
   **/
  public DomainEntityListingResponseDivisionView total(Long total) {
    this.total = total;
    return this;
  }
  ...
  /**
   **/
  public DomainEntityListingResponseDivisionView nextUri(String nextUri) {
  ...
  /**
   **/
  public DomainEntityListingResponseDivisionView previousUri(String previousUri) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DomainEntityListingResponseDivisionView domainEntityListingResponseDivisionView = (DomainEntityListingResponseDivisionView) o;

    return Objects.equals(this.entities, domainEntityListingResponseDivisionView.entities) &&
  ...
  public String toString() {
    ...
    sb.append("class DomainEntityListingResponseDivisionView {\n");
