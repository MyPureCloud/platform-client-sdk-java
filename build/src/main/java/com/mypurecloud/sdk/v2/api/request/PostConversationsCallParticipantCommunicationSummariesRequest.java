...
public class PostConversationsCallParticipantCommunicationSummariesRequest {
	...
	public PostConversationsCallParticipantCommunicationSummariesRequest withConversationId(String conversationId) {
	...
	public PostConversationsCallParticipantCommunicationSummariesRequest withParticipantId(String participantId) {
	...
	public PostConversationsCallParticipantCommunicationSummariesRequest withCommunicationId(String communicationId) {
	...
	public PostConversationsCallParticipantCommunicationSummariesRequest withBody(OnDemandConversationSummaryRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostConversationsCallParticipantCommunicationSummariesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<OnDemandConversationSummaryRequest> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PostConversationsCallParticipantCommunicationSummariesRequest.");
        }
        
        // verify the required parameter 'participantId' is set
        if (this.participantId == null) {
            throw new IllegalStateException("Missing the required parameter 'participantId' when building request for PostConversationsCallParticipantCommunicationSummariesRequest.");
        }
        
        // verify the required parameter 'communicationId' is set
        if (this.communicationId == null) {
            throw new IllegalStateException("Missing the required parameter 'communicationId' when building request for PostConversationsCallParticipantCommunicationSummariesRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/conversations/calls/{conversationId}/participants/{participantId}/communications/{communicationId}/summaries")
	...
	public static class Builder {
		private final PostConversationsCallParticipantCommunicationSummariesRequest request;

		private Builder() {
			request = new PostConversationsCallParticipantCommunicationSummariesRequest();
		}
		...
		public PostConversationsCallParticipantCommunicationSummariesRequest build() {
