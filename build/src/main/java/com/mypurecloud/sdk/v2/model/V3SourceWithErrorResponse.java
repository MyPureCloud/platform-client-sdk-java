...
public class V3SourceWithErrorResponse  implements Serializable {
 ...
 @JsonDeserialize(using = StatusEnumDeserializer.class)
  ...
  public V3SourceWithErrorResponse() {
   ...
   **/
  public V3SourceWithErrorResponse name(String name) {
    this.name = name;
    return this;
  }
   ...
   **/
  public V3SourceWithErrorResponse connectionId(String connectionId) {
   ...
   * The type of the source.
   **/
  public V3SourceWithErrorResponse type(TypeEnum type) {
    this.type = type;
    return this;
  }
   ...
   * The trigger type of the source.
   **/
  public V3SourceWithErrorResponse triggerType(TriggerTypeEnum triggerType) {
   ...
   * The current status of the source.
   **/
  public V3SourceWithErrorResponse status(StatusEnum status) {
    this.status = status;
    return this;
  }
   ...
   **/
  public V3SourceWithErrorResponse createdBy(UserReference createdBy) {
   ...
   **/
  public V3SourceWithErrorResponse modifiedBy(UserReference modifiedBy) {
   ...
   **/
  public V3SourceWithErrorResponse dateCreated(Date dateCreated) {
   ...
   **/
  public V3SourceWithErrorResponse dateModified(Date dateModified) {
   ...
   **/
  public V3SourceWithErrorResponse lastSync(V3SourceLastSynchronization lastSync) {
   ...
   **/
  public V3SourceWithErrorResponse error(ErrorBody error) {
    this.error = error;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V3SourceWithErrorResponse v3SourceWithErrorResponse = (V3SourceWithErrorResponse) o;

    return Objects.equals(this.id, v3SourceWithErrorResponse.id) &&
            Objects.equals(this.name, v3SourceWithErrorResponse.name) &&
            Objects.equals(this.connectionId, v3SourceWithErrorResponse.connectionId) &&
            Objects.equals(this.type, v3SourceWithErrorResponse.type) &&
            Objects.equals(this.triggerType, v3SourceWithErrorResponse.triggerType) &&
            Objects.equals(this.status, v3SourceWithErrorResponse.status) &&
            Objects.equals(this.createdBy, v3SourceWithErrorResponse.createdBy) &&
            Objects.equals(this.modifiedBy, v3SourceWithErrorResponse.modifiedBy) &&
            Objects.equals(this.dateCreated, v3SourceWithErrorResponse.dateCreated) &&
            Objects.equals(this.dateModified, v3SourceWithErrorResponse.dateModified) &&
            Objects.equals(this.lastSync, v3SourceWithErrorResponse.lastSync) &&
            Objects.equals(this.error, v3SourceWithErrorResponse.error) &&
            Objects.equals(this.selfUri, v3SourceWithErrorResponse.selfUri);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, connectionId, type, triggerType, status, createdBy, modifiedBy, dateCreated, dateModified, lastSync, error, selfUri);
  }
