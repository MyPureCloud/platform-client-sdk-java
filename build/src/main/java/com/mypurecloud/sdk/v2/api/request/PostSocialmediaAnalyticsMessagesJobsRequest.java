...
public class PostSocialmediaAnalyticsMessagesJobsRequest {

	private SocialMediaAsyncDetailQuery body;
	public SocialMediaAsyncDetailQuery getBody() {
		return this.body;
	}

	public void setBody(SocialMediaAsyncDetailQuery body) {
		this.body = body;
	}

	public PostSocialmediaAnalyticsMessagesJobsRequest withBody(SocialMediaAsyncDetailQuery body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostSocialmediaAnalyticsMessagesJobsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<SocialMediaAsyncDetailQuery> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostSocialmediaAnalyticsMessagesJobsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/socialmedia/analytics/messages/jobs")
                .withBody(body)
	...
	public static Builder builder(SocialMediaAsyncDetailQuery body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostSocialmediaAnalyticsMessagesJobsRequest request;

		private Builder() {
			request = new PostSocialmediaAnalyticsMessagesJobsRequest();
		}


		public Builder withBody(SocialMediaAsyncDetailQuery body) {
		...
		public Builder withRequiredParams(SocialMediaAsyncDetailQuery body) {
			request.setBody(body);
		...
		public PostSocialmediaAnalyticsMessagesJobsRequest build() {
