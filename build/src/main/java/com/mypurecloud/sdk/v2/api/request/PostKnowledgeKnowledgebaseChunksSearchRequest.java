...
public class PostKnowledgeKnowledgebaseChunksSearchRequest {
	...
	public PostKnowledgeKnowledgebaseChunksSearchRequest withKnowledgeBaseId(String knowledgeBaseId) {
	    this.setKnowledgeBaseId(knowledgeBaseId);
	    return this;
	} 

	private KnowledgeDocumentChunkRequest body;
	public KnowledgeDocumentChunkRequest getBody() {
		return this.body;
	}

	public void setBody(KnowledgeDocumentChunkRequest body) {
		this.body = body;
	}

	public PostKnowledgeKnowledgebaseChunksSearchRequest withBody(KnowledgeDocumentChunkRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostKnowledgeKnowledgebaseChunksSearchRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<KnowledgeDocumentChunkRequest> withHttpInfo() {
        
        // verify the required parameter 'knowledgeBaseId' is set
        if (this.knowledgeBaseId == null) {
            throw new IllegalStateException("Missing the required parameter 'knowledgeBaseId' when building request for PostKnowledgeKnowledgebaseChunksSearchRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/chunks/search")
	...
	public static class Builder {
		private final PostKnowledgeKnowledgebaseChunksSearchRequest request;

		private Builder() {
			request = new PostKnowledgeKnowledgebaseChunksSearchRequest();
		}
		...
		public Builder withBody(KnowledgeDocumentChunkRequest body) {
		...
		public PostKnowledgeKnowledgebaseChunksSearchRequest build() {
