...
public class GetContentmanagementSharesRequest {
	...
	public GetContentmanagementSharesRequest withEntityId(String entityId) {
	...
	public GetContentmanagementSharesRequest withExpand(List<String> expand) {
	...
	public GetContentmanagementSharesRequest withPageSize(Integer pageSize) {
	...
	public GetContentmanagementSharesRequest withPageNumber(Integer pageNumber) {
    ...
    public GetContentmanagementSharesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/contentmanagement/shares")
