...
public class DeleteOrgauthorizationTrusteeUserRolesRequest {
	...
	public DeleteOrgauthorizationTrusteeUserRolesRequest withTrusteeOrgId(String trusteeOrgId) {
	...
	public DeleteOrgauthorizationTrusteeUserRolesRequest withTrusteeUserId(String trusteeUserId) {
    ...
    public DeleteOrgauthorizationTrusteeUserRolesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.trusteeOrgId == null) {
            throw new IllegalStateException("Missing the required parameter 'trusteeOrgId' when building request for DeleteOrgauthorizationTrusteeUserRolesRequest.");
        }
        
        // verify the required parameter 'trusteeUserId' is set
        if (this.trusteeUserId == null) {
            throw new IllegalStateException("Missing the required parameter 'trusteeUserId' when building request for DeleteOrgauthorizationTrusteeUserRolesRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/orgauthorization/trustees/{trusteeOrgId}/users/{trusteeUserId}/roles")
	...
	public static class Builder {
		private final DeleteOrgauthorizationTrusteeUserRolesRequest request;

		private Builder() {
			request = new DeleteOrgauthorizationTrusteeUserRolesRequest();
		}
		...
		public DeleteOrgauthorizationTrusteeUserRolesRequest build() {
