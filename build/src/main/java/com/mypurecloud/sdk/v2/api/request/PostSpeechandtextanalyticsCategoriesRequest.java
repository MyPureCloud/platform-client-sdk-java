...
public class PostSpeechandtextanalyticsCategoriesRequest {
	...
	public PostSpeechandtextanalyticsCategoriesRequest withBody(CategoryRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostSpeechandtextanalyticsCategoriesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<CategoryRequest> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostSpeechandtextanalyticsCategoriesRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/speechandtextanalytics/categories")
                .withBody(body)
	...
	public static Builder builder(CategoryRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostSpeechandtextanalyticsCategoriesRequest request;

		private Builder() {
			request = new PostSpeechandtextanalyticsCategoriesRequest();
		}
		...
		public Builder withRequiredParams(CategoryRequest body) {
			request.setBody(body);
		...
		public PostSpeechandtextanalyticsCategoriesRequest build() {
