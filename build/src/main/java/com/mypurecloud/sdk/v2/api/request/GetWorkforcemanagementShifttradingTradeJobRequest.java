...
public class GetWorkforcemanagementShifttradingTradeJobRequest {
	...
	public GetWorkforcemanagementShifttradingTradeJobRequest withTradeId(String tradeId) {
	...
	public GetWorkforcemanagementShifttradingTradeJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetWorkforcemanagementShifttradingTradeJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.tradeId == null) {
            throw new IllegalStateException("Missing the required parameter 'tradeId' when building request for GetWorkforcemanagementShifttradingTradeJobRequest.");
        }
        
        // verify the required parameter 'jobId' is set
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetWorkforcemanagementShifttradingTradeJobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/shifttrading/trades/{tradeId}/jobs/{jobId}")
	...
	public static class Builder {
		private final GetWorkforcemanagementShifttradingTradeJobRequest request;

		private Builder() {
			request = new GetWorkforcemanagementShifttradingTradeJobRequest();
		}
		...
		public GetWorkforcemanagementShifttradingTradeJobRequest build() {
