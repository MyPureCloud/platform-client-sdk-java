...
public class GetOutboundDiagnosticsCampaignSummaryRequest {
	...
	public GetOutboundDiagnosticsCampaignSummaryRequest withCampaignId(String campaignId) {
	...
	public GetOutboundDiagnosticsCampaignSummaryRequest withStart(String start) {
	    this.setStart(start);
	    return this;
	} 
	...
	public GetOutboundDiagnosticsCampaignSummaryRequest withEnd(String end) {
	    this.setEnd(end);
	    return this;
	} 
    ...
    public GetOutboundDiagnosticsCampaignSummaryRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.campaignId == null) {
            throw new IllegalStateException("Missing the required parameter 'campaignId' when building request for GetOutboundDiagnosticsCampaignSummaryRequest.");
        }
        
        // verify the required parameter 'start' is set
        if (this.start == null) {
            throw new IllegalStateException("Missing the required parameter 'start' when building request for GetOutboundDiagnosticsCampaignSummaryRequest.");
        }
        
        // verify the required parameter 'end' is set
        if (this.end == null) {
            throw new IllegalStateException("Missing the required parameter 'end' when building request for GetOutboundDiagnosticsCampaignSummaryRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/outbound/diagnostics/campaigns/{campaignId}/summary")
                .withPathParameter("campaignId", campaignId)
        

                .withQueryParameters("start", "", start)
        

                .withQueryParameters("end", "", end)
	...
	public static Builder builder(String campaignId, String start, String end) {
	    return new Builder()
	            .withRequiredParams(campaignId, start, end);
	}


	public static class Builder {
		private final GetOutboundDiagnosticsCampaignSummaryRequest request;

		private Builder() {
			request = new GetOutboundDiagnosticsCampaignSummaryRequest();
		}
		...
		public Builder withRequiredParams(String campaignId, String start, String end) {
			request.setCampaignId(campaignId);
			request.setStart(start);
			request.setEnd(end);
		...
		public GetOutboundDiagnosticsCampaignSummaryRequest build() {
