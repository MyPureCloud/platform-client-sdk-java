...
public class GetOutboundImporttemplateRequest {
	...
	public GetOutboundImporttemplateRequest withImportTemplateId(String importTemplateId) {
    ...
    public GetOutboundImporttemplateRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.importTemplateId == null) {
            throw new IllegalStateException("Missing the required parameter 'importTemplateId' when building request for GetOutboundImporttemplateRequest.");
        }
	...
	public static class Builder {
		private final GetOutboundImporttemplateRequest request;

		private Builder() {
			request = new GetOutboundImporttemplateRequest();
		}
		...
		public GetOutboundImporttemplateRequest build() {
