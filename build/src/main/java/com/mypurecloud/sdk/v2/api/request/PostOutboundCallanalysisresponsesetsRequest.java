...
public class PostOutboundCallanalysisresponsesetsRequest {
	...
	public void setBody(ResponseSet body) {
		this.body = body;
	}

	public PostOutboundCallanalysisresponsesetsRequest withBody(ResponseSet body) {
	    this.setBody(body);
	    return this;
	}
    ...
    public PostOutboundCallanalysisresponsesetsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<ResponseSet> withHttpInfo() throws ApiException {
        ...
        if (this.body == null) {
            throw new ApiException(400, "Missing the required parameter 'body' when building request for PostOutboundCallanalysisresponsesetsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/outbound/callanalysisresponsesets")
                .withBody(body)
	...
	public static Builder builder(ResponseSet body) {
	    return new Builder()
	            .withRequiredParams(body);
	}

	public static class Builder {
		private final PostOutboundCallanalysisresponsesetsRequest request;

		private Builder() {
			request = new PostOutboundCallanalysisresponsesetsRequest();
		}
		...
		public Builder withRequiredParams(ResponseSet body) {
			request.setBody(body);
			return this;
		}
