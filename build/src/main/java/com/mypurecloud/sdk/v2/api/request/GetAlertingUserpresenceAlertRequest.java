...
public class GetAlertingUserpresenceAlertRequest {
	...
	public GetAlertingUserpresenceAlertRequest withAlertId(String alertId) {
	...
	public GetAlertingUserpresenceAlertRequest withExpand(List<String> expand) {
    ...
    public GetAlertingUserpresenceAlertRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.alertId == null) {
            throw new IllegalStateException("Missing the required parameter 'alertId' when building request for GetAlertingUserpresenceAlertRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/alerting/userpresence/alerts/{alertId}")
	...
	public static class Builder {
		private final GetAlertingUserpresenceAlertRequest request;

		private Builder() {
			request = new GetAlertingUserpresenceAlertRequest();
		}
		...
		public GetAlertingUserpresenceAlertRequest build() {
