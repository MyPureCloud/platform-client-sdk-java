...
public class DeleteRoutingSkillexpressionsRequest {
	...
	public DeleteRoutingSkillexpressionsRequest withId(List<String> id) {
	    this.setId(id);
	    return this;
	} 
    ...
    public DeleteRoutingSkillexpressionsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("DELETE", "/api/v2/routing/skillexpressions")
	...
	public static class Builder {
		private final DeleteRoutingSkillexpressionsRequest request;

		private Builder() {
			request = new DeleteRoutingSkillexpressionsRequest();
		}
		...
		public DeleteRoutingSkillexpressionsRequest build() {
