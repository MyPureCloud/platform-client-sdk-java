...
public class PatchConversationsCobrowsesessionRequest {
	...
	public PatchConversationsCobrowsesessionRequest withBody(Conversation body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchConversationsCobrowsesessionRequest withCustomHeader(String name, String value) {
	...
	public static class Builder {
		private final PatchConversationsCobrowsesessionRequest request;
