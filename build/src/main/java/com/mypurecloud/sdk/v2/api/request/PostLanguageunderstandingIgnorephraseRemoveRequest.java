...
public class PostLanguageunderstandingIgnorephraseRemoveRequest {
	...
	public PostLanguageunderstandingIgnorephraseRemoveRequest withLanguageCode(String languageCode) {
	...
	public PostLanguageunderstandingIgnorephraseRemoveRequest withBody(RemoveEntitiesRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostLanguageunderstandingIgnorephraseRemoveRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<RemoveEntitiesRequest> withHttpInfo() {
        ...
        if (this.languageCode == null) {
            throw new IllegalStateException("Missing the required parameter 'languageCode' when building request for PostLanguageunderstandingIgnorephraseRemoveRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostLanguageunderstandingIgnorephraseRemoveRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/languageunderstanding/ignorephrases/{languageCode}/remove")
	...
	public static class Builder {
		private final PostLanguageunderstandingIgnorephraseRemoveRequest request;

		private Builder() {
			request = new PostLanguageunderstandingIgnorephraseRemoveRequest();
		}
		...
		public PostLanguageunderstandingIgnorephraseRemoveRequest build() {
