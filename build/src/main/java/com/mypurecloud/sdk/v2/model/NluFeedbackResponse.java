...
public class NluFeedbackResponse  implements Serializable {
  ...
  @ApiModelProperty(example = "null", value = "The date when the feedback was created. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss.SSSZ")
