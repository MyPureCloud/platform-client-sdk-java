...
public class PostConversationsCallbacksBulkUpdateRequest {
    
	private BulkCallbackPatchRequest body;
	public BulkCallbackPatchRequest getBody() {
		return this.body;
	}

	public void setBody(BulkCallbackPatchRequest body) {
		this.body = body;
	}

	public PostConversationsCallbacksBulkUpdateRequest withBody(BulkCallbackPatchRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostConversationsCallbacksBulkUpdateRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<BulkCallbackPatchRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostConversationsCallbacksBulkUpdateRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/conversations/callbacks/bulk/update")
                .withBody(body)
	...
	public static Builder builder(BulkCallbackPatchRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostConversationsCallbacksBulkUpdateRequest request;

		private Builder() {
			request = new PostConversationsCallbacksBulkUpdateRequest();
		}

		
		public Builder withBody(BulkCallbackPatchRequest body) {
		...
		public Builder withRequiredParams(BulkCallbackPatchRequest body) {
			request.setBody(body);
		...
		public PostConversationsCallbacksBulkUpdateRequest build() {
