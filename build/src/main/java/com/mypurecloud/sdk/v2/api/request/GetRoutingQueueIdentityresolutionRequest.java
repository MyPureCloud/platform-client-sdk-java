...
public class GetRoutingQueueIdentityresolutionRequest {
	...
	public GetRoutingQueueIdentityresolutionRequest withQueueId(String queueId) {
    ...
    public GetRoutingQueueIdentityresolutionRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.queueId == null) {
            throw new IllegalStateException("Missing the required parameter 'queueId' when building request for GetRoutingQueueIdentityresolutionRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/routing/queues/{queueId}/identityresolution")
	...
	public static class Builder {
		private final GetRoutingQueueIdentityresolutionRequest request;

		private Builder() {
			request = new GetRoutingQueueIdentityresolutionRequest();
		}
		...
		public GetRoutingQueueIdentityresolutionRequest build() {
