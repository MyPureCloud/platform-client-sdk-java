...
public class PatchKnowledgeSettingRequest {

	private String knowledgeSettingId;
	public String getKnowledgeSettingId() {
		return this.knowledgeSettingId;
	}
	...
	public PatchKnowledgeSettingRequest withKnowledgeSettingId(String knowledgeSettingId) {
	    this.setKnowledgeSettingId(knowledgeSettingId);
	    return this;
	} 

	private KnowledgeSettingsRequest body;
	public KnowledgeSettingsRequest getBody() {
		return this.body;
	}

	public void setBody(KnowledgeSettingsRequest body) {
		this.body = body;
	}

	public PatchKnowledgeSettingRequest withBody(KnowledgeSettingsRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchKnowledgeSettingRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<KnowledgeSettingsRequest> withHttpInfo() {
        
        // verify the required parameter 'knowledgeSettingId' is set
        if (this.knowledgeSettingId == null) {
            throw new IllegalStateException("Missing the required parameter 'knowledgeSettingId' when building request for PatchKnowledgeSettingRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchKnowledgeSettingRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/knowledge/settings/{knowledgeSettingId}")
                .withPathParameter("knowledgeSettingId", knowledgeSettingId)
	...
	public static Builder builder(String knowledgeSettingId, KnowledgeSettingsRequest body) {
	    return new Builder()
	            .withRequiredParams(knowledgeSettingId, body);
	}


	public static class Builder {
		private final PatchKnowledgeSettingRequest request;

		private Builder() {
			request = new PatchKnowledgeSettingRequest();
		}


		public Builder withKnowledgeSettingId(String knowledgeSettingId) {
			request.setKnowledgeSettingId(knowledgeSettingId);
			return this;
		}

		public Builder withBody(KnowledgeSettingsRequest body) {
		...
		public Builder withRequiredParams(String knowledgeSettingId, KnowledgeSettingsRequest body) {
			request.setKnowledgeSettingId(knowledgeSettingId);
			request.setBody(body);
		...
		public PatchKnowledgeSettingRequest build() {
            
            // verify the required parameter 'knowledgeSettingId' is set
            if (request.knowledgeSettingId == null) {
                throw new IllegalStateException("Missing the required parameter 'knowledgeSettingId' when building request for PatchKnowledgeSettingRequest.");
            }
