...
public class GetWorkforcemanagementBusinessunitWeekScheduleRequest {
	...
	public GetWorkforcemanagementBusinessunitWeekScheduleRequest withBusinessUnitId(String businessUnitId) {
	...
	public GetWorkforcemanagementBusinessunitWeekScheduleRequest withWeekId(LocalDate weekId) {
	...
	public GetWorkforcemanagementBusinessunitWeekScheduleRequest withScheduleId(String scheduleId) {
    ...
    public GetWorkforcemanagementBusinessunitWeekScheduleRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for GetWorkforcemanagementBusinessunitWeekScheduleRequest.");
        }
        
        // verify the required parameter 'weekId' is set
        if (this.weekId == null) {
            throw new IllegalStateException("Missing the required parameter 'weekId' when building request for GetWorkforcemanagementBusinessunitWeekScheduleRequest.");
        }
        
        // verify the required parameter 'scheduleId' is set
        if (this.scheduleId == null) {
            throw new IllegalStateException("Missing the required parameter 'scheduleId' when building request for GetWorkforcemanagementBusinessunitWeekScheduleRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/weeks/{weekId}/schedules/{scheduleId}")
	...
	public static class Builder {
		private final GetWorkforcemanagementBusinessunitWeekScheduleRequest request;

		private Builder() {
			request = new GetWorkforcemanagementBusinessunitWeekScheduleRequest();
		}
		...
		public GetWorkforcemanagementBusinessunitWeekScheduleRequest build() {
