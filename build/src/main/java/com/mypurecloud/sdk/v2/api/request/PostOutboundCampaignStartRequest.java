...
public class PostOutboundCampaignStartRequest {
	...
	public PostOutboundCampaignStartRequest withCampaignId(String campaignId) {
    ...
    public PostOutboundCampaignStartRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.campaignId == null) {
            throw new IllegalStateException("Missing the required parameter 'campaignId' when building request for PostOutboundCampaignStartRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/outbound/campaigns/{campaignId}/start")
	...
	public static class Builder {
		private final PostOutboundCampaignStartRequest request;

		private Builder() {
			request = new PostOutboundCampaignStartRequest();
		}
		...
		public PostOutboundCampaignStartRequest build() {
