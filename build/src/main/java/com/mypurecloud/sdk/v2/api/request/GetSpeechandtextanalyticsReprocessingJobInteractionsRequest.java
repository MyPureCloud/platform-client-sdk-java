...
public class GetSpeechandtextanalyticsReprocessingJobInteractionsRequest {
	...
	public GetSpeechandtextanalyticsReprocessingJobInteractionsRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetSpeechandtextanalyticsReprocessingJobInteractionsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetSpeechandtextanalyticsReprocessingJobInteractionsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/speechandtextanalytics/reprocessing/jobs/{jobId}/interactions")
	...
	public static class Builder {
		private final GetSpeechandtextanalyticsReprocessingJobInteractionsRequest request;

		private Builder() {
			request = new GetSpeechandtextanalyticsReprocessingJobInteractionsRequest();
		}
		...
		public GetSpeechandtextanalyticsReprocessingJobInteractionsRequest build() {
