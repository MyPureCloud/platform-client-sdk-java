...
public class DeleteOutboundContactlistsRequest {
	...
	public DeleteOutboundContactlistsRequest withId(List<String> id) {
	    this.setId(id);
	    return this;
	} 
    ...
    public DeleteOutboundContactlistsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.id == null) {
            throw new IllegalStateException("Missing the required parameter 'id' when building request for DeleteOutboundContactlistsRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/outbound/contactlists")
	...
	public static class Builder {
		private final DeleteOutboundContactlistsRequest request;

		private Builder() {
			request = new DeleteOutboundContactlistsRequest();
		}
		...
		public DeleteOutboundContactlistsRequest build() {
