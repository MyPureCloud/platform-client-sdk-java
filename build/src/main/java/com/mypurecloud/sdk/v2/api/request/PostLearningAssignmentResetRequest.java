...
public class PostLearningAssignmentResetRequest {
	...
	public PostLearningAssignmentResetRequest withAssignmentId(String assignmentId) {
    ...
    public PostLearningAssignmentResetRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.assignmentId == null) {
            throw new IllegalStateException("Missing the required parameter 'assignmentId' when building request for PostLearningAssignmentResetRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/learning/assignments/{assignmentId}/reset")
	...
	public static class Builder {
		private final PostLearningAssignmentResetRequest request;

		private Builder() {
			request = new PostLearningAssignmentResetRequest();
		}
		...
		public PostLearningAssignmentResetRequest build() {
