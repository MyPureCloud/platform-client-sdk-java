...
public class GetConversationsMessagingIntegrationsInstagramIntegrationIdRequest {
	...
	public GetConversationsMessagingIntegrationsInstagramIntegrationIdRequest withIntegrationId(String integrationId) {
	...
	public GetConversationsMessagingIntegrationsInstagramIntegrationIdRequest withExpand(String expand) {
    ...
    public GetConversationsMessagingIntegrationsInstagramIntegrationIdRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.integrationId == null) {
            throw new IllegalStateException("Missing the required parameter 'integrationId' when building request for GetConversationsMessagingIntegrationsInstagramIntegrationIdRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/conversations/messaging/integrations/instagram/{integrationId}")
	...
	public static class Builder {
		private final GetConversationsMessagingIntegrationsInstagramIntegrationIdRequest request;

		private Builder() {
			request = new GetConversationsMessagingIntegrationsInstagramIntegrationIdRequest();
		}
		...
		public GetConversationsMessagingIntegrationsInstagramIntegrationIdRequest build() {
