...
public class PatchConversationsMessagingIntegrationsWhatsappEmbeddedsignupIntegrationIdRequest {
	...
	public PatchConversationsMessagingIntegrationsWhatsappEmbeddedsignupIntegrationIdRequest withIntegrationId(String integrationId) {
	    this.setIntegrationId(integrationId);
	    return this;
	} 

	private WhatsAppEmbeddedSignupIntegrationActivationRequest body;
	public WhatsAppEmbeddedSignupIntegrationActivationRequest getBody() {
		return this.body;
	}

	public void setBody(WhatsAppEmbeddedSignupIntegrationActivationRequest body) {
		this.body = body;
	}

	public PatchConversationsMessagingIntegrationsWhatsappEmbeddedsignupIntegrationIdRequest withBody(WhatsAppEmbeddedSignupIntegrationActivationRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchConversationsMessagingIntegrationsWhatsappEmbeddedsignupIntegrationIdRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<WhatsAppEmbeddedSignupIntegrationActivationRequest> withHttpInfo() {
        
        // verify the required parameter 'integrationId' is set
        if (this.integrationId == null) {
            throw new IllegalStateException("Missing the required parameter 'integrationId' when building request for PatchConversationsMessagingIntegrationsWhatsappEmbeddedsignupIntegrationIdRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchConversationsMessagingIntegrationsWhatsappEmbeddedsignupIntegrationIdRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/conversations/messaging/integrations/whatsapp/embeddedsignup/{integrationId}")
	...
	public static Builder builder(String integrationId, WhatsAppEmbeddedSignupIntegrationActivationRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PatchConversationsMessagingIntegrationsWhatsappEmbeddedsignupIntegrationIdRequest request;

		private Builder() {
			request = new PatchConversationsMessagingIntegrationsWhatsappEmbeddedsignupIntegrationIdRequest();
		}
		...
		public Builder withBody(WhatsAppEmbeddedSignupIntegrationActivationRequest body) {
		...
		public Builder withRequiredParams(String integrationId, WhatsAppEmbeddedSignupIntegrationActivationRequest body) {
			request.setIntegrationId(integrationId);
			request.setBody(body);
		...
		public PatchConversationsMessagingIntegrationsWhatsappEmbeddedsignupIntegrationIdRequest build() {
