...
public class PatchSocialmediaTopicDataingestionrulesFacebookFacebookIngestionRuleIdRequest {
	...
	public PatchSocialmediaTopicDataingestionrulesFacebookFacebookIngestionRuleIdRequest withTopicId(String topicId) {
	...
	public PatchSocialmediaTopicDataingestionrulesFacebookFacebookIngestionRuleIdRequest withFacebookIngestionRuleId(String facebookIngestionRuleId) {
	...
	public PatchSocialmediaTopicDataingestionrulesFacebookFacebookIngestionRuleIdRequest withBody(DataIngestionRuleStatusPatchRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchSocialmediaTopicDataingestionrulesFacebookFacebookIngestionRuleIdRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<DataIngestionRuleStatusPatchRequest> withHttpInfo() {
        ...
        if (this.topicId == null) {
            throw new IllegalStateException("Missing the required parameter 'topicId' when building request for PatchSocialmediaTopicDataingestionrulesFacebookFacebookIngestionRuleIdRequest.");
        }
        
        // verify the required parameter 'facebookIngestionRuleId' is set
        if (this.facebookIngestionRuleId == null) {
            throw new IllegalStateException("Missing the required parameter 'facebookIngestionRuleId' when building request for PatchSocialmediaTopicDataingestionrulesFacebookFacebookIngestionRuleIdRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/socialmedia/topics/{topicId}/dataingestionrules/facebook/{facebookIngestionRuleId}")
	...
	public static class Builder {
		private final PatchSocialmediaTopicDataingestionrulesFacebookFacebookIngestionRuleIdRequest request;

		private Builder() {
			request = new PatchSocialmediaTopicDataingestionrulesFacebookFacebookIngestionRuleIdRequest();
		}
		...
		public PatchSocialmediaTopicDataingestionrulesFacebookFacebookIngestionRuleIdRequest build() {
