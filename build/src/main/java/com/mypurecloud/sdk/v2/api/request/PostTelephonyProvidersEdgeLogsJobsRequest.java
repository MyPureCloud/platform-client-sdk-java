...
public class PostTelephonyProvidersEdgeLogsJobsRequest {
	...
	public PostTelephonyProvidersEdgeLogsJobsRequest withEdgeId(String edgeId) {
	    this.setEdgeId(edgeId);
	    return this;
	} 
	
	private EdgeLogsJobRequest body;
	public EdgeLogsJobRequest getBody() {
		return this.body;
	}

	public void setBody(EdgeLogsJobRequest body) {
		this.body = body;
	}

	public PostTelephonyProvidersEdgeLogsJobsRequest withBody(EdgeLogsJobRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostTelephonyProvidersEdgeLogsJobsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<EdgeLogsJobRequest> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("POST", "/api/v2/telephony/providers/edges/{edgeId}/logs/jobs")
	...
	public static Builder builder(String edgeId, EdgeLogsJobRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostTelephonyProvidersEdgeLogsJobsRequest request;

		private Builder() {
			request = new PostTelephonyProvidersEdgeLogsJobsRequest();
		}
		...
		public Builder withBody(EdgeLogsJobRequest body) {
		...
		public Builder withRequiredParams(String edgeId, EdgeLogsJobRequest body) {
			request.setEdgeId(edgeId);
						request.setBody(body);
		...
		public PostTelephonyProvidersEdgeLogsJobsRequest build() {
