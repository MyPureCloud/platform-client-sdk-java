...
public class PutConversationsCobrowsesessionRecordingstateRequest {
	...
	public PutConversationsCobrowsesessionRecordingstateRequest withBody(SetRecordingState body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public ApiRequest<SetRecordingState> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PutConversationsCobrowsesessionRecordingstateRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutConversationsCobrowsesessionRecordingstateRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/conversations/cobrowsesessions/{conversationId}/recordingstate")
	...
	public static class Builder {
		private final PutConversationsCobrowsesessionRecordingstateRequest request;

		private Builder() {
			request = new PutConversationsCobrowsesessionRecordingstateRequest();
		}
		...
		public PutConversationsCobrowsesessionRecordingstateRequest build() {
