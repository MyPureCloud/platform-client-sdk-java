...
public class GetConversationsMessagingIntegrationsAppleIntegrationIdRequest {
	...
	public GetConversationsMessagingIntegrationsAppleIntegrationIdRequest withIntegrationId(String integrationId) {
	...
	public GetConversationsMessagingIntegrationsAppleIntegrationIdRequest withExpand(String expand) {
    ...
    public GetConversationsMessagingIntegrationsAppleIntegrationIdRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.integrationId == null) {
            throw new IllegalStateException("Missing the required parameter 'integrationId' when building request for GetConversationsMessagingIntegrationsAppleIntegrationIdRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/conversations/messaging/integrations/apple/{integrationId}")
	...
	public static class Builder {
		private final GetConversationsMessagingIntegrationsAppleIntegrationIdRequest request;

		private Builder() {
			request = new GetConversationsMessagingIntegrationsAppleIntegrationIdRequest();
		}
		...
		public GetConversationsMessagingIntegrationsAppleIntegrationIdRequest build() {
