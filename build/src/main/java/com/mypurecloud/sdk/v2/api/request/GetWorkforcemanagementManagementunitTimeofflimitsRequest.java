...
public class GetWorkforcemanagementManagementunitTimeofflimitsRequest {
	...
	public GetWorkforcemanagementManagementunitTimeofflimitsRequest withManagementUnitId(String managementUnitId) {
    ...
    public GetWorkforcemanagementManagementunitTimeofflimitsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.managementUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'managementUnitId' when building request for GetWorkforcemanagementManagementunitTimeofflimitsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/managementunits/{managementUnitId}/timeofflimits")
	...
	public static class Builder {
		private final GetWorkforcemanagementManagementunitTimeofflimitsRequest request;

		private Builder() {
			request = new GetWorkforcemanagementManagementunitTimeofflimitsRequest();
		}
		...
		public GetWorkforcemanagementManagementunitTimeofflimitsRequest build() {
