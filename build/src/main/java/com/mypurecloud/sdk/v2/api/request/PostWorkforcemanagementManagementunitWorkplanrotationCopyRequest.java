...
public class PostWorkforcemanagementManagementunitWorkplanrotationCopyRequest {
	...
	private CopyWorkPlanRotationRequest body;
	public CopyWorkPlanRotationRequest getBody() {
		return this.body;
	}

	public void setBody(CopyWorkPlanRotationRequest body) {
		this.body = body;
	}
    ...
    public ApiRequest<CopyWorkPlanRotationRequest> withHttpInfo() {
        
        // verify the required parameter 'managementUnitId' is set
        if (this.managementUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'managementUnitId' when building request for PostWorkforcemanagementManagementunitWorkplanrotationCopyRequest.");
        }
	...
	public static class Builder {
		private final PostWorkforcemanagementManagementunitWorkplanrotationCopyRequest request;

		private Builder() {
			request = new PostWorkforcemanagementManagementunitWorkplanrotationCopyRequest();
		}
		...
		public Builder withBody(CopyWorkPlanRotationRequest body) {
		...
		public PostWorkforcemanagementManagementunitWorkplanrotationCopyRequest build() {
