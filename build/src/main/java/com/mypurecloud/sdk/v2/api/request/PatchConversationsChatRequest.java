...
public class PatchConversationsChatRequest {
	...
	public PatchConversationsChatRequest withConversationId(String conversationId) {
    ...
    public ApiRequest<Conversation> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PatchConversationsChatRequest.");
        }
        ...
        return ApiRequestBuilder.create("PATCH", "/api/v2/conversations/chats/{conversationId}")
	...
	public static class Builder {
		private final PatchConversationsChatRequest request;

		private Builder() {
			request = new PatchConversationsChatRequest();
		}
