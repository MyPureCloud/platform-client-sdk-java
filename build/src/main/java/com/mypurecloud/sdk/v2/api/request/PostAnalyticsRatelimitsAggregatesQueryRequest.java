...
public class PostAnalyticsRatelimitsAggregatesQueryRequest {

	private RateLimitAggregationQuery body;
	public RateLimitAggregationQuery getBody() {
		return this.body;
	}

	public void setBody(RateLimitAggregationQuery body) {
		this.body = body;
	}

	public PostAnalyticsRatelimitsAggregatesQueryRequest withBody(RateLimitAggregationQuery body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostAnalyticsRatelimitsAggregatesQueryRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<RateLimitAggregationQuery> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostAnalyticsRatelimitsAggregatesQueryRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/analytics/ratelimits/aggregates/query")
                .withBody(body)
	...
	public static Builder builder(RateLimitAggregationQuery body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostAnalyticsRatelimitsAggregatesQueryRequest request;

		private Builder() {
			request = new PostAnalyticsRatelimitsAggregatesQueryRequest();
		}


		public Builder withBody(RateLimitAggregationQuery body) {
		...
		public Builder withRequiredParams(RateLimitAggregationQuery body) {
			request.setBody(body);
		...
		public PostAnalyticsRatelimitsAggregatesQueryRequest build() {
