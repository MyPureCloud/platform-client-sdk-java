...
public class PatchWorkforcemanagementManagementunitAgentsRequest {
	...
	public PatchWorkforcemanagementManagementunitAgentsRequest withManagementUnitId(String managementUnitId) {
	    this.setManagementUnitId(managementUnitId);
	    return this;
	} 

	private UpdateMuAgentsRequest body;
	public UpdateMuAgentsRequest getBody() {
		return this.body;
	}

	public void setBody(UpdateMuAgentsRequest body) {
		this.body = body;
	}

	public PatchWorkforcemanagementManagementunitAgentsRequest withBody(UpdateMuAgentsRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchWorkforcemanagementManagementunitAgentsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<UpdateMuAgentsRequest> withHttpInfo() {
        
        // verify the required parameter 'managementUnitId' is set
        if (this.managementUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'managementUnitId' when building request for PatchWorkforcemanagementManagementunitAgentsRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchWorkforcemanagementManagementunitAgentsRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/workforcemanagement/managementunits/{managementUnitId}/agents")
	...
	public static Builder builder(String managementUnitId, UpdateMuAgentsRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PatchWorkforcemanagementManagementunitAgentsRequest request;

		private Builder() {
			request = new PatchWorkforcemanagementManagementunitAgentsRequest();
		}
		...
		public Builder withBody(UpdateMuAgentsRequest body) {
		...
		public Builder withRequiredParams(String managementUnitId, UpdateMuAgentsRequest body) {
			request.setManagementUnitId(managementUnitId);
			request.setBody(body);
		...
		public PatchWorkforcemanagementManagementunitAgentsRequest build() {
