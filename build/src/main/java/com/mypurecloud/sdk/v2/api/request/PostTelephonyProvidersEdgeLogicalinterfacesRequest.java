...
public class PostTelephonyProvidersEdgeLogicalinterfacesRequest {
	...
	public PostTelephonyProvidersEdgeLogicalinterfacesRequest withEdgeId(String edgeId) {
	...
	public PostTelephonyProvidersEdgeLogicalinterfacesRequest withBody(DomainLogicalInterface body) {
	    this.setBody(body);
	    return this;
	}
    ...
    public PostTelephonyProvidersEdgeLogicalinterfacesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<DomainLogicalInterface> withHttpInfo() throws ApiException {
        ...
        if (this.edgeId == null) {
            throw new ApiException(400, "Missing the required parameter 'edgeId' when building request for PostTelephonyProvidersEdgeLogicalinterfacesRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new ApiException(400, "Missing the required parameter 'body' when building request for PostTelephonyProvidersEdgeLogicalinterfacesRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/telephony/providers/edges/{edgeId}/logicalinterfaces")
