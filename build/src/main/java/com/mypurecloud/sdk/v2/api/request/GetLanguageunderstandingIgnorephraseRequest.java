...
public class GetLanguageunderstandingIgnorephraseRequest {
	...
	public GetLanguageunderstandingIgnorephraseRequest withLanguageCode(String languageCode) {
	...
	public GetLanguageunderstandingIgnorephraseRequest withPageSize(Integer pageSize) {
	...
	public GetLanguageunderstandingIgnorephraseRequest withPageNumber(Integer pageNumber) {
	...
	public GetLanguageunderstandingIgnorephraseRequest withText(String text) {
	    this.setText(text);
	    return this;
	} 
	...
	public GetLanguageunderstandingIgnorephraseRequest withSortOrder(String sortOrder) {
	...
	public GetLanguageunderstandingIgnorephraseRequest withSortBy(String sortBy) {
    ...
    public GetLanguageunderstandingIgnorephraseRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.languageCode == null) {
            throw new IllegalStateException("Missing the required parameter 'languageCode' when building request for GetLanguageunderstandingIgnorephraseRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/languageunderstanding/ignorephrases/{languageCode}")
	...
	public static class Builder {
		private final GetLanguageunderstandingIgnorephraseRequest request;

		private Builder() {
			request = new GetLanguageunderstandingIgnorephraseRequest();
		}
		...
		public GetLanguageunderstandingIgnorephraseRequest build() {
