...
public class DeleteRoutingSmsAddressRequest {
	...
	public DeleteRoutingSmsAddressRequest withAddressId(String addressId) {
    ...
    public DeleteRoutingSmsAddressRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.addressId == null) {
            throw new IllegalStateException("Missing the required parameter 'addressId' when building request for DeleteRoutingSmsAddressRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/routing/sms/addresses/{addressId}")
	...
	public static class Builder {
		private final DeleteRoutingSmsAddressRequest request;

		private Builder() {
			request = new DeleteRoutingSmsAddressRequest();
		}
		...
		public DeleteRoutingSmsAddressRequest build() {
