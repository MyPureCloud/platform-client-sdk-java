...
public class PostAlertingAlertsQueryRequest {

	private GetAlertQuery body;
	public GetAlertQuery getBody() {
		return this.body;
	}

	public void setBody(GetAlertQuery body) {
		this.body = body;
	}

	public PostAlertingAlertsQueryRequest withBody(GetAlertQuery body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostAlertingAlertsQueryRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<GetAlertQuery> withHttpInfo() {
        

        return ApiRequestBuilder.create("POST", "/api/v2/alerting/alerts/query")
                .withBody(body)
	...
	public static class Builder {
		private final PostAlertingAlertsQueryRequest request;

		private Builder() {
			request = new PostAlertingAlertsQueryRequest();
		}


		public Builder withBody(GetAlertQuery body) {
		...
		public PostAlertingAlertsQueryRequest build() {
