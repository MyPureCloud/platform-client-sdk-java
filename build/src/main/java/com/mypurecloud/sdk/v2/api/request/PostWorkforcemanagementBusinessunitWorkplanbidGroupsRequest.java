...
public class PostWorkforcemanagementBusinessunitWorkplanbidGroupsRequest {
	...
	public PostWorkforcemanagementBusinessunitWorkplanbidGroupsRequest withBusinessUnitId(String businessUnitId) {
	...
	public PostWorkforcemanagementBusinessunitWorkplanbidGroupsRequest withBidId(String bidId) {
	    this.setBidId(bidId);
	    return this;
	} 
	...
	public void setBody(WorkPlanBidGroupCreate body) {
		this.body = body;
	}

	public PostWorkforcemanagementBusinessunitWorkplanbidGroupsRequest withBody(WorkPlanBidGroupCreate body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementBusinessunitWorkplanbidGroupsRequest withCustomHeader(String name, String value) {
	...
	public static class Builder {
		...
		private Builder() {
			request = new PostWorkforcemanagementBusinessunitWorkplanbidGroupsRequest();
		}
		...
		public Builder withBody(WorkPlanBidGroupCreate body) {
