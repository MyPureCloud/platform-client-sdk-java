...
public class DeleteAssistantRequest {
    ...
    public DeleteAssistantRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.assistantId == null) {
            throw new IllegalStateException("Missing the required parameter 'assistantId' when building request for DeleteAssistantRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/assistants/{assistantId}")
	...
	public static class Builder {
		private final DeleteAssistantRequest request;
