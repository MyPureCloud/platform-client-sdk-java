...
public class GetConversationsMessagingSupportedcontentSupportedContentIdRequest {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.supportedContentId == null) {
            throw new IllegalStateException("Missing the required parameter 'supportedContentId' when building request for GetConversationsMessagingSupportedcontentSupportedContentIdRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/conversations/messaging/supportedcontent/{supportedContentId}")
	...
	public static class Builder {
		private final GetConversationsMessagingSupportedcontentSupportedContentIdRequest request;

		private Builder() {
			request = new GetConversationsMessagingSupportedcontentSupportedContentIdRequest();
		}
		...
		public GetConversationsMessagingSupportedcontentSupportedContentIdRequest build() {
