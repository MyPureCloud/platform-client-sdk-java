...
public class GetTelephonyProvidersEdgesEdgegroupRequest {
	...
	public enum expandValues { 
		PHONETRUNKBASES("phoneTrunkBases"), 
		EDGETRUNKBASEASSIGNMENT("edgeTrunkBaseAssignment");
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.edgeGroupId == null) {
            throw new IllegalStateException("Missing the required parameter 'edgeGroupId' when building request for GetTelephonyProvidersEdgesEdgegroupRequest.");
        }
