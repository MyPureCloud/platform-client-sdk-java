...
public class GetQualityFormVersionsRequest {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.formId == null) {
            throw new IllegalStateException("Missing the required parameter 'formId' when building request for GetQualityFormVersionsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/quality/forms/{formId}/versions")
