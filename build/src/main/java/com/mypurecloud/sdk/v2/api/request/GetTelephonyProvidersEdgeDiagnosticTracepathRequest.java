...
public class GetTelephonyProvidersEdgeDiagnosticTracepathRequest {
	...
	public GetTelephonyProvidersEdgeDiagnosticTracepathRequest withEdgeId(String edgeId) {
    ...
    public GetTelephonyProvidersEdgeDiagnosticTracepathRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.edgeId == null) {
            throw new IllegalStateException("Missing the required parameter 'edgeId' when building request for GetTelephonyProvidersEdgeDiagnosticTracepathRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/telephony/providers/edges/{edgeId}/diagnostic/tracepath")
	...
	public static class Builder {
		private final GetTelephonyProvidersEdgeDiagnosticTracepathRequest request;

		private Builder() {
			request = new GetTelephonyProvidersEdgeDiagnosticTracepathRequest();
		}
		...
		public GetTelephonyProvidersEdgeDiagnosticTracepathRequest build() {
