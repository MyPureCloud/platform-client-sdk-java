...
public class GetWorkforcemanagementBusinessunitTimeoffplanRequest {
	...
	public GetWorkforcemanagementBusinessunitTimeoffplanRequest withTimeOffPlanId(String timeOffPlanId) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for GetWorkforcemanagementBusinessunitTimeoffplanRequest.");
        }
        
        // verify the required parameter 'timeOffPlanId' is set
        if (this.timeOffPlanId == null) {
            throw new IllegalStateException("Missing the required parameter 'timeOffPlanId' when building request for GetWorkforcemanagementBusinessunitTimeoffplanRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/timeoffplans/{timeOffPlanId}")
	...
	public static class Builder {
		private final GetWorkforcemanagementBusinessunitTimeoffplanRequest request;

		private Builder() {
			request = new GetWorkforcemanagementBusinessunitTimeoffplanRequest();
		}
		...
		public GetWorkforcemanagementBusinessunitTimeoffplanRequest build() {
