...
public class GetIntegrationsSpeechLexBotAliasRequest {
	...
	public GetIntegrationsSpeechLexBotAliasRequest withAliasId(String aliasId) {
    ...
    public GetIntegrationsSpeechLexBotAliasRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.aliasId == null) {
            throw new IllegalStateException("Missing the required parameter 'aliasId' when building request for GetIntegrationsSpeechLexBotAliasRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/integrations/speech/lex/bot/alias/{aliasId}")
	...
	public static class Builder {
		private final GetIntegrationsSpeechLexBotAliasRequest request;

		private Builder() {
			request = new GetIntegrationsSpeechLexBotAliasRequest();
		}
		...
		public GetIntegrationsSpeechLexBotAliasRequest build() {
