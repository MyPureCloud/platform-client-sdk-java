...
public class GetFlowsInstancesJobRequest {
	...
	public GetFlowsInstancesJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetFlowsInstancesJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetFlowsInstancesJobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/flows/instances/jobs/{jobId}")
	...
	public static class Builder {
		private final GetFlowsInstancesJobRequest request;

		private Builder() {
			request = new GetFlowsInstancesJobRequest();
		}
		...
		public GetFlowsInstancesJobRequest build() {
