...
public class PostConversationsMessagesRequest {
    
	private CreateOutboundMessagingConversationRequest body;
	public CreateOutboundMessagingConversationRequest getBody() {
		return this.body;
	}

	public void setBody(CreateOutboundMessagingConversationRequest body) {
		this.body = body;
	}

	public PostConversationsMessagesRequest withBody(CreateOutboundMessagingConversationRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostConversationsMessagesRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<CreateOutboundMessagingConversationRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostConversationsMessagesRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/conversations/messages")
                .withBody(body)
	...
	public static Builder builder(CreateOutboundMessagingConversationRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostConversationsMessagesRequest request;

		private Builder() {
			request = new PostConversationsMessagesRequest();
		}

		
		public Builder withBody(CreateOutboundMessagingConversationRequest body) {
		...
		public Builder withRequiredParams(CreateOutboundMessagingConversationRequest body) {
			request.setBody(body);
		...
		public PostConversationsMessagesRequest build() {
