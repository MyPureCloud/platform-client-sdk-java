...
public class ConversationVideoEventTopicJourneyCustomer  implements Serializable {
  
  private String id = null;
  private String idType = null;

  public ConversationVideoEventTopicJourneyCustomer() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
    }
  }

  public ConversationVideoEventTopicJourneyCustomer(Boolean initWithEmptyList) {
   ...
   **/
  public ConversationVideoEventTopicJourneyCustomer id(String id) {
    this.id = id;
    return this;
  }
   ...
   **/
  public ConversationVideoEventTopicJourneyCustomer idType(String idType) {
    this.idType = idType;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ConversationVideoEventTopicJourneyCustomer conversationVideoEventTopicJourneyCustomer = (ConversationVideoEventTopicJourneyCustomer) o;

    return Objects.equals(this.id, conversationVideoEventTopicJourneyCustomer.id) &&
            Objects.equals(this.idType, conversationVideoEventTopicJourneyCustomer.idType);
  }
