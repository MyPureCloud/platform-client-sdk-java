...
public class GetJourneyViewSchedulesRequest {
	...
	public GetJourneyViewSchedulesRequest withViewId(String viewId) {
    ...
    public GetJourneyViewSchedulesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.viewId == null) {
            throw new IllegalStateException("Missing the required parameter 'viewId' when building request for GetJourneyViewSchedulesRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/journey/views/{viewId}/schedules")
	...
	public static Builder builder(String viewId) {
	    return new Builder()
	            .withRequiredParams(viewId);
	}


	public static class Builder {
		private final GetJourneyViewSchedulesRequest request;

		private Builder() {
			request = new GetJourneyViewSchedulesRequest();
		}
		...
		public Builder withRequiredParams(String viewId) {
			request.setViewId(viewId);
		...
		public GetJourneyViewSchedulesRequest build() {
