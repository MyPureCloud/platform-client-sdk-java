...
public class DeleteKnowledgeKnowledgebaseSourcesSalesforceSourceIdRequest {
	...
	public DeleteKnowledgeKnowledgebaseSourcesSalesforceSourceIdRequest withKnowledgeBaseId(String knowledgeBaseId) {
	...
	public DeleteKnowledgeKnowledgebaseSourcesSalesforceSourceIdRequest withSourceId(String sourceId) {
    ...
    public DeleteKnowledgeKnowledgebaseSourcesSalesforceSourceIdRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.knowledgeBaseId == null) {
            throw new IllegalStateException("Missing the required parameter 'knowledgeBaseId' when building request for DeleteKnowledgeKnowledgebaseSourcesSalesforceSourceIdRequest.");
        }
        
        // verify the required parameter 'sourceId' is set
        if (this.sourceId == null) {
            throw new IllegalStateException("Missing the required parameter 'sourceId' when building request for DeleteKnowledgeKnowledgebaseSourcesSalesforceSourceIdRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/sources/salesforce/{sourceId}")
	...
	public static class Builder {
		private final DeleteKnowledgeKnowledgebaseSourcesSalesforceSourceIdRequest request;

		private Builder() {
			request = new DeleteKnowledgeKnowledgebaseSourcesSalesforceSourceIdRequest();
		}
		...
		public DeleteKnowledgeKnowledgebaseSourcesSalesforceSourceIdRequest build() {
