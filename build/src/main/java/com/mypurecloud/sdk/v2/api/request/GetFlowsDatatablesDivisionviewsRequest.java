...
public class GetFlowsDatatablesDivisionviewsRequest {
	...
	public GetFlowsDatatablesDivisionviewsRequest withExpand(String expand) {
	...
	public GetFlowsDatatablesDivisionviewsRequest withPageNumber(Integer pageNumber) {
	...
	public GetFlowsDatatablesDivisionviewsRequest withPageSize(Integer pageSize) {
	...
	public GetFlowsDatatablesDivisionviewsRequest withSortBy(String sortBy) {
	...
	public GetFlowsDatatablesDivisionviewsRequest withSortOrder(String sortOrder) {
	...
	public GetFlowsDatatablesDivisionviewsRequest withDivisionId(List<String> divisionId) {
	...
	public GetFlowsDatatablesDivisionviewsRequest withName(String name) {
	    this.setName(name);
	    return this;
	} 
    ...
    public GetFlowsDatatablesDivisionviewsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/flows/datatables/divisionviews")
	...
	public static class Builder {
		private final GetFlowsDatatablesDivisionviewsRequest request;

		private Builder() {
			request = new GetFlowsDatatablesDivisionviewsRequest();
		}
		...
		public GetFlowsDatatablesDivisionviewsRequest build() {
