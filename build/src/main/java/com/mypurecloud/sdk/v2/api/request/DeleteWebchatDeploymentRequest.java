...
public class DeleteWebchatDeploymentRequest {
	...
	public DeleteWebchatDeploymentRequest withDeploymentId(String deploymentId) {
    ...
    public DeleteWebchatDeploymentRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.deploymentId == null) {
            throw new IllegalStateException("Missing the required parameter 'deploymentId' when building request for DeleteWebchatDeploymentRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/webchat/deployments/{deploymentId}")
	...
	public static class Builder {
		private final DeleteWebchatDeploymentRequest request;

		private Builder() {
			request = new DeleteWebchatDeploymentRequest();
		}
		...
		public DeleteWebchatDeploymentRequest build() {
