...
public class PostWorkforcemanagementManagementunitUserTimeoffrequestTimeoffbalanceJobsRequest {
	...
	public PostWorkforcemanagementManagementunitUserTimeoffrequestTimeoffbalanceJobsRequest withManagementUnitId(String managementUnitId) {
	...
	public PostWorkforcemanagementManagementunitUserTimeoffrequestTimeoffbalanceJobsRequest withUserId(String userId) {
	...
	public PostWorkforcemanagementManagementunitUserTimeoffrequestTimeoffbalanceJobsRequest withTimeOffRequestId(String timeOffRequestId) {
    ...
    public PostWorkforcemanagementManagementunitUserTimeoffrequestTimeoffbalanceJobsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.managementUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'managementUnitId' when building request for PostWorkforcemanagementManagementunitUserTimeoffrequestTimeoffbalanceJobsRequest.");
        }
        
        // verify the required parameter 'userId' is set
        if (this.userId == null) {
            throw new IllegalStateException("Missing the required parameter 'userId' when building request for PostWorkforcemanagementManagementunitUserTimeoffrequestTimeoffbalanceJobsRequest.");
        }
        
        // verify the required parameter 'timeOffRequestId' is set
        if (this.timeOffRequestId == null) {
            throw new IllegalStateException("Missing the required parameter 'timeOffRequestId' when building request for PostWorkforcemanagementManagementunitUserTimeoffrequestTimeoffbalanceJobsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/managementunits/{managementUnitId}/users/{userId}/timeoffrequests/{timeOffRequestId}/timeoffbalance/jobs")
	...
	public static class Builder {
		private final PostWorkforcemanagementManagementunitUserTimeoffrequestTimeoffbalanceJobsRequest request;

		private Builder() {
			request = new PostWorkforcemanagementManagementunitUserTimeoffrequestTimeoffbalanceJobsRequest();
		}
		...
		public PostWorkforcemanagementManagementunitUserTimeoffrequestTimeoffbalanceJobsRequest build() {
