...
public class DeleteOutboundDnclistRequest {
	...
	public DeleteOutboundDnclistRequest withDncListId(String dncListId) {
    ...
    public DeleteOutboundDnclistRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.dncListId == null) {
            throw new IllegalStateException("Missing the required parameter 'dncListId' when building request for DeleteOutboundDnclistRequest.");
        }
