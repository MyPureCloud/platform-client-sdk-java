...
public class GetGamificationScorecardsPointsAlltimeRequest {
	...
	public GetGamificationScorecardsPointsAlltimeRequest withEndWorkday(LocalDate endWorkday) {
    ...
    public GetGamificationScorecardsPointsAlltimeRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.endWorkday == null) {
            throw new IllegalStateException("Missing the required parameter 'endWorkday' when building request for GetGamificationScorecardsPointsAlltimeRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/gamification/scorecards/points/alltime")
	...
	public static Builder builder(LocalDate endWorkday) {
	    return new Builder()
	            .withRequiredParams(endWorkday);
	}
	

	public static class Builder {
		private final GetGamificationScorecardsPointsAlltimeRequest request;

		private Builder() {
			request = new GetGamificationScorecardsPointsAlltimeRequest();
		}
		...
		public Builder withRequiredParams(LocalDate endWorkday) {
			request.setEndWorkday(endWorkday);
		...
		public GetGamificationScorecardsPointsAlltimeRequest build() {
