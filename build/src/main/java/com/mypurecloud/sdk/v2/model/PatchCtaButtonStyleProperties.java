...
public class PatchCtaButtonStyleProperties  implements Serializable {
 ...
 @JsonDeserialize(using = TextAlignEnumDeserializer.class)
   ...
   **/
  public PatchCtaButtonStyleProperties color(String color) {
    this.color = color;
    return this;
  }
   ...
   **/
  public PatchCtaButtonStyleProperties font(String font) {
    this.font = font;
    return this;
  }
   ...
   **/
  public PatchCtaButtonStyleProperties fontSize(String fontSize) {
   ...
   * Text alignment.
   **/
  public PatchCtaButtonStyleProperties textAlign(TextAlignEnum textAlign) {
   ...
   **/
  public PatchCtaButtonStyleProperties backgroundColor(String backgroundColor) {
    this.backgroundColor = backgroundColor;
    return this;
  }
  
  @ApiModelProperty(example = "null", value = "Background color of the CTA button. (eg. #A04033)")
