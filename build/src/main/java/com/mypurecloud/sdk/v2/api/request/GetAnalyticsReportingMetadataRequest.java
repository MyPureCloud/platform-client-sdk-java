...
public class GetAnalyticsReportingMetadataRequest {
	...
	public GetAnalyticsReportingMetadataRequest withPageNumber(Integer pageNumber) {
	...
	public GetAnalyticsReportingMetadataRequest withPageSize(Integer pageSize) {
	...
	public GetAnalyticsReportingMetadataRequest withLocale(String locale) {
    ...
    public GetAnalyticsReportingMetadataRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/analytics/reporting/metadata")
