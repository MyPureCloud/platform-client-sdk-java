...
public class GetFlowsExportJobRequest {
	...
	public GetFlowsExportJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
	...
	public GetFlowsExportJobRequest withExpand(List<String> expand) {
    ...
    public GetFlowsExportJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetFlowsExportJobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/flows/export/jobs/{jobId}")
	...
	public static class Builder {
		private final GetFlowsExportJobRequest request;

		private Builder() {
			request = new GetFlowsExportJobRequest();
		}
		...
		public GetFlowsExportJobRequest build() {
