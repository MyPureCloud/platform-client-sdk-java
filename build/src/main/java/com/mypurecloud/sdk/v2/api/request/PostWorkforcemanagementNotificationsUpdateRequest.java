...
public class PostWorkforcemanagementNotificationsUpdateRequest {
    
	private UpdateNotificationsRequest body;
	public UpdateNotificationsRequest getBody() {
		return this.body;
	}

	public void setBody(UpdateNotificationsRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementNotificationsUpdateRequest withBody(UpdateNotificationsRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementNotificationsUpdateRequest withCustomHeader(String name, String value) {
	...
	public static class Builder {
		private final PostWorkforcemanagementNotificationsUpdateRequest request;

		private Builder() {
			request = new PostWorkforcemanagementNotificationsUpdateRequest();
		}

		
		public Builder withBody(UpdateNotificationsRequest body) {
