...
public class PatchWorkforcemanagementBusinessunitActivitycodesBulkRequest {
	...
	public PatchWorkforcemanagementBusinessunitActivitycodesBulkRequest withBusinessUnitId(String businessUnitId) {
	    this.setBusinessUnitId(businessUnitId);
	    return this;
	} 

	private BulkUpdateActivityCodeRequest body;
	public BulkUpdateActivityCodeRequest getBody() {
		return this.body;
	}

	public void setBody(BulkUpdateActivityCodeRequest body) {
		this.body = body;
	}

	public PatchWorkforcemanagementBusinessunitActivitycodesBulkRequest withBody(BulkUpdateActivityCodeRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchWorkforcemanagementBusinessunitActivitycodesBulkRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<BulkUpdateActivityCodeRequest> withHttpInfo() {
        
        // verify the required parameter 'businessUnitId' is set
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PatchWorkforcemanagementBusinessunitActivitycodesBulkRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchWorkforcemanagementBusinessunitActivitycodesBulkRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/activitycodes/bulk")
	...
	public static Builder builder(String businessUnitId, BulkUpdateActivityCodeRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PatchWorkforcemanagementBusinessunitActivitycodesBulkRequest request;

		private Builder() {
			request = new PatchWorkforcemanagementBusinessunitActivitycodesBulkRequest();
		}
		...
		public Builder withBody(BulkUpdateActivityCodeRequest body) {
		...
		public Builder withRequiredParams(String businessUnitId, BulkUpdateActivityCodeRequest body) {
			request.setBusinessUnitId(businessUnitId);
			request.setBody(body);
		...
		public PatchWorkforcemanagementBusinessunitActivitycodesBulkRequest build() {
