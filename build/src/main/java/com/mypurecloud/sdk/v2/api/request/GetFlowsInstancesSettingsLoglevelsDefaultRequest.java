...
public class GetFlowsInstancesSettingsLoglevelsDefaultRequest {
	...
	public GetFlowsInstancesSettingsLoglevelsDefaultRequest withExpand(List<String> expand) {
    ...
    public GetFlowsInstancesSettingsLoglevelsDefaultRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/flows/instances/settings/loglevels/default")
	...
	public static class Builder {
		private final GetFlowsInstancesSettingsLoglevelsDefaultRequest request;

		private Builder() {
			request = new GetFlowsInstancesSettingsLoglevelsDefaultRequest();
		}
		...
		public GetFlowsInstancesSettingsLoglevelsDefaultRequest build() {
