...
public class PutRecordingCrossplatformMediaretentionpolicyRequest {
	...
	public PutRecordingCrossplatformMediaretentionpolicyRequest withPolicyId(String policyId) {
	...
	public PutRecordingCrossplatformMediaretentionpolicyRequest withBody(CrossPlatformPolicy body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutRecordingCrossplatformMediaretentionpolicyRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<CrossPlatformPolicy> withHttpInfo() {
        ...
        if (this.policyId == null) {
            throw new IllegalStateException("Missing the required parameter 'policyId' when building request for PutRecordingCrossplatformMediaretentionpolicyRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutRecordingCrossplatformMediaretentionpolicyRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/recording/crossplatform/mediaretentionpolicies/{policyId}")
	...
	public static class Builder {
		private final PutRecordingCrossplatformMediaretentionpolicyRequest request;

		private Builder() {
			request = new PutRecordingCrossplatformMediaretentionpolicyRequest();
		}
		...
		public PutRecordingCrossplatformMediaretentionpolicyRequest build() {
