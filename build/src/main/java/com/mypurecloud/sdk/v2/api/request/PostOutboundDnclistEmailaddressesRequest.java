...
public class PostOutboundDnclistEmailaddressesRequest {
	...
	public PostOutboundDnclistEmailaddressesRequest withDncListId(String dncListId) {
	...
	public PostOutboundDnclistEmailaddressesRequest withBody(List<String> body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostOutboundDnclistEmailaddressesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<List<String>> withHttpInfo() {
        ...
        if (this.dncListId == null) {
            throw new IllegalStateException("Missing the required parameter 'dncListId' when building request for PostOutboundDnclistEmailaddressesRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostOutboundDnclistEmailaddressesRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/outbound/dnclists/{dncListId}/emailaddresses")
	...
	public static Builder builder(String dncListId, List<String> body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostOutboundDnclistEmailaddressesRequest request;

		private Builder() {
			request = new PostOutboundDnclistEmailaddressesRequest();
		}
		...
		public Builder withRequiredParams(String dncListId, List<String> body) {
			request.setDncListId(dncListId);
			request.setBody(body);
		...
		public PostOutboundDnclistEmailaddressesRequest build() {
