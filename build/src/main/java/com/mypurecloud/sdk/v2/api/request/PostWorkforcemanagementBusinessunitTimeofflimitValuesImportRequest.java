...
public class PostWorkforcemanagementBusinessunitTimeofflimitValuesImportRequest {
	...
	public PostWorkforcemanagementBusinessunitTimeofflimitValuesImportRequest withBusinessUnitId(String businessUnitId) {
	...
	public PostWorkforcemanagementBusinessunitTimeofflimitValuesImportRequest withTimeOffLimitId(String timeOffLimitId) {
	    this.setTimeOffLimitId(timeOffLimitId);
	    return this;
	} 

	private BuImportTimeOffLimitValuesRequest body;
	public BuImportTimeOffLimitValuesRequest getBody() {
		return this.body;
	}

	public void setBody(BuImportTimeOffLimitValuesRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementBusinessunitTimeofflimitValuesImportRequest withBody(BuImportTimeOffLimitValuesRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementBusinessunitTimeofflimitValuesImportRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<BuImportTimeOffLimitValuesRequest> withHttpInfo() {
        
        // verify the required parameter 'businessUnitId' is set
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PostWorkforcemanagementBusinessunitTimeofflimitValuesImportRequest.");
        }
        
        // verify the required parameter 'timeOffLimitId' is set
        if (this.timeOffLimitId == null) {
            throw new IllegalStateException("Missing the required parameter 'timeOffLimitId' when building request for PostWorkforcemanagementBusinessunitTimeofflimitValuesImportRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementBusinessunitTimeofflimitValuesImportRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/timeofflimits/{timeOffLimitId}/values/import")
	...
	public static Builder builder(String businessUnitId, String timeOffLimitId, BuImportTimeOffLimitValuesRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementBusinessunitTimeofflimitValuesImportRequest request;

		private Builder() {
			request = new PostWorkforcemanagementBusinessunitTimeofflimitValuesImportRequest();
		}
		...
		public Builder withBody(BuImportTimeOffLimitValuesRequest body) {
		...
		public Builder withRequiredParams(String businessUnitId, String timeOffLimitId, BuImportTimeOffLimitValuesRequest body) {
			request.setBusinessUnitId(businessUnitId);
			request.setTimeOffLimitId(timeOffLimitId);
			request.setBody(body);
		...
		public PostWorkforcemanagementBusinessunitTimeofflimitValuesImportRequest build() {
