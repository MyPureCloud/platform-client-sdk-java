...
public class PatchWorkforcemanagementBusinessunitOpportunityRequest {
	...
	private PatchOpportunityRequest body;
	public PatchOpportunityRequest getBody() {
		return this.body;
	}

	public void setBody(PatchOpportunityRequest body) {
		this.body = body;
	}
    ...
    public ApiRequest<PatchOpportunityRequest> withHttpInfo() {
        
        // verify the required parameter 'businessUnitId' is set
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PatchWorkforcemanagementBusinessunitOpportunityRequest.");
        }
        
        // verify the required parameter 'opportunityId' is set
        if (this.opportunityId == null) {
            throw new IllegalStateException("Missing the required parameter 'opportunityId' when building request for PatchWorkforcemanagementBusinessunitOpportunityRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchWorkforcemanagementBusinessunitOpportunityRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/opportunities/{opportunityId}")
                .withPathParameter("businessUnitId", businessUnitId)
        
                .withPathParameter("opportunityId", opportunityId)
	...
	public static Builder builder(String businessUnitId, String opportunityId, PatchOpportunityRequest body) {
	    return new Builder()
	            .withRequiredParams(businessUnitId, opportunityId, body);
	}


	public static class Builder {
		private final PatchWorkforcemanagementBusinessunitOpportunityRequest request;

		private Builder() {
			request = new PatchWorkforcemanagementBusinessunitOpportunityRequest();
		}
		...
		public Builder withBody(PatchOpportunityRequest body) {
		...
		public Builder withRequiredParams(String businessUnitId, String opportunityId, PatchOpportunityRequest body) {
			request.setBusinessUnitId(businessUnitId);
			request.setOpportunityId(opportunityId);
			request.setBody(body);
		...
		public PatchWorkforcemanagementBusinessunitOpportunityRequest build() {
