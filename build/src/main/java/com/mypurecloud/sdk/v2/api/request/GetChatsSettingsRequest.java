...
public class GetChatsSettingsRequest {
    ...
    public GetChatsSettingsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/chats/settings")
	...
	public static class Builder {
		private final GetChatsSettingsRequest request;

		private Builder() {
			request = new GetChatsSettingsRequest();
		}
		...
		public GetChatsSettingsRequest build() {
