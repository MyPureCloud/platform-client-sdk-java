...
public class GetKnowledgeKnowledgebaseUnansweredGroupRequest {
	...
	public GetKnowledgeKnowledgebaseUnansweredGroupRequest withKnowledgeBaseId(String knowledgeBaseId) {
	...
	public GetKnowledgeKnowledgebaseUnansweredGroupRequest withGroupId(String groupId) {
	...
	public GetKnowledgeKnowledgebaseUnansweredGroupRequest withApp(String app) {
	    this.setApp(app);
	    return this;
	} 
	...
	public GetKnowledgeKnowledgebaseUnansweredGroupRequest withDateStart(LocalDate dateStart) {
	...
	public GetKnowledgeKnowledgebaseUnansweredGroupRequest withDateEnd(LocalDate dateEnd) {
    ...
    public GetKnowledgeKnowledgebaseUnansweredGroupRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.knowledgeBaseId == null) {
            throw new IllegalStateException("Missing the required parameter 'knowledgeBaseId' when building request for GetKnowledgeKnowledgebaseUnansweredGroupRequest.");
        }
        
        // verify the required parameter 'groupId' is set
        if (this.groupId == null) {
            throw new IllegalStateException("Missing the required parameter 'groupId' when building request for GetKnowledgeKnowledgebaseUnansweredGroupRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/unanswered/groups/{groupId}")
	...
	public static Builder builder(String knowledgeBaseId, String groupId) {
	    return new Builder()
	            .withRequiredParams(knowledgeBaseId, groupId);
	}


	public static class Builder {
		private final GetKnowledgeKnowledgebaseUnansweredGroupRequest request;

		private Builder() {
			request = new GetKnowledgeKnowledgebaseUnansweredGroupRequest();
		}
		...
		public Builder withRequiredParams(String knowledgeBaseId, String groupId) {
			request.setKnowledgeBaseId(knowledgeBaseId);
			request.setGroupId(groupId);
		...
		public GetKnowledgeKnowledgebaseUnansweredGroupRequest build() {
