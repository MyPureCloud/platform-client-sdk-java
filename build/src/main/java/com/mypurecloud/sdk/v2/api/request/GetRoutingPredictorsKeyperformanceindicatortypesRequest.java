...
public class GetRoutingPredictorsKeyperformanceindicatortypesRequest {
    ...
    public GetRoutingPredictorsKeyperformanceindicatortypesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/routing/predictors/keyperformanceindicatortypes")
	...
	public static class Builder {
		private final GetRoutingPredictorsKeyperformanceindicatortypesRequest request;

		private Builder() {
			request = new GetRoutingPredictorsKeyperformanceindicatortypesRequest();
		}
		...
		public GetRoutingPredictorsKeyperformanceindicatortypesRequest build() {
