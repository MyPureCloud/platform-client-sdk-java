...
public class FlowAsyncAggregationQuery  implements Serializable {
 ...
 @JsonDeserialize(using = AlternateTimeDimensionEnumDeserializer.class)
  ...
  public FlowAsyncAggregationQuery() {
  ...
  public FlowAsyncAggregationQuery(Boolean initWithEmptyList) {
   ...
   **/
  public FlowAsyncAggregationQuery interval(String interval) {
   ...
   **/
  public FlowAsyncAggregationQuery granularity(String granularity) {
   ...
   **/
  public FlowAsyncAggregationQuery timeZone(String timeZone) {
   ...
   **/
  public FlowAsyncAggregationQuery groupBy(List<GroupByEnum> groupBy) {
   ...
   **/
  public FlowAsyncAggregationQuery filter(FlowAggregateQueryFilter filter) {
    this.filter = filter;
    return this;
  }
   ...
   **/
  public FlowAsyncAggregationQuery metrics(List<MetricsEnum> metrics) {
   ...
   **/
  public FlowAsyncAggregationQuery flattenMultivaluedDimensions(Boolean flattenMultivaluedDimensions) {
   ...
   **/
  public FlowAsyncAggregationQuery views(List<FlowAggregationView> views) {
    this.views = views;
    return this;
  }
   ...
   * Dimension to use as the alternative timestamp for data in the aggregate.  Choosing \"eventTime\" uses the actual time of the data event.
   **/
  public FlowAsyncAggregationQuery alternateTimeDimension(AlternateTimeDimensionEnum alternateTimeDimension) {
   ...
   **/
  public FlowAsyncAggregationQuery pageSize(Integer pageSize) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    FlowAsyncAggregationQuery flowAsyncAggregationQuery = (FlowAsyncAggregationQuery) o;

    return Objects.equals(this.interval, flowAsyncAggregationQuery.interval) &&
            Objects.equals(this.granularity, flowAsyncAggregationQuery.granularity) &&
            Objects.equals(this.timeZone, flowAsyncAggregationQuery.timeZone) &&
            Objects.equals(this.groupBy, flowAsyncAggregationQuery.groupBy) &&
            Objects.equals(this.filter, flowAsyncAggregationQuery.filter) &&
            Objects.equals(this.metrics, flowAsyncAggregationQuery.metrics) &&
            Objects.equals(this.flattenMultivaluedDimensions, flowAsyncAggregationQuery.flattenMultivaluedDimensions) &&
            Objects.equals(this.views, flowAsyncAggregationQuery.views) &&
            Objects.equals(this.alternateTimeDimension, flowAsyncAggregationQuery.alternateTimeDimension) &&
            Objects.equals(this.pageSize, flowAsyncAggregationQuery.pageSize);
  }
