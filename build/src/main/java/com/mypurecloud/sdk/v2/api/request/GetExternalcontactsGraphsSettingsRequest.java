...
public class GetExternalcontactsGraphsSettingsRequest {
    ...
    public GetExternalcontactsGraphsSettingsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/externalcontacts/graphs/settings")
	...
	public static class Builder {
		private final GetExternalcontactsGraphsSettingsRequest request;

		private Builder() {
			request = new GetExternalcontactsGraphsSettingsRequest();
		}
		...
		public GetExternalcontactsGraphsSettingsRequest build() {
