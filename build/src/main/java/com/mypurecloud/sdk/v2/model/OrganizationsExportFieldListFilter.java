...
public class OrganizationsExportFieldListFilter  implements Serializable {
 ...
 @JsonDeserialize(using = FieldEnumDeserializer.class)
  ...
  public OrganizationsExportFieldListFilter() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
      values = new ArrayList<String>();
    }
  }

  public OrganizationsExportFieldListFilter(Boolean initWithEmptyList) {
   ...
   * Field name to apply the filter
   **/
  public OrganizationsExportFieldListFilter field(FieldEnum field) {
    this.field = field;
    return this;
  }
   ...
   **/
  public OrganizationsExportFieldListFilter values(List<String> values) {
    this.values = values;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    OrganizationsExportFieldListFilter organizationsExportFieldListFilter = (OrganizationsExportFieldListFilter) o;

    return Objects.equals(this.field, organizationsExportFieldListFilter.field) &&
            Objects.equals(this.values, organizationsExportFieldListFilter.values);
  }
