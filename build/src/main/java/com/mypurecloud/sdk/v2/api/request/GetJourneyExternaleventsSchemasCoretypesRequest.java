...
public class GetJourneyExternaleventsSchemasCoretypesRequest {
    ...
    public GetJourneyExternaleventsSchemasCoretypesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/journey/externalevents/schemas/coretypes")
	...
	public static class Builder {
		private final GetJourneyExternaleventsSchemasCoretypesRequest request;

		private Builder() {
			request = new GetJourneyExternaleventsSchemasCoretypesRequest();
		}
		...
		public GetJourneyExternaleventsSchemasCoretypesRequest build() {
