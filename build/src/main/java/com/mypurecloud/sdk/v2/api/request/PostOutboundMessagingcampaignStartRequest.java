...
public class PostOutboundMessagingcampaignStartRequest {
	...
	public PostOutboundMessagingcampaignStartRequest withMessagingCampaignId(String messagingCampaignId) {
    ...
    public PostOutboundMessagingcampaignStartRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.messagingCampaignId == null) {
            throw new IllegalStateException("Missing the required parameter 'messagingCampaignId' when building request for PostOutboundMessagingcampaignStartRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/outbound/messagingcampaigns/{messagingCampaignId}/start")
	...
	public static class Builder {
		private final PostOutboundMessagingcampaignStartRequest request;

		private Builder() {
			request = new PostOutboundMessagingcampaignStartRequest();
		}
		...
		public PostOutboundMessagingcampaignStartRequest build() {
