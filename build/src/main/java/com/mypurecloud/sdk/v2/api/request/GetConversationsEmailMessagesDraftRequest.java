...
public class GetConversationsEmailMessagesDraftRequest {
    ...
    public GetConversationsEmailMessagesDraftRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() throws ApiException {
        ...
        if (this.emailId == null) {
            throw new ApiException(400, "Missing the required parameter 'emailId' when building request for GetConversationsEmailMessagesDraftRequest.");
        }
	...
	public static class Builder {
		private final GetConversationsEmailMessagesDraftRequest request;
