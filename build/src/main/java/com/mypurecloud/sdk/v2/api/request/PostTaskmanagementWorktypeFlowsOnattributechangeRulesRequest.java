...
public class PostTaskmanagementWorktypeFlowsOnattributechangeRulesRequest {
	...
	private WorkitemOnAttributeChangeRuleCreate body;
	public WorkitemOnAttributeChangeRuleCreate getBody() {
		return this.body;
	}

	public void setBody(WorkitemOnAttributeChangeRuleCreate body) {
		this.body = body;
	}

	public PostTaskmanagementWorktypeFlowsOnattributechangeRulesRequest withBody(WorkitemOnAttributeChangeRuleCreate body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public ApiRequest<WorkitemOnAttributeChangeRuleCreate> withHttpInfo() {
        
        // verify the required parameter 'worktypeId' is set
        if (this.worktypeId == null) {
            throw new IllegalStateException("Missing the required parameter 'worktypeId' when building request for PostTaskmanagementWorktypeFlowsOnattributechangeRulesRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostTaskmanagementWorktypeFlowsOnattributechangeRulesRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/taskmanagement/worktypes/{worktypeId}/flows/onattributechange/rules")
	...
	public static Builder builder(String worktypeId, WorkitemOnAttributeChangeRuleCreate body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostTaskmanagementWorktypeFlowsOnattributechangeRulesRequest request;

		private Builder() {
			request = new PostTaskmanagementWorktypeFlowsOnattributechangeRulesRequest();
		}
		...
		public Builder withBody(WorkitemOnAttributeChangeRuleCreate body) {
		...
		public Builder withRequiredParams(String worktypeId, WorkitemOnAttributeChangeRuleCreate body) {
			request.setWorktypeId(worktypeId);
			request.setBody(body);
		...
		public PostTaskmanagementWorktypeFlowsOnattributechangeRulesRequest build() {
