...
public class IgnoreTopic  implements Serializable {
 ...
 @JsonDeserialize(using = MediaTypeEnumDeserializer.class)
   ...
   **/
  public IgnoreTopic text(String text) {
    this.text = text;
    return this;
  }
  
  @ApiModelProperty(example = "pay bill", required = true, value = "Text of the topic to be ignored")
  @JsonProperty("text")
   ...
   * Type of participant
   **/
  public IgnoreTopic participant(ParticipantEnum participant) {
   ...
   * Media Type for the entity (Optional)
   **/
  public IgnoreTopic mediaType(MediaTypeEnum mediaType) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    IgnoreTopic ignoreTopic = (IgnoreTopic) o;

    return Objects.equals(this.text, ignoreTopic.text) &&
            Objects.equals(this.participant, ignoreTopic.participant) &&
            Objects.equals(this.mediaType, ignoreTopic.mediaType);
  }
