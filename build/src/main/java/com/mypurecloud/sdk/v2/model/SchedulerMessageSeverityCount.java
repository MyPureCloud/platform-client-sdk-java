...
public class SchedulerMessageSeverityCount  implements Serializable {
 ...
 @JsonDeserialize(using = SeverityEnumDeserializer.class)
  ...
  public SchedulerMessageSeverityCount() {
   ...
   * The schedule message severity
   **/
  public SchedulerMessageSeverityCount severity(SeverityEnum severity) {
    this.severity = severity;
    return this;
  }
  
  @ApiModelProperty(example = "null", value = "The schedule message severity")
   ...
   **/
  public SchedulerMessageSeverityCount count(Integer count) {
    this.count = count;
    return this;
  }
  
  @ApiModelProperty(example = "null", value = "The number of schedule messages with the given severity")
  @JsonProperty("count")
