...
public class PostWorkforcemanagementManagementunitWorkplanCopyRequest {
	...
	public PostWorkforcemanagementManagementunitWorkplanCopyRequest withManagementUnitId(String managementUnitId) {
	...
	public PostWorkforcemanagementManagementunitWorkplanCopyRequest withWorkPlanId(String workPlanId) {
	    this.setWorkPlanId(workPlanId);
	    return this;
	} 
	
	private CopyWorkPlan body;
	public CopyWorkPlan getBody() {
		return this.body;
	}

	public void setBody(CopyWorkPlan body) {
		this.body = body;
	}

	public PostWorkforcemanagementManagementunitWorkplanCopyRequest withBody(CopyWorkPlan body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementManagementunitWorkplanCopyRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<CopyWorkPlan> withHttpInfo() {
        
        // verify the required parameter 'managementUnitId' is set
        if (this.managementUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'managementUnitId' when building request for PostWorkforcemanagementManagementunitWorkplanCopyRequest.");
        }
	...
	public static class Builder {
		private final PostWorkforcemanagementManagementunitWorkplanCopyRequest request;

		private Builder() {
			request = new PostWorkforcemanagementManagementunitWorkplanCopyRequest();
		}
		...
		public Builder withBody(CopyWorkPlan body) {
		...
		public PostWorkforcemanagementManagementunitWorkplanCopyRequest build() {
