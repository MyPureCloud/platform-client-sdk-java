...
public class DeleteFlowsDatatableRequest {
	...
	public DeleteFlowsDatatableRequest withDatatableId(String datatableId) {
    ...
    public DeleteFlowsDatatableRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.datatableId == null) {
            throw new IllegalStateException("Missing the required parameter 'datatableId' when building request for DeleteFlowsDatatableRequest.");
        }
	...
	public static class Builder {
		private final DeleteFlowsDatatableRequest request;

		private Builder() {
			request = new DeleteFlowsDatatableRequest();
		}
		...
		public DeleteFlowsDatatableRequest build() {
