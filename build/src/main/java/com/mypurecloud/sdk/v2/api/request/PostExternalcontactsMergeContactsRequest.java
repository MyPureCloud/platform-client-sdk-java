...
public class PostExternalcontactsMergeContactsRequest {

	private MergeRequest body;
	public MergeRequest getBody() {
		return this.body;
	}

	public void setBody(MergeRequest body) {
		this.body = body;
	}

	public PostExternalcontactsMergeContactsRequest withBody(MergeRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostExternalcontactsMergeContactsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<MergeRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostExternalcontactsMergeContactsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/externalcontacts/merge/contacts")
                .withBody(body)
	...
	public static Builder builder(MergeRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostExternalcontactsMergeContactsRequest request;

		private Builder() {
			request = new PostExternalcontactsMergeContactsRequest();
		}


		public Builder withBody(MergeRequest body) {
		...
		public Builder withRequiredParams(MergeRequest body) {
			request.setBody(body);
		...
		public PostExternalcontactsMergeContactsRequest build() {
