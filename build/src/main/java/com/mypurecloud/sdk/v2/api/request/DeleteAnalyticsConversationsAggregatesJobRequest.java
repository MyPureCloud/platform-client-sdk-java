...
public class DeleteAnalyticsConversationsAggregatesJobRequest {
	...
	public DeleteAnalyticsConversationsAggregatesJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public DeleteAnalyticsConversationsAggregatesJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for DeleteAnalyticsConversationsAggregatesJobRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/analytics/conversations/aggregates/jobs/{jobId}")
	...
	public static class Builder {
		private final DeleteAnalyticsConversationsAggregatesJobRequest request;

		private Builder() {
			request = new DeleteAnalyticsConversationsAggregatesJobRequest();
		}
		...
		public DeleteAnalyticsConversationsAggregatesJobRequest build() {
