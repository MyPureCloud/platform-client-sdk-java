...
public class QueueConversationCobrowseEventTopicJourneyCustomer  implements Serializable {
  
  private String id = null;
  private String idType = null;

  public QueueConversationCobrowseEventTopicJourneyCustomer() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
    }
  }

  public QueueConversationCobrowseEventTopicJourneyCustomer(Boolean initWithEmptyList) {
   ...
   **/
  public QueueConversationCobrowseEventTopicJourneyCustomer id(String id) {
    this.id = id;
    return this;
  }
   ...
   **/
  public QueueConversationCobrowseEventTopicJourneyCustomer idType(String idType) {
    this.idType = idType;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    QueueConversationCobrowseEventTopicJourneyCustomer queueConversationCobrowseEventTopicJourneyCustomer = (QueueConversationCobrowseEventTopicJourneyCustomer) o;

    return Objects.equals(this.id, queueConversationCobrowseEventTopicJourneyCustomer.id) &&
            Objects.equals(this.idType, queueConversationCobrowseEventTopicJourneyCustomer.idType);
  }
