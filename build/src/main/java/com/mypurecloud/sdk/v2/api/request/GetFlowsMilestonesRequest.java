...
public class GetFlowsMilestonesRequest {
	...
	public GetFlowsMilestonesRequest withPageNumber(Integer pageNumber) {
	...
	public GetFlowsMilestonesRequest withPageSize(Integer pageSize) {
	...
	public GetFlowsMilestonesRequest withSortBy(String sortBy) {
	...
	public GetFlowsMilestonesRequest withSortOrder(String sortOrder) {
	...
	public GetFlowsMilestonesRequest withId(List<String> id) {
	    this.setId(id);
	    return this;
	} 
	...
	public GetFlowsMilestonesRequest withName(String name) {
	    this.setName(name);
	    return this;
	} 
	...
	public GetFlowsMilestonesRequest withDescription(String description) {
	...
	public GetFlowsMilestonesRequest withNameOrDescription(String nameOrDescription) {
	...
	public GetFlowsMilestonesRequest withDivisionId(List<String> divisionId) {
    ...
    public GetFlowsMilestonesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/flows/milestones")
	...
	public static class Builder {
		private final GetFlowsMilestonesRequest request;

		private Builder() {
			request = new GetFlowsMilestonesRequest();
		}
		...
		public GetFlowsMilestonesRequest build() {
