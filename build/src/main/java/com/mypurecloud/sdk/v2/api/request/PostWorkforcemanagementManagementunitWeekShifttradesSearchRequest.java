...
public class PostWorkforcemanagementManagementunitWeekShifttradesSearchRequest {
	...
	public PostWorkforcemanagementManagementunitWeekShifttradesSearchRequest withManagementUnitId(String managementUnitId) {
	...
	public PostWorkforcemanagementManagementunitWeekShifttradesSearchRequest withWeekDateId(LocalDate weekDateId) {
	    this.setWeekDateId(weekDateId);
	    return this;
	} 

	private SearchShiftTradesRequest body;
	public SearchShiftTradesRequest getBody() {
		return this.body;
	}

	public void setBody(SearchShiftTradesRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementManagementunitWeekShifttradesSearchRequest withBody(SearchShiftTradesRequest body) {
	    this.setBody(body);
	    return this;
	} 
	...
	public PostWorkforcemanagementManagementunitWeekShifttradesSearchRequest withForceDownloadService(Boolean forceDownloadService) {
    ...
    public PostWorkforcemanagementManagementunitWeekShifttradesSearchRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<SearchShiftTradesRequest> withHttpInfo() {
        
        // verify the required parameter 'managementUnitId' is set
        if (this.managementUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'managementUnitId' when building request for PostWorkforcemanagementManagementunitWeekShifttradesSearchRequest.");
        }
        
        // verify the required parameter 'weekDateId' is set
        if (this.weekDateId == null) {
            throw new IllegalStateException("Missing the required parameter 'weekDateId' when building request for PostWorkforcemanagementManagementunitWeekShifttradesSearchRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementManagementunitWeekShifttradesSearchRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/managementunits/{managementUnitId}/weeks/{weekDateId}/shifttrades/search")
	...
	public static Builder builder(String managementUnitId, LocalDate weekDateId, SearchShiftTradesRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementManagementunitWeekShifttradesSearchRequest request;

		private Builder() {
			request = new PostWorkforcemanagementManagementunitWeekShifttradesSearchRequest();
		}
		...
		public Builder withBody(SearchShiftTradesRequest body) {
		...
		public Builder withRequiredParams(String managementUnitId, LocalDate weekDateId, SearchShiftTradesRequest body) {
			request.setManagementUnitId(managementUnitId);
			request.setWeekDateId(weekDateId);
			request.setBody(body);
		...
		public PostWorkforcemanagementManagementunitWeekShifttradesSearchRequest build() {
