...
public class PostConversationSummaryFeedbackRequest {
    ...
    public ApiRequest<FeedbackAddRequest> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("POST", "/api/v2/conversations/{conversationId}/summaries/{summaryId}/feedback")
	...
	public static class Builder {
		private final PostConversationSummaryFeedbackRequest request;

		private Builder() {
			request = new PostConversationSummaryFeedbackRequest();
		}
