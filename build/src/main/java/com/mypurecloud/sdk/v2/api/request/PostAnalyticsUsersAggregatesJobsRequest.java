...
public class PostAnalyticsUsersAggregatesJobsRequest {

	private UserAsyncAggregationQuery body;
	public UserAsyncAggregationQuery getBody() {
		return this.body;
	}

	public void setBody(UserAsyncAggregationQuery body) {
		this.body = body;
	}

	public PostAnalyticsUsersAggregatesJobsRequest withBody(UserAsyncAggregationQuery body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostAnalyticsUsersAggregatesJobsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<UserAsyncAggregationQuery> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostAnalyticsUsersAggregatesJobsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/analytics/users/aggregates/jobs")
                .withBody(body)
	...
	public static Builder builder(UserAsyncAggregationQuery body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostAnalyticsUsersAggregatesJobsRequest request;

		private Builder() {
			request = new PostAnalyticsUsersAggregatesJobsRequest();
		}


		public Builder withBody(UserAsyncAggregationQuery body) {
		...
		public Builder withRequiredParams(UserAsyncAggregationQuery body) {
			request.setBody(body);
		...
		public PostAnalyticsUsersAggregatesJobsRequest build() {
