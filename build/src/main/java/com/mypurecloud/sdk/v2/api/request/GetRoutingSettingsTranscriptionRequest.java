...
public class GetRoutingSettingsTranscriptionRequest {
    ...
    public GetRoutingSettingsTranscriptionRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/routing/settings/transcription")
	...
	public static class Builder {
		private final GetRoutingSettingsTranscriptionRequest request;

		private Builder() {
			request = new GetRoutingSettingsTranscriptionRequest();
		}
		...
		public GetRoutingSettingsTranscriptionRequest build() {
