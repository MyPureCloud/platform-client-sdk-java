...
public class GetUserOutofofficeRequest {
	...
	public GetUserOutofofficeRequest withUserId(String userId) {
    ...
    public GetUserOutofofficeRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.userId == null) {
            throw new IllegalStateException("Missing the required parameter 'userId' when building request for GetUserOutofofficeRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/users/{userId}/outofoffice")
	...
	public static class Builder {
		private final GetUserOutofofficeRequest request;

		private Builder() {
			request = new GetUserOutofofficeRequest();
		}
		...
		public GetUserOutofofficeRequest build() {
