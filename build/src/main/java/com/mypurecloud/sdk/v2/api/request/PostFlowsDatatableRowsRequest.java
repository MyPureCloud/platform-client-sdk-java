...
public class PostFlowsDatatableRowsRequest {
	...
	public PostFlowsDatatableRowsRequest withDatatableId(String datatableId) {
	    this.setDatatableId(datatableId);
	    return this;
	} 
	
	private Object dataTableRow;
	public Object getDataTableRow() {
		return this.dataTableRow;
	}

	public void setDataTableRow(Object dataTableRow) {
		this.dataTableRow = dataTableRow;
	}

	public PostFlowsDatatableRowsRequest withDataTableRow(Object dataTableRow) {
	    this.setDataTableRow(dataTableRow);
	    return this;
	} 
    ...
    public PostFlowsDatatableRowsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Object> withHttpInfo() {
        ...
        if (this.datatableId == null) {
            throw new IllegalStateException("Missing the required parameter 'datatableId' when building request for PostFlowsDatatableRowsRequest.");
        }
        
        // verify the required parameter 'dataTableRow' is set
        if (this.dataTableRow == null) {
            throw new IllegalStateException("Missing the required parameter 'dataTableRow' when building request for PostFlowsDatatableRowsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/flows/datatables/{datatableId}/rows")
                .withPathParameter("datatableId", datatableId)
        
                .withBody(dataTableRow)
	...
	public static Builder builder(String datatableId, Object dataTableRow) {
	    return new Builder()
	            .withRequiredParams(datatableId, dataTableRow);
	}
	

	public static class Builder {
		private final PostFlowsDatatableRowsRequest request;

		private Builder() {
			request = new PostFlowsDatatableRowsRequest();
		}
		...
		public Builder withDataTableRow(Object dataTableRow) {
			request.setDataTableRow(dataTableRow);
			return this;
		}
		

		
		public Builder withRequiredParams(String datatableId, Object dataTableRow) {
			request.setDatatableId(datatableId);
						request.setDataTableRow(dataTableRow);
		...
		public PostFlowsDatatableRowsRequest build() {
