...
public class ConversationScreenShareEventTopicWrapup  implements Serializable {
  ...
  public ConversationScreenShareEventTopicWrapup() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
      tags = new ArrayList<String>();
    }
  }

  public ConversationScreenShareEventTopicWrapup(Boolean initWithEmptyList) {
   ...
   **/
  public ConversationScreenShareEventTopicWrapup durationSeconds(Long durationSeconds) {
