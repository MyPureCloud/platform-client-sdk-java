...
public class UsersRulesQueryResponse  implements Serializable {
  ...
  /**
   **/
  public UsersRulesQueryResponse entities(List<UserReference> entities) {
  ...
  /**
   **/
  public UsersRulesQueryResponse pageSize(Integer pageSize) {
  ...
  /**
   **/
  public UsersRulesQueryResponse pageNumber(Integer pageNumber) {
  ...
  /**
   **/
  public UsersRulesQueryResponse nextUri(String nextUri) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    UsersRulesQueryResponse usersRulesQueryResponse = (UsersRulesQueryResponse) o;

    return Objects.equals(this.entities, usersRulesQueryResponse.entities) &&
