...
public class SummaryAggregationView  implements Serializable {
 ...
 @JsonDeserialize(using = FunctionEnumDeserializer.class)
   ...
   * Target metric name
   **/
  public SummaryAggregationView target(TargetEnum target) {
    this.target = target;
    return this;
  }
   ...
   **/
  public SummaryAggregationView name(String name) {
    this.name = name;
    return this;
  }
   ...
   * Type of view you wish to create
   **/
  public SummaryAggregationView function(FunctionEnum function) {
   ...
   **/
  public SummaryAggregationView range(AggregationRange range) {
    this.range = range;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SummaryAggregationView summaryAggregationView = (SummaryAggregationView) o;

    return Objects.equals(this.target, summaryAggregationView.target) &&
            Objects.equals(this.name, summaryAggregationView.name) &&
            Objects.equals(this.function, summaryAggregationView.function) &&
            Objects.equals(this.range, summaryAggregationView.range);
  }
