...
public class PostWorkforcemanagementManagementunitTimeoffrequestsWaitlistpositionsQueryRequest {
	...
	public PostWorkforcemanagementManagementunitTimeoffrequestsWaitlistpositionsQueryRequest withManagementUnitId(String managementUnitId) {
	    this.setManagementUnitId(managementUnitId);
	    return this;
	} 

	private QueryWaitlistPositionsRequest body;
	public QueryWaitlistPositionsRequest getBody() {
		return this.body;
	}

	public void setBody(QueryWaitlistPositionsRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementManagementunitTimeoffrequestsWaitlistpositionsQueryRequest withBody(QueryWaitlistPositionsRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementManagementunitTimeoffrequestsWaitlistpositionsQueryRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<QueryWaitlistPositionsRequest> withHttpInfo() {
        
        // verify the required parameter 'managementUnitId' is set
        if (this.managementUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'managementUnitId' when building request for PostWorkforcemanagementManagementunitTimeoffrequestsWaitlistpositionsQueryRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementManagementunitTimeoffrequestsWaitlistpositionsQueryRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/managementunits/{managementUnitId}/timeoffrequests/waitlistpositions/query")
	...
	public static Builder builder(String managementUnitId, QueryWaitlistPositionsRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementManagementunitTimeoffrequestsWaitlistpositionsQueryRequest request;

		private Builder() {
			request = new PostWorkforcemanagementManagementunitTimeoffrequestsWaitlistpositionsQueryRequest();
		}
		...
		public Builder withBody(QueryWaitlistPositionsRequest body) {
		...
		public Builder withRequiredParams(String managementUnitId, QueryWaitlistPositionsRequest body) {
			request.setManagementUnitId(managementUnitId);
			request.setBody(body);
		...
		public PostWorkforcemanagementManagementunitTimeoffrequestsWaitlistpositionsQueryRequest build() {
