...
public class GetExternalcontactsContactsSchemasCoretypeRequest {
	...
	public GetExternalcontactsContactsSchemasCoretypeRequest withCoreTypeName(String coreTypeName) {
    ...
    public GetExternalcontactsContactsSchemasCoretypeRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.coreTypeName == null) {
            throw new IllegalStateException("Missing the required parameter 'coreTypeName' when building request for GetExternalcontactsContactsSchemasCoretypeRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/externalcontacts/contacts/schemas/coretypes/{coreTypeName}")
	...
	public static class Builder {
		private final GetExternalcontactsContactsSchemasCoretypeRequest request;

		private Builder() {
			request = new GetExternalcontactsContactsSchemasCoretypeRequest();
		}
		...
		public GetExternalcontactsContactsSchemasCoretypeRequest build() {
