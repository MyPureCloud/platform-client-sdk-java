...
public class GetWorkforcemanagementAlternativeshiftsOffersJobRequest {
	...
	public GetWorkforcemanagementAlternativeshiftsOffersJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetWorkforcemanagementAlternativeshiftsOffersJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetWorkforcemanagementAlternativeshiftsOffersJobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/alternativeshifts/offers/jobs/{jobId}")
	...
	public static class Builder {
		private final GetWorkforcemanagementAlternativeshiftsOffersJobRequest request;

		private Builder() {
			request = new GetWorkforcemanagementAlternativeshiftsOffersJobRequest();
		}
		...
		public GetWorkforcemanagementAlternativeshiftsOffersJobRequest build() {
