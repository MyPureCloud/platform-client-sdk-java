...
public class PostExternalcontactsBulkContactsEnrichRequest {

	private BulkContactsEnrichRequest body;
	public BulkContactsEnrichRequest getBody() {
		return this.body;
	}

	public void setBody(BulkContactsEnrichRequest body) {
		this.body = body;
	}

	public PostExternalcontactsBulkContactsEnrichRequest withBody(BulkContactsEnrichRequest body) {
	    this.setBody(body);
	    return this;
	} 
	...
	public PostExternalcontactsBulkContactsEnrichRequest withDryRun(Boolean dryRun) {
    ...
    public PostExternalcontactsBulkContactsEnrichRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<BulkContactsEnrichRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostExternalcontactsBulkContactsEnrichRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/externalcontacts/bulk/contacts/enrich")
	...
	public static Builder builder(BulkContactsEnrichRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostExternalcontactsBulkContactsEnrichRequest request;

		private Builder() {
			request = new PostExternalcontactsBulkContactsEnrichRequest();
		}


		public Builder withBody(BulkContactsEnrichRequest body) {
		...
		public Builder withRequiredParams(BulkContactsEnrichRequest body) {
			request.setBody(body);
		...
		public PostExternalcontactsBulkContactsEnrichRequest build() {
