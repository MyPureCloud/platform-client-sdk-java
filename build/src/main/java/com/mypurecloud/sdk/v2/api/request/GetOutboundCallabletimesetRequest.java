...
public class GetOutboundCallabletimesetRequest {
	...
	public GetOutboundCallabletimesetRequest withCallableTimeSetId(String callableTimeSetId) {
    ...
    public GetOutboundCallabletimesetRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.callableTimeSetId == null) {
            throw new IllegalStateException("Missing the required parameter 'callableTimeSetId' when building request for GetOutboundCallabletimesetRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/outbound/callabletimesets/{callableTimeSetId}")
	...
	public static class Builder {
		private final GetOutboundCallabletimesetRequest request;

		private Builder() {
			request = new GetOutboundCallabletimesetRequest();
		}
		...
		public GetOutboundCallabletimesetRequest build() {
