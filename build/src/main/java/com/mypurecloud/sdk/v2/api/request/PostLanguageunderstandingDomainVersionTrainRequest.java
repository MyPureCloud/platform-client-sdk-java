...
public class PostLanguageunderstandingDomainVersionTrainRequest {
	...
	public PostLanguageunderstandingDomainVersionTrainRequest withDomainId(String domainId) {
	...
	public PostLanguageunderstandingDomainVersionTrainRequest withDomainVersionId(String domainVersionId) {
    ...
    public PostLanguageunderstandingDomainVersionTrainRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.domainId == null) {
            throw new IllegalStateException("Missing the required parameter 'domainId' when building request for PostLanguageunderstandingDomainVersionTrainRequest.");
        }
        
        // verify the required parameter 'domainVersionId' is set
        if (this.domainVersionId == null) {
            throw new IllegalStateException("Missing the required parameter 'domainVersionId' when building request for PostLanguageunderstandingDomainVersionTrainRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/languageunderstanding/domains/{domainId}/versions/{domainVersionId}/train")
	...
	public static class Builder {
		private final PostLanguageunderstandingDomainVersionTrainRequest request;

		private Builder() {
			request = new PostLanguageunderstandingDomainVersionTrainRequest();
		}
		...
		public PostLanguageunderstandingDomainVersionTrainRequest build() {
