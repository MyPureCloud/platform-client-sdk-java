...
public class PatchVoicemailUserpolicyRequest {
	...
	public PatchVoicemailUserpolicyRequest withUserId(String userId) {
	...
	public PatchVoicemailUserpolicyRequest withBody(VoicemailUserPolicy body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchVoicemailUserpolicyRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<VoicemailUserPolicy> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("PATCH", "/api/v2/voicemail/userpolicies/{userId}")
