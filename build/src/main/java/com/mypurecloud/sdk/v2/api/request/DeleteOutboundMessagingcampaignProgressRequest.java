...
public class DeleteOutboundMessagingcampaignProgressRequest {
	...
	public DeleteOutboundMessagingcampaignProgressRequest withMessagingCampaignId(String messagingCampaignId) {
    ...
    public DeleteOutboundMessagingcampaignProgressRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.messagingCampaignId == null) {
            throw new IllegalStateException("Missing the required parameter 'messagingCampaignId' when building request for DeleteOutboundMessagingcampaignProgressRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/outbound/messagingcampaigns/{messagingCampaignId}/progress")
	...
	public static class Builder {
		private final DeleteOutboundMessagingcampaignProgressRequest request;

		private Builder() {
			request = new DeleteOutboundMessagingcampaignProgressRequest();
		}
		...
		public DeleteOutboundMessagingcampaignProgressRequest build() {
