...
public class PostWorkforcemanagementManagementunitTimeoffplansRequest {
	...
	public PostWorkforcemanagementManagementunitTimeoffplansRequest withManagementUnitId(String managementUnitId) {
	    this.setManagementUnitId(managementUnitId);
	    return this;
	} 

	private CreateTimeOffPlanRequest body;
	public CreateTimeOffPlanRequest getBody() {
		return this.body;
	}

	public void setBody(CreateTimeOffPlanRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementManagementunitTimeoffplansRequest withBody(CreateTimeOffPlanRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementManagementunitTimeoffplansRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<CreateTimeOffPlanRequest> withHttpInfo() {
        
        // verify the required parameter 'managementUnitId' is set
        if (this.managementUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'managementUnitId' when building request for PostWorkforcemanagementManagementunitTimeoffplansRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementManagementunitTimeoffplansRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/managementunits/{managementUnitId}/timeoffplans")
	...
	public static Builder builder(String managementUnitId, CreateTimeOffPlanRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementManagementunitTimeoffplansRequest request;

		private Builder() {
			request = new PostWorkforcemanagementManagementunitTimeoffplansRequest();
		}
		...
		public Builder withBody(CreateTimeOffPlanRequest body) {
		...
		public Builder withRequiredParams(String managementUnitId, CreateTimeOffPlanRequest body) {
			request.setManagementUnitId(managementUnitId);
			request.setBody(body);
		...
		public PostWorkforcemanagementManagementunitTimeoffplansRequest build() {
