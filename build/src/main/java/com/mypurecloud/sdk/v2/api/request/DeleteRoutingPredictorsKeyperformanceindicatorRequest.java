...
public class DeleteRoutingPredictorsKeyperformanceindicatorRequest {
	...
	public DeleteRoutingPredictorsKeyperformanceindicatorRequest withKpiId(String kpiId) {
	    this.setKpiId(kpiId);
	    return this;
	} 
    ...
    public DeleteRoutingPredictorsKeyperformanceindicatorRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.kpiId == null) {
            throw new IllegalStateException("Missing the required parameter 'kpiId' when building request for DeleteRoutingPredictorsKeyperformanceindicatorRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/routing/predictors/keyperformanceindicators/{kpiId}")
	...
	public static class Builder {
		private final DeleteRoutingPredictorsKeyperformanceindicatorRequest request;

		private Builder() {
			request = new DeleteRoutingPredictorsKeyperformanceindicatorRequest();
		}
		...
		public DeleteRoutingPredictorsKeyperformanceindicatorRequest build() {
