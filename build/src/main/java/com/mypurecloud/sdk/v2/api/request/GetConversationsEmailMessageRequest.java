...
public class GetConversationsEmailMessageRequest {
    ...
    public ApiRequest<Void> withHttpInfo() throws ApiException {
        ...
        if (this.emailId == null) {
            throw new ApiException(400, "Missing the required parameter 'emailId' when building request for GetConversationsEmailMessageRequest.");
        }
        
        // verify the required parameter 'messageId' is set
        if (this.messageId == null) {
            throw new ApiException(400, "Missing the required parameter 'messageId' when building request for GetConversationsEmailMessageRequest.");
        }
