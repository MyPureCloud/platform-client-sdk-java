...
public class PostRoutingEmailOutboundDomainsSimulatedRequest {
	...
	public PostRoutingEmailOutboundDomainsSimulatedRequest withBody(OutboundDomain body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostRoutingEmailOutboundDomainsSimulatedRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<OutboundDomain> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostRoutingEmailOutboundDomainsSimulatedRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/routing/email/outbound/domains/simulated")
                .withBody(body)
	...
	public static class Builder {
		private final PostRoutingEmailOutboundDomainsSimulatedRequest request;

		private Builder() {
			request = new PostRoutingEmailOutboundDomainsSimulatedRequest();
		}
		...
		public PostRoutingEmailOutboundDomainsSimulatedRequest build() {
