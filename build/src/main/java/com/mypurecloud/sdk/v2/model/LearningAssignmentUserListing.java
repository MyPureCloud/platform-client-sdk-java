...
public class LearningAssignmentUserListing  implements Serializable, PagedResource<LearningAssignmentUser> {
  ...
  private List<LearningAssignmentUser> entities = null;
  ...
  public LearningAssignmentUserListing() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
      entities = new ArrayList<LearningAssignmentUser>();
    }
  }

  public LearningAssignmentUserListing(Boolean initWithEmptyList) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(entities, pageSize, pageNumber, total, unfilteredTotal, lastUri, firstUri, selfUri, nextUri, previousUri, pageCount);
  }
