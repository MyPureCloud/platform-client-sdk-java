...
public class PostWorkforcemanagementTimeoffrequestsRequest {
    
	private CreateAgentTimeOffRequest body;
	public CreateAgentTimeOffRequest getBody() {
		return this.body;
	}

	public void setBody(CreateAgentTimeOffRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementTimeoffrequestsRequest withBody(CreateAgentTimeOffRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementTimeoffrequestsRequest withCustomHeader(String name, String value) {
	...
	public static class Builder {
		private final PostWorkforcemanagementTimeoffrequestsRequest request;

		private Builder() {
			request = new PostWorkforcemanagementTimeoffrequestsRequest();
		}

		
		public Builder withBody(CreateAgentTimeOffRequest body) {
