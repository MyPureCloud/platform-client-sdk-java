...
public class CaseManagementAggregationSort  implements Serializable {
 ...
 @JsonDeserialize(using = FunctionEnumDeserializer.class)
  ...
  public CaseManagementAggregationSort() {
   ...
   * Name of the metric used for sorting values.
   **/
  public CaseManagementAggregationSort name(NameEnum name) {
    this.name = name;
    return this;
  }
   ...
   * Aggregation function used for the sort metric.
   **/
  public CaseManagementAggregationSort function(FunctionEnum function) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CaseManagementAggregationSort caseManagementAggregationSort = (CaseManagementAggregationSort) o;

    return Objects.equals(this.name, caseManagementAggregationSort.name) &&
            Objects.equals(this.function, caseManagementAggregationSort.function);
  }
