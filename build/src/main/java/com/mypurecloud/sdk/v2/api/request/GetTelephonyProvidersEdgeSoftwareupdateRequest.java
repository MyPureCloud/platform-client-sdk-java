...
public class GetTelephonyProvidersEdgeSoftwareupdateRequest {
	...
	public GetTelephonyProvidersEdgeSoftwareupdateRequest withEdgeId(String edgeId) {
    ...
    public GetTelephonyProvidersEdgeSoftwareupdateRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.edgeId == null) {
            throw new IllegalStateException("Missing the required parameter 'edgeId' when building request for GetTelephonyProvidersEdgeSoftwareupdateRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/telephony/providers/edges/{edgeId}/softwareupdate")
	...
	public static class Builder {
		private final GetTelephonyProvidersEdgeSoftwareupdateRequest request;

		private Builder() {
			request = new GetTelephonyProvidersEdgeSoftwareupdateRequest();
		}
		...
		public GetTelephonyProvidersEdgeSoftwareupdateRequest build() {
