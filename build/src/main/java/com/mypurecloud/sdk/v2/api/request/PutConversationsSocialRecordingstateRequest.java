...
public class PutConversationsSocialRecordingstateRequest {
	...
	public PutConversationsSocialRecordingstateRequest withConversationId(String conversationId) {
	...
	public PutConversationsSocialRecordingstateRequest withBody(SetRecordingState body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutConversationsSocialRecordingstateRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<SetRecordingState> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PutConversationsSocialRecordingstateRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutConversationsSocialRecordingstateRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/conversations/socials/{conversationId}/recordingstate")
	...
	public static class Builder {
		private final PutConversationsSocialRecordingstateRequest request;

		private Builder() {
			request = new PutConversationsSocialRecordingstateRequest();
		}
		...
		public PutConversationsSocialRecordingstateRequest build() {
