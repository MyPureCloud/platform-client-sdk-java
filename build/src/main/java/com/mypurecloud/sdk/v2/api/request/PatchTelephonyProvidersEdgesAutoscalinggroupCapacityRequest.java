...
public class PatchTelephonyProvidersEdgesAutoscalinggroupCapacityRequest {
	...
	public PatchTelephonyProvidersEdgesAutoscalinggroupCapacityRequest withAsgId(String asgId) {
	    this.setAsgId(asgId);
	    return this;
	} 
	
	private AsgScaleRequest body;
	public AsgScaleRequest getBody() {
		return this.body;
	}

	public void setBody(AsgScaleRequest body) {
		this.body = body;
	}

	public PatchTelephonyProvidersEdgesAutoscalinggroupCapacityRequest withBody(AsgScaleRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchTelephonyProvidersEdgesAutoscalinggroupCapacityRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<AsgScaleRequest> withHttpInfo() {
        
        // verify the required parameter 'asgId' is set
        if (this.asgId == null) {
            throw new IllegalStateException("Missing the required parameter 'asgId' when building request for PatchTelephonyProvidersEdgesAutoscalinggroupCapacityRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchTelephonyProvidersEdgesAutoscalinggroupCapacityRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/telephony/providers/edges/autoscalinggroups/{asgId}/capacity")
                .withPathParameter("asgId", asgId)
	...
	public static Builder builder(String asgId, AsgScaleRequest body) {
	    return new Builder()
	            .withRequiredParams(asgId, body);
	}
	

	public static class Builder {
		private final PatchTelephonyProvidersEdgesAutoscalinggroupCapacityRequest request;

		private Builder() {
			request = new PatchTelephonyProvidersEdgesAutoscalinggroupCapacityRequest();
		}

		
		public Builder withAsgId(String asgId) {
			request.setAsgId(asgId);
			return this;
		}
		
		public Builder withBody(AsgScaleRequest body) {
		...
		public Builder withRequiredParams(String asgId, AsgScaleRequest body) {
			request.setAsgId(asgId);
						request.setBody(body);
		...
		public PatchTelephonyProvidersEdgesAutoscalinggroupCapacityRequest build() {
            
            // verify the required parameter 'asgId' is set
            if (request.asgId == null) {
                throw new IllegalStateException("Missing the required parameter 'asgId' when building request for PatchTelephonyProvidersEdgesAutoscalinggroupCapacityRequest.");
            }
