...
public class PostFlowsExecutionsRequest {
    
	private FlowExecutionLaunchRequest flowLaunchRequest;
	public FlowExecutionLaunchRequest getFlowLaunchRequest() {
		return this.flowLaunchRequest;
	}

	public void setFlowLaunchRequest(FlowExecutionLaunchRequest flowLaunchRequest) {
		this.flowLaunchRequest = flowLaunchRequest;
	}

	public PostFlowsExecutionsRequest withFlowLaunchRequest(FlowExecutionLaunchRequest flowLaunchRequest) {
	    this.setFlowLaunchRequest(flowLaunchRequest);
	    return this;
	} 
    ...
    public PostFlowsExecutionsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<FlowExecutionLaunchRequest> withHttpInfo() {
        
        // verify the required parameter 'flowLaunchRequest' is set
        if (this.flowLaunchRequest == null) {
            throw new IllegalStateException("Missing the required parameter 'flowLaunchRequest' when building request for PostFlowsExecutionsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/flows/executions")
                .withBody(flowLaunchRequest)
	...
	public static Builder builder(FlowExecutionLaunchRequest flowLaunchRequest) {
	    return new Builder()
	            .withRequiredParams(flowLaunchRequest);
	}
	

	public static class Builder {
		private final PostFlowsExecutionsRequest request;

		private Builder() {
			request = new PostFlowsExecutionsRequest();
		}

		
		public Builder withFlowLaunchRequest(FlowExecutionLaunchRequest flowLaunchRequest) {
			request.setFlowLaunchRequest(flowLaunchRequest);
			return this;
		}
		

		
		public Builder withRequiredParams(FlowExecutionLaunchRequest flowLaunchRequest) {
			request.setFlowLaunchRequest(flowLaunchRequest);
		...
		public PostFlowsExecutionsRequest build() {
            
            // verify the required parameter 'flowLaunchRequest' is set
            if (request.flowLaunchRequest == null) {
                throw new IllegalStateException("Missing the required parameter 'flowLaunchRequest' when building request for PostFlowsExecutionsRequest.");
            }
