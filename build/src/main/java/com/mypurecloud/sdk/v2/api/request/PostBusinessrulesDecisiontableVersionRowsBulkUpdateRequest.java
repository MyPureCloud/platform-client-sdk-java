...
public class PostBusinessrulesDecisiontableVersionRowsBulkUpdateRequest {
	...
	public PostBusinessrulesDecisiontableVersionRowsBulkUpdateRequest withTableId(String tableId) {
	...
	public PostBusinessrulesDecisiontableVersionRowsBulkUpdateRequest withTableVersion(Integer tableVersion) {
	    this.setTableVersion(tableVersion);
	    return this;
	} 

	private BulkUpdateDecisionTableRowsRequest body;
	public BulkUpdateDecisionTableRowsRequest getBody() {
		return this.body;
	}

	public void setBody(BulkUpdateDecisionTableRowsRequest body) {
		this.body = body;
	}

	public PostBusinessrulesDecisiontableVersionRowsBulkUpdateRequest withBody(BulkUpdateDecisionTableRowsRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostBusinessrulesDecisiontableVersionRowsBulkUpdateRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<BulkUpdateDecisionTableRowsRequest> withHttpInfo() {
        
        // verify the required parameter 'tableId' is set
        if (this.tableId == null) {
            throw new IllegalStateException("Missing the required parameter 'tableId' when building request for PostBusinessrulesDecisiontableVersionRowsBulkUpdateRequest.");
        }
        
        // verify the required parameter 'tableVersion' is set
        if (this.tableVersion == null) {
            throw new IllegalStateException("Missing the required parameter 'tableVersion' when building request for PostBusinessrulesDecisiontableVersionRowsBulkUpdateRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostBusinessrulesDecisiontableVersionRowsBulkUpdateRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/businessrules/decisiontables/{tableId}/versions/{tableVersion}/rows/bulk/update")
	...
	public static Builder builder(String tableId, Integer tableVersion, BulkUpdateDecisionTableRowsRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostBusinessrulesDecisiontableVersionRowsBulkUpdateRequest request;

		private Builder() {
			request = new PostBusinessrulesDecisiontableVersionRowsBulkUpdateRequest();
		}
		...
		public Builder withBody(BulkUpdateDecisionTableRowsRequest body) {
		...
		public Builder withRequiredParams(String tableId, Integer tableVersion, BulkUpdateDecisionTableRowsRequest body) {
			request.setTableId(tableId);
			request.setTableVersion(tableVersion);
			request.setBody(body);
		...
		public PostBusinessrulesDecisiontableVersionRowsBulkUpdateRequest build() {
