...
public class GetQualityConversationAuditsRequest {
	...
	public GetQualityConversationAuditsRequest withExpand(List<Object> expand) {
    ...
    public ApiRequest<Void> withHttpInfo() throws ApiException {
        ...
        if (this.conversationId == null) {
            throw new ApiException(400, "Missing the required parameter 'conversationId' when building request for GetQualityConversationAuditsRequest.");
        }
