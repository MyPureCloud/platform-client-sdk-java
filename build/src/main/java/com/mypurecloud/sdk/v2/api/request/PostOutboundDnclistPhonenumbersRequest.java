...
public class PostOutboundDnclistPhonenumbersRequest {
	...
	public PostOutboundDnclistPhonenumbersRequest withDncListId(String dncListId) {
	...
	public PostOutboundDnclistPhonenumbersRequest withBody(List<String> body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostOutboundDnclistPhonenumbersRequest withCustomHeader(String name, String value) {
	...
	public static class Builder {
		...
		private Builder() {
			request = new PostOutboundDnclistPhonenumbersRequest();
		}
