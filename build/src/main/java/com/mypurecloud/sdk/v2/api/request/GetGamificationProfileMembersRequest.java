...
public class GetGamificationProfileMembersRequest {
    ...
    public GetGamificationProfileMembersRequest withCustomHeader(String name, String value) {
	...
	public static class Builder {
		private final GetGamificationProfileMembersRequest request;

		private Builder() {
			request = new GetGamificationProfileMembersRequest();
		}
