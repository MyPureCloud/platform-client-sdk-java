...
public class GetAuthorizationRoleUsersRequest {
	...
	public GetAuthorizationRoleUsersRequest withRoleId(String roleId) {
	...
	public GetAuthorizationRoleUsersRequest withPageSize(Integer pageSize) {
	...
	public GetAuthorizationRoleUsersRequest withPageNumber(Integer pageNumber) {
    ...
    public GetAuthorizationRoleUsersRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.roleId == null) {
            throw new IllegalStateException("Missing the required parameter 'roleId' when building request for GetAuthorizationRoleUsersRequest.");
        }
