...
public class GetUsersCustomattributesSchemasCoretypeRequest {
	...
	public GetUsersCustomattributesSchemasCoretypeRequest withCoreTypeName(String coreTypeName) {
    ...
    public GetUsersCustomattributesSchemasCoretypeRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.coreTypeName == null) {
            throw new IllegalStateException("Missing the required parameter 'coreTypeName' when building request for GetUsersCustomattributesSchemasCoretypeRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/users/customattributes/schemas/coretypes/{coreTypeName}")
	...
	public static class Builder {
		private final GetUsersCustomattributesSchemasCoretypeRequest request;

		private Builder() {
			request = new GetUsersCustomattributesSchemasCoretypeRequest();
		}
		...
		public GetUsersCustomattributesSchemasCoretypeRequest build() {
