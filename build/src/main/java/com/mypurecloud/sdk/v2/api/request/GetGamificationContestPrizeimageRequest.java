...
public class GetGamificationContestPrizeimageRequest {
	...
	public GetGamificationContestPrizeimageRequest withContestId(String contestId) {
	...
	public GetGamificationContestPrizeimageRequest withPrizeImageId(String prizeImageId) {
	    this.setPrizeImageId(prizeImageId);
	    return this;
	} 
    ...
    public GetGamificationContestPrizeimageRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.contestId == null) {
            throw new IllegalStateException("Missing the required parameter 'contestId' when building request for GetGamificationContestPrizeimageRequest.");
        }
        
        // verify the required parameter 'prizeImageId' is set
        if (this.prizeImageId == null) {
            throw new IllegalStateException("Missing the required parameter 'prizeImageId' when building request for GetGamificationContestPrizeimageRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/gamification/contests/{contestId}/prizeimages/{prizeImageId}")
                .withPathParameter("contestId", contestId)
        
                .withPathParameter("prizeImageId", prizeImageId)
	...
	public static Builder builder(String contestId, String prizeImageId) {
	    return new Builder()
	            .withRequiredParams(contestId, prizeImageId);
	}


	public static class Builder {
		private final GetGamificationContestPrizeimageRequest request;

		private Builder() {
			request = new GetGamificationContestPrizeimageRequest();
		}
		...
		public Builder withPrizeImageId(String prizeImageId) {
			request.setPrizeImageId(prizeImageId);
			return this;
		}



		public Builder withRequiredParams(String contestId, String prizeImageId) {
			request.setContestId(contestId);
			request.setPrizeImageId(prizeImageId);
		...
		public GetGamificationContestPrizeimageRequest build() {
