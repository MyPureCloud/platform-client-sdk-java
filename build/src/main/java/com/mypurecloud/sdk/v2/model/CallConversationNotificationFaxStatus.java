...
public class CallConversationNotificationFaxStatus  implements Serializable {
  ...
  /**
   **/
  public CallConversationNotificationFaxStatus direction(String direction) {
  ...
  /**
   **/
  public CallConversationNotificationFaxStatus expectedPages(Integer expectedPages) {
  ...
  /**
   **/
  public CallConversationNotificationFaxStatus activePage(Integer activePage) {
  ...
  /**
   **/
  public CallConversationNotificationFaxStatus linesTransmitted(Integer linesTransmitted) {
  ...
  /**
   **/
  public CallConversationNotificationFaxStatus bytesTransmitted(Integer bytesTransmitted) {
  ...
  /**
   **/
  public CallConversationNotificationFaxStatus dataRate(Integer dataRate) {
  ...
  /**
   **/
  public CallConversationNotificationFaxStatus pageErrors(Integer pageErrors) {
  ...
  /**
   **/
  public CallConversationNotificationFaxStatus lineErrors(Integer lineErrors) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.direction, callConversationNotificationFaxStatus.direction) &&
        Objects.equals(this.expectedPages, callConversationNotificationFaxStatus.expectedPages) &&
        Objects.equals(this.activePage, callConversationNotificationFaxStatus.activePage) &&
        Objects.equals(this.linesTransmitted, callConversationNotificationFaxStatus.linesTransmitted) &&
        Objects.equals(this.bytesTransmitted, callConversationNotificationFaxStatus.bytesTransmitted) &&
        Objects.equals(this.dataRate, callConversationNotificationFaxStatus.dataRate) &&
        Objects.equals(this.pageErrors, callConversationNotificationFaxStatus.pageErrors) &&
        Objects.equals(this.lineErrors, callConversationNotificationFaxStatus.lineErrors);
  }
