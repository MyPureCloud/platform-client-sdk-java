...
public class GetExternalcontactsNotesExportsRequest {
	...
	public GetExternalcontactsNotesExportsRequest withDivisionIds(List<String> divisionIds) {
	...
	public GetExternalcontactsNotesExportsRequest withAfter(String after) {
	    this.setAfter(after);
	    return this;
	} 
	...
	public GetExternalcontactsNotesExportsRequest withPageSize(Integer pageSize) {
    ...
    public GetExternalcontactsNotesExportsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/externalcontacts/notes/exports")
	...
	public static class Builder {
		private final GetExternalcontactsNotesExportsRequest request;

		private Builder() {
			request = new GetExternalcontactsNotesExportsRequest();
		}
		...
		public GetExternalcontactsNotesExportsRequest build() {
