...
public class DeleteArchitectPromptsRequest {
	...
	public DeleteArchitectPromptsRequest withId(List<String> id) {
	    this.setId(id);
	    return this;
	} 
    ...
    public DeleteArchitectPromptsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.id == null) {
            throw new IllegalStateException("Missing the required parameter 'id' when building request for DeleteArchitectPromptsRequest.");
        }
