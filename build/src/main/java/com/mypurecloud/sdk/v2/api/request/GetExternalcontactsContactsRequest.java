...
public class GetExternalcontactsContactsRequest {
	...
	public GetExternalcontactsContactsRequest withPageSize(Integer pageSize) {
	...
	public GetExternalcontactsContactsRequest withPageNumber(Integer pageNumber) {
	...
	public GetExternalcontactsContactsRequest withQ(String q) {
	    this.setQ(q);
	    return this;
	} 
	...
	public GetExternalcontactsContactsRequest withSortOrder(String sortOrder) {
	...
	public GetExternalcontactsContactsRequest withExpand(List<String> expand) {
    ...
    public GetExternalcontactsContactsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/externalcontacts/contacts")
	...
	public static class Builder {
		...
		private Builder() {
			request = new GetExternalcontactsContactsRequest();
		}
