...
public class PostSocialmediaTopicsRequest {

	private SocialTopicRequest body;
	public SocialTopicRequest getBody() {
		return this.body;
	}

	public void setBody(SocialTopicRequest body) {
		this.body = body;
	}

	public PostSocialmediaTopicsRequest withBody(SocialTopicRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostSocialmediaTopicsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<SocialTopicRequest> withHttpInfo() {
        

        return ApiRequestBuilder.create("POST", "/api/v2/socialmedia/topics")
                .withBody(body)
	...
	public static class Builder {
		private final PostSocialmediaTopicsRequest request;

		private Builder() {
			request = new PostSocialmediaTopicsRequest();
		}


		public Builder withBody(SocialTopicRequest body) {
		...
		public PostSocialmediaTopicsRequest build() {
