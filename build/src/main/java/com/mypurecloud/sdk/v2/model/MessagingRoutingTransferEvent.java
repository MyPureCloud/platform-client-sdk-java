...
public class MessagingRoutingTransferEvent  implements Serializable {
 ...
 @JsonDeserialize(using = TransferTypeEnumDeserializer.class)
  ...
  public MessagingRoutingTransferEvent(Boolean initWithEmptyList) {
   ...
   **/
  public MessagingRoutingTransferEvent eventId(String eventId) {
   ...
   **/
  public MessagingRoutingTransferEvent eventDateTime(Date eventDateTime) {
   ...
   **/
  public MessagingRoutingTransferEvent conversationId(String conversationId) {
   ...
   * Indicates the desired type of transfer.
   **/
  public MessagingRoutingTransferEvent transferType(TransferTypeEnum transferType) {
   ...
   **/
  public MessagingRoutingTransferEvent commandId(String commandId) {
   ...
   * Indicates the desired type of transfer.
   **/
  public MessagingRoutingTransferEvent initiatingCommunicationId(String initiatingCommunicationId) {
   ...
   **/
  public MessagingRoutingTransferEvent targetCommunicationId(String targetCommunicationId) {
   ...
   **/
  public MessagingRoutingTransferEvent objectCommunicationId(String objectCommunicationId) {
   ...
   **/
  public MessagingRoutingTransferEvent destinationQueueId(String destinationQueueId) {
   ...
   **/
  public MessagingRoutingTransferEvent languageId(String languageId) {
   ...
   **/
  public MessagingRoutingTransferEvent skillIds(List<String> skillIds) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    MessagingRoutingTransferEvent messagingRoutingTransferEvent = (MessagingRoutingTransferEvent) o;

    return Objects.equals(this.eventId, messagingRoutingTransferEvent.eventId) &&
            Objects.equals(this.eventDateTime, messagingRoutingTransferEvent.eventDateTime) &&
            Objects.equals(this.conversationId, messagingRoutingTransferEvent.conversationId) &&
            Objects.equals(this.transferType, messagingRoutingTransferEvent.transferType) &&
            Objects.equals(this.commandId, messagingRoutingTransferEvent.commandId) &&
            Objects.equals(this.initiatingCommunicationId, messagingRoutingTransferEvent.initiatingCommunicationId) &&
            Objects.equals(this.targetCommunicationId, messagingRoutingTransferEvent.targetCommunicationId) &&
            Objects.equals(this.objectCommunicationId, messagingRoutingTransferEvent.objectCommunicationId) &&
            Objects.equals(this.destinationQueueId, messagingRoutingTransferEvent.destinationQueueId) &&
            Objects.equals(this.languageId, messagingRoutingTransferEvent.languageId) &&
            Objects.equals(this.skillIds, messagingRoutingTransferEvent.skillIds);
  }
