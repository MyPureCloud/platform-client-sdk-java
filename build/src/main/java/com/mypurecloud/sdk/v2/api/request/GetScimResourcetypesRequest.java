...
public class GetScimResourcetypesRequest {
    ...
    public GetScimResourcetypesRequest withCustomHeader(String name, String value) {
	...
	public static class Builder {
		private final GetScimResourcetypesRequest request;
		...
		public GetScimResourcetypesRequest build() {
