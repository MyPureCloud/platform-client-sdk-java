...
public class GetExternalcontactsRelationshipsExportsRequest {
	...
	public GetExternalcontactsRelationshipsExportsRequest withDivisionIds(List<String> divisionIds) {
	...
	public GetExternalcontactsRelationshipsExportsRequest withAfter(String after) {
	    this.setAfter(after);
	    return this;
	} 
	...
	public GetExternalcontactsRelationshipsExportsRequest withPageSize(Integer pageSize) {
    ...
    public GetExternalcontactsRelationshipsExportsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/externalcontacts/relationships/exports")
	...
	public static class Builder {
		private final GetExternalcontactsRelationshipsExportsRequest request;

		private Builder() {
			request = new GetExternalcontactsRelationshipsExportsRequest();
		}
		...
		public GetExternalcontactsRelationshipsExportsRequest build() {
