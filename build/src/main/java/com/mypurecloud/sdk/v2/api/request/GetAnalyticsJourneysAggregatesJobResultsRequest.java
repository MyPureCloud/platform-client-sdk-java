...
public class GetAnalyticsJourneysAggregatesJobResultsRequest {
	...
	public GetAnalyticsJourneysAggregatesJobResultsRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
	...
	public GetAnalyticsJourneysAggregatesJobResultsRequest withCursor(String cursor) {
    ...
    public GetAnalyticsJourneysAggregatesJobResultsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetAnalyticsJourneysAggregatesJobResultsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/analytics/journeys/aggregates/jobs/{jobId}/results")
	...
	public static class Builder {
		private final GetAnalyticsJourneysAggregatesJobResultsRequest request;

		private Builder() {
			request = new GetAnalyticsJourneysAggregatesJobResultsRequest();
		}
		...
		public GetAnalyticsJourneysAggregatesJobResultsRequest build() {
