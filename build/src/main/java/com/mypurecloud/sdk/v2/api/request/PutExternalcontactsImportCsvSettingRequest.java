...
public class PutExternalcontactsImportCsvSettingRequest {
	...
	public PutExternalcontactsImportCsvSettingRequest withSettingsId(String settingsId) {
	    this.setSettingsId(settingsId);
	    return this;
	} 

	private CsvSettings body;
	public CsvSettings getBody() {
		return this.body;
	}

	public void setBody(CsvSettings body) {
		this.body = body;
	}

	public PutExternalcontactsImportCsvSettingRequest withBody(CsvSettings body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutExternalcontactsImportCsvSettingRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<CsvSettings> withHttpInfo() {
        
        // verify the required parameter 'settingsId' is set
        if (this.settingsId == null) {
            throw new IllegalStateException("Missing the required parameter 'settingsId' when building request for PutExternalcontactsImportCsvSettingRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutExternalcontactsImportCsvSettingRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/externalcontacts/import/csv/settings/{settingsId}")
	...
	public static Builder builder(String settingsId, CsvSettings body) {
	    return new Builder()
	...
	public static class Builder {
		private final PutExternalcontactsImportCsvSettingRequest request;

		private Builder() {
			request = new PutExternalcontactsImportCsvSettingRequest();
		}
		...
		public Builder withBody(CsvSettings body) {
		...
		public Builder withRequiredParams(String settingsId, CsvSettings body) {
			request.setSettingsId(settingsId);
			request.setBody(body);
		...
		public PutExternalcontactsImportCsvSettingRequest build() {
