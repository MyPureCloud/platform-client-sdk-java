...
public class GetRoutingEmailOutboundDomainActivationRequest {
	...
	public GetRoutingEmailOutboundDomainActivationRequest withDomainId(String domainId) {
    ...
    public GetRoutingEmailOutboundDomainActivationRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.domainId == null) {
            throw new IllegalStateException("Missing the required parameter 'domainId' when building request for GetRoutingEmailOutboundDomainActivationRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/routing/email/outbound/domains/{domainId}/activation")
	...
	public static class Builder {
		private final GetRoutingEmailOutboundDomainActivationRequest request;

		private Builder() {
			request = new GetRoutingEmailOutboundDomainActivationRequest();
		}
		...
		public GetRoutingEmailOutboundDomainActivationRequest build() {
