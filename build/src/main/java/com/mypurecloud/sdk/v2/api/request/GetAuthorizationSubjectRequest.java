...
public class GetAuthorizationSubjectRequest {
	...
	public GetAuthorizationSubjectRequest withSubjectId(String subjectId) {
    ...
    public GetAuthorizationSubjectRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.subjectId == null) {
            throw new IllegalStateException("Missing the required parameter 'subjectId' when building request for GetAuthorizationSubjectRequest.");
        }
	...
	public static class Builder {
		private final GetAuthorizationSubjectRequest request;

		private Builder() {
			request = new GetAuthorizationSubjectRequest();
		}
		...
		public GetAuthorizationSubjectRequest build() {
