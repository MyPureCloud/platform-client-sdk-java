...
public class PatchWorkforcemanagementBusinessunitAlternativeshiftsSettingsRequest {
	...
	public PatchWorkforcemanagementBusinessunitAlternativeshiftsSettingsRequest withBusinessUnitId(String businessUnitId) {
	    this.setBusinessUnitId(businessUnitId);
	    return this;
	} 

	private UpdateAlternativeShiftBuSettingsRequest body;
	public UpdateAlternativeShiftBuSettingsRequest getBody() {
		return this.body;
	}

	public void setBody(UpdateAlternativeShiftBuSettingsRequest body) {
		this.body = body;
	}

	public PatchWorkforcemanagementBusinessunitAlternativeshiftsSettingsRequest withBody(UpdateAlternativeShiftBuSettingsRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchWorkforcemanagementBusinessunitAlternativeshiftsSettingsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<UpdateAlternativeShiftBuSettingsRequest> withHttpInfo() {
        
        // verify the required parameter 'businessUnitId' is set
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PatchWorkforcemanagementBusinessunitAlternativeshiftsSettingsRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchWorkforcemanagementBusinessunitAlternativeshiftsSettingsRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/alternativeshifts/settings")
	...
	public static Builder builder(String businessUnitId, UpdateAlternativeShiftBuSettingsRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PatchWorkforcemanagementBusinessunitAlternativeshiftsSettingsRequest request;

		private Builder() {
			request = new PatchWorkforcemanagementBusinessunitAlternativeshiftsSettingsRequest();
		}
		...
		public Builder withBody(UpdateAlternativeShiftBuSettingsRequest body) {
		...
		public Builder withRequiredParams(String businessUnitId, UpdateAlternativeShiftBuSettingsRequest body) {
			request.setBusinessUnitId(businessUnitId);
			request.setBody(body);
		...
		public PatchWorkforcemanagementBusinessunitAlternativeshiftsSettingsRequest build() {
