...
public class PostConversationDisconnectRequest {
	...
	public PostConversationDisconnectRequest withConversationId(String conversationId) {
    ...
    public PostConversationDisconnectRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PostConversationDisconnectRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/conversations/{conversationId}/disconnect")
	...
	public static class Builder {
		private final PostConversationDisconnectRequest request;

		private Builder() {
			request = new PostConversationDisconnectRequest();
		}
		...
		public PostConversationDisconnectRequest build() {
