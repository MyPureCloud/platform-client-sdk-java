...
public class GetWorkforcemanagementBusinessunitWeekShorttermforecastDataRequest {
	...
	public GetWorkforcemanagementBusinessunitWeekShorttermforecastDataRequest withBusinessUnitId(String businessUnitId) {
	...
	public GetWorkforcemanagementBusinessunitWeekShorttermforecastDataRequest withWeekDateId(LocalDate weekDateId) {
	...
	public GetWorkforcemanagementBusinessunitWeekShorttermforecastDataRequest withForecastId(String forecastId) {
	...
	public GetWorkforcemanagementBusinessunitWeekShorttermforecastDataRequest withWeekNumber(Integer weekNumber) {
	...
	public GetWorkforcemanagementBusinessunitWeekShorttermforecastDataRequest withForceDownloadService(Boolean forceDownloadService) {
    ...
    public GetWorkforcemanagementBusinessunitWeekShorttermforecastDataRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for GetWorkforcemanagementBusinessunitWeekShorttermforecastDataRequest.");
        }
        
        // verify the required parameter 'weekDateId' is set
        if (this.weekDateId == null) {
            throw new IllegalStateException("Missing the required parameter 'weekDateId' when building request for GetWorkforcemanagementBusinessunitWeekShorttermforecastDataRequest.");
        }
        
        // verify the required parameter 'forecastId' is set
        if (this.forecastId == null) {
            throw new IllegalStateException("Missing the required parameter 'forecastId' when building request for GetWorkforcemanagementBusinessunitWeekShorttermforecastDataRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/weeks/{weekDateId}/shorttermforecasts/{forecastId}/data")
                ...
                .withQueryParameters("weekNumber", "", weekNumber)
	...
	public static class Builder {
		private final GetWorkforcemanagementBusinessunitWeekShorttermforecastDataRequest request;

		private Builder() {
			request = new GetWorkforcemanagementBusinessunitWeekShorttermforecastDataRequest();
		}
		...
		public Builder withWeekNumber(Integer weekNumber) {
		...
		public GetWorkforcemanagementBusinessunitWeekShorttermforecastDataRequest build() {
