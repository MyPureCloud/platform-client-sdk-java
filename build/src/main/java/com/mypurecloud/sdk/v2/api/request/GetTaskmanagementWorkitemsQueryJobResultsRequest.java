...
public class GetTaskmanagementWorkitemsQueryJobResultsRequest {
	...
	public GetTaskmanagementWorkitemsQueryJobResultsRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetTaskmanagementWorkitemsQueryJobResultsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetTaskmanagementWorkitemsQueryJobResultsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/taskmanagement/workitems/query/jobs/{jobId}/results")
	...
	public static class Builder {
		private final GetTaskmanagementWorkitemsQueryJobResultsRequest request;

		private Builder() {
			request = new GetTaskmanagementWorkitemsQueryJobResultsRequest();
		}
		...
		public GetTaskmanagementWorkitemsQueryJobResultsRequest build() {
