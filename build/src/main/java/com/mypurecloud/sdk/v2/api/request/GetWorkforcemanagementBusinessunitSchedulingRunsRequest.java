...
public class GetWorkforcemanagementBusinessunitSchedulingRunsRequest {
	...
	public GetWorkforcemanagementBusinessunitSchedulingRunsRequest withBusinessUnitId(String businessUnitId) {
    ...
    public GetWorkforcemanagementBusinessunitSchedulingRunsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for GetWorkforcemanagementBusinessunitSchedulingRunsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/scheduling/runs")
	...
	public static class Builder {
		private final GetWorkforcemanagementBusinessunitSchedulingRunsRequest request;

		private Builder() {
			request = new GetWorkforcemanagementBusinessunitSchedulingRunsRequest();
		}
		...
		public GetWorkforcemanagementBusinessunitSchedulingRunsRequest build() {
