...
public class ResolutionDetailQueryClause  implements Serializable {
 ...
 @JsonDeserialize(using = TypeEnumDeserializer.class)
  ...
  public ResolutionDetailQueryClause() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
      predicates = new ArrayList<ResolutionDetailQueryPredicate>();
    }
  }

  public ResolutionDetailQueryClause(Boolean initWithEmptyList) {
   ...
   * Boolean operation to apply to the provided predicates
   **/
  public ResolutionDetailQueryClause type(TypeEnum type) {
    this.type = type;
    return this;
  }
   ...
   **/
  public ResolutionDetailQueryClause predicates(List<ResolutionDetailQueryPredicate> predicates) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ResolutionDetailQueryClause resolutionDetailQueryClause = (ResolutionDetailQueryClause) o;

    return Objects.equals(this.type, resolutionDetailQueryClause.type) &&
            Objects.equals(this.predicates, resolutionDetailQueryClause.predicates);
  }
