...
public class GetFlowsExecutionRequest {
	...
	public GetFlowsExecutionRequest withFlowExecutionId(String flowExecutionId) {
	    this.setFlowExecutionId(flowExecutionId);
	    return this;
	} 
    ...
    public GetFlowsExecutionRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.flowExecutionId == null) {
            throw new IllegalStateException("Missing the required parameter 'flowExecutionId' when building request for GetFlowsExecutionRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/flows/executions/{flowExecutionId}")
                .withPathParameter("flowExecutionId", flowExecutionId)
	...
	public static Builder builder(String flowExecutionId) {
	    return new Builder()
	            .withRequiredParams(flowExecutionId);
	}
	

	public static class Builder {
		private final GetFlowsExecutionRequest request;

		private Builder() {
			request = new GetFlowsExecutionRequest();
		}

		
		public Builder withFlowExecutionId(String flowExecutionId) {
			request.setFlowExecutionId(flowExecutionId);
			return this;
		}
		

		
		public Builder withRequiredParams(String flowExecutionId) {
			request.setFlowExecutionId(flowExecutionId);
		...
		public GetFlowsExecutionRequest build() {
            
            // verify the required parameter 'flowExecutionId' is set
            if (request.flowExecutionId == null) {
                throw new IllegalStateException("Missing the required parameter 'flowExecutionId' when building request for GetFlowsExecutionRequest.");
            }
