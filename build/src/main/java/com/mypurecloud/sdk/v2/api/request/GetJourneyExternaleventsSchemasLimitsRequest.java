...
public class GetJourneyExternaleventsSchemasLimitsRequest {
    ...
    public GetJourneyExternaleventsSchemasLimitsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/journey/externalevents/schemas/limits")
	...
	public static class Builder {
		private final GetJourneyExternaleventsSchemasLimitsRequest request;

		private Builder() {
			request = new GetJourneyExternaleventsSchemasLimitsRequest();
		}
		...
		public GetJourneyExternaleventsSchemasLimitsRequest build() {
