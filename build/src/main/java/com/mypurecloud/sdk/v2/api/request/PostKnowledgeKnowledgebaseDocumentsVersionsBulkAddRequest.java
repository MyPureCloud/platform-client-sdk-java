...
public class PostKnowledgeKnowledgebaseDocumentsVersionsBulkAddRequest {
	...
	public PostKnowledgeKnowledgebaseDocumentsVersionsBulkAddRequest withKnowledgeBaseId(String knowledgeBaseId) {
	    this.setKnowledgeBaseId(knowledgeBaseId);
	    return this;
	} 

	private KnowledgeDocumentBulkVersionAddRequest body;
	public KnowledgeDocumentBulkVersionAddRequest getBody() {
		return this.body;
	}

	public void setBody(KnowledgeDocumentBulkVersionAddRequest body) {
		this.body = body;
	}

	public PostKnowledgeKnowledgebaseDocumentsVersionsBulkAddRequest withBody(KnowledgeDocumentBulkVersionAddRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostKnowledgeKnowledgebaseDocumentsVersionsBulkAddRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<KnowledgeDocumentBulkVersionAddRequest> withHttpInfo() {
        
        // verify the required parameter 'knowledgeBaseId' is set
        if (this.knowledgeBaseId == null) {
            throw new IllegalStateException("Missing the required parameter 'knowledgeBaseId' when building request for PostKnowledgeKnowledgebaseDocumentsVersionsBulkAddRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostKnowledgeKnowledgebaseDocumentsVersionsBulkAddRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/documents/versions/bulk/add")
	...
	public static Builder builder(String knowledgeBaseId, KnowledgeDocumentBulkVersionAddRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostKnowledgeKnowledgebaseDocumentsVersionsBulkAddRequest request;

		private Builder() {
			request = new PostKnowledgeKnowledgebaseDocumentsVersionsBulkAddRequest();
		}
		...
		public Builder withBody(KnowledgeDocumentBulkVersionAddRequest body) {
		...
		public Builder withRequiredParams(String knowledgeBaseId, KnowledgeDocumentBulkVersionAddRequest body) {
			request.setKnowledgeBaseId(knowledgeBaseId);
			request.setBody(body);
		...
		public PostKnowledgeKnowledgebaseDocumentsVersionsBulkAddRequest build() {
