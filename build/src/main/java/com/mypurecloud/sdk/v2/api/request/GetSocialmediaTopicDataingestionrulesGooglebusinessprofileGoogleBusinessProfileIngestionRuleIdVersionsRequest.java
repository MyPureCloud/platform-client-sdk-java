...
public class GetSocialmediaTopicDataingestionrulesGooglebusinessprofileGoogleBusinessProfileIngestionRuleIdVersionsRequest {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.topicId == null) {
            throw new IllegalStateException("Missing the required parameter 'topicId' when building request for GetSocialmediaTopicDataingestionrulesGooglebusinessprofileGoogleBusinessProfileIngestionRuleIdVersionsRequest.");
        }
        ...
        if (this.googleBusinessProfileIngestionRuleId == null) {
            throw new IllegalStateException("Missing the required parameter 'googleBusinessProfileIngestionRuleId' when building request for GetSocialmediaTopicDataingestionrulesGooglebusinessprofileGoogleBusinessProfileIngestionRuleIdVersionsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/socialmedia/topics/{topicId}/dataingestionrules/googlebusinessprofile/{googleBusinessProfileIngestionRuleId}/versions")
	...
	public static Builder builder(String topicId, String googleBusinessProfileIngestionRuleId) {
	    return new Builder()
	            .withRequiredParams(topicId, googleBusinessProfileIngestionRuleId);
	}


	public static class Builder {
		private final GetSocialmediaTopicDataingestionrulesGooglebusinessprofileGoogleBusinessProfileIngestionRuleIdVersionsRequest request;

		private Builder() {
			request = new GetSocialmediaTopicDataingestionrulesGooglebusinessprofileGoogleBusinessProfileIngestionRuleIdVersionsRequest();
		}
		...
		public Builder withRequiredParams(String topicId, String googleBusinessProfileIngestionRuleId) {
			request.setTopicId(topicId);
			request.setGoogleBusinessProfileIngestionRuleId(googleBusinessProfileIngestionRuleId);
		...
		public GetSocialmediaTopicDataingestionrulesGooglebusinessprofileGoogleBusinessProfileIngestionRuleIdVersionsRequest build() {
