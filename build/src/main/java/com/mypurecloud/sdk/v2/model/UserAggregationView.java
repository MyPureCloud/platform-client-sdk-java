...
public class UserAggregationView  implements Serializable {
 ...
 @JsonDeserialize(using = FunctionEnumDeserializer.class)
   ...
   * Target metric name
   **/
  public UserAggregationView target(TargetEnum target) {
    this.target = target;
    return this;
  }
   ...
   **/
  public UserAggregationView name(String name) {
    this.name = name;
    return this;
  }
   ...
   * Type of view you wish to create
   **/
  public UserAggregationView function(FunctionEnum function) {
   ...
   **/
  public UserAggregationView range(AggregationRange range) {
    this.range = range;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    UserAggregationView userAggregationView = (UserAggregationView) o;

    return Objects.equals(this.target, userAggregationView.target) &&
            Objects.equals(this.name, userAggregationView.name) &&
            Objects.equals(this.function, userAggregationView.function) &&
            Objects.equals(this.range, userAggregationView.range);
  }
