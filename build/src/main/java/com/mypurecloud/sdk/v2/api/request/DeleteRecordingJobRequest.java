...
public class DeleteRecordingJobRequest {
	...
	public DeleteRecordingJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public DeleteRecordingJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for DeleteRecordingJobRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/recording/jobs/{jobId}")
	...
	public static class Builder {
		private final DeleteRecordingJobRequest request;

		private Builder() {
			request = new DeleteRecordingJobRequest();
		}
		...
		public DeleteRecordingJobRequest build() {
