...
public class GetTelephonyAgentsGreetingsMeRequest {
    ...
    public GetTelephonyAgentsGreetingsMeRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/telephony/agents/greetings/me")
	...
	public static class Builder {
		private final GetTelephonyAgentsGreetingsMeRequest request;

		private Builder() {
			request = new GetTelephonyAgentsGreetingsMeRequest();
		}
		...
		public GetTelephonyAgentsGreetingsMeRequest build() {
