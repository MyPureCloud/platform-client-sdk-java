...
public class PatchExternalcontactsOrganizationRequest {
	...
	public PatchExternalcontactsOrganizationRequest withExternalOrganizationId(String externalOrganizationId) {
	...
	public PatchExternalcontactsOrganizationRequest withBody(ExternalContactsPatchRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchExternalcontactsOrganizationRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<ExternalContactsPatchRequest> withHttpInfo() {
        ...
        if (this.externalOrganizationId == null) {
            throw new IllegalStateException("Missing the required parameter 'externalOrganizationId' when building request for PatchExternalcontactsOrganizationRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchExternalcontactsOrganizationRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/externalcontacts/organizations/{externalOrganizationId}")
	...
	public static Builder builder(String externalOrganizationId, ExternalContactsPatchRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PatchExternalcontactsOrganizationRequest request;

		private Builder() {
			request = new PatchExternalcontactsOrganizationRequest();
		}
		...
		public Builder withRequiredParams(String externalOrganizationId, ExternalContactsPatchRequest body) {
			request.setExternalOrganizationId(externalOrganizationId);
			request.setBody(body);
		...
		public PatchExternalcontactsOrganizationRequest build() {
