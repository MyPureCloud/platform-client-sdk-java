...
public class DeleteOutboundContactlisttemplateRequest {
	...
	public DeleteOutboundContactlisttemplateRequest withContactListTemplateId(String contactListTemplateId) {
    ...
    public DeleteOutboundContactlisttemplateRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.contactListTemplateId == null) {
            throw new IllegalStateException("Missing the required parameter 'contactListTemplateId' when building request for DeleteOutboundContactlisttemplateRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/outbound/contactlisttemplates/{contactListTemplateId}")
	...
	public static Builder builder(String contactListTemplateId) {
	    return new Builder()
	            .withRequiredParams(contactListTemplateId);
	}


	public static class Builder {
		private final DeleteOutboundContactlisttemplateRequest request;

		private Builder() {
			request = new DeleteOutboundContactlisttemplateRequest();
		}
		...
		public Builder withRequiredParams(String contactListTemplateId) {
			request.setContactListTemplateId(contactListTemplateId);
		...
		public DeleteOutboundContactlisttemplateRequest build() {
