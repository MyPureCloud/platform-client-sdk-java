...
public class GetConversationsMessagingIntegrationsLineIntegrationIdRequest {
	...
	public GetConversationsMessagingIntegrationsLineIntegrationIdRequest withIntegrationId(String integrationId) {
	...
	public GetConversationsMessagingIntegrationsLineIntegrationIdRequest withExpand(String expand) {
    ...
    public GetConversationsMessagingIntegrationsLineIntegrationIdRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.integrationId == null) {
            throw new IllegalStateException("Missing the required parameter 'integrationId' when building request for GetConversationsMessagingIntegrationsLineIntegrationIdRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/conversations/messaging/integrations/line/{integrationId}")
	...
	public static class Builder {
		private final GetConversationsMessagingIntegrationsLineIntegrationIdRequest request;

		private Builder() {
			request = new GetConversationsMessagingIntegrationsLineIntegrationIdRequest();
		}
		...
		public GetConversationsMessagingIntegrationsLineIntegrationIdRequest build() {
