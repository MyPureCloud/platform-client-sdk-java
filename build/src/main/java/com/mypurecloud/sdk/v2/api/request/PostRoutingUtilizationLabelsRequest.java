...
public class PostRoutingUtilizationLabelsRequest {

	private CreateUtilizationLabelRequest body;
	public CreateUtilizationLabelRequest getBody() {
		return this.body;
	}

	public void setBody(CreateUtilizationLabelRequest body) {
		this.body = body;
	}

	public PostRoutingUtilizationLabelsRequest withBody(CreateUtilizationLabelRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostRoutingUtilizationLabelsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<CreateUtilizationLabelRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostRoutingUtilizationLabelsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/routing/utilization/labels")
                .withBody(body)
	...
	public static Builder builder(CreateUtilizationLabelRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostRoutingUtilizationLabelsRequest request;

		private Builder() {
			request = new PostRoutingUtilizationLabelsRequest();
		}


		public Builder withBody(CreateUtilizationLabelRequest body) {
		...
		public Builder withRequiredParams(CreateUtilizationLabelRequest body) {
			request.setBody(body);
		...
		public PostRoutingUtilizationLabelsRequest build() {
