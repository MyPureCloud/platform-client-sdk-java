...
public class DeleteOutboundSchedulesCampaignRequest {
	...
	public DeleteOutboundSchedulesCampaignRequest withCampaignId(String campaignId) {
    ...
    public DeleteOutboundSchedulesCampaignRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.campaignId == null) {
            throw new IllegalStateException("Missing the required parameter 'campaignId' when building request for DeleteOutboundSchedulesCampaignRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/outbound/schedules/campaigns/{campaignId}")
	...
	public static class Builder {
		private final DeleteOutboundSchedulesCampaignRequest request;

		private Builder() {
			request = new DeleteOutboundSchedulesCampaignRequest();
		}
		...
		public DeleteOutboundSchedulesCampaignRequest build() {
