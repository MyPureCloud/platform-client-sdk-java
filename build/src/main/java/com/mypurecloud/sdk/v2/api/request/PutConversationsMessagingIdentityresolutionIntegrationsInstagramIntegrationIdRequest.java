...
public class PutConversationsMessagingIdentityresolutionIntegrationsInstagramIntegrationIdRequest {
	...
	public PutConversationsMessagingIdentityresolutionIntegrationsInstagramIntegrationIdRequest withIntegrationId(String integrationId) {
	    this.setIntegrationId(integrationId);
	    return this;
	} 

	private InstagramIdentityResolutionConfig body;
	public InstagramIdentityResolutionConfig getBody() {
		return this.body;
	}

	public void setBody(InstagramIdentityResolutionConfig body) {
		this.body = body;
	}

	public PutConversationsMessagingIdentityresolutionIntegrationsInstagramIntegrationIdRequest withBody(InstagramIdentityResolutionConfig body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutConversationsMessagingIdentityresolutionIntegrationsInstagramIntegrationIdRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<InstagramIdentityResolutionConfig> withHttpInfo() {
        
        // verify the required parameter 'integrationId' is set
        if (this.integrationId == null) {
            throw new IllegalStateException("Missing the required parameter 'integrationId' when building request for PutConversationsMessagingIdentityresolutionIntegrationsInstagramIntegrationIdRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutConversationsMessagingIdentityresolutionIntegrationsInstagramIntegrationIdRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/conversations/messaging/identityresolution/integrations/instagram/{integrationId}")
	...
	public static Builder builder(String integrationId, InstagramIdentityResolutionConfig body) {
	    return new Builder()
	...
	public static class Builder {
		private final PutConversationsMessagingIdentityresolutionIntegrationsInstagramIntegrationIdRequest request;

		private Builder() {
			request = new PutConversationsMessagingIdentityresolutionIntegrationsInstagramIntegrationIdRequest();
		}
		...
		public Builder withBody(InstagramIdentityResolutionConfig body) {
		...
		public Builder withRequiredParams(String integrationId, InstagramIdentityResolutionConfig body) {
			request.setIntegrationId(integrationId);
			request.setBody(body);
		...
		public PutConversationsMessagingIdentityresolutionIntegrationsInstagramIntegrationIdRequest build() {
