...
public class PostConversationAssignRequest {
	...
	public PostConversationAssignRequest withConversationId(String conversationId) {
	    this.setConversationId(conversationId);
	    return this;
	} 
	
	private ConversationUser body;
	public ConversationUser getBody() {
		return this.body;
	}

	public void setBody(ConversationUser body) {
		this.body = body;
	}

	public PostConversationAssignRequest withBody(ConversationUser body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostConversationAssignRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<ConversationUser> withHttpInfo() {
        
        // verify the required parameter 'conversationId' is set
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PostConversationAssignRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostConversationAssignRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/conversations/{conversationId}/assign")
	...
	public static Builder builder(String conversationId, ConversationUser body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostConversationAssignRequest request;

		private Builder() {
			request = new PostConversationAssignRequest();
		}
		...
		public Builder withBody(ConversationUser body) {
		...
		public Builder withRequiredParams(String conversationId, ConversationUser body) {
			request.setConversationId(conversationId);
						request.setBody(body);
		...
		public PostConversationAssignRequest build() {
