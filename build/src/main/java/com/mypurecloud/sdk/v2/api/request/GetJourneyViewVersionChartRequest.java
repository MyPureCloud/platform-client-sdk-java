...
public class GetJourneyViewVersionChartRequest {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/journey/views/{viewId}/versions/{journeyViewVersion}/charts/{chartId}")
	...
	public static Builder builder(String viewId, String journeyViewVersion, String chartId) {
	    return new Builder()
	            .withRequiredParams(viewId, journeyViewVersion, chartId);
	}


	public static class Builder {
		private final GetJourneyViewVersionChartRequest request;

		private Builder() {
			request = new GetJourneyViewVersionChartRequest();
		}
