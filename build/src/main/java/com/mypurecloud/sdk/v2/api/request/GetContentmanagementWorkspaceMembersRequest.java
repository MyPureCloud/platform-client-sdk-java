...
public class GetContentmanagementWorkspaceMembersRequest {
	...
	public GetContentmanagementWorkspaceMembersRequest withWorkspaceId(String workspaceId) {
	...
	public GetContentmanagementWorkspaceMembersRequest withPageSize(Integer pageSize) {
	...
	public GetContentmanagementWorkspaceMembersRequest withPageNumber(Integer pageNumber) {
	...
	public GetContentmanagementWorkspaceMembersRequest withExpand(List<String> expand) {
    ...
    public GetContentmanagementWorkspaceMembersRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.workspaceId == null) {
            throw new IllegalStateException("Missing the required parameter 'workspaceId' when building request for GetContentmanagementWorkspaceMembersRequest.");
        }
