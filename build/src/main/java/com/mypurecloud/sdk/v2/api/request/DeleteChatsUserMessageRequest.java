...
public class DeleteChatsUserMessageRequest {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("DELETE", "/api/v2/chats/users/{userId}/messages/{messageId}")
	...
	public static Builder builder(String userId, String messageId) {
	    return new Builder()
	            .withRequiredParams(userId, messageId);
	}


	public static class Builder {
		private final DeleteChatsUserMessageRequest request;

		private Builder() {
			request = new DeleteChatsUserMessageRequest();
		}
