...
public class DeleteAnalyticsConversationsDetailsJobRequest {
	...
	public DeleteAnalyticsConversationsDetailsJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public DeleteAnalyticsConversationsDetailsJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for DeleteAnalyticsConversationsDetailsJobRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/analytics/conversations/details/jobs/{jobId}")
	...
	public static class Builder {
		private final DeleteAnalyticsConversationsDetailsJobRequest request;

		private Builder() {
			request = new DeleteAnalyticsConversationsDetailsJobRequest();
		}
		...
		public DeleteAnalyticsConversationsDetailsJobRequest build() {
