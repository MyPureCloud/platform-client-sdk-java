...
public class SurveyAggregationView  implements Serializable {
 ...
 @JsonDeserialize(using = FunctionEnumDeserializer.class)
   ...
   * Target metric name
   **/
  public SurveyAggregationView target(TargetEnum target) {
    this.target = target;
    return this;
  }
   ...
   **/
  public SurveyAggregationView name(String name) {
    this.name = name;
    return this;
  }
   ...
   * Type of view you wish to create
   **/
  public SurveyAggregationView function(FunctionEnum function) {
   ...
   **/
  public SurveyAggregationView range(AggregationRange range) {
    this.range = range;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SurveyAggregationView surveyAggregationView = (SurveyAggregationView) o;

    return Objects.equals(this.target, surveyAggregationView.target) &&
            Objects.equals(this.name, surveyAggregationView.name) &&
            Objects.equals(this.function, surveyAggregationView.function) &&
            Objects.equals(this.range, surveyAggregationView.range);
  }
