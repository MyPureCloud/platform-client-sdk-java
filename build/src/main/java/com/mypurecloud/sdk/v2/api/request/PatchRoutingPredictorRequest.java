...
public class PatchRoutingPredictorRequest {
    ...
    public ApiRequest<PatchPredictorRequest> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("PATCH", "/api/v2/routing/predictors/{predictorId}")
	...
	public static class Builder {
		private final PatchRoutingPredictorRequest request;

		private Builder() {
			request = new PatchRoutingPredictorRequest();
		}
