...
public class ConversationVideoEventTopicScoredAgent  implements Serializable {
  ...
  public ConversationVideoEventTopicScoredAgent() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
    }
  }

  public ConversationVideoEventTopicScoredAgent(Boolean initWithEmptyList) {
   ...
   **/
  public ConversationVideoEventTopicScoredAgent score(Long score) {
    this.score = score;
    return this;
  }
