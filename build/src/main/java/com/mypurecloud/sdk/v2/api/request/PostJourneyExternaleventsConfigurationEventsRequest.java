...
public class PostJourneyExternaleventsConfigurationEventsRequest {
	...
	private ExternalEventsRequest body;
	public ExternalEventsRequest getBody() {
		return this.body;
	}

	public void setBody(ExternalEventsRequest body) {
		this.body = body;
	}

	public PostJourneyExternaleventsConfigurationEventsRequest withBody(ExternalEventsRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public ApiRequest<ExternalEventsRequest> withHttpInfo() {
        
        // verify the required parameter 'configurationId' is set
        if (this.configurationId == null) {
            throw new IllegalStateException("Missing the required parameter 'configurationId' when building request for PostJourneyExternaleventsConfigurationEventsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/journey/externalevents/configurations/{configurationId}/events")
	...
	public static class Builder {
		private final PostJourneyExternaleventsConfigurationEventsRequest request;

		private Builder() {
			request = new PostJourneyExternaleventsConfigurationEventsRequest();
		}
		...
		public Builder withBody(ExternalEventsRequest body) {
		...
		public PostJourneyExternaleventsConfigurationEventsRequest build() {
