...
public class DeleteOutboundCampaignRequest {
	...
	public DeleteOutboundCampaignRequest withCampaignId(String campaignId) {
    ...
    public DeleteOutboundCampaignRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.campaignId == null) {
            throw new IllegalStateException("Missing the required parameter 'campaignId' when building request for DeleteOutboundCampaignRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/outbound/campaigns/{campaignId}")
	...
	public static class Builder {
		private final DeleteOutboundCampaignRequest request;

		private Builder() {
			request = new DeleteOutboundCampaignRequest();
		}
		...
		public DeleteOutboundCampaignRequest build() {
