...
public class PostWorkforcemanagementManagementunitWeekShorttermforecastsGenerateRequest {
	...
	public PostWorkforcemanagementManagementunitWeekShorttermforecastsGenerateRequest withManagementUnitId(String managementUnitId) {
	...
	public PostWorkforcemanagementManagementunitWeekShorttermforecastsGenerateRequest withWeekDateId(String weekDateId) {
	    this.setWeekDateId(weekDateId);
	    return this;
	} 
	
	private GenerateShortTermForecastRequest body;
	public GenerateShortTermForecastRequest getBody() {
		return this.body;
	}

	public void setBody(GenerateShortTermForecastRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementManagementunitWeekShorttermforecastsGenerateRequest withBody(GenerateShortTermForecastRequest body) {
	    this.setBody(body);
	    return this;
	} 
	...
	public PostWorkforcemanagementManagementunitWeekShorttermforecastsGenerateRequest withForceAsync(Boolean forceAsync) {
    ...
    public PostWorkforcemanagementManagementunitWeekShorttermforecastsGenerateRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<GenerateShortTermForecastRequest> withHttpInfo() {
        
        // verify the required parameter 'managementUnitId' is set
        if (this.managementUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'managementUnitId' when building request for PostWorkforcemanagementManagementunitWeekShorttermforecastsGenerateRequest.");
        }
        
        // verify the required parameter 'weekDateId' is set
        if (this.weekDateId == null) {
            throw new IllegalStateException("Missing the required parameter 'weekDateId' when building request for PostWorkforcemanagementManagementunitWeekShorttermforecastsGenerateRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementManagementunitWeekShorttermforecastsGenerateRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/managementunits/{managementUnitId}/weeks/{weekDateId}/shorttermforecasts/generate")
	...
	public static Builder builder(String managementUnitId, String weekDateId, GenerateShortTermForecastRequest body) {
	    return new Builder()
	            .withRequiredParams(managementUnitId, weekDateId, body);
	}
	

	public static class Builder {
		private final PostWorkforcemanagementManagementunitWeekShorttermforecastsGenerateRequest request;

		private Builder() {
			request = new PostWorkforcemanagementManagementunitWeekShorttermforecastsGenerateRequest();
		}
		...
		public Builder withBody(GenerateShortTermForecastRequest body) {
		...
		public Builder withRequiredParams(String managementUnitId, String weekDateId, GenerateShortTermForecastRequest body) {
			request.setManagementUnitId(managementUnitId);
						request.setWeekDateId(weekDateId);
						request.setBody(body);
		...
		public PostWorkforcemanagementManagementunitWeekShorttermforecastsGenerateRequest build() {
