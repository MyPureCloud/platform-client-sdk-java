...
public class GetQualityPublishedformsSurveysDivisionviewRequest {
	...
	public GetQualityPublishedformsSurveysDivisionviewRequest withSurveyFormId(String surveyFormId) {
	    this.setSurveyFormId(surveyFormId);
	    return this;
	} 
    ...
    public GetQualityPublishedformsSurveysDivisionviewRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.surveyFormId == null) {
            throw new IllegalStateException("Missing the required parameter 'surveyFormId' when building request for GetQualityPublishedformsSurveysDivisionviewRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/quality/publishedforms/surveys/divisionviews/{surveyFormId}")
                .withPathParameter("surveyFormId", surveyFormId)
	...
	public static Builder builder(String surveyFormId) {
	    return new Builder()
	            .withRequiredParams(surveyFormId);
	}


	public static class Builder {
		private final GetQualityPublishedformsSurveysDivisionviewRequest request;

		private Builder() {
			request = new GetQualityPublishedformsSurveysDivisionviewRequest();
		}


		public Builder withSurveyFormId(String surveyFormId) {
			request.setSurveyFormId(surveyFormId);
			return this;
		}



		public Builder withRequiredParams(String surveyFormId) {
			request.setSurveyFormId(surveyFormId);
		...
		public GetQualityPublishedformsSurveysDivisionviewRequest build() {
            
            // verify the required parameter 'surveyFormId' is set
            if (request.surveyFormId == null) {
                throw new IllegalStateException("Missing the required parameter 'surveyFormId' when building request for GetQualityPublishedformsSurveysDivisionviewRequest.");
            }
