...
public class GetFlowsValidateJobRequest {
	...
	public GetFlowsValidateJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
	...
	public GetFlowsValidateJobRequest withExpand(List<String> expand) {
    ...
    public GetFlowsValidateJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetFlowsValidateJobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/flows/validate/jobs/{jobId}")
	...
	public static class Builder {
		private final GetFlowsValidateJobRequest request;

		private Builder() {
			request = new GetFlowsValidateJobRequest();
		}
		...
		public GetFlowsValidateJobRequest build() {
