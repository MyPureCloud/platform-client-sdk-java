...
public class PostWorkforcemanagementManagementunitWeekShifttradesRequest {
	...
	public PostWorkforcemanagementManagementunitWeekShifttradesRequest withManagementUnitId(String managementUnitId) {
	...
	public PostWorkforcemanagementManagementunitWeekShifttradesRequest withWeekDateId(LocalDate weekDateId) {
	    this.setWeekDateId(weekDateId);
	    return this;
	} 
	
	private AddShiftTradeRequest body;
	public AddShiftTradeRequest getBody() {
		return this.body;
	}

	public void setBody(AddShiftTradeRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementManagementunitWeekShifttradesRequest withBody(AddShiftTradeRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementManagementunitWeekShifttradesRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<AddShiftTradeRequest> withHttpInfo() {
        
        // verify the required parameter 'managementUnitId' is set
        if (this.managementUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'managementUnitId' when building request for PostWorkforcemanagementManagementunitWeekShifttradesRequest.");
        }
        
        // verify the required parameter 'weekDateId' is set
        if (this.weekDateId == null) {
            throw new IllegalStateException("Missing the required parameter 'weekDateId' when building request for PostWorkforcemanagementManagementunitWeekShifttradesRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementManagementunitWeekShifttradesRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/managementunits/{managementUnitId}/weeks/{weekDateId}/shifttrades")
	...
	public static Builder builder(String managementUnitId, LocalDate weekDateId, AddShiftTradeRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementManagementunitWeekShifttradesRequest request;

		private Builder() {
			request = new PostWorkforcemanagementManagementunitWeekShifttradesRequest();
		}
		...
		public Builder withBody(AddShiftTradeRequest body) {
		...
		public Builder withRequiredParams(String managementUnitId, LocalDate weekDateId, AddShiftTradeRequest body) {
			request.setManagementUnitId(managementUnitId);
						request.setWeekDateId(weekDateId);
						request.setBody(body);
		...
		public PostWorkforcemanagementManagementunitWeekShifttradesRequest build() {
