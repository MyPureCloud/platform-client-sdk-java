...
public class PutKnowledgeKnowledgebaseSourcesSalesforceSourceIdRequest {
	...
	public PutKnowledgeKnowledgebaseSourcesSalesforceSourceIdRequest withKnowledgeBaseId(String knowledgeBaseId) {
	...
	public PutKnowledgeKnowledgebaseSourcesSalesforceSourceIdRequest withSourceId(String sourceId) {
	    this.setSourceId(sourceId);
	    return this;
	} 

	private SalesforceSourceRequest body;
	public SalesforceSourceRequest getBody() {
		return this.body;
	}

	public void setBody(SalesforceSourceRequest body) {
		this.body = body;
	}

	public PutKnowledgeKnowledgebaseSourcesSalesforceSourceIdRequest withBody(SalesforceSourceRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutKnowledgeKnowledgebaseSourcesSalesforceSourceIdRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<SalesforceSourceRequest> withHttpInfo() {
        
        // verify the required parameter 'knowledgeBaseId' is set
        if (this.knowledgeBaseId == null) {
            throw new IllegalStateException("Missing the required parameter 'knowledgeBaseId' when building request for PutKnowledgeKnowledgebaseSourcesSalesforceSourceIdRequest.");
        }
        
        // verify the required parameter 'sourceId' is set
        if (this.sourceId == null) {
            throw new IllegalStateException("Missing the required parameter 'sourceId' when building request for PutKnowledgeKnowledgebaseSourcesSalesforceSourceIdRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutKnowledgeKnowledgebaseSourcesSalesforceSourceIdRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/sources/salesforce/{sourceId}")
	...
	public static Builder builder(String knowledgeBaseId, String sourceId, SalesforceSourceRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PutKnowledgeKnowledgebaseSourcesSalesforceSourceIdRequest request;

		private Builder() {
			request = new PutKnowledgeKnowledgebaseSourcesSalesforceSourceIdRequest();
		}
		...
		public Builder withBody(SalesforceSourceRequest body) {
		...
		public Builder withRequiredParams(String knowledgeBaseId, String sourceId, SalesforceSourceRequest body) {
			request.setKnowledgeBaseId(knowledgeBaseId);
			request.setSourceId(sourceId);
			request.setBody(body);
		...
		public PutKnowledgeKnowledgebaseSourcesSalesforceSourceIdRequest build() {
