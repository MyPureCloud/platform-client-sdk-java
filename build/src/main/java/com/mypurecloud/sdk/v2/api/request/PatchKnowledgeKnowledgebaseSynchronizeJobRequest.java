...
public class PatchKnowledgeKnowledgebaseSynchronizeJobRequest {
    ...
    public ApiRequest<SyncStatusRequest> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("PATCH", "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/synchronize/jobs/{syncJobId}")
	...
	public static Builder builder(String knowledgeBaseId, String syncJobId, SyncStatusRequest body) {
	    return new Builder()
	            .withRequiredParams(knowledgeBaseId, syncJobId, body);
	}


	public static class Builder {
		private final PatchKnowledgeKnowledgebaseSynchronizeJobRequest request;

		private Builder() {
			request = new PatchKnowledgeKnowledgebaseSynchronizeJobRequest();
		}
