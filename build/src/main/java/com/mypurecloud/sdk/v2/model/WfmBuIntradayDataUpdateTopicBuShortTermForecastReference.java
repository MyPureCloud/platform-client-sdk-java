...
public class WfmBuIntradayDataUpdateTopicBuShortTermForecastReference  implements Serializable {
  ...
  public WfmBuIntradayDataUpdateTopicBuShortTermForecastReference() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
    }
  }

  public WfmBuIntradayDataUpdateTopicBuShortTermForecastReference(Boolean initWithEmptyList) {
