...
public class GetSpeechandtextanalyticsProgramsTranscriptionenginesDialectsRequest {
    ...
    public GetSpeechandtextanalyticsProgramsTranscriptionenginesDialectsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/speechandtextanalytics/programs/transcriptionengines/dialects")
	...
	public static class Builder {
		private final GetSpeechandtextanalyticsProgramsTranscriptionenginesDialectsRequest request;

		private Builder() {
			request = new GetSpeechandtextanalyticsProgramsTranscriptionenginesDialectsRequest();
		}
		...
		public GetSpeechandtextanalyticsProgramsTranscriptionenginesDialectsRequest build() {
