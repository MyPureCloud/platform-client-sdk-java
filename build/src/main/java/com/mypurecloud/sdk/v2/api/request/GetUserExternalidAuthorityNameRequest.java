...
public class GetUserExternalidAuthorityNameRequest {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/users/{userId}/externalid/{authorityName}")
	...
	public static Builder builder(String userId, String authorityName) {
	    return new Builder()
	            .withRequiredParams(userId, authorityName);
	}
	

	public static class Builder {
		private final GetUserExternalidAuthorityNameRequest request;

		private Builder() {
			request = new GetUserExternalidAuthorityNameRequest();
		}
