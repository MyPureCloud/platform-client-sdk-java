...
public class PostOutboundConversationDncRequest {
	...
	public PostOutboundConversationDncRequest withConversationId(String conversationId) {
    ...
    public PostOutboundConversationDncRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PostOutboundConversationDncRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/outbound/conversations/{conversationId}/dnc")
	...
	public static class Builder {
		private final PostOutboundConversationDncRequest request;

		private Builder() {
			request = new PostOutboundConversationDncRequest();
		}
		...
		public PostOutboundConversationDncRequest build() {
