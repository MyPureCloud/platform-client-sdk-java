...
public class GetGamificationProfilesUsersMeRequest {
	...
	public GetGamificationProfilesUsersMeRequest withWorkday(LocalDate workday) {
    ...
    public GetGamificationProfilesUsersMeRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/gamification/profiles/users/me")
	...
	public static class Builder {
		private final GetGamificationProfilesUsersMeRequest request;

		private Builder() {
			request = new GetGamificationProfilesUsersMeRequest();
		}
		...
		public GetGamificationProfilesUsersMeRequest build() {
