...
public class PostDivisionBasedPresenceDefinitionsRequest {
	...
	public PostDivisionBasedPresenceDefinitionsRequest withBody(OrganizationPresenceDefinition body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostDivisionBasedPresenceDefinitionsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<OrganizationPresenceDefinition> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostDivisionBasedPresenceDefinitionsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/presence/definitions")
                .withBody(body)
	...
	public static Builder builder(OrganizationPresenceDefinition body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostDivisionBasedPresenceDefinitionsRequest request;

		private Builder() {
			request = new PostDivisionBasedPresenceDefinitionsRequest();
		}
		...
		public Builder withRequiredParams(OrganizationPresenceDefinition body) {
			request.setBody(body);
		...
		public PostDivisionBasedPresenceDefinitionsRequest build() {
