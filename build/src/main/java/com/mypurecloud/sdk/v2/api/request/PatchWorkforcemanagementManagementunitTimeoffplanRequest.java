...
public class PatchWorkforcemanagementManagementunitTimeoffplanRequest {
	...
	private UpdateTimeOffPlanRequest body;
	public UpdateTimeOffPlanRequest getBody() {
		return this.body;
	}

	public void setBody(UpdateTimeOffPlanRequest body) {
		this.body = body;
	}
    ...
    public ApiRequest<UpdateTimeOffPlanRequest> withHttpInfo() {
        
        // verify the required parameter 'managementUnitId' is set
        if (this.managementUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'managementUnitId' when building request for PatchWorkforcemanagementManagementunitTimeoffplanRequest.");
        }
	...
	public static class Builder {
		private final PatchWorkforcemanagementManagementunitTimeoffplanRequest request;

		private Builder() {
			request = new PatchWorkforcemanagementManagementunitTimeoffplanRequest();
		}
		...
		public Builder withBody(UpdateTimeOffPlanRequest body) {
		...
		public PatchWorkforcemanagementManagementunitTimeoffplanRequest build() {
