...
public class DivsPermittedEntityListing  implements Serializable, PagedResource<AuthzDivision> {
  ...
  public DivsPermittedEntityListing() {
  ...
  /**
   **/
  public DivsPermittedEntityListing entities(List<AuthzDivision> entities) {
  ...
  @ApiModelProperty(example = "null", value = "")
  @JsonProperty("allDivsPermitted")
  public Boolean getAllDivsPermitted() {
    return allDivsPermitted;
  }
  public void setAllDivsPermitted(Boolean allDivsPermitted) {
    this.allDivsPermitted = allDivsPermitted;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(entities, pageSize, pageNumber, total, allDivsPermitted, nextUri, previousUri, lastUri, firstUri, selfUri, pageCount);
  }
