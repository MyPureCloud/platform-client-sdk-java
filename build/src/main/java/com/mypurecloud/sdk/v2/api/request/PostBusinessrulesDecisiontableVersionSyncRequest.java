...
public class PostBusinessrulesDecisiontableVersionSyncRequest {
	...
	public PostBusinessrulesDecisiontableVersionSyncRequest withTableId(String tableId) {
	...
	public PostBusinessrulesDecisiontableVersionSyncRequest withTableVersion(Integer tableVersion) {
    ...
    public PostBusinessrulesDecisiontableVersionSyncRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.tableId == null) {
            throw new IllegalStateException("Missing the required parameter 'tableId' when building request for PostBusinessrulesDecisiontableVersionSyncRequest.");
        }
        
        // verify the required parameter 'tableVersion' is set
        if (this.tableVersion == null) {
            throw new IllegalStateException("Missing the required parameter 'tableVersion' when building request for PostBusinessrulesDecisiontableVersionSyncRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/businessrules/decisiontables/{tableId}/versions/{tableVersion}/sync")
	...
	public static class Builder {
		private final PostBusinessrulesDecisiontableVersionSyncRequest request;

		private Builder() {
			request = new PostBusinessrulesDecisiontableVersionSyncRequest();
		}
		...
		public PostBusinessrulesDecisiontableVersionSyncRequest build() {
