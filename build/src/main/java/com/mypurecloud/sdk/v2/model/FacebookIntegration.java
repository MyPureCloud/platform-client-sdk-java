...
public class FacebookIntegration  implements Serializable {
 ...
 @JsonDeserialize(using = CreateStatusEnumDeserializer.class)
   ...
   **/
  public FacebookIntegration supportedContent(SupportedContentReference supportedContent) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, supportedContent, messagingSetting, appId, pageId, pageName, pageProfileImageUrl, status, recipient, dateCreated, dateModified, createdBy, modifiedBy, version, createStatus, createError, selfUri);
  }
