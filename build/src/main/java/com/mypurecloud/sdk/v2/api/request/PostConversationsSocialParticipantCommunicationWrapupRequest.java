...
public class PostConversationsSocialParticipantCommunicationWrapupRequest {
	...
	public PostConversationsSocialParticipantCommunicationWrapupRequest withBody(WrapupInput body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public ApiRequest<WrapupInput> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("POST", "/api/v2/conversations/socials/{conversationId}/participants/{participantId}/communications/{communicationId}/wrapup")
	...
	public static class Builder {
		private final PostConversationsSocialParticipantCommunicationWrapupRequest request;

		private Builder() {
			request = new PostConversationsSocialParticipantCommunicationWrapupRequest();
		}
