...
public class PostWorkforcemanagementAgentsOpportunitiesEnrollmentsBulkStatusesUpdateRequest {

	private AgentBulkStatusUpdateOpportunityEnrollmentsRequest body;
	public AgentBulkStatusUpdateOpportunityEnrollmentsRequest getBody() {
		return this.body;
	}

	public void setBody(AgentBulkStatusUpdateOpportunityEnrollmentsRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementAgentsOpportunitiesEnrollmentsBulkStatusesUpdateRequest withBody(AgentBulkStatusUpdateOpportunityEnrollmentsRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementAgentsOpportunitiesEnrollmentsBulkStatusesUpdateRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<AgentBulkStatusUpdateOpportunityEnrollmentsRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementAgentsOpportunitiesEnrollmentsBulkStatusesUpdateRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/agents/opportunities/enrollments/bulk/statuses/update")
                .withBody(body)
	...
	public static Builder builder(AgentBulkStatusUpdateOpportunityEnrollmentsRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementAgentsOpportunitiesEnrollmentsBulkStatusesUpdateRequest request;

		private Builder() {
			request = new PostWorkforcemanagementAgentsOpportunitiesEnrollmentsBulkStatusesUpdateRequest();
		}


		public Builder withBody(AgentBulkStatusUpdateOpportunityEnrollmentsRequest body) {
		...
		public Builder withRequiredParams(AgentBulkStatusUpdateOpportunityEnrollmentsRequest body) {
			request.setBody(body);
		...
		public PostWorkforcemanagementAgentsOpportunitiesEnrollmentsBulkStatusesUpdateRequest build() {
