...
public class PostWorkforcemanagementAgentUnavailabletimesQueryRequest {
	...
	public PostWorkforcemanagementAgentUnavailabletimesQueryRequest withAgentId(String agentId) {
	    this.setAgentId(agentId);
	    return this;
	} 

	private QueryAgentUnavailableTimesRequest body;
	public QueryAgentUnavailableTimesRequest getBody() {
		return this.body;
	}

	public void setBody(QueryAgentUnavailableTimesRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementAgentUnavailabletimesQueryRequest withBody(QueryAgentUnavailableTimesRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementAgentUnavailabletimesQueryRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<QueryAgentUnavailableTimesRequest> withHttpInfo() {
        
        // verify the required parameter 'agentId' is set
        if (this.agentId == null) {
            throw new IllegalStateException("Missing the required parameter 'agentId' when building request for PostWorkforcemanagementAgentUnavailabletimesQueryRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementAgentUnavailabletimesQueryRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/agents/{agentId}/unavailabletimes/query")
	...
	public static Builder builder(String agentId, QueryAgentUnavailableTimesRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementAgentUnavailabletimesQueryRequest request;

		private Builder() {
			request = new PostWorkforcemanagementAgentUnavailabletimesQueryRequest();
		}
		...
		public Builder withBody(QueryAgentUnavailableTimesRequest body) {
		...
		public Builder withRequiredParams(String agentId, QueryAgentUnavailableTimesRequest body) {
			request.setAgentId(agentId);
			request.setBody(body);
		...
		public PostWorkforcemanagementAgentUnavailabletimesQueryRequest build() {
