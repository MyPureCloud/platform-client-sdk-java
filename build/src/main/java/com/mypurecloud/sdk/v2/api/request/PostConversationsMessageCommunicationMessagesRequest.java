...
public class PostConversationsMessageCommunicationMessagesRequest {
    ...
    public ApiRequest<AdditionalMessage> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("POST", "/api/v2/conversations/messages/{conversationId}/communications/{communicationId}/messages")
	...
	public static class Builder {
		private final PostConversationsMessageCommunicationMessagesRequest request;

		private Builder() {
			request = new PostConversationsMessageCommunicationMessagesRequest();
		}
