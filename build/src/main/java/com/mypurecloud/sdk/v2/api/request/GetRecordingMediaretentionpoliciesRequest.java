...
public class GetRecordingMediaretentionpoliciesRequest {
	...
	public GetRecordingMediaretentionpoliciesRequest withDeleteDaysThreshold(Integer deleteDaysThreshold) {
    ...
    public GetRecordingMediaretentionpoliciesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/recording/mediaretentionpolicies")
	...
	public static class Builder {
		private final GetRecordingMediaretentionpoliciesRequest request;

		private Builder() {
			request = new GetRecordingMediaretentionpoliciesRequest();
		}
