...
public class PatchIntegrationsActionRequest {
	...
	public void setBody(UpdateActionInput body) {
		this.body = body;
	}
    ...
    public PatchIntegrationsActionRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<UpdateActionInput> withHttpInfo() {
        
        // verify the required parameter 'actionId' is set
        if (this.actionId == null) {
            throw new IllegalStateException("Missing the required parameter 'actionId' when building request for PatchIntegrationsActionRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchIntegrationsActionRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/integrations/actions/{actionId}")
	...
	public static Builder builder(String actionId, UpdateActionInput body) {
	    return new Builder()
	...
	public static class Builder {
		private final PatchIntegrationsActionRequest request;

		private Builder() {
			request = new PatchIntegrationsActionRequest();
		}
		...
		public Builder withBody(UpdateActionInput body) {
		...
		public Builder withRequiredParams(String actionId, UpdateActionInput body) {
			request.setActionId(actionId);
						request.setBody(body);
