...
public class GetKnowledgeKnowledgebaseLanguageCategoryRequest {
	...
	public GetKnowledgeKnowledgebaseLanguageCategoryRequest withCategoryId(String categoryId) {
	...
	public GetKnowledgeKnowledgebaseLanguageCategoryRequest withKnowledgeBaseId(String knowledgeBaseId) {
	...
	public GetKnowledgeKnowledgebaseLanguageCategoryRequest withLanguageCode(String languageCode) {
    ...
    public GetKnowledgeKnowledgebaseLanguageCategoryRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.categoryId == null) {
            throw new IllegalStateException("Missing the required parameter 'categoryId' when building request for GetKnowledgeKnowledgebaseLanguageCategoryRequest.");
        }
        
        // verify the required parameter 'knowledgeBaseId' is set
        if (this.knowledgeBaseId == null) {
            throw new IllegalStateException("Missing the required parameter 'knowledgeBaseId' when building request for GetKnowledgeKnowledgebaseLanguageCategoryRequest.");
        }
        
        // verify the required parameter 'languageCode' is set
        if (this.languageCode == null) {
            throw new IllegalStateException("Missing the required parameter 'languageCode' when building request for GetKnowledgeKnowledgebaseLanguageCategoryRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/languages/{languageCode}/categories/{categoryId}")
	...
	public static class Builder {
		private final GetKnowledgeKnowledgebaseLanguageCategoryRequest request;

		private Builder() {
			request = new GetKnowledgeKnowledgebaseLanguageCategoryRequest();
		}
		...
		public GetKnowledgeKnowledgebaseLanguageCategoryRequest build() {
