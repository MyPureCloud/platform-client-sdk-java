...
public class GetArchitectDependencytrackingTypesRequest {
	...
	public GetArchitectDependencytrackingTypesRequest withPageNumber(Integer pageNumber) {
	...
	public GetArchitectDependencytrackingTypesRequest withPageSize(Integer pageSize) {
    ...
    public GetArchitectDependencytrackingTypesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/architect/dependencytracking/types")
