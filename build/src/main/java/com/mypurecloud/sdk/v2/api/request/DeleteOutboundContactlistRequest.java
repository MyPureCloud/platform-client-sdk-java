...
public class DeleteOutboundContactlistRequest {
	...
	public DeleteOutboundContactlistRequest withContactListId(String contactListId) {
    ...
    public DeleteOutboundContactlistRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.contactListId == null) {
            throw new IllegalStateException("Missing the required parameter 'contactListId' when building request for DeleteOutboundContactlistRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/outbound/contactlists/{contactListId}")
	...
	public static class Builder {
		private final DeleteOutboundContactlistRequest request;

		private Builder() {
			request = new DeleteOutboundContactlistRequest();
		}
		...
		public DeleteOutboundContactlistRequest build() {
