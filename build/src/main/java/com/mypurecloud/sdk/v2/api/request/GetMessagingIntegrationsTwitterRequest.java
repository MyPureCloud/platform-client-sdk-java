...
public class GetMessagingIntegrationsTwitterRequest {
	...
	public GetMessagingIntegrationsTwitterRequest withPageSize(Integer pageSize) {
	...
	public GetMessagingIntegrationsTwitterRequest withPageNumber(Integer pageNumber) {
    ...
    public GetMessagingIntegrationsTwitterRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/messaging/integrations/twitter")
	...
	public static class Builder {
		private final GetMessagingIntegrationsTwitterRequest request;

		private Builder() {
			request = new GetMessagingIntegrationsTwitterRequest();
		}
		...
		public GetMessagingIntegrationsTwitterRequest build() {
