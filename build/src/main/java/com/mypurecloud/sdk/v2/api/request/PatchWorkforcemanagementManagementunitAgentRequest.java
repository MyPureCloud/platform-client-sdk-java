...
public class PatchWorkforcemanagementManagementunitAgentRequest {
	...
	public PatchWorkforcemanagementManagementunitAgentRequest withManagementUnitId(String managementUnitId) {
	...
	public PatchWorkforcemanagementManagementunitAgentRequest withAgentId(String agentId) {
	    this.setAgentId(agentId);
	    return this;
	} 
	
	private UpdateAgentRequest body;
	public UpdateAgentRequest getBody() {
		return this.body;
	}

	public void setBody(UpdateAgentRequest body) {
		this.body = body;
	}

	public PatchWorkforcemanagementManagementunitAgentRequest withBody(UpdateAgentRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchWorkforcemanagementManagementunitAgentRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<UpdateAgentRequest> withHttpInfo() {
        
        // verify the required parameter 'managementUnitId' is set
        if (this.managementUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'managementUnitId' when building request for PatchWorkforcemanagementManagementunitAgentRequest.");
        }
        
        // verify the required parameter 'agentId' is set
        if (this.agentId == null) {
            throw new IllegalStateException("Missing the required parameter 'agentId' when building request for PatchWorkforcemanagementManagementunitAgentRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchWorkforcemanagementManagementunitAgentRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/workforcemanagement/managementunits/{managementUnitId}/agents/{agentId}")
	...
	public static Builder builder(String managementUnitId, String agentId, UpdateAgentRequest body) {
	    return new Builder()
	            .withRequiredParams(managementUnitId, agentId, body);
	}
	

	public static class Builder {
		private final PatchWorkforcemanagementManagementunitAgentRequest request;

		private Builder() {
			request = new PatchWorkforcemanagementManagementunitAgentRequest();
		}
		...
		public Builder withBody(UpdateAgentRequest body) {
		...
		public Builder withRequiredParams(String managementUnitId, String agentId, UpdateAgentRequest body) {
			request.setManagementUnitId(managementUnitId);
						request.setAgentId(agentId);
						request.setBody(body);
		...
		public PatchWorkforcemanagementManagementunitAgentRequest build() {
