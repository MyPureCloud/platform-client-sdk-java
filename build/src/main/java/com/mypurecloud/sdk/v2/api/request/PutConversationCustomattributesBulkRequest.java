...
public class PutConversationCustomattributesBulkRequest {
	...
	public PutConversationCustomattributesBulkRequest withConversationId(String conversationId) {
	    this.setConversationId(conversationId);
	    return this;
	} 

	private List<CustomAttributesUpdateRequest> body;
	public List<CustomAttributesUpdateRequest> getBody() {
		return this.body;
	}

	public void setBody(List<CustomAttributesUpdateRequest> body) {
		this.body = body;
	}

	public PutConversationCustomattributesBulkRequest withBody(List<CustomAttributesUpdateRequest> body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutConversationCustomattributesBulkRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<List<CustomAttributesUpdateRequest>> withHttpInfo() {
        
        // verify the required parameter 'conversationId' is set
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PutConversationCustomattributesBulkRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/conversations/{conversationId}/customattributes/bulk")
	...
	public static class Builder {
		private final PutConversationCustomattributesBulkRequest request;

		private Builder() {
			request = new PutConversationCustomattributesBulkRequest();
		}
		...
		public Builder withBody(List<CustomAttributesUpdateRequest> body) {
		...
		public PutConversationCustomattributesBulkRequest build() {
