...
public class GetExternalcontactsContactUnresolvedRequest {
	...
	public GetExternalcontactsContactUnresolvedRequest withContactId(String contactId) {
	...
	public GetExternalcontactsContactUnresolvedRequest withExpand(List<String> expand) {
    ...
    public GetExternalcontactsContactUnresolvedRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.contactId == null) {
            throw new IllegalStateException("Missing the required parameter 'contactId' when building request for GetExternalcontactsContactUnresolvedRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/externalcontacts/contacts/{contactId}/unresolved")
	...
	public static class Builder {
		private final GetExternalcontactsContactUnresolvedRequest request;

		private Builder() {
			request = new GetExternalcontactsContactUnresolvedRequest();
		}
		...
		public GetExternalcontactsContactUnresolvedRequest build() {
