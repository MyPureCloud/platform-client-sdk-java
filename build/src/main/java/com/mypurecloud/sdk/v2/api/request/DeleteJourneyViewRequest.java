...
public class DeleteJourneyViewRequest {
	...
	public DeleteJourneyViewRequest withViewId(String viewId) {
    ...
    public DeleteJourneyViewRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.viewId == null) {
            throw new IllegalStateException("Missing the required parameter 'viewId' when building request for DeleteJourneyViewRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/journey/views/{viewId}")
	...
	public static class Builder {
		private final DeleteJourneyViewRequest request;

		private Builder() {
			request = new DeleteJourneyViewRequest();
		}
		...
		public DeleteJourneyViewRequest build() {
