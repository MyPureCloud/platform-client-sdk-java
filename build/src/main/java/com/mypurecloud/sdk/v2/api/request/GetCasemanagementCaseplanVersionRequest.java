...
public class GetCasemanagementCaseplanVersionRequest {
	...
	public GetCasemanagementCaseplanVersionRequest withCaseplanId(String caseplanId) {
	...
	public GetCasemanagementCaseplanVersionRequest withVersionId(String versionId) {
    ...
    public GetCasemanagementCaseplanVersionRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.caseplanId == null) {
            throw new IllegalStateException("Missing the required parameter 'caseplanId' when building request for GetCasemanagementCaseplanVersionRequest.");
        }
        
        // verify the required parameter 'versionId' is set
        if (this.versionId == null) {
            throw new IllegalStateException("Missing the required parameter 'versionId' when building request for GetCasemanagementCaseplanVersionRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/casemanagement/caseplans/{caseplanId}/versions/{versionId}")
	...
	public static class Builder {
		private final GetCasemanagementCaseplanVersionRequest request;

		private Builder() {
			request = new GetCasemanagementCaseplanVersionRequest();
		}
		...
		public GetCasemanagementCaseplanVersionRequest build() {
