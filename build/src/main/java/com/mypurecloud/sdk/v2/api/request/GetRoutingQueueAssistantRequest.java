...
public class GetRoutingQueueAssistantRequest {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/routing/queues/{queueId}/assistant")
	...
	public static class Builder {
		private final GetRoutingQueueAssistantRequest request;

		private Builder() {
			request = new GetRoutingQueueAssistantRequest();
		}
