...
public class PatchConversationsMessageParticipantRequest {
	...
	public PatchConversationsMessageParticipantRequest withConversationId(String conversationId) {
	...
	public PatchConversationsMessageParticipantRequest withParticipantId(String participantId) {
	...
	public PatchConversationsMessageParticipantRequest withBody(MediaParticipantRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchConversationsMessageParticipantRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<MediaParticipantRequest> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PatchConversationsMessageParticipantRequest.");
        }
        
        // verify the required parameter 'participantId' is set
        if (this.participantId == null) {
            throw new IllegalStateException("Missing the required parameter 'participantId' when building request for PatchConversationsMessageParticipantRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/conversations/messages/{conversationId}/participants/{participantId}")
	...
	public static class Builder {
		private final PatchConversationsMessageParticipantRequest request;

		private Builder() {
			request = new PatchConversationsMessageParticipantRequest();
		}
		...
		public PatchConversationsMessageParticipantRequest build() {
