...
public class GetCasemanagementCasesQueryJobResultsRequest {
	...
	public GetCasemanagementCasesQueryJobResultsRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetCasemanagementCasesQueryJobResultsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetCasemanagementCasesQueryJobResultsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/casemanagement/cases/query/jobs/{jobId}/results")
	...
	public static class Builder {
		private final GetCasemanagementCasesQueryJobResultsRequest request;

		private Builder() {
			request = new GetCasemanagementCasesQueryJobResultsRequest();
		}
		...
		public GetCasemanagementCasesQueryJobResultsRequest build() {
