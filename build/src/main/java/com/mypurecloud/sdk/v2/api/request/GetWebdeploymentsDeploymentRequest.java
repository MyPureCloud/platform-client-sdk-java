...
public class GetWebdeploymentsDeploymentRequest {
	...
	public GetWebdeploymentsDeploymentRequest withDeploymentId(String deploymentId) {
	...
	public GetWebdeploymentsDeploymentRequest withExpand(List<String> expand) {
    ...
    public GetWebdeploymentsDeploymentRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.deploymentId == null) {
            throw new IllegalStateException("Missing the required parameter 'deploymentId' when building request for GetWebdeploymentsDeploymentRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/webdeployments/deployments/{deploymentId}")
	...
	public static class Builder {
		private final GetWebdeploymentsDeploymentRequest request;

		private Builder() {
			request = new GetWebdeploymentsDeploymentRequest();
		}
		...
		public GetWebdeploymentsDeploymentRequest build() {
