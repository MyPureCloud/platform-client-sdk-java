...
public class PatchOutboundCampaignRequest {
    ...
    public ApiRequest<CampaignPatchRequest> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("PATCH", "/api/v2/outbound/campaigns/{campaignId}")
	...
	public static class Builder {
		private final PatchOutboundCampaignRequest request;

		private Builder() {
			request = new PatchOutboundCampaignRequest();
		}
