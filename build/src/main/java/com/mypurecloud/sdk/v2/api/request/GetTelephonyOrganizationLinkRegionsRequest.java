...
public class GetTelephonyOrganizationLinkRegionsRequest {
    ...
    public GetTelephonyOrganizationLinkRegionsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/telephony/organization/link/regions")
	...
	public static class Builder {
		private final GetTelephonyOrganizationLinkRegionsRequest request;

		private Builder() {
			request = new GetTelephonyOrganizationLinkRegionsRequest();
		}
		...
		public GetTelephonyOrganizationLinkRegionsRequest build() {
