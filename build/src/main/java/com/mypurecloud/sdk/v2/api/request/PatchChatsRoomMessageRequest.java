...
public class PatchChatsRoomMessageRequest {
    ...
    public ApiRequest<SendMessageBody> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("PATCH", "/api/v2/chats/rooms/{roomJid}/messages/{messageId}")
	...
	public static Builder builder(String roomJid, String messageId, SendMessageBody body) {
	    return new Builder()
	            .withRequiredParams(roomJid, messageId, body);
	}


	public static class Builder {
		private final PatchChatsRoomMessageRequest request;

		private Builder() {
			request = new PatchChatsRoomMessageRequest();
		}
