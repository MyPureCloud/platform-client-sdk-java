...
public class GetTelephonyProvidersEdgesAvailablelanguagesRequest {
    ...
    public GetTelephonyProvidersEdgesAvailablelanguagesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() throws ApiException {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/telephony/providers/edges/availablelanguages")                .withCustomHeaders(customHeaders)
	...
	public static class Builder {
		private final GetTelephonyProvidersEdgesAvailablelanguagesRequest request;

		private Builder() {
			request = new GetTelephonyProvidersEdgesAvailablelanguagesRequest();
		}
