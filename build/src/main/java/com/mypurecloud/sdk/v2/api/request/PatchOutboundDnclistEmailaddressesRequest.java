...
public class PatchOutboundDnclistEmailaddressesRequest {
	...
	public PatchOutboundDnclistEmailaddressesRequest withDncListId(String dncListId) {
	    this.setDncListId(dncListId);
	    return this;
	} 

	private DncPatchEmailsRequest body;
	public DncPatchEmailsRequest getBody() {
		return this.body;
	}

	public void setBody(DncPatchEmailsRequest body) {
		this.body = body;
	}

	public PatchOutboundDnclistEmailaddressesRequest withBody(DncPatchEmailsRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchOutboundDnclistEmailaddressesRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<DncPatchEmailsRequest> withHttpInfo() {
        
        // verify the required parameter 'dncListId' is set
        if (this.dncListId == null) {
            throw new IllegalStateException("Missing the required parameter 'dncListId' when building request for PatchOutboundDnclistEmailaddressesRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchOutboundDnclistEmailaddressesRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/outbound/dnclists/{dncListId}/emailaddresses")
	...
	public static Builder builder(String dncListId, DncPatchEmailsRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PatchOutboundDnclistEmailaddressesRequest request;

		private Builder() {
			request = new PatchOutboundDnclistEmailaddressesRequest();
		}
		...
		public Builder withBody(DncPatchEmailsRequest body) {
		...
		public Builder withRequiredParams(String dncListId, DncPatchEmailsRequest body) {
			request.setDncListId(dncListId);
			request.setBody(body);
		...
		public PatchOutboundDnclistEmailaddressesRequest build() {
