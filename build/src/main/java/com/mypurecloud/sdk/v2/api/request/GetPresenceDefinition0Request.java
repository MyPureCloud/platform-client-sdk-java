...
public class GetPresenceDefinition0Request {
	...
	public GetPresenceDefinition0Request withDefinitionId(String definitionId) {
    ...
    public GetPresenceDefinition0Request withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.definitionId == null) {
            throw new IllegalStateException("Missing the required parameter 'definitionId' when building request for GetPresenceDefinition0Request.");
        }
	...
	public static class Builder {
		private final GetPresenceDefinition0Request request;

		private Builder() {
			request = new GetPresenceDefinition0Request();
		}
		...
		public GetPresenceDefinition0Request build() {
