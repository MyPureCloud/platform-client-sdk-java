...
public class DeleteSocialmediaTopicDataingestionrulesTwitterTwitterIngestionRuleIdRequest {
	...
	public DeleteSocialmediaTopicDataingestionrulesTwitterTwitterIngestionRuleIdRequest withTopicId(String topicId) {
	...
	public DeleteSocialmediaTopicDataingestionrulesTwitterTwitterIngestionRuleIdRequest withTwitterIngestionRuleId(String twitterIngestionRuleId) {
	...
	public DeleteSocialmediaTopicDataingestionrulesTwitterTwitterIngestionRuleIdRequest withHardDelete(Boolean hardDelete) {
    ...
    public DeleteSocialmediaTopicDataingestionrulesTwitterTwitterIngestionRuleIdRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.topicId == null) {
            throw new IllegalStateException("Missing the required parameter 'topicId' when building request for DeleteSocialmediaTopicDataingestionrulesTwitterTwitterIngestionRuleIdRequest.");
        }
        
        // verify the required parameter 'twitterIngestionRuleId' is set
        if (this.twitterIngestionRuleId == null) {
            throw new IllegalStateException("Missing the required parameter 'twitterIngestionRuleId' when building request for DeleteSocialmediaTopicDataingestionrulesTwitterTwitterIngestionRuleIdRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/socialmedia/topics/{topicId}/dataingestionrules/twitter/{twitterIngestionRuleId}")
	...
	public static class Builder {
		private final DeleteSocialmediaTopicDataingestionrulesTwitterTwitterIngestionRuleIdRequest request;

		private Builder() {
			request = new DeleteSocialmediaTopicDataingestionrulesTwitterTwitterIngestionRuleIdRequest();
		}
		...
		public DeleteSocialmediaTopicDataingestionrulesTwitterTwitterIngestionRuleIdRequest build() {
