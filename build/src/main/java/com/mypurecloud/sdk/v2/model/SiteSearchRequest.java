...
import com.mypurecloud.sdk.v2.model.SiteSearchCriteria;
...
public class SiteSearchRequest  implements Serializable {
 ...
 @JsonDeserialize(using = SortOrderEnumDeserializer.class)
  ...
  private List<SiteSearchCriteria> query = new ArrayList<SiteSearchCriteria>();

  
  /**
   * The sort order for results
   **/
  public SiteSearchRequest sortOrder(SortOrderEnum sortOrder) {
   ...
   **/
  public SiteSearchRequest sortBy(String sortBy) {
    this.sortBy = sortBy;
    return this;
  }
   ...
   **/
  public SiteSearchRequest pageSize(Integer pageSize) {
   ...
   **/
  public SiteSearchRequest pageNumber(Integer pageNumber) {
   ...
   **/
  public SiteSearchRequest sort(List<SearchSort> sort) {
    this.sort = sort;
    return this;
  }
   ...
   **/
  public SiteSearchRequest expand(List<String> expand) {
    this.expand = expand;
    return this;
  }
  ...
  /**
   **/
  public SiteSearchRequest query(List<SiteSearchCriteria> query) {
    this.query = query;
    return this;
  }
  ...
  @JsonProperty("query")
  public List<SiteSearchCriteria> getQuery() {
    return query;
  }
  public void setQuery(List<SiteSearchCriteria> query) {
    this.query = query;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SiteSearchRequest siteSearchRequest = (SiteSearchRequest) o;

    return Objects.equals(this.sortOrder, siteSearchRequest.sortOrder) &&
            Objects.equals(this.sortBy, siteSearchRequest.sortBy) &&
            Objects.equals(this.pageSize, siteSearchRequest.pageSize) &&
            Objects.equals(this.pageNumber, siteSearchRequest.pageNumber) &&
            Objects.equals(this.sort, siteSearchRequest.sort) &&
            Objects.equals(this.expand, siteSearchRequest.expand) &&
            Objects.equals(this.query, siteSearchRequest.query);
  }
