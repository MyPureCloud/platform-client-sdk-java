...
public class GetWorkforcemanagementWorkplanbidsRequest {
    ...
    public GetWorkforcemanagementWorkplanbidsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/workplanbids")
	...
	public static class Builder {
		private final GetWorkforcemanagementWorkplanbidsRequest request;

		private Builder() {
			request = new GetWorkforcemanagementWorkplanbidsRequest();
		}
		...
		public GetWorkforcemanagementWorkplanbidsRequest build() {
