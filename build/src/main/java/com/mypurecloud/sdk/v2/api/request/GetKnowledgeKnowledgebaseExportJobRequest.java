...
public class GetKnowledgeKnowledgebaseExportJobRequest {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/export/jobs/{exportJobId}")
	...
	public static Builder builder(String knowledgeBaseId, String exportJobId) {
	    return new Builder()
	            .withRequiredParams(knowledgeBaseId, exportJobId);
	}


	public static class Builder {
		private final GetKnowledgeKnowledgebaseExportJobRequest request;

		private Builder() {
			request = new GetKnowledgeKnowledgebaseExportJobRequest();
		}
