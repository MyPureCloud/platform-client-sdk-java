...
public class PatchUserCustomattributesBulkRequest {
	...
	public PatchUserCustomattributesBulkRequest withUserId(String userId) {
	    this.setUserId(userId);
	    return this;
	} 

	private List<UserCustomAttributesUpdateRequest> userCustomAttributesList;
	public List<UserCustomAttributesUpdateRequest> getUserCustomAttributesList() {
		return this.userCustomAttributesList;
	}

	public void setUserCustomAttributesList(List<UserCustomAttributesUpdateRequest> userCustomAttributesList) {
		this.userCustomAttributesList = userCustomAttributesList;
	}
	...
	public PatchUserCustomattributesBulkRequest withUserCustomAttributesList(List<UserCustomAttributesUpdateRequest> userCustomAttributesList) {
	    this.setUserCustomAttributesList(userCustomAttributesList);
	    return this;
	} 
    ...
    public PatchUserCustomattributesBulkRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<List<UserCustomAttributesUpdateRequest>> withHttpInfo() {
        
        // verify the required parameter 'userId' is set
        if (this.userId == null) {
            throw new IllegalStateException("Missing the required parameter 'userId' when building request for PatchUserCustomattributesBulkRequest.");
        }
        
        // verify the required parameter 'userCustomAttributesList' is set
        if (this.userCustomAttributesList == null) {
            throw new IllegalStateException("Missing the required parameter 'userCustomAttributesList' when building request for PatchUserCustomattributesBulkRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/users/{userId}/customattributes/bulk")
                .withPathParameter("userId", userId)
        
                .withBody(userCustomAttributesList)
	...
	public static Builder builder(String userId, List<UserCustomAttributesUpdateRequest> userCustomAttributesList) {
	    return new Builder()
	            .withRequiredParams(userId, userCustomAttributesList);
	}


	public static class Builder {
		private final PatchUserCustomattributesBulkRequest request;

		private Builder() {
			request = new PatchUserCustomattributesBulkRequest();
		}
		...
		public Builder withUserCustomAttributesList(List<UserCustomAttributesUpdateRequest> userCustomAttributesList) {
			request.setUserCustomAttributesList(userCustomAttributesList);
			return this;
		}



		public Builder withRequiredParams(String userId, List<UserCustomAttributesUpdateRequest> userCustomAttributesList) {
			request.setUserId(userId);
			request.setUserCustomAttributesList(userCustomAttributesList);
		...
		public PatchUserCustomattributesBulkRequest build() {
            ...
            // verify the required parameter 'userCustomAttributesList' is set
            if (request.userCustomAttributesList == null) {
                throw new IllegalStateException("Missing the required parameter 'userCustomAttributesList' when building request for PatchUserCustomattributesBulkRequest.");
            }
