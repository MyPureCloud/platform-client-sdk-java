...
public class GetOutboundContactlistTimezonemappingpreviewRequest {
	...
	public GetOutboundContactlistTimezonemappingpreviewRequest withContactListId(String contactListId) {
    ...
    public GetOutboundContactlistTimezonemappingpreviewRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.contactListId == null) {
            throw new IllegalStateException("Missing the required parameter 'contactListId' when building request for GetOutboundContactlistTimezonemappingpreviewRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/outbound/contactlists/{contactListId}/timezonemappingpreview")
	...
	public static class Builder {
		private final GetOutboundContactlistTimezonemappingpreviewRequest request;

		private Builder() {
			request = new GetOutboundContactlistTimezonemappingpreviewRequest();
		}
		...
		public GetOutboundContactlistTimezonemappingpreviewRequest build() {
