...
public class PostWorkforcemanagementCalendarUrlIcsRequest {
	...
	public PostWorkforcemanagementCalendarUrlIcsRequest withLanguage(String language) {
    ...
    public PostWorkforcemanagementCalendarUrlIcsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/calendar/url/ics")
	...
	public static class Builder {
		private final PostWorkforcemanagementCalendarUrlIcsRequest request;

		private Builder() {
			request = new PostWorkforcemanagementCalendarUrlIcsRequest();
		}
		...
		public PostWorkforcemanagementCalendarUrlIcsRequest build() {
