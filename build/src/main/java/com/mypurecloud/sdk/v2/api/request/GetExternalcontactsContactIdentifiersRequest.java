...
public class GetExternalcontactsContactIdentifiersRequest {
	...
	public GetExternalcontactsContactIdentifiersRequest withContactId(String contactId) {
    ...
    public GetExternalcontactsContactIdentifiersRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.contactId == null) {
            throw new IllegalStateException("Missing the required parameter 'contactId' when building request for GetExternalcontactsContactIdentifiersRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/externalcontacts/contacts/{contactId}/identifiers")
	...
	public static class Builder {
		private final GetExternalcontactsContactIdentifiersRequest request;

		private Builder() {
			request = new GetExternalcontactsContactIdentifiersRequest();
		}
		...
		public GetExternalcontactsContactIdentifiersRequest build() {
