...
public class RecordingContentStory  implements Serializable {
 ...
 @JsonDeserialize(using = TypeEnumDeserializer.class)
   ...
   * Type of ephemeral story attachment.
   **/
  public RecordingContentStory type(TypeEnum type) {
    this.type = type;
    return this;
  }
   ...
   **/
  public RecordingContentStory url(String url) {
    this.url = url;
    return this;
  }
   ...
   **/
  public RecordingContentStory replyToId(String replyToId) {
