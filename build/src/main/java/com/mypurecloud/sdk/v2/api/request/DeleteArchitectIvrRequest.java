...
public class DeleteArchitectIvrRequest {
	...
	public DeleteArchitectIvrRequest withIvrId(String ivrId) {
	    this.setIvrId(ivrId);
	    return this;
	} 
    ...
    public DeleteArchitectIvrRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.ivrId == null) {
            throw new IllegalStateException("Missing the required parameter 'ivrId' when building request for DeleteArchitectIvrRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/architect/ivrs/{ivrId}")
	...
	public static class Builder {
		private final DeleteArchitectIvrRequest request;

		private Builder() {
			request = new DeleteArchitectIvrRequest();
		}
		...
		public DeleteArchitectIvrRequest build() {
