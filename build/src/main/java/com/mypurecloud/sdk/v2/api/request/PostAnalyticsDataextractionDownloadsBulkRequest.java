...
public class PostAnalyticsDataextractionDownloadsBulkRequest {

	private DownloadServiceRequest body;
	public DownloadServiceRequest getBody() {
		return this.body;
	}

	public void setBody(DownloadServiceRequest body) {
		this.body = body;
	}

	public PostAnalyticsDataextractionDownloadsBulkRequest withBody(DownloadServiceRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostAnalyticsDataextractionDownloadsBulkRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<DownloadServiceRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostAnalyticsDataextractionDownloadsBulkRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/analytics/dataextraction/downloads/bulk")
                .withBody(body)
	...
	public static Builder builder(DownloadServiceRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostAnalyticsDataextractionDownloadsBulkRequest request;

		private Builder() {
			request = new PostAnalyticsDataextractionDownloadsBulkRequest();
		}


		public Builder withBody(DownloadServiceRequest body) {
		...
		public Builder withRequiredParams(DownloadServiceRequest body) {
			request.setBody(body);
		...
		public PostAnalyticsDataextractionDownloadsBulkRequest build() {
