...
public class NotesExportFieldListFilter  implements Serializable {
 ...
 @JsonDeserialize(using = FieldEnumDeserializer.class)
  ...
  public NotesExportFieldListFilter() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
      values = new ArrayList<String>();
    }
  }

  public NotesExportFieldListFilter(Boolean initWithEmptyList) {
   ...
   * Field name to apply the filter
   **/
  public NotesExportFieldListFilter field(FieldEnum field) {
    this.field = field;
    return this;
  }
   ...
   **/
  public NotesExportFieldListFilter values(List<String> values) {
    this.values = values;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    NotesExportFieldListFilter notesExportFieldListFilter = (NotesExportFieldListFilter) o;

    return Objects.equals(this.field, notesExportFieldListFilter.field) &&
            Objects.equals(this.values, notesExportFieldListFilter.values);
  }
