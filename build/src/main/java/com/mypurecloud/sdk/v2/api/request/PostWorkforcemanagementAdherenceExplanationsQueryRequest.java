...
public class PostWorkforcemanagementAdherenceExplanationsQueryRequest {
	...
	public PostWorkforcemanagementAdherenceExplanationsQueryRequest withBody(AgentQueryAdherenceExplanationsRequest body) {
	    this.setBody(body);
	    return this;
	} 
	...
	public PostWorkforcemanagementAdherenceExplanationsQueryRequest withForceAsync(Boolean forceAsync) {
	...
	public PostWorkforcemanagementAdherenceExplanationsQueryRequest withForceDownloadService(Boolean forceDownloadService) {
    ...
    public PostWorkforcemanagementAdherenceExplanationsQueryRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<AgentQueryAdherenceExplanationsRequest> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementAdherenceExplanationsQueryRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/adherence/explanations/query")
	...
	public static Builder builder(AgentQueryAdherenceExplanationsRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementAdherenceExplanationsQueryRequest request;

		private Builder() {
			request = new PostWorkforcemanagementAdherenceExplanationsQueryRequest();
		}
		...
		public Builder withRequiredParams(AgentQueryAdherenceExplanationsRequest body) {
			request.setBody(body);
		...
		public PostWorkforcemanagementAdherenceExplanationsQueryRequest build() {
