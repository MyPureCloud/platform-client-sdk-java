...
public class SupportedDialectsEntityListing  implements Serializable {
  ...
  private List<SupportedDialectsTranscriptionEngine> entities = null;

  public SupportedDialectsEntityListing() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
      entities = new ArrayList<SupportedDialectsTranscriptionEngine>();
    }
  }

  public SupportedDialectsEntityListing(Boolean initWithEmptyList) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SupportedDialectsEntityListing supportedDialectsEntityListing = (SupportedDialectsEntityListing) o;

    return Objects.equals(this.entities, supportedDialectsEntityListing.entities);
  }
