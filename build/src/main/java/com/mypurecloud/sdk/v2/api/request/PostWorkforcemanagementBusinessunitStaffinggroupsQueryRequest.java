...
public class PostWorkforcemanagementBusinessunitStaffinggroupsQueryRequest {
	...
	public PostWorkforcemanagementBusinessunitStaffinggroupsQueryRequest withBusinessUnitId(String businessUnitId) {
	    this.setBusinessUnitId(businessUnitId);
	    return this;
	} 

	private QueryUserStaffingGroupListRequest body;
	public QueryUserStaffingGroupListRequest getBody() {
		return this.body;
	}

	public void setBody(QueryUserStaffingGroupListRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementBusinessunitStaffinggroupsQueryRequest withBody(QueryUserStaffingGroupListRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementBusinessunitStaffinggroupsQueryRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<QueryUserStaffingGroupListRequest> withHttpInfo() {
        
        // verify the required parameter 'businessUnitId' is set
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PostWorkforcemanagementBusinessunitStaffinggroupsQueryRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementBusinessunitStaffinggroupsQueryRequest.");
        }
	...
	public static Builder builder(String businessUnitId, QueryUserStaffingGroupListRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementBusinessunitStaffinggroupsQueryRequest request;

		private Builder() {
			request = new PostWorkforcemanagementBusinessunitStaffinggroupsQueryRequest();
		}
		...
		public Builder withRequiredParams(String businessUnitId, QueryUserStaffingGroupListRequest body) {
			request.setBusinessUnitId(businessUnitId);
			request.setBody(body);
		...
		public PostWorkforcemanagementBusinessunitStaffinggroupsQueryRequest build() {
