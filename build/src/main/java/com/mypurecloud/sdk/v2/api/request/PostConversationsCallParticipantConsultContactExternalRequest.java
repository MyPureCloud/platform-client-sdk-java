...
public class PostConversationsCallParticipantConsultContactExternalRequest {
	...
	public PostConversationsCallParticipantConsultContactExternalRequest withConversationId(String conversationId) {
	...
	public PostConversationsCallParticipantConsultContactExternalRequest withParticipantId(String participantId) {
	    this.setParticipantId(participantId);
	    return this;
	} 

	private ConsultTransferToExternalContact body;
	public ConsultTransferToExternalContact getBody() {
		return this.body;
	}

	public void setBody(ConsultTransferToExternalContact body) {
		this.body = body;
	}

	public PostConversationsCallParticipantConsultContactExternalRequest withBody(ConsultTransferToExternalContact body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostConversationsCallParticipantConsultContactExternalRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<ConsultTransferToExternalContact> withHttpInfo() {
        
        // verify the required parameter 'conversationId' is set
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PostConversationsCallParticipantConsultContactExternalRequest.");
        }
        
        // verify the required parameter 'participantId' is set
        if (this.participantId == null) {
            throw new IllegalStateException("Missing the required parameter 'participantId' when building request for PostConversationsCallParticipantConsultContactExternalRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostConversationsCallParticipantConsultContactExternalRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/conversations/calls/{conversationId}/participants/{participantId}/consult/contact/external")
	...
	public static Builder builder(String conversationId, String participantId, ConsultTransferToExternalContact body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostConversationsCallParticipantConsultContactExternalRequest request;

		private Builder() {
			request = new PostConversationsCallParticipantConsultContactExternalRequest();
		}
		...
		public Builder withBody(ConsultTransferToExternalContact body) {
		...
		public Builder withRequiredParams(String conversationId, String participantId, ConsultTransferToExternalContact body) {
			request.setConversationId(conversationId);
			request.setParticipantId(participantId);
			request.setBody(body);
		...
		public PostConversationsCallParticipantConsultContactExternalRequest build() {
