...
public class PatchTaskmanagementWorkitemsBulkAddJobRequest {
	...
	public PatchTaskmanagementWorkitemsBulkAddJobRequest withBulkJobId(String bulkJobId) {
	    this.setBulkJobId(bulkJobId);
	    return this;
	} 

	private BulkJobUpdate body;
	public BulkJobUpdate getBody() {
		return this.body;
	}

	public void setBody(BulkJobUpdate body) {
		this.body = body;
	}

	public PatchTaskmanagementWorkitemsBulkAddJobRequest withBody(BulkJobUpdate body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchTaskmanagementWorkitemsBulkAddJobRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<BulkJobUpdate> withHttpInfo() {
        
        // verify the required parameter 'bulkJobId' is set
        if (this.bulkJobId == null) {
            throw new IllegalStateException("Missing the required parameter 'bulkJobId' when building request for PatchTaskmanagementWorkitemsBulkAddJobRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchTaskmanagementWorkitemsBulkAddJobRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/taskmanagement/workitems/bulk/add/jobs/{bulkJobId}")
                .withPathParameter("bulkJobId", bulkJobId)
	...
	public static Builder builder(String bulkJobId, BulkJobUpdate body) {
	    return new Builder()
	            .withRequiredParams(bulkJobId, body);
	}


	public static class Builder {
		private final PatchTaskmanagementWorkitemsBulkAddJobRequest request;

		private Builder() {
			request = new PatchTaskmanagementWorkitemsBulkAddJobRequest();
		}


		public Builder withBulkJobId(String bulkJobId) {
			request.setBulkJobId(bulkJobId);
			return this;
		}

		public Builder withBody(BulkJobUpdate body) {
		...
		public Builder withRequiredParams(String bulkJobId, BulkJobUpdate body) {
			request.setBulkJobId(bulkJobId);
			request.setBody(body);
		...
		public PatchTaskmanagementWorkitemsBulkAddJobRequest build() {
            
            // verify the required parameter 'bulkJobId' is set
            if (request.bulkJobId == null) {
                throw new IllegalStateException("Missing the required parameter 'bulkJobId' when building request for PatchTaskmanagementWorkitemsBulkAddJobRequest.");
            }
