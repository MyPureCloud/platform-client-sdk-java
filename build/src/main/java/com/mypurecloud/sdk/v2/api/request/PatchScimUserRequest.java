...
public class PatchScimUserRequest {
	...
	public PatchScimUserRequest withUserId(String userId) {
	...
	public PatchScimUserRequest withBody(ScimV2PatchRequest body) {
	    this.setBody(body);
	    return this;
	} 
	...
	public PatchScimUserRequest withIfMatch(String ifMatch) {
    ...
    public PatchScimUserRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<ScimV2PatchRequest> withHttpInfo() {
        ...
        if (this.userId == null) {
            throw new IllegalStateException("Missing the required parameter 'userId' when building request for PatchScimUserRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchScimUserRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/scim/users/{userId}")
	...
	public static class Builder {
		private final PatchScimUserRequest request;

		private Builder() {
			request = new PatchScimUserRequest();
		}
		...
		public PatchScimUserRequest build() {
