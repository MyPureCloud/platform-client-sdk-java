...
public class PutRoutingDirectroutingbackupSettingsMeRequest {
	...
	public PutRoutingDirectroutingbackupSettingsMeRequest withBody(AgentDirectRoutingBackupSettings body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutRoutingDirectroutingbackupSettingsMeRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<AgentDirectRoutingBackupSettings> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutRoutingDirectroutingbackupSettingsMeRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/routing/directroutingbackup/settings/me")
                .withBody(body)
	...
	public static Builder builder(AgentDirectRoutingBackupSettings body) {
	    return new Builder()
	...
	public static class Builder {
		private final PutRoutingDirectroutingbackupSettingsMeRequest request;

		private Builder() {
			request = new PutRoutingDirectroutingbackupSettingsMeRequest();
		}
		...
		public Builder withRequiredParams(AgentDirectRoutingBackupSettings body) {
			request.setBody(body);
		...
		public PutRoutingDirectroutingbackupSettingsMeRequest build() {
