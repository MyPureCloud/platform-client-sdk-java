...
public class DeleteBusinessrulesDecisiontableVersionSnapshotRequest {
	...
	public DeleteBusinessrulesDecisiontableVersionSnapshotRequest withTableId(String tableId) {
	...
	public DeleteBusinessrulesDecisiontableVersionSnapshotRequest withTableVersion(Integer tableVersion) {
    ...
    public DeleteBusinessrulesDecisiontableVersionSnapshotRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.tableId == null) {
            throw new IllegalStateException("Missing the required parameter 'tableId' when building request for DeleteBusinessrulesDecisiontableVersionSnapshotRequest.");
        }
        
        // verify the required parameter 'tableVersion' is set
        if (this.tableVersion == null) {
            throw new IllegalStateException("Missing the required parameter 'tableVersion' when building request for DeleteBusinessrulesDecisiontableVersionSnapshotRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/businessrules/decisiontables/{tableId}/versions/{tableVersion}/snapshot")
	...
	public static class Builder {
		private final DeleteBusinessrulesDecisiontableVersionSnapshotRequest request;

		private Builder() {
			request = new DeleteBusinessrulesDecisiontableVersionSnapshotRequest();
		}
		...
		public DeleteBusinessrulesDecisiontableVersionSnapshotRequest build() {
