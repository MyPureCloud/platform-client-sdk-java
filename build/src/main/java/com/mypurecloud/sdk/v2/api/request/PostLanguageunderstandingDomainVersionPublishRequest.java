...
public class PostLanguageunderstandingDomainVersionPublishRequest {
	...
	public PostLanguageunderstandingDomainVersionPublishRequest withDomainId(String domainId) {
	...
	public PostLanguageunderstandingDomainVersionPublishRequest withDomainVersionId(String domainVersionId) {
    ...
    public PostLanguageunderstandingDomainVersionPublishRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.domainId == null) {
            throw new IllegalStateException("Missing the required parameter 'domainId' when building request for PostLanguageunderstandingDomainVersionPublishRequest.");
        }
        
        // verify the required parameter 'domainVersionId' is set
        if (this.domainVersionId == null) {
            throw new IllegalStateException("Missing the required parameter 'domainVersionId' when building request for PostLanguageunderstandingDomainVersionPublishRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/languageunderstanding/domains/{domainId}/versions/{domainVersionId}/publish")
	...
	public static class Builder {
		private final PostLanguageunderstandingDomainVersionPublishRequest request;

		private Builder() {
			request = new PostLanguageunderstandingDomainVersionPublishRequest();
		}
		...
		public PostLanguageunderstandingDomainVersionPublishRequest build() {
