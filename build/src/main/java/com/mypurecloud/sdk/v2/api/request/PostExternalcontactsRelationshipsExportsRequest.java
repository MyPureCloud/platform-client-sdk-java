...
public class PostExternalcontactsRelationshipsExportsRequest {

	private RelationshipsExport body;
	public RelationshipsExport getBody() {
		return this.body;
	}

	public void setBody(RelationshipsExport body) {
		this.body = body;
	}

	public PostExternalcontactsRelationshipsExportsRequest withBody(RelationshipsExport body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostExternalcontactsRelationshipsExportsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<RelationshipsExport> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostExternalcontactsRelationshipsExportsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/externalcontacts/relationships/exports")
                .withBody(body)
	...
	public static Builder builder(RelationshipsExport body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostExternalcontactsRelationshipsExportsRequest request;

		private Builder() {
			request = new PostExternalcontactsRelationshipsExportsRequest();
		}


		public Builder withBody(RelationshipsExport body) {
		...
		public Builder withRequiredParams(RelationshipsExport body) {
			request.setBody(body);
		...
		public PostExternalcontactsRelationshipsExportsRequest build() {
