...
public class GetOrganizationsLimitsDocsFreetrialRequest {
    ...
    public GetOrganizationsLimitsDocsFreetrialRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/organizations/limits/docs/freetrial")
	...
	public static class Builder {
		private final GetOrganizationsLimitsDocsFreetrialRequest request;

		private Builder() {
			request = new GetOrganizationsLimitsDocsFreetrialRequest();
		}
		...
		public GetOrganizationsLimitsDocsFreetrialRequest build() {
