...
public class GetRoutingUserDirectroutingbackupSettingsRequest {
	...
	public GetRoutingUserDirectroutingbackupSettingsRequest withUserId(String userId) {
    ...
    public GetRoutingUserDirectroutingbackupSettingsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.userId == null) {
            throw new IllegalStateException("Missing the required parameter 'userId' when building request for GetRoutingUserDirectroutingbackupSettingsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/routing/users/{userId}/directroutingbackup/settings")
	...
	public static class Builder {
		private final GetRoutingUserDirectroutingbackupSettingsRequest request;

		private Builder() {
			request = new GetRoutingUserDirectroutingbackupSettingsRequest();
		}
		...
		public GetRoutingUserDirectroutingbackupSettingsRequest build() {
