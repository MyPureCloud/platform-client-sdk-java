...
public class GetGreetingDownloadsRequest {
	...
	public GetGreetingDownloadsRequest withGreetingId(String greetingId) {
	...
	public GetGreetingDownloadsRequest withFormatId(String formatId) {
    ...
    public GetGreetingDownloadsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.greetingId == null) {
            throw new IllegalStateException("Missing the required parameter 'greetingId' when building request for GetGreetingDownloadsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/greetings/{greetingId}/downloads")
	...
	public static class Builder {
		private final GetGreetingDownloadsRequest request;

		private Builder() {
			request = new GetGreetingDownloadsRequest();
		}
		...
		public GetGreetingDownloadsRequest build() {
