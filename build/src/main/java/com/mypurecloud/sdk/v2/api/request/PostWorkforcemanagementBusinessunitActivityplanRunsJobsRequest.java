...
public class PostWorkforcemanagementBusinessunitActivityplanRunsJobsRequest {
	...
	public PostWorkforcemanagementBusinessunitActivityplanRunsJobsRequest withBusinessUnitId(String businessUnitId) {
	...
	public PostWorkforcemanagementBusinessunitActivityplanRunsJobsRequest withActivityPlanId(String activityPlanId) {
    ...
    public PostWorkforcemanagementBusinessunitActivityplanRunsJobsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PostWorkforcemanagementBusinessunitActivityplanRunsJobsRequest.");
        }
        
        // verify the required parameter 'activityPlanId' is set
        if (this.activityPlanId == null) {
            throw new IllegalStateException("Missing the required parameter 'activityPlanId' when building request for PostWorkforcemanagementBusinessunitActivityplanRunsJobsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/activityplans/{activityPlanId}/runs/jobs")
	...
	public static Builder builder(String businessUnitId, String activityPlanId) {
	    return new Builder()
	            .withRequiredParams(businessUnitId, activityPlanId);
	}


	public static class Builder {
		private final PostWorkforcemanagementBusinessunitActivityplanRunsJobsRequest request;

		private Builder() {
			request = new PostWorkforcemanagementBusinessunitActivityplanRunsJobsRequest();
		}
		...
		public Builder withRequiredParams(String businessUnitId, String activityPlanId) {
			request.setBusinessUnitId(businessUnitId);
			request.setActivityPlanId(activityPlanId);
		...
		public PostWorkforcemanagementBusinessunitActivityplanRunsJobsRequest build() {
