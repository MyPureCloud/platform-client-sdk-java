...
public class PostAnalyticsTaskmanagementAggregatesQueryRequest {

	private TaskManagementAggregationQuery body;
	public TaskManagementAggregationQuery getBody() {
		return this.body;
	}

	public void setBody(TaskManagementAggregationQuery body) {
		this.body = body;
	}

	public PostAnalyticsTaskmanagementAggregatesQueryRequest withBody(TaskManagementAggregationQuery body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostAnalyticsTaskmanagementAggregatesQueryRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<TaskManagementAggregationQuery> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostAnalyticsTaskmanagementAggregatesQueryRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/analytics/taskmanagement/aggregates/query")
                .withBody(body)
	...
	public static Builder builder(TaskManagementAggregationQuery body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostAnalyticsTaskmanagementAggregatesQueryRequest request;

		private Builder() {
			request = new PostAnalyticsTaskmanagementAggregatesQueryRequest();
		}


		public Builder withBody(TaskManagementAggregationQuery body) {
		...
		public Builder withRequiredParams(TaskManagementAggregationQuery body) {
			request.setBody(body);
		...
		public PostAnalyticsTaskmanagementAggregatesQueryRequest build() {
