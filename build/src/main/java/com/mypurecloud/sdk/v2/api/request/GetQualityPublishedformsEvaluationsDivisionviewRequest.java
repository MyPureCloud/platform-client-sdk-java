...
public class GetQualityPublishedformsEvaluationsDivisionviewRequest {
	...
	public GetQualityPublishedformsEvaluationsDivisionviewRequest withEvaluationFormId(String evaluationFormId) {
	    this.setEvaluationFormId(evaluationFormId);
	    return this;
	} 
    ...
    public GetQualityPublishedformsEvaluationsDivisionviewRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.evaluationFormId == null) {
            throw new IllegalStateException("Missing the required parameter 'evaluationFormId' when building request for GetQualityPublishedformsEvaluationsDivisionviewRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/quality/publishedforms/evaluations/divisionviews/{evaluationFormId}")
                .withPathParameter("evaluationFormId", evaluationFormId)
	...
	public static Builder builder(String evaluationFormId) {
	    return new Builder()
	            .withRequiredParams(evaluationFormId);
	}


	public static class Builder {
		private final GetQualityPublishedformsEvaluationsDivisionviewRequest request;

		private Builder() {
			request = new GetQualityPublishedformsEvaluationsDivisionviewRequest();
		}


		public Builder withEvaluationFormId(String evaluationFormId) {
			request.setEvaluationFormId(evaluationFormId);
			return this;
		}



		public Builder withRequiredParams(String evaluationFormId) {
			request.setEvaluationFormId(evaluationFormId);
		...
		public GetQualityPublishedformsEvaluationsDivisionviewRequest build() {
            
            // verify the required parameter 'evaluationFormId' is set
            if (request.evaluationFormId == null) {
                throw new IllegalStateException("Missing the required parameter 'evaluationFormId' when building request for GetQualityPublishedformsEvaluationsDivisionviewRequest.");
            }
