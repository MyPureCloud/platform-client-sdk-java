...
public class BotAggregationView  implements Serializable {
 ...
 @JsonDeserialize(using = FunctionEnumDeserializer.class)
   ...
   * Target metric name
   **/
  public BotAggregationView target(TargetEnum target) {
    this.target = target;
    return this;
  }
   ...
   **/
  public BotAggregationView name(String name) {
    this.name = name;
    return this;
  }
   ...
   * Type of view you wish to create
   **/
  public BotAggregationView function(FunctionEnum function) {
   ...
   **/
  public BotAggregationView range(AggregationRange range) {
    this.range = range;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    BotAggregationView botAggregationView = (BotAggregationView) o;

    return Objects.equals(this.target, botAggregationView.target) &&
            Objects.equals(this.name, botAggregationView.name) &&
            Objects.equals(this.function, botAggregationView.function) &&
            Objects.equals(this.range, botAggregationView.range);
  }
