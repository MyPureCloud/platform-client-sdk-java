...
public class PutOutboundSchedulesWhatsappcampaignRequest {
	...
	private WhatsAppCampaignSchedule body;
	public WhatsAppCampaignSchedule getBody() {
		return this.body;
	}

	public void setBody(WhatsAppCampaignSchedule body) {
		this.body = body;
	}

	public PutOutboundSchedulesWhatsappcampaignRequest withBody(WhatsAppCampaignSchedule body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutOutboundSchedulesWhatsappcampaignRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<WhatsAppCampaignSchedule> withHttpInfo() {
        
        // verify the required parameter 'whatsAppCampaignId' is set
        if (this.whatsAppCampaignId == null) {
            throw new IllegalStateException("Missing the required parameter 'whatsAppCampaignId' when building request for PutOutboundSchedulesWhatsappcampaignRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutOutboundSchedulesWhatsappcampaignRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/outbound/schedules/whatsappcampaigns/{whatsAppCampaignId}")
	...
	public static Builder builder(String whatsAppCampaignId, WhatsAppCampaignSchedule body) {
	    return new Builder()
	            .withRequiredParams(whatsAppCampaignId, body);
	}


	public static class Builder {
		private final PutOutboundSchedulesWhatsappcampaignRequest request;

		private Builder() {
			request = new PutOutboundSchedulesWhatsappcampaignRequest();
		}
		...
		public Builder withBody(WhatsAppCampaignSchedule body) {
		...
		public Builder withRequiredParams(String whatsAppCampaignId, WhatsAppCampaignSchedule body) {
			request.setWhatsAppCampaignId(whatsAppCampaignId);
			request.setBody(body);
		...
		public PutOutboundSchedulesWhatsappcampaignRequest build() {
