...
import com.fasterxml.jackson.annotation.JsonValue;
import com.mypurecloud.sdk.v2.model.CaseManagementAggregateQueryFilter;
import com.mypurecloud.sdk.v2.model.CaseManagementAggregationView;
...
public class CaseManagementAsyncAggregationQuery  implements Serializable {
 ...
 @JsonDeserialize(using = GroupByEnumDeserializer.class)
  ...
  private CaseManagementAggregateQueryFilter filter = null;
 ...
 @JsonDeserialize(using = MetricsEnumDeserializer.class)
  ...
  private List<CaseManagementAggregationView> views = null;
 ...
 @JsonDeserialize(using = AlternateTimeDimensionEnumDeserializer.class)
  ...
  public CaseManagementAsyncAggregationQuery() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
      groupBy = new ArrayList<GroupByEnum>();
      metrics = new ArrayList<MetricsEnum>();
      views = new ArrayList<CaseManagementAggregationView>();
    }
  }

  public CaseManagementAsyncAggregationQuery(Boolean initWithEmptyList) {
   ...
   **/
  public CaseManagementAsyncAggregationQuery interval(String interval) {
   ...
   **/
  public CaseManagementAsyncAggregationQuery granularity(String granularity) {
   ...
   **/
  public CaseManagementAsyncAggregationQuery timeZone(String timeZone) {
   ...
   **/
  public CaseManagementAsyncAggregationQuery groupBy(List<GroupByEnum> groupBy) {
   ...
   **/
  public CaseManagementAsyncAggregationQuery filter(CaseManagementAggregateQueryFilter filter) {
    this.filter = filter;
    return this;
  }
  ...
  @JsonProperty("filter")
  public CaseManagementAggregateQueryFilter getFilter() {
    return filter;
  }
  public void setFilter(CaseManagementAggregateQueryFilter filter) {
    this.filter = filter;
  }
   ...
   **/
  public CaseManagementAsyncAggregationQuery metrics(List<MetricsEnum> metrics) {
   ...
   **/
  public CaseManagementAsyncAggregationQuery flattenMultivaluedDimensions(Boolean flattenMultivaluedDimensions) {
   ...
   **/
  public CaseManagementAsyncAggregationQuery views(List<CaseManagementAggregationView> views) {
    this.views = views;
    return this;
  }
  ...
  @JsonProperty("views")
  public List<CaseManagementAggregationView> getViews() {
    return views;
  }
  public void setViews(List<CaseManagementAggregationView> views) {
    this.views = views;
  }
   ...
   * Dimension to use as the alternative timestamp for data in the aggregate.  Choosing \"eventTime\" uses the actual time of the data event.
   **/
  public CaseManagementAsyncAggregationQuery alternateTimeDimension(AlternateTimeDimensionEnum alternateTimeDimension) {
   ...
   **/
  public CaseManagementAsyncAggregationQuery pageSize(Integer pageSize) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CaseManagementAsyncAggregationQuery caseManagementAsyncAggregationQuery = (CaseManagementAsyncAggregationQuery) o;

    return Objects.equals(this.interval, caseManagementAsyncAggregationQuery.interval) &&
            Objects.equals(this.granularity, caseManagementAsyncAggregationQuery.granularity) &&
            Objects.equals(this.timeZone, caseManagementAsyncAggregationQuery.timeZone) &&
            Objects.equals(this.groupBy, caseManagementAsyncAggregationQuery.groupBy) &&
            Objects.equals(this.filter, caseManagementAsyncAggregationQuery.filter) &&
            Objects.equals(this.metrics, caseManagementAsyncAggregationQuery.metrics) &&
            Objects.equals(this.flattenMultivaluedDimensions, caseManagementAsyncAggregationQuery.flattenMultivaluedDimensions) &&
            Objects.equals(this.views, caseManagementAsyncAggregationQuery.views) &&
            Objects.equals(this.alternateTimeDimension, caseManagementAsyncAggregationQuery.alternateTimeDimension) &&
            Objects.equals(this.pageSize, caseManagementAsyncAggregationQuery.pageSize);
  }
  ...
  public String toString() {
    ...
    sb.append("class CaseManagementAsyncAggregationQuery {\n");
