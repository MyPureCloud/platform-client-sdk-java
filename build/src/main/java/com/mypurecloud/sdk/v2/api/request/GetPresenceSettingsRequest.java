...
public class GetPresenceSettingsRequest {
    ...
    public GetPresenceSettingsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/presence/settings")
	...
	public static class Builder {
		private final GetPresenceSettingsRequest request;

		private Builder() {
			request = new GetPresenceSettingsRequest();
		}
		...
		public GetPresenceSettingsRequest build() {
