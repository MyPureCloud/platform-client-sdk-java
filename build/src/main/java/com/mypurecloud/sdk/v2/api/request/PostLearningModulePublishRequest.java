...
public class PostLearningModulePublishRequest {
	...
	public PostLearningModulePublishRequest withModuleId(String moduleId) {
    ...
    public PostLearningModulePublishRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.moduleId == null) {
            throw new IllegalStateException("Missing the required parameter 'moduleId' when building request for PostLearningModulePublishRequest.");
        }
	...
	public static class Builder {
		private final PostLearningModulePublishRequest request;

		private Builder() {
			request = new PostLearningModulePublishRequest();
		}
		...
		public PostLearningModulePublishRequest build() {
