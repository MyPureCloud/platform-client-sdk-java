...
public class AssessmentJobListing  implements Serializable {
  ...
  /**
   **/
  public AssessmentJobListing total(Long total) {
    this.total = total;
    return this;
  }
  ...
  public List<BenefitAssessmentJob> getEntities() {
    return entities;
  }
  public void setEntities(List<BenefitAssessmentJob> entities) {
    this.entities = entities;
  }
