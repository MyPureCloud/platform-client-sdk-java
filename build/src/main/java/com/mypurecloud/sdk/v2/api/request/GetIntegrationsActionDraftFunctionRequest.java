...
public class GetIntegrationsActionDraftFunctionRequest {
	...
	public GetIntegrationsActionDraftFunctionRequest withActionId(String actionId) {
    ...
    public GetIntegrationsActionDraftFunctionRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.actionId == null) {
            throw new IllegalStateException("Missing the required parameter 'actionId' when building request for GetIntegrationsActionDraftFunctionRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/integrations/actions/{actionId}/draft/function")
	...
	public static class Builder {
		private final GetIntegrationsActionDraftFunctionRequest request;

		private Builder() {
			request = new GetIntegrationsActionDraftFunctionRequest();
		}
		...
		public GetIntegrationsActionDraftFunctionRequest build() {
