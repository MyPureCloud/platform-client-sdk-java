...
public class PostTelephonyProvidersEdgesOutboundroutesRequest {
	...
	public PostTelephonyProvidersEdgesOutboundroutesRequest withBody(OutboundRoute body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostTelephonyProvidersEdgesOutboundroutesRequest withCustomHeader(String name, String value) {
