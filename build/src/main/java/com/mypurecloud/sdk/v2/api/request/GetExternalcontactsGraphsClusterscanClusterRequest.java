...
public class GetExternalcontactsGraphsClusterscanClusterRequest {
	...
	public GetExternalcontactsGraphsClusterscanClusterRequest withScanId(String scanId) {
	...
	public GetExternalcontactsGraphsClusterscanClusterRequest withClusterId(String clusterId) {
    ...
    public GetExternalcontactsGraphsClusterscanClusterRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.scanId == null) {
            throw new IllegalStateException("Missing the required parameter 'scanId' when building request for GetExternalcontactsGraphsClusterscanClusterRequest.");
        }
        
        // verify the required parameter 'clusterId' is set
        if (this.clusterId == null) {
            throw new IllegalStateException("Missing the required parameter 'clusterId' when building request for GetExternalcontactsGraphsClusterscanClusterRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/externalcontacts/graphs/clusterscans/{scanId}/clusters/{clusterId}")
	...
	public static class Builder {
		private final GetExternalcontactsGraphsClusterscanClusterRequest request;

		private Builder() {
			request = new GetExternalcontactsGraphsClusterscanClusterRequest();
		}
		...
		public GetExternalcontactsGraphsClusterscanClusterRequest build() {
