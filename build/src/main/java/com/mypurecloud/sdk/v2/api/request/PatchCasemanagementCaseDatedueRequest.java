...
public class PatchCasemanagementCaseDatedueRequest {
	...
	public PatchCasemanagementCaseDatedueRequest withCaseId(String caseId) {
	    this.setCaseId(caseId);
	    return this;
	} 

	private CaseDateDueUpdate body;
	public CaseDateDueUpdate getBody() {
		return this.body;
	}

	public void setBody(CaseDateDueUpdate body) {
		this.body = body;
	}

	public PatchCasemanagementCaseDatedueRequest withBody(CaseDateDueUpdate body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchCasemanagementCaseDatedueRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<CaseDateDueUpdate> withHttpInfo() {
        
        // verify the required parameter 'caseId' is set
        if (this.caseId == null) {
            throw new IllegalStateException("Missing the required parameter 'caseId' when building request for PatchCasemanagementCaseDatedueRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchCasemanagementCaseDatedueRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/casemanagement/cases/{caseId}/datedue")
	...
	public static Builder builder(String caseId, CaseDateDueUpdate body) {
	    return new Builder()
	...
	public static class Builder {
		private final PatchCasemanagementCaseDatedueRequest request;

		private Builder() {
			request = new PatchCasemanagementCaseDatedueRequest();
		}
		...
		public Builder withBody(CaseDateDueUpdate body) {
		...
		public Builder withRequiredParams(String caseId, CaseDateDueUpdate body) {
			request.setCaseId(caseId);
			request.setBody(body);
		...
		public PatchCasemanagementCaseDatedueRequest build() {
