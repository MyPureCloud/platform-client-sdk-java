...
public class GetConversationsCustomattributesSchemasCoretypeRequest {
	...
	public GetConversationsCustomattributesSchemasCoretypeRequest withCoreTypeName(String coreTypeName) {
    ...
    public GetConversationsCustomattributesSchemasCoretypeRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.coreTypeName == null) {
            throw new IllegalStateException("Missing the required parameter 'coreTypeName' when building request for GetConversationsCustomattributesSchemasCoretypeRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/conversations/customattributes/schemas/coretypes/{coreTypeName}")
	...
	public static class Builder {
		private final GetConversationsCustomattributesSchemasCoretypeRequest request;

		private Builder() {
			request = new GetConversationsCustomattributesSchemasCoretypeRequest();
		}
		...
		public GetConversationsCustomattributesSchemasCoretypeRequest build() {
