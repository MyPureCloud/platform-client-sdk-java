...
public class GetOutboundMessagingcampaignDiagnosticsRequest {
	...
	public GetOutboundMessagingcampaignDiagnosticsRequest withMessagingCampaignId(String messagingCampaignId) {
    ...
    public GetOutboundMessagingcampaignDiagnosticsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.messagingCampaignId == null) {
            throw new IllegalStateException("Missing the required parameter 'messagingCampaignId' when building request for GetOutboundMessagingcampaignDiagnosticsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/outbound/messagingcampaigns/{messagingCampaignId}/diagnostics")
	...
	public static class Builder {
		private final GetOutboundMessagingcampaignDiagnosticsRequest request;

		private Builder() {
			request = new GetOutboundMessagingcampaignDiagnosticsRequest();
		}
		...
		public GetOutboundMessagingcampaignDiagnosticsRequest build() {
