...
public class PostWorkforcemanagementBusinessunitTimeofflimitsRequest {
	...
	public PostWorkforcemanagementBusinessunitTimeofflimitsRequest withBusinessUnitId(String businessUnitId) {
	    this.setBusinessUnitId(businessUnitId);
	    return this;
	} 

	private BuCreateTimeOffLimitRequest body;
	public BuCreateTimeOffLimitRequest getBody() {
		return this.body;
	}

	public void setBody(BuCreateTimeOffLimitRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementBusinessunitTimeofflimitsRequest withBody(BuCreateTimeOffLimitRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementBusinessunitTimeofflimitsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<BuCreateTimeOffLimitRequest> withHttpInfo() {
        
        // verify the required parameter 'businessUnitId' is set
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PostWorkforcemanagementBusinessunitTimeofflimitsRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementBusinessunitTimeofflimitsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/timeofflimits")
	...
	public static Builder builder(String businessUnitId, BuCreateTimeOffLimitRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementBusinessunitTimeofflimitsRequest request;

		private Builder() {
			request = new PostWorkforcemanagementBusinessunitTimeofflimitsRequest();
		}
		...
		public Builder withBody(BuCreateTimeOffLimitRequest body) {
		...
		public Builder withRequiredParams(String businessUnitId, BuCreateTimeOffLimitRequest body) {
			request.setBusinessUnitId(businessUnitId);
			request.setBody(body);
		...
		public PostWorkforcemanagementBusinessunitTimeofflimitsRequest build() {
