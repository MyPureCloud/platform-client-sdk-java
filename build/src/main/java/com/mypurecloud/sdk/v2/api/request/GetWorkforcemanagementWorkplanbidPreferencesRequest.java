...
public class GetWorkforcemanagementWorkplanbidPreferencesRequest {
	...
	public GetWorkforcemanagementWorkplanbidPreferencesRequest withBidId(String bidId) {
	    this.setBidId(bidId);
	    return this;
	} 
    ...
    public GetWorkforcemanagementWorkplanbidPreferencesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.bidId == null) {
            throw new IllegalStateException("Missing the required parameter 'bidId' when building request for GetWorkforcemanagementWorkplanbidPreferencesRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/workplanbids/{bidId}/preferences")
	...
	public static class Builder {
		private final GetWorkforcemanagementWorkplanbidPreferencesRequest request;

		private Builder() {
			request = new GetWorkforcemanagementWorkplanbidPreferencesRequest();
		}
		...
		public GetWorkforcemanagementWorkplanbidPreferencesRequest build() {
