...
public class GetRoutingAvailablemediatypesRequest {
    ...
    public GetRoutingAvailablemediatypesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/routing/availablemediatypes")
	...
	public static class Builder {
		private final GetRoutingAvailablemediatypesRequest request;

		private Builder() {
			request = new GetRoutingAvailablemediatypesRequest();
		}
		...
		public GetRoutingAvailablemediatypesRequest build() {
