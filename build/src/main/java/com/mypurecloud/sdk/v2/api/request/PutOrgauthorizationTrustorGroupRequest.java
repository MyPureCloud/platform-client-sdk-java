...
public class PutOrgauthorizationTrustorGroupRequest {
	...
	public PutOrgauthorizationTrustorGroupRequest withTrustorOrgId(String trustorOrgId) {
	...
	public PutOrgauthorizationTrustorGroupRequest withTrustorGroupId(String trustorGroupId) {
    ...
    public PutOrgauthorizationTrustorGroupRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.trustorOrgId == null) {
            throw new IllegalStateException("Missing the required parameter 'trustorOrgId' when building request for PutOrgauthorizationTrustorGroupRequest.");
        }
        
        // verify the required parameter 'trustorGroupId' is set
        if (this.trustorGroupId == null) {
            throw new IllegalStateException("Missing the required parameter 'trustorGroupId' when building request for PutOrgauthorizationTrustorGroupRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/orgauthorization/trustors/{trustorOrgId}/groups/{trustorGroupId}")
	...
	public static class Builder {
		private final PutOrgauthorizationTrustorGroupRequest request;

		private Builder() {
			request = new PutOrgauthorizationTrustorGroupRequest();
		}
		...
		public PutOrgauthorizationTrustorGroupRequest build() {
