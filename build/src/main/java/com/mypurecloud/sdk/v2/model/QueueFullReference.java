...
public class QueueFullReference  implements Serializable {
 ...
 @JsonDeserialize(using = SkillEvaluationMethodEnumDeserializer.class)
  ...
  public QueueFullReference(Boolean initWithEmptyList) {
   ...
   **/
  public QueueFullReference id(String id) {
    this.id = id;
    return this;
  }
  ...
  /**
   **/
  public QueueFullReference name(String name) {
    this.name = name;
    return this;
  }
   ...
   **/
  public QueueFullReference division(Division division) {
   ...
   **/
  public QueueFullReference description(String description) {
   ...
   **/
  public QueueFullReference dateCreated(Date dateCreated) {
   ...
   **/
  public QueueFullReference dateModified(Date dateModified) {
   ...
   **/
  public QueueFullReference modifiedBy(String modifiedBy) {
   ...
   **/
  public QueueFullReference createdBy(String createdBy) {
   ...
   **/
  public QueueFullReference mediaSettings(QueueMediaSettings mediaSettings) {
   ...
   **/
  public QueueFullReference routingRules(List<RoutingRule> routingRules) {
   ...
   **/
  public QueueFullReference conditionalGroupRouting(ConditionalGroupRouting conditionalGroupRouting) {
   ...
   **/
  public QueueFullReference conditionalGroupActivation(ConditionalGroupActivation conditionalGroupActivation) {
   ...
   **/
  public QueueFullReference bullseye(Bullseye bullseye) {
   ...
   * The Scoring Method for the queue.
   **/
  public QueueFullReference scoringMethod(ScoringMethodEnum scoringMethod) {
   ...
   * The Last Agent Routing Mode for the queue.
   **/
  public QueueFullReference lastAgentRoutingMode(LastAgentRoutingModeEnum lastAgentRoutingMode) {
   ...
   **/
  public QueueFullReference acwSettings(AcwSettings acwSettings) {
   ...
   * The skill evaluation method to use when routing conversations.
   **/
  public QueueFullReference skillEvaluationMethod(SkillEvaluationMethodEnum skillEvaluationMethod) {
   ...
   **/
  public QueueFullReference memberGroups(List<MemberGroup> memberGroups) {
   ...
   **/
  public QueueFullReference queueFlow(DomainEntityRef queueFlow) {
   ...
   **/
  public QueueFullReference emailInQueueFlow(DomainEntityRef emailInQueueFlow) {
   ...
   **/
  public QueueFullReference messageInQueueFlow(DomainEntityRef messageInQueueFlow) {
   ...
   **/
  public QueueFullReference whisperPrompt(DomainEntityRef whisperPrompt) {
   ...
   **/
  public QueueFullReference onHoldPrompt(DomainEntityRef onHoldPrompt) {
   ...
   **/
  public QueueFullReference defaultMediaLanguage(String defaultMediaLanguage) {
   ...
   **/
  public QueueFullReference autoAnswerOnly(Boolean autoAnswerOnly) {
   ...
   **/
  public QueueFullReference cannedResponseLibraries(CannedResponseLibraries cannedResponseLibraries) {
   ...
   **/
  public QueueFullReference enableTranscription(Boolean enableTranscription) {
   ...
   **/
  public QueueFullReference enableAudioMonitoring(Boolean enableAudioMonitoring) {
   ...
   **/
  public QueueFullReference enableManualAssignment(Boolean enableManualAssignment) {
   ...
   **/
  public QueueFullReference agentOwnedRouting(AgentOwnedRouting agentOwnedRouting) {
   ...
   **/
  public QueueFullReference directRouting(DirectRouting directRouting) {
   ...
   **/
  public QueueFullReference callingPartyName(String callingPartyName) {
   ...
   **/
  public QueueFullReference callingPartyNumber(String callingPartyNumber) {
   ...
   **/
  public QueueFullReference defaultScripts(Map<String, Script> defaultScripts) {
   ...
   **/
  public QueueFullReference outboundMessagingAddresses(QueueMessagingAddresses outboundMessagingAddresses) {
   ...
   **/
  public QueueFullReference outboundEmailAddress(QueueEmailAddress outboundEmailAddress) {
   ...
   **/
  public QueueFullReference peerId(String peerId) {
    this.peerId = peerId;
    return this;
  }
   ...
   **/
  public QueueFullReference suppressInQueueCallRecording(Boolean suppressInQueueCallRecording) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    QueueFullReference queueFullReference = (QueueFullReference) o;

    return Objects.equals(this.id, queueFullReference.id) &&
            Objects.equals(this.name, queueFullReference.name) &&
            Objects.equals(this.division, queueFullReference.division) &&
            Objects.equals(this.description, queueFullReference.description) &&
            Objects.equals(this.dateCreated, queueFullReference.dateCreated) &&
            Objects.equals(this.dateModified, queueFullReference.dateModified) &&
            Objects.equals(this.modifiedBy, queueFullReference.modifiedBy) &&
            Objects.equals(this.createdBy, queueFullReference.createdBy) &&
            Objects.equals(this.memberCount, queueFullReference.memberCount) &&
            Objects.equals(this.userMemberCount, queueFullReference.userMemberCount) &&
            Objects.equals(this.joinedMemberCount, queueFullReference.joinedMemberCount) &&
            Objects.equals(this.mediaSettings, queueFullReference.mediaSettings) &&
            Objects.equals(this.routingRules, queueFullReference.routingRules) &&
            Objects.equals(this.conditionalGroupRouting, queueFullReference.conditionalGroupRouting) &&
            Objects.equals(this.conditionalGroupActivation, queueFullReference.conditionalGroupActivation) &&
            Objects.equals(this.bullseye, queueFullReference.bullseye) &&
            Objects.equals(this.scoringMethod, queueFullReference.scoringMethod) &&
            Objects.equals(this.lastAgentRoutingMode, queueFullReference.lastAgentRoutingMode) &&
            Objects.equals(this.acwSettings, queueFullReference.acwSettings) &&
            Objects.equals(this.skillEvaluationMethod, queueFullReference.skillEvaluationMethod) &&
            Objects.equals(this.memberGroups, queueFullReference.memberGroups) &&
            Objects.equals(this.queueFlow, queueFullReference.queueFlow) &&
            Objects.equals(this.emailInQueueFlow, queueFullReference.emailInQueueFlow) &&
            Objects.equals(this.messageInQueueFlow, queueFullReference.messageInQueueFlow) &&
            Objects.equals(this.whisperPrompt, queueFullReference.whisperPrompt) &&
            Objects.equals(this.onHoldPrompt, queueFullReference.onHoldPrompt) &&
            Objects.equals(this.defaultMediaLanguage, queueFullReference.defaultMediaLanguage) &&
            Objects.equals(this.autoAnswerOnly, queueFullReference.autoAnswerOnly) &&
            Objects.equals(this.cannedResponseLibraries, queueFullReference.cannedResponseLibraries) &&
            Objects.equals(this.enableTranscription, queueFullReference.enableTranscription) &&
            Objects.equals(this.enableAudioMonitoring, queueFullReference.enableAudioMonitoring) &&
            Objects.equals(this.enableManualAssignment, queueFullReference.enableManualAssignment) &&
            Objects.equals(this.agentOwnedRouting, queueFullReference.agentOwnedRouting) &&
            Objects.equals(this.directRouting, queueFullReference.directRouting) &&
            Objects.equals(this.callingPartyName, queueFullReference.callingPartyName) &&
            Objects.equals(this.callingPartyNumber, queueFullReference.callingPartyNumber) &&
            Objects.equals(this.defaultScripts, queueFullReference.defaultScripts) &&
            Objects.equals(this.outboundMessagingAddresses, queueFullReference.outboundMessagingAddresses) &&
            Objects.equals(this.outboundEmailAddress, queueFullReference.outboundEmailAddress) &&
            Objects.equals(this.peerId, queueFullReference.peerId) &&
            Objects.equals(this.suppressInQueueCallRecording, queueFullReference.suppressInQueueCallRecording) &&
            Objects.equals(this.selfUri, queueFullReference.selfUri);
  }
