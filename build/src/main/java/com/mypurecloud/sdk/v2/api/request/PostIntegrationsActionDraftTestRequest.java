...
public class PostIntegrationsActionDraftTestRequest {
	...
	public PostIntegrationsActionDraftTestRequest withActionId(String actionId) {
	...
	public PostIntegrationsActionDraftTestRequest withBody(Object body) {
	    this.setBody(body);
	    return this;
	} 
	...
	public PostIntegrationsActionDraftTestRequest withFlatten(Boolean flatten) {
    ...
    public PostIntegrationsActionDraftTestRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Object> withHttpInfo() {
        ...
        if (this.actionId == null) {
            throw new IllegalStateException("Missing the required parameter 'actionId' when building request for PostIntegrationsActionDraftTestRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostIntegrationsActionDraftTestRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/integrations/actions/{actionId}/draft/test")
	...
	public static class Builder {
		private final PostIntegrationsActionDraftTestRequest request;

		private Builder() {
			request = new PostIntegrationsActionDraftTestRequest();
		}
		...
		public PostIntegrationsActionDraftTestRequest build() {
