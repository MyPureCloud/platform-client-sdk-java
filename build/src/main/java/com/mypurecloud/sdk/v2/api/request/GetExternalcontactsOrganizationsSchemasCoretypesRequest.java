...
public class GetExternalcontactsOrganizationsSchemasCoretypesRequest {
    ...
    public GetExternalcontactsOrganizationsSchemasCoretypesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/externalcontacts/organizations/schemas/coretypes")
	...
	public static class Builder {
		private final GetExternalcontactsOrganizationsSchemasCoretypesRequest request;

		private Builder() {
			request = new GetExternalcontactsOrganizationsSchemasCoretypesRequest();
		}
		...
		public GetExternalcontactsOrganizationsSchemasCoretypesRequest build() {
