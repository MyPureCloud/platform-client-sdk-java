...
public class PutCasemanagementCaseplanIntakesettingsRequest {
	...
	public PutCasemanagementCaseplanIntakesettingsRequest withCaseplanId(String caseplanId) {
	    this.setCaseplanId(caseplanId);
	    return this;
	} 

	private IntakeSettingsUpdate body;
	public IntakeSettingsUpdate getBody() {
		return this.body;
	}

	public void setBody(IntakeSettingsUpdate body) {
		this.body = body;
	}

	public PutCasemanagementCaseplanIntakesettingsRequest withBody(IntakeSettingsUpdate body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutCasemanagementCaseplanIntakesettingsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<IntakeSettingsUpdate> withHttpInfo() {
        
        // verify the required parameter 'caseplanId' is set
        if (this.caseplanId == null) {
            throw new IllegalStateException("Missing the required parameter 'caseplanId' when building request for PutCasemanagementCaseplanIntakesettingsRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutCasemanagementCaseplanIntakesettingsRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/casemanagement/caseplans/{caseplanId}/intakesettings")
	...
	public static Builder builder(String caseplanId, IntakeSettingsUpdate body) {
	    return new Builder()
	...
	public static class Builder {
		private final PutCasemanagementCaseplanIntakesettingsRequest request;

		private Builder() {
			request = new PutCasemanagementCaseplanIntakesettingsRequest();
		}
		...
		public Builder withBody(IntakeSettingsUpdate body) {
		...
		public Builder withRequiredParams(String caseplanId, IntakeSettingsUpdate body) {
			request.setCaseplanId(caseplanId);
			request.setBody(body);
		...
		public PutCasemanagementCaseplanIntakesettingsRequest build() {
