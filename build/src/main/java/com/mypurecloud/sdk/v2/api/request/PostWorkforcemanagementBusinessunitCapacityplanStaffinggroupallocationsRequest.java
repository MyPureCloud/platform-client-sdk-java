...
public class PostWorkforcemanagementBusinessunitCapacityplanStaffinggroupallocationsRequest {
	...
	public PostWorkforcemanagementBusinessunitCapacityplanStaffinggroupallocationsRequest withBusinessUnitId(String businessUnitId) {
	...
	public PostWorkforcemanagementBusinessunitCapacityplanStaffinggroupallocationsRequest withCapacityPlanId(String capacityPlanId) {
	    this.setCapacityPlanId(capacityPlanId);
	    return this;
	} 

	private CreateCapacityPlanStaffingGroupMetricChangeRequest body;
	public CreateCapacityPlanStaffingGroupMetricChangeRequest getBody() {
		return this.body;
	}

	public void setBody(CreateCapacityPlanStaffingGroupMetricChangeRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementBusinessunitCapacityplanStaffinggroupallocationsRequest withBody(CreateCapacityPlanStaffingGroupMetricChangeRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementBusinessunitCapacityplanStaffinggroupallocationsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<CreateCapacityPlanStaffingGroupMetricChangeRequest> withHttpInfo() {
        
        // verify the required parameter 'businessUnitId' is set
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PostWorkforcemanagementBusinessunitCapacityplanStaffinggroupallocationsRequest.");
        }
        
        // verify the required parameter 'capacityPlanId' is set
        if (this.capacityPlanId == null) {
            throw new IllegalStateException("Missing the required parameter 'capacityPlanId' when building request for PostWorkforcemanagementBusinessunitCapacityplanStaffinggroupallocationsRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementBusinessunitCapacityplanStaffinggroupallocationsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/capacityplans/{capacityPlanId}/staffinggroupallocations")
	...
	public static Builder builder(String businessUnitId, String capacityPlanId, CreateCapacityPlanStaffingGroupMetricChangeRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementBusinessunitCapacityplanStaffinggroupallocationsRequest request;

		private Builder() {
			request = new PostWorkforcemanagementBusinessunitCapacityplanStaffinggroupallocationsRequest();
		}
		...
		public Builder withBody(CreateCapacityPlanStaffingGroupMetricChangeRequest body) {
		...
		public Builder withRequiredParams(String businessUnitId, String capacityPlanId, CreateCapacityPlanStaffingGroupMetricChangeRequest body) {
			request.setBusinessUnitId(businessUnitId);
			request.setCapacityPlanId(capacityPlanId);
			request.setBody(body);
		...
		public PostWorkforcemanagementBusinessunitCapacityplanStaffinggroupallocationsRequest build() {
