...
public class DeleteScimV2UserRequest {
	...
	public DeleteScimV2UserRequest withUserId(String userId) {
	...
	public DeleteScimV2UserRequest withIfMatch(String ifMatch) {
    ...
    public DeleteScimV2UserRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.userId == null) {
            throw new IllegalStateException("Missing the required parameter 'userId' when building request for DeleteScimV2UserRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/scim/v2/users/{userId}")
	...
	public static class Builder {
		private final DeleteScimV2UserRequest request;

		private Builder() {
			request = new DeleteScimV2UserRequest();
		}
		...
		public DeleteScimV2UserRequest build() {
