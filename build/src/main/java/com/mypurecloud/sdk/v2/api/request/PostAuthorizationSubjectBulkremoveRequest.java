...
public class PostAuthorizationSubjectBulkremoveRequest {
	...
	public PostAuthorizationSubjectBulkremoveRequest withSubjectId(String subjectId) {
	...
	public PostAuthorizationSubjectBulkremoveRequest withBody(RoleDivisionGrants body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostAuthorizationSubjectBulkremoveRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<RoleDivisionGrants> withHttpInfo() {
        ...
        if (this.subjectId == null) {
            throw new IllegalStateException("Missing the required parameter 'subjectId' when building request for PostAuthorizationSubjectBulkremoveRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostAuthorizationSubjectBulkremoveRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/authorization/subjects/{subjectId}/bulkremove")
	...
	public static class Builder {
		private final PostAuthorizationSubjectBulkremoveRequest request;

		private Builder() {
			request = new PostAuthorizationSubjectBulkremoveRequest();
		}
		...
		public PostAuthorizationSubjectBulkremoveRequest build() {
