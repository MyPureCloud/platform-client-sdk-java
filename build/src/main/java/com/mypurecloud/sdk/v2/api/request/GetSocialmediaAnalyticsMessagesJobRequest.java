...
public class GetSocialmediaAnalyticsMessagesJobRequest {
	...
	public GetSocialmediaAnalyticsMessagesJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetSocialmediaAnalyticsMessagesJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetSocialmediaAnalyticsMessagesJobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/socialmedia/analytics/messages/jobs/{jobId}")
	...
	public static class Builder {
		private final GetSocialmediaAnalyticsMessagesJobRequest request;

		private Builder() {
			request = new GetSocialmediaAnalyticsMessagesJobRequest();
		}
		...
		public GetSocialmediaAnalyticsMessagesJobRequest build() {
