...
public class GetWorkforcemanagementShifttradingTradeMatchJobRequest {
	...
	public GetWorkforcemanagementShifttradingTradeMatchJobRequest withTradeId(String tradeId) {
	...
	public GetWorkforcemanagementShifttradingTradeMatchJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetWorkforcemanagementShifttradingTradeMatchJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.tradeId == null) {
            throw new IllegalStateException("Missing the required parameter 'tradeId' when building request for GetWorkforcemanagementShifttradingTradeMatchJobRequest.");
        }
        
        // verify the required parameter 'jobId' is set
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetWorkforcemanagementShifttradingTradeMatchJobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/shifttrading/trades/{tradeId}/match/jobs/{jobId}")
	...
	public static Builder builder(String tradeId, String jobId) {
	    return new Builder()
	            .withRequiredParams(tradeId, jobId);
	}


	public static class Builder {
		private final GetWorkforcemanagementShifttradingTradeMatchJobRequest request;

		private Builder() {
			request = new GetWorkforcemanagementShifttradingTradeMatchJobRequest();
		}
		...
		public Builder withRequiredParams(String tradeId, String jobId) {
			request.setTradeId(tradeId);
			request.setJobId(jobId);
		...
		public GetWorkforcemanagementShifttradingTradeMatchJobRequest build() {
