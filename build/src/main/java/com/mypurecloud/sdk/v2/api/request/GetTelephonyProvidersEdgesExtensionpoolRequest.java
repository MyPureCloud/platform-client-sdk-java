...
public class GetTelephonyProvidersEdgesExtensionpoolRequest {
	...
	public GetTelephonyProvidersEdgesExtensionpoolRequest withExtensionPoolId(String extensionPoolId) {
    ...
    public GetTelephonyProvidersEdgesExtensionpoolRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.extensionPoolId == null) {
            throw new IllegalStateException("Missing the required parameter 'extensionPoolId' when building request for GetTelephonyProvidersEdgesExtensionpoolRequest.");
        }
