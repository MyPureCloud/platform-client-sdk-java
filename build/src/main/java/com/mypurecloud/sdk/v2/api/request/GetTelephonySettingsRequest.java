...
public class GetTelephonySettingsRequest {
    ...
    public GetTelephonySettingsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/telephony/settings")
	...
	public static class Builder {
		private final GetTelephonySettingsRequest request;

		private Builder() {
			request = new GetTelephonySettingsRequest();
		}
		...
		public GetTelephonySettingsRequest build() {
