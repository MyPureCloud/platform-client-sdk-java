...
public class PatchExternalcontactsOrganizationIdentifiersRequest {
	...
	private ExternalOrganizationIdentifierClaimRequest body;
	public ExternalOrganizationIdentifierClaimRequest getBody() {
		return this.body;
	}

	public void setBody(ExternalOrganizationIdentifierClaimRequest body) {
		this.body = body;
	}

	public PatchExternalcontactsOrganizationIdentifiersRequest withBody(ExternalOrganizationIdentifierClaimRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public ApiRequest<ExternalOrganizationIdentifierClaimRequest> withHttpInfo() {
        
        // verify the required parameter 'externalOrganizationId' is set
        if (this.externalOrganizationId == null) {
            throw new IllegalStateException("Missing the required parameter 'externalOrganizationId' when building request for PatchExternalcontactsOrganizationIdentifiersRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchExternalcontactsOrganizationIdentifiersRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/externalcontacts/organizations/{externalOrganizationId}/identifiers")
	...
	public static Builder builder(String externalOrganizationId, ExternalOrganizationIdentifierClaimRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PatchExternalcontactsOrganizationIdentifiersRequest request;

		private Builder() {
			request = new PatchExternalcontactsOrganizationIdentifiersRequest();
		}
		...
		public Builder withBody(ExternalOrganizationIdentifierClaimRequest body) {
		...
		public Builder withRequiredParams(String externalOrganizationId, ExternalOrganizationIdentifierClaimRequest body) {
			request.setExternalOrganizationId(externalOrganizationId);
			request.setBody(body);
		...
		public PatchExternalcontactsOrganizationIdentifiersRequest build() {
