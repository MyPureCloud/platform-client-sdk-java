...
public class DeleteWorkforcemanagementBusinessunitCapacityplanStaffinggroupallocationshistoryRequest {
	...
	private LocalDate beforeDateId;
	public LocalDate getBeforeDateId() {
		return this.beforeDateId;
	}

	public void setBeforeDateId(LocalDate beforeDateId) {
		this.beforeDateId = beforeDateId;
	}
	...
	public DeleteWorkforcemanagementBusinessunitCapacityplanStaffinggroupallocationshistoryRequest withBeforeDateId(LocalDate beforeDateId) {
	    this.setBeforeDateId(beforeDateId);
	    return this;
	} 
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for DeleteWorkforcemanagementBusinessunitCapacityplanStaffinggroupallocationshistoryRequest.");
        }
        
        // verify the required parameter 'capacityPlanId' is set
        if (this.capacityPlanId == null) {
            throw new IllegalStateException("Missing the required parameter 'capacityPlanId' when building request for DeleteWorkforcemanagementBusinessunitCapacityplanStaffinggroupallocationshistoryRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/capacityplans/{capacityPlanId}/staffinggroupallocationshistory")
                .withPathParameter("businessUnitId", businessUnitId)
        
                .withPathParameter("capacityPlanId", capacityPlanId)
        

                .withQueryParameters("beforeDateId", "", beforeDateId)
	...
	public static class Builder {
		private final DeleteWorkforcemanagementBusinessunitCapacityplanStaffinggroupallocationshistoryRequest request;

		private Builder() {
			request = new DeleteWorkforcemanagementBusinessunitCapacityplanStaffinggroupallocationshistoryRequest();
		}
		...
		public Builder withBeforeDateId(LocalDate beforeDateId) {
			request.setBeforeDateId(beforeDateId);
			return this;
		}
		...
		public DeleteWorkforcemanagementBusinessunitCapacityplanStaffinggroupallocationshistoryRequest build() {
