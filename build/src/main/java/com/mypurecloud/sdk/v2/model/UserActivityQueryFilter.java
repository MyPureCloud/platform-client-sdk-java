...
public class UserActivityQueryFilter  implements Serializable {
 ...
 @JsonDeserialize(using = TypeEnumDeserializer.class)
  ...
  private List<UserActivityQueryClause> clauses = new ArrayList<UserActivityQueryClause>();
  private List<UserActivityQueryPredicate> predicates = new ArrayList<UserActivityQueryPredicate>();
