...
public class AssessmentListing  implements Serializable {
  ...
  /**
   **/
  public AssessmentListing entities(List<BenefitAssessment> entities) {
  ...
  public List<BenefitAssessment> getEntities() {
    return entities;
  }
  public void setEntities(List<BenefitAssessment> entities) {
    this.entities = entities;
  }
