...
public class PostWorkforcemanagementTimeoffrequestsIntegrationstatusQueryRequest {

	private CurrentUserTimeOffIntegrationStatusRequest body;
	public CurrentUserTimeOffIntegrationStatusRequest getBody() {
		return this.body;
	}

	public void setBody(CurrentUserTimeOffIntegrationStatusRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementTimeoffrequestsIntegrationstatusQueryRequest withBody(CurrentUserTimeOffIntegrationStatusRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementTimeoffrequestsIntegrationstatusQueryRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<CurrentUserTimeOffIntegrationStatusRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementTimeoffrequestsIntegrationstatusQueryRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/timeoffrequests/integrationstatus/query")
                .withBody(body)
	...
	public static Builder builder(CurrentUserTimeOffIntegrationStatusRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementTimeoffrequestsIntegrationstatusQueryRequest request;

		private Builder() {
			request = new PostWorkforcemanagementTimeoffrequestsIntegrationstatusQueryRequest();
		}


		public Builder withBody(CurrentUserTimeOffIntegrationStatusRequest body) {
		...
		public Builder withRequiredParams(CurrentUserTimeOffIntegrationStatusRequest body) {
			request.setBody(body);
		...
		public PostWorkforcemanagementTimeoffrequestsIntegrationstatusQueryRequest build() {
