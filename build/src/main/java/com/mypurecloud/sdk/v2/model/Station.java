...
public class Station  implements Serializable {
 ...
 @JsonDeserialize(using = StatusEnumDeserializer.class)
  ...
  @JsonProperty("webRtcRequireMediaHelper")
  public Boolean getWebRtcRequireMediaHelper() {
    return webRtcRequireMediaHelper;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, station.id) &&
            ...
            Objects.equals(this.webRtcRequireMediaHelper, station.webRtcRequireMediaHelper) &&
            Objects.equals(this.selfUri, station.selfUri);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, description, status, userId, webRtcUserId, primaryEdge, secondaryEdge, type, lineAppearanceId, webRtcMediaDscp, webRtcPersistentEnabled, webRtcForceTurn, webRtcCallAppearances, webRtcRequireMediaHelper, selfUri);
  }
  ...
  public String toString() {
    ...
    sb.append("    webRtcRequireMediaHelper: ").append(toIndentedString(webRtcRequireMediaHelper)).append("\n");
