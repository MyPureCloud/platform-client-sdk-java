...
public class GetConversationsMessagingIntegrationsOpenExtensionsGooglebusinessprofileTokenRequest {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.tokenId == null) {
            throw new IllegalStateException("Missing the required parameter 'tokenId' when building request for GetConversationsMessagingIntegrationsOpenExtensionsGooglebusinessprofileTokenRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/conversations/messaging/integrations/open/extensions/googlebusinessprofile/tokens/{tokenId}")
	...
	public static class Builder {
		private final GetConversationsMessagingIntegrationsOpenExtensionsGooglebusinessprofileTokenRequest request;

		private Builder() {
			request = new GetConversationsMessagingIntegrationsOpenExtensionsGooglebusinessprofileTokenRequest();
		}
		...
		public GetConversationsMessagingIntegrationsOpenExtensionsGooglebusinessprofileTokenRequest build() {
