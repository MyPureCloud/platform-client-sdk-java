...
public class WfmActivityPlanRunJobCompleteTopicActivityPlanJobException  implements Serializable {
 ...
 @JsonDeserialize(using = ExceptionTypeEnumDeserializer.class)
  ...
  private List<WfmActivityPlanRunJobCompleteTopicActivityPlanOccurrenceReference> occurrences = new ArrayList<WfmActivityPlanRunJobCompleteTopicActivityPlanOccurrenceReference>();
