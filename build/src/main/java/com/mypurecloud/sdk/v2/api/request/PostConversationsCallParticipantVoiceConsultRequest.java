...
public class PostConversationsCallParticipantVoiceConsultRequest {
	...
	public PostConversationsCallParticipantVoiceConsultRequest withConversationId(String conversationId) {
	...
	public PostConversationsCallParticipantVoiceConsultRequest withParticipantId(String participantId) {
	    this.setParticipantId(participantId);
	    return this;
	} 

	private ConsultTransferToAddress body;
	public ConsultTransferToAddress getBody() {
		return this.body;
	}

	public void setBody(ConsultTransferToAddress body) {
		this.body = body;
	}

	public PostConversationsCallParticipantVoiceConsultRequest withBody(ConsultTransferToAddress body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostConversationsCallParticipantVoiceConsultRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<ConsultTransferToAddress> withHttpInfo() {
        
        // verify the required parameter 'conversationId' is set
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PostConversationsCallParticipantVoiceConsultRequest.");
        }
        
        // verify the required parameter 'participantId' is set
        if (this.participantId == null) {
            throw new IllegalStateException("Missing the required parameter 'participantId' when building request for PostConversationsCallParticipantVoiceConsultRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostConversationsCallParticipantVoiceConsultRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/conversations/calls/{conversationId}/participants/{participantId}/voice/consult")
	...
	public static Builder builder(String conversationId, String participantId, ConsultTransferToAddress body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostConversationsCallParticipantVoiceConsultRequest request;

		private Builder() {
			request = new PostConversationsCallParticipantVoiceConsultRequest();
		}
		...
		public Builder withBody(ConsultTransferToAddress body) {
		...
		public Builder withRequiredParams(String conversationId, String participantId, ConsultTransferToAddress body) {
			request.setConversationId(conversationId);
			request.setParticipantId(participantId);
			request.setBody(body);
		...
		public PostConversationsCallParticipantVoiceConsultRequest build() {
