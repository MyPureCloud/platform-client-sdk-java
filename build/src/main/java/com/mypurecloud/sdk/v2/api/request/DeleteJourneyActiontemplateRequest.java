...
public class DeleteJourneyActiontemplateRequest {
	...
	public DeleteJourneyActiontemplateRequest withActionTemplateId(String actionTemplateId) {
	...
	public DeleteJourneyActiontemplateRequest withHardDelete(Boolean hardDelete) {
    ...
    public DeleteJourneyActiontemplateRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.actionTemplateId == null) {
            throw new IllegalStateException("Missing the required parameter 'actionTemplateId' when building request for DeleteJourneyActiontemplateRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/journey/actiontemplates/{actionTemplateId}")
	...
	public static class Builder {
		private final DeleteJourneyActiontemplateRequest request;

		private Builder() {
			request = new DeleteJourneyActiontemplateRequest();
		}
		...
		public DeleteJourneyActiontemplateRequest build() {
