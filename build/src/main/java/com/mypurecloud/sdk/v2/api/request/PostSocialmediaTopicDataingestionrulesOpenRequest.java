...
public class PostSocialmediaTopicDataingestionrulesOpenRequest {
	...
	public PostSocialmediaTopicDataingestionrulesOpenRequest withTopicId(String topicId) {
	    this.setTopicId(topicId);
	    return this;
	} 

	private OpenDataIngestionRuleRequest body;
	public OpenDataIngestionRuleRequest getBody() {
		return this.body;
	}

	public void setBody(OpenDataIngestionRuleRequest body) {
		this.body = body;
	}

	public PostSocialmediaTopicDataingestionrulesOpenRequest withBody(OpenDataIngestionRuleRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostSocialmediaTopicDataingestionrulesOpenRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<OpenDataIngestionRuleRequest> withHttpInfo() {
        
        // verify the required parameter 'topicId' is set
        if (this.topicId == null) {
            throw new IllegalStateException("Missing the required parameter 'topicId' when building request for PostSocialmediaTopicDataingestionrulesOpenRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/socialmedia/topics/{topicId}/dataingestionrules/open")
	...
	public static class Builder {
		private final PostSocialmediaTopicDataingestionrulesOpenRequest request;

		private Builder() {
			request = new PostSocialmediaTopicDataingestionrulesOpenRequest();
		}
		...
		public Builder withBody(OpenDataIngestionRuleRequest body) {
		...
		public PostSocialmediaTopicDataingestionrulesOpenRequest build() {
