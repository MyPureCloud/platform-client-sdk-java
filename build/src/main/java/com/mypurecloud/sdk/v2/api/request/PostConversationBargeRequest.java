...
public class PostConversationBargeRequest {
	...
	public PostConversationBargeRequest withConversationId(String conversationId) {
    ...
    public PostConversationBargeRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PostConversationBargeRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/conversations/{conversationId}/barge")
	...
	public static class Builder {
		private final PostConversationBargeRequest request;

		private Builder() {
			request = new PostConversationBargeRequest();
		}
		...
		public PostConversationBargeRequest build() {
