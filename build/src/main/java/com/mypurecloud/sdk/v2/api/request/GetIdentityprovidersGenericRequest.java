...
public class GetIdentityprovidersGenericRequest {
    ...
    public GetIdentityprovidersGenericRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/identityproviders/generic")
	...
	public static class Builder {
		private final GetIdentityprovidersGenericRequest request;

		private Builder() {
			request = new GetIdentityprovidersGenericRequest();
		}
		...
		public GetIdentityprovidersGenericRequest build() {
