...
public class GetRoutingWrapupcodesDivisionviewRequest {
	...
	public GetRoutingWrapupcodesDivisionviewRequest withCodeId(String codeId) {
    ...
    public GetRoutingWrapupcodesDivisionviewRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.codeId == null) {
            throw new IllegalStateException("Missing the required parameter 'codeId' when building request for GetRoutingWrapupcodesDivisionviewRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/routing/wrapupcodes/divisionviews/{codeId}")
	...
	public static Builder builder(String codeId) {
	    return new Builder()
	            .withRequiredParams(codeId);
	}


	public static class Builder {
		private final GetRoutingWrapupcodesDivisionviewRequest request;

		private Builder() {
			request = new GetRoutingWrapupcodesDivisionviewRequest();
		}
		...
		public Builder withRequiredParams(String codeId) {
			request.setCodeId(codeId);
		...
		public GetRoutingWrapupcodesDivisionviewRequest build() {
