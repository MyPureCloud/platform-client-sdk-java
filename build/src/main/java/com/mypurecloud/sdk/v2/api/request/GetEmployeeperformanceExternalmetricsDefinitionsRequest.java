...
public class GetEmployeeperformanceExternalmetricsDefinitionsRequest {
	...
	public GetEmployeeperformanceExternalmetricsDefinitionsRequest withPageSize(Integer pageSize) {
	...
	public GetEmployeeperformanceExternalmetricsDefinitionsRequest withPageNumber(Integer pageNumber) {
    ...
    public GetEmployeeperformanceExternalmetricsDefinitionsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/employeeperformance/externalmetrics/definitions")
	...
	public static class Builder {
		private final GetEmployeeperformanceExternalmetricsDefinitionsRequest request;

		private Builder() {
			request = new GetEmployeeperformanceExternalmetricsDefinitionsRequest();
		}
		...
		public GetEmployeeperformanceExternalmetricsDefinitionsRequest build() {
