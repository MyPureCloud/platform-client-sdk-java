...
public class PostTelephonyProvidersEdgesCertificateauthoritiesRequest {
	...
	public PostTelephonyProvidersEdgesCertificateauthoritiesRequest withBody(DomainCertificateAuthority body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostTelephonyProvidersEdgesCertificateauthoritiesRequest withCustomHeader(String name, String value) {
