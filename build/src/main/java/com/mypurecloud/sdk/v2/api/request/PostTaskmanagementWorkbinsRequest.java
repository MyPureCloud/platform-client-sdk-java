...
public class PostTaskmanagementWorkbinsRequest {

	private WorkbinCreate body;
	public WorkbinCreate getBody() {
		return this.body;
	}

	public void setBody(WorkbinCreate body) {
		this.body = body;
	}

	public PostTaskmanagementWorkbinsRequest withBody(WorkbinCreate body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostTaskmanagementWorkbinsRequest withCustomHeader(String name, String value) {
	...
	public static class Builder {
		private final PostTaskmanagementWorkbinsRequest request;

		private Builder() {
			request = new PostTaskmanagementWorkbinsRequest();
		}


		public Builder withBody(WorkbinCreate body) {
