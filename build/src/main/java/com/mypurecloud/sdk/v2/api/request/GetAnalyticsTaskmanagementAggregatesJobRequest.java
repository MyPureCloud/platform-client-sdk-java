...
public class GetAnalyticsTaskmanagementAggregatesJobRequest {
	...
	public GetAnalyticsTaskmanagementAggregatesJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetAnalyticsTaskmanagementAggregatesJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetAnalyticsTaskmanagementAggregatesJobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/analytics/taskmanagement/aggregates/jobs/{jobId}")
	...
	public static class Builder {
		private final GetAnalyticsTaskmanagementAggregatesJobRequest request;

		private Builder() {
			request = new GetAnalyticsTaskmanagementAggregatesJobRequest();
		}
		...
		public GetAnalyticsTaskmanagementAggregatesJobRequest build() {
