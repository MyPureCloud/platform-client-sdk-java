...
public class QueueConversationChatEventTopicUriReference  implements Serializable {
  
  private String id = null;
  private String name = null;

  public QueueConversationChatEventTopicUriReference() {
   ...
   **/
  public QueueConversationChatEventTopicUriReference id(String id) {
    this.id = id;
    return this;
  }
   ...
   **/
  public QueueConversationChatEventTopicUriReference name(String name) {
    this.name = name;
    return this;
  }
