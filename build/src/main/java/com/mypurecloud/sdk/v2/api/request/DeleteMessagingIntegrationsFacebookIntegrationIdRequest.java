...
public class DeleteMessagingIntegrationsFacebookIntegrationIdRequest {
	...
	public DeleteMessagingIntegrationsFacebookIntegrationIdRequest withIntegrationId(String integrationId) {
    ...
    public DeleteMessagingIntegrationsFacebookIntegrationIdRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.integrationId == null) {
            throw new IllegalStateException("Missing the required parameter 'integrationId' when building request for DeleteMessagingIntegrationsFacebookIntegrationIdRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/messaging/integrations/facebook/{integrationId}")
	...
	public static class Builder {
		private final DeleteMessagingIntegrationsFacebookIntegrationIdRequest request;

		private Builder() {
			request = new DeleteMessagingIntegrationsFacebookIntegrationIdRequest();
		}
		...
		public DeleteMessagingIntegrationsFacebookIntegrationIdRequest build() {
