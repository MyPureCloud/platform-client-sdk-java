...
public class PostAnalyticsBotsAggregatesQueryRequest {
    
	private BotAggregationQuery body;
	public BotAggregationQuery getBody() {
		return this.body;
	}

	public void setBody(BotAggregationQuery body) {
		this.body = body;
	}

	public PostAnalyticsBotsAggregatesQueryRequest withBody(BotAggregationQuery body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostAnalyticsBotsAggregatesQueryRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<BotAggregationQuery> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostAnalyticsBotsAggregatesQueryRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/analytics/bots/aggregates/query")
                .withBody(body)
	...
	public static Builder builder(BotAggregationQuery body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostAnalyticsBotsAggregatesQueryRequest request;

		private Builder() {
			request = new PostAnalyticsBotsAggregatesQueryRequest();
		}

		
		public Builder withBody(BotAggregationQuery body) {
		...
		public Builder withRequiredParams(BotAggregationQuery body) {
			request.setBody(body);
		...
		public PostAnalyticsBotsAggregatesQueryRequest build() {
