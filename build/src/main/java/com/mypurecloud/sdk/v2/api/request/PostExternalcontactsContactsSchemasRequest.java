...
public class PostExternalcontactsContactsSchemasRequest {
	...
	public PostExternalcontactsContactsSchemasRequest withBody(DataSchema body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostExternalcontactsContactsSchemasRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<DataSchema> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostExternalcontactsContactsSchemasRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/externalcontacts/contacts/schemas")
                .withBody(body)
	...
	public static class Builder {
		private final PostExternalcontactsContactsSchemasRequest request;

		private Builder() {
			request = new PostExternalcontactsContactsSchemasRequest();
		}
		...
		public PostExternalcontactsContactsSchemasRequest build() {
