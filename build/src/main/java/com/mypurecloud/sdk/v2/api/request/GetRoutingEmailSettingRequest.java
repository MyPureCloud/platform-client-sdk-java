...
public class GetRoutingEmailSettingRequest {
	...
	public GetRoutingEmailSettingRequest withPageSize(Integer pageSize) {
	...
	public GetRoutingEmailSettingRequest withPageNumber(Integer pageNumber) {
    ...
    public GetRoutingEmailSettingRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/routing/email/setting")
	...
	public static class Builder {
		private final GetRoutingEmailSettingRequest request;

		private Builder() {
			request = new GetRoutingEmailSettingRequest();
		}
		...
		public GetRoutingEmailSettingRequest build() {
