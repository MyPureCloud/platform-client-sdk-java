...
public class GetWorkforcemanagementManagementunitTimeoffplansRequest {
	...
	public GetWorkforcemanagementManagementunitTimeoffplansRequest withManagementUnitId(String managementUnitId) {
    ...
    public GetWorkforcemanagementManagementunitTimeoffplansRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.managementUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'managementUnitId' when building request for GetWorkforcemanagementManagementunitTimeoffplansRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/managementunits/{managementUnitId}/timeoffplans")
	...
	public static class Builder {
		private final GetWorkforcemanagementManagementunitTimeoffplansRequest request;

		private Builder() {
			request = new GetWorkforcemanagementManagementunitTimeoffplansRequest();
		}
		...
		public GetWorkforcemanagementManagementunitTimeoffplansRequest build() {
