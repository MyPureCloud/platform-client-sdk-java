...
public class DeleteSpeechandtextanalyticsProgramRequest {
	...
	public DeleteSpeechandtextanalyticsProgramRequest withProgramId(String programId) {
	...
	public DeleteSpeechandtextanalyticsProgramRequest withForceDelete(Boolean forceDelete) {
    ...
    public DeleteSpeechandtextanalyticsProgramRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.programId == null) {
            throw new IllegalStateException("Missing the required parameter 'programId' when building request for DeleteSpeechandtextanalyticsProgramRequest.");
        }
