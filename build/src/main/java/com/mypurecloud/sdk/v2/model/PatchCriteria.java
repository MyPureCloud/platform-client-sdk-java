...
public class PatchCriteria  implements Serializable {
 ...
 @JsonDeserialize(using = OperatorEnumDeserializer.class)
   ...
   * The criteria key.
   **/
  public PatchCriteria key(String key) {
    this.key = key;
    return this;
  }
   ...
   * The criteria values.
   **/
  public PatchCriteria values(List<String> values) {
    this.values = values;
    return this;
  }
   ...
   **/
  public PatchCriteria shouldIgnoreCase(Boolean shouldIgnoreCase) {
   ...
   * The comparison operator.
   **/
  public PatchCriteria operator(OperatorEnum operator) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PatchCriteria patchCriteria = (PatchCriteria) o;

    return Objects.equals(this.key, patchCriteria.key) &&
            Objects.equals(this.values, patchCriteria.values) &&
            Objects.equals(this.shouldIgnoreCase, patchCriteria.shouldIgnoreCase) &&
            Objects.equals(this.operator, patchCriteria.operator);
  }
