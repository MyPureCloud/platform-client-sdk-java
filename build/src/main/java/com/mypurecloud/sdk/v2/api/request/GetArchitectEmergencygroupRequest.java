...
public class GetArchitectEmergencygroupRequest {
	...
	public GetArchitectEmergencygroupRequest withEmergencyGroupId(String emergencyGroupId) {
    ...
    public GetArchitectEmergencygroupRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.emergencyGroupId == null) {
            throw new IllegalStateException("Missing the required parameter 'emergencyGroupId' when building request for GetArchitectEmergencygroupRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/architect/emergencygroups/{emergencyGroupId}")
	...
	public static class Builder {
		private final GetArchitectEmergencygroupRequest request;

		private Builder() {
			request = new GetArchitectEmergencygroupRequest();
		}
		...
		public GetArchitectEmergencygroupRequest build() {
