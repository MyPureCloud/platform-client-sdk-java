...
public class PutRoutingQueueIdentityresolutionRequest {
	...
	public PutRoutingQueueIdentityresolutionRequest withQueueId(String queueId) {
	    this.setQueueId(queueId);
	    return this;
	} 

	private IdentityResolutionQueueConfig body;
	public IdentityResolutionQueueConfig getBody() {
		return this.body;
	}

	public void setBody(IdentityResolutionQueueConfig body) {
		this.body = body;
	}

	public PutRoutingQueueIdentityresolutionRequest withBody(IdentityResolutionQueueConfig body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutRoutingQueueIdentityresolutionRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<IdentityResolutionQueueConfig> withHttpInfo() {
        
        // verify the required parameter 'queueId' is set
        if (this.queueId == null) {
            throw new IllegalStateException("Missing the required parameter 'queueId' when building request for PutRoutingQueueIdentityresolutionRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutRoutingQueueIdentityresolutionRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/routing/queues/{queueId}/identityresolution")
	...
	public static Builder builder(String queueId, IdentityResolutionQueueConfig body) {
	    return new Builder()
	...
	public static class Builder {
		private final PutRoutingQueueIdentityresolutionRequest request;

		private Builder() {
			request = new PutRoutingQueueIdentityresolutionRequest();
		}
		...
		public Builder withBody(IdentityResolutionQueueConfig body) {
		...
		public Builder withRequiredParams(String queueId, IdentityResolutionQueueConfig body) {
			request.setQueueId(queueId);
			request.setBody(body);
		...
		public PutRoutingQueueIdentityresolutionRequest build() {
