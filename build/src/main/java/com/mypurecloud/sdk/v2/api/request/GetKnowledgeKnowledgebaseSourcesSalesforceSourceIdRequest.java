...
public class GetKnowledgeKnowledgebaseSourcesSalesforceSourceIdRequest {
	...
	public GetKnowledgeKnowledgebaseSourcesSalesforceSourceIdRequest withKnowledgeBaseId(String knowledgeBaseId) {
	...
	public GetKnowledgeKnowledgebaseSourcesSalesforceSourceIdRequest withSourceId(String sourceId) {
	...
	public GetKnowledgeKnowledgebaseSourcesSalesforceSourceIdRequest withExpand(List<String> expand) {
    ...
    public GetKnowledgeKnowledgebaseSourcesSalesforceSourceIdRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.knowledgeBaseId == null) {
            throw new IllegalStateException("Missing the required parameter 'knowledgeBaseId' when building request for GetKnowledgeKnowledgebaseSourcesSalesforceSourceIdRequest.");
        }
        
        // verify the required parameter 'sourceId' is set
        if (this.sourceId == null) {
            throw new IllegalStateException("Missing the required parameter 'sourceId' when building request for GetKnowledgeKnowledgebaseSourcesSalesforceSourceIdRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/sources/salesforce/{sourceId}")
	...
	public static class Builder {
		private final GetKnowledgeKnowledgebaseSourcesSalesforceSourceIdRequest request;

		private Builder() {
			request = new GetKnowledgeKnowledgebaseSourcesSalesforceSourceIdRequest();
		}
		...
		public GetKnowledgeKnowledgebaseSourcesSalesforceSourceIdRequest build() {
