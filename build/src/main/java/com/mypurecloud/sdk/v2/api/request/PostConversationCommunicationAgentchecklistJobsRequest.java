...
public class PostConversationCommunicationAgentchecklistJobsRequest {
	...
	public PostConversationCommunicationAgentchecklistJobsRequest withConversationId(String conversationId) {
	...
	public PostConversationCommunicationAgentchecklistJobsRequest withCommunicationId(String communicationId) {
	...
	public PostConversationCommunicationAgentchecklistJobsRequest withAgentChecklistId(String agentChecklistId) {
	    this.setAgentChecklistId(agentChecklistId);
	    return this;
	} 

	private ChecklistInferenceJobPayload body;
	public ChecklistInferenceJobPayload getBody() {
		return this.body;
	}

	public void setBody(ChecklistInferenceJobPayload body) {
		this.body = body;
	}

	public PostConversationCommunicationAgentchecklistJobsRequest withBody(ChecklistInferenceJobPayload body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostConversationCommunicationAgentchecklistJobsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<ChecklistInferenceJobPayload> withHttpInfo() {
        
        // verify the required parameter 'conversationId' is set
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PostConversationCommunicationAgentchecklistJobsRequest.");
        }
        
        // verify the required parameter 'communicationId' is set
        if (this.communicationId == null) {
            throw new IllegalStateException("Missing the required parameter 'communicationId' when building request for PostConversationCommunicationAgentchecklistJobsRequest.");
        }
        
        // verify the required parameter 'agentChecklistId' is set
        if (this.agentChecklistId == null) {
            throw new IllegalStateException("Missing the required parameter 'agentChecklistId' when building request for PostConversationCommunicationAgentchecklistJobsRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostConversationCommunicationAgentchecklistJobsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/conversations/{conversationId}/communications/{communicationId}/agentchecklists/{agentChecklistId}/jobs")
	...
	public static Builder builder(String conversationId, String communicationId, String agentChecklistId, ChecklistInferenceJobPayload body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostConversationCommunicationAgentchecklistJobsRequest request;

		private Builder() {
			request = new PostConversationCommunicationAgentchecklistJobsRequest();
		}
		...
		public Builder withBody(ChecklistInferenceJobPayload body) {
		...
		public Builder withRequiredParams(String conversationId, String communicationId, String agentChecklistId, ChecklistInferenceJobPayload body) {
			request.setConversationId(conversationId);
			request.setCommunicationId(communicationId);
			request.setAgentChecklistId(agentChecklistId);
			request.setBody(body);
		...
		public PostConversationCommunicationAgentchecklistJobsRequest build() {
