...
public class PostWorkforcemanagementBusinessunitIntradayRequest {
	...
	public PostWorkforcemanagementBusinessunitIntradayRequest withBusinessUnitId(String businessUnitId) {
	...
	public void setBody(IntradayPlanningGroupRequest body) {
		this.body = body;
	}
    ...
    public ApiRequest<IntradayPlanningGroupRequest> withHttpInfo() {
	...
	public static class Builder {
		private final PostWorkforcemanagementBusinessunitIntradayRequest request;

		private Builder() {
			request = new PostWorkforcemanagementBusinessunitIntradayRequest();
		}
		...
		public PostWorkforcemanagementBusinessunitIntradayRequest build() {
