...
public class DeleteOrgauthorizationTrustorsRequest {
	...
	public DeleteOrgauthorizationTrustorsRequest withId(List<String> id) {
	    this.setId(id);
	    return this;
	} 
    ...
    public DeleteOrgauthorizationTrustorsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.id == null) {
            throw new IllegalStateException("Missing the required parameter 'id' when building request for DeleteOrgauthorizationTrustorsRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/orgauthorization/trustors")
	...
	public static class Builder {
		private final DeleteOrgauthorizationTrustorsRequest request;

		private Builder() {
			request = new DeleteOrgauthorizationTrustorsRequest();
		}
		...
		public DeleteOrgauthorizationTrustorsRequest build() {
