...
public class PostRoutingSkillgroupsRequest {
    ...
    public PostRoutingSkillgroupsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<SkillGroup> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostRoutingSkillgroupsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/routing/skillgroups")
                .withBody(body)
	...
	public static class Builder {
		private final PostRoutingSkillgroupsRequest request;

		private Builder() {
			request = new PostRoutingSkillgroupsRequest();
		}
		...
		public PostRoutingSkillgroupsRequest build() {
