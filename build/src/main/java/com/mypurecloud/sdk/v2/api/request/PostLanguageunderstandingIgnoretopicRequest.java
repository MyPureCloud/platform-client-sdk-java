...
public class PostLanguageunderstandingIgnoretopicRequest {
	...
	public PostLanguageunderstandingIgnoretopicRequest withLanguageCode(String languageCode) {
	    this.setLanguageCode(languageCode);
	    return this;
	} 

	private IgnoreTopicsRequest body;
	public IgnoreTopicsRequest getBody() {
		return this.body;
	}

	public void setBody(IgnoreTopicsRequest body) {
		this.body = body;
	}

	public PostLanguageunderstandingIgnoretopicRequest withBody(IgnoreTopicsRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostLanguageunderstandingIgnoretopicRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<IgnoreTopicsRequest> withHttpInfo() {
        
        // verify the required parameter 'languageCode' is set
        if (this.languageCode == null) {
            throw new IllegalStateException("Missing the required parameter 'languageCode' when building request for PostLanguageunderstandingIgnoretopicRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostLanguageunderstandingIgnoretopicRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/languageunderstanding/ignoretopics/{languageCode}")
	...
	public static Builder builder(String languageCode, IgnoreTopicsRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostLanguageunderstandingIgnoretopicRequest request;

		private Builder() {
			request = new PostLanguageunderstandingIgnoretopicRequest();
		}
		...
		public Builder withBody(IgnoreTopicsRequest body) {
		...
		public Builder withRequiredParams(String languageCode, IgnoreTopicsRequest body) {
			request.setLanguageCode(languageCode);
			request.setBody(body);
		...
		public PostLanguageunderstandingIgnoretopicRequest build() {
