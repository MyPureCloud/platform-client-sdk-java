...
public class GetAlertingUserpresenceAlertsRequest {
	...
	public GetAlertingUserpresenceAlertsRequest withExpand(List<String> expand) {
    ...
    public GetAlertingUserpresenceAlertsRequest withCustomHeader(String name, String value) {
