...
public class PostOutboundContactlisttemplatesBulkRetrieveRequest {

	private ContactListTemplateBulkRetrieveBody body;
	public ContactListTemplateBulkRetrieveBody getBody() {
		return this.body;
	}

	public void setBody(ContactListTemplateBulkRetrieveBody body) {
		this.body = body;
	}

	public PostOutboundContactlisttemplatesBulkRetrieveRequest withBody(ContactListTemplateBulkRetrieveBody body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostOutboundContactlisttemplatesBulkRetrieveRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<ContactListTemplateBulkRetrieveBody> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostOutboundContactlisttemplatesBulkRetrieveRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/outbound/contactlisttemplates/bulk/retrieve")
                .withBody(body)
	...
	public static Builder builder(ContactListTemplateBulkRetrieveBody body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostOutboundContactlisttemplatesBulkRetrieveRequest request;

		private Builder() {
			request = new PostOutboundContactlisttemplatesBulkRetrieveRequest();
		}


		public Builder withBody(ContactListTemplateBulkRetrieveBody body) {
		...
		public Builder withRequiredParams(ContactListTemplateBulkRetrieveBody body) {
			request.setBody(body);
		...
		public PostOutboundContactlisttemplatesBulkRetrieveRequest build() {
