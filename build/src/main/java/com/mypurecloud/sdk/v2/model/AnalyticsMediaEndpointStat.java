...
public class AnalyticsMediaEndpointStat  implements Serializable {
  ...
  @ApiModelProperty(example = "null", value = "The MIME types of the audio encodings used by the audio streams belonging to this endpoint")
  @JsonProperty("codecs")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(codecs, minMos, minRFactor, maxLatencyMs, receivedPackets, invalidPackets, discardedPackets, duplicatePackets, overrunPackets, underrunPackets);
  }
