...
public class GetRoutingAssessmentsJobRequest {
	...
	public GetRoutingAssessmentsJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetRoutingAssessmentsJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetRoutingAssessmentsJobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/routing/assessments/jobs/{jobId}")
	...
	public static class Builder {
		private final GetRoutingAssessmentsJobRequest request;

		private Builder() {
			request = new GetRoutingAssessmentsJobRequest();
		}
		...
		public GetRoutingAssessmentsJobRequest build() {
