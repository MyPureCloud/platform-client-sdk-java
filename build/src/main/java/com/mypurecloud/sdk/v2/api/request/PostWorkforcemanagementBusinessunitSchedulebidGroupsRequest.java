...
public class PostWorkforcemanagementBusinessunitSchedulebidGroupsRequest {
	...
	public PostWorkforcemanagementBusinessunitSchedulebidGroupsRequest withBusinessUnitId(String businessUnitId) {
	...
	public PostWorkforcemanagementBusinessunitSchedulebidGroupsRequest withBidId(String bidId) {
	    this.setBidId(bidId);
	    return this;
	} 

	private ScheduleBidGroupCreate body;
	public ScheduleBidGroupCreate getBody() {
		return this.body;
	}

	public void setBody(ScheduleBidGroupCreate body) {
		this.body = body;
	}

	public PostWorkforcemanagementBusinessunitSchedulebidGroupsRequest withBody(ScheduleBidGroupCreate body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementBusinessunitSchedulebidGroupsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<ScheduleBidGroupCreate> withHttpInfo() {
        
        // verify the required parameter 'businessUnitId' is set
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PostWorkforcemanagementBusinessunitSchedulebidGroupsRequest.");
        }
        
        // verify the required parameter 'bidId' is set
        if (this.bidId == null) {
            throw new IllegalStateException("Missing the required parameter 'bidId' when building request for PostWorkforcemanagementBusinessunitSchedulebidGroupsRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementBusinessunitSchedulebidGroupsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/schedulebids/{bidId}/groups")
	...
	public static Builder builder(String businessUnitId, String bidId, ScheduleBidGroupCreate body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementBusinessunitSchedulebidGroupsRequest request;

		private Builder() {
			request = new PostWorkforcemanagementBusinessunitSchedulebidGroupsRequest();
		}
		...
		public Builder withBody(ScheduleBidGroupCreate body) {
		...
		public Builder withRequiredParams(String businessUnitId, String bidId, ScheduleBidGroupCreate body) {
			request.setBusinessUnitId(businessUnitId);
			request.setBidId(bidId);
			request.setBody(body);
		...
		public PostWorkforcemanagementBusinessunitSchedulebidGroupsRequest build() {
