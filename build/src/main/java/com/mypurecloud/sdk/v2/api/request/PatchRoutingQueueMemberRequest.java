...
public class PatchRoutingQueueMemberRequest {
	...
	public PatchRoutingQueueMemberRequest withQueueId(String queueId) {
	...
	public PatchRoutingQueueMemberRequest withMemberId(String memberId) {
	...
	public PatchRoutingQueueMemberRequest withBody(QueueMember body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchRoutingQueueMemberRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<QueueMember> withHttpInfo() {
        ...
        if (this.queueId == null) {
            throw new IllegalStateException("Missing the required parameter 'queueId' when building request for PatchRoutingQueueMemberRequest.");
        }
        
        // verify the required parameter 'memberId' is set
        if (this.memberId == null) {
            throw new IllegalStateException("Missing the required parameter 'memberId' when building request for PatchRoutingQueueMemberRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchRoutingQueueMemberRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/routing/queues/{queueId}/members/{memberId}")
	...
	public static class Builder {
		private final PatchRoutingQueueMemberRequest request;

		private Builder() {
			request = new PatchRoutingQueueMemberRequest();
		}
		...
		public PatchRoutingQueueMemberRequest build() {
