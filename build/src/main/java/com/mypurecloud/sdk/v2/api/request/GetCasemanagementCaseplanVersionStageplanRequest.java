...
public class GetCasemanagementCaseplanVersionStageplanRequest {
	...
	public GetCasemanagementCaseplanVersionStageplanRequest withCaseplanId(String caseplanId) {
	...
	public GetCasemanagementCaseplanVersionStageplanRequest withVersionId(String versionId) {
	...
	public GetCasemanagementCaseplanVersionStageplanRequest withStageplanId(String stageplanId) {
	...
	public GetCasemanagementCaseplanVersionStageplanRequest withExpands(List<String> expands) {
    ...
    public GetCasemanagementCaseplanVersionStageplanRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.caseplanId == null) {
            throw new IllegalStateException("Missing the required parameter 'caseplanId' when building request for GetCasemanagementCaseplanVersionStageplanRequest.");
        }
        
        // verify the required parameter 'versionId' is set
        if (this.versionId == null) {
            throw new IllegalStateException("Missing the required parameter 'versionId' when building request for GetCasemanagementCaseplanVersionStageplanRequest.");
        }
        
        // verify the required parameter 'stageplanId' is set
        if (this.stageplanId == null) {
            throw new IllegalStateException("Missing the required parameter 'stageplanId' when building request for GetCasemanagementCaseplanVersionStageplanRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/casemanagement/caseplans/{caseplanId}/versions/{versionId}/stageplans/{stageplanId}")
	...
	public static Builder builder(String caseplanId, String versionId, String stageplanId) {
	    return new Builder()
	            .withRequiredParams(caseplanId, versionId, stageplanId);
	}


	public static class Builder {
		private final GetCasemanagementCaseplanVersionStageplanRequest request;

		private Builder() {
			request = new GetCasemanagementCaseplanVersionStageplanRequest();
		}
		...
		public Builder withRequiredParams(String caseplanId, String versionId, String stageplanId) {
			request.setCaseplanId(caseplanId);
			request.setVersionId(versionId);
			request.setStageplanId(stageplanId);
		...
		public GetCasemanagementCaseplanVersionStageplanRequest build() {
