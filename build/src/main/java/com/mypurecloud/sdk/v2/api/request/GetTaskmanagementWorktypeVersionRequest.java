...
public class GetTaskmanagementWorktypeVersionRequest {
	...
	public GetTaskmanagementWorktypeVersionRequest withWorktypeId(String worktypeId) {
	...
	public GetTaskmanagementWorktypeVersionRequest withEntityVersion(Integer entityVersion) {
    ...
    public GetTaskmanagementWorktypeVersionRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.worktypeId == null) {
            throw new IllegalStateException("Missing the required parameter 'worktypeId' when building request for GetTaskmanagementWorktypeVersionRequest.");
        }
        
        // verify the required parameter 'entityVersion' is set
        if (this.entityVersion == null) {
            throw new IllegalStateException("Missing the required parameter 'entityVersion' when building request for GetTaskmanagementWorktypeVersionRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/taskmanagement/worktypes/{worktypeId}/versions/{entityVersion}")
	...
	public static Builder builder(String worktypeId, Integer entityVersion) {
	    return new Builder()
	            .withRequiredParams(worktypeId, entityVersion);
	}


	public static class Builder {
		private final GetTaskmanagementWorktypeVersionRequest request;

		private Builder() {
			request = new GetTaskmanagementWorktypeVersionRequest();
		}
		...
		public Builder withRequiredParams(String worktypeId, Integer entityVersion) {
			request.setWorktypeId(worktypeId);
			request.setEntityVersion(entityVersion);
		...
		public GetTaskmanagementWorktypeVersionRequest build() {
