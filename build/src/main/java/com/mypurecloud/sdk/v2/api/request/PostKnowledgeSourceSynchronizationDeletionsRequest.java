...
public class PostKnowledgeSourceSynchronizationDeletionsRequest {
	...
	public PostKnowledgeSourceSynchronizationDeletionsRequest withSourceId(String sourceId) {
	...
	public PostKnowledgeSourceSynchronizationDeletionsRequest withSynchronizationId(String synchronizationId) {
	    this.setSynchronizationId(synchronizationId);
	    return this;
	} 

	private V3SynchronizationFileDeletionRequest body;
	public V3SynchronizationFileDeletionRequest getBody() {
		return this.body;
	}

	public void setBody(V3SynchronizationFileDeletionRequest body) {
		this.body = body;
	}

	public PostKnowledgeSourceSynchronizationDeletionsRequest withBody(V3SynchronizationFileDeletionRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostKnowledgeSourceSynchronizationDeletionsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<V3SynchronizationFileDeletionRequest> withHttpInfo() {
        
        // verify the required parameter 'sourceId' is set
        if (this.sourceId == null) {
            throw new IllegalStateException("Missing the required parameter 'sourceId' when building request for PostKnowledgeSourceSynchronizationDeletionsRequest.");
        }
        
        // verify the required parameter 'synchronizationId' is set
        if (this.synchronizationId == null) {
            throw new IllegalStateException("Missing the required parameter 'synchronizationId' when building request for PostKnowledgeSourceSynchronizationDeletionsRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostKnowledgeSourceSynchronizationDeletionsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/knowledge/sources/{sourceId}/synchronizations/{synchronizationId}/deletions")
	...
	public static Builder builder(String sourceId, String synchronizationId, V3SynchronizationFileDeletionRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostKnowledgeSourceSynchronizationDeletionsRequest request;

		private Builder() {
			request = new PostKnowledgeSourceSynchronizationDeletionsRequest();
		}
		...
		public Builder withBody(V3SynchronizationFileDeletionRequest body) {
		...
		public Builder withRequiredParams(String sourceId, String synchronizationId, V3SynchronizationFileDeletionRequest body) {
			request.setSourceId(sourceId);
			request.setSynchronizationId(synchronizationId);
			request.setBody(body);
		...
		public PostKnowledgeSourceSynchronizationDeletionsRequest build() {
