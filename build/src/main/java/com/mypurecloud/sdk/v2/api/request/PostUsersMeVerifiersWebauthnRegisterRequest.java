...
public class PostUsersMeVerifiersWebauthnRegisterRequest {

	private FinishWebAuthnRegistrationRequest body;
	public FinishWebAuthnRegistrationRequest getBody() {
		return this.body;
	}

	public void setBody(FinishWebAuthnRegistrationRequest body) {
		this.body = body;
	}

	public PostUsersMeVerifiersWebauthnRegisterRequest withBody(FinishWebAuthnRegistrationRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostUsersMeVerifiersWebauthnRegisterRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<FinishWebAuthnRegistrationRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostUsersMeVerifiersWebauthnRegisterRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/users/me/verifiers/webauthn/register")
                .withBody(body)
	...
	public static Builder builder(FinishWebAuthnRegistrationRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostUsersMeVerifiersWebauthnRegisterRequest request;

		private Builder() {
			request = new PostUsersMeVerifiersWebauthnRegisterRequest();
		}


		public Builder withBody(FinishWebAuthnRegistrationRequest body) {
		...
		public Builder withRequiredParams(FinishWebAuthnRegistrationRequest body) {
			request.setBody(body);
		...
		public PostUsersMeVerifiersWebauthnRegisterRequest build() {
