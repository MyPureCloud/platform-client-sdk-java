...
public class PostTelephonyProvidersEdgesSitesRequest {
	...
	public void setBody(Site body) {
		this.body = body;
	}

	public PostTelephonyProvidersEdgesSitesRequest withBody(Site body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostTelephonyProvidersEdgesSitesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Site> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("POST", "/api/v2/telephony/providers/edges/sites")
                .withBody(body)
	...
	public static Builder builder(Site body) {
	    return new Builder()
	...
	public static class Builder {
		...
		private Builder() {
			request = new PostTelephonyProvidersEdgesSitesRequest();
		}

		
		public Builder withBody(Site body) {
		...
		public Builder withRequiredParams(Site body) {
			request.setBody(body);
