...
public class GetWorkforcemanagementBusinessunitTimeofflimitRequest {
	...
	public GetWorkforcemanagementBusinessunitTimeofflimitRequest withBusinessUnitId(String businessUnitId) {
	...
	public GetWorkforcemanagementBusinessunitTimeofflimitRequest withTimeOffLimitId(String timeOffLimitId) {
    ...
    public GetWorkforcemanagementBusinessunitTimeofflimitRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for GetWorkforcemanagementBusinessunitTimeofflimitRequest.");
        }
        
        // verify the required parameter 'timeOffLimitId' is set
        if (this.timeOffLimitId == null) {
            throw new IllegalStateException("Missing the required parameter 'timeOffLimitId' when building request for GetWorkforcemanagementBusinessunitTimeofflimitRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/timeofflimits/{timeOffLimitId}")
	...
	public static class Builder {
		private final GetWorkforcemanagementBusinessunitTimeofflimitRequest request;

		private Builder() {
			request = new GetWorkforcemanagementBusinessunitTimeofflimitRequest();
		}
		...
		public GetWorkforcemanagementBusinessunitTimeofflimitRequest build() {
