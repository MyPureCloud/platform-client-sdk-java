...
public class GetIntegrationsSpeechTtsSettingsRequest {
    ...
    public GetIntegrationsSpeechTtsSettingsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/integrations/speech/tts/settings")
	...
	public static class Builder {
		private final GetIntegrationsSpeechTtsSettingsRequest request;

		private Builder() {
			request = new GetIntegrationsSpeechTtsSettingsRequest();
		}
		...
		public GetIntegrationsSpeechTtsSettingsRequest build() {
