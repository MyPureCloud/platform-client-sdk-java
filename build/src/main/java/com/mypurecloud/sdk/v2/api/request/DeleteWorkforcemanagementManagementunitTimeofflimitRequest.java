...
public class DeleteWorkforcemanagementManagementunitTimeofflimitRequest {
	...
	public DeleteWorkforcemanagementManagementunitTimeofflimitRequest withManagementUnitId(String managementUnitId) {
	...
	public DeleteWorkforcemanagementManagementunitTimeofflimitRequest withTimeOffLimitId(String timeOffLimitId) {
    ...
    public DeleteWorkforcemanagementManagementunitTimeofflimitRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.managementUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'managementUnitId' when building request for DeleteWorkforcemanagementManagementunitTimeofflimitRequest.");
        }
        
        // verify the required parameter 'timeOffLimitId' is set
        if (this.timeOffLimitId == null) {
            throw new IllegalStateException("Missing the required parameter 'timeOffLimitId' when building request for DeleteWorkforcemanagementManagementunitTimeofflimitRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/workforcemanagement/managementunits/{managementUnitId}/timeofflimits/{timeOffLimitId}")
	...
	public static class Builder {
		private final DeleteWorkforcemanagementManagementunitTimeofflimitRequest request;

		private Builder() {
			request = new DeleteWorkforcemanagementManagementunitTimeofflimitRequest();
		}
		...
		public DeleteWorkforcemanagementManagementunitTimeofflimitRequest build() {
