...
public class PostWorkforcemanagementManagementunitUserTimeoffbalanceJobsRequest {
	...
	public PostWorkforcemanagementManagementunitUserTimeoffbalanceJobsRequest withManagementUnitId(String managementUnitId) {
	...
	public PostWorkforcemanagementManagementunitUserTimeoffbalanceJobsRequest withUserId(String userId) {
	...
	public void setBody(TimeOffBalanceRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementManagementunitUserTimeoffbalanceJobsRequest withBody(TimeOffBalanceRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementManagementunitUserTimeoffbalanceJobsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<TimeOffBalanceRequest> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/managementunits/{managementUnitId}/users/{userId}/timeoffbalance/jobs")
	...
	public static Builder builder(String managementUnitId, String userId, TimeOffBalanceRequest body) {
	    return new Builder()
	...
	public static class Builder {
		...
		private Builder() {
			request = new PostWorkforcemanagementManagementunitUserTimeoffbalanceJobsRequest();
		}
		...
		public Builder withBody(TimeOffBalanceRequest body) {
		...
		public Builder withRequiredParams(String managementUnitId, String userId, TimeOffBalanceRequest body) {
			request.setManagementUnitId(managementUnitId);
			request.setUserId(userId);
			request.setBody(body);
