...
public class GetConversationsMessagingIdentityresolutionIntegrationsInstagramIntegrationIdRequest {
	...
	public GetConversationsMessagingIdentityresolutionIntegrationsInstagramIntegrationIdRequest withIntegrationId(String integrationId) {
    ...
    public GetConversationsMessagingIdentityresolutionIntegrationsInstagramIntegrationIdRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.integrationId == null) {
            throw new IllegalStateException("Missing the required parameter 'integrationId' when building request for GetConversationsMessagingIdentityresolutionIntegrationsInstagramIntegrationIdRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/conversations/messaging/identityresolution/integrations/instagram/{integrationId}")
	...
	public static class Builder {
		private final GetConversationsMessagingIdentityresolutionIntegrationsInstagramIntegrationIdRequest request;

		private Builder() {
			request = new GetConversationsMessagingIdentityresolutionIntegrationsInstagramIntegrationIdRequest();
		}
		...
		public GetConversationsMessagingIdentityresolutionIntegrationsInstagramIntegrationIdRequest build() {
