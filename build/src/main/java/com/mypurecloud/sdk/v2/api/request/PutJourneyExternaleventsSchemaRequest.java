...
public class PutJourneyExternaleventsSchemaRequest {
	...
	public PutJourneyExternaleventsSchemaRequest withSchemaId(String schemaId) {
	    this.setSchemaId(schemaId);
	    return this;
	} 

	private JourneySchemaUpdateRequest body;
	public JourneySchemaUpdateRequest getBody() {
		return this.body;
	}

	public void setBody(JourneySchemaUpdateRequest body) {
		this.body = body;
	}

	public PutJourneyExternaleventsSchemaRequest withBody(JourneySchemaUpdateRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutJourneyExternaleventsSchemaRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<JourneySchemaUpdateRequest> withHttpInfo() {
        
        // verify the required parameter 'schemaId' is set
        if (this.schemaId == null) {
            throw new IllegalStateException("Missing the required parameter 'schemaId' when building request for PutJourneyExternaleventsSchemaRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutJourneyExternaleventsSchemaRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/journey/externalevents/schemas/{schemaId}")
	...
	public static Builder builder(String schemaId, JourneySchemaUpdateRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PutJourneyExternaleventsSchemaRequest request;

		private Builder() {
			request = new PutJourneyExternaleventsSchemaRequest();
		}
		...
		public Builder withBody(JourneySchemaUpdateRequest body) {
		...
		public Builder withRequiredParams(String schemaId, JourneySchemaUpdateRequest body) {
			request.setSchemaId(schemaId);
			request.setBody(body);
		...
		public PutJourneyExternaleventsSchemaRequest build() {
