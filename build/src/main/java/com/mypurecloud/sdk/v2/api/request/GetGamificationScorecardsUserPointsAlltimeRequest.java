...
public class GetGamificationScorecardsUserPointsAlltimeRequest {
	...
	public GetGamificationScorecardsUserPointsAlltimeRequest withUserId(String userId) {
	...
	public GetGamificationScorecardsUserPointsAlltimeRequest withEndWorkday(LocalDate endWorkday) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.userId == null) {
            throw new IllegalStateException("Missing the required parameter 'userId' when building request for GetGamificationScorecardsUserPointsAlltimeRequest.");
        }
        
        // verify the required parameter 'endWorkday' is set
        if (this.endWorkday == null) {
            throw new IllegalStateException("Missing the required parameter 'endWorkday' when building request for GetGamificationScorecardsUserPointsAlltimeRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/gamification/scorecards/users/{userId}/points/alltime")
	...
	public static Builder builder(String userId, LocalDate endWorkday) {
	    return new Builder()
	            .withRequiredParams(userId, endWorkday);
	}
	

	public static class Builder {
		private final GetGamificationScorecardsUserPointsAlltimeRequest request;

		private Builder() {
			request = new GetGamificationScorecardsUserPointsAlltimeRequest();
		}
		...
		public Builder withRequiredParams(String userId, LocalDate endWorkday) {
			request.setUserId(userId);
						request.setEndWorkday(endWorkday);
		...
		public GetGamificationScorecardsUserPointsAlltimeRequest build() {
