...
public class GetOrgauthorizationTrustorGroupsRequest {
	...
	public GetOrgauthorizationTrustorGroupsRequest withTrustorOrgId(String trustorOrgId) {
	...
	public GetOrgauthorizationTrustorGroupsRequest withPageSize(Integer pageSize) {
	...
	public GetOrgauthorizationTrustorGroupsRequest withPageNumber(Integer pageNumber) {
    ...
    public GetOrgauthorizationTrustorGroupsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.trustorOrgId == null) {
            throw new IllegalStateException("Missing the required parameter 'trustorOrgId' when building request for GetOrgauthorizationTrustorGroupsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/orgauthorization/trustors/{trustorOrgId}/groups")
	...
	public static class Builder {
		private final GetOrgauthorizationTrustorGroupsRequest request;

		private Builder() {
			request = new GetOrgauthorizationTrustorGroupsRequest();
		}
		...
		public GetOrgauthorizationTrustorGroupsRequest build() {
