...
public class GetTelephonyProvidersEdgesSiteOutboundroutesRequest {
	...
	public GetTelephonyProvidersEdgesSiteOutboundroutesRequest withExternalTrunkBasesIds(String externalTrunkBasesIds) {
    ...
    public GetTelephonyProvidersEdgesSiteOutboundroutesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.siteId == null) {
            throw new IllegalStateException("Missing the required parameter 'siteId' when building request for GetTelephonyProvidersEdgesSiteOutboundroutesRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/telephony/providers/edges/sites/{siteId}/outboundroutes")
	...
	public static class Builder {
		private final GetTelephonyProvidersEdgesSiteOutboundroutesRequest request;

		private Builder() {
			request = new GetTelephonyProvidersEdgesSiteOutboundroutesRequest();
		}
