...
public class PutIntegrationsSpeechTtsSettingsRequest {
    
	private TtsSettings body;
	public TtsSettings getBody() {
		return this.body;
	}

	public void setBody(TtsSettings body) {
		this.body = body;
	}

	public PutIntegrationsSpeechTtsSettingsRequest withBody(TtsSettings body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutIntegrationsSpeechTtsSettingsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<TtsSettings> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutIntegrationsSpeechTtsSettingsRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/integrations/speech/tts/settings")
                .withBody(body)
	...
	public static Builder builder(TtsSettings body) {
	    return new Builder()
	...
	public static class Builder {
		private final PutIntegrationsSpeechTtsSettingsRequest request;

		private Builder() {
			request = new PutIntegrationsSpeechTtsSettingsRequest();
		}

		
		public Builder withBody(TtsSettings body) {
		...
		public Builder withRequiredParams(TtsSettings body) {
			request.setBody(body);
		...
		public PutIntegrationsSpeechTtsSettingsRequest build() {
