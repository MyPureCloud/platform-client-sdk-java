...
public class GetConversationParticipantSecureivrsessionRequest {
	...
	public GetConversationParticipantSecureivrsessionRequest withConversationId(String conversationId) {
	...
	public GetConversationParticipantSecureivrsessionRequest withParticipantId(String participantId) {
	...
	public GetConversationParticipantSecureivrsessionRequest withSecureSessionId(String secureSessionId) {
	    this.setSecureSessionId(secureSessionId);
	    return this;
	} 
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for GetConversationParticipantSecureivrsessionRequest.");
        }
        
        // verify the required parameter 'participantId' is set
        if (this.participantId == null) {
            throw new IllegalStateException("Missing the required parameter 'participantId' when building request for GetConversationParticipantSecureivrsessionRequest.");
        }
        
        // verify the required parameter 'secureSessionId' is set
        if (this.secureSessionId == null) {
            throw new IllegalStateException("Missing the required parameter 'secureSessionId' when building request for GetConversationParticipantSecureivrsessionRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/conversations/{conversationId}/participants/{participantId}/secureivrsessions/{secureSessionId}")
                .withPathParameter("conversationId", conversationId)
        
                .withPathParameter("participantId", participantId)
        
                .withPathParameter("secureSessionId", secureSessionId)
	...
	public static Builder builder(String conversationId, String participantId, String secureSessionId) {
	    return new Builder()
	            .withRequiredParams(conversationId, participantId, secureSessionId);
	}
	

	public static class Builder {
		private final GetConversationParticipantSecureivrsessionRequest request;

		private Builder() {
			request = new GetConversationParticipantSecureivrsessionRequest();
		}
		...
		public Builder withSecureSessionId(String secureSessionId) {
			request.setSecureSessionId(secureSessionId);
			return this;
		}
		

		
		public Builder withRequiredParams(String conversationId, String participantId, String secureSessionId) {
			request.setConversationId(conversationId);
						request.setParticipantId(participantId);
						request.setSecureSessionId(secureSessionId);
		...
		public GetConversationParticipantSecureivrsessionRequest build() {
            ...
            // verify the required parameter 'secureSessionId' is set
            if (request.secureSessionId == null) {
                throw new IllegalStateException("Missing the required parameter 'secureSessionId' when building request for GetConversationParticipantSecureivrsessionRequest.");
            }
