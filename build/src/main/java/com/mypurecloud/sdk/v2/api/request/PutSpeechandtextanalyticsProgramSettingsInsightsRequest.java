...
public class PutSpeechandtextanalyticsProgramSettingsInsightsRequest {
	...
	public PutSpeechandtextanalyticsProgramSettingsInsightsRequest withProgramId(String programId) {
	    this.setProgramId(programId);
	    return this;
	} 

	private InsightsSettingsRequest body;
	public InsightsSettingsRequest getBody() {
		return this.body;
	}

	public void setBody(InsightsSettingsRequest body) {
		this.body = body;
	}
    ...
    public ApiRequest<InsightsSettingsRequest> withHttpInfo() {
        
        // verify the required parameter 'programId' is set
        if (this.programId == null) {
            throw new IllegalStateException("Missing the required parameter 'programId' when building request for PutSpeechandtextanalyticsProgramSettingsInsightsRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutSpeechandtextanalyticsProgramSettingsInsightsRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/speechandtextanalytics/programs/{programId}/settings/insights")
	...
	public static Builder builder(String programId, InsightsSettingsRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PutSpeechandtextanalyticsProgramSettingsInsightsRequest request;

		private Builder() {
			request = new PutSpeechandtextanalyticsProgramSettingsInsightsRequest();
		}
		...
		public Builder withBody(InsightsSettingsRequest body) {
		...
		public Builder withRequiredParams(String programId, InsightsSettingsRequest body) {
			request.setProgramId(programId);
			request.setBody(body);
		...
		public PutSpeechandtextanalyticsProgramSettingsInsightsRequest build() {
