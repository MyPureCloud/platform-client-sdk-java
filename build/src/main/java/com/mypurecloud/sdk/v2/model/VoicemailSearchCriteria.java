...
public class VoicemailSearchCriteria  implements Serializable {
 ...
 @JsonDeserialize(using = OperatorEnumDeserializer.class)
  ...
  private List<VoicemailSearchCriteria> group = null;
 ...
 @JsonDeserialize(using = TypeEnumDeserializer.class)
  ...
  public VoicemailSearchCriteria() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
      values = new ArrayList<String>();
      group = new ArrayList<VoicemailSearchCriteria>();
      fields = new ArrayList<String>();
    }
  }

  public VoicemailSearchCriteria(Boolean initWithEmptyList) {
   ...
   **/
  public VoicemailSearchCriteria values(List<String> values) {
    this.values = values;
    return this;
  }
   ...
   **/
  public VoicemailSearchCriteria group(List<VoicemailSearchCriteria> group) {
    this.group = group;
    return this;
  }
  ...
  @JsonProperty("group")
  public List<VoicemailSearchCriteria> getGroup() {
    return group;
  }
  public void setGroup(List<VoicemailSearchCriteria> group) {
    this.group = group;
  }
   ...
   **/
  public VoicemailSearchCriteria dateFormat(String dateFormat) {
