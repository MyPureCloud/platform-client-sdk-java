...
public class GetRoutingQueueComparisonperiodsRequest {
	...
	public GetRoutingQueueComparisonperiodsRequest withQueueId(String queueId) {
    ...
    public GetRoutingQueueComparisonperiodsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.queueId == null) {
            throw new IllegalStateException("Missing the required parameter 'queueId' when building request for GetRoutingQueueComparisonperiodsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/routing/queues/{queueId}/comparisonperiods")
	...
	public static class Builder {
		private final GetRoutingQueueComparisonperiodsRequest request;

		private Builder() {
			request = new GetRoutingQueueComparisonperiodsRequest();
		}
		...
		public GetRoutingQueueComparisonperiodsRequest build() {
