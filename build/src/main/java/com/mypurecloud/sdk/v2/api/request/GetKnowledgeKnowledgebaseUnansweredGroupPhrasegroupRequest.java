...
public class GetKnowledgeKnowledgebaseUnansweredGroupPhrasegroupRequest {
	...
	public GetKnowledgeKnowledgebaseUnansweredGroupPhrasegroupRequest withKnowledgeBaseId(String knowledgeBaseId) {
	...
	public GetKnowledgeKnowledgebaseUnansweredGroupPhrasegroupRequest withGroupId(String groupId) {
	...
	public GetKnowledgeKnowledgebaseUnansweredGroupPhrasegroupRequest withPhraseGroupId(String phraseGroupId) {
	...
	public GetKnowledgeKnowledgebaseUnansweredGroupPhrasegroupRequest withApp(String app) {
	    this.setApp(app);
	    return this;
	} 
	...
	public GetKnowledgeKnowledgebaseUnansweredGroupPhrasegroupRequest withDateStart(LocalDate dateStart) {
	...
	public GetKnowledgeKnowledgebaseUnansweredGroupPhrasegroupRequest withDateEnd(LocalDate dateEnd) {
    ...
    public GetKnowledgeKnowledgebaseUnansweredGroupPhrasegroupRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/unanswered/groups/{groupId}/phrasegroups/{phraseGroupId}")
	...
	public static Builder builder(String knowledgeBaseId, String groupId, String phraseGroupId) {
	    return new Builder()
	            .withRequiredParams(knowledgeBaseId, groupId, phraseGroupId);
	}
	...
	public static class Builder {
		...
		private Builder() {
			request = new GetKnowledgeKnowledgebaseUnansweredGroupPhrasegroupRequest();
		}
		...
		public Builder withRequiredParams(String knowledgeBaseId, String groupId, String phraseGroupId) {
			request.setKnowledgeBaseId(knowledgeBaseId);
			request.setGroupId(groupId);
			request.setPhraseGroupId(phraseGroupId);
