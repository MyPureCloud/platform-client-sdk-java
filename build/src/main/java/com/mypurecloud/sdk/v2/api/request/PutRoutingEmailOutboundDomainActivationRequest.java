...
public class PutRoutingEmailOutboundDomainActivationRequest {
	...
	public PutRoutingEmailOutboundDomainActivationRequest withDomainId(String domainId) {
    ...
    public PutRoutingEmailOutboundDomainActivationRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.domainId == null) {
            throw new IllegalStateException("Missing the required parameter 'domainId' when building request for PutRoutingEmailOutboundDomainActivationRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/routing/email/outbound/domains/{domainId}/activation")
	...
	public static class Builder {
		private final PutRoutingEmailOutboundDomainActivationRequest request;

		private Builder() {
			request = new PutRoutingEmailOutboundDomainActivationRequest();
		}
		...
		public PutRoutingEmailOutboundDomainActivationRequest build() {
