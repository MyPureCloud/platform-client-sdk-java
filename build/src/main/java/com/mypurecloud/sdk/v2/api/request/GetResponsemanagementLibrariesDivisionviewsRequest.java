...
public class GetResponsemanagementLibrariesDivisionviewsRequest {
	...
	public GetResponsemanagementLibrariesDivisionviewsRequest withPageNumber(Integer pageNumber) {
	...
	public GetResponsemanagementLibrariesDivisionviewsRequest withPageSize(Integer pageSize) {
	...
	public GetResponsemanagementLibrariesDivisionviewsRequest withMessagingTemplateFilter(String messagingTemplateFilter) {
	...
	public GetResponsemanagementLibrariesDivisionviewsRequest withLibraryPrefix(String libraryPrefix) {
    ...
    public GetResponsemanagementLibrariesDivisionviewsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/responsemanagement/libraries/divisionviews")
	...
	public static class Builder {
		private final GetResponsemanagementLibrariesDivisionviewsRequest request;

		private Builder() {
			request = new GetResponsemanagementLibrariesDivisionviewsRequest();
		}
		...
		public GetResponsemanagementLibrariesDivisionviewsRequest build() {
