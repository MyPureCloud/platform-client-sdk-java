...
public class DeleteExternalcontactsSettingsRequest {
    ...
    public DeleteExternalcontactsSettingsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("DELETE", "/api/v2/externalcontacts/settings")
	...
	public static class Builder {
		private final DeleteExternalcontactsSettingsRequest request;

		private Builder() {
			request = new DeleteExternalcontactsSettingsRequest();
		}
		...
		public DeleteExternalcontactsSettingsRequest build() {
