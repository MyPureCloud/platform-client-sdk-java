...
public class PutUserStationDefaultstationStationIdRequest {
	...
	public PutUserStationDefaultstationStationIdRequest withUserId(String userId) {
	...
	public PutUserStationDefaultstationStationIdRequest withStationId(String stationId) {
    ...
    public PutUserStationDefaultstationStationIdRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.userId == null) {
            throw new IllegalStateException("Missing the required parameter 'userId' when building request for PutUserStationDefaultstationStationIdRequest.");
        }
        
        // verify the required parameter 'stationId' is set
        if (this.stationId == null) {
            throw new IllegalStateException("Missing the required parameter 'stationId' when building request for PutUserStationDefaultstationStationIdRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/users/{userId}/station/defaultstation/{stationId}")
