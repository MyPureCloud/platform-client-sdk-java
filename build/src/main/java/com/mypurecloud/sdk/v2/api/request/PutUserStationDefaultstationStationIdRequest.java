...
public class PutUserStationDefaultstationStationIdRequest {
    ...
    public ApiRequest<Void> withHttpInfo() throws ApiException {
        ...
        if (this.userId == null) {
            throw new ApiException(400, "Missing the required parameter 'userId' when building request for PutUserStationDefaultstationStationIdRequest.");
        }
        
        // verify the required parameter 'stationId' is set
        if (this.stationId == null) {
            throw new ApiException(400, "Missing the required parameter 'stationId' when building request for PutUserStationDefaultstationStationIdRequest.");
        }
