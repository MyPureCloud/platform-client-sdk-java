...
public class GetCasemanagementCaseCommentRequest {
	...
	public GetCasemanagementCaseCommentRequest withCaseId(String caseId) {
	...
	public GetCasemanagementCaseCommentRequest withCommentId(String commentId) {
    ...
    public GetCasemanagementCaseCommentRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.caseId == null) {
            throw new IllegalStateException("Missing the required parameter 'caseId' when building request for GetCasemanagementCaseCommentRequest.");
        }
        
        // verify the required parameter 'commentId' is set
        if (this.commentId == null) {
            throw new IllegalStateException("Missing the required parameter 'commentId' when building request for GetCasemanagementCaseCommentRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/casemanagement/cases/{caseId}/comments/{commentId}")
	...
	public static class Builder {
		private final GetCasemanagementCaseCommentRequest request;

		private Builder() {
			request = new GetCasemanagementCaseCommentRequest();
		}
		...
		public GetCasemanagementCaseCommentRequest build() {
