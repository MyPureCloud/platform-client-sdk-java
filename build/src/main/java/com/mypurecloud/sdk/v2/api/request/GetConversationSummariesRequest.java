...
public class GetConversationSummariesRequest {
	...
	public GetConversationSummariesRequest withConversationId(String conversationId) {
    ...
    public GetConversationSummariesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for GetConversationSummariesRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/conversations/{conversationId}/summaries")
	...
	public static class Builder {
		private final GetConversationSummariesRequest request;

		private Builder() {
			request = new GetConversationSummariesRequest();
		}
		...
		public GetConversationSummariesRequest build() {
