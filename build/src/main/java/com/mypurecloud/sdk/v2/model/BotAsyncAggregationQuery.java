...
import com.fasterxml.jackson.annotation.JsonValue;
import com.mypurecloud.sdk.v2.model.BotAggregateQueryFilter;
import com.mypurecloud.sdk.v2.model.BotAggregationSort;
import com.mypurecloud.sdk.v2.model.BotAggregationView;
...
public class BotAsyncAggregationQuery  implements Serializable {
 ...
 @JsonDeserialize(using = QueryTypeEnumDeserializer.class)
  ...
  private BotAggregationSort sortMetric = null;
  ...
  public BotAsyncAggregationQuery() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
      ...
      views = new ArrayList<BotAggregationView>();
    }
  }

  public BotAsyncAggregationQuery(Boolean initWithEmptyList) {
   ...
   **/
  public BotAsyncAggregationQuery interval(String interval) {
   ...
   **/
  public BotAsyncAggregationQuery granularity(String granularity) {
   ...
   **/
  public BotAsyncAggregationQuery timeZone(String timeZone) {
   ...
   **/
  public BotAsyncAggregationQuery groupBy(List<GroupByEnum> groupBy) {
   ...
   **/
  public BotAsyncAggregationQuery filter(BotAggregateQueryFilter filter) {
    this.filter = filter;
    return this;
  }
  ...
  @JsonProperty("filter")
  public BotAggregateQueryFilter getFilter() {
    return filter;
  }
  public void setFilter(BotAggregateQueryFilter filter) {
    this.filter = filter;
  }
   ...
   **/
  public BotAsyncAggregationQuery metrics(List<MetricsEnum> metrics) {
   ...
   **/
  public BotAsyncAggregationQuery flattenMultivaluedDimensions(Boolean flattenMultivaluedDimensions) {
   ...
   **/
  public BotAsyncAggregationQuery views(List<BotAggregationView> views) {
    this.views = views;
    return this;
  }
  ...
  @JsonProperty("views")
  public List<BotAggregationView> getViews() {
    return views;
  }
  public void setViews(List<BotAggregationView> views) {
    this.views = views;
  }
   ...
   * Dimension to use as the alternative timestamp for data in the aggregate.  Choosing \"eventTime\" uses the actual time of the data event.
   **/
  public BotAsyncAggregationQuery alternateTimeDimension(AlternateTimeDimensionEnum alternateTimeDimension) {
   ...
   * Query type to use. Use groupBy for all matching results, and topN/bottomN for N results ordered by the sortMetric. Default is groupBy.
   **/
  public BotAsyncAggregationQuery queryType(QueryTypeEnum queryType) {
   ...
   **/
  public BotAsyncAggregationQuery sortMetric(BotAggregationSort sortMetric) {
  ...
  public BotAggregationSort getSortMetric() {
    return sortMetric;
  }
  public void setSortMetric(BotAggregationSort sortMetric) {
    this.sortMetric = sortMetric;
  }
   ...
   **/
  public BotAsyncAggregationQuery limit(Integer limit) {
    this.limit = limit;
    return this;
  }
   ...
   **/
  public BotAsyncAggregationQuery pageSize(Integer pageSize) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    BotAsyncAggregationQuery botAsyncAggregationQuery = (BotAsyncAggregationQuery) o;

    return Objects.equals(this.interval, botAsyncAggregationQuery.interval) &&
            Objects.equals(this.granularity, botAsyncAggregationQuery.granularity) &&
            Objects.equals(this.timeZone, botAsyncAggregationQuery.timeZone) &&
            Objects.equals(this.groupBy, botAsyncAggregationQuery.groupBy) &&
            Objects.equals(this.filter, botAsyncAggregationQuery.filter) &&
            Objects.equals(this.metrics, botAsyncAggregationQuery.metrics) &&
            Objects.equals(this.flattenMultivaluedDimensions, botAsyncAggregationQuery.flattenMultivaluedDimensions) &&
            Objects.equals(this.views, botAsyncAggregationQuery.views) &&
            Objects.equals(this.alternateTimeDimension, botAsyncAggregationQuery.alternateTimeDimension) &&
            Objects.equals(this.queryType, botAsyncAggregationQuery.queryType) &&
            Objects.equals(this.sortMetric, botAsyncAggregationQuery.sortMetric) &&
            Objects.equals(this.limit, botAsyncAggregationQuery.limit) &&
            Objects.equals(this.pageSize, botAsyncAggregationQuery.pageSize);
  }
