...
public class ReprocessJobEntityListingResponse  implements Serializable, PagedResource<ReprocessJobResponse> {
  
  private List<ReprocessJobResponse> entities = null;
  ...
  /**
   **/
  public ReprocessJobEntityListingResponse entities(List<ReprocessJobResponse> entities) {
  ...
  public List<ReprocessJobResponse> getEntities() {
    return entities;
  }
  public void setEntities(List<ReprocessJobResponse> entities) {
    this.entities = entities;
  }
  ...
  /**
   **/
  public ReprocessJobEntityListingResponse pageSize(Integer pageSize) {
  ...
  /**
   **/
  public ReprocessJobEntityListingResponse pageNumber(Integer pageNumber) {
  ...
  /**
   **/
  public ReprocessJobEntityListingResponse total(Long total) {
    this.total = total;
    return this;
  }
   ...
   **/
  public ReprocessJobEntityListingResponse queueTotal(Integer queueTotal) {
    this.queueTotal = queueTotal;
    return this;
  }
  
  @ApiModelProperty(example = "null", required = true, value = "The total number of queued jobs.")
  ...
  /**
   **/
  public ReprocessJobEntityListingResponse nextUri(String nextUri) {
  ...
  /**
   **/
  public ReprocessJobEntityListingResponse pageCount(Integer pageCount) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ReprocessJobEntityListingResponse reprocessJobEntityListingResponse = (ReprocessJobEntityListingResponse) o;

    return Objects.equals(this.entities, reprocessJobEntityListingResponse.entities) &&
            Objects.equals(this.pageSize, reprocessJobEntityListingResponse.pageSize) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(entities, pageSize, pageNumber, total, queueTotal, firstUri, nextUri, previousUri, lastUri, selfUri, pageCount);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ReprocessJobEntityListingResponse {\n");
