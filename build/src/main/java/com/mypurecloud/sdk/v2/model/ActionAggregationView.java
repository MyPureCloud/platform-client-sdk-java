...
public class ActionAggregationView  implements Serializable {
 ...
 @JsonDeserialize(using = FunctionEnumDeserializer.class)
   ...
   * Target metric name
   **/
  public ActionAggregationView target(TargetEnum target) {
    this.target = target;
    return this;
  }
   ...
   **/
  public ActionAggregationView name(String name) {
    this.name = name;
    return this;
  }
   ...
   * Type of view you wish to create
   **/
  public ActionAggregationView function(FunctionEnum function) {
   ...
   **/
  public ActionAggregationView range(AggregationRange range) {
    this.range = range;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ActionAggregationView actionAggregationView = (ActionAggregationView) o;

    return Objects.equals(this.target, actionAggregationView.target) &&
            Objects.equals(this.name, actionAggregationView.name) &&
            Objects.equals(this.function, actionAggregationView.function) &&
            Objects.equals(this.range, actionAggregationView.range);
  }
