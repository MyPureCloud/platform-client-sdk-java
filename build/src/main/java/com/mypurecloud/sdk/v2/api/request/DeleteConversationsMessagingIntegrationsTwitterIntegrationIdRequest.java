...
public class DeleteConversationsMessagingIntegrationsTwitterIntegrationIdRequest {
	...
	public DeleteConversationsMessagingIntegrationsTwitterIntegrationIdRequest withIntegrationId(String integrationId) {
    ...
    public DeleteConversationsMessagingIntegrationsTwitterIntegrationIdRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.integrationId == null) {
            throw new IllegalStateException("Missing the required parameter 'integrationId' when building request for DeleteConversationsMessagingIntegrationsTwitterIntegrationIdRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/conversations/messaging/integrations/twitter/{integrationId}")
	...
	public static class Builder {
		private final DeleteConversationsMessagingIntegrationsTwitterIntegrationIdRequest request;

		private Builder() {
			request = new DeleteConversationsMessagingIntegrationsTwitterIntegrationIdRequest();
		}
		...
		public DeleteConversationsMessagingIntegrationsTwitterIntegrationIdRequest build() {
