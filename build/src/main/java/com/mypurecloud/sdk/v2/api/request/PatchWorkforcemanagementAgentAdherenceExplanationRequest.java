...
public class PatchWorkforcemanagementAgentAdherenceExplanationRequest {
	...
	public PatchWorkforcemanagementAgentAdherenceExplanationRequest withAgentId(String agentId) {
	...
	public PatchWorkforcemanagementAgentAdherenceExplanationRequest withExplanationId(String explanationId) {
	    this.setExplanationId(explanationId);
	    return this;
	} 
	...
	public void setBody(UpdateAdherenceExplanationStatusRequest body) {
		this.body = body;
	}

	public PatchWorkforcemanagementAgentAdherenceExplanationRequest withBody(UpdateAdherenceExplanationStatusRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchWorkforcemanagementAgentAdherenceExplanationRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<UpdateAdherenceExplanationStatusRequest> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("PATCH", "/api/v2/workforcemanagement/agents/{agentId}/adherence/explanations/{explanationId}")
                .withPathParameter("agentId", agentId)
        
                .withPathParameter("explanationId", explanationId)
	...
	public static Builder builder(String agentId, String explanationId, UpdateAdherenceExplanationStatusRequest body) {
	    return new Builder()
	            .withRequiredParams(agentId, explanationId, body);
	}
	...
	public static class Builder {
		...
		private Builder() {
			request = new PatchWorkforcemanagementAgentAdherenceExplanationRequest();
		}
		...
		public Builder withExplanationId(String explanationId) {
			request.setExplanationId(explanationId);
			return this;
		}

		public Builder withBody(UpdateAdherenceExplanationStatusRequest body) {
		...
		public Builder withRequiredParams(String agentId, String explanationId, UpdateAdherenceExplanationStatusRequest body) {
			request.setAgentId(agentId);
			request.setExplanationId(explanationId);
			request.setBody(body);
