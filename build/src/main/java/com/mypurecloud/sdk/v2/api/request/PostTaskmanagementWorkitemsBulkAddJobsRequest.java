...
public class PostTaskmanagementWorkitemsBulkAddJobsRequest {

	private BulkJobAddRequest body;
	public BulkJobAddRequest getBody() {
		return this.body;
	}

	public void setBody(BulkJobAddRequest body) {
		this.body = body;
	}

	public PostTaskmanagementWorkitemsBulkAddJobsRequest withBody(BulkJobAddRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostTaskmanagementWorkitemsBulkAddJobsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<BulkJobAddRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostTaskmanagementWorkitemsBulkAddJobsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/taskmanagement/workitems/bulk/add/jobs")
                .withBody(body)
	...
	public static Builder builder(BulkJobAddRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostTaskmanagementWorkitemsBulkAddJobsRequest request;

		private Builder() {
			request = new PostTaskmanagementWorkitemsBulkAddJobsRequest();
		}


		public Builder withBody(BulkJobAddRequest body) {
		...
		public Builder withRequiredParams(BulkJobAddRequest body) {
			request.setBody(body);
		...
		public PostTaskmanagementWorkitemsBulkAddJobsRequest build() {
