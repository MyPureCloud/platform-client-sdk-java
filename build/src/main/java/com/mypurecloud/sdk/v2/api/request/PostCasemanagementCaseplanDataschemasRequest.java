...
public class PostCasemanagementCaseplanDataschemasRequest {
	...
	public PostCasemanagementCaseplanDataschemasRequest withCaseplanId(String caseplanId) {
	...
	public PostCasemanagementCaseplanDataschemasRequest withBody(CaseplanDataSchemaRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostCasemanagementCaseplanDataschemasRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<CaseplanDataSchemaRequest> withHttpInfo() {
        ...
        if (this.caseplanId == null) {
            throw new IllegalStateException("Missing the required parameter 'caseplanId' when building request for PostCasemanagementCaseplanDataschemasRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostCasemanagementCaseplanDataschemasRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/casemanagement/caseplans/{caseplanId}/dataschemas")
	...
	public static Builder builder(String caseplanId, CaseplanDataSchemaRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostCasemanagementCaseplanDataschemasRequest request;

		private Builder() {
			request = new PostCasemanagementCaseplanDataschemasRequest();
		}
		...
		public Builder withRequiredParams(String caseplanId, CaseplanDataSchemaRequest body) {
			request.setCaseplanId(caseplanId);
			request.setBody(body);
		...
		public PostCasemanagementCaseplanDataschemasRequest build() {
