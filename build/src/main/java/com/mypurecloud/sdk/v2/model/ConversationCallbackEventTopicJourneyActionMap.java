...
public class ConversationCallbackEventTopicJourneyActionMap  implements Serializable {
  ...
  public ConversationCallbackEventTopicJourneyActionMap() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
    }
  }

  public ConversationCallbackEventTopicJourneyActionMap(Boolean initWithEmptyList) {
   ...
   **/
  public ConversationCallbackEventTopicJourneyActionMap id(String id) {
    this.id = id;
    return this;
  }
   ...
   **/
  public ConversationCallbackEventTopicJourneyActionMap version(Long version) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ConversationCallbackEventTopicJourneyActionMap conversationCallbackEventTopicJourneyActionMap = (ConversationCallbackEventTopicJourneyActionMap) o;

    return Objects.equals(this.id, conversationCallbackEventTopicJourneyActionMap.id) &&
            Objects.equals(this.version, conversationCallbackEventTopicJourneyActionMap.version);
  }
