...
public class TextMessageListing  implements Serializable, PagedResource<MessageData> {
  
  private List<MessageData> entities = new ArrayList<MessageData>();
  ...
  /**
   **/
  public TextMessageListing entities(List<MessageData> entities) {
  ...
  public List<MessageData> getEntities() {
    return entities;
  }
  public void setEntities(List<MessageData> entities) {
    this.entities = entities;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(entities, pageSize, pageNumber, total, firstUri, selfUri, pageCount, lastUri, nextUri, previousUri);
  }
