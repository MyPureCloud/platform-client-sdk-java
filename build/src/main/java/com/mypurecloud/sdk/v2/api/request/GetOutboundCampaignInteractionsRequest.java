...
public class GetOutboundCampaignInteractionsRequest {
	...
	public GetOutboundCampaignInteractionsRequest withCampaignId(String campaignId) {
    ...
    public GetOutboundCampaignInteractionsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() throws ApiException {
        ...
        if (this.campaignId == null) {
            throw new ApiException(400, "Missing the required parameter 'campaignId' when building request for GetOutboundCampaignInteractionsRequest.");
        }
