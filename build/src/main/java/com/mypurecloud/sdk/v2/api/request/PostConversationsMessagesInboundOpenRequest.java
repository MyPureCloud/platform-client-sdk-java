...
public class PostConversationsMessagesInboundOpenRequest {
    
	private OpenNormalizedMessage body;
	public OpenNormalizedMessage getBody() {
		return this.body;
	}

	public void setBody(OpenNormalizedMessage body) {
		this.body = body;
	}

	public PostConversationsMessagesInboundOpenRequest withBody(OpenNormalizedMessage body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostConversationsMessagesInboundOpenRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<OpenNormalizedMessage> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostConversationsMessagesInboundOpenRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/conversations/messages/inbound/open")
                .withBody(body)
	...
	public static Builder builder(OpenNormalizedMessage body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostConversationsMessagesInboundOpenRequest request;

		private Builder() {
			request = new PostConversationsMessagesInboundOpenRequest();
		}

		
		public Builder withBody(OpenNormalizedMessage body) {
		...
		public Builder withRequiredParams(OpenNormalizedMessage body) {
			request.setBody(body);
		...
		public PostConversationsMessagesInboundOpenRequest build() {
