...
public class PutUsersMeVerifierRequest {
	...
	public PutUsersMeVerifierRequest withVerifierId(String verifierId) {
	...
	public PutUsersMeVerifierRequest withBody(UpdateVerifierRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutUsersMeVerifierRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<UpdateVerifierRequest> withHttpInfo() {
        ...
        if (this.verifierId == null) {
            throw new IllegalStateException("Missing the required parameter 'verifierId' when building request for PutUsersMeVerifierRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutUsersMeVerifierRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/users/me/verifiers/{verifierId}")
                .withPathParameter("verifierId", verifierId)
	...
	public static Builder builder(String verifierId, UpdateVerifierRequest body) {
	    return new Builder()
	            .withRequiredParams(verifierId, body);
	}


	public static class Builder {
		private final PutUsersMeVerifierRequest request;

		private Builder() {
			request = new PutUsersMeVerifierRequest();
		}
		...
		public Builder withRequiredParams(String verifierId, UpdateVerifierRequest body) {
			request.setVerifierId(verifierId);
			request.setBody(body);
		...
		public PutUsersMeVerifierRequest build() {
