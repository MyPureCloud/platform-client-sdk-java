...
public class PostConversationsEmailsRequest {
	...
	public void setBody(CreateEmailRequest body) {
		this.body = body;
	}

	public PostConversationsEmailsRequest withBody(CreateEmailRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostConversationsEmailsRequest withCustomHeader(String name, String value) {
