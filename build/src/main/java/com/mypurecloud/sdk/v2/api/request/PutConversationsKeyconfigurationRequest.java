...
public class PutConversationsKeyconfigurationRequest {

	private String keyconfigurationsId;
	public String getKeyconfigurationsId() {
		return this.keyconfigurationsId;
	}

	public void setKeyconfigurationsId(String keyconfigurationsId) {
		this.keyconfigurationsId = keyconfigurationsId;
	}

	public PutConversationsKeyconfigurationRequest withKeyconfigurationsId(String keyconfigurationsId) {
	    this.setKeyconfigurationsId(keyconfigurationsId);
	    return this;
	} 

	private ConversationEncryptionConfiguration body;
	public ConversationEncryptionConfiguration getBody() {
		return this.body;
	}

	public void setBody(ConversationEncryptionConfiguration body) {
		this.body = body;
	}

	public PutConversationsKeyconfigurationRequest withBody(ConversationEncryptionConfiguration body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutConversationsKeyconfigurationRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<ConversationEncryptionConfiguration> withHttpInfo() {
        
        // verify the required parameter 'keyconfigurationsId' is set
        if (this.keyconfigurationsId == null) {
            throw new IllegalStateException("Missing the required parameter 'keyconfigurationsId' when building request for PutConversationsKeyconfigurationRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutConversationsKeyconfigurationRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/conversations/keyconfigurations/{keyconfigurationsId}")
                .withPathParameter("keyconfigurationsId", keyconfigurationsId)
	...
	public static Builder builder(String keyconfigurationsId, ConversationEncryptionConfiguration body) {
	    return new Builder()
	            .withRequiredParams(keyconfigurationsId, body);
	}


	public static class Builder {
		private final PutConversationsKeyconfigurationRequest request;

		private Builder() {
			request = new PutConversationsKeyconfigurationRequest();
		}


		public Builder withKeyconfigurationsId(String keyconfigurationsId) {
			request.setKeyconfigurationsId(keyconfigurationsId);
			return this;
		}

		public Builder withBody(ConversationEncryptionConfiguration body) {
		...
		public Builder withRequiredParams(String keyconfigurationsId, ConversationEncryptionConfiguration body) {
			request.setKeyconfigurationsId(keyconfigurationsId);
			request.setBody(body);
		...
		public PutConversationsKeyconfigurationRequest build() {
            
            // verify the required parameter 'keyconfigurationsId' is set
            if (request.keyconfigurationsId == null) {
                throw new IllegalStateException("Missing the required parameter 'keyconfigurationsId' when building request for PutConversationsKeyconfigurationRequest.");
            }
