...
public class DeleteUserStationAssociatedstationRequest {
	...
	public DeleteUserStationAssociatedstationRequest withUserId(String userId) {
    ...
    public DeleteUserStationAssociatedstationRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.userId == null) {
            throw new IllegalStateException("Missing the required parameter 'userId' when building request for DeleteUserStationAssociatedstationRequest.");
        }
