...
public class GetOutboundDigitalrulesetRequest {
	...
	public GetOutboundDigitalrulesetRequest withDigitalRuleSetId(String digitalRuleSetId) {
    ...
    public GetOutboundDigitalrulesetRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.digitalRuleSetId == null) {
            throw new IllegalStateException("Missing the required parameter 'digitalRuleSetId' when building request for GetOutboundDigitalrulesetRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/outbound/digitalrulesets/{digitalRuleSetId}")
	...
	public static class Builder {
		private final GetOutboundDigitalrulesetRequest request;

		private Builder() {
			request = new GetOutboundDigitalrulesetRequest();
		}
		...
		public GetOutboundDigitalrulesetRequest build() {
