...
public class PutFlowsInstancesSettingsLoglevelsDefaultRequest {
	...
	public PutFlowsInstancesSettingsLoglevelsDefaultRequest withBody(FlowLogLevelRequest body) {
	    this.setBody(body);
	    return this;
	} 
	...
	public PutFlowsInstancesSettingsLoglevelsDefaultRequest withExpand(List<String> expand) {
    ...
    public PutFlowsInstancesSettingsLoglevelsDefaultRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<FlowLogLevelRequest> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutFlowsInstancesSettingsLoglevelsDefaultRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/flows/instances/settings/loglevels/default")
	...
	public static Builder builder(FlowLogLevelRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PutFlowsInstancesSettingsLoglevelsDefaultRequest request;

		private Builder() {
			request = new PutFlowsInstancesSettingsLoglevelsDefaultRequest();
		}
		...
		public Builder withRequiredParams(FlowLogLevelRequest body) {
			request.setBody(body);
		...
		public PutFlowsInstancesSettingsLoglevelsDefaultRequest build() {
