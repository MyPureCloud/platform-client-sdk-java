...
public class DeleteWorkforcemanagementBusinessunitRequest {
	...
	public DeleteWorkforcemanagementBusinessunitRequest withBusinessUnitId(String businessUnitId) {
    ...
    public DeleteWorkforcemanagementBusinessunitRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for DeleteWorkforcemanagementBusinessunitRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/workforcemanagement/businessunits/{businessUnitId}")
	...
	public static class Builder {
		private final DeleteWorkforcemanagementBusinessunitRequest request;

		private Builder() {
			request = new DeleteWorkforcemanagementBusinessunitRequest();
		}
		...
		public DeleteWorkforcemanagementBusinessunitRequest build() {
