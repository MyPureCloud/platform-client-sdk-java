...
public class GetWorkforcemanagementManagementunitSchedulingRunResultRequest {
	...
	public GetWorkforcemanagementManagementunitSchedulingRunResultRequest withManagementUnitId(String managementUnitId) {
	...
	public GetWorkforcemanagementManagementunitSchedulingRunResultRequest withRunId(String runId) {
	    this.setRunId(runId);
	    return this;
	} 
    ...
    public GetWorkforcemanagementManagementunitSchedulingRunResultRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.managementUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'managementUnitId' when building request for GetWorkforcemanagementManagementunitSchedulingRunResultRequest.");
        }
        
        // verify the required parameter 'runId' is set
        if (this.runId == null) {
            throw new IllegalStateException("Missing the required parameter 'runId' when building request for GetWorkforcemanagementManagementunitSchedulingRunResultRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/managementunits/{managementUnitId}/scheduling/runs/{runId}/result")
	...
	public static class Builder {
		private final GetWorkforcemanagementManagementunitSchedulingRunResultRequest request;

		private Builder() {
			request = new GetWorkforcemanagementManagementunitSchedulingRunResultRequest();
		}
		...
		public GetWorkforcemanagementManagementunitSchedulingRunResultRequest build() {
