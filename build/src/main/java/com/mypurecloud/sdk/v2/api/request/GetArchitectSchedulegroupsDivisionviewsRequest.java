...
public class GetArchitectSchedulegroupsDivisionviewsRequest {
	...
	public GetArchitectSchedulegroupsDivisionviewsRequest withPageNumber(Integer pageNumber) {
	...
	public GetArchitectSchedulegroupsDivisionviewsRequest withPageSize(Integer pageSize) {
	...
	public GetArchitectSchedulegroupsDivisionviewsRequest withSortBy(String sortBy) {
	...
	public GetArchitectSchedulegroupsDivisionviewsRequest withSortOrder(String sortOrder) {
	...
	public GetArchitectSchedulegroupsDivisionviewsRequest withId(List<String> id) {
	    this.setId(id);
	    return this;
	} 
	...
	public GetArchitectSchedulegroupsDivisionviewsRequest withName(String name) {
	    this.setName(name);
	    return this;
	} 
	...
	public GetArchitectSchedulegroupsDivisionviewsRequest withDivisionId(List<String> divisionId) {
    ...
    public GetArchitectSchedulegroupsDivisionviewsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/architect/schedulegroups/divisionviews")
	...
	public static class Builder {
		private final GetArchitectSchedulegroupsDivisionviewsRequest request;

		private Builder() {
			request = new GetArchitectSchedulegroupsDivisionviewsRequest();
		}
		...
		public GetArchitectSchedulegroupsDivisionviewsRequest build() {
