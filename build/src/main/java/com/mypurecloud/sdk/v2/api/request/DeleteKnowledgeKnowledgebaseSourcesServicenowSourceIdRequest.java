...
public class DeleteKnowledgeKnowledgebaseSourcesServicenowSourceIdRequest {
	...
	public DeleteKnowledgeKnowledgebaseSourcesServicenowSourceIdRequest withKnowledgeBaseId(String knowledgeBaseId) {
	...
	public DeleteKnowledgeKnowledgebaseSourcesServicenowSourceIdRequest withSourceId(String sourceId) {
    ...
    public DeleteKnowledgeKnowledgebaseSourcesServicenowSourceIdRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.knowledgeBaseId == null) {
            throw new IllegalStateException("Missing the required parameter 'knowledgeBaseId' when building request for DeleteKnowledgeKnowledgebaseSourcesServicenowSourceIdRequest.");
        }
        
        // verify the required parameter 'sourceId' is set
        if (this.sourceId == null) {
            throw new IllegalStateException("Missing the required parameter 'sourceId' when building request for DeleteKnowledgeKnowledgebaseSourcesServicenowSourceIdRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/sources/servicenow/{sourceId}")
	...
	public static class Builder {
		private final DeleteKnowledgeKnowledgebaseSourcesServicenowSourceIdRequest request;

		private Builder() {
			request = new DeleteKnowledgeKnowledgebaseSourcesServicenowSourceIdRequest();
		}
		...
		public DeleteKnowledgeKnowledgebaseSourcesServicenowSourceIdRequest build() {
