...
public class UserFullReference  implements Serializable {
 ...
 @JsonDeserialize(using = StateEnumDeserializer.class)
  ...
  public UserFullReference(Boolean initWithEmptyList) {
   ...
   **/
  public UserFullReference id(String id) {
    this.id = id;
    return this;
  }
  ...
  /**
   **/
  public UserFullReference name(String name) {
    this.name = name;
    return this;
  }
   ...
   **/
  public UserFullReference division(Division division) {
  ...
  /**
   **/
  public UserFullReference chat(Chat chat) {
    this.chat = chat;
    return this;
  }
  ...
  /**
   **/
  public UserFullReference department(String department) {
  ...
  /**
   **/
  public UserFullReference email(String email) {
    this.email = email;
    return this;
  }
   ...
   **/
  public UserFullReference addresses(List<Contact> addresses) {
  ...
  /**
   **/
  public UserFullReference title(String title) {
    this.title = title;
    return this;
  }
  ...
  /**
   **/
  public UserFullReference username(String username) {
  ...
  /**
   **/
  public UserFullReference manager(User manager) {
  ...
  /**
   **/
  public UserFullReference images(List<Image> images) {
    this.images = images;
    return this;
  }
   ...
   **/
  public UserFullReference version(Integer version) {
  ...
  /**
   **/
  public UserFullReference certifications(List<String> certifications) {
  ...
  /**
   **/
  public UserFullReference biography(Biography biography) {
  ...
  /**
   **/
  public UserFullReference employerInfo(EmployerInfo employerInfo) {
   ...
   **/
  public UserFullReference preferredName(String preferredName) {
   ...
   * acd auto answer
   **/
  public UserFullReference acdAutoAnswer(Boolean acdAutoAnswer) {
  ...
  /**
   **/
  public UserFullReference lastTokenIssued(OAuthLastTokenIssued lastTokenIssued) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    UserFullReference userFullReference = (UserFullReference) o;

    return Objects.equals(this.id, userFullReference.id) &&
            Objects.equals(this.name, userFullReference.name) &&
            Objects.equals(this.division, userFullReference.division) &&
            Objects.equals(this.chat, userFullReference.chat) &&
            Objects.equals(this.department, userFullReference.department) &&
            Objects.equals(this.email, userFullReference.email) &&
            Objects.equals(this.primaryContactInfo, userFullReference.primaryContactInfo) &&
            Objects.equals(this.addresses, userFullReference.addresses) &&
            Objects.equals(this.state, userFullReference.state) &&
            Objects.equals(this.title, userFullReference.title) &&
            Objects.equals(this.username, userFullReference.username) &&
            Objects.equals(this.manager, userFullReference.manager) &&
            Objects.equals(this.images, userFullReference.images) &&
            Objects.equals(this.version, userFullReference.version) &&
            Objects.equals(this.certifications, userFullReference.certifications) &&
            Objects.equals(this.biography, userFullReference.biography) &&
            Objects.equals(this.employerInfo, userFullReference.employerInfo) &&
            Objects.equals(this.preferredName, userFullReference.preferredName) &&
            Objects.equals(this.routingStatus, userFullReference.routingStatus) &&
            Objects.equals(this.presence, userFullReference.presence) &&
            Objects.equals(this.integrationPresence, userFullReference.integrationPresence) &&
            Objects.equals(this.conversationSummary, userFullReference.conversationSummary) &&
            Objects.equals(this.outOfOffice, userFullReference.outOfOffice) &&
            Objects.equals(this.geolocation, userFullReference.geolocation) &&
            Objects.equals(this.station, userFullReference.station) &&
            Objects.equals(this.authorization, userFullReference.authorization) &&
            Objects.equals(this.profileSkills, userFullReference.profileSkills) &&
            Objects.equals(this.locations, userFullReference.locations) &&
            Objects.equals(this.groups, userFullReference.groups) &&
            Objects.equals(this.team, userFullReference.team) &&
            Objects.equals(this.workPlanBidRanks, userFullReference.workPlanBidRanks) &&
            Objects.equals(this.skills, userFullReference.skills) &&
            Objects.equals(this.languages, userFullReference.languages) &&
            Objects.equals(this.acdAutoAnswer, userFullReference.acdAutoAnswer) &&
            Objects.equals(this.languagePreference, userFullReference.languagePreference) &&
            Objects.equals(this.lastTokenIssued, userFullReference.lastTokenIssued) &&
            Objects.equals(this.dateLastLogin, userFullReference.dateLastLogin) &&
            Objects.equals(this.dateWelcomeSent, userFullReference.dateWelcomeSent) &&
            Objects.equals(this.selfUri, userFullReference.selfUri);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, division, chat, department, email, primaryContactInfo, addresses, state, title, username, manager, images, version, certifications, biography, employerInfo, preferredName, routingStatus, presence, integrationPresence, conversationSummary, outOfOffice, geolocation, station, authorization, profileSkills, locations, groups, team, workPlanBidRanks, skills, languages, acdAutoAnswer, languagePreference, lastTokenIssued, dateLastLogin, dateWelcomeSent, selfUri);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UserFullReference {\n");
