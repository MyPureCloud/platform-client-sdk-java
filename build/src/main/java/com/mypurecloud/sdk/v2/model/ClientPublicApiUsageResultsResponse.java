...
import com.fasterxml.jackson.annotation.JsonValue;
import com.mypurecloud.sdk.v2.model.ClientPublicApiUsage;
...
public class ClientPublicApiUsageResultsResponse  implements Serializable {
 ...
 @JsonDeserialize(using = QueryStatusEnumDeserializer.class)
  ...
  private List<ClientPublicApiUsage> entities = null;
  ...
  /**
   **/
  public ClientPublicApiUsageResultsResponse name(String name) {
    this.name = name;
    return this;
  }
   ...
   * The status of the query.
   **/
  public ClientPublicApiUsageResultsResponse queryStatus(QueryStatusEnum queryStatus) {
   ...
   **/
  public ClientPublicApiUsageResultsResponse errorBody(ErrorBody errorBody) {
   ...
   **/
  public ClientPublicApiUsageResultsResponse nextUri(String nextUri) {
   ...
   **/
  public ClientPublicApiUsageResultsResponse entities(List<ClientPublicApiUsage> entities) {
  ...
  public List<ClientPublicApiUsage> getEntities() {
    return entities;
  }
  public void setEntities(List<ClientPublicApiUsage> entities) {
    this.entities = entities;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ClientPublicApiUsageResultsResponse clientPublicApiUsageResultsResponse = (ClientPublicApiUsageResultsResponse) o;

    return Objects.equals(this.name, clientPublicApiUsageResultsResponse.name) &&
            Objects.equals(this.queryStatus, clientPublicApiUsageResultsResponse.queryStatus) &&
            Objects.equals(this.errorBody, clientPublicApiUsageResultsResponse.errorBody) &&
            Objects.equals(this.nextUri, clientPublicApiUsageResultsResponse.nextUri) &&
            Objects.equals(this.entities, clientPublicApiUsageResultsResponse.entities) &&
            Objects.equals(this.selfUri, clientPublicApiUsageResultsResponse.selfUri);
  }
