...
public class PostWorkforcemanagementBusinessunitWorkplanbidsRequest {
	...
	public PostWorkforcemanagementBusinessunitWorkplanbidsRequest withBusinessUnitId(String businessUnitId) {
	    this.setBusinessUnitId(businessUnitId);
	    return this;
	} 

	private CreateWorkPlanBid body;
	public CreateWorkPlanBid getBody() {
		return this.body;
	}

	public void setBody(CreateWorkPlanBid body) {
		this.body = body;
	}

	public PostWorkforcemanagementBusinessunitWorkplanbidsRequest withBody(CreateWorkPlanBid body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementBusinessunitWorkplanbidsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<CreateWorkPlanBid> withHttpInfo() {
	...
	public static class Builder {
		private final PostWorkforcemanagementBusinessunitWorkplanbidsRequest request;

		private Builder() {
			request = new PostWorkforcemanagementBusinessunitWorkplanbidsRequest();
		}
		...
		public Builder withBody(CreateWorkPlanBid body) {
		...
		public PostWorkforcemanagementBusinessunitWorkplanbidsRequest build() {
