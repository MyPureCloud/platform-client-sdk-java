...
public class PutSpeechandtextanalyticsCategoryRequest {
	...
	public PutSpeechandtextanalyticsCategoryRequest withCategoryId(String categoryId) {
	...
	public PutSpeechandtextanalyticsCategoryRequest withBody(CategoryRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutSpeechandtextanalyticsCategoryRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<CategoryRequest> withHttpInfo() {
        ...
        if (this.categoryId == null) {
            throw new IllegalStateException("Missing the required parameter 'categoryId' when building request for PutSpeechandtextanalyticsCategoryRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutSpeechandtextanalyticsCategoryRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/speechandtextanalytics/categories/{categoryId}")
	...
	public static Builder builder(String categoryId, CategoryRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PutSpeechandtextanalyticsCategoryRequest request;

		private Builder() {
			request = new PutSpeechandtextanalyticsCategoryRequest();
		}
		...
		public Builder withRequiredParams(String categoryId, CategoryRequest body) {
			request.setCategoryId(categoryId);
			request.setBody(body);
		...
		public PutSpeechandtextanalyticsCategoryRequest build() {
