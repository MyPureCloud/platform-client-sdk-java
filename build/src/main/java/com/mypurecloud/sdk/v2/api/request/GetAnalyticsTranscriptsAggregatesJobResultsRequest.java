...
public class GetAnalyticsTranscriptsAggregatesJobResultsRequest {
	...
	public GetAnalyticsTranscriptsAggregatesJobResultsRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
	...
	public GetAnalyticsTranscriptsAggregatesJobResultsRequest withCursor(String cursor) {
    ...
    public GetAnalyticsTranscriptsAggregatesJobResultsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetAnalyticsTranscriptsAggregatesJobResultsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/analytics/transcripts/aggregates/jobs/{jobId}/results")
	...
	public static class Builder {
		private final GetAnalyticsTranscriptsAggregatesJobResultsRequest request;

		private Builder() {
			request = new GetAnalyticsTranscriptsAggregatesJobResultsRequest();
		}
		...
		public GetAnalyticsTranscriptsAggregatesJobResultsRequest build() {
