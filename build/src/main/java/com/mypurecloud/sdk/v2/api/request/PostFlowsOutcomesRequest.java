...
public class PostFlowsOutcomesRequest {
	...
	public PostFlowsOutcomesRequest withBody(FlowOutcome body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostFlowsOutcomesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<FlowOutcome> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("POST", "/api/v2/flows/outcomes")
                .withBody(body)
	...
	public static class Builder {
		private final PostFlowsOutcomesRequest request;

		private Builder() {
			request = new PostFlowsOutcomesRequest();
		}
		...
		public PostFlowsOutcomesRequest build() {
