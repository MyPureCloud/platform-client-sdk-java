...
public class GetFlowsDatatablesDivisionviewRequest {
	...
	public GetFlowsDatatablesDivisionviewRequest withDatatableId(String datatableId) {
	...
	public GetFlowsDatatablesDivisionviewRequest withExpand(String expand) {
    ...
    public GetFlowsDatatablesDivisionviewRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.datatableId == null) {
            throw new IllegalStateException("Missing the required parameter 'datatableId' when building request for GetFlowsDatatablesDivisionviewRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/flows/datatables/divisionviews/{datatableId}")
	...
	public static class Builder {
		private final GetFlowsDatatablesDivisionviewRequest request;

		private Builder() {
			request = new GetFlowsDatatablesDivisionviewRequest();
		}
		...
		public GetFlowsDatatablesDivisionviewRequest build() {
