...
public class GetGamificationScorecardsUsersValuesTrendsRequest {
	...
	public GetGamificationScorecardsUsersValuesTrendsRequest withFilterType(String filterType) {
	...
	public GetGamificationScorecardsUsersValuesTrendsRequest withFilterId(String filterId) {
	...
	public GetGamificationScorecardsUsersValuesTrendsRequest withStartWorkday(LocalDate startWorkday) {
	...
	public GetGamificationScorecardsUsersValuesTrendsRequest withEndWorkday(LocalDate endWorkday) {
	...
	public GetGamificationScorecardsUsersValuesTrendsRequest withTimeZone(String timeZone) {
    ...
    public GetGamificationScorecardsUsersValuesTrendsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.filterType == null) {
            throw new IllegalStateException("Missing the required parameter 'filterType' when building request for GetGamificationScorecardsUsersValuesTrendsRequest.");
        }
        
        // verify the required parameter 'filterId' is set
        if (this.filterId == null) {
            throw new IllegalStateException("Missing the required parameter 'filterId' when building request for GetGamificationScorecardsUsersValuesTrendsRequest.");
        }
        
        // verify the required parameter 'startWorkday' is set
        if (this.startWorkday == null) {
            throw new IllegalStateException("Missing the required parameter 'startWorkday' when building request for GetGamificationScorecardsUsersValuesTrendsRequest.");
        }
        
        // verify the required parameter 'endWorkday' is set
        if (this.endWorkday == null) {
            throw new IllegalStateException("Missing the required parameter 'endWorkday' when building request for GetGamificationScorecardsUsersValuesTrendsRequest.");
        }
