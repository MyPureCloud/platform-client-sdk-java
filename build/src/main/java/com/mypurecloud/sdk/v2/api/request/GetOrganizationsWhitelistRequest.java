...
public class GetOrganizationsWhitelistRequest {
    ...
    public GetOrganizationsWhitelistRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/organizations/whitelist")
	...
	public static class Builder {
		private final GetOrganizationsWhitelistRequest request;

		private Builder() {
			request = new GetOrganizationsWhitelistRequest();
		}
		...
		public GetOrganizationsWhitelistRequest build() {
