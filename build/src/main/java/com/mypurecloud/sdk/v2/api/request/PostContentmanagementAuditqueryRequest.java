...
public class PostContentmanagementAuditqueryRequest {
	...
	public void setBody(ContentQueryRequest body) {
		this.body = body;
	}

	public PostContentmanagementAuditqueryRequest withBody(ContentQueryRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostContentmanagementAuditqueryRequest withCustomHeader(String name, String value) {
