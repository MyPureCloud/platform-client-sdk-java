...
public class PatchTaskmanagementWorkitemUsersMeWrapupsRequest {
	...
	public PatchTaskmanagementWorkitemUsersMeWrapupsRequest withWorkitemId(String workitemId) {
	...
	public PatchTaskmanagementWorkitemUsersMeWrapupsRequest withBody(WorkitemWrapupUpdate body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchTaskmanagementWorkitemUsersMeWrapupsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<WorkitemWrapupUpdate> withHttpInfo() {
        ...
        if (this.workitemId == null) {
            throw new IllegalStateException("Missing the required parameter 'workitemId' when building request for PatchTaskmanagementWorkitemUsersMeWrapupsRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchTaskmanagementWorkitemUsersMeWrapupsRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/taskmanagement/workitems/{workitemId}/users/me/wrapups")
	...
	public static Builder builder(String workitemId, WorkitemWrapupUpdate body) {
	    return new Builder()
	...
	public static class Builder {
		private final PatchTaskmanagementWorkitemUsersMeWrapupsRequest request;

		private Builder() {
			request = new PatchTaskmanagementWorkitemUsersMeWrapupsRequest();
		}
		...
		public Builder withRequiredParams(String workitemId, WorkitemWrapupUpdate body) {
			request.setWorkitemId(workitemId);
			request.setBody(body);
		...
		public PatchTaskmanagementWorkitemUsersMeWrapupsRequest build() {
