...
public class PostKnowledgeKnowledgebaseCategoriesRequest {
	...
	public PostKnowledgeKnowledgebaseCategoriesRequest withKnowledgeBaseId(String knowledgeBaseId) {
    ...
    public PostKnowledgeKnowledgebaseCategoriesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<CategoryCreateRequest> withHttpInfo() {
        ...
        if (this.knowledgeBaseId == null) {
            throw new IllegalStateException("Missing the required parameter 'knowledgeBaseId' when building request for PostKnowledgeKnowledgebaseCategoriesRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostKnowledgeKnowledgebaseCategoriesRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/categories")
	...
	public static class Builder {
		private final PostKnowledgeKnowledgebaseCategoriesRequest request;

		private Builder() {
			request = new PostKnowledgeKnowledgebaseCategoriesRequest();
		}
		...
		public PostKnowledgeKnowledgebaseCategoriesRequest build() {
