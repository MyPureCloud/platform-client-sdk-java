...
public class PostConversationsMessagesAgentlessRequest {
    
	private SendAgentlessOutboundMessageRequest body;
	public SendAgentlessOutboundMessageRequest getBody() {
		return this.body;
	}

	public void setBody(SendAgentlessOutboundMessageRequest body) {
		this.body = body;
	}

	public PostConversationsMessagesAgentlessRequest withBody(SendAgentlessOutboundMessageRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostConversationsMessagesAgentlessRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<SendAgentlessOutboundMessageRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostConversationsMessagesAgentlessRequest.");
        }
	...
	public static Builder builder(SendAgentlessOutboundMessageRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostConversationsMessagesAgentlessRequest request;

		private Builder() {
			request = new PostConversationsMessagesAgentlessRequest();
		}
		...
		public Builder withRequiredParams(SendAgentlessOutboundMessageRequest body) {
			request.setBody(body);
		...
		public PostConversationsMessagesAgentlessRequest build() {
