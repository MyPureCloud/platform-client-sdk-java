...
public class GetLanguagesTranslationsUserRequest {
	...
	public GetLanguagesTranslationsUserRequest withUserId(String userId) {
    ...
    public GetLanguagesTranslationsUserRequest withCustomHeader(String name, String value) {
