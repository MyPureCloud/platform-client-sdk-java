...
public class PostExternalcontactsBulkOrganizationsRemoveRequest {
	...
	public PostExternalcontactsBulkOrganizationsRemoveRequest withBody(BulkIdsRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostExternalcontactsBulkOrganizationsRemoveRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<BulkIdsRequest> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostExternalcontactsBulkOrganizationsRemoveRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/externalcontacts/bulk/organizations/remove")
                .withBody(body)
	...
	public static class Builder {
		private final PostExternalcontactsBulkOrganizationsRemoveRequest request;

		private Builder() {
			request = new PostExternalcontactsBulkOrganizationsRemoveRequest();
		}
		...
		public PostExternalcontactsBulkOrganizationsRemoveRequest build() {
