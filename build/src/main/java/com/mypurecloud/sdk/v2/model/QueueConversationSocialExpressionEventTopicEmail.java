...
public class QueueConversationSocialExpressionEventTopicEmail  implements Serializable {
 ...
 @JsonDeserialize(using = DirectionEnumDeserializer.class)
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, state, initialState, held, autoGenerated, subject, provider, scriptId, peerId, messagesSent, errorInfo, disconnectType, startHoldTime, connectedTime, disconnectedTime, messageId, direction, draftAttachments, spam, wrapup, afterCallWork, afterCallWorkRequired, queueMediaSettings, resumeTime);
  }
