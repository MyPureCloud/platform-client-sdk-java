...
public class StatEventQueueTopicIntervalMetrics  implements Serializable {
  
  private String interval = null;
  private List<StatEventQueueTopicMetricStats> metrics = null;

  public StatEventQueueTopicIntervalMetrics() {
  ...
  /**
   **/
  public StatEventQueueTopicIntervalMetrics interval(String interval) {
  ...
  public List<StatEventQueueTopicMetricStats> getMetrics() {
    return metrics;
  }
  public void setMetrics(List<StatEventQueueTopicMetricStats> metrics) {
    this.metrics = metrics;
  }
