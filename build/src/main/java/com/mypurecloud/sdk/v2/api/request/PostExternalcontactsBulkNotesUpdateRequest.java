...
public class PostExternalcontactsBulkNotesUpdateRequest {
    
	private BulkNotesRequest body;
	public BulkNotesRequest getBody() {
		return this.body;
	}

	public void setBody(BulkNotesRequest body) {
		this.body = body;
	}

	public PostExternalcontactsBulkNotesUpdateRequest withBody(BulkNotesRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostExternalcontactsBulkNotesUpdateRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<BulkNotesRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostExternalcontactsBulkNotesUpdateRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/externalcontacts/bulk/notes/update")
                .withBody(body)
	...
	public static Builder builder(BulkNotesRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostExternalcontactsBulkNotesUpdateRequest request;

		private Builder() {
			request = new PostExternalcontactsBulkNotesUpdateRequest();
		}

		
		public Builder withBody(BulkNotesRequest body) {
		...
		public Builder withRequiredParams(BulkNotesRequest body) {
			request.setBody(body);
		...
		public PostExternalcontactsBulkNotesUpdateRequest build() {
