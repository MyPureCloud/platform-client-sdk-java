...
public class AcdStartDetailEventTopicAcdStartEvent  implements Serializable {
 ...
 @JsonDeserialize(using = MessageTypeEnumDeserializer.class)
  ...
  /**
   **/
  public AcdStartDetailEventTopicAcdStartEvent eventTime(Integer eventTime) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(eventTime, conversationId, participantId, sessionId, mediaType, provider, direction, ani, dnis, addressTo, addressFrom, callbackUserName, callbackNumbers, callbackScheduledTime, subject, messageType, queueId, divisionId);
  }
