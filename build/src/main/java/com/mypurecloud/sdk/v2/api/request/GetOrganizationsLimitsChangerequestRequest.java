...
public class GetOrganizationsLimitsChangerequestRequest {
	...
	public GetOrganizationsLimitsChangerequestRequest withRequestId(String requestId) {
    ...
    public GetOrganizationsLimitsChangerequestRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.requestId == null) {
            throw new IllegalStateException("Missing the required parameter 'requestId' when building request for GetOrganizationsLimitsChangerequestRequest.");
        }
