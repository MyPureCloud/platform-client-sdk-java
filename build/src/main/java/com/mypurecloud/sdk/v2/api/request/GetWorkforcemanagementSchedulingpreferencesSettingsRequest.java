...
public class GetWorkforcemanagementSchedulingpreferencesSettingsRequest {
    ...
    public GetWorkforcemanagementSchedulingpreferencesSettingsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/schedulingpreferences/settings")
	...
	public static class Builder {
		private final GetWorkforcemanagementSchedulingpreferencesSettingsRequest request;

		private Builder() {
			request = new GetWorkforcemanagementSchedulingpreferencesSettingsRequest();
		}
		...
		public GetWorkforcemanagementSchedulingpreferencesSettingsRequest build() {
