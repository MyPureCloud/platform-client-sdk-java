...
public class GetConversationsMessagingSettingsRequest {
	...
	public GetConversationsMessagingSettingsRequest withPageSize(Integer pageSize) {
	...
	public GetConversationsMessagingSettingsRequest withPageNumber(Integer pageNumber) {
    ...
    public GetConversationsMessagingSettingsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/conversations/messaging/settings")
	...
	public static class Builder {
		private final GetConversationsMessagingSettingsRequest request;

		private Builder() {
			request = new GetConversationsMessagingSettingsRequest();
		}
		...
		public GetConversationsMessagingSettingsRequest build() {
