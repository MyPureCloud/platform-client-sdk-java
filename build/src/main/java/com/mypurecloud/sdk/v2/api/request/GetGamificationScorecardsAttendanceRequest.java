...
public class GetGamificationScorecardsAttendanceRequest {
	...
	public GetGamificationScorecardsAttendanceRequest withStartWorkday(LocalDate startWorkday) {
	...
	public GetGamificationScorecardsAttendanceRequest withEndWorkday(LocalDate endWorkday) {
    ...
    public GetGamificationScorecardsAttendanceRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.startWorkday == null) {
            throw new IllegalStateException("Missing the required parameter 'startWorkday' when building request for GetGamificationScorecardsAttendanceRequest.");
        }
        
        // verify the required parameter 'endWorkday' is set
        if (this.endWorkday == null) {
            throw new IllegalStateException("Missing the required parameter 'endWorkday' when building request for GetGamificationScorecardsAttendanceRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/gamification/scorecards/attendance")
	...
	public static class Builder {
		private final GetGamificationScorecardsAttendanceRequest request;

		private Builder() {
			request = new GetGamificationScorecardsAttendanceRequest();
		}
		...
		public GetGamificationScorecardsAttendanceRequest build() {
