...
public class PostWorkforcemanagementHistoricaldataBulkRemoveJobsRequest {

	private HistoricalImportDeleteFilesJobRequest body;
	public HistoricalImportDeleteFilesJobRequest getBody() {
		return this.body;
	}

	public void setBody(HistoricalImportDeleteFilesJobRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementHistoricaldataBulkRemoveJobsRequest withBody(HistoricalImportDeleteFilesJobRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementHistoricaldataBulkRemoveJobsRequest withCustomHeader(String name, String value) {
	...
	public static class Builder {
		private final PostWorkforcemanagementHistoricaldataBulkRemoveJobsRequest request;

		private Builder() {
			request = new PostWorkforcemanagementHistoricaldataBulkRemoveJobsRequest();
		}


		public Builder withBody(HistoricalImportDeleteFilesJobRequest body) {
