...
public class GetLanguageRequest {
	...
	public GetLanguageRequest withLanguageId(String languageId) {
    ...
    public GetLanguageRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() throws ApiException {
        ...
        if (this.languageId == null) {
            throw new ApiException(400, "Missing the required parameter 'languageId' when building request for GetLanguageRequest.");
        }
