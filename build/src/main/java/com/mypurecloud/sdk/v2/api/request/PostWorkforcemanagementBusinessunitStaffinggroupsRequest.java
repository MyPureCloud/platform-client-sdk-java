...
public class PostWorkforcemanagementBusinessunitStaffinggroupsRequest {
	...
	public PostWorkforcemanagementBusinessunitStaffinggroupsRequest withBusinessUnitId(String businessUnitId) {
	    this.setBusinessUnitId(businessUnitId);
	    return this;
	} 

	private CreateStaffingGroupRequest body;
	public CreateStaffingGroupRequest getBody() {
		return this.body;
	}

	public void setBody(CreateStaffingGroupRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementBusinessunitStaffinggroupsRequest withBody(CreateStaffingGroupRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementBusinessunitStaffinggroupsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<CreateStaffingGroupRequest> withHttpInfo() {
	...
	public static class Builder {
		private final PostWorkforcemanagementBusinessunitStaffinggroupsRequest request;

		private Builder() {
			request = new PostWorkforcemanagementBusinessunitStaffinggroupsRequest();
		}
		...
		public Builder withBody(CreateStaffingGroupRequest body) {
		...
		public PostWorkforcemanagementBusinessunitStaffinggroupsRequest build() {
