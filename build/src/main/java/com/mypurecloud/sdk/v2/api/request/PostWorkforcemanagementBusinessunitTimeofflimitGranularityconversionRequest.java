...
public class PostWorkforcemanagementBusinessunitTimeofflimitGranularityconversionRequest {
	...
	public PostWorkforcemanagementBusinessunitTimeofflimitGranularityconversionRequest withBusinessUnitId(String businessUnitId) {
	...
	public PostWorkforcemanagementBusinessunitTimeofflimitGranularityconversionRequest withTimeOffLimitId(String timeOffLimitId) {
	    this.setTimeOffLimitId(timeOffLimitId);
	    return this;
	} 

	private BuConvertTimeOffLimitGranularityJobRequest body;
	public BuConvertTimeOffLimitGranularityJobRequest getBody() {
		return this.body;
	}

	public void setBody(BuConvertTimeOffLimitGranularityJobRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementBusinessunitTimeofflimitGranularityconversionRequest withBody(BuConvertTimeOffLimitGranularityJobRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementBusinessunitTimeofflimitGranularityconversionRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<BuConvertTimeOffLimitGranularityJobRequest> withHttpInfo() {
        
        // verify the required parameter 'businessUnitId' is set
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PostWorkforcemanagementBusinessunitTimeofflimitGranularityconversionRequest.");
        }
        
        // verify the required parameter 'timeOffLimitId' is set
        if (this.timeOffLimitId == null) {
            throw new IllegalStateException("Missing the required parameter 'timeOffLimitId' when building request for PostWorkforcemanagementBusinessunitTimeofflimitGranularityconversionRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementBusinessunitTimeofflimitGranularityconversionRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/timeofflimits/{timeOffLimitId}/granularityconversion")
	...
	public static Builder builder(String businessUnitId, String timeOffLimitId, BuConvertTimeOffLimitGranularityJobRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementBusinessunitTimeofflimitGranularityconversionRequest request;

		private Builder() {
			request = new PostWorkforcemanagementBusinessunitTimeofflimitGranularityconversionRequest();
		}
		...
		public Builder withBody(BuConvertTimeOffLimitGranularityJobRequest body) {
		...
		public Builder withRequiredParams(String businessUnitId, String timeOffLimitId, BuConvertTimeOffLimitGranularityJobRequest body) {
			request.setBusinessUnitId(businessUnitId);
			request.setTimeOffLimitId(timeOffLimitId);
			request.setBody(body);
		...
		public PostWorkforcemanagementBusinessunitTimeofflimitGranularityconversionRequest build() {
