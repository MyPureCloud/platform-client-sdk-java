...
public class PostSocialmediaEscalationrulesRequest {
	...
	public PostSocialmediaEscalationrulesRequest withBody(EscalationRuleRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostSocialmediaEscalationrulesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<EscalationRuleRequest> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("POST", "/api/v2/socialmedia/escalationrules")
                .withBody(body)
	...
	public static class Builder {
		private final PostSocialmediaEscalationrulesRequest request;

		private Builder() {
			request = new PostSocialmediaEscalationrulesRequest();
		}
		...
		public PostSocialmediaEscalationrulesRequest build() {
