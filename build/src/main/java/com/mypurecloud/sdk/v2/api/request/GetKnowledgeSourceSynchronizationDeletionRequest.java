...
public class GetKnowledgeSourceSynchronizationDeletionRequest {
	...
	public GetKnowledgeSourceSynchronizationDeletionRequest withSourceId(String sourceId) {
	...
	public GetKnowledgeSourceSynchronizationDeletionRequest withSynchronizationId(String synchronizationId) {
	...
	public GetKnowledgeSourceSynchronizationDeletionRequest withFileId(String fileId) {
    ...
    public GetKnowledgeSourceSynchronizationDeletionRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.sourceId == null) {
            throw new IllegalStateException("Missing the required parameter 'sourceId' when building request for GetKnowledgeSourceSynchronizationDeletionRequest.");
        }
        
        // verify the required parameter 'synchronizationId' is set
        if (this.synchronizationId == null) {
            throw new IllegalStateException("Missing the required parameter 'synchronizationId' when building request for GetKnowledgeSourceSynchronizationDeletionRequest.");
        }
        
        // verify the required parameter 'fileId' is set
        if (this.fileId == null) {
            throw new IllegalStateException("Missing the required parameter 'fileId' when building request for GetKnowledgeSourceSynchronizationDeletionRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/knowledge/sources/{sourceId}/synchronizations/{synchronizationId}/deletions/{fileId}")
	...
	public static class Builder {
		private final GetKnowledgeSourceSynchronizationDeletionRequest request;

		private Builder() {
			request = new GetKnowledgeSourceSynchronizationDeletionRequest();
		}
		...
		public GetKnowledgeSourceSynchronizationDeletionRequest build() {
