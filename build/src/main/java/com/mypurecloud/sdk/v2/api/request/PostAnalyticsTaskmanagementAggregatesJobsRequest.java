...
public class PostAnalyticsTaskmanagementAggregatesJobsRequest {

	private TaskManagementAsyncAggregationQuery body;
	public TaskManagementAsyncAggregationQuery getBody() {
		return this.body;
	}

	public void setBody(TaskManagementAsyncAggregationQuery body) {
		this.body = body;
	}

	public PostAnalyticsTaskmanagementAggregatesJobsRequest withBody(TaskManagementAsyncAggregationQuery body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostAnalyticsTaskmanagementAggregatesJobsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<TaskManagementAsyncAggregationQuery> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostAnalyticsTaskmanagementAggregatesJobsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/analytics/taskmanagement/aggregates/jobs")
                .withBody(body)
	...
	public static Builder builder(TaskManagementAsyncAggregationQuery body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostAnalyticsTaskmanagementAggregatesJobsRequest request;

		private Builder() {
			request = new PostAnalyticsTaskmanagementAggregatesJobsRequest();
		}


		public Builder withBody(TaskManagementAsyncAggregationQuery body) {
		...
		public Builder withRequiredParams(TaskManagementAsyncAggregationQuery body) {
			request.setBody(body);
		...
		public PostAnalyticsTaskmanagementAggregatesJobsRequest build() {
