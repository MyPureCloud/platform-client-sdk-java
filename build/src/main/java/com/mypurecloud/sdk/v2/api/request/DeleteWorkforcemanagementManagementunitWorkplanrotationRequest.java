...
public class DeleteWorkforcemanagementManagementunitWorkplanrotationRequest {
	...
	public DeleteWorkforcemanagementManagementunitWorkplanrotationRequest withManagementUnitId(String managementUnitId) {
	...
	public DeleteWorkforcemanagementManagementunitWorkplanrotationRequest withWorkPlanRotationId(String workPlanRotationId) {
    ...
    public DeleteWorkforcemanagementManagementunitWorkplanrotationRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.managementUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'managementUnitId' when building request for DeleteWorkforcemanagementManagementunitWorkplanrotationRequest.");
        }
        
        // verify the required parameter 'workPlanRotationId' is set
        if (this.workPlanRotationId == null) {
            throw new IllegalStateException("Missing the required parameter 'workPlanRotationId' when building request for DeleteWorkforcemanagementManagementunitWorkplanrotationRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/workforcemanagement/managementunits/{managementUnitId}/workplanrotations/{workPlanRotationId}")
	...
	public static class Builder {
		private final DeleteWorkforcemanagementManagementunitWorkplanrotationRequest request;

		private Builder() {
			request = new DeleteWorkforcemanagementManagementunitWorkplanrotationRequest();
		}
		...
		public DeleteWorkforcemanagementManagementunitWorkplanrotationRequest build() {
