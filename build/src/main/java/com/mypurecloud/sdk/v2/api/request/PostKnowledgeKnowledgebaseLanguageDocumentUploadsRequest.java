...
public class PostKnowledgeKnowledgebaseLanguageDocumentUploadsRequest {
	...
	public PostKnowledgeKnowledgebaseLanguageDocumentUploadsRequest withDocumentId(String documentId) {
	...
	public PostKnowledgeKnowledgebaseLanguageDocumentUploadsRequest withKnowledgeBaseId(String knowledgeBaseId) {
	...
	public PostKnowledgeKnowledgebaseLanguageDocumentUploadsRequest withLanguageCode(String languageCode) {
	...
	private KnowledgeDocumentContentUpload body;
	public KnowledgeDocumentContentUpload getBody() {
		return this.body;
	}

	public void setBody(KnowledgeDocumentContentUpload body) {
		this.body = body;
	}

	public PostKnowledgeKnowledgebaseLanguageDocumentUploadsRequest withBody(KnowledgeDocumentContentUpload body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostKnowledgeKnowledgebaseLanguageDocumentUploadsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<KnowledgeDocumentContentUpload> withHttpInfo() {
        
        // verify the required parameter 'documentId' is set
        if (this.documentId == null) {
            throw new IllegalStateException("Missing the required parameter 'documentId' when building request for PostKnowledgeKnowledgebaseLanguageDocumentUploadsRequest.");
        }
        
        // verify the required parameter 'knowledgeBaseId' is set
        if (this.knowledgeBaseId == null) {
            throw new IllegalStateException("Missing the required parameter 'knowledgeBaseId' when building request for PostKnowledgeKnowledgebaseLanguageDocumentUploadsRequest.");
        }
        
        // verify the required parameter 'languageCode' is set
        if (this.languageCode == null) {
            throw new IllegalStateException("Missing the required parameter 'languageCode' when building request for PostKnowledgeKnowledgebaseLanguageDocumentUploadsRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostKnowledgeKnowledgebaseLanguageDocumentUploadsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/languages/{languageCode}/documents/{documentId}/uploads")
	...
	public static Builder builder(String documentId, String knowledgeBaseId, String languageCode, KnowledgeDocumentContentUpload body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostKnowledgeKnowledgebaseLanguageDocumentUploadsRequest request;

		private Builder() {
			request = new PostKnowledgeKnowledgebaseLanguageDocumentUploadsRequest();
		}
		...
		public Builder withBody(KnowledgeDocumentContentUpload body) {
		...
		public Builder withRequiredParams(String documentId, String knowledgeBaseId, String languageCode, KnowledgeDocumentContentUpload body) {
			request.setDocumentId(documentId);
			request.setKnowledgeBaseId(knowledgeBaseId);
			request.setLanguageCode(languageCode);
			request.setBody(body);
		...
		public PostKnowledgeKnowledgebaseLanguageDocumentUploadsRequest build() {
