...
public class GetUserCustomattributeRequest {
	...
	public GetUserCustomattributeRequest withUserId(String userId) {
	...
	public GetUserCustomattributeRequest withSchemaId(String schemaId) {
    ...
    public GetUserCustomattributeRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.userId == null) {
            throw new IllegalStateException("Missing the required parameter 'userId' when building request for GetUserCustomattributeRequest.");
        }
        
        // verify the required parameter 'schemaId' is set
        if (this.schemaId == null) {
            throw new IllegalStateException("Missing the required parameter 'schemaId' when building request for GetUserCustomattributeRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/users/{userId}/customattributes/{schemaId}")
	...
	public static class Builder {
		private final GetUserCustomattributeRequest request;

		private Builder() {
			request = new GetUserCustomattributeRequest();
		}
		...
		public GetUserCustomattributeRequest build() {
