...
public class GetIntegrationsSpeechDialogflowAgentsRequest {
	...
	public GetIntegrationsSpeechDialogflowAgentsRequest withPageNumber(Integer pageNumber) {
	...
	public GetIntegrationsSpeechDialogflowAgentsRequest withPageSize(Integer pageSize) {
	...
	public GetIntegrationsSpeechDialogflowAgentsRequest withName(String name) {
	    this.setName(name);
	    return this;
	} 
    ...
    public GetIntegrationsSpeechDialogflowAgentsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/integrations/speech/dialogflow/agents")
	...
	public static class Builder {
		private final GetIntegrationsSpeechDialogflowAgentsRequest request;

		private Builder() {
			request = new GetIntegrationsSpeechDialogflowAgentsRequest();
		}
		...
		public GetIntegrationsSpeechDialogflowAgentsRequest build() {
