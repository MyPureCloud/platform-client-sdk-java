...
public class GetWorkforcemanagementBusinessunitsDivisionviewsRequest {
	...
	public GetWorkforcemanagementBusinessunitsDivisionviewsRequest withDivisionId(List<String> divisionId) {
    ...
    public GetWorkforcemanagementBusinessunitsDivisionviewsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/businessunits/divisionviews")
	...
	public static class Builder {
		private final GetWorkforcemanagementBusinessunitsDivisionviewsRequest request;

		private Builder() {
			request = new GetWorkforcemanagementBusinessunitsDivisionviewsRequest();
		}
		...
		public GetWorkforcemanagementBusinessunitsDivisionviewsRequest build() {
