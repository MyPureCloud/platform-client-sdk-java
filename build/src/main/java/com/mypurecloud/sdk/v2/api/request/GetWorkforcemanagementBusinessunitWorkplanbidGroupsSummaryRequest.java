...
public class GetWorkforcemanagementBusinessunitWorkplanbidGroupsSummaryRequest {
	...
	public GetWorkforcemanagementBusinessunitWorkplanbidGroupsSummaryRequest withBusinessUnitId(String businessUnitId) {
	...
	public GetWorkforcemanagementBusinessunitWorkplanbidGroupsSummaryRequest withBidId(String bidId) {
	    this.setBidId(bidId);
	    return this;
	} 
    ...
    public GetWorkforcemanagementBusinessunitWorkplanbidGroupsSummaryRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for GetWorkforcemanagementBusinessunitWorkplanbidGroupsSummaryRequest.");
        }
        
        // verify the required parameter 'bidId' is set
        if (this.bidId == null) {
            throw new IllegalStateException("Missing the required parameter 'bidId' when building request for GetWorkforcemanagementBusinessunitWorkplanbidGroupsSummaryRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/workplanbids/{bidId}/groups/summary")
	...
	public static class Builder {
		private final GetWorkforcemanagementBusinessunitWorkplanbidGroupsSummaryRequest request;

		private Builder() {
			request = new GetWorkforcemanagementBusinessunitWorkplanbidGroupsSummaryRequest();
		}
		...
		public GetWorkforcemanagementBusinessunitWorkplanbidGroupsSummaryRequest build() {
