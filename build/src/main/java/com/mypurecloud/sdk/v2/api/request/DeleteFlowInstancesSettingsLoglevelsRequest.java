...
public class DeleteFlowInstancesSettingsLoglevelsRequest {
	...
	public DeleteFlowInstancesSettingsLoglevelsRequest withFlowId(String flowId) {
    ...
    public DeleteFlowInstancesSettingsLoglevelsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.flowId == null) {
            throw new IllegalStateException("Missing the required parameter 'flowId' when building request for DeleteFlowInstancesSettingsLoglevelsRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/flows/{flowId}/instances/settings/loglevels")
	...
	public static class Builder {
		private final DeleteFlowInstancesSettingsLoglevelsRequest request;

		private Builder() {
			request = new DeleteFlowInstancesSettingsLoglevelsRequest();
		}
		...
		public DeleteFlowInstancesSettingsLoglevelsRequest build() {
