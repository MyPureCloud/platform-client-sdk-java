...
public class GetRoutingSmsIdentityresolutionPhonenumberRequest {
	...
	public GetRoutingSmsIdentityresolutionPhonenumberRequest withAddressId(String addressId) {
    ...
    public GetRoutingSmsIdentityresolutionPhonenumberRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.addressId == null) {
            throw new IllegalStateException("Missing the required parameter 'addressId' when building request for GetRoutingSmsIdentityresolutionPhonenumberRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/routing/sms/identityresolution/phonenumbers/{addressId}")
	...
	public static class Builder {
		private final GetRoutingSmsIdentityresolutionPhonenumberRequest request;

		private Builder() {
			request = new GetRoutingSmsIdentityresolutionPhonenumberRequest();
		}
		...
		public GetRoutingSmsIdentityresolutionPhonenumberRequest build() {
