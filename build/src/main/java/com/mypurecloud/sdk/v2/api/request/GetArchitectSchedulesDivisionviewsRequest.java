...
public class GetArchitectSchedulesDivisionviewsRequest {
	...
	public GetArchitectSchedulesDivisionviewsRequest withPageNumber(Integer pageNumber) {
	...
	public GetArchitectSchedulesDivisionviewsRequest withPageSize(Integer pageSize) {
	...
	public GetArchitectSchedulesDivisionviewsRequest withSortBy(String sortBy) {
	...
	public GetArchitectSchedulesDivisionviewsRequest withSortOrder(String sortOrder) {
	...
	public GetArchitectSchedulesDivisionviewsRequest withId(List<String> id) {
	    this.setId(id);
	    return this;
	} 
	...
	public GetArchitectSchedulesDivisionviewsRequest withName(String name) {
	    this.setName(name);
	    return this;
	} 
	...
	public GetArchitectSchedulesDivisionviewsRequest withDivisionId(List<String> divisionId) {
    ...
    public GetArchitectSchedulesDivisionviewsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/architect/schedules/divisionviews")
	...
	public static class Builder {
		private final GetArchitectSchedulesDivisionviewsRequest request;

		private Builder() {
			request = new GetArchitectSchedulesDivisionviewsRequest();
		}
		...
		public GetArchitectSchedulesDivisionviewsRequest build() {
