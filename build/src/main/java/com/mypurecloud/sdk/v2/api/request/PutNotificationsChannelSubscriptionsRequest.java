...
public class PutNotificationsChannelSubscriptionsRequest {
    ...
    public ApiRequest<List<ChannelTopic>> withHttpInfo() throws ApiException {
        ...
        if (this.channelId == null) {
            throw new ApiException(400, "Missing the required parameter 'channelId' when building request for PutNotificationsChannelSubscriptionsRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new ApiException(400, "Missing the required parameter 'body' when building request for PutNotificationsChannelSubscriptionsRequest.");
        }
