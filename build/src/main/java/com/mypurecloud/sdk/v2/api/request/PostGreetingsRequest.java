...
public class PostGreetingsRequest {
	...
	public PostGreetingsRequest withBody(Greeting body) {
	    this.setBody(body);
	    return this;
	}
    ...
    public PostGreetingsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Greeting> withHttpInfo() throws ApiException {
        ...
        if (this.body == null) {
            throw new ApiException(400, "Missing the required parameter 'body' when building request for PostGreetingsRequest.");
        }
