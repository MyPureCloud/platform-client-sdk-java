...
public class GetRoutingDirectroutingbackupSettingsMeRequest {
    ...
    public GetRoutingDirectroutingbackupSettingsMeRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/routing/directroutingbackup/settings/me")
	...
	public static class Builder {
		private final GetRoutingDirectroutingbackupSettingsMeRequest request;

		private Builder() {
			request = new GetRoutingDirectroutingbackupSettingsMeRequest();
		}
		...
		public GetRoutingDirectroutingbackupSettingsMeRequest build() {
