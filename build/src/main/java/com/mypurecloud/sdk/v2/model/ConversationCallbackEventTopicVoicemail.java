...
public class ConversationCallbackEventTopicVoicemail  implements Serializable {
 ...
 @JsonDeserialize(using = UploadStatusEnumDeserializer.class)
  ...
  public ConversationCallbackEventTopicVoicemail() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
    }
  }

  public ConversationCallbackEventTopicVoicemail(Boolean initWithEmptyList) {
