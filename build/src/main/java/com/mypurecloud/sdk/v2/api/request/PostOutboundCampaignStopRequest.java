...
public class PostOutboundCampaignStopRequest {
	...
	public PostOutboundCampaignStopRequest withCampaignId(String campaignId) {
    ...
    public PostOutboundCampaignStopRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.campaignId == null) {
            throw new IllegalStateException("Missing the required parameter 'campaignId' when building request for PostOutboundCampaignStopRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/outbound/campaigns/{campaignId}/stop")
	...
	public static class Builder {
		private final PostOutboundCampaignStopRequest request;

		private Builder() {
			request = new PostOutboundCampaignStopRequest();
		}
		...
		public PostOutboundCampaignStopRequest build() {
