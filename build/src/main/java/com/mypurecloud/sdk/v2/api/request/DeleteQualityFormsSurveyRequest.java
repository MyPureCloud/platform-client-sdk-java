...
public class DeleteQualityFormsSurveyRequest {
	...
	public DeleteQualityFormsSurveyRequest withFormId(String formId) {
    ...
    public DeleteQualityFormsSurveyRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.formId == null) {
            throw new IllegalStateException("Missing the required parameter 'formId' when building request for DeleteQualityFormsSurveyRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/quality/forms/surveys/{formId}")
	...
	public static class Builder {
		private final DeleteQualityFormsSurveyRequest request;

		private Builder() {
			request = new DeleteQualityFormsSurveyRequest();
		}
		...
		public DeleteQualityFormsSurveyRequest build() {
