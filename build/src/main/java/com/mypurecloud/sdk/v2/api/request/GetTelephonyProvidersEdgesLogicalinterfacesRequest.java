...
public class GetTelephonyProvidersEdgesLogicalinterfacesRequest {
	...
	public GetTelephonyProvidersEdgesLogicalinterfacesRequest withEdgeIds(String edgeIds) {
	...
	public GetTelephonyProvidersEdgesLogicalinterfacesRequest withExpand(List<String> expand) {
    ...
    public GetTelephonyProvidersEdgesLogicalinterfacesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/telephony/providers/edges/logicalinterfaces")
