...
public class DeleteRoutingUserUtilizationRequest {
	...
	public DeleteRoutingUserUtilizationRequest withUserId(String userId) {
    ...
    public DeleteRoutingUserUtilizationRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.userId == null) {
            throw new IllegalStateException("Missing the required parameter 'userId' when building request for DeleteRoutingUserUtilizationRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/routing/users/{userId}/utilization")
	...
	public static class Builder {
		private final DeleteRoutingUserUtilizationRequest request;

		private Builder() {
			request = new DeleteRoutingUserUtilizationRequest();
		}
		...
		public DeleteRoutingUserUtilizationRequest build() {
