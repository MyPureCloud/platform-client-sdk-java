...
public class QueueConversationScreenShareEventTopicJourneyActionMap  implements Serializable {
  
  private String id = null;
  private Long version = null;

  public QueueConversationScreenShareEventTopicJourneyActionMap() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
    }
  }

  public QueueConversationScreenShareEventTopicJourneyActionMap(Boolean initWithEmptyList) {
   ...
   **/
  public QueueConversationScreenShareEventTopicJourneyActionMap id(String id) {
    this.id = id;
    return this;
  }
   ...
   **/
  public QueueConversationScreenShareEventTopicJourneyActionMap version(Long version) {
