...
public class DeleteOrphanrecordingRequest {
	...
	public DeleteOrphanrecordingRequest withOrphanId(String orphanId) {
    ...
    public DeleteOrphanrecordingRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() throws ApiException {
        ...
        if (this.orphanId == null) {
            throw new ApiException(400, "Missing the required parameter 'orphanId' when building request for DeleteOrphanrecordingRequest.");
        }
