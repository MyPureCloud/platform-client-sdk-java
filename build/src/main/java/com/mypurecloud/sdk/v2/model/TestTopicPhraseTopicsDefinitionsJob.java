...
import com.fasterxml.jackson.annotation.JsonValue;
import com.mypurecloud.sdk.v2.model.TestTopicPhraseTestTopicPhraseResults;
...
public class TestTopicPhraseTopicsDefinitionsJob  implements Serializable {
 ...
 @JsonDeserialize(using = StateEnumDeserializer.class)
  ...
  public TestTopicPhraseTopicsDefinitionsJob(Boolean initWithEmptyList) {
  ...
  /**
   **/
  public TestTopicPhraseTopicsDefinitionsJob id(String id) {
    this.id = id;
    return this;
  }
  ...
  /**
   **/
  public TestTopicPhraseTopicsDefinitionsJob state(StateEnum state) {
    this.state = state;
    return this;
  }
  ...
  /**
   **/
  public TestTopicPhraseTopicsDefinitionsJob testTopicPhraseResults(List<TestTopicPhraseTestTopicPhraseResults> testTopicPhraseResults) {
  ...
  public List<TestTopicPhraseTestTopicPhraseResults> getTestTopicPhraseResults() {
    return testTopicPhraseResults;
  }
  public void setTestTopicPhraseResults(List<TestTopicPhraseTestTopicPhraseResults> testTopicPhraseResults) {
    this.testTopicPhraseResults = testTopicPhraseResults;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TestTopicPhraseTopicsDefinitionsJob testTopicPhraseTopicsDefinitionsJob = (TestTopicPhraseTopicsDefinitionsJob) o;
