...
public class PostRecordingUploadsReportsRequest {

	private RecordingUploadReportRequest body;
	public RecordingUploadReportRequest getBody() {
		return this.body;
	}

	public void setBody(RecordingUploadReportRequest body) {
		this.body = body;
	}

	public PostRecordingUploadsReportsRequest withBody(RecordingUploadReportRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostRecordingUploadsReportsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<RecordingUploadReportRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostRecordingUploadsReportsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/recording/uploads/reports")
                .withBody(body)
	...
	public static Builder builder(RecordingUploadReportRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostRecordingUploadsReportsRequest request;

		private Builder() {
			request = new PostRecordingUploadsReportsRequest();
		}


		public Builder withBody(RecordingUploadReportRequest body) {
		...
		public Builder withRequiredParams(RecordingUploadReportRequest body) {
			request.setBody(body);
		...
		public PostRecordingUploadsReportsRequest build() {
