...
public class GetLanguageunderstandingMinerTopicsRequest {
	...
	public GetLanguageunderstandingMinerTopicsRequest withMinerId(String minerId) {
    ...
    public GetLanguageunderstandingMinerTopicsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.minerId == null) {
            throw new IllegalStateException("Missing the required parameter 'minerId' when building request for GetLanguageunderstandingMinerTopicsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/languageunderstanding/miners/{minerId}/topics")
	...
	public static class Builder {
		private final GetLanguageunderstandingMinerTopicsRequest request;

		private Builder() {
			request = new GetLanguageunderstandingMinerTopicsRequest();
		}
		...
		public GetLanguageunderstandingMinerTopicsRequest build() {
