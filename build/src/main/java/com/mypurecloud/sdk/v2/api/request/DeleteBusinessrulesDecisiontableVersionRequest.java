...
public class DeleteBusinessrulesDecisiontableVersionRequest {
	...
	public DeleteBusinessrulesDecisiontableVersionRequest withTableId(String tableId) {
	...
	public DeleteBusinessrulesDecisiontableVersionRequest withTableVersion(Integer tableVersion) {
    ...
    public DeleteBusinessrulesDecisiontableVersionRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.tableId == null) {
            throw new IllegalStateException("Missing the required parameter 'tableId' when building request for DeleteBusinessrulesDecisiontableVersionRequest.");
        }
        
        // verify the required parameter 'tableVersion' is set
        if (this.tableVersion == null) {
            throw new IllegalStateException("Missing the required parameter 'tableVersion' when building request for DeleteBusinessrulesDecisiontableVersionRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/businessrules/decisiontables/{tableId}/versions/{tableVersion}")
	...
	public static class Builder {
		private final DeleteBusinessrulesDecisiontableVersionRequest request;

		private Builder() {
			request = new DeleteBusinessrulesDecisiontableVersionRequest();
		}
		...
		public DeleteBusinessrulesDecisiontableVersionRequest build() {
