...
public class GetTaskmanagementWorkitemsQueryJobRequest {
	...
	public GetTaskmanagementWorkitemsQueryJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetTaskmanagementWorkitemsQueryJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetTaskmanagementWorkitemsQueryJobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/taskmanagement/workitems/query/jobs/{jobId}")
	...
	public static class Builder {
		private final GetTaskmanagementWorkitemsQueryJobRequest request;

		private Builder() {
			request = new GetTaskmanagementWorkitemsQueryJobRequest();
		}
		...
		public GetTaskmanagementWorkitemsQueryJobRequest build() {
