...
public class GetRoutingEmailDomainDkimRequest {
	...
	public GetRoutingEmailDomainDkimRequest withDomainId(String domainId) {
    ...
    public GetRoutingEmailDomainDkimRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.domainId == null) {
            throw new IllegalStateException("Missing the required parameter 'domainId' when building request for GetRoutingEmailDomainDkimRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/routing/email/domains/{domainId}/dkim")
	...
	public static class Builder {
		private final GetRoutingEmailDomainDkimRequest request;

		private Builder() {
			request = new GetRoutingEmailDomainDkimRequest();
		}
		...
		public GetRoutingEmailDomainDkimRequest build() {
