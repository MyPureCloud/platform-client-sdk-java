...
public class GetConversationsMessagingIntegrationsRequest {
	...
	public GetConversationsMessagingIntegrationsRequest withPageSize(Integer pageSize) {
	...
	public GetConversationsMessagingIntegrationsRequest withPageNumber(Integer pageNumber) {
	...
	public GetConversationsMessagingIntegrationsRequest withSupportedContentId(String supportedContentId) {
    ...
    public GetConversationsMessagingIntegrationsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/conversations/messaging/integrations")
	...
	public static class Builder {
		private final GetConversationsMessagingIntegrationsRequest request;

		private Builder() {
			request = new GetConversationsMessagingIntegrationsRequest();
		}
		...
		public GetConversationsMessagingIntegrationsRequest build() {
