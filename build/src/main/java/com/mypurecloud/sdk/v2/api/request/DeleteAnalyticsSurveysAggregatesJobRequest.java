...
public class DeleteAnalyticsSurveysAggregatesJobRequest {
	...
	public DeleteAnalyticsSurveysAggregatesJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public DeleteAnalyticsSurveysAggregatesJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for DeleteAnalyticsSurveysAggregatesJobRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/analytics/surveys/aggregates/jobs/{jobId}")
	...
	public static class Builder {
		private final DeleteAnalyticsSurveysAggregatesJobRequest request;

		private Builder() {
			request = new DeleteAnalyticsSurveysAggregatesJobRequest();
		}
		...
		public DeleteAnalyticsSurveysAggregatesJobRequest build() {
