...
public class GetSpeechandtextanalyticsProgramTranscriptionenginesRequest {
	...
	public GetSpeechandtextanalyticsProgramTranscriptionenginesRequest withProgramId(String programId) {
    ...
    public GetSpeechandtextanalyticsProgramTranscriptionenginesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.programId == null) {
            throw new IllegalStateException("Missing the required parameter 'programId' when building request for GetSpeechandtextanalyticsProgramTranscriptionenginesRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/speechandtextanalytics/programs/{programId}/transcriptionengines")
	...
	public static class Builder {
		private final GetSpeechandtextanalyticsProgramTranscriptionenginesRequest request;

		private Builder() {
			request = new GetSpeechandtextanalyticsProgramTranscriptionenginesRequest();
		}
		...
		public GetSpeechandtextanalyticsProgramTranscriptionenginesRequest build() {
