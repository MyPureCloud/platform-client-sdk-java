...
public class DeleteSpeechandtextanalyticsReprocessingJobRequest {
	...
	public DeleteSpeechandtextanalyticsReprocessingJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public DeleteSpeechandtextanalyticsReprocessingJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for DeleteSpeechandtextanalyticsReprocessingJobRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/speechandtextanalytics/reprocessing/jobs/{jobId}")
	...
	public static class Builder {
		private final DeleteSpeechandtextanalyticsReprocessingJobRequest request;

		private Builder() {
			request = new DeleteSpeechandtextanalyticsReprocessingJobRequest();
		}
		...
		public DeleteSpeechandtextanalyticsReprocessingJobRequest build() {
