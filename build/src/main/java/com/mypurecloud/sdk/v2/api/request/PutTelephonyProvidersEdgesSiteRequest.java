...
public class PutTelephonyProvidersEdgesSiteRequest {
	...
	public PutTelephonyProvidersEdgesSiteRequest withSiteId(String siteId) {
	...
	public PutTelephonyProvidersEdgesSiteRequest withBody(Site body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutTelephonyProvidersEdgesSiteRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Site> withHttpInfo() {
        ...
        if (this.siteId == null) {
            throw new IllegalStateException("Missing the required parameter 'siteId' when building request for PutTelephonyProvidersEdgesSiteRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutTelephonyProvidersEdgesSiteRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/telephony/providers/edges/sites/{siteId}")
	...
	public static Builder builder(String siteId, Site body) {
	    return new Builder()
	...
	public static class Builder {
		private final PutTelephonyProvidersEdgesSiteRequest request;

		private Builder() {
			request = new PutTelephonyProvidersEdgesSiteRequest();
		}
		...
		public Builder withRequiredParams(String siteId, Site body) {
			request.setSiteId(siteId);
						request.setBody(body);
		...
		public PutTelephonyProvidersEdgesSiteRequest build() {
