...
public class Row  implements Serializable {
  ...
  public Row(Boolean initWithEmptyList) {
  ...
  @ApiModelProperty(example = "null", required = true, value = "The ID of the row to update")
  @JsonProperty("rowId")
   ...
   **/
  public Row inputs(Map<String, DecisionTableRowParameterValue> inputs) {
    this.inputs = inputs;
    return this;
  }
   ...
   **/
  public Row outputs(Map<String, DecisionTableRowParameterValue> outputs) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.rowId, row.rowId) &&
            Objects.equals(this.inputs, row.inputs) &&
            Objects.equals(this.outputs, row.outputs);
  }

  @Override
  public int hashCode() {
    return Objects.hash(rowId, inputs, outputs);
  }
