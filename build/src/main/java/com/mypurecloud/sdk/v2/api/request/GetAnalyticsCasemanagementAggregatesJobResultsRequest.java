...
public class GetAnalyticsCasemanagementAggregatesJobResultsRequest {
	...
	public GetAnalyticsCasemanagementAggregatesJobResultsRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
	...
	public GetAnalyticsCasemanagementAggregatesJobResultsRequest withCursor(String cursor) {
    ...
    public GetAnalyticsCasemanagementAggregatesJobResultsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetAnalyticsCasemanagementAggregatesJobResultsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/analytics/casemanagement/aggregates/jobs/{jobId}/results")
	...
	public static class Builder {
		private final GetAnalyticsCasemanagementAggregatesJobResultsRequest request;

		private Builder() {
			request = new GetAnalyticsCasemanagementAggregatesJobResultsRequest();
		}
		...
		public GetAnalyticsCasemanagementAggregatesJobResultsRequest build() {
