...
public class GetSpeechandtextanalyticsConversationCommunicationTranscripturlsRequest {
	...
	public GetSpeechandtextanalyticsConversationCommunicationTranscripturlsRequest withConversationId(String conversationId) {
	...
	public GetSpeechandtextanalyticsConversationCommunicationTranscripturlsRequest withCommunicationId(String communicationId) {
    ...
    public GetSpeechandtextanalyticsConversationCommunicationTranscripturlsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for GetSpeechandtextanalyticsConversationCommunicationTranscripturlsRequest.");
        }
        
        // verify the required parameter 'communicationId' is set
        if (this.communicationId == null) {
            throw new IllegalStateException("Missing the required parameter 'communicationId' when building request for GetSpeechandtextanalyticsConversationCommunicationTranscripturlsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/speechandtextanalytics/conversations/{conversationId}/communications/{communicationId}/transcripturls")
	...
	public static class Builder {
		private final GetSpeechandtextanalyticsConversationCommunicationTranscripturlsRequest request;

		private Builder() {
			request = new GetSpeechandtextanalyticsConversationCommunicationTranscripturlsRequest();
		}
		...
		public GetSpeechandtextanalyticsConversationCommunicationTranscripturlsRequest build() {
