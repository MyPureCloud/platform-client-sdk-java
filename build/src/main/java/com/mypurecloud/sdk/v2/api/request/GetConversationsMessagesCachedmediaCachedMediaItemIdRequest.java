...
public class GetConversationsMessagesCachedmediaCachedMediaItemIdRequest {
	...
	public GetConversationsMessagesCachedmediaCachedMediaItemIdRequest withCachedMediaItemId(String cachedMediaItemId) {
    ...
    public GetConversationsMessagesCachedmediaCachedMediaItemIdRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.cachedMediaItemId == null) {
            throw new IllegalStateException("Missing the required parameter 'cachedMediaItemId' when building request for GetConversationsMessagesCachedmediaCachedMediaItemIdRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/conversations/messages/cachedmedia/{cachedMediaItemId}")
	...
	public static class Builder {
		private final GetConversationsMessagesCachedmediaCachedMediaItemIdRequest request;

		private Builder() {
			request = new GetConversationsMessagesCachedmediaCachedMediaItemIdRequest();
		}
		...
		public GetConversationsMessagesCachedmediaCachedMediaItemIdRequest build() {
