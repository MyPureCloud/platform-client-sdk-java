...
public class GetArchitectScheduleRequest {
	...
	public GetArchitectScheduleRequest withScheduleId(String scheduleId) {
    ...
    public GetArchitectScheduleRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.scheduleId == null) {
            throw new IllegalStateException("Missing the required parameter 'scheduleId' when building request for GetArchitectScheduleRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/architect/schedules/{scheduleId}")
	...
	public static class Builder {
		private final GetArchitectScheduleRequest request;

		private Builder() {
			request = new GetArchitectScheduleRequest();
		}
		...
		public GetArchitectScheduleRequest build() {
