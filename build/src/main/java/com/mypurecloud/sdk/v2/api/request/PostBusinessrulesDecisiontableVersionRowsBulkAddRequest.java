...
public class PostBusinessrulesDecisiontableVersionRowsBulkAddRequest {
	...
	public PostBusinessrulesDecisiontableVersionRowsBulkAddRequest withTableId(String tableId) {
	...
	public PostBusinessrulesDecisiontableVersionRowsBulkAddRequest withTableVersion(Integer tableVersion) {
	    this.setTableVersion(tableVersion);
	    return this;
	} 

	private BulkAddDecisionTableRowsRequest body;
	public BulkAddDecisionTableRowsRequest getBody() {
		return this.body;
	}

	public void setBody(BulkAddDecisionTableRowsRequest body) {
		this.body = body;
	}

	public PostBusinessrulesDecisiontableVersionRowsBulkAddRequest withBody(BulkAddDecisionTableRowsRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostBusinessrulesDecisiontableVersionRowsBulkAddRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<BulkAddDecisionTableRowsRequest> withHttpInfo() {
        
        // verify the required parameter 'tableId' is set
        if (this.tableId == null) {
            throw new IllegalStateException("Missing the required parameter 'tableId' when building request for PostBusinessrulesDecisiontableVersionRowsBulkAddRequest.");
        }
        
        // verify the required parameter 'tableVersion' is set
        if (this.tableVersion == null) {
            throw new IllegalStateException("Missing the required parameter 'tableVersion' when building request for PostBusinessrulesDecisiontableVersionRowsBulkAddRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostBusinessrulesDecisiontableVersionRowsBulkAddRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/businessrules/decisiontables/{tableId}/versions/{tableVersion}/rows/bulk/add")
	...
	public static Builder builder(String tableId, Integer tableVersion, BulkAddDecisionTableRowsRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostBusinessrulesDecisiontableVersionRowsBulkAddRequest request;

		private Builder() {
			request = new PostBusinessrulesDecisiontableVersionRowsBulkAddRequest();
		}
		...
		public Builder withBody(BulkAddDecisionTableRowsRequest body) {
		...
		public Builder withRequiredParams(String tableId, Integer tableVersion, BulkAddDecisionTableRowsRequest body) {
			request.setTableId(tableId);
			request.setTableVersion(tableVersion);
			request.setBody(body);
		...
		public PostBusinessrulesDecisiontableVersionRowsBulkAddRequest build() {
