...
public class GetIntegrationsSpeechNuanceNuanceIntegrationIdBotsRequest {
	...
	public GetIntegrationsSpeechNuanceNuanceIntegrationIdBotsRequest withNuanceIntegrationId(String nuanceIntegrationId) {
	...
	public GetIntegrationsSpeechNuanceNuanceIntegrationIdBotsRequest withPageNumber(Integer pageNumber) {
	...
	public GetIntegrationsSpeechNuanceNuanceIntegrationIdBotsRequest withPageSize(Integer pageSize) {
	...
	public GetIntegrationsSpeechNuanceNuanceIntegrationIdBotsRequest withOnlyRegisteredBots(Boolean onlyRegisteredBots) {
    ...
    public GetIntegrationsSpeechNuanceNuanceIntegrationIdBotsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.nuanceIntegrationId == null) {
            throw new IllegalStateException("Missing the required parameter 'nuanceIntegrationId' when building request for GetIntegrationsSpeechNuanceNuanceIntegrationIdBotsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/integrations/speech/nuance/{nuanceIntegrationId}/bots")
	...
	public static class Builder {
		private final GetIntegrationsSpeechNuanceNuanceIntegrationIdBotsRequest request;

		private Builder() {
			request = new GetIntegrationsSpeechNuanceNuanceIntegrationIdBotsRequest();
		}
		...
		public GetIntegrationsSpeechNuanceNuanceIntegrationIdBotsRequest build() {
