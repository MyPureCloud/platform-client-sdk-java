...
public class QueueConversationEmailEventTopicScoredAgent  implements Serializable {
  ...
  public QueueConversationEmailEventTopicScoredAgent() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
    }
  }

  public QueueConversationEmailEventTopicScoredAgent(Boolean initWithEmptyList) {
   ...
   **/
  public QueueConversationEmailEventTopicScoredAgent score(Long score) {
    this.score = score;
    return this;
  }
