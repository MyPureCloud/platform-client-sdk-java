...
public class GetScimV2ResourcetypeRequest {
	...
	public GetScimV2ResourcetypeRequest withResourceType(String resourceType) {
    ...
    public GetScimV2ResourcetypeRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.resourceType == null) {
            throw new IllegalStateException("Missing the required parameter 'resourceType' when building request for GetScimV2ResourcetypeRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/scim/v2/resourcetypes/{resourceType}")
	...
	public static class Builder {
		private final GetScimV2ResourcetypeRequest request;

		private Builder() {
			request = new GetScimV2ResourcetypeRequest();
		}
		...
		public GetScimV2ResourcetypeRequest build() {
