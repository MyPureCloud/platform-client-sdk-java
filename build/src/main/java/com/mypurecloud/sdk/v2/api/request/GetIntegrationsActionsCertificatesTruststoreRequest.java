...
public class GetIntegrationsActionsCertificatesTruststoreRequest {
    ...
    public GetIntegrationsActionsCertificatesTruststoreRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/integrations/actions/certificates/truststore")
	...
	public static class Builder {
		private final GetIntegrationsActionsCertificatesTruststoreRequest request;

		private Builder() {
			request = new GetIntegrationsActionsCertificatesTruststoreRequest();
		}
		...
		public GetIntegrationsActionsCertificatesTruststoreRequest build() {
