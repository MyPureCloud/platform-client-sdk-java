...
public class GetProfilesGroupsRequest {
	...
	public GetProfilesGroupsRequest withPageSize(Integer pageSize) {
	...
	public GetProfilesGroupsRequest withPageNumber(Integer pageNumber) {
	...
	public GetProfilesGroupsRequest withId(List<String> id) {
	    this.setId(id);
	    return this;
	} 
	...
	public GetProfilesGroupsRequest withSortOrder(String sortOrder) {
    ...
    public GetProfilesGroupsRequest withCustomHeader(String name, String value) {
