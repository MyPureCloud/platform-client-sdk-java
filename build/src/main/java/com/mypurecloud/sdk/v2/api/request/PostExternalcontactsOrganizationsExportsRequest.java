...
public class PostExternalcontactsOrganizationsExportsRequest {

	private OrganizationsExport body;
	public OrganizationsExport getBody() {
		return this.body;
	}

	public void setBody(OrganizationsExport body) {
		this.body = body;
	}

	public PostExternalcontactsOrganizationsExportsRequest withBody(OrganizationsExport body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostExternalcontactsOrganizationsExportsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<OrganizationsExport> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostExternalcontactsOrganizationsExportsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/externalcontacts/organizations/exports")
                .withBody(body)
	...
	public static Builder builder(OrganizationsExport body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostExternalcontactsOrganizationsExportsRequest request;

		private Builder() {
			request = new PostExternalcontactsOrganizationsExportsRequest();
		}


		public Builder withBody(OrganizationsExport body) {
		...
		public Builder withRequiredParams(OrganizationsExport body) {
			request.setBody(body);
		...
		public PostExternalcontactsOrganizationsExportsRequest build() {
