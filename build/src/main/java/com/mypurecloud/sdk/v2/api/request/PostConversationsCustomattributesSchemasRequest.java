...
public class PostConversationsCustomattributesSchemasRequest {

	private ConversationJsonSchemaRequest body;
	public ConversationJsonSchemaRequest getBody() {
		return this.body;
	}

	public void setBody(ConversationJsonSchemaRequest body) {
		this.body = body;
	}

	public PostConversationsCustomattributesSchemasRequest withBody(ConversationJsonSchemaRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostConversationsCustomattributesSchemasRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<ConversationJsonSchemaRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostConversationsCustomattributesSchemasRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/conversations/customattributes/schemas")
                .withBody(body)
	...
	public static Builder builder(ConversationJsonSchemaRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostConversationsCustomattributesSchemasRequest request;

		private Builder() {
			request = new PostConversationsCustomattributesSchemasRequest();
		}


		public Builder withBody(ConversationJsonSchemaRequest body) {
		...
		public Builder withRequiredParams(ConversationJsonSchemaRequest body) {
			request.setBody(body);
		...
		public PostConversationsCustomattributesSchemasRequest build() {
