...
public class PostRoutingEmailDomainMailfromRequest {
	...
	public PostRoutingEmailDomainMailfromRequest withDomainId(String domainId) {
	    this.setDomainId(domainId);
	    return this;
	} 

	private MailFromResult body;
	public MailFromResult getBody() {
		return this.body;
	}

	public void setBody(MailFromResult body) {
		this.body = body;
	}

	public PostRoutingEmailDomainMailfromRequest withBody(MailFromResult body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostRoutingEmailDomainMailfromRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<MailFromResult> withHttpInfo() {
        
        // verify the required parameter 'domainId' is set
        if (this.domainId == null) {
            throw new IllegalStateException("Missing the required parameter 'domainId' when building request for PostRoutingEmailDomainMailfromRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostRoutingEmailDomainMailfromRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/routing/email/domains/{domainId}/mailfrom")
	...
	public static Builder builder(String domainId, MailFromResult body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostRoutingEmailDomainMailfromRequest request;

		private Builder() {
			request = new PostRoutingEmailDomainMailfromRequest();
		}
		...
		public Builder withBody(MailFromResult body) {
		...
		public Builder withRequiredParams(String domainId, MailFromResult body) {
			request.setDomainId(domainId);
			request.setBody(body);
		...
		public PostRoutingEmailDomainMailfromRequest build() {
