...
public class DeleteRoutingUtilizationTagRequest {
	...
	public DeleteRoutingUtilizationTagRequest withTagId(String tagId) {
	    this.setTagId(tagId);
	    return this;
	} 
	...
	public DeleteRoutingUtilizationTagRequest withForceDelete(Boolean forceDelete) {
    ...
    public DeleteRoutingUtilizationTagRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.tagId == null) {
            throw new IllegalStateException("Missing the required parameter 'tagId' when building request for DeleteRoutingUtilizationTagRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/routing/utilization/tags/{tagId}")
	...
	public static Builder builder(String tagId) {
	    return new Builder()
	            .withRequiredParams(tagId);
	}


	public static class Builder {
		private final DeleteRoutingUtilizationTagRequest request;

		private Builder() {
			request = new DeleteRoutingUtilizationTagRequest();
		}
		...
		public Builder withRequiredParams(String tagId) {
			request.setTagId(tagId);
		...
		public DeleteRoutingUtilizationTagRequest build() {
