...
public class PostConversationsMessagingIntegrationsOpenExtensionsGooglebusinessprofileRequest {

	private GoogleBusinessProfileOpenIntegrationRequest body;
	public GoogleBusinessProfileOpenIntegrationRequest getBody() {
		return this.body;
	}

	public void setBody(GoogleBusinessProfileOpenIntegrationRequest body) {
		this.body = body;
	}

	public PostConversationsMessagingIntegrationsOpenExtensionsGooglebusinessprofileRequest withBody(GoogleBusinessProfileOpenIntegrationRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostConversationsMessagingIntegrationsOpenExtensionsGooglebusinessprofileRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<GoogleBusinessProfileOpenIntegrationRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostConversationsMessagingIntegrationsOpenExtensionsGooglebusinessprofileRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/conversations/messaging/integrations/open/extensions/googlebusinessprofile")
                .withBody(body)
	...
	public static Builder builder(GoogleBusinessProfileOpenIntegrationRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostConversationsMessagingIntegrationsOpenExtensionsGooglebusinessprofileRequest request;

		private Builder() {
			request = new PostConversationsMessagingIntegrationsOpenExtensionsGooglebusinessprofileRequest();
		}


		public Builder withBody(GoogleBusinessProfileOpenIntegrationRequest body) {
		...
		public Builder withRequiredParams(GoogleBusinessProfileOpenIntegrationRequest body) {
			request.setBody(body);
		...
		public PostConversationsMessagingIntegrationsOpenExtensionsGooglebusinessprofileRequest build() {
