...
public class PostOutboundContactlistsBulkUpdateRequest {

	private ContactListsBulkEditRequest body;
	public ContactListsBulkEditRequest getBody() {
		return this.body;
	}

	public void setBody(ContactListsBulkEditRequest body) {
		this.body = body;
	}

	public PostOutboundContactlistsBulkUpdateRequest withBody(ContactListsBulkEditRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostOutboundContactlistsBulkUpdateRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<ContactListsBulkEditRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostOutboundContactlistsBulkUpdateRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/outbound/contactlists/bulk/update")
                .withBody(body)
	...
	public static Builder builder(ContactListsBulkEditRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostOutboundContactlistsBulkUpdateRequest request;

		private Builder() {
			request = new PostOutboundContactlistsBulkUpdateRequest();
		}


		public Builder withBody(ContactListsBulkEditRequest body) {
		...
		public Builder withRequiredParams(ContactListsBulkEditRequest body) {
			request.setBody(body);
		...
		public PostOutboundContactlistsBulkUpdateRequest build() {
