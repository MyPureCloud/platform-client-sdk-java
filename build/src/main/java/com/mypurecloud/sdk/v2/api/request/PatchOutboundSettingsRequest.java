...
public class PatchOutboundSettingsRequest {
    
	private OutboundSettings body;
	public OutboundSettings getBody() {
		return this.body;
	}

	public void setBody(OutboundSettings body) {
		this.body = body;
	}

	public PatchOutboundSettingsRequest withBody(OutboundSettings body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchOutboundSettingsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<OutboundSettings> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchOutboundSettingsRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/outbound/settings")
                .withBody(body)
	...
	public static Builder builder(OutboundSettings body) {
	    return new Builder()
	...
	public static class Builder {
		private final PatchOutboundSettingsRequest request;

		private Builder() {
			request = new PatchOutboundSettingsRequest();
		}

		
		public Builder withBody(OutboundSettings body) {
		...
		public Builder withRequiredParams(OutboundSettings body) {
			request.setBody(body);
		...
		public PatchOutboundSettingsRequest build() {
