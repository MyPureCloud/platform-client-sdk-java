...
public class ConversationCallEventTopicErrorBody  implements Serializable {
  ...
  private List<ConversationCallEventTopicDetail> details = null;
  private List<ConversationCallEventTopicErrorBody> errors = null;
  private ConversationCallEventTopicLimit limit = null;

  public ConversationCallEventTopicErrorBody() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
      details = new ArrayList<ConversationCallEventTopicDetail>();
      errors = new ArrayList<ConversationCallEventTopicErrorBody>();
    }
  }

  public ConversationCallEventTopicErrorBody(Boolean initWithEmptyList) {
  ...
  /**
   **/
  public ConversationCallEventTopicErrorBody status(Long status) {
    this.status = status;
    return this;
  }
