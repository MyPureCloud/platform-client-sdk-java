...
public class GetRecordingsScreensessionsDetailsRequest {
    ...
    public GetRecordingsScreensessionsDetailsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/recordings/screensessions/details")
	...
	public static class Builder {
		private final GetRecordingsScreensessionsDetailsRequest request;

		private Builder() {
			request = new GetRecordingsScreensessionsDetailsRequest();
		}
		...
		public GetRecordingsScreensessionsDetailsRequest build() {
