...
public class DeleteAnalyticsActionsAggregatesJobRequest {
	...
	public DeleteAnalyticsActionsAggregatesJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public DeleteAnalyticsActionsAggregatesJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for DeleteAnalyticsActionsAggregatesJobRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/analytics/actions/aggregates/jobs/{jobId}")
	...
	public static class Builder {
		private final DeleteAnalyticsActionsAggregatesJobRequest request;

		private Builder() {
			request = new DeleteAnalyticsActionsAggregatesJobRequest();
		}
		...
		public DeleteAnalyticsActionsAggregatesJobRequest build() {
