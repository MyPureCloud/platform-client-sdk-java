...
public class GetSpeechandtextanalyticsProgramsSettingsInsightsRequest {
	...
	public GetSpeechandtextanalyticsProgramsSettingsInsightsRequest withPageSize(Integer pageSize) {
	...
	public GetSpeechandtextanalyticsProgramsSettingsInsightsRequest withPageNumber(Integer pageNumber) {
	...
	public GetSpeechandtextanalyticsProgramsSettingsInsightsRequest withProgramIds(List<String> programIds) {
	    this.setProgramIds(programIds);
	    return this;
	} 
    ...
    public GetSpeechandtextanalyticsProgramsSettingsInsightsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/speechandtextanalytics/programs/settings/insights")
                ...
                .withQueryParameters("programIds", "multi", programIds)
	...
	public static class Builder {
		private final GetSpeechandtextanalyticsProgramsSettingsInsightsRequest request;

		private Builder() {
			request = new GetSpeechandtextanalyticsProgramsSettingsInsightsRequest();
		}
		...
		public Builder withProgramIds(List<String> programIds) {
		...
		public GetSpeechandtextanalyticsProgramsSettingsInsightsRequest build() {
