...
public class PostJourneyDeploymentWebeventsRequest {
	...
	public PostJourneyDeploymentWebeventsRequest withDeploymentId(String deploymentId) {
	    this.setDeploymentId(deploymentId);
	    return this;
	} 

	private WebEventRequest body;
	public WebEventRequest getBody() {
		return this.body;
	}

	public void setBody(WebEventRequest body) {
		this.body = body;
	}

	public PostJourneyDeploymentWebeventsRequest withBody(WebEventRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostJourneyDeploymentWebeventsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<WebEventRequest> withHttpInfo() {
        
        // verify the required parameter 'deploymentId' is set
        if (this.deploymentId == null) {
            throw new IllegalStateException("Missing the required parameter 'deploymentId' when building request for PostJourneyDeploymentWebeventsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/journey/deployments/{deploymentId}/webevents")
	...
	public static class Builder {
		private final PostJourneyDeploymentWebeventsRequest request;

		private Builder() {
			request = new PostJourneyDeploymentWebeventsRequest();
		}
		...
		public Builder withBody(WebEventRequest body) {
		...
		public PostJourneyDeploymentWebeventsRequest build() {
