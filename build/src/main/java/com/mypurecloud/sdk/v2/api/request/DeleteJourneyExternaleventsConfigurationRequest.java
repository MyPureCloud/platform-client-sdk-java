...
public class DeleteJourneyExternaleventsConfigurationRequest {
	...
	public DeleteJourneyExternaleventsConfigurationRequest withConfigId(String configId) {
    ...
    public DeleteJourneyExternaleventsConfigurationRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.configId == null) {
            throw new IllegalStateException("Missing the required parameter 'configId' when building request for DeleteJourneyExternaleventsConfigurationRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/journey/externalevents/configurations/{configId}")
	...
	public static class Builder {
		private final DeleteJourneyExternaleventsConfigurationRequest request;

		private Builder() {
			request = new DeleteJourneyExternaleventsConfigurationRequest();
		}
		...
		public DeleteJourneyExternaleventsConfigurationRequest build() {
