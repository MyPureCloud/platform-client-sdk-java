...
public class GetOrgauthorizationTrustorGroupRequest {
	...
	public GetOrgauthorizationTrustorGroupRequest withTrustorOrgId(String trustorOrgId) {
	...
	public GetOrgauthorizationTrustorGroupRequest withTrustorGroupId(String trustorGroupId) {
    ...
    public GetOrgauthorizationTrustorGroupRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.trustorOrgId == null) {
            throw new IllegalStateException("Missing the required parameter 'trustorOrgId' when building request for GetOrgauthorizationTrustorGroupRequest.");
        }
        
        // verify the required parameter 'trustorGroupId' is set
        if (this.trustorGroupId == null) {
            throw new IllegalStateException("Missing the required parameter 'trustorGroupId' when building request for GetOrgauthorizationTrustorGroupRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/orgauthorization/trustors/{trustorOrgId}/groups/{trustorGroupId}")
	...
	public static class Builder {
		private final GetOrgauthorizationTrustorGroupRequest request;

		private Builder() {
			request = new GetOrgauthorizationTrustorGroupRequest();
		}
		...
		public GetOrgauthorizationTrustorGroupRequest build() {
