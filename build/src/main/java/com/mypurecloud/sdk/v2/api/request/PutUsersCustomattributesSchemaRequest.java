...
public class PutUsersCustomattributesSchemaRequest {
	...
	public PutUsersCustomattributesSchemaRequest withSchemaId(String schemaId) {
	...
	public PutUsersCustomattributesSchemaRequest withBody(DataSchema body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutUsersCustomattributesSchemaRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<DataSchema> withHttpInfo() {
        ...
        if (this.schemaId == null) {
            throw new IllegalStateException("Missing the required parameter 'schemaId' when building request for PutUsersCustomattributesSchemaRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutUsersCustomattributesSchemaRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/users/customattributes/schemas/{schemaId}")
	...
	public static class Builder {
		private final PutUsersCustomattributesSchemaRequest request;

		private Builder() {
			request = new PutUsersCustomattributesSchemaRequest();
		}
		...
		public PutUsersCustomattributesSchemaRequest build() {
