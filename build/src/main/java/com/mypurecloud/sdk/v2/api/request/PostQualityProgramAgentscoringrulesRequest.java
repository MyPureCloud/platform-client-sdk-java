...
public class PostQualityProgramAgentscoringrulesRequest {
	...
	public PostQualityProgramAgentscoringrulesRequest withProgramId(String programId) {
	...
	public PostQualityProgramAgentscoringrulesRequest withBody(AgentScoringRule body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostQualityProgramAgentscoringrulesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<AgentScoringRule> withHttpInfo() {
        ...
        if (this.programId == null) {
            throw new IllegalStateException("Missing the required parameter 'programId' when building request for PostQualityProgramAgentscoringrulesRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostQualityProgramAgentscoringrulesRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/quality/programs/{programId}/agentscoringrules")
	...
	public static Builder builder(String programId, AgentScoringRule body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostQualityProgramAgentscoringrulesRequest request;

		private Builder() {
			request = new PostQualityProgramAgentscoringrulesRequest();
		}
		...
		public Builder withRequiredParams(String programId, AgentScoringRule body) {
			request.setProgramId(programId);
			request.setBody(body);
		...
		public PostQualityProgramAgentscoringrulesRequest build() {
