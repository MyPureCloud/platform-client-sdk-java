...
import com.mypurecloud.sdk.v2.model.DocumentVariationQueryChunkBlock;
...
public class KnowledgeDocumentQueryVariation  implements Serializable {
  ...
  private List<DocumentVariationQueryChunkBlock> chunks = null;
  private String selfUri = null;

  public KnowledgeDocumentQueryVariation() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
      contexts = new ArrayList<DocumentVariationContext>();
      chunks = new ArrayList<DocumentVariationQueryChunkBlock>();
    }
  }

  public KnowledgeDocumentQueryVariation(Boolean initWithEmptyList) {
   ...
   **/
  public KnowledgeDocumentQueryVariation documentVersion(AddressableEntityRef documentVersion) {
   ...
   **/
  public KnowledgeDocumentQueryVariation contexts(List<DocumentVariationContext> contexts) {
   ...
   **/
  public KnowledgeDocumentQueryVariation priority(Integer priority) {
   ...
   **/
  public KnowledgeDocumentQueryVariation name(String name) {
    this.name = name;
    return this;
  }
   ...
   **/
  public KnowledgeDocumentQueryVariation body(DocumentBodyResponse body) {
    this.body = body;
    return this;
  }
   ...
   **/
  public KnowledgeDocumentQueryVariation chunks(List<DocumentVariationQueryChunkBlock> chunks) {
    this.chunks = chunks;
    return this;
  }
  ...
  @JsonProperty("chunks")
  public List<DocumentVariationQueryChunkBlock> getChunks() {
    return chunks;
  }
  public void setChunks(List<DocumentVariationQueryChunkBlock> chunks) {
    this.chunks = chunks;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    KnowledgeDocumentQueryVariation knowledgeDocumentQueryVariation = (KnowledgeDocumentQueryVariation) o;

    return Objects.equals(this.id, knowledgeDocumentQueryVariation.id) &&
            Objects.equals(this.dateCreated, knowledgeDocumentQueryVariation.dateCreated) &&
            Objects.equals(this.dateModified, knowledgeDocumentQueryVariation.dateModified) &&
            Objects.equals(this.documentVersion, knowledgeDocumentQueryVariation.documentVersion) &&
            Objects.equals(this.contexts, knowledgeDocumentQueryVariation.contexts) &&
            Objects.equals(this.document, knowledgeDocumentQueryVariation.document) &&
            Objects.equals(this.priority, knowledgeDocumentQueryVariation.priority) &&
            Objects.equals(this.name, knowledgeDocumentQueryVariation.name) &&
            Objects.equals(this.body, knowledgeDocumentQueryVariation.body) &&
            Objects.equals(this.chunks, knowledgeDocumentQueryVariation.chunks) &&
            Objects.equals(this.selfUri, knowledgeDocumentQueryVariation.selfUri);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, dateCreated, dateModified, documentVersion, contexts, document, priority, name, body, chunks, selfUri);
  }
