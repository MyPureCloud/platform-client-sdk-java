...
public class ConversationMessageEventTopicErrorDetails  implements Serializable {
  ...
  public ConversationMessageEventTopicErrorDetails() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
    }
  }

  public ConversationMessageEventTopicErrorDetails(Boolean initWithEmptyList) {
   ...
   **/
  public ConversationMessageEventTopicErrorDetails status(Long status) {
    this.status = status;
    return this;
  }
   ...
   **/
  public ConversationMessageEventTopicErrorDetails code(String code) {
    this.code = code;
    return this;
  }
   ...
   **/
  public ConversationMessageEventTopicErrorDetails message(String message) {
   ...
   **/
  public ConversationMessageEventTopicErrorDetails messageWithParams(String messageWithParams) {
   ...
   **/
  public ConversationMessageEventTopicErrorDetails messageParams(Map<String, String> messageParams) {
   ...
   **/
  public ConversationMessageEventTopicErrorDetails contextId(String contextId) {
  ...
  /**
   **/
  public ConversationMessageEventTopicErrorDetails uri(String uri) {
    this.uri = uri;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ConversationMessageEventTopicErrorDetails conversationMessageEventTopicErrorDetails = (ConversationMessageEventTopicErrorDetails) o;

    return Objects.equals(this.status, conversationMessageEventTopicErrorDetails.status) &&
            Objects.equals(this.code, conversationMessageEventTopicErrorDetails.code) &&
            Objects.equals(this.message, conversationMessageEventTopicErrorDetails.message) &&
