...
public class GetRoutingUtilizationTagsRequest {
	...
	public GetRoutingUtilizationTagsRequest withPageSize(Integer pageSize) {
	...
	public GetRoutingUtilizationTagsRequest withPageNumber(Integer pageNumber) {
	...
	public GetRoutingUtilizationTagsRequest withSortOrder(String sortOrder) {
	...
	public GetRoutingUtilizationTagsRequest withName(String name) {
	    this.setName(name);
	    return this;
	} 
    ...
    public GetRoutingUtilizationTagsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/routing/utilization/tags")
	...
	public static class Builder {
		private final GetRoutingUtilizationTagsRequest request;

		private Builder() {
			request = new GetRoutingUtilizationTagsRequest();
		}
		...
		public GetRoutingUtilizationTagsRequest build() {
