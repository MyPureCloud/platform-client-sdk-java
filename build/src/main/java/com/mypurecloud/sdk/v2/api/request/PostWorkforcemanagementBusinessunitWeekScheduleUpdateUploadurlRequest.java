...
public class PostWorkforcemanagementBusinessunitWeekScheduleUpdateUploadurlRequest {
	...
	public PostWorkforcemanagementBusinessunitWeekScheduleUpdateUploadurlRequest withBusinessUnitId(String businessUnitId) {
	...
	public PostWorkforcemanagementBusinessunitWeekScheduleUpdateUploadurlRequest withWeekId(LocalDate weekId) {
	...
	public PostWorkforcemanagementBusinessunitWeekScheduleUpdateUploadurlRequest withScheduleId(String scheduleId) {
	...
	public PostWorkforcemanagementBusinessunitWeekScheduleUpdateUploadurlRequest withBody(UploadUrlRequestBody body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementBusinessunitWeekScheduleUpdateUploadurlRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<UploadUrlRequestBody> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PostWorkforcemanagementBusinessunitWeekScheduleUpdateUploadurlRequest.");
        }
        
        // verify the required parameter 'weekId' is set
        if (this.weekId == null) {
            throw new IllegalStateException("Missing the required parameter 'weekId' when building request for PostWorkforcemanagementBusinessunitWeekScheduleUpdateUploadurlRequest.");
        }
        
        // verify the required parameter 'scheduleId' is set
        if (this.scheduleId == null) {
            throw new IllegalStateException("Missing the required parameter 'scheduleId' when building request for PostWorkforcemanagementBusinessunitWeekScheduleUpdateUploadurlRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementBusinessunitWeekScheduleUpdateUploadurlRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/weeks/{weekId}/schedules/{scheduleId}/update/uploadurl")
	...
	public static Builder builder(String businessUnitId, LocalDate weekId, String scheduleId, UploadUrlRequestBody body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementBusinessunitWeekScheduleUpdateUploadurlRequest request;

		private Builder() {
			request = new PostWorkforcemanagementBusinessunitWeekScheduleUpdateUploadurlRequest();
		}
		...
		public Builder withRequiredParams(String businessUnitId, LocalDate weekId, String scheduleId, UploadUrlRequestBody body) {
			request.setBusinessUnitId(businessUnitId);
						request.setWeekId(weekId);
						request.setScheduleId(scheduleId);
						request.setBody(body);
		...
		public PostWorkforcemanagementBusinessunitWeekScheduleUpdateUploadurlRequest build() {
