...
public class DocumentationV2SearchAggregation  implements Serializable {
 ...
 @JsonDeserialize(using = OrderEnumDeserializer.class)
   ...
   **/
  public DocumentationV2SearchAggregation field(String field) {
    this.field = field;
    return this;
  }
   ...
   **/
  public DocumentationV2SearchAggregation name(String name) {
    this.name = name;
    return this;
  }
   ...
   * The type of aggregation to perform
   **/
  public DocumentationV2SearchAggregation type(TypeEnum type) {
    this.type = type;
    return this;
  }
   ...
   **/
  public DocumentationV2SearchAggregation value(String value) {
    this.value = value;
    return this;
  }
   ...
   **/
  public DocumentationV2SearchAggregation size(Integer size) {
    this.size = size;
    return this;
  }
   ...
   **/
  public DocumentationV2SearchAggregation order(List<OrderEnum> order) {
    this.order = order;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DocumentationV2SearchAggregation documentationV2SearchAggregation = (DocumentationV2SearchAggregation) o;

    return Objects.equals(this.field, documentationV2SearchAggregation.field) &&
            Objects.equals(this.name, documentationV2SearchAggregation.name) &&
            Objects.equals(this.type, documentationV2SearchAggregation.type) &&
            Objects.equals(this.value, documentationV2SearchAggregation.value) &&
            Objects.equals(this.size, documentationV2SearchAggregation.size) &&
            Objects.equals(this.order, documentationV2SearchAggregation.order);
  }
