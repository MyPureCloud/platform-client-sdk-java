...
public class GetWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionExportForecastJobRequest {
	...
	public GetWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionExportForecastJobRequest withBusinessUnitId(String businessUnitId) {
	...
	public GetWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionExportForecastJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionExportForecastJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for GetWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionExportForecastJobRequest.");
        }
        
        // verify the required parameter 'jobId' is set
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionExportForecastJobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/mainforecast/continuousforecast/session/export/forecast/jobs/{jobId}")
	...
	public static class Builder {
		private final GetWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionExportForecastJobRequest request;

		private Builder() {
			request = new GetWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionExportForecastJobRequest();
		}
		...
		public GetWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionExportForecastJobRequest build() {
