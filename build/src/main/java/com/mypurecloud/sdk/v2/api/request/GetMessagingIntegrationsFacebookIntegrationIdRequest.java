...
public class GetMessagingIntegrationsFacebookIntegrationIdRequest {
	...
	public GetMessagingIntegrationsFacebookIntegrationIdRequest withIntegrationId(String integrationId) {
    ...
    public GetMessagingIntegrationsFacebookIntegrationIdRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.integrationId == null) {
            throw new IllegalStateException("Missing the required parameter 'integrationId' when building request for GetMessagingIntegrationsFacebookIntegrationIdRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/messaging/integrations/facebook/{integrationId}")
	...
	public static class Builder {
		private final GetMessagingIntegrationsFacebookIntegrationIdRequest request;

		private Builder() {
			request = new GetMessagingIntegrationsFacebookIntegrationIdRequest();
		}
		...
		public GetMessagingIntegrationsFacebookIntegrationIdRequest build() {
