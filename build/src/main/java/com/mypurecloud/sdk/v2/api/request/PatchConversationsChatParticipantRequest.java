...
public class PatchConversationsChatParticipantRequest {
	...
	public PatchConversationsChatParticipantRequest withConversationId(String conversationId) {
    ...
    public ApiRequest<MediaParticipantRequest> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PatchConversationsChatParticipantRequest.");
        }
        ...
        return ApiRequestBuilder.create("PATCH", "/api/v2/conversations/chats/{conversationId}/participants/{participantId}")
