...
public class FlowAggregationSort  implements Serializable {
 ...
 @JsonDeserialize(using = FunctionEnumDeserializer.class)
  ...
  public FlowAggregationSort(Boolean initWithEmptyList) {
   ...
   * Name of the metric used for sorting values.
   **/
  public FlowAggregationSort name(NameEnum name) {
    this.name = name;
    return this;
  }
   ...
   * Aggregation function used for the sort metric.
   **/
  public FlowAggregationSort function(FunctionEnum function) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    FlowAggregationSort flowAggregationSort = (FlowAggregationSort) o;

    return Objects.equals(this.name, flowAggregationSort.name) &&
            Objects.equals(this.function, flowAggregationSort.function);
  }
