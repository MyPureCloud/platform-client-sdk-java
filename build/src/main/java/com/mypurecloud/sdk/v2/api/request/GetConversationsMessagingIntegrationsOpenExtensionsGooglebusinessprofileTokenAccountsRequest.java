...
public class GetConversationsMessagingIntegrationsOpenExtensionsGooglebusinessprofileTokenAccountsRequest {
	...
	public GetConversationsMessagingIntegrationsOpenExtensionsGooglebusinessprofileTokenAccountsRequest withTokenId(String tokenId) {
    ...
    public GetConversationsMessagingIntegrationsOpenExtensionsGooglebusinessprofileTokenAccountsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.tokenId == null) {
            throw new IllegalStateException("Missing the required parameter 'tokenId' when building request for GetConversationsMessagingIntegrationsOpenExtensionsGooglebusinessprofileTokenAccountsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/conversations/messaging/integrations/open/extensions/googlebusinessprofile/tokens/{tokenId}/accounts")
	...
	public static Builder builder(String tokenId) {
	    return new Builder()
	            .withRequiredParams(tokenId);
	}


	public static class Builder {
		private final GetConversationsMessagingIntegrationsOpenExtensionsGooglebusinessprofileTokenAccountsRequest request;

		private Builder() {
			request = new GetConversationsMessagingIntegrationsOpenExtensionsGooglebusinessprofileTokenAccountsRequest();
		}
		...
		public Builder withRequiredParams(String tokenId) {
			request.setTokenId(tokenId);
		...
		public GetConversationsMessagingIntegrationsOpenExtensionsGooglebusinessprofileTokenAccountsRequest build() {
