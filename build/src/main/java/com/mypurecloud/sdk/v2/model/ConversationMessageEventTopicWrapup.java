...
public class ConversationMessageEventTopicWrapup  implements Serializable {
  ...
  public ConversationMessageEventTopicWrapup() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
      tags = new ArrayList<String>();
    }
  }

  public ConversationMessageEventTopicWrapup(Boolean initWithEmptyList) {
   ...
   **/
  public ConversationMessageEventTopicWrapup durationSeconds(Long durationSeconds) {
