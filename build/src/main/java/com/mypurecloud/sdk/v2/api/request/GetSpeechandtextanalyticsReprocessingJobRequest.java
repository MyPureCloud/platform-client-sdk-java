...
public class GetSpeechandtextanalyticsReprocessingJobRequest {
	...
	public GetSpeechandtextanalyticsReprocessingJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetSpeechandtextanalyticsReprocessingJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetSpeechandtextanalyticsReprocessingJobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/speechandtextanalytics/reprocessing/jobs/{jobId}")
	...
	public static class Builder {
		private final GetSpeechandtextanalyticsReprocessingJobRequest request;

		private Builder() {
			request = new GetSpeechandtextanalyticsReprocessingJobRequest();
		}
		...
		public GetSpeechandtextanalyticsReprocessingJobRequest build() {
