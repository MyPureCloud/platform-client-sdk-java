...
public class NluDomainVersionListing  implements Serializable, PagedResource<NluDomainVersion> {
  
  private List<NluDomainVersion> entities = null;
  ...
  public NluDomainVersionListing() {
  ...
  /**
   **/
  public NluDomainVersionListing entities(List<NluDomainVersion> entities) {
  ...
  public List<NluDomainVersion> getEntities() {
    return entities;
  }
  public void setEntities(List<NluDomainVersion> entities) {
    this.entities = entities;
  }
