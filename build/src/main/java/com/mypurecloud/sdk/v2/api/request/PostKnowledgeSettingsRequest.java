...
public class PostKnowledgeSettingsRequest {
	...
	public PostKnowledgeSettingsRequest withBody(KnowledgeSettingsRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostKnowledgeSettingsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<KnowledgeSettingsRequest> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("POST", "/api/v2/knowledge/settings")
                .withBody(body)
	...
	public static class Builder {
		private final PostKnowledgeSettingsRequest request;

		private Builder() {
			request = new PostKnowledgeSettingsRequest();
		}
		...
		public PostKnowledgeSettingsRequest build() {
