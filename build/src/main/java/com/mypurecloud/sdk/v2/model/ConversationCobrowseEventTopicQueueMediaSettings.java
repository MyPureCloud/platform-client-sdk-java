...
public class ConversationCobrowseEventTopicQueueMediaSettings  implements Serializable {
  ...
  public ConversationCobrowseEventTopicQueueMediaSettings() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
    }
  }

  public ConversationCobrowseEventTopicQueueMediaSettings(Boolean initWithEmptyList) {
   ...
   **/
  public ConversationCobrowseEventTopicQueueMediaSettings alertingTimeoutSeconds(Long alertingTimeoutSeconds) {
