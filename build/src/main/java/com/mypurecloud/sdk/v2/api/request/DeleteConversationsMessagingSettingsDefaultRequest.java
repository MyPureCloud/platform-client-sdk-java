...
public class DeleteConversationsMessagingSettingsDefaultRequest {
    ...
    public DeleteConversationsMessagingSettingsDefaultRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("DELETE", "/api/v2/conversations/messaging/settings/default")
	...
	public static class Builder {
		private final DeleteConversationsMessagingSettingsDefaultRequest request;

		private Builder() {
			request = new DeleteConversationsMessagingSettingsDefaultRequest();
		}
		...
		public DeleteConversationsMessagingSettingsDefaultRequest build() {
