...
public class WhatsAppIntegrationEntityListing  implements Serializable, PagedResource<WhatsAppIntegration> {
  
  private List<WhatsAppIntegration> entities = null;
  ...
  public WhatsAppIntegrationEntityListing() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
      entities = new ArrayList<WhatsAppIntegration>();
    }
  }

  public WhatsAppIntegrationEntityListing(Boolean initWithEmptyList) {
  ...
  /**
   **/
  public WhatsAppIntegrationEntityListing entities(List<WhatsAppIntegration> entities) {
  ...
  public List<WhatsAppIntegration> getEntities() {
    return entities;
  }
  public void setEntities(List<WhatsAppIntegration> entities) {
    this.entities = entities;
  }
