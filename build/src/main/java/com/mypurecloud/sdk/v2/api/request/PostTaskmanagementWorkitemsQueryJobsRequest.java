...
public class PostTaskmanagementWorkitemsQueryJobsRequest {

	private WorkitemQueryJobCreate body;
	public WorkitemQueryJobCreate getBody() {
		return this.body;
	}

	public void setBody(WorkitemQueryJobCreate body) {
		this.body = body;
	}

	public PostTaskmanagementWorkitemsQueryJobsRequest withBody(WorkitemQueryJobCreate body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostTaskmanagementWorkitemsQueryJobsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<WorkitemQueryJobCreate> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostTaskmanagementWorkitemsQueryJobsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/taskmanagement/workitems/query/jobs")
                .withBody(body)
	...
	public static Builder builder(WorkitemQueryJobCreate body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostTaskmanagementWorkitemsQueryJobsRequest request;

		private Builder() {
			request = new PostTaskmanagementWorkitemsQueryJobsRequest();
		}


		public Builder withBody(WorkitemQueryJobCreate body) {
		...
		public Builder withRequiredParams(WorkitemQueryJobCreate body) {
			request.setBody(body);
		...
		public PostTaskmanagementWorkitemsQueryJobsRequest build() {
