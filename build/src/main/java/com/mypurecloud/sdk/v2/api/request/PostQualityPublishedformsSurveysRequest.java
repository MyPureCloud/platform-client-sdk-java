...
public class PostQualityPublishedformsSurveysRequest {
	...
	public PostQualityPublishedformsSurveysRequest withBody(PublishForm body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostQualityPublishedformsSurveysRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<PublishForm> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostQualityPublishedformsSurveysRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/quality/publishedforms/surveys")
                .withBody(body)
	...
	public static class Builder {
		private final PostQualityPublishedformsSurveysRequest request;

		private Builder() {
			request = new PostQualityPublishedformsSurveysRequest();
		}
		...
		public PostQualityPublishedformsSurveysRequest build() {
