...
public class GetUserScreenmonitorsSessionRequest {
	...
	public GetUserScreenmonitorsSessionRequest withUserId(String userId) {
	...
	public GetUserScreenmonitorsSessionRequest withScreenMonitoringId(String screenMonitoringId) {
    ...
    public GetUserScreenmonitorsSessionRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.userId == null) {
            throw new IllegalStateException("Missing the required parameter 'userId' when building request for GetUserScreenmonitorsSessionRequest.");
        }
        
        // verify the required parameter 'screenMonitoringId' is set
        if (this.screenMonitoringId == null) {
            throw new IllegalStateException("Missing the required parameter 'screenMonitoringId' when building request for GetUserScreenmonitorsSessionRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/users/{userId}/screenmonitors/sessions/{screenMonitoringId}")
	...
	public static class Builder {
		private final GetUserScreenmonitorsSessionRequest request;

		private Builder() {
			request = new GetUserScreenmonitorsSessionRequest();
		}
		...
		public GetUserScreenmonitorsSessionRequest build() {
