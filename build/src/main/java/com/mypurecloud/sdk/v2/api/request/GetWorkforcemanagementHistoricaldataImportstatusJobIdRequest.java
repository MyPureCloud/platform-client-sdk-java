...
public class GetWorkforcemanagementHistoricaldataImportstatusJobIdRequest {
	...
	public GetWorkforcemanagementHistoricaldataImportstatusJobIdRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetWorkforcemanagementHistoricaldataImportstatusJobIdRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetWorkforcemanagementHistoricaldataImportstatusJobIdRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/historicaldata/importstatus/{jobId}")
	...
	public static class Builder {
		private final GetWorkforcemanagementHistoricaldataImportstatusJobIdRequest request;

		private Builder() {
			request = new GetWorkforcemanagementHistoricaldataImportstatusJobIdRequest();
		}
		...
		public GetWorkforcemanagementHistoricaldataImportstatusJobIdRequest build() {
