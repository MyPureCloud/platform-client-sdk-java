...
public class PostTelephonyProvidersEdgesTrunksSearchRequest {
	...
	public PostTelephonyProvidersEdgesTrunksSearchRequest withBody(TelephonySearchRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostTelephonyProvidersEdgesTrunksSearchRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<TelephonySearchRequest> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostTelephonyProvidersEdgesTrunksSearchRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/telephony/providers/edges/trunks/search")
                .withBody(body)
	...
	public static class Builder {
		private final PostTelephonyProvidersEdgesTrunksSearchRequest request;

		private Builder() {
			request = new PostTelephonyProvidersEdgesTrunksSearchRequest();
		}
		...
		public PostTelephonyProvidersEdgesTrunksSearchRequest build() {
