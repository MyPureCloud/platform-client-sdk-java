...
public class GetWorkforcemanagementManagementunitRequest {
    ...
    public GetWorkforcemanagementManagementunitRequest withCustomHeader(String name, String value) {
	...
	public static class Builder {
		private final GetWorkforcemanagementManagementunitRequest request;

		private Builder() {
			request = new GetWorkforcemanagementManagementunitRequest();
		}
