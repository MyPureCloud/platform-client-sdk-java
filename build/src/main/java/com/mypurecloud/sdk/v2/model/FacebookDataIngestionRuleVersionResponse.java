...
public class FacebookDataIngestionRuleVersionResponse  implements Serializable {
 ...
 @JsonDeserialize(using = StatusEnumDeserializer.class)
  ...
  public FacebookDataIngestionRuleVersionResponse() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
    }
  }

  public FacebookDataIngestionRuleVersionResponse(Boolean initWithEmptyList) {
   ...
   **/
  public FacebookDataIngestionRuleVersionResponse ingestionRuleInfo(MessageInfo ingestionRuleInfo) {
  ...
  @ApiModelProperty(example = "null", value = "Id of the Integration when source is owned (Authenticated). This entity is created using the /conversations/messaging/integrations/facebook resource. Optional when configuring non-owned pages.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, facebookDataIngestionRuleVersionResponse.id) &&
            ...
            Objects.equals(this.platform, facebookDataIngestionRuleVersionResponse.platform) &&
            Objects.equals(this.ingestionRuleInfo, facebookDataIngestionRuleVersionResponse.ingestionRuleInfo) &&
