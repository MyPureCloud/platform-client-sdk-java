...
public class GetUserFavoritesRequest {
    ...
    public GetUserFavoritesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.userId == null) {
            throw new IllegalStateException("Missing the required parameter 'userId' when building request for GetUserFavoritesRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/users/{userId}/favorites")
