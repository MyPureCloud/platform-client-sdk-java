...
public class GetSpeechandtextanalyticsDialectsRequest {
    ...
    public GetSpeechandtextanalyticsDialectsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/speechandtextanalytics/dialects")
	...
	public static class Builder {
		private final GetSpeechandtextanalyticsDialectsRequest request;

		private Builder() {
			request = new GetSpeechandtextanalyticsDialectsRequest();
		}
		...
		public GetSpeechandtextanalyticsDialectsRequest build() {
