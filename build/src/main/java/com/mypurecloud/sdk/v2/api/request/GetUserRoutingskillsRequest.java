...
public class GetUserRoutingskillsRequest {
    ...
    public GetUserRoutingskillsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() throws ApiException {
        ...
        if (this.userId == null) {
            throw new ApiException(400, "Missing the required parameter 'userId' when building request for GetUserRoutingskillsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/users/{userId}/routingskills")
	...
	public static class Builder {
		private final GetUserRoutingskillsRequest request;

		private Builder() {
			request = new GetUserRoutingskillsRequest();
		}
