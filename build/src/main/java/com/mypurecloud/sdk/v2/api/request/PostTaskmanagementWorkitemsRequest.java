...
public class PostTaskmanagementWorkitemsRequest {

	private WorkitemCreate body;
	public WorkitemCreate getBody() {
		return this.body;
	}

	public void setBody(WorkitemCreate body) {
		this.body = body;
	}

	public PostTaskmanagementWorkitemsRequest withBody(WorkitemCreate body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostTaskmanagementWorkitemsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<WorkitemCreate> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostTaskmanagementWorkitemsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/taskmanagement/workitems")
                .withBody(body)
	...
	public static Builder builder(WorkitemCreate body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostTaskmanagementWorkitemsRequest request;

		private Builder() {
			request = new PostTaskmanagementWorkitemsRequest();
		}


		public Builder withBody(WorkitemCreate body) {
		...
		public Builder withRequiredParams(WorkitemCreate body) {
			request.setBody(body);
		...
		public PostTaskmanagementWorkitemsRequest build() {
