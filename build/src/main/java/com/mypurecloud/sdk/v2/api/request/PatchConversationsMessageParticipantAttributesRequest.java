...
public class PatchConversationsMessageParticipantAttributesRequest {
	...
	public PatchConversationsMessageParticipantAttributesRequest withConversationId(String conversationId) {
	...
	public PatchConversationsMessageParticipantAttributesRequest withParticipantId(String participantId) {
	...
	public PatchConversationsMessageParticipantAttributesRequest withBody(ParticipantAttributes body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchConversationsMessageParticipantAttributesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<ParticipantAttributes> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PatchConversationsMessageParticipantAttributesRequest.");
        }
        
        // verify the required parameter 'participantId' is set
        if (this.participantId == null) {
            throw new IllegalStateException("Missing the required parameter 'participantId' when building request for PatchConversationsMessageParticipantAttributesRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/conversations/messages/{conversationId}/participants/{participantId}/attributes")
	...
	public static class Builder {
		private final PatchConversationsMessageParticipantAttributesRequest request;

		private Builder() {
			request = new PatchConversationsMessageParticipantAttributesRequest();
		}
		...
		public PatchConversationsMessageParticipantAttributesRequest build() {
