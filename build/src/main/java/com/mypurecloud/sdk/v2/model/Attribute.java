...
public class Attribute  implements Serializable {
  ...
  public Attribute(Boolean initWithEmptyList) {
  ...
  @ApiModelProperty(example = "null", required = true, value = "The attribute name.")
  @JsonProperty("name")
   ...
   **/
  public Attribute dateCreated(Date dateCreated) {
   ...
   * Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss[.mmm]Z
   **/
  public Attribute dateModified(Date dateModified) {
