...
public class PostUsersSearchConversationTargetRequest {
	...
	public void setBody(UserSearchRequest body) {
		this.body = body;
	}

	public PostUsersSearchConversationTargetRequest withBody(UserSearchRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostUsersSearchConversationTargetRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<UserSearchRequest> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostUsersSearchConversationTargetRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/users/search/conversation/target")
                .withBody(body)
	...
	public static class Builder {
		private final PostUsersSearchConversationTargetRequest request;

		private Builder() {
			request = new PostUsersSearchConversationTargetRequest();
		}
		...
		public PostUsersSearchConversationTargetRequest build() {
