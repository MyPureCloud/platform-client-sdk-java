...
public class GetTaskmanagementWorktypeRequest {
	...
	public GetTaskmanagementWorktypeRequest withWorktypeId(String worktypeId) {
	...
	public GetTaskmanagementWorktypeRequest withExpands(List<String> expands) {
    ...
    public GetTaskmanagementWorktypeRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.worktypeId == null) {
            throw new IllegalStateException("Missing the required parameter 'worktypeId' when building request for GetTaskmanagementWorktypeRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/taskmanagement/worktypes/{worktypeId}")
	...
	public static class Builder {
		private final GetTaskmanagementWorktypeRequest request;

		private Builder() {
			request = new GetTaskmanagementWorktypeRequest();
		}
		...
		public GetTaskmanagementWorktypeRequest build() {
