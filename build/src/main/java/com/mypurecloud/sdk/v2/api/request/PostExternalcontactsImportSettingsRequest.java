...
public class PostExternalcontactsImportSettingsRequest {
	...
	public PostExternalcontactsImportSettingsRequest withBody(ContactImportSettings body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostExternalcontactsImportSettingsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<ContactImportSettings> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostExternalcontactsImportSettingsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/externalcontacts/import/settings")
                .withBody(body)
	...
	public static Builder builder(ContactImportSettings body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostExternalcontactsImportSettingsRequest request;

		private Builder() {
			request = new PostExternalcontactsImportSettingsRequest();
		}
		...
		public Builder withRequiredParams(ContactImportSettings body) {
			request.setBody(body);
		...
		public PostExternalcontactsImportSettingsRequest build() {
