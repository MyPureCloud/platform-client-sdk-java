...
public class PostJourneyFlowsPathsQueryRequest {

	private FlowPathsQuery body;
	public FlowPathsQuery getBody() {
		return this.body;
	}

	public void setBody(FlowPathsQuery body) {
		this.body = body;
	}

	public PostJourneyFlowsPathsQueryRequest withBody(FlowPathsQuery body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostJourneyFlowsPathsQueryRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<FlowPathsQuery> withHttpInfo() {
        

        return ApiRequestBuilder.create("POST", "/api/v2/journey/flows/paths/query")
                .withBody(body)
	...
	public static class Builder {
		private final PostJourneyFlowsPathsQueryRequest request;

		private Builder() {
			request = new PostJourneyFlowsPathsQueryRequest();
		}


		public Builder withBody(FlowPathsQuery body) {
		...
		public PostJourneyFlowsPathsQueryRequest build() {
