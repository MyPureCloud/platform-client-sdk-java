...
public class PostWorkforcemanagementTeamShrinkageJobsRequest {
	...
	public PostWorkforcemanagementTeamShrinkageJobsRequest withTeamId(String teamId) {
	    this.setTeamId(teamId);
	    return this;
	} 

	private WfmHistoricalShrinkageTeamsRequest body;
	public WfmHistoricalShrinkageTeamsRequest getBody() {
		return this.body;
	}

	public void setBody(WfmHistoricalShrinkageTeamsRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementTeamShrinkageJobsRequest withBody(WfmHistoricalShrinkageTeamsRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementTeamShrinkageJobsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<WfmHistoricalShrinkageTeamsRequest> withHttpInfo() {
        
        // verify the required parameter 'teamId' is set
        if (this.teamId == null) {
            throw new IllegalStateException("Missing the required parameter 'teamId' when building request for PostWorkforcemanagementTeamShrinkageJobsRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementTeamShrinkageJobsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/teams/{teamId}/shrinkage/jobs")
	...
	public static Builder builder(String teamId, WfmHistoricalShrinkageTeamsRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementTeamShrinkageJobsRequest request;

		private Builder() {
			request = new PostWorkforcemanagementTeamShrinkageJobsRequest();
		}
		...
		public Builder withBody(WfmHistoricalShrinkageTeamsRequest body) {
		...
		public Builder withRequiredParams(String teamId, WfmHistoricalShrinkageTeamsRequest body) {
			request.setTeamId(teamId);
			request.setBody(body);
		...
		public PostWorkforcemanagementTeamShrinkageJobsRequest build() {
