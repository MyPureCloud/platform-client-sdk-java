...
public class GetLanguageunderstandingSettingsRequest {
    ...
    public GetLanguageunderstandingSettingsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/languageunderstanding/settings")
	...
	public static class Builder {
		private final GetLanguageunderstandingSettingsRequest request;

		private Builder() {
			request = new GetLanguageunderstandingSettingsRequest();
		}
		...
		public GetLanguageunderstandingSettingsRequest build() {
