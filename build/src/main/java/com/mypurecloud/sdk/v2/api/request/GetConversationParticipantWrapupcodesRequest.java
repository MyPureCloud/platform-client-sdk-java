...
public class GetConversationParticipantWrapupcodesRequest {
	...
	public GetConversationParticipantWrapupcodesRequest withConversationId(String conversationId) {
	...
	public GetConversationParticipantWrapupcodesRequest withParticipantId(String participantId) {
    ...
    public GetConversationParticipantWrapupcodesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for GetConversationParticipantWrapupcodesRequest.");
        }
        
        // verify the required parameter 'participantId' is set
        if (this.participantId == null) {
            throw new IllegalStateException("Missing the required parameter 'participantId' when building request for GetConversationParticipantWrapupcodesRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/conversations/{conversationId}/participants/{participantId}/wrapupcodes")
	...
	public static class Builder {
		private final GetConversationParticipantWrapupcodesRequest request;

		private Builder() {
			request = new GetConversationParticipantWrapupcodesRequest();
		}
		...
		public GetConversationParticipantWrapupcodesRequest build() {
