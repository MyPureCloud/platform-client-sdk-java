...
public class GetJourneyExternaleventsSchemaRequest {
	...
	public GetJourneyExternaleventsSchemaRequest withSchemaId(String schemaId) {
    ...
    public GetJourneyExternaleventsSchemaRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.schemaId == null) {
            throw new IllegalStateException("Missing the required parameter 'schemaId' when building request for GetJourneyExternaleventsSchemaRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/journey/externalevents/schemas/{schemaId}")
	...
	public static class Builder {
		private final GetJourneyExternaleventsSchemaRequest request;

		private Builder() {
			request = new GetJourneyExternaleventsSchemaRequest();
		}
		...
		public GetJourneyExternaleventsSchemaRequest build() {
