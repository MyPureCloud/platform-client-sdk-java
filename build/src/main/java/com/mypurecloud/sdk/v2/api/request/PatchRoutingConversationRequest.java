...
public class PatchRoutingConversationRequest {
    ...
    public ApiRequest<RoutingConversationAttributesRequest> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("PATCH", "/api/v2/routing/conversations/{conversationId}")
	...
	public static class Builder {
		private final PatchRoutingConversationRequest request;

		private Builder() {
			request = new PatchRoutingConversationRequest();
		}
