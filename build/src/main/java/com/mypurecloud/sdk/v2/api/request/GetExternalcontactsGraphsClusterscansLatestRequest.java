...
public class GetExternalcontactsGraphsClusterscansLatestRequest {
	...
	public GetExternalcontactsGraphsClusterscansLatestRequest withExpand(List<String> expand) {
    ...
    public GetExternalcontactsGraphsClusterscansLatestRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/externalcontacts/graphs/clusterscans/latest")
	...
	public static class Builder {
		private final GetExternalcontactsGraphsClusterscansLatestRequest request;

		private Builder() {
			request = new GetExternalcontactsGraphsClusterscansLatestRequest();
		}
		...
		public GetExternalcontactsGraphsClusterscansLatestRequest build() {
