...
public class PostFlowsDatatableExportJobsRequest {
	...
	public PostFlowsDatatableExportJobsRequest withDatatableId(String datatableId) {
    ...
    public PostFlowsDatatableExportJobsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.datatableId == null) {
            throw new IllegalStateException("Missing the required parameter 'datatableId' when building request for PostFlowsDatatableExportJobsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/flows/datatables/{datatableId}/export/jobs")
	...
	public static class Builder {
		private final PostFlowsDatatableExportJobsRequest request;

		private Builder() {
			request = new PostFlowsDatatableExportJobsRequest();
		}
		...
		public PostFlowsDatatableExportJobsRequest build() {
