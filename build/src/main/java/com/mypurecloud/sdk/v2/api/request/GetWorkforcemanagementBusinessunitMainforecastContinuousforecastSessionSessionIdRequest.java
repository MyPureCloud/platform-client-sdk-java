...
public class GetWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionSessionIdRequest {
	...
	public GetWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionSessionIdRequest withBusinessUnitId(String businessUnitId) {
	...
	public GetWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionSessionIdRequest withSessionId(String sessionId) {
    ...
    public GetWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionSessionIdRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for GetWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionSessionIdRequest.");
        }
        
        // verify the required parameter 'sessionId' is set
        if (this.sessionId == null) {
            throw new IllegalStateException("Missing the required parameter 'sessionId' when building request for GetWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionSessionIdRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/mainforecast/continuousforecast/session/{sessionId}")
	...
	public static Builder builder(String businessUnitId, String sessionId) {
	    return new Builder()
	            .withRequiredParams(businessUnitId, sessionId);
	}


	public static class Builder {
		private final GetWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionSessionIdRequest request;

		private Builder() {
			request = new GetWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionSessionIdRequest();
		}
		...
		public Builder withRequiredParams(String businessUnitId, String sessionId) {
			request.setBusinessUnitId(businessUnitId);
			request.setSessionId(sessionId);
		...
		public GetWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionSessionIdRequest build() {
