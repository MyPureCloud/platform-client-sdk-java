...
public class PostTaskmanagementWorktypeFlowsOncreateRulesRequest {
	...
	public PostTaskmanagementWorktypeFlowsOncreateRulesRequest withWorktypeId(String worktypeId) {
	    this.setWorktypeId(worktypeId);
	    return this;
	} 

	private WorkitemOnCreateRuleCreate body;
	public WorkitemOnCreateRuleCreate getBody() {
		return this.body;
	}

	public void setBody(WorkitemOnCreateRuleCreate body) {
		this.body = body;
	}

	public PostTaskmanagementWorktypeFlowsOncreateRulesRequest withBody(WorkitemOnCreateRuleCreate body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostTaskmanagementWorktypeFlowsOncreateRulesRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<WorkitemOnCreateRuleCreate> withHttpInfo() {
        
        // verify the required parameter 'worktypeId' is set
        if (this.worktypeId == null) {
            throw new IllegalStateException("Missing the required parameter 'worktypeId' when building request for PostTaskmanagementWorktypeFlowsOncreateRulesRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostTaskmanagementWorktypeFlowsOncreateRulesRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/taskmanagement/worktypes/{worktypeId}/flows/oncreate/rules")
	...
	public static Builder builder(String worktypeId, WorkitemOnCreateRuleCreate body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostTaskmanagementWorktypeFlowsOncreateRulesRequest request;

		private Builder() {
			request = new PostTaskmanagementWorktypeFlowsOncreateRulesRequest();
		}
		...
		public Builder withBody(WorkitemOnCreateRuleCreate body) {
		...
		public Builder withRequiredParams(String worktypeId, WorkitemOnCreateRuleCreate body) {
			request.setWorktypeId(worktypeId);
			request.setBody(body);
		...
		public PostTaskmanagementWorktypeFlowsOncreateRulesRequest build() {
