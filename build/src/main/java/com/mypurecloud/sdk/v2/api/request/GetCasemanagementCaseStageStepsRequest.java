...
public class GetCasemanagementCaseStageStepsRequest {
	...
	public GetCasemanagementCaseStageStepsRequest withCaseId(String caseId) {
	...
	public GetCasemanagementCaseStageStepsRequest withStageId(String stageId) {
	...
	public GetCasemanagementCaseStageStepsRequest withBefore(String before) {
	...
	public GetCasemanagementCaseStageStepsRequest withAfter(String after) {
	    this.setAfter(after);
	    return this;
	} 
	...
	public GetCasemanagementCaseStageStepsRequest withPageSize(String pageSize) {
    ...
    public GetCasemanagementCaseStageStepsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.caseId == null) {
            throw new IllegalStateException("Missing the required parameter 'caseId' when building request for GetCasemanagementCaseStageStepsRequest.");
        }
        
        // verify the required parameter 'stageId' is set
        if (this.stageId == null) {
            throw new IllegalStateException("Missing the required parameter 'stageId' when building request for GetCasemanagementCaseStageStepsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/casemanagement/cases/{caseId}/stages/{stageId}/steps")
	...
	public static class Builder {
		private final GetCasemanagementCaseStageStepsRequest request;

		private Builder() {
			request = new GetCasemanagementCaseStageStepsRequest();
		}
		...
		public GetCasemanagementCaseStageStepsRequest build() {
