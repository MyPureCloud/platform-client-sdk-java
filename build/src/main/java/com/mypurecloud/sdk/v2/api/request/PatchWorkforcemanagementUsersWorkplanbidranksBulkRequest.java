...
public class PatchWorkforcemanagementUsersWorkplanbidranksBulkRequest {

	private List<WorkPlanBidRanks> body;
	public List<WorkPlanBidRanks> getBody() {
		return this.body;
	}

	public void setBody(List<WorkPlanBidRanks> body) {
		this.body = body;
	}

	public PatchWorkforcemanagementUsersWorkplanbidranksBulkRequest withBody(List<WorkPlanBidRanks> body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchWorkforcemanagementUsersWorkplanbidranksBulkRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<List<WorkPlanBidRanks>> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchWorkforcemanagementUsersWorkplanbidranksBulkRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/workforcemanagement/users/workplanbidranks/bulk")
                .withBody(body)
	...
	public static Builder builder(List<WorkPlanBidRanks> body) {
	    return new Builder()
	...
	public static class Builder {
		private final PatchWorkforcemanagementUsersWorkplanbidranksBulkRequest request;

		private Builder() {
			request = new PatchWorkforcemanagementUsersWorkplanbidranksBulkRequest();
		}


		public Builder withBody(List<WorkPlanBidRanks> body) {
		...
		public Builder withRequiredParams(List<WorkPlanBidRanks> body) {
			request.setBody(body);
		...
		public PatchWorkforcemanagementUsersWorkplanbidranksBulkRequest build() {
