...
public class PostConversationsCallParticipantConsultRequest {
	...
	public PostConversationsCallParticipantConsultRequest withConversationId(String conversationId) {
    ...
    public ApiRequest<ConsultTransfer> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PostConversationsCallParticipantConsultRequest.");
        }
        ...
        return ApiRequestBuilder.create("POST", "/api/v2/conversations/calls/{conversationId}/participants/{participantId}/consult")
