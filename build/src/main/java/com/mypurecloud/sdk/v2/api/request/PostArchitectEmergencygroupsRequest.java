...
public class PostArchitectEmergencygroupsRequest {
	...
	public PostArchitectEmergencygroupsRequest withBody(EmergencyGroup body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostArchitectEmergencygroupsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<EmergencyGroup> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostArchitectEmergencygroupsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/architect/emergencygroups")
                .withBody(body)
	...
	public static Builder builder(EmergencyGroup body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostArchitectEmergencygroupsRequest request;

		private Builder() {
			request = new PostArchitectEmergencygroupsRequest();
		}
		...
		public Builder withRequiredParams(EmergencyGroup body) {
			request.setBody(body);
		...
		public PostArchitectEmergencygroupsRequest build() {
