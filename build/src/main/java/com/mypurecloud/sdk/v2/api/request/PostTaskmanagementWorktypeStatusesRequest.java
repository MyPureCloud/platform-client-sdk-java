...
public class PostTaskmanagementWorktypeStatusesRequest {
	...
	public PostTaskmanagementWorktypeStatusesRequest withWorktypeId(String worktypeId) {
	    this.setWorktypeId(worktypeId);
	    return this;
	} 

	private WorkitemStatusCreate body;
	public WorkitemStatusCreate getBody() {
		return this.body;
	}

	public void setBody(WorkitemStatusCreate body) {
		this.body = body;
	}

	public PostTaskmanagementWorktypeStatusesRequest withBody(WorkitemStatusCreate body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostTaskmanagementWorktypeStatusesRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<WorkitemStatusCreate> withHttpInfo() {
	...
	public static class Builder {
		private final PostTaskmanagementWorktypeStatusesRequest request;

		private Builder() {
			request = new PostTaskmanagementWorktypeStatusesRequest();
		}
		...
		public Builder withBody(WorkitemStatusCreate body) {
		...
		public PostTaskmanagementWorktypeStatusesRequest build() {
