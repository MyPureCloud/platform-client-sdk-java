...
public class GetOutboundMessagingcampaignsDivisionviewRequest {
	...
	public GetOutboundMessagingcampaignsDivisionviewRequest withMessagingCampaignId(String messagingCampaignId) {
    ...
    public GetOutboundMessagingcampaignsDivisionviewRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.messagingCampaignId == null) {
            throw new IllegalStateException("Missing the required parameter 'messagingCampaignId' when building request for GetOutboundMessagingcampaignsDivisionviewRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/outbound/messagingcampaigns/divisionviews/{messagingCampaignId}")
	...
	public static class Builder {
		private final GetOutboundMessagingcampaignsDivisionviewRequest request;

		private Builder() {
			request = new GetOutboundMessagingcampaignsDivisionviewRequest();
		}
		...
		public GetOutboundMessagingcampaignsDivisionviewRequest build() {
