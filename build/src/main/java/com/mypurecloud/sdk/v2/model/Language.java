...
public class Language  implements Serializable {
 ...
 @JsonDeserialize(using = StateEnumDeserializer.class)
  ...
  public Language(Boolean initWithEmptyList) {
  ...
  @ApiModelProperty(example = "null", required = true, value = "The language name.")
  @JsonProperty("name")
   ...
   **/
  public Language dateModified(Date dateModified) {
