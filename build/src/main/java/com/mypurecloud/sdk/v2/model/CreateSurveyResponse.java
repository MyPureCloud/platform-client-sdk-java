...
public class CreateSurveyResponse  implements Serializable {
 ...
 @JsonDeserialize(using = SurveyTypeEnumDeserializer.class)
  ...
  private String customerSurveyUrl = null;
  ...
  /**
   **/
  public CreateSurveyResponse name(String name) {
    this.name = name;
    return this;
  }
  ...
  /**
   **/
  public CreateSurveyResponse conversation(ConversationReference conversation) {
   ...
   **/
  public CreateSurveyResponse surveyForm(SurveyForm surveyForm) {
  ...
  /**
   **/
  public CreateSurveyResponse agent(DomainEntityRef agent) {
    this.agent = agent;
    return this;
  }
  ...
  /**
   **/
  public CreateSurveyResponse status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  /**
   **/
  public CreateSurveyResponse queue(QueueReference queue) {
    this.queue = queue;
    return this;
  }
  ...
  /**
   **/
  public CreateSurveyResponse answers(SurveyScoringSet answers) {
   ...
   **/
  public CreateSurveyResponse completedDate(Date completedDate) {
   ...
   **/
  public CreateSurveyResponse surveyErrorDetails(SurveyErrorDetails surveyErrorDetails) {
   ...
   **/
  public CreateSurveyResponse agentTeam(Team agentTeam) {
   ...
   * Type of the survey
   **/
  public CreateSurveyResponse surveyType(SurveyTypeEnum surveyType) {
   ...
   **/
  public CreateSurveyResponse missingRequiredAnswer(Boolean missingRequiredAnswer) {
   ...
   **/
  public CreateSurveyResponse flow(AddressableEntityRef flow) {
    this.flow = flow;
    return this;
  }
   ...
   **/
  public CreateSurveyResponse customerSurveyUrl(String customerSurveyUrl) {
    this.customerSurveyUrl = customerSurveyUrl;
    return this;
  }
  
  @ApiModelProperty(example = "null", value = "The URL for the customer survey.")
  @JsonProperty("customerSurveyUrl")
  public String getCustomerSurveyUrl() {
    return customerSurveyUrl;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, createSurveyResponse.id) &&
            Objects.equals(this.name, createSurveyResponse.name) &&
            Objects.equals(this.conversation, createSurveyResponse.conversation) &&
            Objects.equals(this.surveyForm, createSurveyResponse.surveyForm) &&
            Objects.equals(this.agent, createSurveyResponse.agent) &&
            Objects.equals(this.status, createSurveyResponse.status) &&
            Objects.equals(this.queue, createSurveyResponse.queue) &&
            Objects.equals(this.answers, createSurveyResponse.answers) &&
            Objects.equals(this.completedDate, createSurveyResponse.completedDate) &&
            Objects.equals(this.surveyErrorDetails, createSurveyResponse.surveyErrorDetails) &&
            Objects.equals(this.agentTeam, createSurveyResponse.agentTeam) &&
            Objects.equals(this.surveyType, createSurveyResponse.surveyType) &&
            Objects.equals(this.missingRequiredAnswer, createSurveyResponse.missingRequiredAnswer) &&
            Objects.equals(this.flow, createSurveyResponse.flow) &&
            Objects.equals(this.customerSurveyUrl, createSurveyResponse.customerSurveyUrl) &&
            Objects.equals(this.selfUri, createSurveyResponse.selfUri);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, conversation, surveyForm, agent, status, queue, answers, completedDate, surveyErrorDetails, agentTeam, surveyType, missingRequiredAnswer, flow, customerSurveyUrl, selfUri);
  }
  ...
  public String toString() {
    ...
    sb.append("    customerSurveyUrl: ").append(toIndentedString(customerSurveyUrl)).append("\n");
