...
public class GetTelephonyProvidersEdgesSiteRequest {
	...
	public GetTelephonyProvidersEdgesSiteRequest withSiteId(String siteId) {
    ...
    public GetTelephonyProvidersEdgesSiteRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.siteId == null) {
            throw new IllegalStateException("Missing the required parameter 'siteId' when building request for GetTelephonyProvidersEdgesSiteRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/telephony/providers/edges/sites/{siteId}")
	...
	public static class Builder {
		private final GetTelephonyProvidersEdgesSiteRequest request;

		private Builder() {
			request = new GetTelephonyProvidersEdgesSiteRequest();
		}
		...
		public GetTelephonyProvidersEdgesSiteRequest build() {
