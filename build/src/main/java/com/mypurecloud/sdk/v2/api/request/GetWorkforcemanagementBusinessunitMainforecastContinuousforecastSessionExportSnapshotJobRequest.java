...
public class GetWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionExportSnapshotJobRequest {
	...
	public GetWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionExportSnapshotJobRequest withBusinessUnitId(String businessUnitId) {
	...
	public GetWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionExportSnapshotJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionExportSnapshotJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for GetWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionExportSnapshotJobRequest.");
        }
        
        // verify the required parameter 'jobId' is set
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionExportSnapshotJobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/mainforecast/continuousforecast/session/export/snapshot/jobs/{jobId}")
	...
	public static class Builder {
		private final GetWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionExportSnapshotJobRequest request;

		private Builder() {
			request = new GetWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionExportSnapshotJobRequest();
		}
		...
		public GetWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionExportSnapshotJobRequest build() {
