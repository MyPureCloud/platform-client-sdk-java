...
import com.fasterxml.jackson.annotation.JsonValue;
import com.mypurecloud.sdk.v2.model.RateLimitAggregateQueryFilter;
import com.mypurecloud.sdk.v2.model.RateLimitAggregationView;
...
public class RateLimitAggregationQuery  implements Serializable {
 ...
 @JsonDeserialize(using = GroupByEnumDeserializer.class)
  ...
  private RateLimitAggregateQueryFilter filter = null;
 ...
 @JsonDeserialize(using = MetricsEnumDeserializer.class)
  ...
  private List<RateLimitAggregationView> views = null;
 ...
 @JsonDeserialize(using = AlternateTimeDimensionEnumDeserializer.class)
  ...
  public RateLimitAggregationQuery() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
      ...
      views = new ArrayList<RateLimitAggregationView>();
    }
  }

  public RateLimitAggregationQuery(Boolean initWithEmptyList) {
   ...
   **/
  public RateLimitAggregationQuery interval(String interval) {
   ...
   **/
  public RateLimitAggregationQuery granularity(String granularity) {
   ...
   **/
  public RateLimitAggregationQuery timeZone(String timeZone) {
   ...
   **/
  public RateLimitAggregationQuery groupBy(List<GroupByEnum> groupBy) {
   ...
   **/
  public RateLimitAggregationQuery filter(RateLimitAggregateQueryFilter filter) {
    this.filter = filter;
    return this;
  }
  ...
  @JsonProperty("filter")
  public RateLimitAggregateQueryFilter getFilter() {
    return filter;
  }
  public void setFilter(RateLimitAggregateQueryFilter filter) {
    this.filter = filter;
  }
   ...
   **/
  public RateLimitAggregationQuery metrics(List<MetricsEnum> metrics) {
   ...
   **/
  public RateLimitAggregationQuery flattenMultivaluedDimensions(Boolean flattenMultivaluedDimensions) {
   ...
   **/
  public RateLimitAggregationQuery views(List<RateLimitAggregationView> views) {
    this.views = views;
    return this;
  }
  ...
  @JsonProperty("views")
  public List<RateLimitAggregationView> getViews() {
    return views;
  }
  public void setViews(List<RateLimitAggregationView> views) {
    this.views = views;
  }
   ...
   * Dimension to use as the alternative timestamp for data in the aggregate.  Choosing \"eventTime\" uses the actual time of the data event.
   **/
  public RateLimitAggregationQuery alternateTimeDimension(AlternateTimeDimensionEnum alternateTimeDimension) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RateLimitAggregationQuery rateLimitAggregationQuery = (RateLimitAggregationQuery) o;

    return Objects.equals(this.interval, rateLimitAggregationQuery.interval) &&
            Objects.equals(this.granularity, rateLimitAggregationQuery.granularity) &&
            Objects.equals(this.timeZone, rateLimitAggregationQuery.timeZone) &&
            Objects.equals(this.groupBy, rateLimitAggregationQuery.groupBy) &&
            Objects.equals(this.filter, rateLimitAggregationQuery.filter) &&
            Objects.equals(this.metrics, rateLimitAggregationQuery.metrics) &&
            Objects.equals(this.flattenMultivaluedDimensions, rateLimitAggregationQuery.flattenMultivaluedDimensions) &&
            Objects.equals(this.views, rateLimitAggregationQuery.views) &&
            Objects.equals(this.alternateTimeDimension, rateLimitAggregationQuery.alternateTimeDimension);
  }
