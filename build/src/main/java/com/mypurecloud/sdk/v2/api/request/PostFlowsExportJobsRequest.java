...
public class PostFlowsExportJobsRequest {

	private RegisterArchitectExportJob body;
	public RegisterArchitectExportJob getBody() {
		return this.body;
	}

	public void setBody(RegisterArchitectExportJob body) {
		this.body = body;
	}

	public PostFlowsExportJobsRequest withBody(RegisterArchitectExportJob body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostFlowsExportJobsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<RegisterArchitectExportJob> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostFlowsExportJobsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/flows/export/jobs")
                .withBody(body)
	...
	public static Builder builder(RegisterArchitectExportJob body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostFlowsExportJobsRequest request;

		private Builder() {
			request = new PostFlowsExportJobsRequest();
		}


		public Builder withBody(RegisterArchitectExportJob body) {
		...
		public Builder withRequiredParams(RegisterArchitectExportJob body) {
			request.setBody(body);
		...
		public PostFlowsExportJobsRequest build() {
