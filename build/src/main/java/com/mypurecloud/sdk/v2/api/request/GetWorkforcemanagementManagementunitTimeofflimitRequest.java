...
public class GetWorkforcemanagementManagementunitTimeofflimitRequest {
	...
	public GetWorkforcemanagementManagementunitTimeofflimitRequest withManagementUnitId(String managementUnitId) {
	...
	public GetWorkforcemanagementManagementunitTimeofflimitRequest withTimeOffLimitId(String timeOffLimitId) {
    ...
    public GetWorkforcemanagementManagementunitTimeofflimitRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.managementUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'managementUnitId' when building request for GetWorkforcemanagementManagementunitTimeofflimitRequest.");
        }
        
        // verify the required parameter 'timeOffLimitId' is set
        if (this.timeOffLimitId == null) {
            throw new IllegalStateException("Missing the required parameter 'timeOffLimitId' when building request for GetWorkforcemanagementManagementunitTimeofflimitRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/managementunits/{managementUnitId}/timeofflimits/{timeOffLimitId}")
	...
	public static class Builder {
		private final GetWorkforcemanagementManagementunitTimeofflimitRequest request;

		private Builder() {
			request = new GetWorkforcemanagementManagementunitTimeofflimitRequest();
		}
		...
		public GetWorkforcemanagementManagementunitTimeofflimitRequest build() {
