...
public class QueueConversationMessageEventTopicScoredAgent  implements Serializable {
  ...
  public QueueConversationMessageEventTopicScoredAgent() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
    }
  }

  public QueueConversationMessageEventTopicScoredAgent(Boolean initWithEmptyList) {
   ...
   **/
  public QueueConversationMessageEventTopicScoredAgent score(Long score) {
    this.score = score;
    return this;
  }
