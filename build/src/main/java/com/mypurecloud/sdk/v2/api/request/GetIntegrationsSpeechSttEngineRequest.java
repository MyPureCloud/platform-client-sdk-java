...
public class GetIntegrationsSpeechSttEngineRequest {
	...
	public GetIntegrationsSpeechSttEngineRequest withEngineId(String engineId) {
    ...
    public GetIntegrationsSpeechSttEngineRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.engineId == null) {
            throw new IllegalStateException("Missing the required parameter 'engineId' when building request for GetIntegrationsSpeechSttEngineRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/integrations/speech/stt/engines/{engineId}")
	...
	public static class Builder {
		private final GetIntegrationsSpeechSttEngineRequest request;

		private Builder() {
			request = new GetIntegrationsSpeechSttEngineRequest();
		}
		...
		public GetIntegrationsSpeechSttEngineRequest build() {
