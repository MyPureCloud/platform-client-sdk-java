...
public class DynamicGroupRoutingSkillCondition  implements Serializable {
 ...
 @JsonDeserialize(using = ComparatorEnumDeserializer.class)
  ...
  private List<DynamicGroupSkillCondition> childConditions = new ArrayList<DynamicGroupSkillCondition>();

  
  /**
   * The routing skill to be used in the skill condition query
   **/
  public DynamicGroupRoutingSkillCondition routingSkill(String routingSkill) {
   ...
   * Comparator that will be applied to the proficiency
   **/
  public DynamicGroupRoutingSkillCondition comparator(ComparatorEnum comparator) {
   ...
   **/
  public DynamicGroupRoutingSkillCondition proficiency(Integer proficiency) {
   ...
   **/
  public DynamicGroupRoutingSkillCondition childConditions(List<DynamicGroupSkillCondition> childConditions) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DynamicGroupRoutingSkillCondition dynamicGroupRoutingSkillCondition = (DynamicGroupRoutingSkillCondition) o;

    return Objects.equals(this.routingSkill, dynamicGroupRoutingSkillCondition.routingSkill) &&
            Objects.equals(this.comparator, dynamicGroupRoutingSkillCondition.comparator) &&
            Objects.equals(this.proficiency, dynamicGroupRoutingSkillCondition.proficiency) &&
            Objects.equals(this.childConditions, dynamicGroupRoutingSkillCondition.childConditions);
  }
