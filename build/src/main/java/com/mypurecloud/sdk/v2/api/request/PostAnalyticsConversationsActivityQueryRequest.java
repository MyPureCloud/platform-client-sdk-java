...
public class PostAnalyticsConversationsActivityQueryRequest {

	private ConversationActivityQuery body;
	public ConversationActivityQuery getBody() {
		return this.body;
	}

	public void setBody(ConversationActivityQuery body) {
		this.body = body;
	}

	public PostAnalyticsConversationsActivityQueryRequest withBody(ConversationActivityQuery body) {
	    this.setBody(body);
	    return this;
	} 
	...
	public PostAnalyticsConversationsActivityQueryRequest withPageSize(Integer pageSize) {
	...
	public PostAnalyticsConversationsActivityQueryRequest withPageNumber(Integer pageNumber) {
    ...
    public PostAnalyticsConversationsActivityQueryRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<ConversationActivityQuery> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostAnalyticsConversationsActivityQueryRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/analytics/conversations/activity/query")
	...
	public static Builder builder(ConversationActivityQuery body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostAnalyticsConversationsActivityQueryRequest request;

		private Builder() {
			request = new PostAnalyticsConversationsActivityQueryRequest();
		}


		public Builder withBody(ConversationActivityQuery body) {
		...
		public Builder withRequiredParams(ConversationActivityQuery body) {
			request.setBody(body);
		...
		public PostAnalyticsConversationsActivityQueryRequest build() {
