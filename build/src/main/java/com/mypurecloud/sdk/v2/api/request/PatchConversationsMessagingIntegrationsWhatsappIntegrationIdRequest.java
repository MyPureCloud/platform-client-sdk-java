...
public class PatchConversationsMessagingIntegrationsWhatsappIntegrationIdRequest {
	...
	public PatchConversationsMessagingIntegrationsWhatsappIntegrationIdRequest withIntegrationId(String integrationId) {
	    this.setIntegrationId(integrationId);
	    return this;
	} 
	
	private WhatsAppIntegrationUpdateRequest body;
	public WhatsAppIntegrationUpdateRequest getBody() {
		return this.body;
	}

	public void setBody(WhatsAppIntegrationUpdateRequest body) {
		this.body = body;
	}

	public PatchConversationsMessagingIntegrationsWhatsappIntegrationIdRequest withBody(WhatsAppIntegrationUpdateRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchConversationsMessagingIntegrationsWhatsappIntegrationIdRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<WhatsAppIntegrationUpdateRequest> withHttpInfo() {
        
        // verify the required parameter 'integrationId' is set
        if (this.integrationId == null) {
            throw new IllegalStateException("Missing the required parameter 'integrationId' when building request for PatchConversationsMessagingIntegrationsWhatsappIntegrationIdRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchConversationsMessagingIntegrationsWhatsappIntegrationIdRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/conversations/messaging/integrations/whatsapp/{integrationId}")
	...
	public static Builder builder(String integrationId, WhatsAppIntegrationUpdateRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PatchConversationsMessagingIntegrationsWhatsappIntegrationIdRequest request;

		private Builder() {
			request = new PatchConversationsMessagingIntegrationsWhatsappIntegrationIdRequest();
		}
		...
		public Builder withBody(WhatsAppIntegrationUpdateRequest body) {
		...
		public Builder withRequiredParams(String integrationId, WhatsAppIntegrationUpdateRequest body) {
			request.setIntegrationId(integrationId);
						request.setBody(body);
		...
		public PatchConversationsMessagingIntegrationsWhatsappIntegrationIdRequest build() {
