...
public class DocumentVariationAnswer  implements Serializable {
  ...
  public DocumentVariationAnswer() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
      contexts = new ArrayList<DocumentVariationContext>();
    }
  }

  public DocumentVariationAnswer(Boolean initWithEmptyList) {
   ...
   **/
  public DocumentVariationAnswer documentVersion(AddressableEntityRef documentVersion) {
   ...
   **/
  public DocumentVariationAnswer contexts(List<DocumentVariationContext> contexts) {
   ...
   **/
  public DocumentVariationAnswer priority(Integer priority) {
   ...
   **/
  public DocumentVariationAnswer name(String name) {
    this.name = name;
    return this;
  }
   ...
   **/
  public DocumentVariationAnswer body(DocumentBodyWithHighlight body) {
    this.body = body;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DocumentVariationAnswer documentVariationAnswer = (DocumentVariationAnswer) o;

    return Objects.equals(this.id, documentVariationAnswer.id) &&
            Objects.equals(this.dateCreated, documentVariationAnswer.dateCreated) &&
            Objects.equals(this.dateModified, documentVariationAnswer.dateModified) &&
            Objects.equals(this.documentVersion, documentVariationAnswer.documentVersion) &&
            Objects.equals(this.contexts, documentVariationAnswer.contexts) &&
            Objects.equals(this.document, documentVariationAnswer.document) &&
            Objects.equals(this.priority, documentVariationAnswer.priority) &&
            Objects.equals(this.name, documentVariationAnswer.name) &&
            Objects.equals(this.body, documentVariationAnswer.body) &&
            Objects.equals(this.selfUri, documentVariationAnswer.selfUri);
  }
