...
public class GetIntegrationsSpeechLexBotsRequest {
	...
	public GetIntegrationsSpeechLexBotsRequest withPageNumber(Integer pageNumber) {
	...
	public GetIntegrationsSpeechLexBotsRequest withPageSize(Integer pageSize) {
	...
	public GetIntegrationsSpeechLexBotsRequest withName(String name) {
	    this.setName(name);
	    return this;
	} 
    ...
    public GetIntegrationsSpeechLexBotsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/integrations/speech/lex/bots")
	...
	public static class Builder {
		private final GetIntegrationsSpeechLexBotsRequest request;

		private Builder() {
			request = new GetIntegrationsSpeechLexBotsRequest();
		}
		...
		public GetIntegrationsSpeechLexBotsRequest build() {
