...
public class FlowExecutionAggregationView  implements Serializable {
 ...
 @JsonDeserialize(using = FunctionEnumDeserializer.class)
  ...
  public FlowExecutionAggregationView() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
    }
  }

  public FlowExecutionAggregationView(Boolean initWithEmptyList) {
   ...
   * Target metric name
   **/
  public FlowExecutionAggregationView target(TargetEnum target) {
    this.target = target;
    return this;
  }
   ...
   **/
  public FlowExecutionAggregationView name(String name) {
    this.name = name;
    return this;
  }
   ...
   * Type of view you wish to create
   **/
  public FlowExecutionAggregationView function(FunctionEnum function) {
   ...
   **/
  public FlowExecutionAggregationView range(AggregationRange range) {
    this.range = range;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    FlowExecutionAggregationView flowExecutionAggregationView = (FlowExecutionAggregationView) o;

    return Objects.equals(this.target, flowExecutionAggregationView.target) &&
            Objects.equals(this.name, flowExecutionAggregationView.name) &&
            Objects.equals(this.function, flowExecutionAggregationView.function) &&
            Objects.equals(this.range, flowExecutionAggregationView.range);
  }
