...
public class PostBusinessrulesDecisiontableVersionExecuteRequest {
	...
	public PostBusinessrulesDecisiontableVersionExecuteRequest withTableId(String tableId) {
	...
	public PostBusinessrulesDecisiontableVersionExecuteRequest withTableVersion(Integer tableVersion) {
	...
	public PostBusinessrulesDecisiontableVersionExecuteRequest withBody(DecisionTableExecutionRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostBusinessrulesDecisiontableVersionExecuteRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<DecisionTableExecutionRequest> withHttpInfo() {
        ...
        if (this.tableId == null) {
            throw new IllegalStateException("Missing the required parameter 'tableId' when building request for PostBusinessrulesDecisiontableVersionExecuteRequest.");
        }
        
        // verify the required parameter 'tableVersion' is set
        if (this.tableVersion == null) {
            throw new IllegalStateException("Missing the required parameter 'tableVersion' when building request for PostBusinessrulesDecisiontableVersionExecuteRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostBusinessrulesDecisiontableVersionExecuteRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/businessrules/decisiontables/{tableId}/versions/{tableVersion}/execute")
	...
	public static Builder builder(String tableId, Integer tableVersion, DecisionTableExecutionRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostBusinessrulesDecisiontableVersionExecuteRequest request;

		private Builder() {
			request = new PostBusinessrulesDecisiontableVersionExecuteRequest();
		}
		...
		public Builder withRequiredParams(String tableId, Integer tableVersion, DecisionTableExecutionRequest body) {
			request.setTableId(tableId);
			request.setTableVersion(tableVersion);
			request.setBody(body);
		...
		public PostBusinessrulesDecisiontableVersionExecuteRequest build() {
