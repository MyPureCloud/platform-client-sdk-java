...
public class GetCoachingAppointmentAnnotationRequest {
	...
	public GetCoachingAppointmentAnnotationRequest withAppointmentId(String appointmentId) {
	...
	public GetCoachingAppointmentAnnotationRequest withAnnotationId(String annotationId) {
    ...
    public GetCoachingAppointmentAnnotationRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.appointmentId == null) {
            throw new IllegalStateException("Missing the required parameter 'appointmentId' when building request for GetCoachingAppointmentAnnotationRequest.");
        }
        
        // verify the required parameter 'annotationId' is set
        if (this.annotationId == null) {
            throw new IllegalStateException("Missing the required parameter 'annotationId' when building request for GetCoachingAppointmentAnnotationRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/coaching/appointments/{appointmentId}/annotations/{annotationId}")
	...
	public static class Builder {
		private final GetCoachingAppointmentAnnotationRequest request;

		private Builder() {
			request = new GetCoachingAppointmentAnnotationRequest();
		}
		...
		public GetCoachingAppointmentAnnotationRequest build() {
