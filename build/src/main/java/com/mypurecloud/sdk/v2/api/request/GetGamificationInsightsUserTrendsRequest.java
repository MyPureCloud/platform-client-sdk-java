...
public class GetGamificationInsightsUserTrendsRequest {
	...
	public GetGamificationInsightsUserTrendsRequest withUserId(String userId) {
	...
	public GetGamificationInsightsUserTrendsRequest withFilterType(String filterType) {
	...
	public GetGamificationInsightsUserTrendsRequest withFilterId(String filterId) {
	...
	public GetGamificationInsightsUserTrendsRequest withGranularity(String granularity) {
    ...
    public GetGamificationInsightsUserTrendsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.userId == null) {
            throw new IllegalStateException("Missing the required parameter 'userId' when building request for GetGamificationInsightsUserTrendsRequest.");
        }
        
        // verify the required parameter 'filterType' is set
        if (this.filterType == null) {
            throw new IllegalStateException("Missing the required parameter 'filterType' when building request for GetGamificationInsightsUserTrendsRequest.");
        }
        
        // verify the required parameter 'filterId' is set
        if (this.filterId == null) {
            throw new IllegalStateException("Missing the required parameter 'filterId' when building request for GetGamificationInsightsUserTrendsRequest.");
        }
        
        // verify the required parameter 'granularity' is set
        if (this.granularity == null) {
            throw new IllegalStateException("Missing the required parameter 'granularity' when building request for GetGamificationInsightsUserTrendsRequest.");
        }
        
        // verify the required parameter 'comparativePeriodStartWorkday' is set
        if (this.comparativePeriodStartWorkday == null) {
            throw new IllegalStateException("Missing the required parameter 'comparativePeriodStartWorkday' when building request for GetGamificationInsightsUserTrendsRequest.");
        }
        
        // verify the required parameter 'comparativePeriodEndWorkday' is set
        if (this.comparativePeriodEndWorkday == null) {
            throw new IllegalStateException("Missing the required parameter 'comparativePeriodEndWorkday' when building request for GetGamificationInsightsUserTrendsRequest.");
        }
        
        // verify the required parameter 'primaryPeriodStartWorkday' is set
        if (this.primaryPeriodStartWorkday == null) {
            throw new IllegalStateException("Missing the required parameter 'primaryPeriodStartWorkday' when building request for GetGamificationInsightsUserTrendsRequest.");
        }
        
        // verify the required parameter 'primaryPeriodEndWorkday' is set
        if (this.primaryPeriodEndWorkday == null) {
            throw new IllegalStateException("Missing the required parameter 'primaryPeriodEndWorkday' when building request for GetGamificationInsightsUserTrendsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/gamification/insights/users/{userId}/trends")
	...
	public static Builder builder(String userId, String filterType, String filterId, String granularity, LocalDate comparativePeriodStartWorkday, LocalDate comparativePeriodEndWorkday, LocalDate primaryPeriodStartWorkday, LocalDate primaryPeriodEndWorkday) {
	    return new Builder()
	            .withRequiredParams(userId, filterType, filterId, granularity, comparativePeriodStartWorkday, comparativePeriodEndWorkday, primaryPeriodStartWorkday, primaryPeriodEndWorkday);
	}


	public static class Builder {
		private final GetGamificationInsightsUserTrendsRequest request;

		private Builder() {
			request = new GetGamificationInsightsUserTrendsRequest();
		}
		...
		public Builder withRequiredParams(String userId, String filterType, String filterId, String granularity, LocalDate comparativePeriodStartWorkday, LocalDate comparativePeriodEndWorkday, LocalDate primaryPeriodStartWorkday, LocalDate primaryPeriodEndWorkday) {
			request.setUserId(userId);
			request.setFilterType(filterType);
			request.setFilterId(filterId);
			request.setGranularity(granularity);
		...
		public GetGamificationInsightsUserTrendsRequest build() {
