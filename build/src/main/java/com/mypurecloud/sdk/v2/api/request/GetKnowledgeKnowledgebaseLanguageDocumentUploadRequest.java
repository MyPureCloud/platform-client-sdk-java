...
public class GetKnowledgeKnowledgebaseLanguageDocumentUploadRequest {
	...
	public GetKnowledgeKnowledgebaseLanguageDocumentUploadRequest withDocumentId(String documentId) {
	...
	public GetKnowledgeKnowledgebaseLanguageDocumentUploadRequest withKnowledgeBaseId(String knowledgeBaseId) {
	...
	public GetKnowledgeKnowledgebaseLanguageDocumentUploadRequest withLanguageCode(String languageCode) {
	...
	public GetKnowledgeKnowledgebaseLanguageDocumentUploadRequest withUploadId(String uploadId) {
    ...
    public GetKnowledgeKnowledgebaseLanguageDocumentUploadRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.documentId == null) {
            throw new IllegalStateException("Missing the required parameter 'documentId' when building request for GetKnowledgeKnowledgebaseLanguageDocumentUploadRequest.");
        }
        
        // verify the required parameter 'knowledgeBaseId' is set
        if (this.knowledgeBaseId == null) {
            throw new IllegalStateException("Missing the required parameter 'knowledgeBaseId' when building request for GetKnowledgeKnowledgebaseLanguageDocumentUploadRequest.");
        }
        
        // verify the required parameter 'languageCode' is set
        if (this.languageCode == null) {
            throw new IllegalStateException("Missing the required parameter 'languageCode' when building request for GetKnowledgeKnowledgebaseLanguageDocumentUploadRequest.");
        }
        
        // verify the required parameter 'uploadId' is set
        if (this.uploadId == null) {
            throw new IllegalStateException("Missing the required parameter 'uploadId' when building request for GetKnowledgeKnowledgebaseLanguageDocumentUploadRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/languages/{languageCode}/documents/{documentId}/uploads/{uploadId}")
	...
	public static Builder builder(String documentId, String knowledgeBaseId, String languageCode, String uploadId) {
	    return new Builder()
	            .withRequiredParams(documentId, knowledgeBaseId, languageCode, uploadId);
	}


	public static class Builder {
		private final GetKnowledgeKnowledgebaseLanguageDocumentUploadRequest request;

		private Builder() {
			request = new GetKnowledgeKnowledgebaseLanguageDocumentUploadRequest();
		}
		...
		public Builder withRequiredParams(String documentId, String knowledgeBaseId, String languageCode, String uploadId) {
			request.setDocumentId(documentId);
			request.setKnowledgeBaseId(knowledgeBaseId);
			request.setLanguageCode(languageCode);
			request.setUploadId(uploadId);
		...
		public GetKnowledgeKnowledgebaseLanguageDocumentUploadRequest build() {
