...
public class GetIntegrationsCredentialsTypesRequest {
    ...
    public GetIntegrationsCredentialsTypesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/integrations/credentials/types")
	...
	public static class Builder {
		private final GetIntegrationsCredentialsTypesRequest request;

		private Builder() {
			request = new GetIntegrationsCredentialsTypesRequest();
		}
		...
		public GetIntegrationsCredentialsTypesRequest build() {
