...
public class JourneyOutcomeEventsNotificationOutcome  implements Serializable {
  
  private String id = null;
  private String selfUri = null;
  private String displayName = null;

  public JourneyOutcomeEventsNotificationOutcome() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
    }
  }

  public JourneyOutcomeEventsNotificationOutcome(Boolean initWithEmptyList) {
  ...
  /**
   **/
  public JourneyOutcomeEventsNotificationOutcome id(String id) {
    this.id = id;
    return this;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, selfUri, displayName);
  }
