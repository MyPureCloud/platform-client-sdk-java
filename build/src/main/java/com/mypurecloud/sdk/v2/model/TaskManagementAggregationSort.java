...
public class TaskManagementAggregationSort  implements Serializable {
 ...
 @JsonDeserialize(using = FunctionEnumDeserializer.class)
  ...
  public TaskManagementAggregationSort() {
   ...
   * Name of the metric used for sorting values.
   **/
  public TaskManagementAggregationSort name(NameEnum name) {
    this.name = name;
    return this;
  }
   ...
   * Aggregation function used for the sort metric.
   **/
  public TaskManagementAggregationSort function(FunctionEnum function) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TaskManagementAggregationSort taskManagementAggregationSort = (TaskManagementAggregationSort) o;

    return Objects.equals(this.name, taskManagementAggregationSort.name) &&
            Objects.equals(this.function, taskManagementAggregationSort.function);
  }
