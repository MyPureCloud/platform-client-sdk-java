...
public class PostAnalyticsConversationsDetailsJobsRequest {
    
	private AsyncConversationQuery body;
	public AsyncConversationQuery getBody() {
		return this.body;
	}

	public void setBody(AsyncConversationQuery body) {
		this.body = body;
	}

	public PostAnalyticsConversationsDetailsJobsRequest withBody(AsyncConversationQuery body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostAnalyticsConversationsDetailsJobsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<AsyncConversationQuery> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostAnalyticsConversationsDetailsJobsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/analytics/conversations/details/jobs")
                .withBody(body)
	...
	public static Builder builder(AsyncConversationQuery body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostAnalyticsConversationsDetailsJobsRequest request;

		private Builder() {
			request = new PostAnalyticsConversationsDetailsJobsRequest();
		}

		
		public Builder withBody(AsyncConversationQuery body) {
		...
		public Builder withRequiredParams(AsyncConversationQuery body) {
			request.setBody(body);
		...
		public PostAnalyticsConversationsDetailsJobsRequest build() {
