...
public class GetAnalyticsReportingScheduleHistoryLatestRequest {
	...
	public GetAnalyticsReportingScheduleHistoryLatestRequest withScheduleId(String scheduleId) {
    ...
    public GetAnalyticsReportingScheduleHistoryLatestRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.scheduleId == null) {
            throw new IllegalStateException("Missing the required parameter 'scheduleId' when building request for GetAnalyticsReportingScheduleHistoryLatestRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/analytics/reporting/schedules/{scheduleId}/history/latest")
	...
	public static class Builder {
		private final GetAnalyticsReportingScheduleHistoryLatestRequest request;

		private Builder() {
			request = new GetAnalyticsReportingScheduleHistoryLatestRequest();
		}
		...
		public GetAnalyticsReportingScheduleHistoryLatestRequest build() {
