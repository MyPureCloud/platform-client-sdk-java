...
public class PatchUserPresencesPurecloudRequest {
	...
	public PatchUserPresencesPurecloudRequest withUserId(String userId) {
	...
	public PatchUserPresencesPurecloudRequest withBody(UserPresence body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchUserPresencesPurecloudRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<UserPresence> withHttpInfo() {
        ...
        if (this.userId == null) {
            throw new IllegalStateException("Missing the required parameter 'userId' when building request for PatchUserPresencesPurecloudRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchUserPresencesPurecloudRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/users/{userId}/presences/purecloud")
