...
public class PostLicenseInferPermissionsRequest {
	...
	public PostLicenseInferPermissionsRequest withBody(List<String> body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostLicenseInferPermissionsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<List<String>> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("POST", "/api/v2/license/infer/permissions")
                .withBody(body)
	...
	public static class Builder {
		private final PostLicenseInferPermissionsRequest request;

		private Builder() {
			request = new PostLicenseInferPermissionsRequest();
		}
		...
		public PostLicenseInferPermissionsRequest build() {
