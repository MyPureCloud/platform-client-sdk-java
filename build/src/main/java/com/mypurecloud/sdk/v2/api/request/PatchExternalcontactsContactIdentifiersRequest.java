...
public class PatchExternalcontactsContactIdentifiersRequest {
	...
	public PatchExternalcontactsContactIdentifiersRequest withContactId(String contactId) {
	    this.setContactId(contactId);
	    return this;
	} 

	private IdentifierClaimRequest body;
	public IdentifierClaimRequest getBody() {
		return this.body;
	}

	public void setBody(IdentifierClaimRequest body) {
		this.body = body;
	}

	public PatchExternalcontactsContactIdentifiersRequest withBody(IdentifierClaimRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchExternalcontactsContactIdentifiersRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<IdentifierClaimRequest> withHttpInfo() {
        
        // verify the required parameter 'contactId' is set
        if (this.contactId == null) {
            throw new IllegalStateException("Missing the required parameter 'contactId' when building request for PatchExternalcontactsContactIdentifiersRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchExternalcontactsContactIdentifiersRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/externalcontacts/contacts/{contactId}/identifiers")
	...
	public static Builder builder(String contactId, IdentifierClaimRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PatchExternalcontactsContactIdentifiersRequest request;

		private Builder() {
			request = new PatchExternalcontactsContactIdentifiersRequest();
		}
		...
		public Builder withBody(IdentifierClaimRequest body) {
		...
		public Builder withRequiredParams(String contactId, IdentifierClaimRequest body) {
			request.setContactId(contactId);
			request.setBody(body);
		...
		public PatchExternalcontactsContactIdentifiersRequest build() {
