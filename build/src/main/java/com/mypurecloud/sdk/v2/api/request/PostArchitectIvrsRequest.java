...
public class PostArchitectIvrsRequest {
	...
	public PostArchitectIvrsRequest withBody(IVR body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostArchitectIvrsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<IVR> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostArchitectIvrsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/architect/ivrs")
                .withBody(body)
	...
	public static Builder builder(IVR body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostArchitectIvrsRequest request;

		private Builder() {
			request = new PostArchitectIvrsRequest();
		}
		...
		public Builder withRequiredParams(IVR body) {
			request.setBody(body);
		...
		public PostArchitectIvrsRequest build() {
