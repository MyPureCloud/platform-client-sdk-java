...
public class PutRoutingUtilizationLabelRequest {
	...
	public PutRoutingUtilizationLabelRequest withLabelId(String labelId) {
	...
	public void setBody(UpdateUtilizationLabelRequest body) {
		this.body = body;
	}

	public PutRoutingUtilizationLabelRequest withBody(UpdateUtilizationLabelRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutRoutingUtilizationLabelRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<UpdateUtilizationLabelRequest> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("PUT", "/api/v2/routing/utilization/labels/{labelId}")
	...
	public static Builder builder(String labelId, UpdateUtilizationLabelRequest body) {
	    return new Builder()
	            .withRequiredParams(labelId, body);
	}
	...
	public static class Builder {
		...
		private Builder() {
			request = new PutRoutingUtilizationLabelRequest();
		}
		...
		public Builder withBody(UpdateUtilizationLabelRequest body) {
		...
		public Builder withRequiredParams(String labelId, UpdateUtilizationLabelRequest body) {
			request.setLabelId(labelId);
			request.setBody(body);
