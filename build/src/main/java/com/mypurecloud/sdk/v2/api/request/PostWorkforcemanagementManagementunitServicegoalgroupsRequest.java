...
public class PostWorkforcemanagementManagementunitServicegoalgroupsRequest {
	...
	public PostWorkforcemanagementManagementunitServicegoalgroupsRequest withManagementUnitId(String managementUnitId) {
	    this.setManagementUnitId(managementUnitId);
	    return this;
	} 
	
	private CreateServiceGoalGroupRequest body;
	public CreateServiceGoalGroupRequest getBody() {
		return this.body;
	}

	public void setBody(CreateServiceGoalGroupRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementManagementunitServicegoalgroupsRequest withBody(CreateServiceGoalGroupRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementManagementunitServicegoalgroupsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<CreateServiceGoalGroupRequest> withHttpInfo() {
        
        // verify the required parameter 'managementUnitId' is set
        if (this.managementUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'managementUnitId' when building request for PostWorkforcemanagementManagementunitServicegoalgroupsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/managementunits/{managementUnitId}/servicegoalgroups")
	...
	public static class Builder {
		private final PostWorkforcemanagementManagementunitServicegoalgroupsRequest request;

		private Builder() {
			request = new PostWorkforcemanagementManagementunitServicegoalgroupsRequest();
		}
		...
		public Builder withBody(CreateServiceGoalGroupRequest body) {
		...
		public PostWorkforcemanagementManagementunitServicegoalgroupsRequest build() {
