...
public class GetKnowledgeKnowledgebaseSynchronizeJobRequest {
	...
	public GetKnowledgeKnowledgebaseSynchronizeJobRequest withKnowledgeBaseId(String knowledgeBaseId) {
	...
	public GetKnowledgeKnowledgebaseSynchronizeJobRequest withSyncJobId(String syncJobId) {
    ...
    public GetKnowledgeKnowledgebaseSynchronizeJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.knowledgeBaseId == null) {
            throw new IllegalStateException("Missing the required parameter 'knowledgeBaseId' when building request for GetKnowledgeKnowledgebaseSynchronizeJobRequest.");
        }
        
        // verify the required parameter 'syncJobId' is set
        if (this.syncJobId == null) {
            throw new IllegalStateException("Missing the required parameter 'syncJobId' when building request for GetKnowledgeKnowledgebaseSynchronizeJobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/synchronize/jobs/{syncJobId}")
	...
	public static class Builder {
		private final GetKnowledgeKnowledgebaseSynchronizeJobRequest request;

		private Builder() {
			request = new GetKnowledgeKnowledgebaseSynchronizeJobRequest();
		}
		...
		public GetKnowledgeKnowledgebaseSynchronizeJobRequest build() {
