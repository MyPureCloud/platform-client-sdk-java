...
public class PostUserExternalidRequest {
	...
	public PostUserExternalidRequest withUserId(String userId) {
	    this.setUserId(userId);
	    return this;
	} 

	private UserExternalIdentifier body;
	public UserExternalIdentifier getBody() {
		return this.body;
	}

	public void setBody(UserExternalIdentifier body) {
		this.body = body;
	}

	public PostUserExternalidRequest withBody(UserExternalIdentifier body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostUserExternalidRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<UserExternalIdentifier> withHttpInfo() {
        
        // verify the required parameter 'userId' is set
        if (this.userId == null) {
            throw new IllegalStateException("Missing the required parameter 'userId' when building request for PostUserExternalidRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostUserExternalidRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/users/{userId}/externalid")
	...
	public static Builder builder(String userId, UserExternalIdentifier body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostUserExternalidRequest request;

		private Builder() {
			request = new PostUserExternalidRequest();
		}
		...
		public Builder withBody(UserExternalIdentifier body) {
		...
		public Builder withRequiredParams(String userId, UserExternalIdentifier body) {
			request.setUserId(userId);
			request.setBody(body);
		...
		public PostUserExternalidRequest build() {
