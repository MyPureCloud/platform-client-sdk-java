...
public class GetTaskmanagementWorktypeVersionsRequest {
	...
	public GetTaskmanagementWorktypeVersionsRequest withWorktypeId(String worktypeId) {
	...
	public GetTaskmanagementWorktypeVersionsRequest withAfter(String after) {
	    this.setAfter(after);
	    return this;
	} 
	...
	public GetTaskmanagementWorktypeVersionsRequest withPageSize(Integer pageSize) {
	...
	public GetTaskmanagementWorktypeVersionsRequest withSortOrder(String sortOrder) {
    ...
    public GetTaskmanagementWorktypeVersionsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.worktypeId == null) {
            throw new IllegalStateException("Missing the required parameter 'worktypeId' when building request for GetTaskmanagementWorktypeVersionsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/taskmanagement/worktypes/{worktypeId}/versions")
	...
	public static class Builder {
		private final GetTaskmanagementWorktypeVersionsRequest request;

		private Builder() {
			request = new GetTaskmanagementWorktypeVersionsRequest();
		}
		...
		public GetTaskmanagementWorktypeVersionsRequest build() {
