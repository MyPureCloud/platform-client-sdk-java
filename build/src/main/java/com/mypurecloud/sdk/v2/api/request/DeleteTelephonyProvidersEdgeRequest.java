...
public class DeleteTelephonyProvidersEdgeRequest {
	...
	public DeleteTelephonyProvidersEdgeRequest withEdgeId(String edgeId) {
    ...
    public DeleteTelephonyProvidersEdgeRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.edgeId == null) {
            throw new IllegalStateException("Missing the required parameter 'edgeId' when building request for DeleteTelephonyProvidersEdgeRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/telephony/providers/edges/{edgeId}")
	...
	public static class Builder {
		private final DeleteTelephonyProvidersEdgeRequest request;

		private Builder() {
			request = new DeleteTelephonyProvidersEdgeRequest();
		}
		...
		public DeleteTelephonyProvidersEdgeRequest build() {
