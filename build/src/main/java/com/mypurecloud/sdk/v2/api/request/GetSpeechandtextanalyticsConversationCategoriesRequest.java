...
public class GetSpeechandtextanalyticsConversationCategoriesRequest {
	...
	public GetSpeechandtextanalyticsConversationCategoriesRequest withConversationId(String conversationId) {
	...
	public GetSpeechandtextanalyticsConversationCategoriesRequest withPageSize(Integer pageSize) {
	...
	public GetSpeechandtextanalyticsConversationCategoriesRequest withPageNumber(Integer pageNumber) {
    ...
    public GetSpeechandtextanalyticsConversationCategoriesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for GetSpeechandtextanalyticsConversationCategoriesRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/speechandtextanalytics/conversations/{conversationId}/categories")
	...
	public static class Builder {
		private final GetSpeechandtextanalyticsConversationCategoriesRequest request;

		private Builder() {
			request = new GetSpeechandtextanalyticsConversationCategoriesRequest();
		}
		...
		public GetSpeechandtextanalyticsConversationCategoriesRequest build() {
