...
public class PostFlowsActionsUnlockRequest {
	...
	public PostFlowsActionsUnlockRequest withFlow(String flow) {
	    this.setFlow(flow);
	    return this;
	} 
    ...
    public PostFlowsActionsUnlockRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.flow == null) {
            throw new IllegalStateException("Missing the required parameter 'flow' when building request for PostFlowsActionsUnlockRequest.");
        }
