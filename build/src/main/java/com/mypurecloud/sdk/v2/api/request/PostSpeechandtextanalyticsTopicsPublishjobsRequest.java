...
public class PostSpeechandtextanalyticsTopicsPublishjobsRequest {
    
	private TopicJobRequest body;
	public TopicJobRequest getBody() {
		return this.body;
	}

	public void setBody(TopicJobRequest body) {
		this.body = body;
	}

	public PostSpeechandtextanalyticsTopicsPublishjobsRequest withBody(TopicJobRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostSpeechandtextanalyticsTopicsPublishjobsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<TopicJobRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostSpeechandtextanalyticsTopicsPublishjobsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/speechandtextanalytics/topics/publishjobs")
                .withBody(body)
	...
	public static Builder builder(TopicJobRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostSpeechandtextanalyticsTopicsPublishjobsRequest request;

		private Builder() {
			request = new PostSpeechandtextanalyticsTopicsPublishjobsRequest();
		}

		
		public Builder withBody(TopicJobRequest body) {
		...
		public Builder withRequiredParams(TopicJobRequest body) {
			request.setBody(body);
		...
		public PostSpeechandtextanalyticsTopicsPublishjobsRequest build() {
