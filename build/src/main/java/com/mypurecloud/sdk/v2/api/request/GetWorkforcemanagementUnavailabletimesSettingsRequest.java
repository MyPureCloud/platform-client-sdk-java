...
public class GetWorkforcemanagementUnavailabletimesSettingsRequest {
    ...
    public GetWorkforcemanagementUnavailabletimesSettingsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/unavailabletimes/settings")
	...
	public static class Builder {
		private final GetWorkforcemanagementUnavailabletimesSettingsRequest request;

		private Builder() {
			request = new GetWorkforcemanagementUnavailabletimesSettingsRequest();
		}
		...
		public GetWorkforcemanagementUnavailabletimesSettingsRequest build() {
