...
public class PostJourneyExternaleventsSchemasRequest {

	private JourneyJsonSchemaRequest body;
	public JourneyJsonSchemaRequest getBody() {
		return this.body;
	}

	public void setBody(JourneyJsonSchemaRequest body) {
		this.body = body;
	}

	public PostJourneyExternaleventsSchemasRequest withBody(JourneyJsonSchemaRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostJourneyExternaleventsSchemasRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<JourneyJsonSchemaRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostJourneyExternaleventsSchemasRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/journey/externalevents/schemas")
                .withBody(body)
	...
	public static Builder builder(JourneyJsonSchemaRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostJourneyExternaleventsSchemasRequest request;

		private Builder() {
			request = new PostJourneyExternaleventsSchemasRequest();
		}


		public Builder withBody(JourneyJsonSchemaRequest body) {
		...
		public Builder withRequiredParams(JourneyJsonSchemaRequest body) {
			request.setBody(body);
		...
		public PostJourneyExternaleventsSchemasRequest build() {
