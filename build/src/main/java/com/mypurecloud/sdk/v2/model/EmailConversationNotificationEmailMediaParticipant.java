...
public class EmailConversationNotificationEmailMediaParticipant  implements Serializable {
  ...
  /**
   **/
  public EmailConversationNotificationEmailMediaParticipant user(DependencyTrackingBuildNotificationNotificationUser user) {
    this.user = user;
    return this;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, address, startTime, connectedTime, endTime, startHoldTime, purpose, state, direction, disconnectType, held, wrapupRequired, wrapupPrompt, user, queue, attributes, errorInfo, script, wrapupTimeoutMs, wrapupSkipped, provider, externalContact, externalOrganization, wrapup, subject, messagesSent);
  }
