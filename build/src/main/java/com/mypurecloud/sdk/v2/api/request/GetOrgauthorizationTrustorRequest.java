...
public class GetOrgauthorizationTrustorRequest {
	...
	public GetOrgauthorizationTrustorRequest withTrustorOrgId(String trustorOrgId) {
    ...
    public GetOrgauthorizationTrustorRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.trustorOrgId == null) {
            throw new IllegalStateException("Missing the required parameter 'trustorOrgId' when building request for GetOrgauthorizationTrustorRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/orgauthorization/trustors/{trustorOrgId}")
	...
	public static class Builder {
		private final GetOrgauthorizationTrustorRequest request;

		private Builder() {
			request = new GetOrgauthorizationTrustorRequest();
		}
		...
		public GetOrgauthorizationTrustorRequest build() {
