...
public class GetWorkforcemanagementAgentsMeAdherenceHistoricalJobRequest {
	...
	public GetWorkforcemanagementAgentsMeAdherenceHistoricalJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetWorkforcemanagementAgentsMeAdherenceHistoricalJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetWorkforcemanagementAgentsMeAdherenceHistoricalJobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/agents/me/adherence/historical/jobs/{jobId}")
	...
	public static class Builder {
		private final GetWorkforcemanagementAgentsMeAdherenceHistoricalJobRequest request;

		private Builder() {
			request = new GetWorkforcemanagementAgentsMeAdherenceHistoricalJobRequest();
		}
		...
		public GetWorkforcemanagementAgentsMeAdherenceHistoricalJobRequest build() {
