...
public class PostExternalcontactsBulkNotesRemoveRequest {
	...
	public PostExternalcontactsBulkNotesRemoveRequest withBody(BulkIdsRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostExternalcontactsBulkNotesRemoveRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<BulkIdsRequest> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostExternalcontactsBulkNotesRemoveRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/externalcontacts/bulk/notes/remove")
                .withBody(body)
	...
	public static class Builder {
		private final PostExternalcontactsBulkNotesRemoveRequest request;

		private Builder() {
			request = new PostExternalcontactsBulkNotesRemoveRequest();
		}
		...
		public PostExternalcontactsBulkNotesRemoveRequest build() {
