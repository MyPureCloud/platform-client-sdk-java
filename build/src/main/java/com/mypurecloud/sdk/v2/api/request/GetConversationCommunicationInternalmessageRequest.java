...
public class GetConversationCommunicationInternalmessageRequest {
	...
	public GetConversationCommunicationInternalmessageRequest withConversationId(String conversationId) {
	...
	public GetConversationCommunicationInternalmessageRequest withMessageId(String messageId) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for GetConversationCommunicationInternalmessageRequest.");
        }
        
        // verify the required parameter 'communicationId' is set
        if (this.communicationId == null) {
            throw new IllegalStateException("Missing the required parameter 'communicationId' when building request for GetConversationCommunicationInternalmessageRequest.");
        }
        
        // verify the required parameter 'messageId' is set
        if (this.messageId == null) {
            throw new IllegalStateException("Missing the required parameter 'messageId' when building request for GetConversationCommunicationInternalmessageRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/conversations/{conversationId}/communications/{communicationId}/internalmessages/{messageId}")
	...
	public static Builder builder(String conversationId, String communicationId, String messageId) {
	    return new Builder()
	            .withRequiredParams(conversationId, communicationId, messageId);
	}


	public static class Builder {
		private final GetConversationCommunicationInternalmessageRequest request;

		private Builder() {
			request = new GetConversationCommunicationInternalmessageRequest();
		}
		...
		public Builder withRequiredParams(String conversationId, String communicationId, String messageId) {
			request.setConversationId(conversationId);
			request.setCommunicationId(communicationId);
			request.setMessageId(messageId);
		...
		public GetConversationCommunicationInternalmessageRequest build() {
