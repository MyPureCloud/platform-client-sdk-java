...
public class WorkspaceEntityListing  implements Serializable, PagedResource<Workspace> {
  
  private List<Workspace> entities = new ArrayList<Workspace>();
  ...
  /**
   **/
  public WorkspaceEntityListing entities(List<Workspace> entities) {
  ...
  public List<Workspace> getEntities() {
    return entities;
  }
  public void setEntities(List<Workspace> entities) {
    this.entities = entities;
  }
