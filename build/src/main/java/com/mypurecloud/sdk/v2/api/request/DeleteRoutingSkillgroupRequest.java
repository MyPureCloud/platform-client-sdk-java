...
public class DeleteRoutingSkillgroupRequest {
	...
	public DeleteRoutingSkillgroupRequest withSkillGroupId(String skillGroupId) {
    ...
    public DeleteRoutingSkillgroupRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.skillGroupId == null) {
            throw new IllegalStateException("Missing the required parameter 'skillGroupId' when building request for DeleteRoutingSkillgroupRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/routing/skillgroups/{skillGroupId}")
	...
	public static class Builder {
		private final DeleteRoutingSkillgroupRequest request;

		private Builder() {
			request = new DeleteRoutingSkillgroupRequest();
		}
		...
		public DeleteRoutingSkillgroupRequest build() {
