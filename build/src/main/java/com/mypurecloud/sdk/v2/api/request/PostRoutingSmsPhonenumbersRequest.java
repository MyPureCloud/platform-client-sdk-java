...
public class PostRoutingSmsPhonenumbersRequest {
    
	private SmsPhoneNumberProvision body;
	public SmsPhoneNumberProvision getBody() {
		return this.body;
	}

	public void setBody(SmsPhoneNumberProvision body) {
		this.body = body;
	}

	public PostRoutingSmsPhonenumbersRequest withBody(SmsPhoneNumberProvision body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostRoutingSmsPhonenumbersRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<SmsPhoneNumberProvision> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostRoutingSmsPhonenumbersRequest.");
        }
	...
	public static Builder builder(SmsPhoneNumberProvision body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostRoutingSmsPhonenumbersRequest request;

		private Builder() {
			request = new PostRoutingSmsPhonenumbersRequest();
		}
		...
		public Builder withRequiredParams(SmsPhoneNumberProvision body) {
			request.setBody(body);
		...
		public PostRoutingSmsPhonenumbersRequest build() {
