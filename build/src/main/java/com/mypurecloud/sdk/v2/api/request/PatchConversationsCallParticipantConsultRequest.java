...
public class PatchConversationsCallParticipantConsultRequest {
	...
	public PatchConversationsCallParticipantConsultRequest withCallId(String callId) {
    ...
    public ApiRequest<ConsultTransferUpdate> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("PATCH", "/api/v2/conversations/calls/{callId}/participants/{participantId}/consult")
	...
	public static Builder builder(String callId, String participantId, ConsultTransferUpdate body) {
	    return new Builder()
	...
	public static class Builder {
		...
		public Builder withRequiredParams(String callId, String participantId, ConsultTransferUpdate body) {
			request.setCallId(callId);
			request.setParticipantId(participantId);
			request.setBody(body);
			return this;
