...
public class PostAuthorizationPolicySimulateRequest {
	...
	public PostAuthorizationPolicySimulateRequest withPolicyId(String policyId) {
	    this.setPolicyId(policyId);
	    return this;
	} 

	private PolicyTestPayload body;
	public PolicyTestPayload getBody() {
		return this.body;
	}

	public void setBody(PolicyTestPayload body) {
		this.body = body;
	}

	public PostAuthorizationPolicySimulateRequest withBody(PolicyTestPayload body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostAuthorizationPolicySimulateRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<PolicyTestPayload> withHttpInfo() {
        
        // verify the required parameter 'policyId' is set
        if (this.policyId == null) {
            throw new IllegalStateException("Missing the required parameter 'policyId' when building request for PostAuthorizationPolicySimulateRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostAuthorizationPolicySimulateRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/authorization/policies/{policyId}/simulate")
	...
	public static Builder builder(String policyId, PolicyTestPayload body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostAuthorizationPolicySimulateRequest request;

		private Builder() {
			request = new PostAuthorizationPolicySimulateRequest();
		}
		...
		public Builder withBody(PolicyTestPayload body) {
		...
		public Builder withRequiredParams(String policyId, PolicyTestPayload body) {
			request.setPolicyId(policyId);
			request.setBody(body);
		...
		public PostAuthorizationPolicySimulateRequest build() {
