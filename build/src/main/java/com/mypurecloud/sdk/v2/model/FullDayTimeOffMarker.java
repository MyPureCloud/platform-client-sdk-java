...
public class FullDayTimeOffMarker  implements Serializable {
  ...
  public FullDayTimeOffMarker() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
    }
  }

  public FullDayTimeOffMarker(Boolean initWithEmptyList) {
   ...
   **/
  public FullDayTimeOffMarker businessUnitDate(LocalDate businessUnitDate) {
   ...
   **/
  public FullDayTimeOffMarker lengthMinutes(Integer lengthMinutes) {
   ...
   **/
  public FullDayTimeOffMarker description(String description) {
   ...
   **/
  public FullDayTimeOffMarker activityCodeId(String activityCodeId) {
   ...
   **/
  public FullDayTimeOffMarker paid(Boolean paid) {
    this.paid = paid;
    return this;
  }
   ...
   **/
  public FullDayTimeOffMarker timeOffRequestId(String timeOffRequestId) {
