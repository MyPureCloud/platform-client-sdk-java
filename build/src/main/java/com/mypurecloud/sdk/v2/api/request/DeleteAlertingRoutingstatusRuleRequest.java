...
public class DeleteAlertingRoutingstatusRuleRequest {
	...
	public DeleteAlertingRoutingstatusRuleRequest withRuleId(String ruleId) {
    ...
    public DeleteAlertingRoutingstatusRuleRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.ruleId == null) {
            throw new IllegalStateException("Missing the required parameter 'ruleId' when building request for DeleteAlertingRoutingstatusRuleRequest.");
        }
