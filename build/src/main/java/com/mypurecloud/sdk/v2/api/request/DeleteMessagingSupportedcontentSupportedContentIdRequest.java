...
public class DeleteMessagingSupportedcontentSupportedContentIdRequest {
	...
	public DeleteMessagingSupportedcontentSupportedContentIdRequest withSupportedContentId(String supportedContentId) {
    ...
    public DeleteMessagingSupportedcontentSupportedContentIdRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.supportedContentId == null) {
            throw new IllegalStateException("Missing the required parameter 'supportedContentId' when building request for DeleteMessagingSupportedcontentSupportedContentIdRequest.");
        }
