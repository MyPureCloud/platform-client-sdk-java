...
public class DeleteWorkforcemanagementManagementunitServicegoalgroupRequest {
	...
	public DeleteWorkforcemanagementManagementunitServicegoalgroupRequest withManagementUnitId(String managementUnitId) {
	...
	public DeleteWorkforcemanagementManagementunitServicegoalgroupRequest withServiceGoalGroupId(String serviceGoalGroupId) {
    ...
    public DeleteWorkforcemanagementManagementunitServicegoalgroupRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.managementUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'managementUnitId' when building request for DeleteWorkforcemanagementManagementunitServicegoalgroupRequest.");
        }
        
        // verify the required parameter 'serviceGoalGroupId' is set
        if (this.serviceGoalGroupId == null) {
            throw new IllegalStateException("Missing the required parameter 'serviceGoalGroupId' when building request for DeleteWorkforcemanagementManagementunitServicegoalgroupRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/workforcemanagement/managementunits/{managementUnitId}/servicegoalgroups/{serviceGoalGroupId}")
	...
	public static class Builder {
		private final DeleteWorkforcemanagementManagementunitServicegoalgroupRequest request;

		private Builder() {
			request = new DeleteWorkforcemanagementManagementunitServicegoalgroupRequest();
		}
		...
		public DeleteWorkforcemanagementManagementunitServicegoalgroupRequest build() {
