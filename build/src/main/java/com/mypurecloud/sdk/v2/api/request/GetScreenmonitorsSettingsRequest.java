...
public class GetScreenmonitorsSettingsRequest {
    ...
    public GetScreenmonitorsSettingsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/screenmonitors/settings")
	...
	public static class Builder {
		private final GetScreenmonitorsSettingsRequest request;

		private Builder() {
			request = new GetScreenmonitorsSettingsRequest();
		}
		...
		public GetScreenmonitorsSettingsRequest build() {
