...
public class GetContentmanagementShareRequest {
	...
	public GetContentmanagementShareRequest withShareId(String shareId) {
	...
	public GetContentmanagementShareRequest withExpand(List<String> expand) {
    ...
    public GetContentmanagementShareRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/contentmanagement/shares/{shareId}")
