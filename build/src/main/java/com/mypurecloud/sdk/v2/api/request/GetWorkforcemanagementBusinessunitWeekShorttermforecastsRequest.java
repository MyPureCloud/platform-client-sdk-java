...
public class GetWorkforcemanagementBusinessunitWeekShorttermforecastsRequest {
	...
	public GetWorkforcemanagementBusinessunitWeekShorttermforecastsRequest withBusinessUnitId(String businessUnitId) {
	...
	public GetWorkforcemanagementBusinessunitWeekShorttermforecastsRequest withWeekDateId(String weekDateId) {
    ...
    public GetWorkforcemanagementBusinessunitWeekShorttermforecastsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for GetWorkforcemanagementBusinessunitWeekShorttermforecastsRequest.");
        }
        
        // verify the required parameter 'weekDateId' is set
        if (this.weekDateId == null) {
            throw new IllegalStateException("Missing the required parameter 'weekDateId' when building request for GetWorkforcemanagementBusinessunitWeekShorttermforecastsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/weeks/{weekDateId}/shorttermforecasts")
	...
	public static Builder builder(String businessUnitId, String weekDateId) {
	    return new Builder()
	            .withRequiredParams(businessUnitId, weekDateId);
	}
	

	public static class Builder {
		private final GetWorkforcemanagementBusinessunitWeekShorttermforecastsRequest request;

		private Builder() {
			request = new GetWorkforcemanagementBusinessunitWeekShorttermforecastsRequest();
		}
		...
		public Builder withRequiredParams(String businessUnitId, String weekDateId) {
			request.setBusinessUnitId(businessUnitId);
						request.setWeekDateId(weekDateId);
		...
		public GetWorkforcemanagementBusinessunitWeekShorttermforecastsRequest build() {
