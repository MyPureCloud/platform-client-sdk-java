...
public class PutUserCallforwardingRequest {
	...
	public PutUserCallforwardingRequest withUserId(String userId) {
	...
	public PutUserCallforwardingRequest withBody(CallForwarding body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutUserCallforwardingRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<CallForwarding> withHttpInfo() {
        ...
        if (this.userId == null) {
            throw new IllegalStateException("Missing the required parameter 'userId' when building request for PutUserCallforwardingRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutUserCallforwardingRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/users/{userId}/callforwarding")
