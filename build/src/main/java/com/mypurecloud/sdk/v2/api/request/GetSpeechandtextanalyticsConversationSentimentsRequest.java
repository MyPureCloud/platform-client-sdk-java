...
public class GetSpeechandtextanalyticsConversationSentimentsRequest {
	...
	public GetSpeechandtextanalyticsConversationSentimentsRequest withConversationId(String conversationId) {
    ...
    public GetSpeechandtextanalyticsConversationSentimentsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for GetSpeechandtextanalyticsConversationSentimentsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/speechandtextanalytics/conversations/{conversationId}/sentiments")
	...
	public static class Builder {
		private final GetSpeechandtextanalyticsConversationSentimentsRequest request;

		private Builder() {
			request = new GetSpeechandtextanalyticsConversationSentimentsRequest();
		}
		...
		public GetSpeechandtextanalyticsConversationSentimentsRequest build() {
