...
public class DeleteSocialmediaTopicDataingestionrulesInstagramInstagramIngestionRuleIdRequest {
	...
	public DeleteSocialmediaTopicDataingestionrulesInstagramInstagramIngestionRuleIdRequest withTopicId(String topicId) {
	...
	public DeleteSocialmediaTopicDataingestionrulesInstagramInstagramIngestionRuleIdRequest withInstagramIngestionRuleId(String instagramIngestionRuleId) {
	...
	public DeleteSocialmediaTopicDataingestionrulesInstagramInstagramIngestionRuleIdRequest withHardDelete(Boolean hardDelete) {
    ...
    public DeleteSocialmediaTopicDataingestionrulesInstagramInstagramIngestionRuleIdRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.topicId == null) {
            throw new IllegalStateException("Missing the required parameter 'topicId' when building request for DeleteSocialmediaTopicDataingestionrulesInstagramInstagramIngestionRuleIdRequest.");
        }
        
        // verify the required parameter 'instagramIngestionRuleId' is set
        if (this.instagramIngestionRuleId == null) {
            throw new IllegalStateException("Missing the required parameter 'instagramIngestionRuleId' when building request for DeleteSocialmediaTopicDataingestionrulesInstagramInstagramIngestionRuleIdRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/socialmedia/topics/{topicId}/dataingestionrules/instagram/{instagramIngestionRuleId}")
	...
	public static class Builder {
		private final DeleteSocialmediaTopicDataingestionrulesInstagramInstagramIngestionRuleIdRequest request;

		private Builder() {
			request = new DeleteSocialmediaTopicDataingestionrulesInstagramInstagramIngestionRuleIdRequest();
		}
		...
		public DeleteSocialmediaTopicDataingestionrulesInstagramInstagramIngestionRuleIdRequest build() {
