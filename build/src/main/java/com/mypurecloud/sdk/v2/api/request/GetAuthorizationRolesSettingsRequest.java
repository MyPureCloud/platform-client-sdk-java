...
public class GetAuthorizationRolesSettingsRequest {
    ...
    public GetAuthorizationRolesSettingsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/authorization/roles/settings")
	...
	public static class Builder {
		private final GetAuthorizationRolesSettingsRequest request;

		private Builder() {
			request = new GetAuthorizationRolesSettingsRequest();
		}
		...
		public GetAuthorizationRolesSettingsRequest build() {
