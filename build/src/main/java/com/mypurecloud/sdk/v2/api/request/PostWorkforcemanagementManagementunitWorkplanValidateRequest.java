...
public class PostWorkforcemanagementManagementunitWorkplanValidateRequest {
	...
	public PostWorkforcemanagementManagementunitWorkplanValidateRequest withManagementUnitId(String managementUnitId) {
	...
	public PostWorkforcemanagementManagementunitWorkplanValidateRequest withWorkPlanId(String workPlanId) {
	...
	public PostWorkforcemanagementManagementunitWorkplanValidateRequest withExpand(List<String> expand) {
    ...
    public PostWorkforcemanagementManagementunitWorkplanValidateRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<WorkPlanValidationRequest> withHttpInfo() {
        
        // verify the required parameter 'managementUnitId' is set
        if (this.managementUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'managementUnitId' when building request for PostWorkforcemanagementManagementunitWorkplanValidateRequest.");
        }
	...
	public static class Builder {
		private final PostWorkforcemanagementManagementunitWorkplanValidateRequest request;

		private Builder() {
			request = new PostWorkforcemanagementManagementunitWorkplanValidateRequest();
		}
		...
		public PostWorkforcemanagementManagementunitWorkplanValidateRequest build() {
