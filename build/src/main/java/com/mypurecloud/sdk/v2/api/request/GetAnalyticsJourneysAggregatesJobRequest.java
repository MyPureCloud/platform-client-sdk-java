...
public class GetAnalyticsJourneysAggregatesJobRequest {
	...
	public GetAnalyticsJourneysAggregatesJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetAnalyticsJourneysAggregatesJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetAnalyticsJourneysAggregatesJobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/analytics/journeys/aggregates/jobs/{jobId}")
	...
	public static class Builder {
		private final GetAnalyticsJourneysAggregatesJobRequest request;

		private Builder() {
			request = new GetAnalyticsJourneysAggregatesJobRequest();
		}
		...
		public GetAnalyticsJourneysAggregatesJobRequest build() {
