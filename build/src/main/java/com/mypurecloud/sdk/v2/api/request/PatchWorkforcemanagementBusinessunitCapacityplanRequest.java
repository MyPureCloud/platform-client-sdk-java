...
public class PatchWorkforcemanagementBusinessunitCapacityplanRequest {
	...
	public PatchWorkforcemanagementBusinessunitCapacityplanRequest withBusinessUnitId(String businessUnitId) {
	...
	public PatchWorkforcemanagementBusinessunitCapacityplanRequest withCapacityPlanId(String capacityPlanId) {
	    this.setCapacityPlanId(capacityPlanId);
	    return this;
	} 

	private UpdateCapacityPlanRequest body;
	public UpdateCapacityPlanRequest getBody() {
		return this.body;
	}

	public void setBody(UpdateCapacityPlanRequest body) {
		this.body = body;
	}

	public PatchWorkforcemanagementBusinessunitCapacityplanRequest withBody(UpdateCapacityPlanRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchWorkforcemanagementBusinessunitCapacityplanRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<UpdateCapacityPlanRequest> withHttpInfo() {
        
        // verify the required parameter 'businessUnitId' is set
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PatchWorkforcemanagementBusinessunitCapacityplanRequest.");
        }
        
        // verify the required parameter 'capacityPlanId' is set
        if (this.capacityPlanId == null) {
            throw new IllegalStateException("Missing the required parameter 'capacityPlanId' when building request for PatchWorkforcemanagementBusinessunitCapacityplanRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchWorkforcemanagementBusinessunitCapacityplanRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/capacityplans/{capacityPlanId}")
	...
	public static Builder builder(String businessUnitId, String capacityPlanId, UpdateCapacityPlanRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PatchWorkforcemanagementBusinessunitCapacityplanRequest request;

		private Builder() {
			request = new PatchWorkforcemanagementBusinessunitCapacityplanRequest();
		}
		...
		public Builder withBody(UpdateCapacityPlanRequest body) {
		...
		public Builder withRequiredParams(String businessUnitId, String capacityPlanId, UpdateCapacityPlanRequest body) {
			request.setBusinessUnitId(businessUnitId);
			request.setCapacityPlanId(capacityPlanId);
			request.setBody(body);
		...
		public PatchWorkforcemanagementBusinessunitCapacityplanRequest build() {
