...
public class GetAnalyticsSummariesAggregatesJobRequest {
	...
	public GetAnalyticsSummariesAggregatesJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetAnalyticsSummariesAggregatesJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetAnalyticsSummariesAggregatesJobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/analytics/summaries/aggregates/jobs/{jobId}")
	...
	public static class Builder {
		private final GetAnalyticsSummariesAggregatesJobRequest request;

		private Builder() {
			request = new GetAnalyticsSummariesAggregatesJobRequest();
		}
		...
		public GetAnalyticsSummariesAggregatesJobRequest build() {
