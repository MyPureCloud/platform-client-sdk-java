...
public class GetConversationsMessageDetailsRequest {
	...
	public GetConversationsMessageDetailsRequest withMessageId(String messageId) {
    ...
    public GetConversationsMessageDetailsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.messageId == null) {
            throw new IllegalStateException("Missing the required parameter 'messageId' when building request for GetConversationsMessageDetailsRequest.");
        }
	...
	public static class Builder {
		private final GetConversationsMessageDetailsRequest request;

		private Builder() {
			request = new GetConversationsMessageDetailsRequest();
		}
		...
		public GetConversationsMessageDetailsRequest build() {
