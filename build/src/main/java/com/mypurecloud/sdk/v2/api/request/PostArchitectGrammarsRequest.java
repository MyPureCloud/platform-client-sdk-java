...
public class PostArchitectGrammarsRequest {
	...
	public PostArchitectGrammarsRequest withBody(Grammar body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostArchitectGrammarsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Grammar> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostArchitectGrammarsRequest.");
        }
	...
	public static Builder builder(Grammar body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostArchitectGrammarsRequest request;

		private Builder() {
			request = new PostArchitectGrammarsRequest();
		}
		...
		public Builder withRequiredParams(Grammar body) {
			request.setBody(body);
		...
		public PostArchitectGrammarsRequest build() {
