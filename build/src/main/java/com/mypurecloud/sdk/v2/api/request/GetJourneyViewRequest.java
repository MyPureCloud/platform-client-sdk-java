...
public class GetJourneyViewRequest {
	...
	public GetJourneyViewRequest withViewId(String viewId) {
    ...
    public GetJourneyViewRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.viewId == null) {
            throw new IllegalStateException("Missing the required parameter 'viewId' when building request for GetJourneyViewRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/journey/views/{viewId}")
	...
	public static class Builder {
		private final GetJourneyViewRequest request;

		private Builder() {
			request = new GetJourneyViewRequest();
		}
		...
		public GetJourneyViewRequest build() {
