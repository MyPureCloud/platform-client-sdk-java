...
public class PostAnalyticsResolutionsAggregatesJobsRequest {

	private ResolutionAsyncAggregationQuery body;
	public ResolutionAsyncAggregationQuery getBody() {
		return this.body;
	}

	public void setBody(ResolutionAsyncAggregationQuery body) {
		this.body = body;
	}

	public PostAnalyticsResolutionsAggregatesJobsRequest withBody(ResolutionAsyncAggregationQuery body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostAnalyticsResolutionsAggregatesJobsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<ResolutionAsyncAggregationQuery> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostAnalyticsResolutionsAggregatesJobsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/analytics/resolutions/aggregates/jobs")
                .withBody(body)
	...
	public static Builder builder(ResolutionAsyncAggregationQuery body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostAnalyticsResolutionsAggregatesJobsRequest request;

		private Builder() {
			request = new PostAnalyticsResolutionsAggregatesJobsRequest();
		}


		public Builder withBody(ResolutionAsyncAggregationQuery body) {
		...
		public Builder withRequiredParams(ResolutionAsyncAggregationQuery body) {
			request.setBody(body);
		...
		public PostAnalyticsResolutionsAggregatesJobsRequest build() {
