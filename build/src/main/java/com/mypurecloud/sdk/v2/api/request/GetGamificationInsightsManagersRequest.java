...
public class GetGamificationInsightsManagersRequest {
	...
	public GetGamificationInsightsManagersRequest withFilterType(String filterType) {
	...
	public GetGamificationInsightsManagersRequest withFilterId(String filterId) {
	...
	public GetGamificationInsightsManagersRequest withGranularity(String granularity) {
	...
	public GetGamificationInsightsManagersRequest withStartWorkday(LocalDate startWorkday) {
	...
	public GetGamificationInsightsManagersRequest withPageSize(Integer pageSize) {
	...
	public GetGamificationInsightsManagersRequest withPageNumber(Integer pageNumber) {
    ...
    public GetGamificationInsightsManagersRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.filterType == null) {
            throw new IllegalStateException("Missing the required parameter 'filterType' when building request for GetGamificationInsightsManagersRequest.");
        }
        
        // verify the required parameter 'filterId' is set
        if (this.filterId == null) {
            throw new IllegalStateException("Missing the required parameter 'filterId' when building request for GetGamificationInsightsManagersRequest.");
        }
        
        // verify the required parameter 'granularity' is set
        if (this.granularity == null) {
            throw new IllegalStateException("Missing the required parameter 'granularity' when building request for GetGamificationInsightsManagersRequest.");
        }
        
        // verify the required parameter 'startWorkday' is set
        if (this.startWorkday == null) {
            throw new IllegalStateException("Missing the required parameter 'startWorkday' when building request for GetGamificationInsightsManagersRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/gamification/insights/managers")
	...
	public static class Builder {
		private final GetGamificationInsightsManagersRequest request;

		private Builder() {
			request = new GetGamificationInsightsManagersRequest();
		}
		...
		public GetGamificationInsightsManagersRequest build() {
