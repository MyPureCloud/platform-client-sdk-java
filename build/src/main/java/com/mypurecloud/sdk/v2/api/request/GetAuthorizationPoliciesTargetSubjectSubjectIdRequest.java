...
public class GetAuthorizationPoliciesTargetSubjectSubjectIdRequest {
	...
	public GetAuthorizationPoliciesTargetSubjectSubjectIdRequest withTargetName(String targetName) {
	...
	public GetAuthorizationPoliciesTargetSubjectSubjectIdRequest withSubjectId(String subjectId) {
    ...
    public GetAuthorizationPoliciesTargetSubjectSubjectIdRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.targetName == null) {
            throw new IllegalStateException("Missing the required parameter 'targetName' when building request for GetAuthorizationPoliciesTargetSubjectSubjectIdRequest.");
        }
        
        // verify the required parameter 'subjectId' is set
        if (this.subjectId == null) {
            throw new IllegalStateException("Missing the required parameter 'subjectId' when building request for GetAuthorizationPoliciesTargetSubjectSubjectIdRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/authorization/policies/targets/{targetName}/subject/{subjectId}")
	...
	public static class Builder {
		private final GetAuthorizationPoliciesTargetSubjectSubjectIdRequest request;

		private Builder() {
			request = new GetAuthorizationPoliciesTargetSubjectSubjectIdRequest();
		}
		...
		public GetAuthorizationPoliciesTargetSubjectSubjectIdRequest build() {
