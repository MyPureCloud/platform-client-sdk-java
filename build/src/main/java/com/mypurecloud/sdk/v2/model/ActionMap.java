...
public class ActionMap  implements Serializable {
  ...
  private Integer estimatedWaitTimeLimit = null;
  ...
  /**
   **/
  public ActionMap name(String name) {
    this.name = name;
    return this;
  }
   ...
   **/
  public ActionMap estimatedWaitTimeLimit(Integer estimatedWaitTimeLimit) {
    this.estimatedWaitTimeLimit = estimatedWaitTimeLimit;
    return this;
  }
  
  @ApiModelProperty(example = "null", value = "The estimated wait time limit above which actions will not be offered.")
  @JsonProperty("estimatedWaitTimeLimit")
  public Integer getEstimatedWaitTimeLimit() {
    return estimatedWaitTimeLimit;
  }
  public void setEstimatedWaitTimeLimit(Integer estimatedWaitTimeLimit) {
    this.estimatedWaitTimeLimit = estimatedWaitTimeLimit;
  }
  ...
  @ApiModelProperty(example = "null", value = "Timestamp indicating when the action map was created. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss.SSSZ")
  ...
  @ApiModelProperty(example = "null", value = "Timestamp indicating when the action map was last updated. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss.SSSZ")
  ...
  @ApiModelProperty(example = "null", value = "Timestamp at which the action map is scheduled to start firing. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss.SSSZ")
  ...
  @ApiModelProperty(example = "null", value = "Timestamp at which the action map is scheduled to stop firing. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss.SSSZ")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, actionMap.id) &&
        Objects.equals(this.name, actionMap.name) &&
        ...
        Objects.equals(this.estimatedWaitTimeLimit, actionMap.estimatedWaitTimeLimit) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, version, isActive, displayName, triggerWithSegments, triggerWithEventConditions, triggerWithOutcomeProbabilityConditions, pageUrlConditions, activation, weight, action, estimatedWaitTimeLimit, selfUri, createdDate, modifiedDate, startDate, endDate);
  }
  ...
  public String toString() {
    ...
    sb.append("    estimatedWaitTimeLimit: ").append(toIndentedString(estimatedWaitTimeLimit)).append("\n");
