...
public class GetSpeechandtextanalyticsTopicsGeneratedphrasesJobRequest {
	...
	public GetSpeechandtextanalyticsTopicsGeneratedphrasesJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetSpeechandtextanalyticsTopicsGeneratedphrasesJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetSpeechandtextanalyticsTopicsGeneratedphrasesJobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/speechandtextanalytics/topics/generatedphrases/jobs/{jobId}")
	...
	public static class Builder {
		private final GetSpeechandtextanalyticsTopicsGeneratedphrasesJobRequest request;

		private Builder() {
			request = new GetSpeechandtextanalyticsTopicsGeneratedphrasesJobRequest();
		}
		...
		public GetSpeechandtextanalyticsTopicsGeneratedphrasesJobRequest build() {
