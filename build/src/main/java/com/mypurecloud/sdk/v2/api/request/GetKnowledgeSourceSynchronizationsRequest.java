...
public class GetKnowledgeSourceSynchronizationsRequest {
	...
	public GetKnowledgeSourceSynchronizationsRequest withSourceId(String sourceId) {
	...
	public GetKnowledgeSourceSynchronizationsRequest withBefore(String before) {
	...
	public GetKnowledgeSourceSynchronizationsRequest withAfter(String after) {
	    this.setAfter(after);
	    return this;
	} 
	...
	public GetKnowledgeSourceSynchronizationsRequest withPageSize(String pageSize) {
    ...
    public GetKnowledgeSourceSynchronizationsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.sourceId == null) {
            throw new IllegalStateException("Missing the required parameter 'sourceId' when building request for GetKnowledgeSourceSynchronizationsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/knowledge/sources/{sourceId}/synchronizations")
	...
	public static class Builder {
		private final GetKnowledgeSourceSynchronizationsRequest request;

		private Builder() {
			request = new GetKnowledgeSourceSynchronizationsRequest();
		}
		...
		public GetKnowledgeSourceSynchronizationsRequest build() {
