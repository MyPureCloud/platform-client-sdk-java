...
public class EventMessage  implements Serializable {
 ...
 @JsonDeserialize(using = CodeEnumDeserializer.class)
  public enum CodeEnum {
    ...
    CAMPAIGN_CHECK_JOB_DUPLICATE("CAMPAIGN_CHECK_JOB_DUPLICATE"),
    ...
    CAMPAIGN_RULE_QUEUE_ACTION_THROTTLED("CAMPAIGN_RULE_QUEUE_ACTION_THROTTLED"),
    CAMPAIGN_RULE_QUEUE_NOT_FOUND("CAMPAIGN_RULE_QUEUE_NOT_FOUND"),
    ...
    IMPORT_INVALID_RETENTION_TYPE("IMPORT_INVALID_RETENTION_TYPE"),
    IMPORT_INVALID_RETENTION_DAYS_MUST_BE_SET("IMPORT_INVALID_RETENTION_DAYS_MUST_BE_SET"),
    IMPORT_INVALID_RETENTION_DAYS_MUST_NOT_BE_SET("IMPORT_INVALID_RETENTION_DAYS_MUST_NOT_BE_SET"),
    IMPORT_INVALID_RETENTION_DAYS_MUST_BE_POSITIVE("IMPORT_INVALID_RETENTION_DAYS_MUST_BE_POSITIVE"),
    IMPORT_INVALID_RETENTION_DAYS_EXCEEDS_LIMIT("IMPORT_INVALID_RETENTION_DAYS_EXCEEDS_LIMIT"),
    IMPORT_INVALID_RETENTION_EXPIRATION_DATE_MUST_BE_SET("IMPORT_INVALID_RETENTION_EXPIRATION_DATE_MUST_BE_SET"),
    IMPORT_INVALID_RETENTION_EXPIRATION_DATE_MUST_NOT_BE_SET("IMPORT_INVALID_RETENTION_EXPIRATION_DATE_MUST_NOT_BE_SET"),
    IMPORT_INVALID_RETENTION_EXPIRATION_DATE_INVALID_FORMAT("IMPORT_INVALID_RETENTION_EXPIRATION_DATE_INVALID_FORMAT"),
    IMPORT_INVALID_RETENTION_EXPIRATION_DATE_NO_SECONDS("IMPORT_INVALID_RETENTION_EXPIRATION_DATE_NO_SECONDS"),
    IMPORT_INVALID_RETENTION_EXPIRATION_DATE_EXCEEDS_LIMIT("IMPORT_INVALID_RETENTION_EXPIRATION_DATE_EXCEEDS_LIMIT"),
    IMPORT_INVALID_RETENTION_MISSING_TYPE("IMPORT_INVALID_RETENTION_MISSING_TYPE"),
    IMPORT_INVALID_RETENTION_MISSING_PREFERRED_TIMEZONE("IMPORT_INVALID_RETENTION_MISSING_PREFERRED_TIMEZONE"),
    IMPORT_INVALID_RETENTION_EXPIRATION_IN_PAST("IMPORT_INVALID_RETENTION_EXPIRATION_IN_PAST"),
    IMPORT_CONTACT_LIST_NAME_LENGTH_EXCEEDED("IMPORT_CONTACT_LIST_NAME_LENGTH_EXCEEDED"),
    FAILED_TO_DELETE_CONTACT_LIST("FAILED_TO_DELETE_CONTACT_LIST"),
    RESOURCE_NOT_FOUND("RESOURCE_NOT_FOUND"),
    INVALID_CONTACT_UPDATE("INVALID_CONTACT_UPDATE"),
