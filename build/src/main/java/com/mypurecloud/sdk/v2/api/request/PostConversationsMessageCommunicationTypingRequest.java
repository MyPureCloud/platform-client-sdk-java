...
public class PostConversationsMessageCommunicationTypingRequest {
    ...
    public ApiRequest<MessageTypingEventRequest> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("POST", "/api/v2/conversations/messages/{conversationId}/communications/{communicationId}/typing")
	...
	public static class Builder {
		private final PostConversationsMessageCommunicationTypingRequest request;

		private Builder() {
			request = new PostConversationsMessageCommunicationTypingRequest();
		}
