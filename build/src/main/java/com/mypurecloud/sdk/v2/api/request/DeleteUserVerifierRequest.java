...
public class DeleteUserVerifierRequest {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("DELETE", "/api/v2/users/{userId}/verifiers/{verifierId}")
	...
	public static Builder builder(String userId, String verifierId) {
	    return new Builder()
	            .withRequiredParams(userId, verifierId);
	}


	public static class Builder {
		private final DeleteUserVerifierRequest request;

		private Builder() {
			request = new DeleteUserVerifierRequest();
		}
