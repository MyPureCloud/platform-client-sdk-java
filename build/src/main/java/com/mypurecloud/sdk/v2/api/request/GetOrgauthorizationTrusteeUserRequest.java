...
public class GetOrgauthorizationTrusteeUserRequest {
	...
	public GetOrgauthorizationTrusteeUserRequest withTrusteeOrgId(String trusteeOrgId) {
	...
	public GetOrgauthorizationTrusteeUserRequest withTrusteeUserId(String trusteeUserId) {
    ...
    public GetOrgauthorizationTrusteeUserRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.trusteeOrgId == null) {
            throw new IllegalStateException("Missing the required parameter 'trusteeOrgId' when building request for GetOrgauthorizationTrusteeUserRequest.");
        }
        
        // verify the required parameter 'trusteeUserId' is set
        if (this.trusteeUserId == null) {
            throw new IllegalStateException("Missing the required parameter 'trusteeUserId' when building request for GetOrgauthorizationTrusteeUserRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/orgauthorization/trustees/{trusteeOrgId}/users/{trusteeUserId}")
	...
	public static class Builder {
		private final GetOrgauthorizationTrusteeUserRequest request;

		private Builder() {
			request = new GetOrgauthorizationTrusteeUserRequest();
		}
		...
		public GetOrgauthorizationTrusteeUserRequest build() {
