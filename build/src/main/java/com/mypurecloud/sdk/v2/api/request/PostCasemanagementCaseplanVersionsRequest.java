...
public class PostCasemanagementCaseplanVersionsRequest {
	...
	public PostCasemanagementCaseplanVersionsRequest withCaseplanId(String caseplanId) {
    ...
    public PostCasemanagementCaseplanVersionsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.caseplanId == null) {
            throw new IllegalStateException("Missing the required parameter 'caseplanId' when building request for PostCasemanagementCaseplanVersionsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/casemanagement/caseplans/{caseplanId}/versions")
	...
	public static class Builder {
		private final PostCasemanagementCaseplanVersionsRequest request;

		private Builder() {
			request = new PostCasemanagementCaseplanVersionsRequest();
		}
		...
		public PostCasemanagementCaseplanVersionsRequest build() {
