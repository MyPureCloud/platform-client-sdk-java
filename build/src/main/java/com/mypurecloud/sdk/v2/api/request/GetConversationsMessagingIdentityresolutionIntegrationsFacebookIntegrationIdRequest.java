...
public class GetConversationsMessagingIdentityresolutionIntegrationsFacebookIntegrationIdRequest {
	...
	public GetConversationsMessagingIdentityresolutionIntegrationsFacebookIntegrationIdRequest withIntegrationId(String integrationId) {
    ...
    public GetConversationsMessagingIdentityresolutionIntegrationsFacebookIntegrationIdRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.integrationId == null) {
            throw new IllegalStateException("Missing the required parameter 'integrationId' when building request for GetConversationsMessagingIdentityresolutionIntegrationsFacebookIntegrationIdRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/conversations/messaging/identityresolution/integrations/facebook/{integrationId}")
	...
	public static class Builder {
		private final GetConversationsMessagingIdentityresolutionIntegrationsFacebookIntegrationIdRequest request;

		private Builder() {
			request = new GetConversationsMessagingIdentityresolutionIntegrationsFacebookIntegrationIdRequest();
		}
		...
		public GetConversationsMessagingIdentityresolutionIntegrationsFacebookIntegrationIdRequest build() {
