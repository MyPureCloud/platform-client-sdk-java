...
public class GetIntegrationsActionFunctionRequest {
	...
	public GetIntegrationsActionFunctionRequest withActionId(String actionId) {
    ...
    public GetIntegrationsActionFunctionRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.actionId == null) {
            throw new IllegalStateException("Missing the required parameter 'actionId' when building request for GetIntegrationsActionFunctionRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/integrations/actions/{actionId}/function")
	...
	public static class Builder {
		private final GetIntegrationsActionFunctionRequest request;

		private Builder() {
			request = new GetIntegrationsActionFunctionRequest();
		}
		...
		public GetIntegrationsActionFunctionRequest build() {
