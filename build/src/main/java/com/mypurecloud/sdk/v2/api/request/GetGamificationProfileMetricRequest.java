...
public class GetGamificationProfileMetricRequest {
	...
	public GetGamificationProfileMetricRequest withProfileId(String profileId) {
	...
	public GetGamificationProfileMetricRequest withMetricId(String metricId) {
	...
	public GetGamificationProfileMetricRequest withWorkday(LocalDate workday) {
    ...
    public GetGamificationProfileMetricRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.profileId == null) {
            throw new IllegalStateException("Missing the required parameter 'profileId' when building request for GetGamificationProfileMetricRequest.");
        }
        
        // verify the required parameter 'metricId' is set
        if (this.metricId == null) {
            throw new IllegalStateException("Missing the required parameter 'metricId' when building request for GetGamificationProfileMetricRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/gamification/profiles/{profileId}/metrics/{metricId}")
	...
	public static Builder builder(String profileId, String metricId) {
	    return new Builder()
	            .withRequiredParams(profileId, metricId);
	}
	

	public static class Builder {
		private final GetGamificationProfileMetricRequest request;

		private Builder() {
			request = new GetGamificationProfileMetricRequest();
		}
		...
		public Builder withRequiredParams(String profileId, String metricId) {
			request.setProfileId(profileId);
						request.setMetricId(metricId);
		...
		public GetGamificationProfileMetricRequest build() {
