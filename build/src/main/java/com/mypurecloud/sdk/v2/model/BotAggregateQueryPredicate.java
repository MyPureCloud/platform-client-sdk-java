...
public class BotAggregateQueryPredicate  implements Serializable {
 ...
 @JsonDeserialize(using = OperatorEnumDeserializer.class)
  ...
  public BotAggregateQueryPredicate() {
   ...
   * Optional type, can usually be inferred
   **/
  public BotAggregateQueryPredicate type(TypeEnum type) {
    this.type = type;
    return this;
  }
   ...
   * Left hand side for dimension predicates
   **/
  public BotAggregateQueryPredicate dimension(DimensionEnum dimension) {
   ...
   * Optional operator, default is matches
   **/
  public BotAggregateQueryPredicate operator(OperatorEnum operator) {
   ...
   **/
  public BotAggregateQueryPredicate value(String value) {
    this.value = value;
    return this;
  }
   ...
   * Right hand side for dimension predicates
   **/
  public BotAggregateQueryPredicate range(NumericRange range) {
    this.range = range;
    return this;
  }
