...
public class PostConversationsMessagingIntegrationsWhatsappEmbeddedsignupRequest {

	private WhatsAppEmbeddedSignupIntegrationRequest body;
	public WhatsAppEmbeddedSignupIntegrationRequest getBody() {
		return this.body;
	}

	public void setBody(WhatsAppEmbeddedSignupIntegrationRequest body) {
		this.body = body;
	}

	public PostConversationsMessagingIntegrationsWhatsappEmbeddedsignupRequest withBody(WhatsAppEmbeddedSignupIntegrationRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostConversationsMessagingIntegrationsWhatsappEmbeddedsignupRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<WhatsAppEmbeddedSignupIntegrationRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostConversationsMessagingIntegrationsWhatsappEmbeddedsignupRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/conversations/messaging/integrations/whatsapp/embeddedsignup")
                .withBody(body)
	...
	public static Builder builder(WhatsAppEmbeddedSignupIntegrationRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostConversationsMessagingIntegrationsWhatsappEmbeddedsignupRequest request;

		private Builder() {
			request = new PostConversationsMessagingIntegrationsWhatsappEmbeddedsignupRequest();
		}


		public Builder withBody(WhatsAppEmbeddedSignupIntegrationRequest body) {
		...
		public Builder withRequiredParams(WhatsAppEmbeddedSignupIntegrationRequest body) {
			request.setBody(body);
		...
		public PostConversationsMessagingIntegrationsWhatsappEmbeddedsignupRequest build() {
