...
public class PatchChatsUserSettingsRequest {
    ...
    public ApiRequest<ChatUserSettings> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("PATCH", "/api/v2/chats/users/{userId}/settings")
	...
	public static class Builder {
		private final PatchChatsUserSettingsRequest request;

		private Builder() {
			request = new PatchChatsUserSettingsRequest();
		}
