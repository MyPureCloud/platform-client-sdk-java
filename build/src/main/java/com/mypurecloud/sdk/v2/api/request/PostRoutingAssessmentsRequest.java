...
public class PostRoutingAssessmentsRequest {
    
	private CreateBenefitAssessmentRequest body;
	public CreateBenefitAssessmentRequest getBody() {
		return this.body;
	}

	public void setBody(CreateBenefitAssessmentRequest body) {
		this.body = body;
	}

	public PostRoutingAssessmentsRequest withBody(CreateBenefitAssessmentRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostRoutingAssessmentsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<CreateBenefitAssessmentRequest> withHttpInfo() {
        

        return ApiRequestBuilder.create("POST", "/api/v2/routing/assessments")
                .withBody(body)
	...
	public static class Builder {
		private final PostRoutingAssessmentsRequest request;

		private Builder() {
			request = new PostRoutingAssessmentsRequest();
		}

		
		public Builder withBody(CreateBenefitAssessmentRequest body) {
		...
		public PostRoutingAssessmentsRequest build() {
