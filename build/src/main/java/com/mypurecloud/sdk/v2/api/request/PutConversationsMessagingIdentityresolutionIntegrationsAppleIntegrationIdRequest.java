...
public class PutConversationsMessagingIdentityresolutionIntegrationsAppleIntegrationIdRequest {
	...
	public PutConversationsMessagingIdentityresolutionIntegrationsAppleIntegrationIdRequest withIntegrationId(String integrationId) {
    ...
    public PutConversationsMessagingIdentityresolutionIntegrationsAppleIntegrationIdRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<AppleIdentityResolutionConfig> withHttpInfo() {
        ...
        if (this.integrationId == null) {
            throw new IllegalStateException("Missing the required parameter 'integrationId' when building request for PutConversationsMessagingIdentityresolutionIntegrationsAppleIntegrationIdRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutConversationsMessagingIdentityresolutionIntegrationsAppleIntegrationIdRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/conversations/messaging/identityresolution/integrations/apple/{integrationId}")
	...
	public static class Builder {
		private final PutConversationsMessagingIdentityresolutionIntegrationsAppleIntegrationIdRequest request;

		private Builder() {
			request = new PutConversationsMessagingIdentityresolutionIntegrationsAppleIntegrationIdRequest();
		}
		...
		public PutConversationsMessagingIdentityresolutionIntegrationsAppleIntegrationIdRequest build() {
