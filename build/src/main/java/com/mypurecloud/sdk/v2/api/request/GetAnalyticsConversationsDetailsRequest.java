...
public class GetAnalyticsConversationsDetailsRequest {
	...
	public GetAnalyticsConversationsDetailsRequest withId(List<String> id) {
	    this.setId(id);
	    return this;
	} 
    ...
    public GetAnalyticsConversationsDetailsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/analytics/conversations/details")
	...
	public static class Builder {
		private final GetAnalyticsConversationsDetailsRequest request;

		private Builder() {
			request = new GetAnalyticsConversationsDetailsRequest();
		}
		...
		public GetAnalyticsConversationsDetailsRequest build() {
