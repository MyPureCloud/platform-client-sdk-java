...
public class PatchConversationSummaryEngagementsRequest {
	...
	public PatchConversationSummaryEngagementsRequest withConversationId(String conversationId) {
	...
	public PatchConversationSummaryEngagementsRequest withSummaryId(String summaryId) {
	    this.setSummaryId(summaryId);
	    return this;
	} 

	private EngagementRequest body;
	public EngagementRequest getBody() {
		return this.body;
	}

	public void setBody(EngagementRequest body) {
		this.body = body;
	}

	public PatchConversationSummaryEngagementsRequest withBody(EngagementRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchConversationSummaryEngagementsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<EngagementRequest> withHttpInfo() {
        
        // verify the required parameter 'conversationId' is set
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PatchConversationSummaryEngagementsRequest.");
        }
        
        // verify the required parameter 'summaryId' is set
        if (this.summaryId == null) {
            throw new IllegalStateException("Missing the required parameter 'summaryId' when building request for PatchConversationSummaryEngagementsRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/conversations/{conversationId}/summaries/{summaryId}/engagements")
                .withPathParameter("conversationId", conversationId)
        
                .withPathParameter("summaryId", summaryId)
	...
	public static Builder builder(String conversationId, String summaryId) {
	    return new Builder()
	            .withRequiredParams(conversationId, summaryId);
	}


	public static class Builder {
		private final PatchConversationSummaryEngagementsRequest request;

		private Builder() {
			request = new PatchConversationSummaryEngagementsRequest();
		}
		...
		public Builder withBody(EngagementRequest body) {
		...
		public PatchConversationSummaryEngagementsRequest build() {
