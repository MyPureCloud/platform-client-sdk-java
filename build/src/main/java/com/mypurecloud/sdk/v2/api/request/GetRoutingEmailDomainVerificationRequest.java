...
public class GetRoutingEmailDomainVerificationRequest {
	...
	public GetRoutingEmailDomainVerificationRequest withDomainId(String domainId) {
    ...
    public GetRoutingEmailDomainVerificationRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.domainId == null) {
            throw new IllegalStateException("Missing the required parameter 'domainId' when building request for GetRoutingEmailDomainVerificationRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/routing/email/domains/{domainId}/verification")
	...
	public static class Builder {
		private final GetRoutingEmailDomainVerificationRequest request;

		private Builder() {
			request = new GetRoutingEmailDomainVerificationRequest();
		}
		...
		public GetRoutingEmailDomainVerificationRequest build() {
