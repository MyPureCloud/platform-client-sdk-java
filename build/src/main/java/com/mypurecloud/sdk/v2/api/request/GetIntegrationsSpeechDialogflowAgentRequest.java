...
public class GetIntegrationsSpeechDialogflowAgentRequest {
	...
	public GetIntegrationsSpeechDialogflowAgentRequest withAgentId(String agentId) {
    ...
    public GetIntegrationsSpeechDialogflowAgentRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.agentId == null) {
            throw new IllegalStateException("Missing the required parameter 'agentId' when building request for GetIntegrationsSpeechDialogflowAgentRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/integrations/speech/dialogflow/agents/{agentId}")
	...
	public static class Builder {
		private final GetIntegrationsSpeechDialogflowAgentRequest request;

		private Builder() {
			request = new GetIntegrationsSpeechDialogflowAgentRequest();
		}
		...
		public GetIntegrationsSpeechDialogflowAgentRequest build() {
