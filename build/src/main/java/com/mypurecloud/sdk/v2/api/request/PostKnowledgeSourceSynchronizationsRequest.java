...
public class PostKnowledgeSourceSynchronizationsRequest {
	...
	public PostKnowledgeSourceSynchronizationsRequest withSourceId(String sourceId) {
	    this.setSourceId(sourceId);
	    return this;
	} 

	private V3StartManualSyncRequest body;
	public V3StartManualSyncRequest getBody() {
		return this.body;
	}

	public void setBody(V3StartManualSyncRequest body) {
		this.body = body;
	}

	public PostKnowledgeSourceSynchronizationsRequest withBody(V3StartManualSyncRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostKnowledgeSourceSynchronizationsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<V3StartManualSyncRequest> withHttpInfo() {
        
        // verify the required parameter 'sourceId' is set
        if (this.sourceId == null) {
            throw new IllegalStateException("Missing the required parameter 'sourceId' when building request for PostKnowledgeSourceSynchronizationsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/knowledge/sources/{sourceId}/synchronizations")
	...
	public static class Builder {
		private final PostKnowledgeSourceSynchronizationsRequest request;

		private Builder() {
			request = new PostKnowledgeSourceSynchronizationsRequest();
		}
		...
		public Builder withBody(V3StartManualSyncRequest body) {
		...
		public PostKnowledgeSourceSynchronizationsRequest build() {
