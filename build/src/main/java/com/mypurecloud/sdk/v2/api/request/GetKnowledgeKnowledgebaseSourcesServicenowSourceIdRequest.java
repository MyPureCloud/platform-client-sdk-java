...
public class GetKnowledgeKnowledgebaseSourcesServicenowSourceIdRequest {
	...
	public GetKnowledgeKnowledgebaseSourcesServicenowSourceIdRequest withKnowledgeBaseId(String knowledgeBaseId) {
	...
	public GetKnowledgeKnowledgebaseSourcesServicenowSourceIdRequest withSourceId(String sourceId) {
	...
	public GetKnowledgeKnowledgebaseSourcesServicenowSourceIdRequest withExpand(List<String> expand) {
    ...
    public GetKnowledgeKnowledgebaseSourcesServicenowSourceIdRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.knowledgeBaseId == null) {
            throw new IllegalStateException("Missing the required parameter 'knowledgeBaseId' when building request for GetKnowledgeKnowledgebaseSourcesServicenowSourceIdRequest.");
        }
        
        // verify the required parameter 'sourceId' is set
        if (this.sourceId == null) {
            throw new IllegalStateException("Missing the required parameter 'sourceId' when building request for GetKnowledgeKnowledgebaseSourcesServicenowSourceIdRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/sources/servicenow/{sourceId}")
	...
	public static class Builder {
		private final GetKnowledgeKnowledgebaseSourcesServicenowSourceIdRequest request;

		private Builder() {
			request = new GetKnowledgeKnowledgebaseSourcesServicenowSourceIdRequest();
		}
		...
		public GetKnowledgeKnowledgebaseSourcesServicenowSourceIdRequest build() {
