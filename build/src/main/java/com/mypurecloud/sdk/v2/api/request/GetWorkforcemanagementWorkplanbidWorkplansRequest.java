...
public class GetWorkforcemanagementWorkplanbidWorkplansRequest {
	...
	public GetWorkforcemanagementWorkplanbidWorkplansRequest withBidId(String bidId) {
	    this.setBidId(bidId);
	    return this;
	} 
    ...
    public GetWorkforcemanagementWorkplanbidWorkplansRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.bidId == null) {
            throw new IllegalStateException("Missing the required parameter 'bidId' when building request for GetWorkforcemanagementWorkplanbidWorkplansRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/workplanbids/{bidId}/workplans")
	...
	public static class Builder {
		private final GetWorkforcemanagementWorkplanbidWorkplansRequest request;

		private Builder() {
			request = new GetWorkforcemanagementWorkplanbidWorkplansRequest();
		}
		...
		public GetWorkforcemanagementWorkplanbidWorkplansRequest build() {
