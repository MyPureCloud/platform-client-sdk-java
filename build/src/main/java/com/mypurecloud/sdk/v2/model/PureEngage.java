...
public class PureEngage  implements Serializable {
 ...
 @JsonDeserialize(using = SsoBindingEnumDeserializer.class)
  ...
  /**
   **/
  public PureEngage logoImageData(String logoImageData) {
  ...
  /**
   **/
  public PureEngage nameIdentifierFormat(NameIdentifierFormatEnum nameIdentifierFormat) {
  ...
  /**
   **/
  public PureEngage ssoBinding(SsoBindingEnum ssoBinding) {
  ...
  /**
   **/
  public PureEngage signAuthnRequests(Boolean signAuthnRequests) {
  ...
  /**
   **/
  public PureEngage providerName(String providerName) {
  ...
  /**
   **/
  public PureEngage displayOnLogin(Boolean displayOnLogin) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, pureEngage.id) &&
            ...
            Objects.equals(this.logoImageData, pureEngage.logoImageData) &&
            Objects.equals(this.nameIdentifierFormat, pureEngage.nameIdentifierFormat) &&
            Objects.equals(this.ssoBinding, pureEngage.ssoBinding) &&
            Objects.equals(this.signAuthnRequests, pureEngage.signAuthnRequests) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, disabled, issuerURI, ssoTargetURI, sloURI, sloBinding, relyingPartyIdentifier, certificate, certificates, logoImageData, nameIdentifierFormat, ssoBinding, signAuthnRequests, providerName, displayOnLogin, autoProvisionUsers, selfUri);
  }
