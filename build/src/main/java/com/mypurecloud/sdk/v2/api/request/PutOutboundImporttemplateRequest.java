...
public class PutOutboundImporttemplateRequest {
	...
	public PutOutboundImporttemplateRequest withImportTemplateId(String importTemplateId) {
	...
	public PutOutboundImporttemplateRequest withBody(ImportTemplate body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutOutboundImporttemplateRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<ImportTemplate> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("PUT", "/api/v2/outbound/importtemplates/{importTemplateId}")
	...
	public static Builder builder(String importTemplateId, ImportTemplate body) {
	    return new Builder()
	            .withRequiredParams(importTemplateId, body);
	}
	...
	public static class Builder {
		...
		private Builder() {
			request = new PutOutboundImporttemplateRequest();
		}
		...
		public Builder withRequiredParams(String importTemplateId, ImportTemplate body) {
			request.setImportTemplateId(importTemplateId);
			request.setBody(body);
