...
public class GetFlowsDatatableExportJobRequest {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/flows/datatables/{datatableId}/export/jobs/{exportJobId}")
	...
	public static Builder builder(String datatableId, String exportJobId) {
	    return new Builder()
	            .withRequiredParams(datatableId, exportJobId);
	}
	

	public static class Builder {
		private final GetFlowsDatatableExportJobRequest request;

		private Builder() {
			request = new GetFlowsDatatableExportJobRequest();
		}
