...
public class DeleteTelephonyProvidersEdgeLogicalinterfaceRequest {
	...
	public DeleteTelephonyProvidersEdgeLogicalinterfaceRequest withEdgeId(String edgeId) {
	...
	public DeleteTelephonyProvidersEdgeLogicalinterfaceRequest withInterfaceId(String interfaceId) {
    ...
    public DeleteTelephonyProvidersEdgeLogicalinterfaceRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("DELETE", "/api/v2/telephony/providers/edges/{edgeId}/logicalinterfaces/{interfaceId}")
