...
public class GetConversationsMessageCommunicationMessagesMediaMediaIdRequest {
	...
	public GetConversationsMessageCommunicationMessagesMediaMediaIdRequest withConversationId(String conversationId) {
	...
	public GetConversationsMessageCommunicationMessagesMediaMediaIdRequest withCommunicationId(String communicationId) {
	...
	public GetConversationsMessageCommunicationMessagesMediaMediaIdRequest withMediaId(String mediaId) {
    ...
    public GetConversationsMessageCommunicationMessagesMediaMediaIdRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for GetConversationsMessageCommunicationMessagesMediaMediaIdRequest.");
        }
        
        // verify the required parameter 'communicationId' is set
        if (this.communicationId == null) {
            throw new IllegalStateException("Missing the required parameter 'communicationId' when building request for GetConversationsMessageCommunicationMessagesMediaMediaIdRequest.");
        }
        
        // verify the required parameter 'mediaId' is set
        if (this.mediaId == null) {
            throw new IllegalStateException("Missing the required parameter 'mediaId' when building request for GetConversationsMessageCommunicationMessagesMediaMediaIdRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/conversations/messages/{conversationId}/communications/{communicationId}/messages/media/{mediaId}")
                .withPathParameter("conversationId", conversationId)
        
                .withPathParameter("communicationId", communicationId)
        
                .withPathParameter("mediaId", mediaId)
	...
	public static Builder builder(String conversationId, String communicationId, String mediaId) {
	    return new Builder()
	            .withRequiredParams(conversationId, communicationId, mediaId);
	}
	

	public static class Builder {
		private final GetConversationsMessageCommunicationMessagesMediaMediaIdRequest request;

		private Builder() {
			request = new GetConversationsMessageCommunicationMessagesMediaMediaIdRequest();
		}
		...
		public Builder withRequiredParams(String conversationId, String communicationId, String mediaId) {
			request.setConversationId(conversationId);
						request.setCommunicationId(communicationId);
						request.setMediaId(mediaId);
		...
		public GetConversationsMessageCommunicationMessagesMediaMediaIdRequest build() {
