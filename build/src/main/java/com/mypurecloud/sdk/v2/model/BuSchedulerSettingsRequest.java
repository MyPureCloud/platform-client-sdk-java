...
public class BuSchedulerSettingsRequest  implements Serializable {
   ...
   **/
  public BuSchedulerSettingsRequest consistentServiceLevelSmoothing(Boolean consistentServiceLevelSmoothing) {
    this.consistentServiceLevelSmoothing = consistentServiceLevelSmoothing;
    return this;
  }
  
  @ApiModelProperty(example = "null", value = "Indicates whether to provide consistent service level smoothing in schedule generation for this business unit")
   ...
   **/
  public BuSchedulerSettingsRequest metadata(WfmVersionedEntityMetadata metadata) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    BuSchedulerSettingsRequest buSchedulerSettingsRequest = (BuSchedulerSettingsRequest) o;

    return Objects.equals(this.consistentServiceLevelSmoothing, buSchedulerSettingsRequest.consistentServiceLevelSmoothing) &&
            Objects.equals(this.metadata, buSchedulerSettingsRequest.metadata);
  }
  ...
  public String toString() {
    ...
    sb.append("class BuSchedulerSettingsRequest {\n");
