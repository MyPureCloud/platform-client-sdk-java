...
public class GetKnowledgeKnowledgebaseParseJobRequest {
	...
	public GetKnowledgeKnowledgebaseParseJobRequest withKnowledgeBaseId(String knowledgeBaseId) {
	...
	public GetKnowledgeKnowledgebaseParseJobRequest withParseJobId(String parseJobId) {
	...
	public GetKnowledgeKnowledgebaseParseJobRequest withExpand(List<String> expand) {
    ...
    public GetKnowledgeKnowledgebaseParseJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.knowledgeBaseId == null) {
            throw new IllegalStateException("Missing the required parameter 'knowledgeBaseId' when building request for GetKnowledgeKnowledgebaseParseJobRequest.");
        }
        
        // verify the required parameter 'parseJobId' is set
        if (this.parseJobId == null) {
            throw new IllegalStateException("Missing the required parameter 'parseJobId' when building request for GetKnowledgeKnowledgebaseParseJobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/parse/jobs/{parseJobId}")
	...
	public static Builder builder(String knowledgeBaseId, String parseJobId) {
	    return new Builder()
	            .withRequiredParams(knowledgeBaseId, parseJobId);
	}


	public static class Builder {
		private final GetKnowledgeKnowledgebaseParseJobRequest request;

		private Builder() {
			request = new GetKnowledgeKnowledgebaseParseJobRequest();
		}
		...
		public Builder withRequiredParams(String knowledgeBaseId, String parseJobId) {
			request.setKnowledgeBaseId(knowledgeBaseId);
			request.setParseJobId(parseJobId);
		...
		public GetKnowledgeKnowledgebaseParseJobRequest build() {
