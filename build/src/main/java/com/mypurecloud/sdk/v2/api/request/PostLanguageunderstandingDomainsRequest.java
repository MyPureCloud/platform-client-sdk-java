...
public class PostLanguageunderstandingDomainsRequest {
	...
	public PostLanguageunderstandingDomainsRequest withBody(NluDomain body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostLanguageunderstandingDomainsRequest withCustomHeader(String name, String value) {
	...
	public static class Builder {
		private final PostLanguageunderstandingDomainsRequest request;

		private Builder() {
			request = new PostLanguageunderstandingDomainsRequest();
		}
