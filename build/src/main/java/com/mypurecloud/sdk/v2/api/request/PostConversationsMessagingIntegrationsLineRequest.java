...
public class PostConversationsMessagingIntegrationsLineRequest {
	...
	public PostConversationsMessagingIntegrationsLineRequest withBody(LineIntegrationRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostConversationsMessagingIntegrationsLineRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<LineIntegrationRequest> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostConversationsMessagingIntegrationsLineRequest.");
        }
	...
	public static class Builder {
		private final PostConversationsMessagingIntegrationsLineRequest request;

		private Builder() {
			request = new PostConversationsMessagingIntegrationsLineRequest();
		}
		...
		public PostConversationsMessagingIntegrationsLineRequest build() {
