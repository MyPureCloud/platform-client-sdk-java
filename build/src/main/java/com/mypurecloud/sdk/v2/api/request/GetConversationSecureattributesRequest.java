...
public class GetConversationSecureattributesRequest {
	...
	public GetConversationSecureattributesRequest withConversationId(String conversationId) {
    ...
    public GetConversationSecureattributesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for GetConversationSecureattributesRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/conversations/{conversationId}/secureattributes")
	...
	public static class Builder {
		private final GetConversationSecureattributesRequest request;

		private Builder() {
			request = new GetConversationSecureattributesRequest();
		}
		...
		public GetConversationSecureattributesRequest build() {
