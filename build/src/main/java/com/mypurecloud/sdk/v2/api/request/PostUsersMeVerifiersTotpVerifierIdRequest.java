...
public class PostUsersMeVerifiersTotpVerifierIdRequest {
	...
	public PostUsersMeVerifiersTotpVerifierIdRequest withVerifierId(String verifierId) {
	    this.setVerifierId(verifierId);
	    return this;
	} 

	private ValidateVerifierRequest body;
	public ValidateVerifierRequest getBody() {
		return this.body;
	}

	public void setBody(ValidateVerifierRequest body) {
		this.body = body;
	}

	public PostUsersMeVerifiersTotpVerifierIdRequest withBody(ValidateVerifierRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostUsersMeVerifiersTotpVerifierIdRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<ValidateVerifierRequest> withHttpInfo() {
        
        // verify the required parameter 'verifierId' is set
        if (this.verifierId == null) {
            throw new IllegalStateException("Missing the required parameter 'verifierId' when building request for PostUsersMeVerifiersTotpVerifierIdRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostUsersMeVerifiersTotpVerifierIdRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/users/me/verifiers/totp/{verifierId}")
	...
	public static Builder builder(String verifierId, ValidateVerifierRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostUsersMeVerifiersTotpVerifierIdRequest request;

		private Builder() {
			request = new PostUsersMeVerifiersTotpVerifierIdRequest();
		}
		...
		public Builder withBody(ValidateVerifierRequest body) {
		...
		public Builder withRequiredParams(String verifierId, ValidateVerifierRequest body) {
			request.setVerifierId(verifierId);
			request.setBody(body);
		...
		public PostUsersMeVerifiersTotpVerifierIdRequest build() {
