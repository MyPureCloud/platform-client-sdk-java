...
public class GetArchitectGrammarRequest {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/architect/grammars/{grammarId}")
	...
	public static class Builder {
		private final GetArchitectGrammarRequest request;

		private Builder() {
			request = new GetArchitectGrammarRequest();
		}
