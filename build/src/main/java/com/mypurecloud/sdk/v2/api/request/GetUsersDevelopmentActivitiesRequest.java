...
public class GetUsersDevelopmentActivitiesRequest {
	...
	public GetUsersDevelopmentActivitiesRequest withUserId(List<String> userId) {
	...
	public GetUsersDevelopmentActivitiesRequest withModuleId(String moduleId) {
	...
	public GetUsersDevelopmentActivitiesRequest withInterval(String interval) {
	...
	public GetUsersDevelopmentActivitiesRequest withCompletionInterval(String completionInterval) {
	...
	public GetUsersDevelopmentActivitiesRequest withOverdue(String overdue) {
	...
	public GetUsersDevelopmentActivitiesRequest withPass(String pass) {
	    this.setPass(pass);
	    return this;
	} 
	...
	public GetUsersDevelopmentActivitiesRequest withPageSize(Integer pageSize) {
	...
	public GetUsersDevelopmentActivitiesRequest withPageNumber(Integer pageNumber) {
	...
	public GetUsersDevelopmentActivitiesRequest withSortOrder(String sortOrder) {
	...
	public GetUsersDevelopmentActivitiesRequest withTypes(List<String> types) {
	    this.setTypes(types);
	    return this;
	} 
	...
	public GetUsersDevelopmentActivitiesRequest withStatuses(List<String> statuses) {
	...
	public GetUsersDevelopmentActivitiesRequest withRelationship(List<String> relationship) {
    ...
    public GetUsersDevelopmentActivitiesRequest withCustomHeader(String name, String value) {
