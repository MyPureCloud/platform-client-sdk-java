...
public class GetIdentityprovidersPureengageRequest {
    ...
    public GetIdentityprovidersPureengageRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/identityproviders/pureengage")
	...
	public static class Builder {
		private final GetIdentityprovidersPureengageRequest request;

		private Builder() {
			request = new GetIdentityprovidersPureengageRequest();
		}
		...
		public GetIdentityprovidersPureengageRequest build() {
