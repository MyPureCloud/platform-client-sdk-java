...
public class FlowEntityListing  implements Serializable, PagedResource<Flow> {
  
  private List<Flow> entities = new ArrayList<Flow>();
  ...
  /**
   **/
  public FlowEntityListing entities(List<Flow> entities) {
  ...
  public List<Flow> getEntities() {
    return entities;
  }
  public void setEntities(List<Flow> entities) {
    this.entities = entities;
  }
