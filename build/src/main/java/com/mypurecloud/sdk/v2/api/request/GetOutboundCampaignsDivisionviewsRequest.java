...
public class GetOutboundCampaignsDivisionviewsRequest {
	...
	public GetOutboundCampaignsDivisionviewsRequest withPageSize(Integer pageSize) {
	...
	public GetOutboundCampaignsDivisionviewsRequest withPageNumber(Integer pageNumber) {
	...
	public GetOutboundCampaignsDivisionviewsRequest withFilterType(String filterType) {
	...
	public GetOutboundCampaignsDivisionviewsRequest withName(String name) {
	    this.setName(name);
	    return this;
	} 
	...
	public GetOutboundCampaignsDivisionviewsRequest withSortBy(String sortBy) {
	...
	public GetOutboundCampaignsDivisionviewsRequest withSortOrder(String sortOrder) {
    ...
    public GetOutboundCampaignsDivisionviewsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/outbound/campaigns/divisionviews")
	...
	public static class Builder {
		private final GetOutboundCampaignsDivisionviewsRequest request;

		private Builder() {
			request = new GetOutboundCampaignsDivisionviewsRequest();
		}
		...
		public GetOutboundCampaignsDivisionviewsRequest build() {
