...
public class PostWorkforcemanagementShifttradingTradeMatchJobsRequest {
	...
	public PostWorkforcemanagementShifttradingTradeMatchJobsRequest withTradeId(String tradeId) {
	    this.setTradeId(tradeId);
	    return this;
	} 

	private MatchShiftTradeJobRequest body;
	public MatchShiftTradeJobRequest getBody() {
		return this.body;
	}

	public void setBody(MatchShiftTradeJobRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementShifttradingTradeMatchJobsRequest withBody(MatchShiftTradeJobRequest body) {
	    this.setBody(body);
	    return this;
	} 
	...
	public PostWorkforcemanagementShifttradingTradeMatchJobsRequest withForceAsync(Boolean forceAsync) {
    ...
    public PostWorkforcemanagementShifttradingTradeMatchJobsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<MatchShiftTradeJobRequest> withHttpInfo() {
        
        // verify the required parameter 'tradeId' is set
        if (this.tradeId == null) {
            throw new IllegalStateException("Missing the required parameter 'tradeId' when building request for PostWorkforcemanagementShifttradingTradeMatchJobsRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementShifttradingTradeMatchJobsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/shifttrading/trades/{tradeId}/match/jobs")
	...
	public static Builder builder(String tradeId, MatchShiftTradeJobRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementShifttradingTradeMatchJobsRequest request;

		private Builder() {
			request = new PostWorkforcemanagementShifttradingTradeMatchJobsRequest();
		}
		...
		public Builder withBody(MatchShiftTradeJobRequest body) {
		...
		public Builder withRequiredParams(String tradeId, MatchShiftTradeJobRequest body) {
			request.setTradeId(tradeId);
			request.setBody(body);
		...
		public PostWorkforcemanagementShifttradingTradeMatchJobsRequest build() {
