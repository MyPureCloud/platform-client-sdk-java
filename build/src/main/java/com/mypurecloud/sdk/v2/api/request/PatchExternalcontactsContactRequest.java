...
public class PatchExternalcontactsContactRequest {
	...
	public PatchExternalcontactsContactRequest withContactId(String contactId) {
	...
	public PatchExternalcontactsContactRequest withBody(ExternalContactsPatchRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchExternalcontactsContactRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<ExternalContactsPatchRequest> withHttpInfo() {
        ...
        if (this.contactId == null) {
            throw new IllegalStateException("Missing the required parameter 'contactId' when building request for PatchExternalcontactsContactRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchExternalcontactsContactRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/externalcontacts/contacts/{contactId}")
	...
	public static Builder builder(String contactId, ExternalContactsPatchRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PatchExternalcontactsContactRequest request;

		private Builder() {
			request = new PatchExternalcontactsContactRequest();
		}
		...
		public Builder withRequiredParams(String contactId, ExternalContactsPatchRequest body) {
			request.setContactId(contactId);
			request.setBody(body);
		...
		public PatchExternalcontactsContactRequest build() {
