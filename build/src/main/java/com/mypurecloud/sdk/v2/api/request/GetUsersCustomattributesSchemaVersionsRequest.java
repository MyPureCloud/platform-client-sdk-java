...
public class GetUsersCustomattributesSchemaVersionsRequest {
	...
	public GetUsersCustomattributesSchemaVersionsRequest withSchemaId(String schemaId) {
    ...
    public GetUsersCustomattributesSchemaVersionsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.schemaId == null) {
            throw new IllegalStateException("Missing the required parameter 'schemaId' when building request for GetUsersCustomattributesSchemaVersionsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/users/customattributes/schemas/{schemaId}/versions")
	...
	public static class Builder {
		private final GetUsersCustomattributesSchemaVersionsRequest request;

		private Builder() {
			request = new GetUsersCustomattributesSchemaVersionsRequest();
		}
		...
		public GetUsersCustomattributesSchemaVersionsRequest build() {
