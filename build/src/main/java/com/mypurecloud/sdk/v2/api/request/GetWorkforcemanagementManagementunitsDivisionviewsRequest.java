...
public class GetWorkforcemanagementManagementunitsDivisionviewsRequest {
	...
	public GetWorkforcemanagementManagementunitsDivisionviewsRequest withDivisionId(List<String> divisionId) {
    ...
    public GetWorkforcemanagementManagementunitsDivisionviewsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/managementunits/divisionviews")
	...
	public static class Builder {
		private final GetWorkforcemanagementManagementunitsDivisionviewsRequest request;

		private Builder() {
			request = new GetWorkforcemanagementManagementunitsDivisionviewsRequest();
		}
		...
		public GetWorkforcemanagementManagementunitsDivisionviewsRequest build() {
