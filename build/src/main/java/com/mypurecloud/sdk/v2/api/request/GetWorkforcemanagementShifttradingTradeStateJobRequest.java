...
public class GetWorkforcemanagementShifttradingTradeStateJobRequest {
	...
	public GetWorkforcemanagementShifttradingTradeStateJobRequest withTradeId(String tradeId) {
	...
	public GetWorkforcemanagementShifttradingTradeStateJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetWorkforcemanagementShifttradingTradeStateJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.tradeId == null) {
            throw new IllegalStateException("Missing the required parameter 'tradeId' when building request for GetWorkforcemanagementShifttradingTradeStateJobRequest.");
        }
        
        // verify the required parameter 'jobId' is set
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetWorkforcemanagementShifttradingTradeStateJobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/shifttrading/trades/{tradeId}/state/jobs/{jobId}")
	...
	public static class Builder {
		private final GetWorkforcemanagementShifttradingTradeStateJobRequest request;

		private Builder() {
			request = new GetWorkforcemanagementShifttradingTradeStateJobRequest();
		}
		...
		public GetWorkforcemanagementShifttradingTradeStateJobRequest build() {
