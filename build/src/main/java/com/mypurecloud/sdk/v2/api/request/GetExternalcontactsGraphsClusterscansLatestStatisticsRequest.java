...
public class GetExternalcontactsGraphsClusterscansLatestStatisticsRequest {
    ...
    public GetExternalcontactsGraphsClusterscansLatestStatisticsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/externalcontacts/graphs/clusterscans/latest/statistics")
	...
	public static class Builder {
		private final GetExternalcontactsGraphsClusterscansLatestStatisticsRequest request;

		private Builder() {
			request = new GetExternalcontactsGraphsClusterscansLatestStatisticsRequest();
		}
		...
		public GetExternalcontactsGraphsClusterscansLatestStatisticsRequest build() {
