...
public class GetExternalcontactsOrganizationsSchemaVersionsRequest {
	...
	public GetExternalcontactsOrganizationsSchemaVersionsRequest withSchemaId(String schemaId) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.schemaId == null) {
            throw new IllegalStateException("Missing the required parameter 'schemaId' when building request for GetExternalcontactsOrganizationsSchemaVersionsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/externalcontacts/organizations/schemas/{schemaId}/versions")
	...
	public static class Builder {
		private final GetExternalcontactsOrganizationsSchemaVersionsRequest request;

		private Builder() {
			request = new GetExternalcontactsOrganizationsSchemaVersionsRequest();
		}
		...
		public GetExternalcontactsOrganizationsSchemaVersionsRequest build() {
