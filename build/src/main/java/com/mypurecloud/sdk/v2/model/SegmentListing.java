...
public class SegmentListing  implements Serializable, PagedResource<JourneySegment> {
  
  private List<JourneySegment> entities = new ArrayList<JourneySegment>();
  ...
  /**
   **/
  public SegmentListing entities(List<JourneySegment> entities) {
  ...
  public List<JourneySegment> getEntities() {
    return entities;
  }
  public void setEntities(List<JourneySegment> entities) {
    this.entities = entities;
  }
