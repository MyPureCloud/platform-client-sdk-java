...
public class DeleteUsersStationsMeAssociatedstationRequest {
    ...
    public DeleteUsersStationsMeAssociatedstationRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("DELETE", "/api/v2/users/stations/me/associatedstation")
	...
	public static class Builder {
		private final DeleteUsersStationsMeAssociatedstationRequest request;

		private Builder() {
			request = new DeleteUsersStationsMeAssociatedstationRequest();
		}
		...
		public DeleteUsersStationsMeAssociatedstationRequest build() {
