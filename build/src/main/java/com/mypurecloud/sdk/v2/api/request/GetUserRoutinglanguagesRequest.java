...
public class GetUserRoutinglanguagesRequest {
	...
	public GetUserRoutinglanguagesRequest withUserId(String userId) {
	...
	public GetUserRoutinglanguagesRequest withPageSize(Integer pageSize) {
	...
	public GetUserRoutinglanguagesRequest withPageNumber(Integer pageNumber) {
	...
	public GetUserRoutinglanguagesRequest withSortOrder(String sortOrder) {
    ...
    public GetUserRoutinglanguagesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.userId == null) {
            throw new IllegalStateException("Missing the required parameter 'userId' when building request for GetUserRoutinglanguagesRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/users/{userId}/routinglanguages")
	...
	public static class Builder {
		private final GetUserRoutinglanguagesRequest request;

		private Builder() {
			request = new GetUserRoutinglanguagesRequest();
		}
		...
		public GetUserRoutinglanguagesRequest build() {
