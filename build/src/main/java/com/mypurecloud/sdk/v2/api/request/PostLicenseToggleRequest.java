...
public class PostLicenseToggleRequest {
	...
	public PostLicenseToggleRequest withFeatureName(String featureName) {
    ...
    public PostLicenseToggleRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.featureName == null) {
            throw new IllegalStateException("Missing the required parameter 'featureName' when building request for PostLicenseToggleRequest.");
        }
