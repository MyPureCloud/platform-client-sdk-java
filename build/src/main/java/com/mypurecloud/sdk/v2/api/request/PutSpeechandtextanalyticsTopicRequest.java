...
public class PutSpeechandtextanalyticsTopicRequest {
	...
	public PutSpeechandtextanalyticsTopicRequest withTopicId(String topicId) {
	...
	public void setBody(TopicRequest body) {
		this.body = body;
	}

	public PutSpeechandtextanalyticsTopicRequest withBody(TopicRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutSpeechandtextanalyticsTopicRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<TopicRequest> withHttpInfo() {
        
        // verify the required parameter 'topicId' is set
        if (this.topicId == null) {
            throw new IllegalStateException("Missing the required parameter 'topicId' when building request for PutSpeechandtextanalyticsTopicRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutSpeechandtextanalyticsTopicRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/speechandtextanalytics/topics/{topicId}")
	...
	public static Builder builder(String topicId, TopicRequest body) {
	    return new Builder()
	            .withRequiredParams(topicId, body);
	}
	

	public static class Builder {
		private final PutSpeechandtextanalyticsTopicRequest request;

		private Builder() {
			request = new PutSpeechandtextanalyticsTopicRequest();
		}
		...
		public Builder withRequiredParams(String topicId, TopicRequest body) {
			request.setTopicId(topicId);
						request.setBody(body);
		...
		public PutSpeechandtextanalyticsTopicRequest build() {
