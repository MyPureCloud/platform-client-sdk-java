...
public class PostKnowledgeKnowledgebaseLanguageTrainingPromoteRequest {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("POST", "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/languages/{languageCode}/trainings/{trainingId}/promote")
	...
	public static class Builder {
		private final PostKnowledgeKnowledgebaseLanguageTrainingPromoteRequest request;

		private Builder() {
			request = new PostKnowledgeKnowledgebaseLanguageTrainingPromoteRequest();
		}
