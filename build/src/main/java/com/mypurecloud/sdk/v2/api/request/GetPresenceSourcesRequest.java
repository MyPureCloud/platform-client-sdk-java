...
public class GetPresenceSourcesRequest {
    ...
    public GetPresenceSourcesRequest withCustomHeader(String name, String value) {
	...
	public static class Builder {
		private final GetPresenceSourcesRequest request;

		private Builder() {
			request = new GetPresenceSourcesRequest();
		}
		...
		public GetPresenceSourcesRequest build() {
