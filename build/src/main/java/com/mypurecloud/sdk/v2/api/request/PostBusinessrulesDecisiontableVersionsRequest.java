...
public class PostBusinessrulesDecisiontableVersionsRequest {
	...
	public PostBusinessrulesDecisiontableVersionsRequest withTableId(String tableId) {
    ...
    public PostBusinessrulesDecisiontableVersionsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.tableId == null) {
            throw new IllegalStateException("Missing the required parameter 'tableId' when building request for PostBusinessrulesDecisiontableVersionsRequest.");
        }
	...
	public static class Builder {
		private final PostBusinessrulesDecisiontableVersionsRequest request;

		private Builder() {
			request = new PostBusinessrulesDecisiontableVersionsRequest();
		}
		...
		public PostBusinessrulesDecisiontableVersionsRequest build() {
