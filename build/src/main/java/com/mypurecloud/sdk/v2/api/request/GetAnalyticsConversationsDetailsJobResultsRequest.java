...
public class GetAnalyticsConversationsDetailsJobResultsRequest {
	...
	public GetAnalyticsConversationsDetailsJobResultsRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
	...
	public GetAnalyticsConversationsDetailsJobResultsRequest withCursor(String cursor) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetAnalyticsConversationsDetailsJobResultsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/analytics/conversations/details/jobs/{jobId}/results")
	...
	public static class Builder {
		private final GetAnalyticsConversationsDetailsJobResultsRequest request;

		private Builder() {
			request = new GetAnalyticsConversationsDetailsJobResultsRequest();
		}
		...
		public GetAnalyticsConversationsDetailsJobResultsRequest build() {
