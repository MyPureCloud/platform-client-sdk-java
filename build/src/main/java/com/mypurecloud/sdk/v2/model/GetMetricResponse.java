...
public class GetMetricResponse  implements Serializable {
  
  private Long total = null;
  private List<Metric> entities = new ArrayList<Metric>();
  private String selfUri = null;

  
  /**
   **/
  public GetMetricResponse total(Long total) {
    this.total = total;
    return this;
  }
  ...
  public List<Metric> getEntities() {
    return entities;
  }
  public void setEntities(List<Metric> entities) {
    this.entities = entities;
  }
