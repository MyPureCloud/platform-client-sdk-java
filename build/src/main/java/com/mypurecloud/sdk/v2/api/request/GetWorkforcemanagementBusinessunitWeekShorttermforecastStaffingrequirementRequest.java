...
public class GetWorkforcemanagementBusinessunitWeekShorttermforecastStaffingrequirementRequest {
	...
	public GetWorkforcemanagementBusinessunitWeekShorttermforecastStaffingrequirementRequest withBusinessUnitId(String businessUnitId) {
	...
	public GetWorkforcemanagementBusinessunitWeekShorttermforecastStaffingrequirementRequest withWeekDateId(LocalDate weekDateId) {
	...
	public GetWorkforcemanagementBusinessunitWeekShorttermforecastStaffingrequirementRequest withForecastId(String forecastId) {
	...
	public GetWorkforcemanagementBusinessunitWeekShorttermforecastStaffingrequirementRequest withWeekNumbers(List<String> weekNumbers) {
	    this.setWeekNumbers(weekNumbers);
	    return this;
	} 
	...
	public GetWorkforcemanagementBusinessunitWeekShorttermforecastStaffingrequirementRequest withExpand(List<String> expand) {
	    this.setExpand(expand);
	    return this;
	} 

	public enum expandValues { 
		RESULTS_PLANNINGGROUPSTAFFINGREQUIREMENTS_MINIMUMSTAFFPERINTERVAL("results.planningGroupStaffingRequirements.minimumStaffPerInterval"),
		RESULTS_PLANNINGGROUPSTAFFINGREQUIREMENTS_EFFECTIVESTAFFPERINTERVAL("results.planningGroupStaffingRequirements.effectiveStaffPerInterval");
    ...
    public GetWorkforcemanagementBusinessunitWeekShorttermforecastStaffingrequirementRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for GetWorkforcemanagementBusinessunitWeekShorttermforecastStaffingrequirementRequest.");
        }
        
        // verify the required parameter 'weekDateId' is set
        if (this.weekDateId == null) {
            throw new IllegalStateException("Missing the required parameter 'weekDateId' when building request for GetWorkforcemanagementBusinessunitWeekShorttermforecastStaffingrequirementRequest.");
        }
        
        // verify the required parameter 'forecastId' is set
        if (this.forecastId == null) {
            throw new IllegalStateException("Missing the required parameter 'forecastId' when building request for GetWorkforcemanagementBusinessunitWeekShorttermforecastStaffingrequirementRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/weeks/{weekDateId}/shorttermforecasts/{forecastId}/staffingrequirement")
                ...
                .withQueryParameters("weekNumbers", "multi", weekNumbers)
	...
	public static class Builder {
		private final GetWorkforcemanagementBusinessunitWeekShorttermforecastStaffingrequirementRequest request;

		private Builder() {
			request = new GetWorkforcemanagementBusinessunitWeekShorttermforecastStaffingrequirementRequest();
		}
		...
		public Builder withWeekNumbers(List<String> weekNumbers) {
			request.setWeekNumbers(weekNumbers);
			return this;
		}
		...
		public GetWorkforcemanagementBusinessunitWeekShorttermforecastStaffingrequirementRequest build() {
