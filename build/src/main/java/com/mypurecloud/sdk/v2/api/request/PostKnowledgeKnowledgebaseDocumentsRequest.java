...
public class PostKnowledgeKnowledgebaseDocumentsRequest {
	...
	public PostKnowledgeKnowledgebaseDocumentsRequest withKnowledgeBaseId(String knowledgeBaseId) {
    ...
    public PostKnowledgeKnowledgebaseDocumentsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<KnowledgeDocumentReq> withHttpInfo() {
        ...
        if (this.knowledgeBaseId == null) {
            throw new IllegalStateException("Missing the required parameter 'knowledgeBaseId' when building request for PostKnowledgeKnowledgebaseDocumentsRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostKnowledgeKnowledgebaseDocumentsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/documents")
	...
	public static class Builder {
		private final PostKnowledgeKnowledgebaseDocumentsRequest request;

		private Builder() {
			request = new PostKnowledgeKnowledgebaseDocumentsRequest();
		}
		...
		public PostKnowledgeKnowledgebaseDocumentsRequest build() {
