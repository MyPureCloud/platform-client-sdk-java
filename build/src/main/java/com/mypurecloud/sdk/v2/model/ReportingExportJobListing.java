...
public class ReportingExportJobListing  implements Serializable, PagedResource<ReportingExportJobResponse> {
  ...
  /**
   **/
  public ReportingExportJobListing entities(List<ReportingExportJobResponse> entities) {
  ...
  public List<ReportingExportJobResponse> getEntities() {
    return entities;
  }
  public void setEntities(List<ReportingExportJobResponse> entities) {
    this.entities = entities;
  }
