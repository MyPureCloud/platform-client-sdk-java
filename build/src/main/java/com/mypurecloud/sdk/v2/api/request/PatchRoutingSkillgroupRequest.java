...
public class PatchRoutingSkillgroupRequest {
	...
	public PatchRoutingSkillgroupRequest withSkillGroupId(String skillGroupId) {
	...
	public PatchRoutingSkillgroupRequest withBody(SkillGroup body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchRoutingSkillgroupRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<SkillGroup> withHttpInfo() {
        ...
        if (this.skillGroupId == null) {
            throw new IllegalStateException("Missing the required parameter 'skillGroupId' when building request for PatchRoutingSkillgroupRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchRoutingSkillgroupRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/routing/skillgroups/{skillGroupId}")
	...
	public static Builder builder(String skillGroupId, SkillGroup body) {
	    return new Builder()
	            .withRequiredParams(skillGroupId, body);
	}


	public static class Builder {
		private final PatchRoutingSkillgroupRequest request;

		private Builder() {
			request = new PatchRoutingSkillgroupRequest();
		}
		...
		public Builder withRequiredParams(String skillGroupId, SkillGroup body) {
			request.setSkillGroupId(skillGroupId);
			request.setBody(body);
		...
		public PatchRoutingSkillgroupRequest build() {
