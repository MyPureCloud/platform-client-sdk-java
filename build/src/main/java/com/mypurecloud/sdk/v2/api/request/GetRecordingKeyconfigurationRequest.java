...
public class GetRecordingKeyconfigurationRequest {
	...
	public GetRecordingKeyconfigurationRequest withKeyConfigurationId(String keyConfigurationId) {
    ...
    public GetRecordingKeyconfigurationRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.keyConfigurationId == null) {
            throw new IllegalStateException("Missing the required parameter 'keyConfigurationId' when building request for GetRecordingKeyconfigurationRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/recording/keyconfigurations/{keyConfigurationId}")
	...
	public static Builder builder(String keyConfigurationId) {
	    return new Builder()
	            .withRequiredParams(keyConfigurationId);
	}


	public static class Builder {
		private final GetRecordingKeyconfigurationRequest request;

		private Builder() {
			request = new GetRecordingKeyconfigurationRequest();
		}
		...
		public Builder withRequiredParams(String keyConfigurationId) {
			request.setKeyConfigurationId(keyConfigurationId);
		...
		public GetRecordingKeyconfigurationRequest build() {
