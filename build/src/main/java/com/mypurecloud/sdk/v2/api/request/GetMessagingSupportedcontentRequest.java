...
public class GetMessagingSupportedcontentRequest {
	...
	public GetMessagingSupportedcontentRequest withPageSize(Integer pageSize) {
	...
	public GetMessagingSupportedcontentRequest withPageNumber(Integer pageNumber) {
    ...
    public GetMessagingSupportedcontentRequest withCustomHeader(String name, String value) {
