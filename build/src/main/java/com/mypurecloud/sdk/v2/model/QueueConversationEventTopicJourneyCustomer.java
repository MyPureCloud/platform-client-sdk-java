...
public class QueueConversationEventTopicJourneyCustomer  implements Serializable {
  
  private String id = null;
  private String idType = null;

  public QueueConversationEventTopicJourneyCustomer() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
    }
  }

  public QueueConversationEventTopicJourneyCustomer(Boolean initWithEmptyList) {
   ...
   **/
  public QueueConversationEventTopicJourneyCustomer id(String id) {
    this.id = id;
    return this;
  }
   ...
   **/
  public QueueConversationEventTopicJourneyCustomer idType(String idType) {
    this.idType = idType;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    QueueConversationEventTopicJourneyCustomer queueConversationEventTopicJourneyCustomer = (QueueConversationEventTopicJourneyCustomer) o;

    return Objects.equals(this.id, queueConversationEventTopicJourneyCustomer.id) &&
            Objects.equals(this.idType, queueConversationEventTopicJourneyCustomer.idType);
  }
