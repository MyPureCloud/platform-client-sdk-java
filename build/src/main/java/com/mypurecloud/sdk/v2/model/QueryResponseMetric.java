...
import com.fasterxml.jackson.annotation.JsonValue;
import com.mypurecloud.sdk.v2.model.QueryResponseStats;
...
public class QueryResponseMetric  implements Serializable {
 ...
 @JsonDeserialize(using = MetricEnumDeserializer.class)
   ...
   * The metric this applies to
   **/
  public QueryResponseMetric metric(MetricEnum metric) {
    this.metric = metric;
    return this;
  }
   ...
   **/
  public QueryResponseMetric stats(QueryResponseStats stats) {
    this.stats = stats;
    return this;
  }
