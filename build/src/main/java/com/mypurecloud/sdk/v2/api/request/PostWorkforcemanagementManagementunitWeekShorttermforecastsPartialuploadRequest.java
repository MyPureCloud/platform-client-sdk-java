...
public class PostWorkforcemanagementManagementunitWeekShorttermforecastsPartialuploadRequest {
	...
	public PostWorkforcemanagementManagementunitWeekShorttermforecastsPartialuploadRequest withManagementUnitId(String managementUnitId) {
	...
	public PostWorkforcemanagementManagementunitWeekShorttermforecastsPartialuploadRequest withWeekDateId(String weekDateId) {
	    this.setWeekDateId(weekDateId);
	    return this;
	} 
	
	private RouteGroupList body;
	public RouteGroupList getBody() {
		return this.body;
	}

	public void setBody(RouteGroupList body) {
		this.body = body;
	}

	public PostWorkforcemanagementManagementunitWeekShorttermforecastsPartialuploadRequest withBody(RouteGroupList body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementManagementunitWeekShorttermforecastsPartialuploadRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<RouteGroupList> withHttpInfo() {
        
        // verify the required parameter 'managementUnitId' is set
        if (this.managementUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'managementUnitId' when building request for PostWorkforcemanagementManagementunitWeekShorttermforecastsPartialuploadRequest.");
        }
        
        // verify the required parameter 'weekDateId' is set
        if (this.weekDateId == null) {
            throw new IllegalStateException("Missing the required parameter 'weekDateId' when building request for PostWorkforcemanagementManagementunitWeekShorttermforecastsPartialuploadRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementManagementunitWeekShorttermforecastsPartialuploadRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/managementunits/{managementUnitId}/weeks/{weekDateId}/shorttermforecasts/partialupload")
	...
	public static Builder builder(String managementUnitId, String weekDateId, RouteGroupList body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementManagementunitWeekShorttermforecastsPartialuploadRequest request;

		private Builder() {
			request = new PostWorkforcemanagementManagementunitWeekShorttermforecastsPartialuploadRequest();
		}
		...
		public Builder withBody(RouteGroupList body) {
		...
		public Builder withRequiredParams(String managementUnitId, String weekDateId, RouteGroupList body) {
			request.setManagementUnitId(managementUnitId);
						request.setWeekDateId(weekDateId);
						request.setBody(body);
		...
		public PostWorkforcemanagementManagementunitWeekShorttermforecastsPartialuploadRequest build() {
