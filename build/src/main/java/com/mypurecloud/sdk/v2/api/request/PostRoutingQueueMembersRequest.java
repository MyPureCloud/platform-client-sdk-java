...
public class PostRoutingQueueMembersRequest {
	...
	public PostRoutingQueueMembersRequest withQueueId(String queueId) {
	...
	public PostRoutingQueueMembersRequest withBody(List<WritableEntity> body) {
	    this.setBody(body);
	    return this;
	} 
	...
	public PostRoutingQueueMembersRequest withDelete(Boolean delete) {
    ...
    public PostRoutingQueueMembersRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<List<WritableEntity>> withHttpInfo() {
        ...
        if (this.queueId == null) {
            throw new IllegalStateException("Missing the required parameter 'queueId' when building request for PostRoutingQueueMembersRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostRoutingQueueMembersRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/routing/queues/{queueId}/members")
	...
	public static class Builder {
		private final PostRoutingQueueMembersRequest request;

		private Builder() {
			request = new PostRoutingQueueMembersRequest();
		}
		...
		public PostRoutingQueueMembersRequest build() {
