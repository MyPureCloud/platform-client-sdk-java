...
public class GetWorkforcemanagementBusinessunitStaffinggroupsRequest {
	...
	public GetWorkforcemanagementBusinessunitStaffinggroupsRequest withBusinessUnitId(String businessUnitId) {
	...
	public GetWorkforcemanagementBusinessunitStaffinggroupsRequest withManagementUnitId(String managementUnitId) {
    ...
    public GetWorkforcemanagementBusinessunitStaffinggroupsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for GetWorkforcemanagementBusinessunitStaffinggroupsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/staffinggroups")
	...
	public static class Builder {
		private final GetWorkforcemanagementBusinessunitStaffinggroupsRequest request;

		private Builder() {
			request = new GetWorkforcemanagementBusinessunitStaffinggroupsRequest();
		}
		...
		public GetWorkforcemanagementBusinessunitStaffinggroupsRequest build() {
