...
public class DeleteAlertingRoutingstatusAlertRequest {
	...
	public DeleteAlertingRoutingstatusAlertRequest withAlertId(String alertId) {
    ...
    public DeleteAlertingRoutingstatusAlertRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() throws ApiException {
        ...
        return ApiRequestBuilder.create("DELETE", "/api/v2/alerting/routingstatus/alerts/{alertId}")
	...
	public static class Builder {
		private final DeleteAlertingRoutingstatusAlertRequest request;

		private Builder() {
			request = new DeleteAlertingRoutingstatusAlertRequest();
		}
