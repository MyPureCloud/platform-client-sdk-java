...
public class GetTaskmanagementWorkitemsBulkAddJobRequest {
	...
	public GetTaskmanagementWorkitemsBulkAddJobRequest withBulkJobId(String bulkJobId) {
    ...
    public GetTaskmanagementWorkitemsBulkAddJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.bulkJobId == null) {
            throw new IllegalStateException("Missing the required parameter 'bulkJobId' when building request for GetTaskmanagementWorkitemsBulkAddJobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/taskmanagement/workitems/bulk/add/jobs/{bulkJobId}")
	...
	public static class Builder {
		private final GetTaskmanagementWorkitemsBulkAddJobRequest request;

		private Builder() {
			request = new GetTaskmanagementWorkitemsBulkAddJobRequest();
		}
		...
		public GetTaskmanagementWorkitemsBulkAddJobRequest build() {
