...
public class GetConversationsMessagingIntegrationTwitterOauthSettingsRequest {
	...
	public GetConversationsMessagingIntegrationTwitterOauthSettingsRequest withIntegrationId(String integrationId) {
    ...
    public GetConversationsMessagingIntegrationTwitterOauthSettingsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.integrationId == null) {
            throw new IllegalStateException("Missing the required parameter 'integrationId' when building request for GetConversationsMessagingIntegrationTwitterOauthSettingsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/conversations/messaging/integrations/{integrationId}/twitter/oauth/settings")
	...
	public static class Builder {
		private final GetConversationsMessagingIntegrationTwitterOauthSettingsRequest request;

		private Builder() {
			request = new GetConversationsMessagingIntegrationTwitterOauthSettingsRequest();
		}
		...
		public GetConversationsMessagingIntegrationTwitterOauthSettingsRequest build() {
