...
public class PostJourneyViewVersionsRequest {
	...
	public PostJourneyViewVersionsRequest withViewId(String viewId) {
	...
	public PostJourneyViewVersionsRequest withBody(JourneyView body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostJourneyViewVersionsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<JourneyView> withHttpInfo() {
        ...
        if (this.viewId == null) {
            throw new IllegalStateException("Missing the required parameter 'viewId' when building request for PostJourneyViewVersionsRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostJourneyViewVersionsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/journey/views/{viewId}/versions")
	...
	public static Builder builder(String viewId, JourneyView body) {
	    return new Builder()
	            .withRequiredParams(viewId, body);
	}


	public static class Builder {
		private final PostJourneyViewVersionsRequest request;

		private Builder() {
			request = new PostJourneyViewVersionsRequest();
		}
		...
		public Builder withRequiredParams(String viewId, JourneyView body) {
			request.setViewId(viewId);
			request.setBody(body);
		...
		public PostJourneyViewVersionsRequest build() {
