...
public class GetSocialmediaTopicDataingestionrulesTwitterTwitterIngestionRuleIdRequest {
	...
	public GetSocialmediaTopicDataingestionrulesTwitterTwitterIngestionRuleIdRequest withTopicId(String topicId) {
	...
	public GetSocialmediaTopicDataingestionrulesTwitterTwitterIngestionRuleIdRequest withTwitterIngestionRuleId(String twitterIngestionRuleId) {
	...
	public GetSocialmediaTopicDataingestionrulesTwitterTwitterIngestionRuleIdRequest withIncludeDeleted(Boolean includeDeleted) {
    ...
    public GetSocialmediaTopicDataingestionrulesTwitterTwitterIngestionRuleIdRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.topicId == null) {
            throw new IllegalStateException("Missing the required parameter 'topicId' when building request for GetSocialmediaTopicDataingestionrulesTwitterTwitterIngestionRuleIdRequest.");
        }
        
        // verify the required parameter 'twitterIngestionRuleId' is set
        if (this.twitterIngestionRuleId == null) {
            throw new IllegalStateException("Missing the required parameter 'twitterIngestionRuleId' when building request for GetSocialmediaTopicDataingestionrulesTwitterTwitterIngestionRuleIdRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/socialmedia/topics/{topicId}/dataingestionrules/twitter/{twitterIngestionRuleId}")
	...
	public static class Builder {
		private final GetSocialmediaTopicDataingestionrulesTwitterTwitterIngestionRuleIdRequest request;

		private Builder() {
			request = new GetSocialmediaTopicDataingestionrulesTwitterTwitterIngestionRuleIdRequest();
		}
		...
		public GetSocialmediaTopicDataingestionrulesTwitterTwitterIngestionRuleIdRequest build() {
