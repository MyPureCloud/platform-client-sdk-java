...
public class GetArchitectEmergencygroupsDivisionviewsRequest {
	...
	public GetArchitectEmergencygroupsDivisionviewsRequest withPageNumber(Integer pageNumber) {
	...
	public GetArchitectEmergencygroupsDivisionviewsRequest withPageSize(Integer pageSize) {
	...
	public GetArchitectEmergencygroupsDivisionviewsRequest withSortBy(String sortBy) {
	...
	public GetArchitectEmergencygroupsDivisionviewsRequest withSortOrder(String sortOrder) {
	...
	public GetArchitectEmergencygroupsDivisionviewsRequest withId(List<String> id) {
	    this.setId(id);
	    return this;
	} 
	...
	public GetArchitectEmergencygroupsDivisionviewsRequest withName(String name) {
	    this.setName(name);
	    return this;
	} 
	...
	public GetArchitectEmergencygroupsDivisionviewsRequest withDivisionId(List<String> divisionId) {
    ...
    public GetArchitectEmergencygroupsDivisionviewsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/architect/emergencygroups/divisionviews")
	...
	public static class Builder {
		private final GetArchitectEmergencygroupsDivisionviewsRequest request;

		private Builder() {
			request = new GetArchitectEmergencygroupsDivisionviewsRequest();
		}
		...
		public GetArchitectEmergencygroupsDivisionviewsRequest build() {
