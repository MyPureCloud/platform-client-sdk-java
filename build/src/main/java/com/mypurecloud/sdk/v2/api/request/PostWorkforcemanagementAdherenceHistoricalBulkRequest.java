...
public class PostWorkforcemanagementAdherenceHistoricalBulkRequest {

	private WfmHistoricalAdherenceBulkQuery body;
	public WfmHistoricalAdherenceBulkQuery getBody() {
		return this.body;
	}

	public void setBody(WfmHistoricalAdherenceBulkQuery body) {
		this.body = body;
	}

	public PostWorkforcemanagementAdherenceHistoricalBulkRequest withBody(WfmHistoricalAdherenceBulkQuery body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementAdherenceHistoricalBulkRequest withCustomHeader(String name, String value) {
	...
	public static class Builder {
		private final PostWorkforcemanagementAdherenceHistoricalBulkRequest request;

		private Builder() {
			request = new PostWorkforcemanagementAdherenceHistoricalBulkRequest();
		}


		public Builder withBody(WfmHistoricalAdherenceBulkQuery body) {
