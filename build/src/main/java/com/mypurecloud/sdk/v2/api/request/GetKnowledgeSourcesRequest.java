...
public class GetKnowledgeSourcesRequest {
	...
	public GetKnowledgeSourcesRequest withExpand(List<String> expand) {
    ...
    public GetKnowledgeSourcesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/knowledge/sources")
	...
	public static class Builder {
		private final GetKnowledgeSourcesRequest request;

		private Builder() {
			request = new GetKnowledgeSourcesRequest();
		}
		...
		public GetKnowledgeSourcesRequest build() {
