...
public class GetWorkforcemanagementBusinessunitSchedulebidsRequest {
	...
	public GetWorkforcemanagementBusinessunitSchedulebidsRequest withBusinessUnitId(String businessUnitId) {
    ...
    public GetWorkforcemanagementBusinessunitSchedulebidsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for GetWorkforcemanagementBusinessunitSchedulebidsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/schedulebids")
	...
	public static class Builder {
		private final GetWorkforcemanagementBusinessunitSchedulebidsRequest request;

		private Builder() {
			request = new GetWorkforcemanagementBusinessunitSchedulebidsRequest();
		}
		...
		public GetWorkforcemanagementBusinessunitSchedulebidsRequest build() {
