...
public class FlowExecutionAggregationQuery  implements Serializable {
 ...
 @JsonDeserialize(using = AlternateTimeDimensionEnumDeserializer.class)
  ...
  public FlowExecutionAggregationQuery(Boolean initWithEmptyList) {
   ...
   **/
  public FlowExecutionAggregationQuery interval(String interval) {
   ...
   **/
  public FlowExecutionAggregationQuery granularity(String granularity) {
   ...
   **/
  public FlowExecutionAggregationQuery timeZone(String timeZone) {
   ...
   **/
  public FlowExecutionAggregationQuery groupBy(List<GroupByEnum> groupBy) {
   ...
   **/
  public FlowExecutionAggregationQuery filter(FlowExecutionAggregateQueryFilter filter) {
    this.filter = filter;
    return this;
  }
   ...
   **/
  public FlowExecutionAggregationQuery metrics(List<MetricsEnum> metrics) {
   ...
   **/
  public FlowExecutionAggregationQuery flattenMultivaluedDimensions(Boolean flattenMultivaluedDimensions) {
   ...
   **/
  public FlowExecutionAggregationQuery views(List<FlowExecutionAggregationView> views) {
    this.views = views;
    return this;
  }
   ...
   * Dimension to use as the alternative timestamp for data in the aggregate.  Choosing \"eventTime\" uses the actual time of the data event.
   **/
  public FlowExecutionAggregationQuery alternateTimeDimension(AlternateTimeDimensionEnum alternateTimeDimension) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    FlowExecutionAggregationQuery flowExecutionAggregationQuery = (FlowExecutionAggregationQuery) o;

    return Objects.equals(this.interval, flowExecutionAggregationQuery.interval) &&
            Objects.equals(this.granularity, flowExecutionAggregationQuery.granularity) &&
            Objects.equals(this.timeZone, flowExecutionAggregationQuery.timeZone) &&
            Objects.equals(this.groupBy, flowExecutionAggregationQuery.groupBy) &&
            Objects.equals(this.filter, flowExecutionAggregationQuery.filter) &&
            Objects.equals(this.metrics, flowExecutionAggregationQuery.metrics) &&
            Objects.equals(this.flattenMultivaluedDimensions, flowExecutionAggregationQuery.flattenMultivaluedDimensions) &&
            Objects.equals(this.views, flowExecutionAggregationQuery.views) &&
            Objects.equals(this.alternateTimeDimension, flowExecutionAggregationQuery.alternateTimeDimension);
  }
