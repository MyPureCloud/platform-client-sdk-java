...
public class PostAnalyticsSurveysAggregatesJobsRequest {

	private SurveyAsyncAggregationQuery body;
	public SurveyAsyncAggregationQuery getBody() {
		return this.body;
	}

	public void setBody(SurveyAsyncAggregationQuery body) {
		this.body = body;
	}

	public PostAnalyticsSurveysAggregatesJobsRequest withBody(SurveyAsyncAggregationQuery body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostAnalyticsSurveysAggregatesJobsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<SurveyAsyncAggregationQuery> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostAnalyticsSurveysAggregatesJobsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/analytics/surveys/aggregates/jobs")
                .withBody(body)
	...
	public static Builder builder(SurveyAsyncAggregationQuery body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostAnalyticsSurveysAggregatesJobsRequest request;

		private Builder() {
			request = new PostAnalyticsSurveysAggregatesJobsRequest();
		}


		public Builder withBody(SurveyAsyncAggregationQuery body) {
		...
		public Builder withRequiredParams(SurveyAsyncAggregationQuery body) {
			request.setBody(body);
		...
		public PostAnalyticsSurveysAggregatesJobsRequest build() {
