...
public class GetConversationsCustomattributesSchemaVersionsRequest {
	...
	public GetConversationsCustomattributesSchemaVersionsRequest withSchemaId(String schemaId) {
    ...
    public GetConversationsCustomattributesSchemaVersionsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.schemaId == null) {
            throw new IllegalStateException("Missing the required parameter 'schemaId' when building request for GetConversationsCustomattributesSchemaVersionsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/conversations/customattributes/schemas/{schemaId}/versions")
	...
	public static class Builder {
		private final GetConversationsCustomattributesSchemaVersionsRequest request;

		private Builder() {
			request = new GetConversationsCustomattributesSchemaVersionsRequest();
		}
		...
		public GetConversationsCustomattributesSchemaVersionsRequest build() {
