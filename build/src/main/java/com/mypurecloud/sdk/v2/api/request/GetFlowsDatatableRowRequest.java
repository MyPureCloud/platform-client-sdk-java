...
public class GetFlowsDatatableRowRequest {
	...
	public GetFlowsDatatableRowRequest withDatatableId(String datatableId) {
	...
	public GetFlowsDatatableRowRequest withRowId(String rowId) {
	    this.setRowId(rowId);
	    return this;
	} 
	...
	public GetFlowsDatatableRowRequest withShowbrief(Boolean showbrief) {
    ...
    public GetFlowsDatatableRowRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.datatableId == null) {
            throw new IllegalStateException("Missing the required parameter 'datatableId' when building request for GetFlowsDatatableRowRequest.");
        }
        
        // verify the required parameter 'rowId' is set
        if (this.rowId == null) {
            throw new IllegalStateException("Missing the required parameter 'rowId' when building request for GetFlowsDatatableRowRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/flows/datatables/{datatableId}/rows/{rowId}")
	...
	public static class Builder {
		private final GetFlowsDatatableRowRequest request;

		private Builder() {
			request = new GetFlowsDatatableRowRequest();
		}
		...
		public GetFlowsDatatableRowRequest build() {
