...
public class PutSpeechandtextanalyticsSettingsRequest {
    
	private SpeechTextAnalyticsSettingsRequest body;
	public SpeechTextAnalyticsSettingsRequest getBody() {
		return this.body;
	}

	public void setBody(SpeechTextAnalyticsSettingsRequest body) {
		this.body = body;
	}

	public PutSpeechandtextanalyticsSettingsRequest withBody(SpeechTextAnalyticsSettingsRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutSpeechandtextanalyticsSettingsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<SpeechTextAnalyticsSettingsRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutSpeechandtextanalyticsSettingsRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/speechandtextanalytics/settings")
                .withBody(body)
	...
	public static Builder builder(SpeechTextAnalyticsSettingsRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PutSpeechandtextanalyticsSettingsRequest request;

		private Builder() {
			request = new PutSpeechandtextanalyticsSettingsRequest();
		}

		
		public Builder withBody(SpeechTextAnalyticsSettingsRequest body) {
		...
		public Builder withRequiredParams(SpeechTextAnalyticsSettingsRequest body) {
			request.setBody(body);
		...
		public PutSpeechandtextanalyticsSettingsRequest build() {
