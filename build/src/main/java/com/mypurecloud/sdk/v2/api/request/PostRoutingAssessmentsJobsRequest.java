...
public class PostRoutingAssessmentsJobsRequest {
    
	private CreateBenefitAssessmentJobRequest body;
	public CreateBenefitAssessmentJobRequest getBody() {
		return this.body;
	}

	public void setBody(CreateBenefitAssessmentJobRequest body) {
		this.body = body;
	}

	public PostRoutingAssessmentsJobsRequest withBody(CreateBenefitAssessmentJobRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostRoutingAssessmentsJobsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<CreateBenefitAssessmentJobRequest> withHttpInfo() {
        

        return ApiRequestBuilder.create("POST", "/api/v2/routing/assessments/jobs")
                .withBody(body)
	...
	public static class Builder {
		private final PostRoutingAssessmentsJobsRequest request;

		private Builder() {
			request = new PostRoutingAssessmentsJobsRequest();
		}

		
		public Builder withBody(CreateBenefitAssessmentJobRequest body) {
		...
		public PostRoutingAssessmentsJobsRequest build() {
