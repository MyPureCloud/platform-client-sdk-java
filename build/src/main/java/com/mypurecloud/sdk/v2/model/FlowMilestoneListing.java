...
public class FlowMilestoneListing  implements Serializable, PagedResource<FlowMilestone> {
  ...
  public FlowMilestoneListing() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
      entities = new ArrayList<FlowMilestone>();
    }
  }

  public FlowMilestoneListing(Boolean initWithEmptyList) {
  ...
  /**
   **/
  public FlowMilestoneListing entities(List<FlowMilestone> entities) {
  ...
  public List<FlowMilestone> getEntities() {
    return entities;
  }
  public void setEntities(List<FlowMilestone> entities) {
    this.entities = entities;
  }
