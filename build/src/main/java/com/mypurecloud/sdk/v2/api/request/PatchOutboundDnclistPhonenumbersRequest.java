...
public class PatchOutboundDnclistPhonenumbersRequest {
	...
	public PatchOutboundDnclistPhonenumbersRequest withDncListId(String dncListId) {
	    this.setDncListId(dncListId);
	    return this;
	} 

	private DncPatchPhoneNumbersRequest body;
	public DncPatchPhoneNumbersRequest getBody() {
		return this.body;
	}

	public void setBody(DncPatchPhoneNumbersRequest body) {
		this.body = body;
	}

	public PatchOutboundDnclistPhonenumbersRequest withBody(DncPatchPhoneNumbersRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchOutboundDnclistPhonenumbersRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<DncPatchPhoneNumbersRequest> withHttpInfo() {
        
        // verify the required parameter 'dncListId' is set
        if (this.dncListId == null) {
            throw new IllegalStateException("Missing the required parameter 'dncListId' when building request for PatchOutboundDnclistPhonenumbersRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchOutboundDnclistPhonenumbersRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/outbound/dnclists/{dncListId}/phonenumbers")
	...
	public static Builder builder(String dncListId, DncPatchPhoneNumbersRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PatchOutboundDnclistPhonenumbersRequest request;

		private Builder() {
			request = new PatchOutboundDnclistPhonenumbersRequest();
		}
		...
		public Builder withBody(DncPatchPhoneNumbersRequest body) {
		...
		public Builder withRequiredParams(String dncListId, DncPatchPhoneNumbersRequest body) {
			request.setDncListId(dncListId);
			request.setBody(body);
		...
		public PatchOutboundDnclistPhonenumbersRequest build() {
