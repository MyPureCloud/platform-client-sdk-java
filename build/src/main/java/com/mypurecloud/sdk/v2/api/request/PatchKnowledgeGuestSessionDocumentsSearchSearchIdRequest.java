...
public class PatchKnowledgeGuestSessionDocumentsSearchSearchIdRequest {
	...
	public PatchKnowledgeGuestSessionDocumentsSearchSearchIdRequest withSessionId(String sessionId) {
	...
	public PatchKnowledgeGuestSessionDocumentsSearchSearchIdRequest withSearchId(String searchId) {
	    this.setSearchId(searchId);
	    return this;
	} 

	private SearchUpdateRequest body;
	public SearchUpdateRequest getBody() {
		return this.body;
	}

	public void setBody(SearchUpdateRequest body) {
		this.body = body;
	}

	public PatchKnowledgeGuestSessionDocumentsSearchSearchIdRequest withBody(SearchUpdateRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public ApiRequest<SearchUpdateRequest> withHttpInfo() {
        
        // verify the required parameter 'sessionId' is set
        if (this.sessionId == null) {
            throw new IllegalStateException("Missing the required parameter 'sessionId' when building request for PatchKnowledgeGuestSessionDocumentsSearchSearchIdRequest.");
        }
        
        // verify the required parameter 'searchId' is set
        if (this.searchId == null) {
            throw new IllegalStateException("Missing the required parameter 'searchId' when building request for PatchKnowledgeGuestSessionDocumentsSearchSearchIdRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchKnowledgeGuestSessionDocumentsSearchSearchIdRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/knowledge/guest/sessions/{sessionId}/documents/search/{searchId}")
	...
	public static Builder builder(String sessionId, String searchId, SearchUpdateRequest body) {
	    return new Builder()
	            .withRequiredParams(sessionId, searchId, body);
	}


	public static class Builder {
		private final PatchKnowledgeGuestSessionDocumentsSearchSearchIdRequest request;

		private Builder() {
			request = new PatchKnowledgeGuestSessionDocumentsSearchSearchIdRequest();
		}
		...
		public Builder withBody(SearchUpdateRequest body) {
		...
		public Builder withRequiredParams(String sessionId, String searchId, SearchUpdateRequest body) {
			request.setSessionId(sessionId);
			request.setSearchId(searchId);
			request.setBody(body);
		...
		public PatchKnowledgeGuestSessionDocumentsSearchSearchIdRequest build() {
