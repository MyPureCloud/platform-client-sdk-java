...
public class PostExternalcontactsBulkRelationshipsRequest {
	...
	public PostExternalcontactsBulkRelationshipsRequest withBody(BulkIdsRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostExternalcontactsBulkRelationshipsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<BulkIdsRequest> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostExternalcontactsBulkRelationshipsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/externalcontacts/bulk/relationships")
                .withBody(body)
	...
	public static class Builder {
		private final PostExternalcontactsBulkRelationshipsRequest request;

		private Builder() {
			request = new PostExternalcontactsBulkRelationshipsRequest();
		}
		...
		public PostExternalcontactsBulkRelationshipsRequest build() {
