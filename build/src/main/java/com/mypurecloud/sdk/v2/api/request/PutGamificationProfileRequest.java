...
public class PutGamificationProfileRequest {
	...
	public PutGamificationProfileRequest withProfileId(String profileId) {
    ...
    public ApiRequest<PerformanceProfile> withHttpInfo() {
        ...
        if (this.profileId == null) {
            throw new IllegalStateException("Missing the required parameter 'profileId' when building request for PutGamificationProfileRequest.");
        }
