...
public class GetJourneyExternaleventsConfigurationsRequest {
	...
	public GetJourneyExternaleventsConfigurationsRequest withPageSize(Integer pageSize) {
	...
	public GetJourneyExternaleventsConfigurationsRequest withPageNumber(Integer pageNumber) {
    ...
    public GetJourneyExternaleventsConfigurationsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/journey/externalevents/configurations")
	...
	public static class Builder {
		private final GetJourneyExternaleventsConfigurationsRequest request;

		private Builder() {
			request = new GetJourneyExternaleventsConfigurationsRequest();
		}
		...
		public GetJourneyExternaleventsConfigurationsRequest build() {
