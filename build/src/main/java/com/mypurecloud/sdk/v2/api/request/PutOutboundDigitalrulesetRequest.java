...
public class PutOutboundDigitalrulesetRequest {
	...
	public void setDigitalRuleSetId(String digitalRuleSetId) {
		this.digitalRuleSetId = digitalRuleSetId;
	}

	public PutOutboundDigitalrulesetRequest withDigitalRuleSetId(String digitalRuleSetId) {
	    this.setDigitalRuleSetId(digitalRuleSetId);
	    return this;
	} 
	...
	public void setBody(DigitalRuleSet body) {
		this.body = body;
	}

	public PutOutboundDigitalrulesetRequest withBody(DigitalRuleSet body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutOutboundDigitalrulesetRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<DigitalRuleSet> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("PUT", "/api/v2/outbound/digitalrulesets/{digitalRuleSetId}")
                .withPathParameter("digitalRuleSetId", digitalRuleSetId)
	...
	public static Builder builder(String digitalRuleSetId, DigitalRuleSet body) {
	    return new Builder()
	            .withRequiredParams(digitalRuleSetId, body);
	}
	...
	public static class Builder {
		...
		private Builder() {
			request = new PutOutboundDigitalrulesetRequest();
		}


		public Builder withDigitalRuleSetId(String digitalRuleSetId) {
			request.setDigitalRuleSetId(digitalRuleSetId);
			return this;
		}

		public Builder withBody(DigitalRuleSet body) {
		...
		public Builder withRequiredParams(String digitalRuleSetId, DigitalRuleSet body) {
			request.setDigitalRuleSetId(digitalRuleSetId);
			request.setBody(body);
		...
		public PutOutboundDigitalrulesetRequest build() {
            ...
            // verify the required parameter 'digitalRuleSetId' is set
            if (request.digitalRuleSetId == null) {
                throw new IllegalStateException("Missing the required parameter 'digitalRuleSetId' when building request for PutOutboundDigitalrulesetRequest.");
            }
