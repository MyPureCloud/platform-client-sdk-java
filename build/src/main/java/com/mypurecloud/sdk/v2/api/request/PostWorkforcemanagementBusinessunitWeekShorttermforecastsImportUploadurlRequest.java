...
public class PostWorkforcemanagementBusinessunitWeekShorttermforecastsImportUploadurlRequest {
	...
	public PostWorkforcemanagementBusinessunitWeekShorttermforecastsImportUploadurlRequest withBusinessUnitId(String businessUnitId) {
	...
	public PostWorkforcemanagementBusinessunitWeekShorttermforecastsImportUploadurlRequest withWeekDateId(LocalDate weekDateId) {
	...
	public PostWorkforcemanagementBusinessunitWeekShorttermforecastsImportUploadurlRequest withBody(UploadUrlRequestBody body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementBusinessunitWeekShorttermforecastsImportUploadurlRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<UploadUrlRequestBody> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PostWorkforcemanagementBusinessunitWeekShorttermforecastsImportUploadurlRequest.");
        }
        
        // verify the required parameter 'weekDateId' is set
        if (this.weekDateId == null) {
            throw new IllegalStateException("Missing the required parameter 'weekDateId' when building request for PostWorkforcemanagementBusinessunitWeekShorttermforecastsImportUploadurlRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementBusinessunitWeekShorttermforecastsImportUploadurlRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/weeks/{weekDateId}/shorttermforecasts/import/uploadurl")
	...
	public static Builder builder(String businessUnitId, LocalDate weekDateId, UploadUrlRequestBody body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementBusinessunitWeekShorttermforecastsImportUploadurlRequest request;

		private Builder() {
			request = new PostWorkforcemanagementBusinessunitWeekShorttermforecastsImportUploadurlRequest();
		}
		...
		public Builder withRequiredParams(String businessUnitId, LocalDate weekDateId, UploadUrlRequestBody body) {
			request.setBusinessUnitId(businessUnitId);
						request.setWeekDateId(weekDateId);
						request.setBody(body);
		...
		public PostWorkforcemanagementBusinessunitWeekShorttermforecastsImportUploadurlRequest build() {
