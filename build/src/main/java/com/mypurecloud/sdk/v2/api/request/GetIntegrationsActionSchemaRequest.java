...
public class GetIntegrationsActionSchemaRequest {
	...
	public GetIntegrationsActionSchemaRequest withActionId(String actionId) {
	...
	public GetIntegrationsActionSchemaRequest withFileName(String fileName) {
    ...
    public GetIntegrationsActionSchemaRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.actionId == null) {
            throw new IllegalStateException("Missing the required parameter 'actionId' when building request for GetIntegrationsActionSchemaRequest.");
        }
        
        // verify the required parameter 'fileName' is set
        if (this.fileName == null) {
            throw new IllegalStateException("Missing the required parameter 'fileName' when building request for GetIntegrationsActionSchemaRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/integrations/actions/{actionId}/schemas/{fileName}")
	...
	public static class Builder {
		private final GetIntegrationsActionSchemaRequest request;

		private Builder() {
			request = new GetIntegrationsActionSchemaRequest();
		}
		...
		public GetIntegrationsActionSchemaRequest build() {
