...
public class DialerDnclistConfigChangeImportStatus  implements Serializable {
 ...
 @JsonDeserialize(using = ImportStateEnumDeserializer.class)
  ...
  /**
   **/
  public DialerDnclistConfigChangeImportStatus totalRecords(Integer totalRecords) {
  ...
  /**
   **/
  public DialerDnclistConfigChangeImportStatus completedRecords(Integer completedRecords) {
  ...
  /**
   **/
  public DialerDnclistConfigChangeImportStatus percentageComplete(Integer percentageComplete) {
  ...
  /**
   **/
  public DialerDnclistConfigChangeImportStatus additionalProperties(Object additionalProperties) {
