...
public class GetOrgauthorizationTrusteeGroupsRequest {
	...
	public GetOrgauthorizationTrusteeGroupsRequest withTrusteeOrgId(String trusteeOrgId) {
	...
	public GetOrgauthorizationTrusteeGroupsRequest withPageSize(Integer pageSize) {
	...
	public GetOrgauthorizationTrusteeGroupsRequest withPageNumber(Integer pageNumber) {
    ...
    public GetOrgauthorizationTrusteeGroupsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.trusteeOrgId == null) {
            throw new IllegalStateException("Missing the required parameter 'trusteeOrgId' when building request for GetOrgauthorizationTrusteeGroupsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/orgauthorization/trustees/{trusteeOrgId}/groups")
	...
	public static class Builder {
		private final GetOrgauthorizationTrusteeGroupsRequest request;

		private Builder() {
			request = new GetOrgauthorizationTrusteeGroupsRequest();
		}
		...
		public GetOrgauthorizationTrusteeGroupsRequest build() {
