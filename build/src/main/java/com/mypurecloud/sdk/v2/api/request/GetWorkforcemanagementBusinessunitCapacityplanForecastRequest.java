...
public class GetWorkforcemanagementBusinessunitCapacityplanForecastRequest {
	...
	public GetWorkforcemanagementBusinessunitCapacityplanForecastRequest withBusinessUnitId(String businessUnitId) {
	...
	public GetWorkforcemanagementBusinessunitCapacityplanForecastRequest withCapacityPlanId(String capacityPlanId) {
	...
	public GetWorkforcemanagementBusinessunitCapacityplanForecastRequest withGranularity(String granularity) {
    ...
    public GetWorkforcemanagementBusinessunitCapacityplanForecastRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for GetWorkforcemanagementBusinessunitCapacityplanForecastRequest.");
        }
        
        // verify the required parameter 'capacityPlanId' is set
        if (this.capacityPlanId == null) {
            throw new IllegalStateException("Missing the required parameter 'capacityPlanId' when building request for GetWorkforcemanagementBusinessunitCapacityplanForecastRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/capacityplans/{capacityPlanId}/forecast")
	...
	public static class Builder {
		private final GetWorkforcemanagementBusinessunitCapacityplanForecastRequest request;

		private Builder() {
			request = new GetWorkforcemanagementBusinessunitCapacityplanForecastRequest();
		}
		...
		public GetWorkforcemanagementBusinessunitCapacityplanForecastRequest build() {
