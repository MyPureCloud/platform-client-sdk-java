...
public class GetExternalcontactsImportCsvUploadPreviewRequest {
	...
	public GetExternalcontactsImportCsvUploadPreviewRequest withUploadId(String uploadId) {
    ...
    public GetExternalcontactsImportCsvUploadPreviewRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.uploadId == null) {
            throw new IllegalStateException("Missing the required parameter 'uploadId' when building request for GetExternalcontactsImportCsvUploadPreviewRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/externalcontacts/import/csv/uploads/{uploadId}/preview")
	...
	public static class Builder {
		private final GetExternalcontactsImportCsvUploadPreviewRequest request;

		private Builder() {
			request = new GetExternalcontactsImportCsvUploadPreviewRequest();
		}
		...
		public GetExternalcontactsImportCsvUploadPreviewRequest build() {
