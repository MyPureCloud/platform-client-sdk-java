...
public class QueueConversationChatEventTopicScoredAgent  implements Serializable {
  ...
  public QueueConversationChatEventTopicScoredAgent() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
    }
  }

  public QueueConversationChatEventTopicScoredAgent(Boolean initWithEmptyList) {
   ...
   **/
  public QueueConversationChatEventTopicScoredAgent score(Long score) {
    this.score = score;
    return this;
  }
