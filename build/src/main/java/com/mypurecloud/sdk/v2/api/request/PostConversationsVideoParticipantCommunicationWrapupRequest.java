...
public class PostConversationsVideoParticipantCommunicationWrapupRequest {
	...
	public PostConversationsVideoParticipantCommunicationWrapupRequest withConversationId(String conversationId) {
	...
	public PostConversationsVideoParticipantCommunicationWrapupRequest withParticipantId(String participantId) {
	...
	public PostConversationsVideoParticipantCommunicationWrapupRequest withCommunicationId(String communicationId) {
	...
	public PostConversationsVideoParticipantCommunicationWrapupRequest withBody(ExtendedWrapup body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostConversationsVideoParticipantCommunicationWrapupRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<ExtendedWrapup> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PostConversationsVideoParticipantCommunicationWrapupRequest.");
        }
        
        // verify the required parameter 'participantId' is set
        if (this.participantId == null) {
            throw new IllegalStateException("Missing the required parameter 'participantId' when building request for PostConversationsVideoParticipantCommunicationWrapupRequest.");
        }
        
        // verify the required parameter 'communicationId' is set
        if (this.communicationId == null) {
            throw new IllegalStateException("Missing the required parameter 'communicationId' when building request for PostConversationsVideoParticipantCommunicationWrapupRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/conversations/videos/{conversationId}/participants/{participantId}/communications/{communicationId}/wrapup")
	...
	public static class Builder {
		private final PostConversationsVideoParticipantCommunicationWrapupRequest request;

		private Builder() {
			request = new PostConversationsVideoParticipantCommunicationWrapupRequest();
		}
		...
		public PostConversationsVideoParticipantCommunicationWrapupRequest build() {
