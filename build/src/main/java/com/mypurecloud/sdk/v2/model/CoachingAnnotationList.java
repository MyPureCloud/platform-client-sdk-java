...
public class CoachingAnnotationList  implements Serializable, PagedResource<CoachingAnnotation> {
  ...
  /**
   **/
  public CoachingAnnotationList entities(List<CoachingAnnotation> entities) {
  ...
  public List<CoachingAnnotation> getEntities() {
    return entities;
  }
  public void setEntities(List<CoachingAnnotation> entities) {
    this.entities = entities;
  }
