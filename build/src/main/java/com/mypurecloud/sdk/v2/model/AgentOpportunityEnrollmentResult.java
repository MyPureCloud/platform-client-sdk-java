...
public class AgentOpportunityEnrollmentResult  implements Serializable {
 ...
 @JsonDeserialize(using = DenialCodeEnumDeserializer.class)
  ...
  public AgentOpportunityEnrollmentResult(Boolean initWithEmptyList) {
   ...
   * The current status of the enrollment
   **/
  public AgentOpportunityEnrollmentResult status(StatusEnum status) {
    this.status = status;
    return this;
  }
   ...
   **/
  public AgentOpportunityEnrollmentResult schedule(BuScheduleReference schedule) {
   ...
   * The system-generated message code about enrollment processing results or failures
   **/
  public AgentOpportunityEnrollmentResult systemMessageCode(SystemMessageCodeEnum systemMessageCode) {
   ...
   **/
  public AgentOpportunityEnrollmentResult reviewNote(String reviewNote) {
   ...
   * The denial code
   **/
  public AgentOpportunityEnrollmentResult denialCode(DenialCodeEnum denialCode) {
   ...
   **/
  public AgentOpportunityEnrollmentResult metadata(WfmVersionedEntityMetadata metadata) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    AgentOpportunityEnrollmentResult agentOpportunityEnrollmentResult = (AgentOpportunityEnrollmentResult) o;

    return Objects.equals(this.id, agentOpportunityEnrollmentResult.id) &&
            Objects.equals(this.status, agentOpportunityEnrollmentResult.status) &&
            Objects.equals(this.schedule, agentOpportunityEnrollmentResult.schedule) &&
            Objects.equals(this.systemMessageCode, agentOpportunityEnrollmentResult.systemMessageCode) &&
            Objects.equals(this.reviewNote, agentOpportunityEnrollmentResult.reviewNote) &&
            Objects.equals(this.denialCode, agentOpportunityEnrollmentResult.denialCode) &&
            Objects.equals(this.metadata, agentOpportunityEnrollmentResult.metadata);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, status, schedule, systemMessageCode, reviewNote, denialCode, metadata);
  }
