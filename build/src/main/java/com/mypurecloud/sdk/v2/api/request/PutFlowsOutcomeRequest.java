...
public class PutFlowsOutcomeRequest {
	...
	public PutFlowsOutcomeRequest withFlowOutcomeId(String flowOutcomeId) {
	    this.setFlowOutcomeId(flowOutcomeId);
	    return this;
	} 
	
	private FlowOutcome body;
	public FlowOutcome getBody() {
		return this.body;
	}

	public void setBody(FlowOutcome body) {
		this.body = body;
	}

	public PutFlowsOutcomeRequest withBody(FlowOutcome body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutFlowsOutcomeRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<FlowOutcome> withHttpInfo() {
        
        // verify the required parameter 'flowOutcomeId' is set
        if (this.flowOutcomeId == null) {
            throw new IllegalStateException("Missing the required parameter 'flowOutcomeId' when building request for PutFlowsOutcomeRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/flows/outcomes/{flowOutcomeId}")
	...
	public static class Builder {
		private final PutFlowsOutcomeRequest request;

		private Builder() {
			request = new PutFlowsOutcomeRequest();
		}
		...
		public Builder withBody(FlowOutcome body) {
		...
		public PutFlowsOutcomeRequest build() {
