...
public class PostWorkforcemanagementSchedulingpreferencesQueryRequest {
	...
	public PostWorkforcemanagementSchedulingpreferencesQueryRequest withBody(QueryAgentSchedulingPreferencesRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementSchedulingpreferencesQueryRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<QueryAgentSchedulingPreferencesRequest> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementSchedulingpreferencesQueryRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/schedulingpreferences/query")
                .withBody(body)
	...
	public static Builder builder(QueryAgentSchedulingPreferencesRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementSchedulingpreferencesQueryRequest request;

		private Builder() {
			request = new PostWorkforcemanagementSchedulingpreferencesQueryRequest();
		}
		...
		public Builder withRequiredParams(QueryAgentSchedulingPreferencesRequest body) {
			request.setBody(body);
		...
		public PostWorkforcemanagementSchedulingpreferencesQueryRequest build() {
