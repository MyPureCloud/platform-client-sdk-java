...
public class ConversationEventTopicJourneyActionMap  implements Serializable {
  ...
  public ConversationEventTopicJourneyActionMap() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
    }
  }

  public ConversationEventTopicJourneyActionMap(Boolean initWithEmptyList) {
   ...
   **/
  public ConversationEventTopicJourneyActionMap version(Long version) {
