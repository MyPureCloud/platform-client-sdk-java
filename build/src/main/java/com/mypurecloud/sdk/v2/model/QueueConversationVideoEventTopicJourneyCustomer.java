...
public class QueueConversationVideoEventTopicJourneyCustomer  implements Serializable {
  
  private String id = null;
  private String idType = null;

  public QueueConversationVideoEventTopicJourneyCustomer() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
    }
  }

  public QueueConversationVideoEventTopicJourneyCustomer(Boolean initWithEmptyList) {
   ...
   **/
  public QueueConversationVideoEventTopicJourneyCustomer id(String id) {
    this.id = id;
    return this;
  }
   ...
   **/
  public QueueConversationVideoEventTopicJourneyCustomer idType(String idType) {
    this.idType = idType;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    QueueConversationVideoEventTopicJourneyCustomer queueConversationVideoEventTopicJourneyCustomer = (QueueConversationVideoEventTopicJourneyCustomer) o;

    return Objects.equals(this.id, queueConversationVideoEventTopicJourneyCustomer.id) &&
            Objects.equals(this.idType, queueConversationVideoEventTopicJourneyCustomer.idType);
  }
