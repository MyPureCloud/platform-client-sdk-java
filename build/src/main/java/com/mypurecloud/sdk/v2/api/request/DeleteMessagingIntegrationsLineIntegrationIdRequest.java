...
public class DeleteMessagingIntegrationsLineIntegrationIdRequest {
	...
	public DeleteMessagingIntegrationsLineIntegrationIdRequest withIntegrationId(String integrationId) {
    ...
    public DeleteMessagingIntegrationsLineIntegrationIdRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.integrationId == null) {
            throw new IllegalStateException("Missing the required parameter 'integrationId' when building request for DeleteMessagingIntegrationsLineIntegrationIdRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/messaging/integrations/line/{integrationId}")
	...
	public static class Builder {
		private final DeleteMessagingIntegrationsLineIntegrationIdRequest request;

		private Builder() {
			request = new DeleteMessagingIntegrationsLineIntegrationIdRequest();
		}
		...
		public DeleteMessagingIntegrationsLineIntegrationIdRequest build() {
