...
public class GetAlertingUserpresenceRuleRequest {
	...
	public GetAlertingUserpresenceRuleRequest withRuleId(String ruleId) {
	...
	public GetAlertingUserpresenceRuleRequest withExpand(List<String> expand) {
    ...
    public GetAlertingUserpresenceRuleRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.ruleId == null) {
            throw new IllegalStateException("Missing the required parameter 'ruleId' when building request for GetAlertingUserpresenceRuleRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/alerting/userpresence/rules/{ruleId}")
	...
	public static class Builder {
		private final GetAlertingUserpresenceRuleRequest request;

		private Builder() {
			request = new GetAlertingUserpresenceRuleRequest();
		}
		...
		public GetAlertingUserpresenceRuleRequest build() {
