...
public class GetIntegrationConfigCurrentRequest {
	...
	public GetIntegrationConfigCurrentRequest withIntegrationId(String integrationId) {
    ...
    public GetIntegrationConfigCurrentRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.integrationId == null) {
            throw new IllegalStateException("Missing the required parameter 'integrationId' when building request for GetIntegrationConfigCurrentRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/integrations/{integrationId}/config/current")
	...
	public static class Builder {
		private final GetIntegrationConfigCurrentRequest request;

		private Builder() {
			request = new GetIntegrationConfigCurrentRequest();
		}
		...
		public GetIntegrationConfigCurrentRequest build() {
