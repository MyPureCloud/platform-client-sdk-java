...
public class GetKnowledgeConnectionsRequest {
    ...
    public GetKnowledgeConnectionsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/knowledge/connections")
	...
	public static class Builder {
		private final GetKnowledgeConnectionsRequest request;

		private Builder() {
			request = new GetKnowledgeConnectionsRequest();
		}
		...
		public GetKnowledgeConnectionsRequest build() {
