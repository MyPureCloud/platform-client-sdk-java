...
public class ConversationCallbackEventTopicScoredAgent  implements Serializable {
  ...
  public ConversationCallbackEventTopicScoredAgent() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
    }
  }

  public ConversationCallbackEventTopicScoredAgent(Boolean initWithEmptyList) {
   ...
   **/
  public ConversationCallbackEventTopicScoredAgent score(Long score) {
    this.score = score;
    return this;
  }
