...
public class PutTelephonyProvidersEdgeRequest {
	...
	public PutTelephonyProvidersEdgeRequest withEdgeId(String edgeId) {
	...
	public PutTelephonyProvidersEdgeRequest withBody(Edge body) {
	    this.setBody(body);
	    return this;
	}
    ...
    public PutTelephonyProvidersEdgeRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<Edge> withHttpInfo() throws ApiException {
        
        // verify the required parameter 'edgeId' is set
        if (this.edgeId == null) {
            throw new ApiException(400, "Missing the required parameter 'edgeId' when building request for PutTelephonyProvidersEdgeRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new ApiException(400, "Missing the required parameter 'body' when building request for PutTelephonyProvidersEdgeRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/telephony/providers/edges/{edgeId}")
	...
	public static Builder builder(String edgeId, Edge body) {
	    return new Builder()
	            .withRequiredParams(edgeId, body);
	}

	public static class Builder {
		private final PutTelephonyProvidersEdgeRequest request;

		private Builder() {
			request = new PutTelephonyProvidersEdgeRequest();
		}
		...
		public Builder withBody(Edge body) {
			request.setBody(body);
			return this;
		}

		public Builder withRequiredParams(String edgeId, Edge body) {
			request.setEdgeId(edgeId);
			request.setBody(body);
			return this;
		}
		...
		public PutTelephonyProvidersEdgeRequest build() {
			return request;
		}
	}
}
