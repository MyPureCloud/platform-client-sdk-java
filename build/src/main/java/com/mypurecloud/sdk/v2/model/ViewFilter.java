...
import com.mypurecloud.sdk.v2.model.SocialNumericRange;
...
public class ViewFilter  implements Serializable {
 ...
 @JsonDeserialize(using = SegmentTypesEnumDeserializer.class)
  ...
  private static class EmpathyScoreCategoriesEnumDeserializer extends StdDeserializer<EmpathyScoreCategoriesEnum> {
    public EmpathyScoreCategoriesEnumDeserializer() {
      super(EmpathyScoreCategoriesEnumDeserializer.class);
    }

    @Override
    public EmpathyScoreCategoriesEnum deserialize(JsonParser jsonParser, DeserializationContext ctxt)
            throws IOException {
      JsonNode node = jsonParser.getCodec().readTree(jsonParser);
      return EmpathyScoreCategoriesEnum.fromString(node.toString().replace("\"", ""));
    }
  }
  /**
   * Gets or Sets empathyScoreCategories
   */
 @JsonDeserialize(using = EmpathyScoreCategoriesEnumDeserializer.class)
  public enum EmpathyScoreCategoriesEnum {
    ...
    EmpathyScoreCategoriesEnum(String value) {
      this.value = value;
    }

    @JsonCreator
    public static EmpathyScoreCategoriesEnum fromString(String key) {
      if (key == null) return null;

      for (EmpathyScoreCategoriesEnum value : EmpathyScoreCategoriesEnum.values()) {
        if (key.equalsIgnoreCase(value.toString())) {
          return value;
        }
      }

      return EmpathyScoreCategoriesEnum.values()[0];
    }
  ...
  private List<EmpathyScoreCategoriesEnum> empathyScoreCategories = null;

  private static class SentimentScoreCategoriesEnumDeserializer extends StdDeserializer<SentimentScoreCategoriesEnum> {
    public SentimentScoreCategoriesEnumDeserializer() {
      super(SentimentScoreCategoriesEnumDeserializer.class);
    }

    @Override
    public SentimentScoreCategoriesEnum deserialize(JsonParser jsonParser, DeserializationContext ctxt)
            throws IOException {
      JsonNode node = jsonParser.getCodec().readTree(jsonParser);
      return SentimentScoreCategoriesEnum.fromString(node.toString().replace("\"", ""));
    }
  }
  /**
   * Gets or Sets sentimentScoreCategories
   */
 @JsonDeserialize(using = SentimentScoreCategoriesEnumDeserializer.class)
  public enum SentimentScoreCategoriesEnum {
    ...
    SentimentScoreCategoriesEnum(String value) {
      this.value = value;
    }

    @JsonCreator
    public static SentimentScoreCategoriesEnum fromString(String key) {
      if (key == null) return null;

      for (SentimentScoreCategoriesEnum value : SentimentScoreCategoriesEnum.values()) {
        if (key.equalsIgnoreCase(value.toString())) {
          return value;
        }
      }

      return SentimentScoreCategoriesEnum.values()[0];
    }
  ...
  private List<SentimentScoreCategoriesEnum> sentimentScoreCategories = null;

  private static class SentimentTrendCategoriesEnumDeserializer extends StdDeserializer<SentimentTrendCategoriesEnum> {
    public SentimentTrendCategoriesEnumDeserializer() {
      super(SentimentTrendCategoriesEnumDeserializer.class);
    }

    @Override
    public SentimentTrendCategoriesEnum deserialize(JsonParser jsonParser, DeserializationContext ctxt)
            throws IOException {
      JsonNode node = jsonParser.getCodec().readTree(jsonParser);
      return SentimentTrendCategoriesEnum.fromString(node.toString().replace("\"", ""));
    }
  }
  /**
   * Gets or Sets sentimentTrendCategories
   */
 @JsonDeserialize(using = SentimentTrendCategoriesEnumDeserializer.class)
  public enum SentimentTrendCategoriesEnum {
    ...
    SentimentTrendCategoriesEnum(String value) {
      this.value = value;
    }

    @JsonCreator
    public static SentimentTrendCategoriesEnum fromString(String key) {
      if (key == null) return null;

      for (SentimentTrendCategoriesEnum value : SentimentTrendCategoriesEnum.values()) {
        if (key.equalsIgnoreCase(value.toString())) {
          return value;
        }
      }

      return SentimentTrendCategoriesEnum.values()[0];
    }
 ...
 @JsonDeserialize(using = ContentModerationFlagsEnumDeserializer.class)
  ...
  private static class SocialSourceTypesEnumDeserializer extends StdDeserializer<SocialSourceTypesEnum> {
    public SocialSourceTypesEnumDeserializer() {
      super(SocialSourceTypesEnumDeserializer.class);
    }

    @Override
    public SocialSourceTypesEnum deserialize(JsonParser jsonParser, DeserializationContext ctxt)
            throws IOException {
      JsonNode node = jsonParser.getCodec().readTree(jsonParser);
      return SocialSourceTypesEnum.fromString(node.toString().replace("\"", ""));
    }
  }
  /**
   * Gets or Sets socialSourceTypes
   */
 @JsonDeserialize(using = SocialSourceTypesEnumDeserializer.class)
  public enum SocialSourceTypesEnum {
    ...
    SocialSourceTypesEnum(String value) {
      this.value = value;
    }

    @JsonCreator
    public static SocialSourceTypesEnum fromString(String key) {
      if (key == null) return null;

      for (SocialSourceTypesEnum value : SocialSourceTypesEnum.values()) {
        if (key.equalsIgnoreCase(value.toString())) {
          return value;
        }
      }

      return SocialSourceTypesEnum.values()[0];
    }
  ...
  private List<SocialSourceTypesEnum> socialSourceTypes = null;
  private SocialNumericRange socialFollowerRange = null;
  private Boolean socialVerificationStatus = null;
  private NumericRange socialEngagementLikes = null;
  ...
  private static class EngagementSourcesEnumDeserializer extends StdDeserializer<EngagementSourcesEnum> {
    public EngagementSourcesEnumDeserializer() {
      super(EngagementSourcesEnumDeserializer.class);
    }

    @Override
    public EngagementSourcesEnum deserialize(JsonParser jsonParser, DeserializationContext ctxt)
            throws IOException {
      JsonNode node = jsonParser.getCodec().readTree(jsonParser);
      return EngagementSourcesEnum.fromString(node.toString().replace("\"", ""));
    }
  }
  /**
   * Gets or Sets engagementSources
   */
 @JsonDeserialize(using = EngagementSourcesEnumDeserializer.class)
  public enum EngagementSourcesEnum {
    ...
    EngagementSourcesEnum(String value) {
      this.value = value;
    }

    @JsonCreator
    public static EngagementSourcesEnum fromString(String key) {
      if (key == null) return null;

      for (EngagementSourcesEnum value : EngagementSourcesEnum.values()) {
        if (key.equalsIgnoreCase(value.toString())) {
          return value;
        }
      }

      return EngagementSourcesEnum.values()[0];
    }
  ...
  private List<EngagementSourcesEnum> engagementSources = null;
  private Boolean isSnippetRecorded = null;
  private Boolean takeover = null;

  private static class SocialPostTypesEnumDeserializer extends StdDeserializer<SocialPostTypesEnum> {
    public SocialPostTypesEnumDeserializer() {
      super(SocialPostTypesEnumDeserializer.class);
    }

    @Override
    public SocialPostTypesEnum deserialize(JsonParser jsonParser, DeserializationContext ctxt)
            throws IOException {
      JsonNode node = jsonParser.getCodec().readTree(jsonParser);
      return SocialPostTypesEnum.fromString(node.toString().replace("\"", ""));
    }
  }
  /**
   * Gets or Sets socialPostTypes
   */
 @JsonDeserialize(using = SocialPostTypesEnumDeserializer.class)
  public enum SocialPostTypesEnum {
    ...
    SocialPostTypesEnum(String value) {
      this.value = value;
    }

    @JsonCreator
    public static SocialPostTypesEnum fromString(String key) {
      if (key == null) return null;

      for (SocialPostTypesEnum value : SocialPostTypesEnum.values()) {
        if (key.equalsIgnoreCase(value.toString())) {
          return value;
        }
      }

      return SocialPostTypesEnum.values()[0];
    }
  ...
  private List<SocialPostTypesEnum> socialPostTypes = null;
  ...
  public ViewFilter() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
      ...
      socialSourceTypes = new ArrayList<SocialSourceTypesEnum>();
      engagementSources = new ArrayList<EngagementSourcesEnum>();
      socialPostTypes = new ArrayList<SocialPostTypesEnum>();
    }
  }
  ...
  @ApiModelProperty(example = "null", value = "Filter to indicate if push notification is sent")
  ...
  @ApiModelProperty(example = "null", value = "A set of ratings for Google Business Profile")
  @JsonProperty("socialRatings")
   ...
   **/
  public ViewFilter empathyScoreCategories(List<EmpathyScoreCategoriesEnum> empathyScoreCategories) {
    this.empathyScoreCategories = empathyScoreCategories;
    return this;
  }
  
  @ApiModelProperty(example = "null", value = "A set of Empathy Score Categories for filtering")
  @JsonProperty("empathyScoreCategories")
  public List<EmpathyScoreCategoriesEnum> getEmpathyScoreCategories() {
    return empathyScoreCategories;
  }
  public void setEmpathyScoreCategories(List<EmpathyScoreCategoriesEnum> empathyScoreCategories) {
    this.empathyScoreCategories = empathyScoreCategories;
  }
   ...
   **/
  public ViewFilter sentimentScoreCategories(List<SentimentScoreCategoriesEnum> sentimentScoreCategories) {
    this.sentimentScoreCategories = sentimentScoreCategories;
    return this;
  }
  
  @ApiModelProperty(example = "null", value = "A set of Sentiment Score Categories  for filtering")
  @JsonProperty("sentimentScoreCategories")
  public List<SentimentScoreCategoriesEnum> getSentimentScoreCategories() {
    return sentimentScoreCategories;
  }
  public void setSentimentScoreCategories(List<SentimentScoreCategoriesEnum> sentimentScoreCategories) {
    this.sentimentScoreCategories = sentimentScoreCategories;
  }
   ...
   **/
  public ViewFilter sentimentTrendCategories(List<SentimentTrendCategoriesEnum> sentimentTrendCategories) {
    this.sentimentTrendCategories = sentimentTrendCategories;
    return this;
  }
  
  @ApiModelProperty(example = "null", value = "A set of Sentiment Trend Categories for filtering")
  @JsonProperty("sentimentTrendCategories")
  public List<SentimentTrendCategoriesEnum> getSentimentTrendCategories() {
    return sentimentTrendCategories;
  }
  public void setSentimentTrendCategories(List<SentimentTrendCategoriesEnum> sentimentTrendCategories) {
    this.sentimentTrendCategories = sentimentTrendCategories;
  }
   ...
   **/
  public ViewFilter socialSourceTypes(List<SocialSourceTypesEnum> socialSourceTypes) {
    this.socialSourceTypes = socialSourceTypes;
    return this;
  }
  
  @ApiModelProperty(example = "null", value = "A set of Source Types for social filtering")
  @JsonProperty("socialSourceTypes")
  public List<SocialSourceTypesEnum> getSocialSourceTypes() {
    return socialSourceTypes;
  }
  public void setSocialSourceTypes(List<SocialSourceTypesEnum> socialSourceTypes) {
    this.socialSourceTypes = socialSourceTypes;
  }
  ...
  @ApiModelProperty(example = "null", value = "The follower range used to filter the view")
  @JsonProperty("socialFollowerRange")
  public SocialNumericRange getSocialFollowerRange() {
    return socialFollowerRange;
  }
  ...
  @ApiModelProperty(example = "null", value = "Filter to indicate if the posts from verified user")
  @JsonProperty("socialVerificationStatus")
   ...
   **/
  public ViewFilter socialEngagementLikes(NumericRange socialEngagementLikes) {
    this.socialEngagementLikes = socialEngagementLikes;
    return this;
  }
  
  @ApiModelProperty(example = "null", value = "The likes range used to filter the view")
  @JsonProperty("socialEngagementLikes")
  public NumericRange getSocialEngagementLikes() {
    return socialEngagementLikes;
  }
  public void setSocialEngagementLikes(NumericRange socialEngagementLikes) {
    this.socialEngagementLikes = socialEngagementLikes;
  }
   ...
   **/
  public ViewFilter socialEngagementShares(NumericRange socialEngagementShares) {
    this.socialEngagementShares = socialEngagementShares;
    return this;
  }
  
  @ApiModelProperty(example = "null", value = "The shares range used to filter the view")
  @JsonProperty("socialEngagementShares")
  public NumericRange getSocialEngagementShares() {
    return socialEngagementShares;
  }
  public void setSocialEngagementShares(NumericRange socialEngagementShares) {
    this.socialEngagementShares = socialEngagementShares;
  }
   ...
   **/
  public ViewFilter socialEngagementComments(NumericRange socialEngagementComments) {
    this.socialEngagementComments = socialEngagementComments;
    return this;
  }
  
  @ApiModelProperty(example = "null", value = "The comments range used to filter the view")
  @JsonProperty("socialEngagementComments")
  public NumericRange getSocialEngagementComments() {
    return socialEngagementComments;
  }
  public void setSocialEngagementComments(NumericRange socialEngagementComments) {
    this.socialEngagementComments = socialEngagementComments;
  }
   ...
   **/
  public ViewFilter socialEngagementViews(NumericRange socialEngagementViews) {
    this.socialEngagementViews = socialEngagementViews;
    return this;
  }
  
  @ApiModelProperty(example = "null", value = "The views range used to filter the view")
  @JsonProperty("socialEngagementViews")
  public NumericRange getSocialEngagementViews() {
    return socialEngagementViews;
  }
  public void setSocialEngagementViews(NumericRange socialEngagementViews) {
    this.socialEngagementViews = socialEngagementViews;
  }
  ...
  @ApiModelProperty(example = "null", value = "Filter to indicate for if session is expired")
  ...
  @ApiModelProperty(example = "null", value = "Filter to indicate if the interaction was screen monitored")
  @JsonProperty("screenMonitored")
   ...
   **/
  public ViewFilter engagementSources(List<EngagementSourcesEnum> engagementSources) {
    this.engagementSources = engagementSources;
    return this;
  }
  
  @ApiModelProperty(example = "null", value = "The engagement sources used to filter the view")
  @JsonProperty("engagementSources")
  public List<EngagementSourcesEnum> getEngagementSources() {
    return engagementSources;
  }
  public void setEngagementSources(List<EngagementSourcesEnum> engagementSources) {
    this.engagementSources = engagementSources;
  }
  ...
  @ApiModelProperty(example = "null", value = "Indicates filtering for snippet recorded")
  @JsonProperty("isSnippetRecorded")
  public Boolean getIsSnippetRecorded() {
    return isSnippetRecorded;
  }
  ...
  @ApiModelProperty(example = "null", value = "Indicates filtering for takeover")
   ...
   **/
  public ViewFilter socialPostTypes(List<SocialPostTypesEnum> socialPostTypes) {
    this.socialPostTypes = socialPostTypes;
    return this;
  }
  
  @ApiModelProperty(example = "null", value = "The social post types used to filter the view")
  @JsonProperty("socialPostTypes")
  public List<SocialPostTypesEnum> getSocialPostTypes() {
    return socialPostTypes;
  }
  public void setSocialPostTypes(List<SocialPostTypesEnum> socialPostTypes) {
    this.socialPostTypes = socialPostTypes;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.mediaTypes, viewFilter.mediaTypes) &&
            ...
            Objects.equals(this.socialSourceTypes, viewFilter.socialSourceTypes) &&
            Objects.equals(this.socialFollowerRange, viewFilter.socialFollowerRange) &&
            Objects.equals(this.socialVerificationStatus, viewFilter.socialVerificationStatus) &&
            Objects.equals(this.socialEngagementLikes, viewFilter.socialEngagementLikes) &&
            ...
            Objects.equals(this.isSnippetRecorded, viewFilter.isSnippetRecorded) &&
            Objects.equals(this.takeover, viewFilter.takeover) &&
            Objects.equals(this.socialPostTypes, viewFilter.socialPostTypes);
  }
  ...
  public String toString() {
    ...
    sb.append("    socialSourceTypes: ").append(toIndentedString(socialSourceTypes)).append("\n");
    sb.append("    socialFollowerRange: ").append(toIndentedString(socialFollowerRange)).append("\n");
    sb.append("    socialVerificationStatus: ").append(toIndentedString(socialVerificationStatus)).append("\n");
    sb.append("    socialEngagementLikes: ").append(toIndentedString(socialEngagementLikes)).append("\n");
    ...
    sb.append("    isSnippetRecorded: ").append(toIndentedString(isSnippetRecorded)).append("\n");
    sb.append("    takeover: ").append(toIndentedString(takeover)).append("\n");
    sb.append("    socialPostTypes: ").append(toIndentedString(socialPostTypes)).append("\n");
    sb.append("}");
    return sb.toString();
  }
