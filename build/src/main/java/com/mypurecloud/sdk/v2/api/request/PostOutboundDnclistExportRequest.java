...
public class PostOutboundDnclistExportRequest {
	...
	public PostOutboundDnclistExportRequest withDncListId(String dncListId) {
    ...
    public PostOutboundDnclistExportRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() throws ApiException {
        ...
        if (this.dncListId == null) {
            throw new ApiException(400, "Missing the required parameter 'dncListId' when building request for PostOutboundDnclistExportRequest.");
        }
