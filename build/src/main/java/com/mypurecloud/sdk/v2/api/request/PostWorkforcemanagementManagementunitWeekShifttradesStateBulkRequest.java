...
public class PostWorkforcemanagementManagementunitWeekShifttradesStateBulkRequest {
	...
	public PostWorkforcemanagementManagementunitWeekShifttradesStateBulkRequest withManagementUnitId(String managementUnitId) {
	...
	public PostWorkforcemanagementManagementunitWeekShifttradesStateBulkRequest withWeekDateId(LocalDate weekDateId) {
	    this.setWeekDateId(weekDateId);
	    return this;
	} 
	
	private BulkShiftTradeStateUpdateRequest body;
	public BulkShiftTradeStateUpdateRequest getBody() {
		return this.body;
	}

	public void setBody(BulkShiftTradeStateUpdateRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementManagementunitWeekShifttradesStateBulkRequest withBody(BulkShiftTradeStateUpdateRequest body) {
	    this.setBody(body);
	    return this;
	} 
	...
	public PostWorkforcemanagementManagementunitWeekShifttradesStateBulkRequest withForceAsync(Boolean forceAsync) {
    ...
    public PostWorkforcemanagementManagementunitWeekShifttradesStateBulkRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<BulkShiftTradeStateUpdateRequest> withHttpInfo() {
        
        // verify the required parameter 'managementUnitId' is set
        if (this.managementUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'managementUnitId' when building request for PostWorkforcemanagementManagementunitWeekShifttradesStateBulkRequest.");
        }
        
        // verify the required parameter 'weekDateId' is set
        if (this.weekDateId == null) {
            throw new IllegalStateException("Missing the required parameter 'weekDateId' when building request for PostWorkforcemanagementManagementunitWeekShifttradesStateBulkRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementManagementunitWeekShifttradesStateBulkRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/managementunits/{managementUnitId}/weeks/{weekDateId}/shifttrades/state/bulk")
	...
	public static Builder builder(String managementUnitId, LocalDate weekDateId, BulkShiftTradeStateUpdateRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementManagementunitWeekShifttradesStateBulkRequest request;

		private Builder() {
			request = new PostWorkforcemanagementManagementunitWeekShifttradesStateBulkRequest();
		}
		...
		public Builder withBody(BulkShiftTradeStateUpdateRequest body) {
		...
		public Builder withRequiredParams(String managementUnitId, LocalDate weekDateId, BulkShiftTradeStateUpdateRequest body) {
			request.setManagementUnitId(managementUnitId);
						request.setWeekDateId(weekDateId);
						request.setBody(body);
		...
		public PostWorkforcemanagementManagementunitWeekShifttradesStateBulkRequest build() {
