...
public class GetResponsemanagementLibrariesDivisionviewRequest {
	...
	public GetResponsemanagementLibrariesDivisionviewRequest withLibraryId(String libraryId) {
    ...
    public GetResponsemanagementLibrariesDivisionviewRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.libraryId == null) {
            throw new IllegalStateException("Missing the required parameter 'libraryId' when building request for GetResponsemanagementLibrariesDivisionviewRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/responsemanagement/libraries/divisionviews/{libraryId}")
	...
	public static class Builder {
		private final GetResponsemanagementLibrariesDivisionviewRequest request;

		private Builder() {
			request = new GetResponsemanagementLibrariesDivisionviewRequest();
		}
		...
		public GetResponsemanagementLibrariesDivisionviewRequest build() {
