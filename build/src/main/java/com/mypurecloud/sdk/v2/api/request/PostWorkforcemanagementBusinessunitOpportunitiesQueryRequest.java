...
public class PostWorkforcemanagementBusinessunitOpportunitiesQueryRequest {
	...
	public PostWorkforcemanagementBusinessunitOpportunitiesQueryRequest withBusinessUnitId(String businessUnitId) {
	    this.setBusinessUnitId(businessUnitId);
	    return this;
	} 

	private QueryOpportunitiesRequest body;
	public QueryOpportunitiesRequest getBody() {
		return this.body;
	}

	public void setBody(QueryOpportunitiesRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementBusinessunitOpportunitiesQueryRequest withBody(QueryOpportunitiesRequest body) {
	    this.setBody(body);
	    return this;
	} 
	...
	public PostWorkforcemanagementBusinessunitOpportunitiesQueryRequest withForceDownloadService(Boolean forceDownloadService) {
    ...
    public PostWorkforcemanagementBusinessunitOpportunitiesQueryRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<QueryOpportunitiesRequest> withHttpInfo() {
        
        // verify the required parameter 'businessUnitId' is set
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PostWorkforcemanagementBusinessunitOpportunitiesQueryRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementBusinessunitOpportunitiesQueryRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/opportunities/query")
	...
	public static Builder builder(String businessUnitId, QueryOpportunitiesRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementBusinessunitOpportunitiesQueryRequest request;

		private Builder() {
			request = new PostWorkforcemanagementBusinessunitOpportunitiesQueryRequest();
		}
		...
		public Builder withBody(QueryOpportunitiesRequest body) {
		...
		public Builder withRequiredParams(String businessUnitId, QueryOpportunitiesRequest body) {
			request.setBusinessUnitId(businessUnitId);
			request.setBody(body);
		...
		public PostWorkforcemanagementBusinessunitOpportunitiesQueryRequest build() {
