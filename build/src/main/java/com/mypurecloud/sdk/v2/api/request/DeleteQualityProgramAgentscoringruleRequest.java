...
public class DeleteQualityProgramAgentscoringruleRequest {
	...
	public DeleteQualityProgramAgentscoringruleRequest withProgramId(String programId) {
	...
	public DeleteQualityProgramAgentscoringruleRequest withRuleId(String ruleId) {
    ...
    public DeleteQualityProgramAgentscoringruleRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.programId == null) {
            throw new IllegalStateException("Missing the required parameter 'programId' when building request for DeleteQualityProgramAgentscoringruleRequest.");
        }
        
        // verify the required parameter 'ruleId' is set
        if (this.ruleId == null) {
            throw new IllegalStateException("Missing the required parameter 'ruleId' when building request for DeleteQualityProgramAgentscoringruleRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/quality/programs/{programId}/agentscoringrules/{ruleId}")
	...
	public static class Builder {
		private final DeleteQualityProgramAgentscoringruleRequest request;

		private Builder() {
			request = new DeleteQualityProgramAgentscoringruleRequest();
		}
		...
		public DeleteQualityProgramAgentscoringruleRequest build() {
