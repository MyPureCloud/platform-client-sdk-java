...
public class GetBusinessrulesDecisiontableExportsRequest {
	...
	public GetBusinessrulesDecisiontableExportsRequest withTableId(String tableId) {
	...
	public GetBusinessrulesDecisiontableExportsRequest withAfter(String after) {
	    this.setAfter(after);
	    return this;
	} 
	...
	public GetBusinessrulesDecisiontableExportsRequest withPageSize(String pageSize) {
    ...
    public GetBusinessrulesDecisiontableExportsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.tableId == null) {
            throw new IllegalStateException("Missing the required parameter 'tableId' when building request for GetBusinessrulesDecisiontableExportsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/businessrules/decisiontables/{tableId}/exports")
	...
	public static class Builder {
		private final GetBusinessrulesDecisiontableExportsRequest request;

		private Builder() {
			request = new GetBusinessrulesDecisiontableExportsRequest();
		}
		...
		public GetBusinessrulesDecisiontableExportsRequest build() {
