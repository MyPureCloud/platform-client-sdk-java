...
public class GetWorkforcemanagementManagementunitShifttradesUsersRequest {
	...
	public GetWorkforcemanagementManagementunitShifttradesUsersRequest withManagementUnitId(String managementUnitId) {
    ...
    public GetWorkforcemanagementManagementunitShifttradesUsersRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.managementUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'managementUnitId' when building request for GetWorkforcemanagementManagementunitShifttradesUsersRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/managementunits/{managementUnitId}/shifttrades/users")
	...
	public static class Builder {
		private final GetWorkforcemanagementManagementunitShifttradesUsersRequest request;

		private Builder() {
			request = new GetWorkforcemanagementManagementunitShifttradesUsersRequest();
		}
		...
		public GetWorkforcemanagementManagementunitShifttradesUsersRequest build() {
