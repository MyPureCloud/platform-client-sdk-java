...
public class GetWorkforcemanagementManagementunitShifttradesUsersRequest {
	...
	public GetWorkforcemanagementManagementunitShifttradesUsersRequest withMuId(String muId) {
	    this.setMuId(muId);
	    return this;
	} 
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.muId == null) {
            throw new IllegalStateException("Missing the required parameter 'muId' when building request for GetWorkforcemanagementManagementunitShifttradesUsersRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/managementunits/{muId}/shifttrades/users")
