...
public class TimeOffRequestListItem  implements Serializable {
 ...
 @JsonDeserialize(using = SubstatusEnumDeserializer.class)
  ...
  public TimeOffRequestListItem(Boolean initWithEmptyList) {
   ...
   **/
  public TimeOffRequestListItem id(String id) {
    this.id = id;
    return this;
  }
   ...
   **/
  public TimeOffRequestListItem user(UserReference user) {
    this.user = user;
    return this;
  }
   ...
   **/
  public TimeOffRequestListItem isFullDayRequest(Boolean isFullDayRequest) {
   ...
   **/
  public TimeOffRequestListItem markedAsRead(Boolean markedAsRead) {
   ...
   **/
  public TimeOffRequestListItem activityCodeId(String activityCodeId) {
   ...
   **/
  public TimeOffRequestListItem paid(Boolean paid) {
    this.paid = paid;
    return this;
  }
   ...
   * The status of this time off request
   **/
  public TimeOffRequestListItem status(StatusEnum status) {
    this.status = status;
    return this;
  }
   ...
   * The substatus of this time off request
   **/
  public TimeOffRequestListItem substatus(SubstatusEnum substatus) {
   ...
   **/
  public TimeOffRequestListItem partialDayStartDateTimes(List<Date> partialDayStartDateTimes) {
   ...
   **/
  public TimeOffRequestListItem fullDayManagementUnitDates(List<String> fullDayManagementUnitDates) {
   ...
   **/
  public TimeOffRequestListItem dailyDurationMinutes(Integer dailyDurationMinutes) {
   ...
   **/
  public TimeOffRequestListItem durationMinutes(List<Integer> durationMinutes) {
   ...
   **/
  public TimeOffRequestListItem payableMinutes(List<Integer> payableMinutes) {
   ...
   **/
  public TimeOffRequestListItem fullDayEarliestStartOffsetMinutes(List<Integer> fullDayEarliestStartOffsetMinutes) {
   ...
   **/
  public TimeOffRequestListItem fullDayLatestEndOffsetMinutes(List<Integer> fullDayLatestEndOffsetMinutes) {
   ...
   **/
  public TimeOffRequestListItem notes(String notes) {
    this.notes = notes;
    return this;
  }
   ...
   **/
  public TimeOffRequestListItem submittedBy(UserReference submittedBy) {
   ...
   **/
  public TimeOffRequestListItem submittedDate(Date submittedDate) {
   ...
   **/
  public TimeOffRequestListItem reviewedBy(UserReference reviewedBy) {
   ...
   **/
  public TimeOffRequestListItem reviewedDate(Date reviewedDate) {
   ...
   **/
  public TimeOffRequestListItem syncVersion(Integer syncVersion) {
   ...
   **/
  public TimeOffRequestListItem metadata(WfmVersionedEntityMetadata metadata) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TimeOffRequestListItem timeOffRequestListItem = (TimeOffRequestListItem) o;

    return Objects.equals(this.id, timeOffRequestListItem.id) &&
            Objects.equals(this.user, timeOffRequestListItem.user) &&
            Objects.equals(this.isFullDayRequest, timeOffRequestListItem.isFullDayRequest) &&
            Objects.equals(this.markedAsRead, timeOffRequestListItem.markedAsRead) &&
            Objects.equals(this.activityCodeId, timeOffRequestListItem.activityCodeId) &&
            Objects.equals(this.paid, timeOffRequestListItem.paid) &&
            Objects.equals(this.status, timeOffRequestListItem.status) &&
            Objects.equals(this.substatus, timeOffRequestListItem.substatus) &&
            Objects.equals(this.partialDayStartDateTimes, timeOffRequestListItem.partialDayStartDateTimes) &&
            Objects.equals(this.fullDayManagementUnitDates, timeOffRequestListItem.fullDayManagementUnitDates) &&
            Objects.equals(this.dailyDurationMinutes, timeOffRequestListItem.dailyDurationMinutes) &&
            Objects.equals(this.durationMinutes, timeOffRequestListItem.durationMinutes) &&
            Objects.equals(this.payableMinutes, timeOffRequestListItem.payableMinutes) &&
            Objects.equals(this.fullDayEarliestStartOffsetMinutes, timeOffRequestListItem.fullDayEarliestStartOffsetMinutes) &&
            Objects.equals(this.fullDayLatestEndOffsetMinutes, timeOffRequestListItem.fullDayLatestEndOffsetMinutes) &&
            Objects.equals(this.notes, timeOffRequestListItem.notes) &&
            Objects.equals(this.submittedBy, timeOffRequestListItem.submittedBy) &&
            Objects.equals(this.submittedDate, timeOffRequestListItem.submittedDate) &&
            Objects.equals(this.reviewedBy, timeOffRequestListItem.reviewedBy) &&
            Objects.equals(this.reviewedDate, timeOffRequestListItem.reviewedDate) &&
            Objects.equals(this.syncVersion, timeOffRequestListItem.syncVersion) &&
            Objects.equals(this.metadata, timeOffRequestListItem.metadata) &&
            Objects.equals(this.selfUri, timeOffRequestListItem.selfUri);
  }
