...
public class GetAnalyticsKnowledgeAggregatesJobResultsRequest {
	...
	public GetAnalyticsKnowledgeAggregatesJobResultsRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
	...
	public GetAnalyticsKnowledgeAggregatesJobResultsRequest withCursor(String cursor) {
    ...
    public GetAnalyticsKnowledgeAggregatesJobResultsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetAnalyticsKnowledgeAggregatesJobResultsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/analytics/knowledge/aggregates/jobs/{jobId}/results")
	...
	public static class Builder {
		private final GetAnalyticsKnowledgeAggregatesJobResultsRequest request;

		private Builder() {
			request = new GetAnalyticsKnowledgeAggregatesJobResultsRequest();
		}
		...
		public GetAnalyticsKnowledgeAggregatesJobResultsRequest build() {
