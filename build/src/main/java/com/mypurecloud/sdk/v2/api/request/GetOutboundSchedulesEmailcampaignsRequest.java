...
public class GetOutboundSchedulesEmailcampaignsRequest {
    ...
    public GetOutboundSchedulesEmailcampaignsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/outbound/schedules/emailcampaigns")
	...
	public static class Builder {
		private final GetOutboundSchedulesEmailcampaignsRequest request;

		private Builder() {
			request = new GetOutboundSchedulesEmailcampaignsRequest();
		}
		...
		public GetOutboundSchedulesEmailcampaignsRequest build() {
