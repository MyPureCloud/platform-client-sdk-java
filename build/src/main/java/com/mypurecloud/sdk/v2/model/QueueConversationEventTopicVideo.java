...
public class QueueConversationEventTopicVideo  implements Serializable {
 ...
 @JsonDeserialize(using = DisconnectTypeEnumDeserializer.class)
  ...
  public QueueConversationEventTopicVideo(Boolean initWithEmptyList) {
  ...
  /**
   **/
  public QueueConversationEventTopicVideo initialState(InitialStateEnum initialState) {
   ...
   **/
  public QueueConversationEventTopicVideo peerCount(Long peerCount) {
   ...
   **/
  public QueueConversationEventTopicVideo queueMediaSettings(QueueConversationEventTopicQueueMediaSettings queueMediaSettings) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.state, queueConversationEventTopicVideo.state) &&
            Objects.equals(this.initialState, queueConversationEventTopicVideo.initialState) &&
            ...
            Objects.equals(this.queueMediaSettings, queueConversationEventTopicVideo.queueMediaSettings);
  }

  @Override
  public int hashCode() {
    return Objects.hash(state, initialState, self, id, context, audioMuted, videoMuted, sharingScreen, peerCount, provider, scriptId, peerId, disconnectType, connectedTime, disconnectedTime, msids, wrapup, afterCallWork, afterCallWorkRequired, queueMediaSettings);
  }
