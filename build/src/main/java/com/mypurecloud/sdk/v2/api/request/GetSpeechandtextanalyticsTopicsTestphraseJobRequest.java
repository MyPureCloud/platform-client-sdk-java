...
public class GetSpeechandtextanalyticsTopicsTestphraseJobRequest {
	...
	public GetSpeechandtextanalyticsTopicsTestphraseJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetSpeechandtextanalyticsTopicsTestphraseJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetSpeechandtextanalyticsTopicsTestphraseJobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/speechandtextanalytics/topics/testphrase/jobs/{jobId}")
	...
	public static class Builder {
		private final GetSpeechandtextanalyticsTopicsTestphraseJobRequest request;

		private Builder() {
			request = new GetSpeechandtextanalyticsTopicsTestphraseJobRequest();
		}
		...
		public GetSpeechandtextanalyticsTopicsTestphraseJobRequest build() {
