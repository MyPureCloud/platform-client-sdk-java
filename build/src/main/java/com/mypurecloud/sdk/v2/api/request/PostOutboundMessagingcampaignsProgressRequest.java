...
public class PostOutboundMessagingcampaignsProgressRequest {
	...
	public PostOutboundMessagingcampaignsProgressRequest withBody(List<String> body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostOutboundMessagingcampaignsProgressRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<List<String>> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostOutboundMessagingcampaignsProgressRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/outbound/messagingcampaigns/progress")
                .withBody(body)
	...
	public static class Builder {
		private final PostOutboundMessagingcampaignsProgressRequest request;

		private Builder() {
			request = new PostOutboundMessagingcampaignsProgressRequest();
		}
		...
		public PostOutboundMessagingcampaignsProgressRequest build() {
