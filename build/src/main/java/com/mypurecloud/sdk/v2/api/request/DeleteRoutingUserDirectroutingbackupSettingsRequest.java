...
public class DeleteRoutingUserDirectroutingbackupSettingsRequest {
	...
	public DeleteRoutingUserDirectroutingbackupSettingsRequest withUserId(String userId) {
    ...
    public DeleteRoutingUserDirectroutingbackupSettingsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.userId == null) {
            throw new IllegalStateException("Missing the required parameter 'userId' when building request for DeleteRoutingUserDirectroutingbackupSettingsRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/routing/users/{userId}/directroutingbackup/settings")
	...
	public static class Builder {
		private final DeleteRoutingUserDirectroutingbackupSettingsRequest request;

		private Builder() {
			request = new DeleteRoutingUserDirectroutingbackupSettingsRequest();
		}
		...
		public DeleteRoutingUserDirectroutingbackupSettingsRequest build() {
