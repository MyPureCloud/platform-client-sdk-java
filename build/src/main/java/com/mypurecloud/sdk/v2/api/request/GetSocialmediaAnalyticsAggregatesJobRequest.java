...
public class GetSocialmediaAnalyticsAggregatesJobRequest {
	...
	public GetSocialmediaAnalyticsAggregatesJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetSocialmediaAnalyticsAggregatesJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetSocialmediaAnalyticsAggregatesJobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/socialmedia/analytics/aggregates/jobs/{jobId}")
	...
	public static class Builder {
		private final GetSocialmediaAnalyticsAggregatesJobRequest request;

		private Builder() {
			request = new GetSocialmediaAnalyticsAggregatesJobRequest();
		}
		...
		public GetSocialmediaAnalyticsAggregatesJobRequest build() {
