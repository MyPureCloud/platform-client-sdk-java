...
public class GetQualityPublishedformsEvaluationRequest {
	...
	public GetQualityPublishedformsEvaluationRequest withFormId(String formId) {
    ...
    public GetQualityPublishedformsEvaluationRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.formId == null) {
            throw new IllegalStateException("Missing the required parameter 'formId' when building request for GetQualityPublishedformsEvaluationRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/quality/publishedforms/evaluations/{formId}")
	...
	public static class Builder {
		private final GetQualityPublishedformsEvaluationRequest request;

		private Builder() {
			request = new GetQualityPublishedformsEvaluationRequest();
		}
		...
		public GetQualityPublishedformsEvaluationRequest build() {
