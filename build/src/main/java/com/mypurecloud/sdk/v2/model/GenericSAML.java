...
public class GenericSAML  implements Serializable {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, relyingPartyIdentifier, endpointCompression, nameIdentifierFormat, logoImageData, certificate, issuerURI, ssoTargetURI, disabled, selfUri);
  }
