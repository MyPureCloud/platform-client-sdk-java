...
public class GetOutboundCampaignSkillcombinationsRequest {
	...
	public GetOutboundCampaignSkillcombinationsRequest withCampaignId(String campaignId) {
	...
	public GetOutboundCampaignSkillcombinationsRequest withPageNumber(Integer pageNumber) {
	...
	public GetOutboundCampaignSkillcombinationsRequest withPageSize(Integer pageSize) {
    ...
    public GetOutboundCampaignSkillcombinationsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.campaignId == null) {
            throw new IllegalStateException("Missing the required parameter 'campaignId' when building request for GetOutboundCampaignSkillcombinationsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/outbound/campaigns/{campaignId}/skillcombinations")
	...
	public static class Builder {
		private final GetOutboundCampaignSkillcombinationsRequest request;

		private Builder() {
			request = new GetOutboundCampaignSkillcombinationsRequest();
		}
		...
		public GetOutboundCampaignSkillcombinationsRequest build() {
