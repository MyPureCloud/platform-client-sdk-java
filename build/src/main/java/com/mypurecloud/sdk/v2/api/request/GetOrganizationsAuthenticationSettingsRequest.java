...
public class GetOrganizationsAuthenticationSettingsRequest {
    ...
    public GetOrganizationsAuthenticationSettingsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/organizations/authentication/settings")
	...
	public static class Builder {
		private final GetOrganizationsAuthenticationSettingsRequest request;

		private Builder() {
			request = new GetOrganizationsAuthenticationSettingsRequest();
		}
		...
		public GetOrganizationsAuthenticationSettingsRequest build() {
