...
public class PostFlowsActionsCheckoutRequest {
	...
	public PostFlowsActionsCheckoutRequest withFlow(String flow) {
	    this.setFlow(flow);
	    return this;
	} 
    ...
    public PostFlowsActionsCheckoutRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.flow == null) {
            throw new IllegalStateException("Missing the required parameter 'flow' when building request for PostFlowsActionsCheckoutRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/flows/actions/checkout")
	...
	public static class Builder {
		private final PostFlowsActionsCheckoutRequest request;

		private Builder() {
			request = new PostFlowsActionsCheckoutRequest();
		}
		...
		public PostFlowsActionsCheckoutRequest build() {
