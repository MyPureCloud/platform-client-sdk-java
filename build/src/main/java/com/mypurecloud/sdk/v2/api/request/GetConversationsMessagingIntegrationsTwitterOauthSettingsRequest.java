...
public class GetConversationsMessagingIntegrationsTwitterOauthSettingsRequest {
    ...
    public GetConversationsMessagingIntegrationsTwitterOauthSettingsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/conversations/messaging/integrations/twitter/oauth/settings")
	...
	public static class Builder {
		private final GetConversationsMessagingIntegrationsTwitterOauthSettingsRequest request;

		private Builder() {
			request = new GetConversationsMessagingIntegrationsTwitterOauthSettingsRequest();
		}
		...
		public GetConversationsMessagingIntegrationsTwitterOauthSettingsRequest build() {
