...
public class PostLicenseUsersRequest {
	...
	public PostLicenseUsersRequest withBody(List<String> body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostLicenseUsersRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<List<String>> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("POST", "/api/v2/license/users")
                .withBody(body)
	...
	public static class Builder {
		private final PostLicenseUsersRequest request;

		private Builder() {
			request = new PostLicenseUsersRequest();
		}
		...
		public PostLicenseUsersRequest build() {
