...
public class QueueMemberEntityListing  implements Serializable {
  ...
  /**
   **/
  public QueueMemberEntityListing entities(List<QueueMember> entities) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(entities, pageNumber, pageSize, firstUri, selfUri, previousUri, nextUri);
  }
