...
public class GetAnalyticsResolutionsAggregatesJobResultsRequest {
	...
	public GetAnalyticsResolutionsAggregatesJobResultsRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
	...
	public GetAnalyticsResolutionsAggregatesJobResultsRequest withCursor(String cursor) {
    ...
    public GetAnalyticsResolutionsAggregatesJobResultsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetAnalyticsResolutionsAggregatesJobResultsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/analytics/resolutions/aggregates/jobs/{jobId}/results")
	...
	public static class Builder {
		private final GetAnalyticsResolutionsAggregatesJobResultsRequest request;

		private Builder() {
			request = new GetAnalyticsResolutionsAggregatesJobResultsRequest();
		}
		...
		public GetAnalyticsResolutionsAggregatesJobResultsRequest build() {
