...
public class GetSocialmediaAnalyticsMessagesJobResultsRequest {
	...
	public GetSocialmediaAnalyticsMessagesJobResultsRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
	...
	public GetSocialmediaAnalyticsMessagesJobResultsRequest withCursor(String cursor) {
    ...
    public GetSocialmediaAnalyticsMessagesJobResultsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetSocialmediaAnalyticsMessagesJobResultsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/socialmedia/analytics/messages/jobs/{jobId}/results")
	...
	public static class Builder {
		private final GetSocialmediaAnalyticsMessagesJobResultsRequest request;

		private Builder() {
			request = new GetSocialmediaAnalyticsMessagesJobResultsRequest();
		}
		...
		public GetSocialmediaAnalyticsMessagesJobResultsRequest build() {
