...
public class PostAnalyticsActionsAggregatesJobsRequest {

	private ActionAsyncAggregationQuery body;
	public ActionAsyncAggregationQuery getBody() {
		return this.body;
	}

	public void setBody(ActionAsyncAggregationQuery body) {
		this.body = body;
	}

	public PostAnalyticsActionsAggregatesJobsRequest withBody(ActionAsyncAggregationQuery body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostAnalyticsActionsAggregatesJobsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<ActionAsyncAggregationQuery> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostAnalyticsActionsAggregatesJobsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/analytics/actions/aggregates/jobs")
                .withBody(body)
	...
	public static Builder builder(ActionAsyncAggregationQuery body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostAnalyticsActionsAggregatesJobsRequest request;

		private Builder() {
			request = new PostAnalyticsActionsAggregatesJobsRequest();
		}


		public Builder withBody(ActionAsyncAggregationQuery body) {
		...
		public Builder withRequiredParams(ActionAsyncAggregationQuery body) {
			request.setBody(body);
		...
		public PostAnalyticsActionsAggregatesJobsRequest build() {
