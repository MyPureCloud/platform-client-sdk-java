...
public class GetConversationsMessagingIntegrationsAppleRequest {
	...
	public GetConversationsMessagingIntegrationsAppleRequest withPageSize(Integer pageSize) {
	...
	public GetConversationsMessagingIntegrationsAppleRequest withPageNumber(Integer pageNumber) {
	...
	public GetConversationsMessagingIntegrationsAppleRequest withExpand(String expand) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/conversations/messaging/integrations/apple")
	...
	public static class Builder {
		private final GetConversationsMessagingIntegrationsAppleRequest request;

		private Builder() {
			request = new GetConversationsMessagingIntegrationsAppleRequest();
		}
		...
		public GetConversationsMessagingIntegrationsAppleRequest build() {
