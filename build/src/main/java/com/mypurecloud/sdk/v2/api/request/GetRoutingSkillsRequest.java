...
public class GetRoutingSkillsRequest {
	...
	public GetRoutingSkillsRequest withPageSize(Integer pageSize) {
	...
	public GetRoutingSkillsRequest withPageNumber(Integer pageNumber) {
	...
	public GetRoutingSkillsRequest withName(String name) {
	    this.setName(name);
	    return this;
	} 
    ...
    public GetRoutingSkillsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/routing/skills")
