...
public class GetKnowledgeKnowledgebaseLabelRequest {
	...
	public GetKnowledgeKnowledgebaseLabelRequest withKnowledgeBaseId(String knowledgeBaseId) {
	...
	public GetKnowledgeKnowledgebaseLabelRequest withLabelId(String labelId) {
    ...
    public GetKnowledgeKnowledgebaseLabelRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.knowledgeBaseId == null) {
            throw new IllegalStateException("Missing the required parameter 'knowledgeBaseId' when building request for GetKnowledgeKnowledgebaseLabelRequest.");
        }
        
        // verify the required parameter 'labelId' is set
        if (this.labelId == null) {
            throw new IllegalStateException("Missing the required parameter 'labelId' when building request for GetKnowledgeKnowledgebaseLabelRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/labels/{labelId}")
	...
	public static class Builder {
		private final GetKnowledgeKnowledgebaseLabelRequest request;

		private Builder() {
			request = new GetKnowledgeKnowledgebaseLabelRequest();
		}
		...
		public GetKnowledgeKnowledgebaseLabelRequest build() {
