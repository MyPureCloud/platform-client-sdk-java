...
public class PatchOutboundDnclistCustomexclusioncolumnsRequest {
	...
	public PatchOutboundDnclistCustomexclusioncolumnsRequest withDncListId(String dncListId) {
	    this.setDncListId(dncListId);
	    return this;
	} 

	private DncPatchCustomExclusionColumnsRequest body;
	public DncPatchCustomExclusionColumnsRequest getBody() {
		return this.body;
	}

	public void setBody(DncPatchCustomExclusionColumnsRequest body) {
		this.body = body;
	}

	public PatchOutboundDnclistCustomexclusioncolumnsRequest withBody(DncPatchCustomExclusionColumnsRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchOutboundDnclistCustomexclusioncolumnsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<DncPatchCustomExclusionColumnsRequest> withHttpInfo() {
        
        // verify the required parameter 'dncListId' is set
        if (this.dncListId == null) {
            throw new IllegalStateException("Missing the required parameter 'dncListId' when building request for PatchOutboundDnclistCustomexclusioncolumnsRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchOutboundDnclistCustomexclusioncolumnsRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/outbound/dnclists/{dncListId}/customexclusioncolumns")
	...
	public static Builder builder(String dncListId, DncPatchCustomExclusionColumnsRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PatchOutboundDnclistCustomexclusioncolumnsRequest request;

		private Builder() {
			request = new PatchOutboundDnclistCustomexclusioncolumnsRequest();
		}
		...
		public Builder withBody(DncPatchCustomExclusionColumnsRequest body) {
		...
		public Builder withRequiredParams(String dncListId, DncPatchCustomExclusionColumnsRequest body) {
			request.setDncListId(dncListId);
			request.setBody(body);
		...
		public PatchOutboundDnclistCustomexclusioncolumnsRequest build() {
