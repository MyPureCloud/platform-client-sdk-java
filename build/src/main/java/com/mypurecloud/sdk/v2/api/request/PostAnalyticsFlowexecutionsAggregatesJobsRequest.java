...
public class PostAnalyticsFlowexecutionsAggregatesJobsRequest {

	private FlowExecutionAsyncAggregationQuery body;
	public FlowExecutionAsyncAggregationQuery getBody() {
		return this.body;
	}

	public void setBody(FlowExecutionAsyncAggregationQuery body) {
		this.body = body;
	}

	public PostAnalyticsFlowexecutionsAggregatesJobsRequest withBody(FlowExecutionAsyncAggregationQuery body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostAnalyticsFlowexecutionsAggregatesJobsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<FlowExecutionAsyncAggregationQuery> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostAnalyticsFlowexecutionsAggregatesJobsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/analytics/flowexecutions/aggregates/jobs")
                .withBody(body)
	...
	public static Builder builder(FlowExecutionAsyncAggregationQuery body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostAnalyticsFlowexecutionsAggregatesJobsRequest request;

		private Builder() {
			request = new PostAnalyticsFlowexecutionsAggregatesJobsRequest();
		}


		public Builder withBody(FlowExecutionAsyncAggregationQuery body) {
		...
		public Builder withRequiredParams(FlowExecutionAsyncAggregationQuery body) {
			request.setBody(body);
		...
		public PostAnalyticsFlowexecutionsAggregatesJobsRequest build() {
