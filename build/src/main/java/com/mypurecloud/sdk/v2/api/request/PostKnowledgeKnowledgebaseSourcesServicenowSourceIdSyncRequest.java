...
public class PostKnowledgeKnowledgebaseSourcesServicenowSourceIdSyncRequest {
	...
	public PostKnowledgeKnowledgebaseSourcesServicenowSourceIdSyncRequest withKnowledgeBaseId(String knowledgeBaseId) {
	...
	public PostKnowledgeKnowledgebaseSourcesServicenowSourceIdSyncRequest withSourceId(String sourceId) {
    ...
    public PostKnowledgeKnowledgebaseSourcesServicenowSourceIdSyncRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.knowledgeBaseId == null) {
            throw new IllegalStateException("Missing the required parameter 'knowledgeBaseId' when building request for PostKnowledgeKnowledgebaseSourcesServicenowSourceIdSyncRequest.");
        }
        
        // verify the required parameter 'sourceId' is set
        if (this.sourceId == null) {
            throw new IllegalStateException("Missing the required parameter 'sourceId' when building request for PostKnowledgeKnowledgebaseSourcesServicenowSourceIdSyncRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/sources/servicenow/{sourceId}/sync")
	...
	public static class Builder {
		private final PostKnowledgeKnowledgebaseSourcesServicenowSourceIdSyncRequest request;

		private Builder() {
			request = new PostKnowledgeKnowledgebaseSourcesServicenowSourceIdSyncRequest();
		}
		...
		public PostKnowledgeKnowledgebaseSourcesServicenowSourceIdSyncRequest build() {
