...
public class PostConversationsCallParticipantCommunicationWrapupRequest {
	...
	public PostConversationsCallParticipantCommunicationWrapupRequest withConversationId(String conversationId) {
	...
	public PostConversationsCallParticipantCommunicationWrapupRequest withParticipantId(String participantId) {
	...
	public PostConversationsCallParticipantCommunicationWrapupRequest withCommunicationId(String communicationId) {
	...
	public PostConversationsCallParticipantCommunicationWrapupRequest withBody(ExtendedWrapup body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostConversationsCallParticipantCommunicationWrapupRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<ExtendedWrapup> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PostConversationsCallParticipantCommunicationWrapupRequest.");
        }
        
        // verify the required parameter 'participantId' is set
        if (this.participantId == null) {
            throw new IllegalStateException("Missing the required parameter 'participantId' when building request for PostConversationsCallParticipantCommunicationWrapupRequest.");
        }
        
        // verify the required parameter 'communicationId' is set
        if (this.communicationId == null) {
            throw new IllegalStateException("Missing the required parameter 'communicationId' when building request for PostConversationsCallParticipantCommunicationWrapupRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/conversations/calls/{conversationId}/participants/{participantId}/communications/{communicationId}/wrapup")
	...
	public static class Builder {
		private final PostConversationsCallParticipantCommunicationWrapupRequest request;

		private Builder() {
			request = new PostConversationsCallParticipantCommunicationWrapupRequest();
		}
		...
		public PostConversationsCallParticipantCommunicationWrapupRequest build() {
