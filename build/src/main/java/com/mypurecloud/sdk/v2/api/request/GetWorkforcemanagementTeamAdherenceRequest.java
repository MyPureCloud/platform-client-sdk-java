...
public class GetWorkforcemanagementTeamAdherenceRequest {
	...
	public GetWorkforcemanagementTeamAdherenceRequest withTeamId(String teamId) {
    ...
    public GetWorkforcemanagementTeamAdherenceRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.teamId == null) {
            throw new IllegalStateException("Missing the required parameter 'teamId' when building request for GetWorkforcemanagementTeamAdherenceRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/teams/{teamId}/adherence")
	...
	public static class Builder {
		private final GetWorkforcemanagementTeamAdherenceRequest request;

		private Builder() {
			request = new GetWorkforcemanagementTeamAdherenceRequest();
		}
		...
		public GetWorkforcemanagementTeamAdherenceRequest build() {
