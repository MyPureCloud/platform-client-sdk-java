...
public class ResolutionAggregationSort  implements Serializable {
 ...
 @JsonDeserialize(using = FunctionEnumDeserializer.class)
  ...
  public ResolutionAggregationSort() {
   ...
   * Name of the metric used for sorting values.
   **/
  public ResolutionAggregationSort name(NameEnum name) {
    this.name = name;
    return this;
  }
   ...
   * Aggregation function used for the sort metric.
   **/
  public ResolutionAggregationSort function(FunctionEnum function) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ResolutionAggregationSort resolutionAggregationSort = (ResolutionAggregationSort) o;

    return Objects.equals(this.name, resolutionAggregationSort.name) &&
            Objects.equals(this.function, resolutionAggregationSort.function);
  }
