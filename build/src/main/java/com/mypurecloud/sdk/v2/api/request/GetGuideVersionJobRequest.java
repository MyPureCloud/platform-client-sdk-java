...
public class GetGuideVersionJobRequest {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/guides/{guideId}/versions/{versionId}/jobs/{jobId}")
	...
	public static Builder builder(String guideId, String versionId, String jobId) {
	    return new Builder()
	            .withRequiredParams(guideId, versionId, jobId);
	}


	public static class Builder {
		private final GetGuideVersionJobRequest request;

		private Builder() {
			request = new GetGuideVersionJobRequest();
		}
