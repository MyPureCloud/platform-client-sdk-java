...
public class PostWorkforcemanagementManagementunitWorkplanrotationsRequest {
	...
	public PostWorkforcemanagementManagementunitWorkplanrotationsRequest withManagementUnitId(String managementUnitId) {
	    this.setManagementUnitId(managementUnitId);
	    return this;
	} 
	
	private AddWorkPlanRotationRequest body;
	public AddWorkPlanRotationRequest getBody() {
		return this.body;
	}

	public void setBody(AddWorkPlanRotationRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementManagementunitWorkplanrotationsRequest withBody(AddWorkPlanRotationRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementManagementunitWorkplanrotationsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<AddWorkPlanRotationRequest> withHttpInfo() {
	...
	public static class Builder {
		private final PostWorkforcemanagementManagementunitWorkplanrotationsRequest request;

		private Builder() {
			request = new PostWorkforcemanagementManagementunitWorkplanrotationsRequest();
		}
		...
		public Builder withBody(AddWorkPlanRotationRequest body) {
		...
		public PostWorkforcemanagementManagementunitWorkplanrotationsRequest build() {
