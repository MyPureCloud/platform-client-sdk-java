...
public class GetGamificationContestsRequest {
	...
	public GetGamificationContestsRequest withPageNumber(Integer pageNumber) {
	...
	public GetGamificationContestsRequest withPageSize(Integer pageSize) {
	...
	public GetGamificationContestsRequest withDateStart(LocalDate dateStart) {
	...
	public GetGamificationContestsRequest withDateEnd(LocalDate dateEnd) {
	...
	public GetGamificationContestsRequest withStatus(List<String> status) {
	...
	public GetGamificationContestsRequest withSortBy(String sortBy) {
	...
	public GetGamificationContestsRequest withSortOrder(String sortOrder) {
    ...
    public GetGamificationContestsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/gamification/contests")
	...
	public static class Builder {
		private final GetGamificationContestsRequest request;

		private Builder() {
			request = new GetGamificationContestsRequest();
		}
		...
		public GetGamificationContestsRequest build() {
