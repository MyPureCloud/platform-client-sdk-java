...
public class DeleteJourneyActionmapRequest {
	...
	public DeleteJourneyActionmapRequest withActionMapId(String actionMapId) {
    ...
    public DeleteJourneyActionmapRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.actionMapId == null) {
            throw new IllegalStateException("Missing the required parameter 'actionMapId' when building request for DeleteJourneyActionmapRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/journey/actionmaps/{actionMapId}")
	...
	public static class Builder {
		private final DeleteJourneyActionmapRequest request;

		private Builder() {
			request = new DeleteJourneyActionmapRequest();
		}
		...
		public DeleteJourneyActionmapRequest build() {
