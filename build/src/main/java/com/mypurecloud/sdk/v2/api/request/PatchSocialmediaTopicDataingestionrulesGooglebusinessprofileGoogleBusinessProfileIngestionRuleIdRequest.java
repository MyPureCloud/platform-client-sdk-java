...
public class PatchSocialmediaTopicDataingestionrulesGooglebusinessprofileGoogleBusinessProfileIngestionRuleIdRequest {
	...
	public PatchSocialmediaTopicDataingestionrulesGooglebusinessprofileGoogleBusinessProfileIngestionRuleIdRequest withBody(DataIngestionRuleStatusPatchRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public ApiRequest<DataIngestionRuleStatusPatchRequest> withHttpInfo() {
        ...
        if (this.topicId == null) {
            throw new IllegalStateException("Missing the required parameter 'topicId' when building request for PatchSocialmediaTopicDataingestionrulesGooglebusinessprofileGoogleBusinessProfileIngestionRuleIdRequest.");
        }
        ...
        if (this.googleBusinessProfileIngestionRuleId == null) {
            throw new IllegalStateException("Missing the required parameter 'googleBusinessProfileIngestionRuleId' when building request for PatchSocialmediaTopicDataingestionrulesGooglebusinessprofileGoogleBusinessProfileIngestionRuleIdRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/socialmedia/topics/{topicId}/dataingestionrules/googlebusinessprofile/{googleBusinessProfileIngestionRuleId}")
	...
	public static class Builder {
		private final PatchSocialmediaTopicDataingestionrulesGooglebusinessprofileGoogleBusinessProfileIngestionRuleIdRequest request;

		private Builder() {
			request = new PatchSocialmediaTopicDataingestionrulesGooglebusinessprofileGoogleBusinessProfileIngestionRuleIdRequest();
		}
		...
		public PatchSocialmediaTopicDataingestionrulesGooglebusinessprofileGoogleBusinessProfileIngestionRuleIdRequest build() {
