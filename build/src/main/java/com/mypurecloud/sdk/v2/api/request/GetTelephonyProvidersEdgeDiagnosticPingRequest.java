...
public class GetTelephonyProvidersEdgeDiagnosticPingRequest {
	...
	public GetTelephonyProvidersEdgeDiagnosticPingRequest withEdgeId(String edgeId) {
    ...
    public GetTelephonyProvidersEdgeDiagnosticPingRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.edgeId == null) {
            throw new IllegalStateException("Missing the required parameter 'edgeId' when building request for GetTelephonyProvidersEdgeDiagnosticPingRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/telephony/providers/edges/{edgeId}/diagnostic/ping")
	...
	public static class Builder {
		private final GetTelephonyProvidersEdgeDiagnosticPingRequest request;

		private Builder() {
			request = new GetTelephonyProvidersEdgeDiagnosticPingRequest();
		}
		...
		public GetTelephonyProvidersEdgeDiagnosticPingRequest build() {
