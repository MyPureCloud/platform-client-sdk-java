...
public class GetQualitySurveyRequest {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/quality/surveys/{surveyId}")
                .withPathParameter("surveyId", surveyId)
	...
	public static Builder builder(String surveyId) {
	    return new Builder()
	            .withRequiredParams(surveyId);
	}
	

	public static class Builder {
		private final GetQualitySurveyRequest request;

		private Builder() {
			request = new GetQualitySurveyRequest();
		}
