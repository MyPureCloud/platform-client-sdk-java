...
public class GetSocialmediaTopicDataingestionrulesFacebookFacebookIngestionRuleIdRequest {
	...
	public GetSocialmediaTopicDataingestionrulesFacebookFacebookIngestionRuleIdRequest withTopicId(String topicId) {
	...
	public GetSocialmediaTopicDataingestionrulesFacebookFacebookIngestionRuleIdRequest withFacebookIngestionRuleId(String facebookIngestionRuleId) {
	...
	public GetSocialmediaTopicDataingestionrulesFacebookFacebookIngestionRuleIdRequest withIncludeDeleted(Boolean includeDeleted) {
    ...
    public GetSocialmediaTopicDataingestionrulesFacebookFacebookIngestionRuleIdRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.topicId == null) {
            throw new IllegalStateException("Missing the required parameter 'topicId' when building request for GetSocialmediaTopicDataingestionrulesFacebookFacebookIngestionRuleIdRequest.");
        }
        
        // verify the required parameter 'facebookIngestionRuleId' is set
        if (this.facebookIngestionRuleId == null) {
            throw new IllegalStateException("Missing the required parameter 'facebookIngestionRuleId' when building request for GetSocialmediaTopicDataingestionrulesFacebookFacebookIngestionRuleIdRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/socialmedia/topics/{topicId}/dataingestionrules/facebook/{facebookIngestionRuleId}")
	...
	public static class Builder {
		private final GetSocialmediaTopicDataingestionrulesFacebookFacebookIngestionRuleIdRequest request;

		private Builder() {
			request = new GetSocialmediaTopicDataingestionrulesFacebookFacebookIngestionRuleIdRequest();
		}
		...
		public GetSocialmediaTopicDataingestionrulesFacebookFacebookIngestionRuleIdRequest build() {
