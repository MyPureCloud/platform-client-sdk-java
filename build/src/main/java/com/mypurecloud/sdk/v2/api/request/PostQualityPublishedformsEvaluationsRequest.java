...
public class PostQualityPublishedformsEvaluationsRequest {
	...
	public PostQualityPublishedformsEvaluationsRequest withBody(PublishForm body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostQualityPublishedformsEvaluationsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<PublishForm> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostQualityPublishedformsEvaluationsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/quality/publishedforms/evaluations")
                .withBody(body)
	...
	public static class Builder {
		private final PostQualityPublishedformsEvaluationsRequest request;

		private Builder() {
			request = new PostQualityPublishedformsEvaluationsRequest();
		}
		...
		public PostQualityPublishedformsEvaluationsRequest build() {
