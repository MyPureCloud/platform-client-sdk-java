...
public class GetJourneyActiontargetsRequest {
	...
	public GetJourneyActiontargetsRequest withPageNumber(Integer pageNumber) {
	...
	public GetJourneyActiontargetsRequest withPageSize(Integer pageSize) {
    ...
    public GetJourneyActiontargetsRequest withCustomHeader(String name, String value) {
