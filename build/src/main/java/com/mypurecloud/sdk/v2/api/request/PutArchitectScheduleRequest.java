...
public class PutArchitectScheduleRequest {
    ...
    public ApiRequest<Schedule> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("PUT", "/api/v2/architect/schedules/{scheduleId}")
	...
	public static class Builder {
		private final PutArchitectScheduleRequest request;

		private Builder() {
			request = new PutArchitectScheduleRequest();
		}
