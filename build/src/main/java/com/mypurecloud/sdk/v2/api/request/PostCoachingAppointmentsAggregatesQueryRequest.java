...
public class PostCoachingAppointmentsAggregatesQueryRequest {
    
	private CoachingAppointmentAggregateRequest body;
	public CoachingAppointmentAggregateRequest getBody() {
		return this.body;
	}

	public void setBody(CoachingAppointmentAggregateRequest body) {
		this.body = body;
	}

	public PostCoachingAppointmentsAggregatesQueryRequest withBody(CoachingAppointmentAggregateRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostCoachingAppointmentsAggregatesQueryRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<CoachingAppointmentAggregateRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostCoachingAppointmentsAggregatesQueryRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/coaching/appointments/aggregates/query")
                .withBody(body)
	...
	public static Builder builder(CoachingAppointmentAggregateRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostCoachingAppointmentsAggregatesQueryRequest request;

		private Builder() {
			request = new PostCoachingAppointmentsAggregatesQueryRequest();
		}

		
		public Builder withBody(CoachingAppointmentAggregateRequest body) {
		...
		public Builder withRequiredParams(CoachingAppointmentAggregateRequest body) {
			request.setBody(body);
		...
		public PostCoachingAppointmentsAggregatesQueryRequest build() {
