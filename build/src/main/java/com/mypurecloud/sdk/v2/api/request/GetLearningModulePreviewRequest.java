...
public class GetLearningModulePreviewRequest {
	...
	public GetLearningModulePreviewRequest withModuleId(String moduleId) {
    ...
    public GetLearningModulePreviewRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.moduleId == null) {
            throw new IllegalStateException("Missing the required parameter 'moduleId' when building request for GetLearningModulePreviewRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/learning/modules/{moduleId}/preview")
	...
	public static class Builder {
		private final GetLearningModulePreviewRequest request;

		private Builder() {
			request = new GetLearningModulePreviewRequest();
		}
		...
		public GetLearningModulePreviewRequest build() {
