...
public class GetQualityPublishedformsSurveysDivisionviewsRequest {
	...
	public GetQualityPublishedformsSurveysDivisionviewsRequest withId(List<String> id) {
	    this.setId(id);
	    return this;
	} 
	...
	public GetQualityPublishedformsSurveysDivisionviewsRequest withPageSize(Integer pageSize) {
	...
	public GetQualityPublishedformsSurveysDivisionviewsRequest withPageNumber(Integer pageNumber) {
	...
	public GetQualityPublishedformsSurveysDivisionviewsRequest withName(String name) {
	    this.setName(name);
	    return this;
	} 
	...
	public GetQualityPublishedformsSurveysDivisionviewsRequest withDivisionId(String divisionId) {
    ...
    public GetQualityPublishedformsSurveysDivisionviewsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.id == null) {
            throw new IllegalStateException("Missing the required parameter 'id' when building request for GetQualityPublishedformsSurveysDivisionviewsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/quality/publishedforms/surveys/divisionviews")
	...
	public static class Builder {
		private final GetQualityPublishedformsSurveysDivisionviewsRequest request;

		private Builder() {
			request = new GetQualityPublishedformsSurveysDivisionviewsRequest();
		}
		...
		public GetQualityPublishedformsSurveysDivisionviewsRequest build() {
