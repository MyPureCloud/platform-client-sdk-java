...
public class PostConversationsCallParticipantSnippetRecordRequest {
	...
	public PostConversationsCallParticipantSnippetRecordRequest withConversationId(String conversationId) {
	...
	public PostConversationsCallParticipantSnippetRecordRequest withParticipantId(String participantId) {
	    this.setParticipantId(participantId);
	    return this;
	} 

	private SnippetRecordingRequest body;
	public SnippetRecordingRequest getBody() {
		return this.body;
	}

	public void setBody(SnippetRecordingRequest body) {
		this.body = body;
	}

	public PostConversationsCallParticipantSnippetRecordRequest withBody(SnippetRecordingRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostConversationsCallParticipantSnippetRecordRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<SnippetRecordingRequest> withHttpInfo() {
        
        // verify the required parameter 'conversationId' is set
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PostConversationsCallParticipantSnippetRecordRequest.");
        }
        
        // verify the required parameter 'participantId' is set
        if (this.participantId == null) {
            throw new IllegalStateException("Missing the required parameter 'participantId' when building request for PostConversationsCallParticipantSnippetRecordRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostConversationsCallParticipantSnippetRecordRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/conversations/calls/{conversationId}/participants/{participantId}/snippet/record")
	...
	public static Builder builder(String conversationId, String participantId, SnippetRecordingRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostConversationsCallParticipantSnippetRecordRequest request;

		private Builder() {
			request = new PostConversationsCallParticipantSnippetRecordRequest();
		}
		...
		public Builder withBody(SnippetRecordingRequest body) {
		...
		public Builder withRequiredParams(String conversationId, String participantId, SnippetRecordingRequest body) {
			request.setConversationId(conversationId);
			request.setParticipantId(participantId);
			request.setBody(body);
		...
		public PostConversationsCallParticipantSnippetRecordRequest build() {
