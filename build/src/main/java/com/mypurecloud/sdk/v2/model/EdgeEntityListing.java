...
public class EdgeEntityListing  implements Serializable, PagedResource<Edge> {
  ...
  /**
   **/
  public EdgeEntityListing entities(List<Edge> entities) {
  ...
  public List<Edge> getEntities() {
    return entities;
  }
  public void setEntities(List<Edge> entities) {
    this.entities = entities;
  }
   ...
   **/
  public EdgeEntityListing totalNumberOfEntities(Long totalNumberOfEntities) {
