...
public class PostOutboundDigitalrulesetsRequest {
	...
	public PostOutboundDigitalrulesetsRequest withBody(DigitalRuleSet body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostOutboundDigitalrulesetsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<DigitalRuleSet> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostOutboundDigitalrulesetsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/outbound/digitalrulesets")
                .withBody(body)
	...
	public static Builder builder(DigitalRuleSet body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostOutboundDigitalrulesetsRequest request;

		private Builder() {
			request = new PostOutboundDigitalrulesetsRequest();
		}
		...
		public Builder withRequiredParams(DigitalRuleSet body) {
			request.setBody(body);
		...
		public PostOutboundDigitalrulesetsRequest build() {
