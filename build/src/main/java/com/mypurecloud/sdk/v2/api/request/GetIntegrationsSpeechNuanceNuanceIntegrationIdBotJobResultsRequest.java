...
public class GetIntegrationsSpeechNuanceNuanceIntegrationIdBotJobResultsRequest {
	...
	public GetIntegrationsSpeechNuanceNuanceIntegrationIdBotJobResultsRequest withNuanceIntegrationId(String nuanceIntegrationId) {
	...
	public GetIntegrationsSpeechNuanceNuanceIntegrationIdBotJobResultsRequest withBotId(String botId) {
	    this.setBotId(botId);
	    return this;
	} 
	...
	public GetIntegrationsSpeechNuanceNuanceIntegrationIdBotJobResultsRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetIntegrationsSpeechNuanceNuanceIntegrationIdBotJobResultsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.nuanceIntegrationId == null) {
            throw new IllegalStateException("Missing the required parameter 'nuanceIntegrationId' when building request for GetIntegrationsSpeechNuanceNuanceIntegrationIdBotJobResultsRequest.");
        }
        
        // verify the required parameter 'botId' is set
        if (this.botId == null) {
            throw new IllegalStateException("Missing the required parameter 'botId' when building request for GetIntegrationsSpeechNuanceNuanceIntegrationIdBotJobResultsRequest.");
        }
        
        // verify the required parameter 'jobId' is set
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetIntegrationsSpeechNuanceNuanceIntegrationIdBotJobResultsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/integrations/speech/nuance/{nuanceIntegrationId}/bots/{botId}/jobs/{jobId}/results")
	...
	public static Builder builder(String nuanceIntegrationId, String botId, String jobId) {
	    return new Builder()
	            .withRequiredParams(nuanceIntegrationId, botId, jobId);
	}


	public static class Builder {
		private final GetIntegrationsSpeechNuanceNuanceIntegrationIdBotJobResultsRequest request;

		private Builder() {
			request = new GetIntegrationsSpeechNuanceNuanceIntegrationIdBotJobResultsRequest();
		}
		...
		public Builder withRequiredParams(String nuanceIntegrationId, String botId, String jobId) {
			request.setNuanceIntegrationId(nuanceIntegrationId);
			request.setBotId(botId);
			request.setJobId(jobId);
		...
		public GetIntegrationsSpeechNuanceNuanceIntegrationIdBotJobResultsRequest build() {
