...
public class JourneyWebEventsNotificationEventAction  implements Serializable {
 ...
 @JsonDeserialize(using = MediaTypeEnumDeserializer.class)
  ...
  public JourneyWebEventsNotificationEventAction() {
  ...
  /**
   **/
  public JourneyWebEventsNotificationEventAction id(String id) {
    this.id = id;
    return this;
  }
