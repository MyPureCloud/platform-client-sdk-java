...
public class GetRoutingUtilizationTagRequest {
	...
	public GetRoutingUtilizationTagRequest withTagId(String tagId) {
	    this.setTagId(tagId);
	    return this;
	} 
    ...
    public GetRoutingUtilizationTagRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.tagId == null) {
            throw new IllegalStateException("Missing the required parameter 'tagId' when building request for GetRoutingUtilizationTagRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/routing/utilization/tags/{tagId}")
	...
	public static class Builder {
		private final GetRoutingUtilizationTagRequest request;

		private Builder() {
			request = new GetRoutingUtilizationTagRequest();
		}
		...
		public GetRoutingUtilizationTagRequest build() {
