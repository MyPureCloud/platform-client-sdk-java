...
public class PatchWorkforcemanagementWorkplanbidPreferencesRequest {
	...
	public PatchWorkforcemanagementWorkplanbidPreferencesRequest withBidId(String bidId) {
	    this.setBidId(bidId);
	    return this;
	} 

	private UpdateAgentWorkPlanBiddingPreference body;
	public UpdateAgentWorkPlanBiddingPreference getBody() {
		return this.body;
	}

	public void setBody(UpdateAgentWorkPlanBiddingPreference body) {
		this.body = body;
	}

	public PatchWorkforcemanagementWorkplanbidPreferencesRequest withBody(UpdateAgentWorkPlanBiddingPreference body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchWorkforcemanagementWorkplanbidPreferencesRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<UpdateAgentWorkPlanBiddingPreference> withHttpInfo() {
	...
	public static class Builder {
		private final PatchWorkforcemanagementWorkplanbidPreferencesRequest request;

		private Builder() {
			request = new PatchWorkforcemanagementWorkplanbidPreferencesRequest();
		}
		...
		public Builder withBody(UpdateAgentWorkPlanBiddingPreference body) {
		...
		public PatchWorkforcemanagementWorkplanbidPreferencesRequest build() {
