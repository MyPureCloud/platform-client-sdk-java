...
public class PostRoutingSmsPhonenumbersImportRequest {

	private SmsPhoneNumberImport body;
	public SmsPhoneNumberImport getBody() {
		return this.body;
	}

	public void setBody(SmsPhoneNumberImport body) {
		this.body = body;
	}

	public PostRoutingSmsPhonenumbersImportRequest withBody(SmsPhoneNumberImport body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostRoutingSmsPhonenumbersImportRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<SmsPhoneNumberImport> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostRoutingSmsPhonenumbersImportRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/routing/sms/phonenumbers/import")
                .withBody(body)
	...
	public static Builder builder(SmsPhoneNumberImport body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostRoutingSmsPhonenumbersImportRequest request;

		private Builder() {
			request = new PostRoutingSmsPhonenumbersImportRequest();
		}


		public Builder withBody(SmsPhoneNumberImport body) {
		...
		public Builder withRequiredParams(SmsPhoneNumberImport body) {
			request.setBody(body);
		...
		public PostRoutingSmsPhonenumbersImportRequest build() {
