...
public class PostWorkforcemanagementManagementunitTimeoffrequestsQueryRequest {
	...
	public PostWorkforcemanagementManagementunitTimeoffrequestsQueryRequest withMuId(String muId) {
	    this.setMuId(muId);
	    return this;
	} 
	...
	public void setBody(TimeOffRequestQueryBody body) {
		this.body = body;
	}
    ...
    public PostWorkforcemanagementManagementunitTimeoffrequestsQueryRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<TimeOffRequestQueryBody> withHttpInfo() {
        
        // verify the required parameter 'muId' is set
        if (this.muId == null) {
            throw new IllegalStateException("Missing the required parameter 'muId' when building request for PostWorkforcemanagementManagementunitTimeoffrequestsQueryRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/managementunits/{muId}/timeoffrequests/query")
	...
	public static class Builder {
		private final PostWorkforcemanagementManagementunitTimeoffrequestsQueryRequest request;

		private Builder() {
			request = new PostWorkforcemanagementManagementunitTimeoffrequestsQueryRequest();
		}
		...
		public PostWorkforcemanagementManagementunitTimeoffrequestsQueryRequest build() {
