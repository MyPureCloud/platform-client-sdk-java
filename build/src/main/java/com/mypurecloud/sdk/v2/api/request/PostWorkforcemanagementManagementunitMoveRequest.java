...
public class PostWorkforcemanagementManagementunitMoveRequest {
	...
	public PostWorkforcemanagementManagementunitMoveRequest withManagementUnitId(String managementUnitId) {
	    this.setManagementUnitId(managementUnitId);
	    return this;
	} 

	private MoveManagementUnitRequest body;
	public MoveManagementUnitRequest getBody() {
		return this.body;
	}

	public void setBody(MoveManagementUnitRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementManagementunitMoveRequest withBody(MoveManagementUnitRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementManagementunitMoveRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<MoveManagementUnitRequest> withHttpInfo() {
        
        // verify the required parameter 'managementUnitId' is set
        if (this.managementUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'managementUnitId' when building request for PostWorkforcemanagementManagementunitMoveRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementManagementunitMoveRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/managementunits/{managementUnitId}/move")
	...
	public static Builder builder(String managementUnitId, MoveManagementUnitRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementManagementunitMoveRequest request;

		private Builder() {
			request = new PostWorkforcemanagementManagementunitMoveRequest();
		}
		...
		public Builder withBody(MoveManagementUnitRequest body) {
		...
		public Builder withRequiredParams(String managementUnitId, MoveManagementUnitRequest body) {
			request.setManagementUnitId(managementUnitId);
			request.setBody(body);
		...
		public PostWorkforcemanagementManagementunitMoveRequest build() {
