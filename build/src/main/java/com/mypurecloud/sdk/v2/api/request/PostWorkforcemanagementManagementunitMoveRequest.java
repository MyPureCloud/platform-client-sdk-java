...
public class PostWorkforcemanagementManagementunitMoveRequest {
	...
	public PostWorkforcemanagementManagementunitMoveRequest withMuId(String muId) {
	    this.setMuId(muId);
	    return this;
	} 
    ...
    public ApiRequest<MoveManagementUnitRequest> withHttpInfo() {
        ...
        if (this.muId == null) {
            throw new IllegalStateException("Missing the required parameter 'muId' when building request for PostWorkforcemanagementManagementunitMoveRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/managementunits/{muId}/move")
