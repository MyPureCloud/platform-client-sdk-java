...
public class GetFlowsInstancesSettingsLoglevelsRequest {
	...
	public GetFlowsInstancesSettingsLoglevelsRequest withExpand(List<String> expand) {
	...
	public GetFlowsInstancesSettingsLoglevelsRequest withPageNumber(Integer pageNumber) {
	...
	public GetFlowsInstancesSettingsLoglevelsRequest withPageSize(Integer pageSize) {
    ...
    public GetFlowsInstancesSettingsLoglevelsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/flows/instances/settings/loglevels")
	...
	public static class Builder {
		private final GetFlowsInstancesSettingsLoglevelsRequest request;

		private Builder() {
			request = new GetFlowsInstancesSettingsLoglevelsRequest();
		}
		...
		public GetFlowsInstancesSettingsLoglevelsRequest build() {
