...
public class PostExternalcontactsBulkNotesAddRequest {
	...
	public PostExternalcontactsBulkNotesAddRequest withBody(BulkNotesRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostExternalcontactsBulkNotesAddRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<BulkNotesRequest> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostExternalcontactsBulkNotesAddRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/externalcontacts/bulk/notes/add")
                .withBody(body)
	...
	public static class Builder {
		private final PostExternalcontactsBulkNotesAddRequest request;

		private Builder() {
			request = new PostExternalcontactsBulkNotesAddRequest();
		}
		...
		public PostExternalcontactsBulkNotesAddRequest build() {
