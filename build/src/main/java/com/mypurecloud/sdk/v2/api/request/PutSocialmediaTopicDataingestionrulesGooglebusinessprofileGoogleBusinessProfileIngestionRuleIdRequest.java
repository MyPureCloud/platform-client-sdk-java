...
public class PutSocialmediaTopicDataingestionrulesGooglebusinessprofileGoogleBusinessProfileIngestionRuleIdRequest {
	...
	private GoogleBusinessProfileDataIngestionRuleRequest body;
	public GoogleBusinessProfileDataIngestionRuleRequest getBody() {
		return this.body;
	}

	public void setBody(GoogleBusinessProfileDataIngestionRuleRequest body) {
		this.body = body;
	}

	public PutSocialmediaTopicDataingestionrulesGooglebusinessprofileGoogleBusinessProfileIngestionRuleIdRequest withBody(GoogleBusinessProfileDataIngestionRuleRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public ApiRequest<GoogleBusinessProfileDataIngestionRuleRequest> withHttpInfo() {
        
        // verify the required parameter 'topicId' is set
        if (this.topicId == null) {
            throw new IllegalStateException("Missing the required parameter 'topicId' when building request for PutSocialmediaTopicDataingestionrulesGooglebusinessprofileGoogleBusinessProfileIngestionRuleIdRequest.");
        }
        ...
        if (this.googleBusinessProfileIngestionRuleId == null) {
            throw new IllegalStateException("Missing the required parameter 'googleBusinessProfileIngestionRuleId' when building request for PutSocialmediaTopicDataingestionrulesGooglebusinessprofileGoogleBusinessProfileIngestionRuleIdRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/socialmedia/topics/{topicId}/dataingestionrules/googlebusinessprofile/{googleBusinessProfileIngestionRuleId}")
	...
	public static class Builder {
		private final PutSocialmediaTopicDataingestionrulesGooglebusinessprofileGoogleBusinessProfileIngestionRuleIdRequest request;

		private Builder() {
			request = new PutSocialmediaTopicDataingestionrulesGooglebusinessprofileGoogleBusinessProfileIngestionRuleIdRequest();
		}
		...
		public Builder withBody(GoogleBusinessProfileDataIngestionRuleRequest body) {
		...
		public PutSocialmediaTopicDataingestionrulesGooglebusinessprofileGoogleBusinessProfileIngestionRuleIdRequest build() {
