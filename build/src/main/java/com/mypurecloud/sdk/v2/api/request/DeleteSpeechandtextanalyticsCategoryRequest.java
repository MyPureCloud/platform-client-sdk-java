...
public class DeleteSpeechandtextanalyticsCategoryRequest {
	...
	public DeleteSpeechandtextanalyticsCategoryRequest withCategoryId(String categoryId) {
    ...
    public DeleteSpeechandtextanalyticsCategoryRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.categoryId == null) {
            throw new IllegalStateException("Missing the required parameter 'categoryId' when building request for DeleteSpeechandtextanalyticsCategoryRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/speechandtextanalytics/categories/{categoryId}")
	...
	public static class Builder {
		private final DeleteSpeechandtextanalyticsCategoryRequest request;

		private Builder() {
			request = new DeleteSpeechandtextanalyticsCategoryRequest();
		}
		...
		public DeleteSpeechandtextanalyticsCategoryRequest build() {
