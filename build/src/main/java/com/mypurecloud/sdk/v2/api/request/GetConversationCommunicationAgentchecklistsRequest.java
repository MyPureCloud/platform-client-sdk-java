...
public class GetConversationCommunicationAgentchecklistsRequest {
	...
	public GetConversationCommunicationAgentchecklistsRequest withConversationId(String conversationId) {
	...
	public GetConversationCommunicationAgentchecklistsRequest withCommunicationId(String communicationId) {
    ...
    public GetConversationCommunicationAgentchecklistsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for GetConversationCommunicationAgentchecklistsRequest.");
        }
        
        // verify the required parameter 'communicationId' is set
        if (this.communicationId == null) {
            throw new IllegalStateException("Missing the required parameter 'communicationId' when building request for GetConversationCommunicationAgentchecklistsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/conversations/{conversationId}/communications/{communicationId}/agentchecklists")
	...
	public static class Builder {
		private final GetConversationCommunicationAgentchecklistsRequest request;

		private Builder() {
			request = new GetConversationCommunicationAgentchecklistsRequest();
		}
		...
		public GetConversationCommunicationAgentchecklistsRequest build() {
