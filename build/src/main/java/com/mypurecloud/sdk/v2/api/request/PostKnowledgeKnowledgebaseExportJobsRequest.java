...
public class PostKnowledgeKnowledgebaseExportJobsRequest {
	...
	public PostKnowledgeKnowledgebaseExportJobsRequest withKnowledgeBaseId(String knowledgeBaseId) {
	    this.setKnowledgeBaseId(knowledgeBaseId);
	    return this;
	} 

	private KnowledgeExportJobRequest body;
	public KnowledgeExportJobRequest getBody() {
		return this.body;
	}

	public void setBody(KnowledgeExportJobRequest body) {
		this.body = body;
	}

	public PostKnowledgeKnowledgebaseExportJobsRequest withBody(KnowledgeExportJobRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostKnowledgeKnowledgebaseExportJobsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<KnowledgeExportJobRequest> withHttpInfo() {
        
        // verify the required parameter 'knowledgeBaseId' is set
        if (this.knowledgeBaseId == null) {
            throw new IllegalStateException("Missing the required parameter 'knowledgeBaseId' when building request for PostKnowledgeKnowledgebaseExportJobsRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostKnowledgeKnowledgebaseExportJobsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/export/jobs")
	...
	public static Builder builder(String knowledgeBaseId, KnowledgeExportJobRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostKnowledgeKnowledgebaseExportJobsRequest request;

		private Builder() {
			request = new PostKnowledgeKnowledgebaseExportJobsRequest();
		}
		...
		public Builder withBody(KnowledgeExportJobRequest body) {
		...
		public Builder withRequiredParams(String knowledgeBaseId, KnowledgeExportJobRequest body) {
			request.setKnowledgeBaseId(knowledgeBaseId);
			request.setBody(body);
		...
		public PostKnowledgeKnowledgebaseExportJobsRequest build() {
