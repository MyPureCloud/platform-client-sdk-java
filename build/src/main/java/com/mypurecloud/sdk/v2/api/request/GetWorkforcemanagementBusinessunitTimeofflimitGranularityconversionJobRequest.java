...
public class GetWorkforcemanagementBusinessunitTimeofflimitGranularityconversionJobRequest {
	...
	public GetWorkforcemanagementBusinessunitTimeofflimitGranularityconversionJobRequest withBusinessUnitId(String businessUnitId) {
	...
	public GetWorkforcemanagementBusinessunitTimeofflimitGranularityconversionJobRequest withTimeOffLimitId(String timeOffLimitId) {
	...
	public GetWorkforcemanagementBusinessunitTimeofflimitGranularityconversionJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetWorkforcemanagementBusinessunitTimeofflimitGranularityconversionJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for GetWorkforcemanagementBusinessunitTimeofflimitGranularityconversionJobRequest.");
        }
        
        // verify the required parameter 'timeOffLimitId' is set
        if (this.timeOffLimitId == null) {
            throw new IllegalStateException("Missing the required parameter 'timeOffLimitId' when building request for GetWorkforcemanagementBusinessunitTimeofflimitGranularityconversionJobRequest.");
        }
        
        // verify the required parameter 'jobId' is set
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetWorkforcemanagementBusinessunitTimeofflimitGranularityconversionJobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/timeofflimits/{timeOffLimitId}/granularityconversion/jobs/{jobId}")
	...
	public static Builder builder(String businessUnitId, String timeOffLimitId, String jobId) {
	    return new Builder()
	            .withRequiredParams(businessUnitId, timeOffLimitId, jobId);
	}


	public static class Builder {
		private final GetWorkforcemanagementBusinessunitTimeofflimitGranularityconversionJobRequest request;

		private Builder() {
			request = new GetWorkforcemanagementBusinessunitTimeofflimitGranularityconversionJobRequest();
		}
		...
		public Builder withRequiredParams(String businessUnitId, String timeOffLimitId, String jobId) {
			request.setBusinessUnitId(businessUnitId);
			request.setTimeOffLimitId(timeOffLimitId);
			request.setJobId(jobId);
		...
		public GetWorkforcemanagementBusinessunitTimeofflimitGranularityconversionJobRequest build() {
