...
public class PostTelephonyProvidersEdgesSitesSearchRequest {

	private SiteSearchRequest body;
	public SiteSearchRequest getBody() {
		return this.body;
	}

	public void setBody(SiteSearchRequest body) {
		this.body = body;
	}

	public PostTelephonyProvidersEdgesSitesSearchRequest withBody(SiteSearchRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostTelephonyProvidersEdgesSitesSearchRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<SiteSearchRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostTelephonyProvidersEdgesSitesSearchRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/telephony/providers/edges/sites/search")
                .withBody(body)
	...
	public static Builder builder(SiteSearchRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostTelephonyProvidersEdgesSitesSearchRequest request;

		private Builder() {
			request = new PostTelephonyProvidersEdgesSitesSearchRequest();
		}


		public Builder withBody(SiteSearchRequest body) {
		...
		public Builder withRequiredParams(SiteSearchRequest body) {
			request.setBody(body);
		...
		public PostTelephonyProvidersEdgesSitesSearchRequest build() {
