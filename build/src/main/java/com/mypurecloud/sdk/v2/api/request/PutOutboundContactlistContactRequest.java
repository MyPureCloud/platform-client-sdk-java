...
public class PutOutboundContactlistContactRequest {
	...
	public PutOutboundContactlistContactRequest withContactListId(String contactListId) {
	...
	public PutOutboundContactlistContactRequest withContactId(String contactId) {
	...
	public void setBody(DialerContact body) {
		this.body = body;
	}

	public PutOutboundContactlistContactRequest withBody(DialerContact body) {
	    this.setBody(body);
	    return this;
	}
    ...
    public PutOutboundContactlistContactRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<DialerContact> withHttpInfo() throws ApiException {
        
        // verify the required parameter 'contactListId' is set
        if (this.contactListId == null) {
            throw new ApiException(400, "Missing the required parameter 'contactListId' when building request for PutOutboundContactlistContactRequest.");
        }
        
        // verify the required parameter 'contactId' is set
        if (this.contactId == null) {
            throw new ApiException(400, "Missing the required parameter 'contactId' when building request for PutOutboundContactlistContactRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new ApiException(400, "Missing the required parameter 'body' when building request for PutOutboundContactlistContactRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/outbound/contactlists/{contactListId}/contacts/{contactId}")
