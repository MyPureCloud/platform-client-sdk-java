...
public class GetJourneyViewVersionJobRequest {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/journey/views/{viewId}/versions/{journeyVersionId}/jobs/{jobId}")
	...
	public static Builder builder(String viewId, String journeyVersionId, String jobId) {
	    return new Builder()
	            .withRequiredParams(viewId, journeyVersionId, jobId);
	}


	public static class Builder {
		private final GetJourneyViewVersionJobRequest request;

		private Builder() {
			request = new GetJourneyViewVersionJobRequest();
		}
