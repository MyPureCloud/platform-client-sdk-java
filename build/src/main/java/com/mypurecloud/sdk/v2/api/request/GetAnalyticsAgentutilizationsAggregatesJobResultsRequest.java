...
public class GetAnalyticsAgentutilizationsAggregatesJobResultsRequest {
	...
	public GetAnalyticsAgentutilizationsAggregatesJobResultsRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
	...
	public GetAnalyticsAgentutilizationsAggregatesJobResultsRequest withCursor(String cursor) {
    ...
    public GetAnalyticsAgentutilizationsAggregatesJobResultsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetAnalyticsAgentutilizationsAggregatesJobResultsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/analytics/agentutilizations/aggregates/jobs/{jobId}/results")
	...
	public static class Builder {
		private final GetAnalyticsAgentutilizationsAggregatesJobResultsRequest request;

		private Builder() {
			request = new GetAnalyticsAgentutilizationsAggregatesJobResultsRequest();
		}
		...
		public GetAnalyticsAgentutilizationsAggregatesJobResultsRequest build() {
