...
public class PutOutboundCallanalysisresponsesetRequest {
	...
	public PutOutboundCallanalysisresponsesetRequest withCallAnalysisSetId(String callAnalysisSetId) {
	...
	public PutOutboundCallanalysisresponsesetRequest withBody(ResponseSet body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutOutboundCallanalysisresponsesetRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<ResponseSet> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("PUT", "/api/v2/outbound/callanalysisresponsesets/{callAnalysisSetId}")
