...
public class GetWorkforcemanagementSchedulebidsRequest {
    ...
    public GetWorkforcemanagementSchedulebidsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/schedulebids")
	...
	public static class Builder {
		private final GetWorkforcemanagementSchedulebidsRequest request;

		private Builder() {
			request = new GetWorkforcemanagementSchedulebidsRequest();
		}
		...
		public GetWorkforcemanagementSchedulebidsRequest build() {
