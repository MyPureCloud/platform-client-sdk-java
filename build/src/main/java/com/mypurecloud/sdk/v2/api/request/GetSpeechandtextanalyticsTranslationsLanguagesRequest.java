...
public class GetSpeechandtextanalyticsTranslationsLanguagesRequest {
    ...
    public GetSpeechandtextanalyticsTranslationsLanguagesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/speechandtextanalytics/translations/languages")
	...
	public static class Builder {
		private final GetSpeechandtextanalyticsTranslationsLanguagesRequest request;

		private Builder() {
			request = new GetSpeechandtextanalyticsTranslationsLanguagesRequest();
		}
		...
		public GetSpeechandtextanalyticsTranslationsLanguagesRequest build() {
