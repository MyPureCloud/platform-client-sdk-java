...
public class PostWorkforcemanagementAdherenceExplanationsRequest {

	private AddAdherenceExplanationAgentRequest body;
	public AddAdherenceExplanationAgentRequest getBody() {
		return this.body;
	}

	public void setBody(AddAdherenceExplanationAgentRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementAdherenceExplanationsRequest withBody(AddAdherenceExplanationAgentRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementAdherenceExplanationsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<AddAdherenceExplanationAgentRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementAdherenceExplanationsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/adherence/explanations")
                .withBody(body)
	...
	public static Builder builder(AddAdherenceExplanationAgentRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementAdherenceExplanationsRequest request;

		private Builder() {
			request = new PostWorkforcemanagementAdherenceExplanationsRequest();
		}


		public Builder withBody(AddAdherenceExplanationAgentRequest body) {
		...
		public Builder withRequiredParams(AddAdherenceExplanationAgentRequest body) {
			request.setBody(body);
		...
		public PostWorkforcemanagementAdherenceExplanationsRequest build() {
