...
public class PostWorkforcemanagementAlternativeshiftsTradesRequest {

	private CreateAlternativeShiftTradeRequest body;
	public CreateAlternativeShiftTradeRequest getBody() {
		return this.body;
	}

	public void setBody(CreateAlternativeShiftTradeRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementAlternativeshiftsTradesRequest withBody(CreateAlternativeShiftTradeRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementAlternativeshiftsTradesRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<CreateAlternativeShiftTradeRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementAlternativeshiftsTradesRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/alternativeshifts/trades")
                .withBody(body)
	...
	public static Builder builder(CreateAlternativeShiftTradeRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementAlternativeshiftsTradesRequest request;

		private Builder() {
			request = new PostWorkforcemanagementAlternativeshiftsTradesRequest();
		}


		public Builder withBody(CreateAlternativeShiftTradeRequest body) {
		...
		public Builder withRequiredParams(CreateAlternativeShiftTradeRequest body) {
			request.setBody(body);
		...
		public PostWorkforcemanagementAlternativeshiftsTradesRequest build() {
