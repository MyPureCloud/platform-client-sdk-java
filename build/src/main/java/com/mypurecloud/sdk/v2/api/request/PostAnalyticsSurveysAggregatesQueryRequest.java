...
public class PostAnalyticsSurveysAggregatesQueryRequest {
    ...
    public PostAnalyticsSurveysAggregatesQueryRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<SurveyAggregationQuery> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostAnalyticsSurveysAggregatesQueryRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/analytics/surveys/aggregates/query")
                .withBody(body)
	...
	public static class Builder {
		private final PostAnalyticsSurveysAggregatesQueryRequest request;

		private Builder() {
			request = new PostAnalyticsSurveysAggregatesQueryRequest();
		}
		...
		public PostAnalyticsSurveysAggregatesQueryRequest build() {
