...
public class GetIdentityprovidersOktaRequest {
    ...
    public GetIdentityprovidersOktaRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() throws ApiException {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/identityproviders/okta")                .withCustomHeaders(customHeaders)
	...
	public static class Builder {
		private final GetIdentityprovidersOktaRequest request;

		private Builder() {
			request = new GetIdentityprovidersOktaRequest();
		}




		public GetIdentityprovidersOktaRequest build() {
			return request;
		}
	}
}
