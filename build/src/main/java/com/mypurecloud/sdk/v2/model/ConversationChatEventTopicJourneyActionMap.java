...
public class ConversationChatEventTopicJourneyActionMap  implements Serializable {
  
  private String id = null;
  private Long version = null;

  public ConversationChatEventTopicJourneyActionMap() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
    }
  }

  public ConversationChatEventTopicJourneyActionMap(Boolean initWithEmptyList) {
   ...
   **/
  public ConversationChatEventTopicJourneyActionMap id(String id) {
    this.id = id;
    return this;
  }
   ...
   **/
  public ConversationChatEventTopicJourneyActionMap version(Long version) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ConversationChatEventTopicJourneyActionMap conversationChatEventTopicJourneyActionMap = (ConversationChatEventTopicJourneyActionMap) o;

    return Objects.equals(this.id, conversationChatEventTopicJourneyActionMap.id) &&
            Objects.equals(this.version, conversationChatEventTopicJourneyActionMap.version);
  }
