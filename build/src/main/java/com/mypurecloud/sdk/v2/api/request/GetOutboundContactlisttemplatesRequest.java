...
public class GetOutboundContactlisttemplatesRequest {
	...
	public GetOutboundContactlisttemplatesRequest withPageSize(Integer pageSize) {
	...
	public GetOutboundContactlisttemplatesRequest withPageNumber(Integer pageNumber) {
	...
	public GetOutboundContactlisttemplatesRequest withAllowEmptyResult(Boolean allowEmptyResult) {
	...
	public GetOutboundContactlisttemplatesRequest withFilterType(String filterType) {
	...
	public GetOutboundContactlisttemplatesRequest withName(String name) {
	    this.setName(name);
	    return this;
	} 
	...
	public GetOutboundContactlisttemplatesRequest withTimeZone(String timeZone) {
	...
	public GetOutboundContactlisttemplatesRequest withSortBy(String sortBy) {
	...
	public GetOutboundContactlisttemplatesRequest withSortOrder(String sortOrder) {
    ...
    public GetOutboundContactlisttemplatesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/outbound/contactlisttemplates")
	...
	public static class Builder {
		private final GetOutboundContactlisttemplatesRequest request;

		private Builder() {
			request = new GetOutboundContactlisttemplatesRequest();
		}
		...
		public GetOutboundContactlisttemplatesRequest build() {
