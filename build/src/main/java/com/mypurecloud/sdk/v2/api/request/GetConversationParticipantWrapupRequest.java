...
public class GetConversationParticipantWrapupRequest {
    ...
    public ApiRequest<Void> withHttpInfo() throws ApiException {
        ...
        if (this.conversationId == null) {
            throw new ApiException(400, "Missing the required parameter 'conversationId' when building request for GetConversationParticipantWrapupRequest.");
        }
        
        // verify the required parameter 'participantId' is set
        if (this.participantId == null) {
            throw new ApiException(400, "Missing the required parameter 'participantId' when building request for GetConversationParticipantWrapupRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/conversations/{conversationId}/participants/{participantId}/wrapup")
	...
	public static class Builder {
		private final GetConversationParticipantWrapupRequest request;

		private Builder() {
			request = new GetConversationParticipantWrapupRequest();
		}
