...
public class PostConversationsCallParticipantConsultQueueRequest {
	...
	public PostConversationsCallParticipantConsultQueueRequest withParticipantId(String participantId) {
	    this.setParticipantId(participantId);
	    return this;
	} 

	private ConsultTransferToQueue body;
	public ConsultTransferToQueue getBody() {
		return this.body;
	}

	public void setBody(ConsultTransferToQueue body) {
		this.body = body;
	}

	public PostConversationsCallParticipantConsultQueueRequest withBody(ConsultTransferToQueue body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public ApiRequest<ConsultTransferToQueue> withHttpInfo() {
        
        // verify the required parameter 'conversationId' is set
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PostConversationsCallParticipantConsultQueueRequest.");
        }
        
        // verify the required parameter 'participantId' is set
        if (this.participantId == null) {
            throw new IllegalStateException("Missing the required parameter 'participantId' when building request for PostConversationsCallParticipantConsultQueueRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostConversationsCallParticipantConsultQueueRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/conversations/calls/{conversationId}/participants/{participantId}/consult/queue")
	...
	public static Builder builder(String conversationId, String participantId, ConsultTransferToQueue body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostConversationsCallParticipantConsultQueueRequest request;

		private Builder() {
			request = new PostConversationsCallParticipantConsultQueueRequest();
		}
		...
		public Builder withBody(ConsultTransferToQueue body) {
		...
		public Builder withRequiredParams(String conversationId, String participantId, ConsultTransferToQueue body) {
			request.setConversationId(conversationId);
			request.setParticipantId(participantId);
			request.setBody(body);
		...
		public PostConversationsCallParticipantConsultQueueRequest build() {
