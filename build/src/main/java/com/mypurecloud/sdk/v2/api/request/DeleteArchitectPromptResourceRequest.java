...
public class DeleteArchitectPromptResourceRequest {
	...
	public DeleteArchitectPromptResourceRequest withPromptId(String promptId) {
	...
	public DeleteArchitectPromptResourceRequest withLanguageCode(String languageCode) {
    ...
    public DeleteArchitectPromptResourceRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.promptId == null) {
            throw new IllegalStateException("Missing the required parameter 'promptId' when building request for DeleteArchitectPromptResourceRequest.");
        }
        
        // verify the required parameter 'languageCode' is set
        if (this.languageCode == null) {
            throw new IllegalStateException("Missing the required parameter 'languageCode' when building request for DeleteArchitectPromptResourceRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/architect/prompts/{promptId}/resources/{languageCode}")
	...
	public static class Builder {
		private final DeleteArchitectPromptResourceRequest request;

		private Builder() {
			request = new DeleteArchitectPromptResourceRequest();
		}
		...
		public DeleteArchitectPromptResourceRequest build() {
