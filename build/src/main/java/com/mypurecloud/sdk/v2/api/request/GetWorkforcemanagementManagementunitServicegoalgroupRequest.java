...
public class GetWorkforcemanagementManagementunitServicegoalgroupRequest {
	...
	public GetWorkforcemanagementManagementunitServicegoalgroupRequest withManagementUnitId(String managementUnitId) {
	...
	public GetWorkforcemanagementManagementunitServicegoalgroupRequest withServiceGoalGroupId(String serviceGoalGroupId) {
    ...
    public GetWorkforcemanagementManagementunitServicegoalgroupRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.managementUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'managementUnitId' when building request for GetWorkforcemanagementManagementunitServicegoalgroupRequest.");
        }
        
        // verify the required parameter 'serviceGoalGroupId' is set
        if (this.serviceGoalGroupId == null) {
            throw new IllegalStateException("Missing the required parameter 'serviceGoalGroupId' when building request for GetWorkforcemanagementManagementunitServicegoalgroupRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/managementunits/{managementUnitId}/servicegoalgroups/{serviceGoalGroupId}")
	...
	public static class Builder {
		private final GetWorkforcemanagementManagementunitServicegoalgroupRequest request;

		private Builder() {
			request = new GetWorkforcemanagementManagementunitServicegoalgroupRequest();
		}
		...
		public GetWorkforcemanagementManagementunitServicegoalgroupRequest build() {
