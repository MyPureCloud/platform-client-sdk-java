...
public class PostExternalcontactsBulkNotesRequest {
	...
	public PostExternalcontactsBulkNotesRequest withBody(BulkIdsRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostExternalcontactsBulkNotesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<BulkIdsRequest> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostExternalcontactsBulkNotesRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/externalcontacts/bulk/notes")
                .withBody(body)
	...
	public static class Builder {
		private final PostExternalcontactsBulkNotesRequest request;

		private Builder() {
			request = new PostExternalcontactsBulkNotesRequest();
		}
		...
		public PostExternalcontactsBulkNotesRequest build() {
