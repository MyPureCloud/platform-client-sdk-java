...
public class GetIntegrationsRequest {
	...
	public GetIntegrationsRequest withPageSize(Integer pageSize) {
	...
	public GetIntegrationsRequest withPageNumber(Integer pageNumber) {
	...
	public GetIntegrationsRequest withSortBy(String sortBy) {
	...
	public GetIntegrationsRequest withExpand(List<String> expand) {
	...
	public GetIntegrationsRequest withNextPage(String nextPage) {
	...
	public GetIntegrationsRequest withPreviousPage(String previousPage) {
    ...
    public GetIntegrationsRequest withCustomHeader(String name, String value) {
	...
	public static class Builder {
		private final GetIntegrationsRequest request;
