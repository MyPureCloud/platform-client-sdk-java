...
public class GetGamificationContestAgentsScoresMeRequest {
	...
	public GetGamificationContestAgentsScoresMeRequest withContestId(String contestId) {
	...
	public GetGamificationContestAgentsScoresMeRequest withPageNumber(Integer pageNumber) {
	...
	public GetGamificationContestAgentsScoresMeRequest withPageSize(Integer pageSize) {
	...
	public GetGamificationContestAgentsScoresMeRequest withWorkday(LocalDate workday) {
	...
	public GetGamificationContestAgentsScoresMeRequest withReturnsView(String returnsView) {
    ...
    public GetGamificationContestAgentsScoresMeRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.contestId == null) {
            throw new IllegalStateException("Missing the required parameter 'contestId' when building request for GetGamificationContestAgentsScoresMeRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/gamification/contests/{contestId}/agents/scores/me")
	...
	public static class Builder {
		private final GetGamificationContestAgentsScoresMeRequest request;

		private Builder() {
			request = new GetGamificationContestAgentsScoresMeRequest();
		}
		...
		public GetGamificationContestAgentsScoresMeRequest build() {
