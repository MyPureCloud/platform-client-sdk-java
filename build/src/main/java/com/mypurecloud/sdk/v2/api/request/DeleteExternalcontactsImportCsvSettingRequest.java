...
public class DeleteExternalcontactsImportCsvSettingRequest {
	...
	public DeleteExternalcontactsImportCsvSettingRequest withSettingsId(String settingsId) {
    ...
    public DeleteExternalcontactsImportCsvSettingRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.settingsId == null) {
            throw new IllegalStateException("Missing the required parameter 'settingsId' when building request for DeleteExternalcontactsImportCsvSettingRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/externalcontacts/import/csv/settings/{settingsId}")
	...
	public static class Builder {
		private final DeleteExternalcontactsImportCsvSettingRequest request;

		private Builder() {
			request = new DeleteExternalcontactsImportCsvSettingRequest();
		}
		...
		public DeleteExternalcontactsImportCsvSettingRequest build() {
