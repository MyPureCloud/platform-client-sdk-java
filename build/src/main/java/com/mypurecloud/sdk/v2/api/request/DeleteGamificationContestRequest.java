...
public class DeleteGamificationContestRequest {
	...
	public DeleteGamificationContestRequest withContestId(String contestId) {
    ...
    public DeleteGamificationContestRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.contestId == null) {
            throw new IllegalStateException("Missing the required parameter 'contestId' when building request for DeleteGamificationContestRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/gamification/contests/{contestId}")
	...
	public static class Builder {
		private final DeleteGamificationContestRequest request;

		private Builder() {
			request = new DeleteGamificationContestRequest();
		}
		...
		public DeleteGamificationContestRequest build() {
