...
public class PostKnowledgeKnowledgebaseDocumentsPresentationsRequest {
	...
	public PostKnowledgeKnowledgebaseDocumentsPresentationsRequest withKnowledgeBaseId(String knowledgeBaseId) {
	    this.setKnowledgeBaseId(knowledgeBaseId);
	    return this;
	} 

	private KnowledgeDocumentPresentation body;
	public KnowledgeDocumentPresentation getBody() {
		return this.body;
	}

	public void setBody(KnowledgeDocumentPresentation body) {
		this.body = body;
	}

	public PostKnowledgeKnowledgebaseDocumentsPresentationsRequest withBody(KnowledgeDocumentPresentation body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostKnowledgeKnowledgebaseDocumentsPresentationsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<KnowledgeDocumentPresentation> withHttpInfo() {
        
        // verify the required parameter 'knowledgeBaseId' is set
        if (this.knowledgeBaseId == null) {
            throw new IllegalStateException("Missing the required parameter 'knowledgeBaseId' when building request for PostKnowledgeKnowledgebaseDocumentsPresentationsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/documents/presentations")
	...
	public static class Builder {
		private final PostKnowledgeKnowledgebaseDocumentsPresentationsRequest request;

		private Builder() {
			request = new PostKnowledgeKnowledgebaseDocumentsPresentationsRequest();
		}
		...
		public Builder withBody(KnowledgeDocumentPresentation body) {
		...
		public PostKnowledgeKnowledgebaseDocumentsPresentationsRequest build() {
