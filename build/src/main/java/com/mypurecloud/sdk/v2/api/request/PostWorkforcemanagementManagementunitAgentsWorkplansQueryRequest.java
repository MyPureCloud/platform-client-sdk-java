...
public class PostWorkforcemanagementManagementunitAgentsWorkplansQueryRequest {
	...
	public PostWorkforcemanagementManagementunitAgentsWorkplansQueryRequest withManagementUnitId(String managementUnitId) {
	...
	public void setBody(GetAgentsWorkPlansRequest body) {
		this.body = body;
	}
    ...
    public PostWorkforcemanagementManagementunitAgentsWorkplansQueryRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<GetAgentsWorkPlansRequest> withHttpInfo() {
	...
	public static class Builder {
		private final PostWorkforcemanagementManagementunitAgentsWorkplansQueryRequest request;

		private Builder() {
			request = new PostWorkforcemanagementManagementunitAgentsWorkplansQueryRequest();
		}
		...
		public PostWorkforcemanagementManagementunitAgentsWorkplansQueryRequest build() {
