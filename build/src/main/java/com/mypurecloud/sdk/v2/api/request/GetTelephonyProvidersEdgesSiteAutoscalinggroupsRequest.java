...
public class GetTelephonyProvidersEdgesSiteAutoscalinggroupsRequest {
	...
	public GetTelephonyProvidersEdgesSiteAutoscalinggroupsRequest withSiteId(String siteId) {
    ...
    public GetTelephonyProvidersEdgesSiteAutoscalinggroupsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.siteId == null) {
            throw new IllegalStateException("Missing the required parameter 'siteId' when building request for GetTelephonyProvidersEdgesSiteAutoscalinggroupsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/telephony/providers/edges/sites/{siteId}/autoscalinggroups")
	...
	public static class Builder {
		private final GetTelephonyProvidersEdgesSiteAutoscalinggroupsRequest request;

		private Builder() {
			request = new GetTelephonyProvidersEdgesSiteAutoscalinggroupsRequest();
		}
		...
		public GetTelephonyProvidersEdgesSiteAutoscalinggroupsRequest build() {
