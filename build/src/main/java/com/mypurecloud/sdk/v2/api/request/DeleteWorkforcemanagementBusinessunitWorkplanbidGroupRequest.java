...
public class DeleteWorkforcemanagementBusinessunitWorkplanbidGroupRequest {
	...
	public DeleteWorkforcemanagementBusinessunitWorkplanbidGroupRequest withBusinessUnitId(String businessUnitId) {
	...
	public DeleteWorkforcemanagementBusinessunitWorkplanbidGroupRequest withBidId(String bidId) {
	    this.setBidId(bidId);
	    return this;
	} 
	...
	public DeleteWorkforcemanagementBusinessunitWorkplanbidGroupRequest withBidGroupId(String bidGroupId) {
    ...
    public DeleteWorkforcemanagementBusinessunitWorkplanbidGroupRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("DELETE", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/workplanbids/{bidId}/groups/{bidGroupId}")
	...
	public static class Builder {
		...
		private Builder() {
			request = new DeleteWorkforcemanagementBusinessunitWorkplanbidGroupRequest();
		}
