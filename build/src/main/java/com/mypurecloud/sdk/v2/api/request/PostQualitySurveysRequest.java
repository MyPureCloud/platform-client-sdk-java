...
public class PostQualitySurveysRequest {

	private CreateSurveyRequest body;
	public CreateSurveyRequest getBody() {
		return this.body;
	}

	public void setBody(CreateSurveyRequest body) {
		this.body = body;
	}

	public PostQualitySurveysRequest withBody(CreateSurveyRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostQualitySurveysRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<CreateSurveyRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostQualitySurveysRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/quality/surveys")
                .withBody(body)
	...
	public static Builder builder(CreateSurveyRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostQualitySurveysRequest request;

		private Builder() {
			request = new PostQualitySurveysRequest();
		}


		public Builder withBody(CreateSurveyRequest body) {
		...
		public Builder withRequiredParams(CreateSurveyRequest body) {
			request.setBody(body);
		...
		public PostQualitySurveysRequest build() {
