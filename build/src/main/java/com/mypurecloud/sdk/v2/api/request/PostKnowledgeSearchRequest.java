...
public class PostKnowledgeSearchRequest {

	private KnowledgeSourcesSearchRequest body;
	public KnowledgeSourcesSearchRequest getBody() {
		return this.body;
	}

	public void setBody(KnowledgeSourcesSearchRequest body) {
		this.body = body;
	}

	public PostKnowledgeSearchRequest withBody(KnowledgeSourcesSearchRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostKnowledgeSearchRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<KnowledgeSourcesSearchRequest> withHttpInfo() {
        

        return ApiRequestBuilder.create("POST", "/api/v2/knowledge/search")
                .withBody(body)
	...
	public static class Builder {
		private final PostKnowledgeSearchRequest request;

		private Builder() {
			request = new PostKnowledgeSearchRequest();
		}


		public Builder withBody(KnowledgeSourcesSearchRequest body) {
		...
		public PostKnowledgeSearchRequest build() {
