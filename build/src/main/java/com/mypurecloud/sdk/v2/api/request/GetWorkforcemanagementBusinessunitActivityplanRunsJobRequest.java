...
public class GetWorkforcemanagementBusinessunitActivityplanRunsJobRequest {
	...
	public GetWorkforcemanagementBusinessunitActivityplanRunsJobRequest withBusinessUnitId(String businessUnitId) {
	...
	public GetWorkforcemanagementBusinessunitActivityplanRunsJobRequest withActivityPlanId(String activityPlanId) {
	...
	public GetWorkforcemanagementBusinessunitActivityplanRunsJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetWorkforcemanagementBusinessunitActivityplanRunsJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for GetWorkforcemanagementBusinessunitActivityplanRunsJobRequest.");
        }
        
        // verify the required parameter 'activityPlanId' is set
        if (this.activityPlanId == null) {
            throw new IllegalStateException("Missing the required parameter 'activityPlanId' when building request for GetWorkforcemanagementBusinessunitActivityplanRunsJobRequest.");
        }
        
        // verify the required parameter 'jobId' is set
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetWorkforcemanagementBusinessunitActivityplanRunsJobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/activityplans/{activityPlanId}/runs/jobs/{jobId}")
	...
	public static Builder builder(String businessUnitId, String activityPlanId, String jobId) {
	    return new Builder()
	            .withRequiredParams(businessUnitId, activityPlanId, jobId);
	}


	public static class Builder {
		private final GetWorkforcemanagementBusinessunitActivityplanRunsJobRequest request;

		private Builder() {
			request = new GetWorkforcemanagementBusinessunitActivityplanRunsJobRequest();
		}
		...
		public Builder withRequiredParams(String businessUnitId, String activityPlanId, String jobId) {
			request.setBusinessUnitId(businessUnitId);
			request.setActivityPlanId(activityPlanId);
			request.setJobId(jobId);
		...
		public GetWorkforcemanagementBusinessunitActivityplanRunsJobRequest build() {
