...
public class PostTaskmanagementWorkbinsQueryRequest {

	private WorkbinQueryRequest body;
	public WorkbinQueryRequest getBody() {
		return this.body;
	}

	public void setBody(WorkbinQueryRequest body) {
		this.body = body;
	}

	public PostTaskmanagementWorkbinsQueryRequest withBody(WorkbinQueryRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostTaskmanagementWorkbinsQueryRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<WorkbinQueryRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostTaskmanagementWorkbinsQueryRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/taskmanagement/workbins/query")
                .withBody(body)
	...
	public static Builder builder(WorkbinQueryRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostTaskmanagementWorkbinsQueryRequest request;

		private Builder() {
			request = new PostTaskmanagementWorkbinsQueryRequest();
		}


		public Builder withBody(WorkbinQueryRequest body) {
		...
		public Builder withRequiredParams(WorkbinQueryRequest body) {
			request.setBody(body);
		...
		public PostTaskmanagementWorkbinsQueryRequest build() {
