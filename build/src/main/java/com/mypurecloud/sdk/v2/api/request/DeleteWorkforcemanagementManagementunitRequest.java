...
public class DeleteWorkforcemanagementManagementunitRequest {
	...
	public DeleteWorkforcemanagementManagementunitRequest withManagementUnitId(String managementUnitId) {
    ...
    public DeleteWorkforcemanagementManagementunitRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.managementUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'managementUnitId' when building request for DeleteWorkforcemanagementManagementunitRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/workforcemanagement/managementunits/{managementUnitId}")
	...
	public static class Builder {
		private final DeleteWorkforcemanagementManagementunitRequest request;

		private Builder() {
			request = new DeleteWorkforcemanagementManagementunitRequest();
		}
		...
		public DeleteWorkforcemanagementManagementunitRequest build() {
