...
public class DeleteWorkforcemanagementManagementunitRequest {
	...
	public DeleteWorkforcemanagementManagementunitRequest withMuId(String muId) {
	    this.setMuId(muId);
	    return this;
	} 
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.muId == null) {
            throw new IllegalStateException("Missing the required parameter 'muId' when building request for DeleteWorkforcemanagementManagementunitRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/workforcemanagement/managementunits/{muId}")
