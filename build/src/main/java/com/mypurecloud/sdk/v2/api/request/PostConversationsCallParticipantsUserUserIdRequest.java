...
public class PostConversationsCallParticipantsUserUserIdRequest {
	...
	public PostConversationsCallParticipantsUserUserIdRequest withConversationId(String conversationId) {
	...
	public PostConversationsCallParticipantsUserUserIdRequest withUserId(String userId) {
	...
	public PostConversationsCallParticipantsUserUserIdRequest withBody(Conversation body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostConversationsCallParticipantsUserUserIdRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Conversation> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PostConversationsCallParticipantsUserUserIdRequest.");
        }
        
        // verify the required parameter 'userId' is set
        if (this.userId == null) {
            throw new IllegalStateException("Missing the required parameter 'userId' when building request for PostConversationsCallParticipantsUserUserIdRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostConversationsCallParticipantsUserUserIdRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/conversations/calls/{conversationId}/participants/user/{userId}")
	...
	public static Builder builder(String conversationId, String userId, Conversation body) {
	    return new Builder()
	            .withRequiredParams(conversationId, userId, body);
	}


	public static class Builder {
		private final PostConversationsCallParticipantsUserUserIdRequest request;

		private Builder() {
			request = new PostConversationsCallParticipantsUserUserIdRequest();
		}
		...
		public Builder withRequiredParams(String conversationId, String userId, Conversation body) {
			request.setConversationId(conversationId);
			request.setUserId(userId);
			request.setBody(body);
		...
		public PostConversationsCallParticipantsUserUserIdRequest build() {
