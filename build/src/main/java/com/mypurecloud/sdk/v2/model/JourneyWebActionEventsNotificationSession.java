...
public class JourneyWebActionEventsNotificationSession  implements Serializable {
  
  private String id = null;
  private String selfUri = null;
  private String type = null;

  public JourneyWebActionEventsNotificationSession() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
    }
  }

  public JourneyWebActionEventsNotificationSession(Boolean initWithEmptyList) {
  ...
  /**
   **/
  public JourneyWebActionEventsNotificationSession id(String id) {
    this.id = id;
    return this;
  }
