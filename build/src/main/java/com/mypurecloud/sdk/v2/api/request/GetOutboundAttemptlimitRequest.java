...
public class GetOutboundAttemptlimitRequest {
	...
	public GetOutboundAttemptlimitRequest withAttemptLimitsId(String attemptLimitsId) {
    ...
    public GetOutboundAttemptlimitRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.attemptLimitsId == null) {
            throw new IllegalStateException("Missing the required parameter 'attemptLimitsId' when building request for GetOutboundAttemptlimitRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/outbound/attemptlimits/{attemptLimitsId}")
	...
	public static class Builder {
		private final GetOutboundAttemptlimitRequest request;

		private Builder() {
			request = new GetOutboundAttemptlimitRequest();
		}
		...
		public GetOutboundAttemptlimitRequest build() {
