...
public class GetTaskmanagementWorktypeFlowsOnattributechangeRuleRequest {
	...
	public GetTaskmanagementWorktypeFlowsOnattributechangeRuleRequest withWorktypeId(String worktypeId) {
	...
	public GetTaskmanagementWorktypeFlowsOnattributechangeRuleRequest withRuleId(String ruleId) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.worktypeId == null) {
            throw new IllegalStateException("Missing the required parameter 'worktypeId' when building request for GetTaskmanagementWorktypeFlowsOnattributechangeRuleRequest.");
        }
        
        // verify the required parameter 'ruleId' is set
        if (this.ruleId == null) {
            throw new IllegalStateException("Missing the required parameter 'ruleId' when building request for GetTaskmanagementWorktypeFlowsOnattributechangeRuleRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/taskmanagement/worktypes/{worktypeId}/flows/onattributechange/rules/{ruleId}")
	...
	public static class Builder {
		private final GetTaskmanagementWorktypeFlowsOnattributechangeRuleRequest request;

		private Builder() {
			request = new GetTaskmanagementWorktypeFlowsOnattributechangeRuleRequest();
		}
		...
		public GetTaskmanagementWorktypeFlowsOnattributechangeRuleRequest build() {
