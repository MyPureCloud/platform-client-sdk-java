...
public class ArchitectFlowOutcomeNotificationErrorDetail  implements Serializable {
  ...
  public ArchitectFlowOutcomeNotificationErrorDetail() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
    }
  }

  public ArchitectFlowOutcomeNotificationErrorDetail(Boolean initWithEmptyList) {
  ...
  /**
   **/
  public ArchitectFlowOutcomeNotificationErrorDetail errorCode(String errorCode) {
