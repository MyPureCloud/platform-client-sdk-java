...
import com.mypurecloud.sdk.v2.model.FlowOutcomeDivisionView;
...
public class FlowOutcomeDivisionViewEntityListing  implements Serializable, PagedResource<FlowOutcomeDivisionView> {
  ...
  public FlowOutcomeDivisionViewEntityListing() {
  ...
  /**
   **/
  public FlowOutcomeDivisionViewEntityListing entities(List<FlowOutcomeDivisionView> entities) {
  ...
  public List<FlowOutcomeDivisionView> getEntities() {
    return entities;
  }
  public void setEntities(List<FlowOutcomeDivisionView> entities) {
    this.entities = entities;
  }
