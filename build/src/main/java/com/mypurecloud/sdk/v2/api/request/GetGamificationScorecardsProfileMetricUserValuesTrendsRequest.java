...
public class GetGamificationScorecardsProfileMetricUserValuesTrendsRequest {
	...
	public GetGamificationScorecardsProfileMetricUserValuesTrendsRequest withMetricId(String metricId) {
	...
	public GetGamificationScorecardsProfileMetricUserValuesTrendsRequest withUserId(String userId) {
	...
	public GetGamificationScorecardsProfileMetricUserValuesTrendsRequest withTimeZone(String timeZone) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.profileId == null) {
            throw new IllegalStateException("Missing the required parameter 'profileId' when building request for GetGamificationScorecardsProfileMetricUserValuesTrendsRequest.");
        }
        
        // verify the required parameter 'metricId' is set
        if (this.metricId == null) {
            throw new IllegalStateException("Missing the required parameter 'metricId' when building request for GetGamificationScorecardsProfileMetricUserValuesTrendsRequest.");
        }
        
        // verify the required parameter 'userId' is set
        if (this.userId == null) {
            throw new IllegalStateException("Missing the required parameter 'userId' when building request for GetGamificationScorecardsProfileMetricUserValuesTrendsRequest.");
        }
        
        // verify the required parameter 'startWorkday' is set
        if (this.startWorkday == null) {
            throw new IllegalStateException("Missing the required parameter 'startWorkday' when building request for GetGamificationScorecardsProfileMetricUserValuesTrendsRequest.");
        }
        
        // verify the required parameter 'endWorkday' is set
        if (this.endWorkday == null) {
            throw new IllegalStateException("Missing the required parameter 'endWorkday' when building request for GetGamificationScorecardsProfileMetricUserValuesTrendsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/gamification/scorecards/profiles/{profileId}/metrics/{metricId}/users/{userId}/values/trends")
	...
	public static Builder builder(String profileId, String metricId, String userId, LocalDate startWorkday, LocalDate endWorkday) {
	    return new Builder()
	            .withRequiredParams(profileId, metricId, userId, startWorkday, endWorkday);
	}


	public static class Builder {
		private final GetGamificationScorecardsProfileMetricUserValuesTrendsRequest request;

		private Builder() {
			request = new GetGamificationScorecardsProfileMetricUserValuesTrendsRequest();
		}
		...
		public Builder withRequiredParams(String profileId, String metricId, String userId, LocalDate startWorkday, LocalDate endWorkday) {
			request.setProfileId(profileId);
			request.setMetricId(metricId);
			request.setUserId(userId);
			request.setStartWorkday(startWorkday);
		...
		public GetGamificationScorecardsProfileMetricUserValuesTrendsRequest build() {
