...
public class PostTaskmanagementWorkitemsQueryRequest {

	private WorkitemQueryPostRequest body;
	public WorkitemQueryPostRequest getBody() {
		return this.body;
	}

	public void setBody(WorkitemQueryPostRequest body) {
		this.body = body;
	}

	public PostTaskmanagementWorkitemsQueryRequest withBody(WorkitemQueryPostRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostTaskmanagementWorkitemsQueryRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<WorkitemQueryPostRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostTaskmanagementWorkitemsQueryRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/taskmanagement/workitems/query")
                .withBody(body)
	...
	public static Builder builder(WorkitemQueryPostRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostTaskmanagementWorkitemsQueryRequest request;

		private Builder() {
			request = new PostTaskmanagementWorkitemsQueryRequest();
		}


		public Builder withBody(WorkitemQueryPostRequest body) {
		...
		public Builder withRequiredParams(WorkitemQueryPostRequest body) {
			request.setBody(body);
		...
		public PostTaskmanagementWorkitemsQueryRequest build() {
