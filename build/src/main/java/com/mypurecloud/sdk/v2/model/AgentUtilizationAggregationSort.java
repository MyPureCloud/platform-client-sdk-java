...
public class AgentUtilizationAggregationSort  implements Serializable {
 ...
 @JsonDeserialize(using = FunctionEnumDeserializer.class)
  ...
  public AgentUtilizationAggregationSort() {
   ...
   * Name of the metric used for sorting values.
   **/
  public AgentUtilizationAggregationSort name(NameEnum name) {
    this.name = name;
    return this;
  }
   ...
   * Aggregation function used for the sort metric.
   **/
  public AgentUtilizationAggregationSort function(FunctionEnum function) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    AgentUtilizationAggregationSort agentUtilizationAggregationSort = (AgentUtilizationAggregationSort) o;

    return Objects.equals(this.name, agentUtilizationAggregationSort.name) &&
            Objects.equals(this.function, agentUtilizationAggregationSort.function);
  }
