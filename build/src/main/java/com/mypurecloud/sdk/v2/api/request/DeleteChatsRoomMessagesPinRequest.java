...
public class DeleteChatsRoomMessagesPinRequest {
	...
	public DeleteChatsRoomMessagesPinRequest withRoomJid(String roomJid) {
	...
	public DeleteChatsRoomMessagesPinRequest withPinnedMessageId(String pinnedMessageId) {
    ...
    public DeleteChatsRoomMessagesPinRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.roomJid == null) {
            throw new IllegalStateException("Missing the required parameter 'roomJid' when building request for DeleteChatsRoomMessagesPinRequest.");
        }
        
        // verify the required parameter 'pinnedMessageId' is set
        if (this.pinnedMessageId == null) {
            throw new IllegalStateException("Missing the required parameter 'pinnedMessageId' when building request for DeleteChatsRoomMessagesPinRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/chats/rooms/{roomJid}/messages/pins/{pinnedMessageId}")
	...
	public static class Builder {
		private final DeleteChatsRoomMessagesPinRequest request;

		private Builder() {
			request = new DeleteChatsRoomMessagesPinRequest();
		}
		...
		public DeleteChatsRoomMessagesPinRequest build() {
