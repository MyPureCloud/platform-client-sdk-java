...
public class DeleteRecordingCrossplatformMediaretentionpolicyRequest {
	...
	public DeleteRecordingCrossplatformMediaretentionpolicyRequest withPolicyId(String policyId) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.policyId == null) {
            throw new IllegalStateException("Missing the required parameter 'policyId' when building request for DeleteRecordingCrossplatformMediaretentionpolicyRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/recording/crossplatform/mediaretentionpolicies/{policyId}")
	...
	public static class Builder {
		private final DeleteRecordingCrossplatformMediaretentionpolicyRequest request;

		private Builder() {
			request = new DeleteRecordingCrossplatformMediaretentionpolicyRequest();
		}
		...
		public DeleteRecordingCrossplatformMediaretentionpolicyRequest build() {
