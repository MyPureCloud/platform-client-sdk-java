...
public class GetWorkforcemanagementHistoricaldataBulkRemoveJobRequest {
	...
	public GetWorkforcemanagementHistoricaldataBulkRemoveJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetWorkforcemanagementHistoricaldataBulkRemoveJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetWorkforcemanagementHistoricaldataBulkRemoveJobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/historicaldata/bulk/remove/jobs/{jobId}")
	...
	public static class Builder {
		private final GetWorkforcemanagementHistoricaldataBulkRemoveJobRequest request;

		private Builder() {
			request = new GetWorkforcemanagementHistoricaldataBulkRemoveJobRequest();
		}
		...
		public GetWorkforcemanagementHistoricaldataBulkRemoveJobRequest build() {
