...
public class PutConversationsMessagingSettingsDefaultRequest {
	...
	public PutConversationsMessagingSettingsDefaultRequest withBody(MessagingSettingDefaultRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutConversationsMessagingSettingsDefaultRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<MessagingSettingDefaultRequest> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutConversationsMessagingSettingsDefaultRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/conversations/messaging/settings/default")
                .withBody(body)
	...
	public static class Builder {
		private final PutConversationsMessagingSettingsDefaultRequest request;

		private Builder() {
			request = new PutConversationsMessagingSettingsDefaultRequest();
		}
		...
		public PutConversationsMessagingSettingsDefaultRequest build() {
