...
public class PostWorkforcemanagementBusinessunitTimeofflimitsValuesQueryRequest {
	...
	public PostWorkforcemanagementBusinessunitTimeofflimitsValuesQueryRequest withBusinessUnitId(String businessUnitId) {
	    this.setBusinessUnitId(businessUnitId);
	    return this;
	} 

	private QueryTimeOffLimitValuesRequest body;
	public QueryTimeOffLimitValuesRequest getBody() {
		return this.body;
	}

	public void setBody(QueryTimeOffLimitValuesRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementBusinessunitTimeofflimitsValuesQueryRequest withBody(QueryTimeOffLimitValuesRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementBusinessunitTimeofflimitsValuesQueryRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<QueryTimeOffLimitValuesRequest> withHttpInfo() {
        
        // verify the required parameter 'businessUnitId' is set
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PostWorkforcemanagementBusinessunitTimeofflimitsValuesQueryRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementBusinessunitTimeofflimitsValuesQueryRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/timeofflimits/values/query")
	...
	public static Builder builder(String businessUnitId, QueryTimeOffLimitValuesRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementBusinessunitTimeofflimitsValuesQueryRequest request;

		private Builder() {
			request = new PostWorkforcemanagementBusinessunitTimeofflimitsValuesQueryRequest();
		}
		...
		public Builder withBody(QueryTimeOffLimitValuesRequest body) {
		...
		public Builder withRequiredParams(String businessUnitId, QueryTimeOffLimitValuesRequest body) {
			request.setBusinessUnitId(businessUnitId);
			request.setBody(body);
		...
		public PostWorkforcemanagementBusinessunitTimeofflimitsValuesQueryRequest build() {
