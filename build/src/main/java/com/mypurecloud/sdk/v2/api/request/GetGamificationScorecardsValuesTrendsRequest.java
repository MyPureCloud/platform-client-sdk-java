...
public class GetGamificationScorecardsValuesTrendsRequest {
	...
	public GetGamificationScorecardsValuesTrendsRequest withStartWorkday(LocalDate startWorkday) {
	...
	public GetGamificationScorecardsValuesTrendsRequest withEndWorkday(LocalDate endWorkday) {
	...
	public GetGamificationScorecardsValuesTrendsRequest withFilterType(String filterType) {
	...
	public GetGamificationScorecardsValuesTrendsRequest withTimeZone(String timeZone) {
    ...
    public GetGamificationScorecardsValuesTrendsRequest withCustomHeader(String name, String value) {
	...
	public static class Builder {
		...
		private Builder() {
			request = new GetGamificationScorecardsValuesTrendsRequest();
		}
