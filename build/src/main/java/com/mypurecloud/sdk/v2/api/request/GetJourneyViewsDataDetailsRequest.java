...
public class GetJourneyViewsDataDetailsRequest {
    ...
    public GetJourneyViewsDataDetailsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/journey/views/data/details")
	...
	public static class Builder {
		private final GetJourneyViewsDataDetailsRequest request;

		private Builder() {
			request = new GetJourneyViewsDataDetailsRequest();
		}
		...
		public GetJourneyViewsDataDetailsRequest build() {
