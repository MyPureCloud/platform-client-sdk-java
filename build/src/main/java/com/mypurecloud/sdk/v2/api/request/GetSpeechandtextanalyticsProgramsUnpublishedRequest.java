...
public class GetSpeechandtextanalyticsProgramsUnpublishedRequest {
	...
	public GetSpeechandtextanalyticsProgramsUnpublishedRequest withNextPage(String nextPage) {
	...
	public GetSpeechandtextanalyticsProgramsUnpublishedRequest withPageSize(Integer pageSize) {
    ...
    public GetSpeechandtextanalyticsProgramsUnpublishedRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/speechandtextanalytics/programs/unpublished")
	...
	public static class Builder {
		private final GetSpeechandtextanalyticsProgramsUnpublishedRequest request;

		private Builder() {
			request = new GetSpeechandtextanalyticsProgramsUnpublishedRequest();
		}
		...
		public GetSpeechandtextanalyticsProgramsUnpublishedRequest build() {
