...
public class GetConversationCustomattributeRequest {
	...
	public GetConversationCustomattributeRequest withConversationId(String conversationId) {
	...
	public GetConversationCustomattributeRequest withAttributesId(String attributesId) {
    ...
    public GetConversationCustomattributeRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for GetConversationCustomattributeRequest.");
        }
        
        // verify the required parameter 'attributesId' is set
        if (this.attributesId == null) {
            throw new IllegalStateException("Missing the required parameter 'attributesId' when building request for GetConversationCustomattributeRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/conversations/{conversationId}/customattributes/{attributesId}")
	...
	public static class Builder {
		private final GetConversationCustomattributeRequest request;

		private Builder() {
			request = new GetConversationCustomattributeRequest();
		}
		...
		public GetConversationCustomattributeRequest build() {
