...
public class TtsEngineEntityListing  implements Serializable, PagedResource<TtsEngineEntity> {
  ...
  /**
   **/
  public TtsEngineEntityListing entities(List<TtsEngineEntity> entities) {
  ...
  public List<TtsEngineEntity> getEntities() {
    return entities;
  }
  public void setEntities(List<TtsEngineEntity> entities) {
    this.entities = entities;
  }
