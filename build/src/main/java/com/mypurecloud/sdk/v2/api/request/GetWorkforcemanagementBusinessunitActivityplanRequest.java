...
public class GetWorkforcemanagementBusinessunitActivityplanRequest {
	...
	public GetWorkforcemanagementBusinessunitActivityplanRequest withBusinessUnitId(String businessUnitId) {
	...
	public GetWorkforcemanagementBusinessunitActivityplanRequest withActivityPlanId(String activityPlanId) {
    ...
    public GetWorkforcemanagementBusinessunitActivityplanRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for GetWorkforcemanagementBusinessunitActivityplanRequest.");
        }
        
        // verify the required parameter 'activityPlanId' is set
        if (this.activityPlanId == null) {
            throw new IllegalStateException("Missing the required parameter 'activityPlanId' when building request for GetWorkforcemanagementBusinessunitActivityplanRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/activityplans/{activityPlanId}")
	...
	public static class Builder {
		private final GetWorkforcemanagementBusinessunitActivityplanRequest request;

		private Builder() {
			request = new GetWorkforcemanagementBusinessunitActivityplanRequest();
		}
		...
		public GetWorkforcemanagementBusinessunitActivityplanRequest build() {
