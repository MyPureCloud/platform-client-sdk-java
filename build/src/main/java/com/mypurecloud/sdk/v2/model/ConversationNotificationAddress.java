...
public class ConversationNotificationAddress  implements Serializable {
  ...
  /**
   **/
  public ConversationNotificationAddress name(String name) {
    this.name = name;
    return this;
  }
  ...
  /**
   **/
  public ConversationNotificationAddress nameRaw(String nameRaw) {
  ...
  /**
   **/
  public ConversationNotificationAddress addressNormalized(String addressNormalized) {
  ...
  /**
   **/
  public ConversationNotificationAddress addressRaw(String addressRaw) {
  ...
  /**
   **/
  public ConversationNotificationAddress addressDisplayable(String addressDisplayable) {
  ...
  /**
   **/
  public ConversationNotificationAddress additionalProperties(Object additionalProperties) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.name, conversationNotificationAddress.name) &&
        Objects.equals(this.nameRaw, conversationNotificationAddress.nameRaw) &&
        Objects.equals(this.addressNormalized, conversationNotificationAddress.addressNormalized) &&
        Objects.equals(this.addressRaw, conversationNotificationAddress.addressRaw) &&
        Objects.equals(this.addressDisplayable, conversationNotificationAddress.addressDisplayable) &&
        Objects.equals(this.additionalProperties, conversationNotificationAddress.additionalProperties);
  }
