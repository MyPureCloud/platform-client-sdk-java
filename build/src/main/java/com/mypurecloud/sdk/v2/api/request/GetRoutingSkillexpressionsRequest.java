...
public class GetRoutingSkillexpressionsRequest {
	...
	public GetRoutingSkillexpressionsRequest withFormat(String format) {
	...
	public GetRoutingSkillexpressionsRequest withIncludeArchived(Boolean includeArchived) {
	...
	public GetRoutingSkillexpressionsRequest withId(List<String> id) {
	    this.setId(id);
	    return this;
	} 
    ...
    public GetRoutingSkillexpressionsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/routing/skillexpressions")
	...
	public static class Builder {
		private final GetRoutingSkillexpressionsRequest request;

		private Builder() {
			request = new GetRoutingSkillexpressionsRequest();
		}
		...
		public GetRoutingSkillexpressionsRequest build() {
