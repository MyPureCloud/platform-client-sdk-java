...
public class RelationshipsExportFieldListFilter  implements Serializable {
 ...
 @JsonDeserialize(using = FieldEnumDeserializer.class)
  ...
  public RelationshipsExportFieldListFilter() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
      values = new ArrayList<String>();
    }
  }

  public RelationshipsExportFieldListFilter(Boolean initWithEmptyList) {
   ...
   * Field name to apply the filter
   **/
  public RelationshipsExportFieldListFilter field(FieldEnum field) {
    this.field = field;
    return this;
  }
   ...
   **/
  public RelationshipsExportFieldListFilter values(List<String> values) {
    this.values = values;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RelationshipsExportFieldListFilter relationshipsExportFieldListFilter = (RelationshipsExportFieldListFilter) o;

    return Objects.equals(this.field, relationshipsExportFieldListFilter.field) &&
            Objects.equals(this.values, relationshipsExportFieldListFilter.values);
  }
  ...
  public String toString() {
    ...
    sb.append("class RelationshipsExportFieldListFilter {\n");
