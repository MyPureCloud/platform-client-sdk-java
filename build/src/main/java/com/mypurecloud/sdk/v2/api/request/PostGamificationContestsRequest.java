...
public class PostGamificationContestsRequest {
	...
	public PostGamificationContestsRequest withBody(ContestsCreateRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostGamificationContestsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<ContestsCreateRequest> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostGamificationContestsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/gamification/contests")
                .withBody(body)
	...
	public static Builder builder(ContestsCreateRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostGamificationContestsRequest request;

		private Builder() {
			request = new PostGamificationContestsRequest();
		}
		...
		public Builder withRequiredParams(ContestsCreateRequest body) {
			request.setBody(body);
		...
		public PostGamificationContestsRequest build() {
