...
public class GetWorkforcemanagementManagementunitWorkplanrotationsRequest {
	...
	public GetWorkforcemanagementManagementunitWorkplanrotationsRequest withManagementUnitId(String managementUnitId) {
	...
	public GetWorkforcemanagementManagementunitWorkplanrotationsRequest withExpand(List<String> expand) {
    ...
    public GetWorkforcemanagementManagementunitWorkplanrotationsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.managementUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'managementUnitId' when building request for GetWorkforcemanagementManagementunitWorkplanrotationsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/managementunits/{managementUnitId}/workplanrotations")
	...
	public static class Builder {
		private final GetWorkforcemanagementManagementunitWorkplanrotationsRequest request;

		private Builder() {
			request = new GetWorkforcemanagementManagementunitWorkplanrotationsRequest();
		}
		...
		public GetWorkforcemanagementManagementunitWorkplanrotationsRequest build() {
