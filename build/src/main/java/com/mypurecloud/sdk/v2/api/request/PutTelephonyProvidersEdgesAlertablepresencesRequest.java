...
public class PutTelephonyProvidersEdgesAlertablepresencesRequest {

	private AlertablePresences body;
	public AlertablePresences getBody() {
		return this.body;
	}

	public void setBody(AlertablePresences body) {
		this.body = body;
	}

	public PutTelephonyProvidersEdgesAlertablepresencesRequest withBody(AlertablePresences body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutTelephonyProvidersEdgesAlertablepresencesRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<AlertablePresences> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutTelephonyProvidersEdgesAlertablepresencesRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/telephony/providers/edges/alertablepresences")
                .withBody(body)
	...
	public static Builder builder(AlertablePresences body) {
	    return new Builder()
	...
	public static class Builder {
		private final PutTelephonyProvidersEdgesAlertablepresencesRequest request;

		private Builder() {
			request = new PutTelephonyProvidersEdgesAlertablepresencesRequest();
		}


		public Builder withBody(AlertablePresences body) {
		...
		public Builder withRequiredParams(AlertablePresences body) {
			request.setBody(body);
		...
		public PutTelephonyProvidersEdgesAlertablepresencesRequest build() {
