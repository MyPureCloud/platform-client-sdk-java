...
public class GetCasemanagementCaseCommentsRequest {
	...
	public GetCasemanagementCaseCommentsRequest withCaseId(String caseId) {
	...
	public GetCasemanagementCaseCommentsRequest withAfter(String after) {
	    this.setAfter(after);
	    return this;
	} 
	...
	public GetCasemanagementCaseCommentsRequest withPageSize(Integer pageSize) {
	...
	public GetCasemanagementCaseCommentsRequest withSortOrder(String sortOrder) {
    ...
    public GetCasemanagementCaseCommentsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.caseId == null) {
            throw new IllegalStateException("Missing the required parameter 'caseId' when building request for GetCasemanagementCaseCommentsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/casemanagement/cases/{caseId}/comments")
	...
	public static class Builder {
		private final GetCasemanagementCaseCommentsRequest request;

		private Builder() {
			request = new GetCasemanagementCaseCommentsRequest();
		}
		...
		public GetCasemanagementCaseCommentsRequest build() {
