...
public class ResolutionAggregationView  implements Serializable {
 ...
 @JsonDeserialize(using = FunctionEnumDeserializer.class)
  ...
  public ResolutionAggregationView() {
   ...
   * Target metric name
   **/
  public ResolutionAggregationView target(TargetEnum target) {
    this.target = target;
    return this;
  }
   ...
   **/
  public ResolutionAggregationView name(String name) {
    this.name = name;
    return this;
  }
   ...
   * Type of view you wish to create
   **/
  public ResolutionAggregationView function(FunctionEnum function) {
   ...
   **/
  public ResolutionAggregationView range(AggregationRange range) {
    this.range = range;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ResolutionAggregationView resolutionAggregationView = (ResolutionAggregationView) o;

    return Objects.equals(this.target, resolutionAggregationView.target) &&
            Objects.equals(this.name, resolutionAggregationView.name) &&
            Objects.equals(this.function, resolutionAggregationView.function) &&
            Objects.equals(this.range, resolutionAggregationView.range);
  }
