...
public class DeleteBusinessrulesSchemaRequest {
	...
	public DeleteBusinessrulesSchemaRequest withSchemaId(String schemaId) {
    ...
    public DeleteBusinessrulesSchemaRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.schemaId == null) {
            throw new IllegalStateException("Missing the required parameter 'schemaId' when building request for DeleteBusinessrulesSchemaRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/businessrules/schemas/{schemaId}")
	...
	public static class Builder {
		private final DeleteBusinessrulesSchemaRequest request;

		private Builder() {
			request = new DeleteBusinessrulesSchemaRequest();
		}
		...
		public DeleteBusinessrulesSchemaRequest build() {
