...
public class GetTelephonyProvidersEdgesTrunkMetricsRequest {
	...
	public GetTelephonyProvidersEdgesTrunkMetricsRequest withTrunkId(String trunkId) {
	    this.setTrunkId(trunkId);
	    return this;
	} 
    ...
    public GetTelephonyProvidersEdgesTrunkMetricsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.trunkId == null) {
            throw new IllegalStateException("Missing the required parameter 'trunkId' when building request for GetTelephonyProvidersEdgesTrunkMetricsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/telephony/providers/edges/trunks/{trunkId}/metrics")
	...
	public static class Builder {
		private final GetTelephonyProvidersEdgesTrunkMetricsRequest request;

		private Builder() {
			request = new GetTelephonyProvidersEdgesTrunkMetricsRequest();
		}
		...
		public GetTelephonyProvidersEdgesTrunkMetricsRequest build() {
            
            // verify the required parameter 'trunkId' is set
            if (request.trunkId == null) {
                throw new IllegalStateException("Missing the required parameter 'trunkId' when building request for GetTelephonyProvidersEdgesTrunkMetricsRequest.");
            }
