...
public class PostWorkforcemanagementBusinessunitsRequest {

	private CreateBusinessUnitRequest body;
	public CreateBusinessUnitRequest getBody() {
		return this.body;
	}

	public void setBody(CreateBusinessUnitRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementBusinessunitsRequest withBody(CreateBusinessUnitRequest body) {
	    this.setBody(body);
	    return this;
	} 
	...
	public PostWorkforcemanagementBusinessunitsRequest withIncludeSchedulingDefaultMessageSeverities(Boolean includeSchedulingDefaultMessageSeverities) {
    ...
    public PostWorkforcemanagementBusinessunitsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<CreateBusinessUnitRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementBusinessunitsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/businessunits")
	...
	public static Builder builder(CreateBusinessUnitRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementBusinessunitsRequest request;

		private Builder() {
			request = new PostWorkforcemanagementBusinessunitsRequest();
		}


		public Builder withBody(CreateBusinessUnitRequest body) {
		...
		public Builder withRequiredParams(CreateBusinessUnitRequest body) {
			request.setBody(body);
		...
		public PostWorkforcemanagementBusinessunitsRequest build() {
