...
import com.mypurecloud.sdk.v2.model.InsightsDetailsMetricItem;
import com.mypurecloud.sdk.v2.model.InsightsDetailsOverallItem;
...
public class InsightsDetails  implements Serializable {
 ...
 @JsonDeserialize(using = GranularityEnumDeserializer.class)
   ...
   **/
  public InsightsDetails performanceProfile(AddressableEntityRef performanceProfile) {
   ...
   * The division
   **/
  public InsightsDetails division(DivisionReference division) {
   ...
   * Granularity
   **/
  public InsightsDetails granularity(GranularityEnum granularity) {
   ...
   **/
  public InsightsDetails comparativePeriod(WorkdayPeriod comparativePeriod) {
   ...
   **/
  public InsightsDetails primaryPeriod(WorkdayPeriod primaryPeriod) {
   ...
   * The query user
   **/
  public InsightsDetails user(UserReference user) {
    this.user = user;
    return this;
  }
   ...
   **/
  public InsightsDetails metricData(List<InsightsDetailsMetricItem> metricData) {
  ...
  public List<InsightsDetailsMetricItem> getMetricData() {
    return metricData;
  }
  public void setMetricData(List<InsightsDetailsMetricItem> metricData) {
    this.metricData = metricData;
  }
   ...
   **/
  public InsightsDetails overallData(InsightsDetailsOverallItem overallData) {
  ...
  public InsightsDetailsOverallItem getOverallData() {
    return overallData;
  }
  public void setOverallData(InsightsDetailsOverallItem overallData) {
    this.overallData = overallData;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    InsightsDetails insightsDetails = (InsightsDetails) o;

    return Objects.equals(this.performanceProfile, insightsDetails.performanceProfile) &&
            Objects.equals(this.division, insightsDetails.division) &&
            Objects.equals(this.granularity, insightsDetails.granularity) &&
            Objects.equals(this.comparativePeriod, insightsDetails.comparativePeriod) &&
            Objects.equals(this.primaryPeriod, insightsDetails.primaryPeriod) &&
            Objects.equals(this.user, insightsDetails.user) &&
            Objects.equals(this.metricData, insightsDetails.metricData) &&
            Objects.equals(this.overallData, insightsDetails.overallData);
  }

  @Override
  public int hashCode() {
    return Objects.hash(performanceProfile, division, granularity, comparativePeriod, primaryPeriod, user, metricData, overallData);
  }
