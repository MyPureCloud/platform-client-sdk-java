...
public class QueueConversationChatEventTopicJourneyCustomer  implements Serializable {
  
  private String id = null;
  private String idType = null;

  public QueueConversationChatEventTopicJourneyCustomer() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
    }
  }

  public QueueConversationChatEventTopicJourneyCustomer(Boolean initWithEmptyList) {
   ...
   **/
  public QueueConversationChatEventTopicJourneyCustomer id(String id) {
    this.id = id;
    return this;
  }
   ...
   **/
  public QueueConversationChatEventTopicJourneyCustomer idType(String idType) {
    this.idType = idType;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    QueueConversationChatEventTopicJourneyCustomer queueConversationChatEventTopicJourneyCustomer = (QueueConversationChatEventTopicJourneyCustomer) o;

    return Objects.equals(this.id, queueConversationChatEventTopicJourneyCustomer.id) &&
            Objects.equals(this.idType, queueConversationChatEventTopicJourneyCustomer.idType);
  }
