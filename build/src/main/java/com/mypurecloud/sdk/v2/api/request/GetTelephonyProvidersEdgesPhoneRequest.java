...
public class GetTelephonyProvidersEdgesPhoneRequest {
	...
	public GetTelephonyProvidersEdgesPhoneRequest withPhoneId(String phoneId) {
    ...
    public GetTelephonyProvidersEdgesPhoneRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.phoneId == null) {
            throw new IllegalStateException("Missing the required parameter 'phoneId' when building request for GetTelephonyProvidersEdgesPhoneRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/telephony/providers/edges/phones/{phoneId}")
	...
	public static class Builder {
		private final GetTelephonyProvidersEdgesPhoneRequest request;

		private Builder() {
			request = new GetTelephonyProvidersEdgesPhoneRequest();
		}
		...
		public GetTelephonyProvidersEdgesPhoneRequest build() {
