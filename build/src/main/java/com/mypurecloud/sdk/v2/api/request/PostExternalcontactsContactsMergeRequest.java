...
public class PostExternalcontactsContactsMergeRequest {

	private MergeContactsRequest body;
	public MergeContactsRequest getBody() {
		return this.body;
	}

	public void setBody(MergeContactsRequest body) {
		this.body = body;
	}

	public PostExternalcontactsContactsMergeRequest withBody(MergeContactsRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostExternalcontactsContactsMergeRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<MergeContactsRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostExternalcontactsContactsMergeRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/externalcontacts/contacts/merge")
                .withBody(body)
	...
	public static Builder builder(MergeContactsRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostExternalcontactsContactsMergeRequest request;

		private Builder() {
			request = new PostExternalcontactsContactsMergeRequest();
		}


		public Builder withBody(MergeContactsRequest body) {
		...
		public Builder withRequiredParams(MergeContactsRequest body) {
			request.setBody(body);
		...
		public PostExternalcontactsContactsMergeRequest build() {
