...
public class GetScreenmonitorsSessionsDetailsRequest {
    ...
    public GetScreenmonitorsSessionsDetailsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/screenmonitors/sessions/details")
	...
	public static class Builder {
		private final GetScreenmonitorsSessionsDetailsRequest request;

		private Builder() {
			request = new GetScreenmonitorsSessionsDetailsRequest();
		}
		...
		public GetScreenmonitorsSessionsDetailsRequest build() {
