...
public class PostJourneyViewSchedulesRequest {
    ...
    public ApiRequest<JourneyViewSchedule> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("POST", "/api/v2/journey/views/{viewId}/schedules")
	...
	public static class Builder {
		private final PostJourneyViewSchedulesRequest request;

		private Builder() {
			request = new PostJourneyViewSchedulesRequest();
		}
