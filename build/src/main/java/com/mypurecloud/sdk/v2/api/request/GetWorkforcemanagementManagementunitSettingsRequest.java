...
public class GetWorkforcemanagementManagementunitSettingsRequest {
	...
	public GetWorkforcemanagementManagementunitSettingsRequest withMuId(String muId) {
	    this.setMuId(muId);
	    return this;
	} 
    ...
    public GetWorkforcemanagementManagementunitSettingsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.muId == null) {
            throw new IllegalStateException("Missing the required parameter 'muId' when building request for GetWorkforcemanagementManagementunitSettingsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/managementunits/{muId}/settings")
	...
	public static class Builder {
		private final GetWorkforcemanagementManagementunitSettingsRequest request;

		private Builder() {
			request = new GetWorkforcemanagementManagementunitSettingsRequest();
		}
		...
		public GetWorkforcemanagementManagementunitSettingsRequest build() {
