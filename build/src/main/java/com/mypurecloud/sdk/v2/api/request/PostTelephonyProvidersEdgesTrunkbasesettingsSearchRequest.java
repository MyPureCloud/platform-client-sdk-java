...
public class PostTelephonyProvidersEdgesTrunkbasesettingsSearchRequest {

	private TelephonySearchRequest body;
	public TelephonySearchRequest getBody() {
		return this.body;
	}

	public void setBody(TelephonySearchRequest body) {
		this.body = body;
	}

	public PostTelephonyProvidersEdgesTrunkbasesettingsSearchRequest withBody(TelephonySearchRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostTelephonyProvidersEdgesTrunkbasesettingsSearchRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<TelephonySearchRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostTelephonyProvidersEdgesTrunkbasesettingsSearchRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/telephony/providers/edges/trunkbasesettings/search")
                .withBody(body)
	...
	public static Builder builder(TelephonySearchRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostTelephonyProvidersEdgesTrunkbasesettingsSearchRequest request;

		private Builder() {
			request = new PostTelephonyProvidersEdgesTrunkbasesettingsSearchRequest();
		}


		public Builder withBody(TelephonySearchRequest body) {
		...
		public Builder withRequiredParams(TelephonySearchRequest body) {
			request.setBody(body);
		...
		public PostTelephonyProvidersEdgesTrunkbasesettingsSearchRequest build() {
