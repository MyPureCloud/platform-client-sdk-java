...
public class DeleteQualityFormsEvaluationRequest {
	...
	public DeleteQualityFormsEvaluationRequest withFormId(String formId) {
    ...
    public DeleteQualityFormsEvaluationRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.formId == null) {
            throw new IllegalStateException("Missing the required parameter 'formId' when building request for DeleteQualityFormsEvaluationRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/quality/forms/evaluations/{formId}")
	...
	public static class Builder {
		private final DeleteQualityFormsEvaluationRequest request;

		private Builder() {
			request = new DeleteQualityFormsEvaluationRequest();
		}
		...
		public DeleteQualityFormsEvaluationRequest build() {
