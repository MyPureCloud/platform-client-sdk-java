...
public class GetExternalcontactsContactsSchemaVersionsRequest {
	...
	public GetExternalcontactsContactsSchemaVersionsRequest withSchemaId(String schemaId) {
    ...
    public GetExternalcontactsContactsSchemaVersionsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.schemaId == null) {
            throw new IllegalStateException("Missing the required parameter 'schemaId' when building request for GetExternalcontactsContactsSchemaVersionsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/externalcontacts/contacts/schemas/{schemaId}/versions")
	...
	public static class Builder {
		private final GetExternalcontactsContactsSchemaVersionsRequest request;

		private Builder() {
			request = new GetExternalcontactsContactsSchemaVersionsRequest();
		}
		...
		public GetExternalcontactsContactsSchemaVersionsRequest build() {
