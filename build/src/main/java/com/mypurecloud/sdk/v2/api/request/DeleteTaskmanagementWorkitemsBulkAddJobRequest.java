...
public class DeleteTaskmanagementWorkitemsBulkAddJobRequest {
	...
	public DeleteTaskmanagementWorkitemsBulkAddJobRequest withBulkJobId(String bulkJobId) {
    ...
    public DeleteTaskmanagementWorkitemsBulkAddJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.bulkJobId == null) {
            throw new IllegalStateException("Missing the required parameter 'bulkJobId' when building request for DeleteTaskmanagementWorkitemsBulkAddJobRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/taskmanagement/workitems/bulk/add/jobs/{bulkJobId}")
	...
	public static class Builder {
		private final DeleteTaskmanagementWorkitemsBulkAddJobRequest request;

		private Builder() {
			request = new DeleteTaskmanagementWorkitemsBulkAddJobRequest();
		}
		...
		public DeleteTaskmanagementWorkitemsBulkAddJobRequest build() {
