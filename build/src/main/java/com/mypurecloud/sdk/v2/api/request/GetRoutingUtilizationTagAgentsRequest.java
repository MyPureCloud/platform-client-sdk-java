...
public class GetRoutingUtilizationTagAgentsRequest {
	...
	public GetRoutingUtilizationTagAgentsRequest withTagId(String tagId) {
	    this.setTagId(tagId);
	    return this;
	} 
    ...
    public GetRoutingUtilizationTagAgentsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.tagId == null) {
            throw new IllegalStateException("Missing the required parameter 'tagId' when building request for GetRoutingUtilizationTagAgentsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/routing/utilization/tags/{tagId}/agents")
	...
	public static class Builder {
		private final GetRoutingUtilizationTagAgentsRequest request;

		private Builder() {
			request = new GetRoutingUtilizationTagAgentsRequest();
		}
		...
		public GetRoutingUtilizationTagAgentsRequest build() {
