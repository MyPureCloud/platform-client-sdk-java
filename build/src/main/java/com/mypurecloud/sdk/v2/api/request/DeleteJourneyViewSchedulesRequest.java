...
public class DeleteJourneyViewSchedulesRequest {
	...
	public DeleteJourneyViewSchedulesRequest withViewId(String viewId) {
    ...
    public DeleteJourneyViewSchedulesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.viewId == null) {
            throw new IllegalStateException("Missing the required parameter 'viewId' when building request for DeleteJourneyViewSchedulesRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/journey/views/{viewId}/schedules")
	...
	public static class Builder {
		private final DeleteJourneyViewSchedulesRequest request;

		private Builder() {
			request = new DeleteJourneyViewSchedulesRequest();
		}
		...
		public DeleteJourneyViewSchedulesRequest build() {
