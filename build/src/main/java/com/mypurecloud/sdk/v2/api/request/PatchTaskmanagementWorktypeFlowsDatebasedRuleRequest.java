...
public class PatchTaskmanagementWorktypeFlowsDatebasedRuleRequest {
	...
	public PatchTaskmanagementWorktypeFlowsDatebasedRuleRequest withWorktypeId(String worktypeId) {
	...
	public PatchTaskmanagementWorktypeFlowsDatebasedRuleRequest withRuleId(String ruleId) {
	    this.setRuleId(ruleId);
	    return this;
	} 

	private WorkitemDateBasedRuleUpdate body;
	public WorkitemDateBasedRuleUpdate getBody() {
		return this.body;
	}

	public void setBody(WorkitemDateBasedRuleUpdate body) {
		this.body = body;
	}
    ...
    public ApiRequest<WorkitemDateBasedRuleUpdate> withHttpInfo() {
        
        // verify the required parameter 'worktypeId' is set
        if (this.worktypeId == null) {
            throw new IllegalStateException("Missing the required parameter 'worktypeId' when building request for PatchTaskmanagementWorktypeFlowsDatebasedRuleRequest.");
        }
        
        // verify the required parameter 'ruleId' is set
        if (this.ruleId == null) {
            throw new IllegalStateException("Missing the required parameter 'ruleId' when building request for PatchTaskmanagementWorktypeFlowsDatebasedRuleRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchTaskmanagementWorktypeFlowsDatebasedRuleRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/taskmanagement/worktypes/{worktypeId}/flows/datebased/rules/{ruleId}")
	...
	public static Builder builder(String worktypeId, String ruleId, WorkitemDateBasedRuleUpdate body) {
	    return new Builder()
	...
	public static class Builder {
		private final PatchTaskmanagementWorktypeFlowsDatebasedRuleRequest request;

		private Builder() {
			request = new PatchTaskmanagementWorktypeFlowsDatebasedRuleRequest();
		}
		...
		public Builder withBody(WorkitemDateBasedRuleUpdate body) {
		...
		public Builder withRequiredParams(String worktypeId, String ruleId, WorkitemDateBasedRuleUpdate body) {
			request.setWorktypeId(worktypeId);
			request.setRuleId(ruleId);
			request.setBody(body);
		...
		public PatchTaskmanagementWorktypeFlowsDatebasedRuleRequest build() {
