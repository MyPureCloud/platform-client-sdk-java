...
public class PatchTaskmanagementWorktypeFlowsOnattributechangeRuleRequest {
	...
	public PatchTaskmanagementWorktypeFlowsOnattributechangeRuleRequest withRuleId(String ruleId) {
	    this.setRuleId(ruleId);
	    return this;
	} 

	private WorkitemOnAttributeChangeRuleUpdate body;
	public WorkitemOnAttributeChangeRuleUpdate getBody() {
		return this.body;
	}

	public void setBody(WorkitemOnAttributeChangeRuleUpdate body) {
		this.body = body;
	}

	public PatchTaskmanagementWorktypeFlowsOnattributechangeRuleRequest withBody(WorkitemOnAttributeChangeRuleUpdate body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public ApiRequest<WorkitemOnAttributeChangeRuleUpdate> withHttpInfo() {
        
        // verify the required parameter 'worktypeId' is set
        if (this.worktypeId == null) {
            throw new IllegalStateException("Missing the required parameter 'worktypeId' when building request for PatchTaskmanagementWorktypeFlowsOnattributechangeRuleRequest.");
        }
        
        // verify the required parameter 'ruleId' is set
        if (this.ruleId == null) {
            throw new IllegalStateException("Missing the required parameter 'ruleId' when building request for PatchTaskmanagementWorktypeFlowsOnattributechangeRuleRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchTaskmanagementWorktypeFlowsOnattributechangeRuleRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/taskmanagement/worktypes/{worktypeId}/flows/onattributechange/rules/{ruleId}")
	...
	public static Builder builder(String worktypeId, String ruleId, WorkitemOnAttributeChangeRuleUpdate body) {
	    return new Builder()
	            .withRequiredParams(worktypeId, ruleId, body);
	}


	public static class Builder {
		private final PatchTaskmanagementWorktypeFlowsOnattributechangeRuleRequest request;

		private Builder() {
			request = new PatchTaskmanagementWorktypeFlowsOnattributechangeRuleRequest();
		}
		...
		public Builder withBody(WorkitemOnAttributeChangeRuleUpdate body) {
		...
		public Builder withRequiredParams(String worktypeId, String ruleId, WorkitemOnAttributeChangeRuleUpdate body) {
			request.setWorktypeId(worktypeId);
			request.setRuleId(ruleId);
			request.setBody(body);
		...
		public PatchTaskmanagementWorktypeFlowsOnattributechangeRuleRequest build() {
