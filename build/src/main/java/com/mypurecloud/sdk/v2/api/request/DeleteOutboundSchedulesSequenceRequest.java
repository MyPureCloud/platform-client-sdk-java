...
public class DeleteOutboundSchedulesSequenceRequest {
	...
	public DeleteOutboundSchedulesSequenceRequest withSequenceId(String sequenceId) {
    ...
    public DeleteOutboundSchedulesSequenceRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.sequenceId == null) {
            throw new IllegalStateException("Missing the required parameter 'sequenceId' when building request for DeleteOutboundSchedulesSequenceRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/outbound/schedules/sequences/{sequenceId}")
	...
	public static class Builder {
		private final DeleteOutboundSchedulesSequenceRequest request;

		private Builder() {
			request = new DeleteOutboundSchedulesSequenceRequest();
		}
		...
		public DeleteOutboundSchedulesSequenceRequest build() {
