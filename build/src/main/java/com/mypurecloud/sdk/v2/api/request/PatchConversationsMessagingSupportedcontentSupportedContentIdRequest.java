...
public class PatchConversationsMessagingSupportedcontentSupportedContentIdRequest {
    ...
    public ApiRequest<SupportedContent> withHttpInfo() {
        ...
        if (this.supportedContentId == null) {
            throw new IllegalStateException("Missing the required parameter 'supportedContentId' when building request for PatchConversationsMessagingSupportedcontentSupportedContentIdRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchConversationsMessagingSupportedcontentSupportedContentIdRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/conversations/messaging/supportedcontent/{supportedContentId}")
	...
	public static class Builder {
		private final PatchConversationsMessagingSupportedcontentSupportedContentIdRequest request;

		private Builder() {
			request = new PatchConversationsMessagingSupportedcontentSupportedContentIdRequest();
		}
		...
		public PatchConversationsMessagingSupportedcontentSupportedContentIdRequest build() {
