...
public class V2ConversationMessageTypingEventForUserTopicConversationReason  implements Serializable {
 ...
 @JsonDeserialize(using = CodeEnumDeserializer.class)
  ...
  /**
   **/
  public V2ConversationMessageTypingEventForUserTopicConversationReason code(CodeEnum code) {
    this.code = code;
    return this;
  }
  ...
  /**
   **/
  public V2ConversationMessageTypingEventForUserTopicConversationReason message(String message) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V2ConversationMessageTypingEventForUserTopicConversationReason v2ConversationMessageTypingEventForUserTopicConversationReason = (V2ConversationMessageTypingEventForUserTopicConversationReason) o;
    return Objects.equals(this.code, v2ConversationMessageTypingEventForUserTopicConversationReason.code) &&
        Objects.equals(this.message, v2ConversationMessageTypingEventForUserTopicConversationReason.message);
  }
