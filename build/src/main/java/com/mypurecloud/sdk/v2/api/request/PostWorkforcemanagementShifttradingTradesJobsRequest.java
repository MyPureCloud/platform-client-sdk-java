...
public class PostWorkforcemanagementShifttradingTradesJobsRequest {

	private AddShiftTradeJobRequest body;
	public AddShiftTradeJobRequest getBody() {
		return this.body;
	}

	public void setBody(AddShiftTradeJobRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementShifttradingTradesJobsRequest withBody(AddShiftTradeJobRequest body) {
	    this.setBody(body);
	    return this;
	} 
	...
	public PostWorkforcemanagementShifttradingTradesJobsRequest withForceAsync(Boolean forceAsync) {
    ...
    public PostWorkforcemanagementShifttradingTradesJobsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<AddShiftTradeJobRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementShifttradingTradesJobsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/shifttrading/trades/jobs")
	...
	public static Builder builder(AddShiftTradeJobRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementShifttradingTradesJobsRequest request;

		private Builder() {
			request = new PostWorkforcemanagementShifttradingTradesJobsRequest();
		}


		public Builder withBody(AddShiftTradeJobRequest body) {
		...
		public Builder withRequiredParams(AddShiftTradeJobRequest body) {
			request.setBody(body);
		...
		public PostWorkforcemanagementShifttradingTradesJobsRequest build() {
