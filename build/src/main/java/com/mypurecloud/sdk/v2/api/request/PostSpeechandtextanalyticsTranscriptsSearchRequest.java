...
public class PostSpeechandtextanalyticsTranscriptsSearchRequest {
    
	private TranscriptSearchRequest body;
	public TranscriptSearchRequest getBody() {
		return this.body;
	}

	public void setBody(TranscriptSearchRequest body) {
		this.body = body;
	}

	public PostSpeechandtextanalyticsTranscriptsSearchRequest withBody(TranscriptSearchRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostSpeechandtextanalyticsTranscriptsSearchRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<TranscriptSearchRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostSpeechandtextanalyticsTranscriptsSearchRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/speechandtextanalytics/transcripts/search")
                .withBody(body)
	...
	public static Builder builder(TranscriptSearchRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostSpeechandtextanalyticsTranscriptsSearchRequest request;

		private Builder() {
			request = new PostSpeechandtextanalyticsTranscriptsSearchRequest();
		}

		
		public Builder withBody(TranscriptSearchRequest body) {
		...
		public Builder withRequiredParams(TranscriptSearchRequest body) {
			request.setBody(body);
		...
		public PostSpeechandtextanalyticsTranscriptsSearchRequest build() {
