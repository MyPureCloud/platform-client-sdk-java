...
public class GetJourneyExternaleventsSchemaVersionRequest {
	...
	public GetJourneyExternaleventsSchemaVersionRequest withSchemaId(String schemaId) {
	...
	public GetJourneyExternaleventsSchemaVersionRequest withVersionId(String versionId) {
    ...
    public GetJourneyExternaleventsSchemaVersionRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.schemaId == null) {
            throw new IllegalStateException("Missing the required parameter 'schemaId' when building request for GetJourneyExternaleventsSchemaVersionRequest.");
        }
        
        // verify the required parameter 'versionId' is set
        if (this.versionId == null) {
            throw new IllegalStateException("Missing the required parameter 'versionId' when building request for GetJourneyExternaleventsSchemaVersionRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/journey/externalevents/schemas/{schemaId}/versions/{versionId}")
	...
	public static class Builder {
		private final GetJourneyExternaleventsSchemaVersionRequest request;

		private Builder() {
			request = new GetJourneyExternaleventsSchemaVersionRequest();
		}
		...
		public GetJourneyExternaleventsSchemaVersionRequest build() {
