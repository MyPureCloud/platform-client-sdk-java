...
public class GetTelephonyProvidersEdgesSitesSearchRequest {
	...
	public GetTelephonyProvidersEdgesSitesSearchRequest withQ64(String q64) {
	    this.setQ64(q64);
	    return this;
	} 
	...
	public GetTelephonyProvidersEdgesSitesSearchRequest withExpand(List<String> expand) {
    ...
    public GetTelephonyProvidersEdgesSitesSearchRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.q64 == null) {
            throw new IllegalStateException("Missing the required parameter 'q64' when building request for GetTelephonyProvidersEdgesSitesSearchRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/telephony/providers/edges/sites/search")
	...
	public static class Builder {
		private final GetTelephonyProvidersEdgesSitesSearchRequest request;

		private Builder() {
			request = new GetTelephonyProvidersEdgesSitesSearchRequest();
		}
		...
		public GetTelephonyProvidersEdgesSitesSearchRequest build() {
