...
public class PatchConversationsCallConferenceRequest {
	...
	public PatchConversationsCallConferenceRequest withConversationId(String conversationId) {
	    this.setConversationId(conversationId);
	    return this;
	} 

	private UpdateConferenceRequest body;
	public UpdateConferenceRequest getBody() {
		return this.body;
	}

	public void setBody(UpdateConferenceRequest body) {
		this.body = body;
	}

	public PatchConversationsCallConferenceRequest withBody(UpdateConferenceRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchConversationsCallConferenceRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<UpdateConferenceRequest> withHttpInfo() {
        
        // verify the required parameter 'conversationId' is set
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PatchConversationsCallConferenceRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchConversationsCallConferenceRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/conversations/calls/{conversationId}/conference")
	...
	public static Builder builder(String conversationId, UpdateConferenceRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PatchConversationsCallConferenceRequest request;

		private Builder() {
			request = new PatchConversationsCallConferenceRequest();
		}
		...
		public Builder withBody(UpdateConferenceRequest body) {
		...
		public Builder withRequiredParams(String conversationId, UpdateConferenceRequest body) {
			request.setConversationId(conversationId);
			request.setBody(body);
		...
		public PatchConversationsCallConferenceRequest build() {
