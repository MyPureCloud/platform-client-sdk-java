...
public class PostKnowledgeKnowledgebasesRequest {
    ...
    public PostKnowledgeKnowledgebasesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<KnowledgeBaseCreateRequest> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostKnowledgeKnowledgebasesRequest.");
        }
