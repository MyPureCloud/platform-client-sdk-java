...
public class GetIntentsCustomerintentRequest {
	...
	public GetIntentsCustomerintentRequest withCustomerIntentId(String customerIntentId) {
    ...
    public GetIntentsCustomerintentRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.customerIntentId == null) {
            throw new IllegalStateException("Missing the required parameter 'customerIntentId' when building request for GetIntentsCustomerintentRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/intents/customerintents/{customerIntentId}")
	...
	public static class Builder {
		private final GetIntentsCustomerintentRequest request;

		private Builder() {
			request = new GetIntentsCustomerintentRequest();
		}
		...
		public GetIntentsCustomerintentRequest build() {
