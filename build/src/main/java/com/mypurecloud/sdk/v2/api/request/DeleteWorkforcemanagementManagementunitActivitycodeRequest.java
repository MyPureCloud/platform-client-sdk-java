...
public class DeleteWorkforcemanagementManagementunitActivitycodeRequest {
	...
	public DeleteWorkforcemanagementManagementunitActivitycodeRequest withMuId(String muId) {
	    this.setMuId(muId);
	    return this;
	} 
	...
	public DeleteWorkforcemanagementManagementunitActivitycodeRequest withAcId(String acId) {
	    this.setAcId(acId);
	    return this;
	} 
    ...
    public DeleteWorkforcemanagementManagementunitActivitycodeRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.muId == null) {
            throw new IllegalStateException("Missing the required parameter 'muId' when building request for DeleteWorkforcemanagementManagementunitActivitycodeRequest.");
        }
        
        // verify the required parameter 'acId' is set
        if (this.acId == null) {
            throw new IllegalStateException("Missing the required parameter 'acId' when building request for DeleteWorkforcemanagementManagementunitActivitycodeRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/workforcemanagement/managementunits/{muId}/activitycodes/{acId}")
	...
	public static class Builder {
		private final DeleteWorkforcemanagementManagementunitActivitycodeRequest request;

		private Builder() {
			request = new DeleteWorkforcemanagementManagementunitActivitycodeRequest();
		}
		...
		public DeleteWorkforcemanagementManagementunitActivitycodeRequest build() {
