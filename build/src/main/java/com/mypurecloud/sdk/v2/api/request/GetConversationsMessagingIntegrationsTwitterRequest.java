...
public class GetConversationsMessagingIntegrationsTwitterRequest {
	...
	public GetConversationsMessagingIntegrationsTwitterRequest withPageSize(Integer pageSize) {
	...
	public GetConversationsMessagingIntegrationsTwitterRequest withPageNumber(Integer pageNumber) {
	...
	public GetConversationsMessagingIntegrationsTwitterRequest withExpand(String expand) {
	...
	public GetConversationsMessagingIntegrationsTwitterRequest withSupportedContentId(String supportedContentId) {
	...
	public GetConversationsMessagingIntegrationsTwitterRequest withMessagingSettingId(String messagingSettingId) {
    ...
    public GetConversationsMessagingIntegrationsTwitterRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/conversations/messaging/integrations/twitter")
	...
	public static class Builder {
		private final GetConversationsMessagingIntegrationsTwitterRequest request;

		private Builder() {
			request = new GetConversationsMessagingIntegrationsTwitterRequest();
		}
		...
		public GetConversationsMessagingIntegrationsTwitterRequest build() {
