...
public class GoogleBusinessProfileOpenIntegrationUpdateRequest  implements Serializable {
  ...
  public GoogleBusinessProfileOpenIntegrationUpdateRequest(Boolean initWithEmptyList) {
   ...
   **/
  public GoogleBusinessProfileOpenIntegrationUpdateRequest name(String name) {
    this.name = name;
    return this;
  }
  
  @ApiModelProperty(example = "null", value = "The name of the Google Business Profile Open Integration.")
  @JsonProperty("name")
   ...
   **/
  public GoogleBusinessProfileOpenIntegrationUpdateRequest supportedContent(SupportedContentReference supportedContent) {
   ...
   **/
  public GoogleBusinessProfileOpenIntegrationUpdateRequest messagingSetting(MessagingSettingRequestReference messagingSetting) {
   ...
   **/
  public GoogleBusinessProfileOpenIntegrationUpdateRequest token(GoogleAuthTokenReference token) {
    this.token = token;
    return this;
  }
  
  @ApiModelProperty(example = "null", value = "Google OAuth 2 access token reference. The actual token cannot be accessed via Genesys API, only referenced by this property by its ID. When the token is not referenced by any integration, it is deleted after 24 hours.")
  @JsonProperty("token")
   ...
   **/
  public GoogleBusinessProfileOpenIntegrationUpdateRequest account(GoogleBusinessProfileAccountReference account) {
    this.account = account;
    return this;
  }
  
  @ApiModelProperty(example = "null", value = "Google Business Profile account accessible with the authorization token")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    GoogleBusinessProfileOpenIntegrationUpdateRequest googleBusinessProfileOpenIntegrationUpdateRequest = (GoogleBusinessProfileOpenIntegrationUpdateRequest) o;

    return Objects.equals(this.id, googleBusinessProfileOpenIntegrationUpdateRequest.id) &&
            Objects.equals(this.name, googleBusinessProfileOpenIntegrationUpdateRequest.name) &&
            Objects.equals(this.supportedContent, googleBusinessProfileOpenIntegrationUpdateRequest.supportedContent) &&
            Objects.equals(this.messagingSetting, googleBusinessProfileOpenIntegrationUpdateRequest.messagingSetting) &&
            Objects.equals(this.token, googleBusinessProfileOpenIntegrationUpdateRequest.token) &&
            Objects.equals(this.account, googleBusinessProfileOpenIntegrationUpdateRequest.account) &&
            Objects.equals(this.selfUri, googleBusinessProfileOpenIntegrationUpdateRequest.selfUri);
  }
