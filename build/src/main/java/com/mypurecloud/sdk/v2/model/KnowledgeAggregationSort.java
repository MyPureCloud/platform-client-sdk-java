...
public class KnowledgeAggregationSort  implements Serializable {
 ...
 @JsonDeserialize(using = FunctionEnumDeserializer.class)
  ...
  public KnowledgeAggregationSort() {
   ...
   * Name of the metric used for sorting values.
   **/
  public KnowledgeAggregationSort name(NameEnum name) {
    this.name = name;
    return this;
  }
   ...
   * Aggregation function used for the sort metric.
   **/
  public KnowledgeAggregationSort function(FunctionEnum function) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    KnowledgeAggregationSort knowledgeAggregationSort = (KnowledgeAggregationSort) o;

    return Objects.equals(this.name, knowledgeAggregationSort.name) &&
            Objects.equals(this.function, knowledgeAggregationSort.function);
  }
