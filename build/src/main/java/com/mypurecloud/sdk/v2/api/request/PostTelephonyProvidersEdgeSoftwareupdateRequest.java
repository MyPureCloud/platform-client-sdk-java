...
public class PostTelephonyProvidersEdgeSoftwareupdateRequest {
	...
	public PostTelephonyProvidersEdgeSoftwareupdateRequest withEdgeId(String edgeId) {
	    this.setEdgeId(edgeId);
	    return this;
	}

	private DomainEdgeSoftwareUpdateDto body;
	public DomainEdgeSoftwareUpdateDto getBody() {
		return this.body;
	}

	public void setBody(DomainEdgeSoftwareUpdateDto body) {
		this.body = body;
	}

	public PostTelephonyProvidersEdgeSoftwareupdateRequest withBody(DomainEdgeSoftwareUpdateDto body) {
	    this.setBody(body);
	    return this;
	}
    ...
    public PostTelephonyProvidersEdgeSoftwareupdateRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<DomainEdgeSoftwareUpdateDto> withHttpInfo() throws ApiException {
        
        // verify the required parameter 'edgeId' is set
        if (this.edgeId == null) {
            throw new ApiException(400, "Missing the required parameter 'edgeId' when building request for PostTelephonyProvidersEdgeSoftwareupdateRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new ApiException(400, "Missing the required parameter 'body' when building request for PostTelephonyProvidersEdgeSoftwareupdateRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/telephony/providers/edges/{edgeId}/softwareupdate")
	...
	public static Builder builder(String edgeId, DomainEdgeSoftwareUpdateDto body) {
	    return new Builder()
	            .withRequiredParams(edgeId, body);
	}

	public static class Builder {
		private final PostTelephonyProvidersEdgeSoftwareupdateRequest request;

		private Builder() {
			request = new PostTelephonyProvidersEdgeSoftwareupdateRequest();
		}
		...
		public Builder withBody(DomainEdgeSoftwareUpdateDto body) {
			request.setBody(body);
			return this;
		}

		public Builder withRequiredParams(String edgeId, DomainEdgeSoftwareUpdateDto body) {
			request.setEdgeId(edgeId);
			request.setBody(body);
			return this;
		}
		...
		public PostTelephonyProvidersEdgeSoftwareupdateRequest build() {
			return request;
		}
	}
}
