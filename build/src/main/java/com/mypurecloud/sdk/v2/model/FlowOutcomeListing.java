...
public class FlowOutcomeListing  implements Serializable, PagedResource<FlowOutcome> {
  
  private List<FlowOutcome> entities = null;
  ...
  /**
   **/
  public FlowOutcomeListing entities(List<FlowOutcome> entities) {
  ...
  public List<FlowOutcome> getEntities() {
    return entities;
  }
  public void setEntities(List<FlowOutcome> entities) {
    this.entities = entities;
  }
