...
public class PostOutboundContactlistContactsSearchRequest {
	...
	public PostOutboundContactlistContactsSearchRequest withContactListId(String contactListId) {
	    this.setContactListId(contactListId);
	    return this;
	} 

	private ContactListingRequest body;
	public ContactListingRequest getBody() {
		return this.body;
	}

	public void setBody(ContactListingRequest body) {
		this.body = body;
	}

	public PostOutboundContactlistContactsSearchRequest withBody(ContactListingRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostOutboundContactlistContactsSearchRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<ContactListingRequest> withHttpInfo() {
        
        // verify the required parameter 'contactListId' is set
        if (this.contactListId == null) {
            throw new IllegalStateException("Missing the required parameter 'contactListId' when building request for PostOutboundContactlistContactsSearchRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostOutboundContactlistContactsSearchRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/outbound/contactlists/{contactListId}/contacts/search")
	...
	public static Builder builder(String contactListId, ContactListingRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostOutboundContactlistContactsSearchRequest request;

		private Builder() {
			request = new PostOutboundContactlistContactsSearchRequest();
		}
		...
		public Builder withBody(ContactListingRequest body) {
		...
		public Builder withRequiredParams(String contactListId, ContactListingRequest body) {
			request.setContactListId(contactListId);
			request.setBody(body);
		...
		public PostOutboundContactlistContactsSearchRequest build() {
