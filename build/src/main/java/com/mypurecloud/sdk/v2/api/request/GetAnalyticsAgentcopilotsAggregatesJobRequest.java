...
public class GetAnalyticsAgentcopilotsAggregatesJobRequest {
	...
	public GetAnalyticsAgentcopilotsAggregatesJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetAnalyticsAgentcopilotsAggregatesJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetAnalyticsAgentcopilotsAggregatesJobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/analytics/agentcopilots/aggregates/jobs/{jobId}")
	...
	public static class Builder {
		private final GetAnalyticsAgentcopilotsAggregatesJobRequest request;

		private Builder() {
			request = new GetAnalyticsAgentcopilotsAggregatesJobRequest();
		}
		...
		public GetAnalyticsAgentcopilotsAggregatesJobRequest build() {
