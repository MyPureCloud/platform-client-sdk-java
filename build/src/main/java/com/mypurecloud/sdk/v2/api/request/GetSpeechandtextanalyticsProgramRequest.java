...
public class GetSpeechandtextanalyticsProgramRequest {
	...
	public GetSpeechandtextanalyticsProgramRequest withProgramId(String programId) {
    ...
    public GetSpeechandtextanalyticsProgramRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.programId == null) {
            throw new IllegalStateException("Missing the required parameter 'programId' when building request for GetSpeechandtextanalyticsProgramRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/speechandtextanalytics/programs/{programId}")
	...
	public static class Builder {
		private final GetSpeechandtextanalyticsProgramRequest request;

		private Builder() {
			request = new GetSpeechandtextanalyticsProgramRequest();
		}
		...
		public GetSpeechandtextanalyticsProgramRequest build() {
