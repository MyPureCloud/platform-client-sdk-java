...
public class PutSocialmediaTopicDataingestionrulesOpenOpenIdRequest {
	...
	public PutSocialmediaTopicDataingestionrulesOpenOpenIdRequest withTopicId(String topicId) {
	...
	public PutSocialmediaTopicDataingestionrulesOpenOpenIdRequest withOpenId(String openId) {
    ...
    public ApiRequest<OpenDataIngestionRuleRequest> withHttpInfo() {
        ...
        if (this.topicId == null) {
            throw new IllegalStateException("Missing the required parameter 'topicId' when building request for PutSocialmediaTopicDataingestionrulesOpenOpenIdRequest.");
        }
        
        // verify the required parameter 'openId' is set
        if (this.openId == null) {
            throw new IllegalStateException("Missing the required parameter 'openId' when building request for PutSocialmediaTopicDataingestionrulesOpenOpenIdRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/socialmedia/topics/{topicId}/dataingestionrules/open/{openId}")
	...
	public static class Builder {
		private final PutSocialmediaTopicDataingestionrulesOpenOpenIdRequest request;

		private Builder() {
			request = new PutSocialmediaTopicDataingestionrulesOpenOpenIdRequest();
		}
		...
		public PutSocialmediaTopicDataingestionrulesOpenOpenIdRequest build() {
