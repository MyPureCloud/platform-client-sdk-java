...
public class GetAnalyticsUsersDetailsJobResultsRequest {
	...
	public GetAnalyticsUsersDetailsJobResultsRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
	...
	public GetAnalyticsUsersDetailsJobResultsRequest withCursor(String cursor) {
	...
	public GetAnalyticsUsersDetailsJobResultsRequest withPageSize(Integer pageSize) {
    ...
    public GetAnalyticsUsersDetailsJobResultsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetAnalyticsUsersDetailsJobResultsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/analytics/users/details/jobs/{jobId}/results")
	...
	public static class Builder {
		private final GetAnalyticsUsersDetailsJobResultsRequest request;

		private Builder() {
			request = new GetAnalyticsUsersDetailsJobResultsRequest();
		}
		...
		public GetAnalyticsUsersDetailsJobResultsRequest build() {
