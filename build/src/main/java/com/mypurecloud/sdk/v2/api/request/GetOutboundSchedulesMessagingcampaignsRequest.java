...
public class GetOutboundSchedulesMessagingcampaignsRequest {
    ...
    public GetOutboundSchedulesMessagingcampaignsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/outbound/schedules/messagingcampaigns")
	...
	public static class Builder {
		private final GetOutboundSchedulesMessagingcampaignsRequest request;

		private Builder() {
			request = new GetOutboundSchedulesMessagingcampaignsRequest();
		}
		...
		public GetOutboundSchedulesMessagingcampaignsRequest build() {
