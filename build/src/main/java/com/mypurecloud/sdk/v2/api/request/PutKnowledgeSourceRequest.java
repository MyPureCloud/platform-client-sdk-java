...
public class PutKnowledgeSourceRequest {
	...
	public PutKnowledgeSourceRequest withSourceId(String sourceId) {
	    this.setSourceId(sourceId);
	    return this;
	} 

	private V3SourceUpdateRequest body;
	public V3SourceUpdateRequest getBody() {
		return this.body;
	}

	public void setBody(V3SourceUpdateRequest body) {
		this.body = body;
	}

	public PutKnowledgeSourceRequest withBody(V3SourceUpdateRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutKnowledgeSourceRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<V3SourceUpdateRequest> withHttpInfo() {
        
        // verify the required parameter 'sourceId' is set
        if (this.sourceId == null) {
            throw new IllegalStateException("Missing the required parameter 'sourceId' when building request for PutKnowledgeSourceRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutKnowledgeSourceRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/knowledge/sources/{sourceId}")
	...
	public static Builder builder(String sourceId, V3SourceUpdateRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PutKnowledgeSourceRequest request;

		private Builder() {
			request = new PutKnowledgeSourceRequest();
		}
		...
		public Builder withBody(V3SourceUpdateRequest body) {
		...
		public Builder withRequiredParams(String sourceId, V3SourceUpdateRequest body) {
			request.setSourceId(sourceId);
			request.setBody(body);
		...
		public PutKnowledgeSourceRequest build() {
