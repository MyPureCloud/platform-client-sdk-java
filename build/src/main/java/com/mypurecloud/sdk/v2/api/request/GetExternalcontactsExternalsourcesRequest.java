...
public class GetExternalcontactsExternalsourcesRequest {
	...
	public GetExternalcontactsExternalsourcesRequest withCursor(String cursor) {
	...
	public GetExternalcontactsExternalsourcesRequest withLimit(Integer limit) {
	    this.setLimit(limit);
	    return this;
	} 
	...
	public GetExternalcontactsExternalsourcesRequest withName(String name) {
	    this.setName(name);
	    return this;
	} 
	...
	public GetExternalcontactsExternalsourcesRequest withActive(Boolean active) {
    ...
    public GetExternalcontactsExternalsourcesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/externalcontacts/externalsources")
	...
	public static class Builder {
		private final GetExternalcontactsExternalsourcesRequest request;

		private Builder() {
			request = new GetExternalcontactsExternalsourcesRequest();
		}
		...
		public GetExternalcontactsExternalsourcesRequest build() {
