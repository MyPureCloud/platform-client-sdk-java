...
public class GetWorkforcemanagementAdherenceExplanationRequest {
	...
	public GetWorkforcemanagementAdherenceExplanationRequest withExplanationId(String explanationId) {
    ...
    public GetWorkforcemanagementAdherenceExplanationRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.explanationId == null) {
            throw new IllegalStateException("Missing the required parameter 'explanationId' when building request for GetWorkforcemanagementAdherenceExplanationRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/adherence/explanations/{explanationId}")
	...
	public static Builder builder(String explanationId) {
	    return new Builder()
	            .withRequiredParams(explanationId);
	}


	public static class Builder {
		private final GetWorkforcemanagementAdherenceExplanationRequest request;

		private Builder() {
			request = new GetWorkforcemanagementAdherenceExplanationRequest();
		}
		...
		public Builder withRequiredParams(String explanationId) {
			request.setExplanationId(explanationId);
		...
		public GetWorkforcemanagementAdherenceExplanationRequest build() {
