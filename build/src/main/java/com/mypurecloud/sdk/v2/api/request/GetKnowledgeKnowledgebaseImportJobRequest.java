...
public class GetKnowledgeKnowledgebaseImportJobRequest {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/import/jobs/{importJobId}")
	...
	public static class Builder {
		private final GetKnowledgeKnowledgebaseImportJobRequest request;

		private Builder() {
			request = new GetKnowledgeKnowledgebaseImportJobRequest();
		}
