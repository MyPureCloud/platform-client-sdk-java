...
public class PostKnowledgeConnectionsRequest {

	private ConnectionCreateRequest body;
	public ConnectionCreateRequest getBody() {
		return this.body;
	}

	public void setBody(ConnectionCreateRequest body) {
		this.body = body;
	}

	public PostKnowledgeConnectionsRequest withBody(ConnectionCreateRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostKnowledgeConnectionsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<ConnectionCreateRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostKnowledgeConnectionsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/knowledge/connections")
                .withBody(body)
	...
	public static Builder builder(ConnectionCreateRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostKnowledgeConnectionsRequest request;

		private Builder() {
			request = new PostKnowledgeConnectionsRequest();
		}


		public Builder withBody(ConnectionCreateRequest body) {
		...
		public Builder withRequiredParams(ConnectionCreateRequest body) {
			request.setBody(body);
		...
		public PostKnowledgeConnectionsRequest build() {
