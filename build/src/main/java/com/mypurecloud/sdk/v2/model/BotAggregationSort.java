...
public class BotAggregationSort  implements Serializable {
 ...
 @JsonDeserialize(using = FunctionEnumDeserializer.class)
   ...
   * Name of the metric used for sorting values.
   **/
  public BotAggregationSort name(NameEnum name) {
    this.name = name;
    return this;
  }
   ...
   * Aggregation function used for the sort metric.
   **/
  public BotAggregationSort function(FunctionEnum function) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    BotAggregationSort botAggregationSort = (BotAggregationSort) o;

    return Objects.equals(this.name, botAggregationSort.name) &&
            Objects.equals(this.function, botAggregationSort.function);
  }
