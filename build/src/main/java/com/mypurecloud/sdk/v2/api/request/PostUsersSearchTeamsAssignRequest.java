...
public class PostUsersSearchTeamsAssignRequest {
	...
	public PostUsersSearchTeamsAssignRequest withBody(UserSearchRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostUsersSearchTeamsAssignRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<UserSearchRequest> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostUsersSearchTeamsAssignRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/users/search/teams/assign")
                .withBody(body)
	...
	public static class Builder {
		private final PostUsersSearchTeamsAssignRequest request;

		private Builder() {
			request = new PostUsersSearchTeamsAssignRequest();
		}
		...
		public PostUsersSearchTeamsAssignRequest build() {
