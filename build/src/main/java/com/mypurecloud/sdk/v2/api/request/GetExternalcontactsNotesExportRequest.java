...
public class GetExternalcontactsNotesExportRequest {
	...
	public GetExternalcontactsNotesExportRequest withExportId(String exportId) {
    ...
    public GetExternalcontactsNotesExportRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.exportId == null) {
            throw new IllegalStateException("Missing the required parameter 'exportId' when building request for GetExternalcontactsNotesExportRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/externalcontacts/notes/exports/{exportId}")
	...
	public static class Builder {
		private final GetExternalcontactsNotesExportRequest request;

		private Builder() {
			request = new GetExternalcontactsNotesExportRequest();
		}
		...
		public GetExternalcontactsNotesExportRequest build() {
