...
public class DeleteConversationsMessagingIntegrationsOpenIntegrationIdRequest {
	...
	public DeleteConversationsMessagingIntegrationsOpenIntegrationIdRequest withIntegrationId(String integrationId) {
    ...
    public DeleteConversationsMessagingIntegrationsOpenIntegrationIdRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.integrationId == null) {
            throw new IllegalStateException("Missing the required parameter 'integrationId' when building request for DeleteConversationsMessagingIntegrationsOpenIntegrationIdRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/conversations/messaging/integrations/open/{integrationId}")
	...
	public static class Builder {
		private final DeleteConversationsMessagingIntegrationsOpenIntegrationIdRequest request;

		private Builder() {
			request = new DeleteConversationsMessagingIntegrationsOpenIntegrationIdRequest();
		}
		...
		public DeleteConversationsMessagingIntegrationsOpenIntegrationIdRequest build() {
