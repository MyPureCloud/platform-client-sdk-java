...
public class PostOutboundMessagingcampaignsRequest {
	...
	public PostOutboundMessagingcampaignsRequest withBody(MessagingCampaign body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostOutboundMessagingcampaignsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<MessagingCampaign> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostOutboundMessagingcampaignsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/outbound/messagingcampaigns")
                .withBody(body)
	...
	public static Builder builder(MessagingCampaign body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostOutboundMessagingcampaignsRequest request;

		private Builder() {
			request = new PostOutboundMessagingcampaignsRequest();
		}
		...
		public Builder withRequiredParams(MessagingCampaign body) {
			request.setBody(body);
		...
		public PostOutboundMessagingcampaignsRequest build() {
