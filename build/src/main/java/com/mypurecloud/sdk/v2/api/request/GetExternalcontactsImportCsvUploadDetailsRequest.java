...
public class GetExternalcontactsImportCsvUploadDetailsRequest {
	...
	public GetExternalcontactsImportCsvUploadDetailsRequest withUploadId(String uploadId) {
    ...
    public GetExternalcontactsImportCsvUploadDetailsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.uploadId == null) {
            throw new IllegalStateException("Missing the required parameter 'uploadId' when building request for GetExternalcontactsImportCsvUploadDetailsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/externalcontacts/import/csv/uploads/{uploadId}/details")
	...
	public static class Builder {
		private final GetExternalcontactsImportCsvUploadDetailsRequest request;

		private Builder() {
			request = new GetExternalcontactsImportCsvUploadDetailsRequest();
		}
		...
		public GetExternalcontactsImportCsvUploadDetailsRequest build() {
