...
public class GetAlertingInteractionstatsAlertRequest {
	...
	public GetAlertingInteractionstatsAlertRequest withAlertId(String alertId) {
	...
	public GetAlertingInteractionstatsAlertRequest withExpand(List<String> expand) {
    ...
    public GetAlertingInteractionstatsAlertRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.alertId == null) {
            throw new IllegalStateException("Missing the required parameter 'alertId' when building request for GetAlertingInteractionstatsAlertRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/alerting/interactionstats/alerts/{alertId}")
