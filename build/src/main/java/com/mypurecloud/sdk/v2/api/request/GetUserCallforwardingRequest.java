...
public class GetUserCallforwardingRequest {
	...
	public GetUserCallforwardingRequest withUserId(String userId) {
    ...
    public GetUserCallforwardingRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.userId == null) {
            throw new IllegalStateException("Missing the required parameter 'userId' when building request for GetUserCallforwardingRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/users/{userId}/callforwarding")
	...
	public static class Builder {
		private final GetUserCallforwardingRequest request;

		private Builder() {
			request = new GetUserCallforwardingRequest();
		}
		...
		public GetUserCallforwardingRequest build() {
