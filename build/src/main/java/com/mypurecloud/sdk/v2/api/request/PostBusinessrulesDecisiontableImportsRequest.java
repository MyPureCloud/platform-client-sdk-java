...
public class PostBusinessrulesDecisiontableImportsRequest {
	...
	public PostBusinessrulesDecisiontableImportsRequest withTableId(String tableId) {
	    this.setTableId(tableId);
	    return this;
	} 

	private CreateDecisionTableImportJobRequest body;
	public CreateDecisionTableImportJobRequest getBody() {
		return this.body;
	}

	public void setBody(CreateDecisionTableImportJobRequest body) {
		this.body = body;
	}
    ...
    public PostBusinessrulesDecisiontableImportsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<CreateDecisionTableImportJobRequest> withHttpInfo() {
        
        // verify the required parameter 'tableId' is set
        if (this.tableId == null) {
            throw new IllegalStateException("Missing the required parameter 'tableId' when building request for PostBusinessrulesDecisiontableImportsRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostBusinessrulesDecisiontableImportsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/businessrules/decisiontables/{tableId}/imports")
	...
	public static Builder builder(String tableId, CreateDecisionTableImportJobRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostBusinessrulesDecisiontableImportsRequest request;

		private Builder() {
			request = new PostBusinessrulesDecisiontableImportsRequest();
		}
		...
		public Builder withBody(CreateDecisionTableImportJobRequest body) {
		...
		public Builder withRequiredParams(String tableId, CreateDecisionTableImportJobRequest body) {
			request.setTableId(tableId);
			request.setBody(body);
		...
		public PostBusinessrulesDecisiontableImportsRequest build() {
