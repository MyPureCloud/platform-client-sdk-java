...
public class GetOrganizationsLimitsDocsRequest {
    ...
    public GetOrganizationsLimitsDocsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/organizations/limits/docs")
	...
	public static class Builder {
		private final GetOrganizationsLimitsDocsRequest request;

		private Builder() {
			request = new GetOrganizationsLimitsDocsRequest();
		}
		...
		public GetOrganizationsLimitsDocsRequest build() {
