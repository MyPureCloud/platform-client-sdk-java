...
public class GetEmailsSettingsRequest {
    ...
    public GetEmailsSettingsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/emails/settings")
	...
	public static class Builder {
		private final GetEmailsSettingsRequest request;

		private Builder() {
			request = new GetEmailsSettingsRequest();
		}
		...
		public GetEmailsSettingsRequest build() {
