...
public class PostOutboundContactlistsUploadsRequest {

	private ContactListUploadUrlRequest body;
	public ContactListUploadUrlRequest getBody() {
		return this.body;
	}

	public void setBody(ContactListUploadUrlRequest body) {
		this.body = body;
	}

	public PostOutboundContactlistsUploadsRequest withBody(ContactListUploadUrlRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostOutboundContactlistsUploadsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<ContactListUploadUrlRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostOutboundContactlistsUploadsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/outbound/contactlists/uploads")
                .withBody(body)
	...
	public static Builder builder(ContactListUploadUrlRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostOutboundContactlistsUploadsRequest request;

		private Builder() {
			request = new PostOutboundContactlistsUploadsRequest();
		}


		public Builder withBody(ContactListUploadUrlRequest body) {
		...
		public Builder withRequiredParams(ContactListUploadUrlRequest body) {
			request.setBody(body);
		...
		public PostOutboundContactlistsUploadsRequest build() {
