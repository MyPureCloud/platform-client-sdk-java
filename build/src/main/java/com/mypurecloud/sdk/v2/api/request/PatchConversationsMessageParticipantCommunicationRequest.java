...
public class PatchConversationsMessageParticipantCommunicationRequest {
	...
	public PatchConversationsMessageParticipantCommunicationRequest withConversationId(String conversationId) {
	...
	public PatchConversationsMessageParticipantCommunicationRequest withParticipantId(String participantId) {
	...
	public PatchConversationsMessageParticipantCommunicationRequest withCommunicationId(String communicationId) {
	...
	public PatchConversationsMessageParticipantCommunicationRequest withBody(MediaParticipantRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchConversationsMessageParticipantCommunicationRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<MediaParticipantRequest> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PatchConversationsMessageParticipantCommunicationRequest.");
        }
        
        // verify the required parameter 'participantId' is set
        if (this.participantId == null) {
            throw new IllegalStateException("Missing the required parameter 'participantId' when building request for PatchConversationsMessageParticipantCommunicationRequest.");
        }
        
        // verify the required parameter 'communicationId' is set
        if (this.communicationId == null) {
            throw new IllegalStateException("Missing the required parameter 'communicationId' when building request for PatchConversationsMessageParticipantCommunicationRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchConversationsMessageParticipantCommunicationRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/conversations/messages/{conversationId}/participants/{participantId}/communications/{communicationId}")
	...
	public static class Builder {
		private final PatchConversationsMessageParticipantCommunicationRequest request;

		private Builder() {
			request = new PatchConversationsMessageParticipantCommunicationRequest();
		}
		...
		public PatchConversationsMessageParticipantCommunicationRequest build() {
