...
public class DeleteOutboundSchedulesMessagingcampaignRequest {
	...
	public DeleteOutboundSchedulesMessagingcampaignRequest withMessagingCampaignId(String messagingCampaignId) {
    ...
    public DeleteOutboundSchedulesMessagingcampaignRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.messagingCampaignId == null) {
            throw new IllegalStateException("Missing the required parameter 'messagingCampaignId' when building request for DeleteOutboundSchedulesMessagingcampaignRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/outbound/schedules/messagingcampaigns/{messagingCampaignId}")
	...
	public static class Builder {
		private final DeleteOutboundSchedulesMessagingcampaignRequest request;

		private Builder() {
			request = new DeleteOutboundSchedulesMessagingcampaignRequest();
		}
		...
		public DeleteOutboundSchedulesMessagingcampaignRequest build() {
