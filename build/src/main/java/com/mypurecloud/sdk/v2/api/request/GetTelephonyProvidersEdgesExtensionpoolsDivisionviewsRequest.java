...
public class GetTelephonyProvidersEdgesExtensionpoolsDivisionviewsRequest {
	...
	public GetTelephonyProvidersEdgesExtensionpoolsDivisionviewsRequest withPageNumber(Integer pageNumber) {
	...
	public GetTelephonyProvidersEdgesExtensionpoolsDivisionviewsRequest withPageSize(Integer pageSize) {
	...
	public GetTelephonyProvidersEdgesExtensionpoolsDivisionviewsRequest withSortBy(String sortBy) {
	...
	public GetTelephonyProvidersEdgesExtensionpoolsDivisionviewsRequest withSortOrder(String sortOrder) {
	...
	public GetTelephonyProvidersEdgesExtensionpoolsDivisionviewsRequest withId(List<String> id) {
	    this.setId(id);
	    return this;
	} 
	...
	public GetTelephonyProvidersEdgesExtensionpoolsDivisionviewsRequest withName(String name) {
	    this.setName(name);
	    return this;
	} 
	...
	public GetTelephonyProvidersEdgesExtensionpoolsDivisionviewsRequest withDivisionId(List<String> divisionId) {
    ...
    public GetTelephonyProvidersEdgesExtensionpoolsDivisionviewsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/telephony/providers/edges/extensionpools/divisionviews")
	...
	public static class Builder {
		private final GetTelephonyProvidersEdgesExtensionpoolsDivisionviewsRequest request;

		private Builder() {
			request = new GetTelephonyProvidersEdgesExtensionpoolsDivisionviewsRequest();
		}
		...
		public GetTelephonyProvidersEdgesExtensionpoolsDivisionviewsRequest build() {
