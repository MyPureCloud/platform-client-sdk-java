...
public class DeleteKnowledgeKnowledgebaseDocumentVariationRequest {
	...
	public DeleteKnowledgeKnowledgebaseDocumentVariationRequest withDocumentVariationId(String documentVariationId) {
	...
	public DeleteKnowledgeKnowledgebaseDocumentVariationRequest withDocumentId(String documentId) {
	...
	public DeleteKnowledgeKnowledgebaseDocumentVariationRequest withKnowledgeBaseId(String knowledgeBaseId) {
    ...
    public DeleteKnowledgeKnowledgebaseDocumentVariationRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.documentVariationId == null) {
            throw new IllegalStateException("Missing the required parameter 'documentVariationId' when building request for DeleteKnowledgeKnowledgebaseDocumentVariationRequest.");
        }
        
        // verify the required parameter 'documentId' is set
        if (this.documentId == null) {
            throw new IllegalStateException("Missing the required parameter 'documentId' when building request for DeleteKnowledgeKnowledgebaseDocumentVariationRequest.");
        }
        
        // verify the required parameter 'knowledgeBaseId' is set
        if (this.knowledgeBaseId == null) {
            throw new IllegalStateException("Missing the required parameter 'knowledgeBaseId' when building request for DeleteKnowledgeKnowledgebaseDocumentVariationRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/documents/{documentId}/variations/{documentVariationId}")
	...
	public static class Builder {
		private final DeleteKnowledgeKnowledgebaseDocumentVariationRequest request;

		private Builder() {
			request = new DeleteKnowledgeKnowledgebaseDocumentVariationRequest();
		}
		...
		public DeleteKnowledgeKnowledgebaseDocumentVariationRequest build() {
