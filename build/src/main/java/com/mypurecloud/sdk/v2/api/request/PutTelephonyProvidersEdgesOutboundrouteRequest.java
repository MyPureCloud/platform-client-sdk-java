...
public class PutTelephonyProvidersEdgesOutboundrouteRequest {
	...
	public PutTelephonyProvidersEdgesOutboundrouteRequest withOutboundRouteId(String outboundRouteId) {
	...
	public void setBody(OutboundRoute body) {
		this.body = body;
	}

	public PutTelephonyProvidersEdgesOutboundrouteRequest withBody(OutboundRoute body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutTelephonyProvidersEdgesOutboundrouteRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<OutboundRoute> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("PUT", "/api/v2/telephony/providers/edges/outboundroutes/{outboundRouteId}")
