...
public class PostWorkforcemanagementManagementunitTimeofflimitsRequest {
	...
	public PostWorkforcemanagementManagementunitTimeofflimitsRequest withManagementUnitId(String managementUnitId) {
	    this.setManagementUnitId(managementUnitId);
	    return this;
	} 

	private CreateTimeOffLimitRequest body;
	public CreateTimeOffLimitRequest getBody() {
		return this.body;
	}

	public void setBody(CreateTimeOffLimitRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementManagementunitTimeofflimitsRequest withBody(CreateTimeOffLimitRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementManagementunitTimeofflimitsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<CreateTimeOffLimitRequest> withHttpInfo() {
        
        // verify the required parameter 'managementUnitId' is set
        if (this.managementUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'managementUnitId' when building request for PostWorkforcemanagementManagementunitTimeofflimitsRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementManagementunitTimeofflimitsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/managementunits/{managementUnitId}/timeofflimits")
	...
	public static Builder builder(String managementUnitId, CreateTimeOffLimitRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementManagementunitTimeofflimitsRequest request;

		private Builder() {
			request = new PostWorkforcemanagementManagementunitTimeofflimitsRequest();
		}
		...
		public Builder withBody(CreateTimeOffLimitRequest body) {
		...
		public Builder withRequiredParams(String managementUnitId, CreateTimeOffLimitRequest body) {
			request.setManagementUnitId(managementUnitId);
			request.setBody(body);
		...
		public PostWorkforcemanagementManagementunitTimeofflimitsRequest build() {
