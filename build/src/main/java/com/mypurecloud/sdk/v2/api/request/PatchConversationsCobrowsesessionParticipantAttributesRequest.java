...
public class PatchConversationsCobrowsesessionParticipantAttributesRequest {
    ...
    public ApiRequest<ParticipantAttributes> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PatchConversationsCobrowsesessionParticipantAttributesRequest.");
        }
        ...
        return ApiRequestBuilder.create("PATCH", "/api/v2/conversations/cobrowsesessions/{conversationId}/participants/{participantId}/attributes")
