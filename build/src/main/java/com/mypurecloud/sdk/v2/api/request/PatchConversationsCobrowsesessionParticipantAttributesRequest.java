...
public class PatchConversationsCobrowsesessionParticipantAttributesRequest {
	...
	public PatchConversationsCobrowsesessionParticipantAttributesRequest withCobrowseId(String cobrowseId) {
    ...
    public PatchConversationsCobrowsesessionParticipantAttributesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<ParticipantAttributes> withHttpInfo() {
        ...
        if (this.cobrowseId == null) {
            throw new IllegalStateException("Missing the required parameter 'cobrowseId' when building request for PatchConversationsCobrowsesessionParticipantAttributesRequest.");
        }
        
        // verify the required parameter 'participantId' is set
        if (this.participantId == null) {
            throw new IllegalStateException("Missing the required parameter 'participantId' when building request for PatchConversationsCobrowsesessionParticipantAttributesRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/conversations/cobrowsesessions/{cobrowseId}/participants/{participantId}/attributes")
	...
	public static class Builder {
		private final PatchConversationsCobrowsesessionParticipantAttributesRequest request;

		private Builder() {
			request = new PatchConversationsCobrowsesessionParticipantAttributesRequest();
		}
