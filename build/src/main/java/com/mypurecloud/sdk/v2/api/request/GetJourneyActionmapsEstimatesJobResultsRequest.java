...
public class GetJourneyActionmapsEstimatesJobResultsRequest {
	...
	public GetJourneyActionmapsEstimatesJobResultsRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetJourneyActionmapsEstimatesJobResultsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetJourneyActionmapsEstimatesJobResultsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/journey/actionmaps/estimates/jobs/{jobId}/results")
	...
	public static class Builder {
		private final GetJourneyActionmapsEstimatesJobResultsRequest request;

		private Builder() {
			request = new GetJourneyActionmapsEstimatesJobResultsRequest();
		}
		...
		public GetJourneyActionmapsEstimatesJobResultsRequest build() {
