...
public class GetWorkforcemanagementBusinessunitServicegoaltemplatesRequest {
	...
	public GetWorkforcemanagementBusinessunitServicegoaltemplatesRequest withBusinessUnitId(String businessUnitId) {
	...
	public GetWorkforcemanagementBusinessunitServicegoaltemplatesRequest withExpand(List<String> expand) {
    ...
    public GetWorkforcemanagementBusinessunitServicegoaltemplatesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for GetWorkforcemanagementBusinessunitServicegoaltemplatesRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/servicegoaltemplates")
	...
	public static class Builder {
		private final GetWorkforcemanagementBusinessunitServicegoaltemplatesRequest request;

		private Builder() {
			request = new GetWorkforcemanagementBusinessunitServicegoaltemplatesRequest();
		}
		...
		public GetWorkforcemanagementBusinessunitServicegoaltemplatesRequest build() {
