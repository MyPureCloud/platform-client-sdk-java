...
public class PatchKnowledgeSourceSynchronizationRequest {
	...
	public PatchKnowledgeSourceSynchronizationRequest withSourceId(String sourceId) {
	...
	public PatchKnowledgeSourceSynchronizationRequest withSynchronizationId(String synchronizationId) {
	    this.setSynchronizationId(synchronizationId);
	    return this;
	} 

	private V3SynchronizationUpdateRequest body;
	public V3SynchronizationUpdateRequest getBody() {
		return this.body;
	}

	public void setBody(V3SynchronizationUpdateRequest body) {
		this.body = body;
	}

	public PatchKnowledgeSourceSynchronizationRequest withBody(V3SynchronizationUpdateRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchKnowledgeSourceSynchronizationRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<V3SynchronizationUpdateRequest> withHttpInfo() {
        
        // verify the required parameter 'sourceId' is set
        if (this.sourceId == null) {
            throw new IllegalStateException("Missing the required parameter 'sourceId' when building request for PatchKnowledgeSourceSynchronizationRequest.");
        }
        
        // verify the required parameter 'synchronizationId' is set
        if (this.synchronizationId == null) {
            throw new IllegalStateException("Missing the required parameter 'synchronizationId' when building request for PatchKnowledgeSourceSynchronizationRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchKnowledgeSourceSynchronizationRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/knowledge/sources/{sourceId}/synchronizations/{synchronizationId}")
	...
	public static Builder builder(String sourceId, String synchronizationId, V3SynchronizationUpdateRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PatchKnowledgeSourceSynchronizationRequest request;

		private Builder() {
			request = new PatchKnowledgeSourceSynchronizationRequest();
		}
		...
		public Builder withBody(V3SynchronizationUpdateRequest body) {
		...
		public Builder withRequiredParams(String sourceId, String synchronizationId, V3SynchronizationUpdateRequest body) {
			request.setSourceId(sourceId);
			request.setSynchronizationId(synchronizationId);
			request.setBody(body);
		...
		public PatchKnowledgeSourceSynchronizationRequest build() {
