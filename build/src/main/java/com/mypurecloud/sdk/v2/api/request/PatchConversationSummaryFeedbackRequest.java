...
public class PatchConversationSummaryFeedbackRequest {
	...
	public PatchConversationSummaryFeedbackRequest withConversationId(String conversationId) {
	...
	public PatchConversationSummaryFeedbackRequest withSummaryId(String summaryId) {
	    this.setSummaryId(summaryId);
	    return this;
	} 

	private FeedbackUpdateRequest body;
	public FeedbackUpdateRequest getBody() {
		return this.body;
	}

	public void setBody(FeedbackUpdateRequest body) {
		this.body = body;
	}

	public PatchConversationSummaryFeedbackRequest withBody(FeedbackUpdateRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchConversationSummaryFeedbackRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<FeedbackUpdateRequest> withHttpInfo() {
        
        // verify the required parameter 'conversationId' is set
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PatchConversationSummaryFeedbackRequest.");
        }
        
        // verify the required parameter 'summaryId' is set
        if (this.summaryId == null) {
            throw new IllegalStateException("Missing the required parameter 'summaryId' when building request for PatchConversationSummaryFeedbackRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/conversations/{conversationId}/summaries/{summaryId}/feedback")
	...
	public static class Builder {
		private final PatchConversationSummaryFeedbackRequest request;

		private Builder() {
			request = new PatchConversationSummaryFeedbackRequest();
		}
		...
		public Builder withBody(FeedbackUpdateRequest body) {
		...
		public PatchConversationSummaryFeedbackRequest build() {
