...
public class DeleteOutboundDnclistWhatsappnumbersRequest {
	...
	public DeleteOutboundDnclistWhatsappnumbersRequest withDncListId(String dncListId) {
	...
	public DeleteOutboundDnclistWhatsappnumbersRequest withExpiredOnly(Boolean expiredOnly) {
	    this.setExpiredOnly(expiredOnly);
	    return this;
	} 
    ...
    public DeleteOutboundDnclistWhatsappnumbersRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.dncListId == null) {
            throw new IllegalStateException("Missing the required parameter 'dncListId' when building request for DeleteOutboundDnclistWhatsappnumbersRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/outbound/dnclists/{dncListId}/whatsappnumbers")
                .withPathParameter("dncListId", dncListId)
        

                .withQueryParameters("expiredOnly", "", expiredOnly)
	...
	public static class Builder {
		private final DeleteOutboundDnclistWhatsappnumbersRequest request;

		private Builder() {
			request = new DeleteOutboundDnclistWhatsappnumbersRequest();
		}
		...
		public Builder withExpiredOnly(Boolean expiredOnly) {
			request.setExpiredOnly(expiredOnly);
			return this;
		}
		...
		public DeleteOutboundDnclistWhatsappnumbersRequest build() {
