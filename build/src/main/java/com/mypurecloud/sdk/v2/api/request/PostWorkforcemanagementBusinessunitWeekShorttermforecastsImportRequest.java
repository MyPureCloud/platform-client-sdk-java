...
public class PostWorkforcemanagementBusinessunitWeekShorttermforecastsImportRequest {
	...
	public PostWorkforcemanagementBusinessunitWeekShorttermforecastsImportRequest withBusinessUnitId(String businessUnitId) {
	...
	public PostWorkforcemanagementBusinessunitWeekShorttermforecastsImportRequest withWeekDateId(LocalDate weekDateId) {
	...
	public PostWorkforcemanagementBusinessunitWeekShorttermforecastsImportRequest withBody(WfmProcessUploadRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementBusinessunitWeekShorttermforecastsImportRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<WfmProcessUploadRequest> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PostWorkforcemanagementBusinessunitWeekShorttermforecastsImportRequest.");
        }
        
        // verify the required parameter 'weekDateId' is set
        if (this.weekDateId == null) {
            throw new IllegalStateException("Missing the required parameter 'weekDateId' when building request for PostWorkforcemanagementBusinessunitWeekShorttermforecastsImportRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementBusinessunitWeekShorttermforecastsImportRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/weeks/{weekDateId}/shorttermforecasts/import")
	...
	public static Builder builder(String businessUnitId, LocalDate weekDateId, WfmProcessUploadRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementBusinessunitWeekShorttermforecastsImportRequest request;

		private Builder() {
			request = new PostWorkforcemanagementBusinessunitWeekShorttermforecastsImportRequest();
		}
		...
		public Builder withRequiredParams(String businessUnitId, LocalDate weekDateId, WfmProcessUploadRequest body) {
			request.setBusinessUnitId(businessUnitId);
						request.setWeekDateId(weekDateId);
						request.setBody(body);
		...
		public PostWorkforcemanagementBusinessunitWeekShorttermforecastsImportRequest build() {
