...
public class CallableTimeSetEntityListing  implements Serializable, PagedResource<CallableTimeSet> {
  ...
  public CallableTimeSetEntityListing() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
      entities = new ArrayList<CallableTimeSet>();
    }
  }

  public CallableTimeSetEntityListing(Boolean initWithEmptyList) {
  ...
  /**
   **/
  public CallableTimeSetEntityListing entities(List<CallableTimeSet> entities) {
