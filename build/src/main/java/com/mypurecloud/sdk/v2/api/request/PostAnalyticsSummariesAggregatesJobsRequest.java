...
public class PostAnalyticsSummariesAggregatesJobsRequest {

	private SummaryAsyncAggregationQuery body;
	public SummaryAsyncAggregationQuery getBody() {
		return this.body;
	}

	public void setBody(SummaryAsyncAggregationQuery body) {
		this.body = body;
	}

	public PostAnalyticsSummariesAggregatesJobsRequest withBody(SummaryAsyncAggregationQuery body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostAnalyticsSummariesAggregatesJobsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<SummaryAsyncAggregationQuery> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostAnalyticsSummariesAggregatesJobsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/analytics/summaries/aggregates/jobs")
                .withBody(body)
	...
	public static Builder builder(SummaryAsyncAggregationQuery body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostAnalyticsSummariesAggregatesJobsRequest request;

		private Builder() {
			request = new PostAnalyticsSummariesAggregatesJobsRequest();
		}


		public Builder withBody(SummaryAsyncAggregationQuery body) {
		...
		public Builder withRequiredParams(SummaryAsyncAggregationQuery body) {
			request.setBody(body);
		...
		public PostAnalyticsSummariesAggregatesJobsRequest build() {
