...
public class PatchSocialmediaTopicRequest {
	...
	public PatchSocialmediaTopicRequest withTopicId(String topicId) {
	    this.setTopicId(topicId);
	    return this;
	} 

	private SocialTopicPatchRequest body;
	public SocialTopicPatchRequest getBody() {
		return this.body;
	}

	public void setBody(SocialTopicPatchRequest body) {
		this.body = body;
	}

	public PatchSocialmediaTopicRequest withBody(SocialTopicPatchRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchSocialmediaTopicRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<SocialTopicPatchRequest> withHttpInfo() {
        
        // verify the required parameter 'topicId' is set
        if (this.topicId == null) {
            throw new IllegalStateException("Missing the required parameter 'topicId' when building request for PatchSocialmediaTopicRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/socialmedia/topics/{topicId}")
	...
	public static class Builder {
		private final PatchSocialmediaTopicRequest request;

		private Builder() {
			request = new PatchSocialmediaTopicRequest();
		}
		...
		public Builder withBody(SocialTopicPatchRequest body) {
		...
		public PatchSocialmediaTopicRequest build() {
