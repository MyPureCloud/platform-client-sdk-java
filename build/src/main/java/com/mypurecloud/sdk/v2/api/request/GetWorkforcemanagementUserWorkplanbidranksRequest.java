...
public class GetWorkforcemanagementUserWorkplanbidranksRequest {
	...
	public GetWorkforcemanagementUserWorkplanbidranksRequest withUserId(String userId) {
    ...
    public GetWorkforcemanagementUserWorkplanbidranksRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.userId == null) {
            throw new IllegalStateException("Missing the required parameter 'userId' when building request for GetWorkforcemanagementUserWorkplanbidranksRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/users/{userId}/workplanbidranks")
	...
	public static class Builder {
		private final GetWorkforcemanagementUserWorkplanbidranksRequest request;

		private Builder() {
			request = new GetWorkforcemanagementUserWorkplanbidranksRequest();
		}
		...
		public GetWorkforcemanagementUserWorkplanbidranksRequest build() {
