...
public class GetAnalyticsAgentcopilotsAggregatesJobResultsRequest {
	...
	public GetAnalyticsAgentcopilotsAggregatesJobResultsRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
	...
	public GetAnalyticsAgentcopilotsAggregatesJobResultsRequest withCursor(String cursor) {
    ...
    public GetAnalyticsAgentcopilotsAggregatesJobResultsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetAnalyticsAgentcopilotsAggregatesJobResultsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/analytics/agentcopilots/aggregates/jobs/{jobId}/results")
	...
	public static class Builder {
		private final GetAnalyticsAgentcopilotsAggregatesJobResultsRequest request;

		private Builder() {
			request = new GetAnalyticsAgentcopilotsAggregatesJobResultsRequest();
		}
		...
		public GetAnalyticsAgentcopilotsAggregatesJobResultsRequest build() {
