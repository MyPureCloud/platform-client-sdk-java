...
public class PatchConversationSuggestionRequest {
	...
	public PatchConversationSuggestionRequest withConversationId(String conversationId) {
	...
	public PatchConversationSuggestionRequest withSuggestionId(String suggestionId) {
	    this.setSuggestionId(suggestionId);
	    return this;
	} 

	private SuggestionPatchRequest body;
	public SuggestionPatchRequest getBody() {
		return this.body;
	}

	public void setBody(SuggestionPatchRequest body) {
		this.body = body;
	}

	public PatchConversationSuggestionRequest withBody(SuggestionPatchRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchConversationSuggestionRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<SuggestionPatchRequest> withHttpInfo() {
        
        // verify the required parameter 'conversationId' is set
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PatchConversationSuggestionRequest.");
        }
        
        // verify the required parameter 'suggestionId' is set
        if (this.suggestionId == null) {
            throw new IllegalStateException("Missing the required parameter 'suggestionId' when building request for PatchConversationSuggestionRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchConversationSuggestionRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/conversations/{conversationId}/suggestions/{suggestionId}")
	...
	public static Builder builder(String conversationId, String suggestionId, SuggestionPatchRequest body) {
	    return new Builder()
	            .withRequiredParams(conversationId, suggestionId, body);
	}


	public static class Builder {
		private final PatchConversationSuggestionRequest request;

		private Builder() {
			request = new PatchConversationSuggestionRequest();
		}
		...
		public Builder withBody(SuggestionPatchRequest body) {
		...
		public Builder withRequiredParams(String conversationId, String suggestionId, SuggestionPatchRequest body) {
			request.setConversationId(conversationId);
			request.setSuggestionId(suggestionId);
			request.setBody(body);
		...
		public PatchConversationSuggestionRequest build() {
