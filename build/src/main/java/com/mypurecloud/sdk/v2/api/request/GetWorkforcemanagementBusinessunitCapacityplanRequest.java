...
public class GetWorkforcemanagementBusinessunitCapacityplanRequest {
	...
	public GetWorkforcemanagementBusinessunitCapacityplanRequest withBusinessUnitId(String businessUnitId) {
	...
	public GetWorkforcemanagementBusinessunitCapacityplanRequest withCapacityPlanId(String capacityPlanId) {
    ...
    public GetWorkforcemanagementBusinessunitCapacityplanRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for GetWorkforcemanagementBusinessunitCapacityplanRequest.");
        }
        
        // verify the required parameter 'capacityPlanId' is set
        if (this.capacityPlanId == null) {
            throw new IllegalStateException("Missing the required parameter 'capacityPlanId' when building request for GetWorkforcemanagementBusinessunitCapacityplanRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/capacityplans/{capacityPlanId}")
	...
	public static class Builder {
		private final GetWorkforcemanagementBusinessunitCapacityplanRequest request;

		private Builder() {
			request = new GetWorkforcemanagementBusinessunitCapacityplanRequest();
		}
		...
		public GetWorkforcemanagementBusinessunitCapacityplanRequest build() {
