...
public class ImportTemplateImportStatusImportStatus  implements Serializable {
 ...
 @JsonDeserialize(using = ImportStateEnumDeserializer.class)
  ...
  public ImportTemplateImportStatusImportStatus() {
   ...
   * current status of the import
   **/
  public ImportTemplateImportStatusImportStatus importState(ImportStateEnum importState) {
   ...
   **/
  public ImportTemplateImportStatusImportStatus totalRecords(Long totalRecords) {
   ...
   **/
  public ImportTemplateImportStatusImportStatus completedRecords(Long completedRecords) {
   ...
   **/
  public ImportTemplateImportStatusImportStatus percentageComplete(Long percentageComplete) {
   ...
   **/
  public ImportTemplateImportStatusImportStatus failureReason(String failureReason) {
   ...
   **/
  public ImportTemplateImportStatusImportStatus targetContactListIds(List<String> targetContactListIds) {
   ...
   **/
  public ImportTemplateImportStatusImportStatus listNamePrefix(String listNamePrefix) {
  ...
  /**
   **/
  public ImportTemplateImportStatusImportStatus additionalProperties(Map<String, Object> additionalProperties) {
  ...
  /**
   **/
  public ImportTemplateImportStatusImportStatus getAdditionalProperties(Map<String, Object> getAdditionalProperties) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ImportTemplateImportStatusImportStatus importTemplateImportStatusImportStatus = (ImportTemplateImportStatusImportStatus) o;

    return Objects.equals(this.importState, importTemplateImportStatusImportStatus.importState) &&
            Objects.equals(this.totalRecords, importTemplateImportStatusImportStatus.totalRecords) &&
            Objects.equals(this.completedRecords, importTemplateImportStatusImportStatus.completedRecords) &&
            Objects.equals(this.percentageComplete, importTemplateImportStatusImportStatus.percentageComplete) &&
            Objects.equals(this.failureReason, importTemplateImportStatusImportStatus.failureReason) &&
            Objects.equals(this.targetContactListIds, importTemplateImportStatusImportStatus.targetContactListIds) &&
            Objects.equals(this.listNamePrefix, importTemplateImportStatusImportStatus.listNamePrefix) &&
            Objects.equals(this.additionalProperties, importTemplateImportStatusImportStatus.additionalProperties) &&
            Objects.equals(this.getAdditionalProperties, importTemplateImportStatusImportStatus.getAdditionalProperties);
  }
