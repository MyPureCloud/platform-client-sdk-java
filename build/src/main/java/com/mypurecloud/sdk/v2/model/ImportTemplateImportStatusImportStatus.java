...
public class ImportTemplateImportStatusImportStatus  implements Serializable {
 ...
 @JsonDeserialize(using = ImportStateEnumDeserializer.class)
   ...
   **/
  public ImportTemplateImportStatusImportStatus totalRecords(Integer totalRecords) {
   ...
   **/
  public ImportTemplateImportStatusImportStatus completedRecords(Integer completedRecords) {
   ...
   **/
  public ImportTemplateImportStatusImportStatus percentageComplete(Integer percentageComplete) {
