...
public class JourneyWebEventsNotificationBrowser  implements Serializable {
  ...
  public JourneyWebEventsNotificationBrowser() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
    }
  }

  public JourneyWebEventsNotificationBrowser(Boolean initWithEmptyList) {
  ...
  /**
   **/
  public JourneyWebEventsNotificationBrowser viewHeight(Long viewHeight) {
  ...
  /**
   **/
  public JourneyWebEventsNotificationBrowser viewWidth(Long viewWidth) {
