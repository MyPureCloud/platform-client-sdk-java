...
public class GetFlowsLookupRequest {
	...
	public GetFlowsLookupRequest withId(List<String> id) {
	    this.setId(id);
	    return this;
	} 
	...
	public GetFlowsLookupRequest withPageNumber(Integer pageNumber) {
	...
	public GetFlowsLookupRequest withPageSize(Integer pageSize) {
	...
	public GetFlowsLookupRequest withSortBy(String sortBy) {
	...
	public GetFlowsLookupRequest withSortOrder(String sortOrder) {
    ...
    public GetFlowsLookupRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.id == null) {
            throw new IllegalStateException("Missing the required parameter 'id' when building request for GetFlowsLookupRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/flows/lookup")
	...
	public static class Builder {
		private final GetFlowsLookupRequest request;

		private Builder() {
			request = new GetFlowsLookupRequest();
		}
		...
		public GetFlowsLookupRequest build() {
