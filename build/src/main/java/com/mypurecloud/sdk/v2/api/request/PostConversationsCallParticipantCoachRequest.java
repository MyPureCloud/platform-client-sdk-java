...
public class PostConversationsCallParticipantCoachRequest {
	...
	public PostConversationsCallParticipantCoachRequest withConversationId(String conversationId) {
	...
	public PostConversationsCallParticipantCoachRequest withParticipantId(String participantId) {
    ...
    public PostConversationsCallParticipantCoachRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PostConversationsCallParticipantCoachRequest.");
        }
        
        // verify the required parameter 'participantId' is set
        if (this.participantId == null) {
            throw new IllegalStateException("Missing the required parameter 'participantId' when building request for PostConversationsCallParticipantCoachRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/conversations/calls/{conversationId}/participants/{participantId}/coach")
	...
	public static class Builder {
		private final PostConversationsCallParticipantCoachRequest request;

		private Builder() {
			request = new PostConversationsCallParticipantCoachRequest();
		}
		...
		public PostConversationsCallParticipantCoachRequest build() {
