...
public class GetRoutingSettingsContactcenterRequest {
    ...
    public GetRoutingSettingsContactcenterRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/routing/settings/contactcenter")
	...
	public static class Builder {
		private final GetRoutingSettingsContactcenterRequest request;

		private Builder() {
			request = new GetRoutingSettingsContactcenterRequest();
		}
		...
		public GetRoutingSettingsContactcenterRequest build() {
