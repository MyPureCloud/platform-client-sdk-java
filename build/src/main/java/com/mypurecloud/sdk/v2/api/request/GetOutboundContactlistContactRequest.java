...
public class GetOutboundContactlistContactRequest {
	...
	public GetOutboundContactlistContactRequest withContactListId(String contactListId) {
	...
	public GetOutboundContactlistContactRequest withContactId(String contactId) {
    ...
    public GetOutboundContactlistContactRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/outbound/contactlists/{contactListId}/contacts/{contactId}")
	...
	public static class Builder {
		private final GetOutboundContactlistContactRequest request;

		private Builder() {
			request = new GetOutboundContactlistContactRequest();
		}
		...
		public GetOutboundContactlistContactRequest build() {
