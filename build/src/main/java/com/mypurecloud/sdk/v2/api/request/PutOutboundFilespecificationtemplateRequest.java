...
public class PutOutboundFilespecificationtemplateRequest {
	...
	private FileSpecificationTemplate body;
	public FileSpecificationTemplate getBody() {
		return this.body;
	}

	public void setBody(FileSpecificationTemplate body) {
		this.body = body;
	}

	public PutOutboundFilespecificationtemplateRequest withBody(FileSpecificationTemplate body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutOutboundFilespecificationtemplateRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<FileSpecificationTemplate> withHttpInfo() {
        
        // verify the required parameter 'fileSpecificationTemplateId' is set
        if (this.fileSpecificationTemplateId == null) {
            throw new IllegalStateException("Missing the required parameter 'fileSpecificationTemplateId' when building request for PutOutboundFilespecificationtemplateRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutOutboundFilespecificationtemplateRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/outbound/filespecificationtemplates/{fileSpecificationTemplateId}")
	...
	public static Builder builder(String fileSpecificationTemplateId, FileSpecificationTemplate body) {
	    return new Builder()
	            .withRequiredParams(fileSpecificationTemplateId, body);
	}


	public static class Builder {
		private final PutOutboundFilespecificationtemplateRequest request;

		private Builder() {
			request = new PutOutboundFilespecificationtemplateRequest();
		}
		...
		public Builder withBody(FileSpecificationTemplate body) {
		...
		public Builder withRequiredParams(String fileSpecificationTemplateId, FileSpecificationTemplate body) {
			request.setFileSpecificationTemplateId(fileSpecificationTemplateId);
			request.setBody(body);
		...
		public PutOutboundFilespecificationtemplateRequest build() {
