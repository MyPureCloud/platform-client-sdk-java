...
public class GetIntegrationsBotconnectorBotRequest {
	...
	public GetIntegrationsBotconnectorBotRequest withIntegrationId(String integrationId) {
	...
	public GetIntegrationsBotconnectorBotRequest withBotId(String botId) {
	    this.setBotId(botId);
	    return this;
	} 
	...
	public GetIntegrationsBotconnectorBotRequest withVersion(String version) {
    ...
    public GetIntegrationsBotconnectorBotRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.integrationId == null) {
            throw new IllegalStateException("Missing the required parameter 'integrationId' when building request for GetIntegrationsBotconnectorBotRequest.");
        }
        
        // verify the required parameter 'botId' is set
        if (this.botId == null) {
            throw new IllegalStateException("Missing the required parameter 'botId' when building request for GetIntegrationsBotconnectorBotRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/integrations/botconnectors/{integrationId}/bots/{botId}")
	...
	public static class Builder {
		private final GetIntegrationsBotconnectorBotRequest request;

		private Builder() {
			request = new GetIntegrationsBotconnectorBotRequest();
		}
		...
		public GetIntegrationsBotconnectorBotRequest build() {
