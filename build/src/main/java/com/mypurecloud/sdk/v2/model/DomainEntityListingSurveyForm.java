...
public class DomainEntityListingSurveyForm  implements Serializable, PagedResource<SurveyForm> {
  ...
  /**
   **/
  public DomainEntityListingSurveyForm entities(List<SurveyForm> entities) {
  ...
  public List<SurveyForm> getEntities() {
    return entities;
  }
  public void setEntities(List<SurveyForm> entities) {
    this.entities = entities;
  }
