...
public class PostChatsRoomPinnedmessagesRequest {
	...
	public PostChatsRoomPinnedmessagesRequest withRoomJid(String roomJid) {
	...
	public PostChatsRoomPinnedmessagesRequest withBody(PinnedMessageRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostChatsRoomPinnedmessagesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<PinnedMessageRequest> withHttpInfo() {
        ...
        if (this.roomJid == null) {
            throw new IllegalStateException("Missing the required parameter 'roomJid' when building request for PostChatsRoomPinnedmessagesRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostChatsRoomPinnedmessagesRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/chats/rooms/{roomJid}/pinnedmessages")
	...
	public static class Builder {
		private final PostChatsRoomPinnedmessagesRequest request;

		private Builder() {
			request = new PostChatsRoomPinnedmessagesRequest();
		}
		...
		public PostChatsRoomPinnedmessagesRequest build() {
