...
public class WfmBuShortTermForecastGenerateProgressTopicWfmVersionedEntityMetadata  implements Serializable {
  ...
  public WfmBuShortTermForecastGenerateProgressTopicWfmVersionedEntityMetadata() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
    }
  }

  public WfmBuShortTermForecastGenerateProgressTopicWfmVersionedEntityMetadata(Boolean initWithEmptyList) {
  ...
  /**
   **/
  public WfmBuShortTermForecastGenerateProgressTopicWfmVersionedEntityMetadata version(Long version) {
