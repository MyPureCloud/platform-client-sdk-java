...
public class PatchRecordingMediaretentionpolicyRequest {
    ...
    public ApiRequest<Policy> withHttpInfo() throws ApiException {
        ...
        if (this.policyId == null) {
            throw new ApiException(400, "Missing the required parameter 'policyId' when building request for PatchRecordingMediaretentionpolicyRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new ApiException(400, "Missing the required parameter 'body' when building request for PatchRecordingMediaretentionpolicyRequest.");
        }
