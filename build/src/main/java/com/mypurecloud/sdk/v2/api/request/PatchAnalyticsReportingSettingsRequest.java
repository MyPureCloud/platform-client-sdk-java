...
public class PatchAnalyticsReportingSettingsRequest {
    
	private AnalyticsReportingSettings body;
	public AnalyticsReportingSettings getBody() {
		return this.body;
	}

	public void setBody(AnalyticsReportingSettings body) {
		this.body = body;
	}

	public PatchAnalyticsReportingSettingsRequest withBody(AnalyticsReportingSettings body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchAnalyticsReportingSettingsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<AnalyticsReportingSettings> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchAnalyticsReportingSettingsRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/analytics/reporting/settings")
                .withBody(body)
	...
	public static Builder builder(AnalyticsReportingSettings body) {
	    return new Builder()
	...
	public static class Builder {
		private final PatchAnalyticsReportingSettingsRequest request;

		private Builder() {
			request = new PatchAnalyticsReportingSettingsRequest();
		}

		
		public Builder withBody(AnalyticsReportingSettings body) {
		...
		public Builder withRequiredParams(AnalyticsReportingSettings body) {
			request.setBody(body);
		...
		public PatchAnalyticsReportingSettingsRequest build() {
