...
public class PostWorkforcemanagementBusinessunitWeekSchedulesRequest {
	...
	public PostWorkforcemanagementBusinessunitWeekSchedulesRequest withBusinessUnitId(String businessUnitId) {
	...
	public PostWorkforcemanagementBusinessunitWeekSchedulesRequest withWeekId(LocalDate weekId) {
	    this.setWeekId(weekId);
	    return this;
	} 
	
	private BuCreateBlankScheduleRequest body;
	public BuCreateBlankScheduleRequest getBody() {
		return this.body;
	}

	public void setBody(BuCreateBlankScheduleRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementBusinessunitWeekSchedulesRequest withBody(BuCreateBlankScheduleRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementBusinessunitWeekSchedulesRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<BuCreateBlankScheduleRequest> withHttpInfo() {
        
        // verify the required parameter 'businessUnitId' is set
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PostWorkforcemanagementBusinessunitWeekSchedulesRequest.");
        }
        
        // verify the required parameter 'weekId' is set
        if (this.weekId == null) {
            throw new IllegalStateException("Missing the required parameter 'weekId' when building request for PostWorkforcemanagementBusinessunitWeekSchedulesRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementBusinessunitWeekSchedulesRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/weeks/{weekId}/schedules")
	...
	public static Builder builder(String businessUnitId, LocalDate weekId, BuCreateBlankScheduleRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementBusinessunitWeekSchedulesRequest request;

		private Builder() {
			request = new PostWorkforcemanagementBusinessunitWeekSchedulesRequest();
		}
		...
		public Builder withBody(BuCreateBlankScheduleRequest body) {
		...
		public Builder withRequiredParams(String businessUnitId, LocalDate weekId, BuCreateBlankScheduleRequest body) {
			request.setBusinessUnitId(businessUnitId);
						request.setWeekId(weekId);
						request.setBody(body);
		...
		public PostWorkforcemanagementBusinessunitWeekSchedulesRequest build() {
