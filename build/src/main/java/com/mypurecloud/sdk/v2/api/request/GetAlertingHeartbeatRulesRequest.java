...
public class GetAlertingHeartbeatRulesRequest {
	...
	public GetAlertingHeartbeatRulesRequest withExpand(List<String> expand) {
    ...
    public GetAlertingHeartbeatRulesRequest withCustomHeader(String name, String value) {
