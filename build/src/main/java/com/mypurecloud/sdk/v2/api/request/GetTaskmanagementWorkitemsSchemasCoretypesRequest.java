...
public class GetTaskmanagementWorkitemsSchemasCoretypesRequest {
    ...
    public GetTaskmanagementWorkitemsSchemasCoretypesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/taskmanagement/workitems/schemas/coretypes")
	...
	public static class Builder {
		private final GetTaskmanagementWorkitemsSchemasCoretypesRequest request;

		private Builder() {
			request = new GetTaskmanagementWorkitemsSchemasCoretypesRequest();
		}
		...
		public GetTaskmanagementWorkitemsSchemasCoretypesRequest build() {
