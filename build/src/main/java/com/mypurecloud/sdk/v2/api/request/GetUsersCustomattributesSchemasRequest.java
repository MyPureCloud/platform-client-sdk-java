...
public class GetUsersCustomattributesSchemasRequest {
    ...
    public GetUsersCustomattributesSchemasRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/users/customattributes/schemas")
	...
	public static class Builder {
		private final GetUsersCustomattributesSchemasRequest request;

		private Builder() {
			request = new GetUsersCustomattributesSchemasRequest();
		}
		...
		public GetUsersCustomattributesSchemasRequest build() {
