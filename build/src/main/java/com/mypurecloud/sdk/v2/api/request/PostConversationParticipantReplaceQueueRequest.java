...
public class PostConversationParticipantReplaceQueueRequest {
	...
	public PostConversationParticipantReplaceQueueRequest withConversationId(String conversationId) {
	...
	public PostConversationParticipantReplaceQueueRequest withParticipantId(String participantId) {
	    this.setParticipantId(participantId);
	    return this;
	} 

	private TransferToQueueRequest body;
	public TransferToQueueRequest getBody() {
		return this.body;
	}

	public void setBody(TransferToQueueRequest body) {
		this.body = body;
	}

	public PostConversationParticipantReplaceQueueRequest withBody(TransferToQueueRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostConversationParticipantReplaceQueueRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<TransferToQueueRequest> withHttpInfo() {
        
        // verify the required parameter 'conversationId' is set
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PostConversationParticipantReplaceQueueRequest.");
        }
        
        // verify the required parameter 'participantId' is set
        if (this.participantId == null) {
            throw new IllegalStateException("Missing the required parameter 'participantId' when building request for PostConversationParticipantReplaceQueueRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostConversationParticipantReplaceQueueRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/conversations/{conversationId}/participants/{participantId}/replace/queue")
	...
	public static Builder builder(String conversationId, String participantId, TransferToQueueRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostConversationParticipantReplaceQueueRequest request;

		private Builder() {
			request = new PostConversationParticipantReplaceQueueRequest();
		}
		...
		public Builder withBody(TransferToQueueRequest body) {
		...
		public Builder withRequiredParams(String conversationId, String participantId, TransferToQueueRequest body) {
			request.setConversationId(conversationId);
			request.setParticipantId(participantId);
			request.setBody(body);
		...
		public PostConversationParticipantReplaceQueueRequest build() {
