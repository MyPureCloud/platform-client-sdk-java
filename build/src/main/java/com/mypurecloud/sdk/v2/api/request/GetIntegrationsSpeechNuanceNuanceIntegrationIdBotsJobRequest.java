...
public class GetIntegrationsSpeechNuanceNuanceIntegrationIdBotsJobRequest {
	...
	public GetIntegrationsSpeechNuanceNuanceIntegrationIdBotsJobRequest withNuanceIntegrationId(String nuanceIntegrationId) {
	...
	public GetIntegrationsSpeechNuanceNuanceIntegrationIdBotsJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetIntegrationsSpeechNuanceNuanceIntegrationIdBotsJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.nuanceIntegrationId == null) {
            throw new IllegalStateException("Missing the required parameter 'nuanceIntegrationId' when building request for GetIntegrationsSpeechNuanceNuanceIntegrationIdBotsJobRequest.");
        }
        
        // verify the required parameter 'jobId' is set
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetIntegrationsSpeechNuanceNuanceIntegrationIdBotsJobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/integrations/speech/nuance/{nuanceIntegrationId}/bots/jobs/{jobId}")
	...
	public static class Builder {
		private final GetIntegrationsSpeechNuanceNuanceIntegrationIdBotsJobRequest request;

		private Builder() {
			request = new GetIntegrationsSpeechNuanceNuanceIntegrationIdBotsJobRequest();
		}
		...
		public GetIntegrationsSpeechNuanceNuanceIntegrationIdBotsJobRequest build() {
