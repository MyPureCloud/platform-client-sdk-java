...
public class GetTelephonyProvidersEdgesTrunksMetricsRequest {
	...
	public GetTelephonyProvidersEdgesTrunksMetricsRequest withTrunkIds(String trunkIds) {
	    this.setTrunkIds(trunkIds);
	    return this;
	} 
    ...
    public GetTelephonyProvidersEdgesTrunksMetricsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.trunkIds == null) {
            throw new IllegalStateException("Missing the required parameter 'trunkIds' when building request for GetTelephonyProvidersEdgesTrunksMetricsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/telephony/providers/edges/trunks/metrics")
                .withQueryParameters("trunkIds", "", trunkIds)
	...
	public static Builder builder(String trunkIds) {
	    return new Builder()
	            .withRequiredParams(trunkIds);
	}
	

	public static class Builder {
		private final GetTelephonyProvidersEdgesTrunksMetricsRequest request;

		private Builder() {
			request = new GetTelephonyProvidersEdgesTrunksMetricsRequest();
		}

		
		public Builder withTrunkIds(String trunkIds) {
			request.setTrunkIds(trunkIds);
			return this;
		}
		

		
		public Builder withRequiredParams(String trunkIds) {
			request.setTrunkIds(trunkIds);
		...
		public GetTelephonyProvidersEdgesTrunksMetricsRequest build() {
            
            // verify the required parameter 'trunkIds' is set
            if (request.trunkIds == null) {
                throw new IllegalStateException("Missing the required parameter 'trunkIds' when building request for GetTelephonyProvidersEdgesTrunksMetricsRequest.");
            }
