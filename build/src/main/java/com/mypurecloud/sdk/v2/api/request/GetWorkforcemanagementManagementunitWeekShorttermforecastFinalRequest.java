...
public class GetWorkforcemanagementManagementunitWeekShorttermforecastFinalRequest {
	...
	public GetWorkforcemanagementManagementunitWeekShorttermforecastFinalRequest withManagementUnitId(String managementUnitId) {
	...
	public GetWorkforcemanagementManagementunitWeekShorttermforecastFinalRequest withWeekDateId(String weekDateId) {
	...
	public GetWorkforcemanagementManagementunitWeekShorttermforecastFinalRequest withForecastId(String forecastId) {
	...
	public GetWorkforcemanagementManagementunitWeekShorttermforecastFinalRequest withForceDownloadService(Boolean forceDownloadService) {
    ...
    public GetWorkforcemanagementManagementunitWeekShorttermforecastFinalRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.managementUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'managementUnitId' when building request for GetWorkforcemanagementManagementunitWeekShorttermforecastFinalRequest.");
        }
        
        // verify the required parameter 'weekDateId' is set
        if (this.weekDateId == null) {
            throw new IllegalStateException("Missing the required parameter 'weekDateId' when building request for GetWorkforcemanagementManagementunitWeekShorttermforecastFinalRequest.");
        }
        
        // verify the required parameter 'forecastId' is set
        if (this.forecastId == null) {
            throw new IllegalStateException("Missing the required parameter 'forecastId' when building request for GetWorkforcemanagementManagementunitWeekShorttermforecastFinalRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/managementunits/{managementUnitId}/weeks/{weekDateId}/shorttermforecasts/{forecastId}/final")
	...
	public static class Builder {
		private final GetWorkforcemanagementManagementunitWeekShorttermforecastFinalRequest request;

		private Builder() {
			request = new GetWorkforcemanagementManagementunitWeekShorttermforecastFinalRequest();
		}
		...
		public GetWorkforcemanagementManagementunitWeekShorttermforecastFinalRequest build() {
