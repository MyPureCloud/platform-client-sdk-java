...
public class GetIntegrationsActionDraftValidationRequest {
	...
	public GetIntegrationsActionDraftValidationRequest withActionId(String actionId) {
    ...
    public GetIntegrationsActionDraftValidationRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.actionId == null) {
            throw new IllegalStateException("Missing the required parameter 'actionId' when building request for GetIntegrationsActionDraftValidationRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/integrations/actions/{actionId}/draft/validation")
	...
	public static class Builder {
		private final GetIntegrationsActionDraftValidationRequest request;

		private Builder() {
			request = new GetIntegrationsActionDraftValidationRequest();
		}
		...
		public GetIntegrationsActionDraftValidationRequest build() {
