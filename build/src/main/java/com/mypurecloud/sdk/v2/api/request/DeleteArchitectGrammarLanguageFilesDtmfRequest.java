...
public class DeleteArchitectGrammarLanguageFilesDtmfRequest {
	...
	public DeleteArchitectGrammarLanguageFilesDtmfRequest withGrammarId(String grammarId) {
	...
	public DeleteArchitectGrammarLanguageFilesDtmfRequest withLanguageCode(String languageCode) {
    ...
    public DeleteArchitectGrammarLanguageFilesDtmfRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.grammarId == null) {
            throw new IllegalStateException("Missing the required parameter 'grammarId' when building request for DeleteArchitectGrammarLanguageFilesDtmfRequest.");
        }
        
        // verify the required parameter 'languageCode' is set
        if (this.languageCode == null) {
            throw new IllegalStateException("Missing the required parameter 'languageCode' when building request for DeleteArchitectGrammarLanguageFilesDtmfRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/architect/grammars/{grammarId}/languages/{languageCode}/files/dtmf")
	...
	public static class Builder {
		private final DeleteArchitectGrammarLanguageFilesDtmfRequest request;

		private Builder() {
			request = new DeleteArchitectGrammarLanguageFilesDtmfRequest();
		}
		...
		public DeleteArchitectGrammarLanguageFilesDtmfRequest build() {
