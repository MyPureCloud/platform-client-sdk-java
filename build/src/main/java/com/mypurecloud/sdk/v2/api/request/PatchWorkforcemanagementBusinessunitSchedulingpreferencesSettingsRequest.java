...
public class PatchWorkforcemanagementBusinessunitSchedulingpreferencesSettingsRequest {
	...
	public PatchWorkforcemanagementBusinessunitSchedulingpreferencesSettingsRequest withBusinessUnitId(String businessUnitId) {
	    this.setBusinessUnitId(businessUnitId);
	    return this;
	} 

	private UpdateBusinessUnitSchedulingPreferencesSettingsRequest body;
	public UpdateBusinessUnitSchedulingPreferencesSettingsRequest getBody() {
		return this.body;
	}

	public void setBody(UpdateBusinessUnitSchedulingPreferencesSettingsRequest body) {
		this.body = body;
	}

	public PatchWorkforcemanagementBusinessunitSchedulingpreferencesSettingsRequest withBody(UpdateBusinessUnitSchedulingPreferencesSettingsRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchWorkforcemanagementBusinessunitSchedulingpreferencesSettingsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<UpdateBusinessUnitSchedulingPreferencesSettingsRequest> withHttpInfo() {
        
        // verify the required parameter 'businessUnitId' is set
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PatchWorkforcemanagementBusinessunitSchedulingpreferencesSettingsRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchWorkforcemanagementBusinessunitSchedulingpreferencesSettingsRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/schedulingpreferences/settings")
	...
	public static Builder builder(String businessUnitId, UpdateBusinessUnitSchedulingPreferencesSettingsRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PatchWorkforcemanagementBusinessunitSchedulingpreferencesSettingsRequest request;

		private Builder() {
			request = new PatchWorkforcemanagementBusinessunitSchedulingpreferencesSettingsRequest();
		}
		...
		public Builder withBody(UpdateBusinessUnitSchedulingPreferencesSettingsRequest body) {
		...
		public Builder withRequiredParams(String businessUnitId, UpdateBusinessUnitSchedulingPreferencesSettingsRequest body) {
			request.setBusinessUnitId(businessUnitId);
			request.setBody(body);
		...
		public PatchWorkforcemanagementBusinessunitSchedulingpreferencesSettingsRequest build() {
