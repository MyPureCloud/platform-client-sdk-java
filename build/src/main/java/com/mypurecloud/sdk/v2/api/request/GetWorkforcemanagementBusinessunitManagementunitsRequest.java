...
public class GetWorkforcemanagementBusinessunitManagementunitsRequest {
	...
	public GetWorkforcemanagementBusinessunitManagementunitsRequest withBusinessUnitId(String businessUnitId) {
	...
	public GetWorkforcemanagementBusinessunitManagementunitsRequest withFeature(String feature) {
	...
	public enum featureValues { 
		...
		AGENTSELFSCHEDULEJOB("AgentSelfScheduleJob"),
		AGENTSELFSCHEDULEOFFERS("AgentSelfScheduleOffers"),
		AGENTSELFSCHEDULEQUERY("AgentSelfScheduleQuery"),
		AGENTSELFSCHEDULEACTIVITYMOVE("AgentSelfScheduleActivityMove"),
		SELFSCHEDULESETTINGS("SelfScheduleSettings"),
		AGENTSELFSCHEDULESETTINGS("AgentSelfScheduleSettings"),
		...
		ADHERENCEADJUSTMENTSREASONCODES("AdherenceAdjustmentsReasonCodes"),
		ADHERENCEADJUSTMENTS("AdherenceAdjustments"),
	...
	public GetWorkforcemanagementBusinessunitManagementunitsRequest withDivisionId(String divisionId) {
    ...
    public GetWorkforcemanagementBusinessunitManagementunitsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for GetWorkforcemanagementBusinessunitManagementunitsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/managementunits")
	...
	public static class Builder {
		private final GetWorkforcemanagementBusinessunitManagementunitsRequest request;

		private Builder() {
			request = new GetWorkforcemanagementBusinessunitManagementunitsRequest();
		}
		...
		public GetWorkforcemanagementBusinessunitManagementunitsRequest build() {
