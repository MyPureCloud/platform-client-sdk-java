...
public class FacebookIntegrationUpdateRequest  implements Serializable {
  ...
  public FacebookIntegrationUpdateRequest() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
    }
  }

  public FacebookIntegrationUpdateRequest(Boolean initWithEmptyList) {
   ...
   **/
  public FacebookIntegrationUpdateRequest supportedContent(SupportedContentReference supportedContent) {
   ...
   **/
  public FacebookIntegrationUpdateRequest messagingSetting(MessagingSettingRequestReference messagingSetting) {
