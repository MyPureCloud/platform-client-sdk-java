...
public class GetSpeechandtextanalyticsProgramSettingsInsightsRequest {
	...
	public GetSpeechandtextanalyticsProgramSettingsInsightsRequest withProgramId(String programId) {
    ...
    public GetSpeechandtextanalyticsProgramSettingsInsightsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.programId == null) {
            throw new IllegalStateException("Missing the required parameter 'programId' when building request for GetSpeechandtextanalyticsProgramSettingsInsightsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/speechandtextanalytics/programs/{programId}/settings/insights")
	...
	public static class Builder {
		private final GetSpeechandtextanalyticsProgramSettingsInsightsRequest request;

		private Builder() {
			request = new GetSpeechandtextanalyticsProgramSettingsInsightsRequest();
		}
		...
		public GetSpeechandtextanalyticsProgramSettingsInsightsRequest build() {
