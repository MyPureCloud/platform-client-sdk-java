...
public class GetConfigurationSchemasEdgesVnextSchemaCategorySchemaTypeSchemaIdRequest {
    ...
    public ApiRequest<Void> withHttpInfo() throws ApiException {
        ...
        if (this.schemaCategory == null) {
            throw new ApiException(400, "Missing the required parameter 'schemaCategory' when building request for GetConfigurationSchemasEdgesVnextSchemaCategorySchemaTypeSchemaIdRequest.");
        }
        
        // verify the required parameter 'schemaType' is set
        if (this.schemaType == null) {
            throw new ApiException(400, "Missing the required parameter 'schemaType' when building request for GetConfigurationSchemasEdgesVnextSchemaCategorySchemaTypeSchemaIdRequest.");
        }
        
        // verify the required parameter 'schemaId' is set
        if (this.schemaId == null) {
            throw new ApiException(400, "Missing the required parameter 'schemaId' when building request for GetConfigurationSchemasEdgesVnextSchemaCategorySchemaTypeSchemaIdRequest.");
        }
