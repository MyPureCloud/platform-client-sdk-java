...
public class GetOutboundContactlistContactsBulkJobRequest {
	...
	public GetOutboundContactlistContactsBulkJobRequest withContactListId(String contactListId) {
	...
	public GetOutboundContactlistContactsBulkJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetOutboundContactlistContactsBulkJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.contactListId == null) {
            throw new IllegalStateException("Missing the required parameter 'contactListId' when building request for GetOutboundContactlistContactsBulkJobRequest.");
        }
        
        // verify the required parameter 'jobId' is set
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetOutboundContactlistContactsBulkJobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/outbound/contactlists/{contactListId}/contacts/bulk/jobs/{jobId}")
	...
	public static Builder builder(String contactListId, String jobId) {
	    return new Builder()
	            .withRequiredParams(contactListId, jobId);
	}


	public static class Builder {
		private final GetOutboundContactlistContactsBulkJobRequest request;

		private Builder() {
			request = new GetOutboundContactlistContactsBulkJobRequest();
		}
		...
		public Builder withRequiredParams(String contactListId, String jobId) {
			request.setContactListId(contactListId);
			request.setJobId(jobId);
		...
		public GetOutboundContactlistContactsBulkJobRequest build() {
