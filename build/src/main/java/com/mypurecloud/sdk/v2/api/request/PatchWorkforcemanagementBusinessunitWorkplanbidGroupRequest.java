...
public class PatchWorkforcemanagementBusinessunitWorkplanbidGroupRequest {
	...
	public PatchWorkforcemanagementBusinessunitWorkplanbidGroupRequest withBidId(String bidId) {
	    this.setBidId(bidId);
	    return this;
	} 
	...
	private WorkPlanBidGroupUpdate body;
	public WorkPlanBidGroupUpdate getBody() {
		return this.body;
	}

	public void setBody(WorkPlanBidGroupUpdate body) {
		this.body = body;
	}
    ...
    public ApiRequest<WorkPlanBidGroupUpdate> withHttpInfo() {
        
        // verify the required parameter 'businessUnitId' is set
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PatchWorkforcemanagementBusinessunitWorkplanbidGroupRequest.");
        }
        
        // verify the required parameter 'bidId' is set
        if (this.bidId == null) {
            throw new IllegalStateException("Missing the required parameter 'bidId' when building request for PatchWorkforcemanagementBusinessunitWorkplanbidGroupRequest.");
        }
	...
	public static class Builder {
		private final PatchWorkforcemanagementBusinessunitWorkplanbidGroupRequest request;

		private Builder() {
			request = new PatchWorkforcemanagementBusinessunitWorkplanbidGroupRequest();
		}
		...
		public Builder withBody(WorkPlanBidGroupUpdate body) {
		...
		public PatchWorkforcemanagementBusinessunitWorkplanbidGroupRequest build() {
