...
public class PostRecordingCrossplatformMediaretentionpoliciesRequest {
    
	private CrossPlatformPolicyCreate body;
	public CrossPlatformPolicyCreate getBody() {
		return this.body;
	}

	public void setBody(CrossPlatformPolicyCreate body) {
		this.body = body;
	}

	public PostRecordingCrossplatformMediaretentionpoliciesRequest withBody(CrossPlatformPolicyCreate body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostRecordingCrossplatformMediaretentionpoliciesRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<CrossPlatformPolicyCreate> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostRecordingCrossplatformMediaretentionpoliciesRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/recording/crossplatform/mediaretentionpolicies")
                .withBody(body)
	...
	public static Builder builder(CrossPlatformPolicyCreate body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostRecordingCrossplatformMediaretentionpoliciesRequest request;

		private Builder() {
			request = new PostRecordingCrossplatformMediaretentionpoliciesRequest();
		}

		
		public Builder withBody(CrossPlatformPolicyCreate body) {
		...
		public Builder withRequiredParams(CrossPlatformPolicyCreate body) {
			request.setBody(body);
		...
		public PostRecordingCrossplatformMediaretentionpoliciesRequest build() {
