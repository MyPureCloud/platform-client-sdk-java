...
public class PostWorkforcemanagementBusinessunitCapacityplanCopyRequest {
	...
	public PostWorkforcemanagementBusinessunitCapacityplanCopyRequest withBusinessUnitId(String businessUnitId) {
	...
	public PostWorkforcemanagementBusinessunitCapacityplanCopyRequest withCapacityPlanId(String capacityPlanId) {
	    this.setCapacityPlanId(capacityPlanId);
	    return this;
	} 

	private CopyCapacityPlanRequest body;
	public CopyCapacityPlanRequest getBody() {
		return this.body;
	}

	public void setBody(CopyCapacityPlanRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementBusinessunitCapacityplanCopyRequest withBody(CopyCapacityPlanRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementBusinessunitCapacityplanCopyRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<CopyCapacityPlanRequest> withHttpInfo() {
        
        // verify the required parameter 'businessUnitId' is set
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PostWorkforcemanagementBusinessunitCapacityplanCopyRequest.");
        }
        
        // verify the required parameter 'capacityPlanId' is set
        if (this.capacityPlanId == null) {
            throw new IllegalStateException("Missing the required parameter 'capacityPlanId' when building request for PostWorkforcemanagementBusinessunitCapacityplanCopyRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementBusinessunitCapacityplanCopyRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/capacityplans/{capacityPlanId}/copy")
	...
	public static Builder builder(String businessUnitId, String capacityPlanId, CopyCapacityPlanRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementBusinessunitCapacityplanCopyRequest request;

		private Builder() {
			request = new PostWorkforcemanagementBusinessunitCapacityplanCopyRequest();
		}
		...
		public Builder withBody(CopyCapacityPlanRequest body) {
		...
		public Builder withRequiredParams(String businessUnitId, String capacityPlanId, CopyCapacityPlanRequest body) {
			request.setBusinessUnitId(businessUnitId);
			request.setCapacityPlanId(capacityPlanId);
			request.setBody(body);
		...
		public PostWorkforcemanagementBusinessunitCapacityplanCopyRequest build() {
