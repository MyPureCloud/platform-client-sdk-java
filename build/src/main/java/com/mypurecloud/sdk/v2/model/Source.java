...
public class Source  implements Serializable {
 ...
 @JsonDeserialize(using = TypeEnumDeserializer.class)
  ...
  @ApiModelProperty(example = "null", value = "The description of the source")
  ...
  @ApiModelProperty(example = "null", value = "The type of source")
  @JsonProperty("type")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, source.id) &&
            ...
            Objects.equals(this.deactivated, source.deactivated) &&
            Objects.equals(this.selfUri, source.selfUri);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, description, type, deactivated, selfUri);
  }
