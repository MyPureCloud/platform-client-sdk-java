...
public class GetOutboundContactlistfiltersRequest {
	...
	public GetOutboundContactlistfiltersRequest withPageSize(Integer pageSize) {
	...
	public GetOutboundContactlistfiltersRequest withPageNumber(Integer pageNumber) {
	...
	public GetOutboundContactlistfiltersRequest withAllowEmptyResult(Boolean allowEmptyResult) {
	...
	public GetOutboundContactlistfiltersRequest withFilterType(String filterType) {
	...
	public GetOutboundContactlistfiltersRequest withName(String name) {
	    this.setName(name);
	    return this;
	} 
	...
	public GetOutboundContactlistfiltersRequest withSortBy(String sortBy) {
	...
	public GetOutboundContactlistfiltersRequest withSortOrder(String sortOrder) {
	...
	public GetOutboundContactlistfiltersRequest withContactListId(String contactListId) {
    ...
    public GetOutboundContactlistfiltersRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/outbound/contactlistfilters")
