...
import com.mypurecloud.sdk.v2.model.BotVersionSummary;
...
public class BotConnectorBotVersionSummaryEntityListing  implements Serializable, PagedResource<BotVersionSummary> {
  
  private List<BotVersionSummary> entities = null;
  ...
  public BotConnectorBotVersionSummaryEntityListing() {
  ...
  /**
   **/
  public BotConnectorBotVersionSummaryEntityListing entities(List<BotVersionSummary> entities) {
  ...
  public List<BotVersionSummary> getEntities() {
    return entities;
  }
  public void setEntities(List<BotVersionSummary> entities) {
    this.entities = entities;
  }
