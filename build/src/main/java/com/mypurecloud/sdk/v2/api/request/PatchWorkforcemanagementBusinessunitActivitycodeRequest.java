...
public class PatchWorkforcemanagementBusinessunitActivitycodeRequest {
	...
	public PatchWorkforcemanagementBusinessunitActivitycodeRequest withBody(UpdateActivityCodeRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchWorkforcemanagementBusinessunitActivitycodeRequest withCustomHeader(String name, String value) {
	...
	public static class Builder {
		...
		private Builder() {
			request = new PatchWorkforcemanagementBusinessunitActivitycodeRequest();
		}
