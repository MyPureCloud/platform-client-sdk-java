...
public class PatchConversationRecordingstateRequest {
	...
	public PatchConversationRecordingstateRequest withConversationId(String conversationId) {
	...
	public PatchConversationRecordingstateRequest withBody(SetRecordingState body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchConversationRecordingstateRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<SetRecordingState> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PatchConversationRecordingstateRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchConversationRecordingstateRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/conversations/{conversationId}/recordingstate")
	...
	public static class Builder {
		private final PatchConversationRecordingstateRequest request;

		private Builder() {
			request = new PatchConversationRecordingstateRequest();
		}
		...
		public PatchConversationRecordingstateRequest build() {
