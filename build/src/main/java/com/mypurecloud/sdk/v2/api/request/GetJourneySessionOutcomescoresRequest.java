...
public class GetJourneySessionOutcomescoresRequest {
	...
	public GetJourneySessionOutcomescoresRequest withSessionId(String sessionId) {
    ...
    public GetJourneySessionOutcomescoresRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.sessionId == null) {
            throw new IllegalStateException("Missing the required parameter 'sessionId' when building request for GetJourneySessionOutcomescoresRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/journey/sessions/{sessionId}/outcomescores")
	...
	public static class Builder {
		private final GetJourneySessionOutcomescoresRequest request;

		private Builder() {
			request = new GetJourneySessionOutcomescoresRequest();
		}
		...
		public GetJourneySessionOutcomescoresRequest build() {
