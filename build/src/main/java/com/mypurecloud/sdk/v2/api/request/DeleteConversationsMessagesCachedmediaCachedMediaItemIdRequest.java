...
public class DeleteConversationsMessagesCachedmediaCachedMediaItemIdRequest {

	private String cachedMediaItemId;
	public String getCachedMediaItemId() {
		return this.cachedMediaItemId;
	}

	public void setCachedMediaItemId(String cachedMediaItemId) {
		this.cachedMediaItemId = cachedMediaItemId;
	}

	public DeleteConversationsMessagesCachedmediaCachedMediaItemIdRequest withCachedMediaItemId(String cachedMediaItemId) {
	    this.setCachedMediaItemId(cachedMediaItemId);
	    return this;
	} 
    ...
    public DeleteConversationsMessagesCachedmediaCachedMediaItemIdRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.cachedMediaItemId == null) {
            throw new IllegalStateException("Missing the required parameter 'cachedMediaItemId' when building request for DeleteConversationsMessagesCachedmediaCachedMediaItemIdRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/conversations/messages/cachedmedia/{cachedMediaItemId}")
                .withPathParameter("cachedMediaItemId", cachedMediaItemId)
	...
	public static Builder builder(String cachedMediaItemId) {
	    return new Builder()
	            .withRequiredParams(cachedMediaItemId);
	}


	public static class Builder {
		private final DeleteConversationsMessagesCachedmediaCachedMediaItemIdRequest request;

		private Builder() {
			request = new DeleteConversationsMessagesCachedmediaCachedMediaItemIdRequest();
		}


		public Builder withCachedMediaItemId(String cachedMediaItemId) {
			request.setCachedMediaItemId(cachedMediaItemId);
			return this;
		}



		public Builder withRequiredParams(String cachedMediaItemId) {
			request.setCachedMediaItemId(cachedMediaItemId);
		...
		public DeleteConversationsMessagesCachedmediaCachedMediaItemIdRequest build() {
            
            // verify the required parameter 'cachedMediaItemId' is set
            if (request.cachedMediaItemId == null) {
                throw new IllegalStateException("Missing the required parameter 'cachedMediaItemId' when building request for DeleteConversationsMessagesCachedmediaCachedMediaItemIdRequest.");
            }
