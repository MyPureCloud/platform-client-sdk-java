...
public class GetAuthorizationPolicyAttributesRequest {
	...
	public GetAuthorizationPolicyAttributesRequest withPolicyId(String policyId) {
    ...
    public GetAuthorizationPolicyAttributesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.policyId == null) {
            throw new IllegalStateException("Missing the required parameter 'policyId' when building request for GetAuthorizationPolicyAttributesRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/authorization/policies/{policyId}/attributes")
	...
	public static class Builder {
		private final GetAuthorizationPolicyAttributesRequest request;

		private Builder() {
			request = new GetAuthorizationPolicyAttributesRequest();
		}
		...
		public GetAuthorizationPolicyAttributesRequest build() {
