...
public class DeleteAssistantsAgentchecklistRequest {
	...
	public DeleteAssistantsAgentchecklistRequest withAgentChecklistId(String agentChecklistId) {
    ...
    public DeleteAssistantsAgentchecklistRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.agentChecklistId == null) {
            throw new IllegalStateException("Missing the required parameter 'agentChecklistId' when building request for DeleteAssistantsAgentchecklistRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/assistants/agentchecklists/{agentChecklistId}")
	...
	public static class Builder {
		private final DeleteAssistantsAgentchecklistRequest request;

		private Builder() {
			request = new DeleteAssistantsAgentchecklistRequest();
		}
		...
		public DeleteAssistantsAgentchecklistRequest build() {
