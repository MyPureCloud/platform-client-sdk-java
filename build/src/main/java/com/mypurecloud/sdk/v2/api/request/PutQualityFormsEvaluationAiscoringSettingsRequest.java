...
public class PutQualityFormsEvaluationAiscoringSettingsRequest {
    ...
    public ApiRequest<AiScoringSettings> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("PUT", "/api/v2/quality/forms/evaluations/{formId}/aiscoring/settings")
	...
	public static class Builder {
		private final PutQualityFormsEvaluationAiscoringSettingsRequest request;

		private Builder() {
			request = new PutQualityFormsEvaluationAiscoringSettingsRequest();
		}
