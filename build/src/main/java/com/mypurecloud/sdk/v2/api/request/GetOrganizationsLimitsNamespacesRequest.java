...
public class GetOrganizationsLimitsNamespacesRequest {
	...
	public GetOrganizationsLimitsNamespacesRequest withPageSize(Integer pageSize) {
	...
	public GetOrganizationsLimitsNamespacesRequest withPageNumber(Integer pageNumber) {
    ...
    public GetOrganizationsLimitsNamespacesRequest withCustomHeader(String name, String value) {
