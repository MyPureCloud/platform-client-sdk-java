...
public class GetVoicemailMeMessagesRequest {
	...
	public GetVoicemailMeMessagesRequest withPageSize(Integer pageSize) {
	...
	public GetVoicemailMeMessagesRequest withPageNumber(Integer pageNumber) {
    ...
    public GetVoicemailMeMessagesRequest withCustomHeader(String name, String value) {
	...
	public static class Builder {
		private final GetVoicemailMeMessagesRequest request;

		private Builder() {
			request = new GetVoicemailMeMessagesRequest();
		}
		...
		public GetVoicemailMeMessagesRequest build() {
