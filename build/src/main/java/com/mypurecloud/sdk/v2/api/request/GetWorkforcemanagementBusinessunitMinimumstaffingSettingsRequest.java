...
public class GetWorkforcemanagementBusinessunitMinimumstaffingSettingsRequest {
	...
	public GetWorkforcemanagementBusinessunitMinimumstaffingSettingsRequest withBusinessUnitId(String businessUnitId) {
    ...
    public GetWorkforcemanagementBusinessunitMinimumstaffingSettingsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for GetWorkforcemanagementBusinessunitMinimumstaffingSettingsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/minimumstaffing/settings")
	...
	public static class Builder {
		private final GetWorkforcemanagementBusinessunitMinimumstaffingSettingsRequest request;

		private Builder() {
			request = new GetWorkforcemanagementBusinessunitMinimumstaffingSettingsRequest();
		}
		...
		public GetWorkforcemanagementBusinessunitMinimumstaffingSettingsRequest build() {
