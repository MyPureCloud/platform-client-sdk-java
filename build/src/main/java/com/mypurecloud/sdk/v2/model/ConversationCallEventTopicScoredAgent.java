...
public class ConversationCallEventTopicScoredAgent  implements Serializable {
  ...
  public ConversationCallEventTopicScoredAgent() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
    }
  }

  public ConversationCallEventTopicScoredAgent(Boolean initWithEmptyList) {
   ...
   **/
  public ConversationCallEventTopicScoredAgent score(Long score) {
    this.score = score;
    return this;
  }
