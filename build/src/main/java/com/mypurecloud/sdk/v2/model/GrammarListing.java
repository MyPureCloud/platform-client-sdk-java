...
public class GrammarListing  implements Serializable, PagedResource<Grammar> {
  
  private List<Grammar> entities = null;
  ...
  /**
   **/
  public GrammarListing entities(List<Grammar> entities) {
  ...
  public List<Grammar> getEntities() {
    return entities;
  }
  public void setEntities(List<Grammar> entities) {
    this.entities = entities;
  }
  ...
  /**
   **/
  public GrammarListing pageSize(Integer pageSize) {
  ...
  /**
   **/
  public GrammarListing pageNumber(Integer pageNumber) {
  ...
  /**
   **/
  public GrammarListing total(Long total) {
    this.total = total;
    return this;
  }
  ...
  /**
   **/
  public GrammarListing nextUri(String nextUri) {
  ...
  /**
   **/
  public GrammarListing previousUri(String previousUri) {
  ...
  /**
   **/
  public GrammarListing selfUri(String selfUri) {
  ...
  /**
   **/
  public GrammarListing pageCount(Integer pageCount) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    GrammarListing grammarListing = (GrammarListing) o;

    return Objects.equals(this.entities, grammarListing.entities) &&
