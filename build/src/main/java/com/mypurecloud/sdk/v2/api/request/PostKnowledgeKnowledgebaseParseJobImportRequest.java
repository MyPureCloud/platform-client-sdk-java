...
public class PostKnowledgeKnowledgebaseParseJobImportRequest {
	...
	public PostKnowledgeKnowledgebaseParseJobImportRequest withKnowledgeBaseId(String knowledgeBaseId) {
	...
	public PostKnowledgeKnowledgebaseParseJobImportRequest withParseJobId(String parseJobId) {
	    this.setParseJobId(parseJobId);
	    return this;
	} 

	private KnowledgeParseJobRequestImport body;
	public KnowledgeParseJobRequestImport getBody() {
		return this.body;
	}

	public void setBody(KnowledgeParseJobRequestImport body) {
		this.body = body;
	}

	public PostKnowledgeKnowledgebaseParseJobImportRequest withBody(KnowledgeParseJobRequestImport body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostKnowledgeKnowledgebaseParseJobImportRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<KnowledgeParseJobRequestImport> withHttpInfo() {
        
        // verify the required parameter 'knowledgeBaseId' is set
        if (this.knowledgeBaseId == null) {
            throw new IllegalStateException("Missing the required parameter 'knowledgeBaseId' when building request for PostKnowledgeKnowledgebaseParseJobImportRequest.");
        }
        
        // verify the required parameter 'parseJobId' is set
        if (this.parseJobId == null) {
            throw new IllegalStateException("Missing the required parameter 'parseJobId' when building request for PostKnowledgeKnowledgebaseParseJobImportRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostKnowledgeKnowledgebaseParseJobImportRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/parse/jobs/{parseJobId}/import")
                .withPathParameter("knowledgeBaseId", knowledgeBaseId)
        
                .withPathParameter("parseJobId", parseJobId)
	...
	public static Builder builder(String knowledgeBaseId, String parseJobId, KnowledgeParseJobRequestImport body) {
	    return new Builder()
	            .withRequiredParams(knowledgeBaseId, parseJobId, body);
	}


	public static class Builder {
		private final PostKnowledgeKnowledgebaseParseJobImportRequest request;

		private Builder() {
			request = new PostKnowledgeKnowledgebaseParseJobImportRequest();
		}
		...
		public Builder withParseJobId(String parseJobId) {
			request.setParseJobId(parseJobId);
			return this;
		}

		public Builder withBody(KnowledgeParseJobRequestImport body) {
		...
		public Builder withRequiredParams(String knowledgeBaseId, String parseJobId, KnowledgeParseJobRequestImport body) {
			request.setKnowledgeBaseId(knowledgeBaseId);
			request.setParseJobId(parseJobId);
			request.setBody(body);
		...
		public PostKnowledgeKnowledgebaseParseJobImportRequest build() {
