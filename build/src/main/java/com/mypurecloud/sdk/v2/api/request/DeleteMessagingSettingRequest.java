...
public class DeleteMessagingSettingRequest {
	...
	public DeleteMessagingSettingRequest withMessageSettingId(String messageSettingId) {
    ...
    public DeleteMessagingSettingRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.messageSettingId == null) {
            throw new IllegalStateException("Missing the required parameter 'messageSettingId' when building request for DeleteMessagingSettingRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/messaging/settings/{messageSettingId}")
	...
	public static class Builder {
		private final DeleteMessagingSettingRequest request;

		private Builder() {
			request = new DeleteMessagingSettingRequest();
		}
		...
		public DeleteMessagingSettingRequest build() {
