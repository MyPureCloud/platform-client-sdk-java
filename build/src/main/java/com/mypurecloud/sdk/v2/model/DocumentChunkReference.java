...
public class DocumentChunkReference  implements Serializable {
   ...
   **/
  public DocumentChunkReference id(String id) {
    this.id = id;
    return this;
  }
   ...
   **/
  public DocumentChunkReference title(String title) {
    this.title = title;
    return this;
  }
  
  @ApiModelProperty(example = "null", value = "The title of the document.")
  @JsonProperty("title")
