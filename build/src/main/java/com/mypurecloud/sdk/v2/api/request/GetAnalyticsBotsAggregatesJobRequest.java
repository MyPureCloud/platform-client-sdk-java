...
public class GetAnalyticsBotsAggregatesJobRequest {
	...
	public GetAnalyticsBotsAggregatesJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetAnalyticsBotsAggregatesJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetAnalyticsBotsAggregatesJobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/analytics/bots/aggregates/jobs/{jobId}")
	...
	public static class Builder {
		private final GetAnalyticsBotsAggregatesJobRequest request;

		private Builder() {
			request = new GetAnalyticsBotsAggregatesJobRequest();
		}
		...
		public GetAnalyticsBotsAggregatesJobRequest build() {
