...
public class GetRoutingSettingsRequest {
    ...
    public GetRoutingSettingsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/routing/settings")
	...
	public static class Builder {
		private final GetRoutingSettingsRequest request;

		private Builder() {
			request = new GetRoutingSettingsRequest();
		}
		...
		public GetRoutingSettingsRequest build() {
