...
public class GetConversationsCustomattributesSchemaVersionRequest {
	...
	public GetConversationsCustomattributesSchemaVersionRequest withSchemaId(String schemaId) {
	...
	public GetConversationsCustomattributesSchemaVersionRequest withVersionId(String versionId) {
    ...
    public GetConversationsCustomattributesSchemaVersionRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.schemaId == null) {
            throw new IllegalStateException("Missing the required parameter 'schemaId' when building request for GetConversationsCustomattributesSchemaVersionRequest.");
        }
        
        // verify the required parameter 'versionId' is set
        if (this.versionId == null) {
            throw new IllegalStateException("Missing the required parameter 'versionId' when building request for GetConversationsCustomattributesSchemaVersionRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/conversations/customattributes/schemas/{schemaId}/versions/{versionId}")
	...
	public static class Builder {
		private final GetConversationsCustomattributesSchemaVersionRequest request;

		private Builder() {
			request = new GetConversationsCustomattributesSchemaVersionRequest();
		}
		...
		public GetConversationsCustomattributesSchemaVersionRequest build() {
