...
public class GetFlowsDatatableImportJobRequest {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/flows/datatables/{datatableId}/import/jobs/{importJobId}")
	...
	public static Builder builder(String datatableId, String importJobId) {
	    return new Builder()
	            .withRequiredParams(datatableId, importJobId);
	}
	

	public static class Builder {
		private final GetFlowsDatatableImportJobRequest request;

		private Builder() {
			request = new GetFlowsDatatableImportJobRequest();
		}
