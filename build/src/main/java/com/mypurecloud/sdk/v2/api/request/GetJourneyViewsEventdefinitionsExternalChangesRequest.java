...
public class GetJourneyViewsEventdefinitionsExternalChangesRequest {
    ...
    public GetJourneyViewsEventdefinitionsExternalChangesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/journey/views/eventdefinitions/external/changes")
	...
	public static class Builder {
		private final GetJourneyViewsEventdefinitionsExternalChangesRequest request;

		private Builder() {
			request = new GetJourneyViewsEventdefinitionsExternalChangesRequest();
		}
		...
		public GetJourneyViewsEventdefinitionsExternalChangesRequest build() {
