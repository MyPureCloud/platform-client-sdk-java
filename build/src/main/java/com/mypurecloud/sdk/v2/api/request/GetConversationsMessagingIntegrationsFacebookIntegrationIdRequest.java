...
public class GetConversationsMessagingIntegrationsFacebookIntegrationIdRequest {
	...
	public GetConversationsMessagingIntegrationsFacebookIntegrationIdRequest withIntegrationId(String integrationId) {
	...
	public GetConversationsMessagingIntegrationsFacebookIntegrationIdRequest withExpand(String expand) {
    ...
    public GetConversationsMessagingIntegrationsFacebookIntegrationIdRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.integrationId == null) {
            throw new IllegalStateException("Missing the required parameter 'integrationId' when building request for GetConversationsMessagingIntegrationsFacebookIntegrationIdRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/conversations/messaging/integrations/facebook/{integrationId}")
	...
	public static class Builder {
		private final GetConversationsMessagingIntegrationsFacebookIntegrationIdRequest request;

		private Builder() {
			request = new GetConversationsMessagingIntegrationsFacebookIntegrationIdRequest();
		}
		...
		public GetConversationsMessagingIntegrationsFacebookIntegrationIdRequest build() {
