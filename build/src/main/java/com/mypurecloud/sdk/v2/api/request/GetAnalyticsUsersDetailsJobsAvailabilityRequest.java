...
public class GetAnalyticsUsersDetailsJobsAvailabilityRequest {
    ...
    public GetAnalyticsUsersDetailsJobsAvailabilityRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/analytics/users/details/jobs/availability")
	...
	public static class Builder {
		private final GetAnalyticsUsersDetailsJobsAvailabilityRequest request;

		private Builder() {
			request = new GetAnalyticsUsersDetailsJobsAvailabilityRequest();
		}
		...
		public GetAnalyticsUsersDetailsJobsAvailabilityRequest build() {
