...
public class PatchExternalcontactsContactNoteRequest {
	...
	public PatchExternalcontactsContactNoteRequest withContactId(String contactId) {
	...
	public PatchExternalcontactsContactNoteRequest withNoteId(String noteId) {
	...
	public PatchExternalcontactsContactNoteRequest withBody(ExternalContactsPatchRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchExternalcontactsContactNoteRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<ExternalContactsPatchRequest> withHttpInfo() {
        ...
        if (this.contactId == null) {
            throw new IllegalStateException("Missing the required parameter 'contactId' when building request for PatchExternalcontactsContactNoteRequest.");
        }
        
        // verify the required parameter 'noteId' is set
        if (this.noteId == null) {
            throw new IllegalStateException("Missing the required parameter 'noteId' when building request for PatchExternalcontactsContactNoteRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchExternalcontactsContactNoteRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/externalcontacts/contacts/{contactId}/notes/{noteId}")
	...
	public static Builder builder(String contactId, String noteId, ExternalContactsPatchRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PatchExternalcontactsContactNoteRequest request;

		private Builder() {
			request = new PatchExternalcontactsContactNoteRequest();
		}
		...
		public Builder withRequiredParams(String contactId, String noteId, ExternalContactsPatchRequest body) {
			request.setContactId(contactId);
			request.setNoteId(noteId);
			request.setBody(body);
		...
		public PatchExternalcontactsContactNoteRequest build() {
