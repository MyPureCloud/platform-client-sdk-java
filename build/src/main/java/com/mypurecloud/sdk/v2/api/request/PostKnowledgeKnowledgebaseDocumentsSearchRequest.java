...
public class PostKnowledgeKnowledgebaseDocumentsSearchRequest {
	...
	public PostKnowledgeKnowledgebaseDocumentsSearchRequest withKnowledgeBaseId(String knowledgeBaseId) {
	...
	public PostKnowledgeKnowledgebaseDocumentsSearchRequest withExpand(List<String> expand) {
	...
	public enum expandValues { 
		...
		VARIATIONCHUNKS("variationChunks");
	...
	private KnowledgeDocumentSearchRequest body;
	public KnowledgeDocumentSearchRequest getBody() {
		return this.body;
	}

	public void setBody(KnowledgeDocumentSearchRequest body) {
		this.body = body;
	}

	public PostKnowledgeKnowledgebaseDocumentsSearchRequest withBody(KnowledgeDocumentSearchRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostKnowledgeKnowledgebaseDocumentsSearchRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<KnowledgeDocumentSearchRequest> withHttpInfo() {
        
        // verify the required parameter 'knowledgeBaseId' is set
        if (this.knowledgeBaseId == null) {
            throw new IllegalStateException("Missing the required parameter 'knowledgeBaseId' when building request for PostKnowledgeKnowledgebaseDocumentsSearchRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/documents/search")
	...
	public static class Builder {
		private final PostKnowledgeKnowledgebaseDocumentsSearchRequest request;

		private Builder() {
			request = new PostKnowledgeKnowledgebaseDocumentsSearchRequest();
		}
		...
		public Builder withBody(KnowledgeDocumentSearchRequest body) {
		...
		public PostKnowledgeKnowledgebaseDocumentsSearchRequest build() {
