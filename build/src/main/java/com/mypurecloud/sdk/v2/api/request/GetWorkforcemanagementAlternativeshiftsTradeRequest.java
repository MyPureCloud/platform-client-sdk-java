...
public class GetWorkforcemanagementAlternativeshiftsTradeRequest {
	...
	public GetWorkforcemanagementAlternativeshiftsTradeRequest withTradeId(String tradeId) {
    ...
    public GetWorkforcemanagementAlternativeshiftsTradeRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.tradeId == null) {
            throw new IllegalStateException("Missing the required parameter 'tradeId' when building request for GetWorkforcemanagementAlternativeshiftsTradeRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/alternativeshifts/trades/{tradeId}")
	...
	public static class Builder {
		private final GetWorkforcemanagementAlternativeshiftsTradeRequest request;

		private Builder() {
			request = new GetWorkforcemanagementAlternativeshiftsTradeRequest();
		}
		...
		public GetWorkforcemanagementAlternativeshiftsTradeRequest build() {
