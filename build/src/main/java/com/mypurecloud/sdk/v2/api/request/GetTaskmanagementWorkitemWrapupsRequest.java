...
public class GetTaskmanagementWorkitemWrapupsRequest {
	...
	public GetTaskmanagementWorkitemWrapupsRequest withWorkitemId(String workitemId) {
	...
	public GetTaskmanagementWorkitemWrapupsRequest withExpands(String expands) {
	...
	public GetTaskmanagementWorkitemWrapupsRequest withAfter(String after) {
	    this.setAfter(after);
	    return this;
	} 
	...
	public GetTaskmanagementWorkitemWrapupsRequest withPageSize(Integer pageSize) {
	...
	public GetTaskmanagementWorkitemWrapupsRequest withSortOrder(String sortOrder) {
    ...
    public GetTaskmanagementWorkitemWrapupsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.workitemId == null) {
            throw new IllegalStateException("Missing the required parameter 'workitemId' when building request for GetTaskmanagementWorkitemWrapupsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/taskmanagement/workitems/{workitemId}/wrapups")
	...
	public static class Builder {
		private final GetTaskmanagementWorkitemWrapupsRequest request;

		private Builder() {
			request = new GetTaskmanagementWorkitemWrapupsRequest();
		}
		...
		public GetTaskmanagementWorkitemWrapupsRequest build() {
