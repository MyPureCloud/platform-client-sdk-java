...
public class GetKnowledgeKnowledgebaseDocumentFeedbackFeedbackIdRequest {
	...
	public GetKnowledgeKnowledgebaseDocumentFeedbackFeedbackIdRequest withKnowledgeBaseId(String knowledgeBaseId) {
	...
	public GetKnowledgeKnowledgebaseDocumentFeedbackFeedbackIdRequest withDocumentId(String documentId) {
	...
	public GetKnowledgeKnowledgebaseDocumentFeedbackFeedbackIdRequest withFeedbackId(String feedbackId) {
    ...
    public GetKnowledgeKnowledgebaseDocumentFeedbackFeedbackIdRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.knowledgeBaseId == null) {
            throw new IllegalStateException("Missing the required parameter 'knowledgeBaseId' when building request for GetKnowledgeKnowledgebaseDocumentFeedbackFeedbackIdRequest.");
        }
        
        // verify the required parameter 'documentId' is set
        if (this.documentId == null) {
            throw new IllegalStateException("Missing the required parameter 'documentId' when building request for GetKnowledgeKnowledgebaseDocumentFeedbackFeedbackIdRequest.");
        }
        
        // verify the required parameter 'feedbackId' is set
        if (this.feedbackId == null) {
            throw new IllegalStateException("Missing the required parameter 'feedbackId' when building request for GetKnowledgeKnowledgebaseDocumentFeedbackFeedbackIdRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/documents/{documentId}/feedback/{feedbackId}")
	...
	public static class Builder {
		private final GetKnowledgeKnowledgebaseDocumentFeedbackFeedbackIdRequest request;

		private Builder() {
			request = new GetKnowledgeKnowledgebaseDocumentFeedbackFeedbackIdRequest();
		}
		...
		public GetKnowledgeKnowledgebaseDocumentFeedbackFeedbackIdRequest build() {
