...
public class PostSocialmediaTwitterHistoricalTweetsRequest {

	private TwitterDataHistoricalTweetRequest body;
	public TwitterDataHistoricalTweetRequest getBody() {
		return this.body;
	}

	public void setBody(TwitterDataHistoricalTweetRequest body) {
		this.body = body;
	}

	public PostSocialmediaTwitterHistoricalTweetsRequest withBody(TwitterDataHistoricalTweetRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostSocialmediaTwitterHistoricalTweetsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<TwitterDataHistoricalTweetRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostSocialmediaTwitterHistoricalTweetsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/socialmedia/twitter/historical/tweets")
                .withBody(body)
	...
	public static Builder builder(TwitterDataHistoricalTweetRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostSocialmediaTwitterHistoricalTweetsRequest request;

		private Builder() {
			request = new PostSocialmediaTwitterHistoricalTweetsRequest();
		}


		public Builder withBody(TwitterDataHistoricalTweetRequest body) {
		...
		public Builder withRequiredParams(TwitterDataHistoricalTweetRequest body) {
			request.setBody(body);
		...
		public PostSocialmediaTwitterHistoricalTweetsRequest build() {
