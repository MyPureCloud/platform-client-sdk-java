...
public class HistoricalImportStatusListing  implements Serializable {
  ...
  public HistoricalImportStatusListing() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
      entities = new ArrayList<HistoricalImportStatus>();
    }
  }

  public HistoricalImportStatusListing(Boolean initWithEmptyList) {
   ...
   **/
  public HistoricalImportStatusListing downloadUrl(String downloadUrl) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.entities, historicalImportStatusListing.entities) &&
            Objects.equals(this.downloadUrl, historicalImportStatusListing.downloadUrl);
  }
