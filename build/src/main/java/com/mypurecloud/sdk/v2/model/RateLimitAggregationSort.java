...
public class RateLimitAggregationSort  implements Serializable {
 ...
 @JsonDeserialize(using = FunctionEnumDeserializer.class)
  ...
  public RateLimitAggregationSort() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
    }
  }

  public RateLimitAggregationSort(Boolean initWithEmptyList) {
   ...
   * Name of the metric used for sorting values.
   **/
  public RateLimitAggregationSort name(NameEnum name) {
    this.name = name;
    return this;
  }
   ...
   * Aggregation function used for the sort metric.
   **/
  public RateLimitAggregationSort function(FunctionEnum function) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RateLimitAggregationSort rateLimitAggregationSort = (RateLimitAggregationSort) o;

    return Objects.equals(this.name, rateLimitAggregationSort.name) &&
            Objects.equals(this.function, rateLimitAggregationSort.function);
  }
