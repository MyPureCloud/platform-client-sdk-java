...
public class SkillGroupDefinition  implements Serializable {
   ...
   * The group name.
   **/
  public SkillGroupDefinition name(String name) {
    this.name = name;
    return this;
  }
   ...
   **/
  public SkillGroupDefinition division(WritableDivision division) {
   ...
   * Group description
   **/
  public SkillGroupDefinition description(String description) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SkillGroupDefinition skillGroupDefinition = (SkillGroupDefinition) o;

    return Objects.equals(this.id, skillGroupDefinition.id) &&
            Objects.equals(this.name, skillGroupDefinition.name) &&
            Objects.equals(this.division, skillGroupDefinition.division) &&
            Objects.equals(this.description, skillGroupDefinition.description) &&
            Objects.equals(this.memberCount, skillGroupDefinition.memberCount) &&
            Objects.equals(this.dateModified, skillGroupDefinition.dateModified) &&
            Objects.equals(this.dateCreated, skillGroupDefinition.dateCreated) &&
            Objects.equals(this.selfUri, skillGroupDefinition.selfUri);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, division, description, memberCount, dateModified, dateCreated, selfUri);
  }
