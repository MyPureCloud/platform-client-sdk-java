...
public class GetExternalcontactsOrganizationsSchemasLimitsRequest {
    ...
    public GetExternalcontactsOrganizationsSchemasLimitsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/externalcontacts/organizations/schemas/limits")
	...
	public static class Builder {
		private final GetExternalcontactsOrganizationsSchemasLimitsRequest request;

		private Builder() {
			request = new GetExternalcontactsOrganizationsSchemasLimitsRequest();
		}
		...
		public GetExternalcontactsOrganizationsSchemasLimitsRequest build() {
