...
public class BuScheduleNotificationsSettingsRequest  implements Serializable {
  
  private Integer earlyReminderMinutes = null;
  private List<BuScheduleNotificationsCategorySettings> activityCategorySettings = null;

  public BuScheduleNotificationsSettingsRequest() {
   ...
   **/
  public BuScheduleNotificationsSettingsRequest earlyReminderMinutes(Integer earlyReminderMinutes) {
    this.earlyReminderMinutes = earlyReminderMinutes;
    return this;
  }
  
  @ApiModelProperty(example = "null", value = "The number of minutes prior to the scheduled event to display an early reminder notification")
   ...
   **/
  public BuScheduleNotificationsSettingsRequest activityCategorySettings(List<BuScheduleNotificationsCategorySettings> activityCategorySettings) {
    this.activityCategorySettings = activityCategorySettings;
    return this;
  }
  
  @ApiModelProperty(example = "null", value = "List of activity category notification settings")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    BuScheduleNotificationsSettingsRequest buScheduleNotificationsSettingsRequest = (BuScheduleNotificationsSettingsRequest) o;

    return Objects.equals(this.earlyReminderMinutes, buScheduleNotificationsSettingsRequest.earlyReminderMinutes) &&
            Objects.equals(this.activityCategorySettings, buScheduleNotificationsSettingsRequest.activityCategorySettings);
  }
