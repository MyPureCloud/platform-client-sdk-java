...
public class LocationCreateDefinition  implements Serializable {
 ...
 @JsonDeserialize(using = StateEnumDeserializer.class)
  ...
  public LocationCreateDefinition(Boolean initWithEmptyList) {
   ...
   **/
  public LocationCreateDefinition name(String name) {
    this.name = name;
    return this;
  }
   ...
   **/
  public LocationCreateDefinition version(Integer version) {
   ...
   * Current activity status of the location.
   **/
  public LocationCreateDefinition state(StateEnum state) {
    this.state = state;
    return this;
  }
   ...
   **/
  public LocationCreateDefinition path(List<String> path) {
    this.path = path;
    return this;
  }
   ...
   **/
  public LocationCreateDefinition notes(String notes) {
    this.notes = notes;
    return this;
  }
   ...
   **/
  public LocationCreateDefinition contactUser(String contactUser) {
   ...
   **/
  public LocationCreateDefinition emergencyNumber(LocationEmergencyNumber emergencyNumber) {
   ...
   **/
  public LocationCreateDefinition address(LocationAddress address) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    LocationCreateDefinition locationCreateDefinition = (LocationCreateDefinition) o;

    return Objects.equals(this.name, locationCreateDefinition.name) &&
            Objects.equals(this.version, locationCreateDefinition.version) &&
            Objects.equals(this.state, locationCreateDefinition.state) &&
            Objects.equals(this.path, locationCreateDefinition.path) &&
            Objects.equals(this.notes, locationCreateDefinition.notes) &&
            Objects.equals(this.contactUser, locationCreateDefinition.contactUser) &&
            Objects.equals(this.emergencyNumber, locationCreateDefinition.emergencyNumber) &&
            Objects.equals(this.address, locationCreateDefinition.address);
  }
