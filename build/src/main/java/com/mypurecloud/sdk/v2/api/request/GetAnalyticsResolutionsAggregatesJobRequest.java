...
public class GetAnalyticsResolutionsAggregatesJobRequest {
	...
	public GetAnalyticsResolutionsAggregatesJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetAnalyticsResolutionsAggregatesJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetAnalyticsResolutionsAggregatesJobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/analytics/resolutions/aggregates/jobs/{jobId}")
	...
	public static class Builder {
		private final GetAnalyticsResolutionsAggregatesJobRequest request;

		private Builder() {
			request = new GetAnalyticsResolutionsAggregatesJobRequest();
		}
		...
		public GetAnalyticsResolutionsAggregatesJobRequest build() {
