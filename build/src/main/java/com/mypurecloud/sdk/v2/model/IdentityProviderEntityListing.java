...
public class IdentityProviderEntityListing  implements Serializable, PagedResource<SAMLProvider> {
  ...
  private List<SAMLProvider> entities = null;
  ...
  public IdentityProviderEntityListing() {
  ...
  /**
   **/
  public IdentityProviderEntityListing pageSize(Integer pageSize) {
  ...
  /**
   **/
  public IdentityProviderEntityListing pageNumber(Integer pageNumber) {
  ...
  /**
   **/
  public IdentityProviderEntityListing total(Long total) {
    this.total = total;
    return this;
  }
  ...
  /**
   **/
  public IdentityProviderEntityListing selfUri(String selfUri) {
  ...
  /**
   **/
  public IdentityProviderEntityListing nextUri(String nextUri) {
  ...
  /**
   **/
  public IdentityProviderEntityListing previousUri(String previousUri) {
  ...
  /**
   **/
  public IdentityProviderEntityListing pageCount(Integer pageCount) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    IdentityProviderEntityListing identityProviderEntityListing = (IdentityProviderEntityListing) o;

    return Objects.equals(this.entities, identityProviderEntityListing.entities) &&
            ...
            Objects.equals(this.pageCount, identityProviderEntityListing.pageCount);
  }
