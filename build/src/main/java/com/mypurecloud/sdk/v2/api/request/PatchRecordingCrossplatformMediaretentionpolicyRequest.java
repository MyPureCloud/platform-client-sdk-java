...
public class PatchRecordingCrossplatformMediaretentionpolicyRequest {
	...
	public PatchRecordingCrossplatformMediaretentionpolicyRequest withPolicyId(String policyId) {
    ...
    public PatchRecordingCrossplatformMediaretentionpolicyRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<CrossPlatformPolicyUpdate> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("PATCH", "/api/v2/recording/crossplatform/mediaretentionpolicies/{policyId}")
	...
	public static class Builder {
		...
		private Builder() {
			request = new PatchRecordingCrossplatformMediaretentionpolicyRequest();
		}
