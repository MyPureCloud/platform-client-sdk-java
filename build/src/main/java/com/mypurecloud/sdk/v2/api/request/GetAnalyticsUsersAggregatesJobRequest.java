...
public class GetAnalyticsUsersAggregatesJobRequest {
	...
	public GetAnalyticsUsersAggregatesJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetAnalyticsUsersAggregatesJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetAnalyticsUsersAggregatesJobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/analytics/users/aggregates/jobs/{jobId}")
	...
	public static class Builder {
		private final GetAnalyticsUsersAggregatesJobRequest request;

		private Builder() {
			request = new GetAnalyticsUsersAggregatesJobRequest();
		}
		...
		public GetAnalyticsUsersAggregatesJobRequest build() {
