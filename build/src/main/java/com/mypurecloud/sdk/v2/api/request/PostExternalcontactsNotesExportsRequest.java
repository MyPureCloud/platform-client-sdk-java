...
public class PostExternalcontactsNotesExportsRequest {

	private NotesExport body;
	public NotesExport getBody() {
		return this.body;
	}

	public void setBody(NotesExport body) {
		this.body = body;
	}

	public PostExternalcontactsNotesExportsRequest withBody(NotesExport body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostExternalcontactsNotesExportsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<NotesExport> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostExternalcontactsNotesExportsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/externalcontacts/notes/exports")
                .withBody(body)
	...
	public static Builder builder(NotesExport body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostExternalcontactsNotesExportsRequest request;

		private Builder() {
			request = new PostExternalcontactsNotesExportsRequest();
		}


		public Builder withBody(NotesExport body) {
		...
		public Builder withRequiredParams(NotesExport body) {
			request.setBody(body);
		...
		public PostExternalcontactsNotesExportsRequest build() {
