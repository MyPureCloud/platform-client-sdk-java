...
public class DeleteAnalyticsAgentutilizationsAggregatesJobRequest {
	...
	public DeleteAnalyticsAgentutilizationsAggregatesJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public DeleteAnalyticsAgentutilizationsAggregatesJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for DeleteAnalyticsAgentutilizationsAggregatesJobRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/analytics/agentutilizations/aggregates/jobs/{jobId}")
	...
	public static class Builder {
		private final DeleteAnalyticsAgentutilizationsAggregatesJobRequest request;

		private Builder() {
			request = new DeleteAnalyticsAgentutilizationsAggregatesJobRequest();
		}
		...
		public DeleteAnalyticsAgentutilizationsAggregatesJobRequest build() {
