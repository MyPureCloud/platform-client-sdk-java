...
public class Video  implements Serializable {
 ...
 @JsonDeserialize(using = DisconnectTypeEnumDeserializer.class)
   ...
   * The initial connection state of this communication.
   **/
  public Video initialState(InitialStateEnum initialState) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.state, video.state) &&
            Objects.equals(this.initialState, video.initialState) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(state, initialState, id, context, audioMuted, videoMuted, sharingScreen, peerCount, disconnectType, startAlertingTime, connectedTime, disconnectedTime, provider, peerId, msids, self, wrapup, afterCallWork, afterCallWorkRequired);
  }
