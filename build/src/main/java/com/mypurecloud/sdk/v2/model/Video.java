...
public class Video  implements Serializable {
 ...
 @JsonDeserialize(using = InitialStateEnumDeserializer.class)
  ...
  @Override
  public int hashCode() {
    return Objects.hash(state, id, context, audioMuted, videoMuted, sharingScreen, peerCount, disconnectType, startAlertingTime, connectedTime, disconnectedTime, provider, peerId, msids, self, wrapup, afterCallWork, afterCallWorkRequired, initialState);
  }
