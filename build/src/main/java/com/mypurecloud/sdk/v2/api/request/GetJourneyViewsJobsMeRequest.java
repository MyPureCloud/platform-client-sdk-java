...
public class GetJourneyViewsJobsMeRequest {
	...
	public GetJourneyViewsJobsMeRequest withPageNumber(Integer pageNumber) {
	...
	public GetJourneyViewsJobsMeRequest withPageSize(Integer pageSize) {
	...
	public GetJourneyViewsJobsMeRequest withInterval(String interval) {
	...
	public GetJourneyViewsJobsMeRequest withStatuses(String statuses) {
    ...
    public GetJourneyViewsJobsMeRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/journey/views/jobs/me")
	...
	public static class Builder {
		private final GetJourneyViewsJobsMeRequest request;

		private Builder() {
			request = new GetJourneyViewsJobsMeRequest();
		}
		...
		public GetJourneyViewsJobsMeRequest build() {
