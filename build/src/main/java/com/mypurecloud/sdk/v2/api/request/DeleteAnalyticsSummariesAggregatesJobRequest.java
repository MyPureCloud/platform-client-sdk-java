...
public class DeleteAnalyticsSummariesAggregatesJobRequest {
	...
	public DeleteAnalyticsSummariesAggregatesJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public DeleteAnalyticsSummariesAggregatesJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for DeleteAnalyticsSummariesAggregatesJobRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/analytics/summaries/aggregates/jobs/{jobId}")
	...
	public static class Builder {
		private final DeleteAnalyticsSummariesAggregatesJobRequest request;

		private Builder() {
			request = new DeleteAnalyticsSummariesAggregatesJobRequest();
		}
		...
		public DeleteAnalyticsSummariesAggregatesJobRequest build() {
