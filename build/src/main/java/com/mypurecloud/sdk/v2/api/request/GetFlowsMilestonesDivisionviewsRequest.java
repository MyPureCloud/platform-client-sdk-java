...
public class GetFlowsMilestonesDivisionviewsRequest {
	...
	public GetFlowsMilestonesDivisionviewsRequest withPageNumber(Integer pageNumber) {
	...
	public GetFlowsMilestonesDivisionviewsRequest withPageSize(Integer pageSize) {
	...
	public GetFlowsMilestonesDivisionviewsRequest withSortBy(String sortBy) {
	...
	public GetFlowsMilestonesDivisionviewsRequest withSortOrder(String sortOrder) {
	...
	public GetFlowsMilestonesDivisionviewsRequest withId(List<String> id) {
	    this.setId(id);
	    return this;
	} 
	...
	public GetFlowsMilestonesDivisionviewsRequest withName(String name) {
	    this.setName(name);
	    return this;
	} 
	...
	public GetFlowsMilestonesDivisionviewsRequest withDivisionId(List<String> divisionId) {
    ...
    public GetFlowsMilestonesDivisionviewsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/flows/milestones/divisionviews")
	...
	public static class Builder {
		private final GetFlowsMilestonesDivisionviewsRequest request;

		private Builder() {
			request = new GetFlowsMilestonesDivisionviewsRequest();
		}
		...
		public GetFlowsMilestonesDivisionviewsRequest build() {
