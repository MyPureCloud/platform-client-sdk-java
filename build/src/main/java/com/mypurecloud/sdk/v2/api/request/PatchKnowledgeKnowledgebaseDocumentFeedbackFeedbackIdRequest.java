...
public class PatchKnowledgeKnowledgebaseDocumentFeedbackFeedbackIdRequest {
	...
	public PatchKnowledgeKnowledgebaseDocumentFeedbackFeedbackIdRequest withKnowledgeBaseId(String knowledgeBaseId) {
	...
	public PatchKnowledgeKnowledgebaseDocumentFeedbackFeedbackIdRequest withDocumentId(String documentId) {
	...
	public PatchKnowledgeKnowledgebaseDocumentFeedbackFeedbackIdRequest withFeedbackId(String feedbackId) {
	    this.setFeedbackId(feedbackId);
	    return this;
	} 

	private KnowledgeDocumentFeedbackUpdateRequest body;
	public KnowledgeDocumentFeedbackUpdateRequest getBody() {
		return this.body;
	}

	public void setBody(KnowledgeDocumentFeedbackUpdateRequest body) {
		this.body = body;
	}

	public PatchKnowledgeKnowledgebaseDocumentFeedbackFeedbackIdRequest withBody(KnowledgeDocumentFeedbackUpdateRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchKnowledgeKnowledgebaseDocumentFeedbackFeedbackIdRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<KnowledgeDocumentFeedbackUpdateRequest> withHttpInfo() {
        
        // verify the required parameter 'knowledgeBaseId' is set
        if (this.knowledgeBaseId == null) {
            throw new IllegalStateException("Missing the required parameter 'knowledgeBaseId' when building request for PatchKnowledgeKnowledgebaseDocumentFeedbackFeedbackIdRequest.");
        }
        
        // verify the required parameter 'documentId' is set
        if (this.documentId == null) {
            throw new IllegalStateException("Missing the required parameter 'documentId' when building request for PatchKnowledgeKnowledgebaseDocumentFeedbackFeedbackIdRequest.");
        }
        
        // verify the required parameter 'feedbackId' is set
        if (this.feedbackId == null) {
            throw new IllegalStateException("Missing the required parameter 'feedbackId' when building request for PatchKnowledgeKnowledgebaseDocumentFeedbackFeedbackIdRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/documents/{documentId}/feedback/{feedbackId}")
	...
	public static Builder builder(String knowledgeBaseId, String documentId, String feedbackId) {
	    return new Builder()
	            .withRequiredParams(knowledgeBaseId, documentId, feedbackId);
	}


	public static class Builder {
		private final PatchKnowledgeKnowledgebaseDocumentFeedbackFeedbackIdRequest request;

		private Builder() {
			request = new PatchKnowledgeKnowledgebaseDocumentFeedbackFeedbackIdRequest();
		}
		...
		public Builder withBody(KnowledgeDocumentFeedbackUpdateRequest body) {
		...
		public Builder withRequiredParams(String knowledgeBaseId, String documentId, String feedbackId) {
			request.setKnowledgeBaseId(knowledgeBaseId);
			request.setDocumentId(documentId);
			request.setFeedbackId(feedbackId);
		...
		public PatchKnowledgeKnowledgebaseDocumentFeedbackFeedbackIdRequest build() {
