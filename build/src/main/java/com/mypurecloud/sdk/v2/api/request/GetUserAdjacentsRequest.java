...
public class GetUserAdjacentsRequest {
    ...
    public ApiRequest<Void> withHttpInfo() throws ApiException {
        ...
        if (this.userId == null) {
            throw new ApiException(400, "Missing the required parameter 'userId' when building request for GetUserAdjacentsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/users/{userId}/adjacents")
	...
	public static class Builder {
		private final GetUserAdjacentsRequest request;

		private Builder() {
			request = new GetUserAdjacentsRequest();
		}
