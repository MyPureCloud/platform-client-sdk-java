...
public class PostArchitectSystempromptResourceUploadsRequest {
	...
	public PostArchitectSystempromptResourceUploadsRequest withPromptId(String promptId) {
	...
	public PostArchitectSystempromptResourceUploadsRequest withLanguageCode(String languageCode) {
    ...
    public PostArchitectSystempromptResourceUploadsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.promptId == null) {
            throw new IllegalStateException("Missing the required parameter 'promptId' when building request for PostArchitectSystempromptResourceUploadsRequest.");
        }
        
        // verify the required parameter 'languageCode' is set
        if (this.languageCode == null) {
            throw new IllegalStateException("Missing the required parameter 'languageCode' when building request for PostArchitectSystempromptResourceUploadsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/architect/systemprompts/{promptId}/resources/{languageCode}/uploads")
	...
	public static class Builder {
		private final PostArchitectSystempromptResourceUploadsRequest request;

		private Builder() {
			request = new PostArchitectSystempromptResourceUploadsRequest();
		}
		...
		public PostArchitectSystempromptResourceUploadsRequest build() {
