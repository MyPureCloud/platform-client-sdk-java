...
public class GetRoutingSkillgroupMembersDivisionsRequest {
	...
	public GetRoutingSkillgroupMembersDivisionsRequest withSkillGroupId(String skillGroupId) {
	...
	public GetRoutingSkillgroupMembersDivisionsRequest withExpand(String expand) {
    ...
    public GetRoutingSkillgroupMembersDivisionsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.skillGroupId == null) {
            throw new IllegalStateException("Missing the required parameter 'skillGroupId' when building request for GetRoutingSkillgroupMembersDivisionsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/routing/skillgroups/{skillGroupId}/members/divisions")
	...
	public static class Builder {
		private final GetRoutingSkillgroupMembersDivisionsRequest request;

		private Builder() {
			request = new GetRoutingSkillgroupMembersDivisionsRequest();
		}
		...
		public GetRoutingSkillgroupMembersDivisionsRequest build() {
