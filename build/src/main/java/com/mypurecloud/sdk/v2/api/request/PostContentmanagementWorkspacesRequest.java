...
public class PostContentmanagementWorkspacesRequest {
	...
	public void setBody(WorkspaceCreate body) {
		this.body = body;
	}

	public PostContentmanagementWorkspacesRequest withBody(WorkspaceCreate body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostContentmanagementWorkspacesRequest withCustomHeader(String name, String value) {
