...
public class PostFlowHistoryRequest {
	...
	public PostFlowHistoryRequest withFlowId(String flowId) {
    ...
    public PostFlowHistoryRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.flowId == null) {
            throw new IllegalStateException("Missing the required parameter 'flowId' when building request for PostFlowHistoryRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/flows/{flowId}/history")
	...
	public static class Builder {
		private final PostFlowHistoryRequest request;

		private Builder() {
			request = new PostFlowHistoryRequest();
		}
		...
		public PostFlowHistoryRequest build() {
