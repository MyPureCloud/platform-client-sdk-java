...
public class GetChatsUsersMeSettingsRequest {
    ...
    public GetChatsUsersMeSettingsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/chats/users/me/settings")
	...
	public static class Builder {
		private final GetChatsUsersMeSettingsRequest request;

		private Builder() {
			request = new GetChatsUsersMeSettingsRequest();
		}
		...
		public GetChatsUsersMeSettingsRequest build() {
