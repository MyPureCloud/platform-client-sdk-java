...
public class GetTelephonyProvidersEdgeDiagnosticRouteRequest {
	...
	public GetTelephonyProvidersEdgeDiagnosticRouteRequest withEdgeId(String edgeId) {
    ...
    public GetTelephonyProvidersEdgeDiagnosticRouteRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.edgeId == null) {
            throw new IllegalStateException("Missing the required parameter 'edgeId' when building request for GetTelephonyProvidersEdgeDiagnosticRouteRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/telephony/providers/edges/{edgeId}/diagnostic/route")
	...
	public static class Builder {
		private final GetTelephonyProvidersEdgeDiagnosticRouteRequest request;

		private Builder() {
			request = new GetTelephonyProvidersEdgeDiagnosticRouteRequest();
		}
		...
		public GetTelephonyProvidersEdgeDiagnosticRouteRequest build() {
