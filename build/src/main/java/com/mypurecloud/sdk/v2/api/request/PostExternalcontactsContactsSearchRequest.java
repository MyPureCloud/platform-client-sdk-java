...
public class PostExternalcontactsContactsSearchRequest {

	private ContactSearchRequest body;
	public ContactSearchRequest getBody() {
		return this.body;
	}

	public void setBody(ContactSearchRequest body) {
		this.body = body;
	}

	public PostExternalcontactsContactsSearchRequest withBody(ContactSearchRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostExternalcontactsContactsSearchRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<ContactSearchRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostExternalcontactsContactsSearchRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/externalcontacts/contacts/search")
                .withBody(body)
	...
	public static Builder builder(ContactSearchRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostExternalcontactsContactsSearchRequest request;

		private Builder() {
			request = new PostExternalcontactsContactsSearchRequest();
		}


		public Builder withBody(ContactSearchRequest body) {
		...
		public Builder withRequiredParams(ContactSearchRequest body) {
			request.setBody(body);
		...
		public PostExternalcontactsContactsSearchRequest build() {
