...
public class ActionMapListing  implements Serializable, PagedResource<ActionMap> {
  ...
  /**
   **/
  public ActionMapListing entities(List<ActionMap> entities) {
  ...
  public List<ActionMap> getEntities() {
    return entities;
  }
  public void setEntities(List<ActionMap> entities) {
    this.entities = entities;
  }
