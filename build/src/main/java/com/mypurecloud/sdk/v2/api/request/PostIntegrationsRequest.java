...
public class PostIntegrationsRequest {
    
	private CreateIntegrationRequest body;
	public CreateIntegrationRequest getBody() {
		return this.body;
	}

	public void setBody(CreateIntegrationRequest body) {
		this.body = body;
	}

	public PostIntegrationsRequest withBody(CreateIntegrationRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostIntegrationsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<CreateIntegrationRequest> withHttpInfo() {
	...
	public static class Builder {
		private final PostIntegrationsRequest request;

		private Builder() {
			request = new PostIntegrationsRequest();
		}

		
		public Builder withBody(CreateIntegrationRequest body) {
