...
public class GetKnowledgeKnowledgebaseRequest {
	...
	public GetKnowledgeKnowledgebaseRequest withKnowledgeBaseId(String knowledgeBaseId) {
    ...
    public GetKnowledgeKnowledgebaseRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.knowledgeBaseId == null) {
            throw new IllegalStateException("Missing the required parameter 'knowledgeBaseId' when building request for GetKnowledgeKnowledgebaseRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}")
	...
	public static class Builder {
		private final GetKnowledgeKnowledgebaseRequest request;

		private Builder() {
			request = new GetKnowledgeKnowledgebaseRequest();
		}
		...
		public GetKnowledgeKnowledgebaseRequest build() {
