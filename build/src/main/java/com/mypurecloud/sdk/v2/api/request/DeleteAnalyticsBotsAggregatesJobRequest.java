...
public class DeleteAnalyticsBotsAggregatesJobRequest {
	...
	public DeleteAnalyticsBotsAggregatesJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public DeleteAnalyticsBotsAggregatesJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for DeleteAnalyticsBotsAggregatesJobRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/analytics/bots/aggregates/jobs/{jobId}")
	...
	public static class Builder {
		private final DeleteAnalyticsBotsAggregatesJobRequest request;

		private Builder() {
			request = new DeleteAnalyticsBotsAggregatesJobRequest();
		}
		...
		public DeleteAnalyticsBotsAggregatesJobRequest build() {
