...
public class PostWorkforcemanagementAgentsMePossibleworkshiftsRequest {

	private AgentPossibleWorkShiftsRequest body;
	public AgentPossibleWorkShiftsRequest getBody() {
		return this.body;
	}

	public void setBody(AgentPossibleWorkShiftsRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementAgentsMePossibleworkshiftsRequest withBody(AgentPossibleWorkShiftsRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementAgentsMePossibleworkshiftsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<AgentPossibleWorkShiftsRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementAgentsMePossibleworkshiftsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/agents/me/possibleworkshifts")
                .withBody(body)
	...
	public static Builder builder(AgentPossibleWorkShiftsRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementAgentsMePossibleworkshiftsRequest request;

		private Builder() {
			request = new PostWorkforcemanagementAgentsMePossibleworkshiftsRequest();
		}


		public Builder withBody(AgentPossibleWorkShiftsRequest body) {
		...
		public Builder withRequiredParams(AgentPossibleWorkShiftsRequest body) {
			request.setBody(body);
		...
		public PostWorkforcemanagementAgentsMePossibleworkshiftsRequest build() {
