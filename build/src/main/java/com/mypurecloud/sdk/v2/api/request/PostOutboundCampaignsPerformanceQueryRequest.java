...
public class PostOutboundCampaignsPerformanceQueryRequest {
	...
	public PostOutboundCampaignsPerformanceQueryRequest withBody(List<String> body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostOutboundCampaignsPerformanceQueryRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<List<String>> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostOutboundCampaignsPerformanceQueryRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/outbound/campaigns/performance/query")
                .withBody(body)
	...
	public static class Builder {
		private final PostOutboundCampaignsPerformanceQueryRequest request;

		private Builder() {
			request = new PostOutboundCampaignsPerformanceQueryRequest();
		}
		...
		public PostOutboundCampaignsPerformanceQueryRequest build() {
