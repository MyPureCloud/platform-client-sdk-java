...
public class PostAnalyticsCasemanagementAggregatesJobsRequest {

	private CaseManagementAsyncAggregationQuery body;
	public CaseManagementAsyncAggregationQuery getBody() {
		return this.body;
	}

	public void setBody(CaseManagementAsyncAggregationQuery body) {
		this.body = body;
	}

	public PostAnalyticsCasemanagementAggregatesJobsRequest withBody(CaseManagementAsyncAggregationQuery body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostAnalyticsCasemanagementAggregatesJobsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<CaseManagementAsyncAggregationQuery> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostAnalyticsCasemanagementAggregatesJobsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/analytics/casemanagement/aggregates/jobs")
                .withBody(body)
	...
	public static Builder builder(CaseManagementAsyncAggregationQuery body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostAnalyticsCasemanagementAggregatesJobsRequest request;

		private Builder() {
			request = new PostAnalyticsCasemanagementAggregatesJobsRequest();
		}


		public Builder withBody(CaseManagementAsyncAggregationQuery body) {
		...
		public Builder withRequiredParams(CaseManagementAsyncAggregationQuery body) {
			request.setBody(body);
		...
		public PostAnalyticsCasemanagementAggregatesJobsRequest build() {
