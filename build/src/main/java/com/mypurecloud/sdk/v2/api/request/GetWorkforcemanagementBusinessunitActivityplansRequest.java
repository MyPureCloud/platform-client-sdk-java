...
public class GetWorkforcemanagementBusinessunitActivityplansRequest {
	...
	public GetWorkforcemanagementBusinessunitActivityplansRequest withBusinessUnitId(String businessUnitId) {
	...
	public GetWorkforcemanagementBusinessunitActivityplansRequest withState(String state) {
	    this.setState(state);
	    return this;
	} 
    ...
    public GetWorkforcemanagementBusinessunitActivityplansRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for GetWorkforcemanagementBusinessunitActivityplansRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/activityplans")
	...
	public static class Builder {
		private final GetWorkforcemanagementBusinessunitActivityplansRequest request;

		private Builder() {
			request = new GetWorkforcemanagementBusinessunitActivityplansRequest();
		}
		...
		public GetWorkforcemanagementBusinessunitActivityplansRequest build() {
