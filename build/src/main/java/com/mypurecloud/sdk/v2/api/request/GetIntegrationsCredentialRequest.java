...
public class GetIntegrationsCredentialRequest {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/integrations/credentials/{credentialId}")
	...
	public static class Builder {
		private final GetIntegrationsCredentialRequest request;

		private Builder() {
			request = new GetIntegrationsCredentialRequest();
		}
