...
public class PostIntegrationsWebhookEventsRequest {
	...
	public PostIntegrationsWebhookEventsRequest withTokenId(String tokenId) {
	...
	public PostIntegrationsWebhookEventsRequest withBody(Object body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostIntegrationsWebhookEventsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Object> withHttpInfo() {
        ...
        if (this.tokenId == null) {
            throw new IllegalStateException("Missing the required parameter 'tokenId' when building request for PostIntegrationsWebhookEventsRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostIntegrationsWebhookEventsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/integrations/webhooks/{tokenId}/events")
	...
	public static Builder builder(String tokenId, Object body) {
	    return new Builder()
	            .withRequiredParams(tokenId, body);
	}


	public static class Builder {
		private final PostIntegrationsWebhookEventsRequest request;

		private Builder() {
			request = new PostIntegrationsWebhookEventsRequest();
		}
		...
		public Builder withRequiredParams(String tokenId, Object body) {
			request.setTokenId(tokenId);
			request.setBody(body);
		...
		public PostIntegrationsWebhookEventsRequest build() {
