...
public class DeleteOutboundSchedulesEmailcampaignRequest {
	...
	public DeleteOutboundSchedulesEmailcampaignRequest withEmailCampaignId(String emailCampaignId) {
    ...
    public DeleteOutboundSchedulesEmailcampaignRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.emailCampaignId == null) {
            throw new IllegalStateException("Missing the required parameter 'emailCampaignId' when building request for DeleteOutboundSchedulesEmailcampaignRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/outbound/schedules/emailcampaigns/{emailCampaignId}")
	...
	public static Builder builder(String emailCampaignId) {
	    return new Builder()
	            .withRequiredParams(emailCampaignId);
	}


	public static class Builder {
		private final DeleteOutboundSchedulesEmailcampaignRequest request;

		private Builder() {
			request = new DeleteOutboundSchedulesEmailcampaignRequest();
		}
		...
		public Builder withRequiredParams(String emailCampaignId) {
			request.setEmailCampaignId(emailCampaignId);
		...
		public DeleteOutboundSchedulesEmailcampaignRequest build() {
