...
public class SystemPromptAssetEntityListing  implements Serializable, PagedResource<SystemPromptAsset> {
  ...
  /**
   **/
  public SystemPromptAssetEntityListing entities(List<SystemPromptAsset> entities) {
  ...
  public List<SystemPromptAsset> getEntities() {
    return entities;
  }
  public void setEntities(List<SystemPromptAsset> entities) {
    this.entities = entities;
  }
