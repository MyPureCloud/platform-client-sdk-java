...
public class QueueConversationSocialExpressionEventTopicJourneyCustomer  implements Serializable {
  
  private String id = null;
  private String idType = null;

  public QueueConversationSocialExpressionEventTopicJourneyCustomer() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
    }
  }

  public QueueConversationSocialExpressionEventTopicJourneyCustomer(Boolean initWithEmptyList) {
   ...
   **/
  public QueueConversationSocialExpressionEventTopicJourneyCustomer id(String id) {
    this.id = id;
    return this;
  }
   ...
   **/
  public QueueConversationSocialExpressionEventTopicJourneyCustomer idType(String idType) {
    this.idType = idType;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    QueueConversationSocialExpressionEventTopicJourneyCustomer queueConversationSocialExpressionEventTopicJourneyCustomer = (QueueConversationSocialExpressionEventTopicJourneyCustomer) o;

    return Objects.equals(this.id, queueConversationSocialExpressionEventTopicJourneyCustomer.id) &&
            Objects.equals(this.idType, queueConversationSocialExpressionEventTopicJourneyCustomer.idType);
  }
