...
public class PostCoachingScheduleslotsJobsRequest {

	private CoachingScheduleSlotsJobRequest body;
	public CoachingScheduleSlotsJobRequest getBody() {
		return this.body;
	}

	public void setBody(CoachingScheduleSlotsJobRequest body) {
		this.body = body;
	}

	public PostCoachingScheduleslotsJobsRequest withBody(CoachingScheduleSlotsJobRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostCoachingScheduleslotsJobsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<CoachingScheduleSlotsJobRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostCoachingScheduleslotsJobsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/coaching/scheduleslots/jobs")
                .withBody(body)
	...
	public static Builder builder(CoachingScheduleSlotsJobRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostCoachingScheduleslotsJobsRequest request;

		private Builder() {
			request = new PostCoachingScheduleslotsJobsRequest();
		}


		public Builder withBody(CoachingScheduleSlotsJobRequest body) {
		...
		public Builder withRequiredParams(CoachingScheduleSlotsJobRequest body) {
			request.setBody(body);
		...
		public PostCoachingScheduleslotsJobsRequest build() {
