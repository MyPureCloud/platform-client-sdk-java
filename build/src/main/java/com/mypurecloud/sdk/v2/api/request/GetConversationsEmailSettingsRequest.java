...
public class GetConversationsEmailSettingsRequest {
	...
	public GetConversationsEmailSettingsRequest withConversationId(String conversationId) {
    ...
    public GetConversationsEmailSettingsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for GetConversationsEmailSettingsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/conversations/emails/{conversationId}/settings")
	...
	public static class Builder {
		private final GetConversationsEmailSettingsRequest request;

		private Builder() {
			request = new GetConversationsEmailSettingsRequest();
		}
		...
		public GetConversationsEmailSettingsRequest build() {
