...
public class PatchConversationsMessageRequest {
	...
	public PatchConversationsMessageRequest withConversationId(String conversationId) {
	...
	public PatchConversationsMessageRequest withBody(Conversation body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchConversationsMessageRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Conversation> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PatchConversationsMessageRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchConversationsMessageRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/conversations/messages/{conversationId}")
	...
	public static class Builder {
		private final PatchConversationsMessageRequest request;

		private Builder() {
			request = new PatchConversationsMessageRequest();
		}
		...
		public PatchConversationsMessageRequest build() {
