...
public class GetWorkforcemanagementManagementunitAgentShifttradesRequest {
	...
	public GetWorkforcemanagementManagementunitAgentShifttradesRequest withManagementUnitId(String managementUnitId) {
	...
	public GetWorkforcemanagementManagementunitAgentShifttradesRequest withAgentId(String agentId) {
    ...
    public GetWorkforcemanagementManagementunitAgentShifttradesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.managementUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'managementUnitId' when building request for GetWorkforcemanagementManagementunitAgentShifttradesRequest.");
        }
        
        // verify the required parameter 'agentId' is set
        if (this.agentId == null) {
            throw new IllegalStateException("Missing the required parameter 'agentId' when building request for GetWorkforcemanagementManagementunitAgentShifttradesRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/managementunits/{managementUnitId}/agents/{agentId}/shifttrades")
	...
	public static class Builder {
		private final GetWorkforcemanagementManagementunitAgentShifttradesRequest request;

		private Builder() {
			request = new GetWorkforcemanagementManagementunitAgentShifttradesRequest();
		}
		...
		public GetWorkforcemanagementManagementunitAgentShifttradesRequest build() {
