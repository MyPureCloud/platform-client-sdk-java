...
public class SurveyDetailQueryPredicate  implements Serializable {
 ...
 @JsonDeserialize(using = OperatorEnumDeserializer.class)
  ...
  public SurveyDetailQueryPredicate() {
   ...
   * Optional type, can usually be inferred
   **/
  public SurveyDetailQueryPredicate type(TypeEnum type) {
    this.type = type;
    return this;
  }
   ...
   * Left hand side for dimension predicates
   **/
  public SurveyDetailQueryPredicate dimension(DimensionEnum dimension) {
   ...
   * Left hand side for metric predicates
   **/
  public SurveyDetailQueryPredicate metric(MetricEnum metric) {
    this.metric = metric;
    return this;
  }
   ...
   * Optional operator, default is matches
   **/
  public SurveyDetailQueryPredicate operator(OperatorEnum operator) {
   ...
   **/
  public SurveyDetailQueryPredicate value(String value) {
    this.value = value;
    return this;
  }
   ...
   * Right hand side for dimension or metric predicates
   **/
  public SurveyDetailQueryPredicate range(NumericRange range) {
    this.range = range;
    return this;
  }
