...
public class PostConversationsMessagingSupportedcontentRequest {
	...
	public PostConversationsMessagingSupportedcontentRequest withBody(SupportedContent body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostConversationsMessagingSupportedcontentRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<SupportedContent> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostConversationsMessagingSupportedcontentRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/conversations/messaging/supportedcontent")
                .withBody(body)
	...
	public static class Builder {
		private final PostConversationsMessagingSupportedcontentRequest request;

		private Builder() {
			request = new PostConversationsMessagingSupportedcontentRequest();
		}
		...
		public PostConversationsMessagingSupportedcontentRequest build() {
