...
public class PostUsersMeVerifiersWebauthnRegisterOptionsRequest {
    ...
    public PostUsersMeVerifiersWebauthnRegisterOptionsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("POST", "/api/v2/users/me/verifiers/webauthn/register/options")
	...
	public static class Builder {
		private final PostUsersMeVerifiersWebauthnRegisterOptionsRequest request;

		private Builder() {
			request = new PostUsersMeVerifiersWebauthnRegisterOptionsRequest();
		}
		...
		public PostUsersMeVerifiersWebauthnRegisterOptionsRequest build() {
