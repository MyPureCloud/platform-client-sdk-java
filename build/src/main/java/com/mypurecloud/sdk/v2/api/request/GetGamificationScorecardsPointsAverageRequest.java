...
public class GetGamificationScorecardsPointsAverageRequest {
	...
	public GetGamificationScorecardsPointsAverageRequest withWorkday(LocalDate workday) {
    ...
    public GetGamificationScorecardsPointsAverageRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.workday == null) {
            throw new IllegalStateException("Missing the required parameter 'workday' when building request for GetGamificationScorecardsPointsAverageRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/gamification/scorecards/points/average")
	...
	public static class Builder {
		private final GetGamificationScorecardsPointsAverageRequest request;

		private Builder() {
			request = new GetGamificationScorecardsPointsAverageRequest();
		}
		...
		public GetGamificationScorecardsPointsAverageRequest build() {
