...
public class PatchWorkforcemanagementManagementunitActivitycodeRequest {
	...
	public PatchWorkforcemanagementManagementunitActivitycodeRequest withMuId(String muId) {
	    this.setMuId(muId);
	    return this;
	} 
	...
	public PatchWorkforcemanagementManagementunitActivitycodeRequest withAcId(String acId) {
	    this.setAcId(acId);
	    return this;
	} 
	...
	public void setBody(UpdateActivityCodeRequest body) {
		this.body = body;
	}

	public PatchWorkforcemanagementManagementunitActivitycodeRequest withBody(UpdateActivityCodeRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchWorkforcemanagementManagementunitActivitycodeRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<UpdateActivityCodeRequest> withHttpInfo() {
        ...
        if (this.muId == null) {
            throw new IllegalStateException("Missing the required parameter 'muId' when building request for PatchWorkforcemanagementManagementunitActivitycodeRequest.");
        }
        
        // verify the required parameter 'acId' is set
        if (this.acId == null) {
            throw new IllegalStateException("Missing the required parameter 'acId' when building request for PatchWorkforcemanagementManagementunitActivitycodeRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/workforcemanagement/managementunits/{muId}/activitycodes/{acId}")
	...
	public static class Builder {
		private final PatchWorkforcemanagementManagementunitActivitycodeRequest request;

		private Builder() {
			request = new PatchWorkforcemanagementManagementunitActivitycodeRequest();
		}
		...
		public Builder withBody(UpdateActivityCodeRequest body) {
		...
		public PatchWorkforcemanagementManagementunitActivitycodeRequest build() {
