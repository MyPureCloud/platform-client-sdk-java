...
public class GetUserVerifiersRequest {
	...
	public GetUserVerifiersRequest withUserId(String userId) {
    ...
    public GetUserVerifiersRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.userId == null) {
            throw new IllegalStateException("Missing the required parameter 'userId' when building request for GetUserVerifiersRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/users/{userId}/verifiers")
	...
	public static class Builder {
		private final GetUserVerifiersRequest request;

		private Builder() {
			request = new GetUserVerifiersRequest();
		}
		...
		public GetUserVerifiersRequest build() {
