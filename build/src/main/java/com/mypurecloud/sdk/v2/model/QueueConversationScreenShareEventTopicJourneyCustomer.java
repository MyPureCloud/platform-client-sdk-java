...
public class QueueConversationScreenShareEventTopicJourneyCustomer  implements Serializable {
  
  private String id = null;
  private String idType = null;

  public QueueConversationScreenShareEventTopicJourneyCustomer() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
    }
  }

  public QueueConversationScreenShareEventTopicJourneyCustomer(Boolean initWithEmptyList) {
   ...
   **/
  public QueueConversationScreenShareEventTopicJourneyCustomer id(String id) {
    this.id = id;
    return this;
  }
   ...
   **/
  public QueueConversationScreenShareEventTopicJourneyCustomer idType(String idType) {
    this.idType = idType;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    QueueConversationScreenShareEventTopicJourneyCustomer queueConversationScreenShareEventTopicJourneyCustomer = (QueueConversationScreenShareEventTopicJourneyCustomer) o;

    return Objects.equals(this.id, queueConversationScreenShareEventTopicJourneyCustomer.id) &&
            Objects.equals(this.idType, queueConversationScreenShareEventTopicJourneyCustomer.idType);
  }
