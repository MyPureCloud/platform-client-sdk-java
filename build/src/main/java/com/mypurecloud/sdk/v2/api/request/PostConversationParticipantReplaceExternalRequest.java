...
public class PostConversationParticipantReplaceExternalRequest {
	...
	public PostConversationParticipantReplaceExternalRequest withConversationId(String conversationId) {
	...
	public PostConversationParticipantReplaceExternalRequest withParticipantId(String participantId) {
	    this.setParticipantId(participantId);
	    return this;
	} 

	private TransferToExternalRequest body;
	public TransferToExternalRequest getBody() {
		return this.body;
	}

	public void setBody(TransferToExternalRequest body) {
		this.body = body;
	}

	public PostConversationParticipantReplaceExternalRequest withBody(TransferToExternalRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostConversationParticipantReplaceExternalRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<TransferToExternalRequest> withHttpInfo() {
        
        // verify the required parameter 'conversationId' is set
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PostConversationParticipantReplaceExternalRequest.");
        }
        
        // verify the required parameter 'participantId' is set
        if (this.participantId == null) {
            throw new IllegalStateException("Missing the required parameter 'participantId' when building request for PostConversationParticipantReplaceExternalRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostConversationParticipantReplaceExternalRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/conversations/{conversationId}/participants/{participantId}/replace/external")
	...
	public static Builder builder(String conversationId, String participantId, TransferToExternalRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostConversationParticipantReplaceExternalRequest request;

		private Builder() {
			request = new PostConversationParticipantReplaceExternalRequest();
		}
		...
		public Builder withBody(TransferToExternalRequest body) {
		...
		public Builder withRequiredParams(String conversationId, String participantId, TransferToExternalRequest body) {
			request.setConversationId(conversationId);
			request.setParticipantId(participantId);
			request.setBody(body);
		...
		public PostConversationParticipantReplaceExternalRequest build() {
