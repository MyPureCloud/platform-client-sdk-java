...
public class DocumentContentBlockWithHighlight  implements Serializable {
 ...
 @JsonDeserialize(using = TypeEnumDeserializer.class)
  ...
  public DocumentContentBlockWithHighlight() {
   ...
   * The type of the paragraph block.
   **/
  public DocumentContentBlockWithHighlight type(TypeEnum type) {
    this.type = type;
    return this;
  }
   ...
   **/
  public DocumentContentBlockWithHighlight text(DocumentText text) {
    this.text = text;
    return this;
  }
   ...
   **/
  public DocumentContentBlockWithHighlight image(DocumentBodyImage image) {
    this.image = image;
    return this;
  }
   ...
   **/
  public DocumentContentBlockWithHighlight video(DocumentBodyVideo video) {
    this.video = video;
    return this;
  }
   ...
   **/
  public DocumentContentBlockWithHighlight answerHighlight(DocumentContentHighlightIndex answerHighlight) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DocumentContentBlockWithHighlight documentContentBlockWithHighlight = (DocumentContentBlockWithHighlight) o;

    return Objects.equals(this.type, documentContentBlockWithHighlight.type) &&
            Objects.equals(this.text, documentContentBlockWithHighlight.text) &&
            Objects.equals(this.image, documentContentBlockWithHighlight.image) &&
            Objects.equals(this.video, documentContentBlockWithHighlight.video) &&
            Objects.equals(this.answerHighlight, documentContentBlockWithHighlight.answerHighlight);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, text, image, video, answerHighlight);
  }
