...
public class PostJourneyActionmapsRequest {
	...
	private ActionMap body;
	public ActionMap getBody() {
		return this.body;
	}

	public void setBody(ActionMap body) {
		this.body = body;
	}

	public PostJourneyActionmapsRequest withBody(ActionMap body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostJourneyActionmapsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<ActionMap> withHttpInfo() {
        

        return ApiRequestBuilder.create("POST", "/api/v2/journey/actionmaps")
                .withBody(body)
	...
	public static class Builder {
		private final PostJourneyActionmapsRequest request;

		private Builder() {
			request = new PostJourneyActionmapsRequest();
		}

		
		public Builder withBody(ActionMap body) {
		...
		public PostJourneyActionmapsRequest build() {
