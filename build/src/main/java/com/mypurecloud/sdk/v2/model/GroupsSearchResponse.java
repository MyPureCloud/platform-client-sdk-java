...
public class GroupsSearchResponse  implements Serializable {
   ...
   **/
  public GroupsSearchResponse total(Long total) {
    this.total = total;
    return this;
  }
   ...
   **/
  public GroupsSearchResponse pageCount(Integer pageCount) {
   ...
   **/
  public GroupsSearchResponse pageSize(Integer pageSize) {
   ...
   **/
  public GroupsSearchResponse pageNumber(Integer pageNumber) {
   ...
   **/
  public GroupsSearchResponse previousPage(String previousPage) {
   ...
   **/
  public GroupsSearchResponse currentPage(String currentPage) {
   ...
   **/
  public GroupsSearchResponse nextPage(String nextPage) {
   ...
   **/
  public GroupsSearchResponse types(List<String> types) {
    this.types = types;
    return this;
  }
   ...
   * Search results
   **/
  public GroupsSearchResponse results(List<Group> results) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.total, groupsSearchResponse.total) &&
        Objects.equals(this.pageCount, groupsSearchResponse.pageCount) &&
        Objects.equals(this.pageSize, groupsSearchResponse.pageSize) &&
        Objects.equals(this.pageNumber, groupsSearchResponse.pageNumber) &&
        Objects.equals(this.previousPage, groupsSearchResponse.previousPage) &&
        Objects.equals(this.currentPage, groupsSearchResponse.currentPage) &&
        Objects.equals(this.nextPage, groupsSearchResponse.nextPage) &&
        Objects.equals(this.types, groupsSearchResponse.types) &&
        Objects.equals(this.results, groupsSearchResponse.results);
  }
