...
public class PostTelephonyProvidersEdgeUnpairRequest {
	...
	public PostTelephonyProvidersEdgeUnpairRequest withEdgeId(String edgeId) {
    ...
    public PostTelephonyProvidersEdgeUnpairRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.edgeId == null) {
            throw new IllegalStateException("Missing the required parameter 'edgeId' when building request for PostTelephonyProvidersEdgeUnpairRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/telephony/providers/edges/{edgeId}/unpair")
	...
	public static class Builder {
		private final PostTelephonyProvidersEdgeUnpairRequest request;

		private Builder() {
			request = new PostTelephonyProvidersEdgeUnpairRequest();
		}
		...
		public PostTelephonyProvidersEdgeUnpairRequest build() {
