...
public class GetTaskmanagementWorkbinVersionsRequest {
	...
	public GetTaskmanagementWorkbinVersionsRequest withWorkbinId(String workbinId) {
	...
	public GetTaskmanagementWorkbinVersionsRequest withAfter(String after) {
	    this.setAfter(after);
	    return this;
	} 
	...
	public GetTaskmanagementWorkbinVersionsRequest withPageSize(Integer pageSize) {
	...
	public GetTaskmanagementWorkbinVersionsRequest withSortOrder(String sortOrder) {
    ...
    public GetTaskmanagementWorkbinVersionsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.workbinId == null) {
            throw new IllegalStateException("Missing the required parameter 'workbinId' when building request for GetTaskmanagementWorkbinVersionsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/taskmanagement/workbins/{workbinId}/versions")
	...
	public static class Builder {
		private final GetTaskmanagementWorkbinVersionsRequest request;

		private Builder() {
			request = new GetTaskmanagementWorkbinVersionsRequest();
		}
		...
		public GetTaskmanagementWorkbinVersionsRequest build() {
