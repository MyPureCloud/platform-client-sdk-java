...
public class DeleteConversationRequest {
    ...
    public DeleteConversationRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for DeleteConversationRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/conversations/{conversationId}")
	...
	public static class Builder {
		private final DeleteConversationRequest request;
