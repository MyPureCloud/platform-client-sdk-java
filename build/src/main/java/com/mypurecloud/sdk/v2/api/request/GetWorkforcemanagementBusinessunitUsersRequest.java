...
public class GetWorkforcemanagementBusinessunitUsersRequest {
	...
	public GetWorkforcemanagementBusinessunitUsersRequest withBusinessUnitId(String businessUnitId) {
	...
	public GetWorkforcemanagementBusinessunitUsersRequest withManagementUnitIds(List<String> managementUnitIds) {
    ...
    public GetWorkforcemanagementBusinessunitUsersRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for GetWorkforcemanagementBusinessunitUsersRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/users")
	...
	public static class Builder {
		private final GetWorkforcemanagementBusinessunitUsersRequest request;

		private Builder() {
			request = new GetWorkforcemanagementBusinessunitUsersRequest();
		}
		...
		public GetWorkforcemanagementBusinessunitUsersRequest build() {
