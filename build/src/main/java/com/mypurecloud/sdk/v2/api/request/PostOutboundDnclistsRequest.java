...
public class PostOutboundDnclistsRequest {
    private static final Pattern JSON_MIME_PATTERN = Pattern.compile("(?i)application\\/json(;.*)?");
    private static final String[] AUTH_NAMES = new String[] { };

	private DncListCreate body;
	public DncListCreate getBody() {
		return this.body;
	}

	public void setBody(DncListCreate body) {
		this.body = body;
	}

	public PostOutboundDnclistsRequest withBody(DncListCreate body) {
	    this.setBody(body);
	    return this;
	}
    ...
    public PostOutboundDnclistsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<DncListCreate> withHttpInfo() throws ApiException {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new ApiException(400, "Missing the required parameter 'body' when building request for PostOutboundDnclistsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/outbound/dnclists")
                .withBody(body)
	...
	public static Builder builder(DncListCreate body) {
	    return new Builder()
	            .withRequiredParams(body);
	}

	public static class Builder {
		private final PostOutboundDnclistsRequest request;

		private Builder() {
			request = new PostOutboundDnclistsRequest();
		}

		public Builder withBody(DncListCreate body) {
			request.setBody(body);
			return this;
		}

		public Builder withRequiredParams(DncListCreate body) {
			request.setBody(body);
			return this;
		}


		public PostOutboundDnclistsRequest build() {
			return request;
		}
	}
}
