...
public class PostOutboundDnclistsRequest {
    ...
    public ApiRequest<DncListCreate> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostOutboundDnclistsRequest.");
        }
