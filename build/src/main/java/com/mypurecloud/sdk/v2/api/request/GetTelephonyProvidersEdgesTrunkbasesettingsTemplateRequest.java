...
public class GetTelephonyProvidersEdgesTrunkbasesettingsTemplateRequest {
	...
	public void setTrunkMetabaseId(String trunkMetabaseId) {
		this.trunkMetabaseId = trunkMetabaseId;
	}

	public GetTelephonyProvidersEdgesTrunkbasesettingsTemplateRequest withTrunkMetabaseId(String trunkMetabaseId) {
	    this.setTrunkMetabaseId(trunkMetabaseId);
	    return this;
	} 
    ...
    public GetTelephonyProvidersEdgesTrunkbasesettingsTemplateRequest withCustomHeader(String name, String value) {
	...
	public static class Builder {
		...
		public GetTelephonyProvidersEdgesTrunkbasesettingsTemplateRequest build() {
            ...
            // verify the required parameter 'trunkMetabaseId' is set
            if (request.trunkMetabaseId == null) {
                throw new IllegalStateException("Missing the required parameter 'trunkMetabaseId' when building request for GetTelephonyProvidersEdgesTrunkbasesettingsTemplateRequest.");
            }
