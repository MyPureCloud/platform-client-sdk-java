...
public class DeleteFlowsMilestoneRequest {
	...
	public DeleteFlowsMilestoneRequest withMilestoneId(String milestoneId) {
    ...
    public DeleteFlowsMilestoneRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.milestoneId == null) {
            throw new IllegalStateException("Missing the required parameter 'milestoneId' when building request for DeleteFlowsMilestoneRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/flows/milestones/{milestoneId}")
	...
	public static class Builder {
		private final DeleteFlowsMilestoneRequest request;

		private Builder() {
			request = new DeleteFlowsMilestoneRequest();
		}
		...
		public DeleteFlowsMilestoneRequest build() {
