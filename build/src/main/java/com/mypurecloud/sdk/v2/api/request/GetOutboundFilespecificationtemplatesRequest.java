...
public class GetOutboundFilespecificationtemplatesRequest {
	...
	public GetOutboundFilespecificationtemplatesRequest withPageSize(Integer pageSize) {
	...
	public GetOutboundFilespecificationtemplatesRequest withPageNumber(Integer pageNumber) {
	...
	public GetOutboundFilespecificationtemplatesRequest withAllowEmptyResult(Boolean allowEmptyResult) {
	...
	public GetOutboundFilespecificationtemplatesRequest withFilterType(String filterType) {
	...
	public GetOutboundFilespecificationtemplatesRequest withName(String name) {
	    this.setName(name);
	    return this;
	} 
	...
	public GetOutboundFilespecificationtemplatesRequest withSortBy(String sortBy) {
	...
	public GetOutboundFilespecificationtemplatesRequest withSortOrder(String sortOrder) {
    ...
    public GetOutboundFilespecificationtemplatesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/outbound/filespecificationtemplates")
	...
	public static class Builder {
		private final GetOutboundFilespecificationtemplatesRequest request;

		private Builder() {
			request = new GetOutboundFilespecificationtemplatesRequest();
		}
		...
		public GetOutboundFilespecificationtemplatesRequest build() {
