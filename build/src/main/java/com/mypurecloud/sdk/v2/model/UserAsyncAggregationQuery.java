...
public class UserAsyncAggregationQuery  implements Serializable {
 ...
 @JsonDeserialize(using = AlternateTimeDimensionEnumDeserializer.class)
  ...
  public UserAsyncAggregationQuery() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
      groupBy = new ArrayList<GroupByEnum>();
      metrics = new ArrayList<MetricsEnum>();
      views = new ArrayList<UserAggregationView>();
    }
  }

  public UserAsyncAggregationQuery(Boolean initWithEmptyList) {
   ...
   **/
  public UserAsyncAggregationQuery interval(String interval) {
   ...
   **/
  public UserAsyncAggregationQuery granularity(String granularity) {
   ...
   **/
  public UserAsyncAggregationQuery timeZone(String timeZone) {
   ...
   **/
  public UserAsyncAggregationQuery groupBy(List<GroupByEnum> groupBy) {
   ...
   **/
  public UserAsyncAggregationQuery filter(UserAggregateQueryFilter filter) {
    this.filter = filter;
    return this;
  }
   ...
   **/
  public UserAsyncAggregationQuery metrics(List<MetricsEnum> metrics) {
   ...
   **/
  public UserAsyncAggregationQuery flattenMultivaluedDimensions(Boolean flattenMultivaluedDimensions) {
   ...
   **/
  public UserAsyncAggregationQuery views(List<UserAggregationView> views) {
    this.views = views;
    return this;
  }
   ...
   * Dimension to use as the alternative timestamp for data in the aggregate.  Choosing \"eventTime\" uses the actual time of the data event.
   **/
  public UserAsyncAggregationQuery alternateTimeDimension(AlternateTimeDimensionEnum alternateTimeDimension) {
   ...
   **/
  public UserAsyncAggregationQuery pageSize(Integer pageSize) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    UserAsyncAggregationQuery userAsyncAggregationQuery = (UserAsyncAggregationQuery) o;

    return Objects.equals(this.interval, userAsyncAggregationQuery.interval) &&
            Objects.equals(this.granularity, userAsyncAggregationQuery.granularity) &&
            Objects.equals(this.timeZone, userAsyncAggregationQuery.timeZone) &&
            Objects.equals(this.groupBy, userAsyncAggregationQuery.groupBy) &&
            Objects.equals(this.filter, userAsyncAggregationQuery.filter) &&
            Objects.equals(this.metrics, userAsyncAggregationQuery.metrics) &&
            Objects.equals(this.flattenMultivaluedDimensions, userAsyncAggregationQuery.flattenMultivaluedDimensions) &&
            Objects.equals(this.views, userAsyncAggregationQuery.views) &&
            Objects.equals(this.alternateTimeDimension, userAsyncAggregationQuery.alternateTimeDimension) &&
            Objects.equals(this.pageSize, userAsyncAggregationQuery.pageSize);
  }
