...
public class KnowledgeBaseListing  implements Serializable {
  ...
  /**
   **/
  public KnowledgeBaseListing entities(List<KnowledgeBase> entities) {
  ...
  public List<KnowledgeBase> getEntities() {
    return entities;
  }
  public void setEntities(List<KnowledgeBase> entities) {
    this.entities = entities;
  }
