...
public class GetConversationsEmailParticipantCommunicationWrapupRequest {
	...
	public GetConversationsEmailParticipantCommunicationWrapupRequest withConversationId(String conversationId) {
	...
	public GetConversationsEmailParticipantCommunicationWrapupRequest withParticipantId(String participantId) {
	...
	public GetConversationsEmailParticipantCommunicationWrapupRequest withCommunicationId(String communicationId) {
	...
	public GetConversationsEmailParticipantCommunicationWrapupRequest withProvisional(Boolean provisional) {
    ...
    public GetConversationsEmailParticipantCommunicationWrapupRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/conversations/emails/{conversationId}/participants/{participantId}/communications/{communicationId}/wrapup")
	...
	public static class Builder {
		...
		private Builder() {
			request = new GetConversationsEmailParticipantCommunicationWrapupRequest();
		}
