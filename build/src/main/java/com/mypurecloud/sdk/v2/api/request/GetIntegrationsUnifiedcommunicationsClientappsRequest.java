...
public class GetIntegrationsUnifiedcommunicationsClientappsRequest {
	...
	public GetIntegrationsUnifiedcommunicationsClientappsRequest withPageSize(Integer pageSize) {
	...
	public GetIntegrationsUnifiedcommunicationsClientappsRequest withPageNumber(Integer pageNumber) {
	...
	public GetIntegrationsUnifiedcommunicationsClientappsRequest withSortBy(String sortBy) {
	...
	public GetIntegrationsUnifiedcommunicationsClientappsRequest withExpand(List<String> expand) {
	...
	public GetIntegrationsUnifiedcommunicationsClientappsRequest withNextPage(String nextPage) {
	...
	public GetIntegrationsUnifiedcommunicationsClientappsRequest withPreviousPage(String previousPage) {
    ...
    public GetIntegrationsUnifiedcommunicationsClientappsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/integrations/unifiedcommunications/clientapps")
	...
	public static class Builder {
		private final GetIntegrationsUnifiedcommunicationsClientappsRequest request;

		private Builder() {
			request = new GetIntegrationsUnifiedcommunicationsClientappsRequest();
		}
		...
		public GetIntegrationsUnifiedcommunicationsClientappsRequest build() {
