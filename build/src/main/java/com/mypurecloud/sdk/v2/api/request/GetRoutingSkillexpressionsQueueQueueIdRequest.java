...
public class GetRoutingSkillexpressionsQueueQueueIdRequest {
	...
	public GetRoutingSkillexpressionsQueueQueueIdRequest withQueueId(String queueId) {
	...
	public GetRoutingSkillexpressionsQueueQueueIdRequest withFormat(String format) {
	...
	public GetRoutingSkillexpressionsQueueQueueIdRequest withIncludeArchived(Boolean includeArchived) {
    ...
    public GetRoutingSkillexpressionsQueueQueueIdRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.queueId == null) {
            throw new IllegalStateException("Missing the required parameter 'queueId' when building request for GetRoutingSkillexpressionsQueueQueueIdRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/routing/skillexpressions/queue/{queueId}")
	...
	public static class Builder {
		private final GetRoutingSkillexpressionsQueueQueueIdRequest request;

		private Builder() {
			request = new GetRoutingSkillexpressionsQueueQueueIdRequest();
		}
		...
		public GetRoutingSkillexpressionsQueueQueueIdRequest build() {
