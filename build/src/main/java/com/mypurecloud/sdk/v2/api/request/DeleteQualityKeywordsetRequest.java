...
public class DeleteQualityKeywordsetRequest {
	...
	public DeleteQualityKeywordsetRequest withKeywordSetId(String keywordSetId) {
    ...
    public DeleteQualityKeywordsetRequest withCustomHeader(String name, String value) {
