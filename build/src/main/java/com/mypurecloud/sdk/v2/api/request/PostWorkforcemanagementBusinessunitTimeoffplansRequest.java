...
public class PostWorkforcemanagementBusinessunitTimeoffplansRequest {
	...
	public PostWorkforcemanagementBusinessunitTimeoffplansRequest withBusinessUnitId(String businessUnitId) {
	    this.setBusinessUnitId(businessUnitId);
	    return this;
	} 

	private BuCreateTimeOffPlanRequest body;
	public BuCreateTimeOffPlanRequest getBody() {
		return this.body;
	}

	public void setBody(BuCreateTimeOffPlanRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementBusinessunitTimeoffplansRequest withBody(BuCreateTimeOffPlanRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementBusinessunitTimeoffplansRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<BuCreateTimeOffPlanRequest> withHttpInfo() {
        
        // verify the required parameter 'businessUnitId' is set
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PostWorkforcemanagementBusinessunitTimeoffplansRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementBusinessunitTimeoffplansRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/timeoffplans")
	...
	public static Builder builder(String businessUnitId, BuCreateTimeOffPlanRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementBusinessunitTimeoffplansRequest request;

		private Builder() {
			request = new PostWorkforcemanagementBusinessunitTimeoffplansRequest();
		}
		...
		public Builder withBody(BuCreateTimeOffPlanRequest body) {
		...
		public Builder withRequiredParams(String businessUnitId, BuCreateTimeOffPlanRequest body) {
			request.setBusinessUnitId(businessUnitId);
			request.setBody(body);
		...
		public PostWorkforcemanagementBusinessunitTimeoffplansRequest build() {
