 ...
 */
@ApiModel(description = "Error details when a decision table export job fails")

public class DecisionTableExportJobError  implements Serializable {
  ...
  public DecisionTableExportJobError(Boolean initWithEmptyList) {
   ...
   **/
  public DecisionTableExportJobError errorCode(String errorCode) {
   ...
   **/
  public DecisionTableExportJobError errorMessage(String errorMessage) {
   ...
   **/
  public DecisionTableExportJobError messageWithParams(String messageWithParams) {
   ...
   **/
  public DecisionTableExportJobError messageParams(Map<String, String> messageParams) {
   ...
   **/
  public DecisionTableExportJobError validationErrors(List<DecisionTableJobValidationError> validationErrors) {
    this.validationErrors = validationErrors;
    return this;
  }
  
  @ApiModelProperty(example = "null", value = "Validation failures for the export job")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DecisionTableExportJobError decisionTableExportJobError = (DecisionTableExportJobError) o;

    return Objects.equals(this.errorCode, decisionTableExportJobError.errorCode) &&
            Objects.equals(this.errorMessage, decisionTableExportJobError.errorMessage) &&
            Objects.equals(this.messageWithParams, decisionTableExportJobError.messageWithParams) &&
            Objects.equals(this.messageParams, decisionTableExportJobError.messageParams) &&
            Objects.equals(this.validationErrors, decisionTableExportJobError.validationErrors);
  }
