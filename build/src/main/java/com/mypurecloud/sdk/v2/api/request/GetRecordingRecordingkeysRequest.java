...
public class GetRecordingRecordingkeysRequest {
	...
	public GetRecordingRecordingkeysRequest withPageSize(Integer pageSize) {
	...
	public GetRecordingRecordingkeysRequest withPageNumber(Integer pageNumber) {
    ...
    public GetRecordingRecordingkeysRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/recording/recordingkeys")
