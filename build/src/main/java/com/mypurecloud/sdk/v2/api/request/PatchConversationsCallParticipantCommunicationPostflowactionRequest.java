...
public class PatchConversationsCallParticipantCommunicationPostflowactionRequest {
	...
	private MandatoryPostCallActionInput body;
	public MandatoryPostCallActionInput getBody() {
		return this.body;
	}

	public void setBody(MandatoryPostCallActionInput body) {
		this.body = body;
	}

	public PatchConversationsCallParticipantCommunicationPostflowactionRequest withBody(MandatoryPostCallActionInput body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public ApiRequest<MandatoryPostCallActionInput> withHttpInfo() {
        
        // verify the required parameter 'conversationId' is set
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PatchConversationsCallParticipantCommunicationPostflowactionRequest.");
        }
        
        // verify the required parameter 'participantId' is set
        if (this.participantId == null) {
            throw new IllegalStateException("Missing the required parameter 'participantId' when building request for PatchConversationsCallParticipantCommunicationPostflowactionRequest.");
        }
        
        // verify the required parameter 'communicationId' is set
        if (this.communicationId == null) {
            throw new IllegalStateException("Missing the required parameter 'communicationId' when building request for PatchConversationsCallParticipantCommunicationPostflowactionRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/conversations/calls/{conversationId}/participants/{participantId}/communications/{communicationId}/postflowaction")
	...
	public static class Builder {
		private final PatchConversationsCallParticipantCommunicationPostflowactionRequest request;

		private Builder() {
			request = new PatchConversationsCallParticipantCommunicationPostflowactionRequest();
		}
		...
		public Builder withBody(MandatoryPostCallActionInput body) {
		...
		public PatchConversationsCallParticipantCommunicationPostflowactionRequest build() {
