...
public class DeleteWorkforcemanagementBusinessunitTimeoffplanRequest {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for DeleteWorkforcemanagementBusinessunitTimeoffplanRequest.");
        }
        
        // verify the required parameter 'timeOffPlanId' is set
        if (this.timeOffPlanId == null) {
            throw new IllegalStateException("Missing the required parameter 'timeOffPlanId' when building request for DeleteWorkforcemanagementBusinessunitTimeoffplanRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/timeoffplans/{timeOffPlanId}")
	...
	public static class Builder {
		private final DeleteWorkforcemanagementBusinessunitTimeoffplanRequest request;

		private Builder() {
			request = new DeleteWorkforcemanagementBusinessunitTimeoffplanRequest();
		}
		...
		public DeleteWorkforcemanagementBusinessunitTimeoffplanRequest build() {
