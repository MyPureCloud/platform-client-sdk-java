...
public class DeleteQualityKeywordsetsRequest {
	...
	public DeleteQualityKeywordsetsRequest withIds(String ids) {
	    this.setIds(ids);
	    return this;
	} 
    ...
    public DeleteQualityKeywordsetsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.ids == null) {
            throw new IllegalStateException("Missing the required parameter 'ids' when building request for DeleteQualityKeywordsetsRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/quality/keywordsets")
	...
	public static class Builder {
		private final DeleteQualityKeywordsetsRequest request;

		private Builder() {
			request = new DeleteQualityKeywordsetsRequest();
		}
		...
		public DeleteQualityKeywordsetsRequest build() {
