...
public class PostConversationsVideosMeetingsRequest {

	private GenerateMeetingIdRequest body;
	public GenerateMeetingIdRequest getBody() {
		return this.body;
	}

	public void setBody(GenerateMeetingIdRequest body) {
		this.body = body;
	}

	public PostConversationsVideosMeetingsRequest withBody(GenerateMeetingIdRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostConversationsVideosMeetingsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<GenerateMeetingIdRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostConversationsVideosMeetingsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/conversations/videos/meetings")
                .withBody(body)
	...
	public static Builder builder(GenerateMeetingIdRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostConversationsVideosMeetingsRequest request;

		private Builder() {
			request = new PostConversationsVideosMeetingsRequest();
		}


		public Builder withBody(GenerateMeetingIdRequest body) {
		...
		public Builder withRequiredParams(GenerateMeetingIdRequest body) {
			request.setBody(body);
		...
		public PostConversationsVideosMeetingsRequest build() {
