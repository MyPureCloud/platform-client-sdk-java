...
public class TrustUserEntityListing  implements Serializable, PagedResource<TrustUser> {
  ...
  /**
   **/
  public TrustUserEntityListing entities(List<TrustUser> entities) {
  ...
  public List<TrustUser> getEntities() {
    return entities;
  }
  public void setEntities(List<TrustUser> entities) {
    this.entities = entities;
  }
  ...
  /**
   **/
  public TrustUserEntityListing pageSize(Integer pageSize) {
  ...
  /**
   **/
  public TrustUserEntityListing pageNumber(Integer pageNumber) {
  ...
  /**
   **/
  public TrustUserEntityListing total(Long total) {
    this.total = total;
    return this;
  }
  ...
  /**
   **/
  public TrustUserEntityListing lastUri(String lastUri) {
  ...
  /**
   **/
  public TrustUserEntityListing firstUri(String firstUri) {
  ...
  /**
   **/
  public TrustUserEntityListing selfUri(String selfUri) {
  ...
  /**
   **/
  public TrustUserEntityListing pageCount(Integer pageCount) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TrustUserEntityListing trustUserEntityListing = (TrustUserEntityListing) o;

    return Objects.equals(this.entities, trustUserEntityListing.entities) &&
            Objects.equals(this.pageSize, trustUserEntityListing.pageSize) &&
            Objects.equals(this.pageNumber, trustUserEntityListing.pageNumber) &&
