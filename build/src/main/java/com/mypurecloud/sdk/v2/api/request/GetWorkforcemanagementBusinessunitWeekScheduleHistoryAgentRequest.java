...
public class GetWorkforcemanagementBusinessunitWeekScheduleHistoryAgentRequest {
	...
	public GetWorkforcemanagementBusinessunitWeekScheduleHistoryAgentRequest withBusinessUnitId(String businessUnitId) {
	...
	public GetWorkforcemanagementBusinessunitWeekScheduleHistoryAgentRequest withWeekId(LocalDate weekId) {
	...
	public GetWorkforcemanagementBusinessunitWeekScheduleHistoryAgentRequest withScheduleId(String scheduleId) {
	...
	public GetWorkforcemanagementBusinessunitWeekScheduleHistoryAgentRequest withAgentId(String agentId) {
    ...
    public GetWorkforcemanagementBusinessunitWeekScheduleHistoryAgentRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for GetWorkforcemanagementBusinessunitWeekScheduleHistoryAgentRequest.");
        }
        
        // verify the required parameter 'weekId' is set
        if (this.weekId == null) {
            throw new IllegalStateException("Missing the required parameter 'weekId' when building request for GetWorkforcemanagementBusinessunitWeekScheduleHistoryAgentRequest.");
        }
        
        // verify the required parameter 'scheduleId' is set
        if (this.scheduleId == null) {
            throw new IllegalStateException("Missing the required parameter 'scheduleId' when building request for GetWorkforcemanagementBusinessunitWeekScheduleHistoryAgentRequest.");
        }
        
        // verify the required parameter 'agentId' is set
        if (this.agentId == null) {
            throw new IllegalStateException("Missing the required parameter 'agentId' when building request for GetWorkforcemanagementBusinessunitWeekScheduleHistoryAgentRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/weeks/{weekId}/schedules/{scheduleId}/history/agents/{agentId}")
	...
	public static Builder builder(String businessUnitId, LocalDate weekId, String scheduleId, String agentId) {
	    return new Builder()
	            .withRequiredParams(businessUnitId, weekId, scheduleId, agentId);
	}
	

	public static class Builder {
		private final GetWorkforcemanagementBusinessunitWeekScheduleHistoryAgentRequest request;

		private Builder() {
			request = new GetWorkforcemanagementBusinessunitWeekScheduleHistoryAgentRequest();
		}
		...
		public Builder withRequiredParams(String businessUnitId, LocalDate weekId, String scheduleId, String agentId) {
			request.setBusinessUnitId(businessUnitId);
						request.setWeekId(weekId);
						request.setScheduleId(scheduleId);
						request.setAgentId(agentId);
		...
		public GetWorkforcemanagementBusinessunitWeekScheduleHistoryAgentRequest build() {
