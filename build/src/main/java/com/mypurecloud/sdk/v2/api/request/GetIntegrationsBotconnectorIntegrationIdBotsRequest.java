...
public class GetIntegrationsBotconnectorIntegrationIdBotsRequest {
	...
	public GetIntegrationsBotconnectorIntegrationIdBotsRequest withIntegrationId(String integrationId) {
    ...
    public GetIntegrationsBotconnectorIntegrationIdBotsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.integrationId == null) {
            throw new IllegalStateException("Missing the required parameter 'integrationId' when building request for GetIntegrationsBotconnectorIntegrationIdBotsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/integrations/botconnector/{integrationId}/bots")
	...
	public static class Builder {
		private final GetIntegrationsBotconnectorIntegrationIdBotsRequest request;

		private Builder() {
			request = new GetIntegrationsBotconnectorIntegrationIdBotsRequest();
		}
		...
		public GetIntegrationsBotconnectorIntegrationIdBotsRequest build() {
