...
public class PostKnowledgeKnowledgebaseSourcesSalesforceRequest {
	...
	public PostKnowledgeKnowledgebaseSourcesSalesforceRequest withKnowledgeBaseId(String knowledgeBaseId) {
	...
	public PostKnowledgeKnowledgebaseSourcesSalesforceRequest withBody(SalesforceSourceRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostKnowledgeKnowledgebaseSourcesSalesforceRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<SalesforceSourceRequest> withHttpInfo() {
        ...
        if (this.knowledgeBaseId == null) {
            throw new IllegalStateException("Missing the required parameter 'knowledgeBaseId' when building request for PostKnowledgeKnowledgebaseSourcesSalesforceRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostKnowledgeKnowledgebaseSourcesSalesforceRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/sources/salesforce")
	...
	public static Builder builder(String knowledgeBaseId, SalesforceSourceRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostKnowledgeKnowledgebaseSourcesSalesforceRequest request;

		private Builder() {
			request = new PostKnowledgeKnowledgebaseSourcesSalesforceRequest();
		}
		...
		public Builder withRequiredParams(String knowledgeBaseId, SalesforceSourceRequest body) {
			request.setKnowledgeBaseId(knowledgeBaseId);
			request.setBody(body);
		...
		public PostKnowledgeKnowledgebaseSourcesSalesforceRequest build() {
