...
public class PostWorkforcemanagementShifttradingTradeStateJobsRequest {
	...
	public PostWorkforcemanagementShifttradingTradeStateJobsRequest withTradeId(String tradeId) {
	    this.setTradeId(tradeId);
	    return this;
	} 

	private UpdateShiftTradeStateJobRequest body;
	public UpdateShiftTradeStateJobRequest getBody() {
		return this.body;
	}

	public void setBody(UpdateShiftTradeStateJobRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementShifttradingTradeStateJobsRequest withBody(UpdateShiftTradeStateJobRequest body) {
	    this.setBody(body);
	    return this;
	} 
	...
	public PostWorkforcemanagementShifttradingTradeStateJobsRequest withForceAsync(Boolean forceAsync) {
    ...
    public PostWorkforcemanagementShifttradingTradeStateJobsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<UpdateShiftTradeStateJobRequest> withHttpInfo() {
        
        // verify the required parameter 'tradeId' is set
        if (this.tradeId == null) {
            throw new IllegalStateException("Missing the required parameter 'tradeId' when building request for PostWorkforcemanagementShifttradingTradeStateJobsRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementShifttradingTradeStateJobsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/shifttrading/trades/{tradeId}/state/jobs")
	...
	public static Builder builder(String tradeId, UpdateShiftTradeStateJobRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementShifttradingTradeStateJobsRequest request;

		private Builder() {
			request = new PostWorkforcemanagementShifttradingTradeStateJobsRequest();
		}
		...
		public Builder withBody(UpdateShiftTradeStateJobRequest body) {
		...
		public Builder withRequiredParams(String tradeId, UpdateShiftTradeStateJobRequest body) {
			request.setTradeId(tradeId);
			request.setBody(body);
		...
		public PostWorkforcemanagementShifttradingTradeStateJobsRequest build() {
