...
public class GetTaskmanagementWorktypeFlowsOnattributechangeRulesRequest {
	...
	public GetTaskmanagementWorktypeFlowsOnattributechangeRulesRequest withWorktypeId(String worktypeId) {
	...
	public GetTaskmanagementWorktypeFlowsOnattributechangeRulesRequest withAfter(String after) {
	    this.setAfter(after);
	    return this;
	} 
	...
	public GetTaskmanagementWorktypeFlowsOnattributechangeRulesRequest withPageSize(Integer pageSize) {
    ...
    public GetTaskmanagementWorktypeFlowsOnattributechangeRulesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.worktypeId == null) {
            throw new IllegalStateException("Missing the required parameter 'worktypeId' when building request for GetTaskmanagementWorktypeFlowsOnattributechangeRulesRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/taskmanagement/worktypes/{worktypeId}/flows/onattributechange/rules")
	...
	public static class Builder {
		private final GetTaskmanagementWorktypeFlowsOnattributechangeRulesRequest request;

		private Builder() {
			request = new GetTaskmanagementWorktypeFlowsOnattributechangeRulesRequest();
		}
		...
		public GetTaskmanagementWorktypeFlowsOnattributechangeRulesRequest build() {
