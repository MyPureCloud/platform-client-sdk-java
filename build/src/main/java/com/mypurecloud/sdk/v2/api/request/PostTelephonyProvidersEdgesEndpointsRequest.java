...
public class PostTelephonyProvidersEdgesEndpointsRequest {
	...
	public PostTelephonyProvidersEdgesEndpointsRequest withBody(Endpoint body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostTelephonyProvidersEdgesEndpointsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Endpoint> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostTelephonyProvidersEdgesEndpointsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/telephony/providers/edges/endpoints")
                .withBody(body)
	...
	public static Builder builder(Endpoint body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostTelephonyProvidersEdgesEndpointsRequest request;

		private Builder() {
			request = new PostTelephonyProvidersEdgesEndpointsRequest();
		}
		...
		public Builder withRequiredParams(Endpoint body) {
			request.setBody(body);
		...
		public PostTelephonyProvidersEdgesEndpointsRequest build() {
