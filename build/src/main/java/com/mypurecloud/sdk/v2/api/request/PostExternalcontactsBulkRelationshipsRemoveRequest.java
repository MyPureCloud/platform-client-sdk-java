...
public class PostExternalcontactsBulkRelationshipsRemoveRequest {
	...
	public PostExternalcontactsBulkRelationshipsRemoveRequest withBody(BulkIdsRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public ApiRequest<BulkIdsRequest> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostExternalcontactsBulkRelationshipsRemoveRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/externalcontacts/bulk/relationships/remove")
                .withBody(body)
	...
	public static class Builder {
		private final PostExternalcontactsBulkRelationshipsRemoveRequest request;

		private Builder() {
			request = new PostExternalcontactsBulkRelationshipsRemoveRequest();
		}
		...
		public PostExternalcontactsBulkRelationshipsRemoveRequest build() {
