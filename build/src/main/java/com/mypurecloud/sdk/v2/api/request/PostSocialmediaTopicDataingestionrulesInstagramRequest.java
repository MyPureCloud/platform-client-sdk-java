...
public class PostSocialmediaTopicDataingestionrulesInstagramRequest {
	...
	public PostSocialmediaTopicDataingestionrulesInstagramRequest withTopicId(String topicId) {
	    this.setTopicId(topicId);
	    return this;
	} 

	private InstagramDataIngestionRuleRequest body;
	public InstagramDataIngestionRuleRequest getBody() {
		return this.body;
	}

	public void setBody(InstagramDataIngestionRuleRequest body) {
		this.body = body;
	}

	public PostSocialmediaTopicDataingestionrulesInstagramRequest withBody(InstagramDataIngestionRuleRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostSocialmediaTopicDataingestionrulesInstagramRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<InstagramDataIngestionRuleRequest> withHttpInfo() {
        
        // verify the required parameter 'topicId' is set
        if (this.topicId == null) {
            throw new IllegalStateException("Missing the required parameter 'topicId' when building request for PostSocialmediaTopicDataingestionrulesInstagramRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/socialmedia/topics/{topicId}/dataingestionrules/instagram")
	...
	public static class Builder {
		private final PostSocialmediaTopicDataingestionrulesInstagramRequest request;

		private Builder() {
			request = new PostSocialmediaTopicDataingestionrulesInstagramRequest();
		}
		...
		public Builder withBody(InstagramDataIngestionRuleRequest body) {
		...
		public PostSocialmediaTopicDataingestionrulesInstagramRequest build() {
