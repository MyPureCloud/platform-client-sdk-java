...
public class PostConversationsChatParticipantReplaceRequest {
	...
	public PostConversationsChatParticipantReplaceRequest withChatId(String chatId) {
	...
	public PostConversationsChatParticipantReplaceRequest withParticipantId(String participantId) {
	...
	public PostConversationsChatParticipantReplaceRequest withBody(TransferRequest body) {
	    this.setBody(body);
	    return this;
	}
    ...
    public PostConversationsChatParticipantReplaceRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<TransferRequest> withHttpInfo() throws ApiException {
        ...
        if (this.chatId == null) {
            throw new ApiException(400, "Missing the required parameter 'chatId' when building request for PostConversationsChatParticipantReplaceRequest.");
        }
        
        // verify the required parameter 'participantId' is set
        if (this.participantId == null) {
            throw new ApiException(400, "Missing the required parameter 'participantId' when building request for PostConversationsChatParticipantReplaceRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new ApiException(400, "Missing the required parameter 'body' when building request for PostConversationsChatParticipantReplaceRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/conversations/chats/{chatId}/participants/{participantId}/replace")
	...
	public static Builder builder(String chatId, String participantId, TransferRequest body) {
	    return new Builder()
	            .withRequiredParams(chatId, participantId, body);
	}
	...
	public static class Builder {
		...
		private Builder() {
			request = new PostConversationsChatParticipantReplaceRequest();
		}
		...
		public Builder withRequiredParams(String chatId, String participantId, TransferRequest body) {
			request.setChatId(chatId);
			request.setParticipantId(participantId);
			request.setBody(body);
			return this;
