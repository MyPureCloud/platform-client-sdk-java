...
public class DeleteRecordingMediaretentionpolicyRequest {
	...
	public DeleteRecordingMediaretentionpolicyRequest withPolicyId(String policyId) {
    ...
    public DeleteRecordingMediaretentionpolicyRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.policyId == null) {
            throw new IllegalStateException("Missing the required parameter 'policyId' when building request for DeleteRecordingMediaretentionpolicyRequest.");
        }
