...
public class GetMessagingIntegrationsTwitterIntegrationIdRequest {
	...
	public GetMessagingIntegrationsTwitterIntegrationIdRequest withIntegrationId(String integrationId) {
    ...
    public GetMessagingIntegrationsTwitterIntegrationIdRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.integrationId == null) {
            throw new IllegalStateException("Missing the required parameter 'integrationId' when building request for GetMessagingIntegrationsTwitterIntegrationIdRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/messaging/integrations/twitter/{integrationId}")
	...
	public static class Builder {
		private final GetMessagingIntegrationsTwitterIntegrationIdRequest request;

		private Builder() {
			request = new GetMessagingIntegrationsTwitterIntegrationIdRequest();
		}
		...
		public GetMessagingIntegrationsTwitterIntegrationIdRequest build() {
