...
public class GetAnalyticsTranscriptsAggregatesJobRequest {
	...
	public GetAnalyticsTranscriptsAggregatesJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetAnalyticsTranscriptsAggregatesJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetAnalyticsTranscriptsAggregatesJobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/analytics/transcripts/aggregates/jobs/{jobId}")
	...
	public static class Builder {
		private final GetAnalyticsTranscriptsAggregatesJobRequest request;

		private Builder() {
			request = new GetAnalyticsTranscriptsAggregatesJobRequest();
		}
		...
		public GetAnalyticsTranscriptsAggregatesJobRequest build() {
