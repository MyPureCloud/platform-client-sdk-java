...
public class GetWorkforcemanagementManagementunitShifttradesMatchedRequest {
	...
	public GetWorkforcemanagementManagementunitShifttradesMatchedRequest withMuId(String muId) {
	    this.setMuId(muId);
	    return this;
	} 
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.muId == null) {
            throw new IllegalStateException("Missing the required parameter 'muId' when building request for GetWorkforcemanagementManagementunitShifttradesMatchedRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/managementunits/{muId}/shifttrades/matched")
