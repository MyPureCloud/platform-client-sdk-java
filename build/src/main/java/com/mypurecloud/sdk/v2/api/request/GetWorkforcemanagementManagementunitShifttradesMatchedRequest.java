...
public class GetWorkforcemanagementManagementunitShifttradesMatchedRequest {
	...
	public GetWorkforcemanagementManagementunitShifttradesMatchedRequest withManagementUnitId(String managementUnitId) {
    ...
    public GetWorkforcemanagementManagementunitShifttradesMatchedRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.managementUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'managementUnitId' when building request for GetWorkforcemanagementManagementunitShifttradesMatchedRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/managementunits/{managementUnitId}/shifttrades/matched")
	...
	public static class Builder {
		private final GetWorkforcemanagementManagementunitShifttradesMatchedRequest request;

		private Builder() {
			request = new GetWorkforcemanagementManagementunitShifttradesMatchedRequest();
		}
		...
		public GetWorkforcemanagementManagementunitShifttradesMatchedRequest build() {
