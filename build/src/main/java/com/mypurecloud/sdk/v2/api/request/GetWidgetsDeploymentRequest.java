...
public class GetWidgetsDeploymentRequest {
	...
	public GetWidgetsDeploymentRequest withDeploymentId(String deploymentId) {
    ...
    public GetWidgetsDeploymentRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.deploymentId == null) {
            throw new IllegalStateException("Missing the required parameter 'deploymentId' when building request for GetWidgetsDeploymentRequest.");
        }
