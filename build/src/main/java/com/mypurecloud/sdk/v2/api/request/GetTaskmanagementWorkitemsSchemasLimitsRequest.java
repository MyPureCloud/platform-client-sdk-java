...
public class GetTaskmanagementWorkitemsSchemasLimitsRequest {
    ...
    public GetTaskmanagementWorkitemsSchemasLimitsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/taskmanagement/workitems/schemas/limits")
	...
	public static class Builder {
		private final GetTaskmanagementWorkitemsSchemasLimitsRequest request;

		private Builder() {
			request = new GetTaskmanagementWorkitemsSchemasLimitsRequest();
		}
		...
		public GetTaskmanagementWorkitemsSchemasLimitsRequest build() {
