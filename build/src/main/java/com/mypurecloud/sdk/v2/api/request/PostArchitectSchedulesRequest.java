...
public class PostArchitectSchedulesRequest {
	...
	public PostArchitectSchedulesRequest withBody(Schedule body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostArchitectSchedulesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Schedule> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostArchitectSchedulesRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/architect/schedules")
                .withBody(body)
	...
	public static Builder builder(Schedule body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostArchitectSchedulesRequest request;

		private Builder() {
			request = new PostArchitectSchedulesRequest();
		}
		...
		public Builder withRequiredParams(Schedule body) {
			request.setBody(body);
		...
		public PostArchitectSchedulesRequest build() {
