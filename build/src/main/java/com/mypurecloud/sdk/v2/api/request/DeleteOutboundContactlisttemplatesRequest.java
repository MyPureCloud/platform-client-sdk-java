...
public class DeleteOutboundContactlisttemplatesRequest {
	...
	public DeleteOutboundContactlisttemplatesRequest withId(List<String> id) {
	    this.setId(id);
	    return this;
	} 
    ...
    public DeleteOutboundContactlisttemplatesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.id == null) {
            throw new IllegalStateException("Missing the required parameter 'id' when building request for DeleteOutboundContactlisttemplatesRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/outbound/contactlisttemplates")
	...
	public static class Builder {
		private final DeleteOutboundContactlisttemplatesRequest request;

		private Builder() {
			request = new DeleteOutboundContactlisttemplatesRequest();
		}
		...
		public DeleteOutboundContactlisttemplatesRequest build() {
