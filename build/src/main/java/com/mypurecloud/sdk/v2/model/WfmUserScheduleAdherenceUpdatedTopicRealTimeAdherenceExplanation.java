...
public class WfmUserScheduleAdherenceUpdatedTopicRealTimeAdherenceExplanation  implements Serializable {
 ...
 @JsonDeserialize(using = StatusEnumDeserializer.class)
  ...
  public WfmUserScheduleAdherenceUpdatedTopicRealTimeAdherenceExplanation() {
  ...
  /**
   **/
  public WfmUserScheduleAdherenceUpdatedTopicRealTimeAdherenceExplanation id(String id) {
    this.id = id;
    return this;
  }
  ...
  /**
   **/
  public WfmUserScheduleAdherenceUpdatedTopicRealTimeAdherenceExplanation lengthMinutes(Long lengthMinutes) {
