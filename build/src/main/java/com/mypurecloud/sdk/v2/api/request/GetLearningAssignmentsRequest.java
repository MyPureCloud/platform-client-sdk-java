...
public class GetLearningAssignmentsRequest {
	...
	public GetLearningAssignmentsRequest withModuleId(String moduleId) {
	...
	public GetLearningAssignmentsRequest withInterval(String interval) {
	...
	public GetLearningAssignmentsRequest withCompletionInterval(String completionInterval) {
	...
	public GetLearningAssignmentsRequest withOverdue(String overdue) {
	...
	public GetLearningAssignmentsRequest withPageSize(Integer pageSize) {
	...
	public GetLearningAssignmentsRequest withPageNumber(Integer pageNumber) {
	...
	public GetLearningAssignmentsRequest withPass(String pass) {
	    this.setPass(pass);
	    return this;
	} 
	...
	public GetLearningAssignmentsRequest withMinPercentageScore(Float minPercentageScore) {
	...
	public GetLearningAssignmentsRequest withMaxPercentageScore(Float maxPercentageScore) {
	...
	public GetLearningAssignmentsRequest withSortOrder(String sortOrder) {
	...
	public GetLearningAssignmentsRequest withSortBy(String sortBy) {
	...
	public GetLearningAssignmentsRequest withUserId(List<String> userId) {
	...
	public GetLearningAssignmentsRequest withTypes(List<String> types) {
	    this.setTypes(types);
	    return this;
	} 
	...
	public GetLearningAssignmentsRequest withStates(List<String> states) {
	...
	public GetLearningAssignmentsRequest withExpand(List<String> expand) {
    ...
    public GetLearningAssignmentsRequest withCustomHeader(String name, String value) {
