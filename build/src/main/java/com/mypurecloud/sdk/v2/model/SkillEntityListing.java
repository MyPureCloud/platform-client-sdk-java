...
public class SkillEntityListing  implements Serializable, PagedResource<RoutingSkill> {
  
  private List<RoutingSkill> entities = new ArrayList<RoutingSkill>();
  ...
  /**
   **/
  public SkillEntityListing entities(List<RoutingSkill> entities) {
  ...
  public List<RoutingSkill> getEntities() {
    return entities;
  }
  public void setEntities(List<RoutingSkill> entities) {
    this.entities = entities;
  }
