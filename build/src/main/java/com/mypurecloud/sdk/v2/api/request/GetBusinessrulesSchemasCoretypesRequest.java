...
public class GetBusinessrulesSchemasCoretypesRequest {
    ...
    public GetBusinessrulesSchemasCoretypesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/businessrules/schemas/coretypes")
	...
	public static class Builder {
		private final GetBusinessrulesSchemasCoretypesRequest request;

		private Builder() {
			request = new GetBusinessrulesSchemasCoretypesRequest();
		}
		...
		public GetBusinessrulesSchemasCoretypesRequest build() {
