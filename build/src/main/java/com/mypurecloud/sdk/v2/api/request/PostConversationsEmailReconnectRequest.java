...
public class PostConversationsEmailReconnectRequest {
	...
	public PostConversationsEmailReconnectRequest withConversationId(String conversationId) {
    ...
    public PostConversationsEmailReconnectRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PostConversationsEmailReconnectRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/conversations/emails/{conversationId}/reconnect")
	...
	public static class Builder {
		private final PostConversationsEmailReconnectRequest request;

		private Builder() {
			request = new PostConversationsEmailReconnectRequest();
		}
		...
		public PostConversationsEmailReconnectRequest build() {
