...
public class PostExternalcontactsBulkOrganizationsUpdateRequest {
    
	private BulkOrganizationsRequest body;
	public BulkOrganizationsRequest getBody() {
		return this.body;
	}

	public void setBody(BulkOrganizationsRequest body) {
		this.body = body;
	}

	public PostExternalcontactsBulkOrganizationsUpdateRequest withBody(BulkOrganizationsRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostExternalcontactsBulkOrganizationsUpdateRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<BulkOrganizationsRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostExternalcontactsBulkOrganizationsUpdateRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/externalcontacts/bulk/organizations/update")
                .withBody(body)
	...
	public static Builder builder(BulkOrganizationsRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostExternalcontactsBulkOrganizationsUpdateRequest request;

		private Builder() {
			request = new PostExternalcontactsBulkOrganizationsUpdateRequest();
		}

		
		public Builder withBody(BulkOrganizationsRequest body) {
		...
		public Builder withRequiredParams(BulkOrganizationsRequest body) {
			request.setBody(body);
		...
		public PostExternalcontactsBulkOrganizationsUpdateRequest build() {
