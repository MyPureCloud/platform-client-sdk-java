...
public class DeleteRoutingSmsPhonenumberRequest {
    ...
    public DeleteRoutingSmsPhonenumberRequest withCustomHeader(String name, String value) {
	...
	public static class Builder {
		private final DeleteRoutingSmsPhonenumberRequest request;

		private Builder() {
			request = new DeleteRoutingSmsPhonenumberRequest();
		}
