...
public class DeleteArchitectPromptResourceAudioRequest {
	...
	public DeleteArchitectPromptResourceAudioRequest withPromptId(String promptId) {
	...
	public DeleteArchitectPromptResourceAudioRequest withLanguageCode(String languageCode) {
    ...
    public DeleteArchitectPromptResourceAudioRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.promptId == null) {
            throw new IllegalStateException("Missing the required parameter 'promptId' when building request for DeleteArchitectPromptResourceAudioRequest.");
        }
        
        // verify the required parameter 'languageCode' is set
        if (this.languageCode == null) {
            throw new IllegalStateException("Missing the required parameter 'languageCode' when building request for DeleteArchitectPromptResourceAudioRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/architect/prompts/{promptId}/resources/{languageCode}/audio")
	...
	public static class Builder {
		private final DeleteArchitectPromptResourceAudioRequest request;

		private Builder() {
			request = new DeleteArchitectPromptResourceAudioRequest();
		}
		...
		public DeleteArchitectPromptResourceAudioRequest build() {
