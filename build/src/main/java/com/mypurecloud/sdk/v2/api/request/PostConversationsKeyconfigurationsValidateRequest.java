...
public class PostConversationsKeyconfigurationsValidateRequest {
	...
	public PostConversationsKeyconfigurationsValidateRequest withBody(ConversationEncryptionConfiguration body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostConversationsKeyconfigurationsValidateRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<ConversationEncryptionConfiguration> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostConversationsKeyconfigurationsValidateRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/conversations/keyconfigurations/validate")
                .withBody(body)
	...
	public static Builder builder(ConversationEncryptionConfiguration body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostConversationsKeyconfigurationsValidateRequest request;

		private Builder() {
			request = new PostConversationsKeyconfigurationsValidateRequest();
		}
		...
		public Builder withRequiredParams(ConversationEncryptionConfiguration body) {
			request.setBody(body);
		...
		public PostConversationsKeyconfigurationsValidateRequest build() {
