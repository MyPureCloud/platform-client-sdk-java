...
public class PutTelephonyProvidersEdgesSiteSiteconnectionsRequest {
	...
	public PutTelephonyProvidersEdgesSiteSiteconnectionsRequest withSiteId(String siteId) {
	    this.setSiteId(siteId);
	    return this;
	} 

	private SiteConnections body;
	public SiteConnections getBody() {
		return this.body;
	}

	public void setBody(SiteConnections body) {
		this.body = body;
	}

	public PutTelephonyProvidersEdgesSiteSiteconnectionsRequest withBody(SiteConnections body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutTelephonyProvidersEdgesSiteSiteconnectionsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<SiteConnections> withHttpInfo() {
        
        // verify the required parameter 'siteId' is set
        if (this.siteId == null) {
            throw new IllegalStateException("Missing the required parameter 'siteId' when building request for PutTelephonyProvidersEdgesSiteSiteconnectionsRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutTelephonyProvidersEdgesSiteSiteconnectionsRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/telephony/providers/edges/sites/{siteId}/siteconnections")
	...
	public static Builder builder(String siteId, SiteConnections body) {
	    return new Builder()
	...
	public static class Builder {
		private final PutTelephonyProvidersEdgesSiteSiteconnectionsRequest request;

		private Builder() {
			request = new PutTelephonyProvidersEdgesSiteSiteconnectionsRequest();
		}
		...
		public Builder withBody(SiteConnections body) {
		...
		public Builder withRequiredParams(String siteId, SiteConnections body) {
			request.setSiteId(siteId);
			request.setBody(body);
		...
		public PutTelephonyProvidersEdgesSiteSiteconnectionsRequest build() {
