...
public class PostWorkforcemanagementAgentsOpportunitiesEnrollmentsBulkAddRequest {

	private AgentBulkAddOpportunityEnrollmentsRequest body;
	public AgentBulkAddOpportunityEnrollmentsRequest getBody() {
		return this.body;
	}

	public void setBody(AgentBulkAddOpportunityEnrollmentsRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementAgentsOpportunitiesEnrollmentsBulkAddRequest withBody(AgentBulkAddOpportunityEnrollmentsRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementAgentsOpportunitiesEnrollmentsBulkAddRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<AgentBulkAddOpportunityEnrollmentsRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementAgentsOpportunitiesEnrollmentsBulkAddRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/agents/opportunities/enrollments/bulk/add")
                .withBody(body)
	...
	public static Builder builder(AgentBulkAddOpportunityEnrollmentsRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementAgentsOpportunitiesEnrollmentsBulkAddRequest request;

		private Builder() {
			request = new PostWorkforcemanagementAgentsOpportunitiesEnrollmentsBulkAddRequest();
		}


		public Builder withBody(AgentBulkAddOpportunityEnrollmentsRequest body) {
		...
		public Builder withRequiredParams(AgentBulkAddOpportunityEnrollmentsRequest body) {
			request.setBody(body);
		...
		public PostWorkforcemanagementAgentsOpportunitiesEnrollmentsBulkAddRequest build() {
