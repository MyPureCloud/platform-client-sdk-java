...
public class GetRoutingSkillgroupsRequest {
	...
	public GetRoutingSkillgroupsRequest withPageSize(Integer pageSize) {
	...
	public GetRoutingSkillgroupsRequest withName(String name) {
	    this.setName(name);
	    return this;
	} 
	...
	public GetRoutingSkillgroupsRequest withAfter(String after) {
	    this.setAfter(after);
	    return this;
	} 
	...
	public GetRoutingSkillgroupsRequest withBefore(String before) {
    ...
    public GetRoutingSkillgroupsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/routing/skillgroups")
	...
	public static class Builder {
		private final GetRoutingSkillgroupsRequest request;

		private Builder() {
			request = new GetRoutingSkillgroupsRequest();
		}
		...
		public GetRoutingSkillgroupsRequest build() {
