...
public class PostConversationSuggestionEngagementRequest {
    ...
    public ApiRequest<SuggestionEngagement> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("POST", "/api/v2/conversations/{conversationId}/suggestions/{suggestionId}/engagement")
	...
	public static class Builder {
		...
		private Builder() {
			request = new PostConversationSuggestionEngagementRequest();
		}
