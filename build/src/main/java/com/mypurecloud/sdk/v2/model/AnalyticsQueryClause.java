...
public class AnalyticsQueryClause  implements Serializable {
   ...
   * Boolean operation to apply to the provided predicates
   **/
  public AnalyticsQueryClause type(TypeEnum type) {
    this.type = type;
    return this;
  }
   ...
   **/
  public AnalyticsQueryClause predicates(List<AnalyticsQueryPredicate> predicates) {
    this.predicates = predicates;
    return this;
  }
  
  @ApiModelProperty(example = "null", required = true, value = "Like a three-word sentence: (attribute-name) (operator) (target-value). These can be one of three types: dimension, property, metric.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.type, analyticsQueryClause.type) &&
        Objects.equals(this.predicates, analyticsQueryClause.predicates);
  }
