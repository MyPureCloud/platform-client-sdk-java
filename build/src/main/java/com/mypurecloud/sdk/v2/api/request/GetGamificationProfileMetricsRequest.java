...
public class GetGamificationProfileMetricsRequest {
	...
	public GetGamificationProfileMetricsRequest withMetricIds(String metricIds) {
	    this.setMetricIds(metricIds);
	    return this;
	} 
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/gamification/profiles/{profileId}/metrics")
                ...
                .withQueryParameters("metricIds", "", metricIds)
	...
	public static class Builder {
		private final GetGamificationProfileMetricsRequest request;

		private Builder() {
			request = new GetGamificationProfileMetricsRequest();
		}
		...
		public Builder withMetricIds(String metricIds) {
			request.setMetricIds(metricIds);
			return this;
		}
