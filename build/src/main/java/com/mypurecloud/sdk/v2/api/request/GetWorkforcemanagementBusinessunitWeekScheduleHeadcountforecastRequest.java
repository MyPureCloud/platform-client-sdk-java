...
public class GetWorkforcemanagementBusinessunitWeekScheduleHeadcountforecastRequest {
	...
	public GetWorkforcemanagementBusinessunitWeekScheduleHeadcountforecastRequest withBusinessUnitId(String businessUnitId) {
	...
	public GetWorkforcemanagementBusinessunitWeekScheduleHeadcountforecastRequest withWeekId(LocalDate weekId) {
	...
	public GetWorkforcemanagementBusinessunitWeekScheduleHeadcountforecastRequest withScheduleId(String scheduleId) {
	...
	public GetWorkforcemanagementBusinessunitWeekScheduleHeadcountforecastRequest withForceDownload(Boolean forceDownload) {
    ...
    public GetWorkforcemanagementBusinessunitWeekScheduleHeadcountforecastRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for GetWorkforcemanagementBusinessunitWeekScheduleHeadcountforecastRequest.");
        }
        
        // verify the required parameter 'weekId' is set
        if (this.weekId == null) {
            throw new IllegalStateException("Missing the required parameter 'weekId' when building request for GetWorkforcemanagementBusinessunitWeekScheduleHeadcountforecastRequest.");
        }
        
        // verify the required parameter 'scheduleId' is set
        if (this.scheduleId == null) {
            throw new IllegalStateException("Missing the required parameter 'scheduleId' when building request for GetWorkforcemanagementBusinessunitWeekScheduleHeadcountforecastRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/weeks/{weekId}/schedules/{scheduleId}/headcountforecast")
                ...
                .withQueryParameters("forceDownload", "", forceDownload)
	...
	public static Builder builder(String businessUnitId, LocalDate weekId, String scheduleId) {
	    return new Builder()
	...
	public static class Builder {
		private final GetWorkforcemanagementBusinessunitWeekScheduleHeadcountforecastRequest request;

		private Builder() {
			request = new GetWorkforcemanagementBusinessunitWeekScheduleHeadcountforecastRequest();
		}
		...
		public Builder withForceDownload(Boolean forceDownload) {
		...
		public Builder withRequiredParams(String businessUnitId, LocalDate weekId, String scheduleId) {
			request.setBusinessUnitId(businessUnitId);
						request.setWeekId(weekId);
						request.setScheduleId(scheduleId);
		...
		public GetWorkforcemanagementBusinessunitWeekScheduleHeadcountforecastRequest build() {
