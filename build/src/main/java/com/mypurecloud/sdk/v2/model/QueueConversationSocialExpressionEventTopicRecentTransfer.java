...
public class QueueConversationSocialExpressionEventTopicRecentTransfer  implements Serializable {
 ...
 @JsonDeserialize(using = TransferTypeEnumDeserializer.class)
   ...
   **/
  public QueueConversationSocialExpressionEventTopicRecentTransfer id(String id) {
    this.id = id;
    return this;
  }
  ...
  /**
   **/
  public QueueConversationSocialExpressionEventTopicRecentTransfer state(StateEnum state) {
    this.state = state;
    return this;
  }
   ...
   **/
  public QueueConversationSocialExpressionEventTopicRecentTransfer dateIssued(Date dateIssued) {
  ...
  /**
   **/
  public QueueConversationSocialExpressionEventTopicRecentTransfer initiator(QueueConversationSocialExpressionEventTopicInitiator initiator) {
  ...
  public QueueConversationSocialExpressionEventTopicInitiator getInitiator() {
    return initiator;
  }
  public void setInitiator(QueueConversationSocialExpressionEventTopicInitiator initiator) {
    this.initiator = initiator;
  }
  ...
  public QueueConversationSocialExpressionEventTopicDestination getDestination() {
    return destination;
  }
  public void setDestination(QueueConversationSocialExpressionEventTopicDestination destination) {
    this.destination = destination;
  }
   ...
   * The type of transfer to perform.
   **/
  public QueueConversationSocialExpressionEventTopicRecentTransfer transferType(TransferTypeEnum transferType) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    QueueConversationSocialExpressionEventTopicRecentTransfer queueConversationSocialExpressionEventTopicRecentTransfer = (QueueConversationSocialExpressionEventTopicRecentTransfer) o;

    return Objects.equals(this.id, queueConversationSocialExpressionEventTopicRecentTransfer.id) &&
  ...
  public String toString() {
    ...
    sb.append("class QueueConversationSocialExpressionEventTopicRecentTransfer {\n");
