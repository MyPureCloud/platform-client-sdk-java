...
public class GetTaskmanagementWorktypeStatusRequest {
	...
	public GetTaskmanagementWorktypeStatusRequest withWorktypeId(String worktypeId) {
	...
	public GetTaskmanagementWorktypeStatusRequest withStatusId(String statusId) {
    ...
    public GetTaskmanagementWorktypeStatusRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.worktypeId == null) {
            throw new IllegalStateException("Missing the required parameter 'worktypeId' when building request for GetTaskmanagementWorktypeStatusRequest.");
        }
        
        // verify the required parameter 'statusId' is set
        if (this.statusId == null) {
            throw new IllegalStateException("Missing the required parameter 'statusId' when building request for GetTaskmanagementWorktypeStatusRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/taskmanagement/worktypes/{worktypeId}/statuses/{statusId}")
	...
	public static class Builder {
		private final GetTaskmanagementWorktypeStatusRequest request;

		private Builder() {
			request = new GetTaskmanagementWorktypeStatusRequest();
		}
		...
		public GetTaskmanagementWorktypeStatusRequest build() {
