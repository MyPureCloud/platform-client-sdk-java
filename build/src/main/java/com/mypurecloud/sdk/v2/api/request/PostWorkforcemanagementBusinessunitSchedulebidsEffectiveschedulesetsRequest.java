...
public class PostWorkforcemanagementBusinessunitSchedulebidsEffectiveschedulesetsRequest {
	...
	public PostWorkforcemanagementBusinessunitSchedulebidsEffectiveschedulesetsRequest withBusinessUnitId(String businessUnitId) {
	    this.setBusinessUnitId(businessUnitId);
	    return this;
	} 

	private QueryEffectiveScheduleSetsRequest body;
	public QueryEffectiveScheduleSetsRequest getBody() {
		return this.body;
	}

	public void setBody(QueryEffectiveScheduleSetsRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementBusinessunitSchedulebidsEffectiveschedulesetsRequest withBody(QueryEffectiveScheduleSetsRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementBusinessunitSchedulebidsEffectiveschedulesetsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<QueryEffectiveScheduleSetsRequest> withHttpInfo() {
        
        // verify the required parameter 'businessUnitId' is set
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PostWorkforcemanagementBusinessunitSchedulebidsEffectiveschedulesetsRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementBusinessunitSchedulebidsEffectiveschedulesetsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/schedulebids/effectiveschedulesets")
	...
	public static Builder builder(String businessUnitId, QueryEffectiveScheduleSetsRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementBusinessunitSchedulebidsEffectiveschedulesetsRequest request;

		private Builder() {
			request = new PostWorkforcemanagementBusinessunitSchedulebidsEffectiveschedulesetsRequest();
		}
		...
		public Builder withBody(QueryEffectiveScheduleSetsRequest body) {
		...
		public Builder withRequiredParams(String businessUnitId, QueryEffectiveScheduleSetsRequest body) {
			request.setBusinessUnitId(businessUnitId);
			request.setBody(body);
		...
		public PostWorkforcemanagementBusinessunitSchedulebidsEffectiveschedulesetsRequest build() {
