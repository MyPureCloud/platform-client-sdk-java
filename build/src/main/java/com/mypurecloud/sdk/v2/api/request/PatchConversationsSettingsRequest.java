...
public class PatchConversationsSettingsRequest {

	private Settings body;
	public Settings getBody() {
		return this.body;
	}

	public void setBody(Settings body) {
		this.body = body;
	}

	public PatchConversationsSettingsRequest withBody(Settings body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchConversationsSettingsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<Settings> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchConversationsSettingsRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/conversations/settings")
                .withBody(body)
	...
	public static Builder builder(Settings body) {
	    return new Builder()
	...
	public static class Builder {
		private final PatchConversationsSettingsRequest request;

		private Builder() {
			request = new PatchConversationsSettingsRequest();
		}


		public Builder withBody(Settings body) {
		...
		public Builder withRequiredParams(Settings body) {
			request.setBody(body);
		...
		public PatchConversationsSettingsRequest build() {
