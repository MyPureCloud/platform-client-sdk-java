...
public class TopicJob  implements Serializable {
 ...
 @JsonDeserialize(using = StateEnumDeserializer.class)
   ...
   **/
  public TopicJob dateCreated(Date dateCreated) {
   ...
   * Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss[.mmm]Z
   **/
  public TopicJob dateModified(Date dateModified) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, state, topics, createdBy, dateCreated, dateModified, selfUri);
  }
