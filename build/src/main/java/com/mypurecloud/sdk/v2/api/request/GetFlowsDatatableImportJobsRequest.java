...
public class GetFlowsDatatableImportJobsRequest {
	...
	public GetFlowsDatatableImportJobsRequest withDatatableId(String datatableId) {
	...
	public GetFlowsDatatableImportJobsRequest withPageNumber(Integer pageNumber) {
	...
	public GetFlowsDatatableImportJobsRequest withPageSize(Integer pageSize) {
    ...
    public GetFlowsDatatableImportJobsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.datatableId == null) {
            throw new IllegalStateException("Missing the required parameter 'datatableId' when building request for GetFlowsDatatableImportJobsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/flows/datatables/{datatableId}/import/jobs")
	...
	public static class Builder {
		private final GetFlowsDatatableImportJobsRequest request;

		private Builder() {
			request = new GetFlowsDatatableImportJobsRequest();
		}
		...
		public GetFlowsDatatableImportJobsRequest build() {
