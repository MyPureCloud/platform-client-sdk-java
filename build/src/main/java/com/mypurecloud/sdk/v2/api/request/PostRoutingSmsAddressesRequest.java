...
public class PostRoutingSmsAddressesRequest {
    
	private SmsAddressProvision body;
	public SmsAddressProvision getBody() {
		return this.body;
	}

	public void setBody(SmsAddressProvision body) {
		this.body = body;
	}

	public PostRoutingSmsAddressesRequest withBody(SmsAddressProvision body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostRoutingSmsAddressesRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<SmsAddressProvision> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostRoutingSmsAddressesRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/routing/sms/addresses")
                .withBody(body)
	...
	public static Builder builder(SmsAddressProvision body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostRoutingSmsAddressesRequest request;

		private Builder() {
			request = new PostRoutingSmsAddressesRequest();
		}

		
		public Builder withBody(SmsAddressProvision body) {
		...
		public Builder withRequiredParams(SmsAddressProvision body) {
			request.setBody(body);
		...
		public PostRoutingSmsAddressesRequest build() {
