...
public class AgentAdherenceDayMetrics  implements Serializable {
  ...
  @ApiModelProperty(example = "null", required = true, value = "Start of day offset in seconds relative to query start time")
  ...
  @ApiModelProperty(example = "null", required = true, value = "Duration of schedule in seconds included for adherence percentage calculation")
  ...
  @ApiModelProperty(example = "null", required = true, value = "Total number of adherence exceptions for this user")
  ...
  @ApiModelProperty(example = "null", required = true, value = "Total duration in seconds of adherence exceptions for this user")
  ...
  @ApiModelProperty(example = "null", required = true, value = "The impact duration in seconds of current adherence state for this user")
  ...
  @ApiModelProperty(example = "null", required = true, value = "Total duration in seconds for all scheduled activities")
  ...
  @ApiModelProperty(example = "null", required = true, value = "Total duration in seconds for all actually worked activities")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    AgentAdherenceDayMetrics agentAdherenceDayMetrics = (AgentAdherenceDayMetrics) o;

    return Objects.equals(this.dayStartOffsetSeconds, agentAdherenceDayMetrics.dayStartOffsetSeconds) &&
            Objects.equals(this.adherenceScheduleSeconds, agentAdherenceDayMetrics.adherenceScheduleSeconds) &&
            Objects.equals(this.conformanceScheduleSeconds, agentAdherenceDayMetrics.conformanceScheduleSeconds) &&
            Objects.equals(this.conformanceActualSeconds, agentAdherenceDayMetrics.conformanceActualSeconds) &&
            Objects.equals(this.exceptionCount, agentAdherenceDayMetrics.exceptionCount) &&
            Objects.equals(this.exceptionDurationSeconds, agentAdherenceDayMetrics.exceptionDurationSeconds) &&
            Objects.equals(this.impactSeconds, agentAdherenceDayMetrics.impactSeconds) &&
            Objects.equals(this.scheduleLengthSeconds, agentAdherenceDayMetrics.scheduleLengthSeconds) &&
            Objects.equals(this.actualLengthSeconds, agentAdherenceDayMetrics.actualLengthSeconds) &&
            Objects.equals(this.adherencePercentage, agentAdherenceDayMetrics.adherencePercentage) &&
            Objects.equals(this.conformancePercentage, agentAdherenceDayMetrics.conformancePercentage);
  }
