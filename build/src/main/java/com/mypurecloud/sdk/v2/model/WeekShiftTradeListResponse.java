...
import com.mypurecloud.sdk.v2.model.WeekShiftTradeResponse;
...
public class WeekShiftTradeListResponse  implements Serializable {
  ...
  public WeekShiftTradeListResponse() {
  ...
  /**
   **/
  public WeekShiftTradeListResponse entities(List<WeekShiftTradeResponse> entities) {
  ...
  public List<WeekShiftTradeResponse> getEntities() {
    return entities;
  }
  public void setEntities(List<WeekShiftTradeResponse> entities) {
    this.entities = entities;
  }
