...
public class GetAnalyticsConversationsDetailsJobsAvailabilityRequest {
    ...
    public GetAnalyticsConversationsDetailsJobsAvailabilityRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/analytics/conversations/details/jobs/availability")
	...
	public static class Builder {
		private final GetAnalyticsConversationsDetailsJobsAvailabilityRequest request;

		private Builder() {
			request = new GetAnalyticsConversationsDetailsJobsAvailabilityRequest();
		}
		...
		public GetAnalyticsConversationsDetailsJobsAvailabilityRequest build() {
