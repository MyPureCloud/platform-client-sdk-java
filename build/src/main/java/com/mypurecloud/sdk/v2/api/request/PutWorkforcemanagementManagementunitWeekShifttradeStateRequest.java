...
public class PutWorkforcemanagementManagementunitWeekShifttradeStateRequest {
	...
	public PutWorkforcemanagementManagementunitWeekShifttradeStateRequest withManagementUnitId(String managementUnitId) {
	...
	public PutWorkforcemanagementManagementunitWeekShifttradeStateRequest withWeekDateId(LocalDate weekDateId) {
	...
	public PutWorkforcemanagementManagementunitWeekShifttradeStateRequest withTradeId(String tradeId) {
	    this.setTradeId(tradeId);
	    return this;
	} 
	
	private UpdateShiftTradeStateRequest body;
	public UpdateShiftTradeStateRequest getBody() {
		return this.body;
	}

	public void setBody(UpdateShiftTradeStateRequest body) {
		this.body = body;
	}

	public PutWorkforcemanagementManagementunitWeekShifttradeStateRequest withBody(UpdateShiftTradeStateRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutWorkforcemanagementManagementunitWeekShifttradeStateRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<UpdateShiftTradeStateRequest> withHttpInfo() {
        
        // verify the required parameter 'managementUnitId' is set
        if (this.managementUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'managementUnitId' when building request for PutWorkforcemanagementManagementunitWeekShifttradeStateRequest.");
        }
        
        // verify the required parameter 'weekDateId' is set
        if (this.weekDateId == null) {
            throw new IllegalStateException("Missing the required parameter 'weekDateId' when building request for PutWorkforcemanagementManagementunitWeekShifttradeStateRequest.");
        }
        
        // verify the required parameter 'tradeId' is set
        if (this.tradeId == null) {
            throw new IllegalStateException("Missing the required parameter 'tradeId' when building request for PutWorkforcemanagementManagementunitWeekShifttradeStateRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutWorkforcemanagementManagementunitWeekShifttradeStateRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/workforcemanagement/managementunits/{managementUnitId}/weeks/{weekDateId}/shifttrades/{tradeId}/state")
	...
	public static Builder builder(String managementUnitId, LocalDate weekDateId, String tradeId, UpdateShiftTradeStateRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PutWorkforcemanagementManagementunitWeekShifttradeStateRequest request;

		private Builder() {
			request = new PutWorkforcemanagementManagementunitWeekShifttradeStateRequest();
		}
		...
		public Builder withBody(UpdateShiftTradeStateRequest body) {
		...
		public Builder withRequiredParams(String managementUnitId, LocalDate weekDateId, String tradeId, UpdateShiftTradeStateRequest body) {
			request.setManagementUnitId(managementUnitId);
						request.setWeekDateId(weekDateId);
						request.setTradeId(tradeId);
						request.setBody(body);
		...
		public PutWorkforcemanagementManagementunitWeekShifttradeStateRequest build() {
