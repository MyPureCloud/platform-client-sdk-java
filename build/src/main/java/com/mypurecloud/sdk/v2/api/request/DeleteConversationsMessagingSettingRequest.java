...
public class DeleteConversationsMessagingSettingRequest {
	...
	public DeleteConversationsMessagingSettingRequest withMessageSettingId(String messageSettingId) {
    ...
    public DeleteConversationsMessagingSettingRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.messageSettingId == null) {
            throw new IllegalStateException("Missing the required parameter 'messageSettingId' when building request for DeleteConversationsMessagingSettingRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/conversations/messaging/settings/{messageSettingId}")
	...
	public static class Builder {
		private final DeleteConversationsMessagingSettingRequest request;

		private Builder() {
			request = new DeleteConversationsMessagingSettingRequest();
		}
		...
		public DeleteConversationsMessagingSettingRequest build() {
