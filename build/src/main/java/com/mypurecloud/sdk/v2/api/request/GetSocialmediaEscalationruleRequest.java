...
public class GetSocialmediaEscalationruleRequest {
	...
	public GetSocialmediaEscalationruleRequest withEscalationRuleId(String escalationRuleId) {
	...
	public GetSocialmediaEscalationruleRequest withExpand(String expand) {
    ...
    public GetSocialmediaEscalationruleRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.escalationRuleId == null) {
            throw new IllegalStateException("Missing the required parameter 'escalationRuleId' when building request for GetSocialmediaEscalationruleRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/socialmedia/escalationrules/{escalationRuleId}")
	...
	public static class Builder {
		private final GetSocialmediaEscalationruleRequest request;

		private Builder() {
			request = new GetSocialmediaEscalationruleRequest();
		}
		...
		public GetSocialmediaEscalationruleRequest build() {
