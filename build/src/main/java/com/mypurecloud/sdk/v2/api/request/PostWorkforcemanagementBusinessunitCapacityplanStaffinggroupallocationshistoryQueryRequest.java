...
public class PostWorkforcemanagementBusinessunitCapacityplanStaffinggroupallocationshistoryQueryRequest {
	...
	public PostWorkforcemanagementBusinessunitCapacityplanStaffinggroupallocationshistoryQueryRequest withBusinessUnitId(String businessUnitId) {
	...
	public PostWorkforcemanagementBusinessunitCapacityplanStaffinggroupallocationshistoryQueryRequest withCapacityPlanId(String capacityPlanId) {
	    this.setCapacityPlanId(capacityPlanId);
	    return this;
	} 

	private QueryCapacityPlanStaffingGroupMetricChangeHistory body;
	public QueryCapacityPlanStaffingGroupMetricChangeHistory getBody() {
		return this.body;
	}

	public void setBody(QueryCapacityPlanStaffingGroupMetricChangeHistory body) {
		this.body = body;
	}

	public PostWorkforcemanagementBusinessunitCapacityplanStaffinggroupallocationshistoryQueryRequest withBody(QueryCapacityPlanStaffingGroupMetricChangeHistory body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementBusinessunitCapacityplanStaffinggroupallocationshistoryQueryRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<QueryCapacityPlanStaffingGroupMetricChangeHistory> withHttpInfo() {
        
        // verify the required parameter 'businessUnitId' is set
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PostWorkforcemanagementBusinessunitCapacityplanStaffinggroupallocationshistoryQueryRequest.");
        }
        
        // verify the required parameter 'capacityPlanId' is set
        if (this.capacityPlanId == null) {
            throw new IllegalStateException("Missing the required parameter 'capacityPlanId' when building request for PostWorkforcemanagementBusinessunitCapacityplanStaffinggroupallocationshistoryQueryRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementBusinessunitCapacityplanStaffinggroupallocationshistoryQueryRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/capacityplans/{capacityPlanId}/staffinggroupallocationshistory/query")
                .withPathParameter("businessUnitId", businessUnitId)
        
                .withPathParameter("capacityPlanId", capacityPlanId)
	...
	public static Builder builder(String businessUnitId, String capacityPlanId, QueryCapacityPlanStaffingGroupMetricChangeHistory body) {
	    return new Builder()
	            .withRequiredParams(businessUnitId, capacityPlanId, body);
	}


	public static class Builder {
		private final PostWorkforcemanagementBusinessunitCapacityplanStaffinggroupallocationshistoryQueryRequest request;

		private Builder() {
			request = new PostWorkforcemanagementBusinessunitCapacityplanStaffinggroupallocationshistoryQueryRequest();
		}
		...
		public Builder withCapacityPlanId(String capacityPlanId) {
			request.setCapacityPlanId(capacityPlanId);
			return this;
		}

		public Builder withBody(QueryCapacityPlanStaffingGroupMetricChangeHistory body) {
		...
		public Builder withRequiredParams(String businessUnitId, String capacityPlanId, QueryCapacityPlanStaffingGroupMetricChangeHistory body) {
			request.setBusinessUnitId(businessUnitId);
			request.setCapacityPlanId(capacityPlanId);
			request.setBody(body);
		...
		public PostWorkforcemanagementBusinessunitCapacityplanStaffinggroupallocationshistoryQueryRequest build() {
            ...
            // verify the required parameter 'capacityPlanId' is set
            if (request.capacityPlanId == null) {
                throw new IllegalStateException("Missing the required parameter 'capacityPlanId' when building request for PostWorkforcemanagementBusinessunitCapacityplanStaffinggroupallocationshistoryQueryRequest.");
            }
