...
public class PostFlowsDatatablesRequest {
    ...
    public PostFlowsDatatablesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<DataTable> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostFlowsDatatablesRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/flows/datatables")
                .withBody(body)
	...
	public static class Builder {
		private final PostFlowsDatatablesRequest request;

		private Builder() {
			request = new PostFlowsDatatablesRequest();
		}
		...
		public PostFlowsDatatablesRequest build() {
