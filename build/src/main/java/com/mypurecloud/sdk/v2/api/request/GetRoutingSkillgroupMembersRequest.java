...
public class GetRoutingSkillgroupMembersRequest {
	...
	public GetRoutingSkillgroupMembersRequest withSkillGroupId(String skillGroupId) {
	...
	public GetRoutingSkillgroupMembersRequest withPageSize(Integer pageSize) {
	...
	public GetRoutingSkillgroupMembersRequest withAfter(String after) {
	    this.setAfter(after);
	    return this;
	} 
	...
	public GetRoutingSkillgroupMembersRequest withBefore(String before) {
	...
	public GetRoutingSkillgroupMembersRequest withExpand(String expand) {
    ...
    public GetRoutingSkillgroupMembersRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.skillGroupId == null) {
            throw new IllegalStateException("Missing the required parameter 'skillGroupId' when building request for GetRoutingSkillgroupMembersRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/routing/skillgroups/{skillGroupId}/members")
	...
	public static class Builder {
		private final GetRoutingSkillgroupMembersRequest request;

		private Builder() {
			request = new GetRoutingSkillgroupMembersRequest();
		}
		...
		public GetRoutingSkillgroupMembersRequest build() {
