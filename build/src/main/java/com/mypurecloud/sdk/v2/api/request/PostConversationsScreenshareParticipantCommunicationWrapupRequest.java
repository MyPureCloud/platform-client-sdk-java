...
public class PostConversationsScreenshareParticipantCommunicationWrapupRequest {
	...
	public PostConversationsScreenshareParticipantCommunicationWrapupRequest withConversationId(String conversationId) {
	...
	public PostConversationsScreenshareParticipantCommunicationWrapupRequest withParticipantId(String participantId) {
	...
	public PostConversationsScreenshareParticipantCommunicationWrapupRequest withCommunicationId(String communicationId) {
	...
	public PostConversationsScreenshareParticipantCommunicationWrapupRequest withBody(ExtendedWrapup body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostConversationsScreenshareParticipantCommunicationWrapupRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<ExtendedWrapup> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PostConversationsScreenshareParticipantCommunicationWrapupRequest.");
        }
        
        // verify the required parameter 'participantId' is set
        if (this.participantId == null) {
            throw new IllegalStateException("Missing the required parameter 'participantId' when building request for PostConversationsScreenshareParticipantCommunicationWrapupRequest.");
        }
        
        // verify the required parameter 'communicationId' is set
        if (this.communicationId == null) {
            throw new IllegalStateException("Missing the required parameter 'communicationId' when building request for PostConversationsScreenshareParticipantCommunicationWrapupRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/conversations/screenshares/{conversationId}/participants/{participantId}/communications/{communicationId}/wrapup")
	...
	public static class Builder {
		private final PostConversationsScreenshareParticipantCommunicationWrapupRequest request;

		private Builder() {
			request = new PostConversationsScreenshareParticipantCommunicationWrapupRequest();
		}
		...
		public PostConversationsScreenshareParticipantCommunicationWrapupRequest build() {
