...
public class DeleteExternalcontactsContactRequest {
	...
	public DeleteExternalcontactsContactRequest withContactId(String contactId) {
    ...
    public DeleteExternalcontactsContactRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.contactId == null) {
            throw new IllegalStateException("Missing the required parameter 'contactId' when building request for DeleteExternalcontactsContactRequest.");
        }
