...
public class GetIntegrationsClientappsRequest {
	...
	public GetIntegrationsClientappsRequest withPageSize(Integer pageSize) {
	...
	public GetIntegrationsClientappsRequest withPageNumber(Integer pageNumber) {
	...
	public GetIntegrationsClientappsRequest withSortBy(String sortBy) {
	...
	public GetIntegrationsClientappsRequest withExpand(List<String> expand) {
	...
	public GetIntegrationsClientappsRequest withNextPage(String nextPage) {
	...
	public GetIntegrationsClientappsRequest withPreviousPage(String previousPage) {
    ...
    public GetIntegrationsClientappsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/integrations/clientapps")
	...
	public static class Builder {
		private final GetIntegrationsClientappsRequest request;

		private Builder() {
			request = new GetIntegrationsClientappsRequest();
		}
		...
		public GetIntegrationsClientappsRequest build() {
