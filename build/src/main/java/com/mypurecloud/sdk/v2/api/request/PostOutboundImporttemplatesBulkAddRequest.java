...
public class PostOutboundImporttemplatesBulkAddRequest {

	private List<ImportTemplate> body;
	public List<ImportTemplate> getBody() {
		return this.body;
	}

	public void setBody(List<ImportTemplate> body) {
		this.body = body;
	}

	public PostOutboundImporttemplatesBulkAddRequest withBody(List<ImportTemplate> body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostOutboundImporttemplatesBulkAddRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<List<ImportTemplate>> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostOutboundImporttemplatesBulkAddRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/outbound/importtemplates/bulk/add")
                .withBody(body)
	...
	public static Builder builder(List<ImportTemplate> body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostOutboundImporttemplatesBulkAddRequest request;

		private Builder() {
			request = new PostOutboundImporttemplatesBulkAddRequest();
		}


		public Builder withBody(List<ImportTemplate> body) {
		...
		public Builder withRequiredParams(List<ImportTemplate> body) {
			request.setBody(body);
		...
		public PostOutboundImporttemplatesBulkAddRequest build() {
