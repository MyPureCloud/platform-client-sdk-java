...
public class ParkingStateRequest  implements Serializable {
 ...
 @JsonDeserialize(using = StateEnumDeserializer.class)
   ...
   * State to set the participant.
   **/
  public ParkingStateRequest state(StateEnum state) {
    this.state = state;
    return this;
  }
  
  @ApiModelProperty(example = "null", required = true, value = "State to set the participant.")
  @JsonProperty("state")
