...
public class PatchConversationSecureattributesRequest {
	...
	public PatchConversationSecureattributesRequest withConversationId(String conversationId) {
	...
	public PatchConversationSecureattributesRequest withBody(ConversationSecureAttributes body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchConversationSecureattributesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<ConversationSecureAttributes> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PatchConversationSecureattributesRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchConversationSecureattributesRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/conversations/{conversationId}/secureattributes")
	...
	public static class Builder {
		private final PatchConversationSecureattributesRequest request;

		private Builder() {
			request = new PatchConversationSecureattributesRequest();
		}
		...
		public PatchConversationSecureattributesRequest build() {
