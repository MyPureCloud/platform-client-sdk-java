...
public class ADFS  implements Serializable {
 ...
 @JsonDeserialize(using = SsoBindingEnumDeserializer.class)
  ...
  public ADFS(Boolean initWithEmptyList) {
  ...
  /**
   **/
  public ADFS logoImageData(String logoImageData) {
  ...
  /**
   **/
  public ADFS nameIdentifierFormat(NameIdentifierFormatEnum nameIdentifierFormat) {
  ...
  /**
   **/
  public ADFS ssoBinding(SsoBindingEnum ssoBinding) {
  ...
  /**
   **/
  public ADFS signAuthnRequests(Boolean signAuthnRequests) {
  ...
  /**
   **/
  public ADFS providerName(String providerName) {
  ...
  /**
   **/
  public ADFS displayOnLogin(Boolean displayOnLogin) {
  ...
  /**
   **/
  public ADFS metadataURL(String metadataURL) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, ADFS.id) &&
            ...
            Objects.equals(this.logoImageData, ADFS.logoImageData) &&
            Objects.equals(this.nameIdentifierFormat, ADFS.nameIdentifierFormat) &&
            Objects.equals(this.ssoBinding, ADFS.ssoBinding) &&
            Objects.equals(this.signAuthnRequests, ADFS.signAuthnRequests) &&
