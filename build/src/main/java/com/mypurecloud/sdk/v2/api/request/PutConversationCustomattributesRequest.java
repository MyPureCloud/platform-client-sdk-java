...
public class PutConversationCustomattributesRequest {
	...
	public PutConversationCustomattributesRequest withConversationId(String conversationId) {
	    this.setConversationId(conversationId);
	    return this;
	} 

	private CustomAttributesUpdateRequest body;
	public CustomAttributesUpdateRequest getBody() {
		return this.body;
	}

	public void setBody(CustomAttributesUpdateRequest body) {
		this.body = body;
	}

	public PutConversationCustomattributesRequest withBody(CustomAttributesUpdateRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutConversationCustomattributesRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<CustomAttributesUpdateRequest> withHttpInfo() {
        
        // verify the required parameter 'conversationId' is set
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PutConversationCustomattributesRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/conversations/{conversationId}/customattributes")
	...
	public static class Builder {
		private final PutConversationCustomattributesRequest request;

		private Builder() {
			request = new PutConversationCustomattributesRequest();
		}
		...
		public Builder withBody(CustomAttributesUpdateRequest body) {
		...
		public PutConversationCustomattributesRequest build() {
