...
public class PatchConversationsCallbackParticipantRequest {
	...
	public PatchConversationsCallbackParticipantRequest withCallbackId(String callbackId) {
	...
	public PatchConversationsCallbackParticipantRequest withParticipantId(String participantId) {
	...
	public PatchConversationsCallbackParticipantRequest withBody(MediaParticipantRequest body) {
	    this.setBody(body);
	    return this;
	}
    ...
    public PatchConversationsCallbackParticipantRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<MediaParticipantRequest> withHttpInfo() throws ApiException {
        ...
        return ApiRequestBuilder.create("PATCH", "/api/v2/conversations/callbacks/{callbackId}/participants/{participantId}")
	...
	public static Builder builder(String callbackId, String participantId, MediaParticipantRequest body) {
	    return new Builder()
	            .withRequiredParams(callbackId, participantId, body);
	}

	public static class Builder {
		private final PatchConversationsCallbackParticipantRequest request;

		private Builder() {
			request = new PatchConversationsCallbackParticipantRequest();
		}
		...
		public Builder withRequiredParams(String callbackId, String participantId, MediaParticipantRequest body) {
			request.setCallbackId(callbackId);
			request.setParticipantId(participantId);
			request.setBody(body);
			return this;
		...
		public PatchConversationsCallbackParticipantRequest build() {
			return request;
		}
	}
}
