...
public class PatchConversationsCallbackParticipantRequest {
	...
	public PatchConversationsCallbackParticipantRequest withConversationId(String conversationId) {
    ...
    public ApiRequest<MediaParticipantRequest> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PatchConversationsCallbackParticipantRequest.");
        }
        ...
        return ApiRequestBuilder.create("PATCH", "/api/v2/conversations/callbacks/{conversationId}/participants/{participantId}")
