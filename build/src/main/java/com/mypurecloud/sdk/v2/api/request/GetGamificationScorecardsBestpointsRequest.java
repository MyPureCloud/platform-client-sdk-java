...
public class GetGamificationScorecardsBestpointsRequest {
    ...
    public GetGamificationScorecardsBestpointsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/gamification/scorecards/bestpoints")
	...
	public static class Builder {
		private final GetGamificationScorecardsBestpointsRequest request;

		private Builder() {
			request = new GetGamificationScorecardsBestpointsRequest();
		}
		...
		public GetGamificationScorecardsBestpointsRequest build() {
