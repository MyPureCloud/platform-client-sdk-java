...
public class GetOrgauthorizationTrusteeRequest {
	...
	public GetOrgauthorizationTrusteeRequest withTrusteeOrgId(String trusteeOrgId) {
    ...
    public GetOrgauthorizationTrusteeRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.trusteeOrgId == null) {
            throw new IllegalStateException("Missing the required parameter 'trusteeOrgId' when building request for GetOrgauthorizationTrusteeRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/orgauthorization/trustees/{trusteeOrgId}")
	...
	public static class Builder {
		private final GetOrgauthorizationTrusteeRequest request;

		private Builder() {
			request = new GetOrgauthorizationTrusteeRequest();
		}
		...
		public GetOrgauthorizationTrusteeRequest build() {
