...
public class GetRoutingUtilizationLabelAgentsRequest {
	...
	public GetRoutingUtilizationLabelAgentsRequest withLabelId(String labelId) {
    ...
    public GetRoutingUtilizationLabelAgentsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.labelId == null) {
            throw new IllegalStateException("Missing the required parameter 'labelId' when building request for GetRoutingUtilizationLabelAgentsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/routing/utilization/labels/{labelId}/agents")
	...
	public static class Builder {
		private final GetRoutingUtilizationLabelAgentsRequest request;

		private Builder() {
			request = new GetRoutingUtilizationLabelAgentsRequest();
		}
		...
		public GetRoutingUtilizationLabelAgentsRequest build() {
