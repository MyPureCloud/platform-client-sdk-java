...
public class GetExternalcontactsScanRelationshipsDivisionviewsAllRequest {
	...
	public GetExternalcontactsScanRelationshipsDivisionviewsAllRequest withLimit(Integer limit) {
	    this.setLimit(limit);
	    return this;
	} 
	...
	public GetExternalcontactsScanRelationshipsDivisionviewsAllRequest withCursor(String cursor) {
    ...
    public GetExternalcontactsScanRelationshipsDivisionviewsAllRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/externalcontacts/scan/relationships/divisionviews/all")
	...
	public static class Builder {
		private final GetExternalcontactsScanRelationshipsDivisionviewsAllRequest request;

		private Builder() {
			request = new GetExternalcontactsScanRelationshipsDivisionviewsAllRequest();
		}
		...
		public GetExternalcontactsScanRelationshipsDivisionviewsAllRequest build() {
