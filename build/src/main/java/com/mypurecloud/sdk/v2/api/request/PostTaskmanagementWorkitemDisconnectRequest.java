...
public class PostTaskmanagementWorkitemDisconnectRequest {
	...
	public PostTaskmanagementWorkitemDisconnectRequest withWorkitemId(String workitemId) {
    ...
    public PostTaskmanagementWorkitemDisconnectRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.workitemId == null) {
            throw new IllegalStateException("Missing the required parameter 'workitemId' when building request for PostTaskmanagementWorkitemDisconnectRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/taskmanagement/workitems/{workitemId}/disconnect")
	...
	public static class Builder {
		private final PostTaskmanagementWorkitemDisconnectRequest request;

		private Builder() {
			request = new PostTaskmanagementWorkitemDisconnectRequest();
		}
		...
		public PostTaskmanagementWorkitemDisconnectRequest build() {
