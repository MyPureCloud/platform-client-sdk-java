...
public class PostTelephonyProvidersEdgesEdgegroupsRequest {
	...
	public PostTelephonyProvidersEdgesEdgegroupsRequest withBody(EdgeGroup body) {
	    this.setBody(body);
	    return this;
	}
    ...
    public PostTelephonyProvidersEdgesEdgegroupsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<EdgeGroup> withHttpInfo() throws ApiException {
        ...
        if (this.body == null) {
            throw new ApiException(400, "Missing the required parameter 'body' when building request for PostTelephonyProvidersEdgesEdgegroupsRequest.");
        }
