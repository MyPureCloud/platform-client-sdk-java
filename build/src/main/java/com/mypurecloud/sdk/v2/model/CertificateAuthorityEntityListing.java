...
public class CertificateAuthorityEntityListing  implements Serializable, PagedResource<DomainCertificateAuthority> {
  ...
  /**
   **/
  public CertificateAuthorityEntityListing entities(List<DomainCertificateAuthority> entities) {
  ...
  public List<DomainCertificateAuthority> getEntities() {
    return entities;
  }
  public void setEntities(List<DomainCertificateAuthority> entities) {
    this.entities = entities;
  }
