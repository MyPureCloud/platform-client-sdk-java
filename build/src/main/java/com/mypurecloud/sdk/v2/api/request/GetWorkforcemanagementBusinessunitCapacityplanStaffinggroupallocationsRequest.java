...
public class GetWorkforcemanagementBusinessunitCapacityplanStaffinggroupallocationsRequest {
	...
	public GetWorkforcemanagementBusinessunitCapacityplanStaffinggroupallocationsRequest withBusinessUnitId(String businessUnitId) {
	...
	public GetWorkforcemanagementBusinessunitCapacityplanStaffinggroupallocationsRequest withCapacityPlanId(String capacityPlanId) {
	...
	public GetWorkforcemanagementBusinessunitCapacityplanStaffinggroupallocationsRequest withGranularity(String granularity) {
    ...
    public GetWorkforcemanagementBusinessunitCapacityplanStaffinggroupallocationsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for GetWorkforcemanagementBusinessunitCapacityplanStaffinggroupallocationsRequest.");
        }
        
        // verify the required parameter 'capacityPlanId' is set
        if (this.capacityPlanId == null) {
            throw new IllegalStateException("Missing the required parameter 'capacityPlanId' when building request for GetWorkforcemanagementBusinessunitCapacityplanStaffinggroupallocationsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/capacityplans/{capacityPlanId}/staffinggroupallocations")
	...
	public static Builder builder(String businessUnitId, String capacityPlanId) {
	    return new Builder()
	            .withRequiredParams(businessUnitId, capacityPlanId);
	}


	public static class Builder {
		private final GetWorkforcemanagementBusinessunitCapacityplanStaffinggroupallocationsRequest request;

		private Builder() {
			request = new GetWorkforcemanagementBusinessunitCapacityplanStaffinggroupallocationsRequest();
		}
		...
		public Builder withRequiredParams(String businessUnitId, String capacityPlanId) {
			request.setBusinessUnitId(businessUnitId);
			request.setCapacityPlanId(capacityPlanId);
		...
		public GetWorkforcemanagementBusinessunitCapacityplanStaffinggroupallocationsRequest build() {
