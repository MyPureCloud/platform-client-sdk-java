...
public class JourneyWebActionEventsNotificationDevice  implements Serializable {
 ...
 @JsonDeserialize(using = CategoryEnumDeserializer.class)
  ...
  public JourneyWebActionEventsNotificationDevice(Boolean initWithEmptyList) {
  ...
  /**
   **/
  public JourneyWebActionEventsNotificationDevice screenHeight(Long screenHeight) {
  ...
  /**
   **/
  public JourneyWebActionEventsNotificationDevice screenWidth(Long screenWidth) {
  ...
  /**
   **/
  public JourneyWebActionEventsNotificationDevice screenDensity(Long screenDensity) {
