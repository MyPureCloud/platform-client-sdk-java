...
public class PostWorkforcemanagementBusinessunitUnavailabletimesSettingsQueryRequest {
	...
	public PostWorkforcemanagementBusinessunitUnavailabletimesSettingsQueryRequest withBusinessUnitId(String businessUnitId) {
	    this.setBusinessUnitId(businessUnitId);
	    return this;
	} 

	private QueryAvailabilityManagementUnitsSettingsRequest body;
	public QueryAvailabilityManagementUnitsSettingsRequest getBody() {
		return this.body;
	}

	public void setBody(QueryAvailabilityManagementUnitsSettingsRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementBusinessunitUnavailabletimesSettingsQueryRequest withBody(QueryAvailabilityManagementUnitsSettingsRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementBusinessunitUnavailabletimesSettingsQueryRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<QueryAvailabilityManagementUnitsSettingsRequest> withHttpInfo() {
        
        // verify the required parameter 'businessUnitId' is set
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PostWorkforcemanagementBusinessunitUnavailabletimesSettingsQueryRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementBusinessunitUnavailabletimesSettingsQueryRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/unavailabletimes/settings/query")
	...
	public static Builder builder(String businessUnitId, QueryAvailabilityManagementUnitsSettingsRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementBusinessunitUnavailabletimesSettingsQueryRequest request;

		private Builder() {
			request = new PostWorkforcemanagementBusinessunitUnavailabletimesSettingsQueryRequest();
		}
		...
		public Builder withBody(QueryAvailabilityManagementUnitsSettingsRequest body) {
		...
		public Builder withRequiredParams(String businessUnitId, QueryAvailabilityManagementUnitsSettingsRequest body) {
			request.setBusinessUnitId(businessUnitId);
			request.setBody(body);
		...
		public PostWorkforcemanagementBusinessunitUnavailabletimesSettingsQueryRequest build() {
