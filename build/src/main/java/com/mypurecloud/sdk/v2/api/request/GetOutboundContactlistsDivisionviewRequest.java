...
public class GetOutboundContactlistsDivisionviewRequest {
	...
	public GetOutboundContactlistsDivisionviewRequest withContactListId(String contactListId) {
	...
	public GetOutboundContactlistsDivisionviewRequest withIncludeImportStatus(Boolean includeImportStatus) {
	...
	public GetOutboundContactlistsDivisionviewRequest withIncludeSize(Boolean includeSize) {
    ...
    public GetOutboundContactlistsDivisionviewRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.contactListId == null) {
            throw new IllegalStateException("Missing the required parameter 'contactListId' when building request for GetOutboundContactlistsDivisionviewRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/outbound/contactlists/divisionviews/{contactListId}")
	...
	public static class Builder {
		private final GetOutboundContactlistsDivisionviewRequest request;

		private Builder() {
			request = new GetOutboundContactlistsDivisionviewRequest();
		}
		...
		public GetOutboundContactlistsDivisionviewRequest build() {
