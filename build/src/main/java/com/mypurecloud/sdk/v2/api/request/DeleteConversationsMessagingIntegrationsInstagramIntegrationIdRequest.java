...
public class DeleteConversationsMessagingIntegrationsInstagramIntegrationIdRequest {
	...
	public DeleteConversationsMessagingIntegrationsInstagramIntegrationIdRequest withIntegrationId(String integrationId) {
    ...
    public DeleteConversationsMessagingIntegrationsInstagramIntegrationIdRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.integrationId == null) {
            throw new IllegalStateException("Missing the required parameter 'integrationId' when building request for DeleteConversationsMessagingIntegrationsInstagramIntegrationIdRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/conversations/messaging/integrations/instagram/{integrationId}")
	...
	public static class Builder {
		private final DeleteConversationsMessagingIntegrationsInstagramIntegrationIdRequest request;

		private Builder() {
			request = new DeleteConversationsMessagingIntegrationsInstagramIntegrationIdRequest();
		}
		...
		public DeleteConversationsMessagingIntegrationsInstagramIntegrationIdRequest build() {
