...
public class GetOrgauthorizationTrustorUserRequest {
	...
	public GetOrgauthorizationTrustorUserRequest withTrustorOrgId(String trustorOrgId) {
	...
	public GetOrgauthorizationTrustorUserRequest withTrusteeUserId(String trusteeUserId) {
    ...
    public GetOrgauthorizationTrustorUserRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.trustorOrgId == null) {
            throw new IllegalStateException("Missing the required parameter 'trustorOrgId' when building request for GetOrgauthorizationTrustorUserRequest.");
        }
        
        // verify the required parameter 'trusteeUserId' is set
        if (this.trusteeUserId == null) {
            throw new IllegalStateException("Missing the required parameter 'trusteeUserId' when building request for GetOrgauthorizationTrustorUserRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/orgauthorization/trustors/{trustorOrgId}/users/{trusteeUserId}")
	...
	public static class Builder {
		private final GetOrgauthorizationTrustorUserRequest request;

		private Builder() {
			request = new GetOrgauthorizationTrustorUserRequest();
		}
		...
		public GetOrgauthorizationTrustorUserRequest build() {
