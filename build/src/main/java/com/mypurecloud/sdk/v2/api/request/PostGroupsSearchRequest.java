...
public class PostGroupsSearchRequest {
	...
	public void setBody(GroupSearchRequest body) {
		this.body = body;
	}

	public PostGroupsSearchRequest withBody(GroupSearchRequest body) {
	    this.setBody(body);
	    return this;
	}
    ...
    public PostGroupsSearchRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<GroupSearchRequest> withHttpInfo() throws ApiException {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new ApiException(400, "Missing the required parameter 'body' when building request for PostGroupsSearchRequest.");
        }
