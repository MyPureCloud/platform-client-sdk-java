...
public class PostJourneyExternaleventsConfigurationsRequest {

	private CreateExternalEventsConfigurationRequest body;
	public CreateExternalEventsConfigurationRequest getBody() {
		return this.body;
	}

	public void setBody(CreateExternalEventsConfigurationRequest body) {
		this.body = body;
	}
    ...
    public PostJourneyExternaleventsConfigurationsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<CreateExternalEventsConfigurationRequest> withHttpInfo() {
        

        return ApiRequestBuilder.create("POST", "/api/v2/journey/externalevents/configurations")
                .withBody(body)
	...
	public static class Builder {
		private final PostJourneyExternaleventsConfigurationsRequest request;

		private Builder() {
			request = new PostJourneyExternaleventsConfigurationsRequest();
		}


		public Builder withBody(CreateExternalEventsConfigurationRequest body) {
		...
		public PostJourneyExternaleventsConfigurationsRequest build() {
