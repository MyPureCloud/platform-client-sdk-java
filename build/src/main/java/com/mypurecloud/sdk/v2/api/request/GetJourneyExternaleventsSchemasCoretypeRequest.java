...
public class GetJourneyExternaleventsSchemasCoretypeRequest {
	...
	public GetJourneyExternaleventsSchemasCoretypeRequest withCoreTypeName(String coreTypeName) {
    ...
    public GetJourneyExternaleventsSchemasCoretypeRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.coreTypeName == null) {
            throw new IllegalStateException("Missing the required parameter 'coreTypeName' when building request for GetJourneyExternaleventsSchemasCoretypeRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/journey/externalevents/schemas/coretypes/{coreTypeName}")
	...
	public static class Builder {
		private final GetJourneyExternaleventsSchemasCoretypeRequest request;

		private Builder() {
			request = new GetJourneyExternaleventsSchemasCoretypeRequest();
		}
		...
		public GetJourneyExternaleventsSchemasCoretypeRequest build() {
