...
public class DeleteWorkforcemanagementManagementunitTimeoffplanRequest {
	...
	public DeleteWorkforcemanagementManagementunitTimeoffplanRequest withManagementUnitId(String managementUnitId) {
	    this.setManagementUnitId(managementUnitId);
	    return this;
	} 
	
	private String timeOffPlanId;
	public String getTimeOffPlanId() {
		return this.timeOffPlanId;
	}

	public void setTimeOffPlanId(String timeOffPlanId) {
		this.timeOffPlanId = timeOffPlanId;
	}

	public DeleteWorkforcemanagementManagementunitTimeoffplanRequest withTimeOffPlanId(String timeOffPlanId) {
	    this.setTimeOffPlanId(timeOffPlanId);
	    return this;
	} 
    ...
    public DeleteWorkforcemanagementManagementunitTimeoffplanRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.managementUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'managementUnitId' when building request for DeleteWorkforcemanagementManagementunitTimeoffplanRequest.");
        }
        
        // verify the required parameter 'timeOffPlanId' is set
        if (this.timeOffPlanId == null) {
            throw new IllegalStateException("Missing the required parameter 'timeOffPlanId' when building request for DeleteWorkforcemanagementManagementunitTimeoffplanRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/workforcemanagement/managementunits/{managementUnitId}/timeoffplans/{timeOffPlanId}")
                .withPathParameter("managementUnitId", managementUnitId)
        
                .withPathParameter("timeOffPlanId", timeOffPlanId)
	...
	public static class Builder {
		private final DeleteWorkforcemanagementManagementunitTimeoffplanRequest request;

		private Builder() {
			request = new DeleteWorkforcemanagementManagementunitTimeoffplanRequest();
		}
		...
		public Builder withTimeOffPlanId(String timeOffPlanId) {
		...
		public DeleteWorkforcemanagementManagementunitTimeoffplanRequest build() {
