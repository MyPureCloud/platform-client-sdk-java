...
public class GetWorkforcemanagementBusinessunitSchedulingRunResultRequest {
	...
	public GetWorkforcemanagementBusinessunitSchedulingRunResultRequest withBusinessUnitId(String businessUnitId) {
	...
	public GetWorkforcemanagementBusinessunitSchedulingRunResultRequest withRunId(String runId) {
	    this.setRunId(runId);
	    return this;
	} 
	
	private List<String> managementUnitIds;
	...
	public GetWorkforcemanagementBusinessunitSchedulingRunResultRequest withManagementUnitIds(List<String> managementUnitIds) {
	    this.setManagementUnitIds(managementUnitIds);
	    return this;
	} 
	...
	public GetWorkforcemanagementBusinessunitSchedulingRunResultRequest withExpand(List<String> expand) {
    ...
    public GetWorkforcemanagementBusinessunitSchedulingRunResultRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for GetWorkforcemanagementBusinessunitSchedulingRunResultRequest.");
        }
        
        // verify the required parameter 'runId' is set
        if (this.runId == null) {
            throw new IllegalStateException("Missing the required parameter 'runId' when building request for GetWorkforcemanagementBusinessunitSchedulingRunResultRequest.");
        }
        
        // verify the required parameter 'managementUnitIds' is set
        if (this.managementUnitIds == null) {
            throw new IllegalStateException("Missing the required parameter 'managementUnitIds' when building request for GetWorkforcemanagementBusinessunitSchedulingRunResultRequest.");
        }
        
        // verify the required parameter 'expand' is set
        if (this.expand == null) {
            throw new IllegalStateException("Missing the required parameter 'expand' when building request for GetWorkforcemanagementBusinessunitSchedulingRunResultRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/scheduling/runs/{runId}/result")
                .withPathParameter("businessUnitId", businessUnitId)
        
                .withPathParameter("runId", runId)
        
                .withQueryParameters("managementUnitIds", "multi", managementUnitIds)
	...
	public static Builder builder(String businessUnitId, String runId, List<String> managementUnitIds, List<String> expand) {
	    return new Builder()
	            .withRequiredParams(businessUnitId, runId, managementUnitIds, expand);
	}
	

	public static class Builder {
		private final GetWorkforcemanagementBusinessunitSchedulingRunResultRequest request;

		private Builder() {
			request = new GetWorkforcemanagementBusinessunitSchedulingRunResultRequest();
		}
		...
		public Builder withManagementUnitIds(List<String> managementUnitIds) {
			request.setManagementUnitIds(managementUnitIds);
			return this;
		}
		...
		public Builder withRequiredParams(String businessUnitId, String runId, List<String> managementUnitIds, List<String> expand) {
			request.setBusinessUnitId(businessUnitId);
						request.setRunId(runId);
						request.setManagementUnitIds(managementUnitIds);
						request.setExpand(expand);
		...
		public GetWorkforcemanagementBusinessunitSchedulingRunResultRequest build() {
            ...
            // verify the required parameter 'managementUnitIds' is set
            if (request.managementUnitIds == null) {
                throw new IllegalStateException("Missing the required parameter 'managementUnitIds' when building request for GetWorkforcemanagementBusinessunitSchedulingRunResultRequest.");
            }
