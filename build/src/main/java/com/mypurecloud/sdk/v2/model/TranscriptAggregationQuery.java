...
public class TranscriptAggregationQuery  implements Serializable {
 ...
 @JsonDeserialize(using = QueryTypeEnumDeserializer.class)
  ...
  public TranscriptAggregationQuery() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
      groupBy = new ArrayList<GroupByEnum>();
      metrics = new ArrayList<MetricsEnum>();
      views = new ArrayList<TranscriptAggregationView>();
    }
  }

  public TranscriptAggregationQuery(Boolean initWithEmptyList) {
   ...
   **/
  public TranscriptAggregationQuery interval(String interval) {
   ...
   **/
  public TranscriptAggregationQuery granularity(String granularity) {
   ...
   **/
  public TranscriptAggregationQuery timeZone(String timeZone) {
   ...
   **/
  public TranscriptAggregationQuery groupBy(List<GroupByEnum> groupBy) {
   ...
   **/
  public TranscriptAggregationQuery filter(TranscriptAggregateQueryFilter filter) {
    this.filter = filter;
    return this;
  }
   ...
   **/
  public TranscriptAggregationQuery metrics(List<MetricsEnum> metrics) {
   ...
   **/
  public TranscriptAggregationQuery flattenMultivaluedDimensions(Boolean flattenMultivaluedDimensions) {
   ...
   **/
  public TranscriptAggregationQuery views(List<TranscriptAggregationView> views) {
    this.views = views;
    return this;
  }
   ...
   * Dimension to use as the alternative timestamp for data in the aggregate.  Choosing \"eventTime\" uses the actual time of the data event.
   **/
  public TranscriptAggregationQuery alternateTimeDimension(AlternateTimeDimensionEnum alternateTimeDimension) {
   ...
   * Query type to use. Use groupBy for all matching results, and topN/bottomN for N results ordered by the sortMetric. Default is groupBy.
   **/
  public TranscriptAggregationQuery queryType(QueryTypeEnum queryType) {
   ...
   **/
  public TranscriptAggregationQuery sortMetric(TranscriptAggregationSort sortMetric) {
   ...
   **/
  public TranscriptAggregationQuery limit(Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.interval, transcriptAggregationQuery.interval) &&
            ...
            Objects.equals(this.queryType, transcriptAggregationQuery.queryType) &&
            Objects.equals(this.sortMetric, transcriptAggregationQuery.sortMetric) &&
            Objects.equals(this.limit, transcriptAggregationQuery.limit);
  }
