...
public class PostJourneyViewsRequest {
	...
	public PostJourneyViewsRequest withBody(JourneyView body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostJourneyViewsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<JourneyView> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostJourneyViewsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/journey/views")
                .withBody(body)
	...
	public static Builder builder(JourneyView body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostJourneyViewsRequest request;

		private Builder() {
			request = new PostJourneyViewsRequest();
		}
		...
		public Builder withRequiredParams(JourneyView body) {
			request.setBody(body);
		...
		public PostJourneyViewsRequest build() {
