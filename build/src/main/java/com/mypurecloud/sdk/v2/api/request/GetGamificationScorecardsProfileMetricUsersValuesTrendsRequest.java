...
public class GetGamificationScorecardsProfileMetricUsersValuesTrendsRequest {
	...
	public GetGamificationScorecardsProfileMetricUsersValuesTrendsRequest withProfileId(String profileId) {
	...
	public GetGamificationScorecardsProfileMetricUsersValuesTrendsRequest withMetricId(String metricId) {
	...
	public GetGamificationScorecardsProfileMetricUsersValuesTrendsRequest withFilterType(String filterType) {
	...
	public GetGamificationScorecardsProfileMetricUsersValuesTrendsRequest withStartWorkday(LocalDate startWorkday) {
	...
	public GetGamificationScorecardsProfileMetricUsersValuesTrendsRequest withReferenceWorkday(LocalDate referenceWorkday) {
	...
	public GetGamificationScorecardsProfileMetricUsersValuesTrendsRequest withTimeZone(String timeZone) {
    ...
    public GetGamificationScorecardsProfileMetricUsersValuesTrendsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.profileId == null) {
            throw new IllegalStateException("Missing the required parameter 'profileId' when building request for GetGamificationScorecardsProfileMetricUsersValuesTrendsRequest.");
        }
        
        // verify the required parameter 'metricId' is set
        if (this.metricId == null) {
            throw new IllegalStateException("Missing the required parameter 'metricId' when building request for GetGamificationScorecardsProfileMetricUsersValuesTrendsRequest.");
        }
        ...
        if (this.endWorkday == null) {
            throw new IllegalStateException("Missing the required parameter 'endWorkday' when building request for GetGamificationScorecardsProfileMetricUsersValuesTrendsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/gamification/scorecards/profiles/{profileId}/metrics/{metricId}/users/values/trends")
	...
	public static class Builder {
		private final GetGamificationScorecardsProfileMetricUsersValuesTrendsRequest request;

		private Builder() {
			request = new GetGamificationScorecardsProfileMetricUsersValuesTrendsRequest();
		}
		...
		public GetGamificationScorecardsProfileMetricUsersValuesTrendsRequest build() {
