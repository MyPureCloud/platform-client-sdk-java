...
public class PostExternalcontactsOrganizationsEnrichRequest {

	private ExternalOrganizationEnrichRequest body;
	public ExternalOrganizationEnrichRequest getBody() {
		return this.body;
	}

	public void setBody(ExternalOrganizationEnrichRequest body) {
		this.body = body;
	}

	public PostExternalcontactsOrganizationsEnrichRequest withBody(ExternalOrganizationEnrichRequest body) {
	    this.setBody(body);
	    return this;
	} 
	...
	public PostExternalcontactsOrganizationsEnrichRequest withDryRun(Boolean dryRun) {
    ...
    public PostExternalcontactsOrganizationsEnrichRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<ExternalOrganizationEnrichRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostExternalcontactsOrganizationsEnrichRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/externalcontacts/organizations/enrich")
	...
	public static Builder builder(ExternalOrganizationEnrichRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostExternalcontactsOrganizationsEnrichRequest request;

		private Builder() {
			request = new PostExternalcontactsOrganizationsEnrichRequest();
		}


		public Builder withBody(ExternalOrganizationEnrichRequest body) {
		...
		public Builder withRequiredParams(ExternalOrganizationEnrichRequest body) {
			request.setBody(body);
		...
		public PostExternalcontactsOrganizationsEnrichRequest build() {
