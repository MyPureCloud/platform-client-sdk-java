...
public class PostRoutingQueuesRequest {
	...
	public void setBody(CreateQueueRequest body) {
		this.body = body;
	}

	public PostRoutingQueuesRequest withBody(CreateQueueRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostRoutingQueuesRequest withCustomHeader(String name, String value) {
