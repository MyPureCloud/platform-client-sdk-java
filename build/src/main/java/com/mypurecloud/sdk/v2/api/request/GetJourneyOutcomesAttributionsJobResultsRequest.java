...
public class GetJourneyOutcomesAttributionsJobResultsRequest {
	...
	public GetJourneyOutcomesAttributionsJobResultsRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetJourneyOutcomesAttributionsJobResultsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetJourneyOutcomesAttributionsJobResultsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/journey/outcomes/attributions/jobs/{jobId}/results")
	...
	public static class Builder {
		private final GetJourneyOutcomesAttributionsJobResultsRequest request;

		private Builder() {
			request = new GetJourneyOutcomesAttributionsJobResultsRequest();
		}
		...
		public GetJourneyOutcomesAttributionsJobResultsRequest build() {
