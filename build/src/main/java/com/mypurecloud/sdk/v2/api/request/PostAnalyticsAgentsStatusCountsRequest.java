...
public class PostAnalyticsAgentsStatusCountsRequest {

	private AgentStateCountsRequest body;
	public AgentStateCountsRequest getBody() {
		return this.body;
	}

	public void setBody(AgentStateCountsRequest body) {
		this.body = body;
	}

	public PostAnalyticsAgentsStatusCountsRequest withBody(AgentStateCountsRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostAnalyticsAgentsStatusCountsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<AgentStateCountsRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostAnalyticsAgentsStatusCountsRequest.");
        }
	...
	public static Builder builder(AgentStateCountsRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostAnalyticsAgentsStatusCountsRequest request;

		private Builder() {
			request = new PostAnalyticsAgentsStatusCountsRequest();
		}
		...
		public Builder withRequiredParams(AgentStateCountsRequest body) {
			request.setBody(body);
		...
		public PostAnalyticsAgentsStatusCountsRequest build() {
