...
public class DeleteOutboundCampaignruleRequest {
	...
	public DeleteOutboundCampaignruleRequest withCampaignRuleId(String campaignRuleId) {
    ...
    public DeleteOutboundCampaignruleRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.campaignRuleId == null) {
            throw new IllegalStateException("Missing the required parameter 'campaignRuleId' when building request for DeleteOutboundCampaignruleRequest.");
        }
