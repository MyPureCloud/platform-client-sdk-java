...
public class PostWorkforcemanagementBusinessunitTimeofflimitValuesQueryRequest {
	...
	public PostWorkforcemanagementBusinessunitTimeofflimitValuesQueryRequest withBusinessUnitId(String businessUnitId) {
	...
	public PostWorkforcemanagementBusinessunitTimeofflimitValuesQueryRequest withTimeOffLimitId(String timeOffLimitId) {
	    this.setTimeOffLimitId(timeOffLimitId);
	    return this;
	} 

	private QueryTimeOffLimitValuesForGranularityRequest body;
	public QueryTimeOffLimitValuesForGranularityRequest getBody() {
		return this.body;
	}

	public void setBody(QueryTimeOffLimitValuesForGranularityRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementBusinessunitTimeofflimitValuesQueryRequest withBody(QueryTimeOffLimitValuesForGranularityRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementBusinessunitTimeofflimitValuesQueryRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<QueryTimeOffLimitValuesForGranularityRequest> withHttpInfo() {
        
        // verify the required parameter 'businessUnitId' is set
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PostWorkforcemanagementBusinessunitTimeofflimitValuesQueryRequest.");
        }
        
        // verify the required parameter 'timeOffLimitId' is set
        if (this.timeOffLimitId == null) {
            throw new IllegalStateException("Missing the required parameter 'timeOffLimitId' when building request for PostWorkforcemanagementBusinessunitTimeofflimitValuesQueryRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementBusinessunitTimeofflimitValuesQueryRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/timeofflimits/{timeOffLimitId}/values/query")
	...
	public static Builder builder(String businessUnitId, String timeOffLimitId, QueryTimeOffLimitValuesForGranularityRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementBusinessunitTimeofflimitValuesQueryRequest request;

		private Builder() {
			request = new PostWorkforcemanagementBusinessunitTimeofflimitValuesQueryRequest();
		}
		...
		public Builder withBody(QueryTimeOffLimitValuesForGranularityRequest body) {
		...
		public Builder withRequiredParams(String businessUnitId, String timeOffLimitId, QueryTimeOffLimitValuesForGranularityRequest body) {
			request.setBusinessUnitId(businessUnitId);
			request.setTimeOffLimitId(timeOffLimitId);
			request.setBody(body);
		...
		public PostWorkforcemanagementBusinessunitTimeofflimitValuesQueryRequest build() {
