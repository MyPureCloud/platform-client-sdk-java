...
public class PostQualityEvaluationsSearchRequest {

	private EvaluationSearchRequestDTO body;
	public EvaluationSearchRequestDTO getBody() {
		return this.body;
	}

	public void setBody(EvaluationSearchRequestDTO body) {
		this.body = body;
	}

	public PostQualityEvaluationsSearchRequest withBody(EvaluationSearchRequestDTO body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostQualityEvaluationsSearchRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<EvaluationSearchRequestDTO> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostQualityEvaluationsSearchRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/quality/evaluations/search")
                .withBody(body)
	...
	public static Builder builder(EvaluationSearchRequestDTO body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostQualityEvaluationsSearchRequest request;

		private Builder() {
			request = new PostQualityEvaluationsSearchRequest();
		}


		public Builder withBody(EvaluationSearchRequestDTO body) {
		...
		public Builder withRequiredParams(EvaluationSearchRequestDTO body) {
			request.setBody(body);
		...
		public PostQualityEvaluationsSearchRequest build() {
