...
public class PostConversationsMessagingIntegrationsOpenExtensionsGooglebusinessprofileTokensRequest {

	private GoogleAuthTokenRequest body;
	public GoogleAuthTokenRequest getBody() {
		return this.body;
	}

	public void setBody(GoogleAuthTokenRequest body) {
		this.body = body;
	}

	public PostConversationsMessagingIntegrationsOpenExtensionsGooglebusinessprofileTokensRequest withBody(GoogleAuthTokenRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostConversationsMessagingIntegrationsOpenExtensionsGooglebusinessprofileTokensRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<GoogleAuthTokenRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostConversationsMessagingIntegrationsOpenExtensionsGooglebusinessprofileTokensRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/conversations/messaging/integrations/open/extensions/googlebusinessprofile/tokens")
                .withBody(body)
	...
	public static Builder builder(GoogleAuthTokenRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostConversationsMessagingIntegrationsOpenExtensionsGooglebusinessprofileTokensRequest request;

		private Builder() {
			request = new PostConversationsMessagingIntegrationsOpenExtensionsGooglebusinessprofileTokensRequest();
		}


		public Builder withBody(GoogleAuthTokenRequest body) {
		...
		public Builder withRequiredParams(GoogleAuthTokenRequest body) {
			request.setBody(body);
		...
		public PostConversationsMessagingIntegrationsOpenExtensionsGooglebusinessprofileTokensRequest build() {
