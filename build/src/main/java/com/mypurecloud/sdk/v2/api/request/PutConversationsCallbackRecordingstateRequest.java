...
public class PutConversationsCallbackRecordingstateRequest {
	...
	public PutConversationsCallbackRecordingstateRequest withConversationId(String conversationId) {
	...
	public PutConversationsCallbackRecordingstateRequest withBody(SetRecordingState body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutConversationsCallbackRecordingstateRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<SetRecordingState> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PutConversationsCallbackRecordingstateRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutConversationsCallbackRecordingstateRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/conversations/callbacks/{conversationId}/recordingstate")
	...
	public static class Builder {
		private final PutConversationsCallbackRecordingstateRequest request;

		private Builder() {
			request = new PutConversationsCallbackRecordingstateRequest();
		}
		...
		public PutConversationsCallbackRecordingstateRequest build() {
