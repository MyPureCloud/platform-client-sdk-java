...
public class PutTelephonyProvidersEdgesExtensionpoolRequest {
    ...
    public ApiRequest<ExtensionPool> withHttpInfo() throws ApiException {
        ...
        if (this.extensionPoolId == null) {
            throw new ApiException(400, "Missing the required parameter 'extensionPoolId' when building request for PutTelephonyProvidersEdgesExtensionpoolRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new ApiException(400, "Missing the required parameter 'body' when building request for PutTelephonyProvidersEdgesExtensionpoolRequest.");
        }
