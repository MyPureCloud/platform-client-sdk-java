...
public class PutTelephonyProvidersEdgesExtensionpoolRequest {
	...
	public void setExtensionPoolId(String extensionPoolId) {
		this.extensionPoolId = extensionPoolId;
	}

	public PutTelephonyProvidersEdgesExtensionpoolRequest withExtensionPoolId(String extensionPoolId) {
	    this.setExtensionPoolId(extensionPoolId);
	    return this;
	} 
	...
	public void setBody(ExtensionPool body) {
		this.body = body;
	}

	public PutTelephonyProvidersEdgesExtensionpoolRequest withBody(ExtensionPool body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutTelephonyProvidersEdgesExtensionpoolRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<ExtensionPool> withHttpInfo() {
        ...
        if (this.extensionPoolId == null) {
            throw new IllegalStateException("Missing the required parameter 'extensionPoolId' when building request for PutTelephonyProvidersEdgesExtensionpoolRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutTelephonyProvidersEdgesExtensionpoolRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/telephony/providers/edges/extensionpools/{extensionPoolId}")
	...
	public static class Builder {
		...
		public PutTelephonyProvidersEdgesExtensionpoolRequest build() {
            ...
            // verify the required parameter 'extensionPoolId' is set
            if (request.extensionPoolId == null) {
                throw new IllegalStateException("Missing the required parameter 'extensionPoolId' when building request for PutTelephonyProvidersEdgesExtensionpoolRequest.");
            }
