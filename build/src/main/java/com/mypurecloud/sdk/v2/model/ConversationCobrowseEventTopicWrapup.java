...
public class ConversationCobrowseEventTopicWrapup  implements Serializable {
  ...
  public ConversationCobrowseEventTopicWrapup() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
      tags = new ArrayList<String>();
    }
  }

  public ConversationCobrowseEventTopicWrapup(Boolean initWithEmptyList) {
   ...
   **/
  public ConversationCobrowseEventTopicWrapup durationSeconds(Long durationSeconds) {
