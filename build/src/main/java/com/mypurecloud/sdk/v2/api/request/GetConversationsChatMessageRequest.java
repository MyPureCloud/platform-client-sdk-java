...
public class GetConversationsChatMessageRequest {
	...
	public GetConversationsChatMessageRequest withConversationId(String conversationId) {
	...
	public GetConversationsChatMessageRequest withMessageId(String messageId) {
    ...
    public GetConversationsChatMessageRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for GetConversationsChatMessageRequest.");
        }
        
        // verify the required parameter 'messageId' is set
        if (this.messageId == null) {
            throw new IllegalStateException("Missing the required parameter 'messageId' when building request for GetConversationsChatMessageRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/conversations/chats/{conversationId}/messages/{messageId}")
	...
	public static class Builder {
		private final GetConversationsChatMessageRequest request;

		private Builder() {
			request = new GetConversationsChatMessageRequest();
		}
		...
		public GetConversationsChatMessageRequest build() {
