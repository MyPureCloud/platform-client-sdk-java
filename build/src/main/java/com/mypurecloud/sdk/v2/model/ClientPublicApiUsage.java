...
public class ClientPublicApiUsage  implements Serializable {
 ...
 @JsonDeserialize(using = HttpMethodEnumDeserializer.class)
   ...
   **/
  public ClientPublicApiUsage date(LocalDate date) {
    this.date = date;
    return this;
  }
   ...
   **/
  public ClientPublicApiUsage platform(String platform) {
   ...
   * The http method of the request(s)
   **/
  public ClientPublicApiUsage httpMethod(HttpMethodEnum httpMethod) {
   ...
   **/
  public ClientPublicApiUsage templateUri(String templateUri) {
   ...
   **/
  public ClientPublicApiUsage requestCount(Long requestCount) {
   ...
   **/
  public ClientPublicApiUsage status200(Long status200) {
   ...
   **/
  public ClientPublicApiUsage status300(Long status300) {
   ...
   **/
  public ClientPublicApiUsage status400(Long status400) {
   ...
   **/
  public ClientPublicApiUsage status429(Long status429) {
   ...
   **/
  public ClientPublicApiUsage status500(Long status500) {
   ...
   **/
  public ClientPublicApiUsage organizationId(String organizationId) {
    this.organizationId = organizationId;
    return this;
  }
  
  @ApiModelProperty(example = "null", value = "The organizationId that made the request.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ClientPublicApiUsage clientPublicApiUsage = (ClientPublicApiUsage) o;

    return Objects.equals(this.date, clientPublicApiUsage.date) &&
            Objects.equals(this.platform, clientPublicApiUsage.platform) &&
            Objects.equals(this.httpMethod, clientPublicApiUsage.httpMethod) &&
            Objects.equals(this.templateUri, clientPublicApiUsage.templateUri) &&
            Objects.equals(this.requestCount, clientPublicApiUsage.requestCount) &&
            Objects.equals(this.status200, clientPublicApiUsage.status200) &&
            Objects.equals(this.status300, clientPublicApiUsage.status300) &&
            Objects.equals(this.status400, clientPublicApiUsage.status400) &&
            Objects.equals(this.status429, clientPublicApiUsage.status429) &&
            Objects.equals(this.status500, clientPublicApiUsage.status500) &&
            Objects.equals(this.organizationId, clientPublicApiUsage.organizationId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(date, platform, httpMethod, templateUri, requestCount, status200, status300, status400, status429, status500, organizationId);
  }
