...
public class PatchWorkforcemanagementBusinessunitRequest {
	...
	public PatchWorkforcemanagementBusinessunitRequest withBusinessUnitId(String businessUnitId) {
	    this.setBusinessUnitId(businessUnitId);
	    return this;
	} 

	private UpdateBusinessUnitRequest body;
	public UpdateBusinessUnitRequest getBody() {
		return this.body;
	}

	public void setBody(UpdateBusinessUnitRequest body) {
		this.body = body;
	}

	public PatchWorkforcemanagementBusinessunitRequest withBody(UpdateBusinessUnitRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchWorkforcemanagementBusinessunitRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<UpdateBusinessUnitRequest> withHttpInfo() {
        
        // verify the required parameter 'businessUnitId' is set
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PatchWorkforcemanagementBusinessunitRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchWorkforcemanagementBusinessunitRequest.");
        }
	...
	public static Builder builder(String businessUnitId, UpdateBusinessUnitRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PatchWorkforcemanagementBusinessunitRequest request;

		private Builder() {
			request = new PatchWorkforcemanagementBusinessunitRequest();
		}
		...
		public Builder withRequiredParams(String businessUnitId, UpdateBusinessUnitRequest body) {
			request.setBusinessUnitId(businessUnitId);
			request.setBody(body);
		...
		public PatchWorkforcemanagementBusinessunitRequest build() {
