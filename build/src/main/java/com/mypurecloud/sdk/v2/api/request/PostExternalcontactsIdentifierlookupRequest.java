...
public class PostExternalcontactsIdentifierlookupRequest {

	private ContactIdentifier identifier;
	...
	public PostExternalcontactsIdentifierlookupRequest withIdentifier(ContactIdentifier identifier) {
	...
	public PostExternalcontactsIdentifierlookupRequest withExpand(List<String> expand) {
    ...
    public PostExternalcontactsIdentifierlookupRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<ContactIdentifier> withHttpInfo() {
        
        // verify the required parameter 'identifier' is set
        if (this.identifier == null) {
            throw new IllegalStateException("Missing the required parameter 'identifier' when building request for PostExternalcontactsIdentifierlookupRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/externalcontacts/identifierlookup")
	...
	public static Builder builder(ContactIdentifier identifier) {
	    return new Builder()
	...
	public static class Builder {
		private final PostExternalcontactsIdentifierlookupRequest request;

		private Builder() {
			request = new PostExternalcontactsIdentifierlookupRequest();
		}


		public Builder withIdentifier(ContactIdentifier identifier) {
		...
		public Builder withRequiredParams(ContactIdentifier identifier) {
			request.setIdentifier(identifier);
		...
		public PostExternalcontactsIdentifierlookupRequest build() {
