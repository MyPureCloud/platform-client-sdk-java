...
public class GetAnalyticsDataextractionDownloadRequest {
	...
	public GetAnalyticsDataextractionDownloadRequest withDownloadId(String downloadId) {
    ...
    public GetAnalyticsDataextractionDownloadRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.downloadId == null) {
            throw new IllegalStateException("Missing the required parameter 'downloadId' when building request for GetAnalyticsDataextractionDownloadRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/analytics/dataextraction/downloads/{downloadId}")
	...
	public static class Builder {
		private final GetAnalyticsDataextractionDownloadRequest request;

		private Builder() {
			request = new GetAnalyticsDataextractionDownloadRequest();
		}
		...
		public GetAnalyticsDataextractionDownloadRequest build() {
