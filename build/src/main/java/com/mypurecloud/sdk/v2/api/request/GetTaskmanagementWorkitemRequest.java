...
public class GetTaskmanagementWorkitemRequest {
	...
	public GetTaskmanagementWorkitemRequest withWorkitemId(String workitemId) {
    ...
    public GetTaskmanagementWorkitemRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.workitemId == null) {
            throw new IllegalStateException("Missing the required parameter 'workitemId' when building request for GetTaskmanagementWorkitemRequest.");
        }
	...
	public static class Builder {
		private final GetTaskmanagementWorkitemRequest request;

		private Builder() {
			request = new GetTaskmanagementWorkitemRequest();
		}
		...
		public GetTaskmanagementWorkitemRequest build() {
