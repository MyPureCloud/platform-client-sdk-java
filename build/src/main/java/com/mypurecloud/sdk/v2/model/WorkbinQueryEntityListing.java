...
public class WorkbinQueryEntityListing  implements Serializable {
  ...
  private List<Workbin> entities = null;
  ...
  public WorkbinQueryEntityListing() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
      entities = new ArrayList<Workbin>();
    }
  }

  public WorkbinQueryEntityListing(Boolean initWithEmptyList) {
