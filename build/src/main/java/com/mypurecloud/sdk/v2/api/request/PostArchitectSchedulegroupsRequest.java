...
public class PostArchitectSchedulegroupsRequest {
	...
	public PostArchitectSchedulegroupsRequest withBody(ScheduleGroup body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostArchitectSchedulegroupsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<ScheduleGroup> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostArchitectSchedulegroupsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/architect/schedulegroups")
                .withBody(body)
	...
	public static Builder builder(ScheduleGroup body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostArchitectSchedulegroupsRequest request;

		private Builder() {
			request = new PostArchitectSchedulegroupsRequest();
		}
		...
		public Builder withRequiredParams(ScheduleGroup body) {
			request.setBody(body);
		...
		public PostArchitectSchedulegroupsRequest build() {
