...
public class PostAnalyticsAgentutilizationsAggregatesJobsRequest {

	private AgentUtilizationAsyncAggregationQuery body;
	public AgentUtilizationAsyncAggregationQuery getBody() {
		return this.body;
	}

	public void setBody(AgentUtilizationAsyncAggregationQuery body) {
		this.body = body;
	}

	public PostAnalyticsAgentutilizationsAggregatesJobsRequest withBody(AgentUtilizationAsyncAggregationQuery body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostAnalyticsAgentutilizationsAggregatesJobsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<AgentUtilizationAsyncAggregationQuery> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostAnalyticsAgentutilizationsAggregatesJobsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/analytics/agentutilizations/aggregates/jobs")
                .withBody(body)
	...
	public static Builder builder(AgentUtilizationAsyncAggregationQuery body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostAnalyticsAgentutilizationsAggregatesJobsRequest request;

		private Builder() {
			request = new PostAnalyticsAgentutilizationsAggregatesJobsRequest();
		}


		public Builder withBody(AgentUtilizationAsyncAggregationQuery body) {
		...
		public Builder withRequiredParams(AgentUtilizationAsyncAggregationQuery body) {
			request.setBody(body);
		...
		public PostAnalyticsAgentutilizationsAggregatesJobsRequest build() {
