...
public class PostUserInviteRequest {
	...
	public PostUserInviteRequest withUserId(String userId) {
	...
	public PostUserInviteRequest withForce(Boolean force) {
	    this.setForce(force);
	    return this;
	} 
    ...
    public PostUserInviteRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.userId == null) {
            throw new IllegalStateException("Missing the required parameter 'userId' when building request for PostUserInviteRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/users/{userId}/invite")
	...
	public static class Builder {
		private final PostUserInviteRequest request;

		private Builder() {
			request = new PostUserInviteRequest();
		}
		...
		public PostUserInviteRequest build() {
