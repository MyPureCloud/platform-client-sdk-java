...
public class GetAgenticVirtualagentRequest {
	...
	public GetAgenticVirtualagentRequest withVirtualAgentId(String virtualAgentId) {
    ...
    public GetAgenticVirtualagentRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.virtualAgentId == null) {
            throw new IllegalStateException("Missing the required parameter 'virtualAgentId' when building request for GetAgenticVirtualagentRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/agentic/virtualagents/{virtualAgentId}")
	...
	public static class Builder {
		private final GetAgenticVirtualagentRequest request;

		private Builder() {
			request = new GetAgenticVirtualagentRequest();
		}
		...
		public GetAgenticVirtualagentRequest build() {
