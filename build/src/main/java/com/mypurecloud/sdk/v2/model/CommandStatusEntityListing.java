...
public class CommandStatusEntityListing  implements Serializable, PagedResource<CommandStatus> {
  ...
  /**
   **/
  public CommandStatusEntityListing entities(List<CommandStatus> entities) {
  ...
  public List<CommandStatus> getEntities() {
    return entities;
  }
  public void setEntities(List<CommandStatus> entities) {
    this.entities = entities;
  }
