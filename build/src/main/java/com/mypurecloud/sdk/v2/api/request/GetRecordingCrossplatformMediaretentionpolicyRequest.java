...
public class GetRecordingCrossplatformMediaretentionpolicyRequest {
	...
	public GetRecordingCrossplatformMediaretentionpolicyRequest withPolicyId(String policyId) {
    ...
    public GetRecordingCrossplatformMediaretentionpolicyRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.policyId == null) {
            throw new IllegalStateException("Missing the required parameter 'policyId' when building request for GetRecordingCrossplatformMediaretentionpolicyRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/recording/crossplatform/mediaretentionpolicies/{policyId}")
	...
	public static class Builder {
		private final GetRecordingCrossplatformMediaretentionpolicyRequest request;

		private Builder() {
			request = new GetRecordingCrossplatformMediaretentionpolicyRequest();
		}
		...
		public GetRecordingCrossplatformMediaretentionpolicyRequest build() {
