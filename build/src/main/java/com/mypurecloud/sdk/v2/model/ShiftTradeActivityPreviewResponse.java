...
public class ShiftTradeActivityPreviewResponse  implements Serializable {
  ...
  @ApiModelProperty(example = "null", value = "The start date and time of this activity. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss.SSSZ")
