...
public class DeleteOutboundImporttemplatesRequest {
	...
	public DeleteOutboundImporttemplatesRequest withId(List<String> id) {
	    this.setId(id);
	    return this;
	} 
    ...
    public DeleteOutboundImporttemplatesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.id == null) {
            throw new IllegalStateException("Missing the required parameter 'id' when building request for DeleteOutboundImporttemplatesRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/outbound/importtemplates")
	...
	public static class Builder {
		private final DeleteOutboundImporttemplatesRequest request;

		private Builder() {
			request = new DeleteOutboundImporttemplatesRequest();
		}
		...
		public DeleteOutboundImporttemplatesRequest build() {
