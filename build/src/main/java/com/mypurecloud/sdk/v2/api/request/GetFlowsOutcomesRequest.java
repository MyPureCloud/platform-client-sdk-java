...
public class GetFlowsOutcomesRequest {
	...
	public GetFlowsOutcomesRequest withPageNumber(Integer pageNumber) {
	...
	public GetFlowsOutcomesRequest withPageSize(Integer pageSize) {
	...
	public GetFlowsOutcomesRequest withSortBy(String sortBy) {
	...
	public GetFlowsOutcomesRequest withSortOrder(String sortOrder) {
	...
	public GetFlowsOutcomesRequest withId(List<String> id) {
	    this.setId(id);
	    return this;
	} 
	...
	public GetFlowsOutcomesRequest withName(String name) {
	    this.setName(name);
	    return this;
	} 
	...
	public GetFlowsOutcomesRequest withDescription(String description) {
	...
	public GetFlowsOutcomesRequest withNameOrDescription(String nameOrDescription) {
    ...
    public GetFlowsOutcomesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/flows/outcomes")
	...
	public static class Builder {
		private final GetFlowsOutcomesRequest request;

		private Builder() {
			request = new GetFlowsOutcomesRequest();
		}
		...
		public GetFlowsOutcomesRequest build() {
