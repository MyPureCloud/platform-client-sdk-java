...
public class DeleteOrgauthorizationTrusteesRequest {
	...
	public DeleteOrgauthorizationTrusteesRequest withId(List<String> id) {
	    this.setId(id);
	    return this;
	} 
    ...
    public DeleteOrgauthorizationTrusteesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.id == null) {
            throw new IllegalStateException("Missing the required parameter 'id' when building request for DeleteOrgauthorizationTrusteesRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/orgauthorization/trustees")
	...
	public static class Builder {
		private final DeleteOrgauthorizationTrusteesRequest request;

		private Builder() {
			request = new DeleteOrgauthorizationTrusteesRequest();
		}
		...
		public DeleteOrgauthorizationTrusteesRequest build() {
