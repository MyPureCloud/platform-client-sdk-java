...
public class PatchConversationsMessagingIntegrationsInstagramIntegrationIdRequest {
	...
	public PatchConversationsMessagingIntegrationsInstagramIntegrationIdRequest withIntegrationId(String integrationId) {
	    this.setIntegrationId(integrationId);
	    return this;
	} 

	private InstagramIntegrationUpdateRequest body;
	public InstagramIntegrationUpdateRequest getBody() {
		return this.body;
	}

	public void setBody(InstagramIntegrationUpdateRequest body) {
		this.body = body;
	}

	public PatchConversationsMessagingIntegrationsInstagramIntegrationIdRequest withBody(InstagramIntegrationUpdateRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchConversationsMessagingIntegrationsInstagramIntegrationIdRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<InstagramIntegrationUpdateRequest> withHttpInfo() {
        
        // verify the required parameter 'integrationId' is set
        if (this.integrationId == null) {
            throw new IllegalStateException("Missing the required parameter 'integrationId' when building request for PatchConversationsMessagingIntegrationsInstagramIntegrationIdRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchConversationsMessagingIntegrationsInstagramIntegrationIdRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/conversations/messaging/integrations/instagram/{integrationId}")
	...
	public static Builder builder(String integrationId, InstagramIntegrationUpdateRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PatchConversationsMessagingIntegrationsInstagramIntegrationIdRequest request;

		private Builder() {
			request = new PatchConversationsMessagingIntegrationsInstagramIntegrationIdRequest();
		}
		...
		public Builder withBody(InstagramIntegrationUpdateRequest body) {
		...
		public Builder withRequiredParams(String integrationId, InstagramIntegrationUpdateRequest body) {
			request.setIntegrationId(integrationId);
			request.setBody(body);
		...
		public PatchConversationsMessagingIntegrationsInstagramIntegrationIdRequest build() {
