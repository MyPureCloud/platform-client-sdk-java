...
import com.fasterxml.jackson.annotation.JsonValue;
import com.mypurecloud.sdk.v2.model.TeamActivityData;
...
public class TeamActivityResponse  implements Serializable {
  
  private List<TeamActivityData> results = null;
 ...
 @JsonDeserialize(using = EntityIdDimensionEnumDeserializer.class)
   ...
   * Query results
   **/
  public TeamActivityResponse results(List<TeamActivityData> results) {
  ...
  public List<TeamActivityData> getResults() {
    return results;
  }
  public void setResults(List<TeamActivityData> results) {
    this.results = results;
  }
   ...
   * Dimension that is used as an entityId
   **/
  public TeamActivityResponse entityIdDimension(EntityIdDimensionEnum entityIdDimension) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TeamActivityResponse teamActivityResponse = (TeamActivityResponse) o;

    return Objects.equals(this.results, teamActivityResponse.results) &&
            Objects.equals(this.entityIdDimension, teamActivityResponse.entityIdDimension);
  }
