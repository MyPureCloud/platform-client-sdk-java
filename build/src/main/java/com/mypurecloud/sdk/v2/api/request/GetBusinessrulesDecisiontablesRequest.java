...
public class GetBusinessrulesDecisiontablesRequest {
	...
	public GetBusinessrulesDecisiontablesRequest withAfter(String after) {
	    this.setAfter(after);
	    return this;
	} 
	...
	public GetBusinessrulesDecisiontablesRequest withPageSize(String pageSize) {
	...
	public GetBusinessrulesDecisiontablesRequest withDivisionIds(List<String> divisionIds) {
    ...
    public GetBusinessrulesDecisiontablesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/businessrules/decisiontables")
	...
	public static class Builder {
		private final GetBusinessrulesDecisiontablesRequest request;

		private Builder() {
			request = new GetBusinessrulesDecisiontablesRequest();
		}
		...
		public GetBusinessrulesDecisiontablesRequest build() {
