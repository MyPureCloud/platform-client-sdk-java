...
public class PostKnowledgeKnowledgebaseDocumentsBulkUpdateRequest {
	...
	public PostKnowledgeKnowledgebaseDocumentsBulkUpdateRequest withKnowledgeBaseId(String knowledgeBaseId) {
	    this.setKnowledgeBaseId(knowledgeBaseId);
	    return this;
	} 

	private KnowledgeDocumentBulkUpdateRequest body;
	public KnowledgeDocumentBulkUpdateRequest getBody() {
		return this.body;
	}

	public void setBody(KnowledgeDocumentBulkUpdateRequest body) {
		this.body = body;
	}

	public PostKnowledgeKnowledgebaseDocumentsBulkUpdateRequest withBody(KnowledgeDocumentBulkUpdateRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostKnowledgeKnowledgebaseDocumentsBulkUpdateRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<KnowledgeDocumentBulkUpdateRequest> withHttpInfo() {
        
        // verify the required parameter 'knowledgeBaseId' is set
        if (this.knowledgeBaseId == null) {
            throw new IllegalStateException("Missing the required parameter 'knowledgeBaseId' when building request for PostKnowledgeKnowledgebaseDocumentsBulkUpdateRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostKnowledgeKnowledgebaseDocumentsBulkUpdateRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/documents/bulk/update")
	...
	public static Builder builder(String knowledgeBaseId, KnowledgeDocumentBulkUpdateRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostKnowledgeKnowledgebaseDocumentsBulkUpdateRequest request;

		private Builder() {
			request = new PostKnowledgeKnowledgebaseDocumentsBulkUpdateRequest();
		}
		...
		public Builder withBody(KnowledgeDocumentBulkUpdateRequest body) {
		...
		public Builder withRequiredParams(String knowledgeBaseId, KnowledgeDocumentBulkUpdateRequest body) {
			request.setKnowledgeBaseId(knowledgeBaseId);
			request.setBody(body);
		...
		public PostKnowledgeKnowledgebaseDocumentsBulkUpdateRequest build() {
