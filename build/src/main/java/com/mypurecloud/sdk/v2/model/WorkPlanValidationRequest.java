...
public class WorkPlanValidationRequest  implements Serializable {
 ...
 @JsonDeserialize(using = ShiftStartVariancePeriodEnumDeserializer.class)
  ...
  public WorkPlanValidationRequest(Boolean initWithEmptyList) {
   ...
   **/
  public WorkPlanValidationRequest id(String id) {
    this.id = id;
    return this;
  }
   ...
   **/
  public WorkPlanValidationRequest constrainMaximumWorkingWeekendsPerPlanningPeriod(Boolean constrainMaximumWorkingWeekendsPerPlanningPeriod) {
   ...
   **/
  public WorkPlanValidationRequest maximumWorkingWeekendsPerPlanningPeriod(Integer maximumWorkingWeekendsPerPlanningPeriod) {
   ...
   * The length of the period over which the maximum shift start time variance is applied
   **/
  public WorkPlanValidationRequest shiftStartVariancePeriod(ShiftStartVariancePeriodEnum shiftStartVariancePeriod) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, workPlanValidationRequest.id) &&
            ...
            Objects.equals(this.constrainMaximumWorkingWeekendsPerPlanningPeriod, workPlanValidationRequest.constrainMaximumWorkingWeekendsPerPlanningPeriod) &&
            Objects.equals(this.maximumWorkingWeekendsPerPlanningPeriod, workPlanValidationRequest.maximumWorkingWeekendsPerPlanningPeriod) &&
            ...
            Objects.equals(this.shiftStartVariancePeriod, workPlanValidationRequest.shiftStartVariancePeriod) &&
