...
public class PostKnowledgeSourceSynchronizationUploadsRequest {
	...
	public PostKnowledgeSourceSynchronizationUploadsRequest withSourceId(String sourceId) {
	...
	public PostKnowledgeSourceSynchronizationUploadsRequest withSynchronizationId(String synchronizationId) {
	    this.setSynchronizationId(synchronizationId);
	    return this;
	} 

	private V3SynchronizationUploadUrlRequest body;
	public V3SynchronizationUploadUrlRequest getBody() {
		return this.body;
	}

	public void setBody(V3SynchronizationUploadUrlRequest body) {
		this.body = body;
	}

	public PostKnowledgeSourceSynchronizationUploadsRequest withBody(V3SynchronizationUploadUrlRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostKnowledgeSourceSynchronizationUploadsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<V3SynchronizationUploadUrlRequest> withHttpInfo() {
        
        // verify the required parameter 'sourceId' is set
        if (this.sourceId == null) {
            throw new IllegalStateException("Missing the required parameter 'sourceId' when building request for PostKnowledgeSourceSynchronizationUploadsRequest.");
        }
        
        // verify the required parameter 'synchronizationId' is set
        if (this.synchronizationId == null) {
            throw new IllegalStateException("Missing the required parameter 'synchronizationId' when building request for PostKnowledgeSourceSynchronizationUploadsRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostKnowledgeSourceSynchronizationUploadsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/knowledge/sources/{sourceId}/synchronizations/{synchronizationId}/uploads")
	...
	public static Builder builder(String sourceId, String synchronizationId, V3SynchronizationUploadUrlRequest body) {
	    return new Builder()
	            .withRequiredParams(sourceId, synchronizationId, body);
	}


	public static class Builder {
		private final PostKnowledgeSourceSynchronizationUploadsRequest request;

		private Builder() {
			request = new PostKnowledgeSourceSynchronizationUploadsRequest();
		}
		...
		public Builder withBody(V3SynchronizationUploadUrlRequest body) {
		...
		public Builder withRequiredParams(String sourceId, String synchronizationId, V3SynchronizationUploadUrlRequest body) {
			request.setSourceId(sourceId);
			request.setSynchronizationId(synchronizationId);
			request.setBody(body);
		...
		public PostKnowledgeSourceSynchronizationUploadsRequest build() {
