...
public class PutRoutingSmsIdentityresolutionPhonenumberRequest {
	...
	public PutRoutingSmsIdentityresolutionPhonenumberRequest withBody(IdentityResolutionConfig body) {
	    this.setBody(body);
	    return this;
	} 
	...
	public static Builder builder(String addressId, IdentityResolutionConfig body) {
	    return new Builder()
	...
	public static class Builder {
		...
		public Builder withRequiredParams(String addressId, IdentityResolutionConfig body) {
			request.setAddressId(addressId);
			request.setBody(body);
