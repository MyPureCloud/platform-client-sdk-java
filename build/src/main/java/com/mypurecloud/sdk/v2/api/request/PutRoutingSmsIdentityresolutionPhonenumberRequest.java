...
public class PutRoutingSmsIdentityresolutionPhonenumberRequest {
	...
	public PutRoutingSmsIdentityresolutionPhonenumberRequest withAddressId(String addressId) {
	    this.setAddressId(addressId);
	    return this;
	} 

	private SmsIdentityResolutionConfig body;
	public SmsIdentityResolutionConfig getBody() {
		return this.body;
	}

	public void setBody(SmsIdentityResolutionConfig body) {
		this.body = body;
	}

	public PutRoutingSmsIdentityresolutionPhonenumberRequest withBody(SmsIdentityResolutionConfig body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutRoutingSmsIdentityresolutionPhonenumberRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<SmsIdentityResolutionConfig> withHttpInfo() {
        
        // verify the required parameter 'addressId' is set
        if (this.addressId == null) {
            throw new IllegalStateException("Missing the required parameter 'addressId' when building request for PutRoutingSmsIdentityresolutionPhonenumberRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutRoutingSmsIdentityresolutionPhonenumberRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/routing/sms/identityresolution/phonenumbers/{addressId}")
	...
	public static Builder builder(String addressId, SmsIdentityResolutionConfig body) {
	    return new Builder()
	...
	public static class Builder {
		private final PutRoutingSmsIdentityresolutionPhonenumberRequest request;

		private Builder() {
			request = new PutRoutingSmsIdentityresolutionPhonenumberRequest();
		}
		...
		public Builder withBody(SmsIdentityResolutionConfig body) {
		...
		public Builder withRequiredParams(String addressId, SmsIdentityResolutionConfig body) {
			request.setAddressId(addressId);
			request.setBody(body);
		...
		public PutRoutingSmsIdentityresolutionPhonenumberRequest build() {
