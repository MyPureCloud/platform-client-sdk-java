...
public class GetConversationsKeyconfigurationsRequest {
    ...
    public GetConversationsKeyconfigurationsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/conversations/keyconfigurations")
	...
	public static class Builder {
		private final GetConversationsKeyconfigurationsRequest request;

		private Builder() {
			request = new GetConversationsKeyconfigurationsRequest();
		}
		...
		public GetConversationsKeyconfigurationsRequest build() {
