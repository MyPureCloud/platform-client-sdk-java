...
public class WhatsAppIntegrationRequest  implements Serializable {
  ...
  public WhatsAppIntegrationRequest(Boolean initWithEmptyList) {
   ...
   **/
  public WhatsAppIntegrationRequest messagingSetting(MessagingSettingRequestReference messagingSetting) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, supportedContent, messagingSetting, phoneNumber, wabaCertificate, selfUri);
  }
