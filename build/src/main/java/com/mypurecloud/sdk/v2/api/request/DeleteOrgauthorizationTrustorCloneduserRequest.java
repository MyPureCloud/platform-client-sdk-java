...
public class DeleteOrgauthorizationTrustorCloneduserRequest {
	...
	public DeleteOrgauthorizationTrustorCloneduserRequest withTrustorOrgId(String trustorOrgId) {
	...
	public DeleteOrgauthorizationTrustorCloneduserRequest withTrusteeUserId(String trusteeUserId) {
    ...
    public DeleteOrgauthorizationTrustorCloneduserRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.trustorOrgId == null) {
            throw new IllegalStateException("Missing the required parameter 'trustorOrgId' when building request for DeleteOrgauthorizationTrustorCloneduserRequest.");
        }
        
        // verify the required parameter 'trusteeUserId' is set
        if (this.trusteeUserId == null) {
            throw new IllegalStateException("Missing the required parameter 'trusteeUserId' when building request for DeleteOrgauthorizationTrustorCloneduserRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/orgauthorization/trustors/{trustorOrgId}/clonedusers/{trusteeUserId}")
	...
	public static class Builder {
		private final DeleteOrgauthorizationTrustorCloneduserRequest request;

		private Builder() {
			request = new DeleteOrgauthorizationTrustorCloneduserRequest();
		}
		...
		public DeleteOrgauthorizationTrustorCloneduserRequest build() {
