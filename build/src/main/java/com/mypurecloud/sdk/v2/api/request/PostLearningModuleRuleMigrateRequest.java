...
public class PostLearningModuleRuleMigrateRequest {
	...
	public PostLearningModuleRuleMigrateRequest withModuleId(String moduleId) {
    ...
    public PostLearningModuleRuleMigrateRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.moduleId == null) {
            throw new IllegalStateException("Missing the required parameter 'moduleId' when building request for PostLearningModuleRuleMigrateRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/learning/modules/{moduleId}/rule/migrate")
	...
	public static class Builder {
		private final PostLearningModuleRuleMigrateRequest request;

		private Builder() {
			request = new PostLearningModuleRuleMigrateRequest();
		}
		...
		public PostLearningModuleRuleMigrateRequest build() {
