...
public class PostWorkforcemanagementBusinessunitWorkplanbidCopyRequest {
	...
	public PostWorkforcemanagementBusinessunitWorkplanbidCopyRequest withBusinessUnitId(String businessUnitId) {
	...
	public PostWorkforcemanagementBusinessunitWorkplanbidCopyRequest withBidId(String bidId) {
	    this.setBidId(bidId);
	    return this;
	} 

	private CopyWorkPlanBid body;
	public CopyWorkPlanBid getBody() {
		return this.body;
	}

	public void setBody(CopyWorkPlanBid body) {
		this.body = body;
	}

	public PostWorkforcemanagementBusinessunitWorkplanbidCopyRequest withBody(CopyWorkPlanBid body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementBusinessunitWorkplanbidCopyRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<CopyWorkPlanBid> withHttpInfo() {
        
        // verify the required parameter 'businessUnitId' is set
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PostWorkforcemanagementBusinessunitWorkplanbidCopyRequest.");
        }
        
        // verify the required parameter 'bidId' is set
        if (this.bidId == null) {
            throw new IllegalStateException("Missing the required parameter 'bidId' when building request for PostWorkforcemanagementBusinessunitWorkplanbidCopyRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementBusinessunitWorkplanbidCopyRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/workplanbids/{bidId}/copy")
	...
	public static Builder builder(String businessUnitId, String bidId, CopyWorkPlanBid body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementBusinessunitWorkplanbidCopyRequest request;

		private Builder() {
			request = new PostWorkforcemanagementBusinessunitWorkplanbidCopyRequest();
		}
		...
		public Builder withBody(CopyWorkPlanBid body) {
		...
		public Builder withRequiredParams(String businessUnitId, String bidId, CopyWorkPlanBid body) {
			request.setBusinessUnitId(businessUnitId);
			request.setBidId(bidId);
			request.setBody(body);
		...
		public PostWorkforcemanagementBusinessunitWorkplanbidCopyRequest build() {
