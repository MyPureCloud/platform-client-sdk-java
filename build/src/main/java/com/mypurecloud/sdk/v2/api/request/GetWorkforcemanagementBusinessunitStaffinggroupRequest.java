...
public class GetWorkforcemanagementBusinessunitStaffinggroupRequest {
	...
	public GetWorkforcemanagementBusinessunitStaffinggroupRequest withBusinessUnitId(String businessUnitId) {
	...
	public GetWorkforcemanagementBusinessunitStaffinggroupRequest withStaffingGroupId(String staffingGroupId) {
    ...
    public GetWorkforcemanagementBusinessunitStaffinggroupRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for GetWorkforcemanagementBusinessunitStaffinggroupRequest.");
        }
        
        // verify the required parameter 'staffingGroupId' is set
        if (this.staffingGroupId == null) {
            throw new IllegalStateException("Missing the required parameter 'staffingGroupId' when building request for GetWorkforcemanagementBusinessunitStaffinggroupRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/staffinggroups/{staffingGroupId}")
	...
	public static class Builder {
		private final GetWorkforcemanagementBusinessunitStaffinggroupRequest request;

		private Builder() {
			request = new GetWorkforcemanagementBusinessunitStaffinggroupRequest();
		}
		...
		public GetWorkforcemanagementBusinessunitStaffinggroupRequest build() {
