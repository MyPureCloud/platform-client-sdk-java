...
public class PostRoutingQueueWrapupcodesRequest {
	...
	public PostRoutingQueueWrapupcodesRequest withQueueId(String queueId) {
    ...
    public PostRoutingQueueWrapupcodesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<List<WrapUpCodeReference>> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("POST", "/api/v2/routing/queues/{queueId}/wrapupcodes")
	...
	public static class Builder {
		private final PostRoutingQueueWrapupcodesRequest request;

		private Builder() {
			request = new PostRoutingQueueWrapupcodesRequest();
		}
		...
		public PostRoutingQueueWrapupcodesRequest build() {
