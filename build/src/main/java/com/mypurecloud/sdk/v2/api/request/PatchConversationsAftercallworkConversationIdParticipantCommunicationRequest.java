...
public class PatchConversationsAftercallworkConversationIdParticipantCommunicationRequest {
	...
	public PatchConversationsAftercallworkConversationIdParticipantCommunicationRequest withConversationId(String conversationId) {
	...
	public PatchConversationsAftercallworkConversationIdParticipantCommunicationRequest withParticipantId(String participantId) {
	...
	public PatchConversationsAftercallworkConversationIdParticipantCommunicationRequest withCommunicationId(String communicationId) {
	    this.setCommunicationId(communicationId);
	    return this;
	} 

	private AfterCallWorkUpdate body;
	public AfterCallWorkUpdate getBody() {
		return this.body;
	}

	public void setBody(AfterCallWorkUpdate body) {
		this.body = body;
	}

	public PatchConversationsAftercallworkConversationIdParticipantCommunicationRequest withBody(AfterCallWorkUpdate body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchConversationsAftercallworkConversationIdParticipantCommunicationRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<AfterCallWorkUpdate> withHttpInfo() {
        
        // verify the required parameter 'conversationId' is set
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PatchConversationsAftercallworkConversationIdParticipantCommunicationRequest.");
        }
        
        // verify the required parameter 'participantId' is set
        if (this.participantId == null) {
            throw new IllegalStateException("Missing the required parameter 'participantId' when building request for PatchConversationsAftercallworkConversationIdParticipantCommunicationRequest.");
        }
        
        // verify the required parameter 'communicationId' is set
        if (this.communicationId == null) {
            throw new IllegalStateException("Missing the required parameter 'communicationId' when building request for PatchConversationsAftercallworkConversationIdParticipantCommunicationRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchConversationsAftercallworkConversationIdParticipantCommunicationRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/conversations/aftercallwork/{conversationId}/participants/{participantId}/communications/{communicationId}")
	...
	public static Builder builder(String conversationId, String participantId, String communicationId, AfterCallWorkUpdate body) {
	    return new Builder()
	...
	public static class Builder {
		private final PatchConversationsAftercallworkConversationIdParticipantCommunicationRequest request;

		private Builder() {
			request = new PatchConversationsAftercallworkConversationIdParticipantCommunicationRequest();
		}
		...
		public Builder withBody(AfterCallWorkUpdate body) {
		...
		public Builder withRequiredParams(String conversationId, String participantId, String communicationId, AfterCallWorkUpdate body) {
			request.setConversationId(conversationId);
			request.setParticipantId(participantId);
			request.setCommunicationId(communicationId);
			request.setBody(body);
		...
		public PatchConversationsAftercallworkConversationIdParticipantCommunicationRequest build() {
