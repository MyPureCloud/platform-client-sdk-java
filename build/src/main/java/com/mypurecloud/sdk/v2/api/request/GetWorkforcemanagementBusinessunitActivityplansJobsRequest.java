...
public class GetWorkforcemanagementBusinessunitActivityplansJobsRequest {
	...
	public GetWorkforcemanagementBusinessunitActivityplansJobsRequest withBusinessUnitId(String businessUnitId) {
    ...
    public GetWorkforcemanagementBusinessunitActivityplansJobsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for GetWorkforcemanagementBusinessunitActivityplansJobsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/activityplans/jobs")
	...
	public static class Builder {
		private final GetWorkforcemanagementBusinessunitActivityplansJobsRequest request;

		private Builder() {
			request = new GetWorkforcemanagementBusinessunitActivityplansJobsRequest();
		}
		...
		public GetWorkforcemanagementBusinessunitActivityplansJobsRequest build() {
