...
public class MessagingCampaignSchedule  implements Serializable {
  ...
  public MessagingCampaignSchedule(Boolean initWithEmptyList) {
   ...
   **/
  public MessagingCampaignSchedule recurrences(List<Reoccurrence> recurrences) {
  ...
  @ApiModelProperty(example = "null", value = "The time zone for this messaging campaign schedule. Defaults to UTC if empty or not provided. See here for a list of valid time zones https://www.iana.org/time-zones. Time zones are represented as a string of the zone name as found in the IANA time zone database. For example: UTC, Etc/UTC, or Europe/London")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, messagingCampaignSchedule.id) &&
            ...
            Objects.equals(this.recurrences, messagingCampaignSchedule.recurrences) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, dateCreated, dateModified, version, intervals, recurrences, timeZone, messagingCampaign, selfUri);
  }
