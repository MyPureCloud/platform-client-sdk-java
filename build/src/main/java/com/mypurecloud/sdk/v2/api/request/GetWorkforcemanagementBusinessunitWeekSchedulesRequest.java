...
public class GetWorkforcemanagementBusinessunitWeekSchedulesRequest {
	...
	public GetWorkforcemanagementBusinessunitWeekSchedulesRequest withBusinessUnitId(String businessUnitId) {
	...
	public GetWorkforcemanagementBusinessunitWeekSchedulesRequest withWeekId(String weekId) {
	...
	public GetWorkforcemanagementBusinessunitWeekSchedulesRequest withIncludeOnlyPublished(Boolean includeOnlyPublished) {
	...
	public GetWorkforcemanagementBusinessunitWeekSchedulesRequest withExpand(String expand) {
    ...
    public GetWorkforcemanagementBusinessunitWeekSchedulesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for GetWorkforcemanagementBusinessunitWeekSchedulesRequest.");
        }
        
        // verify the required parameter 'weekId' is set
        if (this.weekId == null) {
            throw new IllegalStateException("Missing the required parameter 'weekId' when building request for GetWorkforcemanagementBusinessunitWeekSchedulesRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/weeks/{weekId}/schedules")
	...
	public static Builder builder(String businessUnitId, String weekId) {
	    return new Builder()
	            .withRequiredParams(businessUnitId, weekId);
	}
	

	public static class Builder {
		private final GetWorkforcemanagementBusinessunitWeekSchedulesRequest request;

		private Builder() {
			request = new GetWorkforcemanagementBusinessunitWeekSchedulesRequest();
		}
		...
		public Builder withRequiredParams(String businessUnitId, String weekId) {
			request.setBusinessUnitId(businessUnitId);
						request.setWeekId(weekId);
		...
		public GetWorkforcemanagementBusinessunitWeekSchedulesRequest build() {
