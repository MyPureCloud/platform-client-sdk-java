...
public class GetJourneyExternalcontactSegmentsRequest {
	...
	public GetJourneyExternalcontactSegmentsRequest withExternalContactId(String externalContactId) {
	...
	public GetJourneyExternalcontactSegmentsRequest withPageSize(String pageSize) {
	...
	public GetJourneyExternalcontactSegmentsRequest withAfter(String after) {
	    this.setAfter(after);
	    return this;
	} 
	...
	public GetJourneyExternalcontactSegmentsRequest withSegmentScope(String segmentScope) {
	...
	public GetJourneyExternalcontactSegmentsRequest withAssignmentState(String assignmentState) {
    ...
    public GetJourneyExternalcontactSegmentsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.externalContactId == null) {
            throw new IllegalStateException("Missing the required parameter 'externalContactId' when building request for GetJourneyExternalcontactSegmentsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/journey/externalcontacts/{externalContactId}/segments")
	...
	public static class Builder {
		private final GetJourneyExternalcontactSegmentsRequest request;

		private Builder() {
			request = new GetJourneyExternalcontactSegmentsRequest();
		}
		...
		public GetJourneyExternalcontactSegmentsRequest build() {
