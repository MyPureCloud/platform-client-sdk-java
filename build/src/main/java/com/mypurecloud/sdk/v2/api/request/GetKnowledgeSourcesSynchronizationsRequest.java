...
public class GetKnowledgeSourcesSynchronizationsRequest {
	...
	public GetKnowledgeSourcesSynchronizationsRequest withBefore(String before) {
	...
	public GetKnowledgeSourcesSynchronizationsRequest withAfter(String after) {
	    this.setAfter(after);
	    return this;
	} 
	...
	public GetKnowledgeSourcesSynchronizationsRequest withPageSize(String pageSize) {
    ...
    public GetKnowledgeSourcesSynchronizationsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/knowledge/sources/synchronizations")
	...
	public static class Builder {
		private final GetKnowledgeSourcesSynchronizationsRequest request;

		private Builder() {
			request = new GetKnowledgeSourcesSynchronizationsRequest();
		}
		...
		public GetKnowledgeSourcesSynchronizationsRequest build() {
