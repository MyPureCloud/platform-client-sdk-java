...
public class GetConversationsCallParticipantWrapupcodesRequest {
	...
	public GetConversationsCallParticipantWrapupcodesRequest withConversationId(String conversationId) {
	...
	public GetConversationsCallParticipantWrapupcodesRequest withParticipantId(String participantId) {
    ...
    public GetConversationsCallParticipantWrapupcodesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for GetConversationsCallParticipantWrapupcodesRequest.");
        }
        
        // verify the required parameter 'participantId' is set
        if (this.participantId == null) {
            throw new IllegalStateException("Missing the required parameter 'participantId' when building request for GetConversationsCallParticipantWrapupcodesRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/conversations/calls/{conversationId}/participants/{participantId}/wrapupcodes")
	...
	public static class Builder {
		private final GetConversationsCallParticipantWrapupcodesRequest request;

		private Builder() {
			request = new GetConversationsCallParticipantWrapupcodesRequest();
		}
		...
		public GetConversationsCallParticipantWrapupcodesRequest build() {
