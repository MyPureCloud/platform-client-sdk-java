...
public class GetConversationsCallParticipantWrapupcodesRequest {
	...
	public GetConversationsCallParticipantWrapupcodesRequest withCallId(String callId) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.callId == null) {
            throw new IllegalStateException("Missing the required parameter 'callId' when building request for GetConversationsCallParticipantWrapupcodesRequest.");
        }
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/conversations/calls/{callId}/participants/{participantId}/wrapupcodes")
