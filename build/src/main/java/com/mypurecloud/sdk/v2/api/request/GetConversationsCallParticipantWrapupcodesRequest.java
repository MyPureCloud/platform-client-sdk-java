...
public class GetConversationsCallParticipantWrapupcodesRequest {
    ...
    public ApiRequest<Void> withHttpInfo() throws ApiException {
        ...
        if (this.callId == null) {
            throw new ApiException(400, "Missing the required parameter 'callId' when building request for GetConversationsCallParticipantWrapupcodesRequest.");
        }
        
        // verify the required parameter 'participantId' is set
        if (this.participantId == null) {
            throw new ApiException(400, "Missing the required parameter 'participantId' when building request for GetConversationsCallParticipantWrapupcodesRequest.");
        }
