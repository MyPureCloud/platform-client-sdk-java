...
public class DeleteWorkforcemanagementCalendarUrlIcsRequest {
    ...
    public DeleteWorkforcemanagementCalendarUrlIcsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("DELETE", "/api/v2/workforcemanagement/calendar/url/ics")
	...
	public static class Builder {
		private final DeleteWorkforcemanagementCalendarUrlIcsRequest request;

		private Builder() {
			request = new DeleteWorkforcemanagementCalendarUrlIcsRequest();
		}
		...
		public DeleteWorkforcemanagementCalendarUrlIcsRequest build() {
