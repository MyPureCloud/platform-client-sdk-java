...
import com.mypurecloud.sdk.v2.model.BulkResponseResultNoteNote;
...
public class BulkNotesResponse  implements Serializable {
  ...
  private List<BulkResponseResultNoteNote> results = new ArrayList<BulkResponseResultNoteNote>();
  ...
  /**
   **/
  public BulkNotesResponse results(List<BulkResponseResultNoteNote> results) {
  ...
  public void setResults(List<BulkResponseResultNoteNote> results) {
    this.results = results;
  }
