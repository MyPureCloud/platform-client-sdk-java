...
import com.mypurecloud.sdk.v2.model.MessagingSticker;
...
public class MessagingStickerEntityListing  implements Serializable, PagedResource<MessagingSticker> {
  ...
  /**
   **/
  public MessagingStickerEntityListing entities(List<MessagingSticker> entities) {
  ...
  public List<MessagingSticker> getEntities() {
    return entities;
  }
  public void setEntities(List<MessagingSticker> entities) {
    this.entities = entities;
  }
  ...
  public String toString() {
    ...
    sb.append("class MessagingStickerEntityListing {\n");
