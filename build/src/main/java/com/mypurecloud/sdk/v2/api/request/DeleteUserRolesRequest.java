...
public class DeleteUserRolesRequest {
	...
	public DeleteUserRolesRequest withUserId(String userId) {
    ...
    public DeleteUserRolesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.userId == null) {
            throw new IllegalStateException("Missing the required parameter 'userId' when building request for DeleteUserRolesRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/users/{userId}/roles")
	...
	public static class Builder {
		private final DeleteUserRolesRequest request;

		private Builder() {
			request = new DeleteUserRolesRequest();
		}
		...
		public DeleteUserRolesRequest build() {
