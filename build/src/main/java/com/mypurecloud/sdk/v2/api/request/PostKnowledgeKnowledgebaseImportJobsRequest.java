...
public class PostKnowledgeKnowledgebaseImportJobsRequest {
	...
	public PostKnowledgeKnowledgebaseImportJobsRequest withKnowledgeBaseId(String knowledgeBaseId) {
	    this.setKnowledgeBaseId(knowledgeBaseId);
	    return this;
	} 

	private KnowledgeImportJobRequest body;
	public KnowledgeImportJobRequest getBody() {
		return this.body;
	}

	public void setBody(KnowledgeImportJobRequest body) {
		this.body = body;
	}

	public PostKnowledgeKnowledgebaseImportJobsRequest withBody(KnowledgeImportJobRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostKnowledgeKnowledgebaseImportJobsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<KnowledgeImportJobRequest> withHttpInfo() {
        
        // verify the required parameter 'knowledgeBaseId' is set
        if (this.knowledgeBaseId == null) {
            throw new IllegalStateException("Missing the required parameter 'knowledgeBaseId' when building request for PostKnowledgeKnowledgebaseImportJobsRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostKnowledgeKnowledgebaseImportJobsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/import/jobs")
	...
	public static Builder builder(String knowledgeBaseId, KnowledgeImportJobRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostKnowledgeKnowledgebaseImportJobsRequest request;

		private Builder() {
			request = new PostKnowledgeKnowledgebaseImportJobsRequest();
		}
		...
		public Builder withBody(KnowledgeImportJobRequest body) {
		...
		public Builder withRequiredParams(String knowledgeBaseId, KnowledgeImportJobRequest body) {
			request.setKnowledgeBaseId(knowledgeBaseId);
			request.setBody(body);
		...
		public PostKnowledgeKnowledgebaseImportJobsRequest build() {
