...
public class PostChatsUsersMeSettingsRequest {

	private UserChatSettingsPost body;
	public UserChatSettingsPost getBody() {
		return this.body;
	}

	public void setBody(UserChatSettingsPost body) {
		this.body = body;
	}

	public PostChatsUsersMeSettingsRequest withBody(UserChatSettingsPost body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostChatsUsersMeSettingsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<UserChatSettingsPost> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostChatsUsersMeSettingsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/chats/users/me/settings")
                .withBody(body)
	...
	public static Builder builder(UserChatSettingsPost body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostChatsUsersMeSettingsRequest request;

		private Builder() {
			request = new PostChatsUsersMeSettingsRequest();
		}


		public Builder withBody(UserChatSettingsPost body) {
		...
		public Builder withRequiredParams(UserChatSettingsPost body) {
			request.setBody(body);
		...
		public PostChatsUsersMeSettingsRequest build() {
