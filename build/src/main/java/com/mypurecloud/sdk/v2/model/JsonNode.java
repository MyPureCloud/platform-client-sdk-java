...
public class JsonNode  implements Serializable {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(array, _null, nodeType, object, _boolean, number, _float, containerNode, missingNode, pojo, integralNumber, floatingPointNumber, _short, _int, _long, _double, bigDecimal, bigInteger, textual, binary, valueNode);
  }
