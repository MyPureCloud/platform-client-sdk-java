...
public class JsonNode  implements Serializable {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(nodeType, _float, object, _boolean, number, floatingPointNumber, valueNode, containerNode, missingNode, binary, pojo, integralNumber, _short, _int, _long, _double, bigDecimal, bigInteger, textual, array, _null);
  }
