...
public class JsonNode  implements Serializable {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(array, _null, nodeType, object, _boolean, number, _float, missingNode, integralNumber, _short, pojo, valueNode, containerNode, floatingPointNumber, _int, _long, _double, bigDecimal, bigInteger, textual, binary);
  }
