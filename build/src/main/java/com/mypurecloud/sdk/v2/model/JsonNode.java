...
public class JsonNode  implements Serializable {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(nodeType, _float, object, _boolean, number, containerNode, valueNode, missingNode, pojo, integralNumber, floatingPointNumber, _short, _int, _long, _double, bigDecimal, bigInteger, textual, binary, array, _null);
  }
