...
public class GetTelephonyProvidersEdgesSiteNumberplansRequest {
	...
	public GetTelephonyProvidersEdgesSiteNumberplansRequest withSiteId(String siteId) {
    ...
    public GetTelephonyProvidersEdgesSiteNumberplansRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.siteId == null) {
            throw new IllegalStateException("Missing the required parameter 'siteId' when building request for GetTelephonyProvidersEdgesSiteNumberplansRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/telephony/providers/edges/sites/{siteId}/numberplans")
	...
	public static class Builder {
		private final GetTelephonyProvidersEdgesSiteNumberplansRequest request;

		private Builder() {
			request = new GetTelephonyProvidersEdgesSiteNumberplansRequest();
		}
		...
		public GetTelephonyProvidersEdgesSiteNumberplansRequest build() {
