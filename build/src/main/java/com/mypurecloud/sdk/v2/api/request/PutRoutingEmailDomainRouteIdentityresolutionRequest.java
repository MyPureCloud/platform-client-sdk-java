...
public class PutRoutingEmailDomainRouteIdentityresolutionRequest {
	...
	public PutRoutingEmailDomainRouteIdentityresolutionRequest withDomainName(String domainName) {
	...
	public PutRoutingEmailDomainRouteIdentityresolutionRequest withRouteId(String routeId) {
    ...
    public ApiRequest<IdentityResolutionConfig> withHttpInfo() {
        ...
        if (this.domainName == null) {
            throw new IllegalStateException("Missing the required parameter 'domainName' when building request for PutRoutingEmailDomainRouteIdentityresolutionRequest.");
        }
        
        // verify the required parameter 'routeId' is set
        if (this.routeId == null) {
            throw new IllegalStateException("Missing the required parameter 'routeId' when building request for PutRoutingEmailDomainRouteIdentityresolutionRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutRoutingEmailDomainRouteIdentityresolutionRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/routing/email/domains/{domainName}/routes/{routeId}/identityresolution")
	...
	public static class Builder {
		private final PutRoutingEmailDomainRouteIdentityresolutionRequest request;

		private Builder() {
			request = new PutRoutingEmailDomainRouteIdentityresolutionRequest();
		}
		...
		public PutRoutingEmailDomainRouteIdentityresolutionRequest build() {
