...
public class DeleteAlertingUserpresenceAlertRequest {
	...
	public DeleteAlertingUserpresenceAlertRequest withAlertId(String alertId) {
    ...
    public DeleteAlertingUserpresenceAlertRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.alertId == null) {
            throw new IllegalStateException("Missing the required parameter 'alertId' when building request for DeleteAlertingUserpresenceAlertRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/alerting/userpresence/alerts/{alertId}")
	...
	public static class Builder {
		private final DeleteAlertingUserpresenceAlertRequest request;

		private Builder() {
			request = new DeleteAlertingUserpresenceAlertRequest();
		}
		...
		public DeleteAlertingUserpresenceAlertRequest build() {
