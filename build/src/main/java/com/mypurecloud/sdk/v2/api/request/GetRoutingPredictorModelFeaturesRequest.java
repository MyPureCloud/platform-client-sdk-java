...
public class GetRoutingPredictorModelFeaturesRequest {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/routing/predictors/{predictorId}/models/{modelId}/features")
                .withPathParameter("predictorId", predictorId)
        
                .withPathParameter("modelId", modelId)
	...
	public static Builder builder(String predictorId, String modelId) {
	    return new Builder()
	            .withRequiredParams(predictorId, modelId);
	}


	public static class Builder {
		private final GetRoutingPredictorModelFeaturesRequest request;

		private Builder() {
			request = new GetRoutingPredictorModelFeaturesRequest();
		}
