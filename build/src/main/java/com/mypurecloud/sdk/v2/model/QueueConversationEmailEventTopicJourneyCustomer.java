...
public class QueueConversationEmailEventTopicJourneyCustomer  implements Serializable {
  
  private String id = null;
  private String idType = null;

  public QueueConversationEmailEventTopicJourneyCustomer() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
    }
  }

  public QueueConversationEmailEventTopicJourneyCustomer(Boolean initWithEmptyList) {
   ...
   **/
  public QueueConversationEmailEventTopicJourneyCustomer id(String id) {
    this.id = id;
    return this;
  }
   ...
   **/
  public QueueConversationEmailEventTopicJourneyCustomer idType(String idType) {
    this.idType = idType;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    QueueConversationEmailEventTopicJourneyCustomer queueConversationEmailEventTopicJourneyCustomer = (QueueConversationEmailEventTopicJourneyCustomer) o;

    return Objects.equals(this.id, queueConversationEmailEventTopicJourneyCustomer.id) &&
            Objects.equals(this.idType, queueConversationEmailEventTopicJourneyCustomer.idType);
  }
