...
public class OutboundMessagingMessagingCampaignConfigChangeSmsPhoneNumberRef  implements Serializable {
  ...
  public OutboundMessagingMessagingCampaignConfigChangeSmsPhoneNumberRef() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
    }
  }

  public OutboundMessagingMessagingCampaignConfigChangeSmsPhoneNumberRef(Boolean initWithEmptyList) {
