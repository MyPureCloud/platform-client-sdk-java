...
public class GetScriptPageRequest {
    ...
    public ApiRequest<Void> withHttpInfo() throws ApiException {
        ...
        if (this.scriptId == null) {
            throw new ApiException(400, "Missing the required parameter 'scriptId' when building request for GetScriptPageRequest.");
        }
        
        // verify the required parameter 'pageId' is set
        if (this.pageId == null) {
            throw new ApiException(400, "Missing the required parameter 'pageId' when building request for GetScriptPageRequest.");
        }
