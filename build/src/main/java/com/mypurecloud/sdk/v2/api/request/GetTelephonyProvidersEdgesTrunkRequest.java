...
public class GetTelephonyProvidersEdgesTrunkRequest {
	...
	public GetTelephonyProvidersEdgesTrunkRequest withTrunkId(String trunkId) {
    ...
    public GetTelephonyProvidersEdgesTrunkRequest withCustomHeader(String name, String value) {
