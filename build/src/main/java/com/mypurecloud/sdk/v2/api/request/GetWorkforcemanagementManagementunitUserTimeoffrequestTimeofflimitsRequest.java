...
public class GetWorkforcemanagementManagementunitUserTimeoffrequestTimeofflimitsRequest {
	...
	public GetWorkforcemanagementManagementunitUserTimeoffrequestTimeofflimitsRequest withManagementUnitId(String managementUnitId) {
	...
	public GetWorkforcemanagementManagementunitUserTimeoffrequestTimeofflimitsRequest withUserId(String userId) {
	...
	public GetWorkforcemanagementManagementunitUserTimeoffrequestTimeofflimitsRequest withTimeOffRequestId(String timeOffRequestId) {
    ...
    public GetWorkforcemanagementManagementunitUserTimeoffrequestTimeofflimitsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.managementUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'managementUnitId' when building request for GetWorkforcemanagementManagementunitUserTimeoffrequestTimeofflimitsRequest.");
        }
        
        // verify the required parameter 'userId' is set
        if (this.userId == null) {
            throw new IllegalStateException("Missing the required parameter 'userId' when building request for GetWorkforcemanagementManagementunitUserTimeoffrequestTimeofflimitsRequest.");
        }
        
        // verify the required parameter 'timeOffRequestId' is set
        if (this.timeOffRequestId == null) {
            throw new IllegalStateException("Missing the required parameter 'timeOffRequestId' when building request for GetWorkforcemanagementManagementunitUserTimeoffrequestTimeofflimitsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/managementunits/{managementUnitId}/users/{userId}/timeoffrequests/{timeOffRequestId}/timeofflimits")
	...
	public static class Builder {
		private final GetWorkforcemanagementManagementunitUserTimeoffrequestTimeofflimitsRequest request;

		private Builder() {
			request = new GetWorkforcemanagementManagementunitUserTimeoffrequestTimeofflimitsRequest();
		}
		...
		public GetWorkforcemanagementManagementunitUserTimeoffrequestTimeofflimitsRequest build() {
