...
public class GetExternalcontactsOrganizationsExportRequest {
	...
	public GetExternalcontactsOrganizationsExportRequest withExportId(String exportId) {
    ...
    public GetExternalcontactsOrganizationsExportRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.exportId == null) {
            throw new IllegalStateException("Missing the required parameter 'exportId' when building request for GetExternalcontactsOrganizationsExportRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/externalcontacts/organizations/exports/{exportId}")
	...
	public static class Builder {
		private final GetExternalcontactsOrganizationsExportRequest request;

		private Builder() {
			request = new GetExternalcontactsOrganizationsExportRequest();
		}
		...
		public GetExternalcontactsOrganizationsExportRequest build() {
