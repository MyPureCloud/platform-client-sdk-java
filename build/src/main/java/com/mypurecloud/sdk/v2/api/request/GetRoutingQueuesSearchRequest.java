...
public class GetRoutingQueuesSearchRequest {
	...
	public GetRoutingQueuesSearchRequest withPageSize(Integer pageSize) {
	...
	public GetRoutingQueuesSearchRequest withPageNumber(Integer pageNumber) {
	...
	public GetRoutingQueuesSearchRequest withSortBy(String sortBy) {
	...
	public GetRoutingQueuesSearchRequest withSortOrder(String sortOrder) {
	...
	public GetRoutingQueuesSearchRequest withName(String name) {
	    this.setName(name);
	    return this;
	} 
	...
	public GetRoutingQueuesSearchRequest withId(List<String> id) {
	    this.setId(id);
	    return this;
	} 
	...
	public GetRoutingQueuesSearchRequest withDivisionId(List<String> divisionId) {
    ...
    public GetRoutingQueuesSearchRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/routing/queues/search")
	...
	public static class Builder {
		private final GetRoutingQueuesSearchRequest request;

		private Builder() {
			request = new GetRoutingQueuesSearchRequest();
		}
		...
		public GetRoutingQueuesSearchRequest build() {
