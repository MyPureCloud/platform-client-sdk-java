...
public class DeleteWorkforcemanagementBusinessunitSchedulebidRequest {
	...
	public DeleteWorkforcemanagementBusinessunitSchedulebidRequest withBusinessUnitId(String businessUnitId) {
	...
	public DeleteWorkforcemanagementBusinessunitSchedulebidRequest withBidId(String bidId) {
	    this.setBidId(bidId);
	    return this;
	} 
    ...
    public DeleteWorkforcemanagementBusinessunitSchedulebidRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for DeleteWorkforcemanagementBusinessunitSchedulebidRequest.");
        }
        
        // verify the required parameter 'bidId' is set
        if (this.bidId == null) {
            throw new IllegalStateException("Missing the required parameter 'bidId' when building request for DeleteWorkforcemanagementBusinessunitSchedulebidRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/schedulebids/{bidId}")
	...
	public static class Builder {
		private final DeleteWorkforcemanagementBusinessunitSchedulebidRequest request;

		private Builder() {
			request = new DeleteWorkforcemanagementBusinessunitSchedulebidRequest();
		}
		...
		public DeleteWorkforcemanagementBusinessunitSchedulebidRequest build() {
