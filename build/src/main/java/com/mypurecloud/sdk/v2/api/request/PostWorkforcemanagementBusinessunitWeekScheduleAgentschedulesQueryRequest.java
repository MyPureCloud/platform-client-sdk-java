...
public class PostWorkforcemanagementBusinessunitWeekScheduleAgentschedulesQueryRequest {
	...
	private BuQueryAgentSchedulesRequest body;
	public BuQueryAgentSchedulesRequest getBody() {
		return this.body;
	}

	public void setBody(BuQueryAgentSchedulesRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementBusinessunitWeekScheduleAgentschedulesQueryRequest withBody(BuQueryAgentSchedulesRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public ApiRequest<BuQueryAgentSchedulesRequest> withHttpInfo() {
        
        // verify the required parameter 'businessUnitId' is set
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PostWorkforcemanagementBusinessunitWeekScheduleAgentschedulesQueryRequest.");
        }
        
        // verify the required parameter 'weekId' is set
        if (this.weekId == null) {
            throw new IllegalStateException("Missing the required parameter 'weekId' when building request for PostWorkforcemanagementBusinessunitWeekScheduleAgentschedulesQueryRequest.");
        }
        
        // verify the required parameter 'scheduleId' is set
        if (this.scheduleId == null) {
            throw new IllegalStateException("Missing the required parameter 'scheduleId' when building request for PostWorkforcemanagementBusinessunitWeekScheduleAgentschedulesQueryRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementBusinessunitWeekScheduleAgentschedulesQueryRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/weeks/{weekId}/schedules/{scheduleId}/agentschedules/query")
	...
	public static Builder builder(String businessUnitId, LocalDate weekId, String scheduleId, BuQueryAgentSchedulesRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementBusinessunitWeekScheduleAgentschedulesQueryRequest request;

		private Builder() {
			request = new PostWorkforcemanagementBusinessunitWeekScheduleAgentschedulesQueryRequest();
		}
		...
		public Builder withBody(BuQueryAgentSchedulesRequest body) {
		...
		public Builder withRequiredParams(String businessUnitId, LocalDate weekId, String scheduleId, BuQueryAgentSchedulesRequest body) {
			request.setBusinessUnitId(businessUnitId);
						request.setWeekId(weekId);
						request.setScheduleId(scheduleId);
						request.setBody(body);
		...
		public PostWorkforcemanagementBusinessunitWeekScheduleAgentschedulesQueryRequest build() {
