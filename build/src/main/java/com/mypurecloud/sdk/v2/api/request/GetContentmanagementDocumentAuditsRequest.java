...
public class GetContentmanagementDocumentAuditsRequest {
    ...
    public GetContentmanagementDocumentAuditsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.documentId == null) {
            throw new IllegalStateException("Missing the required parameter 'documentId' when building request for GetContentmanagementDocumentAuditsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/contentmanagement/documents/{documentId}/audits")
                ...
                .withQueryParameters("transactionFilter", "", transactionFilter)
