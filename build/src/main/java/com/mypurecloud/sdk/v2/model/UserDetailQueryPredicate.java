...
public class UserDetailQueryPredicate  implements Serializable {
 ...
 @JsonDeserialize(using = OperatorEnumDeserializer.class)
  ...
  public UserDetailQueryPredicate() {
   ...
   * Optional type, can usually be inferred
   **/
  public UserDetailQueryPredicate type(TypeEnum type) {
    this.type = type;
    return this;
  }
   ...
   * Left hand side for dimension predicates
   **/
  public UserDetailQueryPredicate dimension(DimensionEnum dimension) {
   ...
   * Optional operator, default is matches
   **/
  public UserDetailQueryPredicate operator(OperatorEnum operator) {
   ...
   **/
  public UserDetailQueryPredicate value(String value) {
    this.value = value;
    return this;
  }
   ...
   * Right hand side for dimension predicates
   **/
  public UserDetailQueryPredicate range(NumericRange range) {
    this.range = range;
    return this;
  }
