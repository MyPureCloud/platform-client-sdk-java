...
public class PutTelephonyProvidersEdgeLogicalinterfaceRequest {
	...
	public PutTelephonyProvidersEdgeLogicalinterfaceRequest withEdgeId(String edgeId) {
	...
	public PutTelephonyProvidersEdgeLogicalinterfaceRequest withInterfaceId(String interfaceId) {
	...
	public void setBody(DomainLogicalInterface body) {
		this.body = body;
	}

	public PutTelephonyProvidersEdgeLogicalinterfaceRequest withBody(DomainLogicalInterface body) {
	    this.setBody(body);
	    return this;
	}
    ...
    public PutTelephonyProvidersEdgeLogicalinterfaceRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<DomainLogicalInterface> withHttpInfo() throws ApiException {
        
        // verify the required parameter 'edgeId' is set
        if (this.edgeId == null) {
            throw new ApiException(400, "Missing the required parameter 'edgeId' when building request for PutTelephonyProvidersEdgeLogicalinterfaceRequest.");
        }
        
        // verify the required parameter 'interfaceId' is set
        if (this.interfaceId == null) {
            throw new ApiException(400, "Missing the required parameter 'interfaceId' when building request for PutTelephonyProvidersEdgeLogicalinterfaceRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new ApiException(400, "Missing the required parameter 'body' when building request for PutTelephonyProvidersEdgeLogicalinterfaceRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/telephony/providers/edges/{edgeId}/logicalinterfaces/{interfaceId}")
