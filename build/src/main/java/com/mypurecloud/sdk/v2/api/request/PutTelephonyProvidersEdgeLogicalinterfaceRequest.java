...
public class PutTelephonyProvidersEdgeLogicalinterfaceRequest {
    ...
    public ApiRequest<DomainLogicalInterface> withHttpInfo() {
        ...
        if (this.edgeId == null) {
            throw new IllegalStateException("Missing the required parameter 'edgeId' when building request for PutTelephonyProvidersEdgeLogicalinterfaceRequest.");
        }
        
        // verify the required parameter 'interfaceId' is set
        if (this.interfaceId == null) {
            throw new IllegalStateException("Missing the required parameter 'interfaceId' when building request for PutTelephonyProvidersEdgeLogicalinterfaceRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutTelephonyProvidersEdgeLogicalinterfaceRequest.");
        }
