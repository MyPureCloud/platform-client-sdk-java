...
public class GetTelephonyProvidersEdgeTrunksRequest {
	...
	public GetTelephonyProvidersEdgeTrunksRequest withEdgeId(String edgeId) {
	...
	public GetTelephonyProvidersEdgeTrunksRequest withPageNumber(Integer pageNumber) {
	...
	public GetTelephonyProvidersEdgeTrunksRequest withPageSize(Integer pageSize) {
	...
	public GetTelephonyProvidersEdgeTrunksRequest withSortBy(String sortBy) {
	...
	public GetTelephonyProvidersEdgeTrunksRequest withSortOrder(String sortOrder) {
	...
	public GetTelephonyProvidersEdgeTrunksRequest withTrunkBaseId(String trunkBaseId) {
	...
	public GetTelephonyProvidersEdgeTrunksRequest withTrunkType(String trunkType) {
    ...
    public GetTelephonyProvidersEdgeTrunksRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.edgeId == null) {
            throw new IllegalStateException("Missing the required parameter 'edgeId' when building request for GetTelephonyProvidersEdgeTrunksRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/telephony/providers/edges/{edgeId}/trunks")
	...
	public static class Builder {
		private final GetTelephonyProvidersEdgeTrunksRequest request;

		private Builder() {
			request = new GetTelephonyProvidersEdgeTrunksRequest();
		}
		...
		public GetTelephonyProvidersEdgeTrunksRequest build() {
