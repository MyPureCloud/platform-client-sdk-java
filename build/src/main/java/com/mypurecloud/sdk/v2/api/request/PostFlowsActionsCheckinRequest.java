...
public class PostFlowsActionsCheckinRequest {
	...
	public PostFlowsActionsCheckinRequest withFlow(String flow) {
	    this.setFlow(flow);
	    return this;
	} 
    ...
    public PostFlowsActionsCheckinRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.flow == null) {
            throw new IllegalStateException("Missing the required parameter 'flow' when building request for PostFlowsActionsCheckinRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/flows/actions/checkin")
	...
	public static class Builder {
		private final PostFlowsActionsCheckinRequest request;

		private Builder() {
			request = new PostFlowsActionsCheckinRequest();
		}
		...
		public PostFlowsActionsCheckinRequest build() {
