...
public class GetWorkforcemanagementManagementunitWeekSchedulesRequest {
	...
	public GetWorkforcemanagementManagementunitWeekSchedulesRequest withManagementUnitId(String managementUnitId) {
	...
	public GetWorkforcemanagementManagementunitWeekSchedulesRequest withWeekId(String weekId) {
    ...
    public GetWorkforcemanagementManagementunitWeekSchedulesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.managementUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'managementUnitId' when building request for GetWorkforcemanagementManagementunitWeekSchedulesRequest.");
        }
        
        // verify the required parameter 'weekId' is set
        if (this.weekId == null) {
            throw new IllegalStateException("Missing the required parameter 'weekId' when building request for GetWorkforcemanagementManagementunitWeekSchedulesRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/managementunits/{managementUnitId}/weeks/{weekId}/schedules")
	...
	public static class Builder {
		private final GetWorkforcemanagementManagementunitWeekSchedulesRequest request;

		private Builder() {
			request = new GetWorkforcemanagementManagementunitWeekSchedulesRequest();
		}
		...
		public GetWorkforcemanagementManagementunitWeekSchedulesRequest build() {
