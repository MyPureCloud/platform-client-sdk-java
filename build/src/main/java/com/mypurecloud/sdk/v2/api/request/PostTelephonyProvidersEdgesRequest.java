...
public class PostTelephonyProvidersEdgesRequest {
	...
	public PostTelephonyProvidersEdgesRequest withBody(Edge body) {
	    this.setBody(body);
	    return this;
	}
    ...
    public PostTelephonyProvidersEdgesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Edge> withHttpInfo() throws ApiException {
        ...
        if (this.body == null) {
            throw new ApiException(400, "Missing the required parameter 'body' when building request for PostTelephonyProvidersEdgesRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/telephony/providers/edges")
                .withBody(body)
	...
	public static Builder builder(Edge body) {
	    return new Builder()
	            .withRequiredParams(body);
	}

	public static class Builder {
		private final PostTelephonyProvidersEdgesRequest request;

		private Builder() {
			request = new PostTelephonyProvidersEdgesRequest();
		}
		...
		public Builder withRequiredParams(Edge body) {
			request.setBody(body);
			return this;
		}
