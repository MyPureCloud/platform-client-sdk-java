...
public class GetJourneyOutcomeRequest {
	...
	public GetJourneyOutcomeRequest withOutcomeId(String outcomeId) {
    ...
    public GetJourneyOutcomeRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.outcomeId == null) {
            throw new IllegalStateException("Missing the required parameter 'outcomeId' when building request for GetJourneyOutcomeRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/journey/outcomes/{outcomeId}")
	...
	public static class Builder {
		private final GetJourneyOutcomeRequest request;

		private Builder() {
			request = new GetJourneyOutcomeRequest();
		}
		...
		public GetJourneyOutcomeRequest build() {
