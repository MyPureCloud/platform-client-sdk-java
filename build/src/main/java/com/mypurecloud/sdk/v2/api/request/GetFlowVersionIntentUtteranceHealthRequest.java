...
public class GetFlowVersionIntentUtteranceHealthRequest {
	...
	public GetFlowVersionIntentUtteranceHealthRequest withFlowId(String flowId) {
	...
	public GetFlowVersionIntentUtteranceHealthRequest withVersionId(String versionId) {
	...
	public GetFlowVersionIntentUtteranceHealthRequest withIntentId(String intentId) {
	...
	public GetFlowVersionIntentUtteranceHealthRequest withUtteranceId(String utteranceId) {
	    this.setUtteranceId(utteranceId);
	    return this;
	} 
	...
	public GetFlowVersionIntentUtteranceHealthRequest withLanguage(String language) {
    ...
    public GetFlowVersionIntentUtteranceHealthRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.flowId == null) {
            throw new IllegalStateException("Missing the required parameter 'flowId' when building request for GetFlowVersionIntentUtteranceHealthRequest.");
        }
        
        // verify the required parameter 'versionId' is set
        if (this.versionId == null) {
            throw new IllegalStateException("Missing the required parameter 'versionId' when building request for GetFlowVersionIntentUtteranceHealthRequest.");
        }
        
        // verify the required parameter 'intentId' is set
        if (this.intentId == null) {
            throw new IllegalStateException("Missing the required parameter 'intentId' when building request for GetFlowVersionIntentUtteranceHealthRequest.");
        }
        
        // verify the required parameter 'utteranceId' is set
        if (this.utteranceId == null) {
            throw new IllegalStateException("Missing the required parameter 'utteranceId' when building request for GetFlowVersionIntentUtteranceHealthRequest.");
        }
        
        // verify the required parameter 'language' is set
        if (this.language == null) {
            throw new IllegalStateException("Missing the required parameter 'language' when building request for GetFlowVersionIntentUtteranceHealthRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/flows/{flowId}/versions/{versionId}/intents/{intentId}/utterances/{utteranceId}/health")
                ...
                .withPathParameter("utteranceId", utteranceId)
	...
	public static Builder builder(String flowId, String versionId, String intentId, String utteranceId, String language) {
	    return new Builder()
	            .withRequiredParams(flowId, versionId, intentId, utteranceId, language);
	}


	public static class Builder {
		private final GetFlowVersionIntentUtteranceHealthRequest request;

		private Builder() {
			request = new GetFlowVersionIntentUtteranceHealthRequest();
		}
		...
		public Builder withUtteranceId(String utteranceId) {
		...
		public Builder withRequiredParams(String flowId, String versionId, String intentId, String utteranceId, String language) {
			request.setFlowId(flowId);
			request.setVersionId(versionId);
			request.setIntentId(intentId);
			request.setUtteranceId(utteranceId);
		...
		public GetFlowVersionIntentUtteranceHealthRequest build() {
