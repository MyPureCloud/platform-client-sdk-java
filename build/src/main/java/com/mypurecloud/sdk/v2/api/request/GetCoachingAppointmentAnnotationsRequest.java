...
public class GetCoachingAppointmentAnnotationsRequest {
	...
	public GetCoachingAppointmentAnnotationsRequest withAppointmentId(String appointmentId) {
	...
	public GetCoachingAppointmentAnnotationsRequest withPageNumber(Integer pageNumber) {
	...
	public GetCoachingAppointmentAnnotationsRequest withPageSize(Integer pageSize) {
    ...
    public GetCoachingAppointmentAnnotationsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.appointmentId == null) {
            throw new IllegalStateException("Missing the required parameter 'appointmentId' when building request for GetCoachingAppointmentAnnotationsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/coaching/appointments/{appointmentId}/annotations")
	...
	public static class Builder {
		private final GetCoachingAppointmentAnnotationsRequest request;

		private Builder() {
			request = new GetCoachingAppointmentAnnotationsRequest();
		}
		...
		public GetCoachingAppointmentAnnotationsRequest build() {
