...
public class DeleteJourneyOutcomesPredictorRequest {
	...
	public DeleteJourneyOutcomesPredictorRequest withPredictorId(String predictorId) {
    ...
    public DeleteJourneyOutcomesPredictorRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.predictorId == null) {
            throw new IllegalStateException("Missing the required parameter 'predictorId' when building request for DeleteJourneyOutcomesPredictorRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/journey/outcomes/predictors/{predictorId}")
                .withPathParameter("predictorId", predictorId)
	...
	public static Builder builder(String predictorId) {
	    return new Builder()
	            .withRequiredParams(predictorId);
	}


	public static class Builder {
		private final DeleteJourneyOutcomesPredictorRequest request;

		private Builder() {
			request = new DeleteJourneyOutcomesPredictorRequest();
		}


		public Builder withPredictorId(String predictorId) {
			request.setPredictorId(predictorId);
			return this;
		}
		...
		public DeleteJourneyOutcomesPredictorRequest build() {
            
            // verify the required parameter 'predictorId' is set
            if (request.predictorId == null) {
                throw new IllegalStateException("Missing the required parameter 'predictorId' when building request for DeleteJourneyOutcomesPredictorRequest.");
            }
