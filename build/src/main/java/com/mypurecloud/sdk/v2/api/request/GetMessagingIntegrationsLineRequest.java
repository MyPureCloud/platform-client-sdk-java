...
public class GetMessagingIntegrationsLineRequest {
	...
	public GetMessagingIntegrationsLineRequest withPageSize(Integer pageSize) {
	...
	public GetMessagingIntegrationsLineRequest withPageNumber(Integer pageNumber) {
    ...
    public GetMessagingIntegrationsLineRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/messaging/integrations/line")
	...
	public static class Builder {
		private final GetMessagingIntegrationsLineRequest request;

		private Builder() {
			request = new GetMessagingIntegrationsLineRequest();
		}
		...
		public GetMessagingIntegrationsLineRequest build() {
