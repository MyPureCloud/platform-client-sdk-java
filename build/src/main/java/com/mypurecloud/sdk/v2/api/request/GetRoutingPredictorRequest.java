...
public class GetRoutingPredictorRequest {
	...
	public GetRoutingPredictorRequest withPredictorId(String predictorId) {
    ...
    public GetRoutingPredictorRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.predictorId == null) {
            throw new IllegalStateException("Missing the required parameter 'predictorId' when building request for GetRoutingPredictorRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/routing/predictors/{predictorId}")
	...
	public static class Builder {
		private final GetRoutingPredictorRequest request;

		private Builder() {
			request = new GetRoutingPredictorRequest();
		}
		...
		public GetRoutingPredictorRequest build() {
