...
public class GetFlowLatestconfigurationRequest {
	...
	public GetFlowLatestconfigurationRequest withFlowId(String flowId) {
	...
	public GetFlowLatestconfigurationRequest withDeleted(Boolean deleted) {
    ...
    public GetFlowLatestconfigurationRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.flowId == null) {
            throw new IllegalStateException("Missing the required parameter 'flowId' when building request for GetFlowLatestconfigurationRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/flows/{flowId}/latestconfiguration")
