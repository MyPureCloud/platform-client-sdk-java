...
public class PostWorkforcemanagementBusinessunitShifttradingWeeksSummaryJobsRequest {
	...
	public PostWorkforcemanagementBusinessunitShifttradingWeeksSummaryJobsRequest withBusinessUnitId(String businessUnitId) {
	    this.setBusinessUnitId(businessUnitId);
	    return this;
	} 

	private QueryWeekSummaryListJobRequest body;
	public QueryWeekSummaryListJobRequest getBody() {
		return this.body;
	}

	public void setBody(QueryWeekSummaryListJobRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementBusinessunitShifttradingWeeksSummaryJobsRequest withBody(QueryWeekSummaryListJobRequest body) {
	    this.setBody(body);
	    return this;
	} 
	...
	public PostWorkforcemanagementBusinessunitShifttradingWeeksSummaryJobsRequest withForceAsync(Boolean forceAsync) {
    ...
    public PostWorkforcemanagementBusinessunitShifttradingWeeksSummaryJobsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<QueryWeekSummaryListJobRequest> withHttpInfo() {
        
        // verify the required parameter 'businessUnitId' is set
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PostWorkforcemanagementBusinessunitShifttradingWeeksSummaryJobsRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementBusinessunitShifttradingWeeksSummaryJobsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/shifttrading/weeks/summary/jobs")
	...
	public static Builder builder(String businessUnitId, QueryWeekSummaryListJobRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementBusinessunitShifttradingWeeksSummaryJobsRequest request;

		private Builder() {
			request = new PostWorkforcemanagementBusinessunitShifttradingWeeksSummaryJobsRequest();
		}
		...
		public Builder withBody(QueryWeekSummaryListJobRequest body) {
		...
		public Builder withRequiredParams(String businessUnitId, QueryWeekSummaryListJobRequest body) {
			request.setBusinessUnitId(businessUnitId);
			request.setBody(body);
		...
		public PostWorkforcemanagementBusinessunitShifttradingWeeksSummaryJobsRequest build() {
