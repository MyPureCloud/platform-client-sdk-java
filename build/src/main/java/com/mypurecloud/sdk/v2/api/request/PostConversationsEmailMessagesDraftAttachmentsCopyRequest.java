...
public class PostConversationsEmailMessagesDraftAttachmentsCopyRequest {
	...
	public void setBody(CopyAttachmentsRequest body) {
		this.body = body;
	}
    ...
    public ApiRequest<CopyAttachmentsRequest> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("POST", "/api/v2/conversations/emails/{conversationId}/messages/draft/attachments/copy")
	...
	public static Builder builder(String conversationId, CopyAttachmentsRequest body) {
	    return new Builder()
	...
	public static class Builder {
		...
		private Builder() {
			request = new PostConversationsEmailMessagesDraftAttachmentsCopyRequest();
		}
		...
		public Builder withBody(CopyAttachmentsRequest body) {
		...
		public Builder withRequiredParams(String conversationId, CopyAttachmentsRequest body) {
			request.setConversationId(conversationId);
						request.setBody(body);
