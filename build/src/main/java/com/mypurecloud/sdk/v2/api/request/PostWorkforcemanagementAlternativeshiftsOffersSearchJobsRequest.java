...
public class PostWorkforcemanagementAlternativeshiftsOffersSearchJobsRequest {

	private AlternativeShiftSearchOffersRequest body;
	public AlternativeShiftSearchOffersRequest getBody() {
		return this.body;
	}

	public void setBody(AlternativeShiftSearchOffersRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementAlternativeshiftsOffersSearchJobsRequest withBody(AlternativeShiftSearchOffersRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementAlternativeshiftsOffersSearchJobsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<AlternativeShiftSearchOffersRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementAlternativeshiftsOffersSearchJobsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/alternativeshifts/offers/search/jobs")
                .withBody(body)
	...
	public static Builder builder(AlternativeShiftSearchOffersRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementAlternativeshiftsOffersSearchJobsRequest request;

		private Builder() {
			request = new PostWorkforcemanagementAlternativeshiftsOffersSearchJobsRequest();
		}


		public Builder withBody(AlternativeShiftSearchOffersRequest body) {
		...
		public Builder withRequiredParams(AlternativeShiftSearchOffersRequest body) {
			request.setBody(body);
		...
		public PostWorkforcemanagementAlternativeshiftsOffersSearchJobsRequest build() {
