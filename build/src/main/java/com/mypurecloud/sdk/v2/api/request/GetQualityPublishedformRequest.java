...
public class GetQualityPublishedformRequest {
	...
	public GetQualityPublishedformRequest withFormId(String formId) {
    ...
    public GetQualityPublishedformRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.formId == null) {
            throw new IllegalStateException("Missing the required parameter 'formId' when building request for GetQualityPublishedformRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/quality/publishedforms/{formId}")
	...
	public static class Builder {
		private final GetQualityPublishedformRequest request;

		private Builder() {
			request = new GetQualityPublishedformRequest();
		}
		...
		public GetQualityPublishedformRequest build() {
