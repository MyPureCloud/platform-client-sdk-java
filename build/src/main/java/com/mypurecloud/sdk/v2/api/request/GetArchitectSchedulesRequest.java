...
public class GetArchitectSchedulesRequest {
	...
	public GetArchitectSchedulesRequest withPageNumber(Integer pageNumber) {
	...
	public GetArchitectSchedulesRequest withPageSize(Integer pageSize) {
	...
	public GetArchitectSchedulesRequest withSortBy(String sortBy) {
	...
	public GetArchitectSchedulesRequest withSortOrder(String sortOrder) {
	...
	public GetArchitectSchedulesRequest withName(String name) {
	    this.setName(name);
	    return this;
	} 
    ...
    public GetArchitectSchedulesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/architect/schedules")
	...
	public static class Builder {
		...
		private Builder() {
			request = new GetArchitectSchedulesRequest();
		}
