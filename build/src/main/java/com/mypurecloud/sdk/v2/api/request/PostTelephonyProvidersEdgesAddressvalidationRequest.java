...
public class PostTelephonyProvidersEdgesAddressvalidationRequest {
	...
	public void setBody(ValidateAddressRequest body) {
		this.body = body;
	}

	public PostTelephonyProvidersEdgesAddressvalidationRequest withBody(ValidateAddressRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostTelephonyProvidersEdgesAddressvalidationRequest withCustomHeader(String name, String value) {
