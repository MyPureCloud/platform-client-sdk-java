...
public class GetIntegrationsSpeechDialogflowcxAgentsRequest {
	...
	public GetIntegrationsSpeechDialogflowcxAgentsRequest withPageNumber(Integer pageNumber) {
	...
	public GetIntegrationsSpeechDialogflowcxAgentsRequest withPageSize(Integer pageSize) {
	...
	public GetIntegrationsSpeechDialogflowcxAgentsRequest withName(String name) {
	    this.setName(name);
	    return this;
	} 
    ...
    public GetIntegrationsSpeechDialogflowcxAgentsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/integrations/speech/dialogflowcx/agents")
	...
	public static class Builder {
		private final GetIntegrationsSpeechDialogflowcxAgentsRequest request;

		private Builder() {
			request = new GetIntegrationsSpeechDialogflowcxAgentsRequest();
		}
		...
		public GetIntegrationsSpeechDialogflowcxAgentsRequest build() {
