...
public class PutAlertingAlertRequest {
	...
	public PutAlertingAlertRequest withAlertId(String alertId) {
	    this.setAlertId(alertId);
	    return this;
	} 

	private AlertingUnreadStatus body;
	public AlertingUnreadStatus getBody() {
		return this.body;
	}

	public void setBody(AlertingUnreadStatus body) {
		this.body = body;
	}

	public PutAlertingAlertRequest withBody(AlertingUnreadStatus body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutAlertingAlertRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<AlertingUnreadStatus> withHttpInfo() {
        
        // verify the required parameter 'alertId' is set
        if (this.alertId == null) {
            throw new IllegalStateException("Missing the required parameter 'alertId' when building request for PutAlertingAlertRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/alerting/alerts/{alertId}")
	...
	public static class Builder {
		private final PutAlertingAlertRequest request;

		private Builder() {
			request = new PutAlertingAlertRequest();
		}
		...
		public Builder withBody(AlertingUnreadStatus body) {
		...
		public PutAlertingAlertRequest build() {
