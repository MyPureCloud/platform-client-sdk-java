...
public class PostKnowledgeKnowledgebaseDocumentsSearchSuggestionsRequest {
	...
	public PostKnowledgeKnowledgebaseDocumentsSearchSuggestionsRequest withKnowledgeBaseId(String knowledgeBaseId) {
	...
	public PostKnowledgeKnowledgebaseDocumentsSearchSuggestionsRequest withBody(KnowledgeDocumentSuggestionRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostKnowledgeKnowledgebaseDocumentsSearchSuggestionsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<KnowledgeDocumentSuggestionRequest> withHttpInfo() {
        ...
        if (this.knowledgeBaseId == null) {
            throw new IllegalStateException("Missing the required parameter 'knowledgeBaseId' when building request for PostKnowledgeKnowledgebaseDocumentsSearchSuggestionsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/documents/search/suggestions")
	...
	public static class Builder {
		private final PostKnowledgeKnowledgebaseDocumentsSearchSuggestionsRequest request;

		private Builder() {
			request = new PostKnowledgeKnowledgebaseDocumentsSearchSuggestionsRequest();
		}
		...
		public PostKnowledgeKnowledgebaseDocumentsSearchSuggestionsRequest build() {
