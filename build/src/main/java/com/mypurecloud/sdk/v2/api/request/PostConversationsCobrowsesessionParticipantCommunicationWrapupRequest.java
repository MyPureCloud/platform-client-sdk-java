...
public class PostConversationsCobrowsesessionParticipantCommunicationWrapupRequest {
	...
	public PostConversationsCobrowsesessionParticipantCommunicationWrapupRequest withConversationId(String conversationId) {
	...
	public PostConversationsCobrowsesessionParticipantCommunicationWrapupRequest withParticipantId(String participantId) {
	...
	public PostConversationsCobrowsesessionParticipantCommunicationWrapupRequest withCommunicationId(String communicationId) {
	...
	public PostConversationsCobrowsesessionParticipantCommunicationWrapupRequest withBody(ExtendedWrapup body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostConversationsCobrowsesessionParticipantCommunicationWrapupRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<ExtendedWrapup> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PostConversationsCobrowsesessionParticipantCommunicationWrapupRequest.");
        }
        
        // verify the required parameter 'participantId' is set
        if (this.participantId == null) {
            throw new IllegalStateException("Missing the required parameter 'participantId' when building request for PostConversationsCobrowsesessionParticipantCommunicationWrapupRequest.");
        }
        
        // verify the required parameter 'communicationId' is set
        if (this.communicationId == null) {
            throw new IllegalStateException("Missing the required parameter 'communicationId' when building request for PostConversationsCobrowsesessionParticipantCommunicationWrapupRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/conversations/cobrowsesessions/{conversationId}/participants/{participantId}/communications/{communicationId}/wrapup")
	...
	public static class Builder {
		private final PostConversationsCobrowsesessionParticipantCommunicationWrapupRequest request;

		private Builder() {
			request = new PostConversationsCobrowsesessionParticipantCommunicationWrapupRequest();
		}
		...
		public PostConversationsCobrowsesessionParticipantCommunicationWrapupRequest build() {
