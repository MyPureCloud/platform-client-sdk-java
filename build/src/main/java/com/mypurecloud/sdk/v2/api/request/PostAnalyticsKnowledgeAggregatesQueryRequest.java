...
public class PostAnalyticsKnowledgeAggregatesQueryRequest {

	private KnowledgeAggregationQuery body;
	public KnowledgeAggregationQuery getBody() {
		return this.body;
	}

	public void setBody(KnowledgeAggregationQuery body) {
		this.body = body;
	}

	public PostAnalyticsKnowledgeAggregatesQueryRequest withBody(KnowledgeAggregationQuery body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostAnalyticsKnowledgeAggregatesQueryRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<KnowledgeAggregationQuery> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostAnalyticsKnowledgeAggregatesQueryRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/analytics/knowledge/aggregates/query")
                .withBody(body)
	...
	public static Builder builder(KnowledgeAggregationQuery body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostAnalyticsKnowledgeAggregatesQueryRequest request;

		private Builder() {
			request = new PostAnalyticsKnowledgeAggregatesQueryRequest();
		}


		public Builder withBody(KnowledgeAggregationQuery body) {
		...
		public Builder withRequiredParams(KnowledgeAggregationQuery body) {
			request.setBody(body);
		...
		public PostAnalyticsKnowledgeAggregatesQueryRequest build() {
