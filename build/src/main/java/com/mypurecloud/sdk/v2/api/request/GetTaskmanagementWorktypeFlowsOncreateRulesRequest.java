...
public class GetTaskmanagementWorktypeFlowsOncreateRulesRequest {
	...
	public GetTaskmanagementWorktypeFlowsOncreateRulesRequest withWorktypeId(String worktypeId) {
	...
	public GetTaskmanagementWorktypeFlowsOncreateRulesRequest withAfter(String after) {
	    this.setAfter(after);
	    return this;
	} 
	...
	public GetTaskmanagementWorktypeFlowsOncreateRulesRequest withPageSize(Integer pageSize) {
    ...
    public GetTaskmanagementWorktypeFlowsOncreateRulesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.worktypeId == null) {
            throw new IllegalStateException("Missing the required parameter 'worktypeId' when building request for GetTaskmanagementWorktypeFlowsOncreateRulesRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/taskmanagement/worktypes/{worktypeId}/flows/oncreate/rules")
	...
	public static class Builder {
		private final GetTaskmanagementWorktypeFlowsOncreateRulesRequest request;

		private Builder() {
			request = new GetTaskmanagementWorktypeFlowsOncreateRulesRequest();
		}
		...
		public GetTaskmanagementWorktypeFlowsOncreateRulesRequest build() {
