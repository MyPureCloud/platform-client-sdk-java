...
public class PostPresenceDefinitions0Request {
	...
	public PostPresenceDefinitions0Request withBody(OrganizationPresenceDefinition body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostPresenceDefinitions0Request withCustomHeader(String name, String value) {
    ...
    public ApiRequest<OrganizationPresenceDefinition> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostPresenceDefinitions0Request.");
        }
	...
	public static class Builder {
		private final PostPresenceDefinitions0Request request;

		private Builder() {
			request = new PostPresenceDefinitions0Request();
		}
		...
		public PostPresenceDefinitions0Request build() {
