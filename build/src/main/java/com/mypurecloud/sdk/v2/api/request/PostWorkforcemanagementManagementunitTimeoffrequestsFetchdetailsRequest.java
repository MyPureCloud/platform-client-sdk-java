...
public class PostWorkforcemanagementManagementunitTimeoffrequestsFetchdetailsRequest {
	...
	private TimeOffRequestListing body;
	public TimeOffRequestListing getBody() {
		return this.body;
	}

	public void setBody(TimeOffRequestListing body) {
		this.body = body;
	}

	public PostWorkforcemanagementManagementunitTimeoffrequestsFetchdetailsRequest withBody(TimeOffRequestListing body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public ApiRequest<TimeOffRequestListing> withHttpInfo() {
	...
	public static class Builder {
		...
		public Builder withBody(TimeOffRequestListing body) {
