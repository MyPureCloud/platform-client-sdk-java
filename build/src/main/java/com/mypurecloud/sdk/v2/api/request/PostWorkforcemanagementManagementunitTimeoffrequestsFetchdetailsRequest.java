...
public class PostWorkforcemanagementManagementunitTimeoffrequestsFetchdetailsRequest {
	...
	public PostWorkforcemanagementManagementunitTimeoffrequestsFetchdetailsRequest withMuId(String muId) {
	    this.setMuId(muId);
	    return this;
	} 
	
	private TimeOffRequestLookupList body;
	public TimeOffRequestLookupList getBody() {
		return this.body;
	}

	public void setBody(TimeOffRequestLookupList body) {
		this.body = body;
	}

	public PostWorkforcemanagementManagementunitTimeoffrequestsFetchdetailsRequest withBody(TimeOffRequestLookupList body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementManagementunitTimeoffrequestsFetchdetailsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<TimeOffRequestLookupList> withHttpInfo() {
        
        // verify the required parameter 'muId' is set
        if (this.muId == null) {
            throw new IllegalStateException("Missing the required parameter 'muId' when building request for PostWorkforcemanagementManagementunitTimeoffrequestsFetchdetailsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/managementunits/{muId}/timeoffrequests/fetchdetails")
	...
	public static class Builder {
		private final PostWorkforcemanagementManagementunitTimeoffrequestsFetchdetailsRequest request;

		private Builder() {
			request = new PostWorkforcemanagementManagementunitTimeoffrequestsFetchdetailsRequest();
		}
		...
		public Builder withBody(TimeOffRequestLookupList body) {
		...
		public PostWorkforcemanagementManagementunitTimeoffrequestsFetchdetailsRequest build() {
