...
public class PutSpeechandtextanalyticsProgramRequest {
	...
	public PutSpeechandtextanalyticsProgramRequest withProgramId(String programId) {
	    this.setProgramId(programId);
	    return this;
	} 
	
	private ProgramRequest body;
	public ProgramRequest getBody() {
		return this.body;
	}

	public void setBody(ProgramRequest body) {
		this.body = body;
	}

	public PutSpeechandtextanalyticsProgramRequest withBody(ProgramRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutSpeechandtextanalyticsProgramRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<ProgramRequest> withHttpInfo() {
        
        // verify the required parameter 'programId' is set
        if (this.programId == null) {
            throw new IllegalStateException("Missing the required parameter 'programId' when building request for PutSpeechandtextanalyticsProgramRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutSpeechandtextanalyticsProgramRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/speechandtextanalytics/programs/{programId}")
	...
	public static Builder builder(String programId, ProgramRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PutSpeechandtextanalyticsProgramRequest request;

		private Builder() {
			request = new PutSpeechandtextanalyticsProgramRequest();
		}
		...
		public Builder withBody(ProgramRequest body) {
		...
		public Builder withRequiredParams(String programId, ProgramRequest body) {
			request.setProgramId(programId);
						request.setBody(body);
		...
		public PutSpeechandtextanalyticsProgramRequest build() {
