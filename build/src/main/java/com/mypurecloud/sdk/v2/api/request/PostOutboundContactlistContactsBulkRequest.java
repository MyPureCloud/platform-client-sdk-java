...
public class PostOutboundContactlistContactsBulkRequest {
	...
	public PostOutboundContactlistContactsBulkRequest withContactListId(String contactListId) {
	...
	public PostOutboundContactlistContactsBulkRequest withBody(List<String> body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostOutboundContactlistContactsBulkRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<List<String>> withHttpInfo() {
        ...
        if (this.contactListId == null) {
            throw new IllegalStateException("Missing the required parameter 'contactListId' when building request for PostOutboundContactlistContactsBulkRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostOutboundContactlistContactsBulkRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/outbound/contactlists/{contactListId}/contacts/bulk")
	...
	public static Builder builder(String contactListId, List<String> body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostOutboundContactlistContactsBulkRequest request;

		private Builder() {
			request = new PostOutboundContactlistContactsBulkRequest();
		}
		...
		public Builder withRequiredParams(String contactListId, List<String> body) {
			request.setContactListId(contactListId);
						request.setBody(body);
		...
		public PostOutboundContactlistContactsBulkRequest build() {
