...
public class GetSocialmediaTopicDataingestionrulesOpenOpenIdRequest {
	...
	public GetSocialmediaTopicDataingestionrulesOpenOpenIdRequest withTopicId(String topicId) {
	...
	public GetSocialmediaTopicDataingestionrulesOpenOpenIdRequest withOpenId(String openId) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.topicId == null) {
            throw new IllegalStateException("Missing the required parameter 'topicId' when building request for GetSocialmediaTopicDataingestionrulesOpenOpenIdRequest.");
        }
        
        // verify the required parameter 'openId' is set
        if (this.openId == null) {
            throw new IllegalStateException("Missing the required parameter 'openId' when building request for GetSocialmediaTopicDataingestionrulesOpenOpenIdRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/socialmedia/topics/{topicId}/dataingestionrules/open/{openId}")
	...
	public static class Builder {
		private final GetSocialmediaTopicDataingestionrulesOpenOpenIdRequest request;

		private Builder() {
			request = new GetSocialmediaTopicDataingestionrulesOpenOpenIdRequest();
		}
		...
		public GetSocialmediaTopicDataingestionrulesOpenOpenIdRequest build() {
