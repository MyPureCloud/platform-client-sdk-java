...
public class DeleteRoutingPredictorRequest {
	...
	public DeleteRoutingPredictorRequest withPredictorId(String predictorId) {
    ...
    public DeleteRoutingPredictorRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.predictorId == null) {
            throw new IllegalStateException("Missing the required parameter 'predictorId' when building request for DeleteRoutingPredictorRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/routing/predictors/{predictorId}")
	...
	public static class Builder {
		private final DeleteRoutingPredictorRequest request;

		private Builder() {
			request = new DeleteRoutingPredictorRequest();
		}
		...
		public DeleteRoutingPredictorRequest build() {
