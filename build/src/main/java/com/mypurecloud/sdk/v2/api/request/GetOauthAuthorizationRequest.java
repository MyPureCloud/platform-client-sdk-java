...
public class GetOauthAuthorizationRequest {
	...
	public GetOauthAuthorizationRequest withClientId(String clientId) {
    ...
    public GetOauthAuthorizationRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.clientId == null) {
            throw new IllegalStateException("Missing the required parameter 'clientId' when building request for GetOauthAuthorizationRequest.");
        }
	...
	public static class Builder {
		private final GetOauthAuthorizationRequest request;

		private Builder() {
			request = new GetOauthAuthorizationRequest();
		}
		...
		public GetOauthAuthorizationRequest build() {
