...
public class GetBusinessrulesDecisiontableExportRequest {
	...
	public GetBusinessrulesDecisiontableExportRequest withTableId(String tableId) {
	...
	public GetBusinessrulesDecisiontableExportRequest withExportJobId(String exportJobId) {
    ...
    public GetBusinessrulesDecisiontableExportRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.tableId == null) {
            throw new IllegalStateException("Missing the required parameter 'tableId' when building request for GetBusinessrulesDecisiontableExportRequest.");
        }
        
        // verify the required parameter 'exportJobId' is set
        if (this.exportJobId == null) {
            throw new IllegalStateException("Missing the required parameter 'exportJobId' when building request for GetBusinessrulesDecisiontableExportRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/businessrules/decisiontables/{tableId}/exports/{exportJobId}")
	...
	public static class Builder {
		private final GetBusinessrulesDecisiontableExportRequest request;

		private Builder() {
			request = new GetBusinessrulesDecisiontableExportRequest();
		}
		...
		public GetBusinessrulesDecisiontableExportRequest build() {
