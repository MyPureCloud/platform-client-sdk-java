...
public class PostUsersDevelopmentActivitiesAggregatesQueryRequest {
	...
	public void setBody(DevelopmentActivityAggregateParam body) {
		this.body = body;
	}

	public PostUsersDevelopmentActivitiesAggregatesQueryRequest withBody(DevelopmentActivityAggregateParam body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostUsersDevelopmentActivitiesAggregatesQueryRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<DevelopmentActivityAggregateParam> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostUsersDevelopmentActivitiesAggregatesQueryRequest.");
        }
