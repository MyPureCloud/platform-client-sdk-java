...
public class PostSocialmediaTopicDataingestionrulesTwitterRequest {
	...
	public PostSocialmediaTopicDataingestionrulesTwitterRequest withTopicId(String topicId) {
	...
	public PostSocialmediaTopicDataingestionrulesTwitterRequest withBody(TwitterDataIngestionRuleRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostSocialmediaTopicDataingestionrulesTwitterRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<TwitterDataIngestionRuleRequest> withHttpInfo() {
        ...
        if (this.topicId == null) {
            throw new IllegalStateException("Missing the required parameter 'topicId' when building request for PostSocialmediaTopicDataingestionrulesTwitterRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/socialmedia/topics/{topicId}/dataingestionrules/twitter")
	...
	public static class Builder {
		private final PostSocialmediaTopicDataingestionrulesTwitterRequest request;

		private Builder() {
			request = new PostSocialmediaTopicDataingestionrulesTwitterRequest();
		}
		...
		public PostSocialmediaTopicDataingestionrulesTwitterRequest build() {
