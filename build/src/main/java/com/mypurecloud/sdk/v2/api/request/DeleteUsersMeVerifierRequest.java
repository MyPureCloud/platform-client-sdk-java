...
public class DeleteUsersMeVerifierRequest {
	...
	public DeleteUsersMeVerifierRequest withVerifierId(String verifierId) {
    ...
    public DeleteUsersMeVerifierRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.verifierId == null) {
            throw new IllegalStateException("Missing the required parameter 'verifierId' when building request for DeleteUsersMeVerifierRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/users/me/verifiers/{verifierId}")
	...
	public static Builder builder(String verifierId) {
	    return new Builder()
	            .withRequiredParams(verifierId);
	}


	public static class Builder {
		private final DeleteUsersMeVerifierRequest request;

		private Builder() {
			request = new DeleteUsersMeVerifierRequest();
		}
		...
		public Builder withRequiredParams(String verifierId) {
			request.setVerifierId(verifierId);
		...
		public DeleteUsersMeVerifierRequest build() {
