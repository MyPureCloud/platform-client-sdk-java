...
public class GetGamificationMetricdefinitionsRequest {
    ...
    public GetGamificationMetricdefinitionsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/gamification/metricdefinitions")
	...
	public static class Builder {
		private final GetGamificationMetricdefinitionsRequest request;

		private Builder() {
			request = new GetGamificationMetricdefinitionsRequest();
		}
		...
		public GetGamificationMetricdefinitionsRequest build() {
