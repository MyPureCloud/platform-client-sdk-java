...
public class GetDivisionBasedPresenceDefinitionsRequest {
	...
	public GetDivisionBasedPresenceDefinitionsRequest withDeactivated(String deactivated) {
	...
	public GetDivisionBasedPresenceDefinitionsRequest withDivisionId(List<String> divisionId) {
	...
	public GetDivisionBasedPresenceDefinitionsRequest withLocaleCode(String localeCode) {
    ...
    public GetDivisionBasedPresenceDefinitionsRequest withCustomHeader(String name, String value) {
	...
	public static class Builder {
		private final GetDivisionBasedPresenceDefinitionsRequest request;

		private Builder() {
			request = new GetDivisionBasedPresenceDefinitionsRequest();
		}
		...
		public GetDivisionBasedPresenceDefinitionsRequest build() {
