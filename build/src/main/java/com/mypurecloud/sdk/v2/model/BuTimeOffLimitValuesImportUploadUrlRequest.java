...
public class BuTimeOffLimitValuesImportUploadUrlRequest  implements Serializable {
  
  private Long contentLengthBytes = null;

  public BuTimeOffLimitValuesImportUploadUrlRequest() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
    }
  }

  public BuTimeOffLimitValuesImportUploadUrlRequest(Boolean initWithEmptyList) {
   ...
   **/
  public BuTimeOffLimitValuesImportUploadUrlRequest contentLengthBytes(Long contentLengthBytes) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    BuTimeOffLimitValuesImportUploadUrlRequest buTimeOffLimitValuesImportUploadUrlRequest = (BuTimeOffLimitValuesImportUploadUrlRequest) o;

    return Objects.equals(this.contentLengthBytes, buTimeOffLimitValuesImportUploadUrlRequest.contentLengthBytes);
  }
