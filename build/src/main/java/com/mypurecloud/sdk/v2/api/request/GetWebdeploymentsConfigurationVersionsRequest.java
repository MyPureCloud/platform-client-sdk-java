...
public class GetWebdeploymentsConfigurationVersionsRequest {
	...
	public GetWebdeploymentsConfigurationVersionsRequest withConfigurationId(String configurationId) {
    ...
    public GetWebdeploymentsConfigurationVersionsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.configurationId == null) {
            throw new IllegalStateException("Missing the required parameter 'configurationId' when building request for GetWebdeploymentsConfigurationVersionsRequest.");
        }
	...
	public static class Builder {
		private final GetWebdeploymentsConfigurationVersionsRequest request;

		private Builder() {
			request = new GetWebdeploymentsConfigurationVersionsRequest();
		}
		...
		public GetWebdeploymentsConfigurationVersionsRequest build() {
