...
public class PostWorkforcemanagementAgentSchedulingpreferencesQueryRequest {
	...
	public PostWorkforcemanagementAgentSchedulingpreferencesQueryRequest withAgentId(String agentId) {
	    this.setAgentId(agentId);
	    return this;
	} 

	private QueryAgentSchedulingPreferencesRequest body;
	public QueryAgentSchedulingPreferencesRequest getBody() {
		return this.body;
	}

	public void setBody(QueryAgentSchedulingPreferencesRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementAgentSchedulingpreferencesQueryRequest withBody(QueryAgentSchedulingPreferencesRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementAgentSchedulingpreferencesQueryRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<QueryAgentSchedulingPreferencesRequest> withHttpInfo() {
        
        // verify the required parameter 'agentId' is set
        if (this.agentId == null) {
            throw new IllegalStateException("Missing the required parameter 'agentId' when building request for PostWorkforcemanagementAgentSchedulingpreferencesQueryRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementAgentSchedulingpreferencesQueryRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/agents/{agentId}/schedulingpreferences/query")
	...
	public static Builder builder(String agentId, QueryAgentSchedulingPreferencesRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementAgentSchedulingpreferencesQueryRequest request;

		private Builder() {
			request = new PostWorkforcemanagementAgentSchedulingpreferencesQueryRequest();
		}
		...
		public Builder withBody(QueryAgentSchedulingPreferencesRequest body) {
		...
		public Builder withRequiredParams(String agentId, QueryAgentSchedulingPreferencesRequest body) {
			request.setAgentId(agentId);
			request.setBody(body);
		...
		public PostWorkforcemanagementAgentSchedulingpreferencesQueryRequest build() {
