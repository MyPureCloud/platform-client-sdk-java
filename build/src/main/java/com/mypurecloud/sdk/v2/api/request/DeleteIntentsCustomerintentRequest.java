...
public class DeleteIntentsCustomerintentRequest {
	...
	public DeleteIntentsCustomerintentRequest withCustomerIntentId(String customerIntentId) {
    ...
    public DeleteIntentsCustomerintentRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.customerIntentId == null) {
            throw new IllegalStateException("Missing the required parameter 'customerIntentId' when building request for DeleteIntentsCustomerintentRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/intents/customerintents/{customerIntentId}")
	...
	public static class Builder {
		private final DeleteIntentsCustomerintentRequest request;

		private Builder() {
			request = new DeleteIntentsCustomerintentRequest();
		}
		...
		public DeleteIntentsCustomerintentRequest build() {
