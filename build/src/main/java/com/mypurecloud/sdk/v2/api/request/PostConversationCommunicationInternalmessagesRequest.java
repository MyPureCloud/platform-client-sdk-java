...
public class PostConversationCommunicationInternalmessagesRequest {
	...
	public PostConversationCommunicationInternalmessagesRequest withConversationId(String conversationId) {
	...
	public PostConversationCommunicationInternalmessagesRequest withCommunicationId(String communicationId) {
	    this.setCommunicationId(communicationId);
	    return this;
	} 

	private InternalMessageRequest body;
	public InternalMessageRequest getBody() {
		return this.body;
	}

	public void setBody(InternalMessageRequest body) {
		this.body = body;
	}

	public PostConversationCommunicationInternalmessagesRequest withBody(InternalMessageRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostConversationCommunicationInternalmessagesRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<InternalMessageRequest> withHttpInfo() {
        
        // verify the required parameter 'conversationId' is set
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PostConversationCommunicationInternalmessagesRequest.");
        }
        
        // verify the required parameter 'communicationId' is set
        if (this.communicationId == null) {
            throw new IllegalStateException("Missing the required parameter 'communicationId' when building request for PostConversationCommunicationInternalmessagesRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostConversationCommunicationInternalmessagesRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/conversations/{conversationId}/communications/{communicationId}/internalmessages")
	...
	public static Builder builder(String conversationId, String communicationId, InternalMessageRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostConversationCommunicationInternalmessagesRequest request;

		private Builder() {
			request = new PostConversationCommunicationInternalmessagesRequest();
		}
		...
		public Builder withBody(InternalMessageRequest body) {
		...
		public Builder withRequiredParams(String conversationId, String communicationId, InternalMessageRequest body) {
			request.setConversationId(conversationId);
			request.setCommunicationId(communicationId);
			request.setBody(body);
		...
		public PostConversationCommunicationInternalmessagesRequest build() {
