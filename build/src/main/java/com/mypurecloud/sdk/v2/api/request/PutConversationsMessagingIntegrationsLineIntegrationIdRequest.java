...
public class PutConversationsMessagingIntegrationsLineIntegrationIdRequest {
	...
	public PutConversationsMessagingIntegrationsLineIntegrationIdRequest withIntegrationId(String integrationId) {
	...
	public PutConversationsMessagingIntegrationsLineIntegrationIdRequest withBody(LineIntegrationRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutConversationsMessagingIntegrationsLineIntegrationIdRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<LineIntegrationRequest> withHttpInfo() {
        ...
        if (this.integrationId == null) {
            throw new IllegalStateException("Missing the required parameter 'integrationId' when building request for PutConversationsMessagingIntegrationsLineIntegrationIdRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutConversationsMessagingIntegrationsLineIntegrationIdRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/conversations/messaging/integrations/line/{integrationId}")
	...
	public static class Builder {
		private final PutConversationsMessagingIntegrationsLineIntegrationIdRequest request;

		private Builder() {
			request = new PutConversationsMessagingIntegrationsLineIntegrationIdRequest();
		}
		...
		public PutConversationsMessagingIntegrationsLineIntegrationIdRequest build() {
