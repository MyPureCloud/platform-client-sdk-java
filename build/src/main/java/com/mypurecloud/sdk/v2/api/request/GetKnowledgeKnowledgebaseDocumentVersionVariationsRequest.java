...
public class GetKnowledgeKnowledgebaseDocumentVersionVariationsRequest {
	...
	public GetKnowledgeKnowledgebaseDocumentVersionVariationsRequest withKnowledgeBaseId(String knowledgeBaseId) {
	...
	public GetKnowledgeKnowledgebaseDocumentVersionVariationsRequest withDocumentId(String documentId) {
	...
	public GetKnowledgeKnowledgebaseDocumentVersionVariationsRequest withVersionId(String versionId) {
	...
	public GetKnowledgeKnowledgebaseDocumentVersionVariationsRequest withBefore(String before) {
	...
	public GetKnowledgeKnowledgebaseDocumentVersionVariationsRequest withAfter(String after) {
	    this.setAfter(after);
	    return this;
	} 
	...
	public GetKnowledgeKnowledgebaseDocumentVersionVariationsRequest withPageSize(String pageSize) {
    ...
    public GetKnowledgeKnowledgebaseDocumentVersionVariationsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.knowledgeBaseId == null) {
            throw new IllegalStateException("Missing the required parameter 'knowledgeBaseId' when building request for GetKnowledgeKnowledgebaseDocumentVersionVariationsRequest.");
        }
        
        // verify the required parameter 'documentId' is set
        if (this.documentId == null) {
            throw new IllegalStateException("Missing the required parameter 'documentId' when building request for GetKnowledgeKnowledgebaseDocumentVersionVariationsRequest.");
        }
        
        // verify the required parameter 'versionId' is set
        if (this.versionId == null) {
            throw new IllegalStateException("Missing the required parameter 'versionId' when building request for GetKnowledgeKnowledgebaseDocumentVersionVariationsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/documents/{documentId}/versions/{versionId}/variations")
	...
	public static Builder builder(String knowledgeBaseId, String documentId, String versionId) {
	    return new Builder()
	            .withRequiredParams(knowledgeBaseId, documentId, versionId);
	}


	public static class Builder {
		private final GetKnowledgeKnowledgebaseDocumentVersionVariationsRequest request;

		private Builder() {
			request = new GetKnowledgeKnowledgebaseDocumentVersionVariationsRequest();
		}
		...
		public GetKnowledgeKnowledgebaseDocumentVersionVariationsRequest build() {
