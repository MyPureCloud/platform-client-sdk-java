...
public class GetWorkforcemanagementManagementunitAgentRequest {
	...
	public GetWorkforcemanagementManagementunitAgentRequest withManagementUnitId(String managementUnitId) {
	...
	public GetWorkforcemanagementManagementunitAgentRequest withAgentId(String agentId) {
	...
	public GetWorkforcemanagementManagementunitAgentRequest withExpand(List<String> expand) {
	    this.setExpand(expand);
	    return this;
	} 

	public enum expandValues { 
		WORKPLANOVERRIDES("workPlanOverrides");
    ...
    public GetWorkforcemanagementManagementunitAgentRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.managementUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'managementUnitId' when building request for GetWorkforcemanagementManagementunitAgentRequest.");
        }
        
        // verify the required parameter 'agentId' is set
        if (this.agentId == null) {
            throw new IllegalStateException("Missing the required parameter 'agentId' when building request for GetWorkforcemanagementManagementunitAgentRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/managementunits/{managementUnitId}/agents/{agentId}")
	...
	public static Builder builder(String managementUnitId, String agentId) {
	    return new Builder()
	            .withRequiredParams(managementUnitId, agentId);
	}


	public static class Builder {
		private final GetWorkforcemanagementManagementunitAgentRequest request;

		private Builder() {
			request = new GetWorkforcemanagementManagementunitAgentRequest();
		}
		...
		public Builder withRequiredParams(String managementUnitId, String agentId) {
			request.setManagementUnitId(managementUnitId);
			request.setAgentId(agentId);
		...
		public GetWorkforcemanagementManagementunitAgentRequest build() {
