...
public class QueueConversationEventTopicScreenMonitoring  implements Serializable {
 ...
 @JsonDeserialize(using = MonitoringTypeEnumDeserializer.class)
   ...
   **/
  public QueueConversationEventTopicScreenMonitoring id(String id) {
    this.id = id;
    return this;
  }
  ...
  /**
   **/
  public QueueConversationEventTopicScreenMonitoring state(StateEnum state) {
    this.state = state;
    return this;
  }
  ...
  /**
   **/
  public QueueConversationEventTopicScreenMonitoring initialState(InitialStateEnum initialState) {
   ...
   * The source provider.
   **/
  public QueueConversationEventTopicScreenMonitoring provider(String provider) {
   ...
   * System defined string indicating what caused the communication to disconnect. Will be null until the communication disconnects.
   **/
  public QueueConversationEventTopicScreenMonitoring disconnectType(DisconnectTypeEnum disconnectType) {
   ...
   **/
  public QueueConversationEventTopicScreenMonitoring connectedTime(Date connectedTime) {
   ...
   **/
  public QueueConversationEventTopicScreenMonitoring disconnectedTime(Date disconnectedTime) {
   ...
   **/
  public QueueConversationEventTopicScreenMonitoring targetUserId(String targetUserId) {
   ...
   **/
  public QueueConversationEventTopicScreenMonitoring screenMonitoringId(String screenMonitoringId) {
   ...
   * The screen monitoring type.
   **/
  public QueueConversationEventTopicScreenMonitoring monitoringType(MonitoringTypeEnum monitoringType) {
   ...
   **/
  public QueueConversationEventTopicScreenMonitoring count(Long count) {
    this.count = count;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    QueueConversationEventTopicScreenMonitoring queueConversationEventTopicScreenMonitoring = (QueueConversationEventTopicScreenMonitoring) o;

    return Objects.equals(this.id, queueConversationEventTopicScreenMonitoring.id) &&
            Objects.equals(this.state, queueConversationEventTopicScreenMonitoring.state) &&
            Objects.equals(this.initialState, queueConversationEventTopicScreenMonitoring.initialState) &&
            Objects.equals(this.provider, queueConversationEventTopicScreenMonitoring.provider) &&
            Objects.equals(this.disconnectType, queueConversationEventTopicScreenMonitoring.disconnectType) &&
            Objects.equals(this.connectedTime, queueConversationEventTopicScreenMonitoring.connectedTime) &&
            Objects.equals(this.disconnectedTime, queueConversationEventTopicScreenMonitoring.disconnectedTime) &&
            Objects.equals(this.targetUserId, queueConversationEventTopicScreenMonitoring.targetUserId) &&
            Objects.equals(this.screenMonitoringId, queueConversationEventTopicScreenMonitoring.screenMonitoringId) &&
            Objects.equals(this.monitoringType, queueConversationEventTopicScreenMonitoring.monitoringType) &&
            Objects.equals(this.count, queueConversationEventTopicScreenMonitoring.count);
  }
