...
public class DomainSchemaReference  implements Serializable {
 ...
 @JsonDeserialize(using = StateEnumDeserializer.class)
   ...
   **/
  public DomainSchemaReference name(String name) {
    this.name = name;
    return this;
  }
   ...
   **/
  public DomainSchemaReference division(Division division) {
   ...
   **/
  public DomainSchemaReference dateCreated(Date dateCreated) {
   ...
   **/
  public DomainSchemaReference dateModified(Date dateModified) {
