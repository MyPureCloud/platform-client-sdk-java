...
public class GetAnalyticsEvaluationsAggregatesJobRequest {
	...
	public GetAnalyticsEvaluationsAggregatesJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetAnalyticsEvaluationsAggregatesJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetAnalyticsEvaluationsAggregatesJobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/analytics/evaluations/aggregates/jobs/{jobId}")
	...
	public static class Builder {
		private final GetAnalyticsEvaluationsAggregatesJobRequest request;

		private Builder() {
			request = new GetAnalyticsEvaluationsAggregatesJobRequest();
		}
		...
		public GetAnalyticsEvaluationsAggregatesJobRequest build() {
