...
public class PostConversationCommunicationAgentchecklistAgentactionRequest {
	...
	public PostConversationCommunicationAgentchecklistAgentactionRequest withConversationId(String conversationId) {
	...
	public PostConversationCommunicationAgentchecklistAgentactionRequest withCommunicationId(String communicationId) {
	...
	public PostConversationCommunicationAgentchecklistAgentactionRequest withAgentChecklistId(String agentChecklistId) {
	    this.setAgentChecklistId(agentChecklistId);
	    return this;
	} 

	private AgentActionPayload body;
	public AgentActionPayload getBody() {
		return this.body;
	}

	public void setBody(AgentActionPayload body) {
		this.body = body;
	}

	public PostConversationCommunicationAgentchecklistAgentactionRequest withBody(AgentActionPayload body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostConversationCommunicationAgentchecklistAgentactionRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<AgentActionPayload> withHttpInfo() {
        
        // verify the required parameter 'conversationId' is set
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PostConversationCommunicationAgentchecklistAgentactionRequest.");
        }
        
        // verify the required parameter 'communicationId' is set
        if (this.communicationId == null) {
            throw new IllegalStateException("Missing the required parameter 'communicationId' when building request for PostConversationCommunicationAgentchecklistAgentactionRequest.");
        }
        
        // verify the required parameter 'agentChecklistId' is set
        if (this.agentChecklistId == null) {
            throw new IllegalStateException("Missing the required parameter 'agentChecklistId' when building request for PostConversationCommunicationAgentchecklistAgentactionRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostConversationCommunicationAgentchecklistAgentactionRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/conversations/{conversationId}/communications/{communicationId}/agentchecklists/{agentChecklistId}/agentaction")
	...
	public static Builder builder(String conversationId, String communicationId, String agentChecklistId, AgentActionPayload body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostConversationCommunicationAgentchecklistAgentactionRequest request;

		private Builder() {
			request = new PostConversationCommunicationAgentchecklistAgentactionRequest();
		}
		...
		public Builder withBody(AgentActionPayload body) {
		...
		public Builder withRequiredParams(String conversationId, String communicationId, String agentChecklistId, AgentActionPayload body) {
			request.setConversationId(conversationId);
			request.setCommunicationId(communicationId);
			request.setAgentChecklistId(agentChecklistId);
			request.setBody(body);
		...
		public PostConversationCommunicationAgentchecklistAgentactionRequest build() {
