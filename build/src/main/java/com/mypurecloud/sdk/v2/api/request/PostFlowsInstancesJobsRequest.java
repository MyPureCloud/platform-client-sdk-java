...
public class PostFlowsInstancesJobsRequest {

	private ExecutionDataRequest body;
	public ExecutionDataRequest getBody() {
		return this.body;
	}

	public void setBody(ExecutionDataRequest body) {
		this.body = body;
	}

	public PostFlowsInstancesJobsRequest withBody(ExecutionDataRequest body) {
	    this.setBody(body);
	    return this;
	} 
	...
	public PostFlowsInstancesJobsRequest withExpand(String expand) {
    ...
    public PostFlowsInstancesJobsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<ExecutionDataRequest> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostFlowsInstancesJobsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/flows/instances/jobs")
	...
	public static Builder builder(ExecutionDataRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostFlowsInstancesJobsRequest request;

		private Builder() {
			request = new PostFlowsInstancesJobsRequest();
		}


		public Builder withBody(ExecutionDataRequest body) {
		...
		public Builder withRequiredParams(ExecutionDataRequest body) {
			request.setBody(body);
		...
		public PostFlowsInstancesJobsRequest build() {
