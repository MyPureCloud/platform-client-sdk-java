...
public class DeleteExternalcontactsImportSettingRequest {
	...
	public DeleteExternalcontactsImportSettingRequest withSettingsId(String settingsId) {
    ...
    public DeleteExternalcontactsImportSettingRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.settingsId == null) {
            throw new IllegalStateException("Missing the required parameter 'settingsId' when building request for DeleteExternalcontactsImportSettingRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/externalcontacts/import/settings/{settingsId}")
	...
	public static class Builder {
		private final DeleteExternalcontactsImportSettingRequest request;

		private Builder() {
			request = new DeleteExternalcontactsImportSettingRequest();
		}
		...
		public DeleteExternalcontactsImportSettingRequest build() {
