...
public class PingIdentity  implements Serializable {
 ...
 @JsonDeserialize(using = SsoBindingEnumDeserializer.class)
  ...
  public PingIdentity(Boolean initWithEmptyList) {
  ...
  /**
   **/
  public PingIdentity sloURI(String sloURI) {
    this.sloURI = sloURI;
    return this;
  }
  ...
  /**
   **/
  public PingIdentity sloBinding(String sloBinding) {
  ...
  /**
   **/
  public PingIdentity certificates(List<String> certificates) {
  ...
  /**
   **/
  public PingIdentity logoImageData(String logoImageData) {
  ...
  /**
   **/
  public PingIdentity nameIdentifierFormat(NameIdentifierFormatEnum nameIdentifierFormat) {
  ...
  /**
   **/
  public PingIdentity ssoBinding(SsoBindingEnum ssoBinding) {
  ...
  /**
   **/
  public PingIdentity signAuthnRequests(Boolean signAuthnRequests) {
  ...
  /**
   **/
  public PingIdentity providerName(String providerName) {
  ...
  /**
   **/
  public PingIdentity displayOnLogin(Boolean displayOnLogin) {
  ...
  /**
   **/
  public PingIdentity forceAuthn(Boolean forceAuthn) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, pingIdentity.id) &&
            ...
            Objects.equals(this.logoImageData, pingIdentity.logoImageData) &&
            Objects.equals(this.nameIdentifierFormat, pingIdentity.nameIdentifierFormat) &&
            Objects.equals(this.ssoBinding, pingIdentity.ssoBinding) &&
            ...
            Objects.equals(this.forceAuthn, pingIdentity.forceAuthn) &&
