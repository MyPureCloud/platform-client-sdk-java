...
public class GetGuidesJobRequest {
	...
	public GetGuidesJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetGuidesJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.jobId == null) {
            throw new IllegalStateException("Missing the required parameter 'jobId' when building request for GetGuidesJobRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/guides/jobs/{jobId}")
	...
	public static class Builder {
		private final GetGuidesJobRequest request;

		private Builder() {
			request = new GetGuidesJobRequest();
		}
		...
		public GetGuidesJobRequest build() {
