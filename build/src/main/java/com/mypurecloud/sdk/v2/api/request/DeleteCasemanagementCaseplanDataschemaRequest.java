...
public class DeleteCasemanagementCaseplanDataschemaRequest {
	...
	public DeleteCasemanagementCaseplanDataschemaRequest withCaseplanId(String caseplanId) {
	...
	public DeleteCasemanagementCaseplanDataschemaRequest withSchemaKeyName(String schemaKeyName) {
    ...
    public DeleteCasemanagementCaseplanDataschemaRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.caseplanId == null) {
            throw new IllegalStateException("Missing the required parameter 'caseplanId' when building request for DeleteCasemanagementCaseplanDataschemaRequest.");
        }
        
        // verify the required parameter 'schemaKeyName' is set
        if (this.schemaKeyName == null) {
            throw new IllegalStateException("Missing the required parameter 'schemaKeyName' when building request for DeleteCasemanagementCaseplanDataschemaRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/casemanagement/caseplans/{caseplanId}/dataschemas/{schemaKeyName}")
	...
	public static Builder builder(String caseplanId, String schemaKeyName) {
	    return new Builder()
	            .withRequiredParams(caseplanId, schemaKeyName);
	}


	public static class Builder {
		private final DeleteCasemanagementCaseplanDataschemaRequest request;

		private Builder() {
			request = new DeleteCasemanagementCaseplanDataschemaRequest();
		}
		...
		public Builder withRequiredParams(String caseplanId, String schemaKeyName) {
			request.setCaseplanId(caseplanId);
			request.setSchemaKeyName(schemaKeyName);
		...
		public DeleteCasemanagementCaseplanDataschemaRequest build() {
