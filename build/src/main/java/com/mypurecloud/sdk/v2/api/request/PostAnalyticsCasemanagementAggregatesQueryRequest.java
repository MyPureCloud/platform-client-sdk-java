...
public class PostAnalyticsCasemanagementAggregatesQueryRequest {

	private CaseManagementAggregationQuery body;
	public CaseManagementAggregationQuery getBody() {
		return this.body;
	}

	public void setBody(CaseManagementAggregationQuery body) {
		this.body = body;
	}

	public PostAnalyticsCasemanagementAggregatesQueryRequest withBody(CaseManagementAggregationQuery body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostAnalyticsCasemanagementAggregatesQueryRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<CaseManagementAggregationQuery> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostAnalyticsCasemanagementAggregatesQueryRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/analytics/casemanagement/aggregates/query")
                .withBody(body)
	...
	public static Builder builder(CaseManagementAggregationQuery body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostAnalyticsCasemanagementAggregatesQueryRequest request;

		private Builder() {
			request = new PostAnalyticsCasemanagementAggregatesQueryRequest();
		}


		public Builder withBody(CaseManagementAggregationQuery body) {
		...
		public Builder withRequiredParams(CaseManagementAggregationQuery body) {
			request.setBody(body);
		...
		public PostAnalyticsCasemanagementAggregatesQueryRequest build() {
