...
public class GetArchitectSystempromptResourceRequest {
	...
	public GetArchitectSystempromptResourceRequest withPromptId(String promptId) {
	...
	public GetArchitectSystempromptResourceRequest withLanguageCode(String languageCode) {
    ...
    public GetArchitectSystempromptResourceRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.promptId == null) {
            throw new IllegalStateException("Missing the required parameter 'promptId' when building request for GetArchitectSystempromptResourceRequest.");
        }
        
        // verify the required parameter 'languageCode' is set
        if (this.languageCode == null) {
            throw new IllegalStateException("Missing the required parameter 'languageCode' when building request for GetArchitectSystempromptResourceRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/architect/systemprompts/{promptId}/resources/{languageCode}")
