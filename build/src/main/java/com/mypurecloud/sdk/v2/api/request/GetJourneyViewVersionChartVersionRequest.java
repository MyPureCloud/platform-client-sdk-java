...
public class GetJourneyViewVersionChartVersionRequest {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/journey/views/{viewId}/versions/{journeyViewVersion}/charts/{chartId}/versions/{chartVersion}")
                .withPathParameter("viewId", viewId)
        
                .withPathParameter("journeyViewVersion", journeyViewVersion)
        
                .withPathParameter("chartId", chartId)
        
                .withPathParameter("chartVersion", chartVersion)
	...
	public static Builder builder(String viewId, String journeyViewVersion, String chartId, String chartVersion) {
	    return new Builder()
	            .withRequiredParams(viewId, journeyViewVersion, chartId, chartVersion);
	}


	public static class Builder {
		private final GetJourneyViewVersionChartVersionRequest request;

		private Builder() {
			request = new GetJourneyViewVersionChartVersionRequest();
		}
		...
		public Builder withJourneyViewVersion(String journeyViewVersion) {
			request.setJourneyViewVersion(journeyViewVersion);
			return this;
		}
		...
		public Builder withChartVersion(String chartVersion) {
			request.setChartVersion(chartVersion);
			return this;
		}
		...
		public GetJourneyViewVersionChartVersionRequest build() {
            ...
            // verify the required parameter 'journeyViewVersion' is set
            if (request.journeyViewVersion == null) {
                throw new IllegalStateException("Missing the required parameter 'journeyViewVersion' when building request for GetJourneyViewVersionChartVersionRequest.");
            }
