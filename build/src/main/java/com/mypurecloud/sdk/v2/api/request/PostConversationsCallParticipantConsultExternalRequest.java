...
public class PostConversationsCallParticipantConsultExternalRequest {
	...
	public PostConversationsCallParticipantConsultExternalRequest withConversationId(String conversationId) {
	...
	public PostConversationsCallParticipantConsultExternalRequest withParticipantId(String participantId) {
	    this.setParticipantId(participantId);
	    return this;
	} 

	private ConsultTransferToExternal body;
	public ConsultTransferToExternal getBody() {
		return this.body;
	}

	public void setBody(ConsultTransferToExternal body) {
		this.body = body;
	}

	public PostConversationsCallParticipantConsultExternalRequest withBody(ConsultTransferToExternal body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostConversationsCallParticipantConsultExternalRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<ConsultTransferToExternal> withHttpInfo() {
        
        // verify the required parameter 'conversationId' is set
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for PostConversationsCallParticipantConsultExternalRequest.");
        }
        
        // verify the required parameter 'participantId' is set
        if (this.participantId == null) {
            throw new IllegalStateException("Missing the required parameter 'participantId' when building request for PostConversationsCallParticipantConsultExternalRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostConversationsCallParticipantConsultExternalRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/conversations/calls/{conversationId}/participants/{participantId}/consult/external")
	...
	public static Builder builder(String conversationId, String participantId, ConsultTransferToExternal body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostConversationsCallParticipantConsultExternalRequest request;

		private Builder() {
			request = new PostConversationsCallParticipantConsultExternalRequest();
		}
		...
		public Builder withBody(ConsultTransferToExternal body) {
		...
		public Builder withRequiredParams(String conversationId, String participantId, ConsultTransferToExternal body) {
			request.setConversationId(conversationId);
			request.setParticipantId(participantId);
			request.setBody(body);
		...
		public PostConversationsCallParticipantConsultExternalRequest build() {
