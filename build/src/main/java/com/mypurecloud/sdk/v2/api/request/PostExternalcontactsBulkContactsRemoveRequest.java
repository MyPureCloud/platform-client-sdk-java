...
public class PostExternalcontactsBulkContactsRemoveRequest {
	...
	public PostExternalcontactsBulkContactsRemoveRequest withBody(BulkIdsRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostExternalcontactsBulkContactsRemoveRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<BulkIdsRequest> withHttpInfo() {
        ...
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostExternalcontactsBulkContactsRemoveRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/externalcontacts/bulk/contacts/remove")
                .withBody(body)
	...
	public static class Builder {
		private final PostExternalcontactsBulkContactsRemoveRequest request;

		private Builder() {
			request = new PostExternalcontactsBulkContactsRemoveRequest();
		}
		...
		public PostExternalcontactsBulkContactsRemoveRequest build() {
