...
public class PostKnowledgeKnowledgebaseDocumentCopiesRequest {
	...
	public PostKnowledgeKnowledgebaseDocumentCopiesRequest withKnowledgeBaseId(String knowledgeBaseId) {
	...
	public PostKnowledgeKnowledgebaseDocumentCopiesRequest withDocumentId(String documentId) {
	    this.setDocumentId(documentId);
	    return this;
	} 

	private KnowledgeDocumentCopy body;
	public KnowledgeDocumentCopy getBody() {
		return this.body;
	}

	public void setBody(KnowledgeDocumentCopy body) {
		this.body = body;
	}

	public PostKnowledgeKnowledgebaseDocumentCopiesRequest withBody(KnowledgeDocumentCopy body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostKnowledgeKnowledgebaseDocumentCopiesRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<KnowledgeDocumentCopy> withHttpInfo() {
        
        // verify the required parameter 'knowledgeBaseId' is set
        if (this.knowledgeBaseId == null) {
            throw new IllegalStateException("Missing the required parameter 'knowledgeBaseId' when building request for PostKnowledgeKnowledgebaseDocumentCopiesRequest.");
        }
        
        // verify the required parameter 'documentId' is set
        if (this.documentId == null) {
            throw new IllegalStateException("Missing the required parameter 'documentId' when building request for PostKnowledgeKnowledgebaseDocumentCopiesRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/documents/{documentId}/copies")
	...
	public static class Builder {
		private final PostKnowledgeKnowledgebaseDocumentCopiesRequest request;

		private Builder() {
			request = new PostKnowledgeKnowledgebaseDocumentCopiesRequest();
		}
		...
		public Builder withBody(KnowledgeDocumentCopy body) {
		...
		public PostKnowledgeKnowledgebaseDocumentCopiesRequest build() {
