...
public class PostTelephonyProvidersEdgeDiagnosticPingRequest {
	...
	public PostTelephonyProvidersEdgeDiagnosticPingRequest withEdgeId(String edgeId) {
	...
	public PostTelephonyProvidersEdgeDiagnosticPingRequest withBody(EdgeNetworkDiagnosticRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostTelephonyProvidersEdgeDiagnosticPingRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<EdgeNetworkDiagnosticRequest> withHttpInfo() {
        ...
        if (this.edgeId == null) {
            throw new IllegalStateException("Missing the required parameter 'edgeId' when building request for PostTelephonyProvidersEdgeDiagnosticPingRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostTelephonyProvidersEdgeDiagnosticPingRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/telephony/providers/edges/{edgeId}/diagnostic/ping")
	...
	public static class Builder {
		private final PostTelephonyProvidersEdgeDiagnosticPingRequest request;

		private Builder() {
			request = new PostTelephonyProvidersEdgeDiagnosticPingRequest();
		}
		...
		public PostTelephonyProvidersEdgeDiagnosticPingRequest build() {
