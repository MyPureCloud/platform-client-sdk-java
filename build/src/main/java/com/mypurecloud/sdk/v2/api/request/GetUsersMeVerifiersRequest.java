...
public class GetUsersMeVerifiersRequest {
    ...
    public GetUsersMeVerifiersRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/users/me/verifiers")
	...
	public static class Builder {
		private final GetUsersMeVerifiersRequest request;

		private Builder() {
			request = new GetUsersMeVerifiersRequest();
		}
		...
		public GetUsersMeVerifiersRequest build() {
