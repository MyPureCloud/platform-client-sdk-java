...
public class PostAnalyticsAgentcopilotsAggregatesQueryRequest {

	private AgentCopilotAggregationQuery body;
	public AgentCopilotAggregationQuery getBody() {
		return this.body;
	}

	public void setBody(AgentCopilotAggregationQuery body) {
		this.body = body;
	}

	public PostAnalyticsAgentcopilotsAggregatesQueryRequest withBody(AgentCopilotAggregationQuery body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostAnalyticsAgentcopilotsAggregatesQueryRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<AgentCopilotAggregationQuery> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostAnalyticsAgentcopilotsAggregatesQueryRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/analytics/agentcopilots/aggregates/query")
                .withBody(body)
	...
	public static Builder builder(AgentCopilotAggregationQuery body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostAnalyticsAgentcopilotsAggregatesQueryRequest request;

		private Builder() {
			request = new PostAnalyticsAgentcopilotsAggregatesQueryRequest();
		}


		public Builder withBody(AgentCopilotAggregationQuery body) {
		...
		public Builder withRequiredParams(AgentCopilotAggregationQuery body) {
			request.setBody(body);
		...
		public PostAnalyticsAgentcopilotsAggregatesQueryRequest build() {
