...
public class GetArchitectIvrsDivisionviewsRequest {
	...
	public GetArchitectIvrsDivisionviewsRequest withPageNumber(Integer pageNumber) {
	...
	public GetArchitectIvrsDivisionviewsRequest withPageSize(Integer pageSize) {
	...
	public GetArchitectIvrsDivisionviewsRequest withSortBy(String sortBy) {
	...
	public GetArchitectIvrsDivisionviewsRequest withSortOrder(String sortOrder) {
	...
	public GetArchitectIvrsDivisionviewsRequest withId(List<String> id) {
	    this.setId(id);
	    return this;
	} 
	...
	public GetArchitectIvrsDivisionviewsRequest withName(String name) {
	    this.setName(name);
	    return this;
	} 
	...
	public GetArchitectIvrsDivisionviewsRequest withDivisionId(List<String> divisionId) {
    ...
    public GetArchitectIvrsDivisionviewsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/architect/ivrs/divisionviews")
	...
	public static class Builder {
		private final GetArchitectIvrsDivisionviewsRequest request;

		private Builder() {
			request = new GetArchitectIvrsDivisionviewsRequest();
		}
		...
		public GetArchitectIvrsDivisionviewsRequest build() {
