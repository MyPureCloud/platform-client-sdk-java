...
import com.fasterxml.jackson.annotation.JsonValue;
import com.mypurecloud.sdk.v2.model.TaskManagementAggregateQueryFilter;
import com.mypurecloud.sdk.v2.model.TaskManagementAggregationView;
...
public class TaskManagementAsyncAggregationQuery  implements Serializable {
 ...
 @JsonDeserialize(using = GroupByEnumDeserializer.class)
  ...
  private TaskManagementAggregateQueryFilter filter = null;
 ...
 @JsonDeserialize(using = MetricsEnumDeserializer.class)
  ...
  private List<TaskManagementAggregationView> views = null;
 ...
 @JsonDeserialize(using = AlternateTimeDimensionEnumDeserializer.class)
  ...
  public TaskManagementAsyncAggregationQuery() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
      ...
      views = new ArrayList<TaskManagementAggregationView>();
    }
  }

  public TaskManagementAsyncAggregationQuery(Boolean initWithEmptyList) {
   ...
   **/
  public TaskManagementAsyncAggregationQuery interval(String interval) {
   ...
   **/
  public TaskManagementAsyncAggregationQuery granularity(String granularity) {
   ...
   **/
  public TaskManagementAsyncAggregationQuery timeZone(String timeZone) {
   ...
   **/
  public TaskManagementAsyncAggregationQuery groupBy(List<GroupByEnum> groupBy) {
   ...
   **/
  public TaskManagementAsyncAggregationQuery filter(TaskManagementAggregateQueryFilter filter) {
    this.filter = filter;
    return this;
  }
  ...
  @JsonProperty("filter")
  public TaskManagementAggregateQueryFilter getFilter() {
    return filter;
  }
  public void setFilter(TaskManagementAggregateQueryFilter filter) {
    this.filter = filter;
  }
   ...
   **/
  public TaskManagementAsyncAggregationQuery metrics(List<MetricsEnum> metrics) {
   ...
   **/
  public TaskManagementAsyncAggregationQuery flattenMultivaluedDimensions(Boolean flattenMultivaluedDimensions) {
   ...
   **/
  public TaskManagementAsyncAggregationQuery views(List<TaskManagementAggregationView> views) {
    this.views = views;
    return this;
  }
  ...
  @JsonProperty("views")
  public List<TaskManagementAggregationView> getViews() {
    return views;
  }
  public void setViews(List<TaskManagementAggregationView> views) {
    this.views = views;
  }
   ...
   * Dimension to use as the alternative timestamp for data in the aggregate.  Choosing \"eventTime\" uses the actual time of the data event.
   **/
  public TaskManagementAsyncAggregationQuery alternateTimeDimension(AlternateTimeDimensionEnum alternateTimeDimension) {
   ...
   **/
  public TaskManagementAsyncAggregationQuery pageSize(Integer pageSize) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TaskManagementAsyncAggregationQuery taskManagementAsyncAggregationQuery = (TaskManagementAsyncAggregationQuery) o;

    return Objects.equals(this.interval, taskManagementAsyncAggregationQuery.interval) &&
            Objects.equals(this.granularity, taskManagementAsyncAggregationQuery.granularity) &&
            Objects.equals(this.timeZone, taskManagementAsyncAggregationQuery.timeZone) &&
            Objects.equals(this.groupBy, taskManagementAsyncAggregationQuery.groupBy) &&
            Objects.equals(this.filter, taskManagementAsyncAggregationQuery.filter) &&
            Objects.equals(this.metrics, taskManagementAsyncAggregationQuery.metrics) &&
            Objects.equals(this.flattenMultivaluedDimensions, taskManagementAsyncAggregationQuery.flattenMultivaluedDimensions) &&
            Objects.equals(this.views, taskManagementAsyncAggregationQuery.views) &&
            Objects.equals(this.alternateTimeDimension, taskManagementAsyncAggregationQuery.alternateTimeDimension) &&
            Objects.equals(this.pageSize, taskManagementAsyncAggregationQuery.pageSize);
  }
