...
public class DeleteKnowledgeKnowledgebaseLabelRequest {
	...
	public DeleteKnowledgeKnowledgebaseLabelRequest withKnowledgeBaseId(String knowledgeBaseId) {
	...
	public DeleteKnowledgeKnowledgebaseLabelRequest withLabelId(String labelId) {
    ...
    public DeleteKnowledgeKnowledgebaseLabelRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.knowledgeBaseId == null) {
            throw new IllegalStateException("Missing the required parameter 'knowledgeBaseId' when building request for DeleteKnowledgeKnowledgebaseLabelRequest.");
        }
        
        // verify the required parameter 'labelId' is set
        if (this.labelId == null) {
            throw new IllegalStateException("Missing the required parameter 'labelId' when building request for DeleteKnowledgeKnowledgebaseLabelRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/labels/{labelId}")
	...
	public static Builder builder(String knowledgeBaseId, String labelId) {
	    return new Builder()
	            .withRequiredParams(knowledgeBaseId, labelId);
	}


	public static class Builder {
		private final DeleteKnowledgeKnowledgebaseLabelRequest request;

		private Builder() {
			request = new DeleteKnowledgeKnowledgebaseLabelRequest();
		}
		...
		public Builder withRequiredParams(String knowledgeBaseId, String labelId) {
			request.setKnowledgeBaseId(knowledgeBaseId);
			request.setLabelId(labelId);
		...
		public DeleteKnowledgeKnowledgebaseLabelRequest build() {
