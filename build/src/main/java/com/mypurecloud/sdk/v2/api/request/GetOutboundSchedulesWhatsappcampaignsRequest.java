...
public class GetOutboundSchedulesWhatsappcampaignsRequest {
    ...
    public GetOutboundSchedulesWhatsappcampaignsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/outbound/schedules/whatsappcampaigns")
	...
	public static class Builder {
		private final GetOutboundSchedulesWhatsappcampaignsRequest request;

		private Builder() {
			request = new GetOutboundSchedulesWhatsappcampaignsRequest();
		}
		...
		public GetOutboundSchedulesWhatsappcampaignsRequest build() {
