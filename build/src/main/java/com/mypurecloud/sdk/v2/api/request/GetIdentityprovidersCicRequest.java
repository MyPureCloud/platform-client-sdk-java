...
public class GetIdentityprovidersCicRequest {
    ...
    public GetIdentityprovidersCicRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() throws ApiException {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/identityproviders/cic")                .withCustomHeaders(customHeaders)
	...
	public static class Builder {
		private final GetIdentityprovidersCicRequest request;

		private Builder() {
			request = new GetIdentityprovidersCicRequest();
		}




		public GetIdentityprovidersCicRequest build() {
			return request;
		}
	}
}
