...
public class ExternalContactsUnresolvedContactChangedTopicLineUserId  implements Serializable {
  ...
  public ExternalContactsUnresolvedContactChangedTopicLineUserId() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
    }
  }

  public ExternalContactsUnresolvedContactChangedTopicLineUserId(Boolean initWithEmptyList) {
