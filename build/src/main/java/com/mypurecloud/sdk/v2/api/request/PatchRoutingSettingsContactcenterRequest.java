...
public class PatchRoutingSettingsContactcenterRequest {
    
	private ContactCenterSettings body;
	public ContactCenterSettings getBody() {
		return this.body;
	}

	public void setBody(ContactCenterSettings body) {
		this.body = body;
	}

	public PatchRoutingSettingsContactcenterRequest withBody(ContactCenterSettings body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchRoutingSettingsContactcenterRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<ContactCenterSettings> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PatchRoutingSettingsContactcenterRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/routing/settings/contactcenter")
                .withBody(body)
	...
	public static Builder builder(ContactCenterSettings body) {
	    return new Builder()
	...
	public static class Builder {
		private final PatchRoutingSettingsContactcenterRequest request;

		private Builder() {
			request = new PatchRoutingSettingsContactcenterRequest();
		}

		
		public Builder withBody(ContactCenterSettings body) {
		...
		public Builder withRequiredParams(ContactCenterSettings body) {
			request.setBody(body);
		...
		public PatchRoutingSettingsContactcenterRequest build() {
