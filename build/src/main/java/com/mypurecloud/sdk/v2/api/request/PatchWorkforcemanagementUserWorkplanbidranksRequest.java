...
public class PatchWorkforcemanagementUserWorkplanbidranksRequest {
	...
	public PatchWorkforcemanagementUserWorkplanbidranksRequest withUserId(String userId) {
	    this.setUserId(userId);
	    return this;
	} 

	private WorkPlanBidRanks body;
	public WorkPlanBidRanks getBody() {
		return this.body;
	}

	public void setBody(WorkPlanBidRanks body) {
		this.body = body;
	}

	public PatchWorkforcemanagementUserWorkplanbidranksRequest withBody(WorkPlanBidRanks body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchWorkforcemanagementUserWorkplanbidranksRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<WorkPlanBidRanks> withHttpInfo() {
	...
	public static class Builder {
		private final PatchWorkforcemanagementUserWorkplanbidranksRequest request;

		private Builder() {
			request = new PatchWorkforcemanagementUserWorkplanbidranksRequest();
		}
		...
		public Builder withBody(WorkPlanBidRanks body) {
		...
		public PatchWorkforcemanagementUserWorkplanbidranksRequest build() {
