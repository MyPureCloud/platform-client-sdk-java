...
public class GetWorkforcemanagementBusinessunitSchedulingpreferencesSettingsRequest {
	...
	public GetWorkforcemanagementBusinessunitSchedulingpreferencesSettingsRequest withBusinessUnitId(String businessUnitId) {
    ...
    public GetWorkforcemanagementBusinessunitSchedulingpreferencesSettingsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for GetWorkforcemanagementBusinessunitSchedulingpreferencesSettingsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/schedulingpreferences/settings")
	...
	public static class Builder {
		private final GetWorkforcemanagementBusinessunitSchedulingpreferencesSettingsRequest request;

		private Builder() {
			request = new GetWorkforcemanagementBusinessunitSchedulingpreferencesSettingsRequest();
		}
		...
		public GetWorkforcemanagementBusinessunitSchedulingpreferencesSettingsRequest build() {
