...
public class PatchTaskmanagementWorktypeRequest {
	...
	public PatchTaskmanagementWorktypeRequest withWorktypeId(String worktypeId) {
	    this.setWorktypeId(worktypeId);
	    return this;
	} 

	private WorktypeUpdate body;
	public WorktypeUpdate getBody() {
		return this.body;
	}

	public void setBody(WorktypeUpdate body) {
		this.body = body;
	}

	public PatchTaskmanagementWorktypeRequest withBody(WorktypeUpdate body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchTaskmanagementWorktypeRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<WorktypeUpdate> withHttpInfo() {
	...
	public static class Builder {
		private final PatchTaskmanagementWorktypeRequest request;

		private Builder() {
			request = new PatchTaskmanagementWorktypeRequest();
		}
		...
		public Builder withBody(WorktypeUpdate body) {
		...
		public PatchTaskmanagementWorktypeRequest build() {
