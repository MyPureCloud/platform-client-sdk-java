...
public class GetTaskmanagementWorktypeFlowsDatebasedRuleRequest {
	...
	public GetTaskmanagementWorktypeFlowsDatebasedRuleRequest withWorktypeId(String worktypeId) {
	...
	public GetTaskmanagementWorktypeFlowsDatebasedRuleRequest withRuleId(String ruleId) {
    ...
    public GetTaskmanagementWorktypeFlowsDatebasedRuleRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.worktypeId == null) {
            throw new IllegalStateException("Missing the required parameter 'worktypeId' when building request for GetTaskmanagementWorktypeFlowsDatebasedRuleRequest.");
        }
        
        // verify the required parameter 'ruleId' is set
        if (this.ruleId == null) {
            throw new IllegalStateException("Missing the required parameter 'ruleId' when building request for GetTaskmanagementWorktypeFlowsDatebasedRuleRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/taskmanagement/worktypes/{worktypeId}/flows/datebased/rules/{ruleId}")
	...
	public static class Builder {
		private final GetTaskmanagementWorktypeFlowsDatebasedRuleRequest request;

		private Builder() {
			request = new GetTaskmanagementWorktypeFlowsDatebasedRuleRequest();
		}
		...
		public GetTaskmanagementWorktypeFlowsDatebasedRuleRequest build() {
