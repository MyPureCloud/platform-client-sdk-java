...
public class GetKnowledgeSourceSynchronizationRequest {
	...
	public GetKnowledgeSourceSynchronizationRequest withSourceId(String sourceId) {
	...
	public GetKnowledgeSourceSynchronizationRequest withSynchronizationId(String synchronizationId) {
    ...
    public GetKnowledgeSourceSynchronizationRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.sourceId == null) {
            throw new IllegalStateException("Missing the required parameter 'sourceId' when building request for GetKnowledgeSourceSynchronizationRequest.");
        }
        
        // verify the required parameter 'synchronizationId' is set
        if (this.synchronizationId == null) {
            throw new IllegalStateException("Missing the required parameter 'synchronizationId' when building request for GetKnowledgeSourceSynchronizationRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/knowledge/sources/{sourceId}/synchronizations/{synchronizationId}")
	...
	public static class Builder {
		private final GetKnowledgeSourceSynchronizationRequest request;

		private Builder() {
			request = new GetKnowledgeSourceSynchronizationRequest();
		}
		...
		public GetKnowledgeSourceSynchronizationRequest build() {
