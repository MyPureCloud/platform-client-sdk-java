...
public class DeleteConversationsCallParticipantConsultRequest {
	...
	public DeleteConversationsCallParticipantConsultRequest withConversationId(String conversationId) {
	...
	public DeleteConversationsCallParticipantConsultRequest withParticipantId(String participantId) {
    ...
    public DeleteConversationsCallParticipantConsultRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.conversationId == null) {
            throw new IllegalStateException("Missing the required parameter 'conversationId' when building request for DeleteConversationsCallParticipantConsultRequest.");
        }
        
        // verify the required parameter 'participantId' is set
        if (this.participantId == null) {
            throw new IllegalStateException("Missing the required parameter 'participantId' when building request for DeleteConversationsCallParticipantConsultRequest.");
        }
        

        return ApiRequestBuilder.create("DELETE", "/api/v2/conversations/calls/{conversationId}/participants/{participantId}/consult")
	...
	public static class Builder {
		private final DeleteConversationsCallParticipantConsultRequest request;

		private Builder() {
			request = new DeleteConversationsCallParticipantConsultRequest();
		}
		...
		public DeleteConversationsCallParticipantConsultRequest build() {
