...
public class DeleteConversationsCallParticipantConsultRequest {
	...
	public DeleteConversationsCallParticipantConsultRequest withCallId(String callId) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.callId == null) {
            throw new IllegalStateException("Missing the required parameter 'callId' when building request for DeleteConversationsCallParticipantConsultRequest.");
        }
        ...
        return ApiRequestBuilder.create("DELETE", "/api/v2/conversations/calls/{callId}/participants/{participantId}/consult")
