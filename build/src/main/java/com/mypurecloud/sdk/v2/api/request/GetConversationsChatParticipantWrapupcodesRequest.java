...
public class GetConversationsChatParticipantWrapupcodesRequest {
	...
	public GetConversationsChatParticipantWrapupcodesRequest withParticipantId(String participantId) {
    ...
    public GetConversationsChatParticipantWrapupcodesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() throws ApiException {
        ...
        if (this.chatId == null) {
            throw new ApiException(400, "Missing the required parameter 'chatId' when building request for GetConversationsChatParticipantWrapupcodesRequest.");
        }
        
        // verify the required parameter 'participantId' is set
        if (this.participantId == null) {
            throw new ApiException(400, "Missing the required parameter 'participantId' when building request for GetConversationsChatParticipantWrapupcodesRequest.");
        }
	...
	public static class Builder {
		private final GetConversationsChatParticipantWrapupcodesRequest request;
