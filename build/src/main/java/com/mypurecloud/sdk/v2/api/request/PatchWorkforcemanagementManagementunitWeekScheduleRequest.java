...
public class PatchWorkforcemanagementManagementunitWeekScheduleRequest {
	...
	public PatchWorkforcemanagementManagementunitWeekScheduleRequest withManagementUnitId(String managementUnitId) {
	...
	public PatchWorkforcemanagementManagementunitWeekScheduleRequest withWeekId(String weekId) {
	...
	public PatchWorkforcemanagementManagementunitWeekScheduleRequest withScheduleId(String scheduleId) {
    ...
    public PatchWorkforcemanagementManagementunitWeekScheduleRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<UpdateWeekScheduleRequest> withHttpInfo() {
        ...
        if (this.managementUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'managementUnitId' when building request for PatchWorkforcemanagementManagementunitWeekScheduleRequest.");
        }
        
        // verify the required parameter 'weekId' is set
        if (this.weekId == null) {
            throw new IllegalStateException("Missing the required parameter 'weekId' when building request for PatchWorkforcemanagementManagementunitWeekScheduleRequest.");
        }
        
        // verify the required parameter 'scheduleId' is set
        if (this.scheduleId == null) {
            throw new IllegalStateException("Missing the required parameter 'scheduleId' when building request for PatchWorkforcemanagementManagementunitWeekScheduleRequest.");
        }
        

        return ApiRequestBuilder.create("PATCH", "/api/v2/workforcemanagement/managementunits/{managementUnitId}/weeks/{weekId}/schedules/{scheduleId}")
	...
	public static class Builder {
		private final PatchWorkforcemanagementManagementunitWeekScheduleRequest request;

		private Builder() {
			request = new PatchWorkforcemanagementManagementunitWeekScheduleRequest();
		}
		...
		public PatchWorkforcemanagementManagementunitWeekScheduleRequest build() {
