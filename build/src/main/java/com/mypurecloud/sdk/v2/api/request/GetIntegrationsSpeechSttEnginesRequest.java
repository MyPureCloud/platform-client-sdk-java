...
public class GetIntegrationsSpeechSttEnginesRequest {
	...
	public GetIntegrationsSpeechSttEnginesRequest withPageNumber(Integer pageNumber) {
	...
	public GetIntegrationsSpeechSttEnginesRequest withPageSize(Integer pageSize) {
	...
	public GetIntegrationsSpeechSttEnginesRequest withName(String name) {
	    this.setName(name);
	    return this;
	} 
    ...
    public GetIntegrationsSpeechSttEnginesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/integrations/speech/stt/engines")
	...
	public static class Builder {
		private final GetIntegrationsSpeechSttEnginesRequest request;

		private Builder() {
			request = new GetIntegrationsSpeechSttEnginesRequest();
		}
		...
		public GetIntegrationsSpeechSttEnginesRequest build() {
