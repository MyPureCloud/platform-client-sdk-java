...
public class GetSocialmediaTopicDataingestionrulesInstagramInstagramIngestionRuleIdVersionsRequest {
	...
	public GetSocialmediaTopicDataingestionrulesInstagramInstagramIngestionRuleIdVersionsRequest withTopicId(String topicId) {
	...
	public GetSocialmediaTopicDataingestionrulesInstagramInstagramIngestionRuleIdVersionsRequest withInstagramIngestionRuleId(String instagramIngestionRuleId) {
	...
	public GetSocialmediaTopicDataingestionrulesInstagramInstagramIngestionRuleIdVersionsRequest withPageNumber(Integer pageNumber) {
	...
	public GetSocialmediaTopicDataingestionrulesInstagramInstagramIngestionRuleIdVersionsRequest withPageSize(Integer pageSize) {
	...
	public GetSocialmediaTopicDataingestionrulesInstagramInstagramIngestionRuleIdVersionsRequest withIncludeDeleted(Boolean includeDeleted) {
    ...
    public GetSocialmediaTopicDataingestionrulesInstagramInstagramIngestionRuleIdVersionsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.topicId == null) {
            throw new IllegalStateException("Missing the required parameter 'topicId' when building request for GetSocialmediaTopicDataingestionrulesInstagramInstagramIngestionRuleIdVersionsRequest.");
        }
        
        // verify the required parameter 'instagramIngestionRuleId' is set
        if (this.instagramIngestionRuleId == null) {
            throw new IllegalStateException("Missing the required parameter 'instagramIngestionRuleId' when building request for GetSocialmediaTopicDataingestionrulesInstagramInstagramIngestionRuleIdVersionsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/socialmedia/topics/{topicId}/dataingestionrules/instagram/{instagramIngestionRuleId}/versions")
	...
	public static class Builder {
		private final GetSocialmediaTopicDataingestionrulesInstagramInstagramIngestionRuleIdVersionsRequest request;

		private Builder() {
			request = new GetSocialmediaTopicDataingestionrulesInstagramInstagramIngestionRuleIdVersionsRequest();
		}
		...
		public GetSocialmediaTopicDataingestionrulesInstagramInstagramIngestionRuleIdVersionsRequest build() {
