...
public class PostAnalyticsKnowledgeAggregatesJobsRequest {

	private KnowledgeAsyncAggregationQuery body;
	public KnowledgeAsyncAggregationQuery getBody() {
		return this.body;
	}

	public void setBody(KnowledgeAsyncAggregationQuery body) {
		this.body = body;
	}

	public PostAnalyticsKnowledgeAggregatesJobsRequest withBody(KnowledgeAsyncAggregationQuery body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostAnalyticsKnowledgeAggregatesJobsRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<KnowledgeAsyncAggregationQuery> withHttpInfo() {
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostAnalyticsKnowledgeAggregatesJobsRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/analytics/knowledge/aggregates/jobs")
                .withBody(body)
	...
	public static Builder builder(KnowledgeAsyncAggregationQuery body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostAnalyticsKnowledgeAggregatesJobsRequest request;

		private Builder() {
			request = new PostAnalyticsKnowledgeAggregatesJobsRequest();
		}


		public Builder withBody(KnowledgeAsyncAggregationQuery body) {
		...
		public Builder withRequiredParams(KnowledgeAsyncAggregationQuery body) {
			request.setBody(body);
		...
		public PostAnalyticsKnowledgeAggregatesJobsRequest build() {
