...
public class AgentCopilotAggregationSort  implements Serializable {
 ...
 @JsonDeserialize(using = FunctionEnumDeserializer.class)
  ...
  public AgentCopilotAggregationSort() {
   ...
   * Name of the metric used for sorting values.
   **/
  public AgentCopilotAggregationSort name(NameEnum name) {
    this.name = name;
    return this;
  }
   ...
   * Aggregation function used for the sort metric.
   **/
  public AgentCopilotAggregationSort function(FunctionEnum function) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    AgentCopilotAggregationSort agentCopilotAggregationSort = (AgentCopilotAggregationSort) o;

    return Objects.equals(this.name, agentCopilotAggregationSort.name) &&
            Objects.equals(this.function, agentCopilotAggregationSort.function);
  }
