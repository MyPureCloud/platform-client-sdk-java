...
public class GetRecordingJobRequest {
	...
	public GetRecordingJobRequest withJobId(String jobId) {
	    this.setJobId(jobId);
	    return this;
	} 
    ...
    public GetRecordingJobRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/recording/jobs/{jobId}")
	...
	public static class Builder {
		...
		private Builder() {
			request = new GetRecordingJobRequest();
		}
