...
public class GetOrganizationsLimitsNamespaceDefaultsRequest {
	...
	public GetOrganizationsLimitsNamespaceDefaultsRequest withNamespaceName(String namespaceName) {
    ...
    public GetOrganizationsLimitsNamespaceDefaultsRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.namespaceName == null) {
            throw new IllegalStateException("Missing the required parameter 'namespaceName' when building request for GetOrganizationsLimitsNamespaceDefaultsRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/organizations/limits/namespaces/{namespaceName}/defaults")
	...
	public static class Builder {
		private final GetOrganizationsLimitsNamespaceDefaultsRequest request;

		private Builder() {
			request = new GetOrganizationsLimitsNamespaceDefaultsRequest();
		}
		...
		public GetOrganizationsLimitsNamespaceDefaultsRequest build() {
