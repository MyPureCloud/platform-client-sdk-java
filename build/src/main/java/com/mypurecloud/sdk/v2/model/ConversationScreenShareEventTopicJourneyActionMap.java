...
public class ConversationScreenShareEventTopicJourneyActionMap  implements Serializable {
  ...
  public ConversationScreenShareEventTopicJourneyActionMap() {
    if (ApiClient.LEGACY_EMPTY_LIST == true) { 
    }
  }

  public ConversationScreenShareEventTopicJourneyActionMap(Boolean initWithEmptyList) {
   ...
   **/
  public ConversationScreenShareEventTopicJourneyActionMap version(Long version) {
