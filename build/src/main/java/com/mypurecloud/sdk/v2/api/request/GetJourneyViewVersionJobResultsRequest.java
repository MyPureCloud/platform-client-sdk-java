...
public class GetJourneyViewVersionJobResultsRequest {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/journey/views/{viewId}/versions/{journeyViewVersion}/jobs/{jobId}/results")
	...
	public static Builder builder(String viewId, String journeyViewVersion, String jobId) {
	    return new Builder()
	            .withRequiredParams(viewId, journeyViewVersion, jobId);
	}


	public static class Builder {
		private final GetJourneyViewVersionJobResultsRequest request;

		private Builder() {
			request = new GetJourneyViewVersionJobResultsRequest();
		}
