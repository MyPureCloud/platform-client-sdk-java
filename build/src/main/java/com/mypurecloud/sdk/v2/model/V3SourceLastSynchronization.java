...
public class V3SourceLastSynchronization  implements Serializable {
 ...
 @JsonDeserialize(using = IngestionStatusEnumDeserializer.class)
   ...
   **/
  public V3SourceLastSynchronization dateStart(Date dateStart) {
   ...
   **/
  public V3SourceLastSynchronization dateEnd(Date dateEnd) {
   ...
   **/
  public V3SourceLastSynchronization dateSourceIntervalStart(Date dateSourceIntervalStart) {
   ...
   **/
  public V3SourceLastSynchronization dateSourceIntervalEnd(Date dateSourceIntervalEnd) {
   ...
   * The trigger type of the synchronization.
   **/
  public V3SourceLastSynchronization triggerType(TriggerTypeEnum triggerType) {
   ...
   * The status of the synchronization.
   **/
  public V3SourceLastSynchronization status(StatusEnum status) {
    this.status = status;
    return this;
  }
   ...
   **/
  public V3SourceLastSynchronization statistics(V3SynchronizationStatistics statistics) {
   ...
   **/
  public V3SourceLastSynchronization error(ErrorBody error) {
    this.error = error;
    return this;
  }
   ...
   * The status of the ingestion.
   **/
  public V3SourceLastSynchronization ingestionStatus(IngestionStatusEnum ingestionStatus) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V3SourceLastSynchronization v3SourceLastSynchronization = (V3SourceLastSynchronization) o;

    return Objects.equals(this.id, v3SourceLastSynchronization.id) &&
            Objects.equals(this.dateStart, v3SourceLastSynchronization.dateStart) &&
            Objects.equals(this.dateEnd, v3SourceLastSynchronization.dateEnd) &&
            Objects.equals(this.dateSourceIntervalStart, v3SourceLastSynchronization.dateSourceIntervalStart) &&
            Objects.equals(this.dateSourceIntervalEnd, v3SourceLastSynchronization.dateSourceIntervalEnd) &&
            Objects.equals(this.triggerType, v3SourceLastSynchronization.triggerType) &&
            Objects.equals(this.status, v3SourceLastSynchronization.status) &&
            Objects.equals(this.statistics, v3SourceLastSynchronization.statistics) &&
            Objects.equals(this.error, v3SourceLastSynchronization.error) &&
            Objects.equals(this.ingestionStatus, v3SourceLastSynchronization.ingestionStatus) &&
            Objects.equals(this.selfUri, v3SourceLastSynchronization.selfUri);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, dateStart, dateEnd, dateSourceIntervalStart, dateSourceIntervalEnd, triggerType, status, statistics, error, ingestionStatus, selfUri);
  }
