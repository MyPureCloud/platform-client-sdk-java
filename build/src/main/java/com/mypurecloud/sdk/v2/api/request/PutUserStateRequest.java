...
public class PutUserStateRequest {
	...
	public PutUserStateRequest withUserId(String userId) {
	    this.setUserId(userId);
	    return this;
	} 
	
	private UserState body;
	public UserState getBody() {
		return this.body;
	}

	public void setBody(UserState body) {
		this.body = body;
	}

	public PutUserStateRequest withBody(UserState body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutUserStateRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<UserState> withHttpInfo() {
        
        // verify the required parameter 'userId' is set
        if (this.userId == null) {
            throw new IllegalStateException("Missing the required parameter 'userId' when building request for PutUserStateRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutUserStateRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/users/{userId}/state")
	...
	public static Builder builder(String userId, UserState body) {
	    return new Builder()
	...
	public static class Builder {
		private final PutUserStateRequest request;

		private Builder() {
			request = new PutUserStateRequest();
		}
		...
		public Builder withBody(UserState body) {
		...
		public Builder withRequiredParams(String userId, UserState body) {
			request.setUserId(userId);
						request.setBody(body);
		...
		public PutUserStateRequest build() {
