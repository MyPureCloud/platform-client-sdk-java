...
public class GetTelephonyProvidersEdgesOutboundrouteRequest {
	...
	public GetTelephonyProvidersEdgesOutboundrouteRequest withOutboundRouteId(String outboundRouteId) {
    ...
    public GetTelephonyProvidersEdgesOutboundrouteRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.outboundRouteId == null) {
            throw new IllegalStateException("Missing the required parameter 'outboundRouteId' when building request for GetTelephonyProvidersEdgesOutboundrouteRequest.");
        }
        

        return ApiRequestBuilder.create("GET", "/api/v2/telephony/providers/edges/outboundroutes/{outboundRouteId}")
	...
	public static class Builder {
		private final GetTelephonyProvidersEdgesOutboundrouteRequest request;

		private Builder() {
			request = new GetTelephonyProvidersEdgesOutboundrouteRequest();
		}
		...
		public GetTelephonyProvidersEdgesOutboundrouteRequest build() {
