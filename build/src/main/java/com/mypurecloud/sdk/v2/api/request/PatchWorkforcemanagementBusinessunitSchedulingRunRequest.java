...
public class PatchWorkforcemanagementBusinessunitSchedulingRunRequest {
	...
	public PatchWorkforcemanagementBusinessunitSchedulingRunRequest withBusinessUnitId(String businessUnitId) {
	...
	public PatchWorkforcemanagementBusinessunitSchedulingRunRequest withRunId(String runId) {
	    this.setRunId(runId);
	    return this;
	} 
	
	private PatchBuScheduleRunRequest body;
	public PatchBuScheduleRunRequest getBody() {
		return this.body;
	}

	public void setBody(PatchBuScheduleRunRequest body) {
		this.body = body;
	}

	public PatchWorkforcemanagementBusinessunitSchedulingRunRequest withBody(PatchBuScheduleRunRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PatchWorkforcemanagementBusinessunitSchedulingRunRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<PatchBuScheduleRunRequest> withHttpInfo() {
        
        // verify the required parameter 'businessUnitId' is set
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PatchWorkforcemanagementBusinessunitSchedulingRunRequest.");
        }
	...
	public static class Builder {
		private final PatchWorkforcemanagementBusinessunitSchedulingRunRequest request;

		private Builder() {
			request = new PatchWorkforcemanagementBusinessunitSchedulingRunRequest();
		}
		...
		public Builder withBody(PatchBuScheduleRunRequest body) {
		...
		public PatchWorkforcemanagementBusinessunitSchedulingRunRequest build() {
