...
public class GetWorkforcemanagementShifttradesRequest {
    ...
    public GetWorkforcemanagementShifttradesRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/workforcemanagement/shifttrades")
	...
	public static class Builder {
		private final GetWorkforcemanagementShifttradesRequest request;

		private Builder() {
			request = new GetWorkforcemanagementShifttradesRequest();
		}
		...
		public GetWorkforcemanagementShifttradesRequest build() {
