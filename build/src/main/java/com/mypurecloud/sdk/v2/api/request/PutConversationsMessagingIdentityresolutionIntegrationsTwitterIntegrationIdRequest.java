...
public class PutConversationsMessagingIdentityresolutionIntegrationsTwitterIntegrationIdRequest {
	...
	public PutConversationsMessagingIdentityresolutionIntegrationsTwitterIntegrationIdRequest withIntegrationId(String integrationId) {
	    this.setIntegrationId(integrationId);
	    return this;
	} 

	private TwitterIdentityResolutionConfig body;
	public TwitterIdentityResolutionConfig getBody() {
		return this.body;
	}

	public void setBody(TwitterIdentityResolutionConfig body) {
		this.body = body;
	}

	public PutConversationsMessagingIdentityresolutionIntegrationsTwitterIntegrationIdRequest withBody(TwitterIdentityResolutionConfig body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutConversationsMessagingIdentityresolutionIntegrationsTwitterIntegrationIdRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<TwitterIdentityResolutionConfig> withHttpInfo() {
        
        // verify the required parameter 'integrationId' is set
        if (this.integrationId == null) {
            throw new IllegalStateException("Missing the required parameter 'integrationId' when building request for PutConversationsMessagingIdentityresolutionIntegrationsTwitterIntegrationIdRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutConversationsMessagingIdentityresolutionIntegrationsTwitterIntegrationIdRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/conversations/messaging/identityresolution/integrations/twitter/{integrationId}")
	...
	public static Builder builder(String integrationId, TwitterIdentityResolutionConfig body) {
	    return new Builder()
	...
	public static class Builder {
		private final PutConversationsMessagingIdentityresolutionIntegrationsTwitterIntegrationIdRequest request;

		private Builder() {
			request = new PutConversationsMessagingIdentityresolutionIntegrationsTwitterIntegrationIdRequest();
		}
		...
		public Builder withBody(TwitterIdentityResolutionConfig body) {
		...
		public Builder withRequiredParams(String integrationId, TwitterIdentityResolutionConfig body) {
			request.setIntegrationId(integrationId);
			request.setBody(body);
		...
		public PutConversationsMessagingIdentityresolutionIntegrationsTwitterIntegrationIdRequest build() {
