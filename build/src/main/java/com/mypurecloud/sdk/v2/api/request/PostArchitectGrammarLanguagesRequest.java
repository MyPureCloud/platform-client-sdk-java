...
public class PostArchitectGrammarLanguagesRequest {
    ...
    public ApiRequest<GrammarLanguage> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("POST", "/api/v2/architect/grammars/{grammarId}/languages")
	...
	public static Builder builder(String grammarId, GrammarLanguage body) {
	    return new Builder()
	            .withRequiredParams(grammarId, body);
	}


	public static class Builder {
		private final PostArchitectGrammarLanguagesRequest request;

		private Builder() {
			request = new PostArchitectGrammarLanguagesRequest();
		}
