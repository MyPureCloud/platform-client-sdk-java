...
public class GetConfigurationSchemasEdgesVnextRequest {
	...
	public GetConfigurationSchemasEdgesVnextRequest withPageSize(Integer pageSize) {
	...
	public GetConfigurationSchemasEdgesVnextRequest withPageNumber(Integer pageNumber) {
    ...
    public GetConfigurationSchemasEdgesVnextRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        return ApiRequestBuilder.create("GET", "/api/v2/configuration/schemas/edges/vnext")
	...
	public static class Builder {
		private final GetConfigurationSchemasEdgesVnextRequest request;

		private Builder() {
			request = new GetConfigurationSchemasEdgesVnextRequest();
		}
		...
		public GetConfigurationSchemasEdgesVnextRequest build() {
