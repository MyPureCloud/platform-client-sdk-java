...
public class PutOutboundContactlisttemplateRequest {

	private String contactListTemplateId;
	public String getContactListTemplateId() {
		return this.contactListTemplateId;
	}

	public void setContactListTemplateId(String contactListTemplateId) {
		this.contactListTemplateId = contactListTemplateId;
	}

	public PutOutboundContactlisttemplateRequest withContactListTemplateId(String contactListTemplateId) {
	    this.setContactListTemplateId(contactListTemplateId);
	    return this;
	} 
	...
	public PutOutboundContactlisttemplateRequest withBody(ContactListTemplate body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PutOutboundContactlisttemplateRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<ContactListTemplate> withHttpInfo() {
        ...
        if (this.contactListTemplateId == null) {
            throw new IllegalStateException("Missing the required parameter 'contactListTemplateId' when building request for PutOutboundContactlisttemplateRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PutOutboundContactlisttemplateRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/outbound/contactlisttemplates/{contactListTemplateId}")
                .withPathParameter("contactListTemplateId", contactListTemplateId)
	...
	public static Builder builder(String contactListTemplateId, ContactListTemplate body) {
	    return new Builder()
	            .withRequiredParams(contactListTemplateId, body);
	}


	public static class Builder {
		private final PutOutboundContactlisttemplateRequest request;

		private Builder() {
			request = new PutOutboundContactlisttemplateRequest();
		}


		public Builder withContactListTemplateId(String contactListTemplateId) {
			request.setContactListTemplateId(contactListTemplateId);
			return this;
		}
		...
		public Builder withRequiredParams(String contactListTemplateId, ContactListTemplate body) {
			request.setContactListTemplateId(contactListTemplateId);
			request.setBody(body);
		...
		public PutOutboundContactlisttemplateRequest build() {
            
            // verify the required parameter 'contactListTemplateId' is set
            if (request.contactListTemplateId == null) {
                throw new IllegalStateException("Missing the required parameter 'contactListTemplateId' when building request for PutOutboundContactlisttemplateRequest.");
            }
