...
public class OutboundDomainCreateRequest  implements Serializable {
 ...
 @JsonDeserialize(using = SenderTypeEnumDeserializer.class)
  ...
  public OutboundDomainCreateRequest() {
   ...
   **/
  public OutboundDomainCreateRequest id(String id) {
    this.id = id;
    return this;
  }
   ...
   * Sender Type
   **/
  public OutboundDomainCreateRequest senderType(SenderTypeEnum senderType) {
   ...
   **/
  public OutboundDomainCreateRequest emailSetting(EmailSettingReference emailSetting) {
   ...
   **/
  public OutboundDomainCreateRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    OutboundDomainCreateRequest outboundDomainCreateRequest = (OutboundDomainCreateRequest) o;

    return Objects.equals(this.id, outboundDomainCreateRequest.id) &&
            Objects.equals(this.senderType, outboundDomainCreateRequest.senderType) &&
            Objects.equals(this.emailSetting, outboundDomainCreateRequest.emailSetting) &&
            Objects.equals(this.name, outboundDomainCreateRequest.name);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, senderType, emailSetting, name);
  }
