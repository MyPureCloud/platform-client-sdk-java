...
public class PutOrgauthorizationTrustorCloneduserRequest {
	...
	public PutOrgauthorizationTrustorCloneduserRequest withTrustorOrgId(String trustorOrgId) {
	...
	public PutOrgauthorizationTrustorCloneduserRequest withTrusteeUserId(String trusteeUserId) {
    ...
    public PutOrgauthorizationTrustorCloneduserRequest withCustomHeader(String name, String value) {
    ...
    public ApiRequest<Void> withHttpInfo() {
        ...
        if (this.trustorOrgId == null) {
            throw new IllegalStateException("Missing the required parameter 'trustorOrgId' when building request for PutOrgauthorizationTrustorCloneduserRequest.");
        }
        
        // verify the required parameter 'trusteeUserId' is set
        if (this.trusteeUserId == null) {
            throw new IllegalStateException("Missing the required parameter 'trusteeUserId' when building request for PutOrgauthorizationTrustorCloneduserRequest.");
        }
        

        return ApiRequestBuilder.create("PUT", "/api/v2/orgauthorization/trustors/{trustorOrgId}/clonedusers/{trusteeUserId}")
	...
	public static class Builder {
		private final PutOrgauthorizationTrustorCloneduserRequest request;

		private Builder() {
			request = new PutOrgauthorizationTrustorCloneduserRequest();
		}
		...
		public PutOrgauthorizationTrustorCloneduserRequest build() {
