...
public class PostWorkforcemanagementBusinessunitCapacityplansBulkRemoveRequest {
	...
	public PostWorkforcemanagementBusinessunitCapacityplansBulkRemoveRequest withBusinessUnitId(String businessUnitId) {
	    this.setBusinessUnitId(businessUnitId);
	    return this;
	} 

	private CapacityPlanDeleteRequest body;
	public CapacityPlanDeleteRequest getBody() {
		return this.body;
	}

	public void setBody(CapacityPlanDeleteRequest body) {
		this.body = body;
	}

	public PostWorkforcemanagementBusinessunitCapacityplansBulkRemoveRequest withBody(CapacityPlanDeleteRequest body) {
	    this.setBody(body);
	    return this;
	} 
    ...
    public PostWorkforcemanagementBusinessunitCapacityplansBulkRemoveRequest withCustomHeader(String name, String value) {
        this.addCustomHeader(name, value);
        return this;
    }

    public ApiRequest<CapacityPlanDeleteRequest> withHttpInfo() {
        
        // verify the required parameter 'businessUnitId' is set
        if (this.businessUnitId == null) {
            throw new IllegalStateException("Missing the required parameter 'businessUnitId' when building request for PostWorkforcemanagementBusinessunitCapacityplansBulkRemoveRequest.");
        }
        
        // verify the required parameter 'body' is set
        if (this.body == null) {
            throw new IllegalStateException("Missing the required parameter 'body' when building request for PostWorkforcemanagementBusinessunitCapacityplansBulkRemoveRequest.");
        }
        

        return ApiRequestBuilder.create("POST", "/api/v2/workforcemanagement/businessunits/{businessUnitId}/capacityplans/bulk/remove")
	...
	public static Builder builder(String businessUnitId, CapacityPlanDeleteRequest body) {
	    return new Builder()
	...
	public static class Builder {
		private final PostWorkforcemanagementBusinessunitCapacityplansBulkRemoveRequest request;

		private Builder() {
			request = new PostWorkforcemanagementBusinessunitCapacityplansBulkRemoveRequest();
		}
		...
		public Builder withBody(CapacityPlanDeleteRequest body) {
		...
		public Builder withRequiredParams(String businessUnitId, CapacityPlanDeleteRequest body) {
			request.setBusinessUnitId(businessUnitId);
			request.setBody(body);
		...
		public PostWorkforcemanagementBusinessunitCapacityplansBulkRemoveRequest build() {
