...
| **clearExport** | <!----><!---->**Boolean**<!----> | For DELETE action, setting this to true will clear any pending exports for recordings. This field is not used for EXPORT action. Default value = false |  [optional] |
