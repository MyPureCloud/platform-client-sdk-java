---
title: OpenInboundMessagingReceiptChannel
---
...
| ------------ | ------------- | ------------- | ------------- |
| **to** | <!----><!---->[**OpenMessagingToRecipient**](OpenMessagingToRecipient.html)<!----> | Information about the recipient the message is intended for. |  |
