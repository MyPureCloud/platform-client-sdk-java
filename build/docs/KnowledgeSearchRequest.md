...
| **pageSize** | <!----><!---->**Integer**<!----> | Page size of the returned results |  |
| **pageNumber** | <!----><!---->**Integer**<!----> | Page number of the returned results |  |
| **documentType** | [**DocumentTypeEnum**](#DocumentTypeEnum)<!----> | Document type to be used while searching |  |
