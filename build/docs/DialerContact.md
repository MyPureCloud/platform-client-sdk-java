...
| **contactColumnTimeZones** | [**Map&lt;String, ContactColumnTimeZone&gt;**](ContactColumnTimeZone) | Map containing data about the timezone the contact is mapped to. This will only be populated if the contact list has automatic timezone mapping turned on. The key is the column name. The value is the timezone it mapped to and the type of column: Phone or Zip |  [optional] |
