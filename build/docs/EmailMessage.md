...
| **state** | [**StateEnum**](#StateEnum)<!----> | The state of the current draft. |  [optional] |
| **draftType** | [**DraftTypeEnum**](#DraftTypeEnum)<!----> | The type of draft that need to be treated. |  [optional] |
