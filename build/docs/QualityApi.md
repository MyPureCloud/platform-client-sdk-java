...
> [EvaluationFormDivisionViewListing](EvaluationFormDivisionViewListing) getQualityPublishedformsEvaluationsDivisionviews(pageSize, pageNumber, name)
...
> [SurveyFormDivisionViewListing](SurveyFormDivisionViewListing) getQualityPublishedformsSurveysDivisionviews(pageSize, pageNumber, name)
