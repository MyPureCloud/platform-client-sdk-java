...
| **supportedGranularities** | [**List<SupportedGranularitiesEnum>**](#Enum--SupportedGranularitiesEnum) | Granularity of time off limits supported to query availability information. Default is 'Daily' |  [optional] |


## Enum: SupportedGranularitiesEnum
