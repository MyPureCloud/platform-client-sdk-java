...
try {
    ...
    System.err.println("Exception when calling WorkforceManagementApi#getWorkforcemanagementAdherenceHistoricalBulkJob");
    e.printStackTrace();
}
```
...
try {
    ...
    System.err.println("Exception when calling WorkforceManagementApi#getWorkforcemanagementAdherenceHistoricalJob");
    e.printStackTrace();
}
```
...
> [ContinuousForecastGetSessionResponse](ContinuousForecastGetSessionResponse) getWorkforcemanagementBusinessunitMainforecastContinuousforecastSession(businessUnitId)
...
try {
    ...
    System.err.println("Exception when calling WorkforceManagementApi#getWorkforcemanagementBusinessunitMainforecastContinuousforecastSession");
    e.printStackTrace();
}
```
...
try {
    ...
    System.err.println("Exception when calling WorkforceManagementApi#getWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionExportForecastJob");
    e.printStackTrace();
}
```
...
try {
    ...
    System.err.println("Exception when calling WorkforceManagementApi#getWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionExportHistoricalJob");
    e.printStackTrace();
}
```
...
try {
    ...
    System.err.println("Exception when calling WorkforceManagementApi#getWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionExportSnapshotJob");
    e.printStackTrace();
}
```
...
> [ContinuousForecastSessionResponse](ContinuousForecastSessionResponse) getWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionSessionId(businessUnitId, sessionId)
...
try {
    ...
    System.err.println("Exception when calling WorkforceManagementApi#getWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionSessionId");
    e.printStackTrace();
}
```
...
> [ContinuousForecastSnapshotResponse](ContinuousForecastSnapshotResponse) getWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionSessionIdSnapshotSnapshotId(businessUnitId, sessionId, snapshotId)
...
try {
    ...
    System.err.println("Exception when calling WorkforceManagementApi#getWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionSessionIdSnapshotSnapshotId");
    e.printStackTrace();
}
```
...
WorkforceManagementApi apiInstance = new WorkforceManagementApi();
String businessUnitId = "businessUnitId_example"; // String | The ID of the business unit, or 'mine' for the business unit of the logged-in user.
String feature = "feature_example"; // String | If specified, the list of management units for which the user is authorized to use the requested feature will be returned
String divisionId = "divisionId_example"; // String | If specified, the list of management units belonging to the specified division will be returned
try {
...
String managementUnitId = "managementUnitId_example"; // String | The ID of the management unit to get management unit specific staffing groups
Boolean forceDownloadService = true; // Boolean | Force the result of this operation to be sent via download service. For testing/app development purposes
List<String> expand = Arrays.asList(null); // List<String> | Include to access additional data for the time-off plans
try {
...
LocalDate earliestWeekDate = new LocalDate(); // LocalDate | If weekId == 'recent', specify the earliest schedule start week date (inclusive) to include in the 'recent' range, in yyyy-MM-dd format. Ignored if weekId != 'recent'. Dates are represented as an ISO-8601 string. For example: yyyy-MM-dd
LocalDate latestWeekDate = new LocalDate(); // LocalDate | If weekId == 'recent', specify the latest schedule start week date (inclusive) to include in the 'recent' range, in yyyy-MM-dd format. Ignored if weekId != 'recent'. Dates are represented as an ISO-8601 string. For example: yyyy-MM-dd
...
| **earliestWeekDate** | **LocalDate**| If weekId &#x3D;&#x3D; &#39;recent&#39;, specify the earliest schedule start week date (inclusive) to include in the &#39;recent&#39; range, in yyyy-MM-dd format. Ignored if weekId !&#x3D; &#39;recent&#39;. Dates are represented as an ISO-8601 string. For example: yyyy-MM-dd | [optional] 
| **latestWeekDate** | **LocalDate**| If weekId &#x3D;&#x3D; &#39;recent&#39;, specify the latest schedule start week date (inclusive) to include in the &#39;recent&#39; range, in yyyy-MM-dd format. Ignored if weekId !&#x3D; &#39;recent&#39;. Dates are represented as an ISO-8601 string. For example: yyyy-MM-dd | [optional] 
...
WorkforceManagementApi apiInstance = new WorkforceManagementApi();
String feature = "feature_example"; // String | If specified, the list of business units for which the user is authorized to use the requested feature will be returned
String divisionId = "divisionId_example"; // String | If specified, the list of business units belonging to the specified division will be returned
try {
...
WorkforceManagementApi apiInstance = new WorkforceManagementApi();
String jobId = "jobId_example"; // String | The job ID of the historical data delete request
try {
    HistoricalImportDeleteFilesJobResponse result = apiInstance.getWorkforcemanagementHistoricaldataBulkRemoveJob(jobId);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling WorkforceManagementApi#getWorkforcemanagementHistoricaldataBulkRemoveJob");
    e.printStackTrace();
}
```
...
try {
    ...
    System.err.println("Exception when calling WorkforceManagementApi#getWorkforcemanagementHistoricaldataBulkRemoveJobs");
    e.printStackTrace();
}
```
...
WorkforceManagementApi apiInstance = new WorkforceManagementApi();
WfmHistoricalAdherenceBulkQuery body = new WfmHistoricalAdherenceBulkQuery(); // WfmHistoricalAdherenceBulkQuery | body
try {
    WfmHistoricalAdherenceBulkResponse result = apiInstance.postWorkforcemanagementAdherenceHistoricalBulk(body);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling WorkforceManagementApi#postWorkforcemanagementAdherenceHistoricalBulk");
    e.printStackTrace();
}
```
...
WorkforceManagementApi apiInstance = new WorkforceManagementApi();
AgentPossibleWorkShiftsRequest body = new AgentPossibleWorkShiftsRequest(); // AgentPossibleWorkShiftsRequest | body
try {
    AgentPossibleWorkShiftsResponse result = apiInstance.postWorkforcemanagementAgentsMePossibleworkshifts(body);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling WorkforceManagementApi#postWorkforcemanagementAgentsMePossibleworkshifts");
    e.printStackTrace();
}
```
...
WorkforceManagementApi apiInstance = new WorkforceManagementApi();
String businessUnitId = "businessUnitId_example"; // String | The ID of the business unit
AggregatedExportJobRequest body = new AggregatedExportJobRequest(); // AggregatedExportJobRequest | The request body
try {
    ...
    System.err.println("Exception when calling WorkforceManagementApi#postWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionExportForecastJobs");
    e.printStackTrace();
}
```
...
try {
    ...
    System.err.println("Exception when calling WorkforceManagementApi#postWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionExportHistoricalJobs");
    e.printStackTrace();
}
```
...
WorkforceManagementApi apiInstance = new WorkforceManagementApi();
String businessUnitId = "businessUnitId_example"; // String | The ID of the business unit
AggregatedExportSnapshotJobRequest body = new AggregatedExportSnapshotJobRequest(); // AggregatedExportSnapshotJobRequest | The request body
try {
    ...
    System.err.println("Exception when calling WorkforceManagementApi#postWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionExportSnapshotJobs");
    e.printStackTrace();
}
```
...
WorkforceManagementApi apiInstance = new WorkforceManagementApi();
HistoricalImportDeleteFilesJobRequest body = new HistoricalImportDeleteFilesJobRequest(); // HistoricalImportDeleteFilesJobRequest | body
try {
    HistoricalImportDeleteFilesJobResponse result = apiInstance.postWorkforcemanagementHistoricaldataBulkRemoveJobs(body);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling WorkforceManagementApi#postWorkforcemanagementHistoricaldataBulkRemoveJobs");
    e.printStackTrace();
}
```
...
String includeOnly = "includeOnly_example"; // String | Limit response to the specified field
try {
