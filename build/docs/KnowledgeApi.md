...
KnowledgeApi apiInstance = new KnowledgeApi();
String knowledgeBaseId = "knowledgeBaseId_example"; // String | Knowledge base ID.
String contextId = "contextId_example"; // String | Context ID.
KnowledgeContextRequest body = new KnowledgeContextRequest(); // KnowledgeContextRequest | 
try {
    KnowledgeContextResponse result = apiInstance.patchKnowledgeKnowledgebaseContext(knowledgeBaseId, contextId, body);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling KnowledgeApi#patchKnowledgeKnowledgebaseContext");
    e.printStackTrace();
}
```
...
String knowledgeBaseId = "knowledgeBaseId_example"; // String | Knowledge base ID.
String contextId = "contextId_example"; // String | Context ID.
String contextValueId = "contextValueId_example"; // String | Context Value ID.
KnowledgeContextValueRequest body = new KnowledgeContextValueRequest(); // KnowledgeContextValueRequest | 
try {
    ...
    System.err.println("Exception when calling KnowledgeApi#patchKnowledgeKnowledgebaseContextValue");
    e.printStackTrace();
}
```
