...
| **unassignedDivisionContactsEnabled** | **Boolean** | When set to true, will allow Workitems to be associated with External Contacts that are not assigned to any division. Default value is true. |  [optional] |
