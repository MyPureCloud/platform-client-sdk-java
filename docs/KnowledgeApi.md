...
try {
    ...
    System.err.println("Exception when calling KnowledgeApi#deleteKnowledgeKnowledgebaseCategory");
    e.printStackTrace();
}
```
...
try {
    ...
    System.err.println("Exception when calling KnowledgeApi#deleteKnowledgeKnowledgebaseDocument");
    e.printStackTrace();
}
```
...
try {
    ...
    System.err.println("Exception when calling KnowledgeApi#deleteKnowledgeKnowledgebaseDocumentVariation");
    e.printStackTrace();
}
```
...
try {
    ...
    System.err.println("Exception when calling KnowledgeApi#deleteKnowledgeKnowledgebaseExportJob");
    e.printStackTrace();
}
```
...
try {
    ...
    System.err.println("Exception when calling KnowledgeApi#deleteKnowledgeKnowledgebaseImportJob");
    e.printStackTrace();
}
```
...
try {
    ...
    System.err.println("Exception when calling KnowledgeApi#deleteKnowledgeKnowledgebaseLabel");
    e.printStackTrace();
}
```
...
String parentId = "parentId_example"; // String | If specified, retrieves the children categories by parent category ID.
Boolean isRoot = true; // Boolean | If specified, retrieves only the root categories.
String name = "name_example"; // String | Filter to return the categories that starts with the given category name.
String sortBy = "Name"; // String | Name: sort by category names alphabetically; Hierarchy: sort by the full path of hierarchical category names alphabetically
String expand = "expand_example"; // String | The specified entity attribute will be filled. Supported value:\"Ancestors\": every ancestors will be filled via the parent attribute recursively,but only the id, name, parentId will be present for the ancestors.
Boolean includeDocumentCount = true; // Boolean | If specified, retrieves the number of documents related to category.
try {
    ...
    System.err.println("Exception when calling KnowledgeApi#getKnowledgeGuestSessionCategories");
    e.printStackTrace();
}
```
...
try {
    ...
    System.err.println("Exception when calling KnowledgeApi#getKnowledgeKnowledgebaseCategories");
    e.printStackTrace();
}
```
...
try {
    ...
    System.err.println("Exception when calling KnowledgeApi#getKnowledgeKnowledgebaseCategory");
    e.printStackTrace();
}
```
...
String knowledgeBaseId = "knowledgeBaseId_example"; // String | Knowledge base ID.
String documentId = "documentId_example"; // String | Document ID.
List<String> expand = Arrays.asList(null); // List<String> | The specified entity attributes will be filled. Comma separated values expected. Max No. of variations that can be returned on expand is 20.
String state = "state_example"; // String | \"when state is \"Draft\", draft version of the document is returned,otherwise by default published version is returned in the response.
try {
    KnowledgeDocumentResponse result = apiInstance.getKnowledgeKnowledgebaseDocument(knowledgeBaseId, documentId, expand, state);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling KnowledgeApi#getKnowledgeKnowledgebaseDocument");
    e.printStackTrace();
}
```
...
try {
    ...
    System.err.println("Exception when calling KnowledgeApi#getKnowledgeKnowledgebaseDocumentFeedback");
    e.printStackTrace();
}
```
...
try {
    ...
    System.err.println("Exception when calling KnowledgeApi#getKnowledgeKnowledgebaseDocumentFeedbackFeedbackId");
    e.printStackTrace();
}
```
...
String knowledgeBaseId = "knowledgeBaseId_example"; // String | Globally unique identifier for the knowledge base.
String documentId = "documentId_example"; // String | Globally unique identifier for the document.
String versionId = "versionId_example"; // String | Globally unique identifier for the document version.
List<String> expand = Arrays.asList(null); // List<String> | The specified entity attributes will be filled. Comma separated values expected.
try {
    ...
    System.err.println("Exception when calling KnowledgeApi#getKnowledgeKnowledgebaseDocumentVersion");
    e.printStackTrace();
}
```
...
String documentId = "documentId_example"; // String | Globally unique identifier for the document.
String versionId = "versionId_example"; // String | Globally unique identifier for the document version.
String variationId = "variationId_example"; // String | Globally unique identifier for the document version variation.
try {
    ...
    System.err.println("Exception when calling KnowledgeApi#getKnowledgeKnowledgebaseDocumentVersionVariation");
    e.printStackTrace();
}
```
...
try {
    ...
    System.err.println("Exception when calling KnowledgeApi#getKnowledgeKnowledgebaseDocumentVersionVariations");
    e.printStackTrace();
}
```
...
try {
    ...
    System.err.println("Exception when calling KnowledgeApi#getKnowledgeKnowledgebaseDocumentVersions");
    e.printStackTrace();
}
```
...
try {
    ...
    System.err.println("Exception when calling KnowledgeApi#getKnowledgeKnowledgebaseExportJob");
    e.printStackTrace();
}
```
...
try {
    ...
    System.err.println("Exception when calling KnowledgeApi#getKnowledgeKnowledgebaseLabel");
    e.printStackTrace();
}
```
...
String after = "after_example"; // String | The cursor that points to the end of the set of entities that has been returned.
String pageSize = "pageSize_example"; // String | Number of entities to return. Maximum of 200.
String name = "name_example"; // String | Filter to return the labels that contains the given phrase in the name.
Boolean includeDocumentCount = true; // Boolean | If specified, retrieves the number of documents related to label.
try {
    ...
    System.err.println("Exception when calling KnowledgeApi#getKnowledgeKnowledgebaseLabels");
    e.printStackTrace();
}
```
...
String before = "before_example"; // String | The cursor that points to the start of the set of entities that has been returned.
String after = "after_example"; // String | The cursor that points to the end of the set of entities that has been returned.
String limit = "limit_example"; // String | Number of entities to return. Maximum of 100. Deprecated in favour of pageSize
...
KnowledgeApi apiInstance = new KnowledgeApi();
String sessionId = "sessionId_example"; // String | Knowledge guest session ID.
String searchId = "searchId_example"; // String | Search Result ID
SearchUpdateRequest body = new SearchUpdateRequest(); // SearchUpdateRequest | 
try {
    apiInstance.patchKnowledgeGuestSessionDocumentsSearchSearchId(sessionId, searchId, body);
} catch (ApiException e) {
    System.err.println("Exception when calling KnowledgeApi#patchKnowledgeGuestSessionDocumentsSearchSearchId");
    e.printStackTrace();
}
```
...
try {
    ...
    System.err.println("Exception when calling KnowledgeApi#patchKnowledgeKnowledgebaseCategory");
    e.printStackTrace();
}
```
...
try {
    ...
    System.err.println("Exception when calling KnowledgeApi#patchKnowledgeKnowledgebaseDocument");
    e.printStackTrace();
}
```
...
KnowledgeApi apiInstance = new KnowledgeApi();
String knowledgeBaseId = "knowledgeBaseId_example"; // String | The ID of knowledge base containing the documents to query.
String searchId = "searchId_example"; // String | Search Result ID
SearchUpdateRequest body = new SearchUpdateRequest(); // SearchUpdateRequest | 
try {
    apiInstance.patchKnowledgeKnowledgebaseDocumentsSearchSearchId(knowledgeBaseId, searchId, body);
} catch (ApiException e) {
    System.err.println("Exception when calling KnowledgeApi#patchKnowledgeKnowledgebaseDocumentsSearchSearchId");
    e.printStackTrace();
}
```
...
try {
    ...
    System.err.println("Exception when calling KnowledgeApi#patchKnowledgeKnowledgebaseImportJob");
    e.printStackTrace();
}
```
...
String knowledgeBaseId = "knowledgeBaseId_example"; // String | Knowledge base ID
String labelId = "labelId_example"; // String | Label ID
LabelUpdateRequest body = new LabelUpdateRequest(); // LabelUpdateRequest | 
try {
    LabelResponse result = apiInstance.patchKnowledgeKnowledgebaseLabel(knowledgeBaseId, labelId, body);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling KnowledgeApi#patchKnowledgeKnowledgebaseLabel");
    e.printStackTrace();
}
```
...
String phraseGroupId = "phraseGroupId_example"; // String | The ID of the phraseGroup to be updated.
UnansweredPhraseGroupPatchRequestBody body = new UnansweredPhraseGroupPatchRequestBody(); // UnansweredPhraseGroupPatchRequestBody | Request body of the update unanswered group endpoint.
try {
    ...
    System.err.println("Exception when calling KnowledgeApi#patchKnowledgeKnowledgebaseUnansweredGroupPhrasegroup");
    e.printStackTrace();
}
```
...
String sessionId = "sessionId_example"; // String | Knowledge guest session ID.
String documentId = "documentId_example"; // String | Document ID.
KnowledgeGuestDocumentFeedback body = new KnowledgeGuestDocumentFeedback(); // KnowledgeGuestDocumentFeedback | 
try {
    KnowledgeGuestDocumentFeedback result = apiInstance.postKnowledgeGuestSessionDocumentFeedback(sessionId, documentId, body);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling KnowledgeApi#postKnowledgeGuestSessionDocumentFeedback");
    e.printStackTrace();
}
```
...
KnowledgeDocumentGuestSearchRequest body = new KnowledgeDocumentGuestSearchRequest(); // KnowledgeDocumentGuestSearchRequest | 
try {
    KnowledgeDocumentGuestSearch result = apiInstance.postKnowledgeGuestSessionDocumentsSearch(sessionId, expand, body);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling KnowledgeApi#postKnowledgeGuestSessionDocumentsSearch");
    e.printStackTrace();
}
```
...
try {
    ...
    System.err.println("Exception when calling KnowledgeApi#postKnowledgeGuestSessionDocumentsSearchSuggestions");
    e.printStackTrace();
}
```
...
KnowledgeApi apiInstance = new KnowledgeApi();
KnowledgeGuestSession body = new KnowledgeGuestSession(); // KnowledgeGuestSession | 
try {
    KnowledgeGuestSession result = apiInstance.postKnowledgeGuestSessions(body);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling KnowledgeApi#postKnowledgeGuestSessions");
    e.printStackTrace();
}
```
...
try {
    ...
    System.err.println("Exception when calling KnowledgeApi#postKnowledgeKnowledgebaseCategories");
    e.printStackTrace();
}
```
...
KnowledgeApi apiInstance = new KnowledgeApi();
String knowledgeBaseId = "knowledgeBaseId_example"; // String | Knowledge Base ID
KnowledgeDocumentChunkRequest body = new KnowledgeDocumentChunkRequest(); // KnowledgeDocumentChunkRequest | 
try {
    KnowledgeDocumentChunkResponse result = apiInstance.postKnowledgeKnowledgebaseChunksSearch(knowledgeBaseId, body);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling KnowledgeApi#postKnowledgeKnowledgebaseChunksSearch");
    e.printStackTrace();
}
```
...
String knowledgeBaseId = "knowledgeBaseId_example"; // String | Knowledge base ID.
String documentId = "documentId_example"; // String | Document ID.
KnowledgeDocumentFeedback body = new KnowledgeDocumentFeedback(); // KnowledgeDocumentFeedback | 
try {
    ...
    System.err.println("Exception when calling KnowledgeApi#postKnowledgeKnowledgebaseDocumentFeedback");
    e.printStackTrace();
}
```
...
String knowledgeBaseId = "knowledgeBaseId_example"; // String | Globally unique identifier for the knowledge base.
String documentId = "documentId_example"; // String | Globally unique identifier for the document.
KnowledgeDocumentVersion body = new KnowledgeDocumentVersion(); // KnowledgeDocumentVersion | 
try {
    KnowledgeDocumentVersion result = apiInstance.postKnowledgeKnowledgebaseDocumentVersions(knowledgeBaseId, documentId, body);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling KnowledgeApi#postKnowledgeKnowledgebaseDocumentVersions");
    e.printStackTrace();
}
```
...
String knowledgeBaseId = "knowledgeBaseId_example"; // String | Knowledge base ID.
String documentId = "documentId_example"; // String | Document ID.
KnowledgeDocumentView body = new KnowledgeDocumentView(); // KnowledgeDocumentView | 
try {
    apiInstance.postKnowledgeKnowledgebaseDocumentViews(knowledgeBaseId, documentId, body);
} catch (ApiException e) {
    System.err.println("Exception when calling KnowledgeApi#postKnowledgeKnowledgebaseDocumentViews");
    e.printStackTrace();
}
```
...
try {
    ...
    System.err.println("Exception when calling KnowledgeApi#postKnowledgeKnowledgebaseDocuments");
    e.printStackTrace();
}
```
...
String knowledgeBaseId = "knowledgeBaseId_example"; // String | The ID of knowledge base containing the documents to query.
List<String> expand = Arrays.asList(null); // List<String> | Fields, if any, to expand for each document in the search result matching the query.
KnowledgeDocumentSearchRequest body = new KnowledgeDocumentSearchRequest(); // KnowledgeDocumentSearchRequest | 
try {
    KnowledgeDocumentSearch result = apiInstance.postKnowledgeKnowledgebaseDocumentsSearch(knowledgeBaseId, expand, body);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling KnowledgeApi#postKnowledgeKnowledgebaseDocumentsSearch");
    e.printStackTrace();
}
```
...
try {
    ...
    System.err.println("Exception when calling KnowledgeApi#postKnowledgeKnowledgebaseDocumentsSearchSuggestions");
    e.printStackTrace();
}
```
...
KnowledgeApi apiInstance = new KnowledgeApi();
String knowledgeBaseId = "knowledgeBaseId_example"; // String | Knowledge base ID
KnowledgeExportJobRequest body = new KnowledgeExportJobRequest(); // KnowledgeExportJobRequest | 
try {
    KnowledgeExportJobResponse result = apiInstance.postKnowledgeKnowledgebaseExportJobs(knowledgeBaseId, body);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling KnowledgeApi#postKnowledgeKnowledgebaseExportJobs");
    e.printStackTrace();
}
```
...
KnowledgeApi apiInstance = new KnowledgeApi();
String knowledgeBaseId = "knowledgeBaseId_example"; // String | Knowledge base ID
KnowledgeImportJobRequest body = new KnowledgeImportJobRequest(); // KnowledgeImportJobRequest | 
try {
    KnowledgeImportJobResponse result = apiInstance.postKnowledgeKnowledgebaseImportJobs(knowledgeBaseId, body);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling KnowledgeApi#postKnowledgeKnowledgebaseImportJobs");
    e.printStackTrace();
}
```
...
KnowledgeApi apiInstance = new KnowledgeApi();
String knowledgeBaseId = "knowledgeBaseId_example"; // String | Knowledge base ID
LabelCreateRequest body = new LabelCreateRequest(); // LabelCreateRequest | 
try {
    LabelResponse result = apiInstance.postKnowledgeKnowledgebaseLabels(knowledgeBaseId, body);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling KnowledgeApi#postKnowledgeKnowledgebaseLabels");
    e.printStackTrace();
}
```
