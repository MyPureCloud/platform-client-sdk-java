...
| **contentType** | [**ContentTypeEnum**](#Enum--ContentTypeEnum) | The content type that is going to be uploaded. If Content Management document is used for faxing, contentType will be ignored |  [optional] |
