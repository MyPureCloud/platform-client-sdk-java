...
| **startOffsetMinutes** | **Integer** | The start offset in minutes for the time-off marker |  [optional] |
| **endOffsetMinutes** | **Integer** | The end offset in minutes for the time-off marker |  [optional] |
...
| **payableMinutes** | **Integer** | Payable minutes for the time off marker. Must not exceed lengthMinutes |  [optional] |
