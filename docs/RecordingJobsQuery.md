...
| ------------ | ------------- | ------------- | ------------- |
| **action** | [**ActionEnum**](#Enum--ActionEnum) | Operation to perform bulk task. If the operation will cause the delete date of a recording to be older than the export date, the export date will be adjusted to the delete date. |  |
...
| **includePolicyBasedRecordings** | **Boolean** | Whether to include policy-based recordings for the action, default value = true |  [optional] |
| **includeSnippetRecordings** | **Boolean** | Whether to include snippet recordings for the action, default value = true |  [optional] |
