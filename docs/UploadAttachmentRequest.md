...
| **contentLengthBytes** | **Integer** | The length of the file to upload in bytes |  |
| **contentMd5** | **String** | Content MD5 of the file to upload |  [optional] |
| **inlineImage** | **Boolean** | Whether or not the attachment should be attached inline |  [optional] |
