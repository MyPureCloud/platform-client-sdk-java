...
| **appliesTo** | [**List<AppliesToEnum>**](#Enum--AppliesToEnum) | One of \"CONTACT\" or \"EXTERNAL_ORGANIZATION\".  Indicates the built-in entity type to which this schema applies. |  [optional] |
