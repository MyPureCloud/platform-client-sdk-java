...
| ------------ | ------------- | ------------- | ------------- |
| **responses** | [**Map&lt;String, DialerResponsesetConfigChangeReaction&gt;**](DialerResponsesetConfigChangeReaction) | Map of disposition identifiers to reactions. For example: {\"disposition.classification.callable.person\": {\"reactionType\": \"transfer\"}} |  [optional] |
